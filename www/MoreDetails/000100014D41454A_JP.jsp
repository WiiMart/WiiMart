...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">剣と魔法のファンタジー・アクションゲームの決定版。魔人デス＝アダーによって肉親の命を奪われた３人（バーバリアンのアックス=バトラー、アマゾネスのティリス＝フレィアー、ドワーフのギリウス＝サンダーヘッド）は、力を合わせて魔人討伐の旅に出ます。巨大な亀の甲羅の上にできた村の住民を襲う火を吹くドラゴン、野営するプレイヤーに忍び寄るシーフ、巨大な鳥の上でのガイコツ騎士との攻防、王宮の奥に眠る秘密の通路など、さまざまな舞台で戦いが繰り広げられます。旅の目的を果たすためにはプレイヤー同士の協力が必要です。アーケードでも大ヒットした２人協力プレイに加え、プレイヤー同士の対戦も可能なデュエルモードを搭載。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
