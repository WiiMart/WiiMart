...
function initPage()
{
	...
	setUnderButtonL(true, "뒤로", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "이 소프트웨어의<BR>설명서 보기", "javascript:showManual('000100014843464B')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『Wii 스피크 채널』은 「Wii 스피크」를 사용하여 멀리 떨어진 곳에 있는 친구와 대화를 나누거나, 친구에게 보이스 메시지를 보낼 수 있는 Wii 채널입니다.<BR><BR>Wii 친구와 함께 최대 4대의 Wii 본체에서 「Wii 스피크」를 연결하여 『Wii 스피크 채널』을 이용하면, 마치 같은 공간에 있는 듯한 감각으로 대화를 즐길 수 있습니다.<BR>수화기 등을 이용하지 않기 때문에 TV 앞에 있는 모든 사람이 대화에 참가할 수 있습니다. 또한통화 요금은 무료입니다.（※）<BR><BR>※단, 초고속 인터넷 환경이 필요합니다.<BR><BR>대화 중에는 SD 메모리 카드 또는 Wii 알림판에 들어 있는 사진을 상대방에게 전송하여, 함께 보면서 대화를 나눌 수도 있습니다.<BR><BR>또 하나의 기능으로, Wii 친구가 『Wii 스피크 채널』을 갖고 있지 않아도 Wii 친구의 Wii 알림판에 보이스 메시지를 사진과 함께 전송할 수 있습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843464B/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843464B/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii 스피크 채널</span></div>
</div>
