...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157394250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Salut et bienvenue au Big Town Shoot Out ! Si vous êtes un tireur d'élite et que la gâchette vous démange, vous êtes au bon endroit !
<br><br>
Le Big Town Shoot Out vous guidera au travers de 40 niveaux de plus en plus difficiles, dans 10 zones différentes avec 10 jeux distincts pouvant être joués simultanément par 1 à 4 joueurs. Êtes-vous un cowboy suffisamment doué pour relever ce défi ?
<br><br>
Alors, comme mon vieux père avait l'habitude de dire, risque tout, n'aie peur de rien, n'aie pas de regrets. Ce n'est peut-être pas ce qu'il y a de plus facile, mais c'est l'approche des cowboys.
<br><br>Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157394250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157394250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Big Town Shoot Out</span></div>
</div>
