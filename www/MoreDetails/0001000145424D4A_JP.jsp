...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９３年にリリースされたプロレスゲームで、プレイヤーは１０人の個性的なレスラーから一人を選択してチャンピオンの座を目指すことになります。本作ならではの特徴といえば、独特な組み技システムでしょう。試合中に相手のレスラーに接近して組み合うと、画面にゲージが表示されます。ここでプレイヤーはボタンを連打して相手よりも多くのゲージを溜めることで優先的に技をかけられます。もちろん、プロレスゲームでは定番の要素も満載。中間距離での打撃技の応酬や、トップロープからの空中技、遠距離からのダッシュ技、そして約束の反則攻撃も…。試合会場も普通のリングだけではなく、電流マッチや、ストリートマッチなどもあり、味がある試合が楽しめます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイヤー・スープレックス</span></div>
</div>
