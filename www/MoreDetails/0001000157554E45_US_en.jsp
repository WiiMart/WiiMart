...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157554E45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Get ready to call “UNO” on your Wii console! The world famous card game is faithfully reproduced for the Wii console and also features exciting new rules. With a multiplayer mode played on one Wii console or through Nintendo Wi-Fi Connection, UNO™ has never been so fun and easy, so be the first to get rid of all your cards!
<p>
• The #1 card game for friends and family fun recreated with the game’s classic identity and rules that are easy enough for anyone to understand!<br>
• Allows for customizing the game rules and discovering new ways to play UNO™ like “UNO 7-0”, “UNO Challenge”, “Jump In” and many others.<br>
• A thrilling multiplayer mode on Nintendo Wi-Fi Connection allows up to 6 people to experience all the enjoyment of playing UNO™ with friends. For a truly immersive experience, talk to your opponents and call out “UNO” for real using the Wii Speak accessory! Victory has never been so enjoyable.</div>
  <div id="image02">
