...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157435545')", "wiiSelectSound()");
...
Rattle-a-Kiss: Gauge the correct rattle speed to give that shy guy a push so he flies in for a smooch.<br>
Rattle Blast: An intense duel where you need to get your rattling strength just right!<br>
