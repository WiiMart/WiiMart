...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157324350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Allena la tua mente ed elimina lo stress grazie a 25 mini-giochi di Logica, Calcoli, Memoria, Vista e Focus.
<br><br>
Scegli il tuo tutor preferito e partecipa ad una sessione d'allenamento personale per ricevere una valutazione su misura.
<br><br>
Mettiti a confronto con amici e familiari, sfidandoli con il tuo Mii personalizzato in 3 eccitanti modalità multigiocatore. Fagli vedere chi è il migliore! Inoltre, grazie al Test bambini ed al Test senior, tutti i membri della famiglia potranno partecipare!
<br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324350/FFFD0014" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324350/FFFD0015" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Brain Challenge </span></div>
</div>
