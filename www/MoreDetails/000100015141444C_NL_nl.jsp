...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit schietspel is het vervolg op het meesterwerk Gradius. Twee jaar na het laatste epische gevecht doet het Gradius-leger opnieuw een beroep op het superdimensionale gevechtsvliegtuig Vic Viper om de invasie van een nieuwe vijand, Gofer genaamd, tegen te gaan. Met het nieuwste model van de Vic Viper kunnen spelers uit verschillende wapens en schilden kiezen om de uiteenlopende levels en vijandelijke aanvalspatronen aan te pakken. Met negen levels is deze naadloze overzetting van het origineel een van de langste spellen in de serie en bevat het ook meer karakteristieke, snelle muziek die de intense actie begeleidt.
<br><br>Het spel is voorzien van Engelse schermteksten met wat Japans.<br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
