...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Solomon's Key is an action/puzzle game where you control the wizard Dana and delve into a labyrinth to seek out a magical tome called Solomon's Key, the key item that will aid you in your quest to drive away evil spirits let loose in the world!
<br><br>
The goal of the game is to use buttons to create and destroy blocks, using all of the skill and techniques at your disposal to find keys to pass through doors. You can adjust the number of lives available and the difficulty level for a custom experience.
<br><br>
This game has appeared on a variety of platforms, but the arcade version focuses strongly on the action elements of the game, making it more challenging and allowing players of all skill levels, from beginner to expert, to enjoy it!</div>
  <div id="image02">
