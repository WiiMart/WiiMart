...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Art Style: light trax te presenta un nuevo estilo de juego de carreras con un aspecto completamente surrealista. Deberás controlar un haz de luz que se mueve constantemente hacia delante a la vez que tu punto de vista cambia entre las perspectivas de 2D y 3D.
<p>
Para empezar, elige uno de los dos modos de juegos, cada uno con un objetivo distinto. En el modo "light tours" compites con otros haces de luz para conseguir la mayor puntuación en una carrera de tres circuitos. Ten cuidado con los obstáculos, utiliza los objetos y usa el turbo sabiamente para llegar primero a la meta. En el modo "freeway", tu objetivo consiste en conseguir la máxima puntuación llegando lo más lejos posible dentro de un tiempo límite. Es imprescindible llegar a ser un experto en los dos modos: tendrás que dominar ambos para progresar en el juego y desbloquear todos sus modos.
<p>
Gracias a sus controles precisos y su banda sonora de música tecno, Art Style: light trax te ofrece una experiencia única. ¿Estás listo para competir en esta carrera a la velocidad de la luz?
<p>
La serie de Art Style ofrece un diseño elegante, gráficos pulidos y controles simples, creando una experiencia que se centra principalmente en un estilo de juego divertido y atractivo.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414C45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414C45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Art Style<sup>TM</sup>: light trax<sup>TM</sup></span></div>
</div>
