...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Partez à la conquête des greens avec Mario (et Luigi en mode deux joueurs) dans cette simulation sportive de 1992.
<br><br>
NES Open Tournament Golf vous propose trois parcours internationaux (Royaume-Uni, Etats-Unis et Japon) et trois modes de jeu (Stroke Play, Match Play et Tournoi).
<br><br>
Préparez votre coup sur l'écran de carte en 2D en choisissant le club le mieux adapté, ajustez la distance en fonction du vent, puis passez sur l'écran de frappe pour tenter un coup au timing parfait.
