...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744394A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ドラキュラ、復活。クラシックテイストの新作が登場。<BR><BR>Wiiウェア「ReBirth」シリーズ第3弾。 ついに“ドラキュラ”が蘇る。<BR><BR>1989年にゲームボーイで発売された「ドラキュラ伝説」の世界観を元に、新解釈、新コンセプトで完全リメイクした、ステージクリア型の2Dアクションゲーム。<BR>各ステージは、美麗なゴシックホラー調のグラフィック表現に生まれ変わり、新たに描きおこした手ごたえ十分な魔物や、ボスキャラが行く手を阻む。<BR>「悪魔城ドラキュラ」シリーズからセレクトされた新アレンジの楽曲にも注目。<BR><BR>≪ストーリー≫<BR>100年の後に蘇るという予言通り、かつて人間を恐怖に陥れた魔王、ドラキュラ伯爵が復活の時を迎える。<BR>その危機に、かつてドラキュラを滅ぼした正統ヴァンパイアハンター、ベルモンド一族の末裔であるクリストファー・ベルモンドが立ち上がる。<BR>プレイヤーは、クリストファー・ベルモンドとなり、闇の眷族がひしめき巧妙なトラップに満ちた、ドラキュラ城に単身乗り込み、宿敵ドラキュラ伯爵を滅ぼさなければならない。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015744394A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744394A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドラキュラ伝説 ReBirth</span></div>
</div>
