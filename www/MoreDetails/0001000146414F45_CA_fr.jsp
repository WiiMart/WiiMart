...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A classic arcade title first released by Tecmo, Solomon's Key defined the 1980s puzzle-strategy genre.  As Dana, a skilled and talented hero, you must strategically maneuver through over 40 stages using mysterious block-creation skills and other magical powers.  Free the captive Fairy in each stage by finding the Bell, and escape by grabbing the Magic Key.  Use quick thinking and magical firepower to discover hidden items and evade numerous enemies as you race against the clock! Solomon's Key also features over 10 secret levels and multiple endings you can unlock!  Do you have what it takes to unravel the secrets of Solomon's Key?</div>
  <div id="image02">
