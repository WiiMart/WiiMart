...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157525150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Met meer dan 30 legendarische dieren, waaronder wolharige neushoorns, witstaartherten, wolven en reuzenherten, brengt Deer Drive Legends WiiWare je naar de uithoeken van de wereld om te jagen op de wildste dieren, die zelden door de mens zijn gezien. Sommige zouden zelfs al uitgestorven zijn! Deze dieren zijn snel, dodelijk en willen jou als avondeten! Stort je in gevaarlijke eindgevechten met de gevreesde T-Rex, sabeltandkatten en Gastornis. Met diverse wapens om uit te kiezen, zoals scherpschuttersgeweren, kruisbogen en krachtige shotguns, is Deer Drive Legends WiiWare de ultieme jachtgame waar je op hebt gewacht!</div>
  <div id="image02">
