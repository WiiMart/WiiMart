...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Digital Champ è un gioco di simulazione di pugilato che, grazie alla prospettiva in prima persona, ti proietta al centro dell'azione! Determinato a contrastare i piani di conquista del mondo concepiti da Mother Computer, devi penetrare in territorio nemico e sconfiggere gli avversari usando la tua affinata tecnica pugilistica.<br><br>
Gli incontri si compongono di 12 round, ognuno dei quali di 3 minuti. Per passare al match successivo devi mandare KO l'avversario o atterrarlo tre volte in un round per poter vincere il KO tecnico (TKO). Hai a disposizione un arsenale di colpi (destro, sinistro, gancio, colpo caricato) e ben tre tipi di pugni "Devastator". Para i colpi dei rivali, schiva i loro attacchi e cerca il momento giusto per bersagliarli di pugni potenti e precisi. Sfrutta al meglio le tecniche a tua disposizione e sconfiggi l'avversario più pericoloso, il terribile Digital Champ!
<br><br>
