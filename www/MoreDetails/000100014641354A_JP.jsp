...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アリティア王国の王子「マルス」が、暗黒竜メディウス率いる「ドルーア帝国」に滅ぼされた祖国の解放とメディウス打倒を目的とするアカネイア同盟軍の中心となっていく、シミュレーションＲＰＧ「ファイアーエムブレム」シリーズの最初のソフトです。本作は１９９０年に発売され、シミュレーションゲームの駒（ユニット）にＲＰＧのような成長とキャラクターとしての個性が与えられたシミュレーションＲＰＧのさきがけとして知られています。ひとりひとりのユニットは「ナイト」「戦士」「アーチャー」「僧侶」など個性豊かな職業に属し、個々に違う機動力や攻撃力、攻撃方法を持っています。プレイヤーは、それぞれのユニットの個性を生かした采配で戦況を指揮し、戦いでの勝利をめざします。歴戦をともにして成長した仲間は、上級職にクラスチェンジをし、より強力な仲間になってくれますが、一方で、戦闘で攻撃を受けＨＰが０になったユニットは二度と物語に登場しなくなるので、進軍には細心の注意が必要です。時には敵に話しかけることや、「村」や「民家」に立ち寄ることで、新たな仲間やアイテムを得ることができます。あなたの一手が物語を左右するのです。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイアーエムブレム<sup>&reg;</sup>　暗黒竜と光の剣</span></div>
</div>
