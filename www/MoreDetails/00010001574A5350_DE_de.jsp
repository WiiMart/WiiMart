...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574A5350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jungle Speed® ist ein blitzschnelles Kartenspiel für die ganze Familie, bei dem Schnelligkeit und ein gutes Auge den Sieg entscheiden.<br><br>
Drehe die Karten um, beobachte Deinen Gegner und nimm das Totem im richtigen Moment um das Spiel zu gewinnen. Ausgerechnet wenn Du denkst, du
hast es geschafft, kann eine neue Karte vorübergehend die Regeln ändern und dich an den Rand drängen. <br><br>Das Spiel beginnt wenn der erste seine Karten umdreht. Eine Änderung der Symbole tritt erst dann in Kraft, wenn zwei Karten zusammen passen. Spieler mit den passenden Karten müssen sich dann beeilen, das Totem in der Mitte des Tisches zu schnappen. Der Verlierer bekommt die Karten des Siegers. <br><br>Mit der Zeit gewinnt jeder Spieler, der als erster alle Karten los ist.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
