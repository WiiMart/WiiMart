...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti à l'origine sur la Nintendo 64, Wave Race 64 a immédiatement évincé la concurrence avec ses impressionnants graphismes en 3D et son gameplay efficace!<br><br>
Dans le mode Championship, exercez-vous dans neuf courses différentes, de la reposante Sunny Beach à la turbulente Marine Fortress. Chaque course est truffée d'obstacles et équipée de rampes d'où vous pouvez vous jeter pour effectuer des acrobaties incroyables!
<br><br>
Jouez contre un ami dans le mode Vs, choisissez le mode Time Trial pour finir la course le plus vite possible ou encore le mode Stunt pour tester votre équilibre, effectuer des sauts périlleux arrière et des tonneaux! Si vous vous débrouillez bien, vous pourrez même chevaucher un dauphin!
<br><br>Texte écran en anglais ou en allemand.</div>
  <div id="image02">
