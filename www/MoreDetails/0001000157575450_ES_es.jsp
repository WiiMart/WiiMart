...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157575450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Los clásicos juegos retro pueden ir más allá de su plataforma original y avanzar en la siguiente generación. BurgerTime World Tour es la evolución de un clásico arcade mejorado con entorno cilíndrico rotatorio en 3D y gran jugabilidad retro.
<br><br>
El eje rotatorio te permite ver a través del nivel cilíndrico, creando elementos clave para decidir la manera más rápida de completar una hamburguesa. Ahora Peter Pepper puede lanzar a sus enemigos. Lanzar una verdura enfadada ayudará a soltar con precisión a un enemigo en una parte de la hamburguesa, lo que dará al jugador muchos puntos de bonificación.
<br><br>
Con elementos de plataformas desafiantes, jefes y más de 20 niveles, el nuevo BurgerTime está fresco y en su jugo. Vive el BurgerTime original en un mundo 3D mucho más grande. ¡Huye de verduras enfadadas y construye hoy tu BurgerTime World!
<br><br>
