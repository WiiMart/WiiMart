...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cuarta entrega de la saga Samurai Shodown, juego de lucha publicado en 1996. Al igual que en Samurai Shodown III: Blades of Blood, la presente entrega conserva el sistema de barra de furia así como las espectaculares técnicas de combo. Además, los finales varían dependiendo del tiempo transcurrido hasta completar el juego. Kazuki Kazama y Sogetsu Kazama entran en escena como nuevos invitados al torneo, que consta de un total de 17 samuráis impacientes por poner a prueba sus habilidades.<br><br>Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
