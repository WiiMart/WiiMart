...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Diese neue Version des Fotokanals ist eine optionale, kostenlose Aktualisierung. Folgende Änderungen sind darin enthalten:
<br><br>
<b>Persönliche Anpassung der Fotokanal-Schaltfläche</b>
<br>
Ändere die Fotokanal-Schaltfläche im Wii-Menü in dein Lieblingsbild, das auf einer SD Card oder an der Wii-Pinnwand vorliegt.
<br><br>
<b>Anderes Format der Audiodateien</b>
<br>
Das Musikformat der Hintergrundmusik bei Diashows wurde von MP3 zu AAC geändert. (AAC-Dateien erreichen bei gleicher Dateigröße eine bessere als MP3-Dateien.)
<br><br>
Hinweise:
<br>
- Nach dem Herunterladen der Version 1.1 ist das Abspielen von Musikdateien im MP3-Format nicht mehr möglich. Die ursprüngliche Version des Fotokanals kann jedoch nachträglich wiederhergestellt werden, indem Version 1.1 gelöscht wird.
<br><br>
- Auf den Wii-Konsolen, die seit Dezember 2007 ausgeliefert werden, ist bereits Version 1.1 des Fotokanals enthalten. Dabei ist das Wiederherstellen der Version 1.0 nicht möglich.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000048415A41/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000048415A41/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fotokanal 1.1</span></div>
</div>
