...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157544650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De BIT.TRIP-serie wordt gecompleteerd met BIT.TRIP FLUX: CommanderVideo’s laatste reis.<br><br>
Grijp je Wii-afstandsbediening en maak je klaar voor een klassieke spelervaring terwijl CommanderVideo terugkeert naar de bron.<br><br>
Of je nu in je eentje speelt of coöperatief met twee spelers, je zult worden geconfronteerd met nieuwe uitdagingen waarvan zelfs de meest ervaren BIT.TRIPPERS zullen schrikken.<br><br>
Geniet van nieuwe uitdagingen binnen de vertrouwde spelervaring waarmee het fenomeen BIT.TRIP ooit begon.<br><br>
• Nieuwe Power-Ups inclusief het schermvullende batje!<br>
• Nieuwe soorten Beats inclusief Avoid Beats!<br>
• Checkpoints halverwege het level!<br>
• Klassieke BIT.TRIP BEAT-spelervaring nu met alle Modes inclusief de nieuwe Meta Mode! <br>
• Bit Shifter keert terug als de Chiptune gastster!<br><br>
Vergezel CommanderVideo als hij zijn missie afmaakt en terugkeert naar... huis.
<br><br>
