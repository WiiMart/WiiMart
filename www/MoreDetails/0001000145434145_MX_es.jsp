...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“Real Bout Fatal Fury 2: The Newcomers” es la séptima entrega de la saga de juegos de lucha Fatal Fury, publicada en 1998. Continuando con el mismo modo de juego que en ediciones anteriores, “Real Bout Fatal Fury 2: The Newcomers”presenta un sistema de dos líneas de batalla mejorado, así como nuevas características, tales como: el “Golpe Perforador”, un sistema de ataque con el que puede deshacerse la guardia del oponente; la capacidad de mantenerse en la línea secundaria de batalla manteniendo la cruz de control pulsada hacia arriba o siguiendo caminando; o la capacidad de ponerse de pie de inmediato cuando el personaje es derribado tocando los botones en el momento justo. Además, dos nuevos personajes se unen al torneo: Li Xiang Fei, maestra de Kung Fu, y un boxeador conocido como Rick Strowd. Y eso no es todo, Geese Howard reaparece como personaje disponible. ¡Elige uno de los 2 luchadores y pon a prueba tus fuerzas!
<p>(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434145/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">REAL BOUT FATAL FURY 2</span></div>
</div>
