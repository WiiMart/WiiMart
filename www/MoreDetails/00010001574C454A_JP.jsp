...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574C454A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ふしぎなどうぶつ「プーヨー」といっしょに踊ったり、かずを数えるなど６種類の遊びを楽しめる幼児番組風ゲームです。Ｗｉｉリモコンを振ったり、ボタンを押して反応する様々な仕掛けが用意されているのでおもちゃの様に触って楽しめます。また、司会のおねえさんが声でナビゲートしてくれるので小さなお子様も安心してプレイできます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C454A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C454A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">プーヨーとあそぼう エピソード１</span></div>
</div>
