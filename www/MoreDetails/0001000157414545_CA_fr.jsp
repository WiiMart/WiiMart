...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157414545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Around the World brings fun to geography! Whether you're alone and want to improve your knowledge or you want to compete with other friends and family in exciting mini-games, this game is for you! It is composed of one solo mode to improve your knowledge about this topic and one multiplayer mode to play with your friends and family. With fun and entertainment, this game addresses geography as a whole through various topics such as monuments, history, sports, art, literature and people.
<p>
The concept of this party game is essentially oriented towards two types of games where the player should answer within a defined time:<br>
- A quiz during which the player answers questions by choosing the right answer among many possibilities.<br>
- A mode during which the player has to point as closely as possible to a given place.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
