...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">리얼한 그래픽과 입체적인 화면이 특징적인 가로 스크롤액션 게임입니다. 커다란 몸집에 힘이 센 동키와 날렵하고 재빠른 디디콩. 때로는 동물친구도 동원하여 다양한 액션으로 코스를 클리어해 보세요. 숨겨진 스테이지와 보너스 면을 찾아내면 100% 클리어를 달성할 수 있습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414554/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414554/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">동키콩 컨트리<sup>TM</sup></span></div>
</div>
