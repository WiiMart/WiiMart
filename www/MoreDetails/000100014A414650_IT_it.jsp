...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questa è la famosa simulazione in cui un giocatore assume il ruolo di sindaco e deve trasformare una nuova città in una megalopoli. Questa versione, cosviluppata da Maxis e Nintendo, è da molti ritenuta il miglior adattamento del gioco originale. All’inizio fu pubblicata solo su Super Nintendo e includeva diverse caratteristiche extra. Le stagioni cambiavano l'aspetto della città. Alcuni dei più famosi personaggi Nintendo, raggiunto un certo punto del gioco, facevano la loro sorprendente apparizione. Questa versione, inoltre, includeva delle missioni extra nella modalità scenario. SimCity™ viene ricordato anche per aver offerto alcune delle musiche più belle per il Super Nintendo.
