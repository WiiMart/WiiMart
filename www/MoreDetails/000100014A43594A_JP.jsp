...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１６世紀初頭のヨーロッパを舞台に、世界の大海原を船で冒険するシミュレーションロールプレイング。プレイヤーは、異なる境遇と行動目的を持つ６人のキャラクターの中から１人を選択し、全世界の海洋と港を舞台に冒険を繰り広げます。貿易でお金を稼いだり、船を新造したり、海賊と戦って名声を上げたりなど、何をするのもプレイヤーの自由です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">大航海時代Ⅱ</span></div>
</div>
