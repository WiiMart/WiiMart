...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bomberman ’93, het spannende en verbeterde vervolg op het oorspronkelijke Bomberman!<br>Met zijn 6 werelden, die stuk voor stuk 8 gebieden beslaan, biedt de normale speelstand meer plezier dan je aan kunt. In 48 verschillende gebieden blaas je al je vijanden op, terwijl je zoekt naar de verborgen uitgang om het volgende gebied te bereiken, voordat de tijd op is. De ‘schop’-functie maakt in deze versie van Bomberman voor het eerst zijn opwachting, dus je kunt echt je meest geslepen tactieken in de strijd gooien! Maak slim gebruik van de vallen en nieuwe voorwerpen om elk gebied in recordtijd te voltooien! In Battle Game kunnen maximaal vijf spelers het tegen elkaar opnemen, maar kijk uit, want al die nieuwe foefjes en gadgets (zoals de lopende band) staan garant voor een explosieve strijd!<br><br>Als je met meer personen wilt spelen, moet je voor iedere speler een Wii-afstandsbediening of Nintendo GameCube Controller op het systeem aansluiten.<br>Om met zijn vijven te spelen, heb je tenminste één Nintendo GameCube Controller nodig.<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414150/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414150/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bomberman<sup>&reg;</sup> ’93</span></div>
</div>
