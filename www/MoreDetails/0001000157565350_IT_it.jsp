...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157565350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Vesti i panni delle più grandi divinità delle maggiori tradizioni mitologiche: nordica, egizia, romana e giapponese. Sarai un dio in lotta per impedire agli esseri umani di usurpare il tuo posto. Questi sfacciati, infatti, si sono messi in testa di costruire una torre per poterti sfidare!
<br><br>
...
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157565350/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
