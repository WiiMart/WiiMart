...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574E3950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">L'esercito è tornato, e cerca una nuova generazione di reclute! La classica saga di strategia a turni, Military Madness, nota anche come Nectaris, esplode su WiiWare con una schiera di caratteristiche tutte nuove. Oltre alla campagna per giocatore singolo, tu e i tuoi alleati potrete fare la guerra in locale o online in partite fino a quattro giocatori, a squadre o tutti contro tutti. Non importa se ti coprirai di gloria o subirai delle schiaccianti sconfitte, potrai sempre confrontarti con gli altri generali controllando la classifica. Esiste persino un'unità esclusiva per partite multigiocatore, il Comandante, che presenta 20 abilità uniche per cambiare le sorti della battaglia. Questo è di certo l'episodio più pazzo della serie!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E3950/FFFD0013" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E3950/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MILITARY MADNESS</span></div>
</div>
