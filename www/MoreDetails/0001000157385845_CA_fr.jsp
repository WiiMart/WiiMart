...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157385845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Battle Poker is a family-friendly card game with up to four players battling against the clock to make the best five-card hand possible. Battles are played across multiple rounds, with points scored for each round based on the quality of the hand. Each player uses a Wii Remote to point and click on a standard deck of cards laid across the screen. The first click flips the card over, at which point it can be grabbed by anyone else. You've got to have fast fingers and eyes if you're to grab the cards you need before someone else snatches them from you.</div>
  <div id="image02">
