...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157414550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Around the World è un simpatico gioco a contenuto geografico. È costituito da una modalità "Solo" (giocatore singolo), nella quale migliorare le proprie conoscenze geografiche e da una modalità "Multi" (multigiocatore), nella quale sfidare parenti e amici.  
L'idea di base per questo party game è la riunione di due giochi con domande alle quali rispondere entro un tempo dato: <br>
- il quiz in cui il giocatore risponde a una domanda scegliendo la risposta giusta tra varie proposte,<br>
- il gioco "indica il punto più vicino possibile" in cui il giocatore deve situare con precisione un determinato luogo.<br><br>
Sempre all'insegna del divertimento, questo gioco è incentrato sulla geografia in senso lato e se ne occupa attraverso vari temi come monumenti, storia, sport, arte, letteratura, società e personaggi. <br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414550/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414550/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Around the world</span></div>
</div>
