...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157533950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ahora es tu oportunidad de jugar el crucigrama quiebra-cerebros, tomándote el mundo por montera.<br><br>Con más de 100 000 000 crucigramas de Sudoku, ¡Tú nunca verás el mismo crucigrama dos veces, en el desafío de Sudoku !  Puedes seleccionar el clásico Sudoku tablero, de nueve por nueve así como Grand Sudoku el cual te desafía a completar ¡cinco tableros de intersección simultáneamente! ¿Solo un principiante? No te preocupes. Con las tres opciones de dificultad, incluso el jugador más novato puede completar un Sudoku con facilidad. Pero si eres un experimentado profesional, desafíate a ti mismo en el modo de “Experto” y prueba tus verdaderas habilidades. <br><br>¡Es tiempo de ponerte tu gorro para pensar y ver cuántos crucigramas de Sudoku puedes conquistar!<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
