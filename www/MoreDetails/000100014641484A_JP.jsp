...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコン初のテニスゲーム。シングルス・ダブルスの両方で遊ぶことができ、ダブルスではプレイヤー同士がペアとなってコンピュータと対戦が可能。簡単操作で、スマッシュ・ボレー・ロブなどのさまざまなショットを打ち分けられる、誰でも楽しめる本格テニスゲームです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">テニス</span></div>
</div>
