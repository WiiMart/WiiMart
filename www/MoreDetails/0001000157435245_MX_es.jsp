...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157435245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Carnival King es un divertido juego de video para todas las edades, que lleva el espíritu y la energía de los competitivos juegos de feria a la pantalla. Los jugadores compiten para obtener la puntuación más alta y premios durante su visita a parques de diversiones diferentes: Arcadia, Dreamland y Lagoon Park. Cada parque tiene cuatro conjuntos de juegos y una ronda de bonificación que pone a prueba la velocidad y precisión de los jugadores al tirar. Sin importar que seas un tirador novato o experto, los juegos son un desafío continuo y puedes ajustar el nivel de dificultad a tu confianza creciente como jugador.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Carnival King</span></div>
</div>
