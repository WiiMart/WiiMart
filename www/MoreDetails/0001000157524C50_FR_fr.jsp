...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157524C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En l'an 2112, les foules sont fascinées par des courses à vitesse extrême. La dernière technologie de course antigravité a intégré un système de phases. Une correspondance parfaite entre le circuit et la machine est la clé pour rester en vie.
<br><br>
...
<br><br>
Faites chauffer les machines. Le futur, c'est maintenant...
<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524C50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524C50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
