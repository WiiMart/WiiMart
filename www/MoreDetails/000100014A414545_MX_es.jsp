...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Donkey Kong Country es una increíble aventura, y el primer juego en estrenar a Diddy Kong, el compinche de Donkey Kong. Desafiados por la descabellada tribu de reptiles llamados Kremlings, los Kongs se enfrentarán a sus astutos adversarios armados con volátiles movimientos, enormes músculos y sus increíbles números de acrobacia . Este dúo también contará con la ayuda de su gran grupo de amigos y familia, desde Funky Kong, Cranky Kong , y Candy Kong, hasta a Rambi el rinoceronte, Expresso la avestruz, Enguarde el pez espada, el loro Squawks, y la rana Winky. Este juego tiene hasta 30 niveles, además de docenas de cuevas y cuartos secretos--para dar un total de más de cien áreas. ¡Ayúdale a los Kongs para que logren recuperar sus tesoro de bananas!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Donkey Kong<sup>TM</sup> Country</span></div>
</div>
