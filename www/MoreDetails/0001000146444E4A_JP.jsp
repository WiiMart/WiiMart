...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気アクションゲーム「ロックマン」シリーズの第二弾です。２００Ｘ年、ロックマンによって悪の天才科学者Ｄｒ．ワイリーの世界征服の野望は阻止され、世界に平和が戻りました。しかしＤｒ．ワイリーは自ら新たに作り出した８体の戦闘用ロボットを使い、再び世界征服を企てます。前作を上回る８つのステージと８体のボス、更に手ごわくなったＤｒ．ワイリー軍団がロックマンの前に立ちはだかります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146444E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146444E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン<sup>&reg;</sup>2</span></div>
</div>
