...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015751344A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">懐かしの玩具『拳闘士』がWiiウェアに登場。シンプルだからこそ、夢中になってしまう拳闘士をお茶の間にお届けします。<BR>さらに、Wiiウェアならではの「アドバンスモード」を用意。アッパー、ガードにウィービング、拳闘士の新しい遊びを楽しめます。Wiiリモコンをフリフリして家族や友達と手軽に熱く楽しんでください。<BR><BR>＜モード紹介＞<BR>■アドバンスモード<BR>玩具では出来なかったアッパーやガードなどのボクシングの基本となる操作が行えます。また、パンチを当てればダウンする玩具とは異なり、相手の体力をゼロにするとダウンします。
さらに、パンチを出すたびに減少していくスタミナゲージを用意。スタミナがゼロになると疲れてしまい一定時間パンチが出せなくなってしまいます。手数勝負では勝てないアドバンスモードならではの駆け引きを楽しめます。<BR><BR>■おもちゃモード<BR>玩具の遊びを再現したモードです。一定回数相手にパンチを当てるとダウンします。拳闘士を知っている人も知らない人もすぐに遊ぶ事が出来ます。<BR><BR>■ミニゲームモード<BR>・スピードノックアウト！<BR>対戦相手のノックアウトまでの時間を競います<BR><BR>・ジャッジミット！<BR>ランダムで出てくるミットにパンチを当て続けましょう</div>
  <div id="image02">
    <img src="/oss/ccs/000100015751344A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015751344A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">拳闘士　フリフリボクシング</span></div>
</div>
