...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157465150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Frogger’s coin-op thrills are back and better than ever! With the original game currently celebrating 30 years of car-dodging, log-jumping, and road-traversing, players can jump into the action with classic and brand-new game modes including Tile Capture, Battle Royale, Freak Out and more that expand the challenge of Frogger's style of run-and-dodge gameplay.
<br><br>
Customise your game board with a variety of different skins, from the modern neon style of HYPER ARCADE to the 8-bit sprites from Castlevania and even CONTRA! Throw down against friends or the CPU in up to 4 player matches to find out who's really the top frog!</div>
  <div id="image02">
