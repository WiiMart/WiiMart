...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157324D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BLASTER MASTER™ OVERDRIVE est un jeu d’aventure et d’action se déroulant sur une Terre infectée par un terrible virus polymorphe.<br><br<
Les pauvres petits animaux sans défense du monde entier, infectés par le virus, sont maintenant de vraies terreurs carnivores engloutissant des litres d’hémoglobine. 
Ouf ! Alex est là et, par une heureuse coïncidence, il se trouve qu’il est un des biologistes les plus renommés au monde, spécialisé dans la typologie de la mutation virale et la manipulation génétique.<br><br>
Tout biologiste consciencieux faisant face à une catastrophe globale imminente a besoin d’un super engin et Alex ne fait pas exception à la règle. Il a S.O.P.H.I.A., un engin du tonnerre capable de changer de forme, un dévoreur d’essence, une machine d’enfer crachant des projectiles, un hymne à la destruction sur quatre roues. <br><br>
L’heure est grave, mais avec Alex et S.O.P.H.I.A. sur le coup, le monde va peut-être s’en sortir pour cette fois.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324D50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324D50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BLASTER MASTER<sup>TM</sup> </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">OVERDRIVE</span></div>
  </div>
