...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９１年にリリースされたベルトスクロールアクションです。プレイヤーは選ばれし超戦士となって、荒廃したワシントンシティを舞台に、現代に復活しようと目論む過去の亡霊と戦います。本作の最大の特徴はプレイ中にキャラクターを変更できる点でしょう。敵との戦いの中で幽閉されたキャラクターを開放すれば、そのキャラクターを使用可能。状況に合わせて忍犬、サムライ、ニンジャなどを切り替えて戦うことが攻略の鍵です。またアイテムを手に入れることで武器や念が使えるといった要素もあります。通常世界に加えて異世界などの冒険もあり、最後まで新鮮な気持ちでプレイできることでしょう。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542574A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542574A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">戦国伝承</span></div>
</div>
