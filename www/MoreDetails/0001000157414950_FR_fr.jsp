...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157414950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">101 jeux pour ravir tous les joueurs ! 
Énigmes, jeux d'arcades effrénés, courses automobiles, sport, cuisine, FPS, sudoku et bien plus encore ! 
Ce pack comblera vraiment tous les joueurs ! <br><br>
