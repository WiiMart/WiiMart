...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157384350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP CORE zet de BIT.TRIP saga voort met dit spel in retro-arcade stijl.
<br><br>
BIT.TRIP CORE is een spannend actie/ritme spel dat je het beste kunt spelen door je te laten leiden door de muziek en op te gaan in wat er op het scherm gebeurt. Je zult merken dat er veel inspiratie van spellen uit de jaren 80 in zit, maar dan in een hedendaags jasje. De gameplay is totaal nieuw voor de serie en is niet langer gebaseerd op de één-assige besturing van BIT.TRIP BEAT maar je kunt nu met twee assen werken.
<br><br>
Als het je teveel wordt, haal je er een vriend(in) bij om samen in Multiplayer te spelen. Haal het eind van het level en je bent een stap dichter bij het uitspelen van BIT.TRIP.
<br><br>
