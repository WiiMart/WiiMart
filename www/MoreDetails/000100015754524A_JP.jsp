...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015754524A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">リズムよく弾を打ち返すことで遊べる新感覚レトロリズムアクションゲームです。<BR><BR>●クラシックなアーケードスタイルプレイ<BR>70年代8bitゲームマシンを思わせる簡単な操作方法(Wiiリモコンによるアナログ操作)で誰でもすぐに遊べます。<BR>※Wiiリモコンを水平に構え、前後に傾けることによってパドルが上下に移動します。<BR><BR>●音楽／リズムベースのアクションとインタラクション<BR>音楽のテンポに合わせて飛んでくる弾を、自機で打ち返していきます。
打ち返す＝演奏となり、音楽を奏でることができます。<BR><BR>●レトロをテーマとしたアート＆音声<BR>70年代8bitゲームマシンを思わせるゲーム画面、音楽でどこか懐かしく新しいゲームプレイが楽しめます。<BR>古さの中にも3Dモデルや半透明エフェクトを使った派手な演出でプレイヤーを盛り上げます。<BR><BR>●4人同時プレイ可能
<BR>友達同士、家族みんなで楽しめます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015754524A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015754524A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
