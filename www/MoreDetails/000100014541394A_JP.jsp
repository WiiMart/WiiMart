...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年にサンソフトからリリースされた格闘ゲームで、同社が１９９５年にリリースした『ギャラクシーファイト』に続くタイトルとして知られています。当時、格闘ゲームは複雑化やマニア化の一途をたどっていましたが、本作ではかわいいキャラクターを採用したほか、必殺技のコマンドもそれほど複雑ではなく、コマンド投げやハラハラアタック（超必殺技）のコマンドを全キャラ共通にしたため、少しの練習で格闘ゲームの醍醐味が楽しめるとして幅広いファンを獲得することとなりました。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">わくわく７</span></div>
</div>
