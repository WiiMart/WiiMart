...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">画面の上から降ってくる「ぷよ」を同じ色どうし、縦横４つ以上くっつけて次々と消していくアクションパズルゲーム。同時消しや連鎖消しで高得点になり、相手のフィールドにたくさんのおじゃまぷよを降らせることができます。１人で遊べる「ひとりでぷよぷよ」はもちろん、対戦モードの「ふたりでぷよぷよ」もおすすめです。落ちものパズルゲームの金字塔ともいえるシリーズの初代作。
<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
