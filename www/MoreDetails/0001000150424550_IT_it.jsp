...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Motoroader è un gioco di corse futuristico nel quale fino a cinque utenti possono sfidarsi in entusiasmanti competizioni. Vinci premi in denaro e usali per acquistare nuove parti con cui potenziare il tuo veicolo: compra “TIRE (PNEUMATICI)” e “BODY (CARROZZERIA)”, e aggiungi “SPECIAL (PEZZI SPECIALI)”! Salta gli ostacoli usando il fantastico “HOPPER (MOLLA)” e sfreccia oltre i rivali a tutta velocità usando la “NITRO (TURBO)”!
Nessun gioco per più utenti potrebbe dirsi completo senza delle armi con cui attaccare gli avversari! Lancia le “GRENADE (GRANATE)” per colpire davanti, e sgancia le “BOMBER (BOMBE)” per far saltare in aria gli avversari che si trovano dietro di te!
Supera gli avversari in tutti e 8 gli HEATS (EVENTI) e conquista il titolo di campione!
...
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Motoroader<sup>TM</sup></span></div>
</div>
