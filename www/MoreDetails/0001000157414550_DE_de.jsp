...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157414550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bei dem Spiel "Around the World" geht es um Geografie. Im Einzelmodus kannst du dein Wissen verbessern, um dann im Multiplayermodus gegen Freunde oder Familienmitglieder anzutreten.
<br><br>
Das Konzept dieses Partyspiels baut auf zwei Spielarten auf, bei denen der Spieler die Antwort innerhalb begrenzter Zeit geben muss:<br>
- Das Quiz, in welchem der Spieler eine Frage beantworten muss, indem er eine der verfügbaren Antwortmöglichkeiten auswählt,<br>
- "Zeige möglichst genau". Der Spieler muss einen vorgegebenen Ort möglichst genau lokalisieren.<br><br>
Auf lustige und unterhaltsame Weise greift dieses Spiel das Thema Geografie anhand verschiedener Themenbereiche wie Denkmäler, Geschichte, Sport, Kunst, Literatur und Menschen auf.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414550/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414550/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
