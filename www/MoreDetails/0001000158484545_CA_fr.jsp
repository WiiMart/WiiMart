...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158484545')", "wiiSelectSound()");
...
<p>
BIT.TRIP BEAT brings retro action back as you use the Wii Remote’s motion sensor to bounce beats in this rhythm game. Retro visuals, classic game play, four-player multiplayer, and an 8-bit soundtrack will get you in the zone and rock your world. Pay attention, though! Like most classic games, the challenges are mighty. If you can stay cool as the difficulty increases, you’ll discover the beginnings of the BIT.TRIP saga...</div>
  <div id="image02">
