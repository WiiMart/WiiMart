...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157395545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome aboard! Here you'll find four fabulous games to satisfy your appetite for gambling:<br>
- Slot Machines<br>
- Roulette<br>
- Black  Jack<br>
- “Video” Poker
<p>
Once on deck, you will be able to choose:<br>
- Competition mode<br>
- Quick Play mode
<p>
If you beat a record, you will have to enter your name in order to appear in the high scores table. But beware of bankruptcy!</div>
  <div id="image02">
