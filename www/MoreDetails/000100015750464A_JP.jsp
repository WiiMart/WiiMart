...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750464A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ポケモン不思議のダンジョン』がついにＷｉｉウェアに登場！<BR>「ポケモンダンジョンシリーズ」初の３Ｄによる表現で、やさしい色合いやポケモンのかわいらしさを生かし、まるで絵本のような雰囲気の中で冒険をお楽しみいただけます。<BR>「不思議のダンジョン」とは、冒険するたびにダンジョンの地形や敵ポケモン、どうぐの位置などが変化する、文字通り「不思議の」ダンジョン。ポケモンのわざや、いろいろなどうぐをうまく使って、ダンジョンの奥へ進んでいきましょう。<BR>おなじみのダンジョンでの遊びに加え、ポケモンがポケモンに乗り、タワーになっているポケモンが連続してわざを使う「ポケモンタワー」などの新要素も追加！<BR>「思いやり」をテーマに語られるポケモンたちの、心温まるストーリーもお楽しみいただけます。<BR>もちろん、冒険中倒れてしまったときはニンテンドーＷｉ－Ｆｉコネクションで救助を求めることもできます。<BR>たくさんのポケモンたちと一緒に冒険団で活躍してみませんか？<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100015750464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ポケモン不思議のダンジョン<sup>TM</sup></span></div>
</div>
