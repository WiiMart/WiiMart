...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Deze verbeterde telg uit de Lode Runner-familie bevat een stand waarbij je met 5 spelers tegen elkaar kunt spelen. Grote hoeveelheden goud zijn uit het Time Machine Research Center gestolen en de verantwoordelijke bende gebruikt een tijdmachine om te ontsnappen en het goud in verschillende tijdperken te verstoppen. Het Center stuurt een team, de “Runners” genaamd, eropuit om het goud terug te krijgen.
<br><br>
Naast de bekende PUZZLE-stand kent het spel een BATTLE-stand waarbij maximaal 5 spelers het tegen elkaar kunnen opnemen, en een EDIT-stand waarmee je je eigen levels kunt ontwerpen.
<br><br>
De BATTLE-stand kun je op drie manieren spelen: zorg dat je als laatste overblijft in SURVIVAL; steel voorwerpen van vijanden en ontsnap in ESCAPE; als je met zijn vieren speelt, kun je het in 2 teams uitvechten in TAG MATCH.
<br><br>
Om met meerdere personen te spelen, moet je voor elke speler een Wii-afstandsbediening of Nintendo GameCube Controller op het systeem aansluiten.
Om met zijn vijven te spelen, is tenminste één Nintendo GameCube Controller nodig.
<br><br>
