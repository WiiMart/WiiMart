...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マリオやルイージ、ピーチなど、マリオシリーズでおなじみのキャラクターたちが登場するゴルフゲームです。使用できるキャラクターは、マリオやヨッシーなどにこのソフトのオリジナルキャラクターも加えて、総勢１３人。キャラクターごとに球筋や飛距離が異なるため、自分に合ったキャラクターを選んでプレイします。操作方法は非常にシンプルです。ゲージを見ながらタイミングよくボタンを押すだけで、ナイスショットを打つことができます。また、ショット前にクラブの種類や打点など、細かい設定ができるのもこのソフトの特徴です。操作に慣れた人やゴルフ好きの人は、ショット画面の情報をよく見ながら設定をおこない、好成績をめざしてみましょう。スピードゴルフやクラブスロット、リングショットといった一風変わったモードも搭載されており、普通のゴルフとは違った感覚でお楽しみいただけます。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マリオゴルフ<sup>TM</sup>６４</span></div>
</div>
