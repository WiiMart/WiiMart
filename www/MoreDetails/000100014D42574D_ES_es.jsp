...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego para uno o más jugadores amplía las posibilidades de sus dos antecesores, ya que se han añadido algunos movimientos para que los jugadores puedan poner trabas a sus adversarios durante la partida. Como en el Columns original, las joyas caen en la parte inferior y el jugador tiene que girarlas y dirigirlas para que formen grupos de tres o más en líneas verticales, horizontales o diagonales, y así evitar que se acumulen y lleguen a la parte superior de la pantalla.<br><br> Entre las novedades de Columns III se encuentran unas piedras mágicas especiales que pueden elevar las joyas acumuladas del adversario o hacer descender las propias, lo que añade un elemento estratégico adicional a la partida. Este es un título genial para jugar con amigos, ¡así que descárgatelo ya y entra en acción!<br><br>Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
