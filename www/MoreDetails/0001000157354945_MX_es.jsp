...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157354945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“5 in 1 Solitaire” incluye los juegos populares de siempre como “Klondike”, “Spider” y “Free Cell” y también versiones únicas de los solitarios “Golf” y “Gaps”. Cada una de estas versiones tiene un estilo de juego único lo suficientemente fácil para el jugador novato pero a la vez retador para el jugador experimentado de solitarios. Podrás también ver tutorías para cada juego así como seguir tu puntuación y tus estadísticas de juego para ver tus avances. ¡Prueba tu rapidez en alcanzar la victoria!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157354945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157354945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">5 in 1 Solitaire</span></div>
</div>
