...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158494245')", "wiiSelectSound()");
...
<p>
An arcade game with real coin-op flavor! Jack and Walter are two old fishermen in a fantasy world. They have found places where crazy fish leap out of the water all day long. The perfect place for a spot of fishing. It's a shame the other strange creatures aren’t going to make things easy! With this surreal action game, you will experience the excitement of the great arcade classics on your Wii console. Hold on tight to your Wii Remote controller and fish 'em all!
<p>
Features: <br>
- Nine colorful scenarios<br>
- Three game modes: Arcade, Challenge, Fishtris.<br>
- One or two players.
<p>
Arcade<br>
Play a game in Arcade mode to see how long you can last. Catch as many fish as you can within the time limit.
<p>
Challenge<br>
Each challenge sets you a target. Note how many fish of each color you need to catch.
Sometimes, it will tell you which items you need to avoid or set a time limit.
<p>
Fishtris<br>
Even more difficult! Match three or more fish of the same color to make them disappear.</div>
  <div id="image02">
