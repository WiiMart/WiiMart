...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Uncharted Waters: New Horizons is a game set in the Age of Discovery, the golden era of European global exploration during the early 16th century. The player selects one of six characters to play as, each with different backgrounds and different motivations. The player is free to sail the world's oceans as he or she wishes, visiting a variety of exotic ports and making thrilling new discoveries.</div>
  <div id="image02">
