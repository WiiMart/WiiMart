...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">謎の傭兵Ｘとなって最新ロボット「シグナス」を操縦する、サイドビュー視点のアクションシューティングゲームです。ビームガンで狙った敵を破壊しながらラウンド内を進み、ゴール地点にたどり着くとラウンドクリアです。たとえ敵の攻撃を受けても時間が経過すると回復できますが、短時間に連続で攻撃を受けてしまうとゲームオーバーにつながるので要注意です。ダメージを示すＴＥＭＰメーターやタイムに気を配り、ダッシュやホバリング、照準切り換えを駆使して攻略していきます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイネストアワー<sup>&reg;</sup></span></div>
</div>
