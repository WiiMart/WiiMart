...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D4845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Es astuto, atrevido, valiente, es… ¡Un ratón! Mouse House es un juego lógico de acertijos muy accesible y de avance rápido en el cual usted guía un pequeño ratón atrevido durante su búsqueda para recoger queso en cada uno de los 100 acertijos desafiantes. Pero estos no son laberintos sencillos – nuestro adorable héroe tiene que arreglárselas para pasar esquivando a un elenco de creaturas coloridas que incluyen abejas que lanzan aguijones y ratas repugnantes, así como a través de mañosas trampas tal como bandas transportadoras, pisos que se colapsan ¡y más! Es un verdadero juego de “tómalo y juega”, la combinación de sus controles simples y múltiples niveles de desafío hacen de Mouse House ¡el juego perfecto para jugadores de todas las edades!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D4845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mouse House<sup>TM</sup></span></div>
</div>
