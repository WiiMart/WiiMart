...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157484550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The famous Heracles has taken on a challenge like none he has ever faced! Our hero will have to beat his opponents in a race across mythological kingdoms and be the first to reach the top of Mount Olympus.<br><br>

You can play as Heracles and help him return the sacred trophy, or play as one of the other varied mythological characters from Satyr to Poseidon and claim the prize for yourself!<br><br>

Race through 3 racing cups across 10 courses set in 5 mythic landscapes and use awesome fantasy weaponry to defeat your opponents: Zeus’ lightning rods, tridents, fireballs and more!<br><br>

Get your friends together for intense 2 to 4 players split-screen multiplayer action in Championship, Single Race or Battle Mode!</div>
  <div id="image02">
