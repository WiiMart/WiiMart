...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157394945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El Universo se está volviendo oscuro y depende de Konki, Guardián Estelar, para poner las cosas en orden. El Dr. Dark Matter (Materia Oscura) y su banda de errantes ladrones espaciales han robado muchas de las Piedras de Constelación que componen los cielos. Recupera las Piedras y una vez más trae la luz al cielo oscuro. Incorporando un uso único de las capacidades infrarrojas del Wii Remote, simplemente apunta y lleva a Konki a través de 20 peligrosas misiones cronometradas y de colección en una frenética carrera contra el reloj. Explora vastas estaciones espaciales mientras evitas el fuego disparado desde pequeñas torres, las minas y enormes máquinas aplastadoras. Deslízate a través de abarrotados campos de asteroides, gaseosos anillos planetarios y más. Evita los elementos nocivos, recoge preciados objetos y actualizaciones de nave, y salva las Piedras de Constelación antes de que el cielo nocturno se pierda para siempre.</div>
  <div id="image02">
