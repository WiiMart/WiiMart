...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157385745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Crea divertidas tarjetas de Halloween y envíalas! Usa tu imaginación para vestir a tu personaje con diferentes disfraces. Luego, decora la tarjeta eligiendo el fondo y la música. También podrás elegir entre muchas pegatinas. Usa el Wii Remote para navegar por los diferentes menús y añadir las pegatinas. Podrás elegir la posición y el tamaño que quieras. Una vez acabada, escribe una nota y envíasela a tus amigos. Prueba este nuevo y fácil programa. ¡Sigue el sencillo tutorial para aprender a usarlo correctamente!</div>
  <div id="image02">
