...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574A4650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to the world of Gnomz. Gnomz is a new exciting arcade fighter for the WiiWare™ service. Gnomz allows up to four Players to play against each other and/or AI opponents in three different game modes.<br><br>
Game features:<br><br>
