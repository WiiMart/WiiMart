...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Ninja Gaiden II se revela a un nuevo villano, Ashtar. Asume el rol de Ryu Hayabusa y rescata a Irene Lew, una ex-agente de la CIA. Destruye la Espada del Caos, un arma de gran poder forjada a partir del hueso de un demonio. Utiliza técnicas como Fire Wheel o Windmill Throwing Star y ataca mientras te sostienes de las paredes o las escaleras. Utiliza la técnica mas innovadora de todas--la habilidad de crear Shadow Clones, sombras anaranjadas de Ryu que lo seguirán constantemente, repitiendo acciones previas (movimiento o ataque) en un ciclo retardado. Derrota una vez más a criminales, criaturas y jefes con nuevas técnicas de pelea e incluso más armas mientras avanzas a través de múltiples etapas en tu camino para destruir a Asthar, Jaquio y el Reino del Caos.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146435145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146435145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ninja Gaiden<sup>TM</sup> II:</span></div>
</div>
