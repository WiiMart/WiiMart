...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015754484A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大人気プリスクール玩具、『せんせい』がゲームならではの要素も追加されてＷｉｉウェアで登場！<BR><BR>●Wiiでお絵描きができる！簡単に絵が描けるスタンプやＷｉｉリモコンならではの操作のアクションペイントで自由にお絵描き！<BR>ＤＳダウンロードプレイでニンテンドーＤＳを使ってタッチペンで絵を描くこともできる！<BR><BR>●お絵描きした絵が命を持って動きだす！<BR>おえかきをした絵を海と島に送り出すことができます！送り出された絵は、海の中や島の上をまるで命をもったように動き出します。描いた動物や飛行機の絵が動き出すのは子どもたちの夢！絵を描くのが楽しくなっちゃう！！<BR><BR>●描いた絵が動き出す！夢の世界を探検しよう！<BR>Ｗｉｉリモコンとヌンチャクを使って、描いた絵と一緒に海や島を探検できます。Ｗｉｉリモコンとヌンチャクの操作を役割分担する事で、親子で探検する事もできます！<BR><BR>※ＳＤカードへの保存について<BR>本ソフトで描いた絵は、ＳＤカードにコピーを保存する事が出来ます。ただし、ＳＤカードに保存したコピーの絵を本ソフトに読み込む事は出来ません。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015754484A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015754484A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">かく！うごく！つかまえる！せんせいWii</span></div>
</div>
