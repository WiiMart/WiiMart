...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157484650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Join the elite army unit in Heavy Fire: Special Operations, a popular arcade shooter for WiiWare. Play challenging missions in the Middle East from the ground, Humvee or Blackhawk. You will need a quick trigger-finger to finish extremely dangerous levels.<br><br>

Rise through the military ranks and get more and more powerful weapons differing in features and controls. Replay the game to improve your best score that can be submitted to the world ranking. Make combos and smash the environment to get more points.<br><br>

You can take out enemies in a single-player mode or with the additional firepower of your friend in a multi-player! The Wii Zapper accessory is supported, but not required.</div>
  <div id="image02">
