...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rilasciato nel 1996, Art of Fighting 3: The Path of the Warrior è un gioco di combattimento a incontri ambientato a Grasshill Valley, luogo in cui le svariate vicissitudini e le battaglie tra i combattenti sono rivelate al giocatore. A esclusione dei protagonisti Ryo e Robert, questo capitolo presenta un cast di personaggi completamente rinnovato. Inoltre, il nuovo sistema di combo aeree, l’ampliamento del sistema di guardia, la possibilità di infliggere danno agli avversari stesi a terra e la possibilità di terminare l’incontro grazie all’ultimate K.O. rendono questo nuovo titolo un grande passo avanti nella serie. Per di più, la grafica di gioco realizzata tramite la tecnologia del motion capture, in grado di acquisire le performance di attori professionisti, portarono il gioco ad aprire nuove possibilità espressive a tutto il genere dei giochi di combattimento bidimensionali.<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE PATH OF THE WARRIOR</span></div>
</div>
