...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157414C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Take racing games to a whole new level, as the genre-defining Art Style series breaks the speed of light!
<br><br>
In Art Style: light trax, you control a light beam that is competing with other beams racing towards a goal. You move forwards automatically, letting you concentrate on speed, switching positions to get the lead on your opponents, and using their slipstream to overtake. Manoeuvre through courses that shift from 2D to 3D, hit dash panels to get a boost, and dodge obstacles to avoid losing precious seconds. 
<br><br>
There are two main modes to choose from: Campaign (compete in groups of races) and Freeway (travel as far as possible within a set time). Perform well and you can also unlock further modes and features.
<br><br>
With simple controls yet challenging gameplay, and a driving electronic soundtrack, Art Style: light trax is a racing experience that is truly light years ahead.</div>
  <div id="image02">
