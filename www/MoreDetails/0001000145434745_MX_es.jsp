...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Shock Troopers: 2nd Squad es un juego de acción de temática militar publicado originalmente en 1999.<br><br>
Para detener a una gran corporación de chiflados, tendrás que elegir a uno de cuatro mercenarios con el que combatirla a base de disparos, saltos y un surtido de armas de lo más variado.<br><br>
Se ha dejado intacto el sistema de puntuación por alabanzas, pero el equipo de mercenarios ha sido renovado por completo.<br><br>
Esta nueva entrega ofrece una gran cantidad de posibilidades, entre ellas, la posibilidad de controlar toda clase de vehículos o la elección de rutas distintas, gracias a lo cual podrás disfrutar de un juego de lo más ágil y variado.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434745/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SHOCK TROOPERS 2ND SQUAD</span></div>
</div>
