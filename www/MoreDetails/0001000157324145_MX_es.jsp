...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Big Bass Arcade está cargado con mucha acción de pesca! Atrapa cantidades de peces y prueba suerte con el Récord Mundial de Lubina. Pesca con el reel percas, lofolatilos, lucios, mojarras de agallas azules y mojarritas. Compite en Desafíos y Torneos o practica Pesca libre en cualquier lago a tu propio ritmo.
<p>
Big Bass Arcade tiene muchas opciones: 4 lagos llenos de peces, 9 cebos y 5 torneos en múltiples lagos. Los puntajes altos se registran para cada evento, en tu búsqueda por lograr el Récord Mundial de Lubina. Experimenta comportamientos reales de los peces y efectos visuales espectaculares. ¡Devuélvele la diversión a la pesca en consola! Usa el Wii Remote y el Nunchuk como una caña virtual y lanza el reel y controla la acción de lucha del pez. Big Bass Arcade está dirigido por igual a aficionados a la pesca y jugadores, ya que captura toda la adrenalina de la lucha del pez en un juego tipo arcade.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324145/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Big Bass Arcade</span></div>
</div>
