...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157463250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ponte en la piel de la hija del Amo Oscuro e instala trampas y monstruos en la torre para aniquilar las interminables oleadas de aventureros que quieren invadir tu castillo en este RPG.
<br><br>
La única manera de evitar que los aventureros destruyan el cristal oscuro del último piso de la malévola torre es plagándola de monstruos y trampas llamadas “Artefactos”. ¡Mueve tu torre por todas las tierras y conquista cada lugar hasta conseguir dominar el mundo entero!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
