...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界中で人気のヒーロー、ミミズの「ジム」が再び「サイバースーツ」に身を包み、大活躍するドタバタアクションゲームの第二弾。劇場用アニメを見ているかのような、なめらかで多彩な動きも健在です。前作以上に奇想天外で、シュールさに磨きのかかった多数のステージが楽しめます。前作のエンディングでついにお姫様のもとへとたどり着き、告白することができたジムでしたが、宇宙カラスの「サイクロウ」が彼女を連れ去ってしまいます。ジムは仲間とともにサイクロウを追って再び宇宙へ冒険に出ました。おなじみのプラズマショットやヘッドホイップ（ムチ）攻撃はもちろん、ブタを抱えて歩いたり、サンショウウオに変身したり、クイズに挑戦したり、予想もしない難関をクリアして、サイクロウとその仲間たちをやっつけてください。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アースワームジム２</span></div>
</div>
