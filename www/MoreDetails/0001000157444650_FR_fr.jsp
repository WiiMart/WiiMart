...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157444650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prépare-toi à défendre ton château des assauts d'envahisseurs acharnés!
<br><br>
Pour empêcher les envahisseurs de détruire ton beau château, pointe les troupes ennemies avec la télécommande Wii et maintiens enfoncé le bouton A (ou le bouton B) pour les attraper. Une fois les ennemis entre tes mains, tu peux les lancer dans les airs en basculant la télécommande Wii vers le haut et en relâchant le bouton.
<br><br>
Certains ennemis sont trop lourds pour être attrapés. Ils requièrent une autre tactique de combat.
<br><br>
Defend Your Castle prend en charge de 1 à 4 joueurs dans un jeu mi-coopératif, mi-compétitif. Les joueurs peuvent aisément rejoindre ou quitter une partie en cours. Il leur suffit d'activer leur télécommande Wii et de commencer à jouer. Le jeu règlera automatiquement le niveau de difficulté pour s'adapter à chaque nouveau joueur.
<br><br>
Le texte à l'écran sera en anglais.</div>
  <div id="image02">
