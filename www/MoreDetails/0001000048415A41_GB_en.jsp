...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This updated version of the Photo Channel is an optional, free upgrade to the original Photo Channel and includes the following new features and changes:
<br><br>
<b>Customised Photo Channel icon</b>
<br>
...
<br><br>
<b>Different audio file format</b>
<br>
...
<br><br>
- Wii consoles released since December 2007 already include Photo Channel 1.1 and will be unable to revert to Photo Channel 1.0.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000048415A41/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000048415A41/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Photo Channel 1.1</span></div>
</div>
