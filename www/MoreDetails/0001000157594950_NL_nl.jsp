...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157594950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Help Vektor aan de klauwen van de boosaardige CPU en zijn leger patrouilles, jagers en onderscheppers te ontsnappen.
<br><br>
Vektor zit al een eeuwigheid vast in de CPU en jij bent zijn enige hoop om te ontsnappen. Help hem tijdens zijn reis door de CPU om zijn geheugen terug te krijgen en de verschillende vijanden te doden die het op hem hebben voorzien. Maar kijk uit! Hoe verder Vektor komt, des te gevaarlijker de CPU wordt…  
<br><br>
Werk met Vektor samen om aan de boosaardige klauwen van de CPU te ontsnappen. Loods hem door het doolhof van de CPU en probeer patrouilles, jagers en onderscheppers te ontwijken. Je moet snel handelen want de CPU heeft je ontsnapping zo in de smiezen. Vektor zal nieuwe vaardigheden voor je coderen zodat jij het tegen de steeds sterkere CPU kunt opnemen. Maar het lot van Vektor ligt in jouw handen...
<br><br>
