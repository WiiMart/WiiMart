...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードで一世を風靡した人気作「ファイナルファイト」のスーパーファミコンへの移植作。次々と行く手に立ちふさがる敵を倒しながら進んでいくという、シンプルかつ爽快なアクションゲームです。物語の舞台は超犯罪都市「メトロシティ」。そこに巣くう犯罪組織「マッドギア」にさらわれたジェシカを救い出すため、恋人であるコーディーと、メトロシティの市長であり、ジェシカの父親でもあるハガーが立ち上がります。マーシャルアーツの使い手でバランスの取れたコーディー、パワフルなプロレス技を駆使するハガーを操作し、様々なアイテムを駆使してそれぞれのステージの最後に待ち構えるボスを倒せばステージクリアです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファイト<sup>&reg;</sup></span></div>
</div>
