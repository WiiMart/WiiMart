...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157414F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is an activity game based on the children's book The Very Hungry Caterpillar. Young players can learn the alphabet by associating words and pictures with each letter, as well as engaging in drawing and colouring exercises.<br><br>

This game consists of three sections.<br><br>

The Alphabet<br>
Flash cards for first-time readers that you can enjoy on your TV.<br><br>

What is this?<br>
Over 130 words in all!* Easy-to-understand quizzes for your child with art and narration.<br>
* Add-on content required for full set of words.<br><br>

Colour, Colour, Colour<br>
Erase the colour to reveal the hidden illustration!<br><br>

Enjoy learning to read along with the Very Hungry Caterpillar!</div>
  <div id="image02">
