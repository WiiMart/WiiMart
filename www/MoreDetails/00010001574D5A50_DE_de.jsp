...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574D5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mahjong ist einer der beliebtesten Spieleklassiker. 
<br><br>
Schärfen Sie Ihre Sinne mit 30 verschiedenen Mahjong-Puzzles in 3D mit Millionen verschiedener Möglichkeiten. Zusätzliche Herausforderungen kommen in Form von "Memory" und "Paare bilden".
<br><br>
Sie können eine Partie jederzeit speichern und zu einem späteren Zeitpunkt fortsetzen. Die vielen unterschiedlichen Hintergrund-Grafiken und Spielstein-Designs ermöglichen eine Anpassung des Spiels nach Ihren Vorlieben. Die intuitive Steuerung per Wii-Fernbedienung und die Zoom-Funktion machen das Spielen zum Vergnügen.
<br><br>
Lehnen Sie sich zurück und genießen Sie den Spaß und Entspannung mit dieser Mahjong-Sammlung.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
