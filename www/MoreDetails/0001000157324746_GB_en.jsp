...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157324746')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Phoenix Wright is back! <br><br>

The courtroom drama is heating up with ruthless D.A., Franzisca von Karma. New colourful characters, dramatic stories and gameplay – the defence never rests! <br><br>

- Four shocking new cases! <br>
- New “Psyche-Lock” Feature: use questioning to reveal hidden testimony!<br><br>In-game text will be in French.</div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Justice For All (French Version)</span></div>
  </div>
