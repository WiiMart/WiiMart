...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９３年８月６日にスーパーファミコン用ソフトとして発売された本作は、ファミコン用ソフト『熱血高校ドッジボール部』を大幅にリニューアルしたスポーツゲームです。システム面が大幅にパワーアップしており、選手のレベルアップやオリジナルチームの作成、シュートの合成などが可能となっています。キャラクターについても個性的な多数のキャラクターが登場します。好みの「くにお」キャラを選んで、自分だけのオリジナルチームで優勝を目指しましょう。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A45444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A45444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">くにおくんのドッジボールだよ</span></div>
</div>
