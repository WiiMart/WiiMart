...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">強力な装備を身にまとった警察官が、犯罪組織と戦いを繰り広げるアクションゲームです。アーケード版の半世紀後の世界を描いた、メガドライブオリジナルの物語が展開します。プレイヤーは装甲機動警察「ＥＳＷＡＴ」の隊員。ステージを進み、階級を上げることで武装戦闘服を装備し、より強力な敵と戦います。戦闘服「ＩＣＥ」は、プラズマキャノン、ロケットランチャーなど５種類のショットを装備・選択が可能。また、バーナーを使って空中を自在に移動することもできます。監獄や発電所、バイオ研究所など、さまざまな場所に潜む犯罪者たちは罠を張り巡らせ、プレイヤーを待ち受けています。ステージの最深部には強力な武装を装備した巨大なボスが登場、ＥＳＷＡＴとの一騎打ちを繰り広げます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ESWAT<sup>TM</sup>：サイバーポリス イースワット</span></div>
</div>
