...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il mondo di Termina ha le ore contate: la traiettoria della sua luna è stata deviata da una misteriosa entità maligna e tu hai solo tre giorni per evitare la collisione!
<br><br>
In questo epico seguito di The Legend of Zelda: Ocarina of Time, Link disporrà di una serie di maschere magiche per trasformarsi, fra le altre cose, in un Cespuglio Deku, un Goron e uno Zora. Queste trasformazioni ti consentiranno di eseguire azioni speciali, come volare, arrotolarti su te stesso e respirare sott'acqua!
<br><br>
Avrai solo 72 ore a disposizione per salvare Termina, ma sarà possibile viaggiare avanti e indietro nel tempo per svelare il mistero della maschera di Majora. 
<br><br>
Una trama avvolgente, personaggi intriganti, decine di maschere da scoprire, nonché la prima apparizione di Tingle, completano il quadro di questo acclamato capolavoro!
<br><br>Il testo all'interno del gioco può essere visualizzato in inglese, tedesco, francese e spagnolo.</div>
  <div id="image02">
