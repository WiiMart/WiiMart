...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574C4550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Benvenuto nel mondo dei PooYoo, il primo gioco d'intelligenza poetico e divertente dedicato ai bambini da 3 a 6 anni di età.
<br><br>
Insieme ai PooYoo, un'allegra banda di cuccioli, il tuo bambino imparerà divertendosi tutte le abilità necessarie al suo sviluppo: numeri, lettere, lateralizzazione, forme, colori e molto altro. I bambini potranno ballare con i loro nuovi amici e riceveranno numerose ricompense interattive. I livelli di interattività sono due, in modo che il gioco sia accessibile a bambini di ogni età e livello di sviluppo.
<br><br>
Questo gioco è stato pensato per bambini che non padroneggiano ancora la lettura.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4550/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4550/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Episodio 1</span></div>
  </div>
