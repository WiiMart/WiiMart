...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Solomon's Key es un juego de puzles y acción que te pondrá en la piel del brujo Dana a través de intrincados laberintos en busca de un libro mágico llamado Solomon's Key. Este libro supuestamente le permitirá acabar con las demoníacas fuerzas del mal que campan a sus anchas por el mundo. El objetivo fundamental del juego es utilizar los botones para crear y destruir bloques, además de utilizar distintas técnicas para encontrar las llaves que te permitirán atravesar las distintas puertas. Este juego ha sido desarrollado para distintas plataformas, pero la versión arcade se centra fundamentalmente en la acción, convirtiéndolo en un auténtico desafío que dejará satisfecho a todo tipo de público. Por supuesto, también podrás configurar el número de vidas y el nivel de dificultad.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145364E45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145364E45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
