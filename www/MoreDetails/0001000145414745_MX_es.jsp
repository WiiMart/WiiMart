...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Como el primer vídeo juego de la serie King of Fighters, The King of Fighters ’94 reunió a varios personajes populares de otras franquicias reconocidas y los enfrentó a unos con otros. Enfrenta a guerreros de Fatal Fury contra los favoritos de su serie hermana, Art of Fighting. O ve si los actores de las series Ikari Warriors y Psycho Soldier se ajustan mejor a tu estilo de pelea. Además, hay un grupo de nuevos personajes, exclusivo de la serie KOF, que está dispuesto a unirse a la pelea. Pero hay una variación – en vez de la configuración de pelea regular mejor-dos-de-tres, los jugadores eligen a uno de los ocho equipos, cada uno formado por tres integrantes. Para ganar, todos los miembros del otro equipo deben ser eliminados antes de que tus peleadores sean derribados. Utiliza el medidor de poder del juego para causar daño máximo y termina el round con un movimiento final devastador. Es una batalla majestuosa como ninguna otra – un vídeo juego cuya inspiración es vista fácilmente en los vídeo juegos de pelea que le siguieron. ¿Puede tu equipo ser el último que quede en pie?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE KING OF FIGHTERS '94</span></div>
</div>
