...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">迷路の中をゴーストから逃げ回りながら、ちりばめられたクッキーをすべて食べてステージクリアを目指す「パックマン」をアレンジしたアクションゲーム。フィールドやキャラクターすべてが立体で表現され、マップもカラフルにアレンジされているほか、パックマンがジャンプしてゴーストを避けることができるようになったことが大きな特長です。４種類のステージがあり、初代パックマンのステージと同じステージも登場します。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145374B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145374B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パックマニア<sup>&reg;</sup></span></div>
</div>
