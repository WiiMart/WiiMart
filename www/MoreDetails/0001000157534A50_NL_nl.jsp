...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157534A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Het ultieme Zoek de Verschillen spel voor WiiWare met 160 plaatjes, 3 moeilijkheidsgraden en 1.600 verschillen om te vinden! 
 <br><br>
Speel alleen of met vrienden; zoek uit wie het beste is! 
 <br><br>
Verken vreemde en mooie plaatjes in verschillende categorieën: Landschappen, Huisdieren, Speelkwartier en Smakelijk! 
 <br><br>
4 spelmodes beschikbaar: 
 <br><br>
- Arcade:  <br>
  De plaatjes zijn te zien in willekeurige volgorde: zoek in elk ervan de 5 verschillen. <br>
- Time Attack:<br>
   Zoek in elk plaatje één verschil zolang de timer loopt! <br>
- Select scenes: <br>
  Speel met de plaatjes die je zelf kiest en zoek in elk ervan de 5 verschillen.<br>
- Multiplayer: <br>
  Speel tegen je vrienden (tot 4 spelers).<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    </div>
  <div id="image01">
