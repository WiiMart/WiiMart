...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「フォース」を使ったアクションが特徴の人気シューティングゲームの、移植バージョンです。アーケード版と同様の８つのステージに加え、マスターシステム版だけのオリジナル隠しステージも追加されました。異次元空間を舞台に、最新鋭戦闘機「Ｒ－９」が「バイド帝国」と戦います。途中出現するＰＯＷアーマーを破壊することで、本作最大の特徴である装備「フォース」と、対空・対地・反射の３種類の「レーザー」が装備可能となります。必殺の「波動砲」と組み合わせた攻撃で、「ドブケラドプス」「ゴマンダー」や巨大戦艦など個性豊かなバイド帝国の兵器群を撃破してください。ハード性能の限界に挑戦した再現度や、ＦＭ音源にも対応した美しいＢＧＭも魅力です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｒ－ＴＹＰＥ<sup>&reg;</sup></span></div>
</div>
