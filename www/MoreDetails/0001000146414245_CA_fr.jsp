...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Based on the popular arcade game, Donkey Kong Jr. is the sequel to the immensely successful Donkey Kong.  Play as Donkey Kong's son, Junior, and rescue your dad who has been kidnapped and imprisoned in a cage by Mario.  Use your jumping and climbing abilities to clamber up vines and chains, gather vital fruit and keys, and open the cage to free your father.  Make sure you avoid the pesky birds, nasty electric sparks, and creepy chompers!  Four different worlds filled with numerous climbing and jumping puzzles await you in this timeless classic.</div>
  <div id="image02">
