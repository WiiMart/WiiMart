...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157465645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El fútbol regresa a WiiWare!
<p>
Soccer Up es un divertido juego de fútbol donde tendrás un control total de cada acción de tus jugadores. ¡Controla el balón, dribla y dispara dándole efecto al balón para batir al portero rival! Demuestra tu habilidad y realiza pases cortos, largos y disparos a portería. Puedes controlar la altura, efecto y fuerza del disparo. ¡Conviértete en un maestro del fútbol! Cada país participante está representado por su selección nacional. Con el editor integrado podrás crear tu propio equipo, elegir el color de la equipación y lo más importante, jugar con los Mii que tengas creados previamente en el Canal Mii de tu consola Wii.
<p>
Características:<br>
- Free Control Ball, tendrás que dominar el balón ya que su comportamiento es libre.<br>
- After Kick, controla la altura, dirección y efecto de tus pases y disparos.<br>
- Opción Multijugador local de hasta 4 jugadores en modo cooperativo o enfrentamiento.
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157465645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157465645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Soccer Up</span></div>
</div>
