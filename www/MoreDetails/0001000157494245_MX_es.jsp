...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157494245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Cansado de la misma cosa? ¿Sigues esperando algo nuevo en juegos casuales/mixtos? Pues, ¿adivina que? La nueva gran cosa en juegos ha llegado! Bittos+ se trata de rotar, mover, y colocar piezas de juego en un tablero para crear cuadros. Si, escuchaste bien, cuadros! Y mas importante, cuadros dentro de cuadros! La accion cuadratica mas divertida de todos los tiempos! Y todo porque al hacer cuadros, haces Bittos! Entre mas cuadros, mas Bittos! ¿Que podria ser mas divertido? Crear Bittos cuando juegas Bittos+ proporciona horas y horas de entretenimiento para toda la familia, barcadas de retos y valor de rejuego para el jugador mas ávido. Con multiples modos para desbloquear, estilos de juego que se adaptan a tu animo, varios metodos de control reactivo en tiempo verdadero, reconocimientos que coleccionar, tablas de puntajes altos para ti y tu familia. Bittos+ te conmueve, te lleva por experiencias geniales hacia un nuevo mundo para jugar, entregandose a darte una experiencia diferente.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157494245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157494245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">bittos+</span></div>
</div>
