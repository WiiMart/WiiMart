...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157445650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mêlant action et réflexion dans un monde en 3D, Voodoo Dice apporte une nouvelle dimension aux jeux de casse-tête avec des énigmes originales et innovantes qui mettront vos nerfs à rude épreuve.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157445650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157445650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
