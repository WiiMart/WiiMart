...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Metal Slug 3 is the fourth installment in the Metal Slug series, following Metal Slug, Metal Slug 2, and Metal Slug X. Marco and Tarma are back to blast their way through another action-packed adventure, picking up various weapons along the way to make the going easier. The Slugs are also back and more colorful than ever, with Slugmariners, Drill Slugs, and Elephant Slugs joining the original Metal Slugs and Slugnoids. As with previous titles, there are hidden items to be found and POWs to be rescued, while a branching map allows players to take a different route to the end with each play-through.</div>
  <div id="image02">
