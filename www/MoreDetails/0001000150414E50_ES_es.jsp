...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Military Madness es un juego de simulación futurista que sitúa al jugador en medio de una guerra en la superficie lunar.
Las reglas son sencillas, por lo que será más fácil para los jugadores inexpertos disfrutar de este emocionante juego de estrategia bélica. Desde la pantalla del título tendrás acceso a instrucciones detalladas y fáciles de entender.
Military Madness está basado en turnos, permitiéndote desarrollar tu estrategia antes de mover. Además, las unidades que tienes para cada fase ya están decididas por ti, ¡así te podrás concentrar solo en dar ordenes!
¡Utiliza el terreno y rodea a tu enemigo para hacerte con la victoria!
¡Combate a lo largo de 16 fases y desbarata los planes de tu enemigo!
<br><br>
