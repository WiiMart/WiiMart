...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Más de 10 años antes de que llegara Picross DS, hubo un Mario’s Super Picross en Super Nintendo. Este clásico de "crucigramas con dibujo", que hasta ahora no estaba disponible fuera de Japón, incluye cientos de problemas que son todo un desafío para el cerebro, pero también un pasatiempo muy relajante.
<br><br>
Cada problema de Picross se compone de una cuadrícula que, si se cincela bien, te desvela un dibujo. En el modo principal de Mario, si das un paso en falso, pierdes un tiempo valioso. Sin embargo, en los problemas de Wario –que son más difíciles–, ¡los errores no se señalan y el temporizador no cuenta! 
<br><br>
Mario's Super Picross, como Picross DS, también incluye varias melodías de fondo y una función de guardado para que puedas retomar los problemas cuando quieras.
<br><br>Compatible con la exploración entrelazada del cable por componentes de Wii.
<br><br>Textos de pantalla parcialmente en japonés</div>
  <div id="image02">
