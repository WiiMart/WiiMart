...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ロボットを駆る爽快感と熱い演出が今も多くのファンを持つ「重装機兵」シリーズの原点となる、アクションシューティングゲームです。第４次世界大戦からの復興を遂げつつあった地球に正体不明の宇宙戦艦が襲来、宇宙、地上、スペースコロニーを巻き込んだ全面戦争が始まります。アサルトスーツ「レイノス」のパイロットである主人公は、広がる戦火の中で戦いに身を投じます。地上戦、宇宙空間、大気圏突入などさまざまな状況下で行われる戦闘は刻々と変化し、戦局は通信で伝えられます。ステージでは、戦績に応じて支給される武装パーツを自由に選択し、通信による指令にしたがって出撃。ジャンプと様々な武装パーツを使い分け、通信の内容とエネルギーゲージの増減に気をつけながら、ステージごとに異なるミッションを遂行していきましょう。のちにスーパーファミコンで発売された『重装機兵ヴァルケン』に続く時代の世界に起こった、よりスケールの大きな戦争をえがいたスペースオペラの名作です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42564A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42564A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">重装機兵レイノス<sup>TM</sup></span></div>
</div>
