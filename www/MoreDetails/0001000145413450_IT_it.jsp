...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo picchiaduro uscito nel 1995 è il seguito del titolo distribuito l'anno precedente, Samurai Shodown II. Sebbene esso rappresenti il terzo capitolo della serie, la storia si svolge a cavallo tra il primo ed il secondo capitolo.
<br>
Il giocatore potrà scegliere di vestire i panni di un eroico guerriero tra una rosa di dodici samurai che bramano di sconfiggere Zankuro Minazuki. Oltre a disporre di piccole funzionalità innovative rispetto alla versione precedente, come quella di riempire la barra della rabbia premendo dei pulsanti e l'abilità di difendersi a mezz'aria, questo nuovo capitolo consente anche di scegliere due tipi di personalità, "slash" o "bust", per ciascun personaggio. Ciascuna tipologia ha il proprio set di mosse speciali da usare, il che raddoppia, di fatto, il totale delle opzioni di gioco. 
<br><br>Il testo all'interno del gioco può essere visualizzato in inglese, spagnolo, portoghese, giapponese e coreano.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145413450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145413450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SAMURAI SHODOWN Ⅲ</span></div>
</div>
