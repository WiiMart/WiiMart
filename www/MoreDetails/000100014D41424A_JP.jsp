...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">宝石の美しいグラフィックと心洗われるサウンドに誰もが魅了された、癒し系・落ち物パズルゲームです。上から落ちてくる宝石を同じ色にタテ・ヨコ・ナナメに並べて消していきます。シンプルなルールが楽しい「アーケードモード」に加え、２人協力プレイのダブルスが遊べる「オリジナルモード」や決められた宝石を消すスピードを競う「フラッシュコラムス」モードを搭載。一瞬の判断が勝負となる「フラッシュコラムス」の対戦プレイでは白熱のバトルが楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">コラムス<sup>TM</sup></span></div>
</div>
