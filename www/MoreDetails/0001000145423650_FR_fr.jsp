...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Faisant suite à Metal Slug, Metal Slug 2 et Metal Slug X, ce jeu est le quatrième opus de la série Metal Slug. Comme dans les épisodes précédents, Marco, Tarma et le reste de son équipe doivent se battre en utilisant tout un arsenal militaire. Parmi les points forts du jeu, on notera un éventail de véhicules gonflés à bloc. En plus des traditionnels Metal Slug et Slugnoid, découvrez de nouveaux blindés comme le Slug Mariner, le Drill Slug ou encore l'Elephant Slug, qui ajoutent une grosse dose de poudre à l'action explosive !
Si la recherche d'objets cachés et le sauvetage de prisonniers restent fidèles au rendez-vous, une toute nouvelle configuration des niveaux permet de choisir entre différentes routes. Grâce à ces multiples embranchements, il y a de quoi s'amuser encore et encore... et encore !
<br><br>
Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145423650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145423650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">METAL SLUG 3</span></div>
</div>
