...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001575A4850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Zoo è un rilassante gioco di simulazione che ti dà l'opportunità di allevare animali esotici e di scoprire la natura in modo semplice e appassionante, usando solo il telecomando Wii.
<br><br>
Avrai a disposizione 12 tipi di animali (4 dei quali venduti separatamente come contenuti aggiuntivi). Seleziona i tuoi preferiti e allevali finché non diventano adulti.
Nutrirli, coccolarli e tenere puliti gli ambienti in cui vivono è un ottimo sistema per formare un legame duraturo.
<br><br>
La personalità di ciascun animale cambia in base alle cure che riceve. Giorno dopo giorno, i tuoi animali potranno trasformarsi in creaturine viziate o in voraci mangioni. E se nascerà un cucciolo, avrai un'altra bocca da sfamare!
<br><br<
Nel gioco, il tempo passa molto più velocemente che nella realtà. Alcuni tipi di animali sono attivi di giorno, altri di notte, e anche osservarli senza interferire può essere divertente.
<br><br>
Allora, cosa aspetti a creare uno zoo tutto tuo?<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4850/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
