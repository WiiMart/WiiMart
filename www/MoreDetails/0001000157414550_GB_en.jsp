...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157414550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“Around the World” brings the fun to geography!<br>
Whether you're alone and want to improve your knowledge or you want to compete with other friends and family in exciting mini-games, this game is for you!<br>
It is composed of one solo mode to improve your knowledge of this topic and one multiplayer mode to fight with your friends and family.<br><br>
This party game consists of two different modes where the player has a limited amount of time to answer:<br>
- A quiz where the player must choose the correct answer from multiple choice questions.<br>
- "Point to the closest" where the player must correctly locate different places.<br><br>
With fun and entertainment, this game addresses geography as a whole through various topics such as monuments, history, sports, art, literature and people.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414550/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414550/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
