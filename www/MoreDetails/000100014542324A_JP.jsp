...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９７年にリリースされた格闘ゲームで、『餓狼伝説』シリーズの第６弾。前作のシステムをベースにしつつも、より進化した２ラインバトルを導入、パワーゲージシステムの改良、リングアウト制の廃止などを盛り込み、より多彩な駆け引きが楽しめるようになりました。登場キャラクターは前作に登場していた１５人（ギース除く）に、タン・フー・ルー、チン・シンザン、 ローレンス・ブラッド、ヴォルフガング・クラウザーを加えた総勢１９人。まさにスペシャルの名にふさわしいメンバーが、最強の座を目指して腕を競います。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">リアルバウト餓狼伝説</span></div>
</div>
