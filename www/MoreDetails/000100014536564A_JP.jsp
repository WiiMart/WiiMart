...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">クォータービューの立体的な画面とリアルなゲームシステムが特徴的なシューティングゲーム。プレイヤーが操る戦闘機は城壁とバリアで守られた基地へ潜入し、宇宙基地の最深部にいる司令ロボットの破壊をめざします。高低差と奥行きのある立体的な画面の中で、高度に注意しながら敵戦闘機と空中戦をおこないます。自機の燃料は徐々に減っていきますので、地上にあるオイルタンクを破壊して補充してください。ラウンドは前線基地・宇宙空間・バリア網・司令ロボット戦の４つのステージで構成され、すべてのステージをクリアすると、難易度の上がった新たなラウンドに挑戦できます。日本のみならず海外で高い人気を博しました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザクソン<sup>TM</sup></span></div>
</div>
