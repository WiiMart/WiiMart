...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Super Star Soldier is a classic vertical-scrolling shooting game. In addition to the NORMAL GAME, there are 2 min and 5 min Time Attack Modes, and a mode where high-scores can be checked.<br>NORMAL GAME is made up of 8 different stages, and in each stage (except Stage 7), a boss awaits you at the end.
<br><br>
The special attack squad, lead by the Mother Brain, have launched an all out invasion on the Earth. Take your small-scale fighter, the Neo Caesar, with its arsenal of 4 regular weapons and 2 special weapons, and send them back where they belong!</div>
  <div id="image02">
