...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">An update is available that will make it easier for future users to download this channel. If you last updated this channel after September 1st, 2009, you will not see any changes if you update now.  For more details, see support.nintendo.com.
<p>
With the Internet Channel, you can browse the Web with family and friends from the comfort of your living room! Use the Wii Remote to quickly and easily navigate websites, check your Web-based e-mail, or shop online. You can even zoom in and out to make any page easy to read.<p><p>

You can go directly to websites by entering a Web address, or use the search function to find whatever you're looking for on the Internet. Mark websites as favorites for fast and easy browsing.<p><p>

New in the Internet Channel is support for Adobe Flash Lite 3.1, so now you can watch even more videos than before!<br>
*Some Flash content may not be supported.<p><p>

Download the Internet Channel and start surfing today!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414445/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414445/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Internet Channel</span></div>
</div>
