...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『聖剣伝説』シリーズ第二弾。モーションバトルシステムを採用し、コマンドバトルの戦略性をリアルタイムにかつシームレスに、誰でも爽快に体感できるRPGです。シリーズの象徴とも言えるリングコマンドがはじめて搭載され、画面を切り替えることなくさまざまな行動をスムーズにおこなえるようになりました。思いがけないいきさつから「聖剣」を引き抜いてしまった少年ランディは、プリムとポポイの２人の仲間とともに、暴走したマナの力を封印するため世界を巡り歩く冒険の旅に出ます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">聖剣伝説<sup>&reg;</sup>２</span></div>
</div>
