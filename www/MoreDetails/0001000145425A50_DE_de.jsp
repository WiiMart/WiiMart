...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Real Bout Fatal Fury wurde erstmals 1995 veröffentlicht und ist Nummer 5 in der Reihe dieser Kampfspielserie. Basierend auf den Vorgängern hat diese Version einige Neuheiten, so den jetzt unabhängigen Schwing-Knopf, die Einführung eines weiter entwickelten Systems kombinierter Attacken und den Ring-Out Gegner, die allesamt für ein flüssigeres und unterhaltsameres Spielvergnügen sorgen. Real Bout Fatal Fury besitzt 16 spielbare Kämpfer, darunter die Qin-Brüder (die Boss-Charaktere der Vorgängerversion) und die Favoriten aller Nutzer, Billy Cane und Duck King. Kämpfe dich durch den gnadenlosen Wettkampf und erreiche die Spitze!<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
