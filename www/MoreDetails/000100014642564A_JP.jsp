...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">相撲の持つ独特の緊張感を損なわず、キャラクターや技はコミカルにデフォルメされた相撲ゲームの代表作。主人公は前頭十三枚目からスタートし、取り組みを重ね、大相撲の最高位である横綱を目指していきます。シンプルな操作方法ながら、押し・張り手・投げ等の技に加え、特定操作によって繰り出される特殊技を組み合わせることで、実戦さながらの白熱した戦いが楽しめます。日本の国技である相撲を手軽で奥深く楽しめる本作は、相撲ファン、スポーツゲームファンのみならず、多くのプレイヤーを虜にしました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642564A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
