...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dans ce jeu d’action à scrolling vertical, sorti à l’origine en 1991, vous incarnez un super guerrier devant se battre contre des fantômes venus du passé qui tentent de prendre possession du présent. Vous avez la possibilité de changer de personnage en cours de jeu. Si vous libérez un prisonnier durant le combat, vous pouvez l’utiliser. Une stratégie efficace consiste à changer de personnage (chien ninja, samouraï ou ninja), suivant la situation. Ramassez des bonus, tels que des armes ou des orbes vous donnant des attaques magiques. L’aventure se déroule dans le monde réel, mais également dans un monde parallèle, où les niveaux changent à un rythme trépidant sans vous laissez un moment de répit. <br><br>Texte écran en anglais.</div>
  <div id="image02">
