...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157533345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Silver Star Chess cuenta con 2 modos - 1 jugador y 2 jugadores. El modo de 1 jugador permite que juegues una partida de ajedrez contra la computadora. El modo de 2 jugadores permite que juegues contra otra persona. En el modo de 1 jugador, podrás elegir entre 5 oponentes distintos de la computadora, apagar la música de fondo, ajustar efectos de sonido, y mientras te encuentres en la partida, tienes la alternativa de acceder a la ayuda para jugar. Además durante la partida, puedes repetir tu ultimo movimiento, guardar la partida, o simplemente dejar de jugar. Después de que el juego haya terminado, podrás revisar cada movimiento hecho en la partida anterior y, mientras la revisas, tienes la opción de retomar a esta en cualquier momento.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157533345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157533345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Silver Star Chess</span></div>
</div>
