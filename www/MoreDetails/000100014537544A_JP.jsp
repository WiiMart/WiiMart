...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">コミカルアクションゲーム『マッピー』の続編です。ネズミの警官マッピーが、泥棒猫のニャームコ達に盗まれた品物を取り返すべく、ニャームコ屋敷の庭をステージに追いかけっこを繰り広げます。ホッピングに乗って前後左右に移動し、ニャームコやミューキーズといった敵に捕まらないように、だるまや招き猫などのアイテムを集めましょう。時にはその場でホップしたり、加速ボタンをうまく使うことがポイントです。ステージ途中で出現するボックスを開けると飛び出すマジカルアイテムにはさまざまな効果があり、反撃のチャンス。ステージ上のすべてのアイテムを取ると、ラウンドクリアです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ホッピングマッピー<sup>&reg;</sup></span></div>
</div>
