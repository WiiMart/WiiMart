...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157505050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Challenge the family in the slickest Ping Pong game available!

An intuitive and exciting control system will keep the entire family transfixed in nail-biting rounds of Ping Pong.

Master the control system and the special attacks, then pull off some spectacular shots!
<br><br>
Two game modes: Single and Versus for one or two players respectively.

Three exclusive minigames for sharpening your skills.
<br><br>
Choose between four player profiles and take part in the most incredible tournament ever organised.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505050/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
