...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157455150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Serás tan fuerte como para alcanzar los 64 niveles?<br><br>
Tienes 25 objetivos que cumplir, que te permitirán hacer subir tu porcentaje de progresión. El nivel de dificultad del juego se adaptará a tus resultados.<br>
Encontrarás bolas especiales: sus comportamientos te serán explicados durante el juego. Las bolas tienen diferentes propiedades, algunas son más frágiles que otras. Cada nivel posee su tabla de resultado, ¡trata de ser primero!<br><br>
Para jugar, lleva la bola al punto de salida. Una vez se alcanza la salida, el nivel ya está acabado. Para desplazar la bola, debes inclinar el decorado. Para ello utiliza el mando de Wii horizontalmente: inclina el mando de Wii y el decorado se inclinará. También puedes jugar con la Wii Balance Board.<br>
La bola es frágil, ¡no la hagas caer desde demasiada altura! ¡Tampoco toques los obstáculos mortales como los picos o las charcas de ácido!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
