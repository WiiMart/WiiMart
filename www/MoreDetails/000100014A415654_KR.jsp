...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">파워드 슈트로 무장한 여전사 사무스 아란의 활약을 그린 인기 SF 액션 어드벤처 게임입니다. 과거 사무스가 전투를 펼쳤던 제베스 행성을 무대로, 빼앗긴 수수께끼의 생명체 「메트로이드」를 둘러싸고 우주해적과의 목숨을 건 한판 승부가 시작됩니다. 진행 도중 발견되는 다양한 아이템을 장비하면 행동 범위와 공격 수단의 폭이 넓어집니다. 각 지도의 구조와 장치를 파악하고 어떤 장비를 활용하여 뚫고 나갈지는 플레이어의 몫입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A415654/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A415654/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">슈퍼 메트로이드<sup>TM</sup></span></div>
</div>
