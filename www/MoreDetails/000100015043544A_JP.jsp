...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">簡単操作で多彩なプレイが可能な正統派テニスゲームです。用意されている選手は男女あわせて総勢２６名。選手によって異なるプレイスタイルと得意な球種を持っているので、自分の戦術にあった選手を選んでください。試合形式は「シングルス」と「ダブルス」があり、コンピュータ対戦のシングルス１人プレイから、ダブルスの４人同時プレイまでが可能です。「ＷＯＲＬＤ　ＴＯＵＲ」モードでは、オリジナル選手を作成して世界ツアーに参戦し、８カ国で開催される大会を勝ち抜いて、ワールドチャンピオンをめざします。４大大会を制することでテニスプレイヤーの最高の栄誉「グランドスラム」の達成も可能です。距離感やボールを打つタイミングを簡単に覚えることができる機能も用意されており、初めてプレイされる方でも安心して遊んでいただけます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パワーテニス</span></div>
</div>
