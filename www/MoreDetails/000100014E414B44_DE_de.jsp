...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In Pokémon Snap fängst du die Pokémon nicht mit einem Pokéball ein, sondern mit einem Fotoapparat! Als aufstrebender junger Fotograf Todd hilfst du Professor Eich bei seinen Forschungen über Pokémon, indem du sie von deinem speziell angefertigten Fahrzeug (dem ZERO-ONE-Mobil) aus fotografierst.
<br><br>
Reise über die Pokémon-Insel und fotografiere die Pokémon in ihrer natürlichen Umgebung. Viele Pokémon sind jedoch kamerascheu, also wirst du spezielle Items wie Nahrung oder eine Flöte brauchen, um sie anzulocken.
<br><br>
Professor Eich wird deine Fotos nach Kriterien wie der Pose des abgebildeten Pokémon und seiner Größe im Bild bewerten. Also lege los und zeige, was du als Pokémon-Fotograf drauf hast!
<br><br>
Die Virtual Console-Version von Pokémon Snap ist auch mit der Wii-Pinnwand kompatibel - so kannst du nun auch deine Freunde an deinen Lieblingsfotos der Pokémon teilhaben lassen!<br>Keine Unterstützung der Rumble-Funktion des Originals.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414B44/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414B44/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
