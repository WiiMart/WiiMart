...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">軽快なＢＧＭと共に、考古学者「チャレンジャー」を操り、誘拐された「ロスマリー王国」の「マリア王女」を救い出すアクションゲームです。ゲームはストーリー展開に沿った４つのシーンで描かれ、それぞれ操作方法や目的が変わります。導入部は、王女を乗せ逃走する列車に飛び移り、先頭車両を目指す横スクロールアクション。続いては１００画面分もの広大なフィールドを、「キーワード」を求めて探索するトップビューアクションです。フィールド内の洞窟で３つのキーワードを手に入れると、いよいよ「プレシオドランド」のピラミッドに乗り込み「ドン・ワルドラド」との対決となります。手に汗握る数々の冒険を、ナイフひとつで切り抜ける姿は、まさに冒険映画の主人公。難易度調整機能も搭載されており、プレーヤーのテクニックに合わせて冒険を楽しむことができます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">チャレンジャー</span></div>
</div>
