...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574C5450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dark creatures have taken over Jake’s high school and it’s up to you to guide him through each classroom in order to be reunited with his girlfriend Rachael. Existing light sources must be used smartly to create bridges of light for Jake to cross. One false step, and Jake gets pulled into the darkness. Along the way he’ll encounter twisted versions of his school’s faculty, which must be battled in order to advance.
<br><br>
LIT is a horror puzzle game that requires the Wii Remote and Nunchuk attachment. It contains 30 levels, 5 boss battles, replay modes, several unlockables including multiple endings, Dark Mode timed challenges and an unlockable character.</div>
  <div id="image02">
