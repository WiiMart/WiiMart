...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574C4350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The ultimate BINGO game collection! Includes classic BINGO games and an exciting new BINGO PARTY mode.
<br><br>
In BINGO PARTY Deluxe, play with up to 4 players in 75-Ball BINGO, 90-Ball BINGO, or BINGO PARTY game modes. The more you play, the more BINGO points you collect! Keep collecting BINGO points to unlock many fun goodies in the game including new game modes, BINGO card patterns, and more!
<br><br>
All BINGO game modes can also be played with computer players, whose difficulty setting can be easily adjusted to match your skill level!
<br><br>
The new BINGO PARTY game mode created exclusively for this game adds exciting action to BINGO by having players compete to quickly find and stamp BINGO numbers on multiple BINGO cards that eventually complete BINGO patterns that reward big points! Or players can enjoy the classic 75-Ball BINGO and 90-Ball BINGO game modes with the goal of completing winning BINGO patterns on your own BINGO cards.</div>
  <div id="image02">
