...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Riscopri questo rompicapo con elementi di azione pubblicato da Data East nel 1996!
Le regole sono chiare e semplici: il clown dovrà catturare le sfere e lanciarle nuovamente per aria nella fila desiderata. Quando tre o più sfere dello stesso colore sono allineate in verticale, queste scompariranno magicamente.<br>
Non mancano inoltre gli effetti a sorpresa. Ci sono ad esempio le Sfere speciali, una per ogni colore, in grado di far scomparire tutte le sfere dello stesso colore dallo schermo. Le Sfere freccia eliminano tutto quel che si trova lungo il percorso indicato dalla freccia stessa. Le Sfere schiuma sono di ostacolo al giocatore. Infine, le Sfere arcobaleno sono tra le più particolari e si trasformano in Sfere speciali a contatto con qualsiasi colore. Questi elementi a sorpresa e i loro effetti non fanno altro che raddoppiare il divertimento!<br>
Scegli tra la modalità VS CPU per una sfida contro un avversario controllato dalla console e la modalità Puzzle per una partita in solitaria. Infine potrai anche sfidare i tuoi amici in emozionanti partite a due giocatori.<br><br>
