...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157444850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La serie di giochi Art Style, disponibile unicamente su WiiWare, ti offre titoli unici e facili da giocare, caratterizzati da un originalissimo sistema di gioco e impareggiabili per atmosfera, musica e grafica.
<br><br>
Art Style: ROTOHEX è un rompicapo mozzafiato per uno o due giocatori. Fai ruotare i tasselli colorati che cadono su tutta la superficie del campo di gioco per comporre esagoni di un unico colore che scompariranno subito dopo. Maggiore sarà il numero dei colori dei tasselli e più avvincente sarà la sfida.
<br><br>
Se soddisfi alcune condizioni nella modalità Giocatore Singolo potrai sbloccare due nuove modalità: la modalità Infinita che metterà a dura prova la tua resistenza, e la modalità Sprint riservata ai veri esperti. Grazie alla modalità Sfida puoi inoltre cimentarti in un testa a testa con un amico facendo del tuo meglio per restare in gioco!
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444850/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444850/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
