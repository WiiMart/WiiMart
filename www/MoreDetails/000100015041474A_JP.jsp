...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">時間内に爆弾で敵を倒し、出口を見つけるといったシンプルなルールでありながら、ついつい熱くなる対戦プレイが魅力のアクションゲーム。１人プレイのノーマルモードと５人までプレイ可能なバトルモードの２つのモードで遊べます。シリーズ初のお助けキャラ「ルーイ」と９人のボンバーファミリーが登場。破壊したブロックから出現するタマゴに飛び乗れば、ランダムで特徴の違った５種類のルーイのいずれかに乗ることができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ボンバーマン<sup>&reg;</sup>’９４</span></div>
</div>
