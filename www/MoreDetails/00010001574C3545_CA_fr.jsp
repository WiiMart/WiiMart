...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574C3545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">HB Arcade Disc Golf recreates the popular disc-flinging sport in the comfort of your own living room. Playing the game is as easy as tossing a disc around on a beautiful day. The goal of the game is to put the disc in the basket in the fewest amount of throws possible. Disc golfers have three different types of discs at their disposal when out on the course: a driver, a mid-range disc, and a putter. Also, there are three different types of throw available: forehand, backhand, and the hammer throw. The forehand and backhand throws change based on the handedness of the player, and can be used to draw or fade a shot, while the hammer throw is less about distance and more about height. At the end of the round, scores are tallied, and the player with the lowest score is the winner.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C3545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C3545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">HB Arcade Disc Golf</span></div>
</div>
