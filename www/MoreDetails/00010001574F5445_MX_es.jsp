...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F5445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Overturn es un juego de lucha futurista robot contra robot. Elige qué robot pilotar de entre 8 modelos diferentes y gana maestría usando armas de corta y larga distancia para aniquilar a tus enemigos en 6 torneos para un jugador. Desbloquea modos secretos y hasta 12 armas nuevas. Diseña tus robots eligiendo el color y las armas a equipar para tu próxima batalla. Pasa a la acción en línea jugando en Internet en una Batalla VS de 2 jugadores o con 4 jugadores en Battle Royale. Busca amigos u otra gente a lo largo del mundo que estén en línea para disputar una batalla. Puedes usar opcionalmente la Wii Balance Board para controlar tu robot desplazando tu peso a los lados.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F5445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F5445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">OVERTURN</span></div>
</div>
