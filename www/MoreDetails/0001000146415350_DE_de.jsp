...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Steig in deinen Solvalou-Jäger und halte den Ansturm der Xevious-Streitkräfte auf! Schalte Fluggegner mit Zapper-Raketen aus und mache Bodenziele mit Blaster-Bomben dem Erdboden gleich. Zerstöre Andor Genesis, um einen gewaltigen Punktebonus zu verdienen!
Vielfältige Gegner, eine reiche Auswahl vertikal scrollender Hintergründe und nicht zuletzt etliche versteckte Features machten Xevious schon zum Erscheinungszeitpunkt zu einem Ausnahme-Shooter. Die 1989 veröffentlichte NES-Version wurde sofort zu einem Spieleklassiker.<br><br>

Im Zweispielermodus steuern beide Spieler ihre Solvalou-Jäger abwechselnd. Wenn ein Schiff zerstört wird, ist der Mitspieler an der Reihe.<br>
Um im Zweispielermodus zu spielen, werden zwei Controller benötigt.
