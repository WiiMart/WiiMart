...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157435350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pak de Wii-afstandsbediening en geef de tegenstander een 'stoot' onder de gordel in dit virtuele biljartspel! Geniet van 'Matchups' (met klassieke favorieten als 'Snooker', '9 Ball', '8 Ball' en 'Volgorde') en stapsgewijze trickshots in de puzzelmodus. <br><br>
Dit spel biedt twee soorten besturing: je kunt de speelbal direct en virtueel 'stoten' met de Wii-afstandsbediening of 'stoten' door de kracht in te stellen met de knoppen.
Oefen in de oefenmodus en leer alle waanzinnige technieken die je nodig hebt om een echte kampioen te worden. <br><br>
Creëer je eigen uitdaging met de bewerkingsfunctie en maak de trickshot van je dromen. Laat met ongelooflijke stoten zien wie de grootste shark in de pool is!<br><br>Voorzien van Nederlandstalige schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435350/FFFD0017" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435350/FFFD0018" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
