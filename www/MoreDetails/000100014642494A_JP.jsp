...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公（リトルマック）を操作して、チャンピオンを目指すボクシングゲーム。対戦相手の繰り出すパンチをかわし、その隙にパンチを打ち込むことが攻略のカギです。１試合は３ラウンド制。１ラウンドで相手を３回ダウンさせるとＫＯ勝ち、３ラウンドまでに勝負がつかない場合は判定となります。クセのある強敵たちに勝ち続け、最強のボクサー「ミスター・ドリーム」と対決を目指します。<BR><BR>1990年8月に北米で発売され、また2001年12月に発売されたゲームキューブ用ソフト「どうぶつの森＋」のゲーム内で登場するファミコン家具で遊ぶことができたソフトです。（日本未発売）

<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パンチアウト<sup>&reg;</sup></span></div>
</div>
