...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574E4550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Werde zum König der Angler! Die Pinguine haben Hunger und brauchen deine Hilfe. Fange so viele Fische wie möglich, bevor sie dir jemand stiehlt!<br>
In diesem spannenden Spiel ist Strategie enorm wichtig. Bleibe vor den anderen Pinguinen, damit du nicht eingeschlossen wirst, und versuche auf die Eisschollen mit den meisten Fischen zu gelangen. Bei „Penguins & Friends“ können bis zu vier Spieler mitmachen – wenn sie die Kälte aushalten.
<br><br>
Spielprinzip<br>
Das Spielfeld besteht aus Eisblöcken mit einer festgelegten Anzahl an Fischen (1, 2 oder 3) darunter. Die Blöcke sind sechseckig und bilden eine bienenwabenartige Struktur. Die Anfangsposition der Blöcke ist veränderbar und sorgt so für jeweils verschiedene Spielfelder.<br>
Jeder Spieler verfügt über eine bestimmte Anzahl an Pinguinen, die als Markierungen dienen. Die Zahl ist dabei abhängig von der Anzahl der Spieler und der Spielfeldgröße.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E4550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E4550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
