...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157504C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Sobrevivirás a los templos pachinkeet de Planet Pachinko? En un futuro muy lejano, una antigua civilización ocultó sus riquezas en intrincados templos dedicados al juego del Pachinko. Ahora, la familia Robot debe abrirse paso por los peligrosos templos en busca de su cachorrillo perdido. Usando cohetes, láseres, granadas y lanzadores de limo, ¿superarán los desafíos? Pero no se adentran en los templos solos. El pirata Vile Vill y sus secuaces quieres saquear los templos y llevarse también a la familia Robot. Juega en el modo de un jugador o con un amigo.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504C45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504C45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Planet Pachinko</span></div>
</div>
