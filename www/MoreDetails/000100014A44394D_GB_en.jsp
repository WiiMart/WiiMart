...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dive headfirst into the action with your famously hard head in the first instalment of the Bonk series on the SNES. This time, Bonk has been caught in King Drool's trap and hurled into darkness. To find his way back to prehistoric times, he must embark on an adventure through streets, caves and eventually outer space!<br><br>
Progress through the stages controlling Bonk, but watch out for enemies blocking your path. Eat meat to transform Bonk and perform even more powerful attacks! Many challenges lie in Bonk's path. In addition to Bonk's spin and climb moves, you can use items like candy, which changes Bonk's size, to overcome these obstacles!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
