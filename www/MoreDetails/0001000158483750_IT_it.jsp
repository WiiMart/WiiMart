...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158483750')", "wiiSelectSound()");
...
<br><br>
Delle creature oscure hanno invaso il liceo di Jake. Sta a te condurlo in ciascuna delle aule per riunirlo alla sua ragazza, Rachael. Dovrai usare le fonti di luce in maniera intelligente, in modo da creare ponti di luce che Jake potrà attraversare. Un passo falso e Jake verrà trascinato nell’oscurità. Lungo la strada, incontrerà versioni malvagie dei suoi insegnanti, che dovrà combattere per continuare il percorso.
<br><br>
LIT è un puzzle dell'orrore che richiede l'uso del telecomando Wii e del nunchuk. Il gioco contiene 30 livelli, 5 scontri con boss di fine livello, la modalità replay e diversi elementi sbloccabili (con inclusi vari finali alternativi). Troverai inoltre infinite sfide nell'oscurità e un personaggio sbloccabile.
<br><br>
