...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157495445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Un juego de objetos escondidos para todos ha llegado a WiiWare! ¡Da lo mejor de ti e intenta buscar 12 objetos determinados entre una multitud de objetos en pantalla tan rápido como puedas! Desde grandes peces a pequeños pendientes. Objetos fáciles de encontrar y otros muy bien escondidos. ¡Puedes encontrar un montón de objetos y de diversión en este juego de objetos escondidos! ¡Al contrario que la mayoría de juegos de objetos escondidos, podrás jugar con amigos y familiares y competir para saber quién es el mejor buscador de objetos en cada nivel! (Hasta 4 jugadores) ¡Con 10 niveles en total y más de 277 objetos diferentes podrás divertirte mucho buscando! ¡Además, muchos objetos cambian de posición cada vez que juegas con lo que podrás disfrutar de cada nivel una y otra vez! ¡Juega y disfruta con tus amigos!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157495445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157495445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
