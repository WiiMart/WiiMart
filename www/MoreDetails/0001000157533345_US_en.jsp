...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157533345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Silver Star Chess has two modes: 1-Player and 2-Player. 1-Player mode allows you to play a chess match against the computer opponent. 2-Player mode allows you to play against another person. In 1-Player mode, you can select one of five different computer opponents, as well as turn the background music off, adjust sound effects, and access in-game help features. Also, during the match, you can redo your last move, save the game at any point, or resign from the game. After the match has ended, you can review each move made during the match. While reviewing the match like this, you can resume that match at any point.</div>
  <div id="image02">
