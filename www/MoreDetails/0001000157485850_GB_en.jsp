...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157485850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Helix is one of the most innovative and fun music rhythm games ever designed.
<br><br>
...
<br><br>
Enjoy incredible replay value with 26 of the most amazing dance music tracks you've ever heard!  With three difficulty levels there are 78 different levels in the game to play.  Try to unlock all of the songs!<br><br>2 Wii Remotes are strongly recommended when playing this game!</div>
  <div id="image02">
