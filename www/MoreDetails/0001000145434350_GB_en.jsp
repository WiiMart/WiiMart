...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This game is an improved version of Metal Slug 2. While based on Metal Slug 2, it includes the new "Iron Lizard" weapon which chases enemies and the "Drop Shot" weapon whose shots bounce. With many new enemies, the game allows the user to readjust the game's difficulty by changing the positioning of bosses and other things. It also includes several arranged production features such as changed backgrounds and some rearranged BGM. It's a solidly enjoyable gameplay experience and Metal Slug fans might make some new discoveries if they compare it with Metal Slug 2!</div>
  <div id="image02">
