...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Salta sul ring! Vesti i panni di uno dei dodici lottatori in lizza per il titolo di campione, e scatena la tua furia. Potrai scegliere tra Asteroid, noto per la sua enorme mole, Viper, capace di colpi fulminei, Phantom, maestro degli attacchi più subdoli, e ancora molti altri.<br><br> Natsume Championship Wrestling ti offrirà una delle più autentiche esperienze di gioco dell’era dei 16 bit, con un complesso sistema di lotta e oltre 50 mosse da padroneggiare. Metti alla prova la tua abilità gareggiando contro la CPU o sfida i tuoi amici in una delle modalità multigiocatore, tra cui Esibizione e Round Robin!
<br><br>
