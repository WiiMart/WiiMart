...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ponte en la piel de un guerrero solitario, armado hasta los dientes, al que se le encomienda una misión de alto secreto tras las líneas enemigas para liberar a sus compañeros de armas.
<br><br>
En este juego, publicado inicialmente para SEGA MASTER SYSTEM en los EE. UU. con el título de Rambo: First Blood II (en Europa se llamó Secret Command), los jugadores se enfrentarán a los frenéticos ataques de soldados, tropas con misiles, tanques, y otros enemigos que harán todo lo posible para evitar la liberación de los rehenes. Usa tu fiel metralleta y un arco compuesto, equipado con puntas de flecha explosivas, para hacerte con la victoria.
<br><br>
¡No dejes que nada se interponga en tu camino! Si juegas con un amigo en el modo para dos jugadores, doblarás la potencia de fuego.
<br><br>
