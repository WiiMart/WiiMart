...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ツインレバーの組み合わせで２０種類以上の技を繰り出すことができる格闘ゲーム。シナリオの目的は「鍛錬」というシンプルな作りながらも、多彩な技を駆使して相手を倒す、まさに元祖格闘ゲームと言える興奮と爽快感を味わえます。より多くの瓦を割れば高得点を得られるなどのボーナス面も数種類あります。斬新なアイデアを盛り込んだ内容で人気を博しました。<BR><BR>詳細は、<Center>http://www.hamster.co.jp/products/vca.htm</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">空手道</span></div>
</div>
