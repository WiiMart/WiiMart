...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is a fighting game released in 1997, the sixth installment in the Fatal Fury series. It bases its system on previous games in the series and introduced a more evolved 2-line battle scenario, improved the power gauge system and abolished the ring out system among other things allowing for a greater diversity in strategies. In addition to the 15 characters featured in previous games (excluding Geese) they added: Tung Fu Rue, Cheng Sinzan, Laurence Blood and Wolfgang Krauser for a total roster size of 19 characters, all truly suited to the name 'special' - all here to duke it out  to see who will come out on top.</div>
  <div id="image02">
