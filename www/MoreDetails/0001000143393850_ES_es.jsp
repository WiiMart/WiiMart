...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La tripulación androide de una nave de transporte se ha rebelado contra sus amos y ha erradicado a todos los miembros humanos de la tripulación.
<br><br>
Un prototipo de androide, llamado "Influence Device", ha sido introducido en el interior de la nave para ayudarte a retomar el control de la situación. Utiliza el "Influence Device" para destruir a los androides, disparándoles o golpeándolos. 
<br><br>
Podrás controlar temporalmente los circuitos de un androide enemigo para usar su energía y armamento contra otros rebeldes. ¡Elimina a todos los androides que ocupan las 16 cubiertas de la nave!
<br><br>
