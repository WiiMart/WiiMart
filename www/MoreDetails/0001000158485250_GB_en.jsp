...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158485250')", "wiiSelectSound()");
...
<br><br>
The LEGEND starts here; play Furry Legends, the dynamic platform-adventure with the most fur ever seen in games so far!<br>
Start the crazy adventure and solve the fun, physics-based puzzles taking place in Furland, a fantastic 3D world.<br>
Furland is a humorous and weird place, populated by funny creatures you’ve never seen before - like five eyed crabs, round cows, crazy rabbits AND of course the lovely Furballs!<br>
The player controls fluffy characters who each have different special skills, such as the ability to manipulate time, which can influence the physics-driven environment.<br><br>
Save the Furballs from their doom and keep Furland safe from Lord Squarie.<br>
Are you ready for the crazy adventure? Can you save Furland and its lovely Furballs?<br><br>
Try the furriest game of the century and start the story now!</div>
  <div id="image02">
