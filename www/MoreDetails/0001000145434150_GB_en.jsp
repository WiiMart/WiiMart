...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Real Bout Fatal Fury 2: The Newcomers" is the seventh instalment in the Fatal Fury fighting game franchise and was first released in 1998. Based on the same game mechanics as previous instalments, Real Bout Fatal Fury 2: The Newcomers boasts an evolved version of the 2-line battle scenario, as well as many new features such as: "Break Shot" - a guard cancel system that is available for several moves. In addition, when a character continues walking, their sway line accumulates and when a character is knocked down, if the player  times the gauge and button action expertly enough, the character will swiftly get back on their feet. This time around, 2 newcomers have been introduced: Li Xiang Fei the Kung-Fu master and a boxer by the name of Rick Strowd, meanwhile Geese Howard makes a reappearance as a playable character. Choose from 22 fighters and test your might!</div>
  <div id="image02">
