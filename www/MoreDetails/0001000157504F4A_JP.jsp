...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157504F4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ポップルと魔法のクレヨン」は、飛び出す絵本を読み進めていくポップアップアドベンチャーです。くいしんぼうのポップルは、たべものを求めて色々な絵本に飛び込みますが、迷い込んだ絵本はなぜかお話が途中で止まってしまいます。そこで不思議な魔法のクレヨンで絵本をぬってみたり、絵本の中のアイテムをつかんでみたりすると、絵本の中で変化が起こり、お話が展開していきます。うまく操作して絵本の物語を完成させてください。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504F4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504F4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ポップルと魔法のクレヨン</span></div>
</div>
