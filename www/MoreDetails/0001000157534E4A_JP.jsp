...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157534E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おなじみの、史上最速のハリネズミ『ソニック』が、 懐かしくも新しい、横スクロールアクションゲームとしてWiiウェアに登場！ <BR>Wiiだからこそ実現できた美しいグラフィック。 <BR>さらにジェットコースターの様なスピード感と、 アクロバティックなアクションの数々に圧倒されること間違いなし！ <BR>またタイムアタックモードを選択すれば、 クリアタイムをWiFiランキングに登録することも可能。 <BR>世界中のユーザーと腕を競いあう楽しさが体験できます。 <BR><BR>新生ソニックの大冒険、ぜひお楽しみください！</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534E4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534E4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SONIC THE HEDGEHOG 4<sup>TM</sup></span></div>
</div>
