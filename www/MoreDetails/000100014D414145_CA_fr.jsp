...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">When Zeus, the legendary Greek God, brings you back to life, you set forth on a mission to rescue his daughter Athena from the underworld. Along the way, you collect the Spirit Balls dropped by enemies to increase your strength, and to transform into a variety of mythical creatures with powerful attacks.</div>
  <div id="image02">
