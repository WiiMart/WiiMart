...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744324A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スタンダードモード、トリックモードの二つのモードで遊べる、ご存知ナンバーパズルゲームです。ご家庭でお気軽にナンバーパズルに挑戦していただけます。<BR>Wi-Fiランキングにも対応し、全国のパズラーと腕を競うことが出来ます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015744324A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744324A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">@SIMPLEシリーズVol.2</span></div>
</div>
