...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Kirby’s first 3-D adventure is also his Nintendo 64 debut, and it finds the always-versatile hero battling a new enemy called Dark Matter. Dark Matter is after a distant land’s powerful crystal, but a young fairy named Ribbon attempts to save it by escaping with the gem to Dream Land. Now the crystal has been broken, and it’s scattered around the world. Take control of Kirby and help him journey across six worlds, battling a wide variety of enemies and challenging bosses, as he tries to collect all 100 pieces of the shattered crystal. Along the way, you’ll utilize Kirby’s trademark copying ability to use enemies’ strengths against them. Not only that, but try combining any two abilities to create a brand-new one—which is usually stronger than the original! Throw in three exciting multiplayer minigames, and you’ve got a package of which even King Dedede would be proud. Fans of Kirby and action games with bright, colorful graphics should vacuum this one up!</div>
  <div id="image02">
