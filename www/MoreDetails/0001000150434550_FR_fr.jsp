...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Power Golf est la combinaison parfaite entre une jouabilité simple mais précise et des graphismes de haute volée. Testez votre drive dans le mode un joueur Stroke Play ou dans les modes multijoueurs Match Play et Competition. Que vous soyez gentleman golfeur ou néophyte, goûtez aux joies du swing en participant à des tournois prestigieux !
<br><br>
Choisissez l’un des trois personnages disponibles pour jouer au niveau de difficulté novice, intermédiaire ou expert. Maîtrisez l’ensemble des paramètres comme la force du vent ou le relief du terrain. Affrontez d’autres joueurs dans le classique Normal Match ou pariez un de vos clubs dans un mode unique, le Club Match.
<br><br>
Jusqu’à trois joueurs peuvent s’affronter dans l’incontournable mode Competition. Des handicaps sont également disponibles pour que les joueurs débutants puissent exécuter des coups dignes d’un véritable champion ! 
<br><br>Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Power Golf</span></div>
</div>
