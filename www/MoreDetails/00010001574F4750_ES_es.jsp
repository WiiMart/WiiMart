...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F4750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Papá, mamá, Sarah y Billy vuelven para jugar al minigolf!
<br>
¡Juega en múltiples campos de golf con obstáculos como bumpers, rampas, ventiladores y muchos más!
<br>
¡Hasta ocho jugadores pueden jugar usando el mando de Wii! A ver quién de tus amigos es el mejor en cada campo.
<br>
Puedes descargar nuevos campos para seguir divirtiéndote jugando al minigolf. Aumentan las apuestas, con campos de minigolf todavía más complicados de superar.
<br>
¿Puedes vencer en todos los campos y ser el campeón del minigolf?
<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4750/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
