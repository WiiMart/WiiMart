...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年にリリースされた格闘ゲームです。架空の国「時叛宮(ジパング)」を舞台に、１０人の忍者や武芸者たちが腕を競います。本作の特徴といえば、各キャラクターそれぞれが多種多様な武器を持っていることでしょう。しかも素手状態か武器装備状態かによって基本技や必殺技が変化するため、プレイヤーは状況に応じて素手と武器を使い分けなければなりません。さらに超力ゲージによるダメージの増加や、「超力必殺」「真超力」「闇超力」「闇コンボ」等の強力でド派手な技なども必見です。 <BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">NINJA MASTER'S ～覇王忍法帖～</span></div>
</div>
