...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dungeon Explorer is a multiplayer Action/RPG where up to 5 players can play at the same time. The story takes place in underground dungeons.  You can choose from 8 different character types: Fighter, Thief, Warlock, Witch, Bishop, Elf, Bard, or Knome. Depending on the character, the types of magic you can use, your attack strength, and your movement will all vary. To survive, you must know all about your enemies' weaknesses. You must also know about the special attributes of each magic spell and use them to your greatest advantage. In team-play games, working together is the key to victory.<p>When battling with multiple players, you must connect the same number of Wii Remotes or Nintendo GameCube Controllers as the number of players.  To play with 5 players, you will need at least 1 Nintendo GameCube Controller.</div>
  <div id="image02">
