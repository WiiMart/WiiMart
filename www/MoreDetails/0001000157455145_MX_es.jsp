...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157455145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lleva la bola al punto de salida. Una vez que se alcanza la salida, el nivel ya está acabado. Para desplazar la bola, debes inclinar el campo de juego. Utiliza el Wii Remote horizontalmente. Inclina el Wii Remote y el campo de juego se inclinará. También puedes jugar con la Wii Balance Board (vende con Wii Fit). La bola es frágil, no la hagas caer de demasiado alto. No toques tampoco los obstáculos mortales como las espinas o los charcos de ácido. ¿Serás tan fuerte como para alcanzar los 64 niveles? Tienes también 25 objetivos de cumplir. Te permitirán hacer subir tu porcentaje de progresión. El nivel de dificultad del juego se adapta a tus resultados. Encontrarás bolas especiales, sus comportamientos serán explicados durante el juego. Las bolas tienen diferentes propiedades, ciertas son más frágiles que otras. Cada nivel posee su tabla de resultado, trata de ser el primero sobre cada una.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157455145/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
