...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157423750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Viaja por América para hacer tus sueños realidad gracias a un torneo de billar donde podrás ganar millones. 
<br>
Visita los bares más interesantes y conoce a los 7 mejores jugadores del circuito, como una estrella de la música country (Travis), una bióloga (Alison) y un sheriff (John). <br>Aprende todos los trucos mientras juegas gracias a una completa ayuda, y si eres un jugador experto, supera desafíos para demostrar tu habilidad con el taco.<br> Mantén las cosas interesantes con 3 sets de reglas.
<br><br>
Texto en pantallas en español.</div>
  <div id="image02">
