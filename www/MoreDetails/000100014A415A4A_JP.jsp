...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">義賊ゴエモンと忍者エビス丸が、はんにゃ大将軍にさらわれたゆき姫を救出するために奮闘するアクションゲームです。江戸時代を舞台に、ゲームセンターやファーストフードといった現代的な要素を織り交ぜた不思議な世界観で、魚屋から御用役人、からくりロボなど個性豊かな敵が登場します。各ステージのあちこちに配置された隠しアイテムや隠しキャラクターを探したり、多彩なミニゲームが遊べたりするのも魅力。「ゴエモン」シリーズ初のスーパーファミコン用ソフトです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A415A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A415A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">がんばれゴエモン<sup>&reg;</sup></span></div>
</div>
