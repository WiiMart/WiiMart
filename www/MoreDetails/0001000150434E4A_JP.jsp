...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ＰＣエンジンで初めて発売されたゴルフゲームです。風向や風力、ボールのスピンなどに注意しながら、特徴ある１８ホールを攻略します。ショットは、上下に往復するパワーメーターに合わせてボタンを押すだけの簡単操作。基本的に空振りがなく初心者にも安心です。ゲームモードは「ストローク」、「マッチ」に加え、４日間のプレイで賞金王をめざす「トーナメント」の３種類が用意されています。多人数対戦にも対応しているほか、名前やパラメーターを自由に設定したオリジナル選手を作成して参加することもできます。プレイのポイントは、１４本のクラブを使いこなすこと。各クラブの平均飛距離を把握して、スコア・アップをめざしてください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ウィニングショット</span></div>
</div>
