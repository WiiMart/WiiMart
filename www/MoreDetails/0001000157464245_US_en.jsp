...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157464245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Enjoy a fun day at Sandy Beach as you build elaborate sand castles. You can work peacefully on your sand castle or enter into a battle with invading crabs in Crab Battle mode. Players will strategically build their sand castle and defend it with cannons against an army of destructive crabs. After successfully defending your sand castle, discover beach treasures and additional cannons with your metal detector to customize your castle even more.</div>
  <div id="image02">
