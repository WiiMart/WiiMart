...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Manche Leute mögen Katzen, andere lieber Hunde. Der eine isst seine Eier lieber gekocht, der andere mag sie gebraten. Jeder hat seine eigenen Ansichten, und jetzt kannst du herausfinden, was genau die Anderen denken! Die Ergebnisse werden dich überraschen!
<br><br>
Der Meinungskanal bietet dir regelmäßig neue Fragen, die du einfach mit einer von zwei vorgegebenen Möglichkeiten beantworten kannst. Anschließend kannst du dir das Ergebnis ansehen und vergleichen, wie andere Teilnehmer in deinem Land und auf der ganzen Welt die Frage beantwortet haben. Außerdem kannst du eine Vorhersage abgeben, welche Antwort wohl die meisten Stimmen bekommt und so herausfinden, wie gut du Andere einschätzen kannst.
<br><br>
Der Meinungskanal ist kostenlos, also trommel deine Familie zusammen, tauscht eure Meinungen aus und entdeckt, was die Leute wirklich denken!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414A50/FFFD001F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414A50/FFFD0025" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Meinungskanal</span></div>
</div>
