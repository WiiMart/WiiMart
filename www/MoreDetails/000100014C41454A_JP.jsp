...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">セガの人気キャラクター「アレックスキッド」が大活躍する、セガ・マークⅢで発売されたアクションゲームです。岩をも砕く「ブロッ拳」の使い手アレックスキッド（アレク）が、侵略者「じゃんけん大王」に支配された世界を取り戻すために大冒険を繰り広げます。海へ空へ大地へと展開する多彩なステージや、スコパコサイクルやプチコプターなどショップで購入できるさまざまなアイテムを使ったアクションも魅力です。さらに、ステージ最後のボス戦では、じゃんけん大王や子分たちとの、命をかけた「じゃんけん勝負」が待っています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C41454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C41454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アレックスキッドのミラクルワールド<sup>TM</sup></span></div>
</div>
