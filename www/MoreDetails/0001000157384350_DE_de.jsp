...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157384350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das Arcade-Spiel BIT.TRIP CORE setzt die BIT.TRIP-Saga im Retro-Stil fort.
<br><br>
BIT.TRIP CORE ist ein aufregendes Action-/Rhythmus-Spiel, bei dem man sich am besten auf die Musik konzentriert und sich von der visuellen Pracht faszinieren lässt. Das Spiel ist von den Klassikern der 80er-Jahre inspiriert, jedoch mit einem modernen Ansatz. Das Gameplay ist vollkommen neu für die Reihe: Die Steuerung von BIT.TRIP BEAT mit nur einer Achse ist einer verbesserten Zweiachsen-Steuerung gewichen.
<br><br>
Falls das Ganze zu schwierig werden sollte, kann das Abenteuer mit einem Freund auch im Mehrspieler-Modus gespielt werden. Wer es bis zum Ende schafft, kommt dem Ziel, BIT.TRIP abzuschließen, einen Schritt näher.
<br><br>
Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157384350/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157384350/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
