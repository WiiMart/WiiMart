...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157475050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Zenquaria trasforma il tuo televisore in un acquario. Potrai rilassarti osservando le specie che lo popolano, leggere l'enciclopedia per saperne di più su come prendertene cura e persino nuotare nella vasca con un Mii!
<br><br>
Abbellisci i tuoi acquari con circa 40 specie e vari sfondi, piante e oggetti decorativi. Gli acquari cambiano di giorno in giorno: i pesci crescono e se li allevi bene si riproducono. Questi cambiamenti avvengono anche se il tuo Wii è spento.
<br><br>
Puoi visualizzare la vasca da varie angolature e persino osservarla tramite gli occhi di un pesce! Seleziona gli esemplari presenti per leggere delle informazioni sulle specie corrispondenti, come nome scientifico e habitat naturale. Potrai inoltre tuffarti nell'acquario con un Mii per versare del mangime o leggere delle interessanti curiosità sugli acquari e i pesci che li popolano.
<br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157475050/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Zenquaria<sup>TM</sup>: Acquario virtuale</span></div>
</div>
