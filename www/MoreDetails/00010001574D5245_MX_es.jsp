...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D5245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Los chirridos de ruedas, el olor a goma quemada, el subidón de adrenalina y los enemigos que quedan tras el polvo: estas son las emociones que impulsan a los verdaderos conductores de carreras automovilísticas. Sin embargo, hay muchas otras cosas en el mundo de Monochrome Racing, ¡hay pasión por el color! El color lo es todo aquí. Es aquello por lo que luchas en un mundo donde todo está en blanco y negro. El color es tu combustible, te da velocidad, te hace más fuerte y, en definitiva, te convierte en el verdadero líder de un mundo monocromo de carreras.
<p>
- Más de 80 pistas para completar<br>
- Más de 10 vehículos que elegir y a los que realizar mejoras<br>
- Multitud de potenciadores y bonificaciones que harán más fuerte a tu vehículo y más débiles a tus enemigos<br>
- Sumérgete en el misterioso mundo monocromo
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D5245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
