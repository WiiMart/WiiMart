...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157435545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">3-2-1, Rattle Battle! es un party game lleno de minijuegos fascinantes. Con controles intuitivos, cualquiera pueda disfrutar del juego: simplemente agarra el mando de Wii y muévelo rápidamente para “traquetear”. Mucha diversión para un solo jugador, ¡pero la fiesta empieza de verdad cuando juegas con la familia y los amigos! Registra puntuaciones máximas en la clasificación de CWF de Nintendo para ver si estás a la altura de otros jugadores de todo el mundo.<p>

■Minijuegos:<br>
Rattle In Time: ¡Traquetea en el momento preciso!<br>
Rattle Reflex: ¡Pon a prueba tu concentración!<br>
Rattle With Caution: ¡Traquetea para moverte cuando el malo te da la espalda!<br>
Tight Rope Rattle: ¡Traquetea para andar sobre la cuerda floja mientras esquivas las flechas!<br>
Rattle-a-Kiss: ¡Traquetea a la velocidad adecuada y empuja al tímido para que se besuquee!<br>
Rattle Blast: Un duelo intenso con la fuerza de traqueteo adecuada.<br>
*Con 12 minijuegos, ¡tú y tus amigos estáis a punto de tener un momento de traqueteo alucinante!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">3-2-1, Rattle Battle!</span></div>
</div>
