...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pitstop II fue el primer juego de carreras que introdujo el aliciente de enfrentarse directamente a un oponente, con la emoción de la lucha por el liderato en la pista y la tensión que genera repostar y cambiar los neumáticos en el menor tiempo posible. 
<br><br>
Con sus gráficos en tercera persona y la pantalla dividida, el juego permite que dos jugadores experimenten el desafío de una carrera de coches codo con codo.
<br><br>
Te esperan seis de las pistas más difíciles del mundo, desde las curvas cerradísimas de Brands Hatch hasta la recta de una milla en el circuito de Vallelunga. Puedes practicar contra la consola, pero nada es comparable a la diversión de una carrera contra otro jugador. Esta es la historia que se esconde tras Pitstop II. Algo tan simple como que las carreras de coches nunca fueron un deporte para solitarios.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143394D50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143394D50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pitstop II<sup>TM</sup></span></div>
</div>
