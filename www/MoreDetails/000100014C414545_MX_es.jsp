...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En este platformer de los años ochenta, eres Alex Kidd, buscando a su hermano perdido Egle. Para encontrar a tu hermano tendrás que contender con el malvado Gran Janken, que enviará a sus hombres de confianza y monstruos para frustrar tu progreso. Un aspecto de esta aventura es que tendrás que jugar el juego clásico de "piedra, papel, y tijeras" contra los hombres de confianza para derrotarlos. ¡Con 16 niveles diferentes para conquistar para salvar a Egle, este clásico está seguro de probar tus habilidades y tu agudeza al mismo tiempo!
<p>
Ten en cuenta que, Alex Kidd en Miracle World es presentado como fue lanzado originalmente en 1986. Las modificaciones que incluyeron la versión "incorporada" en el Sega Master System no se refleja en esta versión.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Alex Kidd</span></div>
</div>
