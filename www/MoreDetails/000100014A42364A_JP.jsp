...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ひょんなことから家を飛び出したレッドとブルーの兄弟が、７つの不思議な財宝「オーパーツ」をめぐって闇の組織と戦う大冒険ＲＰＧです。バトルシステムはこれまでのＲＰＧにはない「アクションポイント・バトルシステム」を採用。従来のコマンド入力方式と違い、アクションポイントを消費することで、１ターンの間に攻撃や特技、移動など複数の行動ができる、動きと戦術を両立した画期的なシステムです。世界の破滅を阻止するべく、さまざまな古代の謎を解く冒険の旅に出発してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">トレジャーハンターG<sup>&reg;</sup></span></div>
</div>
