...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Revive toda la emoción de las peleas callejeras con este juego clásico de lucha para dos jugadores!
<br><br>
Algo huele a chamusquina en Bayside City. Varios luchadores han sido secuestrados, y corre el rumor de que están siendo utilizados para crear un ejército de clones. Cuando tres miembros de su gimnasio desaparecen, Rick (alias Hack) y Doug (alias Slash) deciden tomar cartas en el asunto, y se lanzan a las calles para resolver este misterio.
<br><br>
Tanto Hack como Slash dominan poderosas técnicas de lucha libre y artes marciales, ¡y cuando pintan bastos no dudan en utilizarlas! Tampoco hacen ascos a usar puñales, bates y otros objetos para demostrar quién manda. Por si eso fuera poco, se enfurecen cuando les golpean... y entonces es mejor no buscarles las cosquillas: ¡los golpes no les afectan, brillan poseídos por la furia y sus técnicas se vuelven más poderosas que nunca!
<br><br>
¡Estos tíos están preparados para poner orden en la ciudad! ¡A qué esperas para echarles una mano!
<br><br>
