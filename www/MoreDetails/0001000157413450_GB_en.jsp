...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157413450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Play wacky microgames with friends and show off your WarioWare creations on the big screen with WarioWare: Do It Yourself - Showcase, the perfect companion to WarioWare: Do It Yourself on Nintendo DS!
<br><br>
