...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This riveting golf game, first released in 1996, puts you in the shoes of one of 6 professional golf players! You can compete on a number of golf courses across the world, travelling to Japan (Fujiyama Oriental Golf Club), America (Grand Canyon Golf Course), Austria (Blue Lagoon Golf Course) and Germany (Baden Golf Course). 
<br><br>
The game features two modes of play. The first is the “Stroke Play” mode, in which you attempt to get a high score by golfing your way through all 18 holes. The second is “Match Play”, in which two players compete club-to-club to see who can triumph by winning the most of the 18 holes.
<br><br>
With colourful courses and intuitive gameplay awaiting you, what are you waiting for? It's tee time!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
