...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">絵本や空想が大好きな女の子「アリス」を操作して、鏡の国を悪の女王から救う、斜め視点のアクションシューテュングゲームです。シャボン玉で敵をはじいたり、倒したりしながらフロアを進みます。攻撃ボタンを押し続けるとシャボン玉はどんどん大きくなり、より強力な攻撃が可能になります。ジャンプして敵の攻撃をよけたり、フロアが切れている場所を飛び越えることもできますが、フロアのないところへジャンプしたり、敵の攻撃にはじき飛ばされてフロアから落ちると、ミスとなります。フロア最後に待ち受けているボスを倒すことで出現する鏡に入るとラウンドクリアです。ハテナマークのついた箱を攻撃すると手に入るさまざまなアイテムをうまく活用してください。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145364C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145364C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メルヘンメイズ<sup>&reg;</sup></span></div>
</div>
