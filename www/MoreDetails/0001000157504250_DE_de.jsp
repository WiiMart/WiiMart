...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157504250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pub Darts ist eine einfache Darts-Simulation, die die einzigartige Wii-Steuerung nutzt, um die Bewegungen eines Dart-Wurfs zu simulieren. Das Spiel findet in einem Pub statt, in dem die Spieler in aller Ruhe ein paar Runden ihrer Lieblings-Dartspiele spielen, darunter 501, Cricket, Around the Clock, Killer, und Baseball.<br><br>Die Steuerung funktioniert wie bei einem echten Dart-Spiel. Jeder Spieler kann sich ein eigenes Profil inklusive Avatar anlegen und sogar das Design der Pfeile bestimmen. <br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
