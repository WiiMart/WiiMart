...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157545450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toki Tori est son nom, récupérer des oeufs est son but!<br><br>

Dans ce jeu énigme / plateforme, le joueur peut utiliser tout un tas d’objets comme le Téléwarp, l’Insta-rocher™ et l'Aspirolimace. Une utilisation subtile et combinée de ces objets est indispensable pour résoudre tout les niveaux du jeu, c'est-à-dire pas moins de 70. Ces niveaux vont de facile à extrêmement difficile, et nécessitent une douzaine d’heures de temps de jeu.<br><br>

Toki Tori tire le meilleur de ce que la Wii peut offrir. Utilisant la télécommande Wii à travers un système de commandes insolite, le jeu offre au joueur un style de jeu nouveau et reposant. Un deuxième joueur peut vous aider, en dessinant des indices pendant que vous jouez. Le jeu utilise aussi le bureau Wii de façon unique !<br><br>

Toki Tori :<br><br>

- est un jeu d’Énigme / Plateforme<br>
- offrant une douzaine d’heures de temps de jeu<br>
- utilisant les diverses télécommandes Wii pour un nouveau style de jeu<br>
- utilisant le bureau Wii<br>
- avec un manuel et un texte en Français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Toki Tori</span></div>
</div>
