...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157505345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Introducing a new kind of Pokémon challenge, available exclusively on the WiiWare service! Pokémon Rumble is an action game in which you control Toy Pokémon (referred to as "Pokémon") and take on wave after wave of other Pokémon in a variety of stages.
<p>
...
<p>
Combining beautiful cel-shaded graphics and exciting game play features with the world of Pokémon, this is one Rumble you won't want to miss!</div>
  <div id="image02">
