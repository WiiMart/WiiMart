...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">クイズ番組の出場者となって優勝をめざす、最大５人の対戦プレイが楽しいクイズゲームです。プレイヤーは個性豊かな出場者の１人となり、番組進行にしたがってクイズに挑戦していきます。出題形式はさまざまで、通常の早押しクイズはもちろんのこと、時間内に間違いなく答えることが重要な「ペーパークイズ」や、回答する早さで得点が変化する「全員参加クイズ」、同一ジャンルを選び続けることで高得点の問題に挑戦できる「ジャンル選択クイズ」など、次々と変化します。番組終了までは全員参加でプレイできるので、パーティープレイに最適です。みごと優勝したプレイヤーは、豪華賞品をかけて「タイムアタッククイズ」に挑戦。さらにクイズを極めた人たちには、新しい出題形式を加えた「特番」放送が待っています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パーティークイズ　ＭＥＧＡ　Ｑ<sup>TM</sup></span></div>
</div>
