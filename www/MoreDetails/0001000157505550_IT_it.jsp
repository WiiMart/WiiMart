...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157505550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“PUZZLE BOBBLE Plus!” è un gioco semplicissimo da cui non riuscirete assolutamente più a staccarvi. Lo scopo del gioco è far scoppiare più bolle possibile con il vostro personale cannone sparabolle. Ogni volta che riuscirete a colpire una serie da 3 bolle dello stesso colore, le farete esplodere! Le modalità disponibili sono due: PUZZLE 1G, con ben 135 livelli in cui lottare per il punteggio più alto o per il miglior tempo, e SFIDA, dove ve la dovrete vedere con i vostri amici o con un personaggio controllato dal computer.<br><br>

E non è tutto. Ci sono altri 270 livelli pronti per voi nelle due serie di contenuti aggiuntivi! 135 nuovi livelli ciascuno. “PUZZLE BOBBLE Plus!” è facile da giocare e così divertente che non riuscirete più a smettere. Quindi, che state aspettando!?<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
