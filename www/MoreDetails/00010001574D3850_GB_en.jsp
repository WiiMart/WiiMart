...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D3850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A brand new addition to the "Bomberman" series is available on WiiWare! Simple controls make this a great game for family and friends to enjoy at anytime!<br><br>

New Items can be used by shaking the Wii Remote. A whole new experience for a Bomberman title! You can even take the intensity up another notch by adding your own Miis to the mix!<br><br>

This title will prove to be a blast for everyone--from those who've never touched a Bomberman game, to the Bomberman masters!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3850/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
