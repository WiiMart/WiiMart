...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">本格的な「連珠」（五目ならべ）が楽しめるファミコン初期に発売されたソフト。歯ごたえのあるコンピュータとの勝負が楽しめるのはもちろん、プレイヤー同士の対戦も可能。コンピュータの思考時間も短く、テンポ良く遊べます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">五目ならべ 連珠</span></div>
</div>
