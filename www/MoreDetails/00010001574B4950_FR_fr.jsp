...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574B4950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Vivez une passionnante aventure au château de Whiterock à la recherche de la princesse disparue. Trouvez tous les objets cachés dans dix décors méticuleusement détaillés tout en faisant connaissance avec les habitants et en découvrant les différentes pièces du château. Vous pouvez parcourir ce monde médiéval fantastique en solo, vous mesurer à d’autres joueurs ou participer à des parties en coopération. Ne tardez plus à explorer l’immense château du roi avec ses donjons lugubres et ses recoins secrets. Chaque aventure est unique, car les objets sont toujours dissimulés dans des endroits différents. La chasse au meilleur score a commencé ! En sortirez-vous vainqueur ?<br><br>Texte écran en français.</div>
  <div id="image02">
