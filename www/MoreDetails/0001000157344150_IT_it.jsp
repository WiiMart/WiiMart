...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157344150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ARCADE SPORTS è una raccolta formata da quattro giochi arcade completi: air hockey, bowling, biliardo e snooker.
<br><br>
AIR HOCKEY<br>
- Regole standard
<br><br>
...
POOL (BILIARDO)<br>
- 9 palle<br>
- 8 palle (regole inglesi e americane)<br>
- 6 palle
<br><br>
SNOOKER (GIOCO A 6 BUCHE)<br>
- Snooker<br>
- 6 palle
...
<br><br>
PRACTICE (ALLENAMENTO)<br>
Questa modalità permette di esercitarsi giocando una partita di prova.
<br>
VERSUS MATCH (SFIDA)<br>
Selezionando questa opzione è possibile disputare una singola partita in qualsiasi modalità di gioco.
<br>
SEASON MODE (MODALITÀ STAGIONE)<br>
La modalità Stagione è composta da una serie di 10 tornei di vario tipo. L'obiettivo è raggiungere il primo posto nella classifica.
<br>
MULTIGIOCATORE<br>
Arcade Sports permette a un massimo di 2 giocatori di gareggiare l'uno contro l'altro in una sfida su una sola console Wii.<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
