...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444F50')", "wiiSelectSound()");
...
<br>
<br>
Frenético juego de carreras con vista superior para entre 1 y 8 jugadores.
<br>
<br>
Elige entre 32 vehículos de 4 categorías (pequeña, mediana, pesada, especial).
<br>
<br>
12 pistas y 3 circuitos que se basan en 4 ambientes (ciudad, colina, nieve, oasis).
<br>
<br>
7 modos, incluyendo los modos tradicionales para un jugador, de carrera en equipo y de campeonato multijugador, y otros modos absurdos como VIP, Meteorito, Patata fría y Contaminación.
<br>
<br>
El juego admite cualquier combinación de mandos de Wii, Nunchuks y mandos clásicos.
<br>
<br>
