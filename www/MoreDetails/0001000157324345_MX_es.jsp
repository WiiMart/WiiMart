...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Al igual que tu cuerpo, tu cerebro necesita ejercitarse para mantenerse en forma. ¡Ahora puedes hacerlo de manera fácil y divertida! Estimula tu cerebro y libera el estrés mediante varios minijuegos en una sesión personal con la que obtendrás tu evaluación detallada. ¡Desafía los cerebros de tus amigos en divertidos juegos multijugador para ver quién es el más listo! Pon a prueba la habilidad de tu cerebro con minijuegos de Memoria, Lógica, Mates, Visual y Atención. Compárate con tus amigos desafiando sus cerebros en 3 modos multijugador. Desarrolla tu capacidad de resistencia a situaciones de estrés que pueden suceder en la vida real. Usa un Mii™ personalizado en tus sesiones personales. Elige tu entrenador personal favorito. Haz un seguimiento de tu progreso general, gracias a las detalladas gráficas y estadísticas. Los modos especiales Test de niños y Test sénior harán que todo el mundo quiera jugar.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Brain Challenge<sup>TM</sup></span></div>
</div>
