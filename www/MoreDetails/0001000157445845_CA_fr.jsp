...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157445845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Diatomic is a fast retro arcade action game set inside a set of petri dishes. The safe confines of your petri dish are about to be invaded by nine different diatomic creatures that seek to destroy you. Armed with your shield, tail, strategic intelligence and good reflexes you stand a good chance to defeat the overwhelming odds. You must stay alive during 65 hectic stages, spread over five chapters. The high score list shows what kind of player you are. Playing defensively and gaining an all-out defensive high score is harder to pull off than gaining an all-out offensive high score.</div>
  <div id="image02">
