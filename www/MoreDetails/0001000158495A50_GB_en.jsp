...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158495A50')", "wiiSelectSound()");
...
<br><br>Classic 8-bit graphics clash with the modern 3D era: welcome to the first 3D Pixel retro-cool racing game in the world! 
Challenge up to three friends in crazy race modes! Enjoy the fast arcade action and unlock new tracks and cars. 
Turn on your headlights and experience the thrill of the night race! Select your favourite car and get ready to burst into the first 3D Pixel championship in the world! 
Game Modes: Single Race, Championship, Capture the flag, Hot pursuit, Time trial <br>
Variable weather conditions: Sun, Fog, Rain, Snow.</div>
  <div id="image02">
