...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">正義感に燃えるフレッシュポリス「マッピー」となって、いたずら好きの「ニャームコ」たちが持っていってしまった品物（ターゲット）を取り返していくアクションゲームです。舞台はニャームコの館。トランポリンで上下してフロアーを移動し、館に散らばったターゲットを全て取り返すとラウンドクリアです。通路でニャームコや手下の「ミューキーズ」に捕まったり、床下や落とし穴に落ちるとミスになります。パワードアやベル、落とし穴などの仕掛けをうまく使って、ピンチを切り抜けましょう。同じターゲットを連続して取ると得点が２倍、３倍、４倍……とアップ。ニャームコが隠れているターゲットを取るとボーナス点が加算されるので、高得点のチャンスです。ドアアタックやドアダッシュなどのテクニックも駆使してハイスコアをめざしてください。ただし、１つのラウンドで長時間もたもたしていると、無敵の「ご先祖様」が出てくるので注意しましょう。キャラクターのかわいい動きや楽しいゲームミュージックで、幅広いユーザーに支持されたタイトルです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
