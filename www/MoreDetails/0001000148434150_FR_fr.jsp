...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Grâce à la chaîne Jam with the Band Live, vous pouvez monter votre groupe en utilisant votre console Wii. Votre téléviseur vous sert alors de haut-parleur!
<br><br>
Téléchargez cette chaîne et sélectionnez "Comment se connecter" pour savoir comment monter votre groupe en multijoueur Wii.
<br><br>
Jouez vos morceaux préférés, tout seul ou avec des amis. Vous pouvez également chanter! (Votre téléviseur ne retransmet cependant pas votre voix.)
<br><br>
Chaque joueur doit avoir une Nintendo DS. Cependant, une seule carte DS Jam with the Band est requise. Les joueurs n'ayant pas de carte DS peuvent se joindre au groupe grâce au téléchargement DS.
<br><br>
Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434150/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434150/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chaîne Jam with the Band<sup>TM</sup> Live</span></div>
</div>
