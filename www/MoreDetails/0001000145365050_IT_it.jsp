...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Originariamente pubblicato nelle sale giochi di tutta Europa col nome di "Shadow Warriors", questo impegnativo picchiaduro a scorrimento è ormai diventato un gioco di culto.
<br><br>
Diventa un maestro delle Cinque Arti di Combattimento Ninja tramandate dai tempi del Giappone feudale ed entra nella "Giungla", una terribile città americana, per sconfiggere orde di nemici appartenenti a un'organizzazione criminale. Il gioco trae spunto da tutte le leggende che circolano in occidente nei confronti dei ninja e del Giappone, creando un mix entusiasmante di cultura ninja e cultura americana. 
<br><br>
Usa tre pulsanti per compiere delle mosse mozzafiato come lo Scaraventa collo, il Calcio in sospensione e la Tripla combo. In questa versione il numero di vite del giocatore e il livello di difficoltà possono essere modificati.
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145365050/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145365050/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
