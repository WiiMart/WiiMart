...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">城の君主や兵士に命令を出し、より多くの土地に勢力を広げて他国との戦いに勝つことが目的のリアルタイムシミュレーションゲーム。本作では、モナーク王国のアル王子をはじめ、ルビア姫ほかゆかいな仲間たちが織りなす物語を楽しみつつ、奥深いルールを理解していくことができる「ストーリー」モードが追加されました。また「記録挑戦」モードでは、パソコンで発売された「ロードモナーク」「アドバンスドロードモナーク」のステージをまとめて収録。人気のシリーズを大宮ソフトが独自の味付けでアレンジした、とことん遊べる一本です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロードモナーク<sup>TM</sup>　とことん戦闘伝説</span></div>
</div>
