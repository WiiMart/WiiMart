...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cette suite directe de The Legend of Zelda™ est connue pour le changement de direction qu'elle a fait prendre à la série tout en introduisant des éléments qui allaient devenir de futurs standards de l'univers Zelda. Dans Zelda II™: The Adventure of Link™, Link part à la recherche de la Triforce du Courage afin de réveiller la Princesse Zelda, plongée dans un profond sommeil par un magicien diabolique. Pendant ce temps, les sbires de Ganon tentent de ressusciter leur maître...<br>
Zelda II abandonne la vue de dessus classique au profit d'une vue de côté à défilement horizontal et d'une carte du monde, tout en introduisant des éléments de jeu de rôle uniques à la série. Les fans de la première heure trouveront également dans Zelda II de nombreux noms de lieux et de personnages qui leur sembleront familiers.
<br><br>Le texte à l'écran sera en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Zelda II<sup>TM</sup>: The Adventure of Link<sup>TM</sup></span></div>
</div>
