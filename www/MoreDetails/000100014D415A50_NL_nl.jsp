...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aan het einde van het eerste spel zijn een aantal aardbewoners in ToeJam en Earls ruimteschip meegelift en nu maken zij Funkotron onveilig. ToeJam en Earl moeten de aardbewoners opsporen, in grote flessen opsluiten en in raketschepen naar de aarde terugsturen.
<br><br>
Bovendien word je op een gekke missie gestuurd om tien geliefde voorwerpen van Funkapotamus, de bron van alle ’funk’ in het heelal, terug te vinden en hem zo over te halen naar de planeet Funkotron terug te keren. Gebruik al je funky krachten, zoals Funk Move en Funk Scan, om de aardbewoners te ontwijken en uiteindelijk te vangen.
...
<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D415A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D415A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ToeJam &amp; Earl in Panic on Funkotron<sup>TM</sup></span></div>
</div>
