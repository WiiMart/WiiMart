...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157445050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Grazie alla Dr. Mario Demo, puoi farti un'idea di quanto sia divertente giocare online con Dr. Mario per WiiWare.
<br><br>
Questa demo ti permette di collegarti a un amico che ha la versione integrale del gioco (Dr. Mario & Sterminavirus) per sfidarvi attraverso la Nintendo Wi-Fi Connection.
<br><br>
Ricorda che questa demo per il gioco online non consente di usare nessuna modalità quando non si è collegati, né per un solo giocatore, né per più giocatori e non include la modalità Sterminavirus.
<br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157445050/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157445050/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
