...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157324746')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Phoenix Wright est de retour ! <br><br>

Cette fois-ci, le prince des tribunaux va devoir en découdre avec l'impitoyable procureur Franziska von Karma ! De nouveaux personnages hauts en couleur, des scénarios incroyables et de nombreux éléments de jeu inédits : vous n'aurez pas le temps de souffler !<br> <br>

- Quatre nouvelles affaires complètement folles ! <br>
- Une toute nouvelle caractéristique "Verrou-psyché" : posez les bonnes questions pour pousser les témoins à dire la vérité, toute la vérité, rien que la vérité !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324746/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324746/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Justice For All (Version française)</span></div>
  </div>
