...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lanzado por SNK en 1991, King of the Monsters es un juego de lucha entre monstruos. El jugador elige uno de los seis monstruos y lo deja viajar por Japón para librar combates con el objetivo de ser el vencedor. Además de los puñetazos, patadas y otros movimientos normales, cada monstruo cuenta con maniobras devastadoras, tales como lanzar fuego y rayos con los que derrotar a sus oponentes.<br><br>
La última entrega cuenta con elementos propios de la lucha libre profesional. Para alzarte con la victoria, deberás agotar a tu oponente y bloquearlo en el suelo durante tres segundos. Si es tu oponente quien te bloquea en el suelo, tendrás que pulsar repetidamente un botón para zafarte de él.<br><br>
Además de jugar individualmente contra la consola, la última entrega permite también organizar combates en equipo, uno contra uno o dos jugadores en relevo contra la consola.
<br><br>
