...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157573250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Continue the search for Wally, his friends and more in Where's Wally? Fantastic Journey 2! <br>Based on the hit publishing series, Where's Wally? The Fantastic Journey 2 is ultimate SEARCH & FIND fun inside the magical worlds of The Nasty Nasties, The Fighting Foresters, The Deep-Sea Divers and more!. Challenge friends or play solo as you search for hidden items, and be ready for surprises and sabotage to fuel the fun!</div>
  <div id="image02">
