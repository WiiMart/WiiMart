...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Disfruta con toda tu familia y amigos superando las pruebas más divertidas! Family & Friends Party es un juego interactivo de tablero para todos los públicos en el que pueden participar de 1 a 8 jugadores. El objetivo del
juego es completar todas las
pruebas que Family & Friends
Party te asignará.<br>¡El primero en superarlas será el ganador de Family & Friends Party!
<br><br>
¿Cómo se juega?<br>
Se juega por turnos. En cada turno el equipo seleccionado deberá superar una prueba concreta. La prueba será jugada por uno o dos jugadores del equipo, en función del tipo de prueba. No obstante, el resto de jugadores del equipo podrán ayudar y dar apoyo, ¡toda ayuda es poca!<br>
Hay 6 pruebas distintas de tipo “Single” en el juego. Las pruebas “Single” las deberán jugar los miembros de un mismo equipo de manera cooperativa.  Además, de vez en cuando se nos propondrá jugar pruebas de tipo “Versus”, las cuales deberán jugar todos los equipos a la vez de manera competitiva.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464D50/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464D50/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
