...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157504250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pub Darts es un sencillo juego de simulación de dardos que usa los controles únicos de Wii imitando los movimientos de lanzamiento de dardos. El juego está ambientado en un pub en el que los jugadores se reúnen para disfrutar de sus juegos de dardos favoritos, 501, Cricket y otros más.<br><br> Antes de comenzar con uno de los 5 juegos, deberás crear un perfil. Esto te permite crear un personaje a tu medida y seleccionar el diseño de la pluma para las partidas. Se puede guardar el perfil y así utilizarlo de nuevo cuando vuelves a jugar.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
