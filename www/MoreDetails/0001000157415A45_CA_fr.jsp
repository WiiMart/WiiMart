...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157415A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">All aboard! Power up your intellect and embark on an epic quest aboard The Amazing Brain Train! Fueled by your mental energy, Professor Fizzwizzle's Brain Train will take you on a brain-boosting adventure! Put your mighty mind to the test and see how far you can go!<br>
• 15 different brain games in 5 categories:<br>
*Search - Find the solution, and your hidden talent!<br> 
*Planning - Think ahead, to victory!<br>
*Spatial - You'll be a master of mental manipulation!<br>
*Memory - Make the most of your powerful memory!<br>
*Numbers - Become a numerical ninja!<br>
• Three different ways to play<br>
• Tons of extra features<br></div>
  <div id="image02">
