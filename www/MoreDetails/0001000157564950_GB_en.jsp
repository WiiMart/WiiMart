...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157564950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Violin Paradise is a game for players who love music and dream of becoming a violinist! This game is designed for all the family- up to four people can play at the same time. Choose to play as a conductor, violinist, violist or cellist, who perform lively or soft classical music together.<br><br>
The game includes a micro orchestra which brings players the enjoyment of performance and the delight of accomplishment.<br><br>
The game can either be played alone, or with up to three other players as an ensemble.This enhances replayability of the game.<br>
Experience amazing graphical effects, which change as your performance improves.<br>
Simple but sophisticated controls ensure that the game is impossible to put down,
and with more than fifty pieces of music to choose from, a fun time playing is guaranteed!</div>
  <div id="image02">
