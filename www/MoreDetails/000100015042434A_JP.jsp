...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">美少女ゲームの先駆けとしてゲームファンに旋風を巻き起こしたアーケードゲームからの移植作。全１２ステージの横スクロールタイプのアクションゲームです。プレイヤーは「ナムコシアター」で上演されている舞台「ワンダーモモ」の主人公を演じます。ロリコット星からやってきた正義のヒロイン「モモ」が、怪人軍団「ワルデモン」を相手に戦うという舞台設定で、ジャンプやキックを駆使して襲いかかる敵を倒していきます。敵を倒していくことで、少しずつ「ワンダーパワー」が増え「ワンダーモモ」に変身できるようになり、変身中は攻撃力、防御力、ジャンプ力がぐんとアップし、「ワンダーリング」での攻撃も可能になります。特定のステージをクリアすると「モモのピンナップ」が表示されるなど、ＰＣエンジン版ならではの演出も見逃せません。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワンダーモモ<sup>TM</sup></span></div>
</div>
