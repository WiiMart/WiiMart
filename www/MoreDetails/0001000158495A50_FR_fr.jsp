...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158495A50')", "wiiSelectSound()");
...
<br><br>Avec 3D Pixel Racing, revivez les courses de voiture comme dans les plus grands classiques du jeu vidéo.<br>
Vous avez le choix entre plusieurs modes de jeu, de la simple Course solo aux palpitantes Courses poursuites.<br>
10 circuits, 11 voitures et 10 pilotes vous attendent! Relevez tous les défis pour déverrouiller l'intégralité des contenus cachés.<br>
Grâce à l'écran partagé du mode multijoueur, jusqu'à 4 participants peuvent disputer une course simultanément!<br>
Modes de jeu: Course solo, Championnat, Capture du drapeau, Course poursuite, Contre-la-montre.
