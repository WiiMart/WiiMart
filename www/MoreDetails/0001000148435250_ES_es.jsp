...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este canal está destinado a los jugadores de The Legend of Zelda: Skyward Sword.
<br><br>
El canal se ha creado para solucionar una incidencia con los datos de guardado que impide continuar la partida. Durante la misión del Cantar del Héroe, si se obtiene en primer lugar la estrofa del dragón del trueno en el desierto, ya no se producen los eventos necesarios para conseguir las estrofas del volcán y del bosque. Si no posees The Legend of Zelda: Skyward Sword, no es necesario que uses este canal.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435250/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
