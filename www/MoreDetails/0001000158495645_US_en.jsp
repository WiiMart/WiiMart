...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158495645')", "wiiSelectSound()");
...
<p>
Think you can be the next big music star? Well now you’ve got all the tools right at your fingertips with Mix Superstar. Create, mix and record your own royalty-free musical masterpieces right on your Wii Console. There are over 1,000 Dance, Hip Hop and Techno loops included across multiple instruments like Drum, Bass, Synth, Guitar and even voice tracks. 
<p>
