...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C4745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">HB Arcade Cards es una a colección de juegos de naipes divertidos y fáciles de jugar. La colección incluye: rummy, corazones, euchre, canasta, cribbage y el clásico solitario. Cada juego va acompañado de un tutorial donde se explican las reglas y cómo jugar. Puedes unirte a un jugador virtual para jugar al euchre o al cribbage. Juega con tu Mii o con uno de nuestros cuatro personajes originales. HB Arcade Cards es un título moderno y con estilo del que no te aburrirás. ¡No hay dos partidas iguales!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">HB Arcade Cards</span></div>
</div>
