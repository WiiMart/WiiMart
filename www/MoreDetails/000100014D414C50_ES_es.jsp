...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mike y Spike Bonanza disfrutan de su programa de televisión favorito y, de repente, el televisor hace un ruido y una figura de un extraño aparece en pantalla. Este personaje les pide que recojan determinados objetos que ha colocado dentro de varios edificios con el fin de comprobar su seguridad. Si regresan con todas las cosas, serán recompensados. Ellos aseguran que su trabajo estará hecho en solo 3 minutos. Sin embargo, ellos no saben que cada edificio es custodiado por guardias de seguridad, los cuales darán la alarma si son sorprendidos con las manos en la masa. Además, la recompensa por atrapar a Mike y Spike es sustanciosa. Por suerte, Mike y Spike están equipados con balas que mantienen inconscientes a los guardias durante unos segundos. Ayuda a los infames hermanos Bonanza a infiltrarse en diferentes lugares, pasando por bancos, mansiones y casinos, ¡y no permitas que les atrapen!<br><br>Textos de pantalla en inglés.<br>Incompatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
