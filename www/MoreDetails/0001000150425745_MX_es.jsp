...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Air "Zonk" es una secuela de las series populares de "Bonk's Aventures". Este juego de tirador de acción horizontal conserva el mismo estilo de caricatura de Bonk, pero toma lugar en el futuro cibernético tipo punk.  El energético Zonk junta a todos sus amigos para formar al "Team Cool" (Equipo Cool),  y precisan para parar el plan del "King Drool" (Rey Drool) de conquistar el mundo. Elije 3 niveles de dificultad y de 3 tipos de Modos de Amigos.  Dispárale a los robots cibernéticos del King Drool y esquiva sus ataques mientras que recolectas los "Air Bones" ("Huesos del Aire") para desatar una variedad de ataques.  Disfruta los movimientos únicos como el de unirse con un amigo para crear una forma hibrida  invencible o destruir al enemigo con un ataque cargado. Air "Zonk” esta lleno de humor, al igual que su chiflado tema musical que se toca una vez que obtengas una gran puntuación o cuando el juego termine.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150425745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150425745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
