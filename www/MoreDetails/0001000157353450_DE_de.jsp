...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157353450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Hab Spaß mit der ganzen Familie und spiel mit ihnen in den verschiedenen Spielmodi.<br>
5 Spots Party ist ein jugendfreies Geschicklichkeitsspiel, das auf dem bekannten Spiel basiert, bei dem 5 Unterschiede gesucht werden müssen. 
<br><br>
Das Ziel besteht darin, in den drei Spielmodi die höchstmögliche Anzahl an Unterschieden in den Bildern, die gezeigt werden, zu finden. Im Party-Modus wetteiferst du mit anderen Spielern und musst möglichst viele Fehler entdecken. Im 1-Spieler-Modus gilt es, Spielrekorde zu schlagen, d.h. die Unterschiede herauszufinden, bevor die Zeit abläuft. 
<br><br>
Was denkst du, wie weit du kommen wirst?
<br><br>
