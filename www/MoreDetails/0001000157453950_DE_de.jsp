...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157453950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Alien Crush Returns ist die Auferstehung des erfolgreichen Turbografx Pinball-Klassikers, Alien Crush. Mit neuen Spiel- und Kontrollfunktionen ist dies eine Wii-Erfahrung die du nicht missen möchtest! <br><br>Mit der
kugelsicheren Einfachheit und
dem actionreichen Nervenkitzel
eines Standard-Flippers besitzt
Alien Crush alle Elemente, die
du in einem Videospiel
erwartest, inklusive grotesker,
atemberaubender Spielfelder und
einzigartiger Action-Ball-Tricks,
die den Spaß und die Aufregung
des Flippers neu definieren.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157453950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157453950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
