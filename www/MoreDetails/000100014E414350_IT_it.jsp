...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pubblicato in tutto il mondo nell'inverno del 1998, The Legend of Zelda: Ocarina of Time fu un successo istantaneo e venne considerato da subito uno dei più grandi giochi della storia.
<br><br>
Nei panni di Link, l'eroe leggendario, dovrete viaggiare per tutta Hyrule, e persino attraverso il tempo, per ostacolare i piani di Ganondorf. Utilizzerete armi e strumenti assortiti, vi scontrerete contro boss enormi e risolverete enigmi complicatissimi che sono tra i migliori mai apparsi in un gioco della serie di Zelda.
<br><br>
Ocarina of Time trasferì magnificamente il classico stile 2D con inquadratura dall'alto di Zelda in un mondo completamente tridimensionale, ed è ancora oggi uno dei massimi esempi di game design.
<br><br>
Ma il fascino di Ocarina non è solo nella sua impostazione cinematografica e nel suo innovativo sistema di combattimento, ha anche una trama epica, personaggi indimenticabili, labirinti progettati minuziosamente e una giocabilità ai massimi livelli. È semplicemente un capolavoro!
<br><br>Il testo all'interno del gioco può essere visualizzato in inglese, tedesco e francese.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414350/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414350/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Legend of Zelda<sup>TM</sup>: Ocarina of Time<sup>TM</sup></span></div>
</div>
