...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574D5250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les crissements de pneus, l’odeur du caoutchouc brûlé, les montées d’adrénaline, les adversaires laissés derrière dans un nuage de poussière... telles sont les émotions qui font vibrer les vrais pilotes de course. Mais dans le monde de Monochrome Racing, tu découvriras quelque chose de nouveau : la passion de la couleur ! Dans ce monde en noir et blanc, seule la couleur compte. Désormais, la couleur sera ta seule obsession. La couleur est ton essence, elle te permet d’accélérer, elle te rend plus fort et, au final, c’est par la couleur que tu dirigeras le monde de Monochrome Racing.<br><br>
- Explore plus de 80 circuits<br>
- Plus de 10 modèles différents à améliorer <br>
- Utilise les nombreux bonus et améliorations pour renforcer ton véhicule et affaiblir ceux de tes adversaires<br>
 - Plonge dans ce monde monochrome mystérieux !

<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D5250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Monochrome Racing</span></div>
</div>
