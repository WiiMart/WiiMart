...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ファイナルファンタジー」シリーズ第六弾。スーパーファミコンの性能をフルに活用したシリーズの集大成。「魔導の力」を持つ少女ティナをはじめとした、総勢１４名のパーティーメンバーが登場。戦いを通して描かれるキャラクターたちの物語、魔導アーマーに代表されるSF的な世界観に思わず引き込まれるでしょう。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファンタジー<sup>&reg;</sup>Ⅵ</span></div>
</div>
