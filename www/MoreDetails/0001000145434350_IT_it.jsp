...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo titolo è una versione migliorata di Metal Slug 2. Mantenendo inalterato l’impianto di gioco di Metal Slug 2, aggiunge la nuova “Iron Lizard”, arma a inseguimento o la “Drop Shot” che invece spara colpi rimbalzanti, oltre a svariate e inedite tipologie di avversari e una difficoltà di gioco completamente rivisitata, effettuata attraverso il cambio di posizione dei boss e di molti altri dettagli. Include inoltre altre numerose caratteristiche rinnovate appositamente per l’occasione, quali nuovi sfondi e arrangiamenti delle musiche di sottofondo. Un’esperienza di gioco solida e divertente, dove i fan della serie possono scoprire, giocando, le sorprendenti differenze con l’originale Metal Slug 2.
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">METAL SLUG X</span></div>
</div>
