...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157545050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tetris Party es un juego de
puzle muy adictivo que parece
fácil a simple vista y que seguro
os mantendrá entretenidos
a ti, a toda tu familia y a tus
amigos durante horas. Este
juego para WiiWare tiene 
variaciones de Tetris nunca
antes vistas para los modos
un jugador y multijugador, incluyendo Escalador, Corredor de etapas, Sombra y modos para la Wii Balance Board. Además,
varios de los modos dan la
oportunidad a los jugadores de
sacar provecho de la capacidad
única del mando de Wii para
apuntar y disparar.<br><br>Textos de pantalla en español.<br>Compatible con Wii Balance Board.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545050/FFFD000D" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545050/FFFD000E" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
