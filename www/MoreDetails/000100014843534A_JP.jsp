...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">この本体に保存されているセーブデータ、Wiiウェア、Wiiバーチャルコンソールソフト等のダウンロードソフト、登録済みのWiiポイント等をWii U本体にまとめて引っ越し（移動）をします。<BR><BR>
引っ越しをするためには、引っ越し先となるWii U本体セットと空き容量が512MB以上のSD/SDHCメモリーカード1枚が必要です。<BR>
※引っ越しをしたデータは、この本体から消去されます。<BR>
※一度引っ越しをしたデータをこの本体に戻すことはできません。<BR>
※一部引っ越しができないソフトがあります。引っ越しができないソフトは、この本体でのみご利用いただけます。 <BR>
※WiiポイントはWiiショッピングチャンネルでのみご利用いただけます。<BR><BR>
あらかじめ引っ越し先となるWii U本体のWiiメニューで【Wiiからの引っ越し】をはじめて、準備をする必要があります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii Uへの引っ越し</span></div>
</div>
