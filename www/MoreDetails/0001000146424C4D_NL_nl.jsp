...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit legendarische actie-/puzzelspel is al vanaf zijn begin tot op de dag van vandaag een vertrouwde naam in videogames, mede door de vele vervolgen en verwante titels die in de tussentijd zijn uitgekomen!
<br><br>
De speler bestuurt de held, ook wel “Runner”, en verzamelt de goudstukken die in elk level verspreid liggen, terwijl hij uit handen van de meedogenloze robots probeert te blijven. De regels zijn simpel, maar de levels worden steeds lastiger om uit te vogelen. Geen van de 50 levels is zo makkelijk als het lijkt. De Runner ontwijkt vijanden door links en rechts van hem gaten in de vloer te maken. Op deze manier kan hij plaatsen bereiken die op het eerste gezicht onbereikbaar lijken. Spelers zullen hun hersenen flink aan het werk moeten zetten om alle goudstukken in elk level te verzamelen. Alleen dan kunnen ze doorgaan naar het volgende!
<br><br>
Naast de gewone spelstanden bevat deze versie van het spel een Edit Mode, waarin spelers hun eigen levels kunnen ontwerpen. Zo haal je nog meer plezier uit het spel!
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424C4D/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424C4D/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Lode Runner<sup>&reg;</sup></span></div>
</div>
