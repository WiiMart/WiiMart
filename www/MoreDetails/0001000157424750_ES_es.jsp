...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bang Attack es un divertido puzzle a todo color para jóvenes y no tan jóvenes. No hay necesidad de aprender cómo se juega al Bang Attack. Simplemente, basta con jugar para hacerse con la idea. Encuentra objetos iguales y golpéalos con tu martillo. Cuando tengas suficientes puntos, podrás usar el mando de Wii para empezar a usar el martillo GRANDE. ¿Que te encuentras un plátano por el camino? ¡Dale un buen golpe y deshazte de él!
<br><br>
¿Tienes dos mandos de Wii? Juega contra otra persona y descubre quién es el verdadero campeón. No se llega a ser un campeón así como así. Hay que combinar estrategia y velocidad en el momento exacto. Utiliza los objetos especiales para estorbar a tu contrincante, porque ése es el único modo de ganar.
<br><br>
Bang Attack tiene 40 niveles. Esto te
garantiza muchas horas de 
diversión. Bang Attack es un juego con
el que toda la familia disfrutará 
jugando.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424750/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
