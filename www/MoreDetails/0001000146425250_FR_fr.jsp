...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Contrôlez votre chasseur et coopérez avec d'autres pilotes pour vaincre les forces extraterrestres.
<br>
Ces dernières utiliseront des formations d'attaque variées pour vous détruire. Si un de vos chasseurs se fait capturer, libérez-le et combinez vos forces pour former un chasseur double, deux fois plus puissant ! 
<br>
Dans les CHALLENGING STAGES, utilisez un chasseur double pour augmenter vos chances de gagner des bonus !
<br>
Sorti en 1981, Galaga est immédiatement devenu un classique grâce à son système de combinaisons original et à la diversité des formations d'attaque ennemis.
<br><br>
