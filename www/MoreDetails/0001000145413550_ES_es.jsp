...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Revive los combates más duros de la legendaria saga de lucha Fatal Fury con su arrolladora cuarta entrega, publicada por primera vez en 1995!
<br><br>
Si en los anteriores capítulos los enfrentamientos se desarrollaban en dos planos de profundidad, ¡ahora los combates adquieren una dimensión completamente nueva con un tercer plano intermedio! Planifica bien tu estrategia porque no podrás permanecer indefinidamente en los planos frontal y posterior: transcurridos unos segundos, regresarás automáticamente al plano intermedio.
<br><br>
Pero eso no es todo: ejecuta las combinaciones de golpes más devastadoras pulsando el botón adecuado en el momento preciso, remata a tu oponente con una versión aún más mortífera de los ya de por sí poderosos ataques especiales o finales, prueba los golpes perfeccionados de cada personaje... ¡y descubre muchas novedades más!
<br><br>
La fuerza bruta ya no es suficiente: ¡si quieres alzarte con la victoria, tendrás que echar mano de las tácticas más efectivas contra cada oponente!
<br><br>
Textos de pantalla en inglés, español o japonés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145413550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145413550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FATAL FURY 3<sup>TM</sup></span></div>
</div>
