...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158494E50')", "wiiSelectSound()");
...
<br><br>
Avec les PooYoos, une joyeuse bande d'adorables bébés animaux, votre enfant découvrira en s'amusant les apprentissages indispensables à son développement : chiffres, lettres, latéralisation, formes, couleurs... Le jeu l'invitera aussi à danser avec ses nouveaux amis et lui offrira de belles récompenses interactives.<br><br>
Ce jeu a été conçu pour être utilisé par des enfants qui ne maîtrisent pas encore la lecture.
<br><br>
Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494E50/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Épisode 1 - Démo</span></div>
  </div>
