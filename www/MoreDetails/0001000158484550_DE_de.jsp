...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158484550')", "wiiSelectSound()");
...
<br><br>BIT.TRIP BEAT bringt Retro-Action in diesem Rhythmus-Spiel zurück. Dazu kippst du die Wii-Fernbedienung und nutzt den Bewegungssensor um "Beats" abprallen zu lassen!
<br><br>
