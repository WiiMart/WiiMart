...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157575850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paper Wars Cannon Fodder è un tipico gioco di tower defence realizzato da programmatori esterni residenti in Ungheria e Polonia. Roba da pochi soldi: hanno risparmiato su tutto, è difficile anche immaginarlo. E lo scopo geniale della partita? Ma uccidere tutti i nemici, naturalmente! Non te lo saresti mai aspettato, eh?<br> La storia è sempre la stessa: orde di nemici spietati pronti a tutto per sopravvivere allo sterminio! La modalità multigiocatore supporta fino a quattro partecipanti. Inoltre, se pensi che in questo gioco servano dei bonus speciali, allora complimenti: hai indovinato! Puoi ottenerli svolgendo uno dei tre tipi di campagna: Classic, Winter Assault e Cyber Wars.  <br>
Grazie a grafica fatta a mano, musica in stile "marcia dell'armata rossa" e suoni fastidiosi, non vedrai l'ora di finire il livello e ottenere una medaglia per lo sforzo sovrumano!
