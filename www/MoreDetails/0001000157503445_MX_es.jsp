...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157503445')", "wiiSelectSound()");
...
Este juego está diseñado para niños que aún no saben leer. Las instrucciones se dan oralmente en francés, inglés, o español, según la opción de idioma de la consola Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157503445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157503445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Episode 3</span></div>
  </div>
