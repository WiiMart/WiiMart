...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157425250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pirates: The Key of Dreams è un frenetico sparatutto navale. Naviga per i Caraibi tra cannoni tonanti, saccheggi, blocchi navali e infine lacontro Barbanera stesso.
<br><br>
Sei un capitano di vascello che è stato inviato come infiltrato sotto copertura, fingendosi uno spietato pirata per cercare e recuperare The Key of Dreams, un prezioso e pericoloso artefatto maledetto. Salva i naufraghi per rafforzare la tua ciurma, guadagna miglioramenti per le tue abilità in navigazione, armamenti, integrità strutturale e cartografia. Raccogli armi sempre più potenti come razzi, mine, palle con catena, lame circolari e lanciafiamme: porta la distruzione ai tuoi nemici.
<br><br>
Gioca contro 3 dei tuoi vili amici o avversari controllati dalla IA in frenetiche battaglie multiplayer in più di 35 livelli e 7 ambientazioni a tema.  Scegli tra diversi tipi di imbarcazioni che riflettono il tuo stile di gioco. Gioca in modalità turbo se sei abbastanza tosto!
