...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157424A4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">あの牧場物語の世界で、お店けいえいを体験しましょう。平凡でちょっとさびしい田舎町「クローバータウン」を舞台に、小さな主人公がおじいさんの牧場と、おばあさんのお店を守るため、さらにはクローバータウンのみんなを元気にするために、毎日おお忙し。<BR><BR>やさいやたまご、ミルクなど、牧場で育てたものをお店で商品にして売り出しましょう。おきゃくさんの注文どおりに作ると、おきゃくさんと仲良くなれます。<BR><BR>さらにこれまで牧場物語シリーズに登場したキャラクターもお客さんとしてやってきます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424A4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424A4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">牧場物語シリーズ</span></div>
</div>
