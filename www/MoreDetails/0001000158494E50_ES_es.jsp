...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494E50')", "wiiSelectSound()");
...
<br><br>
Con los PooYoos, una alegre banda de adorables animalitos, los niños se divertirán y aprenderán elementos básicos para su desarrollo: números, letras, lateralización, formas, colores y más cosas. También podrán bailar con sus nuevos amigos y conseguir montones de premios. Hay dos niveles de interactividad para que los niños puedan jugar a partir de cualquier edad y nivel.
<br><br>
Este juego está diseñado para niños que aún no saben leer.
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494E50/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
