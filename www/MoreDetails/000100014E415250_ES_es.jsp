...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Comienza la cuenta atrás! Una misteriosa fuerza ha sacado a la luna de su órbita, y está a punto de impactar contra Termina. ¡Tienes tres días para salvar el mundo!
<br><br>
La espectacular continuación de The Legend of Zelda: Ocarina of Time nos trae de nuevo a Link. En esta ocasión, nuestro héroe cuenta con varias máscaras que le permitirán convertirse en Deku, Goron y Zora, volar, rodar por el suelo y nadar.
<br><br>
Aunque solo dispone de 72 horas para salvar Termina, Link puede repetir ese ciclo tantas veces como quiera, adquiriendo así el conocimiento y las habilidades necesarias para resolver el misterio de Majora's Mask.
<br><br>
Un fantástico hilo argumental, docenas de máscaras por descubrir y el debut de Tingle en la saga completan un título que no puede faltar en tu colección.
<br><br>Textos de pantalla en inglés, alemán, francés o español.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E415250/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E415250/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
