...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C4945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Liight es un juego de acertijos en donde usas luces de colores y sombras para resolver los acertijos y hacer música. Cada acertijo en Liight es una combinación única de luces de colores y "objetivos" presentados en un tablero especial. Si cubres completamente un objetivo con una luz del mismo color, el objetivo se iluminará y tocará música. Un acertijo se resuelve cuando todos los objetivos estén iluminados y tocando música juntos. ¡Cada acertijo hace una canción diferente cada vez que juegues!
<p>
...
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
