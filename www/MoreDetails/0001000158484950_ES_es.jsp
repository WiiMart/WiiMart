...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484950')", "wiiSelectSound()");
...
<br><br>
A pesar de sus propiedades casi mágicas –puede pasar de estado líquido a sólido o gaseoso–, casi no pensamos en el agua en nuestro día a día, ¡y ya es hora de que recupere protagonismo!
<br><br>
Será precisamente agua lo que controlarás cuando entres en Acuáticus, un libro mágico corrompido por un poder maligno. Transfórmate en hielo o vapor, o conserva tu estado líquido para combatir enemigos, resolver puzles y reunir las Gotas Arcoíris que hay diseminadas por las páginas de Acuáticus, ¡y devuélvele la armonía!
<br><br>
En lugar de mover el agua directamente, inclina el libro con el mando de Wii para desplazarte por los laberintos de Acuáticus... ¡pero evita los lagos de lava o los fosos de arena!
<br><br>
Encuentra las piezas de puzle que desbloquean las salas de juego para poner a prueba tus habilidades. Intenta batir récords en La sala de engranajes o en Sube que te pilla.
<br><br>
Hydroventure es diferente, refrescante y único, ¡como el agua!<br><br>
