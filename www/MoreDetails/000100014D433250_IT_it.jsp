...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">L'anellide supereroe Jim è tornato per un sequel fuori dal mondo, e con lui c'è il suo nuovo compagno Snott! Earthworm Jim 2 contiene molta più azione che qualsiasi altro platformer di nuova generazione: ciascun livello è caratterizzato da uno stile diverso e da missioni con meccaniche di gioco sempre nuove come labirinti, gare di quiz o puro arcade. Sarai in grado di salvare la principessa?
<br><br>
La musica del gioco è stata composta da Tommy Tallarico. 
<br><br>
Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D433250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D433250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Earthworm Jim 2<sup>TM</sup></span></div>
</div>
