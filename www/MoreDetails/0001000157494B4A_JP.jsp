...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157494B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">◆ツタが導く物語。◆<BR>アンティークな絵本を舞台に、幼い「アイビィ」が走り回る大冒険！ツタを引いて「アイビィ」を無事にゴールまで導こう！<BR>新しいけど、どこか懐かしい。世界中のアクションゲームファンにおすすめのゲームです。<BR>■びよーんと伸びるツタを使って「アイビィ」を導こう！<BR>「アイビィ」は飛ぶことが出来ないので、ただがむしゃらに走るだけ。1人では、階段を登る事もできません。<BR>ツタを引いて、「アイビィ」の旅を助けてあげましょう。<BR><BR>■やりこむほどに、おもしろい！<BR>うまくなっていくにしたがって、新しいやりこみ要素が登場する構成により「シンプルで間口は広いが、奥は深い！」を実現しています。<BR><BR>■「アイビィ・ザ・キウィ？」公式サイトＵＲＬ<BR>http://b.bngi-channel.jp/kiwi/<BR><BR>※本製品は１～４人の協力プレイが可能ですが、Ｗｉｉパッケージ版「アイビィ・ザ・キウィ？」で遊べる対戦仕様は入っておりません。尚、ステージ構成はＷｉｉパッケージ版と同様ですが、ステージ数は少なくなります。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157494B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157494B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">IVY THE KIWI?<sup>TM</sup> mini</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">(アイビィ・ザ・キウィ？ ミニ)</span></div>
  </div>
