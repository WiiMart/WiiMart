...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157505250')", "wiiSelectSound()");
...
<br><br>
Art Style: CUBELLO is a 3D puzzle game that will test your powers of spatial awareness, and your reflexes! The aim is simple: remove the coloured cubes that make up the ‘Cubello’ by launching matching cubes with the Wii Remote.
<br><br>
However, the Cubello is constantly spinning; therefore your aim must be exact, and your judgement spot-on, to eliminate the cubes correctly to finish the puzzle. If you’re looking for a real challenge, try your hand at Endless Mode!</div>
  <div id="image02">
