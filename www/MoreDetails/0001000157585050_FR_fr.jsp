...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157585050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paint Splash transforme votre téléviseur en une toile interactive où les enfants de tous âges peuvent découvrir la peinture en utilisant la Wiimote. Jusqu'à quatre personnes peuvent peindre en même temps. Ainsi, toute la famille peut participer à la création des peintures fantastiques.
<br><br>
Faites votre choix parmi plusieurs brosses et outils de peinture, utilisez toutes les couleurs de l'arc-en-ciel ou activez le mode Splash en secouant la télécommande Wii et les éclaboussures de peinture apparaîtront sur l'écran ! Idéal pour les plus jeunes membres de la famille.
<br><br>
...
Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157585050/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157585050/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
