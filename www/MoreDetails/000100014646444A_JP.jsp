...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">運動会で他の学校をつぶそうと企んだ藤堂護であったが、くにおたちの活躍によりその計画は失敗してしまう。しかし、失敗するのが嫌いな藤堂は、計画をねり直し、再び運動会を開催するのであった。<BR><BR>『びっくり熱血新記録! はるかなる金メダル』は、１９９２年６月２６日に発売されたファミリーコンピュータ用のソフトです。くにお率いる熱血高校チームをはじめとする４チームに、アメリカから参加のオクラホマハイスクールを加えた全5チームで様々なスポーツで対戦します。ハードルを破壊して突き進むことも可能な「４００ｍハードル」など５つの競技を行い、メダルの数を競い合うはちゃめちゃスポーツバトルゲームです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">びっくり熱血新記録！</span></div>
</div>
