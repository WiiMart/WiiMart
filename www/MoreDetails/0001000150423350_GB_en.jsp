...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Devil’s Crush is the exciting sequel to the hit pinball game Alien Crush, and features even smoother ball movement and enhanced special effects.
<br><br>
...
<br><br>
The game’s ominous theme is enhanced by its enemies - from wandering Skeleton Knights, Sorcerers and even a Giant Face that changes from a goddess to a sinister serpent!</div>
  <div id="image02">
