...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157434B50')", "wiiSelectSound()");
...
• Records: Your best scores will be saved... for you to beat</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157434B50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
