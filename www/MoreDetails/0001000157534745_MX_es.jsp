...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157534745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SAMEGAME es un juego de puzle simple pero a la vez absorbente donde eliminas bloques iguales en grupos de 2 o más. Consigue una puntuación alta eliminando más bloques a la vez. Si eliminas toda la cuadrícula, podrás seguir jugando con otro diseño completamente nuevo. ¡Eliminar todos los bloques es la clave para acumular puntos! Ajusta la dificultad del juego para un jugador probando diferentes tamaños de la cuadrícula y números de colores. ¡Juega a tu manera! Hasta 4 jugadores se pueden enfrentar en cualquiera de los 3 modos de multijugador. "Fame Game", la opción más sencilla, es similar al modo de un jugador. "Shame Game" obliga a los jugadores a conseguir la puntuación más baja. "Blame Game" es todos contra todos puesto que todo el mundo busca bloques en una misma cuadrícula. Escoge entre diferentes tipos de bloques, gráficos de fondo y música para personalizar tu experiencia de juego. SAMEGAME: Fácil de aprender, fácil de jugar... ¡pero difícil de dominar!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pop'Em Drop'Em SAMEGAME</span></div>
</div>
