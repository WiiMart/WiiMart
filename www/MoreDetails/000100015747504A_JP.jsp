...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015747504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「アクアリビング ～テレビでながめる魚たち～」は、ご自宅のテレビで色鮮やかな熱帯魚を心ゆくまでながめていただけるソフトです。<BR><BR>
多数のネオン・テトラが群泳する水槽、エンゼルフィッシュとディスカスが混泳する水槽、ブラックライトに照らし出された水槽など、あらかじめ８種類の趣向の異なる水槽が用意されていますので、すぐに熱帯魚観賞をお楽しみいただけます。<BR><BR>水槽に泳がせる熱帯魚の種類や数を選んだり、流木や岩などを自由に動かしレイアウトを変えて、自分好みの水槽にアレンジできます。<BR><BR>また、ソフト内の熱帯魚図鑑で気に入った熱帯魚について詳しく調べたり、魚の視点から水槽をながめることもできます。<BR><BR>アクアリビングで熱帯魚のいる生活をはじめてみませんか？<BR><BR><BR>【本ソフトで観賞できる代表的な魚の種類】<BR><BR>グッピー、ネオン・テトラ、エンゼルフィッシュ、ディスカス、アロワナ、コリドラスなど、有名な熱帯魚のほか、金魚（琉金、出目金）を含め、総数は約４０種類。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100015747504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015747504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アクアリビング</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">～テレビでながめる魚たち～</span></div>
  </div>
