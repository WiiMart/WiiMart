...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015741344A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">簡単操作でアツくなれる瞬間アクションゲームがＷｉｉウェアに登場！<BR><BR>

５秒で終わるプチゲームを全７２種類収録。<BR>
任天堂から無料で配信されるゲームをダウンロードして、
自分好みのゲームを集めることもできます。<BR><BR>

また、ニンテンドーＤＳソフト『メイドイン俺』で作った「ゲーム」や「マンガ」、
「レコード」（音楽）をワイヤレス通信で転送すれば、
それらのコンテンツをテレビ画面で楽しむことも可能。<BR>
さらに、ＷｉｉＣｏｎｎｅｃｔ２４でＷｉｉフレンドと
コンテンツのやりとりができるので、楽しみがどんどん広がります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015741344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015741344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">あそぶメイドイン俺</span></div>
</div>
