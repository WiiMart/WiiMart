...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">R-TYPE ist ein klassischer, horizontal scrollender Shooter aus den Spielhallen, der 1987 von Irem entwickelt wurde. Im Spiel befindest du dich im 22. Jahrhundert und bist die letzte Hoffnung der Menschheit im Kampf gegen das bösartige Bydo-Imperium. Dein Schiff ist der R-9a „Arrowhead“ und verfügt über eine Standardbewaffnung, die du im Laufe der Missionen durch Power-Ups und Upgrades verbessern kannst.
<br><br>
Navigiere durch acht herausfordernde Level, die deine Reflexe auf die Probe stellen. Diese SEGA MASTER SYSTEM-Version enthält eine besondere geheime Mission, welche in keiner anderen Veröffentlichung enthalten ist.
<br><br>
