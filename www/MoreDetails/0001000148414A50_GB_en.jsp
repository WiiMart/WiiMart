...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Some people like cats, others prefer dogs. Some like their eggs boiled, others fried. Everybody has their own opinion, and now there’s a way to find out exactly what other people are thinking. The results may surprise you!
<br><br>
The Everybody Votes Channel brings you regularly updated questions upon which you can vote, simply by choosing one of the two answers provided. You can then check the results and see how your opinion compares with others in your own country and abroad. You can also see how tuned-in you are to public opinion by predicting which answer will get the most votes. 
<br><br>
The Everybody Votes Channel is available for free, so gather your family around, share your opinions and discover what people really think!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414A50/FFFD001E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414A50/FFFD0024" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Everybody Votes Channel</span></div>
</div>
