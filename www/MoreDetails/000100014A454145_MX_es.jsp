...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Sube al ring! ¡Selecciona entre 12 extravagantes luchadores y provoca dolor! ¡Utiliza la potencia masiva de Asteroid, los golpes rápidos como un relámpago de Viper, los ataques ocultos de Phantom y muchos otros hombres locos del ring! ¡Con su robusto sistema de combate y más de 50 movimientos para dominar, Natsume Championship Wrestling ofrece la acción más profunda y más realista de la era de los 16 bits! ¡Prueba tu fuerza contra el habilidoso AI, o hasta 4 jugadores pueden competir en partidas de exhibición, en parejas y todos contra todos!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A454145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A454145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Natsume Championship Wrestling<sup>TM</sup></span></div>
</div>
