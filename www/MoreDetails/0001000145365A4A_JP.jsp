...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">宇宙空間を舞台に、自機「ファイナルスター」を操って次々にあらわれる敵機の編隊を撃ち落としていく縦スクロールタイプのシューティングゲーム。ワンボタンを駆使して敵機を撃墜する爽快感や全２５エリアの至る所に配置された隠しスペシャルボーナスなど、様々な要素が人気を博しました。ＤＩＰスイッチ設定機能も搭載しており、
自機残数や難易度の変更など、お好みの設定でゲームを遊ぶこともできます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145365A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145365A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スターフォース<sup>TM</sup></span></div>
</div>
