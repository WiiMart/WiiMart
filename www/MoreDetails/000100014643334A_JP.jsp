...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アワはきドラゴン「バブルン」と「ボブルン」を操作する、パズル的な謎解き要素をあわせもつアクションゲームです。吐いたアワに敵を包みこんで体当たりでアワを割ると敵を倒すことができ、全ての敵を倒すとラウンドクリアです。各ラウンドには見えない空気の流れがあり、ラウンドごとにアワの流れる方向が異なります。空気の流れやさまざまなアイテムを上手に利用し、全１００面におよぶラウンドを攻略してください。２人同時プレイにも対応しており、その場合にだけ到達できるエンディングがあるなど、協力して遊ぶことでより一層お楽しみいただけます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
