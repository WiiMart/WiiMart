...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742384A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">思わず夢中になるボウリングゲームです。リビングで家族や友達とわいわいボウリングを楽しみましょう。ポップな音楽の流れるおしゃれなボウリング場で、本格的なボウリングゲームをプレイしてください。6人の個性あふれるボウラーのなかから好きなキャラクターを選んで、自由にカスタマイズすることができます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742384A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742384A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ハマる★ボウリング</span></div>
</div>
