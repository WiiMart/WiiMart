...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">地獄からよみがえった平家の武士「平景清」が、壇ノ浦で滅ぼされた一族のため、宿敵「源頼朝」を倒すまで戦うアクションゲームです。プレイヤーは景清を操作してさまざまな国のステージをクリアし、頼朝のいる鎌倉をめざします。頼朝を倒すためには、どこかの国にある「三種の神器」を集めなければなりません。アイテムで剣を強化したり、「巻物」を使って必殺技を繰り出しながら、各国のクリア地点である「鳥居」に向かいます。国によっては複数の鳥居が存在し、攻略ルートを選択することも可能です。また、ゲーム画面は国によって「横モード」「平面モード」「ＢＩＧモード」と変化し、それぞれ異なったアクションが楽しめます。「ＢＩＧモード」では「弁慶」や「義経」といった歴史上の人物が驚きのスケールで登場し、迫力満点の一騎打ちを挑むことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150415A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150415A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">源平討魔伝<sup>&reg;</sup></span></div>
</div>
