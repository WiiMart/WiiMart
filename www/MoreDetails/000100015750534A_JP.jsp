...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750534A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『乱戦！ポケモンスクランブル』は、ポケモンのおもちゃ（以下、ポケモン）を自在に動かしてバトルをおこなう、アクションゲームです。<BR>
２５０種類を超えるポケモンたちが登場。数百種類のわざを繰り出し、次々と現れるポケモンを倒して、仲間にすることもできます。強いポケモンを仲間にして、全ての敵を倒すまで戦うバトルロイヤル形式の新感覚のポケモンバトルに挑戦してください。<BR>
シンプルな操作で爽快なアクションを楽しめるだけでなく、ポケモンを「集める」楽しさをはじめとした、やりこみ要素も満載。最大４人までの協力プレイも可能です。また、Ｗｉｉリモコンにお気に入りのポケモンを入れて持ち運び、協力プレイで使用することもできます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">乱戦！ポケモンスクランブル<sup>TM</sup></span></div>
</div>
