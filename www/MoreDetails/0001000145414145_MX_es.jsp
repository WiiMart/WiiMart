...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lazado en 1991 y una de las series más populares en el genero de pelea, este titulo introduce combatientes como Terry Bogard, Andy Bogard, y Joe Higashi. Selecciona a uno de estos tres y visita varios sitios mientras que tu personaje se mete en varias peleas callejeras a través de la ciudad ficticia de South Town. Si eres lo suficientemente bueno, eventualmente te enfrentarás contra Billy Kane y luego contra su jefe, el famoso pandillero Geese Howard. Cada combatiente tiene su propia maniobra de resolución y luchará en dos diferentes niveles en la pantalla, uno en el primer plano y otro más alejado en el fondo. El juego también presenta un modo de dos jugadores el cual es reconocido por su único montaje el cual permite que los dos jugadores luchen al mismo tiempo y se ayuden uno al otro. ¿Tienes lo que se requiere para ganar el torneo de King of Fighters (Rey de los Luchadores)?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
