...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">GHOSTS'N GOBLINS es un clásico juego repleto de puñetazos (y lanzas). Prueba el juego que catapultó a Capcom a lo más alto de la industria de los juegos recreativos en 1985. Ayuda a Arthur a vencer a hordas de monstruos mientras él intenta rescatar a la princesa. El primer (y posiblemente el único) juego en el que recibir un disparo te deja en ropa interior.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145353445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145353445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
