...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574F4150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Papa, Mama, Sarah en Billy zijn terug voor nog meer familieplezier, deze keer met airhockey!
In dit spel kun je overal laten zien hoe goed je in airhockey bent: in een sportzaal, in een dichtbegroeid bos, in een amusementspark en zelfs in een ijskoud noordpoolaquarium!<br><br>
Family Glide Hockey valt op door zijn kleurrijke, ‘cel-shaded’ graphics en de vrolijke muziek. Bovendien bevat het spel allerlei leuke manieren om te spelen! Zo is er een stand voor één speler, een versusstand (voor maximaal vier spelers) en een reeks boeiende minigames, waaronder "Glide Hockey Brawl!", "Glide Hockey Drill!" en "Glide Hockey Tracer!", waarin je je vaardigheden op de proef kunt stellen!<br><br>Voorzien van Nederlandstalige schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4150/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4150/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
