...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">KARNOV’S REVENGE est un jeu de combat commercialisé en 1994 par Data East. Suite du non moins célèbre Fighter's History, il met en scène treize combattants qui s'affrontent lors d'un tournoi intitulé "Great Grapple" (la grande lutte). Cet épisode introduit un nouveau système de points faibles attribués à chaque personnage, et fait aussi apparaître les redoutables techniques cachées. De plus, vous avez la possibilité d’incarner les boss du précédent volet : Clown et Karnov. Sachez enfin que le jeu contient un niveau secret tiré du classique jeu d'arcade "Karate Champ". Il s'agit d’un duel contre un taureau !
