...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157535350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Solitaire offre 18 tra i più famosi ed amati giochi di carte in solitario tra cui: Klondike, FreeCell, Spider, Pyramid e Yukon. La maggior parte dei giochi dispone di opzioni personalizzate, in modo da poter giocare con le tue regole preferite. Grazie alle istruzioni su schermo potrai imparare a giocare con nuove varianti.
<br><br>
Sono disponibili statistiche per tutti i giocatori che amano seguire i propri progressi. Puoi salvare lo stato del gioco in qualsiasi momento e riprenderlo in seguito o personalizzare l'aspetto scegliendo tra diversi sfondi. Lo stile e l'interfaccia del gioco sono stati progettati per un utilizzo semplice e intuitivo tramite il telecomando Wii.
<br><br>
Siediti e rilassati... Goditi la sfida infinita offerta da questa collezione di solitari.
<br><br>
