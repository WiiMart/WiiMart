...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Diner Dash, el juego de puzles de acción número uno para PC ha llegado a WiiWare! ¡Guía a Flo, una antigua oficinista convertida en restauradora, mientras levanta su imperio con cuatro restaurantes únicos! ¡Conéctate y enfréntate a jugadores en partidas cara a cara! ¡Si aceptas el desafío, busca un amigo u otro jugador online para jugar en equipo, enfrentándoos a otros seis jugadores para ver quién tiene el mejor restaurante de la ciudad! <br><br> 

Sienta a los clientes, toma nota, sirve la comida, cobra y limpia las mesas lo más eficazmente posible dentro del límite de tiempo permitido. Cuanto más rápido sirvas a los clientes, más contentos estarán. La satisfacción del cliente estará reflejada en un medidor de corazón que se vacía a medida que los clientes pierden la paciencia. Si se vacía del todo, el cliente se enfadará y se irá del restaurante.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444450/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444450/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
