...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001575A5A4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">古びた洋館に眠る謎の絵本…不思議で、怖くて、ちょっと切ない物語の扉が開く。Wiiリモコンを使ったスローイング“くまなげ”で謎を解き明かす、新感覚のパズルアクションゲーム。不思議な女の子“ピイナ”と一緒に絵本の世界へ。不思議な力で動く“紙のくま”をうまく投げ込こんで赤いキャンディをゲットしよう！30ステージをこえる謎解きのページがアナタを待っています。おはなしとステージが異なる「バトル編」も同時発売！両方を解き明かすと、さらなるなにかが…？</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A5A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A5A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">くまなげ・パズル編</span></div>
</div>
