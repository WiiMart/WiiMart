...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">江戸時代を舞台とした、和風アクションゲーム。プレイヤーは剣術と忍法の達人である青年剣士「鷹丸」を操作し、４つの城を突破して、その先にそびえる謎の城「村雨城」をめざします。
道中と城内で構成された広大なゲームマップをめぐり、隠されたパワーアップアイテムを探しながら、城の最も奥に位置する城主（ボス）を退治していきます。
村雨城にひそむナゾの生命体「ムラサメ」の正体をあばくべく、幕府の密命を受けた鷹丸の旅がはじまります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146454A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146454A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">謎の村雨城<sup>&reg;</sup></span></div>
</div>
