...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158495550')", "wiiSelectSound()");
...
<br><br>Voetbal van de toekomst! Vernietig de blokken van de verdediging en dreun de bal in het doel om te winnen, maar kijk uit voor vijandelijke verdedigers die het op jou gemunt hebben!<br><br> 

Een ingebouwde editor in het spel biedt onbeperkte mogelijkheden voor het ontwerpen van levels of speel de meer dan 90 levels in verschillende speelmodi, waaronder Arcade en Aanpasbare Toernooien.<br><br> 

- 90 levels lang doelpunten scoren en blokken vernietigen! Eén groot feest!<br><br> 

- Levels met speciale eigenschappen: bewegende blokken, exploderende blokken, schildblokken, onzichtbare blokken en dodelijke 3D-verdedigers.
<br><br> 
- 9 uitdagende eindbazen.<br><br> 

- Level Editor om zelf levels te bouwen. Je kunt maximaal 100 eigen levels opslaan.<br><br> 

- In de Toernooimodus kun je je eigen toernooien samenstellen met de levels uit het spel of zelf ontworpen levels.
<br><br> 
- Speciale Power-Ups & Super Power-Ups om je te helpen (of te hinderen) op je weg naar de goal zoals lasers, bommen, vuurballen en meervoudige ballen en batjes.<br><br> 

- Heel veel speciale achievements en geheimen om vrij te spelen.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
