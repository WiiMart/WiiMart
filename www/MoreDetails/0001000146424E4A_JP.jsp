...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８８年に発売された、若き忍者、リュウ・ハヤブサが主人公の横スクロール型のアクションゲームです。父の遺言をもとに一族に伝わる秘伝の龍剣を手にアメリカへ渡った主人公は、巨大な悪の陰謀に巻き込まれていきます。高難易度ながら、気持ちの良い操作性に支えられた軽快なテンポで楽しめる多彩なアクションと、ステージ間に挿入される感動的なムービーシーン（シネマディスプレイ）、そして美麗なグラフィックなど、様々な要素を兼ね備えた傑作アクションゲームです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
