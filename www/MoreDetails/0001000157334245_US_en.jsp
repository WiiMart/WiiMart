...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157334245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Experience soccer of the future—destroy the defender blocks and smash the ball into the goal to win, but watch for the enemy defenders out to destroy you! A built-in game editor offers unlimited level design possibilities, or play through the 90 game levels over several different play modes, including Arcade and Customizable Tournaments.
<p>
...
- Special Power-Ups and Super Power-Ups to help (or hinder) you on the way to the goal, including lasers, bombs, flaming power balls, and multiple balls and bats.</div>
  <div id="image02">
