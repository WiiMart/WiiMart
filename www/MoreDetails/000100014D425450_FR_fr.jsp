...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Vous êtes Epsilon-Eagle, un soldat extraterrestre génétiquement modifié, doté d'une intelligence et d'une force hors du commun. Lorsque vous décidez de rompre avec votre ancienne organisation criminelle Scarlet, son chef Xi-Tiger vous force à l'affronter en éliminant un otage dans sa tentative pour se débarrasser de vous.
<br><br>
L'heure de la vengeance a sonné dans ce jeu d'action à défilement horizontal ! Utilisez les six armes à votre disposition pour défaire les boss de Scarlet et emparez-vous de l'arme secrète ultime pour remporter le combat final !<br><br>Texte écran en anglais.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
