...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157535350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Solitaire bevat 18 varianten van de meest bekende en geliefde kaartspellen voor één persoon zoals Klondike, FreeCell, Spider, Pyramid en Yukon. Bij de meeste spellen kun je de spelregels aanpassen zodat je het spel kunt spelen volgens je favoriete spelregels. En dankzij de instructies op het scherm kun je nieuwe Solitaire varianten onder de knie krijgen.
<br><br>
Voor wie het verloop van zijn potjes wil bekijken, zijn er statistieken beschikbaar. Je kunt op elke moment de spelsituatie opslaan om later verder te spelen. Ook kun je dankzij een grote verscheidenheid aan achtergronden het spel een eigen uiterlijk geven. De speelstijl en interface zijn speciaal ontwikkeld voor een intuïtief gebruik van de Wii-afstandsbediening.
<br><br>
Ga zitten en ontspan je... geniet van de nimmer eindigende uitdaging en het spelplezier van deze verzameling Solitaire spellen.
<br><br>
