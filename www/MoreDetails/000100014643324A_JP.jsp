...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ギャグテイスト満載の愉快な世界観が今も人気のシミュレーションゲームシリーズの第一弾。群雄割拠の大陸を舞台に、ハードボイルドになりきれない「半熟英雄」のスチャラカ・ウォーズが繰り広げられます。プレイヤーは敵国に部下の将軍たちを攻め込ませて敵の城を占領し、自国の領土を広げていきます。バトルでは、Ａボタン連打による兵士同士の肉弾戦や、強力な「切り札」を駆使して戦うほか、シリーズのシンボルでもある不思議な卵を使う「たまご召喚」でさまざまなエッグモンスターを召喚することもできます。現在まで続く「半熟英雄」シリーズの原点となった作品です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">半熟英雄<sup>&reg;</sup></span></div>
</div>
