...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界のヒーロー“ソニック”が活躍する、スピード感あふれるアクションが魅力のシリーズ第２弾。スピード感、爽快感ともにパワーアップし、シリーズ中でも屈指の傑作として名高いタイトルです。新たに２本シッポのキツネ、テイルスも登場。究極兵器デスエッグ建造に乗り出した悪の天才科学者ドクター・エッグマンの野望を阻止するため、幻の島ウエストサイドを舞台にソニックの新たな冒険が始まります。ステージに隠された伝説の宝石・カオスエメラルドをすべて集めたとき、ソニックの新たな力が目覚めます。ソニックとテイルスで２人同時プレイも可能。また、ゴールまでたどり着くタイムや、手に入れたリングの数などを競う、対戦モードも新たに追加されました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div><BR>JASRAC許諾番号：<BR>6727723184Y43030</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42424A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソニック・ザ・ヘッジホッグ２<sup>TM</sup></span></div>
</div>
