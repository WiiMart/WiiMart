...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">高層ビルの側面をのぼっていくクライミングゲームです。２つのレバーそれぞれでプレイヤーの左右の手を動かす、独特の操作が特徴。開いている窓に手をかけ、交互にレバーを上下することでさらに上の階の窓に手をかけながら、ビルをのぼります。途中には、ビルの上から物が落とされたり、窓が閉められてしまったりと、さまざまな妨害が待ち受けています。
隣の窓に移ったり、危ないときは両手で体重を支えて耐えるなど、２つのレバーをうまく使ってあらゆる妨害から逃れ、ビルをのぼりきってください。頂上から脱出できればステージクリアです。操作は単純ながら奥の深いゲーム性を生み出し、３０年たった現在でも多くのファンに支持されています。<BR><BR>詳細は、<Center>http://www.hamster.co.jp/products/vca.htm</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クレイジー・クライマー</span></div>
</div>
