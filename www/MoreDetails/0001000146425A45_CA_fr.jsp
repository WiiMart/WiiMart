...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The first installment of the immensely successful Metroid series introduces us to the hideous title creatures and the slick, cybernetic bounty hunter Samus Aran. As Samus, your mission is to penetrate the space pirates' home planet, Zebes, and keep them from destroying the galaxy with the dangerous life-forms known as Metroids. Metroid has all the high-tech weaponry, creepy tunnels, and crawly alien creatures that anyone could ask for! With its deep and complex game play, excellent music, and a rare sense of setting, it establishes a frightening ambience that will haunt and entertain you for a very long time!</div>
  <div id="image02">
