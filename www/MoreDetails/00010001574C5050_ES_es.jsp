...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C5050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LONPOS es un puzle de manejo sencillo, pero elevada dificultad, que pondrá a prueba tu capacidad lógica y de concentración. Puedes jugar solo, colaborando con otros jugadores o enfrentándote a ellos. El objetivo es encajar diferentes piezas dentro de un tablero, para lo que deberás hacer que se muevan y giren usando el mando de Wii.
<br><br>
Hay varios modos de juego: en el modo normal lucharás contra el reloj, intentando resolver los puzles en el menor tiempo posible para ganar puntos. En el modo continuo, cualquier movimiento en falso puede suponer la derrota. También dispones de un modo cooperativo, con el que tú y un amigo os turnaréis para completar los puzles; y del modo enfrentamiento, en el que podrás medirte hasta a tres rivales.
<br><br>
LONPOS ya viene equipado con una gran cantidad de puzles, suficiente como para mantener ocupada tu materia gris durante una buena temporada.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C5050/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C5050/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
