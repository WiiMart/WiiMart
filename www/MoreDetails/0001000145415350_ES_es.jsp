...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Coge tu katana y prepárate para desplegar tus habilidades de samurai frente a tus enemigos! Publicado en 1994, Samurai Shodown 2 está considerado como uno de los mejores juegos de SNK, y en él volvemos a encontrar el medidor de furia que tanto éxito dio al primer juego. Cuando el medidor está lleno, no solo se incrementa la fuerza de los ataques, sino que además el jugador puede usar una técnica especial que puede romper el arma del adversario, forzándolo a luchar desarmado. 
<br><br>
El juego también incorpora más movimientos, tales como eludir golpes o rodar hacia atrás o hacia adelante, lo que permite desarrollar una mayor variedad de estrategias. Un detalle destacable es la voz que la actriz Reiko Chiba, venerada en el mundo de los videojuegos, prestó a Cham Cham, uno de los nuevos personajes.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SAMURAI SHODOWN<sup>TM</sup> 2</span></div>
</div>
