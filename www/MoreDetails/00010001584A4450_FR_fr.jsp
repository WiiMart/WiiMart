...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001584A4450')", "wiiSelectSound()");
...
<br><br>
MotoHeroz est un jeu de course aux commandes simples alliant défis physiques et graphismes époustouflants, pour une aventure de course inédite ! Les joueurs font la course, se pourchassent et traversent un monde riche en couleurs, dans lequel ils affronteront leurs amis, participeront à des courses quotidiennes et chercheront des secrets et des pièces. Découvrez des graphismes simples et efficaces pour une expérience de jeu unique ! Le mode Solo présente des personnages mémorables et des effets visuels somptueux. Jouez également au mode multijoueur, avec jusqu'à quatre joueurs en même temps ! Effectuez des courses fantômes, rejoignez une Ligue d'amis et participez à des compétitions en ligne. Tout ça grâce à MotoHeroz, sur WiiWare !
