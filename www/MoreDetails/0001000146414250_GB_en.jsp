...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Donkey Kong has finally been captured by Mario! Reverse roles and help his son Junior avoid many dangers to save the giant ape. To reach his emprisoned father, Junior is able climb vines and drop fruits on his enemies. A precious tip is that it is possible to move much faster by grabbing two vines at the same time. Here is another smash hit of the early Eighties, released not long after the successful platform game Donkey Kong™. For the first and only time, Mario plays the role of the  bad guy  in a videogame! The main protagonist Junior later reappeared as one of the drivers in the original Super Mario Kart™.</div>
  <div id="image02">
