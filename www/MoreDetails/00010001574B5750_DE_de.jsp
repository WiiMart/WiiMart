...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574B5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Spielt zusammen oder tretet in jeder Stufe gegeneinander an, um die benötigten Objekte zu finden, die dem Held dieses Spiels helfen, einen Weg nach Hause zu finden. Von Muscheln bis zu funkelnden Juwelen – gib dein Bestes, um die versteckten Objekte so schnell wie möglich zu finden! Während dieses Abenteuers wirst du in einigen Action-Stufen auch Gespenstern und einem Drachen begegnen. Jede Stufe bietet unzählige Objekte die für jede Menge Spaß und Spannung sorgen!
  <br><br>
Jede Stufe kann mit bis zu vier Spielern für den großen Spielspaß gespielt werden. Familie und Freunde können zusammen spielen, um eine gute Stufenabschluss-Zeit zu erreichen oder gegeneinander antreten, um zu sehen, wer der beste ist auf der Suche nach versteckten Objekten in jeder Stufe!  <br><br>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Abenteuer auf der Insel der </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Magie - Wimmelbild-Spiel</span></div>
  </div>
