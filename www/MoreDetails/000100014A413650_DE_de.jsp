...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Monster, Werwölfe und andere Kreaturen machen Jagd auf deine Nachbarn, deren Kinder und alles andere, was ihnen über den Weg läuft. Es ist deine Aufgabe, deine Nachbarn zu retten!
<br><br>
Spiele das Spiel als eines von zwei mutigen Kindern: Zeke oder Julie. Beide werden auf die gleiche Weise gesteuert und besitzen dieselben Eigenschaften. Wenn ein Spiel mit zwei Spielern gewählt wird, muss sich jeder für eine der beiden Kinder entscheiden.
<br><br>
Das Spiel beginnt mit drei Versuchen. Wenn deine Gesundheitsanzeige leer ist, verlierst du einen Versuch, es gibt jedoch versteckte Bonusversuche und du kannst Bonusversuche gewinnen, wenn du nach Vollendung eines Abschnitts noch 10 Nachbarn übrig und genügend Punkte hast.
<br><br>
Bereite dich darauf vor, 48 Levels mit Riesenameisen, verrückten Wissenschaftlern und Riesenbabys zu bezwingen. Finde sieben Bonusabschnitte (achte auf Fragezeichen!), sammle Punkte und horte Wasserpistolen und andere Waffen!
<br><br>
Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A413650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A413650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Zombies</span></div>
</div>
