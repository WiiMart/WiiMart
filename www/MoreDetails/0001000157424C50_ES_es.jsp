...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BUBBLE BOBBLE Plus! es un juego de acción en el que tomas el control de Bub y Bob, quienes pueden eliminar a sus enemigos atrapándolos en las burbujas que lanzan por la boca, para luego reventarlas.<br><br>
Juega en los 100 niveles de la modalidad estándar, la cual recrea el aire nostálgico del juego original, o bien, ponte a prueba en los 100 niveles de la modalidad extra, donde podrás jugar con hasta 3 compañeros en diferentes niveles con enemigos y escenarios nuevos. Además, también podrás disfrutar de más niveles en unas modalidades especiales.<br><br>
Obtén el final verdadero al resolver los puzles ocultos en cada nivel para vencer al jefe final.<br><br>
Y eso no es todo: también podrás disfrutar de 100 niveles extra en los que te enfrentarás a nuevos jefes. Podrás adquirir estos niveles al comprar el contenido adicional “Modalidad experto 1” y “Modalidad experto 2”.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424C50/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424C50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bubble Bobble<sup>TM</sup> Plus!</span></div>
</div>
