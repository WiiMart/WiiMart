...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ひとつの壮大な物語を３人の視点で描いたＲＰＧです。物語は１日単位で進みます。１人のキャラクターで何日も進めることもできれば、３人それぞれを１日毎に進めることもでき、それはプレイヤーが自由に楽しめます。言霊システムで自分だけの魔法が作れるのも大きな特徴です。プレイヤーが６文字以内の任意の言葉で名前を考え登録すると、様々な効果の魔法が出来上がります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ルドラの秘宝</span></div>
</div>
