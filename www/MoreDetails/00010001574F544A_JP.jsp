...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F544A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">対戦が熱いマシンバトルアクションゲームです。マシンの操作の一部にバランスWiiボードを使用することも出来ます。<BR>ストーリーモードでは、次々に現れるライバル達と戦い、各トーナメントを勝ち上がり、マスターチャンピオンを目指します。新しい武器を入手し、自分だけの組み合わせやマシンのカラーを変えたりすることもできます。<BR>Wi-Fiモードでは、ストーリーモードで入手したマシンや武器を使って全国の人と対戦して、ランキングを競うことができます。１対１のVS対戦や４人でのバトルロイヤルで競うことができます。<BR>VSローカルモードでは、Wiiコントローラとヌンチャクが２組あれば、画面を分割して、２人で対戦することができます。<BR>■公式サイトURL<BR>http://www.studio-zan.com/overturn/</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F544A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">オーバーターン</span></div>
</div>
