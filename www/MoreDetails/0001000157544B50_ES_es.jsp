...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157544B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">TV Show King, el juego más vendido de WiiWare, vuelve para una segunda entrega. Hay más de 8000 preguntas divididas en 12 categorías, que incluyen conocimiento general, deportes, cine, música y más... ¡Y eso sin contar las preguntas que puedes crear tú mismo! Aquí tienes todo lo que necesitas para competir con tus amigos.<br><br>
...
• Creador de preguntas: por primera vez, crea tu propio quiz y envíalo en línea. O aún mejor, descarga nuevos paquetes de preguntas creados por otros jugadores y disfruta de un desafío sin fin.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544B50/FFFD0001" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544B50/FFFD000A" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
