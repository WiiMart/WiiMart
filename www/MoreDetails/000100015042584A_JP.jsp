...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">亜空魔団との戦いから２年。「シュビビンマン」に改造されてしまった太助とキャピ子が、地球侵略を宣言する「ライオ帝国」にさらわれた豪徳寺博士を救い出し、元の体を取り戻すため、新たな戦いに挑むサイドビュータイプのアクションシューティングゲームです。ジャンプや必殺技を駆使する「アクションステージ」と横スクロールの「シューティングステージ」で構成された全８ステージを戦い抜きます。現在配信中の前作から受け継いだテンポの良いストーリー展開とともに「ライフの共有」や威力抜群の「協力シュビビーム」といった連携要素で、２人同時プレイの楽しさもパワーアップしています。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">改造町人シュビビンマン２</span></div>
</div>
