...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９２年発売の２Ｄ対戦格闘ゲーム。何者かによってさらわれたユリ・サカザキを助けるため、極限流空手の使い手リョウ・サカザキとロバート・ガルシアの二人がサウスタウンで様々な敵と戦います。必殺技を使用するためには「気力」が必要という独特のシステムが採用されているため、一撃必殺の威力を持つ必殺技の使いどころが重要で、緊張感のある駆け引きが楽しめます。相手の気力を減少させる「挑発」、必殺技を超える「超必殺技」、間合いにより拡大縮小したりダメージを受けると顔がはれ上がったりとダイナミックに変化するグラフィック、声優によるセリフが挿入されるイベントシーンなど、対戦格闘ゲームに新機軸をもたらした意欲作として知られています。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">龍虎の拳<sup>&reg;</sup></span></div>
</div>
