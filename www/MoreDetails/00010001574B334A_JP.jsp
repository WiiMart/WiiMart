...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B334A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">このゲームは親が子供に絵本を読んであげる「よみきかせ」をテーマにしたデジタル絵本です。お子様といっしょに絵本を読んであげたり、クイズの答えをいっしょに考えてあげたりしながらお子様とのコミュニケーションを楽しむことができます。<BR>画面のあちこちには見つけると動き出す「しかけ」が隠れていますので、お子様が飽きてきたときに「しかけ」を動かして、注意をひきつけることができます。<BR>また、ふろくの「あいうえおパズル」でひらがなを覚える練習をすることもできます。<BR><BR>☆絵本のあらすじ<BR>かっぱくんが３匹の子猫を拾いました。おかあさん猫をさがすために、かっぱくんとお友達のケンイチくんが森の仲間をたずね歩きます。おかあさん猫を見つけられるかな？<BR><BR>☆よみきかせナレーション<BR>追加コンテンツとして、タレントのつのだりょうこさんによる「よみきかせナレーション」を購入することもできます。（※有料）</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B334A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B334A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">かっぱくんとあそぼう</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">かっぱくんと３びきのこねこ</span></div>
  </div>
