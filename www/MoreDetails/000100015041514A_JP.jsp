...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">独特のパワーアップシステムをはじめ、美しいグラフィックやサウンドが大人気となった横スクロールシューティングのアーケードゲームからの移植作品です。プレイヤーはそれぞれのステージにあわせて自機をパワーアップさせながら、立ちはだかるバクテリアン軍団を撃破していきます。各ステージの最後にはボスが待ち構えており、これを破壊するとステージクリアです。ＰＣエンジン版では「オプション」装備数が最大４つに増え、「レーザー」の表現もよりアーケード版に忠実に再現されています。さらに「逆火山」と「触手」ステージの間には、巨大生物の骨が横たわる「砂漠」が新たに追加され、手ごたえも一段とアップしています。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">グラディウス<sup>&reg;</sup></span></div>
</div>
