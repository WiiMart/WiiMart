...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157444D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The all-time puzzle classic returns for the Wii generation, featuring online gameplay and a new Germ Buster mode! Destroy all the viruses trapped in the bottle by dropping and slotting capsules to create lines of matching colours. The more viruses you clear, the faster the capsules drop.
<br><br>
In Dr. Mario, challenge the computer in 1 Player mode or go head-to-head with a friend in 2 Player mode.
<br><br>
In Germ Buster (based on the relaxation game in More Brain Training from Dr Kawashima), up to four players can use their Wii Remotes to grab, spin and slot capsules as your Miis try to keep the nasty bugs at bay. Who thought that catching germs could be so much fun?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444D50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444D50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
