...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">新宿・歌舞伎町に事務所を構える私立探偵「神宮寺三郎」を主人公とした本格推理アドベンチャーゲームで、このジャンルを代表する長寿シリーズ「探偵神宮寺三郎」の第一弾です。１９８７年に発売されたこのタイトルは、“煙草を吸う”などのコマンドに代表される、当時としては珍しいリアリティあふれる世界観と、魅力的な“大人”のキャラクター達による人間模様が、ファンの熱狂的な支持を獲得しました。発売当時から色あせることのない、本格ハードボイルドの世界観と人間模様が織りなすドラマをお楽しみください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">探偵神宮寺三郎<sup>TM</sup>　新宿中央公園殺人事件</span></div>
</div>
