...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Weird things are happening on Planet Nebulus. Someone or something has begun building huge towers on the sea floor without a construction license!
<br><br>
Your mission is to ascend each of the eight cylindrical towers, passing various obstacles, and trigger the tower's destruction mechanism to demolish the evil threat.
<br><br>
Praised at the time for its graphical innovation, this is considered to be the most outstanding game from Hewson in 1987. Don't miss out on this classic favourite!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143393450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143393450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Nebulus<sup>TM</sup></span></div>
</div>
