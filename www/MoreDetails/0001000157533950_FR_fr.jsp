...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157533950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Saisissez votre chance de résoudre un casse-tête stimulant qui a déjà captivé le monde entier.  <br><br>Vous n'aurez pas à résoudre le même Sudoku deux fois puisque Défi Sudoku en a plus de 100 000 000 !  Vous pouvez choisir le plateau de jeu classique neuf à neuf de Sudoku ou le Grand Sudoku qui vous met au défi de compléter simultanément 5 grilles de Sudoku entrecroisées.  Vous êtes un débutant ? Pas de problème, vous pouvez choisir parmi les trois niveaux de difficulté, dont le premier permettra même à un joueur inexpérimenté de compléter un casse-tête. Si vous êtes un pro chevronné, relevez le défi du niveau « Expert », montrez vos talents en action.<br><br>Activez votre QI, lancez-vous à la conquête des casse-têtes Sudoku !<br><br>Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157533950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157533950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sudoku Challenge!</span></div>
</div>
