...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『フロントミッション』で登場した機動兵器「ヴァンツァー」を操作し、敵と戦うアクションロールプレイングゲーム。ベルゲン共和国の兵士アルベルト・グレイブナーは、
予期せぬ軍事クーデターに巻き込まれ、さらに大統領拉致の汚名を着せられ母国を追われます。彼は傭兵派遣機構「カーネルライト」へ所属し、自分を陥れた元上官への復讐、そして不可解なクーデターの陰に隠された真実を知るため、戦いに身を投じます。ミッションに応じて世界各地のステージへ移動し、母艦でヴァンツァーなどのセットアップや補給をおこなって出撃します。各ステージはヴァンツァーを操作して敵と戦いながら進む横スクロールアクションとなり、定められた特定の条件を満たすとミッションクリアです。他のフロントミッションシリーズとは異なる世界観でありながらも、ヴァンツァーが登場し、世界を巻き込む巨大な陰謀をえがくという共通したテーマを持っており、シリーズファンの方もお楽しみいただけます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">フロントミッション<sup>&reg;</sup>シリーズ　ガンハザード</span></div>
</div>
