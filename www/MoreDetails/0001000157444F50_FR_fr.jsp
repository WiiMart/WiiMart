...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157444F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Driift Mania est le top des jeux de course multijoueur en vue de haut ! Affrontez vos amis lors de courses folles et dans des modes de jeu totalement loufouques ! Si vous voulez arriver en tête, vous devrez adapter vos aptitudes de pilotage à chaque environnement. 
<br>
<br>
CARACTÉRISTIQUES
<br>
<br>
Jeu de course endiablé en vue de haut pour 1 à 8 joueurs.
<br>
<br>
Choisissez un des 32 véhicules de l’une des 4 catégories (léger, moyen, lourd, spécial).
<br>
<br>
12 circuits et 3 arènes différents proposant 4 types d’environnements (ville, colline, neige, oasis).
<br>
<br>
7 modes de jeu dont les modes classiques solo, course par équipe et championnat multijoueur, mais aussi des modes de jeu délirants comme V.I.P., Météorite, Patate froide et Contamination.
<br><br>
Jouez en combinant télécommandes Wii, Nunchuks et manettes classiques.
<br>
<br>
Graphisme dans le pur style cartoon.<br>
<br>Texte écran en français.</div>
  <div id="image02">
