...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157325445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Line up and get ready to use your mind! Drill Sergeant Mindstrong is a party game that allows up to four people to play at once. Players will become boot-camp trainees under the tough Drill Sergeant Mindstrong and go through mind-boggling, mind-strengthening training games. The rules are simple, but concentration and quick thinking are both key to playing this game and emerging as lean, mean, thinking machines. Become the top boot of your class and earn promotions based on your efforts! This game is best played with friends and family.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157325445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157325445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Drill Sergeant Mindstrong</span></div>
</div>
