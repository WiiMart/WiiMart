...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You are a brave boy who sets off on a journey to rescue the kidnapped princess and reclaim the 8 medallions that were stolen by the evil demon, Dirth.<br>
In this action role-playing game, you’ll need to rely on your magic compass and gather information to find entrances to labyrinths, and defeat the bosses in them.
Travel across land and sea, under the earth and even through the sky on your quest to recover the medallions.
Solve puzzles, avoid traps, move blocks and destroy walls to uncover secret rooms in the labyrinths.
Carefully use your map to uncover hidden treasure and powerful equipment.<br> With a save function, the right difficulty level and a system that doesn’t use experience points, this is a true RPG that anyone can enjoy.</div>
  <div id="image02">
