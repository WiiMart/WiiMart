...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157505950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jump and roll with Pallurikio, a fast-paced action platformer, easy to pick up, yet challenging to master.
<br><br>
...
<br><br>
Featuring physics simulation, Time Attack mode, collectable cards, and space rockets to boot, Pallurikio is a game on which you won’t want to miss out!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505950/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505950/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
