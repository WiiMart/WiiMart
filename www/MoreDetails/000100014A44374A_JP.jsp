...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">あの「高橋名人」が主役となって大活躍するアクションゲームが登場。ハドソンのスーパーファミコン用ソフト第１弾として発売されました。平和の国、アドベンチャーアイランドでまたまた大事件！ミス・ジャングルと呼ばれる美しい娘「ジーナ」が、イタズラ好きの「ダーキー」の魔法で石に変えられてしまいました。高橋名人は彼女を元の姿に戻すため「伝説のオノ」を求めて出発します。シンプルながら歯ごたえのある難易度は今作でも健在。ジャングルや洞窟を抜け、木の枝を上へ上へと登り、海を渡り…<BR>バラエティ豊かなステージを縦横無尽に走りぬけ、ジャマな敵をやっつけながら障害を乗り越え、海の向こうの「でんせつ山」を目指してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">高橋名人の大冒険島</span></div>
</div>
