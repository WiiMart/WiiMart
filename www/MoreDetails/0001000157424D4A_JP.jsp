...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157424D4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「みんなのポケモン牧場」は、Ｗｉｉの中に作られた、ポケモンとＭｉｉが一緒に過ごせる空間です。プレイヤーの作成したＭｉｉが、牧場でポケモンたちと一緒に楽しく過ごします。<BR>
にぎやかな牧場を眺めたり、記念写真を撮影して友達に送ったりして、のんびりとしたポケモン牧場の生活を楽しみましょう。<BR>
ニンテンドーＤＳソフト「ポケットモンスター ダイヤモンド・パール・プラチナ」と連動して、集めた大切なポケモンを預けたり、選んで引取る機能もついています。<BR>
１つの牧場に８本まで「ダイヤモンド・パール・プラチナ」を登録でき、最大１５００匹のポケモンを預けることができるので、友だちや家族といっしょに、みんなでポケモン牧場を大きくしましょう。<BR><BR>

※このソフトは「ポケットモンスターハートゴールド・ソウルシルバー・ブラック・ホワイト」には対応しておりません。<BR><BR>

※このゲームでは、ポケモンを「つかまえる」「育てる」「わざを覚えさせる」「バトルする」「友だちと交換する」ことはできません。<BR><BR>

※牧場に預けたポケモンは、そのポケモンを預けたＤＳカードでしか引取ることができません。<BR>
また、同じＤＳカードであっても、レポートを消して新しく冒険を始めなおした場合も引取れなくなりますのでご注意ください。<BR><BR>

※このソフトは「ポケットモンスター ダイヤモンド・パール・プラチナ」に対応しております。「ダイヤモンド・パール・プラチナ」のいずれのＤＳカードからでもポケモンをあずけることができます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424D4A/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424D4A/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">みんなのポケモン牧場<sup>TM</sup></span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">プラチナ対応版</span></div>
  </div>
