...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157464450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Red de Furries in dit puzzel-avontuur van 60 levels!<BR><BR>Furries zijn schattige groene wezens die graag vreemde planeten bezoeken en vervolgens, zich niet bewust van de gevaren, op onderzoek gaan.<BR><BR>U bent nodig om met behulp van de Wii Remote de touwen, boomstammen, kratten, karren, schakelaars, ventilatoren, ballen en allerlei andere zaken in de levels te beïnvloeden en zo een veilige weg naar de uitgang voor de Furries te creëren. <BR>Bescherm de Furries tegen vreemde galactische wezens, dodelijke putten, enorme explosies en grote druppels anders worden ze het hoofdgerecht van de boze Furax!<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464450/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Save the Furries</span></div>
</div>
