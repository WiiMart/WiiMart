...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157435345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Toma el Wii Remote™ y juega a este juego de billar virtual! Disfruta de las "Partidas", jugando a los clásicos más famosos como el "Bola 9", "Bola 8", "Rotación" y "Snooker", además de superar tiros especiales en el modo "Puzle". Conéctate a la Conexión Wi-Fi de Nintendo para enfrentarte a tus amigos o incluso a oponentes de todo el mundo en las Partidas CWF de Nintendo. Este juego ofrece dos tipos de control, permitiéndote "Golpear" virtualmente la bola blanca con tu Wii Remote, o utilizar los botones para ajustar la fuerza de tu tiro y después "Golpear". Trata de mejorar tus habilidades en el modo "Práctica", aprendiendo así todas las técnicas necesarias para ser un auténtico ganador. Utiliza la característica de edición para crear tus propios desafíos y consigue realizar el tiro que siempre habías soñado lograr. ¡Realiza un tiro asombroso y muestra a todos quién manda en el billar!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">CueSports - Pool Revolution</span></div>
</div>
