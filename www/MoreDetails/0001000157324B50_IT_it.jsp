...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157324B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gioca a palla con i tuoi amici in party game multigiocatore e battetevi per il punteggio più alto utilizzando i vostri personaggi Mii! Scegli tra sei diverse modalità per giocatore singolo e multigiocatore, come Speed Catch, che mette alla prova la tua capacità di afferrare una palla veloce e Bomb Catch, un party game a eliminazione fino a quattro giocatori. Scegli tra tanti personaggi o usa il tuo Mii per giocare ai tuoi giochi preferiti. E se hai sia Let's TAP sia Let's CATCH potrai sbloccare caratteristiche speciali!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
