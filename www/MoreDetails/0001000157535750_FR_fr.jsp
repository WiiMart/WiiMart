...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157535750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dirigez les troupes des Vikings féroces, des Aztèques retors et des Chinois ingénieux et menez-les à la victoire dans une quête délirante tout autour du monde !
<br><br>
Swords & Soldiers est un jeu de stratégie en 2D à défilement horizontal dans lequel vous contrôlez une armée entière dotée d'armes et de sorts plus redoutables les uns que les autres ! Votre objectif : anéantir la base ennemie située à l'autre bout du champ de bataille pour faire triompher vos troupes !
<br><br>
Menez une désopilante campagne solo, affrontez l'IA dans un palpitant mode Escarmouche et défiez vos amis au cours d'intenses combats multijoueur en réseau local ! Et pour ceux qui en voudraient encore plus, les modes Défis à débloquer vous permettent de repousser vos limites pour tenter d'obtenir le meilleur d'entre les meilleurs scores et rejoindre le panthéon des plus grands joueurs de tous les temps !
<br><br>
Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157535750/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157535750/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Swords &amp; Soldiers</span></div>
</div>
