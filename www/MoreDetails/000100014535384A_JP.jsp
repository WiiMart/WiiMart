...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「Mr.Do!」は1982年に株式会社ユニバーサル（現：株式会社ユニバーサルエンターテインメント）から発売された、穴を掘り進めてステージクリアを目指すアクションゲームです。主人公のMr.Do!を操り、武器であるパワーボールや画面内にあるリンゴを使って、迫り来るモンスターを倒しながらゲームを進めていきます。クリア方法は4種類あるので、色々な方法を試してみましょう。<BR><BR>詳細は、<Center>http://www.hamster.co.jp/products/vca.htm</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mr.Do!</span></div>
</div>
