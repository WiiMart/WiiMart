...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157575850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paper Wars Cannon Fodder est un jeu vidéo de type Tower Defense, développé avec incroyablement peu de moyens par plusieurs programmeurs polonais et hongrois externalisés de l'équipe de iFun4all. Quel est donc l'ingénieux objectif du jeu ? Vous ne devinerez jamais... C’est de détruire tous les ennemis ! La même histoire bien connue et palpitante : des hordes d’ennemis féroces essayent de survivre à l’Armageddon ! Il y a plusieurs objectifs supplémentaires à atteindre dans les différentes missions et niveaux – attention, sur votre droite ! Le jeu se joue jusqu’à 4 joueurs en mode coopératif. Si vous avez besoin d'améliorations pour quelques puissances, vous pouvez les débloquer au cours de trois campagnes : Classic, Winter Assault et Cyber Wars. Les graphismes au style « dessiné », la musique militaire à la soviétique et les effets sonores motiveront les joueurs à terminer chaque niveau et à collecter les médailles gratifiant leurs efforts exceptionnels.<br><br>Texte écran en anglais.</div>
  <div id="image02">
