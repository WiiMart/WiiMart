...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D4F4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">もちもちQは簡単操作で誰でも楽しめる、ちょっとブラックでキモかわなパズルゲームです。バラエティに富んだステージは仕掛けたっぷりの楽しいものばかり。しかも全１００ステージもあってボリュームたっぷりです。<BR><BR>■遊びかた<BR>救助ステーションと呼ばれる様々な形の宇宙船を巧みに操縦し、善良な宇宙人”モノ”を救出するのがこのゲームの目的です。邪悪な宇宙人”ダーク・マウス”に近づくと食べられてしまうので気をつけましょう。<BR><BR>２つのボタンを使い、救助ステーションを傾けたり移動させたりし、自分では動く事の出来ないモノを安全なワープホールに導いてあげましょう。<BR>すべてのワープホールの定員を満たすとステージクリアです。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4F4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D4F4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">～あなたが回して救うパズル～</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">もちもちＱ</span></div>
  </div>
