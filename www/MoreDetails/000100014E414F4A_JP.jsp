...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">雪を踏む感触と時間や天候による光の表現が臨場感たっぷりの、リアルな銀世界の中を爽快に滑走する、スノーボードゲームの代表作です。ゲーム中ではアメリカの人気スノーボードメーカー「Ｌａｍａｒ（ラマー）」社の１９９９年モデルを８種類使用可能。プレイヤーはプレイするモードとライダーを選択し、さまざまなコースで速さを競ったり、「トリック」を決めて高得点をめざします。使えるトリックは、手でボードをつかむ「グラブ系」と回転技の「スピン系」を中心に１８種以上。「マッチ・レース」「タイム・アタック」「トリック・アタック」「コンテスト」「２Ｐ対戦」の５つのモードで、ライバルや自分の記録に挑戦しましょう。「タイム・アタック」と「トリック・アタック」では、自分のプレイをゴーストデータとして保存し、表示しながらプレイすることもできます。２Ｐ対戦ではハンディキャップを設定することもできるため、実力差のある相手とでも思う存分に対戦を楽しめます。空中で水平に３回転するスピン系最高難度のトリック「テン・エイティ」（１０８０°）を、ぜひ華麗に決めてください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">テン・エイティ<sup>&reg;</sup>　スノーボーディング</span></div>
</div>
