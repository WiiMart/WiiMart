...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Caratterizzato da molteplici personaggi e un mondo sconfinato da esplorare, Breath of Fire II è il seguito dell’omonimo e popolare gioco di ruolo.<br><br> La storia si apre nel villaggio di Gate, 500 anni dopo la conclusione del primo episodio, con la sparizione del padre e della sorella del giovane Ryu. All’improvviso, quindi, Ryu si ritrova orfano. Gli abitanti del villaggio, però, sembrano essere completamente immemori dell’accaduto. Un giorno, in una chiesa, Ryu incontra Bow, anch’egli orfano e con alle spalle una vicenda molto simile alla sua. I due decidono di fuggire insieme, dando inizio alla loro avventura. L'azione di gioco presenta molteplici punti di vista (come la prospettiva di tre quarti durante i combattimenti, che decretò l’enorme successo del primo gioco della serie) tutti da godere quando userai le tue abilità straordinarie, come la fusione degli sciamani e le trasformazioni in drago, per aiutare i nostri due eroi a portare a termine la loro missione!
<br><br>
Il testo all'interno del gioco è in inglese.
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424B50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Breath of Fire<sup>TM</sup> II</span></div>
</div>
