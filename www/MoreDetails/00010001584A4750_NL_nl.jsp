...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001584A4750')", "wiiSelectSound()");
...
<br><br>
Welkom in de wereld van Gnomz. Gnomz is een nieuw en spannend arcade vechtspel voor de WiiWare™-dienst. In Gnomz kunnen maximaal vier spelers in drie verschillende speltypes tegen elkaar en/of de computer spelen.<br><br>
Kenmerken:<br><br>
* real-time actie multiplayer platform-vechtspel met gnomen.<br>
* 25 gnoomse arena's, boordevol actie.<br>
* uren lang gnomen slopen, meppen, bumpen en dumpen.<br>
* maximaal 4 spelers (+ 4 computerspelers), via lokaal netwerk.<br>
* magische power-ups, vliegende olifanten, regenbogen en fonkelende rendieren.<br>
* Smash Match, Capture the Sock, Socker (sokken verzamelen)<br>
