...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574A5350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jungle Speed® es un veloz juego de cartas para toda la familia, donde rápidos reflejos y una vista aguda te harán triunfar.<br><br>Voltea tus cartas, observa a tus oponentes y toma el tótem en el momento correcto para ganar el juego. Justo cuando pienses que todo está bajo control, una nueva carta puede cambiar las reglas y ponerte en emocionante suspenso. <br><br>El juego comienza cuando un jugador revela su primera tarjeta. Los competidores voltean por turnos sus tarjetas hasta que dos de los símbolos expuestos coincidan. Los jugadores cuyos símbolos coincidieron deben entonces competir para ser el primero en agarrar el tótem en el centro de la mesa; el perdedor se quedará con las tarjetas del ganador y todas las tarjetas del pozo. <br><br>Con las garras y pezuñas volando, la primera persona que consiga librarse de todas sus tarjetas ganará el juego.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574A5350/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574A5350/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Jungle Speed<sup>&reg;</sup></span></div>
</div>
