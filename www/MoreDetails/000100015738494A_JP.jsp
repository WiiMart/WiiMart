...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015738494A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">熱血将棋漫画「ハチワンダイバー」をゲームで再現。マルチシナリオを採用したストーリーモードで真剣師達と繰広げられる将棋バトルを体感できます。将棋初心者でも楽しめるように指し手を二択で選択できる「イージーガイド」を搭載し、誰もが原作の熱い将棋バトルを楽しめます。さらに「みるく」の将棋教室を搭載し、ルールを知らない人でも覚えることができ、その日から真剣師達の戦いに参加できます。また、真剣師達と個別に勝負したい場合は「キャラクターモード」で対局を行うことも可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015738494A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015738494A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ハチワンダイバーWii</span></div>
</div>
