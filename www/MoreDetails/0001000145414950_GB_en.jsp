...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">When their home planets are attacked by the evil Captain Klapton, space bounty hunters Roddy and Cathy spring into action to save the galaxy!
<br><br>
This comical side-scrolling arcade game features action across both foreground and background planes, which you can switch between at the press of a button. Play solo or simultaneously with a friend as you jump, bash and blast your way through worlds of forest, ice, wind and fire.
<br><br>
Use your extendable arms to pull switches, grab power-ups or to even lob enemies at each other. Unleash powerful special moves and look out for secret bonus games, too!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
