...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157344150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ARCADE SPORTS consists of a selection of four fully featured classic arcade sports games including Air Hockey, Bowling, Pool and Snooker.
<br><br>
AIR HOCKEY<br>
- Standard Rules<br>
BOWLING<br>
...
<br>
PRACTICE<br>
This mode allows you to play a practice game and brush up on your skills.<br>
VERSUS MATCH<br>
A one-on-one ‘friendly’ match versus any of the game opponents in any game type.<br>
SEASON MODE<br>
The Season Mode is a series of linked tournaments with 10 tournaments to play of mixed game types. The objective is to make it to the top and become Number 1 ranked.<br>
Play through each event in turn, and after each one you are awarded a world ranking position and achievement rewards.<br>
MULTIPLAYER<br>
Arcade Sports allows up to 2 players to compete head-to-head in a versus match on one Wii console.</div>
  <div id="image02">
