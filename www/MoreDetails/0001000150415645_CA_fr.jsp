...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Brave the streets of New York City in this side-scrolling beat-'em-up game. Thugs have kidnapped your beloved Madonna, and it’s up to you to become a VIGILANTE. Fight your way into enemy territory to get her back! Enemies attack you with weapons like iron pipes, chains, guns, and motorcycles. To fight back, you can punch, kick, or use the “nunchaku” item that appears in the stage. Use each of your attacks effectively to defeat your enemies. To clear a stage, defeat the boss that awaits you at the end. Fight your way through exciting stages that include the City Streets, Junkyard, Brooklyn Bridge, and the Backstreets.</div>
  <div id="image02">
