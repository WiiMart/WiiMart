...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un malvado pirata del espacio, Greedy, ha corrompido a los reyes de los siete planetas del sistema Valdi y ha esclavizado a la gente que vive allí. La falta de un héroe se ve resuelta por Ristar que utiliza sus increíbles brazos extensibles y valentía para salvar a Valdi de las manos de Greedy.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
