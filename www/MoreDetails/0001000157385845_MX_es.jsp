...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157385845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Battle Poker es un juego de cartas para hasta cuatro jugadores, quienes deberán combatir contra el reloj para hacer la mejor mano posible con cinco cartas. Los combates se darán a través de múltiples rondas con puntos asignados para cada ronda, según la calidad de la mano. Cada jugador utilizará un Wii Remote para apuntar y hacer clic en una baraja de cartas estándar establecida por la pantalla. Haz clic en la primera carta, esto la volteará y no podrá ser tomada por nadie más. Tienes que estar alerta para tomar las cartas que necesitas antes de que alguien más las tome de ti.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157385845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157385845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Battle Poker</span></div>
</div>
