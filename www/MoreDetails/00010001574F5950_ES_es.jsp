...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F5950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡¡Prepárate para el viaje más espectacular a través del tiempo en la historia de los videojuegos!! <br>
Acompaña al Bit Boy Kubi en una aventura locamente pixelada y lucha contra hordas de horribles monstruos en:<br>
<br>
- Mazmorras de 4 bits,<br>
- cuevas de 8 bits,<br>
- fortalezas de 16 bits,<br>
- laberintos de 32 bits,<br>
- anfiteatros de 64 bits y<br>
- mundos 128 bits<br>
<br>
¡¡Rescata a los amigos de Kubi!! <br>
¡¡Parte en la persecución definitiva de frutas y récords!!<br>
¡¡Llama a un amigo para divertirte aún más en modo Cooperativo!!<br>
<br>
¡¡El mando de Wii es tu joystick, que empiece la aventura arcade!!
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F5950/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F5950/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bit Boy!!</span></div>
</div>
