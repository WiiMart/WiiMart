...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Experimenta las aventuras originales del Dios Mono en este juego repleto de acción con desplazamiento lateral. ¡Cambia rápidamente entre diferentes niveles de juego para disparar a peligrosos enemigos de frente! Con un original concepto, este juego recreativo retro con un toque estrafalario, se vuelve a lanzar por primera vez en el mundo occidental desde su debut en 1984.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145353745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145353745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SONSON<sup>TM</sup></span></div>
</div>
