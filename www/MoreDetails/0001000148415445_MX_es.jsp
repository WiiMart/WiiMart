...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000148415445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Hay una actualización disponible que facilitará a los usuarios nuevos la descarga de este canal. Si tu última actualización es posterior al 14 de septiembre de 2009, no apreciarás ningún cambio si actualizas ahora.  Para obtener más información visita support.nintendo.com.
<p>
Con el Canal Nintendo, puedes aprender sobre nuevos productos y servicios, además de recibir información sobre Nintendo y otras compañías. Ve un clip de vídeo (ahora disponible en alta calidad) de una variedad de títulos ambos nuevos y viejos, usa una variedad de opciones de búsqueda para revisar información detallada acerca de casi cualquier juego que te puedas imaginar, y obtén recomendaciones de otros títulos que puedas disfrutar basadas en encuestas enviadas por usuarios como tú.
<p>
Usado en conjunción con el Canal Internet, el Canal Nintendo puede automáticamente dirigirte a sitios web de títulos específicos, y a sitios de comercio en línea donde puedes comprar aquel título directamente. ¡Adicionalmente, el Canal Nintendo puede transmitir demos de juegos para el Nintendo DS directamente desde tu Wii hacia tu Nintendo DS para que puedas ver de cerca los juegos que te llamen la atención!
<p>
Con el Canal Nintendo, ¡es muy fácil de descubrir títulos de Wii, WiiWare, de la Consola Virtual, de Nintendo DS, y de Nintendo DSi que encajen con tus gustos perfectamente!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415445/FFFD0018" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415445/FFFD0019" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canal Nintendo</span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Canales Wii</div>
</div>
</body>
</html>
