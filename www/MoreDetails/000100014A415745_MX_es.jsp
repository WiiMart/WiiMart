...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Romance of the Three Kingdoms IV es un juego táctico de simulación en el que el jugador toma el rol de un gobernador que busca unir a China en la era de los tres reinos de Wei, Wu, y Shu. Tu función como gobernador es dirigir un rango de oficiales con distintas características – unos astutos estrategas, otros valientes guerreros – y fortalecer el poderío militar de tu reino. La política exterior, que incluye formar alianzas con ciertos reinos y caer planes para debilitar a otros, tendrá un papel importante en este proceso. Una vez que hayas desarrollado una milicia lo suficientemente poderosa, será tiempo de expandir tus fronteras a través de conquistas militares. La victoria final será obtenida solamente cuando las 43 ciudades en China estén bajo tu control.<p>
Este juego es de 1 a 8 jugadores. Para jugar entre varios jugadores, se usa 1 control, que es pasado entre los jugadores cuando llega su turno.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A415745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A415745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ROMANCE OF THE THREE</span></div>
</div>
