...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ZANAC es el juego de tiroteo de acción vertical que se lanzo en Noviembre 1986. Apodérate del luchador de tecnología avanzada, ZANAC, con el objetivo de destruir las bases de las mecanizadas fuerzas enemigas. Usa tu colección de armas regulares al igual que 8 armas especiales para pasar las 12 intensas áreas del juego. Ten mucho cuidado, ya que la dificultad del juego cambia dependiendo en que tan bien juegas. ¡Esto asegurará que el juego se sienta como que estás experimentando algo nuevo cada vez que juegas!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146423545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146423545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ZANAC</span></div>
</div>
