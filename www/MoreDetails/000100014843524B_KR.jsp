...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">본 채널은 『젤다의 전설 스카이워드 소드』를
구입해 주신 고객님을 대상으로 하는 채널입니다.<BR>
<BR>
본 채널은 『젤다의 전설 스카이워드 소드』를 플레이 중에  게임의 진행 방식에 따라서는 「용사의 노래」를 완성시키는 이벤트에서 「사막」의 뇌룡에게 「용사의 노래」를 얻은 후, 「화산」및 「숲」에서 일어나야 하는 「노래」 이벤트가 일어나지 않고 더 이상 진행할 수 없게 된 저장 데이터를 정상적인 상태로 복구시키기 위한 채널입니다. 『젤다의 전설 스카이워드 소드』를 구입하지 않으신 분은 본 채널을 이용하실 필요가 없습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843524B/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
