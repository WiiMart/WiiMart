...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８７年に登場したアクションゲームです。カプコンでは初めて「買い物ができる」ゲームで、カプコンゲームの通貨名称『ゼニー』が登場する等、記念すべき作品と言えます。主人公『ブラックタイガー』を操作し、闇の中に葬られた王国に光と平和を取り戻す事が目的です。強力な武具やアイテムを購入し、『ブラックドラゴン』を討伐しましょう。国内では家庭用ゲーム機への移植が行われていませんでしたが、このバーチャルコンソールアーケードで初の移植となります。<BR><BR>詳細は、<Center>http://www.capcom-onlinegames.jp/category/wii.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブラックドラゴン</span></div>
</div>
