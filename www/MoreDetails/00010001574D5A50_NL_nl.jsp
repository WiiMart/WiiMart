...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574D5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ontspan met Mahjong, een van de meest geliefde klassiekers op spellengebied. 
<br><br>
Laat je hersens kraken met 30 verschillende 3D Mahjong puzzels met miljoenen verschillende mogelijkheden. De speelstijl en interface zijn speciaal ontworpen voor intuïtief gebruik van de Wii-afstandsbediening. Met een druk op de knop zoom je in. Je kunt kiezen uit zes soorten stenen en een grote verscheidenheid aan achtergronden om het spel aan je voorkeuren aan te passen.
<br>
Wil je een extra uitdaging? Speel dan de extra minigames "Memory" en "Matching".
<br><br>
Ga zitten, ontspan... en geniet van de nimmer eindigende uitdaging en het spelplezier van deze Mahjong verzameling.<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
