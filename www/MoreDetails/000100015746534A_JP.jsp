...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015746534A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「みんなのシアターWii」は、インターネットを使ってさまざまな映画やアニメを好きなときに見ることができるソフトです。さくひんは随時、追加・更新されます。<BR><BR>●さくひんは、｢マイシアター」のジャンルやランキングから選びます。みたい作品がきまったら、利用チケットを購入しましょう。こうしてみることができるようになった作品は、「マイシアター」のスクリーンに追加されます。<BR>●「くわしいないよう」で、さくひんのあらすじや、長さを確認することができます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015746534A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015746534A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">みんなのシアターWii</span></div>
</div>
