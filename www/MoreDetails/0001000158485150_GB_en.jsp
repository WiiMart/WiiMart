...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158485150')", "wiiSelectSound()");
...
<br><br>
Cut scenes, music with lyrics, seven playable characters, hidden levels, final bosses, different weapons, lots of zombies attacking you at all times, explosions, demolitions, fire...</div>
  <div id="image02">
