...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157324B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Speel vangbal met vrienden in de multiplayerpartygames en ga voor de hoogste scores met je Mii en andere personages! Kies uit zes verschillende solo- en multiplayermodi zoals Speed Catch, waar je snelheid op de proef gesteld wordt, en Bomb Catch, een eliminatiepartygame voor maximaal vier spelers. Selecteer een van de vele personages of gebruik je Mii-personage om andere games te spelen. Als je zowel Let's TAP als Let's CATCH hebt, speel je speciale functies vrij!<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
