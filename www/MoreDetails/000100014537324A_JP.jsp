...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">一人称視点のガンシューティングゲーム。艦隊やアステロイドの間をくぐり抜けていく戦闘機の砲手となり、連邦惑星系上に出現した機動惑星「レッドアイ」の破壊をめざします。画面内に現れる敵機や砲台に照準を合わせ、ボタンを押してレーザービームで攻撃してください。レーザービームは連射する事もできます。敵からの攻撃を受けるとシールドの残量が減り、シールドが全て無くなるとゲームオーバーです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スターブレード<sup>&reg;</sup></span></div>
</div>
