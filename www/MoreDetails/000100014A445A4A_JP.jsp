...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">地・水・火・風、４つのクリスタルが、悪の王ダークキングの手に落ちた<BR>緑は消え、水は凍り、炎は舞い、風は荒れ狂う<BR>不思議な老人から勇者の啓示を受けた少年は、平和を取り戻す長い旅に出かけた<BR><BR>アメリカ版ファイナルファンタジーとして発売されたゲームの日本語翻訳版。重厚なストーリーが楽しめるのはもちろん、アクション要素も満載。バトル中に敵のＨＰ状態が目で見てわかるなど、ＲＰＧ初心者にも親切設計となっています。 <BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A445A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A445A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファンタジー<sup>&reg;</sup>USA</span></div>
</div>
