...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">重装機兵（アサルトスーツ）「ＡＳ１１７」に乗り込み、全７ステージを突破していくＳＦアクションゲームです。枯渇した資源をめぐって巨大陣営が対立する近未来、
プレイヤーは装甲機兵小隊の一兵士として戦火に身を投じます。作戦開始時のブリーフィングで状況や攻撃目標などを確認すると、いよいよ出撃。自機に装備されているシールドや全４種類のウェポンを駆使してステージクリアをめざします。各ウェポンはステージ上の「パワーチップ」を集めることで最大３レベルまで強化可能。
特定のウェポンを集中的に強化するか、全体を同時にパワーアップさせていくかはプレイヤーの判断にゆだねられています。臨場感あふれるＢＧＭをはじめ、壁に残る弾痕や飛び散る薬きょう、戦闘中の緊迫した通信など、ミリタリーテイストを凝縮した演出がハードな世界観とストーリー展開を彩り、好評を博しました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">重装機兵ヴァルケン</span></div>
</div>
