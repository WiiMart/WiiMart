...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９４年にリリースされた、数々のゲームを送り出してきたＳＮＫの集大成ともいえる２Ｄ対戦格闘ゲームです。「餓狼伝説」「怒」「サイコソルジャー」「龍虎の拳」などの作品から、主役級キャラクターが３人１組のチームを組んで参戦し、腕を競います。また、本作のみに登場するオリジナルチームも用意されています。３対３のチームバトルシステム、ためることで攻撃力を増加できるパワーゲージ、一発逆転の超必殺技といったユニークなシステムは、以後の格闘ゲームに大きな影響を及ぼしました。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ・キング・オブ・ファイターズ '94</span></div>
</div>
