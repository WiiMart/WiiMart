...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157425650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Llega a todo gas SPOGS Racing, un nuevo juego de carreras de D2C Games en el que encontrarás carreras arcade clásicas, controles sencillos de manejar, vehículos novedosos y mejoras instantáneas Choca y agarra. Móntate en el vehículo, mete la primera y modifica tu bólido sobre la marcha mientras compites contra otros jugadores en una experiencia de carrera totalmente extravagante en tu sistema Wii. Tanto si eres un jugador casual como un piloto empedernido, SPOGS Racing tiene diversión para todos y es una descarga imprescindible para tu biblioteca digital de juegos WiiWare.
<br><br>
