...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dies ist der vierte Teil aus der Arcade-Reihe World Heroes, der 1995 veröffentlicht wurde. In diesem Spiel kämpfen 16 historische Charaktere um den Titel des weltbesten Kämpfers. In vorherigen Spielen war für deine Angriffsstärke die Dauer, wie lange du einen Knopf gedrückt hattest, wichtig. Aber dieses System wurde dieses Mal nicht übernommen. Ergänzend zu der eher herkömmlichen Steuerung von Kampfspielen, die durch Drücken verschiedener Knöpfe schwache, mittlere und starke Attacken ermöglicht, wurden dieses Mal brandneue Elemente eingeführt: Heldenbalken, Extra-Attacken und Blockbrecher-Attacken ermöglichen dir, das Spiel mit neuen Strategien zu erleben!<br><br> Englischer Bildschirmtext.</div>
  <div id="image02">
