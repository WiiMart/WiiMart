...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おなじみ音速のハリネズミ「ソニック」が、マスターシステムで活躍するシリーズ第三弾。スピード感抜群のアクションゲームです。ロケットシューズ、ホッピング、スーパースピンダッシュなど、本作だけの新アイテム・新アクションに加え、ソニックの頼れる相棒「テイルス」を選んでプレイすることもできるようになりました。テイルスは、シッポのプロペラを使ってどこでも飛行が可能なので、ソニックとは違うプレイ感覚で楽しめます。なお本作は、ゲームギアで発売された『ソニック＆テイルス』をマスターシステム用に移植し、海外で発売されたものです。ソフトの内容はゲームギア版とほぼ同一のものとなっています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
