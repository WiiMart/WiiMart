...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157444850')", "wiiSelectSound()");
...
<br><br>
Art Style: ROTOHEX ist ein rasantes Puzzle für einen oder zwei Spieler. Versuche, durch geschicktes Rotieren, die herunterfallenden bunten Dreiecke zu gleichfarbigen Sechsecken zusammenzufügen, um sie verschwinden zu lassen. Je mehr Farbvarianten auftreten, desto größer ist die Herausforderung!
<br><br>
Schalte im Solo-Modus neue Spielvarianten wie den Endlos-Modus oder den noch anspruchsvolleren Sprint-Modus frei, oder tritt im Vs.-Modus gegen einen Freund an - wer schneller reagiert, gewinnt!
<br><br>
