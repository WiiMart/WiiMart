...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157415445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Astro Bugz Revenge is an action-puzzle game with a retro vibe. Protect our solar system from astro bugz and blast them by matching three or more bugz. Pick up valuable power-ups and activate them to annihilate the incoming invaders. Flip to the other side in Revenge mode and play as the bugz. Test your skills against your friends by playing Co-Op or Versus mode. The mechanics of this action packed game will surely keep you challenged.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157415445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157415445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Astro Bugz Revenge</span></div>
</div>
