...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B4645')", "wiiSelectSound()");
...
<br><br>
Kung Fu Funk en un juego descabellado basado en las películas de Kung Fu de los años 70. Reta hasta tres de tus amigos para ver quién se convierte en el mejor maestro de Kung Fu. Hay que superar muchas pruebas en tres modos de juego locos. Como en cualquiera de las películas de Kung Fu, empezarás aprendiendo las artes Zen, un modo relajado donde puedes familiarizarte con los controles. Cuando tu técnica esté al día podrás ingresar en el montaje de la película de entrenamiento de Kung Fu que consiste en locos minijuegos. Y una vez que domines tus habilidades y técnicas de combate podrás luchar en la mejor batalla del siglo como instructor en tu propio disco Kung Fu Dojo.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B4645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B4645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Kung Fu Funk<sup>TM</sup>: Everybody is Kung Fu Fighting!</span></div>
</div>
