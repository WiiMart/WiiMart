...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En el año 2049, la humanidad se ve obligada a abandonar el sumamente contaminado planeta Tierra y buscar otros planetas para colonizar, mientras los mecanizados Orbots permanecen en ella para descontaminarla. Cuando el líder de los Orbots, WarHead, le empiezan a explotar unas tuercas en la cabeza y causa una guerra entre los hermanos de maquinas, un piloto de residuo con el nombre de Vectorman es el único dispuesto a pelear contra él. Te transformarás en un tren de alta velocidad, una potente perforadora, un pescado mecánico, y un poderoso vehículo todo-terreno en esta aventura épica llena de acción. ¡Equípate con armas, recoge morphs (transformadores) y mejoramientos para derrotar a WarHead y restaurar la paz en la Tierra!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D415345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D415345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
