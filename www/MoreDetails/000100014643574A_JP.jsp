...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気のアクションゲーム「スーパーマリオブラザーズ」シリーズの第三弾。登場するキャラクターや操作感はそのままに、数々の新要素が追加されて大きく進化しました。今回のマリオのパワーアップは「しっぽマリオ」や「カエルマリオ」なども加わり大変ユニーク。しっぽを回して空を飛び、普通では行けないような場所に行けたり、水中を驚くほどスイスイと泳ぐこともできます。アクションではＢボタンで物を持ったり、放して投げたりすることも可能に。また各コースはマップ上に配置されていて、キノコワールドの８つのワールドの中を、コースやイベントパネルを選んですごろくのように行き来し、アイテムを活用しながら自分の好きな順番でクリアしていくことができます。大魔王クッパとコクッパ７兄弟に奪われた７本の「魔法の杖」を取り戻し、ピーチ姫を助け出しましょう。マリオとルイージで交代で冒険する２人プレイでは、協力するか競い合うかはプレイヤー次第。「なつかしのマリオブロスゲーム」などのバトルモードがカギとなります。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーマリオブラザーズ<sup>&reg;</sup>３</span></div>
</div>
