...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questa è la decima puntata intrisa d’azione della famosissima serie Castlevania, che descrive l’epica lotta tra il clan di Belmont e le forze oscure del Conte Dracula! Un classico che si riconosce sempre, per la spettacolarità della resa del suo mondo, la difficoltà di gioco estremamente bilanciata e le musiche di alta qualità.
<br><br>
Il giocatore veste i panni di Richter, l’ultimo ammazzavampiri del clan, e lo guida attraverso 13 scenari pieni di trappole pericolose e di segreti nascosti.
Con la tua leggendaria frusta, tramandata da generazioni di Belmont, e con un'ampia scelta di attacchi Rottura Oggetti, toccherà a te sconfiggere Dracula e la sua orda malvagia.
<br><br>
Inoltre, questa volta il nostro eroe non è solo! Salvando Maria Renard, potrai usarla come personaggio giocabile per divertirti ancora di più a dare la caccia ai vampiri! 
<br><br>
Il testo all'interno del gioco è in inglese e parzialmente in giapponese.</div>
  <div id="image02">
