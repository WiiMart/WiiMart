...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cette nouvelle version du fameux « Lode Runner » offre un nouveau mode à 5 joueurs.
On a dérobé l'or qui servait à financer le Centre de Recherche sur la Machine à Remonter le Temps ! De plus, les voleurs ont utilisé une machine pour cacher les lingots d’or à travers les époques. Le centre n'a pas d'autre choix que d'envoyer leur meilleur équipe de « Runner » à la recherche des lingots disparus !
<br><br>
En plus du populaire mode «PUZZLE», ce jeu propose un mode «BATTLE» où 5 joueurs peuvent s’affronter les uns contre les autres, ainsi qu’un mode «EDIT» avec lequel vous pouvez créer vos propres niveaux originaux.
Amusez-vous avec le mode «BATTLE» de plusieurs façons. Éliminez vos adversaires et soyez le dernier joueur restant dans le mode «SURVIVAL».<br> Volez les objets aux ennemis puis échappez-vous avec le mode «ESCAPE».<br> Jouez à quatre joueurs pour former deux équipes qui s’opposeront dans le mode «TAG MATCH».
<br><br>Pour des batailles multijoueurs, vous devez connecter un nombre de télécommandes Wii ou de manettes Nintendo GameCube égal au nombre de joueurs.
Pour jouer à 5 joueurs, vous avez besoin d'au moins une manette Nintendo GameCube.
<br><br>Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BATTLE LODE RUNNER<sup>&reg;</sup></span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Turbografx (PC Engine)</div>
</div>
</body>
</html>
