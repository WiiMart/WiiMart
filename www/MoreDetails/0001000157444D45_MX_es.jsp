...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444D45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El doctor está listo! Mario toma un descanso de sus aventuras y se pone una vez más su estetoscopio para una nueva generación de combate de bacterias. Además del modo clásico de utilizar vitaminas para exterminar bacterias, encontrarás dos modos de batalla y un modo en línea de multijugador, donde puedes probar tus habilidades contra jugadores de alrededor del mundo. ¿Tienes ganas de desafiar a un amigo que no tiene a Dr. Mario Online Rx? Entonces el Desafió - Demo exclusivo de WiiWare es justo lo que el doctor ordenó. ¿O quizás quieres ayuda para combatir esas bacterias desagradables? Prueba Bactericida, donde hasta cuatro jugadores pueden mover simultáneamente las cápsulas simplemente usando el mando de Wii. ¡De cualquier manera, el Dr. Mario Online Rx es una receta para la diversión que todos pueden disfrutar!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444D45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444D45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dr. Mario<sup>&reg;</sup> Online Rx</span></div>
</div>
