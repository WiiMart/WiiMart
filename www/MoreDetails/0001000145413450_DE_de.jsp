...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dies ist ein Kampfspiel, das 1995 als Fortsetzung des im Vorjahr erschienenen Samurai Shodown II herausgebracht wurde. Obwohl dies die dritte Veröffentlichung dieser Serie ist, findet die Handlung zwischen dem ersten und dem zweiten Teil statt. Der Spieler kann zwischen zwölf Samurai wählen, die danach streben, Zankuro Minazuki zu besiegen.<br> Zusammen mit kleineren Upgrades der letzten Version, wie der Fähigkeit, durch das Drücken von Knöpfen den Wut-Balken zu füllen und der Möglichkeit, im Sprung zu blocken, kann man für jeden Charakter zwischen den Persönlichkeits-Typen "slash" und "bust" wählen. Jeder Typ hat sein eigenes Set von Spezialtechniken, die du zu deinem Vorteil nutzen kannst, was effektiv die Anzahl der zu spielenden Charaktere verdoppelt.
<br><br>
Englischer, spanischer, portugiesischer, japanischer und koreanischer Bildschirmtext stehen zur Auswahl.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
