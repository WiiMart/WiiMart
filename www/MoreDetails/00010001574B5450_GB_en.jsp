...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574B5450')", "wiiSelectSound()");
...
<br>
<br>
- Choose from 2 playable characters: Bill Rizer and Lance Bean
<br>
<br>
...
<br>
<br>
- Weapons include standard machine gun, shot gun, homing missiles and laser</div>
  <div id="image02">
