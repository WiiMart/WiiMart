...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157574C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tu joues Frankie, le héros de l'aventure. Frankie est un jeune orphelin qui doit aider son arrière arrière-grand-oncle, le professeur Frankenstein, à construire une étrange machine.<br>
Pour l'aider, le professeur lui
donne un « Steampack » : un
dispositif qui est capable
d'aspirer les vaporites
(d'étranges nuages qui
détériorent les infrastructures de
l'archipel) et de déterrer des
trésors.<br><br>Texte écran en français.</div>
  <div id="image02">
