...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This fast-paced fighting game, a sequel to the well-loved Fighter's History, takes place once again at the Great Grapple martial arts tournament. This time, thirteen combatants have emerged to test their skills against the best of the best in a series of dramatic showdowns!
<br><br>
Notable playing features include a wide range of secret attacks, a weak spot system that assigns a vulnerable area to each fighter, and the introduction of bosses Clown and Karnov from the original as playable characters.
<br><br>
Clear certain conditions and the bull from the bonus stage of the Data East classic Karate Champ will also make a special appearance!</div>
  <div id="image02">
