...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Een honderd procent geslaagde overzetting van het beroemde en meesterlijke schietspel uit de speelhallen, dat tot in de kleinste details hetzelfde is als het origineel: R-TYPE. Vernietig de pantsers van zes verschillende voorwerpen waarmee je jouw R-9 ruimteschip kunt versterken. Plaats hun energie (de Force) voor of achter je R-9, om je aanvalskracht te vergroten of je verdediging te versterken. Knal erop los met je reflecterende laserstralen, en lucht-grond- en anti-vliegtuiglasers. Blijf op de vuurknop drukken om het spervuur te openen met je straalkanon, of houd de knop ingedrukt om de straalmeter op te laden en een allesvernietigend schot te lossen met je golfkanon! Hoe langer je de vuurknop ingedrukt houdt, des te krachtiger is het schot! R-TYPE staat bekend om de lastige eindbazen die je her en der opwachten. Om nog maar te zwijgen over het gebied waarin je het moet opnemen tegen een gigantisch oorlogsschip!
<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">R-TYPE<sup>&reg;</sup></span></div>
</div>
