...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">リアルで多彩な攻撃が見どころの、『双截龍』というタイトルでも知られる横スクロール型格闘アクションゲームの草分け的存在です。荒れ果てた近未来の街を舞台に、クン・フー道場を営む主人公「リー兄弟」が、誘拐された恋人「マリアン」を助け出すために悪の暴力組織「ブラックウォリヤーズ」に立ち向かいます。マップに落ちているアイテム、武器を拾っての攻撃や、強烈な回し蹴りや投げ技、倒れた相手へと馬乗りになるなど、シンプルな操作で痛快なプレイが楽しめます。ゲームモードは本編を１人、もしくは２人のプレイヤーが交互に遊ぶことができる「モードＡ」と、ボスキャラクターとの一対一の対戦プレイとなる「モードＢ・ＶＳモード」が楽しめます。２人での対戦プレイも可能で、個性豊かなボスキャラクターたちを操作してのプレイも本作の魅力です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダブルドラゴン<sup>&reg;</sup></span></div>
</div>
