...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157425350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pop is all about popping bubbles! It may sound simple but there are lots of things you can do to get a high-score and have fun. Just keep an eye on the timer because when it runs out it's game-over!<br>

Each bubble is worth both points and time so try to fill up your timer first then focus on scoring high. You can then start to chain the same colour of bubble for big points by popping bubbles of the same colour. This is a great way to increase you score.<br>

Friends can join you in a game of Pop too! Whenever you are playing all they need to do is connect their Wii Remote and then join in the action. Watch out because they may start using power-ups to hold you back! If they do try to pump up some bubbles or detonate a nuke this will create a shock-wave which will destroy any matching colours of bubbles it touches.<br>

Finally there are badges for completing certain objectives; online high-score tables and WiiConnect24 messages so you can keep up with your friends progress and boast about your own.</div>
  <div id="image02">
