...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Double Dragon is one of the most popular arcade-style action fighting games ever, and has been used as a classic model for subsequent beat'em-up games. Published initially as an arcade title only, it's huge success has allowed the game to be converted across multiple platforms.
<br><br>
...
<br><br>
Double Dragon features 2 player co-op and offers a deep combat system based on punches, kicks and many weapons and interactive items. Moreover, the story will take the player to visit and explore many different locations, from the city suburbs to the mountains.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
