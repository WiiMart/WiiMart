...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157364245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Las latas vacías de la tierra han cobrado vida gracias a los Cannoids, una raza alienígena decidida a destruir el planeta. Mack, un técnico de la instalación de reciclaje Plant 530, es la última esperanza de la Tierra. Toma el papel de Mack en este juego de disparos en primera persona y enfréntate a los extraterrestres invasores, armado con tu cañón de reciclaje y tu fuerza de voluntad. Dispara y aspira para conseguir la victoria, y recuerda que cada disparo cuenta: tu munición también representa tu barra de salud, y cada enemigo que destruyas dejará caer energía que puedes aspirar y utilizar como munición. Con sus controles simples (y la posibilidad de utilizar el Wii Zapper de manera opcional), cualquier jugador podrá salvar la Tierra. Además, las técnicas avanzadas como los combos y el modo Desafío supondrán el reto incluso para los jugadores más experimentados. ¿Serás capaz de salvar la Tierra?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157364245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157364245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Eco Shooter: Plant 530<sup>TM</sup></span></div>
</div>
