...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Salva Blobolonia! Blob ha llegado desde el lejano planeta Blobolonia en búsqueda de un joven terrícola que pueda ayudarle a salvar su mundo. Únete a él en esta fantástica aventura, busca tesoros en misteriosas cavernas subterráneas y viaja hasta Blobolonia para derrotar al malvado emperador. Descubre el increíble apetito de Blob y las transformaciones que sufre dependiendo del sabor del dulce que le lances. ¡Aprende a usar estas habilidades y podrás superar cualquier obstáculo! A Boy and his Blob es un viaje fantástico lleno de sorpresas y divertidos personajes.</div>
  <div id="image02">
