...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Frayez-vous un chemin à travers les environnements colorés et pleins d'action de ce classique des jeux d'arcade, paru en 1987. Explorez des niveaux gigantesques et investissez l'argent durement gagné dans des objets qui vous aideront à vaincre des boss redoutables, dans la droite lignée de Ghosts'n Goblins.
