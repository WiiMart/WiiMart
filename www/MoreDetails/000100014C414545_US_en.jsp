...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In this platformer from the 1980s, you’re Alex Kidd, looking for your lost brother Egle. In order to find your brother, you’ll have to contend with the evil Janken the Great, who will send his henchmen and monsters at you to thwart your progress. One aspect of this adventure is that you’ll have to play the classic game of “rock, paper, scissors” against the henchmen in order to defeat them. With 16 different levels to conquer in order to save Egle, this classic is sure to test your skills and wits at the same time!
<p>
Please note, Alex Kidd in Miracle World is presented as it was originally released in 1986. Modifications included in the Sega Master System "built-in" version are not reflected in this release.</div>
  <div id="image02">
