...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157423450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Estrai il tuo revolver e scopri chi è la pistola più veloce del West! Migliora la tua velocità e precisione facendo pratica con i bersagli che appariranno nel gioco: colpiscili tutti per guadagnare più punti possibile. Puoi sparare ad ogni elemento dello scenario perciò assicurati di esplorare ogni ambiente, per scoprire tutti gli oggetti che ti possono far guadagnare più punti. Ma fai attenzione, dovrai colpire solo i tuoi nemici e non i cittadini onesti o le belle fanciulle! Partecipa ad un classico assalto al treno in stile vecchio West o metti alla prova le tue abilità di pistolero in una serie di sfide sempre più impegnative nei più classici scenari Western. Superando le sfide, potrai guadagnare medaglie e ricompense, per un'avventura senza fine. Prova la modalità per 2 giocatori dove potrai giocare insieme ad un amico con cui realizzare nuovi record o sfidarlo per scoprire chi è la pistola più veloce del West.
<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157423450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157423450/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wild West Guns</span></div>
</div>
