...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">MUSHA es un juego de SEGA GENESIS, preferido entre los aficionados de los juegos de tiros por su experiencia intensa y emocionante. En él te encargarás de controlar a Terri, una chica que controla una MUSHA (armadura superhíbrida de armazón metálico único). El objetivo de Terri es eliminar a Dire 51, una “Intellicomputer” (computadora inteligente) que está fuera de control y planea un ataque contra la humanidad. Usa las armas especiales como el Vanishing Buster (Caza desvanecedor), el Blazing Beam (Rayo abrasador) y el Defensive Detonator (Detonador defensivo), así como una serie de sondas ofensivas que te permiten realizar seis tipos de formaciones de ataque a lo largo de 7 niveles estimulantes. ¡Con ellas podrás alcanzar y destruir a la nefasta Dire 51 para siempre!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
