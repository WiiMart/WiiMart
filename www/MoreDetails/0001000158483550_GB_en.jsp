...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158483550')", "wiiSelectSound()");
...
<br>
Use the Wii Remote like a magic wand to tilt the world. Explore beautifully crafted environments. Survive 20 challenging levels full of strange creatures, traps and puzzles. Unlock bonus levels, competitive playmodes and surprising modifications that change the entire game.
<br>
Turn your world upside-down with And Yet It Moves!</div>
  <div id="image02">
