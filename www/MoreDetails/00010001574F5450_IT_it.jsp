...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574F5450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Overturn Mecha Wars è un torneo con combattimenti testa a testa in cui i giocatori controllano mech futuristici equipaggiati con le armi più moderne e letali.
<br>
Lo scopo del gioco è sconfiggere gli avversari cercando di evitare i loro attacchi, in modo da restare l'ultimo superstite.
<br>
I giocatori possono personalizzare ognuno degli otto mech disponibili, selezionando tra un vasto arsenale di armi speciali ottenibili durante il torneo.
<br>
Il gioco offre una modalità multigiocatore in locale (2 giocatori, schermo condiviso).
<br>
I giocatori possono anche controllare i mech utilizzando la Wii Balance Board!
