...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Più di 10 anni prima di Picross DS c'era Mario’s Super Picross per Super Nintendo. Questo "cruciverba figurato", in precedenza disponibile solo in Giappone, propone centinaia di sfide rilassanti ma coinvolgenti.
<br><br>
Ogni puzzle di Picross consiste in una griglia di caselle che, scolpite nel giusto ordine, formano una figura. Con Mario, nella modalità principale del gioco, una mossa sbagliata vuol dire perdere del tempo prezioso. Nei puzzle di Wario, però, che sono più difficili, gli errori non vengono indicati e non avrai a disposizione nessun tipo di aiuto!
<br><br>
Mario’s Super Picross, come Picross DS, contiene varie melodie di sottofondo e dispone di una funzione di salvataggio che permette al giocatore di continuare i puzzle lasciati a metà.
<br><br>Supporta la modalità interlacciata per il cavo AV Component per Wii.
<br><br>Il testo all'interno del gioco contiene caratteri giapponesi.</div>
  <div id="image02">
