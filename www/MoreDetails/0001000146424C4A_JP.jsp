...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８４年に登場してから現在に至るまで世界各地で支持され、数多くの続編や関連作を生み出している、アクションパズルゲームの代表作です。プレイヤーは
主人公「ランナー」を操作して、敵の「ロボット」に捕まらないように、ステージに配置された「金塊」を集めます。アクションそのものは非常にシンプルですが、ステージのあらゆる箇所がパズル仕立てとなっており、全５０ステージのどれもが一筋縄ではいきません。「ランナー」は自分の左右の床に「穴を掘る」ことで、敵を落として追跡をかわしたり、一見たどり着けないような場所へ道を切り拓いたりすることができます。状況に応じた頭脳プレイで全ての「金塊」を回収し、ステージから脱出するとクリアです。また、通常のプレイモードに加えて、自由にステージをデザインできる「エディットモード」も楽しめます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロードランナー<sup>&reg;</sup></span></div>
</div>
