...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">천사 피트가 암흑의 여신 메두사로부터 빛의 여신 파르테나를 구출하고 엔젤랜드의 평화를 되찾기 위해 모험을 떠나는 액션 게임입니다. 다양한 아이템을 이용하면서 개성 넘치는 가로세로 4개의 스테이지를 클리어해 보세요.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424454/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424454/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">키드 이카루스<sup>TM</sup></span></div>
</div>
