...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">孤島エステリアを舞台に、赤毛の少年剣士「アドル・クリスティン」が失われた古代王国「イース」の秘密をめぐって奔走する、シリーズ最初の冒険記です。プレイヤーは主人公アドルを操作してエステリアの各地を探索し、数々の情報を手がかりに「イース」の謎を解き明かしていきます。街で装備をととのえ、魔物たちのひそむ洞窟や塔では「体当たり」と「魔法」で応戦し、トラップが仕掛けられた危険な場所では知恵をしぼって攻略のヒントを見つけてください。アクションＲＰＧの名作として今なお多くのファンを魅了してやまない「イース」シリーズの原点であり、ＰＣエンジン版ではＣＤ－ＲＯＭの導入により「Ⅰ」と「Ⅱ」の同時収録を実現。生楽器演奏を採用したＢＧＭや声優によるメインキャラクターのボイスなど、豪華な演出も話題を呼びました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141424A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141424A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">イースⅠ・Ⅱ</span></div>
</div>
