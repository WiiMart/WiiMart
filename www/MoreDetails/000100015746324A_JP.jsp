...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015746324A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">魔王の娘となって、戦いの舞台である塔に様々な罠やモンスターを配置し、次々と攻め込んでくる冒険者を撃退する「世界征服RPG」です。<BR>プレイヤーは魔王として、”アーティファクト”と呼ばれるワナの付いたフロアや、手下であるモンスター達を塔に配置することで、塔の最上階にあるダーククリスタルを冒険者に攻撃されないよう守ります。「空飛ぶ塔」を舞台に、世界各地で冒険者たちとの熱いバトルを繰り広げつつ、すべてのステージを制圧して世界征服を目指しましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015746324A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015746324A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">光と闇の姫君と世界征服の塔</span></div>
</div>
