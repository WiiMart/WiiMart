...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157505145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Protöthea™ es un juego de acción de desplazamiento vertical con libertad de movimiento que pone al jugador a los mandos de una nave espacial de última generación, con la misión de destruir el asteroide llamado "Magno 01" y poner fin a los planes de "El Núcleo". Protöthea™, de Ubisoft, introduce nuevos conceptos en un estilo de juego ya clásico, mientras mezcla géneros y aprovecha al máximo las posibilidades de la consola Wii desde los gráficos a los controles. Jugadores de todas las edades y niveles de experiencia pueden pasar un buen rato al mando de su nave, recorriendo 4 mundos diferentes en 10 misiones que pondrán a prueba sus habilidades. Utiliza tu arsenal de armas y los objetos especiales de bonificación para ayudarte a cumplir tu misión, y no olvides ralentizar el tiempo para obtener la ventaja que necesitas y machacar al enemigo.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505145/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
