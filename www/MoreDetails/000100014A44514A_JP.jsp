...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">死食…死の星による不吉な日食が起きるたび、新しい命が失われ、混乱が世界を覆い尽くす。今から６００年前の最初の死食で、ただ一人生き残った赤子は魔王となり世界は荒廃した。それから３００年後の死食で生き残った赤子は聖王となり邪悪な者を全て打ち倒し世界に平和をもたらした。さらに３００年、３度目の死食が起こる。今回現われるのは魔王か聖王なのか、それとも…？　生き残った「運命の子」をめぐり、壮大な物語がはじまる。<BR><BR>ＲＰＧ「ロマンシング　サ・ガ」シリーズ第三弾がバーチャルコンソールに登場。８人の主人公からひとりを選び、異なるストーリーが展開する“フリーシナリオシステム”がさらに進化。のちのシリーズにも継承されていく“陣形技”が初登場。他にも“マスコンバット”や“トレード”などシミュレーション要素が加わり、戦略性の高い特徴的なプレイスタイルが生まれた。スーパーファミコン時代のサガはここに円熟期を迎える。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロマンシング サ・ガ<sup>&reg;</sup>３</span></div>
</div>
