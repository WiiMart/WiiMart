...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ne sous-estimez pas ce jeu à cause de ses graphismes simples et mignons, Tennis est un des jeux les plus techniques de la NES! Bien que les commandes ne soient pas très complexes, seuls les joueurs maîtrisant les revers, services et reprises de volée pourront gagner le tournoi final. Vous pouvez également jouer avec un ami pour affronter l'ordinateur dans des doubles frénétiques. Les habitués de Nintendo noteront la présence d'un personnage célèbre sur le siège de l'arbitre. Il a également exercé le même rôle dans d'autres jeux de sport Nintendo; pourrez-vous tous les retrouver?<br><br>
Le texte à l'écran sera en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Tennis</span></div>
</div>
