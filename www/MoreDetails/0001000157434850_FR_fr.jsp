...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157434850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Votre patience sera un facteur-clé pour affronter les meilleurs joueurs au monde sur Chess Challenge!  Perfectionnez vos compétences en jouant contre l’ordinateur avec des modes de difficulté multiples. Remportez des parties en ligne et comparez votre classement avec les joueurs du monde entier en examinant le tableau de classement en ligne.  <br>
Si vous n’avez pas le temps de jouer une partie d’échecs en direct avec vos amis, Chess Challenge! vous permet aussi de jouer avec jusqu’à cinq amis Wii grâce à WiiConnect24. De plus, vous pouvez donner vie à vos jeux en utilisant vos Mii! Commencez par quelques parties d’essai puis frayez-vous un chemin vers le sommet selon le système de classement ELO. De grands moments d’échecs vous attendent grâce à toutes ces options de jeu!  <br>
A vous de prouver que vous êtes imbattable!<br><br>
