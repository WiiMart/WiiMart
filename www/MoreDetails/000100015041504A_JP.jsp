...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードゲームで有名なシューティングの名作。各ステージのボスをはじめ、その他のキャラクターも細部に至るまで忠実に再現しています。自機「Ｒ－９」は、ＰＯＷアーマーを倒すと現れる６種類のユニットでパワーアップしていきます。なかでもレーザーユニットを取ると出現・成長する「フォース」は、自機の前後に付け替えたり分離攻撃をさせることもできる、代表的なアイテムです。また、ショットボタンは押し続けるとエネルギーをチャージし、より強力な波動砲を撃つことが可能です。３種類のレーザーと波動砲を使いこなし、押し寄せる敵を倒してステージクリアを目指します。Ｒ－ＴＹＰＥ Ⅱはステージ５～最終ステージまでを収録。ステージ１～４はＲ－ＴＹＰＥ Ⅰに収録されています。<BR><br>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｒ－ＴＹＰＥ<sup>&reg;</sup>Ⅱ</span></div>
</div>
