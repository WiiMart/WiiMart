...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001584A4845')", "wiiSelectSound()");
...
<p>
Paint Splash convierte tu TV en un lienzo interactivo en el que niños de todas las edades pueden disfrutar pintando con el Wii Remote. Hasta cuatro personas pueden dibujar al mismo tiempo, permitiendo que toda la familia participe en la creación de pinturas fantásticas usando simplemente los Wii Remote. Escoge entre diferentes pinceles y herramientas en todos los colores del arco iris, o activa el Modo Splash, en el que basta con agitar el Wii Remote para pintar en la pantalla - el modo ideal para los más pequeños de la casa.
<p>
...
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001584A4845/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001584A4845/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
