...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157324750')", "wiiSelectSound()");
...
- New “Psyche-Lock” Feature: use questioning to reveal hidden testimony!</div>
  <div id="image02">
