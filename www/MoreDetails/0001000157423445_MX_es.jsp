...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157423445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Desenfunda tu revólver para ver quién es el más rápido del Oeste. Ajusta tu precisión y velocidad a medida que aparezcan los objetivos en frente de ti. Apunta y dispara para obtener más puntos. Puedes disparar a cualquier elemento, así que asegúrate de explorar todo el escenario para conseguir más puntos. Identifica a tus enemigos de entre todos los personajes que aparezcan y no dispares a los ciudadanos inocentes. Participa en un asalto al tren típico del Lejano Oeste o desafía tus habilidades en otros entornos característicos del Oeste a medida que aumenta la dificultad. A medida que avances por los desafíos, ganarás recompensas y medallas, en una adictiva acción sin descanso. Juega en multijugador con hasta dos jugadores donde tú y tu compañero combinarán puntos o jugarán uno contra el otro para averiguar quién es el más rápido del Lejano Oeste. Texto de las pantallas en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157423445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157423445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
