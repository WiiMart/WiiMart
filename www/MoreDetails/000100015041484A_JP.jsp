...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">隠された金塊を奪還していく名作「ロードランナー」に、対戦の醍醐味をさらにプラスした進化版。ステージクリア方式の「パズルモード」に加え、最大５人までの対戦が可能な「バトルモード」、オリジナルステージの作成が可能な「エディットモード」を搭載。「バトルモード」では、最後まで生き残った人が勝利する「サバイバル」のほか、敵キャラが持っているアイテムを手に入れて脱出する「エスケープ」、４人で２チームに分かれて対戦する「タッグマッチ」と多彩なモードが楽しめます。
<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バトルロードランナー<sup>&reg;</sup></span></div>
</div>
