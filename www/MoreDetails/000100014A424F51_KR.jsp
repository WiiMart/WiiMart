...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">인접한 좌우 패널의 위치를 바꾸어 3개 이상의 같은 패널을 가로 또는 세로로 이어지게 해서 없애 나가는 액션 퍼즐 게임입니다. 커서를 움직여서 위치를 바꿀 패널을 선택하고, a 또는 b 버튼을 누르면 패널의 위치가 바뀝니다. 아래에서 쌓여 올라오는 패널이 화면 위까지 가득 차게 되면 게임 오버입니다. 한 번에 4개 이상의 패널을 없애는 「동시에 없애기」나 패널이 없어진 곳에 떨어진 다른 패널이 다음 패널과 만나 또 다시 없어지게 되는 「연쇄 없애기」 등을 적극적으로 활용해 봅시다. 그 중에서도 가장 고급 테크닉은 「액티브 연쇄」입니다. 패널이 없어지는 동안에도 다른 패널을 움직일 수 있으므로 비어있는 곳에 패널이 떨어지기 전에 미리 패널을 옮겨두어 연속으로 없앨 수 있습니다. 간단한 조작과 쉬운 규칙으로 누구나 즐길 수 있지만 다양한 난이도의 다채로운 게임 모드가 마련되어 있어 게임을 마스터하기 위해서는 상당한 수준이 필요합니다. 특히 스토리 모드나 2인 대전 플레이에서는 패널을 동시에 없애거나 연속으로 없애면 상대방에게 「방해 패널」을 보내서 방해를 할 수 있어 더욱 흥미진진합니다. 동시에 없애기와 연쇄 없애기를 마스터해서 게임을 유리하게 이끌어 보세요.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424F51/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424F51/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">패널로 퐁<sup>TM</sup></span></div>
</div>
...
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">슈퍼 패미컴</div>
</div>
</body>
</html>
