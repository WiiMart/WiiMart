...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Speel met Mario en zijn vrienden wanneer ze een nieuwe draai geven aan het golfen! Kies uit 14 verschillende personages, elk met een eigen kracht en slagstijl. Je kunt zelfs je tegenstanders treiteren om ze uit hun concentratie te brengen.
<br><br>
Mario Golf zit bomvol spelonderdelen, waaronder 10 verschillende spelstanden (zoals Tournament Speed Golf en zelfs Mini-Golf) en zes verschillende banen die je kunt voltooien door het verdienen van ervaringspunten.
<br><br>
Dankzij de toegankelijke besturing en een competitieve stand voor vier spelers kan iedereen zijn draai vinden in Mario Golf!
<br><br>
Voorzien van Engelse schermteksten.</div>
  <div id="image02">
