...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Incarnez un guerrier solitaire et armé jusqu’aux dents envoyé en mission commando top secrète derrière les lignes ennemies pour libérer vos compagnons d'armes.
<br><br>
Dans ce jeu sorti sur SEGA MASTER SYSTEM aux États-Unis sous le nom « Rambo: First Blood II » (« Secret Command » en Europe), préparez-vous à livrer une bataille acharnée contre des soldats ennemis équipés de tanks, de lance-roquettes et d’autres armes redoutables, prêts à tout pour vous empêcher de libérer les otages ! Vous pouvez compter sur votre bonne vieille mitraillette, votre arbalète intégrée et vos flèches explosives pour vous mener vers la victoire !
<br><br>
Rien ne doit vous arrêter ! Pour encore plus de fun, jouez avec un ami en mode deux joueurs et doublez votre puissance de feu !
<br><br>
