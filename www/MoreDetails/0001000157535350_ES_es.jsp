...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157535350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Solitaire encontrarás 18 variantes de este conocido y apasionante juego de cartas de un único jugador. Puedes elegir, por ejemplo, entre Klondike, Freecell, Spider, Pyramid o Yukon. Gran parte de los juegos ofrecen la posibilidad de personalizar las opciones, para poder jugar según las reglas que escojas. Además, con las instrucciones en pantalla puedes aprender nuevas variantes del Solitaire.
<br><br>
Las estadísticas harán las delicias de los amantes de las cifras, que podrán también guardar sus progresos para utilizarlos más adelante o personalizar la presentación con un sinfín de fondos. El estilo y la interfaz del juego están diseñados para facilitar una interacción intuitiva con el mando de Wii.
<br><br>
Siéntate y relájate... Disfruta de un sinfín de desafíos y diviértete con esta selección de juegos de Solitaire.
<br><br>
Textos de pantalla disponibles en inglés, alemán, español, francés e italiano.</div>
  <div id="image02">
