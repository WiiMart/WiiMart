...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157503745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Planetarium es un juego que permite observar los cuerpos celestes desde la comodidad de tu televisor con el Wii Remote. Hay 3 modos principales.
<p>
*Modo Observación: contiene unos 20 000 objetos celestes hasta estrellas de magnitud 7. Puedes cambiar ajustes como mostrar la latitud y la longitud de las constelaciones o la velocidad a la que transcurre el tiempo.
<p>
*Modo Planetario: en él puedes ver 11 recorridos que tratan temas como estrellas, nebulosas, constelaciones y otros objetos celestes.
<p>
*Guía Celeste: contiene información detallada y mitología sobre los objetos celestes y las constelaciones, así como un glosario de los términos que se utilizan en observación.
<p>
My Planetarium es un juego con el que disfrutarás viendo el cielo nocturno mientras aprendes los objetos que contiene. Venga, mira bien las estrellas misteriosas que pueblan el cielo.
<p>
*La información sobre los objetos celestes está actualizada a fecha de junio de 2010.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157503745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157503745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">My Planetarium<sup>TM</sup></span></div>
</div>
