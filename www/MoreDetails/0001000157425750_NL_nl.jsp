...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157425750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De beestjes zijn ontsnapt en er heerst chaos op de boerderij! Het is aan jou de beestjes zo snel mogelijk in hun hok te drijven in deze uitdagende actiepuzzel!  Je moet zo snel mogelijk hekken repareren om alle beestjes veilig en tevreden te houden! Maar het plezier stopt niet op de boerderij; 50 uitdagende niveaus nemen je mee naar exotische locaties, zoals de rimboe, het ijskoude noordpoolgebied, de savanne en meer!  Er zijn zelfs minigames voor als de beestjes niet meewerken: Sneeuwbalvoetbal, Razende Roofdieren, Kip ik heb je, en Hekval. Maximaal vier spelers kunnen tegen elkaar of samen spelen om de losgeslagen beestjes te vangen. Rol je mouwen dus op en haal een vriend erbij – die beestjes vangen zichzelf niet!<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
