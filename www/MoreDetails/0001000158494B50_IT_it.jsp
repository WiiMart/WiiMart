...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158494B50')", "wiiSelectSound()");
...
<br><br>Il pianeta Monsteca non è più il mondo armonioso che era una volta: ora, infatti, è stato invaso da un esercito di robot che hanno lo scopo di comandare e conquistare. I nativi di Monsteca, gli Stompy, non hanno altra scelta se non scappare o essere catturati. Incapaci di difendersi da questi robot, gli Stompy devono fare affidamento sulla forza del branco per collaborare e riuscire a sconfiggerli.<br><br>
Prendi il controllo degli Stompy, mostri carini, anche se non particolarmente brillanti, i quali, una volta svegliatisi, hanno bisogno di aiuto per evitare di essere catturati dai robot che stanno invadendo il loro mondo. È tuo dovere guidarli attraverso ciascun livello. <br><br><ul>
<li>Un divertente gioco di strategia in 3D, rapido e intellettualmente stimolante.</li>
<li>Colonna sonora interattiva.</li>
<li>Venti livelli da giocare e tante ore di divertimento garantito.</li></ul><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
