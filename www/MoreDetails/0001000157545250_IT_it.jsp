...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157545250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP BEAT ti fa rivivere l'azione retro, usando il sensore di movimento del telecomando Wii per battere il tempo in questo ritmico gioco ispirato al tennis da tavolo.
  <br><br>
Grafica retro, gameplay tradizionale, multiplayer a 4 giocatori, e una colonna sonora a 8-bit ti coinvolgeranno: il divertimento è assicurato! Fai attenzione, però: come in tutti i grandi classici, la sfida è tosta. Se manterrai il tuo sangue freddo all'aumentare della difficoltà, scoprirai l'inizio della saga BIT.TRIP...  <br><br>
  
Tutto proviene da qualcosa. Eravamo prima di diventare. Dalla vita viene il ritmo e dal ritmo viene la vita. Siamo esseri di informazioni. Tutto conduce all'apprendimento. Comunichiamo con bit e byte. E torneremo a qualcosa quando diventeremo nulla. Quando avremo completato il nostro BIT.TRIP.  <br><br>
