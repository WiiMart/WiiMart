...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juego de lucha de avance lineal originalmente publicado en 1993. Los protagonistas de esta aventura son guerreros invocados por una sacerdotisa con el propósito de derrotar al Señor Oscuro a medida que combaten por escenarios de varias épocas. Como en la versión anterior, puedes transformar a tus personajes, aunque, a diferencia de esta, no tendrás que salvar a tus aliados para poder hacerlo, sino que puedes convertirte en Ninja, Tengu o Can Ninja desde el comienzo. Además, uno de los nuevos elementos de esta versión es la incorporación de ataques acumulativos y la defensa, dando un giro más táctico a la acción.
<p>(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425845/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
