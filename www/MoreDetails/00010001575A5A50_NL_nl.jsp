...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001575A5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Een vervallen villa is het decor van een uiterst vreemd prentboek. Verzamel al je moed en open de deur naar dit eigenaardige en tikkeltje beangstigende verhaal. Los innovatieve puzzels op door met de Wii-afstandsbediening geanimeerde beren van papieren naar de pagina’s van het boek te gooien. Pak al het rode snoep door op slimme wijze van de unieke omgeving gebruik te maken en je beren strategisch in te zetten. Duik in het spannende verhaal van Pina, het mysterieuze jonge meisje dat de villa bewoont. Er staan je maar liefst dertig uitdagende levels te wachten!<br><br>

Het gelijktijdig uitgegeven "Chaotic Conflicts" is een parallelle game met zijn eigen verhaal en strijdgeoriënteerde levels. Speel beide games om een nóg merkwaardiger mysterie te onthullen ...<br><br>
