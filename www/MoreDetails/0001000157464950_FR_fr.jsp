...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157464950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Reel Fishing Challenge offre une expérience divertissante et stimulante aussi bien aux pêcheurs néophytes qu’aux rois de la pêche. Testez vos compétences et découvrez de nouveaux types de poissons dans le mode défi Mission, ou détendez-vous et appréciez le jeu à votre propre rythme en mode Jeu libre.<br><br> Peu importe le mode de jeu que vous sélectionnez, les superbes graphismes et le cadre naturel du jeu animeront votre expérience de pêche. Choisissez parmi une grande variété de leurres pour attirer et attraper les nombreux poissons futés du jeu. Chaque poisson possède l’apparence et les déplacements d’un vrai poisson : vous pouvez vivre une expérience de la pêche proche de la réalité, sans porter de cuissardes !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464950/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464950/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Reel Fishing<sup>&reg;</sup> Challenge</span></div>
</div>
