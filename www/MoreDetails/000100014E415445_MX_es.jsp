...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El Reino Champiñón le da la bienvenida a un deporte más, con el exitoso Mario Tennis para Nintendo 64. Los títulos de Mario son reconocidos por sus brillantes gráficos y sus controles precisos e intuitivos, pero esta vez, un reparto de 16 personajes de Nintendo está listo para tomar la raqueta (incluyendo por primera vez a Waluigi). Además de la habilidad de engañar al oponente al cambiar los tipos de golpes y escoger la trayectoria de la bola, cada personaje tiene atributos especiales tales como rapidez, técnica, potencia y astucia, mismos que al combinarse ofrecen una extensa variedad de estilos por escoger. La posibilidad de cambiar de modos de juego, desde el clásico modo torneo, hasta el caótico escenario de Bowser, mantendrá a ti y a tus amigos ocupados en la pista por un buen rato (podrás invitar hasta tres amigos). Ya sea que decidas desbloquear todos los secretos en el modo para un jugador o retar a tus amigos a divertirse intensamente en el modo multijugadores, este es un juego que definitivamente...¡presta el servicio!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E415445/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E415445/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mario Tennis<sup>TM</sup></span></div>
</div>
