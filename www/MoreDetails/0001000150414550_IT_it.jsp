...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Super Star Soldier è un classico sparatutto a scorrimento verticale. Oltre al NORMAL GAME (modalità normale), ci sono i 2 MINUTES GAME  e 5 MINUTES GAME (modalità attacco a tempo) e una schermata dove controllare i record.<br>Il NORMAL GAME consiste di 8 livelli diversi e, alla fine di ogni livello (escluso il 7), ti attenderà un boss.<br>La squadra d’attacco speciale, guidata da Mother Brain, ha lanciato un’invasione su scala globale contro la Terra. Prendi la tua agile navetta da combattimento, il Neo Caesar, con il suo arsenale di 4 armi normali e 2 speciali e fagli vedere chi comanda!<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
