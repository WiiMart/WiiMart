...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157424E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to a place where plants, vegetables and fruit come to make their foliage fashionable. You are the Bonsai Barber, a newcomer in a village of friendly organic folk who like nothing better than getting their branches, leaves and twigs trimmed into the latest styles.
<br><br>
Fresh customers arrive each day, demanding your unique services. Go with their suggested style or choose from dozens of others, and then set to work with your Wii Remote: scissors to trim back the foliage, clippers to finish off the edges, and a paintbrush to add a splash of colour. And if you slip up, simply use the water spray to re-grow the leaves!
<br><br>
Building a rapport with your clients is fruitful, too. Keep up the good work and they may send you a postcard or even a souvenir from their holiday. But miss an appointment and they’ll make their feelings known via the Wii Message Board!</div>
  <div id="image02">
