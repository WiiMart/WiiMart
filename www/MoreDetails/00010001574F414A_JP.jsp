...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F414A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">キーワードは簡単爽快で「おきらく」。今度はゲームセンターでもおなじみのエアホッケーが登場です。<BR>Ｗｉｉリモコンでマレットを操作して、相手からのパックを打ち返しましょう。相手ゴールにパックを打ち込めば得点ゲット。<BR>ミラクルショットや、いろんな形・仕掛けが楽しめるステージなど、ゲームならではの面白さもギュギュッとつめてお届けします。<BR>最大４人まで対戦できますので、家族・友達で盛り上がりましょう。<BR>３種類のミニゲームも遊ぶことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F414A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F414A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おきらくエアホッケーWii</span></div>
</div>
