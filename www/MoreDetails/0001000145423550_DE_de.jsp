...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Last Blade ist ein Arcade-Spiel aus dem Jahr 1997. Vor dem Hintergrund der japanischen Bakumatsu-Periode kämpfen mehr als zehn Kämpfer aus unterschiedlichen Gründen gegeneinander. Ähnlich zu seinen Vorgängern aus der Videospielserie „Samurai Shodown“ der gleichen Firma kann man jeden Spielcharakter in zwei verschiedenen Modi wählen: Den große Schäden verursachenden Power-Modus und den Geschwindigkeit erhöhenden Speed-Modus.
Das defensive Blocksystem Repel, mit dem gegnerische Schwertstreiche pariert werden können, und Sublime Slash, der den Super Slice aufhebt und dabei mit Super Secret Slice kombiniert werden kann, verleihen dem Spiel zusätzlichen Reiz und Tiefe.
Vergiss beim Spielen auch nicht die Spezialattacken Super Secret Slice und Hidden Secret Slice!
<br><br>
