...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">横スクロールアクション「悪魔城ドラキュラ」シリーズ第三弾。初代『悪魔城ドラキュラ』と同じく、オーソドックスなステージクリアタイプですが、ステージの最後に分岐があり、次に進むルートを自分で指定することができます。ムチと各種アイテムを使いこなす主人公ラルフに加え、特定のステージをクリアすることで、先に侵入した討伐隊を仲間として一緒に行動することができます。魔法の使い手サイファー、壁を伝って移動できる盗賊グラント、そして父親に反感を持つヴラド公の息子アルカードの３人からひとりを仲間にし、ラルフと仲間を切り替えながらステージの攻略を進めることができます。使用キャラによって攻略法が変わるため、繰り返しプレイしても飽きさせません。また、特殊チップによる迫力のサウンドはファミコンソフトの中でも屈指のもので、本作の魅力のひとつとなりました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">悪魔城伝説</span></div>
</div>
