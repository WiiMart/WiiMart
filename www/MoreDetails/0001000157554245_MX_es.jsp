...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157554245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ubongo es un juego que disfrutará toda la familia. Su mecánica es muy simple, ya que consiste en resolver puzzles con el objetivo de obtener gemas de colores. Al final del tiempo establecido, el jugador que tenga más gemas será el ganador. Bajo está premisa aparentemente simple se esconde un juego extremadamente adictivo... ¡siempre querrás jugar una partida más! El juego de mesa original es un auténtico fenómeno de masas en muchos países, donde su popularidad ha llevado a Ubongo hasta lo más alto de las lista de ventas.
<p>
-Modo Historia<br>
En este modo de juego debes adoptar el papel de Kanu y avanzar venciendo a los esbirros del malvado Rifictus en partidas de Ubongo.
<p>
-Partida Rápida<br>
Este modo ofrece al jugador la posibilidad de disputar partidas rápidas.
<p>
-Contrarreloj<br>
En este modo los jugadores deben centrar sus esfuerzos en reloj... ya que el objetivo es conseguir un buen número de gemas en un tiempo límite.
<p>
-Multijugador<br>
Reta a tus amigos en este Modo Multijugador en el que pueden participar hasta 4 usuarios.
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ubongo</span></div>
</div>
