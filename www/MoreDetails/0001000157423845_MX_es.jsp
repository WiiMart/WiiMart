...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157423845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Disfruta de la moderna y emocionante atmósfera de Midnight Bowling! Prepárate para un juego superdivertido y con una sensación de juego increíble. Gracias al nuevo motor físico que te permite controlar tus acciones con gran precisión y facilidad con tu Wii Remote™, ¡podrás aplicar efectos espectaculares a tu bola de boliche para impresionar a tus oponentes! Enfréntate a 3 amigos en el modo fiesta donde tus habilidades de juego serán puestas a prueba. Cualquiera que sea tu nivel, adéntrate en el modo carrera donde jugarás en los locales de boliche más de moda contra personajes carismáticos.</div>
  <div id="image02">
