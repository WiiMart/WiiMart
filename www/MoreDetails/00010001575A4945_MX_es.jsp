...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001575A4945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rubik's Puzzle Galaxy's RUSH es un juego de rompecabezas 3D con más de 70 desafiantes niveles. Los jugadores deben guiar Cubos a puntos de salida de colores. Usando los controles intuitivos del Wii Remote, los jugadores arrean cubos de color con Transportadores, Tele-transportadores, Señales de Alto, Señales Direccionales y Divisores. RUSH además incluye el Cubo de Rubik original. Los jugadores intentan resolver alguno de los 4 tamaños diferentes de Cubos en solitario o contra otro jugador, o aprender a resolver el Cubo de Rubik clásico. El juego está disponible en los siguientes idiomas: inglés, francés, alemán, italiano y español.
<p>
RUSH:<br>
*Más de 70 niveles rompe-cerebros.<br>
*Esquema de control del Wii Remote hecho a la medida.<br>
...
*Tablas de líderes en línea.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A4945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Rubik's Puzzle Galaxy: RUSH</span></div>
</div>
