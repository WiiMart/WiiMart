...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pour sauver le monde des démons qui le menacent, Dana se lance dans une quête à la recherche de la clé de Salomon pour sceller le passage emprunté par les monstres. Mélange audacieux entre un jeu d'action et un puzzle géant, Solomon's Key™ reste un des défis les plus difficiles à relever sur la NES, mais également un des plus prenants. Le joueur doit utiliser sa logique et ses réflexes pour découvrir tous les mystères de chaque pièce. Les bons joueurs parviendront sûrement à trouver certains secrets, mais seuls les meilleurs arriveront à voir toutes les fins différentes. Serez-vous l'un d'entre eux ?<br><br>Le texte à l'écran sera en anglais.</div>
  <div id="image02">
