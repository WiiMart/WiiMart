...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157475050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Zenquaria permite transformar tu televisor en un espectacular acuario virtual. Relájate observando las distintas especies, consulta la enciclopedia para descubrir información interesante... ¡o sumérgete en el acuario con tu propio Mii!
<br><br>
Crea un acuario a tu gusto: elige qué peces lo habitarán de entre aproximadamente 40 especies diferentes, coloca los elementos decorativos, añade una imagen de fondo... ¡y listo! Los acuarios experimentarán cambios, los especímenes se desarrollarán e incluso podrían tener descendencia. ¡Los cambios se producirán incluso si la consola se encuentra apagada!
<br><br>
Utiliza los distintos tipos de cámara para contemplar los ejemplares desde diferentes ángulos, incluido el propio punto de vista de un pez, y consulta las fichas para conocer datos relevantes de cada ejemplar, como su nombre científico o su hábitat natural. ¡Incluso podrás alimentar a los peces y buscar curiosidades en el acuario con tu Mii!
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157475050/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Zenquaria<sup>TM</sup>: El acuario virtual</span></div>
</div>
