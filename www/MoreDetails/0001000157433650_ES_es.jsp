...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157433650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Adéntrate en el original mundo de Chronos Twins DX, donde vivirás una fantástica aventura llena de ideas innovadoras nunca vistas en otro juego. Gracias a su sistema de juego Dual Gameplay serás capaz de controlar a Nec en dos escenarios temporales a la vez. Chronos Twins DX es acción, plataformas, aventura y puzles que pondrán a prueba tu inteligencia y habilidad.<br><br>
...
- 19 niveles con ambientación fantástica con espectaculares jefes de final de fase.<br>
...
- Cambia el pasado, empujando objetos, destruyendo critaturas... y el presente cambiará en tiempo real.<br>
- Observa como el tiempo avanza mientras progresas en tu aventura.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157433650/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157433650/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
