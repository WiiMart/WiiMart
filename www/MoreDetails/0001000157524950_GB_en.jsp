...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157524950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In "Rainbow Islands: Towering Adventure!", players control the rainbow magic-wielding "Bubby" or "Bobby" to climb the 7 seamless areas of a tower reaching the heavens while defeating enemies with their rainbow powers.<br><br>

Bosses controlled by the scientific genius "Dr. Crescent" await players at the end of every area. Attempt to get through every area to meet the rainbow-coloured comet known as "Holly's Comet" within the allotted time.<br><br>
 
There are 3 game modes for this game. You can enjoy the tale of Holly's Comet in "Story Mode," "Challenge Mode" where players attempt to climb as high as they can from 0m, and "Time Attack" where players select an area and see how fast they can climb it. <br><br>

"Rainbow Islands: Towering Adventure!" is an exhilarating action game where you use rainbows to climb into the heavens!</div>
  <div id="image02">
