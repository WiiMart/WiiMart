...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit klassieke, verticaal scrollende schietspel is wellicht het beste spel van Capcom uit het tijdperk vóór Street Fighter. De WWII-tweedekkeractie van 1942 behoeft geen introductie: dit spel heeft miljoenen klonen voortgebracht en is op bijna elk platform verschenen. En nu voor het eerst op de Wii: de ongeëvenaarde originele versie.
<br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145353250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145353250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">1942</span></div>
</div>
