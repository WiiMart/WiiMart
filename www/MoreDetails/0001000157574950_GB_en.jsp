...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157574950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Begin the search for Wally, his friends and more in Fantastic Journey 1!<br> Based on the hit publishing series, Where's Wally? The Fantastic Journey 1 is ultimate SEARCH & FIND fun inside the magical worlds of The Gobbling Gluttons, The Battling Monks, The Carpet Flyers and more! Challenge friends or play solo as you search for hidden items, and be ready for surprises and sabotage to fuel the fun!</div>
  <div id="image02">
