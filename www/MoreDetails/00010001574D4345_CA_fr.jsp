...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D4345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">No longer is the planet Monsteca the harmonious world it once was—it's been overrun by a robotic army set out to rule and conquer. Monsteca natives, the Stompies, have no choice but to run or be captured. Unable to defend themselves against such heavy machinery, the Stompies must rely on the strength of their herd to work together and defeat the meddling robots. You take control of the Stompies, cute and not so bright monsters, who once awoken, need help to avoid being captured by invading robots. It is your duty to guide them successfully through each level.
<p>
*A fun, full 3D strategy game with a strong sense of flow.<br>
*20 levels to conquer with hours of gameplay.</div>
  <div id="image02">
