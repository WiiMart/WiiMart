...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D5350')", "wiiSelectSound()");
...
<br><br>
So what are you waiting for? Six clients are waiting for your help, you are the only one who can help them!</div>
  <div id="image02">
