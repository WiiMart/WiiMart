...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">All'avvio del gioco vesti i panni di Rhys, principe reggente del regno Orakian di Landen e promesso sposo a Maia, appartenente a un regno rivale. Il giorno delle nozze Maia viene però rapita. Questo evento segna l'inizio di un'avventura ricca di colpi di scena, che porterà nuovamente alla ribalta personaggi e luoghi già incontrati nei precedenti episodi di Phantasy Star. Questa vicenda epica coinvolge diverse generazioni di personaggi e le tue scelte influenzeranno drasticamente il corso della storia, che potrà quindi essere giocata e vissuta varie volte dall'inizio alla fine. In Phantasy Star III le cose non sono sempre come sembrano: presta attenzione e osserva il mistero svelarsi sotto i tuoi occhi!
<br><br>
