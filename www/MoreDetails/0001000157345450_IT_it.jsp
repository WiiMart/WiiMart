...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157345450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stai per intraprendere una delle esperienze più interessanti degli ultimi anni. Destreggiati in quindici diabolici livelli nei quali ti troverai a dover riprodurre immagini impossibili con l’aiuto di palle cariche di energia spaziale. Gareggia contro il tempo e gli ostacoli per attivare i riquadri giusti. Spaceball: Revolution metterà alla prova la tua abilità e concentrazione fino alla fine. Spaceball: Revolution ti consente di confrontare il tuo punteggio con quello dei migliori giocatori del mondo nei vari livelli di difficoltà: Facile, Normale, Difficile ed Esperto.
<br>
 Spaceball: Revolution  ti ha lanciato una sfida. Te la senti di accettare? <br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157345450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157345450/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Spaceball: Revolution</span></div>
</div>
