...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157573350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Keep up the search for Wally, his friends and more in Fantastic Journey 3! <br>Based on the hit publishing series, Where's Wally? The Fantastic Journey 3 is ultimate SEARCH & FIND fun inside the magical worlds of The Unfriendly Giants, The Underground Hunters, The Land of Waldos and more! Challenge friends or go solo as you search for hidden items, and be ready for surprises and sabotage to fuel the fun!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157573350/FFFD0013" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157573350/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
