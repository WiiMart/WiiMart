...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157324650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">I pazienti che si sottopongono a un programma di riabilitazione conoscono bene il problema: molti esercizi essenziali per il processo di guarigione sono monotoni e noiosi. Specialmente quando si parla di postura ed equilibrio, la varietà è quasi inesistente.<br />
È qui che Physiofun Balance Training può essere utile, rendendo piacevoli gli esercizi di equilibrio.<br /><br />
Physiofun Balance Training è perfetto anche per fisioterapisti e cliniche di riabilitazione private. Anziché fare ricorso a costosi macchinari specializzati, gli esercizi più importanti per pazienti che hanno subito infortuni a piedi, ginocchia o bacino possono essere eseguiti in modo gradevole e divertente.<br /><br />
Physiofun Balance Training presenta molte funzioni: oltre a importanti test come la misurazione del baricentro del corpo, la "Modalità Fisio" permette di creare sofisticati programmi di allenamento a carattere fisioterapeutico.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324650/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324650/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Allenamento dell'equilibrio</span></div>
</div>
