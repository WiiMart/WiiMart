...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158485945')", "wiiSelectSound()");
...
<p>
BIT.TRIP FATE es un arcade de desplazamiento lateral guiado en el que CommanderVideo cabalga la vibración para descubrir su destino.
<p>
CommanderVideo necesitará algo de ayuda de los amigos que hizo en BIT.TRIP RUNNER para obstaculizar a Mingrawn Timbletot, quien ha transformado el mundo en una fea pesadilla tecnológica. Únete a Junior Melchkin, CommandgirlVideo y otros para aumentar el poder de CommanderVideo y salvar el mundo.
<p>
Ya juegues solo o en equipo con un copiloto, tendrás que tener el pulso firme para navegar la vibración y apuntar con tus rayos a las retorcidas almas que quieren destruirte.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158485945/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158485945/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
