...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157564950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Violin Paradise is een game voor mensen met een passie voor muziek en dromen van een carrière als violist! De game is ontworpen voor de hele familie en kan door maximaal vier mensen tegelijkertijd gespeeld worden. Kies voor een rol als dirigent, violist, altviolist of cellist en speel samen levendige of verfijnde klassieke muziek.  De game bevat een micro-orkest wat de speler zowel het plezier van een echt optreden als de uitbundigheid na een geslaagde performance laat ervaren.<br><br>
Solo of in een ensemble van maximaal vier spelers biedt de game telkens weer nieuwe manieren om de optredens te ervaren.<br>
Prachtige visuele effecten die naarmate je prestaties beter worden, steeds uitbundiger en vaker verschijnen.<br>
Een eenvoudige, maar verfijnde bediening. Zodra je eenmaal begint met spelen, is dit een spel waar je nooit genoeg van krijgt.<br>
Keuze uit meer dan 50 verschillende composities.<br>
Begin nu met spelen en breng de klassieke muziek met jouw eigen funky sound tot leven.<br><br>De software is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564950/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564950/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Violin Paradise</span></div>
</div>
