...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The wicked sorcerer Agahnim has seized control of Hyrule, and plans to release Ganon from his prison in the Dark World. As legendary hero Link, fulfil your destiny and stop Agahnim’s deadly plot before it’s too late!
<br><br>
The Legend of Zelda: A Link to the Past was a milestone in the Zelda series; with its enormous quest spanning twin worlds, plentiful weapons and items, a massive menagerie of monsters and an epic storyline of good versus evil.
<br><br>
Shigeru Miyamoto’s masterpiece introduced many elements that would go on to become series standards, and Koji Kondo’s memorable soundtrack is among his career best; making A Link to the Past a true Nintendo classic.<br><br>Supports Wii Component cable Interlace Mode</div>
  <div id="image02">
