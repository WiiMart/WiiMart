...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495245')", "wiiSelectSound()");
...
<p>
Nacido en los campus universitarios, Pong Toss es el mejor juego grupal. Ahora, Pong Toss Pro eleva la apuesta ofreciendo mejores gráficos y una mayor precisión gracias a un rediseño completo del sistema de lanzamiento. Como si eso fuera poco, Pong Toss Pro también presenta un nuevo modo de torneo con el que pueden organizarse eliminatorias de 4, 8 o 16 jugadores o equipos en los modos Pong Toss y Speed Pong. Pong Toss Pro incluye 6 mesas de juego, la posibilidad de configurar las reglas de la casa y una enérgica banda sonora de rock que acompaña la experiencia de juego en grupo, así como un comentarista de todas las jugadas. En el modo Speed Pong, pueden competir hasta tres jugadores a la vez. La velocidad y la estrategia son esenciales si quieres seguirle el ritmo al juego. Puedes perjudicar a tus oponentes con una variedad de molestias que los entorpecerá en el momento de tirar. ¡El primero que acierta al último vaso se queda con todo!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495245/FFFD000D" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495245/FFFD000E" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pong Toss Pro -</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Frat Party Games<sup>&reg;</sup> Demo</span></div>
  </div>
