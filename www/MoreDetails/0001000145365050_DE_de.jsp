...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieser temporeiche Actiontitel, ursprünglich als Arcade-Spiel "Shadow Warriors" in Europa erschienen, ist der Kultklassiker schlechthin – und den kannst du jetzt zu Hause spielen!
<br><br>
Du schlüpfst in die Rolle eines Ninjas, der in eine von Gangs verpestete amerikanische Stadt namens "Jungle" geschickt wird, um ein finsteres Syndikat von Attentätern auszuschalten. 
Die ergeben sich aber nicht so einfach! Du wirst all deine Ninja-Fähigkeiten einsetzen müssen – darunter den Fliegenden Nackenwurf und den Schwebekick – um sie zu besiegen. Um dir ein möglichst vielseitiges Spielerlebnis zu bieten, kannst du in dieser Version die Anzahl der Versuche sowie die Schwierigkeitsstufe zu Beginn festlegen.
<br><br>
In diesem Actionklassiker treffen Ninjas auf westliche Gangs. Worauf wartest du noch? Gehe auf die Straße und sage den Gangs den Kampf an!
<br><br>
