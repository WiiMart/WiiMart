...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157424850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You are hopelessly outnumbered and have no option except to fight and win. Just you, your guns, and the thin stretch of "Blood Beach" stand between you and the whole of the Japanese Imperial Navy.
<br><br>
While you have an impressive arsenal including the M2 BMG, 40mm M1, and of course your Thompson SMG, the Imperial Japanese Navy will throw everything they can muster at you, “Zeros”, “Bettys” , even Takao-class battleships in their methodical and relentless push to recapture the Solomon Islands.</div>
  <div id="image02">
