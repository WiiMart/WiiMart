...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The famous simulation in which one takes the role of a mayor and must help a new city thrive and become a megalopolis. This version, co-developed by Maxis and Nintendo, is widely considered as the best adaptation of the original game. It was originally only released on Super Nintendo and includes several extra features. Seasons affect the visual aspect of your town. Some popular Nintendo characters make surprising guest appearances for advanced players who reach a certain stage into the game. This version also features a few extra missions in scenario mode. SimCity™ is also fondly remembered for offering one of the best soundtracks of the Super Nintendo.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
