...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In diesem Spiel, welches erstmals 1991 veröffentlicht wurde, befindet man sich in Washington City. Der Spieler übernimmt due Rolle eines Superkriegers, welcher gegen Geister aus der Vergangenheit, die sich anschicken die Gegenwart zu übernehmen, antreten muss. Das Besondere an diesem Spiel ist die Möglichkeit die Charaktere zu wechseln, während man den Gegner bekämpft. Wird ein eingesperrter Charakter befreit, während man den Gegner bekämpft, so wird dieser Charakter zur Nutzung verfügbar. Der Schlüssel zu einer erfolgreichen Strategie ist ein jeweils zur Situation passender Wechsel zwischen Ninja Dog, Samurai und Ninja. Du kannst auch Gegenstände aufsammeln, wie Waffen und Kugeln für magische Angriffe. Es gibt nicht nur das Abenteuer in der realen Welt, sondern auch in einem Paralleluniversum, wo sich das Geschehen in einer rasenden Geschwindigkeit verändert und keine Langeweile entsteht.<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SENGOKU</span></div>
</div>
