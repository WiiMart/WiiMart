...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574D3350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wie bei den meisten Kämpfen weiß niemand mehr so genau, wo, wie und wann diese Rivalität begann, aber diese Affengruppe bekämpft sich nun schon seit Urzeiten. Der erwählte Kampfstil ist die uralte Kunst des Bananenwerfens und jetzt, als eingeschworene Feinde, wollen diese wütenden Affen bei dieser Obstschlacht mit aller Macht länger als die anderen durchhalten.
<br><br>
Steuere einen von acht Affen und kämpfe mit den bis zu sieben anderen in acht verschiedenen Landschaften. Kämpfe dich als Einzelspieler durch drei immer schwierigere Missionskampagnen, die vom Überleben zu Kokosnusskämpfen führen oder kämpfe alleine gegen die Uhr, sei es als Team oder in einem Deathmatch.
<br><br>
Schließe weitere Wii-Fernbedienungen an, um gegen bis zu drei weitere Spieler anzutreten. Schließe ein Wii Balance Board an und bring dich noch mehr in den Spaß ein.
<br><br>
Möge der beste Affe gewinnen.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3350/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3350/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
