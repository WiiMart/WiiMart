...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">戦国の乱世より受け継がれし暗殺術「忍者五体技」の使い手である忍者を操り、戦慄のアメリカ都市「ジャングル」を舞台に、次々と現れる暗殺組織の敵を撃破していくアクションゲームです。「首投げ」「反動蹴り」「３段連続拳」など、３つのボタンの組み合わせで豪快なアクションが繰り出せます。各ステージは「西洋の間違った忍者・日本文化観」をベースに、忍者とアメリカが混ざったシュールな世界観でえがかれています。また、自キャラの数を増減したり難易度を変更したりなど、ゲーム設定の変更も可能です。<BR><BR>詳細は、<Center>
http://www.tecmo.co.jp/product/vca/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">忍者龍剣伝<sup>TM</sup></span></div>
</div>
