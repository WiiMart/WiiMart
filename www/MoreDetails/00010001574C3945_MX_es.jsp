...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C3945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">!Suelta tu creatividad! !Con "Let's Create! Pottery" hacer objetos de cerámica nunca ha sido más fácil y divertido! !Conviértete en un auténtico artista, crea objetos de cerámica “únicos” y compártelos con tus amigos! !Echa la arcilla en la rueda, libera todo tu talento artístico y aprovecha las docenas de materiales disponibles para crear tu propio diseno! Hasta cuando vidries y cuezas tu primera vasija te sentirás realizado y relajado ya que la alfarería es la mejor manera de aliviar el estrés diario y encontrar la paz interior. !Una experiencia increíble, terapéutica y edificante que puedes disfrutar con tu familia y amigos!
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C3945/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C3945/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Let's Create! Pottery</span></div>
</div>
