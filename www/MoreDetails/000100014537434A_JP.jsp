...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファイター（自機）を操作して敵基地を破壊していく、８方向移動・スクロール型のシューティングゲームです。身の危険を知らせてくれるコンピュータボイスや、前後同時のミサイル発射などが特徴的です。宇宙空間に登場するすべての敵基地を破壊するとラウンドクリア。敵の攻撃を受けたり、小惑星などの障害物に当たるとミスになります。画面内にときどき出現する偵察機を見逃すと、コンディションが「ＲＥＤ」となり敵の総攻撃が始まってしまいます。また、コンディションはゲーム中にも頻繁に変化し、５機編隊の敵機が襲ってきたりと、息もつかせぬスリリングなゲーム展開も魅力のひとつです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ボスコニアン<sup>&reg;</sup></span></div>
</div>
