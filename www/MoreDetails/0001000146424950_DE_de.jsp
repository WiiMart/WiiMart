...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Du bist Little Mac, ein 17 Jahre alter Boxanfänger aus dem Herzen der Bronx. Was dir an Körpergröße fehlt, machst du durch deine Entschlossenheit wett. Es ist Zeit, dich unter der Anleitung deines Trainers Doc Louis den besten Boxern der Welt zu stellen!
<br><br>
Punch-Out!! basiert auf dem Original aus der Spielhalle und ist ein unterhaltsames Boxspiel, in dem der etwas klein geratene Hauptcharakter unter anderem gegen den Franzosen Glass Joe mit seinem empfindlichen Kinn, den Russen Soda Popinski und den mysteriösen Titelverteidiger, Mr. Dream, antritt.
<br><br>
Setze verschiedene Schlagtechniken ein - Geraden, Schläge auf den Körper und Aufwärtshaken - und entdecke den Schwachpunkt deines Gegners, um zum entscheidenden Schlag anzusetzen. Außerdem hat Mario einen Gastauftritt als Ringrichter!
<br><br>Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Punch-Out!!<sup>&reg;</sup></span></div>
</div>
