...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157443950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Castlevania The Adventure ReBirth recupera el estilo tradicional de acción y plataformas de los primeros juegos de Castlevania con una emocionante experiencia de arcade llena de intriga.
<br><br>
Métete en la piel de Christopher Belmont, un heroico guerrero de una larga saga de cazadores de vampiros, y pon fin al reino del mal de Drácula. Son tiempos oscuros para la humanidad. Drácula ha salido de su tumba y se cierne una vez más sobre estas tierras. Su ejército de monstruos procedentes de las profundidades infernales siembran el caos a sus órdenes.
<br>
¡Parte en busca de Castlevania para acabar con Drácula!
