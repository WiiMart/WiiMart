...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">近未来を舞台にしたレースゲーム「Ｆ－ＺＥＲＯ」シリーズの第二弾。個性豊かなマシンが３０種類と大幅に追加され、また、コースが立体化されたことで、起伏の激しいコースが実現し、アクション的な要素が増えました。さらに、登場するすべてのコースで練習や最高４人までの対戦も可能。タイムを競うだけでなく、自分以外のマシンを破壊するまでの時間を競うモード「ＤＥＡＴＨ ＲＡＣＥ」も楽しめます。

<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｆ－ＺＥＲＯ<sup>&reg;</sup>　Ｘ</span></div>
</div>
