...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157434950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In CRYSTAL DEFENDERS R1, you must deploy various units such as Soldiers and Black Mages to stop wave after wave of encroaching monsters from escaping the area with your party's crystals.<br><br>

There are many different types of units to choose from, some specializing in powerful short-range attacks, some wielding far-reaching magicks, and still others equipped with bows, enabling them to bring down aerial foes. Deploy units in strategic locations to take full advantage of their traits.<br><br>
...
CRYSTAL DEFENDERS R1 comes complete with a plethora of exciting stages, each varying in layout and difficulty. Can you defend them all without losing a single crystal?</div>
  <div id="image02">
