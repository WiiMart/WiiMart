...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D4350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El planeta Monsteca ya no es el tranquilo mundo de siempre; ahora lo ha invadido una armada de robots dispuestos a conquistarlo y dominarlo. A los habitantes de Monsteca, los Stompies, no les queda más opción que huir o dejarse capturar. Al no poder defenderse por sí solos de semejante maquinaria, deberán confiar en la fuerza de su manada para trabajar unidos y derrotar a estos entrometidos robots.
<br><br>
Asumirás el control de los Stompies, unos monstruos adorables pero no demasiado inteligentes, que, una vez que se despiertan, necesitan ayuda para no ser capturados por los robots invasores. A ti te corresponde guiarlos con éxito a través de cada nivel.
<br><ul>
<li>Un divertido juego de estrategia en 3D de gran fluidez.</li><li>Dinámico y estimulante para la inteligencia.</li>
<li>Banda sonora interactiva.</li>
<li>Veinte niveles que conquistar con muchas horas de juego.</li><li>Modo de trofeos para aumentar el reto.</li><li>El único juego con Astromaggots.</li></ul><br>Textos de pantalla en español.</div>
  <div id="image02">
