...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Disfruta de la impactante continuación del legendario Samurai Shodown II, publicada por primera vez en 1995, y descubre todo lo acontecido entre los dos primeros capítulos de la serie!
<br><br>
Métete en la piel de uno de los 12 personajes disponibles y desafía en duelo al temible Zankuro Minazuki. Además de defenderte en el aire y pulsar repetidamente los botones para llenar el medidor de agresividad, la mejora más relevante de este nuevo capítulo de la serie consiste en que cada luchador dispone ahora de dos estilos de combate bien diferenciados. Cada estilo pone a tu disposición una serie de movimientos especiales únicos y exclusivos, por lo que, técnicamente, el número de personajes controlables asciende a 24.
<br><br>
Textos de pantalla en inglés, español, portugués, japonés o coreano.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
