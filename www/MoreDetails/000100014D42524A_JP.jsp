...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スパイ映画さながらの活躍が楽しめるアクションシューティングゲームの第二弾。プレイヤーは、ＷＣＰＯの特殊作戦部隊「ローリングサンダー」の工作員「アルバトロス」と「レイラ」となって、よみがえった悪の秘密組織「ネオゲルドラ」に戦いをいどみます。人造人間軍団に立ち向かうプレイヤーの武器は基本的に拳銃ですが、途中ではマシンガンや火炎放射器なども入手可能。ジャンプや低い姿勢で敵の弾を避け、ハイジャンプで２階と１階を行き来するなど、スパイアクションを華麗に駆使してステージを攻略していきます。２人同時プレイも可能となり人気を博したアーケード版をベースに、本作では新たなステージが追加されパワーアップ。戦いの舞台は、マイアミから灼熱のエジプトへとダイナミックに展開していきます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ローリングサンダー<sup>&reg;</sup> ２</span></div>
</div>
