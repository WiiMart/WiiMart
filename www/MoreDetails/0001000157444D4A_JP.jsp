...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157444D4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アクションパズル「Ｄｒ．ＭＡＲＩＯ」と、「もっと脳を鍛える大人のＤＳトレーニング」に収録された「細菌撲滅」が、１つになってＷｉｉウェアに登場。<BR>
ルールは簡単。落ちてくるカプセルを操作して、同じ色のウィルスとカプセルをタテ・ヨコに揃えて消すだけ。シンプルな操作で誰もが楽しめるパズルゲームです。<BR><BR>

●Ｄｒ．ＭＡＲＩＯ<BR>
おなじみのオリジナルモードと２種類の対戦モードで遊べるほか、遠くにいる友達や世界中のプレイヤーとＷｉ-Ｆｉ対戦が可能。また、友達が「Ｄｒ．ＭＡＲ
ＩＯ ＆ 細菌撲滅」を持っていなくても、「フレンドタイセン限定版」を送ることでＷｉ－Ｆｉ対戦が楽しめます。<BR><BR>

●細菌撲滅<BR>
Ｗｉｉリモコンでカプセルを操作。直接カプセルをポイントして、回したり引っ張ったり。直感的な操作でウィルスを退治していきます。Ｗｉｉリモコンが４つあれば、同時に４人で協力プレイが可能。一度にたくさんのカプセルを動かして、効率よくウイルスを退治することもできるので、みんなのチームワークが大切です。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444D4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｄｒ．ＭＡＲＩＯ ＆ 細菌撲滅<sup>TM</sup></span></div>
</div>
