...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mike Jones è un normale studente delle scuole superiori che si trova coinvolto in una straordinaria avventura! Invitato dallo zio archeologo a fargli visita su un'isola tropicale, al suo arrivo Mike scopre che lo zio è stato rapito. Il ragazzo giura di trovarlo e di svelare il mistero che si cela in quello splendido paradiso tropicale!
<br><br>
In StarTropics potrai esplorare l'isola a piedi o con il sottomarino dello zio di Mike oppure perlustrare caverne abitate da mostri e sconfiggerli usando un gran numero di armi e di strumenti.
<br><br>
Nella sua versione originale StarTropics includeva una lettera dello zio di Mike, che era necessario reperire per avanzare nel gioco. Nella versione per la Virtual Console, tale lettera è presente nel manuale di istruzioni, accessibile tramite il menu HOME.<br><br>Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
