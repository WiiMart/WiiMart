...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750554A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">｢パズルボブル Ｗｉｉ｣はカラーバブルを発射して同色のバブルを３個以上くっつけて消す単純明快なパズルゲームです。ゲームモードは２種類のモードから楽しめます。「１Ｐ ＰＵＺＺＬＥ」は各ゾーンで区切られた全１３５ステージをクリアし、スコアとクリアタイムに挑戦するパズルモードです。「ＢＡＴＴＬＥ」はＣＰＵやプレイヤー同士で対戦を楽しめる対戦モードです。更に、２種類の追加コンテンツを購入すると、新たに全２７０ステージを楽しむ事ができます。シンプルで奥が深いパズル要素と、飽きさせない大ボリュームが特徴のＷｉｉウェア版「パズルボブル」です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750554A/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750554A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">PUZZLE BOBBLE Wii</span></div>
</div>
