...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ＲＰＧ「ファイナルファンタジー」シリーズ第５弾。<BR>ジョブチェンジシステムを更に発展させたアビリティ（得意技）の追加により、魔法を使えるナイト等、自分好みのキャラクターを育てられます。<BR>快調なテンポのストーリー、荘厳なサウンド、生活感あふれる町、大空を爽快に飛行する飛空艇なども魅力です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファンタジー<sup>&reg;</sup>V</span></div>
</div>
