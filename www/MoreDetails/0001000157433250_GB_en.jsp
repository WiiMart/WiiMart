...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157433250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In CRYSTAL DEFENDERS R2, you must deploy various units such as Fencers and Black Mages to stop waves of encroaching monsters from escaping the area with your party's crystals.<br><br>

There are many types of units to choose from, some specializing in powerful short-range attacks, some wielding far-reaching magicks, and still others equipped with bows, enabling them to bring down aerial foes. Deploy units in strategic locations to take full advantage of their traits.<br><br>

Each time an enemy breaches your defences and reaches a map's exit, your party will lose crystals. When all your crystals are gone, the game is over.<br><br>

R2 offers several new, challenging maps containing multiple entrances and exits. It also introduces three varieties of Power Crystals, allowing you to enhance the abilities of your units, while new jobs, including Flintlock and Tinker, set the stage for even more complex strategies.<br><br>

Can you defend all the maps without losing a single crystal?</div>
  <div id="image02">
