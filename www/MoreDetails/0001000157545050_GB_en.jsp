...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157545050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tetris Party is a deceptively simple, totally addictive puzzle game that is sure to keep you and all of your friends and family entertained for hours on end. The WiiWare game features never-before-seen single-player and multiplayer variations of Tetris, including Field Climber, Stage Racer, Shadow, and Wii Balance Board-enabled modes. Several of the modes give users the chance to take advantage of the unique point-and-shoot capabilities of the Wii Remote. <br><br>Supports the Wii Balance Board.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545050/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545050/FFFD000A" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
