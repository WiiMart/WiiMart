...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158495545')", "wiiSelectSound()");
...
<p>
Experience soccer of the future—destroy the defender blocks and smash the ball into the goal to win, but watch for the enemy defenders out to destroy you! A built-in game editor offers unlimited level design possibilities, or play through the 90 game levels over several different play modes, including Arcade and Customizable Tournaments.
<p>
- 90 Levels of goal scoring, block breaking fun.<br>
- Special level features including animated blocks, exploding blocks, shield blocks, invisible blocks and deadly 3D defender enemies.<br>
- 9 challenging end of zone bosses to defeat.<br>
- Level Editor to build your own levels. Up to 100 user created levels can be stored.<br>
- Tournament Mode allows you to create your own unique tournaments using game levels or your own levels.<br>
- Special Power-Ups and Super Power-Ups to help (or hinder) you on the way to the goal, including lasers, bombs, flaming power balls, and multiple balls and bats.
<p>
(Content available in English only.)</div>
  <div id="image02">
