...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157484545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The famous Heracles has taken on a challenge like none he has ever faced! Our hero will have to beat his opponents in a race across mythological kingdoms and be the first to reach the top of Mount Olympus. You can play as Heracles and help him return the sacred trophy or play as one of the other varied mythological characters from Satyr to Poseidon and claim the prize for yourself! Race through three racing cups across ten courses set in five mythic landscapes, and use awesome fantasy weaponry to defeat your opponents: tridents, fireballs, Zeus’s lightning rods, and more! Get your friends together for intense two-to-four-player split-screen multiplayer action in Championship, Single Race, or Battle mode!</div>
  <div id="image02">
