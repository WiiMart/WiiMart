...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158494E50')", "wiiSelectSound()");
...
<br><br>Welcome to the world of the PooYoos, the first fun poetic braintrainer for children 3-6 years old.
<br><br>
With the PooYoos, a merry band of adorable baby animals, children will have fun while learning the basics for his or her development: numbers, letters, lateralization, shapes, colors and more. Children get to dance with their new friends and are offered lovely interactive rewards. There are two levels of interactivity, so children can play whatever their age and level.
<br><br>
This game has been designed for use by children who have not yet grasped reading.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494E50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Episode 1 - Demo</span></div>
  </div>
