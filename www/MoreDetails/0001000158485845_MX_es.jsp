...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158485845')", "wiiSelectSound()");
...
<p>
BIT.TRIP RUNNER: ¡El juego de acción y plataformas más rápido y emocionante disponible en WiiWare!
<p>
¡Corre a lo largo de la Luna, derribando muros de cristal y esquivando hambrientas babosas lunares! ¡Atraviesa las Minas Robóticas y enfréntate al MinerMech! ¡Atraviesa a la carrera la Gran Ciudad en busca de amigos y venced juntos al jefe final!
<p>
RUNNER es la cuarta parte de la premiada y aclamada por la crítica serie BIT.TRIP.
<p>
• ¡Controla a CommanderVideo, haz que corra, salte, se deslice, golpee y mucho más!<br>
• ¡Un juego extremadamente adictivo, el tipo de juego que te hace decir “solo una vez más”!<br>
• ¡Con emocionantes retos modernos y retro, recorre más de 50 niveles!<br>
• ¡El supergrupo chiptune Anamanaguchi aparece como invitado!
<p>
¡Únete a CommanderVideo en BIT.TRIP RUNNER en su viaje más épico!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158485845/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158485845/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BIT.TRIP RUNNER</span></div>
</div>
