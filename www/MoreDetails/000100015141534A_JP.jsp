...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ヘヴィメタル調のＢＧＭにのって鎧をまとった剣士が戦う横スクロール型シューティングゲームです。ミストラル王国の６大陸に封印された「暗黒神ザガード」を復活させようともくろむ「ガルド帝国軍」に、剣士「ランディー」が戦いをいどみます。プレイヤーは、６つのステージのどれから攻略するかを選び、さらにステージのはじめには「地・水・火・風」の属性を持つ鎧の中から１つを選択します。攻撃方法はショットと剣攻撃、および広範囲を攻撃できる「精霊召喚」。鎧によって攻撃方法が異なるので、ステージによって鎧を使い分けることがポイントです。敵の攻撃を受けるとライフが減り、ライフが０になるとゲームオーバーです。敵を倒すと手に入る「クリスタル」でステージ開始前にアイテムを購入できるので、精霊召喚をはじめさまざまなアイテムで自機を強化しましょう。ステージには魅力的な敵キャラが続々登場し、また中盤の高速スクロールから中ボス・大ボスの待つ宮殿へ突入していくスピーディな展開は迫力満点で、ゲームを盛り上げます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ウィンズ オブ サンダー</span></div>
</div>
