...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Die verbesserte Version der berühmten “Lode Runner”-Serie beinhaltet einen Fünf-Spieler-Versus-Modus. Gold wurde aus dem Zeitmaschinen-Forschungszentrum gestohlen. Die verantwortliche Gruppe nutzt eine Zeitmaschine zur Flucht, um das Gold in verschiedenen Zeitabschnitten zu verstecken. Das Zentrum sendet die Elitegruppe “Runners”, um das Gold zurückzuholen.
<br><br>
Zusätzlich zum bekannten “PUZZLE”-Modus gibt es einen “BATTLE”-Modus, in dem bis zu fünf Spieler antreten und den “EDIT”-Modus, in dem du eigene Stufen erstellen kannst.
Genieße den “BATTLE”-Modus in diversen Varianten. Sei der letzte Verbleibende, um “SURVIVAL” zu gewinnen. Schnapp dir Gegenstände von Gegnern und flüchte, um “ESCAPE” zu gewinnen. Mit vier Spielern, aufgeteilt in zwei Teams, kannst du im “TAG MATCH” kämpfen.
<br><br>Im Mehrspielermodus benötigt jeder Mitspieler eine Wii-Fernbedienung oder einen Nintendo GameCube-Controller. Um zu fünft zu spielen, wird mindestens ein Nintendo GameCube-Controller benötigt.
