...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">À bord du Solvalou, votre unité de combat, affrontez les forces d' «Andor Genesis» et partez à la conquête de la planète Xevious !
Détruisez les cibles aériennes avec vos «Missiles Zapper» et bombardez les cibles terrestres avec vos «Bombes Blaster» !
Xevious est un jeu de tir vertical qui fut une révolution en son genre lorsqu'il sortit sur NES.
Quand les jeux de l'époque proposaient pour tout décor un simple fond noir, Xevious introduisit avec splendeur le bleu des océans et le vert des forêts.
La qualité des animations, la présence de bonus secrets disséminés à travers les niveaux ainsi que la jouabilité exemplaire ont joué un rôle 
majeur dans l'évolution des jeux de tir qui ont suivi.
Nous vous invitons à découvrir l’ampleur du monde de Xevious et ses nombreuses énigmes, qui font de ce titre une légende.<br><br>

Mode 2 joueurs : le joueur 1 et le joueur 2 prennent le contrôle à tour de rôle (après chaque vie perdue).<br>
Deux manettes sont nécessaires.

<br><br>Le texte à l'écran sera en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Xevious<sup>TM</sup></span></div>
</div>
