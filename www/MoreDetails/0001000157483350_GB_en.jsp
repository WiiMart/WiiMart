...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157483350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Picture this scene...
<br><br>
...
<br><br>
With simple controls, a fun graphical style, and an easy to use interface, Home Sweet Home allows you to nurture your creative side. Remember, a house is not a home until it is a Home Sweet Home!</div>
  <div id="image02">
