...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Across the galaxy, there exists a distant planet known as Gradius.  Gradius’s peaceful existence has been brought to an end by an intense space invasion by a race known as the Bacterion.  To save the planet, the hyperspace fighter Vic Viper has been deployed to fight the Bacterion invasion.  Pilot the Vic Viper through seven stages, shooting and dodging through deadly obstacles, while powering up your ship with various power-ups, including missiles, lasers, options, and shields.  The Vic Viper’s target is the enemy fortress, Xaerous.  The only way to end the war is to plunge deep through the enemy forces and destroy its very core.  And so, the Vic Viper takes off, far into the depths of space!</div>
  <div id="image02">
