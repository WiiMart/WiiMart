...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Teste deine Fähigkeiten im Pokémon-Duell und Lösen von Puzzles gegen die besten Trainer von Puzzle Village! Ein rascher Geist und flinke Finger sind unverzichtbar, wenn du durch das Kombinieren gleichfarbiger Blöcke Puzzleteile aufzulösen und so den Sieg zu erringen versuchst. Je mehr Teile du gleichzeitig auflöst, desto mehr Punkte erhältst du. 
<br><br>
Bewirke mächtige Combos oder Kettenreaktionen, um deinem Gegner (entweder der CPU oder einem Freund) große Störblöcke unterzuschieben, und gewinne Abzeichen von rivalisierenden Trainern, um schließlich zum Puzzle-Meister zu werden!
<br><br>
Neben dem Kampf erwarten dich aber auch viele andere spannende Herausforderungen, vom 3D-Puzzlemodus bis hin zu den hirnzermarternden Übungen in der Puzzle-Universität. Bist du bereit für eine neue Art von Pokémon-Kampf?
<br><br>Deutscher Bildschirmtext.<br>Keine Unterstützung der Rumble-Funktion des Originals.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414E44/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414E44/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
