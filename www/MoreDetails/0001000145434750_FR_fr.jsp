...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Shock Troopers: 2nd Squad est un jeu d’action militaire sorti en 1998. Afin de stopper une grande entreprise devenue incontrôlable, choisissez parmi l’un des quatre mercenaires et battez-vous en utilisant différentes armes et en sautant. Le système de score de l’épisode précédent, très apprécié, est de nouveau présent. Les personnages, eux, sont nouveaux. De plus des changements majeurs, comme l’ajout de véhicules ou d’embranchements à prendre durant les passages importants, rendent le système de jeu plus encore plus facile et intuitif.<br><br>Texte écran en anglais.</div>
  <div id="image02">
