...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">魔王ベルゼブルにより捕らわれの身となった、王や王妃、王女を救出するために、主人公のジャックがアイテムやジャンプを駆使しながら魔の大ピラミッドに挑むアクションゲームです。画面は縦横自由にスクロールすることができ、爽快感と達成感のあるアクションが醍醐味です。ステージは全１６面と＋αのおまけ面で構成。ゲーム史上初めてゲーム偏差値を搭載したシステムは、当時、非常に画期的でした。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マイティボンジャック</span></div>
</div>
