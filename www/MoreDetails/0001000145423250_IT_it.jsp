...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pubblicato nel 1997, REAL BOUT FATAL FURY SPECIAL è il sesto gioco della serie di picchiaduro Fatal Fury. Pur mantenendo lo stesso impianto di gioco, ci si potrà divertire ad attuare le più svariate strategie grazie alla rivoluzionaria introduzione di due piani di combattimento separati, al perfezionamento della barra di energia e all'esclusione delle eliminazioni per ring-out. Ai quindici personaggi presenti nel precedente capitolo, si aggiungono Tung Fu Rue, Cheng Sinzan, Lawrence Blood e Wolfang Krauser, per un totale di diciannove personaggi selezionabili.
Combattenti senza alcun dubbio degni della loro fama si sfidano ancora una volta per dimostrare chi è il più forte!
