...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157574C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You play Frankie, the hero of the story. Frankie is a young orphan who must help his great-great uncle, the professor Frankenstein, to build a strange machine.<br>
To help him the professor gives him a “Steampack”: a device which is able to suck up vaporites (strange clouds that keep destroying mechanical engines) and to unearth treasures.</div>
  <div id="image02">
