...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158494745')", "wiiSelectSound()");
...
<p>
- Enhanced gameplay based on decades-old classics<br>
- Three different worlds that have different gameplay modes<br>
- 150 levels set across all worlds<br>
