...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">恐竜たちが暮らすジュラ星を舞台に、笑いあり涙ありの心温まるストーリーが展開する、リアルタイムシミュレーションゲームの傑作です。前作からの斬新なゲームシステムはそのままに、遊びやすさと戦略性が格段にアップしました。最大の目玉は、恐竜たちと宇宙人たちの、戦いの中ですれ違う複雑な人間（？）模様がドラマチックにえがかれたストーリーモード。手に汗握る先の読めない展開がプレイヤーの心をゆさぶります。さらにバーチャルコンソール版の本作は、ケーブルテレビ配信サービス「セガチャンネル」でしか遊べなかった幻のスペシャルバージョン。多数の新ステージやオマケ要素の他、待望のセーブ機能も追加されています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダイナブラザーズ２スペシャル<sup>TM</sup></span></div>
</div>
