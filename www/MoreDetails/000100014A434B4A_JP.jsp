...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ビーム砲を左右に動かし、降りてくるインベーダーを撃つ、シンプルな固定画面型シューティングゲームです。すべてのスペースインベーダーを撃ち落とせば、ステージクリアです。ビーム砲台のストックがなくなったり、インベーダーに陣地を占領されてしまうとゲームオーバーになります。シューティングゲームブームのさきがけとして一世を風靡した当時のゲームセンターと同じ画面モードでもプレイできるほか、２人対戦モードも搭載されています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
