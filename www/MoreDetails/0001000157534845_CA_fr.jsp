...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157534845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stonekeep. The legendary city was once ruined by a dark god’s magick, but saved by your ancestors. Now the legend of Stonekeep requires a new hero: you!
<p>
Explore dungeons, watch out for deadly traps, fight monsters with a variety of weapons or control dangerous magicks. The choice is yours. But all is not lost. There are allies within the halls of Stonekeep. Choose one to help lead you to victory.
<p>
Features:<br>
*Wield melee weapons, throw projectile weapons or burn your foes with magick.<br>
*Discover new magicks and cast compound spells.<br>
*Explore the Dungeon, Stables, and all Four Halls of the Elements on your way to the Dark Realm.<br>
*Defeat monsters and loot treasures to assist you on your quest.
<p>
