...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Take on the role of Alex Kidd in this cheery 80s platformer. As Alex, your goal is to seek out your lost brother, Egle, who has been kidnapped by the nefarious Janken the Great.
<br><br>
Your heroic journey to free Egle will pit you against not just monsters, but four of Janken's villainous henchmen. However, there's a catch - you will have to defeat them using the age-old game of Rock-paper-scissors!
<br><br>
Put your skills and quick wits to the test as you run, swim and punch your way through 16 exciting and action-packed levels!
<br><br>
Note: 
This game is presented as it was originally released in 1986. Modifications included in the SEGA MASTER SYSTEM "built-in" version are not reflected in this release.</div>
  <div id="image02">
