...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">스케이트가 특기인 펭귄이 남극 대륙을 무대로 목표 지점을 향하는 액션 게임입니다. 빙판 구멍, 크레바스, 익살맞은 바다표범 등의 장애물을 점프나 스케이트 테크닉, 깃발을 획득하면 얻을 수 있는 "펭기콥터" 등을 사용해서 피합니다. 제한시간 내에 남극 대륙에 펼쳐진 각국의 기지에 도달하여 대륙 일주를 목표로 합니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146434E51/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146434E51/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Antarctic Adventure</span></div>
</div>
