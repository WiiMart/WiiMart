...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000148434A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Making the unmissable, unmissable
<br><br>
This NEW Wii Channel provides you with a better and higher quality version of BBC iPlayer on Wii. BBC iPlayer lets you catch up on BBC TV and Radio programmes from the last 7 days. All on your TV, from the comfort of your sofa.
<br><br>
You shouldn’t have any trouble getting to grips with BBC iPlayer - just use your Wii Remote and follow the on-screen instructions. You can find the BBC programme you want by programme type, name or channel. Just press play, sit back and enjoy your favourite show on your full TV screen. 
<br><br>
Plus, the built-in Parental Guidance features mean you won't have to worry that younger family members are watching things they shouldn’t. 
<br><br>
Note: Active broadband access required (additional fees may apply). BBC TV and Radio Programmes are available in the United Kingdom only. To use BBC iPlayer your Wii console’s Country setting in the Wii Settings must be set to United Kingdom.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434A50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434A50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BBC iPlayer</span></div>
</div>
