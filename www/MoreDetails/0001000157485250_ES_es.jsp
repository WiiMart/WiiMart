...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157485250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Heron: Steam Machine es un juego sobre una fábrica en la que una gran máquina de vapor produce patitos de goma. En esta máquina de vapor hay cuatro indicadores que tendrás que vigilar atentamente.
<br><br>
Al conectar las tuberías, ganarás puntos y sacarás presión, ¡haciendo que la máquina siga funcionando un poco más! Si uno de los indicadores llega al máximo, la máquina reventará y acabará el juego.
<br><br>
Si tienes suerte y consigues una puntuación máxima, ¡asegúrate de escribir tu nombre en la lista para que otros jugadores puedan competir contigo!
<br><br>
En Multijugador, podrás cooperar con tus amigos para mantener la máquina de vapor. Cuando juegas con dos, tres o cuatro jugadores, la pantalla se divide en secciones con fondos de colores distintos. Cada jugador puede resolver su propia parte del puzle. Los jugadores están limitados a su sección de la pantalla, ¡así que tendréis que cooperar para que las tuberías encajen bien!
<br><br>
