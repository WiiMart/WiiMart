...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157505A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bruiser y Scratch se encuentran en un extraño mundo con un oscuro secreto. Su única esperanza de encontrar un camino a casa es en desenredar el misterio de este lugar, un rompecabezas de gran tamaño. A lo largo del camino, hacen nuevos amigos y vuelven a enfrentarse con viejos adversarios, cada uno de los cuales desempeñan un papel en su viaje. Bruiser y Scratch ofrecen una serie de niveles de tutoría para que el jugador se desarrolle  gradualmente.  El cuento se desarrolla en más de 48 rompecabezas y seis paisajes. Y para los jugadores que no pueden obtener suficiente, el modo “Challange” ofrece adicionalmente, 75 rompecabezas nuevos que van desde un juego de niños a los mas desafiantes.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bruiser and Scratch</span></div>
</div>
