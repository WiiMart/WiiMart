...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mike e Spike Bonanza stanno guardando il loro programma televisivo preferito quando, all'improvviso, appare sullo schermo la figura oscura di un misterioso sconosciuto che chiede loro di recuperare alcuni oggetti nascosti in vari edifici, per metterne alla prova il sistema di sicurezza. Se riusciranno a riportare gli oggetti, Mike e Spike saranno ricompensati. I due fratelli dichiarano di essere in grado di portare a termine la missione in soli tre minuti. Tuttavia non sanno che ciascun edificio è protetto da delle guardie pronte a dare l'allarme se li scopriranno. Fortunatamente Mike e Spike sono in possesso di armi stordenti in grado di mettere fuori combattimento le guardie per alcuni secondi. Una grossa ricompensa spetta a chi arresterà Mike e Spike. Aiuta i famigerati Bonanza Bros a infiltrarsi in diversi edifici, fra i quali banche, ville e casinò. Occhio a non farti catturare!<br><br>Il testo all'interno del gioco è in inglese.<br>Non supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
