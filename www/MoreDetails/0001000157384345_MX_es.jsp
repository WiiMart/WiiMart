...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157384345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP CORE continúa la saga BIT.TRIP con este juego de estilo retro arcade. BIT.TRIP CORE es un divertido juego de acción y ritmo, que se juega olvidándose de los tonos y dejándose llevar totalmente por lo que se ve. Se inspira en juegos de los 80, pero tiene un toque más moderno. La forma de jugar es nueva en la serie, descartando el control de un solo eje de BIT.TRIP BEAT en favor de la habilidad de controlar dos ejes. Si te resulta demasiado difícil, llama a un amigo y juega en equipo en modo multijugador para 2 jugadores. Llega al final y habrás dado un paso más para completar tu BIT.TRIP.</div>
  <div id="image02">
