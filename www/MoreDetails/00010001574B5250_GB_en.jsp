...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574B5250')", "wiiSelectSound()");
...
<br>
Karate Phants is a 1-on-1 fighting game for 1-2 players featuring characters from Otto Waalkes´comic strip. Fight your way to the top of the tournament by defeating all the computer-controlled fighters, or duke it out with a friend.</div>
  <div id="image02">
