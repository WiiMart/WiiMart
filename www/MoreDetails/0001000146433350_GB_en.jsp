...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bubble Bobble is a puzzle-action game featuring the two Bubble Dragons, Bub and Bob. When it hit arcades in 1986 it introduced brand-new play mechanics, with players defeating enemies by trapping them in bubbles they blew and then popping them.
<br><br>
...
<br><br>
Each round even has different air currents that are not visible, making bubbles rise in unpredictable patterns. Aspects like forcing players to understand and make use of these different patterns while playing helped make Bubble Bobble a revolutionary action game at the time.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
