...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cette chaîne est destinée aux joueurs de The Legend of Zelda: Skyward Sword.
<br><br>
Durant la quête du Chant du héros, après avoir obtenu la mélodie du désert, les événements relatifs au chant peuvent ne pas se déclencher dans le volcan et la forêt, empêchant ainsi de progresser. Cette chaîne a pour but de réparer les données de sauvegarde des joueurs se trouvant dans ce cas de figure. Si vous n'avez pas joué à The Legend of Zelda: Skyward Sword, vous n'avez pas besoin d'utiliser cette chaîne.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435250/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chaîne mise à jour des données</span></div>
</div>
