...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das schnellste Rennerlebnis des Universums kehrt zurück! F-Zero X ist der furiose Nintendo 64-Nachfolger des Super Nintendo-Kulthits - mehr Action jenseits der Schallmauer und der Schwerkraft als je zuvor!
<br><br>
...
<br><br>
Tritt solo im Grand Prix an, stelle neue Rundenrekorde im Zeitfahren auf, beseitige unliebsame Konkurrenten im K.O.-Rennen und tritt im Vs.-Kampf per Split-Screen gegen bis zu drei Freunde gleichzeitig an.
<br><br>Englischer Bildschirmtext.
<br>Keine Unterstützung der Rumble-Funktion des Originals.</div>
  <div id="image02">
