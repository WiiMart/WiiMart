...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">名作シミュレーションＲＰＧ『ファイアーエムブレム』シリーズのスーパーファミコン用第一弾ソフト。スーパーファミコン用にリメイクされた「暗黒竜と光の剣」（オリジナルシナリオはファミコン版）とスーパーファミコン用に新たに作成されたその続編のシナリオ「紋章の謎」がひとつにパッケージされたソフトで、どちらのシナリオからでもプレイ可能。ゲームを盛り上げるストーリーやイベント、多彩なキャラクターも魅力です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイアーエムブレム<sup>&reg;</sup>　紋章の謎</span></div>
</div>
