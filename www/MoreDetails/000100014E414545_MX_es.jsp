...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paper Mario es un juego con gráficos innovadores que rompe los esquemas del género de juego de rol (RPG).  Nuestro fontanero favorito, ahora más flaco, se voltea, gira, y da martillazos a través de una serie de mundos exóticos poblados por un entretenido elenco. Los jugadores deben controlar a varios personajes, antiguos y nuevos, en una compleja historia no-linear que sigue por distintos escenarios de acuerdo a las elecciones que el jugador haga. ¡Los jugadores que estén dispuestos a explorar en profundidad los fabulosos ambientes en 3-D podrán recoger una colección sorprendente de hechizos, ataques, habilidades, y muchos más elementos especiales!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Paper Mario<sup>&reg;</sup></span></div>
</div>
