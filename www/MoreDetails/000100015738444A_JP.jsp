...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015738444A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">メビウス・ドライブは、パワフルで個性的なカートを操作して、ライバル達とレースバトルを繰り広げるレースゲームです。サーキットを連戦し優勝を目指す”グランプリ”や、他のプレイヤーとの対戦が楽しめる”対戦レース（２人同時プレイ）”、ニンテンドーＷｉ－Ｆｉコネクションでの”Ｗｉ－Ｆｉ対戦（無料、最大８人同時）”が楽しめます。登場するサーキットは、ジェットコースターのような激しいアップダウン、走行中に起伏やコーナーが変動する画期的なギミックなどにより、常に予断を許さない迫力あるレイアウトとなっています。ドリフトやターボなどのテクニックを駆使し、次々に現われるライバルの追撃を華麗にかわして、最速ゴールを目指しましょう。あなたの走行はドライバーズポイントとなってカウントされ、称号を手に入れたり全国ランキングで腕を競うこともできます。Ｗｉｉリモコンでのシンプルで画期的な操作が生み出す”未体験の疾走感”を、存分にお楽しみください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015738444A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015738444A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メビウス・ドライブ</span></div>
</div>
