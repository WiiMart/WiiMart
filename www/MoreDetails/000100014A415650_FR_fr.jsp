...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le dernier Métroïde ayant été capturé, la galaxie est désormais en sécurité. Hélas, la talentueuse Samus Aran doit reprendre du service pour récupérer la larve métroïde dérobée par les Pirates de l'espace!
<br><br>
Retrouvez les dédales de la planète Zèbes et engouffrez-vous plus profond que jamais grâce à de nouvelles capacités telles que le "Grappling Beam" (Rayon Grappin) et le "X-ray Scop" (Rayon X permettant de révéler des passages secrets). Affrontez des boss redoutables à l'aide d'un formidable arsenal de rayons laser, de missiles et de bombes!
<br><br>
Super Metroid est considéré comme l'un des plus grands jeux d'action en 2D. Il a tracé la voie de la série des "Metroid Prime" avec son système de carte innovant, sa grande variété d'armes et de combinaisons et son grand nombre de bonus à découvrir.
