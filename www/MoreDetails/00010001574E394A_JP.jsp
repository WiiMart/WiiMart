...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574E394A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">PCエンジンにおいて人気を集めた戦術シミュレーション「ネクタリス」がWiiウェアに登場。<BR>舞台は月面。対立する 2 つの軍勢は、近未来兵器を投入し、激しいバトルを繰り広げていた。 軍勢の総指揮官となり戦況、地形に応じて、戦略的なユニット配置を行い、敵を殲滅、
撃破せよ。戦場での幸運を祈る。<BR><BR>1989年にＰＣエンジンで発売され、今もなお戦略シミュレーションの金字塔として熱狂的な支持を集めるネクタリス。海外では”ミリタリーマッドネス”として知られるネクタリスが今回、ネクタリスを愛してやまないアメリカの精鋭開発チームの手によって、新たな命を吹きこまれ、発祥の地、日本に「逆輸入」される！</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E394A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E394A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">NECTARIS（ネクタリス）</span></div>
</div>
