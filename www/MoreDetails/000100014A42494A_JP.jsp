...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">２Ｄ対戦格闘の代名詞「ストリートファイターⅡ」の続編。強力な必殺技を駆使して真の最強を目指します。各キャラクターには新しい技が追加され、前作では敵として登場した四天王「バイソン」「バルログ」「サガット」「ベガ」がプレイヤーキャラとして使用できます。また、「ターボモード」にすることで、ゲーム中のスピードを調整することが可能。スピードが早ければ早いほど正確な判断と操作が求められ、対戦プレイはさらなる興奮を呼び起こします。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42494A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42494A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ストリートファイター<sup>&reg;</sup>Ⅱ ターボ　</span></div>
</div>
