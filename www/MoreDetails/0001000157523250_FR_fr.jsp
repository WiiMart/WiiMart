...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157523250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un Lapin crétin est coincé à l’intérieur de la télécommande Wii ! Viens jouer avec lui !
<br><br>
Essaye dans un premier temps d’interagir avec lui en bougeant la télécommande Wii ou en appuyant sur les boutons et regarde comme il adore ça !
<br><br>
Une fois que tu auras fait connaissance avec le rongeur loufoque, il sera temps de modifier son apparence dans le laboratoire ! Déforme sa tête et places-y, en guise de couvre-chef, des accessoires aux couleurs des fêtes de fin d’année, et relooke-le intégralement grâce au module de peinture libre !
<br><br>
Quand tu auras un modèle unique de lapin crétin, n’hésite pas à le prendre en photo pour le faire découvrir à tes amis en leur envoyant par message Wii !
<br><br>
Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157523250/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157523250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Labo Lapins Crétins<sup>TM</sup></span></div>
</div>
