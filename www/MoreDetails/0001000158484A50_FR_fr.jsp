...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158484A50')", "wiiSelectSound()");
...
<br><br>
ThruSpace est un casse-tête 3D unique en son genre dans lequel vous pourrez tester vos réflexes et votre perception de l'espace. Vous devrez diriger et faire pivoter le solubloc, un bloc aux formes géométriques variées se déplaçant à toute vitesse, afin qu'il traverse des ouvertures dans une série de murs. Franchissez un maximum de murs et récupérez des cristaux pour obtenir un score record!
<br><br>
Une fois les commandes de base assimilées, maîtrisez l'art des combos figures et des combos cristaux. Certaines ouvertures étant plus larges que le solubloc, essayez de remplir totalement l'intérieur de ces espaces avec l'ombre du solubloc pour obtenir encore plus de points!
<br><br>
Trois modes de jeu sont disponibles: Chrono, Infini et Figures. Vous pouvez sauvegarder trois vidéos de vos meilleures parties et les revoir grâce au mode Souvenirs. Enfin, enregistrez vos scores dans le classement en ligne et comparez-les à ceux des meilleurs joueurs du monde entier!<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484A50/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
