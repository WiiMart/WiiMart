...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424E45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Los residentes del pueblo tienen hambre para lo último en la moda de follaje y tu decides como quieres—el nuevo peluquero—arreglarlos. Utiliza los instrumentos del comercio: las tijeras, las esquiladoras, la botella de rociar, y más, en este humorístico, primero de su clase, un juego de “Peluquería de Primera Persona”. 
<p>
Bonsai Barber presenta un lleno colorido reparto de doce clientes que intrigan, inclusive una actriz temperamental de cebolleta (¡pero no le llames una cebolla!), una científica fresa de persona excéntrica, un cactus vaquero, una zanahoria temeraria, y un plátano suave de alto secreto. 
<p>
Cada día, cinco clientes llegan a probar tu habilidad estilística. Si el cliente solicita un estilo específico tienes que arar ese surco, o puedes depender de su pericia para escoger de más de treinta modas populares... o por qué no pasar a una página nueva, ¡se creativo y ve cómo ellos reaccionan! 
<p>
Ellos son un ramo exigente, así que si pierdes una cita vas a enterarte de ello—en el Tablón de Wii. Pero, si haces un buena trabajo, puedes recibir un regalo o aún una tarjeta postal de un destino exótico, como tus clientes felices viajan a tierras lejanas para mostrar de sus cofias exquisitas. 
<p>
Una mordida sabrosa de un juego, es la peluquería en su más fino, en sólo minutos al día.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424E45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424E45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bonsai Barber<sup>TM</sup></span></div>
</div>
