...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">가까운 미래를 무대로 펼쳐지는 레이싱 게임. 공중에 부양하는 미래형 자동차 「F-ZERO」를 조종하며 9개의 도시, 15개의 서킷을 달려 그랑프리 석권을 노려 봅시다. 자동차는 각각 다른 특징을 가진 4종류의 차체 중에서 선택할 수 있습니다. 공중을 질주하는 짜릿한 조작감과 상쾌한 음악이 플레이어를 미래 세계로 이끌어 줄 것입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414354/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414354/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
