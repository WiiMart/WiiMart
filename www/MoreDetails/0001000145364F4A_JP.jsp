...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公「ジャック」を操作して、アイテムやジャンプを駆使しながらクリアをめざす固定画面型の空中浮遊アクションゲーム。ジャックが軽快なリズムに乗って、世界各地の名所に仕掛けられた爆弾を回収していきます。画面にあるすべての爆弾を回収すると１面クリアです。本作はジャンプの使い方に特徴があり、上下の入力で高さを変えたり再度ボタンを押すことで下降したり、多彩なジャンプを楽しめるのがポイントです。また、コインやパワーボールを取ったり、火のついた爆弾を順序良く回収することで高得点が狙えるなど、ボーナススコアに関する要素も多数用意されています。さらに、自キャラの数やボーナス、難易度などの設定変更も可能です。<BR><BR>詳細は、<Center>
http://www.tecmo.co.jp/product/vca/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145364F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145364F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ボンジャック<sup>TM</sup></span></div>
</div>
