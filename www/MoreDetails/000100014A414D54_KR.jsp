...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">초시공전투기「빅 바이퍼」를 조종하여 파괴신 박테리언의 침략과 맞서는 횡스크롤 슈팅 게임입니다. 사막과 화산 식물, 지대 등 다양한 장애물이 펼쳐지는 스테이지를 진행하여 마지막에 보스를 쓰러뜨리면 스테이지 클리어입니다. 파워업 기능을 이용하면 전투기의 속도를 높일 수 있을 뿐 아니라 미사일, 레이저, 옵션, 방어막 등을 전투기에 장비할 수 있습니다. 나만의 공략법으로 게임을 진행해 봅시다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414D54/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414D54/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">GRADIUS<sup>&reg;</sup> Ⅲ</span></div>
</div>
