...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158484E50')", "wiiSelectSound()");
...
<br><br>
Enter into the original world of Chronos Twins, where you'll live a fantastic adventure full of innovative ideas never seen before in any game. Thanks to its Dual Gameplay game system you'll be able to control Nec in two temporary scenarios at the same time. Chronos Twins mixes adventure, platforms and puzzles that will challenge your intelligence and ability.<br><br>
If you're after a game that is a real challenge, Chronos Twins DX is the game you're looking for.<br><br>
Special Features:<br><br>
• Explore an unknown world where you'll discover endless hidden secrets.<br>
• 19 levels of fantastic atmosphere fully packed with alien beings and spectacular final bosses.<br>
• Play in two worlds simultaneously to progress and overcome challenges that would be impossible to finish in only one world. <br>
• Change the past by moving items, defeating creatures... and the present will change accordingly in real time.<br>
• Observe how time passes by as you progress in your adventure.</div>
  <div id="image02">
