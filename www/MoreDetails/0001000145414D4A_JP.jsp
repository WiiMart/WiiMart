...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">近未来の大都市を舞台に、悪の忍者軍団と戦う横スクロール式の格闘アクションゲーム。プレイヤーは忍者ジョーまたはハヤブサを操作して、要塞「ニンジャタワー」を根城とする「影一族」と戦います。手裏剣や刀などでの通常攻撃や、画面上のすべての敵にダメージを与える忍術のほか、ジャンプや特殊移動、マップ上に落ちている武器や回復アイテムなどを有効に活用して戦いを進めてください。またゲームを進めることで、ムサシ、カゲロウ、ゲンブといった頼もしい仲間が増えていき、ステージごとにプレイキャラクターを選ぶこともできます。２人同時プレイもサポートしており、友達と一緒にプレイすることも可能です。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ニンジャコンバット</span></div>
</div>
