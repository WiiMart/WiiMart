...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">シューティングゲーム制作に定評のあるトレジャーが１９９５年にメガドライブに送り出した傑作アクションシューティングゲームです。『ガンスターヒーローズ』を超える、４５体にもおよぶボスとの戦闘が連続するステージ構成が話題を呼びました。ゼロテレポート、カウンターフォース、ホバリングなど強力なアクションをそなえた主人公「イプシロン２」となめらかな動きを見せる多彩なボスキャラたちとの攻防が、ノンストップで繰り広げられます。プレイヤーへの挑戦状とも言える激しい攻撃の前に敗北を重ねながら攻略法を見つけ出していく、面白さの原点ともいえるゲーム性は、今なおファンから高い支持を得ています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エイリアンソルジャー<sup>TM</sup></span></div>
</div>
