...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574D5758')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">nijntje's wereld is een 2D-spelwereld gebaseerd op het personage gecreëerd door Dick Bruna. In nijntje's wereld speelt het kind als Nijntje. Er moeten verschillende plekken worden verkend, opdrachten worden uitgevoerd, acties met vrienden en voorwerpen worden ondernomen en een serie van educatieve minigames worden gespeeld.<br><br>
  
Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5758/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D5758/FFFD0002" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">nijntje's wereld</span></div>
</div>
