...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Baan je een weg door het ruimtestation en versla de rondsluipende monsters in dit realtime eerste-persoonsschietspel.
<br><br>
Je maakt deel uit van het elite-team ‘Debuggers’, een groep strijders met uiteenlopende talenten, en wordt aangewezen om een onbemand ruimtestation te onderzoeken. Je hebt precies 100 minuten om binnen te dringen, de monsters te verslaan die in elk blok op de loer liggen, en op de onderste verdieping de automatische ontsteker onschadelijk te maken.
<br><br>
Ieder monster dat je laat ontsnappen, maakt het je lastiger om in het binnenste blok te overleven, dus snelheid is de sleutel om het station en de aparte blokken te beschermen.
Ervaar deze spannende race tegen de klok en ontdek wat zich in het ruimtestation werkelijk heeft afgespeeld.
...
<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434150/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434150/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Silent Debuggers</span></div>
</div>
