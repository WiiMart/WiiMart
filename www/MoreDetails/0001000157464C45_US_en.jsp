...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157464C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A magical illustrated encyclopedia, Aquaticus, has been tainted by a vial of evil ink called the Influence. You, as a pool of water that can take on other forms of ice and steam, must overcome obstacles scattered across the pages of Aquaticus and save it from the corruptive Influence.
<p>
Tilt or twist your Wii Remote controller to use the various forms and properties of water on your free-flowing journey through Aquaticus, where every page has multiple panels and illustrations that have come to life. Tackle problems and defeat enemies to reveal magical Rainbow Drops, each of which restores some of Aquaticus’ power and allows it to open more chapters and grant you new powers. These additional powers, such as sticking to objects as a block of ice or shooting bolts of lightning as a steam cloud, will be needed to win the day and destroy the Influence and its minions.
<p>
Along the way, you can also test your ingenuity and reflexes by finding hidden puzzle pieces. These unlock playrooms that give you the opportunity to use the skills you’ve learned and dare you to race against the clock to beat as many challenges as possible. These challenges won’t affect your quest to restore Aquaticus’ powers, but everyone needs a break now and again, right?
<p>
Fluidity offers the chance to slosh and slide your way through an imaginative environment, filled with challenging adventures, using intuitive play control. Are you ready to dive into this unique experience and save the day?</div>
  <div id="image02">
