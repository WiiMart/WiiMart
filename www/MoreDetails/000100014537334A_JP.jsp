...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">正義感に燃えるフレッシュポリス「マッピー」となって、いたずら好きの「ニャームコ」たちが持っていってしまった品物（ターゲット）を取り返していくアクションゲームです。トランポリンで上下してフロアーを移動し、館に散らばったターゲットを全て取り返すとラウンドクリアです。通路でニャームコや手下の「ミューキーズ」に捕まったり、床下や落とし穴に落ちるとミスになり、マッピーの残り数が１つ減ります。マッピーの残り数が０のときにミスするとゲームオーバーになります。パワードアやベル、落とし穴などの仕掛けをうまく使って、ピンチを切り抜けましょう。同じターゲットを連続して取ると得点が２倍、３倍、４倍……とアップ。ニャームコが隠れているターゲットを取るとボーナス点が加算されるので、高得点のチャンスです。
ドアアタックやドアダッシュなどのテクニックも駆使してハイスコアをめざしてください。キャラクターのかわいい動きや楽しいゲームミュージックで、幅広いユーザーに支持されたタイトルです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マッピー<sup>&reg;</sup></span></div>
</div>
