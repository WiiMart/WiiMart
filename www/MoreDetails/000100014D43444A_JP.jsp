...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ソニック・ザ・ヘッジホッグ３』のストーリーの続きをえがくシリーズ第四弾。浮遊島に墜落したエッグマンの要塞「デスエッグ」の復活を阻止するべく、超音速ヒーロー「ソニック」とライバルの「ナックルズ」が、それぞれの個性を生かして活躍するアクションゲームです。本作最大の特徴は、カートリッジに他のソフトのカートリッジを装着する「ロックオンシステム」。バーチャルコンソール版では、その機能も再現しています。メガドライブの『ソニック』１～３のどれかを持っていると、ゲームがパワーアップ。『ソニック３』をロックオンすれば、スーパーエメラルドを集める完全版ストーリーとなり、２つのゲームが連続して進行。エンディングも変化します。
その他にも『ソニック２』や『ソニック３』でナックルズを使えるようになるなど、お楽しみ要素が満載です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソニック＆ナックルズ<sup>TM</sup></span></div>
</div>
