...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A huge global hit at the arcades, this classic shooter blasts its way back on Virtual Console!
...
<br><br>
Weaving your way back and forth through outer space requires lightning-fast reactions and careful shooting. But don't worry, you're not alone - dock with an ally unit, the PURSER, for rapid fire shots!
<br><br>
If you're finding the game too easy or too hard, no problem - you can customise the settings to adjust the difficulty and amount of Final Stars available. So what are you waiting for? Take your place in the cockpit and lift off!</div>
  <div id="image02">
