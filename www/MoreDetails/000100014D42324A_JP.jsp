...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">無限の力を得られるという伝説の秘剣「ラングリッサー」をめぐり、強大な帝国と若き王子レディンとの戦いをえがく、大人気シミュレーションＲＰＧのシリーズ第１作です。母国の崩壊に始まり、ライバルの出現、ドラゴンとの戦いなど、連続する２０のドラマチックなシナリオを、冒険の過程で加わる多くの仲間とともに進めていきましょう。攻略の鍵を握るのは、兵を率いる指揮官キャラクターたち。彼らは指揮範囲にいる自分の兵の能力を上げたり、周囲の兵を回復させることができます。また経験値により３段階にクラスチェンジし、その職種もさまざまに変化させられるので、いかに生き残らせ、育てるかが勝負の分かれ目となります。多彩な魔法や特殊アイテム、地形効果などさまざまな要素をうまく活用し、皇帝ディゴスによる世界制覇の野望を打ち砕いてください。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ラングリッサー<sup>TM</sup></span></div>
</div>
