...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">浮遊世界を舞台にくりひろげられる、ファンタジックなシミュレーションＲＰＧ。ドラゴンを操る戦竜隊の隊長「ビュウ」が仲間とともにグランベロス帝国と戦う物語です。率いるドラゴンの属性や、さまざまなジョブを持つメンバーの技や魔法などを考慮してパーティーユニットを編成し、シミュレーションバトルでの戦闘で経験を積むことで、レベルアップなど戦いを有利に進めていきます。また、ドラゴンの育成はプレイヤー次第。さまざまな強さ、性格、姿に進化し、成長パターンはほぼ無限です。ビュウと恋仲でもある王女「ヨヨ」のゆくえや「神竜の伝説」の謎など、物語は個性的な登場人物やイベントが絡み合ってドラマティックに展開し、多彩で繊細なデジタルアートがそれを彩ります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バハムートラグーン<sup>&reg;</sup></span></div>
</div>
