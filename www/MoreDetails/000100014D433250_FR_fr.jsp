...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jim, le super-héros invertébré est de retour avec son nouveau comparse Snott pour une suite surréaliste dans Earthworm Jim 2. Offrant bien plus d'action que les jeux de plate-forme actuels, chaque niveau propose une mission et un style différents qui s'inspirent de genres aussi variés que les labyrinthes, les quiz ou les jeux d'arcade. Serez-vous de taille à sauver la Princesse ?
<br><br>
Le tout rythmé par les musiques de Tommy Tallarico.
<br><br>
