...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９３年にリリースされたアクションシリーズの第二弾。プレイヤーは、巫女姫に召喚された戦士となって、闇の君主を倒すために様々な時代を駆け抜けることになります。今回も前作と同様にプレイキャラをチェンジできますが、前作のように助けた仲間にチェンジというわけではなく、最初から忍者・天狗・忍犬に自由にチェンジできます。さらに今回は新要素として、溜め攻撃、防御なども盛り込み、戦術性のあるベルトスクロールアクションに仕上がっています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">戦国伝承２</span></div>
</div>
