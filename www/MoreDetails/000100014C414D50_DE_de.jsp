...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Spiele als Sonic oder Tails in "Sonic Chaos" - dem ersten 8-Bit-Titel, in dem auch Sonics treuer Gefährte Tails gesteuert werden kann.<br>
Dr. Eggman (auch bekannt unter dem Namen Dr. Robotnik) hat den roten Chaos Emerald gestohlen, um Nuklearwaffen zu konstruieren. Dadurch ist die Balance der übrigen Chaos Emeralds außer Kontrolle geraten, wodurch diese in ein Paralleluniversum gebeamt wurden. Und nun versinkt Sonics Heimat, South Island, im Meer!<br>
Spiele als Sonic oder Tails und absolviere auf deinem temporeichen Abenteuer um die sechs Chaos Emeralds eine Reihe von Levels. In "Sonic Chaos" kannst du mit Sonic Wirbelangriffe und Schnellsprints ausführen oder als Tails mithilfe von Schnellsprints und Flugfertigkeiten die ganze Spielwelt erkunden!
<br><br>
