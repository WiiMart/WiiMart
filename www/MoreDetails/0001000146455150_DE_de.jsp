...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Biete Dracula in diesem dritten Teil der äußerst beliebten Castlevania-Reihe die Stirn! Wie auch im Originaltitel ‘Castlevania’, ist es die Aufgabe des Spielers, sich durch knifflige sowie anspruchsvolle Level zu schlagen. Doch diesmal gibt es einen bedeutenden Unterschied: Am Ende eines Levels stehen zwei Wege zur Auswahl. Jeder davon führt zu einem völlig anderen Spielerlebnis!
<br><br>
Die innovativste Neuerung dieses Spiels besteht in den Gefährten, die der Spieler auf seinem Weg durch das Abenteuer trifft. Neben dem Hauptcharakter Trevor, der im Kampf gegen das Böse die traditionelle Belmont-Waffe, die Mystikpeitsche, sowie eine Reihe anderer Items einsetzt, kann der Spieler ein Bündnis mit einem von drei individuellen Charakteren eingehen: Sypha, die gefangene Hexe, Grant, der Pirat, der hohe Wände erklimmen kann und Alucard, Draculas Sohn, der mit seinem Vater noch eine Rechnung offen hat.
<br><br>
Aufgrund der zur Auswahl stehenden Charaktere und der Möglichkeit, den Verlauf des Abenteuers durch die Wahl eines bestimmten Wegs selbst zu bestimmen, besitzt dieses Werk auch bei wiederholtem Spielen eine ganz eigene Faszination, die jedes Mal zu einer neuen Spielerfahrung beiträgt.
<br><br>
Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146455150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146455150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Castlevania III</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Dracula's Curse</span></div>
  </div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">NES</div>
</div>
</body>
</html>
