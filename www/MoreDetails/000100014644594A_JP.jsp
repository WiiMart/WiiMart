...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">南北に二分され対立するバレンシア大陸を舞台に、ソフィア王国の騎士に育てられた青年「アルム」とソフィア国王の娘「セリカ」が、平和をもたらすべく戦いの旅に出る、シミュレーションＲＰＧ「ファイアーエムブレム」シリーズの２作目です。ストーリーは全五章からなり、アルムとセリカのふたりを主人公とする物語が、章を追うごとに密接に絡み合っていきます。バレンシア大陸を表現した全体マップ上を進軍し、マップ上の拠点で敵と接触すると戦闘開始。プレイヤーはアルムやセリカとなって、さまざまな職業、能力、個性を持った仲間たちに指示を与え、戦闘マップ上の敵ユニットを撃破していきます。２つの主人公を別々に進軍させるしくみや、敵側から攻めてくるしくみなど、前作「暗黒竜と光の剣」と比べてシステム面にさまざまな変更が加わりました。また、前作のキャラクターの一部が物語に登場するなど、ストーリーや世界観の上でも特徴的な要素を持った意欲作です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイアーエムブレム<sup>&reg;</sup>　外伝</span></div>
</div>
