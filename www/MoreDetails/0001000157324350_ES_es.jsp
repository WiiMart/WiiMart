...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Estimula tu cerebro y libera el estrés con 25 minijuegos de Memoria, Lógica, Mates, Visual y Atención.
<br><br>
Elige tu entrenador favorito y consigue una detallada evaluación de tus resultados personales.
<br><br>
Compárate con tus amigos y familiares dejando que tu Mii personalizado desafíe sus cerebros en tres divertidos modos multijugador. ¡Demuestra quién manda! 
<br><br>
Con los modos especiales Test de niños y Test sénior, gente de todas las edades querrá jugar.
<br><br>
Los textos de la pantalla aparecen en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324350/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324350/FFFD000D" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Reto Mental</span></div>
</div>
