...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ナムコ初の本格的３Ｄシューティングゲーム。戦闘機ガイアを操り、次元を越えて侵略してきた「バッツーラ」から宇宙を救うことが目的です。ゲームはマップモードとコンバットモードで構成され、ゲーム中は常に時間が経過し、情勢は刻一刻と変化していきます。まずはマップモードで味方基地や星、そして敵の位置を把握しましょう。基地や星はマップ上で隣接している敵に攻撃され、最後には破壊されてしまうので注意が必要です。マップモードで目的地を決めてワープすると、コンバットモードに突入。コックピット上のレーダーを頼りに、３Ｄ空間を縦横無尽に飛び回る敵機を探し、撃墜してください。ガイアは、エネルギーが０になると行動不能となってしまい、また連続して攻撃を受けるとシールドが破られて機体を損傷してしまいます。孤独な戦いを生きのび、感動のエンディングをむかえることができるでしょうか。リアルタイムストラテジーとシューティングという２つの要素が同時進行する画期的なゲームシステムが、発売当時高く評価されたタイトルです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スターラスター<sup>&reg;</sup></span></div>
</div>
