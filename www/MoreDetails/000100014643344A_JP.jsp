...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公「ちゃっくん」が入り組んだ迷路のなかをジャンプと天井張り付きで進み、オリに閉じこめられた「ハート」を救い出して時間内に脱出する、固定画面タイプのアクションゲームです。ちゃっくんは左右に１個ずつ爆弾を投げられます。爆弾は一定の時間が経つと爆発し、その煙に巻き込まれた「もんすた」や「もんすたエッグ」を倒したり、オリを壊すことができます。ちゃっくんが「もんすた」や爆弾の煙に触れたり、動くブロックにはさまれたり、時間切れになるとミスとなって、ちゃっくんの残り数がゼロのときにミスするとゲームオーバーです。一定時間無敵となれる「スーパーハート」をうまく活用し、ステージクリアをめざしてください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ちゃっくんぽっぷ<sup>&reg;</sup></span></div>
</div>
