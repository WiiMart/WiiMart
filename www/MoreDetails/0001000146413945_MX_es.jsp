...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Link regresa a Hyrule para buscar la Trifuerza y despertar a Zelda de un sueño sin fin. Embárcate en una misión para encontrar la “Trifuerza del Valor” y salvar a Hyrule de la ruina. Aprende hechizos mágicos, habla con las personas de la aldea para obtener pistas, recoge objetos para aumentar tu poder, y explora seis palacios donde esperan los súbditos del malvado Ganon. Esta secuela del juego clásico de aventura utiliza un motor visual de desplazamiento lateral, único en la serie, que permite un combate más técnico, e incluye una función de recorrido más profunda mientras Link encuentra a los residentes del pueblo en su búsqueda.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Zelda II<sup>TM</sup> - </span></div>
</div>
