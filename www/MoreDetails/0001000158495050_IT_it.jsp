...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158495050')", "wiiSelectSound()");
...
<br><br>Benvenuto nel mondo dei PooYoo, il primo gioco d'intelligenza poetico e divertente per bambini dai 3 ai 6 anni di età.
<br><br>
Insieme ai PooYoo, un'allegra banda di cuccioli, il tuo bambino imparerà divertendosi tutte le abilità necessarie al suo sviluppo: numeri, lettere, lateralizzazione, forme, colori e molto altro. I bambini potranno ballare con i loro nuovi amici e riceveranno numerose ricompense interattive. Grazie ai due livelli di interazione, il tuo bambino potrà godersi, indipendentemente dall'età, le attività basate su magia e colori.
<br><br>
Questo gioco è stato pensato per bambini che non padroneggiano ancora la lettura. <br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495050/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Episodio 3 - Demo</span></div>
  </div>
