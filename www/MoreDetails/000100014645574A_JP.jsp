...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードゲームで人気を集めた横スクロールアクションゲーム。プレイヤーは青年「クロービス」となり、ドラゴンに人質にされた王女セリアを助けるために冒険に旅立ちます。ドラゴン山への道中には、さまざまな魔物たちが立ちはだかります。プレイヤーは、ドラゴン山までのルートを選択し、廃墟や塔などのダンジョンを駆け抜けます。
カブト割りや垂直斬りなどの技や多種多様のアイテムを駆使して、迫り来る魔物や各ラウンドに控えているドラゴンを倒してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
