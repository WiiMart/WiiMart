...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157413450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Engánchate a la locura por los microjuegos con WarioWare: Do It Yourself - Showcase y enséñale a todo el mundo tus obras maestras creadas con WarioWare: Do It Yourself para Nintendo DS! 
<br><br>
Pasa los microjuegos, los discos y los cómics de la versión de Nintendo DS a tu consola Wii para disfrutar de ellos en pantalla grande, solo o con tus amigos, usando el mando de Wii en lugar del lápiz. ¡Y esto no es todo! También puedes jugar a los microjuegos exclusivos incluidos en esta versión o enviarlos a tu consola Nintendo DS.
<br><br>
...
Como algunos de los servicios en línea de la consola Wii han dejado de estar disponibles el 28 de junio de 2013, ya no es posible acceder a las funciones en línea de este programa por medio de WiiConnect24.</div>
  ...
  <div id="image01">
    <img src="/oss/ccs/0001000157413450/FFFD0023" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
