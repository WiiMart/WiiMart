...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Faites des maths avec Donkey Kong Jr. tout en vous amusant! Dans ce jeu NES éducatif, balancez-vous et sautez d'une corde à l'autre pour attraper des chiffres et des symboles mathématiques. Le but du jeu est d'obtenir le résultat indiqué par Donkey Kong.
<br><br>
Evaluez votre niveau en calcul mental en mode solo ou participez à une partie à deux joueurs. Donnez du fil à retordre à votre adversaire en attrapant les chiffres avant lui!
