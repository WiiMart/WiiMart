...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157535845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stunt Cars takes place on elevated race tracks, with very little to stop the player from accidentally driving off the side. Turbo can be used to make a car go faster, but it can only be used for a limited amount of time in each race. As you progress through the game's four championship cups, you'll unlock special features such as the driver achievement awards. 
<p>
KEY FEATURES:<br>
*24 wild and challenging tracks with huge jumps, ramps and tunnels<br>
*Up to four-player split screen multiplayer racing<br>
*Choose from six different cars which are rated differently for speed, acceleration, and weight<br>
*Race achievement awards—12 to win, including Gold Hero, Track Warrior, Stopwatch Pro, and Stunt Champion</div>
  <div id="image02">
