...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157554250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Préparez-vous pour une toute nouvelle expérience... avec votre jeu de plateau préféré ! Son fonctionnement est très simple, car il consiste à résoudre des puzzles dans le but d’obtenir des joyaux colorés.
<br><br>
Ubongo a remporté un énorme succès dans des pays comme l’Allemagne où sa popularité l'a propulsé à la première place des ventes de jeux de plateau. Un million d’exemplaires ont été vendus en Allemagne et il a gagné de nombreuses récompenses, telles que le Meilleur Jeu Familial en Suède et Jeu de l’Année en Norvège et en Finlande.
<br><br>
Mode Histoire<br>
Dans ce mode, le joueur incarne Kanu. Il doit vaincre les acolytes du méchant Rifictus en remportant des parties d’Ubongo.
<br><br>
Partie Rapide<br>
Ce mode permet au joueur de faire des parties rapides d’Ubongo.
<br><br>
Contre-la-montre<br>
Dans ce mode, récupérez autant de joyaux que vous le pouvez durant le temps alloué.
<br><br>
Multijoueur<br>
Jusqu'à 4 joueurs peuvent disputer une partie sur la même console.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554250/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554250/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
