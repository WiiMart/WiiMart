...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158495A50')", "wiiSelectSound()");
...
<br><br>3D Pixel Racing is een racespel dat doet denken aan echte gameklassiekers.<br>
De verschillende speltypen variëren van een klassieke race tot spectaculaire achtervolgingen.
Geniet van 10 circuits, 11 wagens en 10 coureurs. Door de verschillende uitdagingen te voltooien, speel je verborgen content vrij.<br>
Als klap op de vuurpijl kun je tegen maximaal 3 vrienden tegelijk spelen via een gedeeld scherm.<br>
Speltypen:  Enkele Race, Kampioenschap, Vlag veroveren, Achtervolging, Tijdrit.
<br><br>
