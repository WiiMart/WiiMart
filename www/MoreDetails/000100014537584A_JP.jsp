...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">地獄におちてしまった「たろすけ」が、「エンマ大王」の裁きを受けるために５つの地獄を冒険します。気合い弾で攻撃しながら、行く手をはばむ妖怪を退治しましょう。ステージボスの鬼との戦いでは、ご先祖様の「もんもたろう」が助けてくれます。妖怪を倒すと手に入るＭＯＮＥＹで、回復やパワーアップのアイテムを買うこともできます。とった行動によってエンディングが変わるマルチエンディング方式を採用しています。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">妖怪道中記<sup>&reg;</sup></span></div>
</div>
