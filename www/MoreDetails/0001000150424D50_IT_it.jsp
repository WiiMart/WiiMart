...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LEGEND OF HERO TONMA ha dimostrato al mondo videoludico che per fare degli ottimi giochi non è affatto necessario essere un maschio. Progettato e sviluppato da un team di sole donne, questo gioco d’azione dà ai giocatori il controllo del mago Tonma, che, come molti eroi dei videogiochi di quel periodo, dovrà compiere un lungo e pericoloso viaggio per salvare la principessa.<br><br>
Fatti strada attraverso i 7 livelli del gioco usando le abilità di salto e i colpi di Tonma. Raccogli tutti i Potenziamenti e le Barriere per diventare più forte e stracciare i tuoi nemici. Raggiungi la fine di ogni livello e sconfiggi i minacciosi boss che vorrebbero impedirti di continuare il tuo cammino e salvare la principessa.<br><br>
Una volta messe le mani su questo gioco ricco di dettagli e caratterizzato da una grafica in stile fumettistico, non smetterai più di giocarci!
