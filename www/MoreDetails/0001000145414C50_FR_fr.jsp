...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Edité par SNK et sorti en 1994, “Art of Fighting 2” est un jeu de combat où 12 combattants s’affrontent dans un championnat extrêmement rude: le Roi des Combattants. Chaque personnage possède un ensemble de techniques fatales. Cependant, comme dans la version précédente, l’utilisation d’une technique fatale fait diminuer le niveau de la barre d’énergie spirituelle.
<br><br>
De plus, si le joueur utilise la commande de provocation, il peut faire baisser l'énergie spirituelle de son adversaire jusqu'à supprimer ses techniques fatales. Les effets de l'énergie spirituelle sur l'attaque et la défense sont propres à cette version. Plus vous appuyez longtemps sur le bouton, plus l’attaque est puissante. Notez également qu'il est possible de vous défendre en cas de projection si vous appuyez sur le bouton au bon moment.
<br><br>
En résumé, cette version vous offre des combats plus intenses que la version précédente.
<br><br>
