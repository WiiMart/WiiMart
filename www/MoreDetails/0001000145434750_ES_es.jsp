...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Shock Troopers: 2nd Squad es un juego de acción de temática militar publicado originalmente en 1998. Para detener a una gran corporación de chiflados, tendrás que elegir a uno de cuatro mercenarios con el que combatirla a base de disparos, saltos y un surtido de armas de lo más variado. Se ha dejado intacto el sistema de puntuación por alabanzas, pero el equipo de mercenarios ha sido renovado por completo. Esta nueva entrega ofrece una gran cantidad de posibilidades, entre ellas, la posibilidad de controlar toda clase de vehículos o la elección de rutas distintas, gracias a lo cual podrás disfrutar de un juego de lo más ágil y variado.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
