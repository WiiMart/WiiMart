...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157503250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En el juego de puzle Potpourrii todo gira en torno a las estaciones.<br>
<br>
Durante siglos las estaciones han seguido un patrón establecido. Sin embargo, todo ha empezado a cambiar en el bosque. De repente comienza a nevar mientras luce el sol y las plantas florecen mientras se caen las hojas. Después aparece una extraña mugre de color morado. Los duendes se quedan helados. Y aún peor, el roble mágico de la vida está perdiendo sus poderes.<br>
<br>
Todo parece ser culpa de un malvado brujo. Debes ayudar a los duendes a derrotarlo y recuperar el orden natural. Para ello debes hacerte con los espíritus de la estación. Atrápalos con el cañón mágico, lánzalos al centro de la pantalla, agrúpalos y hazlos desaparecer. Pero ten cuidado, ¡cada vez van más rápido!<br>
<br>
En resumen:<br>
- Un juego de puzle que engancha<br>
- Coloridos gráficos y estupendos efectos<br>
- Controles sencillos con el mando de Wii<br>
- Uno o dos jugadores<br>
- Puedes usar tu personaje Mii<br>
<br>
Textos de panatalla en español.</div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">¡Es una fina mezcla entre diversión y reto!</span></div>
  </div>
