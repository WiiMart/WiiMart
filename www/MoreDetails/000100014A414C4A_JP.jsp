...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">対エイリアン戦闘のプロフェッショナルであるビル（ランス）となって、エイリアンに支配された地球を救うアクションゲームです。ステージを真横から見た「サイドビューステージ」と、真上から見た「トップビューステージ」の２種類のステージがあります。２つのステージではそれぞれできるアクションや操作方法などが異なります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">魂斗羅スピリッツ<sup>&reg;</sup></span></div>
</div>
