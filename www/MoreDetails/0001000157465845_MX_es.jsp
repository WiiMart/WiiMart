...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157465845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En la estación más fría del año es cuando a uno más le apetece el fuego acogedor de una chimenea. Sin embargo, no todo el mundo tiene la posibilidad de acurrucarse frente a una en su hogar. ¡Tu nueva chimenea de WiiWare pone una nota de ambiente en cualquier sala!
<br><br>
Puedes escoger entre diferentes tipos de leña y apilarla con el mando de Wii. Después solo tienes que encender la cerilla y tu hogar se convertirá en un espacio cálido y agradable. Dispones de un total de 6 ambientes diferentes: fuego puro, fogata, chimenea rústica, chimenea clásica, chimenea elegante y chimenea zen.
...
¡Un agradable sonido crepitante y un fuego de animación real para que no te falte nada, incluso cuando no hace frío!
<br><br>
- 6 ambientes diferentes: fuego puro, fogata, chimenea rústica, chimenea clásica, chimenea elegante y chimenea zen<br>
- Sonido ambiental acogedor<br>
- Simulación física realista gracias a la tecnología PhysX® by NVIDIA<br>
- 4 funciones de juego: mayordomo (los troncos se reponen automáticamente), continuo (los troncos no se consumen), estándar (fuego creado previamente en la chimenea que elijas), individual (escoge tú mismo la leña y ponla en la chimenea)
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157465845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157465845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Cozy Fire</span></div>
</div>
