...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Op een donkere, stormachtige nacht in het koninkrijk Granseal steelt een dief twee juwelen uit de Tower of the Ancients. Dit luidt het begin in van de vreemde gebeurtenissen die leiden tot de wederopstanding van Zeon, de duivelskoning! Zo wordt de koning van Granseal geveld door een geheimzinnige ziekte, wordt de prinses ontvoerd en wordt een deur geopend naar Arc Valley, het verblijf van de duivelskoning. De jonge zwaardvechter Bowie, die zich realiseert hoe groot het gevaar voor Granseal is, moet het Shining Force-leger leiden om het heilige zwaard en de gestolen juwelen te vinden, en Granseal te beschermen tegen het leger van de kwaadaardige Zeon.
<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D423650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D423650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Shining Force<sup>TM</sup> II</span></div>
</div>
