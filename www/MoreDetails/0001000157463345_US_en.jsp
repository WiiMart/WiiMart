...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157463345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A collection of classic family pen and paper game favorites. Timeless favorites for all the family.
<p>
THE GAMES<br>
• Squares (Dots)<br>
• Nine Men’s Morris (Mill)<br>
• Safe Cracker<br>
• Matchsticks<br>
...
<p>
KEY FEATURES<br>
• Includes eight super challenging classic games.<br>
• Numerous rule sets and game variations—so many ways to play!<br>
• Fun for all the family—up to four players can compete in Tournament mode.<br>
• 20 special secret achievements to unlock.</div>
  <div id="image02">
