...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157423850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Plongez au coeur de l'atmosphère trépidante et branchée de Midnight Bowling !
<br><br>
Préparez-vous à vivre des 
sensations fortes grâce à un 
moteur physique novateur qui 
vous permet de contrôler vos 
lancers avec facilité et précision
avec votre télécommande Wii. Réalisez des effets spectaculaires et impressionnez vos adversaires !
<br><br>
Affrontez jusqu’à 3 amis en mode Fiesta, un mode de jeu très amusant où vous serez mis à rude épreuve ! Quel que soit votre niveau, lancez-vous dans le mode Histoire et affrontez des personnages plus charismatiques les uns que les autres dans les salles de bowling les plus cool de la planète !<br><br>Texte écran en français.</div>
  <div id="image02">
