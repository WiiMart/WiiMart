...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Laat je niet misleiden door de simpele beelden in dit spel. Tennis is een van de meest technische spellen die ooit zijn uitgebracht voor de NES. Hoewel de besturing niet al te ingewikkeld is, zul je het laatste toernooi alleen kunnen bereiken als je je backhands, smashes en volleys tot in de puntjes beheerst. Nodig een vriend uit voor een hectisch dubbelspel tegen de computer. Een bekend Nintendo-personage vervult een gastrol in de stoel van de scheidsrechter. Hij vervulde een soortgelijke rol in een aantal andere sportspellen van Nintendo. Kun je ze nog opnoemen?<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
