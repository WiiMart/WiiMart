...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９７年にリリースされた格闘ゲームで、『ザ・キング・オブ・ファイターズ』シリーズの第４弾。これまでと同様に「餓狼伝説」「怒」「サイコソルジャー」「龍虎の拳」等から人気キャラが出演し、最強の座を賭けて戦います。今回も登場キャラの入れ替えがあり、注目は前作でボスとして登場した神楽ちづる、人気キャラである山崎竜二、ブルー・マリー、ビリー・カーン、新キャラの七枷社や矢吹真吾といったところです。また今作では、ゲーム開始時に「アドバンスト」か「エクストラ」のキャラクターモードを選択でき、この選択によって、ゲーム中の駆け引きが大きく変化します。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ・キング・オブ・ファイターズ '97</span></div>
</div>
