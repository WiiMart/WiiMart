...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Ayúdale a salvar Blobolonia! Blob (cuyo nombre completo es Blobert) ha llegado del lejano planeta Blobolonia en busca de un chico para ayudarle a salvar el mundo.
<br><br>
Únete a él en esta fantástica aventura a través de misteriosas cavernas subterráneas repletas de tesoros. También tendrás que viajar a Blobolonia para enfrentarte al malvado rey. Descubre el insaciable apetito de Blob y las diferentes transformaciones que le provoca cada tipo de golosina que engulle. Tendrás que aprender a usar su variado repertorio de formas para superar los obstáculos más exigentes.
<br><br>
A Boy and His Blob es una singular aventura cargada de sorpresas y cómicos personajes.
<br><br>
