...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マイタンク（自機の戦車）を操作し、戦車や砲台などフィールドに現れる敵部隊に戦いを挑む、全方位スクロール型のシューティングゲームです。２本のスティックを前後に動かすとマイタンクが移動や旋回をおこない、フィールド全体がマイタンクの視点に連動して移動・回転するため、
ダイナミックな操作感を味わえます。敵を倒しながらジャイロが示す矢印の方向へ進み、タイムオーバーとなる前にハッチやゲートを守る敵の砲台をすべて破壊するとステージクリアです。大きな破壊力を持つグレネード攻撃や左右へのロール移動、フィールド中のジャンプゾーンなど、
さまざまなアクションを駆使して全１１ステージを突き進み、浮遊大陸の平和と明日を守ってください。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アサルト<sup>&reg;</sup></span></div>
</div>
