...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">MUSHA es un clásico entre los aficionados a los shooters por su fantástica jugabilidad y su acción trepidante. 
<br><br>
En el juego controlarás a Terri, una chica que pilota un M.U.S.H.A. (armadura superhíbrida de armazón metálico único). El objetivo de Terri es eliminar a Dire 51, un Intellicomputer que está fuera de control y planea un ataque contra la humanidad. 
<br><br>
Dispones de un amplio surtido de armas especiales, como el Rayo destructor, el Rayo abrasador y el Detonador defensivo para derrotar al enemigo. Elige entre 6 tipos de formaciones de ataque diferentes a lo largo de 7 excitantes niveles para, finalmente, ¡destruir al Dire 51 para siempre!
<br><br>
