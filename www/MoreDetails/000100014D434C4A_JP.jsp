...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気の２Ｄ対戦格闘ゲーム「ストリートファイターⅡ」シリーズの第２作としてアーケードに登場した「ストリートファイターⅡダッシュ」をベースに、さまざまな追加要素を盛り込んだメガドライブ版だけのオリジナルタイトルです。はじめて「四天王」が使えるようになったアーケード版を忠実に再現した「ダッシュ」モードはもちろん、ゲームバランスに変更が加えられた「エキサイト」モードも搭載。「エキサイト」モードでは気功拳やヨガテレポートなど技の追加のほか、１１段階のスピード変更が可能になっています。ほかにも、６人までのキャラをそれぞれが選択して対戦を行う「グループバトル」モードなどが楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ストリートファイター<sup>&reg;</sup>Ⅱダッシュプラス</span></div>
</div>
