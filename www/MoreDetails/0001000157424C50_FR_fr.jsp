...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157424C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BUBBLE BOBBLE Plus! est le classique du jeu d’arcade où tu diriges Bub et Bob, nos deux dragons cracheurs de bulles. Leur but ? Emprisonner leurs ennemis dans des bulles et faire éclater le tout !<br><br>

En plus des 100 niveaux du mode Classique où tu retrouveras la saveur du jeu original, tu pourras découvrir le mode Extra et ses 100 autres tableaux jouables à 4 et remplis de nouveautés, comme des ennemis inédits et des dédales jamais explorés encore. Sans oublier le mode Classique Plus !
<br><br>
Résous les puzzles cachés et terrasse le boss final pour découvrir le véritable dénouement du jeu.
<br><br>

Et ce n’est pas tout : 100 niveaux supplémentaires et leurs boss exclusifs t'attendent grâce aux contenus additionnels « Expert 1 » et « Expert 2 » !<br><br>Texte écran en français.</div>
  <div id="image02">
