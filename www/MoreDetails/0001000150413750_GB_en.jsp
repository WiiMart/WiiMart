...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Some classics can’t be beat! Alien Crush is a pinball game that features realistic pinball action and superb ‘biomechanical’ graphics. Complete with a function to nudge the machine, this game feels like you’re playing on the real thing!
<br><br>
Extra balls and bonus points are your keys to getting high scores. Aside from the Main Stage, there are also all sorts of Bonus Stages, such as “Centipede”, “Alien”, “Eyeball”, and “Skull”. These exciting and challenging stages each have objectives, which if you fulfil, will give you huge bonuses. Pull off all kinds of tricks while enjoying intense pinball action!</div>
  <div id="image02">
