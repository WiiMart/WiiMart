...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157533950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Es gibt ein Puzzlespiel, das die Welt im Sturm eroberte – Sudoku. Hier ist deine Chance, das Spiel auszuprobieren, und deine Kombinationsfähigkeit zu trainieren. <br><br>Mit über 100 Millionen Möglichkeiten, die in „Sudoku Challenge!“ eingebaut sind, wirst du keine Variante zweimal zu Gesicht bekommen. Du kannst zwischen dem klassischen 9x9-Spielfeld und dem beliebten „Samurai-Sudoku“, bei dem du fünf überlappende Felder simultan lösen mußt, auswählen. Falls du noch nie Sudoku gespielt hast – keine Angst! Es gibt verschiedene Schwierigkeitsgrade, und mit dem einfachsten kann selbst ein Neuling das Puzzle spielend lösen. Falls du schon Experte in Sudoku bist, dann teste deine Fähigkeiten im „Expertenmodus“. <br><br>Nun wird’s Zeit für ein wenig Gehirntraining. Entdecke die spannende Welt der Sudokus!<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
