...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158483445')", "wiiSelectSound()");
...
<p>
Max & the Magic Marker is an award-winning physics-based puzzle platformer. The game is for all audiences yet still challenging for the hardcore gamer. Max plays like a classic platformer but with a twist. You have a magic marker that enables you to draw freehand in the game– everything you draw becomes real and can be interacted with in the game world. You must help Max overcome enemies, obstacles and puzzles on his way. 
<p>
Enjoy:<br>
- Loads of puzzles with multiple solutions!<br>
- Collect hidden orbs to unlock extras!<br>
- 15 awesome levels in 3 unique worlds! 
<p>
One day Max gets a mysterious marker in the mail. The first thing he draws is a monster, but as soon as the pen leaves the paper, the monster becomes alive and jumps into another drawing. It must be stopped so Max draws himself onto the page and the chase begins. 
<p>
The game has received several awards including the “Independent Games Festival 2010 (IGF) D2D Vision Award”.</div>
  <div id="image02">
