...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Veröffentlicht 1996 ist Art of Fighting 3: The Path of the Warrior ein Kampfspiel, welches in Grasshill Valley spielt, wo Dramen und Schlachten sich zwischen verschiedenen Kämpfern ereignen. Abgesehen von den Protagonisten Ryo und Robert hat diese Zusammenstellung komplett neue Chraktere. Art of Fighting 3: The Path of the Warrior beinhaltet kraftvolle Combos in der Luft, noch effizientere Abwehrmanöver, die Möglichkeit Gegnern am Boden Schaden zuzufügen und ein 1-Runden-Wettkampfsystem genannt „Ultimate K.O.“. Weiterhin basieren die Grafiken auf Motion-Capturing-Technologie, was sie flüssiger als bisher erscheinen lässt und das Spiel zu einem der innovativsten 2D Kampfspiele der Zeit macht.<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
