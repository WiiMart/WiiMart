...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This channel is for players of The Legend of Zelda™: Skyward Sword. <BR>
<BR>
During the portion of the game where you collect the parts of the Song of the Hero, after collecting the Thunder Dragon's song in the desert, some players have experienced an issue where the forest and volcano area events related to acquiring parts of the Song of the Hero don't trigger. If your save data has been affected by this issue, you will be unable to continue your progress through the game. This channel was created to return save data affected by this issue to its normal, playable state.<BR>
<BR>
If you have not played The Legend of Zelda: Skyward Sword, you do not need to use this channel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435245/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Legend of Zelda: Skyward Sword</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Save Data Update Channel</span></div>
  </div>
