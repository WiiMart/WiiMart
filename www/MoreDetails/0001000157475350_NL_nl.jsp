...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157475350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ontmoet Phoenix Wright, de nieuwe beginnende advocaat met de beste vaardigheden van de stad. Stap in de wereld van vier verschillende rechtzaken. Gebruik de Wii-afstandsbediening en onderzoek de plaats van delict, ondervraag getuigen en presenteer schokkende bewijzen.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157475350/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157475350/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Phoenix Wright<sup>TM</sup>: </span></div>
</div>
