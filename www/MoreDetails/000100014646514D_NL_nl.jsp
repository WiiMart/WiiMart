...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stroop je mouwen op voor dit side-scrolling ninja-avontuur vol snoeiharde actie! De kwaadaardige keizer Garuda houdt de stad in zijn duivelse greep. Slechts twee dappere ninjastrijders durven zich te verzetten. Ze zijn zo stil als schaduwen in de sneeuw, vliegensvlug en elegant als de wind, en slaan toe met de explosieve woede van bloeddorstige tijgers!
<br><br>
Speel een coöpspel met een vriend en schakel Garuda’s leger wrede soldaten, razendsnelle ninja’s en monsterlijke robots uit met messen, bommen en werpsterren. Gebruik je ninja-moves om je vast te klampen aan bewegende platforms, om over dodelijke kuilen te springen en om duivelse valstrikken te ontwijken. Verzamel power-ups om een voorsprong te krijgen op de vijand... als je weet hoe je ze moet gebruiken. Een ding is zeker, je zult al je vaardigheden nodig hebben om de dertien intense levels door te komen en Garuda een ouderwetse portie ninjagerechtigheid te serveren!
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014646514D/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646514D/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Shadow of the Ninja<sup>TM</sup></span></div>
</div>
