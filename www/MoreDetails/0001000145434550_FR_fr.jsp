...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Last Blade 2, sorti à l’origine en 1999, est le second épisode de la série (le premier est sorti un an plus tôt). L’histoire se déroule juste après les évenements du premier episode, devant les portes de l’enfer. Le casting est composé de 16 experts en sabre. Ils sont tous uniques. Vous avez le choix entre deux types d’épées (Force et Attaque). Évitez les attaques de votre ennemi grâce au « rebond ».  Vous pouvez également annuler un « Super coup secret » et une « Super capacité secrète » avec un « Tranchant sublime » vous permettant d’enclencher un « Super coup secret » – comme dans l’épisode précédent. De nouvelles possibilités, telles qu’une garde et un rebond aériens, ainsi que la possibilité de se relever après une chute, ont été ajoutées. Amenez vos batailles vers un autre niveau !<br><br>Texte écran en anglais.</div>
  <div id="image02">
