...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157564F4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ロッククライミングには興味があるけど、体力的にも時間的にも難しい…そんな時、このソフト『ロックンロールクライマー』なら、お茶の間でロッククライミングを楽しむことができます。<BR><BR>
しかし、簡単なゲームだと甘く見てはいけません。<BR>
ゲームが始まれば、そこはもう平和なお茶の間ではなく容赦なく立ちはだかる自然との闘いの場。<BR>
そびえ立つ岩壁と、Ｗｉｉリモコンとヌンチャクを使ってキャラクターを動かすリアルな操作性が、臨場感と緊張感を高めます。<BR><BR>
この試練に立ち向かうのはロックンロールをこよなく愛する、クライマーのロックとローラ！　「伝説のギター」を求め、大岩やジャングル、時には滝にも挑みます。<BR><BR>
バランスＷｉｉボードを使えば、足の上げ下げや重心のかけかたによってもキャラクターを操作できるようになり、より直感的に、より本格的なロッククライミング気分を体感することができます。<BR><BR>
からだを使って試練を乗り越えるからこそ得られる達成感を、味わってみませんか？</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564F4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564F4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックンロールクライマー<sup>TM</sup></span></div>
</div>
