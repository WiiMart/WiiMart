...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483450')", "wiiSelectSound()");
...
<br><br>
¿Has soñado alguna vez que tus dibujos eran reales? ¡Pues en este juego lo son!
<br><br>
Un día, Max recibe por correo un misterioso rotulador. Sin pensarlo, lo primero que dibuja es un estrafalario monstruo morado. Sin embargo, nada más levantar el rotulador de la hoja, el monstruo cobra vida y salta del papel a otro dibujo. El monstruo está fuera de control y va de un dibujo a otro causando problemas, así que Max no tiene más remedio que ir tras él.
<br><br>
Armado con el asombroso rotulador, deberás seguir al monstruo a través de quince ingeniosos niveles llenos de desafíos. Pero necesitarás más que buena disposición y rapidez de reflejos para salir airoso. Usa el rotulador mágico para dibujar lo que quieras en el juego y ayuda a Max a derrotar a sus enemigos, superar obstáculos y resolver enigmas. Puedes dibujar escaleras, balancines, globos, tablas de surf y lo que se te ocurra. Las creaciones interactuarán con el entorno físico de tal manera que nunca jugarás dos partidas iguales.
<br><br>
Pueden jugar uno o dos jugadores. En este último caso, uno controlará a Max y otro el rotulador mágico.</div>
  <div id="image02">
