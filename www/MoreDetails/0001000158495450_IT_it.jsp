...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158495450')", "wiiSelectSound()");
...
<br><br>Quando si parla di estrarre velocemente un’arma ci sono solo due tipi di persone: il rapido... e il morto! Ora hai la possibilità di scoprire a quale dei due tipi appartieni, a seconda del caso. Ti troverai a fronteggiare i migliori e più veloci pistoleri, incluso uno dei più veloci al mondo, Wes Flowers.
<br><br>
Sfodera il telecomando Wii e mostra a tutti chi è il più veloce ad estrarre la pistola, in questo sparatutto con azioni reali! Puoi anche sfidare un amico nelle modalità multigiocatore e vedere chi di voi è il più veloce!
<br><br>
Avrai bisogno di grande velocità e una terrificante precisione per sfidare questi pistoleri... quindi preparati all'azione di un vero duello!
<br><br>
