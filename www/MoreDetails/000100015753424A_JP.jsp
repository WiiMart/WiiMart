...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753424A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ソーサリーブレイドは西暦3000年の火星を舞台にしたSFファンタジーRPGです。巨大隕石の落下により地球の文明が崩壊してしまった世界で、火星に移住した子孫（カーネリアン）はほぼ原始の時代からの出発であった開拓時代を乗り越え、やがて文明レベルは地球を目指す宇宙船を作り上げようとするまでに至ります。主人公ティアは地球に向かう宇宙船を建造するリターナー計画に参加する中、テロ組織によって婚約者を失い、婚約者の仇をうつため戦いの中へ身を投じていきます。戦闘で使用する武器にはそれぞれに固有のスキルが備わっており、戦況によって武器を持ち替えて戦うと有利になります。更に武器のスキルを発動させるときに指定された方向へWiiリモコンを振ると、より強力な効果を得ることができます。また、主人公が武器を振るタイミングに合わせて2PのWiiリモコンを振ると、サポートキャラが追加攻撃をしてくれるなど、RPGでありながら2人で楽しむことができます。戦闘などで集めた素材で新しい武器を製造するなどのやりこみ要素も豊富で、Wiiリモコンを使った武器製造はプレイヤーのアクション次第で出来上がった時の能力が変化します。その他にも、Wii本体に登録されたMiiが住人として登場する「Miiの町」など、Wiiならではの楽しさを味わうことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753424A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソーサリーブレイド</span></div>
</div>
