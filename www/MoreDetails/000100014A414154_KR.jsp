...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">공룡랜드를 무대로 쿠파에게 납치된 피치공주를 구출하기 위해 마리오와 루이지가 떠나는 모험을 그린 액션 게임입니다. 든든한 친구 요시와 함께 적을 쓰러뜨리거나, 망토를 둘러 하늘을 나는 등 다채로운 액션과 개성적인 캐릭터들이 많이 등장합니다. 다양한 장치와 수수께끼로 가득한 스테이지를 클리어해 나가는 게임입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414154/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414154/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">슈퍼 마리오 월드<sup>TM</sup></span></div>
</div>
