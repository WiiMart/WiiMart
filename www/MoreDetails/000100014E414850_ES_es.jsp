...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bebé Bowser ha robado el Árbol de la Súper Felicidad y ha lanzado una maldición sobre la Isla de Yoshi, convirtiéndola en un libro de dibujos. Solo quedan seis Yoshis que deben recuperar el árbol y devolver la felicidad al mundo.
<br><br>
Este gracioso y colorido juego de plataformas cuenta con un estilo gráfico único de "2,5 dimensiones" para mostrar los complejos personajes y el emocionante mundo donde los Yoshis pueden correr, nadar, revolotear y olisquear hasta descubrir secretos.
<br><br>
Come fruta, evita a los enemigos y a los obstáculos, y lanza la munición de huevos con los que cuenta Yoshi para frustrar el plan de Bebé Bowser. ¡Quién sabe, puede que hasta encuentres a los misteriosos Yoshis blancos y negros!<br><br>Textos de pantalla en inglés, alemán o francés.</div>
  <div id="image02">
