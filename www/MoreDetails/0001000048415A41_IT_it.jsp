...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questa nuova versione del Canale Foto rappresenta un aggiornamento opzionale e gratuito, che prevede le seguenti novità e modifiche:
<br><br>
<b>Personalizzazione dell'icona del Canale Foto</b>
<br>
Sostituisci l'icona del Canale Foto nel menu Wii con una immagine di tuo gradimento, presa da una scheda SD o dalla bacheca Wii.
<br><br>
<b>Nuovo formato dei file audio</b>
<br>
Il formato dei file musicali riprodotti in sottofondo durante uno slideshow è stato modificato da MP3 a AAC. I file AAC, a parità di dimensioni dei file, offrono in genere una qualità audio superiore.
<br><br>
Attenzione:
<br>
- Se scarichi la versione 1.1 del Canale Foto, non sarai più in grado di riprodurre i file musicali in formato MP3. Per ripristinare la versione originale (Canale Foto 1.0), sarà necessario rimuovere la versione 1.1. 
<br><br>
- Le console Wii immesse sul mercato a partire da dicembre 2007 includono già la versione 1.1 del Canale Foto. Non sarà dunque possibile utilizzare la versione originale 1.0.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000048415A41/FFFD0022" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000048415A41/FFFD0023" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canale Foto 1.1</span></div>
</div>
