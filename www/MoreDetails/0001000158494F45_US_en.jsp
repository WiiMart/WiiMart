...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158494F45')", "wiiSelectSound()");
...
<p>
This game has been designed for use by children who have not yet grasped reading.  The instructions are spoken in French, English, or Spanish, depending on the language setting of the Wii console.</div>
  <div id="image02">
