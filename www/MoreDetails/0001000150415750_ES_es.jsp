...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Esta es una versión actualizada del matamarcianos clásico Galaga. Atraviesa el espacio exterior y supera las 29 rondas hasta llegar a la fortaleza enemiga en el planeta Galaga.<br><br> Cada nivel del juego está formado por unas cuantas rondas, con enemigos y fondos que cambian. Además, la clásica “Galactic Dancing” sigue marcando el final de cada nivel. Gracias a los nuevos “Dimension Warps”, podrás escoger tu ruta de ataque. Recoge cápsulas para abrirlos en las bifurcaciones y enfrentarte a enemigos aún más duros.<br><br> La inclusión en Galaga ‘90 del Triple Caza, los fondos móviles, el jefe Galaga y hasta más efectos especiales, lo convierten en una verdadera obra maestra. 
