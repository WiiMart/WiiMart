...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gewinne die Kontrolle über die rauhen Pflaster des Action-Spiels RIVAL TURF! zurück, dem Zweispieler-Klassiker für Super NES!<br>
Lass die Fäuste fliegen und tobe dich in furiosen Straßenkämpfen richtig aus. So viel geballte Wrestling-Action hast du noch nie erlebt! Dir stehen verschiedenste Moves zur Verfügung, mit denen du richtig austeilen kannst, wie z. B. Bodyslams, Legsweeps, Faustschläge, Seitwärtshaken oder Uppercuts, um nur einige zu nennen.<br><br>
Beiß dich allein durch im Einzelspielermodus, kämpfe Seite an Seite mit einem Freund oder übe punktgenaue Angriffe im unerbittlichen Versus-Modus.<br>
Dies könnte der härteste Kampf deines Lebens werden, mach dich also schon mal warm!
<br><br>
Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A443450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A443450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">RIVAL TURF!</span></div>
</div>
