...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015746434A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">小さな王様となり、滅びてしまった故郷を再建する国造りRPG。かつて瘴気によって国を失った小さな王様は、失踪した父王を探す放浪の旅果てに、とある辺境の地にたどりつきます。そこで王様はクリスタルから建築術（アーキテクト）と呼ばれる不思議な力を授かり、家族代わりの家来とともに滅びてしまった故郷を再建することを決意します。王様は建築術を使い、民家や武器屋などの建物を建てて、少しずつ国を蘇らせていくのがゲームの目的となります。建物の建設だけなく、冒険者の育成や国民とのふれあい、店への投資など、王様としてやるべきことはたくさんあり、一日をどう過ごすかは王様次第。さらに、王国が発展していくと、魔王が王様の前に姿を現します。ともに国を造ってきた冒険者や住民と協力して、魔王を打ち倒しましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015746434A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015746434A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">小さな王様と約束の国</span></div>
</div>
