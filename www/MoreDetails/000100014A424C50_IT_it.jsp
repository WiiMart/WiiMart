...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pac-Man ritorna in Pac-Attack, un rompicapo bizzarro e divertente!
<br><br>
L'obiettivo del gioco è semplice: liberare lo schermo da fantasmi e blocchi in caduta. Per eliminare i blocchi devi porli uno accanto all'altro fino a completare una linea orizzontale. Per sbarazzarti dei fantasmi hai invece bisogno dell'aiuto di Pac-Man, che comparirà di quando in quando per farsi uno spuntino! Il tuo compito è quello di allineare i fantasmi per consentirgli di ripulire lo schermo. Pac-Man si fermerà solo quando avrà esaurito tutti i fantasmi o verrà fermato da un blocco. Può muoversi solo in senso orizzontale o verso il basso. Quando procede in senso orizzontale, si sposta nella direzione verso la quale sta guardando, senza potersi voltare.
<br><br>
Il gioco presenta 3 modalità: 1P NORMAL MODE (Modalità normale), 2P VERSUS MODE (Modalità sfida) e l'appassionante 1P PUZZLE MODE (Modalità puzzle).
<br><br>
