...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ラッシング・ビート」の続編。特徴の異なる５人のキャラクターから操作キャラを選んでプレイできる、２人同時プレイ可能な横スクロール格闘アクションゲームです。行方不明となった３人の仲間を救いだすことが目的です。プレイヤーが一定以上のダメージを受けると、「怒りモード」が発動して攻撃力がアップします。「VS　MODE」では、２プレイヤーとの対戦、コンピューターとの対戦、時間内に何人敵を倒せるかを競うタイムアタックが楽しめます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ラッシング・ビート 乱</span></div>
</div>
