...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ヘラクレスの栄光Ⅲ　神々の沈黙」は、１９９２年に発売されたギリシア神話を題材としたロールプレイングゲームです。どんなに高いところから飛び降りても死なない不死の体を与えられた主人公が、その謎を解き、記憶を取り戻すために自分探しの旅に出ます。自分と同じ不思議な夢を見るという、同じく不死の体を持つ若者や、半神ヘラクレスも仲間に加わり、冒険はやがて世界を救う旅へと変化していきます。感動のラストシーンへ導く秀逸なシナリオは今でもファンの間で語り草になっています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ヘラクレスの栄光<sup>&reg;</sup>Ⅲ</span></div>
</div>
