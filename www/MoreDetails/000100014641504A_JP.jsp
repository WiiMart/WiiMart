...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マリオとルイージが登場する本格ゴルフゲームです。クラブを使ってボールを打ち、なるべく少ない打数でグリーンのカップに入れていきます。グリーンまでの距離によって、自動的にクラブを選択できる初心者でも遊びやすい機能があり、ゴルフをあまり知らない人も、大好きな人も一緒にプレイすることができます。うっそうとした森に囲まれたホールや大きな湖に挟まれたホール、バンカー（砂地）だらけのホールなど、コ－スはさまざまな地形で構成。それぞれのコースで臨機応変にショットを使い分けるのが攻略のコツです。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マリオオープンゴルフ</span></div>
</div>
