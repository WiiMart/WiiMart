...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Boulder Dash werd oorspronkelijk uitgebracht in 1984 en is een van de grote klassiekers onder de computerspellen. Het is een van de weinige computerspellen die geconverteerd werden naar de speelhal (in plaats van andersom).
<br><br>
De held van het spel is de dappere mijnwerker Rockford. Hij moet zich een weg door grotten graven en diamanten verzamelen terwijl hij verschillende gevaarlijke wezens en obstakels zoals vallende rotsblokken uit de weg moet gaan. Hij loopt constant gevaar geplet te worden, ingesloten te worden door een instorting of om te komen bij een ondergrondse explosie.
<br><br>
Strategie en planning zijn van groot belang om de dynamiek van Boulder Dash onder de knie te krijgen. Wanneer het aangegeven aantal juwelen verzameld is, wordt de deur naar de mysterieuze ontsnappingstunnel onthuld en kan Rockford een nieuwe grot gaan onderzoeken.
<br><br>
