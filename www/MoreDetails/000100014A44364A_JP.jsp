...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">火災現場における消火・人命救助を題材としたアクションゲーム。消防士の主人公を操作して、高層ビルや薬品工場などで発生した火災をジャンプやキック、各種アイテムを駆使して鎮火させながら、制限時間内により多くの人命を救助し脱出することが目的です。ステージ開始前には火災現場の状況や目的の説明がなされ、消防車の配置や所持アイテムの設定ができます。炎は時間の経過とともに延焼し、状況は刻一刻と変化していきます。仲間のサポートとアイテムの使い分けがステージクリアのポイントです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイヤー・ファイティング</span></div>
</div>
