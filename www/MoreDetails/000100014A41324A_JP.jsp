...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">神と悪魔、そしてプレイヤー自身の存在（ポジション）を単純に「善＝味方」「悪＝敵」という言葉にあてはめない、「ＬＡＷ」「ＣＨＡＯＳ」という概念を生み出した「真・女神転生」シリーズ第１弾作品。主人公の属性はゲーム内の行動によって変化し、それがストーリーにも影響を及ぼします。また、戦闘中に敵を説得し、仲魔（なかま）にすることができる点も大きな魅力の一つ。「近現代の世界」「悪魔合体」「会話システム」など、ロールプレイングゲームの世界観設定・ゲームシステムにおいて、従来の既成概念を打ち崩す画期的アイデアが盛り込まれた、アトラス初の大作ダンジョンＲＰＧです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41324A/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41324A/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">真・女神転生</span></div>
</div>
