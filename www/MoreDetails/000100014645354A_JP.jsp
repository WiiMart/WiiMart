...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">花火職人の「カン太郎」を操作し、京の都から江戸までの東海道を進む横スクロール型アクションゲームです。京の都で修行して新しい花火の製造方法を身につけた「カン太郎」は、花火を江戸のみんなに見せるため、また許婚の「ももこちゃん」に再会するために、東海道を江戸への帰途につきます。鉄砲を密造する「井の国屋剛左衛門」という悪商人に雇われた忍者や編笠浪人たちの攻撃をかいくぐりながら、かんしゃく玉を武器に江戸までの長い道のりを踏破してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">かんしゃく玉なげカン太郎の</span></div>
</div>
