...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F5045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Necesitará un ojo de lince y una mente aguda para completar esos 100 rompecabezas temáticos de búsqueda de palabras. "Word Seacher Deluxe" contiene palabras divertidas en categorías múltiples incluyendo los palíndromos, las piratas y las pintura. Lleno de una gran variedad de temas a seleccionar, hay un rompecabezas para el disfrute de cada uno. Mejore su vocabulario, su memoria y sus habilidades de resolución de problemas con esos rompecabezas adictivos. Lleve la cuenta de sus juegos y trate de superar su marca una y otra vez a medida que se vayan mezclando las palabras cada vez que juega. ¡Use su materia gris para vencer los 100 rompecabezas hoy mismo!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F5045/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F5045/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Word Searcher Deluxe</span></div>
</div>
