...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">During the past three days, key military computer installations of every major world power have reported security failures. In each case, someone gained access to a primary missile attack computer. Only one person is capable of computer tampering on this scale - Professor Elvin Atombender. 
<br><br>
...
<br><br>
Our computer estimates that he will crack the launch codes and trigger the missile attack in exactly six hours. This is the amount of time you will have to complete your mission.</div>
  <div id="image02">
