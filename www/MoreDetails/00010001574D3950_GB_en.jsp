...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D3950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Happy Hammerin' is a party game suitable for friends and families to compete against each other by bashing moles using the Wii Remote! <br>
Swing the Wii Remote like a hammer and let off some steam as you frantically try and bash the moles popping up all over the screen.
Play against the CPU or go head-to-head with up to four players. 
<br><br>
Players can challenge themselves in three different modes: Mole Adventure (1-2P), Mole Marathon (1P) and Party Battle (1-4P).
Mole Adventure consists of four stages with three difficulty types. The faster you bash, the more points you get.<br>
Register your scores online and compete against the best mole bashers from around the world.<br>
This game supports English, French and German languages.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3950/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
