...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157324F4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ブルーオアシス ～未知なる深海～』は、Wiiウェアで好評発売中の「ブルーオアシス ～魚の癒し空間～」の続編です。<BR><BR>今作のテーマは、まだ解明されていない不思議に満ちた深海です。奇妙な形の魚、美しく光る深海魚やクラゲ、魅力あふれる深海の生き物たちを、Wiiリモコン1つで簡単に育てられます。<BR><BR>前作同様、水槽に入れる生き物や水槽内の置物の配置は自由に選べます。また暗闇を美しく彩るライトも多数用意しています。時間が経つと、魚が繁殖したり育てられる魚が増えていきます。自分だけのオリジナル水槽を、ゆっくりとリビングで眺めることができます。<BR><BR>魚の数、水槽に置ける置物など前作から、大幅にボリュームアップ！今作も、お天気チャンネルに対応し実際の天気にリンクして画面が変化。またWiiコネクト24を使用してフレンドコードを交換した友達に自分の作った水槽をプレゼントできます。さらに、新しく有料追加コンテンツも配信。<BR><BR>魅力溢れる深海の生物に会いに行きましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324F4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324F4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブルーオアシス</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">～未知なる深海～</span></div>
  </div>
