...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大きな口で何でも吸い込んでしまう食いしん坊な「カービィ」が、プププランドの平和を守るためにさまざまな舞台で冒険を繰り広げるアクションゲームです。遊び方もストーリーも違う６種類のゲームがひとつのソフトに詰まった「ゲームオムニバス形式」でプレイでき、さらにシンプルなルールとカンタン操作で対戦も可能なサブゲームも盛り込まれ、気軽に多彩なプレイが楽しめます。おなじみのコピー能力はますます豊富にパワーアップ。また、コピーした敵の能力から「ヘルパー」という仲間を生み出すことができます。カービィを手助けしてくれるヘルパーと協力しながら冒険できるほか、ヘルパーをもうひとりのプレイヤーが操作することもできる、シリーズ初のマルチプレイが導入されました。ユーモラスでほのぼのとした世界観、ゲームモードの多彩さと奥の深さから、今もファンの人気を集めています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">星のカービィ<sup>&reg;</sup>スーパーデラックス</span></div>
</div>
