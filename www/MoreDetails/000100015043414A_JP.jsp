...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">３Ｄダンジョン方式で表現された宇宙ステーションを舞台に、リアルタイムで徘徊するモンスターを倒して行く、緊迫感あふれるＦＰＳです。プレイヤーはどんな仕事でも請け負う戦いのエキスパート「デバッガー」として、無人の貨物ステーション「ゲイン」の探索に乗り込みます。ステーションでは「貨物ブロック」に巣食うモンスターを倒しつつ、１００分以内に最下層の自爆装置を解除しなければなりません。「コアブロック」は、モンスターの侵入を許すと徐々に耐久力が減少し、やがては重要施設もろともブロックが切り離されるため、素早い対応が必要です。攻略のポイントは全体マップの把握とアイテムの活用にあります。激しさを増してゆく警告音や点滅するランプ。そして迫り来る時間と共に、次第に明らかにされる事件の真相は、プレイヤーにスリル満点のサバイバルを体験させてくれます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サイレントデバッガーズ</span></div>
</div>
