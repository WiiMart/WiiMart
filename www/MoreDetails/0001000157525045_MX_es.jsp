...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157525045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Burn the Rope es un juego de desafío en el cual intentas quemar la mayor cantidad de cuerda que puedas en cada nivel. Pero ¡hay una trampa! El fuego sólo arde hacia arriba. Por eso hay que girar la cancha para mantener el fuego ardiendo. Al avanzar por los niveles, vas a encontrar insectos arrastrándose a lo largo de la cuerda. Todos tienen diferentes reacciones al fuego. Por ejemplo, la hormiga cambia el color de la cuerda y por eso puedes quemar cuerdas de colores diferentes y la araña suelta una telaraña que sirve como puente para que puedas alcanzar a partes del nivel que antes no eran accesibles.
<p>
Burn the Rope es muy divertido. Vas a sentirte como si estuvieras ardiendo una cuerda, solo que el extintor del fuego no será necesario.
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157525045/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157525045/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Burn the Rope</span></div>
</div>
