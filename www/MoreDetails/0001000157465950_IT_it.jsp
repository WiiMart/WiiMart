...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157465950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Una raccolta di classici giochi Carta & Penna: i preferiti di sempre, per tutta la famiglia! <br><br>
 
I GIOCHI<br>
• Squares (Dots) - Puntini & Quadrati<br>
• Nine Men’s Morris (Mill) - Tris su scacchiera<br>
• Safe Cracker - Numeri & Logica<br>
• Matchsticks - Fiammiferi<br>
• Noughts & Crosses (Tic-Tac-Toe) - Tris<br>
• 4 In-A-Row - 4 di fila<br>
• BattleFleet - Battaglia navale<br>
• Hangman - L'Impiccato<br><br>

CARATTERISTICHE<br>
• Include 8 giochi classici coinvolgenti<br>
• Numerosi set di regole e diverse variazioni: gioca come preferisci! <br>
• Divertimento per tutta la famiglia: fino a 4  giocatori possono competere in modalità Torneo.<br>
• 20 obiettivi speciali segreti da sbloccare!<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
