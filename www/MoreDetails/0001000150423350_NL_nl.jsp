...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Devil’s Crush is het spectaculaire vervolg op het succesvolle flipperspel Alien Crush en bevat nog vloeiendere balbewegingen en verbeterde ‘special effects’.
<br><br>
Schiet de bal weg met de zogenaamde Devil Shooter. Gebruik vervolgens de flippers en stoot tegen de machine om de bal zo lang mogelijk in het spel te houden en een hoge score te behalen. Door het voltooien van bepaalde doelen kun je 6 verschillende bonuslevels spelen. Wanneer je daarin een ‘Perfect Clear’ bereikt, krijg je enorm veel punten!
<br><br>
Het onheilspellende karakter van het spel wordt versterkt door de aanwezigheid van vijanden als de ronddolende Skeleton Knights, tovenaars en een groot gezicht dat langzaam van een godin in een boosaardige slang verandert!
...
<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150423350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150423350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Devil's Crush</span></div>
</div>
