...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Los depósitos de almacenamiento de la Federación han sido asaltados por piratas, que han extraído de ellos valiosos minerales, joyas, munición y armamento de última generación. Tu misión (si es que la aceptas) consiste en recuperar la totalidad de estas importantes mercancías en un tiempo limitado.
<br><br>
Por si fuera poco, los piratas han activado los sistemas de defensa planetaria, que supondrán un obstáculo adicional en tu camino. Así es que si pretendes recuperar la mercancía, tendrás que vértelas tanto con estos sistemas de defensa como con los propios piratas. 
<br><br>
Ten en cuenta que si no regresas a tiempo, o si la mercancía recuperada no es suficiente, ¡serás penalizado con la pérdida de una de tus naves Cybernoid!
<br><br>
Vamos, valiente soldado, ¡a por los piratas!
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143394950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143394950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Cybernoid<sup>TM</sup></span></div>
</div>
