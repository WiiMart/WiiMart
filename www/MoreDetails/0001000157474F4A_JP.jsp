...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157474F4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『グーの惑星』は、ナゾの生き物「グー」たちを、ゴールの「パイプ」までみちびいていくパズルゲームです。<BR><BR>
ネバネバした「グー」をお互いにくっつけて、まるでタワーや橋のように、さまざまな形につなげることができます。<BR>
Ｗｉｉリモコンでポイントしてボタンを押すと「グー」をつかむので、動かして「パイプ」まで届くようにつないでいきます。<BR>
しかし、「グー」の重さでバランスがとれなくなるとつなげた形が崩れてしまうので、「パイプ」までバランスよくつないでください。<BR><BR>
人数分のＷｉｉリモコンがあれば同時に最大４人まで遊べます。<BR>
プレイ中のいつでも好きな時に、飛び入り参加が可能です。<BR><BR>
ステージをクリアするだけでなく、ステージをクリアしたときにパイプにいれた「グー」を使って、どれだけ高いタワーを作れるか、チャレンジするモードもあります。<BR>
ニンテンドーＷｉ－Ｆｉコネクションで、作ったタワーの高さを世界中のユーザーの記録と比べることができます。<BR><BR>
最大３００個ものグーを使って、世界で一番高いグーのタワーに挑戦してください！！</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157474F4A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157474F4A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">グーの惑星<sup>TM</sup></span></div>
</div>
