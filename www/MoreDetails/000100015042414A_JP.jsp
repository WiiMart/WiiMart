...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファンタジックな世界を舞台に繰り広げられる、縦スクロールタイプのシューティングゲームです。かつて太陽神によって氷河地帯の奥深くに封じこめられた魔王「ザウエル」。その復活のいけにえとして連れ去られた王女「アリーシャ」を救うため、「ミッドガルド王国」の勇士「アムル」は伝説のブルードラゴンへと姿を変え、モンスター軍団が待ち受ける大空へと飛び立ちます。プレイヤーは対空用と対地用の２種類のファイアーを駆使し、カルスト、火山、密林と続く８つのエリアを戦います。エリア中では地上にある「卵」や点滅する敵を破壊することで、さまざまなパワーアップアイテムが出現。青いアイテムでドラゴンの首を増やし、赤いアイテムで火力をアップさせながら、各エリアのボスを倒して「ザウエル」の魔宮をめざします。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
