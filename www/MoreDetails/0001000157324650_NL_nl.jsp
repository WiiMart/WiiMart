...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157324650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Patiënten die een revalidatieprogramma moeten afwerken, kennen het probleem: veel belangrijke oefeningen voor het genezingsproces zijn vaak monotoon en saai. Vooral de evenwichtsoefeningen kennen nauwelijks variatie.<br />
Hierbij kan Physiofun Balance Training helpen. Het programma maakt evenwichtsoefeningen leuk.<br /><br />
Physiofun Balance Training is daarnaast uitstekend geschikt voor fysiotherapeuten en privé-revalidatiecentra. Patiënten die herstellen van voet-, knie- of heupklachten hoeven niet meer op dure speciale apparatuur te werken, maar kunnen belangrijke oefeningen nu op een leuke manier uitvoeren.<br /><br />
Physiofun Balance Training brengt veel functies samen: in combinatie met zinvolle tests, zoals het meten van het zwaartepunt en het evenwicht van het lichaam, biedt de 'Fysiomodus' de mogelijkheid om geavanceerde trainingsschema's op te stellen voor fysiotherapeutische oefeningen.  <br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324650/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324650/FFFD0015" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Evenwichtstraining</span></div>
</div>
