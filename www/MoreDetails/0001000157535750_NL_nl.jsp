...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157535750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Herschrijf de geschiedenis en win de goden voor je door de meedogenloze Vikingen, de sluwe Azteken of de handige Chinezen op oorlogspad te slepen!
<br><br>
Swords & Soldiers is een zijwaartsscrollend strategiespel waarin je beschikt over een compleet leger en allesverwoestende magie. Vernietig de vijandelijke basis aan het eind van het tweedimensionale slagveld en leid je troepen naar de overwinning!
<br><br>
De game biedt uren spelplezier met een solocampagne, uitdagende losse gevechten en een hectisch speltype voor twee spelers waarin je je vrienden met de grond gelijk kan maken! Alsof dat nog niet genoeg is, kun je een aantal lastige uitdagingen vrijspelen waarin je tot het uiterste moet gaan voor die ene glorieuze topscore!
<br><br>
