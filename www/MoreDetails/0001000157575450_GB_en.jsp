...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157575450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Peter Pepper picked a peck of pickled burgers and man, what a fight did he get! Join our hero as he traverses the globe in search of hamburger heaven. Escape from angry veggies and build your BurgerTime World Tour today.
<br><br>
Classic retro games can transcend their original platform and evolve onto the larger world of next generation gaming. BurgerTime World Tour is a maturation of the arcade classic enhanced with an innovative 3D rotating cylindrical environment and elevated retro gameplay. 
<br><br>
The rotational axis allows you to see through the cylinder level, creating strategic elements for determining the fastest way to complete a burger. Enemies can now be thrown by Peter Pepper. Tossing a baddie onto a burger part will rack up bonus points!
<br><br>
Enjoy four culinary capital cuisine worlds and elevated retro gameplay with over 20 fun-filled Burgerlicious levels!  The all-new Burgertime will rock your retro world.  Download today!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157575450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157575450/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BurgerTime World Tour</span></div>
</div>
