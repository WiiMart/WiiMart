...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742354A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">通常のブロック崩しジャンルのゲームとは一線を画す、ストーリー性とオリジナル要素があふれるゲームです。個性的なキャラクターが登場し、バーやカジノ、ディスコなど魅力的なゲームステージが緻密に描かれています。ブロック崩しというなじみ深いアーケードゲームに、様々なアイテム・難易度を設定することで、やりこみ度を高めました。ナンバーワンの「ブロックブレーカー」を目指してください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742354A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742354A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブロック ブレーカー デラックス</span></div>
</div>
