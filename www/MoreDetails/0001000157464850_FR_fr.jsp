...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157464850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Contrôlez un flotte d'avions inépuisable dans ce jeu très addictif de Firemint qui a connu un succès mondial !
Incarnez un contrôleur de trafic aérien dans un aéroport de plus en plus bondé. Dirigez différents modèles d'avions et évitez les collisions !
<br><br>
Facile ? Lorsque les avions se bousculeront au-dessus de l'aéroport, vous devrez faire preuve de calme et de stratégie pour éviter de tomber dans le chaos le plus total ! Pour diriger un appareil, faites-le glisser vers sa piste d'atterrissage avec la télécommande Wii. Jouez seul, entre amis ou en famille, grâce à un mode multijoueur où un maximum de 4 joueurs peuvent rejoindre ou quitter la partie à tout moment.
<br><br>
Visitez 5 aéroports différents, dont la brousse australienne et un porte-avion, et découvrez 10 modèles d'avions, dont des jets, des hélicoptères et des hydravions !
Flight Control s'apprend en moins d'une minute, mais vous aurez beaucoup de mal à vous en détacher !
