...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Originally released in 1984, Boulder Dash is well-known as one of the greats of the classic era of computer games. It is one of the very few computer games ever to be ported from home computers to arcades, rather than the other way around.
<br><br>
...
<br><br>
Strategy and planning are the key to mastering the "physics" of Boulder Dash. Once the indicated amount of Jewels have been collected, the door to the mysterious escape tunnel is revealed, and Rockford can pass through into another cave, filled with precious stones and dangerous traps! So what are you waiting for? The diamond rush is upon us!</div>
  <div id="image02">
