...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D3350')", "wiiSelectSound()");
...
<br><br>
Controlling one of eight monkeys you will do battle with up to seven others across eight different themed landscapes. In single player, battle through three increasingly difficult campaigns of missions ranging from survival to coconut fights or have a one off battle against the clock, as a team or a standard deathmatch.
<br><br>
Connect additional Wii Remotes to battle against up to three additional players. Connect a Wii Balance Board to add more mayhem to the fun.
<br><br>
May the best monkey win.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3350/FFFD000D" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3350/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
