...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">独特の世界観とオリジナリティあふれる操作システムがアーケードで人気を博したシューティングゲームです。「天帝バイオス」によって破壊された「ダストワールド」。人々の無念のオーラによって呼び出された名もないふたりの戦士が、バイオスを倒すべく立ち上がりました。プレイヤーが操作するふたりの戦士は、通常ショットに加え、戦士の周囲を回る「サテライト」による攻撃がおこなえます。立ちふさがる敵を倒してお金を手に入れ、ショップでアイテムを購入することで、サテライトで全方位弾、バルカン砲、追尾レーザーなどによる攻撃が可能となります。ダストワールドからピラミッドワールドを抜け、ダストドラゴンや武神など強力な邪悪神を倒し、
バイオスの待つ天空界をめざしてください。２人での同時プレイも可能です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
