...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B4E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">漢検の問題を家族や友人とクイズ番組感覚で楽しめるソフトです。10級～1級までの問題を選択形式にアレンジした問題を多数収録。また、参加する方のレベルに合わせて様々な出題形式を選択できるので小学生から大人まで楽しむことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B4E4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B4E4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">漢検</span></div>
</div>
