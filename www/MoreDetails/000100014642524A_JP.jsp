...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機（ファイター）を操り、次々に現れる敵機（ギャラガ）をビームで撃墜し、画面上の敵を一掃して次の面へチャレンジする、面クリアタイプのＳＦシューティングゲームです。敵機の捕虜となった自機を救い出すことで２機合体のデュアルファイターになるといった、当時、シューティングゲームとして初の自機パワーアップシステムを導入。また、数面ごとにボーナスステージの「チャレンジングステージ」が巡り来るなど、飽きさせない要素がプレイヤーを虜にしました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ギャラガ<sup>TM</sup></span></div>
</div>
