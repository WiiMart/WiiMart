...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157554E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Préparez-vous à crier “UNO” sur votre console Wii ! Le célèbre jeu de cartes a été fidèlement reproduit sur Wii et agrémenté de toutes nouvelles règles ! Avec un mode Multijoueur accessible depuis une console Wii, jouer à UNO n'aura jamais été aussi facile et amusant, alors soyez le premier à vous débarrasser de toutes vos cartes !
<br><br>
• Le numéro 1 des jeux de cartes pour jouer en famille ou entre amis ! Toujours aussi drôle et toujours aussi facile à jouer grâce à ses règles simplissimes !<br>
• Personnalisez les règles du jeu et découvrez de nouvelles manières de jouer à UNO, comme “UNO 7-0”, “Défi UNO”, “Saute-mouton” et beaucoup d'autres !
<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554E50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554E50/FFFD0002" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
