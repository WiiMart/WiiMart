...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">突然現れた巨大な島・アトランチスを冒険するアクションゲームです。プレイヤーは青年冒険家・ウィンを操作して、次々に登場する敵をかわしながら、謎だらけのアトランチスを探索します。小型爆弾“ボン”を武器に、地面がつるつる滑るアイスゾーンや、あたりが真っ暗なダークゾーンなど、全部で１００のゾーンを踏破し、古代帝国の復活を狙う悪の帝王「ザヴィーラ」を倒してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アトランチスの謎</span></div>
</div>
