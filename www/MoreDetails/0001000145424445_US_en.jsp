...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Puzzle action game released by Data East in 1997. Control a clown to pull in and throw back balloons hurled from the top of the screen. If you line up three or more balloons of the same color in a row vertically they will burst, but if you’re not quick enough the balloons will squash the clown and it’s game over. Once you’ve caught the hang of bursting balloons, next you need to master combos and chains.
<p>
The basic rules of the game haven’t changed since MAGICAL DROP II, but with 16 characters to play as and a new Magical Journey mode, there is much to explore in MAGICAL DROP III!</div>
  <div id="image02">
