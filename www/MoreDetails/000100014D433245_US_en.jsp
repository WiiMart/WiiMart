...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Superhero annelid Jim and his new sidekick Snott are back for an off-the-wall sequel in Earthworm Jim 2. Containing more action than your standard platformer of this era, each stage has a different style and mission that draws on game play from different genres, including mazes, trivia contests, and arcade game style levels. Features game music composed by Tommy Tallarico. Do you have what it takes to rescue the Princess?</div>
  <div id="image02">
