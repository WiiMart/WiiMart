...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495045')", "wiiSelectSound()");
...
<p>
Bienvenidos al mundo de los PooYoos: el primer juego poético de agudeza mental para niños de 3 a 6 años. Con los PooYoos, una alegre banda de adorables animalitos, su hijo se divertirá y aprenderá elementos básicos para su desarrollo: números, letras, lateralización, formas, colores y más cosas. Los niños podrán bailar con sus nuevos amigos y conseguir montones de premios interactivos. Con dos niveles de interactividad, el niño podrá jugar, sea cual sea su edad y nivel, a actividades relacionadas con la música y las plantas.
<p>
Este juego está diseñado para niños que aún no saben leer. Las instrucciones se dan oralmente en francés, inglés, o español, según la opción de idioma de la consola Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495045/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495045/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Learning with the PooYoos: Episode 3</span></div>
</div>
