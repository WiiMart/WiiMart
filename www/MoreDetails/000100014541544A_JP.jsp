...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９４年にリリースされた格闘ゲームで、『ワールドヒーローズ』シリーズの第３弾。歴史上の人物や著名な人物が腕を競うという内容で、総勢１６人の英雄、豪傑、悪漢、格闘家などが世界最強の座をめぐって戦います。ゲームは1日３人と戦い、勝ち越せば翌日へと進める『超武会モード』と、任意の相手と戦う『武者修行モード』の２種類を搭載。前作にはなかったダッシュ、バックステップの追加や、カウンターシステムの導入によってスピード感のある戦いが楽しめるようになっています。また、対戦プレイでは４種の性能から選んで戦うことが可能になり、幅広い駆け引きが楽しめるようになりました。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワールドヒーローズ２ JET</span></div>
</div>
