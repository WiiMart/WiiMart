...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157554E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rufen Sie jetzt "UNO!" auf Ihrer Wii-Konsole! Das weltberühmte Kartenspiel gibt es jetzt für die Wii-Konsole in seiner klassischen Aufmachung und mit seinen leicht verständlichen Regeln! Gestalten Sie Ihr Spiel mit eigenen Hausregeln und Strafen ganz wie Sie es mögen und legen Sie in spannenden Spielrunden Aktionskarten wie Aussetzen und Retour ab!
<br><br>
• Das Kartenspiel Nr. 1, der Spielspaß für Freunde und Familie, in seiner klassischen Aufmachung und mit einfachen Regeln, die alle verstehen!<br>
• Die Spielregeln lassen sich anpassen und bieten neue Spielmöglichkeiten für UNO wie "7-0-UNO", "Challenge UNO", "Jump-In-UNO" und viele andere.
<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554E50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
