...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">鎧武者を思わせる姿のロボットを駆使して戦う縦スクロール型シューティングゲームです。スペースコロニー制御システムコンピュータ「大亜５１」が突如暴走し、地球に対して全面攻撃を開始しました。プレイヤーは、最新鋭アームドアーマー「アレスタ」を駆るＭＵＳＨＡ部隊のパイロット「エリノア・ワイゼン」として、全７ラウンドの戦いにいどみます。自機は、パワーチップによるパワーアップシステムと３種類の特殊兵器、自在に切り替えられる６種類のオプション・フォーメーションを備え、さらに移動スピードの変更も可能。バリエーション豊かな攻撃とテクニカルなシステムにより、爽快感のあるプレイが楽しめます。和をモチーフとした敵デザインや、ステージごとのさまざまな演出、厚みのある音楽などが、今なお高い評価を得ているタイトルです。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">武者アレスタ</span></div>
</div>
