...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157464450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les Furries sont des créatures vertes mignonnettes qui aiment visiter des planètes étranges. Jusque-là,  tout va bien !<BR>Malheureusement, les Furries sont aussi complètement stupides. Elles passent leur temps à bizarrement se balader près des dangers les plus mortels : créatures galactiques, gouffres géants, pics, explosions...<BR><BR>Sauvez les Furries à travers 60 niveaux en utilisant tout un tas d'objets utiles avec la Wii Remote : flippers, cordes, caisses, canons... Tout est bon pour les aider à se frayer un chemin et éviter de devenir le dîner du grand méchant Furax !<br><br>Texte écran en français.</div>
  <div id="image02">
