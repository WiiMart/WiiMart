...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スーパーファミコン版「スターフォックス」の豪華版。随所にフルボイスのムービーが流れる臨場感いっぱいの３Ｄシューティングゲームです。プレイヤーはフォックスとなり、仲間たちと協力し、各ステージの作戦をクリアして惑星ベノムを目指します。惑星ベノムまでのルートは特定のステージのクリア条件によって分岐し、また、仲間が戦闘から離脱せず一定数の敵機を撃墜することでもらえる各ステージの勲章をすべて集めれば、難易度の高いエクストラモードのステージが楽しめます。対戦専用のＶＳモードでは４人までのプレイが可能。生き残りを賭けた撃ち合いや対戦相手を撃ち落とした回数を競うこともできます。<BR><BR>

詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スターフォックス<sup>&reg;</sup>６４</span></div>
</div>
