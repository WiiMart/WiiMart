...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">和風テイストあふれるアクションＲＰＧ。西暦一万四千六百七十二年、魔暦元年。魔王龍骨鬼（りゅうこつき）によって二人の兄を奪われた月氏三兄弟の末弟・風魔は、家宝の波動剣を取り戻すため、そして兄たちの仇を討つため、龍骨鬼の棲む狂鬼島へ向かいます。狂鬼島と、波動剣を隠し持っている悪神どもの棲む鬼顔島・獄門島・三首島の四つの島を舞台に、風魔の闘いがくり広げられます。フィールドマップを行き来し、さまざまなアクションステージや３Ｄ迷路で行く手を阻む魔物を倒しながら、道中のお店で武器やアイテムを買い集め、ほこらで情報を集めます。また、他の島に渡るには鬼面符とよばれる通行手形が必要で、鬼面符と波動剣を三つずつ集めなければ龍骨鬼を倒すことはできません。奪われた三本の波動剣を取りもどし、魔王龍骨鬼を倒してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">月風魔伝</span></div>
</div>
