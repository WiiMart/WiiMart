...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157445245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Mr. Driller W es la nueva y emocionante entrega de este clásico, que te desafía a través de niveles y más niveles de frenéticas excavaciones subterráneas! ¡Recorre más de 20 fases y misiones diferentes! Excava superando un ataque interminable de bloques de colores, esquivando los obstáculos que caen y controlando estratégicamente tu suministro de aire. Con varios niveles de dificultad, habrá desafíos a medida de cualquier jugador, desde principiantes hasta grandes veteranos de Mr. Driller. ¡El tutorial práctico ayudará a los recién llegados a conocer las reglas del juego rápida y fácilmente! ¡Gráficos muy vivos, una jugabilidad adictiva y montones de personajes dan un giro totalmente moderno a esta obra maestra! Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157445245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157445245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mr. DRILLER<sup>&reg;</sup> W</span></div>
</div>
