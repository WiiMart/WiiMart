...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157385745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Create and send fun Halloween cards! Use all your imagination and dress your character with different costumes, then decorate the card choosing the background, the music, and lots of stickers. With the Wii Remote controller, you can easily navigate through the different menus and add the stickers, in the position and size of your choice. Once the card is finished, write a personal note and send it to your friends. Try out this easy and fun new software! Follow the quick tutorial to learn how to properly use it!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157385745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157385745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Happy Holidays Halloween</span></div>
</div>
