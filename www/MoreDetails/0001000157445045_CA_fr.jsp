...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157445045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The doctor is in! This special multiplayer-only version of Dr. Mario Online Rx is available once a friend who owns the full version of the game has sent it to you. After downloading, you can enjoy classic Dr. Mario puzzle action for free. Match vitamins with the same color viruses to rid the world of those nasty germs. It’s a prescription for fun that you’ll want to fill right away!</div>
  <div id="image02">
