...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Lánzate al futuro con F-Zero!  Elige uno de los cuatro coches planeadores alimentados por protones, cada uno con su curva de aceleración y modificaciones de diseño, y después lánzate en una carrera de 15 pistas llenas de desafíos y peligros.  La estrategia juega un papel muy importante en este festín de velocidad, por lo cual tendrás que encontrar atajos, eludir peligros y recoger power-ups si quieres derrotar a tus competidores.  Ten cuidado con la arena, las minas, los imanes y otros puntos problemáticos, pero esté siempre listo para obtener un refuerzo de una placa de velocidad o de salto.  ¡Necesitarás reflejos agudísimos para controlar estas máquinas de velocidad del mañana, por lo cual prepárate para una experiencia que no es de este mundo!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414345/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414345/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">F-Zero<sup>&reg;</sup></span></div>
</div>
