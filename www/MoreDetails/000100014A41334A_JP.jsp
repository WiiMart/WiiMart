...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「かまいたちの夜」は「弟切草」に続いて発売されたサウンドノベルの第２弾タイトルです。サウンドノベルとは、チュンソフトが新たなゲームのジャンルとして世に送りだした、臨場感あふれるサウンド・効果音と、心理描写までも美麗に映像表現したマルチストーリー構造の小説のことです。「かまいたちの夜」の舞台は冬のペンション。このペンションで主人公たちは不可解な殺人事件に巻き込まれてしまいます。あなたは犯人を見つけ、事件を解決する事ができるのでしょうか？文章を単に読み進めるだけでなく、選んだ選択肢によってエンディングや世界観の設定までもが変わるシナリオも用意されるなど、繰り返し遊べる仕組みが盛り込まれています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41334A/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41334A/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">かまいたちの夜<sup>&reg;</sup></span></div>
</div>
