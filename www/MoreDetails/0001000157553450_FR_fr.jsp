...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157553450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Succès au primaire Mathématiques CM 1" propose aux élèves de résoudre des exercices passionnants, en compagnie de Freddy le petit vampire. Ils apprennent les mathématiques tout en s'amusant. Freddy motive les enfants et leur donne des conseils, ce qui leur permet d'apprendre et de progresser à leur rythme.
<br><br>
En récompense d'un entraînement assidu, tu as accès à d'autres niveaux d'un jeu bonus amusant. Une combinaison parfaite du jeu et de l'apprentissage !
<br><br>
Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157553450/FFFD000D" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157553450/FFFD0012" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Succès au primaire</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Mathématiques CM 1</span></div>
  </div>
