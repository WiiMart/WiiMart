...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F4145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Daddy, Mommy, Sarah, and Billy are back for some more family fun, and this time it's glide hockey! This time you can hone and master your skills in a gymnasium, a forest park, a beach, an amusement park, and even in the freezing arctic! Family Glide Hockey sports appealing cel-shaded graphics and endearing music, on top of the friendly competitive matchups. Choose between single-player mode, versus mode (up to four players can play), or challenge your skill in engaging minigames, such as "Glide Hockey Brawl!," "Glide Hockey Drill!," or "Glide Hockey Tracer!"</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
