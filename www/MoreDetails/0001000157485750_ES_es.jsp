...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157485750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">HoopWorld: BasketBrawl es un juego de baloncesto 3 contra 3, ¡con un toque arcade! El escenario está formado por personajes exclusivos y maravillosos entornos naturales. El juego mantiene su rudeza y velocidad gracias a las luchas y a los potenciadores. Escoge tu equipo favorito y juega a Basketbrawl por todo el planeta hasta convertirte en el campeón mundial indiscutible. Juega solo o con un amigo y trata de derrotar a los líderes de la clasificación mundial de HoopWorld. ¿Estás listo?<br><br>
Hace mucho tiempo, una civilización conocida como los Ancianos, adoradores de los poderes mágicos de la Naturaleza, construyeron por todo el mundo una red de templos sagrados. Desde entonces han transcurrido milenios y los templos han quedado en ruinas, pero su energía aún resuena en el lugar donde se levantaron, atrayendo a aventureros de tierras lejanas.  <br><br>Textos de pantalla en español.</div>
  <div id="image02">
