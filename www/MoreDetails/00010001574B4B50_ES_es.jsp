...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B4B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">● ¿Qué es Pop-Up Pirate!?<br>
Todo el mundo puede tener barriles repletos de diversión jugando en el modo Fiesta Pop-Up o disfrutar de una tronchante partida para un jugador en el modo Lógica Pop-Up. Los jugadores deben pinchar a través del barril que mantiene cautivo a su Capitán, ¡teniendo cuidado de no hacerle daño! Las características únicas de la consola Wii lo hacen aún más emocionante, convirtiéndolo en un juego lleno de diversión. ¡Prueba a cambiar al Capitán por un Mii™ dentro del barril para reírte con ganas!
<br><br>
● Jugando a Lógica Pop-Up<br>
Debes seleccionar un agujero dentro del límite de tiempo y clavar tu espada. Si el agujero es seguro, el Capitán te mostrará cuántos de los agujeros dentro de esa zona debes evitar.
Usa estas pistas para guiar tus estocadas, manteniéndote lejos de los agujeros peligrosos. Por cada estocada exitosa, se sumará tiempo extra al tiempo total restante.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
