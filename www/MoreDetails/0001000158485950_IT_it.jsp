...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158485950')", "wiiSelectSound()");
...
<br><br>
BIT.TRIP FATE è uno sparatutto a scorrimento orizzontale su binari. Guida CommanderVideo a cavallo della Vibe e alla scoperta del suo destino.
<br><br>
CommanderVideo potrà contare sul prezioso aiuto degli amici incontrati nel corso di BIT.TRIP RUNNER per contrastare il Mingrawn Timbletot, che ha trasformato il mondo in un incubo tecnologico.  
<br><br>
Unisci le forze con Junior Melchkin, CommandgirlVideo e altri per aumentare i poteri di CommanderVideo e salvare il mondo.
<br><br>
Che tu scelga di giocare da solo o in squadra con un copilota, ti servirà un polso fermo per navigare la Vibe e puntare le armi sulle anime tormentate pronte a distruggerti.
<br><br>
