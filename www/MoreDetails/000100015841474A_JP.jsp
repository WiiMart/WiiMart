...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">赤色のレーシングカーを操作し、敵車や障害物を避けながら燃料切れ前にゴールに到着することが目的の、スピード感あふれるアクションレースゲームです。１９８４年に発売された同名のアーケード版よりもシンプルな内容にアレンジされています。コースを走行中、画面上方から出現する敵車や路面のオイルに接触するとスリップしてしまい、障害物に当たるとクラッシュして燃料が大幅に減ってしまいます。スリップした場合は、カウンタステア（逆ハンドル）等のテクニックを駆使して切り抜けることもできます。また、コースに出現するハートに接触することで燃料の補給が可能です。燃料切れに注意しつつ障害物を避けながら、全６ステージの完走をめざします。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロードファイター</span></div>
</div>
