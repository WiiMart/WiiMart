...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El malvado Balugar ha dividido el planeta Bomber en cinco partes distintas... ¡menos mal que Bomberman ha vuelto para poner orden!
<br><br>
Además de los nueve miembros de la familia Bomber, en esta ocasión contarás con la ayuda del canguro ROOI. Presta atención a los huevos que aparecerán cuando hagas estallar algunos bloques. Si ves uno, salta sobre él y ROOI saldrá enseguida para echarte una mano. Hay varias versiones de ROOI, cada una con sus habilidades particulares. ¡Si las utilizas con astucia, la victoria no se te escapará!
<br><br>
Alucinarás con el modo batalla, que ahora consta de nada menos que 10 fases e incluye fantásticas novedades, como bombas que giran en la dirección de las flechas. Y, por si fuera poco, podrás jugar partidas por equipos con tus amigos. ¡Te lo pasarás bomba!
<br><br>
Textos de pantalla en inglés con algunos caracteres en japonés.</div>
  <div id="image02">
    <img src="/oss/ccs/000100015041474C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041474C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bomberman<sup>&reg;</sup>'94</span></div>
</div>
