...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D5250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Screeching tyres, the smell of burned rubber, the rush of adrenaline and enemies that are left in the dust – these are the emotions that drive real racers. However there is much more than this in the world of Monochrome Racing – there is the passion for colour! Colour is everything here, it is what you strive for, in the world where everything is in black and white. Colour is your fuel, colour gives you speed, colour makes you stronger and ultimately makes you the true leader of the monochrome racing world.
<br><br>
 - More than 80 tracks to complete<br>
 - More than 10 cars to choose from and upgrade<br>
 - Numerous power ups and bonuses that makes your vehicle stronger and your enemies weaker<br>
 - Immerse yourself in the mysterious monochrome</div>
  <div id="image02">
