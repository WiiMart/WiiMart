...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Entra, siéntate y abróchate el cinturón para disfrutar del juego de carreras de karts que se convirtió en leyenda! Elige uno de los ocho personajes del mundo de Mario, cada uno con su estilo de conducción, y compite en tres campeonatos y tres categorías distintas. Si ganas suficientes copas, podrás competir para ganar la más difícil de todas: la copa especial. Llegar a la meta en primer lugar no será fácil, ya que cada circuito tiene obstáculos que deberás superar y tus oponentes utilizarán objetos para conseguir la victoria. Si prefieres otro tipo de desafío, puedes competir con un amigo en carreras para varios jugadores o enfrentarte a él en uno de los circuitos del modo de batalla. En este modo, tu objetivo será explotar los globos de tu oponente antes de que él explote los tuyos. Con 15 circuitos para elegir y pieles de plátano que lanzar, ¡Super Mario Kart es un juego de carreras clásico que no querrás dejar de jugar!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A435745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A435745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
