...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157395250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Planning a Christmas party and want to grab guests’ attention? Or want to send greeting cards without the hassle of licking stamps? Then here is the solution: create and send fun Christmas cards with this unique WiiWare application!
<br><br>
...
As some of the Wii console’s online services were discontinued on 28th June 2013, online features for this software, using WiiConnect24, are no longer available.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157395250/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157395250/FFFD000A" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
