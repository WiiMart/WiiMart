...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pac-Man est de retour dans Pac-Attack, un puzzle délirant où votre mission consiste à faire disparaître de l'écran des blocs et des fantômes. Pour effacer les blocs, alignez-les à l'horizontale. Dès qu'une ligne est formée, les blocs disparaissent.
<br><br>
Pour vous débarrasser des fantômes, vous allez avoir besoin de l'aide de Pac-Man. Celui-ci surgit parfois pour casser la croûte. Alignez tous les fantômes pour qu'il n'ait plus qu'à les avaler. Pac-Man ne s'arrête que lorsqu'il rencontre un bloc ou quand il n'y a plus aucun fantôme. Il ne peut se déplacer que vers le bas ou horizontalement. Sur les surfaces planes, il se dirige dans la direction indiquée par sa bouche.
<br><br>
Trois modes de jeu sont disponibles: les modes 1 et 2 joueurs ainsi qu'un redoutable mode Puzzle – 1 joueur. Vous n'avez que l'embarras du choix!<br><br>
Texte à l'écran en anglais.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
