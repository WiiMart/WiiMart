...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750394A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ポーカーを題材にしたアクションパズルゲームです。<BR>フィールド内に次第にせり上がってくるカードを入れ替え、ポーカーの役を揃えて消していきます。複数の役を揃えて消せば、連鎖が発生して高得点。<BR>ゲームモードは全部で５種類。全10ステージを順番にクリアしていく「のーまる」、３分間のスコアを競う「すこああたっく」、エンドレスでプレイできる「とことん」、２人で協力してステージクリアを目指す「きょうりょく」、役を揃えて相手にバクダンを送りあう「たいせん」と、様々なルールで楽しめます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750394A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750394A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ぽーかーずWii</span></div>
</div>
