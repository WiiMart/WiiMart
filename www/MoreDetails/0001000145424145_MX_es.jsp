...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juego editado en 1996 por Data East, del género de puzles de acción. Las reglas son simples y muy concretas. Has de controlar al payaso para coger pompas y expulsarlas. El objetivo es juntar tres pompas del mismo color en vertical, así conseguirás que desaparezcan de la pantalla. Existen varios tipos de pompas: La Pompa Especial te permite hacer desaparecer todas las pompas del mismo color (hay 4 colores). La Pompa Flecha te permite hacer desaparecer todas las pompas en la dirección de la flecha. La Pompa Espuma es un fastidio durante la partida. La Pompa Irisada funciona como la Pompa Especial, pero da igual el color con el que entre en contacto. Y por supuesto, lo más divertido del juego es hacer cadenas de pompas para que vayan desapareciendo una tras otra. El juego ofrece un Modo VS contra la consola y un Modo Puzzle para jugar de forma individual. También existe la posiblidad de jugar contra un amigo o amiga, lo que proporciona horas y horas de diversión.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MAGICAL DROP II</span></div>
</div>
