...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">빛과 어둠, 두개의 세계를 오가며 하이랄 왕국을 차지하려는 사제 아그님을 쓰러뜨리고 포로가 된 여성들을 구출해 사악한 왕 가논에게서 하이랄 왕국을 구해 내는 것이 모험의 목적. 적과의 배틀, 수수께끼 풀기, 달리기, 열기, 누르기, 던지기 등 주인공이 구사하는 다채로운 액션이 공략의 비결입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414454/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414454/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">젤다의 전설<sup>TM</sup> 신들의 트라이포스</span></div>
</div>
