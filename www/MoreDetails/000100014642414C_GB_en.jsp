...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This speedy table tennis game was originally released only in Japan for the Famicom Disk System. Now, over 20 years later, it makes its European debut on Virtual Console!
<br><br>
Play against the CPU or a friend in a best-of-three table tennis showdown! The goal of the game is to reach a set amount of points while maintaining a two-point lead. If you can do this, you win the game. If you reach the set amount but the scores are tied, you go into "deuce" and have to score two points in a row to win.
<br><br>
Use the full range of controls – smash, lob, forehand and backhand – to beat your opponent and send the crowd wild. And look out for a special appearance by Donkey Kong Jr. in the audience!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
