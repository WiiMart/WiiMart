...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158495550')", "wiiSelectSound()");
...
<br><br>C'est le football du futur : détruisez les blocs de défense et propulsez le ballon au fond des cages pour remporter le match, mais attention car les défenseurs adverses essaieront de vous réduire en miettes !<br><br> 

Profitez de l'éditeur de niveaux intégré, qui offre des possibilités illimitées, ou jouez aux 90 niveaux et aux différents modes de jeu, dont Arcade et Tournoi personnalisable.<br>
- 90 niveaux amusants pour marquer et briser des blocs.<br><br> 

- Des niveaux avec blocs animés, blocs explosifs, blocs de protection, blocs invisibles et adversaires mortels en 3D.<br><br> 

-  9 redoutables boss de fin de zone.<br><br> 

- Un éditeur de niveaux pour créer vos propres parties. Possibilité de stocker plus de 100 niveaux créés.<br><br> 

- En mode Tournament, créez vos propres tournois à partir de niveaux standards ou personnalisés.<br><br> 

- Des bonus et des super bonus vous aideront (ou pas) à trouver le chemin des buts : lasers, bombes, ballons enflammés, ballons multiples et barres.<br><br> 

- De nombreuses récompenses spéciales à débloquer et des surprises à découvrir.<br><br> Texte écran en anglais.</div>
  <div id="image02">
