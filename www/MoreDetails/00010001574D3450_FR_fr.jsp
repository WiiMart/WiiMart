...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574D3450')", "wiiSelectSound()");
...
Le jeu vous fournit aussi une assistance technique intégrale pour le Microphone USB Logitech et le Wii Speak afin d'effectuer vos propres enregistrements vocaux.
  <br><br>
Devenez la plus grande star du monde!<br><br>Texte écran en français.
<br/><br/>
