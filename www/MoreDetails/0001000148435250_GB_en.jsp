...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This Channel is aimed at players of The Legend of Zelda: Skyward Sword.
<br><br>
This Channel was created in order to repair save data that, under certain gameplay conditions, prevents players from proceeding in the game during the Song of the Hero quest when song acquisition events in the volcano and forest areas fail to occur if the Thunder Dragon's Song from the desert area has been obtained first. If you have not played The Legend of Zelda: Skyward Sword, then you do not need to use this Channel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
