...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This legendary role-playing game comes to PAL regions for the first time! Designed by the RPG experts at Square (now Square Enix), Super Mario RPG is satisfyingly deep yet easy to pick up and play.
<br><br>
...
<br><br>
Fight enemies, conjure magic spells and use items to advance your quest. Plus - look out for appearances from many other Nintendo characters along your way!<br><br>In-game text will be in English.</div>
  <div id="image02">
