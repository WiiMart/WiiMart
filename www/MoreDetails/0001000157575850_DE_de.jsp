...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157575850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paper Wars Cannon Fodder ist ein Spiel, das von mehreren ausgelagerten polnischen und ungarischen Programmierern des iFun4all-Teams gemacht wurde. Es ist ein Spiel, das auf die billigste Weise, die Sie sich je vorstellen können, entwickelt wurde. Was ist das sogenannte glorreiche Ziel des Spiels? Sie würden es nie erraten: Alle Feinde zu zerstören! Dieselbe altbekannte, aufregende Geschichte, Horden kaltblütiger Feinde, die dem Grauen entkommen wollen! Das Spiel kann von bis zu vier Spielern bedient werden. Denken Sie, dass ein Spiel außergewöhnliche Extras beinhalten sollte? So möge es auch hier sein! Sie können sich diese während der drei Kampagnen Classic, Winter Assault und Cyber Wars erkämpfen. Die „handgemachte“ grafische Darstellung, Musik, die dem Marsch der sowjetischen Truppen ähnelt und die nervig klingenden Toneffekte machen die Spieler begierig darauf, jeden Level zu beenden und Medaillen für ihre außergewöhnlichen Bemühungen zu sammeln.
