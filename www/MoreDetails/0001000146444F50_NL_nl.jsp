...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dit actiespel voor de NES, dat overgezet is van de originele hit uit de speelhal, speel je een eersteklas commando. Je hebt opdracht gekregen om een parachutelanding te maken in de Zuid-Amerikaanse jungle tijdens een gevaarlijke missie om gijzelaars te redden.
<br><br>
Vanuit een eerste-persoonsperspectief bestuur je een vizier en gebruik je je machinegeweer en granaten om vijanden uit te schakelen. Elk van de zes missies heeft een uniek doel en je prestaties in elke missie bepalen het einde. Maar je kunt niet zomaar in het wilde weg schieten: zorg dat je zoveel mogelijk gijzelaars in leven laat!
<br><br>
Dit spel bevat verschillende eindfilmpjes (en geldbonussen voor je troepen!), afhankelijk van het aantal gijzelaars dat je hebt kunnen redden. Zal de president van de Verenigde Staten tevreden zijn met je prestaties? Pak je wapens op en bepaal je lot!
<br><br>
