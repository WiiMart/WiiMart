...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Based on the popular SEGA arcade game and redesigned for the SEGA MASTER SYSTEM, Enduro Racer takes you on an intense journey of adrenaline through diverse and rough terrain that will test your skills and reaction times to the limits! 
<br>
Ride as fast as you can to pass cars and bikes while avoiding obstacles and pitfalls. Take jumps off ramps and try to keep your speed up, but make sure to keep an eye on your bike's damage so you are able to finish the race!  Are you ready for the challenge?</div>
  <div id="image02">
