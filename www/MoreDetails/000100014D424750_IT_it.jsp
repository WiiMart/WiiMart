...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Headdy, un giocattolo con la testa staccabile, arriva a North Town per scoprire che il malvagio re-marionetta, Dark Demon, sta causando seri problemi. Dark Demon sta raccogliendo tutte le marionette in città, per trasformare alcune di esse in malvagi adepti ed eliminare quelle che non sono giudicate degne di unirsi alle sue legioni. A un certo punto Headdy viene catturato e destinato all’inceneritore, ma riesce a fuggire appena in tempo e ora si appresta a salvare la città.
<br><br>
Per far questo, Headdy dovrà affrontare vari nemici e persino una conoscenza di vecchia data: l'orso Trouble Bruin. Riuscirà Headdy a sgominare i suoi nemici e a sconfiggere Dark Demon?
