...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D4150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">MAGNETIS is all about attraction!<br><br>

Connect the magnets to create electrical explosions. Solving this frantic puzzle will require quick thinking and foresight, anticipating connections in order to generate massive chain reactions to win the highest number of points!<br><br>

To get rid of blocks and score points, you must create lines by connecting same colour left and right magnets by using conductor blocks. The longer the line, the more points it is worth. <br><br>

Team up with your friends in cooperative mode or play against them in battle mode, with up to 4 players competing for the highest score.</div>
  <div id="image02">
