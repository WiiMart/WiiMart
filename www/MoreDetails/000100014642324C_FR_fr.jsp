...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La version originale de la suite du jeu vidéo le plus vendu de tous les temps revient pour vous sur la console virtuelle!
<br><br>
Super Mario Bros.: The Lost Levels, disponible à l'origine uniquement sur le Famicom Disk System au Japon, décuple l'expérience du premier jeu avec des niveaux plus tortueux, des ennemis plus fourbes et de nombreux mondes secrets à découvrir.
<br><br>
Durant une précédente édition du  Hanabi Festival, la version de ce jeu pour la console virtuelle n'a été disponible que pour une période de temps limitée. Ce n'est plus le cas à présent puisque ce jeu est disponible pour tous de manière permanente!
