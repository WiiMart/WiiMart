...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「パワード・ギア（ＰＧ）」と呼ばれる戦闘兵器に搭乗して戦うアクションＲＰＧ。水と緑に包まれた美しい惑星「ユーロ」を舞台に、デグナー帝国軍に父を殺害された主人公「アレフ」の戦いが始まります。ＰＧはファクトリーを利用してパラメーターごとに詳細なセッティングが可能で、戦闘に勝利して得られる資金を蓄えることで、ＰＧの強化もおこなえます。５つのシナリオからなるストーリーは、物語の進行とともに複雑な人間模様を織りなしていきます。アクションシーンでは敵ボスの操縦するＰＧが登場、バリエーション豊かなロボット戦を満喫できます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブラッド・ギア</span></div>
</div>
