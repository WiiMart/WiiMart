...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dit side scrolling actiespel dat zich afspeeld in Washington City en dat oorspronkelijk werd uitgegeven in 1991, is de speler een superkrijger die geesten uit het verleden moet bevechten zodat ze het heden niet verderven. De belangrijkste feature van dit spel is de mogelijkheid van personage te wisselen tijdens het spel. Als je een gevangen genomen personage bevrijdt terwijl je de vijand bevecht, zal je dat personage kunnen gebruiken. De sleutel tot succes ligt in het behending wisselen tussen de ninja dog, samurai and ninja op het juiste moment. Je kunt ook voorwerpen zoals wapens en lichtbollen oppakken die je magische aanvallen geven. Je kunt niet alleen op avontuur gaan in de normale wereld, maar ook in een parallel universum, waarin stages rap veranderen en waar je je nooit zult vervelen.<br><br>De software is voorzien van Engelse schermteksten.</div>
  <div id="image02">
