...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157413750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toribash è il gioco di combattimento online in cui sei tu a creare le mosse! Usa il controllo dei movimenti di precisione per creare le tue mosse - l'unico limite è la tua immaginazione! Muovi le articolazioni del tuo combattente per un massimo impatto e distruggi i tuoi avversari con colpi precisi! Carica al massimo i tuoi movimenti per creare colpi più potenti, quindi afferra i tuoi avversari e schiantali per terra!
<br><br>
Vuoi creare il tuo video di una lotta? Passa semplicemente all'editor dei replay. Puoi aggiungere i tuoi replay in qualsiasi momento e rivedere così quella mossa strabiliante che ti sei perso prima.<br><br>Il testo all'interno del gioco è in italiano.
<br/><br/>
