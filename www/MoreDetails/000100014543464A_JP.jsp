...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９８年にリリースされたサイドビューのシューティングゲーム。『パルスター』の続編にあたるタイトルで、プレイヤーは６種の戦闘機からひとつを選び、惑星レムリアと惑星ムトラスの戦いに参戦することになります。基本的に連射と溜め撃ちを使い分けて敵と戦い、パワーアップアイテムやボーナスアイテムを獲得しながらゲームを進めます。もちろんステージの最後にはボスキャラとの戦いも…。なお、溜め撃ちをブレイクすることで攻撃を変化させたり、溜め撃ちで敵を倒すことでより高得点が稼げたりすることができますので、スコア稼ぎなどにチャレンジしても面白いかもしれません。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014543464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014543464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブレイジングスター</span></div>
</div>
