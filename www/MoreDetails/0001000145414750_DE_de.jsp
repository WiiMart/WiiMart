...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieses 1994 veröffentlichte, bahnbrechende Kampfspiel legte den Grundstein für die ganze King of Fighters-Reihe. Anders als bei den gewöhnlichen Kampfspielen, bei denen immer einer gegen einen kämpft, kannst du bei The King of Fighters '94 eines von acht Teams aussuchen, von denen jedes wiederum aus drei Kämpfern aus so klassischen Spielen wie Fatal Fury, Ikari Warriors, Psycho Soldier und Art of Fighting besteht.
<br><br>
Die Regeln sind einfach: Wähle eines der Trios verschiedener Nationalitäten aus, setze die Spielreihenfolge der Charaktere fest und kämpfe bis zum bitteren Ende. Zusätzlich zu den typischen Spezialmanövern hat jeder Kämpfer noch eine Energieanzeige, die im aufgeladenen Zustand zerstörerische Verzweiflungsmanöver erlaubt. Diese Energieanzeige lädt sich durch jeden Schlag, den dein Kämpfer einstecken muss, weiter auf, so dass du selbst nach einer ordentlichen Abreibung noch die Möglichkeit hast, den Spieß umzudrehen.
<br><br>
Die klare, detailreiche Grafik, die flüssigen Animationen und die fetzigen Soundeffekte und Musikeinlagen machen diesen Spielhallen-Klassiker zu einem Muss für Kampfspiel-Fans.
<br><br>
Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE KING OF </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">FIGHTERS '94</span></div>
  </div>
