...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">時代と共にさまざまな姿に変化する人気ＲＰＧ「シャイニング」シリーズの記念すべき第１作。一流のスタッフが結集して誕生した３ＤダンジョンＲＰＧです。神殿の奥で行方不明になった王女と父を探すため、新米王宮騎士の青年は、幼なじみのホビットの僧侶、エルフのおてんば魔法使いと共に、魔物が待つ迷宮へと向かいます。プレイヤー視点を重視し、ダンジョンも街もすべてがパノラマ３Ｄ。抜群の操作性を誇るコマンドシステムでテンポのよいゲームプレイを楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">シャイニング＆ザ･ダクネス<sup>TM</sup></span></div>
</div>
