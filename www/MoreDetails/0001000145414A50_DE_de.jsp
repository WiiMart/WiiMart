...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das von SNK 1996 erstmals auf den Markt gebrachte Metal Slug ist ein seitwärts scrollendes Actionspiel. Die Spieler steuern Marco (Einzelspieler) und Tarma (nur im Zweispieler-Modus), beide Mitglieder des Special Force Teams Peregrine Falcon (normalerweise Team PF genannt). Ziel des Spiels ist es, General Morden zu stürzen und eine gestohlene Waffe zurückzuerobern: die Metal Slug. <br><br>Grundsätzlich versuchen die Spieler alle Level durch Schießen und Springen zu bewältigen, aber der Einsatz von Waffen wie schweren Maschinengewehren, Schrotflinten, Raketen- und Flammenwerfern erleichtert den Kampf – ebenso wie das Erobern der Metal Slug, die immer wieder im Spiel auftaucht. Das Spiel hat eine Mehrspieler-Funktion, damit auch deine Freunde ihren Spaß haben können!
<br><br>
Englischer Bildschirmtext. Das Tutorial ist auch auf Portugiesisch verfügbar.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
