...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９２年にリリースされたサイドビューのシューティングゲームで、機械生命体と人類との戦いを描いています。プレイヤーはレーザー、ホーミング、グレネードなどの３段階に強化可能な武器や、自機の周囲を旋回するユニットを駆使して戦いますが、ユニットを交えた攻撃がこのゲームの特徴です。ユニットは敵の弾を消すことができ、自機を追尾させたり、位置を固定させたり、射出（ユニットシュート）させたりすることで多彩な攻撃が可能となり、これらの特性を把握し状況に合わせて使うことがゲーム攻略のカギとなります。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ラストリゾート</span></div>
</div>
