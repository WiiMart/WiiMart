...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494A45')", "wiiSelectSound()");
...
<p>
En el año 2112 la población está fascinada con las carreras de velocidad extrema. La última tecnología antigravitacional ha introducido el cambio de fases. La perfecta sincronización entre el tipo de pista y el vehículo de competición es la clave para mantenerse con vida.
<p>
Prepárate para una experiencia de carrera totalmente nueva a velocidad de vértigo. Pon a prueba tus límites para ganar carreras y batir récords. Desafía a tus amigos en una competición en pantalla dividida sin precedentes. Compite contra adversarios implacables y alcanza la cima en todas las ligas. Calienta los motores, el futuro ya está aquí...
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494A45/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494A45/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FAST - Racing League</span></div>
</div>
