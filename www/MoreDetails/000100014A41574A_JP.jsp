...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「三國志Ⅳ」は、２～３世紀の中国における魏・呉・蜀三国時代を背景に、プレイヤーが君主の一人となって中国の統一をめざす戦略シミュレーションゲームです。君主は、智将や猛将など、様々な個性を持った武将たちを指揮して富国強兵を押し進めます。その過程では、他国と同盟を図ったり、計略を仕掛けて敵国の弱体化を狙うなどの外交政策が重要となります。充分な軍備増強がなされたら、版図を広げるべく敵対勢力に攻め込みます。最終的に、中国全４３都市を支配下に掌握するとプレイヤーの勝利となります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">三國志ＩＶ</span></div>
</div>
