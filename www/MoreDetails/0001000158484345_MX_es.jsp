...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484345')", "wiiSelectSound()");
...
<p>
Ponte en el lugar de la hija del Darklord y prepara trampas y monstruos dentro de la torre para aniquilar las interminables oleadas de aventureros que quieren invadir tu castillo en este juego de rol. La única manera de evitar que los aventureros destruyan el cristal oscuro del último piso de la malévola torre es plagándola de monstruos y trampas llamadas “Artefactos”. ¡Mueve tu torre por todas las tierras y conquista cada lugar hasta conseguir dominar el mundo entero!
<p>
...
Después de jugar, irás al Canal Tienda Wii. Esto puede tardar unos minutos.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484345/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484345/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FINAL FANTASY<sup>&reg;</sup> CRYSTAL CHRONICLES<sup>&reg;</sup>:</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">My Life as a Darklord<sup>TM</sup> Demo</span></div>
  </div>
