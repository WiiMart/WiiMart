...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574B4B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">● Qu'est-ce que Pop-Up Pirate! ?<br>
Amusez-vous avec vos amis dans le mode Pop-Up Party ou seul avec le mode délirant Pop-Up Logique. Transpercez le tonneau qui contient le Capitaine captif, en faisant attention à ne pas l'embrocher ! Les fonctions uniques de la console Wii sont
parfaitement exploitées pour 
ajouter encore plus de piment à
ce jeu plein de fun! Vous pouvez même remplacer le Capitaine du tonneau par un Mii™ pour que la fête soit complète !
<br><br>
● Jouer à Pop-Up Logique<br>
Vous devez enfoncer votre épée dans le trou sélectionné durant le temps imparti. Si le trou est sans danger, le Capitaine vous montre le nombre de trous dangereux aux alentours. Utilisez ces indices pour éviter de mettre vos épées dans les trous dangereux. À chaque fois que vous transpercez correctement le tonneau, un temps bonus sera ajouté à votre total de temps restant. <br><br>Texte écran en français.</div>
  <div id="image02">
