...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ゼウスによって封印をとかれた２人の獣戦士が、魔神を倒し女神アテナを救い出すため、狼や虎、ドラゴンなど、いろいろな獣人へ変身して戦っていくアクションゲームです。獣戦士は、スピリットボールをとることで３段階にパワーアップし、炎の力を持つ狼「ウェアウルフ」、空を飛ぶ竜「ウェアドラゴン」など４種の獣人に成長します。２人同時プレイも可能です。世界中で人気を呼び、さまざまな機種に移植された本作ですが、
アーケード版がオリジナルとなっており、グラフィックやサウンドで段違いの迫力を味わえます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">獣王記<sup>TM</sup></span></div>
</div>
