...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015738324A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">プレイヤーは主人公「カヨ」を操作し、障害物をさけて、敵にあたらないようにして、制限時間で陣地を取ることができたらクリアー。シンプルなルールで、レトロゲームの面白さと懐かしさを持つ、完全新作の陣取りゲーム。<BR>野菜の種を手に入れて、作物の種類を増やして、畑を作物でいっぱいにしていく。そんな喜びが加わって、今までにない新しい感覚でゲームを楽しめます。<BR>少しずつ難しくなってくるマップを攻略し、手強い敵や障害物にはさまざまなアイテムの力で対抗。太閤様に収穫した作物を納めないと先には進めません。ギリギリいっぱいまで陣地を広げれば収穫がぐっと増える「大成功」になります。<BR>やりごたえ十分な全２００面以上の畑で、完全攻略を目指します。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015738324A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015738324A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">陣取りアクション！</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">太閤検地～からくり城のナゾ～</span></div>
  </div>
