...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９３年にリリースされた剣劇格闘ゲーム。各地を異変が襲う１８世紀の世界を舞台に、個性豊かな１２人の剣客たちがしのぎを削り、最後には異変の元凶「天草四郎時貞」と対決します。本作の最大の特徴はダメージの蓄積と共に上昇する「怒りゲージ」の存在。戦闘中にこのゲージがＭＡＸになるとキャラの攻撃力が増加するので、より緊張感のある戦いが楽しめます。素手での戦いを描くのが２Ｄ対戦格闘ゲームの主流であった当時、一撃必殺の「武器格闘」という新ジャンルを開拓した意欲作です。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サムライスピリッツ<sup>&reg;</sup></span></div>
</div>
