...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The evil gang known as "Guilty Zero" rules the city and it's up to you as one of the members of the Combatribes to take them down. Choose one of three characters and fight your way through the city of New York. Progress through the game by tackling the goons and boss of each stage using your arsenal of kicks, punches, throws, and other techniques to beat them into submission. Once your stamina bar is reduced to zero, you'll need to use a continue, but when you're out of continues, it's game over. Can you eliminate the threat of "Guilty Zero" and restore the peace in New York City!?</div>
  <div id="image02">
