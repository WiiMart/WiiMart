...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『２０２Ｘ年　大規模空爆の傷跡のこるＮＩＥＤＥＲ　ＴＯＫＹＯ。その一画Ｄ－０３地区で生まれた主人公は、悪魔の噂の真実を確かめようといつものようにアクセスした「ＤＤＳ－ＮＥＴ」で”悪魔召喚プログラム”を手に入れる。「生か死か」――決断は自分で下さなければならない。闘いの日は訪れた……』<BR>人気シリーズ「女神転生」の流れをくむシミュレーションＲＰＧ「魔神転生」シリーズの第一弾です。プレイヤーは全体マップと戦闘マップを交互に繰り返しながらゲームを進めていきます。戦闘マップでは、悪魔会話や悪魔合体といったおなじみのシステムを駆使し、仲魔を増強しながら悪魔を倒してステージクリアを目指します。また、時に迫られるプレイヤーの決断がエンディングを左右することがあります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A45454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A45454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">魔神転生</span></div>
</div>
