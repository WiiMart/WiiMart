...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574B5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Work together or compete in each stage to find the necessary items that will help the game’s hero find a way home. From seashells to sparkling jewels do your best to find the hidden objects as fast as you can! During this adventure you will also confront ghosts and a dragon for some action stages. Lots of items for each stage and lots of excitement can be found in this hidden object game!
<br><br>
Each stage can be played by up to 4 players for great gaming fun. Family and friends can work together to get a quick clear time or compete to see who is the best at finding hidden objects in every stage!
<br><br>
With 11 stages in total, including 2 action stages, there are hundreds of objects to find! Each stage also has a unique feature that creates a unique playing experience each time you play. There is no more memorizing the positions of the hidden objects, which is great for players who want to enjoy each stage again and again!</div>
  <div id="image02">
