...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B5250')", "wiiSelectSound()");
...
<br><br>
Guerreros grises y pesados de todo el mundo se enfrentan en un gran torneo para determinar quién es el mejor luchador de todos los tiempos. ¡Elije tu luchador y prepárate para pegar, pisotear y vomitar en el camino a la victoria! 
<br>
Karate Phants: Gloves of Glory es un juego de lucha 1 contra 1 con personajes de la tira cómica de Otto Waalkes. Ábrete camino hacia la cima del torneo derrotando a todos los luchadores controlados por ordenador, o luchando con un amigo.<br><br>Textos de pantalla en inglés o alemán.</div>
  <div id="image02">
