...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000148415450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Need the latest info on upcoming games? Want to know which titles suit your tastes? Then the Nintendo Channel is for you!
<br><br>
The Nintendo Channel includes regularly updated information about Wii, Nintendo DS, WiiWare and Virtual Console releases. You can see games in action via video clips and exclusive behind-the-scenes reports, and also get recommendations for other games you might enjoy based on user feedback.
<br><br>
If you see any WiiWare or Virtual Console titles that you like, you can go directly to the Wii Shop Channel to download them. You can also use the Nintendo Channel to transfer DS game demos wirelessly from your Wii to your Nintendo DS!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415450/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415450/FFFD001C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
