...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti en 1996, c’est le troisième épisode de la série de jeux de combat « The King of
Fighters ». La série KOF regroupe les stars des jeux SNK, tels que « Fatal Fury », « Ikari Warriors »,<br>« Psycho Soldier » et « Art of Fighting ». Elles se battent pour le titre du plus grand combattant au monde.
<br><br>
Cet épisode ajoute des changements majeurs à la série. Notamment, plusieurs types de saut (petit, moyen, grand), des esquives d’urgence avant et arrière, ainsi qu’une garde dans les airs. L’exécution des coups a été simplifiée et la puissance des projectiles abaissée. En interdisant l’abus de projectiles, ce titre marque un tournant majeur dans la série.
