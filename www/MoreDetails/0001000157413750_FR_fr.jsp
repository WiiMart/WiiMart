...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157413750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toribash est un jeu de combat en ligne qui vous permet de créer vos propres mouvements ! Usez d'une détection de mouvements ultra précise pour créer tous les mouvements que vous souhaitez. Votre imagination sera votre seule limite ! Maniez les articulations de votre personnage pour créer un impact maximal et mettez l'adversaire K-O avec des coups précis. Boostez votre physique pour user d'une vitesse et d'une puissance hors du commun et frapper vos adversaires encore plus fort, puis les attraper et les jeter au sol.
<br><br>
Vous avez envie de créer vos propres films de combat ? Vous n'avez plus qu'à vous ruer sur l'éditeur de ralentis. Vous pouvez l'ouvrir à tout moment et revoir votre combat pour savourer ce mouvement extraordinaire que vous n'avez pas eu le temps de voir dans le feu de l'action.<br><br>Texte écran en français.
<br/><br/>
Certains services en ligne proposés sur la console Wii ayant été désactivés le 28 juin 2013, les fonctions en ligne de ce logiciel utilisant WiiConnect24 ne sont plus disponibles.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413750/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157413750/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Toribash<sup>TM</sup></span></div>
</div>
