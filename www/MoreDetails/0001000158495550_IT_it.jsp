...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158495550')", "wiiSelectSound()");
...
<br><br>Il calcio del futuro! Sbaraglia i mattoncini del difensore e vai diritto in porta a segnare il tuo gol! Occhio ai difensori della squadra avversaria: faranno di tutto per intralciarti!   <br><br> 

L'editor di gioco interno offre infinite possibilità di creare livelli unici. In alternativa, affronta invece i 90 livelli di gioco e le modalità Arcade e Tornei personalizzabili.   <br><br> 

- 90 livelli di gioco e tanti divertenti mattoncini da distruggere!   <br><br>
- Caratteristiche uniche per ciascun livello livello, come ad esempio i mattoncini animati, esplosivi, difensivi e invisibili, oltre ai nemici letali in 3D! <br>  <br>
- 9 boss di fine livello avvincenti!   <br><br>
- Con l'aiuto dell'editor, potrai creare livelli personalizzati e salvare fino a 100 delle tue realizzazioni.   <br><br>
- La modalità Torneo ti consente di giocare tornei unici usando i livelli del gioco o quelli da te creati!   <br><br>
- Potenziamenti e superpotenziamenti favoriranno o ostacoleranno i tiri in porta; tra questi: laser, bombe, sfere infuocate, palle multiple e velivoli futuristici  <br><br> 
- Scoprirai tanti premi speciali e aree segrete di gioco da sbloccare!<br><br>  Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
