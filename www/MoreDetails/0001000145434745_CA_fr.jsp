...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Shock Troopers: 2nd Squad is a military-themed action game, first released in 1999.
<br><br>In order to stop a large corporation from running amok, choose one of four mercenaries and battle through by shooting, using different weapons and jumping.
<br><br>The highly praised scoring system from the previous game has been left intact, but the characters are all new.<br><br>
 Furthermore, some major changes include, the ability to operate vehicles and choosing different routes only at important junctures in the game, making the play system even easier to manage and more intuitive.</div>
  <div id="image02">
