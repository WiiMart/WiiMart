...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157414F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">„The Very Hungry Caterpillar’s ABC“ (Das ABC der kleinen Raupe Nimmersatt) ist ein Lernspiel, dass es Eltern und Kindern erlaubt, sich mit Grundkenntnissen des Englischen vertraut zu machen und zusammen Spaß zu haben.<br><br>

Das Spiel besteht aus vier Teilen, darunter ein lustiges Alphabet mit bunten Buchstaben und Bildern von Eric Carle, sowie ein Wörterbuch für Kinder im Vorschulalter, das Substantive wie Zahlen, Farben, Formen und Tiernamen enthält und einfache Verben und Adjektive wie "run" (laufen), "eat" (essen) und "big" (groß).<br><br>

Eltern können das "To The Parents"-Menü (ein Menü für die Eltern) benutzen, um die Fortschritte ihrer Kinder beim Erinnern der Vokabeln zu überprüfen.<br><br>

Die bunten Illustrationen des international renommierten Kinderbuchautors Eric Carle sind ein Spaß für die ganze Familie.
