...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495545')", "wiiSelectSound()");
...
<p>
El fútbol del futuro: destruye los bloques y los enemigos de la defensa y mete el balón en la portería para ganar. Mueve a tu jugador hacia la izquierda o hacia la derecha para golpear el balón de fútbol hacia arriba y destruir los bloques. Conseguirás mejoras especiales cuando golpees algunos ladrillos. Estas mejoras pueden ayudarte o entorpecerte.
<p>
- 90 niveles para golear y divertirse rompiendo bloques.<br>
- Niveles especiales, que incluyen bloques animados, explosivos, de escudo e invisibles y letales defensas enemigas en 3D.<br>
- 9 desafiantes enemigos especiales para batir al final de cada área.<br>
- Editor de niveles para construir tus propios niveles. Puedes guardar hasta 100 niveles creados por ti.<br>
- El modo Torneo te permite crear torneos únicos con los niveles del juego o con tus propios niveles.<br>
- Potenciadores especiales y superpotenciadores que te ayudarán (o entorpecerán) en tu camino a la portería, como láseres, bombas, balones en llamas y balones y palas múltiples.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495545/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495545/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Soccer Bashi</span></div>
</div>
