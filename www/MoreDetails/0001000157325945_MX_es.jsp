...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157325945')", "wiiSelectSound()");
...
<p>
Ahora podrás convertir tu televisión en una chimenea, dotada de unos gráficos realistas y un fuego que casi te quemará. Prepara la madera, enciende el fuego y avívalo o, si lo prefieres, selecciona la opción “automático” para tener la chimenea en pantalla mientras comes con tu familia, celebras una fiesta con tus amigos o cenas con tu pareja... ¡hay chimeneas para todas las ocasiones!</div>
  <div id="image02">
