...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C3245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Target Toss Pro: Lawn Darts es un nuevo título para WiiWare basado en uno de los juegos de jardín más tristemente famosos del país. Target Toss Pro: Lawn Darts posee cuatro tipos de lanzamientos de dardos entre los cuales elegir: Classic Lawn Darts, 501, Cricket y Poker Darts.
<p>
Classic Lawn Darts implica arrojar tres dardos a dos círculos con una diana con Bono de Punto Rojo de valores crecientes en el centro.  501 es similar al juego de dardos clásico de los bares públicos e implica arrojar tres dardos a una diana, durante 8 turnos de juego, hasta que se alcanza la totalidad de los 501 puntos (y ni un punto más). Cricket es otro juego clásico de bares públicos, de tres lanzamientos por turno, donde los jugadores compiten para alcanzar los números 15 a 20 y el centro de la diana antes que sus oponentes. Poker Darts implica el lanzamiento de cinco dardos a un tablero de 52 cartas de juego, intentando obtener la mejor mano de póquer y los puntajes más altos durante tres manos.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C3245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C3245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Target Toss Pro: Lawn Darts</span></div>
</div>
