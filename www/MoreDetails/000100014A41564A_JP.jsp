...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パワードスーツの女戦士サムス・アランを主人公とする人気ＳＦアクションアドベンチャーのシリーズ第三弾。かつてサムスが戦闘を繰り広げた惑星ゼーベスを再び舞台として、奪われた謎の生命体「メトロイド」をめぐり、宇宙海賊との死闘がはじまります。マップの途中で発見できるさまざまなアイテムを装備することにより、行動範囲と攻撃手段が次第に広がっていきます。マップの仕掛けを見抜き、どの装備を駆使して乗り越えていくか、プレイヤーの発想と操作が試されます。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーメトロイド<sup>&reg;</sup></span></div>
</div>
