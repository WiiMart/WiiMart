...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les Métroïdes, les créatures les plus dangereuses de la galaxie, sont tombées entre les mains des pirates de l'espace! Incarnez Samus Aran, la chasseuse de primes, et explorez la Planète Zèbes pour arrêter Mother Brain, le chef des pirates, et rétablir la paix dans la galaxie. 
<br><br>
Metroid, le classique original de la NES, a offert aux joueurs un mélange inédit d'action et d'exploration qui est devenu la signature de la série. Découvrez la technique de la Boule Morphing pour vous glisser dans toutes les failles et tous les recoins, ainsi que le Rayon de Glace, la Combinaison Varia et l'Attaque en Vrille.
