...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pubblicato nel 1990, NAM 1975 è gioco dal gameplay che combina elementi dei giochi d'azione a scorrimento orizzontale con meccaniche da sparatutto in terza persona. Mentre effettua spostamenti laterali nella parte inferiore dello schermo e conduce feroci scontri a fuoco con i nemici disseminati per tutta l'area di gioco, il giocatore è chiamato a impersonare un soldato delle forze speciali americane che si fa strada in un durissimo scenario di guerra. Le armi principali in dotazione sono mitragliatrici a altre armi da fuoco, granate e altro ancora. Tuttavia, grazie agli oggetti di potenziamento si possono acquisire nuove armi così come incrementare la propria velocità con lo scatto che, se usato con destrezza, ti permetterà di sopravvivere alle situazioni più impervie.<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434B50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">NAM-1975</span></div>
</div>
