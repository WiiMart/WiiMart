...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９４年にリリースされた３on３のストリートバスケットボールゲームです。プレイヤーは性質の異なる１０チームから１つを選んで、ストリートバスケ最強の座を目指すことになります。本作の大きな特徴は、気分爽快なストリートバスケが楽しめること。派手なダンクシュートが決められるのはもちろん、パスからの空中ダンクシュート、リバウンドからのダンクシュートといった具合に、簡単操作でバスケットボールの醍醐味を堪能できます。さらにゲージを溜めれば、天地を揺るがす防御不能のスーパーシュートを繰り出すことも可能。バスケットボールゲームとしての基本はしっかりおさえつつも、ゲームらしい演出もうまく盛り込んだ作品となっています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダンクドリーム</span></div>
</div>
