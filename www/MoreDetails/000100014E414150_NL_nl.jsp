...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Als Mario wordt uitgenodigd in het kasteel, ontdekt hij dat prinses Peach weer eens is ontvoerd door Bowser en zijn handlangers. Maar er is iets veranderd... Het avontuur is driedimensionaal! Ontrafel de geheimen van het kasteel en zoek naar de 120 sterren in deze onvergetelijke releasetitel voor de Nintendo 64. Super Mario 64™ wordt alom beschouwd als een van de beste videogames aller tijden, en hoewel Mario zich op talloze nieuwe manieren kan voortbewegen, is de besturing nog net zo makkelijk als altijd. Dit is bovendien het spel dat ervoor zorgde dat de analoge stick de standaard werd voor videogames.<br><br>In het spel kan worden gekozen voor Engelse, Duitse of Franse schermteksten.</div>
  <div id="image02">
