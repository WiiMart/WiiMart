...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ghosts’n Goblins fue un juego popular de galería antes de hacer su estreno en el NES en 1986. Como los otros juegos en las series, Ghosts’n Goblins presenta grandes desafíos para los jugadores que se atreven a tomar el papel de Arthur, quien se sumerge dentro del reino de demonios y monstruos para rescatar a la princesa. Elige tu arma cuidadosamente y aprovecha su fuerza para acoplarse a la situación presente. Pasa por las seis puertas que te separan de Astaroth, y enséñale una lección de caballerosidad que jamas la olvidará. Demostrando un alto nivel de tecnología para esa era, Ghosts’n Goblins presenta un único en inolvidable universo. El escenario para la aventura te espera. ¿Estas listo(a) para el reto?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146444745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146444745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ghosts'n Goblins</span></div>
</div>
