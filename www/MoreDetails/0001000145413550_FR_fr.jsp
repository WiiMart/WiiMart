...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paru en 1995, ce jeu de combat est le quatrième volet de la saga Fatal Fury. Alors que les épisodes précédents présentaient un second plan à l'écran lors des combats, ce nouvel opus en propose un troisième pour donner une autre dimension à vos duels. Passez au premier plan ou à l'arrière-plan pour esquiver les coups et surprendre votre adversaire!
<br><br>
En plus des combos, des coups spéciaux et des furies de l’épisode précédent, de nouvelles techniques cachées et des coups encore plus spéciaux font maintenant leur apparition, rendant la série plus riche et palpitante que jamais.
<br><br>
La langue du texte peut être choisie entre anglais, espagnol et japonais.</div>
  <div id="image02">
