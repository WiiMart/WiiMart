...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Play through a total of 18 Olympic events in this action sports title. Players compete in 6 categories of events that include: shooting, archery, rowing, swimming and track & field.
<br><br>
The game features an OLYMPICS mode, where you play all the events over the course of a few days, and a TRAINING mode, where you can choose individual events to play.
After practising in TRAINING mode, go for the gold in OLYMPICS mode and break world records! Depending on your play time and ability, you can enjoy the game a number of different ways.
<br><br>
Gather friends and play in competitions with up to 5 players and get even more out of this great game! (When battling with multiple players, you must connect the same number of Wii Remotes or Nintendo GameCube Controllers as the number of players. To play with five players, you will need at least one Nintendo GameCube Controller.)</div>
  <div id="image02">
