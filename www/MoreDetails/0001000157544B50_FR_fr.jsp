...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157544B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">TV Show King, le best-seller du WiiWare, est de retour ! Au programme, 8000 questions réparties en 12 catégories, de la culture générale au sport, en passant par le cinéma et la musique... sans compter les questions que vous pouvez créer vous-même ! De quoi passer des heures à jouer entre amis !<br><br>

• Amusez-vous et instruisez-vous avec des questions en images : identifiez une oeuvre d’art, placez correctement un pays sur une carte du monde...<br>
• L’éditeur de questions : créez votre propre quiz et mettez-le en ligne ! Mieux, téléchargez de nouveaux packs de questions générées par d'autres joueurs !<br>
• Des questions qui aiguiseront vos réflexes grâce à un usage original de la télécommande Wii. Par exemple, éclatez des ballons pour faire apparaître les lettres des réponses.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544B50/FFFD0001" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544B50/FFFD000D" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
