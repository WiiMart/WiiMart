...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574C5050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LONPOS is a simple yet challenging puzzle game that tests your logic and concentration, either by yourself or working with - or against - other players. The aim is to arrange differently-shaped pieces to fit inside a box by moving and rotating them with the Wii Remote so that all pieces are used.
<br><br>
In Normal Mode you battle the clock, solving puzzles as fast as you can to win points. Or take on Continuous Mode, where one false move means failure. In Cooperative Mode, take turns with a friend to complete puzzles, or try Versus Mode to battle with up to three opponents.</div>
  <div id="image02">
