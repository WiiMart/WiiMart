...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B514A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ケンテイＴＶ！　Ｗｉｉ』は、ひとりでもみんなでも最大4人まで遊べるクイズゲームです。5000問以上の豊富な問題と、Wiiリモコンを使った直感的な操作方法で、大人から子供まで誰でも楽しめるクイズゲームです。地方にまつわる様々な「へ～、なるほど」から「く、くだらない！　けど面白い！！」まで、様々な知識をゲーム感覚のクイズで楽しく遊びながら知ることができます。またＷiiリモコンを使ったミニゲームを多数用意。単なるクイズゲームに留まらない、パーティゲームとしても楽しむことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B514A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B514A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ケンテイTV！ Wii</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">みんなでご当地クイズバトル！</span></div>
  </div>
