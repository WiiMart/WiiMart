...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Los Double Dragon, Billy y Jimmy Lee, están de regreso para cobrar venganza por la pérdida de Marian. Durante su misión de eliminar a los malvados guerreros de la sombra oscura, deberán enfrentarse a nueve misiones donde confrontarán a peligrosas pandillas callejeras, ninjas y enormes luchadores mutantes.
Este par deberá abrirse paso a través de zonas de construcción, callejones y escondites bajo el agua que incluyen ¡elevadores secretos, techos con picos y afiladas garras mecánicas! ¿Podrán encarar a los enemigos y como resultado salvar al mundo?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146463545/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146463545/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">DOUBLE DRAGON<sup>&reg;</sup> II:</span></div>
</div>
