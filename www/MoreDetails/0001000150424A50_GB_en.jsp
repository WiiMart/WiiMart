...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In life, the samurai Kagekiyo defeated the shogun Yoritomo and his clan. However, their evil spirits were not completely destroyed. Now, in the world known as the Dark Side, they await the time when they can be returned to our world.
<br><br>
...
<br><br>
This action platformer features real samurai from 12th century Japan! Get ready for some intense one-on-one combat action!</div>
  <div id="image02">
