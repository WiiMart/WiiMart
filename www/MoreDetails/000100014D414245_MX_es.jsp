...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pon a prueba tu destreza en el antiguo Juego Fenicio de Columnas. Las gemas multicolores caen desde lo alto de la pantalla hacia un foso y depende de ti cómo ordenes las joyas cuando caigan en líneas de tres o más. Si las gemas alcanzan la parte superior, el juego se acaba.</div>
  <div id="image02">
