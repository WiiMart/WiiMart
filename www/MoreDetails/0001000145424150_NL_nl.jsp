...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit actie-/puzzelspel, dat in 1996 werd uitgebracht door Data East, zorgt voor knallende pret! De regels zijn eenvoudig: vang ballonnen op met de clown en gooi ze terug. Maak een rij van drie of meer ballonnen in een verticale rij om ze te laten knappen! Sommige ballonnen hebben unieke eigenschappen. Speciale ballonnen bijvoorbeeld, die er in vier verschillende kleuren zijn, laten elke ballon met dezelfde kleur knappen. Pijlballonnen laten alle ballonnen knappen in de richting waar de pijl naartoe wijst. Regenboogballonnen hebben hetzelfde effect als speciale ballonnen, maar kunnen tegen elke ballon worden gegooid, ongeacht de kleur. Tenslotte zijn er ook bubbelballonnen, die je alleen maar tot last zijn. Gebruik de ballonnen zo effectief mogelijk om geweldige kettingreacties en combo's te maken! Kies tussen de VS CPU-stand, die bestaat uit duels met allerlei komische personages, en de puzzelstand, waarin je kunt genieten van een uitdaging voor één speler. Beide standen bieden de mogelijkheid om het op te nemen tegen andere spelers, dus bereid je voor op uren speelplezier met je vrienden!
<br>
Het spel is voorzien van Engelse schermteksten.
<br>
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MAGICAL DROP Ⅱ</span></div>
</div>
