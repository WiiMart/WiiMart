...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">1989년에 발매된 액션 게임으로서 간단한 조작으로 다양한 액션을 펼칠 수 있습니다. ｢열혈 고교｣ 3학년인 쿠니오가 ｢하나조노 고교｣의 리더 리키와 힘을 모아, 갑자기 나타나 인근 학교들을 장악한 ｢레이호우 고교｣의 류이치, 류지 형제와 맞섭니다. 적을 쓰러뜨리면 코인을 얻을 수 있으며 코인을 모아 다양한 아이템을 사서 사용하면 캐릭터를 성장시킬 수 있습니다. 여러 가지 아이템과 액션을 조합하며 새로운 재미를 찾아 보세요.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146445651/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146445651/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">열혈고교</span></div>
</div>
