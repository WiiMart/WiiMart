...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157464E45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You probably know exactly what video games are and how to play them. However, if you haven’t played iFun4all’s Fish Tank yet, you can't really say that you have seen everything! Fish Tank is a combination of the very popular Match 3 genre with a puzzle game style. In this arcade-style matching game, you need to collect shoals of colored fish instead of matching gems or blocks. In order to do that, you need to build up a combination of four or more identical fish and press a corresponding button to remove them from the net. The gameplay goes horizontally—not vertically as you might be used to.
<p>
Looking for more?<br>
- 24 achievements to unlock<br>
- 24 challenging levels<br>
- Nine different power-ups to enhance your playing experience<br>
- Four player co-op mode<br>
- Two game modes: Play and Challenges<br>
