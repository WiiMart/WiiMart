...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">※2017年6月30日（金）をもって、Wiiでのサービスを終了いたします。
<br>　ニンテンドー3DS、Wii Uなどでは引き続きお楽しみいただけます。 
<br>
<br>2005年2月に創設されたYouTubeでは、何十億人もの人々がオリジナルの動画を発見、閲覧、共有しています。
<br>YouTubeは、世界中の人々が繋がり、情報を交換し、お互いに影響を与え合うフォーラムを提供し、規模を問わずオリジナルコンテンツ制作者や広告主にとっての配信プラットフォームとして機能しています。
<br>
<br>YouTube および YouTube ロゴは、Google Inc.の商標または登録商標です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
