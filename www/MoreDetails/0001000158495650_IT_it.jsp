...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158495650')", "wiiSelectSound()");
...
<br><br>Pensi di poter essere tu la prossima star della musica? Allora, non aspettare oltre: con Mix Superstar hai tutti gli strumenti che ti servono! Crea, mixa e registra i tuoi capolavori musicali, senza problemi di copyright, usando la tua console Wii. Scoprirai più di 1.000 loop di musica dance, hip hop e techno con una varietà di strumenti come batteria, basso, sintetizzatore, chitarra, nonché delle tracce vocali. 
<br><br>
Dopo aver creato la tua hit, non potrai non farla conoscere! Mix Superstar ti permette di esportare le tue creazioni musicali e di scaricarle sul tuo computer per averle sempre con te. Puoi anche usare il WiiConnect24 per inviare i brani ai tuoi amici Wii e collaborare nei mix!
<br><br>
Sono inclusi sia il microfono Logitech USB che l'accessorio Wii Speak per registrare la tua voce.
<br><br>
Il Pay & Play della Nintendo Wi-Fi Connection ti permette inoltre di migliorare la tua esperienza di creatore musicale grazie a numerosi pacchetti extra.
<br><br>
Allora, che aspetti? Comincia a farti sentire!</div>
  <div id="image02">
