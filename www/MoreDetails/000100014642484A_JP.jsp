...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">現在も高い人気を誇る「悪魔城ドラキュラ」シリーズの第一弾。かつてドラキュラ伯爵を封じた一族の末裔「シモン＝ベルモンド」が、一族に伝わる聖なるムチを手
に単身悪魔城に乗り込み、短剣や聖水などのさまざまなアイテムを駆使してステージをクリアしていくアクションゲームです。城の最上階にいる、復活した魔王ドラ
キュラ伯爵を打ち倒すのが目標。制限時間内にブロックをクリアできなかったり、床の穴から落ちたり、敵にやられてＬＩＦＥがなくなるとゲームオーバーです。ゲ
ーム内容はもちろん、不気味な悪魔城のグラフィックや雰囲気を盛り上げる音楽も発売当時話題となりました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">悪魔城ドラキュラ<sup>&reg;</sup></span></div>
</div>
