...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ドンキーコングシリーズの３作目は、前作までのアクションとは違い、シューティングゲームです。
プレイヤーは主人公のスタンリーを操作し、フラワーパークに出現したドンキーコングや昆虫たちをスプレーを使って撃退します。
スプレーを当ててドンキーコングを上まで押し上げるか、一定の数の昆虫たちを退治すればステージクリアです。
一回だけ使用でき射程や威力がパワーアップする「パワースプレー」をうまく活用し、ドンキーコングや昆虫たちから花を守ってください。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645554A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645554A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドンキーコング<sup>&reg;</sup>３</span></div>
</div>
