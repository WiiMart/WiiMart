...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気シューティングゲーム『ギャラガ』の続編です。自機「ファイター」を操作して次々と襲いかかるギャラガ軍団をミサイルで撃退し、すべての敵を倒すとステージクリアです。画面上段に待機するボスギャラガが出すトラクタービームを受けると、ファイターは敵の捕虜となり奪われてしまいます。捕虜を連れて飛行するボスギャラガを倒すとファイター同士が合体し、２機合体では２発同時攻撃が可能なデュアルファイター、３機合体で最強のトリプルファイターとなって戦うこともできます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ギャラガ’88 <sup>&reg;</sup></span></div>
</div>
