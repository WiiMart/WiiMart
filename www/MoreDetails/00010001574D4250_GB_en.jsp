...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">What is MaBoShi: The Three Shape Arcade? It’s one game but it’s also three. It’s simple to play, yet deceptively deep.
<br><br>
...
As some of the Wii console’s online services were discontinued on 28th June 2013, online features for this software, using WiiConnect24, are no longer available.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4250/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
