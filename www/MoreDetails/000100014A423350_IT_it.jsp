...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pubblicato per la prima volta nel 1998 per Super Nintendo, questa simulazione di fattoria è il primo gioco della ormai leggendaria serie di Harvest Moon. Avendo a disposizione solo pochi campi e un paio di stalle vuote, dovrai costruire il tuo ranch per poter realizzare il tuo obiettivo finale: il matrimonio!
<br><br>
Dedicati a diversi tipi di colture, acquista o alleva mucche e pollame, fai di tutto per realizzare un profitto vendendo i tuoi prodotti. Potrai corteggiare una delle tante ragazze del villaggio per farla tua sposa. Ma per convincerla a trasferirsi a casa tua dovrai prima lavorare sodo per ampliarla e renderla meno modesta!
<br><br>
Potrai assistere ad eventi speciali, godere delle festività annuali, ammirare le colture e i paesaggi che mutano al variare delle stagioni e riscoprire, con un cane fedele al tuo fianco, quanto sia divertente e appassionante la vita dei campi!
<br><br>
Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A423350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A423350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Harvest Moon</span></div>
</div>
