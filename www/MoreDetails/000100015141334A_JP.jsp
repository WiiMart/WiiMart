...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">惑星ひとつが実験室になる壮大なスケールのシミュレーションゲームです。プレイヤーは自らの手で生命を育み、繁殖させ、知的生命体が誕生するように進化を促します。彼らが築く文明をさらに発展させ、最終的には他の惑星へ移住する「エクソダス」を実行するように導いてください。ゲームの基本は、地殻や大気などのパラメータを調節し、生物にとって快適な環境を整えること。バクテリアや原始動物といった小さな生命が繁殖して数を増やし、やがてさまざまな生物へと進化していきます。一度に大きくパラメータを変えるのは失敗の元。生物への影響を見ながら、少しずつ調節するのが成功のコツです。また、地球と異なる環境の火星や金星といった惑星も用意されており、そのままでは生物の住めない過酷な環境の改造にチャレンジすることもできます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">シムアース</span></div>
</div>
