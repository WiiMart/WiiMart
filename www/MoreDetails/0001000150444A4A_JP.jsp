...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気２Ｄ対戦格闘ゲーム「ストリートファイターⅡ」シリーズのＰＣエンジン版で、ボーナスステージやサウンド効果など、アーケード版の迫力が忠実に再現されています。プレイヤーは「四天王」を含む総勢１２名の中から好きなキャラクターを選び、真の格闘家をめざして果てしなき死闘を繰り広げます。それぞれのキャラクターが持つ必殺技、連続技（コンボ）やキャンセルといったテクニックを駆使し、世界各地で待ち構えているライバルたちとの戦いを勝ち抜いていきます。また、プレイヤー同士で対戦する「Ｖ．Ｓ．ＢＡＴＴＬＥ」モードでは、ハンディキャップを設定することも可能で、それぞれの腕前にあわせた設定をおこなえばより白熱した対戦を楽しむことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150444A4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150444A4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ストリートファイター<sup>&reg;</sup>Ⅱダッシュ</span></div>
</div>
