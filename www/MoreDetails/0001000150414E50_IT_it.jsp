...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Military Madness è una simulazione militare futuristica che ti vedrà impegnato in una serie di battaglie ambientate sulla Luna.
Non serve essere un esperto di giochi di strategia per divertirsi con questo titolo: le semplici regole di gioco permettono a chiunque di cimentarsi con Military Madness.
Leggi le istruzioni nella schermata del titolo e comincia a combattere!
Analizza la situazione sul campo di battaglia, studia le conseguenze delle tue decisioni e impartisci gli ordini! L’azione di gioco a turni richiede che tu valuti attentamente le tue mosse prima di eseguirle.
Inoltre, le unità che partecipano al combattimento sono già decise, così potrai concentrarti esclusivamente sul comando delle forze in campo!
Sfrutta a tuo vantaggio la conformazione del terreno, circonda il nemico e conquista la vittoria!
Combatti in 16 livelli diversi e poni fine alle malvagie ambizioni del nemico!
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414E50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414E50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Military Madness<sup>TM</sup></span></div>
</div>
