...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574E3945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Los militares están de vuelta para buscar a una nueva generación de reclutas!  La clásica serie de estrategia con juego basado en turnos Military Madness, también conocida como Nectaris, explota en WiiWare. Con una renovada artillería gráfica, una nueva unidad de comando, modo de juego en equipo en línea versus multijugador, ¡este es el juego más loco de la serie!
<p />
• Modo multijugador en línea para 4 personas: Coordina estrategia o búrlate de tus enemigos en equipo o en modo multijugador para hasta 4 personas.<br />
• Una unidad totalmente nueva: Comandantes: Elige a un comandante para que lidere tus fuerzas en modo multijugador y elige entre 20 habilidades únicas.<br />
• Múltiples vistas de comando: Planifica tu estrategia en la vista de mapa y observa como se desarrollan las gloriosas batallas con acción de cámara cinematográfica.<br />
• Pizarras de puntuación con estadísticas detalladas: ¡Aumenta tu rango marchando por las pizarras en tu misión para probar que eres el mejor general!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E3945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E3945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Military Madness: Nectaris</span></div>
</div>
