...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157454D45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Use your head and solve the puzzles to escape the room Milo is in! Play alone or with family and friends to solve this puzzling adventure game! Today is Milo’s birthday and he gets an amazing present from his dad...a room of puzzles that he likes to solve. Milo needs to solve all the puzzles to escape from the room. So use the Wii Remote controller and SHAKE!! PUSH!! TWIST!! to interact with, collect, and use items you find in the game. There is plenty to solve using all of the Wii Remote controller’s tricks and treats. See if you have what it takes to figure it all out.</div>
  <div id="image02">
