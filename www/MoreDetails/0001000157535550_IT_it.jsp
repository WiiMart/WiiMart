...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157535550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In un mondo governato dalla legge della giungla, stai per iniziare una battaglia per il futuro. Superando i vari livelli, il tuo personaggio si evolverà e cambieranno anche le tue armi e capacità di sparo.<br><br> All'inizio sei disarmato e puoi solo lanciare oggetti, inizierai poi ad utilizzare armi e sperimentare vari tipi di proiettili. È possibile anche giocare in modalità cooperativa per 2 giocatori.<br><br> I comandi sono semplici! Muovi il tuo personaggio con il Control Stick, sposta il mirino con il telecomando Wii e, schivando gli attacchi dei nemici, centra l'obiettivo. Essere colpiti dai proiettili o toccati dai nemici vicini sono considerati degli errori. Per ogni errore perderai uno dei cuori indicati nella parte inferiore dello schermo e, se commetti un errore quando non hai più cuori, avrai perso la partita.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157535550/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
