...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Es el año 2112. La tierra ha sido invadida por las fuerzas del mal. Debes luchar contra los invasores mientras corres en tu motocicleta de un sector a otro en busca de sobrevivientes. Siente la increíble sensación de velocidad cuando pasas a los malvados Quadrunners y zigzagueas entre rocas peligrosas, derrames de aceite y otros obstáculos en el camino. Si quieres un desafío diferente, crea tu propio circuito en el modo de “diseño” usando distintas vueltas, curvas, y rectas disponibles. Recuerda, tú eres la única esperanza de la tierra--¡Eres Mach Rider!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mach Rider<sup>&reg;</sup></span></div>
</div>
