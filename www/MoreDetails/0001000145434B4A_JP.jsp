...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９０年にリリースされた三人称視点のガンシューティング＋ベルトスクロールアクション。プレイヤーは苛酷な戦場を駆けるアメリカ軍特殊部隊の兵士となって、画面の手前を左右に移動しながら、画面奥の敵と激しい銃撃戦を繰り広げることになります。基本的にはマシンガンなどの銃器や、手りゅう弾などを投擲しつつ敵と戦いますが、アイテムから新しい武器を獲得したり、ダッシュによる高速移動やピンチ回避を上手く使うことで、派手な戦いを楽しめます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
