...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In a world where music is the language of the people, an evil warlord from the north arrives and captures the castle. The queen is imprisoned deep within the castle, and the world's musical instruments are taken and hidden away!
<br><br>
...
<br><br>
And look out for Music Boxes - whenever Milon finds one, he will be transported to a bonus stage! Each music box you find will add a layer to the music in the bonus stages. Try to grab all seven music boxes to create a performance worthy of this epic game!</div>
  <div id="image02">
