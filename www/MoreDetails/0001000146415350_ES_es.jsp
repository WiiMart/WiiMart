...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Libera el planeta Xevious de los tiranos de Gamp! A tu disposición está la nave Solvalou y sus dos armas, el  zapper  para los enemigos aéreos y el  blaster  para objetivos de tierra.
Xevious es un matamarcianos de scroll vertical. En una época en la que estos juegos se desarrollaban sobre fondos negros, Xevious introdujo escenarios móviles con ríos azules y bosques, revolucionando el género e influenciando obras posteriores. ¿Qué son los Gamp? ¿Y Xevious? Disfruta hoy de un mundo majestuoso y lleno de secretos con este legendario videojuego.<br><br>

En el modo 2 jugadores, ambos jugadores se alternan: cuando el jugador 1 es derribado, el turno pasa inmediatamente al jugador 2, y así sucesivamente.<br>Para el modo 2 jugadores son necesarios dos mandos.
