...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">リアリティあふれる世界観と、魅力的なキャラクター達による人間ドラマが人気の本格的推理アドベンチャー、「神宮寺三郎」シリーズの第二弾です。物語の舞台はネオンきらめく新宿から、異国情緒漂う横浜へと移り、さらにスケールアップした事件に神宮寺が挑みます。行方不明になった領事館員エバ・クリスティーナの捜索を進める神宮寺は次第に巨大な陰謀の波へと飲み込まれていきます。今回からは神宮寺の助手である御苑洋子も本格的な捜査に参加し、二人の活躍はその後のシリーズに受け継がれます。美しき行方不明者エバと背後にうごめく陰謀とは？神宮寺は事件を解き明かし、犯人を突き止める事ができるのでしょうか。決して色あせることのない、本格ハードボイルドの世界観と、人間模様が織りなすドラマをお楽しみください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
