...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Originally titled Meta Fight in Japan, this groundbreaking game was given a story makeover and released as Blaster Master™ in the United States, where it received strong critical acclaim and fan raves. Blaster Master™ is still often listed on magazine charts as one of the top 25 NES games ever made.  The sublime blend of side-scrolling shooting/platforming mixed with overhead perspective action/shooting areas is just as addictive now as it was then.<p>
The New York sewers were never like this! You've fallen down a hidden manhole into a world of creatures so terrifying they'd scare the rats away. You can panic and perish, or blast your way through an endless maze of tunnels, searching for the secret passages to your escape. And, that's the easy part. Because the Masters of the Caverns lay waiting - prehistoric creatures so powerful, so gigantic, they literally fill your screen! So load your arsenal and get ready for Blaster Master™.</div>
  <div id="image02">
