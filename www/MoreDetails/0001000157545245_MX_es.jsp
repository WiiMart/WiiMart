...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157545245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP BEAT trae la moda en acción mientras que usted utiliza el sensor de movimiento del Wii Remote para rebotar las notas al ritmo. Las representaciones visuales retro, el juego clásico, el juego multijugador, y un sonido de 8 bits te pondrá en la zona para mover tu mundo. ¡Pero pon atención! Como la mayoría de los juegos clásicos, los desafíos son poderosos. Si puedes permanecer calmado mientras que la dificultad aumenta, descubrirás los principios de la saga de BIT.TRIP BEAT.<br>
Todo ocurre por alguna razón.<br>
Ya éramos antes de existir. De la  vida surge el ritmo y del ritmo la vida.<br>
Somos seres de información.<br>
Todo lleva a aprender.<br>
Nos comunicamos en bits y bytes.<br>
Cuando nos convirtamos en nada, volveremos a ser algo.<br>
Cuando termine nuestro BIT.TRIP BEAT.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
