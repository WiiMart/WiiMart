...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lanzado en 1990, Ninja Combat es un juego de acción de desplazamiento lateral. El jugador ha de manejar a los ninjas Joe (en el modo para un jugador) y Hayabusa (en el modo para dos jugadores) y librar una batalla contra un grupo de ninjas malvados, los “Kage Ichizoku”, que se encuentran en su fortaleza, la “Ninja Tower” (Torre Ninja), ubicada en lo alto de una gran ciudad en un futuro cercano.
Además de servirse de los ataques normales, saltos, movimientos especiales y el ataque ninja que lanza un golpe demoledor a todos los enemigos en pantalla, el jugador deberá aprovechar al máximo las armas y elementos abandonados que pueda recuperar en su avance.
Además, a medida que el jugador progrese en el juego, se encontrará con aliados, tales como Musashi, Kagero y Gembu, lo que le permitirá elegir a diferentes personajes en cada etapa. Esta versión permite jugar simultáneamente a dos jugadores.
<br><br>
