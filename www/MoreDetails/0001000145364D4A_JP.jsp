...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">全米が熱狂したアメリカンフットボールゲームです。レシーバーとランニングバックをそれぞれ分担してプレイします。相手につかまれたらコントローラをすばやく動かして振りほどくなど、アクションとしても楽しめます。１人プレイから、２人対２人の４人同時プレイまで可能。相手チームの隙をつき、プレイヤー同士のパスがつながる瞬間は爽快で、協力対戦の醍醐味が味わえます。また、チーム分けや難易度などの設定変更も可能です。当時テクモボウル専用の巨大２画面筐体を用いていたこのアーケード版は、大きくえがかれたキャラクターなど迫力のグラフィックで人気を博しました。<BR><BR>詳細は、<Center>
http://www.tecmo.co.jp/product/vca/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145364D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145364D4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">テクモボウル<sup>TM</sup></span></div>
</div>
