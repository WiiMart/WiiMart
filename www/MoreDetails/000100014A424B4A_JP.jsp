...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９４年にスーパーファミコンで発売されたロールプレイングゲーム「ブレス オブ ファイア～竜の戦士～」に続く二作目。個性豊かなキャラクター、広大な世界、シャーマンと呼ばれる巫女との合体や竜変身、迫力あるクオータービューでの戦闘がプレイヤーを魅了します。前作の主人公とその仲間たちが、邪悪なる女神ミリアの野望を打ち砕き、世界に平和を取り戻してから５００年後の世界が舞台。ある日突然父と妹が失踪し、さらに村人が自分達のことを忘れてしまうという怪奇な事件から天涯孤独の身になった少年リュウは、教会で出会った同じ境遇の孤児ボッシュと共に村を抜け出し、事件の謎を解くために旅立ちます。旅の途中、洞窟で遭遇する邪悪な魔物が残した「使命の子」の言葉の意味をめぐって、仲間たちと共に壮大なストーリーを楽しめます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424B4A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424B4A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブレス オブ ファイア<sup>&reg;</sup> Ⅱ</span></div>
</div>
