...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年にアーケードゲームで登場し、絶大な支持を得た忍者アクションゲームの傑作です。一跳びで大木の上まで到達できる脅威的なジャンプで、森の中や城内を縦横無尽に移動し、刀と手裏剣で次々と敵を倒していく爽快感あふれる忍者アクションが楽しめます。プレイヤーは、伊賀の忍“影”となって、魔性の者“雪草妖四郎”に囚われた“霧姫”を助けるために魔城へと向かいます。<BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">影の伝説<sup>&reg;</sup></span></div>
</div>
