...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juego de lucha publicado en 1994 Secuela del título FIGHTER'S HISTORY, juego de lucha publicado en 1994. Esta vez trece grandes maestros de las artes marciales vuelven a medir sus fuerzas en el torneo Great Grapple. En esta edición encontrarás un nuevo sistema de puntos débiles distintos para cada personaje, podrás manejar a los jefes finales, Clown y Karnov, y además tendrás acceso a un sinfín de nuevas técnicas asombrosas. Reuniendo ciertas condiciones, podrás batirte en una fase extra contra Ox, el toro de Karate Champ, primer juego de lucha de Data East.</div>
  <div id="image02">
