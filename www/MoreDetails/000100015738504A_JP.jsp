...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015738504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">あの大ヒット玩具『∞プチプチ』がWiiウェアで登場！<BR>Wiiリモコンの音と振動でまるで本当の『プチプチ(R)』をつぶしたような感覚があなたの手に！<BR><BR>
■毎日プチプチ、ストレス解消<BR>メインのマインド診断（しんだん）モードでは、簡単なストレス診断によって、その時のあなたの気分にあったプチプチを紹介します。<BR><BR>■プチプチは全40種以上<BR>いくらをプチプチする『いくら丼プチプチ』、なつかしのゲームを再現した『ゼビウスプチプチ』、女の子のセリフが楽しめる『ツンデレプチ』や、豪快な『しぼりプチ』まで……<BR>色々なプチプチが楽しめます！<BR><BR>■リズムに合わせてつぶそう<BR>プチプチは単につぶすだけではありません。<BR>リズムに合わせてつぶしていくと連鎖（れんさ）が発生！<BR>たくさんのプチプチが一気につぶれて気分爽快です！<BR><BR>■ふたりでもプチプチ<BR>プチプチはふたりでいっしょにつぶせます。<BR>『陣取り対戦』ではバトルも可能！<BR><BR>■公式サイトURL<BR>http://b.bngi-channel.jp/putiputi/</div>
  <div id="image02">
    <img src="/oss/ccs/000100015738504A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015738504A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おうちで∞プチプチWii</span></div>
</div>
