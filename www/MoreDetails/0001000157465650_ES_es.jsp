...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157465650')", "wiiSelectSound()");
...
<br><br>
Football Up! es un divertido juego de fútbol donde tendrás un control total de cada acción de tus jugadores:
<br><br>
¡Controla el balón, dribla y dispara dándole efecto al balón para batir al portero rival!
<br><br>
Demuestra tu habilidad y realiza pases cortos, largos y disparos a portería. Puedes controlar la altura, efecto y fuerza del disparo.
<br><br>
¡Conviértete en un maestro del fútbol control!
<br><br>
Cada país participante está representado por su selección nacional. Con el editor integrado podrás crear tu propio equipo, elegir el color de la equipación y lo más importante, jugar con los Mii™ que tengas creados previamente en el Canal Mii de tu consola Wii.
<br><br>
Características:<br>
...
- ¡Juega la Copa del Mundo!<br>
- Opción Multijugador de hasta 4 jugadores.
