...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157453950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Alien Crush Returns es la encarnación definitiva del popular clásico de los pinball de Turbografx, Alien Crush. Luciendo innovadoras características en el juego y el control, ¡ésta es una
experiencia para tu
Wii que no querrás
perderte!<br><br>Con toda la simplicidad de una bola rodando y la emoción de la aletas moviéndose de un juego de pinball estándar, Alien Crush Returns tiene todos los elementos visuales y digitales que podrías esperar en un videojuego, incluyendo grotescos e impactantes campos de juego además de trucos únicos con las Action Ball que redefinen la diversión y la emoción del pinball.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157453950/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157453950/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ALIEN CRUSH RETURNS</span></div>
</div>
