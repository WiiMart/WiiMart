...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157353445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Have fun with the entire family and compete in three different play modes! 5 Spots Party is a game of skill for all ages based on the popular game of finding five differences. The goal is to find the greatest number of differences in the pictures shown. In the party modes, you must compete with other players and find as many mistakes as possible. In the 1-Player mode, you must find the differences before time runs out in order to beat the game’s highest scores. How far do you think you can go?</div>
  <div id="image02">
