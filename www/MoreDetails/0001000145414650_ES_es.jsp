...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Métete en la piel de Blue, un héroe que debe salvar el planeta Raguy de la invasión de los Daruma, que están contaminado el planeta y han convertido a sus habitantes en esclavos. Ese es el argumento de este juego de acción de desplazamiento horizontal que salió a la venta en 1991.
<br><br>
Blue no solo cuenta con un amplio abanico de armas, como bombas y bumeranes, sino que tiene la habilidad de cambiar de tamaño a voluntad. Otra característica que lo convierte en único y aumenta el tiempo de juego es la división de los niveles: si quieres ver todos los niveles y presenciar toda la destrucción que causan los Daruma en el planeta Raguy, tendrás que completar diferentes combinaciones de niveles.
<br><br>
Con personajes simpáticos, gráficos coloridos y una banda sonora irresistible, Blue's Journey es una muestra divertida de los juegos de plataformas clásicos.
<br><br>
