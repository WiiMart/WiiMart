...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157524750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rage of the Gladiator ist ein Kampfspiel in einer Fantasywelt, bei dem du in der Arena um dein Leben kämpfen musst.<br>
Features:<br>
- Eins der schönsten WiiWare-Spiele aller Zeiten! Umwerfende 3D-Grafiken, Animationen, Schatten, Licht- und Spezialeffekte.<br>
- Komplett vertont: Jeder Endgegner hat seine eigene Persönlichkeit und wird dich gnadenlos verspotten!<br>
- Ausgefallene Finishing-Moves: Beschwöre einen Feuermeteor oder einen Tornado oder verwandele dich in einen Koloss, der zehnmal größer ist als du!<br>
- Charakteranpassung: Spezialisiere dich innerhalb der Fertigkeitenbäume – Offensive, Defensive oder Magie – um neue Kräfte zu erhalten!<br>
- Epische Musik: Freue dich auf mitreißende Meisterwerke des legendären Komponisten Sean Beeson!<br>
- Hoher Wiederspielwert: Spiele das Spiel durch, um den Challenge-Modus freizuschalten, in dem Endgegner neue
Fähigkeiten haben und so eine neue Herausforderung darstellen.<br>
