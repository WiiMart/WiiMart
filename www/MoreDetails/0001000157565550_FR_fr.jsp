...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157565550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Accompagne Mr. Bumblebee lors de sa première grande aventure !<br><br>

Fonce à toute vitesse sous des fleurs gigantesques, la foule t’applaudit depuis les tribunes. Attention, une cascade ! Vite, un virage rapide à gauche pour ne pas te mouiller les ailes ! Aïe, revoilà Junky Punkie, le plus énervant des moustiques ! Heureusement que tu viens de remplir ta jauge de turbo qui te permet de voler beaucoup plus vite que les autres insectes !<br><br>

Caractéristiques :<br>
	•	Adapté à tous les âges grâce à la vitesse de jeu réglable !<br>
	•	Magnifiques graphismes dessinés à la main !<br>
	•	Peut se jouer seul ou à maximum quatre coureurs en même temps !<br>
	•	Quatre modes de jeu différents et six parcours!<br><br>Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157565550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157565550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mister Bumblebee </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Racing Champion</span></div>
  </div>
