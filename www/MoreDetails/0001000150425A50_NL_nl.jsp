...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dit grappige actiespel reis je met de twee prutsende detectives J.J. en Jeff door zes verschillende levels. Op een dag bereikt hen het verzoek een zaak aan te nemen die vereist dat zij "een vermogend man, die ontvoerd is, bevrijden". Kies voor een van de twee personages en begeef je op weg om de zaak op te lossen en je partner te slim af te zijn.
<br><br>
Elk level bestaat uit vier gebieden, waarin vijanden – en de incompetentie van je partner – proberen je van je doel af te houden. In elk gebied kun je diverse voorwerpen laten verschijnen door op bepaalde plaatsen rond te trappen. Spring met je spuitbus in de hand naar je einddoel!
Vergeet niet onderweg je energie aan te vullen tijdens grappige, surreëele sketches in de geheime kamers.
...
<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150425A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150425A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">J.J. &amp; JEFF</span></div>
</div>
