...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157475050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Zenquaria turns your TV into a living aquarium. Simply relax by watching the fish, discover fish-keeping facts using the Encyclopaedia, or even swim with the fish using your Mii!
<br><br>
...
<br><br>
View your aquarium from a variety of camera angles to get a good look at your fish (including a fish’s eye view) and select a fish to view facts such as its scientific name and habitat. Finally, dive in with your Mii to feed the fish, or hunt for trivia icons to discover fish-related facts.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157475050/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
