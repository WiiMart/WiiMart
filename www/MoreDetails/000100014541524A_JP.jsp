...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">３Ｄ視点でプレイするゴルフゲーム。プレイヤーは能力の異なる６名のゴルファーからひとりを選んで、日本、アメリカ、オーストラリア、ドイツの計４コースを回ります。ゲームモードは、１８ホールを回ってトータルスコアで競う「ストロークプレイ」と、ホールごとに勝敗を決め最終的な勝ち星数で決着をつける「マッチプレイ（２Ｐ対戦専用）」の２種類があり、お友達と一緒にラウンドして腕を競うこともできます。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ビッグトーナメントゴルフ</span></div>
</div>
