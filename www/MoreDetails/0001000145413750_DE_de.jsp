...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aus der erstmals 1996 veröffentlichten Serie „Samurai Shodown” erscheint nun der vierte Teil. Wesentliche Veränderungen wurden aus dem Vorgängerspiel “Samurai Shodown 3“ übernommen, wie das System RAGE EXPLOSION und die COMBO-ATTACKEN. Damit werden deine Zweikämpfe noch spannender und abwechslungsreicher. Außerdem ändert sich der Abspann je nach Länge deiner Spieldauer und um ein Happy-End zu sehen musst du konsequent gegen die Zeit ankämpfen ... Neben 17 bekannten Samurai, die auch dieses Mal ihre Fertigkeiten unter Beweis stellen werden, kannst du mit den zwei neuen Charakteren Kazuki Kazama und Sogetsu Kazama spielen.<br><br>Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
