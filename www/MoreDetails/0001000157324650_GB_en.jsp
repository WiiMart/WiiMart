...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157324650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Patients who have completed a rehabilitation program know the problem: Lots of exercises which are necessary and important for the healing process are often monotonous and boring. Especially when we're talking about bodily poise and balance, there's hardly any variation.<br />
This is where Physiofun Balance Training comes in. The program helps make balancing exercises entertaining.<br /><br />
Physiofun Balance Training is also excellently suited for post-rehab care of patients that visited physiotherapists and private rehab centres. Instead of bringing home expensive specialised equipment, important exercises for patients recovering from, for example, foot, knee or hip complaints can now be carried out in a fun and entertaining way.<br /><br />
Physiofun Balance Training brings together lots of functions: Together with meaningful tests such as measuring the body's centre of gravity and balance, the 'Physio Mode' offers the opportunity to create training plans for physiotherapeutic exercises.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324650/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324650/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
