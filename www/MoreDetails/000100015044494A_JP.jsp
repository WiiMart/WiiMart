...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードゲームから移植された人気プロレスゲームです。個性的な８人の「荒くれども」から好きなレスラーを選び試合開始です。果敢に技を仕掛けて相手の体力を奪い、３カウントピンフォールやギブアップ、リングアウトを狙います。このゲームでは「パワー」が重要なポイントで、組み合った状態で「技をかけるとき」や「技を返すとき」はパワーの強い方が有利となります。さらに「関節技のかかり具合」をはじめ、「体力の回復スピード」もパワーが影響するので、あらゆる局面で十字ボタンをガシャガシャ入力し、パワーゲージを上昇させてください。多人数プレイにも対応しており、シングルマッチでの２人対戦や、コンピュータを相手に協力して勝ち抜き戦を行うタッグマッチ、２人ずつに分かれて４人で戦うタッグマッチも楽しめます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015044494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015044494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">チャンピオンレスラー<sup>&reg;</sup></span></div>
</div>
