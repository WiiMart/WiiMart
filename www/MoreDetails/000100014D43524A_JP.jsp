...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードで人気を呼んだアクションシューティングゲームのシリーズ第二弾です。プレイヤーは合衆国傭兵部隊「ウルフ＝フォース」となって、群がる敵を倒しながら
ラストに待ち受ける巨大兵器と一騎打ちを繰り広げます。ショットガンやバーナーなど新たに追加された豊富な武器やおなじみのメガクラッシュ、乗り物に乗っての移動・攻撃など多彩なアクションが可能です。メガドライブ版では、Ｒ国の革命派勢力に捕らわれた前大統領を救出する全７ミッションの「アーケードモード」に加え、
能力の異なる５人の兵士を成長させながら弾道ミサイル基地をめざす全８ミッションの「オリジナルモード」を収録しており、プレイ感覚の異なる２つのゲームが楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">戦場の狼<sup>&reg;</sup>Ⅱ</span></div>
</div>
