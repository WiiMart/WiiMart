...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157475645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Groovin' Blocks es una adictiva mezcla de rompecabezas, acción y sincronía musical. Sigue el ritmo de la música para aumentar la puntuación e intenta conseguir "Superbeats" (Súper ritmos) para duplicar el multiplicador. ¡Consigue la puntuación más alta en cada uno de los 27 niveles y recibe estrellas con las que podrás desbloquear 15 niveles de potenciadores! Groovin' Blocks dispone de 3 niveles de dificultad: fácil, intermedio y difícil. Juega con tus amigos en modo cooperativo o contra ellos en el modo cara a cara. ¡En el modo cara a cara, los potenciadores tienen el efecto contrario y atacarán a tu oponente! Enfréntate a todo tipo de rivales y disfruta de su sistema de juego similar al hándicap del golf.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157475645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157475645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Groovin' Blocks</span></div>
</div>
