...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">요시가 처음으로 주인공이 된 기념할 만한 소프트. 위에서 내려오는 캐릭터들을 보고 같은 캐릭터가 쌓이도록 하여 없애 나가는 게임입니다. 아래 알 조각 위에 굼바와 부끄부끄같은 친숙한 캐릭터들을 쌓은 후 위 알 조각을 쌓는 등 단순한 조작으로 즐길 수 있으며, 알 조각 사이에 캐릭터를 끼워서 없애면 알에서 요시가 깨어나기도 합니다. 「위 알」, 「아래 알」을 능숙하게 쌓아서 고득점을 올리거나 대전 모드에서 상대방을 공격해 보세요.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413754/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413754/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">요시의 알<sup>TM</sup></span></div>
</div>
