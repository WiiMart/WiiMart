...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">伝説の＜大破壊＞によって、文明が崩壊した近未来。そんな荒廃した世界で、過去の文明の遺産を食いつぶしながらも、懸命に生き抜く人々。その中に強力な戦車を駆り、モンスターどもをなぎ倒す「モンスターハンター」と呼ばれる賞金稼ぎたちがいました。
「モンスターハンター」を夢見る主人公は父親の反対を押し切り、夢をかなえるべく家を飛び出しました。広大な世界で少年はどのような出会いを果たし、夢をかなえて行くのでしょうか？世界最強の「モンスターハンター」を夢見る少年の冒険が始まろうとしています。<BR>１９９１年にファミリーコンピュータで発売されたＲＰＧ『メタルマックス』の感動をそのままに、より遊びやすい要素を追加してスーパーファミコン用ソフトとしてリメイク。自由度の高いゲームシステムとドラマチックなストーリーは健在です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A45494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A45494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルマックス<sup>&reg;</sup> リターンズ</span></div>
</div>
