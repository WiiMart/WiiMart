...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157534D45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Forget about being healthy! Here's a game that celebrates eating, getting fat, and fighting! Hold the Wii Remote controller horizontally, and tilt it left, right, up or down to perform all kinds of lifts and throws just like in real sumo. There are also hidden moves like suplexes and scrapbusters thrown in for fun. Use all the moves you learn in tournaments around the world to reach the peak of sumo and become a yokozuna! In ONE PLAYER mode, play eating or sparring minigames to make your wrestler stronger and change how they look. You can also use your own Mii character faces on your wrestlers! In TWO PLAYER mode, take on another person using default wrestlers or the wrestlers that you have created. Chow down! Bulk up! Fight on to become the strongest sumo wrestler ever in Eat! Fat! Fight!</div>
  <div id="image02">
