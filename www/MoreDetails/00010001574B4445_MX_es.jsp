...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B4445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pirates: The Key of Dreams es un frenético juego de acción en el mar. Navegue por el Caribe lanzando cañonazos, saqueando botines, pasando bloqueos y, por último, combatiendo contra el propio Barbanegra. El jugador obtiene el control de un Capitán de la Marina enviado en secreto como despiadado pirata para buscar y salvar “The Key of Dreams”, un valioso y peligroso artefacto maldito. Rescate náufragos para reforzar la tripulación de su barco, obteniendo mejoras en el rendimiento de su navegación, armamento, integridad estructural y habilidades cartográficas. Recoja armas cada vez más potentes incluyendo misiles, minas, disparos en cadena, espadas dentadas y un lanzallamas para liquidar a sus enemigos. Juegue contra tres de sus viles amigos o contrincantes IA en batallas campales de multijugador en 35 niveles y en siete ambientes diferentes. Elija entre diferentes tipos de embarcaciones la que se adapte mejor a su estilo de juego. ¡Juegue en modo turbo si es un pirata de verdad!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B4445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B4445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
