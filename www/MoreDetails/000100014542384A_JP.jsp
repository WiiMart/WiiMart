...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９７年にリリースされたミリタリーアクションゲームです。プレイヤーは国際的に活躍する傭兵として、悪の組織ブラッディスコーピオンによってさらわれてしまったジョージ博士とその孫娘の救出作戦に参加します。個性的な８人の傭兵から３人を選択してチームを編成して戦うチームバトルモードと、８人の傭兵から一人を選んで単独で出撃するロンリーウルフモードの２種類のゲームモードを搭載。さらにゲームスタート時に進行ルート選択をすることでゲーム展開が変わる要素もあり、繰り返し何度も遊べます。二人同時プレイにも対応しています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
