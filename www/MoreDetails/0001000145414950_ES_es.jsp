...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Al sufrir el ataque del malvado Capitán Klapton en sus planetas natales, ¡los cazarrecompensas espaciales Roddy y Cathy entran en acción para salvar la galaxia!
<br><br>
Este divertido juego de recreativa de desplazamiento lateral ofrece acción tanto en primero como en segundo plano, pudiendo pasar de uno a otro con solo pulsar un botón. Juega solo o simultáneamente con un amigo y ábrete paso mediante saltos, disparos y porrazos por mundos de bosques, hielo, viento y fuego.
<br><br>
Usa tus brazos extensibles para accionar interruptores, coger potenciadores y hasta para lanzar unos enemigos contra otros. ¡Utiliza poderosos movimientos especiales y busca juegos secretos extra!
<br><br>
