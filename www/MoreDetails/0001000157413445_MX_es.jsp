...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157413445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Por primera vez, un título de WarioWare está disponible en el servicio WiiWare! WarioWare: D.I.Y. Showcase está diseñado para mostrar los distintos productos de WarioWare: D.I.Y., los cuales incluyen microjuegos, música y cómics de cuatro viñetas. Podrás moverte fácilmente por los menús usando el Wii Remote. Utiliza los distintos modos de juego de la Licuadora (Game Blender) para jugar a los microjuegos, en los cuales verás a Wario, algunos ninjas, animales e incluso las franquicias clásicas de Nintendo. También puedes probar la sección de Música para escuchar o jugar con las canciones utilizando un personaje de Balloon Fight. Además de todos los productos que vienen incluidos, también podrás jugar con las creaciones hechas en WarioWare: D.I.Y. para la consola Nintendo DS o las que recibas de tus amigos, además de las que descargues de la tienda NinSoft (NinSoft Store). Da rienda suelta a tu creatividad y empieza a añadir a tus amigos D.I.Y. ¡Incluso Wario estaría impresionado con las posibilidades!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157413445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">WarioWare<sup>TM</sup>: D.I.Y. Showcase</span></div>
</div>
