...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界刑事警察機構（ＷＣＰＯ）に所属する主人公「アルバトロス」を操作して、世界征服を企む秘密組織「ゲルドラ」に捕らえられた女性工作員「レイラ」を救出する、横スクロール型の人気アクションシューティングゲームです。プレイヤーの唯一の武器は拳銃ですが、弾数に制限があるため、「ＢＵＬＬＥＴ」と書かれた看板のある部屋で弾を補充しながら進みます。ジャンプを中心とした華麗なスパイアクション、「ＡＲＭＳ」と書かれた部屋で入手できるマシンガンなどを駆使して、ステージを攻略していきます。最終ステージには「レイラ」を捕らえた組織の首領「マブー」が待ち受けています。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145374E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145374E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ローリングサンダー<sup>&reg;</sup></span></div>
</div>
