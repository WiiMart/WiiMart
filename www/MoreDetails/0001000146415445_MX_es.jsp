...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego clásico de acción-ninja apareció por primera vez en galerías en 1985 y se hizo inmediatamente popular. Jugando en el rol del ninja Iga “Kage," los jugadores se embarcan en una búsqueda llena de acción camino a un castillo mágico donde la Princesa "Kiri" ha sido aprisionada por "Yohshirou Yukikusa." Para mantenerte con vida, debes moverte de manera vertical y horizontal a través de ambientes de bosques y castillos y ejecutar saltos gigantescos, mientras usas estrellas para lanzar y una espada para derrotar a las tropas enemigas.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Legend of Kage</span></div>
</div>
