...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157575445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Peter Pepper picked a peck of pickled burgers and man, what a fight did he get! Join our hero as he traverses the globe in search of hamburger heaven. Escape from angry veggies and build your BurgerTime World Tour today. Classic retro games can transcend their original platform and evolve to fit the larger world of next generation gaming. BurgerTime World Tour is a maturation of the arcade classic enhanced with an innovative 3D rotating cylindrical environment and elevated retro gameplay. The rotational axis allows you to see through the cylinder level, creating strategic elements for determining the fastest way to complete a burger. Enemies can now be thrown by Peter Pepper. Tossing a baddie onto a burger part will rack up bonus points! Enjoy the 3D rotating cylindrical environment, four culinary capital worlds, platforming, elevated retro gameplay, and over 20 fun-filled Burgerlicious levels! The all-new BurgerTime will rock your retro world.
<p>
