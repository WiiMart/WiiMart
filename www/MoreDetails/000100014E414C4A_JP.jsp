...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マリオやリンクなど、８人以上の任天堂の代表的キャラクターたちが結集し、同時に４人まで対戦できる対戦型アクションゲームです。攻撃をヒットさせると、相手に“蓄積ダメージ”がたまっていきます。蓄積ダメージがたまると、攻撃によってだんだんふっとばされやすくなっていき、画面外に飛び出してしまうと１ミスとなります。制限時間内に、画面外に相手をふっとばした回数を競います。決められた順番にステージをこなしていく１人用モードのほか、制限時間、ストック数、チーム制などさまざまな設定が可能な対戦モードがあります。スティックをすばやく横や上に倒すと同時に攻撃するとくりだせるスマッシュ攻撃や、２０種類あるアイテムを上手に使い分け、激しい戦いを制してください。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ニンテンドウオールスター！　</span></div>
</div>
