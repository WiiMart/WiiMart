...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">キュートなキャラクターが人気を呼んだ、全５０ラウンドのアクションパズルゲームです。プレイヤーは主人公「ミルク」を操作して、ラウンド上の全ての「フルーツ」を集め、
恋人の「ヨーグル」に会いに行かなければなりません。ところが、各ラウンドではライバルの「ナッツ」がジャマをしようと、しつこくミルクを追いかけてきます。ナッツにつかまったり水に落ちたりしないように注意して、時間とともに減っていくボーナス点がゼロになる前に、ヨーグルのもとにたどり着ければラウンドクリアです。分かりやすいルールをはじめ、ゲームには難易度別に「ＧＡＭＥ　Ａ」と「ＧＡＭＥ　Ｂ」の２種類のモードが用意されており、アクションに慣れていない初心者でも安心してプレイを楽しむことができます。また「ＧＡＭＥ　ＥＤＩＴＯＲ」モードでは、自分だけのオリジナルラウンドを作ることも可能です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ナッツ&amp;ミルク</span></div>
</div>
