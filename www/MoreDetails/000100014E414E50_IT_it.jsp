...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Metti alla prova le tue abilità nella lotta e nella risoluzione di enigmi battendoti contro i migliori Allenatori di Pokémon del Puzzle Village! Per vincere dovrai dimostrare di possedere riflessi rapidi e movimenti fulminei, eliminando i segmenti del puzzle ottenuti combinando blocchi dello stesso colore. Il tuo punteggio sarà tanto più elevato quanto maggiore sarà il numero di elementi che riuscirai a eliminare nello stesso tempo!
<br><br>
Realizza una serie di combo e di reazioni a catena (Chains) per lanciare dei potenti attacchi al tuo avversario (la CPU o un amico) e ottenere delle medaglie dagli Allenatori rivali, diventando così il Pokémon Puzzle Master, il campione assoluto di Pokémon Puzzle!
<br><br>
Oltre all'abilità nella lotta, dovrai dimostrare di possedere altre doti. Molte sfide ti attendono: dalla modalità 3D (3D mode) agli esercizi rompicapo che si svolgono presso la Puzzle University. Sei pronto per un nuovo tipo di sfida?
<br><br>
Il testo all'interno del gioco è in inglese.<br>La funzione rumble del gioco originale non è disponibile.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414E50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414E50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pokémon<sup>TM</sup> Puzzle League</span></div>
</div>
