...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574A5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Preparati a giocare il puzzle game per eccellenza, adesso disponibile su Wii!
<br>
Allinea tre gemme scintillanti alla volta per farle esplodere in cascate di colori e punti. Allineane almeno quattro per creare potenti gemme, dotate di effetti speciali, in grado di incrementare il tuo punteggio e metterti di buon umore con brillanti combo e reazioni a catena.
<br>
Raggiungi vette incredibili in modalità Classica o lotta contro il tempo in modalità Azione. Per aggiungere spettacolo al divertimento, dai libero sfogo al tuo genio con rompicapi multisfaccettati o raggiungi lo zen nella modalità Infinita. Ogni partita è un gioiello di divertimento. <br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574A5750/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
