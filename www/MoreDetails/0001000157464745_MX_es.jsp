...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Frogger Returns lleva el reto emocionante de Frogger de arcade a otra dimensión! El modo de jugar clásico desde el punto de vista de pájaro ha sido mejorado con gráficos 3D coloridos, ¡una perspectiva nueva, niveles completamente nuevos, enemigos nuevos y bonificaciones para usar y evadir que cambian la estrategia de jugar! Multijugador local te permite competir en carreras contra un amigo para alcanzar la victoria.<br>
• Gráficos mejorados. El juego clásico de Frogger tiene la apariencia totalmente nueva.<br>
• Niveles completamente nuevos. Atraviesa las cuatro etapas del viaje original de Frogger desde la carretera hasta la casa por una aventura nueva.<br>
• Varios modos de jugar. Derrota tus puntuaciones altas, compite contra el reloj, o sólo hace que Frogger llegue a su hoja de nenúfar. ¡Juega como quieras!<br>
• Nuevos jefes y tácticos. Los nuevos enemigos y bonificaciones  harán que cambies tu estrategia.<br>
• ¡Juega con un amigo! Multijugador local te deja competir en carreras contra un amigo.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Frogger Returns</span></div>
</div>
