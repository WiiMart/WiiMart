...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F594A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">追跡してくるモンスター達に捕まらないように、迷路の中に散らばった友達を集めて助けていくクラシックアクションゲーム。 ゲームを進めるとグラフィックやBGM等が4Bit～128Bit時代を経て進化し、奥深くなっていきます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F594A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F594A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ビットマン</span></div>
</div>
