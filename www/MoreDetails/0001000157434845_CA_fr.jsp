...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157434845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Patience will be key when you perfect your skills going up against the best with Chess Challenge!. Your chess skills will be put to the test by playing against the computer in multiple difficulty modes. Win matches and watch your chess rating rise as your continue to learn and master your skills. With full Mii™ character support you can really bring your games to life! Start off practicing on some casual games, and work your way up to fully ELO-rated matches. With all of these gameplay options you have some serious chess action awaiting you! It’s time to play the best.</div>
  <div id="image02">
