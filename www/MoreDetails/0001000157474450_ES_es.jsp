...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157474450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Increíble juego en 2D de acción espacial y disparos! Ponte al mando de la nave espacial Vic Viper y atraviesa niveles llenos de enemigos, obstáculos y durísimos jefes. Recoge cápsulas potenciadoras: aceleradores a bombas, láseres y copias de tu nave y sus armas.
<br>
<br>
CARACTERÍSTICAS
<br>
<br>
Nuevo episodio de la saga de culto de Konami.
<br>
<br>
Sube tus puntuaciones del modo Ataque a las tablas en línea y compáralas con las de tus amigos.
<br>
<br>
Sistema de armas mejorable con aceleradores, misiles, bombas de expansión, misiles de ida y vuelta, disparos dobles, disparos verticales, arma de cola, láser, láseres gemelos, disparo de onda, opción, escudo y campo de fuerza.
<br>
<br>
Repeticiones: graba y vuelve a ver tus misiones.
<br>
<br>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Gradius Rebirth</span></div>
</div>
