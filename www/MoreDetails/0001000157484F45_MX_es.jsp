...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157484F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Utiliza el Wii Remote™ como si fuera un palo de hockey y dispara en 3 emocionantes competiciones donde se pondrán a prueba tus habilidades. Cara a cara: ¡Tienes que marcar el mayor número de goles en el menor tiempo posible! En 3 niveles de dificultad, te enfrentarás a 3 jugadores cada vez más talentosos, cada uno portando la camiseta de su país. En el modo de 2 jugadores, intercambiarán como portero y atacante. El jugador que marque más goles tras cinco tiros será el ganador. En Tiro de precisión: Consigue un buen resultado dándole a tantos blancos como puedas en cualquiera de los tres niveles de dificultad. Cada vez que falles un tiro, aparecerá una X en la esquina superior izquierda. 3 fallos y habrás perdido. En Potencia de tiro: Haz tu tiro y comprueba tu potencia en el marcador que aparecerá. Tienes 3 intentos para conseguir tu mejor tiro. Sólo los tiros más rápidos tendrán el honor de aparecer en la lista de mejores resultados.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157484F45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157484F45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Hockey Allstar Shootout</span></div>
</div>
