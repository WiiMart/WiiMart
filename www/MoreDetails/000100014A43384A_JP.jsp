...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気ＲＰＧ「ファイナルファンタジー」シリーズの４作目。従来のターン制バトルに時間の概念を取り入れ、緊張感と戦略性を高めたアクティブタイムバトルシステムがシリーズ初登場。グラフィック、音楽、物語性とその演出すべてがハードとともに大きく進化した、スーパーファミコン初の「ファイナルファンタジー」です。軍事国家バロンの飛空艇団“紅い翼”の部隊長であった暗黒騎士セシルは、国王に不審を抱いた罪でその座を剥奪され、親友の竜騎士部隊長カインとともに辺境の村ミストへ向かう別命を受けます。セシルは、国王の命令で罪の無い人々から略奪を繰り返していたことを悩みながらも、仲間との出会いや別れを繰り返しながら、己の内なる闇と決別する試練を乗り越えることで聖なる力を手にし、世界を覆う闇と対峙していきます。<BR>※バトル時のみ2人で協力プレイが行えます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファンタジー<sup>&reg;</sup>IV</span></div>
</div>
