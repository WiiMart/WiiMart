...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Acompaña a Donkey Kong Jr. en una clase de matemáticas muy diferente! En este juego educativo de NES, tendrás que trepar y saltar por la pantalla recogiendo números y símbolos para obtener el resultado que muestre Donkey Kong en su pancarta.
<br><br>
Usa tus habilidades matemáticas en el modo de un jugador o desafía a un amigo en una carrera de cálculo de dos jugadores. ¡Podrás molestar a tu contrincante cogiendo los números antes que él!
