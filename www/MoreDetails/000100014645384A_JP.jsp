...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８６年に発売され話題となった伝説のゲームです。プレイヤーはごく普通のサラリーマン。会社からスタートし、目の前に立ちはだかる数々の障害をクリアしながら、
南海の孤島に隠された宝を見つけることが目的です。「アクション」あり「アドベンチャー」あり「シューティング」あり。当時のファミコンソフトの常識を超えたゲーム内容は、発売以来２０年以上の歳月を経てもなお語り継がれています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645384A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645384A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">たけしの挑戦状<sup>TM</sup></span></div>
</div>
