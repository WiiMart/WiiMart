...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157464D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Divertiti con i tuoi amici e familiari affrontando prove appassionanti! Family & Friends Party è un gioco da tavolo interattivo per giocatori di tutte le età (da 1 a 8 giocatori). Lo scopo del gioco è quello di superare tutte le prove presenti in Family & Friends Party.<br>
Il primo che riuscirà a superarle tutte sarà il vincitore!
<br><br>
Come si gioca<br>
Le squadre giocano a turno. In ogni turno, la squadra selezionata deve superare una prova specifica che verrà giocata da 1 o 2 membri della squadra, a seconda del tipo di prova. Gli altri membri possono comunque aiutare e consigliare: vedrai che il lavoro di squadra sarà prezioso!<br>
Nel gioco ci sono 6 diverse prove “Single”, che dovranno essere affrontate dai membri di una stessa squadra in maniera collaborativa. A volte ci saranno anche delle prove “Versus”, in cui tutte le squadre si affronteranno contemporaneamente.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464D50/FFFD0013" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464D50/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
