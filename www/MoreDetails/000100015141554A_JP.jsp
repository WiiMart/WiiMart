...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">伝説の武具を手に入れた少年「レオ」と少女「プラプリル」が、モンスターランドを舞台に大冒険を繰り広げるコミカルアクションシューティングゲーム。１人プレイではレオを操作、２人同時プレイではプラプリルも加わって、かわいくてコミカルな魔物たちが待ち受ける、海あり山ありの楽しい１４ラウンドにいどみます。各ラウンドは大きく分けて、前半のアクションモードと後半のシューティングモードからなります。障害物や穴をジャンプでかわして進むアクションモードでは、「フード」でバイタリティを回復させながら、さまざまな特性のアイテムをうまく使って出口をめざします。爽快感あふれるシューティングモードでは、飛来する敵を撃破していくことでアイテムが続々と出現。最後に待ち構える個性的なボスを倒すとラウンドクリアです。ＣＤ－ＲＯＭならではの高品質のゲームミュージックをバックに、全ラウンドを制覇してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">モンスター・レアー</span></div>
</div>
