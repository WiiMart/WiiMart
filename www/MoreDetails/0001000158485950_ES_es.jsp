...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158485950')", "wiiSelectSound()");
...
<br><br>
En BIT.TRIP FATE, un arcade de desplazamiento lateral, CommanderVideo sigue el camino marcado por la vibración para descubrir su destino.
<br><br>
Mingrawn Timbletot ha transformado el mundo en una horrible pesadilla tecnológica, y CommanderVideo está dispuesto a detenerle con la ayuda de los amigos que conoció en BIT.TRIP RUNNER.
<br><br>
¡Únete a Junior Melchkin, CommandgirlVideo y muchos más y combina sus poderes con los de CommanderVideo para salvar al mundo!
<br><br>
Vive esta emocionante aventura en solitario o con un amigo, ¡y más vale que tengas un pulso firme! ¡Lo necesitarás para seguir la vibración mientras apuntas con tus rayos a las retorcidas almas que quieren destruirte!
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158485950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158485950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BIT.TRIP FATE</span></div>
</div>
