...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574D5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">miffy's welt ist eine 2-D-Spielwelt, die auf einem Charakter von Dick Brune basiert. In Miffys Welt spielen die Kinder als Miffy, erforschen verschiedene Gegenden, führen kleine Abenteuer durch, interagieren mit Freunden und Objekten und greifen auf erzieherische Minispiele zu. <br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5750/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">miffys welt</span></div>
</div>
