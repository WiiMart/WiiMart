...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Easy to play, hard to master, Shadow Dancer: The Secret of Shinobi™, first released in 1987, is the sequel to the original Shinobi™ arcade game, and is one of the only games in the Shinobi series to feature true arcade-style gameplay. Play as Joe Musashi, the master ninja known to his enemies only as “The Shinobi”. This battle is not one you must fight alone, as this is the first game in the Shinobi series to feature your ninja attack dog, Yamoto, who will charge foes on command, leaving them open to a powerful drop kick. Use your mastery of ancient ninja technique to topple the crime syndicate—the Neo Zeed Corporation, and free the foreign dignitaries they have taken hostage in New York City. Good luck, and may the ninja spirits help guide you in your journey.</div>
  <div id="image02">
