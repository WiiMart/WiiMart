...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157475349')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Incontra Phoenix Wright, l’emergente e giovane avvocato con le più incredibili abilità investigative che ci sono in città! Prendi parte a 4 casi intriganti per scoprire le drammatiche, sconvolgenti e anche comiche vicissitudini dell’aula di tribunale. Utilizza il telecomando Wii per perlustrare la scena del crimine, interrogare i testimoni e rivelare la sconvolgente verità.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157475349/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157475349/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Phoenix Wright<sup>TM</sup>: Ace Attorney</span></div>
</div>
