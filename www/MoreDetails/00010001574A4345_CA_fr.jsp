...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574A4345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">JellyCar 2, the hit driving platform game, is here and fully loaded with more than 30 levels, multiplayer, and much more! Play head-to-head or co-op in Multiplayer Flag, Gems, and Tether modes. Post high scores, best times, and longest jumps in the Hall of Fame. With so much squishy goodness, you’ll want to drive JellyCar 2 all around town!
<p>
Classic:<br>
Drive your squishy car and use your special abilities to drive through squishy worlds!
<p>
Jelly Factory:<br>
...
<p>
Factory Mode:<br>
Create and play your own puzzles! Choose ramps, wheels, levers, and more!</div>
  <div id="image02">
