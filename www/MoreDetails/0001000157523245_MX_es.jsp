...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157523245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un rabbid está atrapado dentro del Wii Remote. ¡Ven a jugar con él! Lo primero, intenta interactuar con él moviendo el Wii Remote o pulsando los botones. Verás cómo le gusta. Después de que empecéis a conoceros, es hora de cambiar su aspecto en el laboratorio: deformar su cabeza, ponerle accesorios a la moda para que lleve sombrero, o cambiar su aspecto de la cabeza a los pies con el módulo de dibujo. Cuando hayas convertido a tu rabbid en algo único, puedes hacer una foto y enviarla con un mensaje de Wii a tus amigos. Textos de pantalla en inglés, francés y español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157523245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157523245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">RABBIDS LAB</span></div>
</div>
