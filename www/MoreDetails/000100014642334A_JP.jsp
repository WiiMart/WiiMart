...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">広大な地上と、地下迷宮での幾多の謎。知恵と勇気が試される、アクション型ロールプレイングゲームの決定版です。１９８６年に発売された『ワルキューレの冒険』は、美しく凛々しいワルキューレの容姿と、星座と血液型を入力することにより素質と成長度が決まるというシステムが話題を呼びました。神の子ワルキューレの現身（うつしみ）となり、悪の化身ゾウナを倒し、マーベルランドに平和を取り戻すことが目的です。ワルキューレとその背景にある壮大なバックストーリーも注目されました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワルキューレの冒険<sup>&reg;</sup> 時の鍵伝説</span></div>
</div>
