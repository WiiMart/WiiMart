...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157564345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El juego de cartas de casino más jugado del mundo hace su debut WiiWare con personajes sumamente detallados, animaciones realistas e inteligencia artificial avanzada - haciendo V.I.P. Casino: Blackjack el juego de blackjack más realista que se ha hecho jamás. Rompimos el molde de juegos de cartas tradicionales y su constante interfaz de 2D integrando nuestra animada interfaz de 3D en la mesa y creando un estilo visualmente impresionante y una experiencia de juego que se siente simplemente perfecta. Utilice los controles de movimiento del mando de Wii para pedir una más, pararse, y apostar. ¡Juega para alcanzar logros como High Roller, Power Player, Card Shark, Elite Gambler, y muchos más! En partidas de multijugador, es un duelo de sagacidad contra el crupier. ¡Hasta cuatro jugadores pueden jugar, y quienquiera que gane la fortuna más grande en un predeterminado número de manos, será el campeón!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">V.I.P. Casino: Blackjack<sup>TM</sup></span></div>
</div>
