...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Power Golf combina un sistema di controllo semplice ed efficace e una splendida rappresentazione grafica per offrirti una divertentissima simulazione di golf. Affronta le 18 buche nelle tre modalità di gioco: Stroke Play, per un solo utente, o Match Play e Competition, per più giocatori.
Partecipa ai tornei scegliendo il grado di difficoltà tra Principiante, Intermedio e Avanzato. La forza del vento e l’inclinazione del green rendono ogni buca diversa dalle altre, aggiungendo così altri elementi alla sfida.
Affronta altri giocatori nel tradizionale Normal Match o scommetti una delle tue mazze nell’innovativo Club Match.
Power Golf offre una funzione di handicap che permette anche ai principianti di competere alla pari dei rivali più esperti. 
