...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C4C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Entra en el mundo de Little Tournament Over Yonder. Juega en el papel de un joven Príncipe o Princesa liderando a tu equipo por numerosas batallas. Planifica y despliega tus unidades para conseguir ventajas estratégicas. Lanza batallas en tiempo real entre unidades y lucha con esfuerzo, lucha con rapidez, lucha con inteligencia. Crea tu equipo; contrata nuevas unidades con diferentes poderes; haz que ganen experiencia en el campo de batalla para subir de nivel. Este juego es una mezcla de planificación estratégica y lucha rápida en tiempo real. Es el juego para el guerrero definitivo, aquel que utiliza tanto la mente como los músculos. Participa en un desafío de Torneo de un jugador para obtener la gloria o desafía a tu amigo en un combate Versus de dos jugadores.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4C45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4C45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Little Tournament Over Yonder</span></div>
</div>
