...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toma el papel de Roddy o Cathy, cazarrecompensas, en este juego de acción-horizontal basado en el futuro cuando humanos han colonizado el espacio. Pero no todo está bien – piratas del espacio llamados Klaptons han estado cruzando las galaxias, destruyendo colonizaciones pacíficas en su camino. Este comportamiento vergonzoso causa que tengan un precio por sus vidas, y ahora Roddy y Cathy deben viajar por cuatro distintos mundos en una misión para derrotar a su líder, Captain Klapton (Capitán Klapton). Ambos personajes tienen brazos retráctiles – que se usan para agarrar enemigos y otros objetos en el escenario – los cuales podrán ser lanzados hacia otros para destruirlos. También, ponte en busca por anillos o palancas para jalar, porque esto puede revelar bonificaciones especiales. Todavía para añadir más a la mezcla, el juego usa un sistema único donde acción pasa en dos planos, con el jugador cambiando de uno al otro cuando quiera. ¿Puedes tú demostrar que eres digno del nombre Top Hunter (Mejor Cazador) y ayudar salvar el universo?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">TOP HUNTER</span></div>
</div>
