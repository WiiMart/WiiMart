...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This direct sequel to the original The Legend of Zelda™ is famous for taking the series in a new direction, while also introducing elements that would go on to become standard in future Zelda games. In Zelda II™: The Adventure of Link™, Link is on a quest to seek the Triforce of Courage and awaken Princess Zelda from a sleeping spell placed upon her by an evil wizard. Meanwhile, Ganon’s minions are attempting to resurrect their master.<br>
Instead of the regular top-down viewpoint, Zelda II uses a side-scrolling perspective and overworld map, and features role-playing aspects that are unique to the series. Zelda II also features many character and place names that fans of the series are sure to find familiar.</div>
  <div id="image02">
