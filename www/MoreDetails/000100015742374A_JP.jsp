...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742374A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">直感的な操作で誰でも楽しめる、奥の深いビリヤードゲームです。本場のビリヤードバーの臨場感を味わうことができます。チャレンジモードでは、鮮やかなトリックショットを決めましょう！ナインボール、アメリカ式エイトボール、イギリス式エイトボールの3種類のルールで、本格ビリヤードゲームをお楽しみください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742374A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742374A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ハマる★ビリヤード</span></div>
</div>
