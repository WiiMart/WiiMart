...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157475945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gyrostarr challenges you and up to three additional players to pilot your ships through a series of twisting, turning, technoplasma tracks while battling a variety of deadly alien foes at ever-increasing speeds. While you fight and maneuver, you must collect enough energy to activate the ancient warpgate at the end of each track. Succeed, and you can journey to the next, even deadlier track. Fail, and the gate slams shut, destroying your ship! Enhance your ship with weapon pickups, coordinate your attacks with your friends to fire powerful combined blasts, and use your grapple to snag energy and pickups in the midst of combat. Control your ship with the Wii Remote™ controller, Nunchuk™ controller, or Classic Controller™, or use the “paired” control system that allows two players to use a connected Wii Remote and a Nunchuk or Classic Controller at the same time! Offering 50 levels of intense action, powerful pickups, high-speed bonus levels, and 1-4 player mayhem, Gyrostarr is a killer arcade challenge!</div>
  <div id="image02">
