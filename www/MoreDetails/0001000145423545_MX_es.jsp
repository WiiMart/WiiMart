...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Last Blade es un juego de lucha lanzado por primera vez en 1997 y ambientado en el periodo "Bakumatsu" de la historia japonesa, en el cual unos diez luchadores empuñan la espada para combatir motivados por diferentes propósitos. Con características similares a sus predecesores de la serie "Samurai Showdown", de la misma editora, The Last Blade se diferencia en que, al seleccionar un personaje, puedes elegir entre dos tipos de espada: “Power”, que concentra el daño, o “Speed”, que favorece el juego rápido. Además, los jugadores pueden utilizar movimientos como “Repel”, el cual les permite evitar los embistes enemigos, y “Sublime Slash”, el cual cancela un ataque “Super Slice” y puede combinarse con “Super Secret Slice”. Estos son solo algunos de los elementos que se suman a la enorme cantidad de maniobras que este juego ofrece. ¡No te pierdas movimientos poderosísimos como “Super Secret Slice” y “Hidden Secret Slice”!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145423545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145423545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
