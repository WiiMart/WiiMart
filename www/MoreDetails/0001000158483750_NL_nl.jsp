...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158483750')", "wiiSelectSound()");
...
<br><br>
Duistere figuren hebben Jake’s middelbare school overgenomen en jij moet hem helpen door elk klaslokaal te komen, zodat hij herenigd kan worden met zijn vriendin Rachael. De bestaande lichtbronnen moeten slim worden gebruikt om lichtbruggen voor Jack te creëren waar hij overheen kan gaan. Eén misstap en Jack wordt  de duisternis in getrokken. Onderweg wordt hij geconfronteerd met karakters die  een verwrongen weergave zijn van het schoolpersoneel. Hij moet hen verslaan om verder te kunnen komen.
<br><br>
LIT is een horror puzzelspel waarvoor de Wii-afstandsbediening en de Nunchuk accessoires nodig zijn. Er zijn 30 niveaus, 5 gevechten met een baas, terugspeelinstellingen en diverse unlockables, zoals verschillende aflopen van het verhaal,  geklokte uitdagingen met donker-instelling en een unlockable karakter.
<br><br>
