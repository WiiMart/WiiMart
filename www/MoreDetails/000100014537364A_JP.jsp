...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">海を舞台とした落ち物パズルアクションゲーム。画面上から落ちてくる赤・青・黄など全６色のキューブを次々と消していきます。キューブは同じ色のキューブとぶつかるとヒビが入り、ヒビの入ったキューブにもう一度同じ色のキューブをぶつけると、ヒビの入ったキューブを崩すことができます。フィールドがすべてキューブで埋め尽くされ、キューブを落とすことができなくなるとゲームオーバーです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エメラルディア<sup>&reg;</sup></span></div>
</div>
