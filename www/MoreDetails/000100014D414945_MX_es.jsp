...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fantasyland ha sido tomada por fuerzas destructivas y una llamada de auxilio viene desde el espacio. Sin perder tiempo llegará el Space Harrier, que, armado con su láser, deberá burlar las hordas enemigas a través de doce etapas llenas de sorpresas, con un peligroso boss al final de cada una.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
