...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158495450')", "wiiSelectSound()");
...
Veuillez noter que vous ne pouvez pas sauvegarder votre progression dans cette version démo.<br><br>
Il n’y a que deux catégories de cow-boys : ceux qui tirent vite... et les autres ! Affrontez les plus fines gâchettes de la région, y compris le très redouté Wes Flowers !<br><br>
Dégainez votre télécommande Wii et montrez-leur qui est vraiment le plus rapide dans ces duels en direct ! Vous pouvez même vous mesurer à un ami en mode multijoueur et voir qui a les meilleurs réflexes.<br><br> 
Il vous faudra faire preuve d’une rapidité considérable et d’une précision impressionnante pour affronter ces tireurs... Alors, préparez-vous pour beaucoup d'action !
