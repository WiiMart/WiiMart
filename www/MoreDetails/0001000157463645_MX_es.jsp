...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157463645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Frobot está programado para amar, no para la guerra, pero cuando sus cinco novias fueron robo-secuestradas no pierde un segundo para pelear en las calles. ¡Hazte camino hasta el Funkytown hasta el cuartel general BotBlocker y devuelve lo que es tuyo!<br>
...
• Haz el Baile Disco - ¡Desbloquea mapas multiplaya al termina los niveles de playa solo en tiempo record!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157463645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157463645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
