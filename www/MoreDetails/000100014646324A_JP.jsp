...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『すごろクエスト ダイスの戦士たち』は、１９９１年６月２８日に発売されたロールプレイングゲーム。ダイスを振り、すごろくのマップ上を冒険し、止まったマスにより様々なイベントが発生します。ファイター、エルフ、ドワーフ、ハーフエルフのタイプの違う４人のキャラクターから1人を選び、ダイスを振り、魔物と戦いキャラクターを育てていきます。マップの最後にはボスが道をふさいでおり、ボスを倒してゴールを目指します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">すごろクエスト</span></div>
</div>
