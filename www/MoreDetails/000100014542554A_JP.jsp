...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９１年にリリースされた異色のベースボールゲーム。プレイヤーは、近未来の世界を舞台に、２リーグ各６球団から１チームを選んでリーグ優勝を目指します。試合はサイバーエッグというドームで開催され、ホームランゾーンが異様に小さい、フェアゾーンが非常に広い、ボールが止まるストップゾーンがある、試合の進行とともにクラッカー（地雷）が設置される、試合中にアーマーを購入して選手を強化できるなど、実に特殊なベースボールを体験できます。最初は戸惑うかもしれませんが、慣れてくると本作ならではの戦略を編み出したりアクシデントを楽しめるようになるでしょう。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">2020年スーパーベースボール</span></div>
</div>
