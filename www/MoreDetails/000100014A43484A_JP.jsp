...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スーパーファミコン版がんばれゴエモンシリーズの第三弾。江戸時代から未来へと時代をまたにかける壮大なアクションアドベンチャーゲームです。町で情報やアイテムを集めながら、アクションステージで謎を解き、
敵をやっつけて「からくり盗賊団」にとらわれた「物知りじいさん」と
ヒロイン「おみっちゃん」を助け出してください。敵の攻撃や仕掛けに当たったり落ちたりするとライフゲージが減り、ライフゲージがなくなると１回アウトになりプレイヤーを１人失います。プレイヤーがすべてアウトになるとゲームオーバーとなり、最後に旅日記をつけたところまで戻されてしまいます。操作できるキャラクターは主人公の「ゴエモン」と相棒の「えびす丸」に加え、からくり忍者の「サスケ」、くノ一の「ヤエちゃん」の４人。
それぞれ攻撃方法や特殊能力が異なるので、状況に応じてプレイヤーを切り替えて進みましょう。「カラクリウォーカー」や「激震インパクトステージ」などの新要素も満載。２人同時協力プレイも可能です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">がんばれゴエモン３</span></div>
</div>
