...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９２年にリリースされたサッカーゲームで、８カ国の代表チームが優勝を目指して火花を散らします。本作の特徴は、近未来が舞台ということで、選手はロボットになっていたり、１チーム７人制であったり、守備側はアームパンチやショルダータックルによる攻撃が可能だったり、パワーゲージを溜めることでトリッキーなシュートを繰り出せたりと、サッカーの内容に大きなアレンジが加えられています。ファールやオフサイドも存在せず、ラインを割ってもバウンドウォールのおかげでプレイが続行するので、スピーディで超攻撃的なサッカーが堪能できることでしょう。もちろん二人での対戦プレイも可能です。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サッカーブロール</span></div>
</div>
