...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">このチャンネルは、ダウンロードできません。<BR><BR>
『ゼルダの伝説 スカイウォードソード』のデータを修復される場合は、「ゼルダの伝説　スカイウォードソード　データ修復チャンネル」をダウンロードしていただき、そちらをご利用ください。</div>
  <div id="image02">
    <img src="/oss/ccs/00010000534F554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
