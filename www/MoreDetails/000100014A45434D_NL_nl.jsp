...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Een nieuw millennium is aangebroken. Een portaal is geopend. De ketting des tijds... doorbroken.
<br><br>
Een jonge man wordt terug in de tijd geplaatst waardoor het verloop van de geschiedenis, en daarmee ook de toekomst, wordt veranderd. Hij moet zijn weg terug naar huis vinden, maar eerst zal hij tot aan de uiteinden der tijden moeten reizen om de chronologie van de wereld te herstellen. 
<br><br>
Onderweg ontmoet hij vreemde vrienden en vijanden, bedient hij ongelooflijke apparatuur en voertuigen en infiltreert en neutraliseert hij vestingen van het verleden, het heden en de toekomst.
<br><br>
Een paradox is geboren. Als hij het verloop van de tijd niet herstelt, zal niets meer bij hetzelfde blijven.
<br><br>
Hij is degene die een held zal worden. Zijn naam is Crono.
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A45434D/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A45434D/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">CHRONO TRIGGER<sup>&reg;</sup></span></div>
</div>
