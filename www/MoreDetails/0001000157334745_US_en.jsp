...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157334745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Phoenix Wright is back as the third game in the popular Ace Attorney handheld franchise comes to WiiWare!  As Phoenix Wright, you’ll play through five shocking new cases in first person perspective! The game features two unique game play modes. In Investigations Mode you’ll survey crime scenes, interview witnesses and gather evidence. You’ll then present findings, listen to testimonials and examine witnesses in Court Mode.  Trials and Tribulations also includes the “Psyche-Lock” feature that allows Phoenix to use a line of questioning to reveal inconsistencies in witness testimony.</div>
  <div id="image02">
