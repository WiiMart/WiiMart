...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９５年に発売された、いまだに根強いファンが多い脱出パニックホラー。北欧の山間部にひっそりたたずむ古びた屋敷「クロックタワー」。孤児の美少女ジェニファーはこの屋敷に養育されることになり、３人の友人と訪れる。そこでジェニファーが見るものは……<BR>主人公は１４歳の女の子。戦うことはできませんので、うまく逃げて屋敷の謎を解き明かしましょう。次々と襲われる友人達。迫り来る巨大なハサミ。『究極の緊張感』があなたを襲います。あなたの行動一つ一つによりシナリオは複雑に分岐し、それぞれの異なるエンディングが展開します。あなたは８つのエンディング＋αを全て見ることができるでしょうか。行動選択後は自動で動いてくれるので、アクションが苦手な方でもお楽しみいただけます。映画的な「シネマティックライブ」を思う存分体験して下さい。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44524A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44524A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クロックタワー<sup>&reg;</sup></span></div>
</div>
