...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In het jaar 2560 is F-Zero het grootste racekampioenschap in het universum. De races worden gehouden op gevaarlijke parcours en op verschillende planeten. Coureurs uit alle uithoeken zetten hun leven op het spel en strijden om de eerste plaats in hun hypermoderne hovercrafts. Ontdek of herontdek dit onvergetelijke racespel voor de Super Nintendo! Door gebruik te maken van "Mode 7", een speciaal effect van de Super Nintendo, kreeg snelheid in racespellen een nieuwe betekenis. De parcours zijn bezaaid met dodelijke vallen, waardoor spelers steeds op zoek moeten naar manieren om hun rondetijden te verbeteren. De soundtrack van F-Zero™ is bovendien een van de bekendste in de geschiedenis van videogames. <br><br>Het spel is voorzien van Engelse schermteksten.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
