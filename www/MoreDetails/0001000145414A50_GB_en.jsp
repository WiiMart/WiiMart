...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Take up the challenge of Metal Slug, SNK's classic side-scrolling military action game from 1996. You control Marco (in one player mode) and Tarma (in two player mode), members of the special ops force Team Peregrine Falcon (Team PF). Team PF are the Army's last hope in their quest to overthrow the rogue General Morden and recapture the stolen weapon Metal Slug.<br><br>

Move through the levels by jumping and using the wide range of weaponry at your disposal, including heavy machine guns, shotguns, rocket launchers and flamethrowers as well as the Metal Slug itself. Use them well as you take on waves of enemies in one- or two-player mode!<br><br>

The tutorial is also available in Portuguese.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
