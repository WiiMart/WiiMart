...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ponte en la piel de un ninja, maestro de las Cinco Artes Marciales Ninja asesinas transmitidas de generación en generación desde la caótica era del Japón feudal, y adéntrate en la "jungla de asfalto", una aterradora ciudad estadounidense, para acabar con las hordas del sindicato del crimen. Utiliza tan solo tres botones para realizar trepidantes movimientos como el lanzamiento de cuello, el enganche y patada o la combinación triple de golpes. Cada una de las fases del juego está inspirada en las concepciones erróneas que los occidentales tienen sobre los ninjas y Japón, dando lugar a una fantástica mezcla de culturas que seguro logrará cautivarte. Además, podrás configurar opciones como el número de vidas inicial o el nivel de dificultad.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145365045/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145365045/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
