...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">緑の恐竜のような外見を持つ「ワギャン」を操作する横スクロール型アクションゲームです。主人公のワギャンは、悪の天才科学者「ドクターデビル」を倒し、島の平和を取り戻すために冒険をします。口から発する「ワッ」「ギャー」といった声による音波攻撃をおこなうことで敵をしびれさせることができます。しびれさせた敵には上に乗ることができ、それによって行動できる範囲が広がります。各ステージの最後に待ち受けるボスキャラクターと、しりとりや神経衰弱といったミニゲームで対戦をおこなうという奇抜なゲームシステムが人気を集めました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワギャンランド<sup>&reg;</sup></span></div>
</div>
