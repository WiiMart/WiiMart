...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「高橋名人」を主人公にしたアクションゲームのシリーズ第２作です。キュラ大王を倒し、平和を取り戻したアドベンチャーアイランド。しかし新たな侵略者「ベルゼバフ」によって、島は再び占領されてしまいました。ベルゼバフとその手下たちを倒し、恋人の「ティナ」を助け出すため、名人の新たな戦いがはじまります。プレイヤーは、ジャマする敵や障害物をかわしながらゴールを目指してダッシュ！　ステージの最後に登場するボスを倒して８つの島を取り戻していきます。本作では基本の武器となる石オノのほか、能力の異なる４種類の恐竜が登場し、名人を助けてくれます。水中や空など、さまざまな場所で活躍してくれる頼もしい仲間とともにステージを攻略してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">高橋名人の冒険島II</span></div>
</div>
