...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574F4750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Papa, Maman, Sarah et Billy sont de retour pour se lancer dans le mini-golf !
<br>
Joue sur de nombreux parcours truffés d'obstacles variés tels que des  bosses, des rampes de vitesse, des ventilateurs et beaucoup d'autres !
<br>
Jusqu'à 8 joueurs peuvent jouer ensemble avec une seule télécommande Wii ! Découvre qui de tes amis est vraiment le meilleur sur chaque parcours.
<br>
Tu peux télécharger de nouveaux parcours pour continuer l'expérience passionnante du mini-golf. Tu découvriras des parcours de mini-golf encore plus complexes et plus difficiles à réussir.
<br>
Peux-tu réussir tous les parcours et devenir le champion du mini-golf ?
<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4750/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4750/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Family Mini Golf</span></div>
</div>
