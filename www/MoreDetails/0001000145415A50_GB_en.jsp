...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is the fourth instalment in the World Heroes fighting game series, released in 1995. In this game, 16 figures from across history fight for the title of the world's strongest. In previous instalments, the amount of time you held a button down determined the strength or weakness of an attack, but that system has been removed in this game. In addition to the more orthodox fighting game approach of allowing weak, middle, and strong attacks using different buttons, this game includes the all-new elements of the Hero Gauge, Extra Attacks, and Guard Breaker Attacks, adding an exciting new layer of strategy to the gameplay experience.</div>
  <div id="image02">
