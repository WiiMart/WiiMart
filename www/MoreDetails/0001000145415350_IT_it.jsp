...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Preparati a diventare un vero samurai in questo picchiaduro del 1994 ideato da SNK!
<br><br>
Al sistema della rabbia, molto apprezzato nel primo episodio della serie, che aumenta il potere di attacco del personaggio quando la barra è piena, si affianca ora la possibilità di utilizzare una tecnica speciale in grado di distruggere l'arma dell'avversario costringendolo a combattere disarmato. Le nuove tecniche di movimento che ti permettono di rotolare avanti o indietro e di schivare gli attacchi, completano il quadro di quello che da molti è considerato il migliore picchiaduro di tutti i tempi.
<br><br>
Una piccola chicca: la voce di Cham Cham è dell'attrice Reiko Chiba, una vera star nella comunità dei videogiochi.
<br><br>
