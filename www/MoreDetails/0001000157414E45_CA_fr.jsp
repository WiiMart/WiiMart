...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157414E45')", "wiiSelectSound()");
...
<p>
- Use your Wii Remote™ controller to drop a virtual hammer on your ants, use your Wii Remote™ controller like a metal detector to find in-game gold and much more!</div>
  <div id="image02">
