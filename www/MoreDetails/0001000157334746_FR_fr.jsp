...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157334746')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La troisième aventure de Phoenix Wright arrive sur WiiWare ! La scène de la cour continue dans TRIALS AND TRIBULATIONS. 
Des nouveaux personnages hauts en couleur, des histoires à rebondissements et un gameplay où la défense ne se repose jamais !
                                         
Le troisième jeu de la franchise populaire Ace Attorney sur DS arrive sur WiiWare !  Cinq nouvelles affaires choquantes en vue à la première personne !  Fonctionnalité “Psyche-Lock” – des témoins cachent la vérité ! Questionnez-les pour révéler les failles de leur témoignage. <br>   <br>    Deux modes de jeu :<br>   - Enquêtes – inspecter les scènes du crime, discuter avec les témoins et recueillir des preuves. <br>   - Cour – présenter ses conclusions, écouter les témoignages et interroger les témoins.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334746/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157334746/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Trials and Tribulations (Version française)</span></div>
  </div>
