...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157584250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Incarnez Ben Tennyson et déjouez le plan malicieux de Hex visant à contrôler la Terre. Grâce aux pouvoirs de l’Omnitrix, transformez-vous en 10 formes extraterrestres dont Glacial, Arachno-Singe et, pour la première fois, Aimantosaure dans la bataille contre Hex et ses subalternes.<br><br>
  
Frayez-vous un chemin à travers 15 niveaux tout en résolvant des énigmes, et luttez contre les méchants dans la toute nouvelle aventure de Ben! <br><br>
  
Entrez dans l'univers de<br> Ben 10: Alien Force, avec des personnages en 3D évoluant dans un superbe environnement en 2D!<br><br>Texte écran en français.</div>
  <div id="image02">
