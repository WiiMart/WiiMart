...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157534750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SAMEGAME is a simple yet engrossing puzzle game where you clear matching blocks in sets of 2 or more.<br><br>

Score high by clearing out more blocks at once. If you manage to clear the entire grid, you can keep on playing with a whole new layout. Getting rid of all those blocks is the key to raking in the points!<br><br>

Adjust the difficulty in a one-player game by trying different grid sizes and numbers of colors. Play it your way!<br><br>

Up to 4 players can face off in any one of 3 multiplayer modes. "Fame Game", the most straightforward choice, is similar to the one-player version. "Shame Game" turns the tables on the players, forcing them to go for the lowest score. Finally, in "Blame Game", it's a free-for-all as everyone vies for blocks on one big grid.<br><br>

Choose from different block styles, background graphics and music, to customize your playing experience.<br><br>

SAMEGAME: Easy to learn, easy to play... hard to put down!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534750/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534750/FFFD000A" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
