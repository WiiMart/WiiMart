...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157464250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sandy Beach è un gioco di costruzione di castelli di sabbia in 3D che ti consente, mediante il telecomando Wii, di creare e perfezionare maestosi castelli di sabbia. Potrai in seguito scattare foto delle tue opere e salvarle nella galleria fotografica dedicata. I giocatori possono divertirsi con il gioco cooperativo mentre realizzano il proprio castello di sabbia sul tranquillo litorale di Sandy Beach.<br>
Fai però attenzione all'invasione dei granchi! Questi piomberanno sul tuo castello di sabbia nella modalità "Battaglia dei Granchi". Costruisci il tuo castello in maniera strategica e difendilo con i cannoni dai granchi che tentano di annientare le tue imponenti creazioni di sabbia.<br>
Dopo averne garantito l'integrità, usa il metal detector per cercare tesori nascosti con cui decorare il tuo castello oppure trova cannoni aggiuntivi mediante i quali proteggerti dai granchi malvagi.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sandy Beach</span></div>
</div>
