...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Sal a la cancha en uno de los primeros juegos de voleibol creados! Selecciona entre competencias de hombres o mujeres, escoge uno de los ocho países disponibles para representar, y luego prepárate para el juego más intenso. Los simples controles incluyen todos los movimientos necesarios para dirigir tu equipo de seis personas efectivamente. ¡Tómate tu tiempo para entrenarlos y perfeccionar sus habilidades en el modo de “training” (“entrenamiento”) ya que necesitarás practicar antes de competir con los contrincantes de la computadora! O si prefieres jugar con múltiples jugadores, enfréntate a un amigo en el modo de dos Jugadores para ver quien tiene la mejor habilidad. ¡Bloquea y remata hasta llegar hacia la victoria!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146435545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146435545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Volleyball</span></div>
</div>
