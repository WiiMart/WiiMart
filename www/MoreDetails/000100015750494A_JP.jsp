...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750494A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">サーキットのピットレーンを舞台に繰り広げられる、パニックアクションゲームです。<BR>ゲーム中ではクルマはもちろん、壊れた「ナニ」かが次々とピットイン。<BR>そんな壊れた物体「ナニ」に、伝説の美人（？）ピットクルーたちが立ち向かいます。<BR><BR>操作は簡単。WiiリモコンのAボタンでクルーをつかみ、壊れたパーツで離すだけで、クルーは自動的に修理を始めます。エレガントな指示で複数のクルーを同時に操作し、自らもWiiリモコンで修理を手伝いながら、1秒でも早くナニたちをピットアウトさせましょう。<BR>ゲームには２種類のルールでプレイできるノーマルモードをはじめ、２チームに分かれて対戦するアブノーマルモードや、世界のプレイヤーたちと記録を競うランキングモードも搭載されています。各モードでは最大４つのWiiリモコンが使用できるので、家族や友だちとうまく連携をとっていけば、驚くような記録がとび出るかも知れません。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750494A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750494A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ピットクルーパニック！</span></div>
</div>
