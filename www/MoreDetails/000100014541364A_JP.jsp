...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">格闘ゲーム『ザ・キング・オブ・ファイターズ』シリーズの第３弾で、１９９６年にリリースされました。本シリーズはＳＮＫのオールスター作品ともいわれ、「餓狼伝説」「怒」「サイコソルジャー」「龍虎の拳」などの人気キャラが、世界最強の座を目指して腕を競うことになります。今回はシステム的に大幅な変更が加えられており、大中小の三種類のジャンプ、前転や後転といった緊急回避、空中ガードといった追加要素があったり、各種コマンドの見直しで技が出しやすくなったり、さらに飛び道具が弱体化したりしています。いわゆる飛び道具で飛ばして落とすという安易なセオリーが通用しなくなり、ある意味で節目といえる作品に仕上がりました。
<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ・キング・オブ・ファイターズ '96</span></div>
</div>
