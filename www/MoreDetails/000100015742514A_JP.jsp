...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742514A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ハドソンの名作シューティングゲーム「スターソルジャー」シリーズの最新作が登場。「２分」と「５分」の制限時間で得点を競うスコアアタック専用のオリジナルバージョン。突如現れた謎の敵「ブレイン軍」に対抗するために急遽開発された戦闘機「シーザー」。人類の存亡をかけた戦いが今、はじまります。迫り来る敵を撃破しながらステージ随所に配置されたアイテムでパワーアップを繰り返し、敵要塞の中枢を目指してください。大量の敵を破壊するという、本来持つシューティングゲームの「爽快感」と、高得点を目指すために何度もプレイしてしまう奥深い「戦略性」を兼ね備えたスコアアタックシューティングの決定版。獲得したハイスコアはニンテンドーWi-Fiコネクションでランキング登録することができ、リビングにいながら世界の強豪プレイヤーたちと腕を競うことができます。高橋名人も驚きのテクニックで世界ランカーを目指しましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742514A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742514A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｓｔａｒ　Ｓｏｌｄｉｅｒ　Ｒ</span></div>
</div>
