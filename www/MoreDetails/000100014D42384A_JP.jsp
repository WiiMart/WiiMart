...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">２００７年１２月に２０周年を迎えた、セガを代表するロールプレイングゲーム「ファンタシースター」シリーズの方向性を決定づけたタイトルです。前作から１０００年後、巨大コンピュータ「マザーブレイン」による管理下で高度に発達したアルゴル太陽系第２惑星モタビアから、物語は始まります。州政府のエージェントである主人公ユーシスは、人々を襲うバイオモンスター発生の謎を解くため、妹ネイや６人の仲間たちとともに調査に乗り出します。テクニック（魔法）と剣や銃、クローといった武器を駆使したアニメーション戦闘はシリーズおなじみのもの。ＳＦとファンタジーの融合した独自の世界観と衝撃的なストーリーは、当時大いに話題となり、多くのファンを生み出しました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファンタシースターⅡ<sup>TM</sup>　還らざる時の終わりに</span></div>
</div>
