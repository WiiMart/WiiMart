...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157595350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Benvenuti nella città di Sunnyville! Visita i mercatini locali per trovare oggetti e tesori nascosti, poi usa i tuoi fantastici ritrovamenti per decorare la casa dei tuoi sogni e vincere l’illustre "Superstar Homes Magazine Contest!".  Sfida il tempo o gioca in tutta tranquillità, cercando centinaia di oggetti nascosti in scenari molto divertenti. Supera sfide senza sosta in questo incredibile gioco di oggetti nascosti!
<br>
Ambientazioni avvincenti – Esplora 12 ambientazioni a tema per completare la tua missione di ricerca di tesori nascosti, incontrando diversi personaggi eccentrici lungo il cammino.
<br>
Suggerimenti segreti – Trova le stelle nascoste in ogni scenario per ottenere suggerimenti bonus e superare i livelli più velocemente.
<br>
Scenari bonus – Rivisita le ambientazioni per sbloccare missioni inedite in cui dovrai sfidare il tempo.

<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157595350/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157595350/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Yard Sale<sup>TM</sup> Hidden </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Treasures: Sunnyville</span></div>
  </div>
