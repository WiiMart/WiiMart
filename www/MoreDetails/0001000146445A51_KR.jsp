...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">패밀리컴퓨터 세대를 대표하는 캐릭터인 「쿠니오」가 대활약하는 열혈고교 시리즈 중에서도 대전 플레이가 특징적인 액션 게임으로, 전작 「열혈고교」에서 등장했던 캐릭터들이 많이 등장합니다. 이번에는 「쿠니오」의 「열혈 팀」, 「리키」의 「하나조노 팀」, 「류이치・류지 형제」의 「레이호우 팀」, 「고오다」를 중심으로 각 학교의 대표들이 모인 「각 학교 연합 팀」, 이상의 총 4팀이 펀치와 킥, 개성적인 필살기 등의 개성적인 액션을 구사하며, 4가지 경기가 열리는 운동회에서 우승을 놓고 겨루게 됩니다. 4명 동시 대전도 가능합니다. 자신만의 공략법을 찾거나 팀별 배틀도 즐겨 보세요.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146445A51/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146445A51/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">열혈고교 으라차차 대운동회</span></div>
</div>
