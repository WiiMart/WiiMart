...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000148434645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Wii Speak Channel allows Wii Friends to chat with one another or send messages with voice recordings, regardless of how far apart they may be. Watch as your Mii characters represent you on the television screen and activate "Talk Big" or "Change Voice" mode to mix up the conversation. Have a photo you want to show off? Send it to your Wii Friends during your chat and instantly share the story behind the photo. And with a maximum of four Wii consoles allowed in a chat, you'll never run short of topics to discuss. 
<p>
Download the Wii Speak Channel today and get talking!
<p>
Compatible wireless router or Nintendo Wi-Fi USB Connector and broadband access required. For more info, go to nintendo.com.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
