...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157465750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Alors que Follie se rend chez sa tante avec un chargement de graines d'Artifleur, son vaisseau est dévié de sa trajectoire et s'écrase dans une zone particulièrement triste de la planète Elilia.<br>
<br>
Aidez Follie à retrouver ses graines pour redécorer la planète de fond en comble ! Vous rencontrerez d'étranges indigènes, certains prêts à l'aider mais d'autres mal intentionnés, tels que les vilains nains de jardin !<br>
<br>
Flowerworks: Follie's Adventure est un jeu pour un ou deux joueurs qui mêle joyeusement fleurs, feux d'artifice, exploration et fun ! Trois modes de jeu vous attendent ainsi que cinq niveaux de difficulté, pour une aventure épique d'une vingtaine d'heures.<br>
<br>
Flowerworks: Follie's Adventure est une version améliorée de Flowerworks qui contient un mode deux joueurs en équipe, deux niveaux de difficulté supplémentaires et bien d'autres surprises !<br><br>Texte écran en français.</div>
  <div id="image02">
