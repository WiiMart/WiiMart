...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Trenches se despliega en Wii y no toma prisioneros. Trenches ha sido diseñado para Wii desde cero para ser una experiencia inmersiva y apasionante que da un giro al tradicional género de defensa de la torre con su propio y personal estilo. Dirige a las Fuerzas Expedicionarias Británicas como defensoras del mundo libre. Tus tropas deben tomar el campo, impedir que tu búnker sea invadido y usar las trincheras situadas en el campo de batalla para mantener posiciones en tierra de nadie. 
¡Conduce a fusileros, morteros, francotiradores, artilleros y muchos más contra los enemigos en el este! ¡Elige tus extras para personalizar el modo de jugar la campaña de un jugador o unirte a un amigo en modo cooperativo y competitivo multijugador de pantalla partida! ¡Tu guerra, tus reglas!
