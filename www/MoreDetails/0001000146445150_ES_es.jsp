...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Double Dribble es un juego de baloncesto para NES en el que se enfrentan dos equipos de cinco jugadores y que está inspirado en el juego de sala recreativa de 1986 con el mismo nombre.
<br><br>
En el juego se pueden elegir cuatro equipos diferentes y además se puede ajustar la dificultad y el tiempo del partido. ¡Plántale cara en la cancha tanto a la consola como a un amigo!
<br><br>
Double Dribble fue un juego adelantado a su tiempo, ya que incluía comentarios, secuencias de vídeo y recreaba el baloncesto real con asombrosa exactitud. Tanto si quieres recordar buenos momentos como si te lo perdiste cuando salió a la venta, ahora puedes disfrutar de este clásico en la consola virtual.
<br><br>
