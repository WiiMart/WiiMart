...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D5758')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">el mundo de miffy es un universo en 2D basado en el personaje creado por Dick Bruna. <br> En el mundo de miffy, el niño juega como Miffy, explorando diferentes lugares y llevando a cabo pequeñas búsquedas, interactuando con amigos y objetos y accediendo a una serie de minijuegos educativos.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5758/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">el mundo de miffy</span></div>
</div>
