...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B5745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Un divertido juego de objetos ocultos para niños y adultos! ¡Encuentra los objetos de cada nivel rápidamente para completar esta aventura! Colabora o compite en cada nivel para encontrar los elementos necesarios para que nuestro héroe pueda conseguir encontrar el camino de vuelta a casa. Desde conchas marinas a brillantes joyas, ¡esfuérzate al máximo para encontrar los objetos ocultos lo más rápido que puedas! Durante esta aventura también deberás enfrentarte a fantasmas e incluso a un dragón en algunos de los niveles de acción. ¡Encontrarás montones de objetos en cada nivel y sobretodo diversión a raudales en este juego de objetos ocultos!
<p>
En cada nivel pueden jugar hasta 4 jugadores para mayor diversión durante la partida. ¡Colabora con tu familia o tus amigos para completar rápidamente el nivel o compite para ver quién es el mejor en la búsqueda de objetos ocultos en cada nivel! ¡Juega y diviértete en compañía!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B5745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B5745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Adventure on LOST ISLAND -</span></div>
</div>
