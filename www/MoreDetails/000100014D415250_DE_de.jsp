...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Du schlüpfst in die Rolle von Prinz Ali, der das Goldene Armband gefunden hat. Dies gehörte einst einem Zauberer, der einen langen Krieg gegen einen bösen Machthaber führte, in dessen Besitz sich das Silberne Armband befand. Dieses wurde dazu benutzt, Chaos und Zerstörung zu verursachen; das Goldene Armband jedoch hatte die Macht, vier Geister herbeizurufen: "Dytto", den Geist des Wassers, "Efreet", den Geist des Feuers, "Shade", den Geist der Schatten und "Bow", den Geist der Pflanzen.
<br><br>
Prinz Ali reist nun durch ganz Oasis, um nach und nach die Fähigkeit zu erlangen, all diese Geister herbeizurufen und denjenigen aufzuhalten, der das Silberne Armband gefunden hat und dieses erneut zu bösen Zwecken einsetzt. Benutze deinen Verstand und deine Schnelligkeit, um an das Silberne Armband zu kommen!
<br><br>Englischer Bildschirmtext.
<br>Interlace-Modus mit dem Wii-Komponenten-Video-Kabel wird nicht unterstützt.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D415250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D415250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Story of Thor<sup>TM</sup></span></div>
</div>
