...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti en 1995, c’est le quatrième episode de la série de jeux de combat World Heroes. Dans ce jeu, 16 personnalités historiques se battent pour décrocher le titre de l’homme le plus fort du monde. Dans les épisodes précédents, le temps de pression sur un bouton determinait la force ou la faiblesse d’une attaque. Ce système a été retiré du jeu. En plus d’une approche plus orthodoxe du jeu de combat, permettant des attaques faibles, moyennes et fortes, grâce à l’utilisation de différents boutons, ce jeu inclut de tout nouveaux éléments tels que la Barre Hero, des Attaques Extra ainsi que des attaques qui cassent la garde, ajoutant une nouvelle approche stratégique à l’expérience de jeu.<br><br>Texte écran en anglais.</div>
  <div id="image02">
