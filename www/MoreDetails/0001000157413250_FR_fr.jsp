...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157413250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le célèbre jeu de puzzle de la Nintendo DS arrive sur WiiWare. Choisissez votre Mii préféré et dirigez le canon en pivotant la télécommande Wii vers la droite ou la gauche. Tirez sur des gemmes de même couleur pour les éliminer avant qu'elles n'atteignent le bout de la ligne.
<br><br>
Plongez au cœur de l'action avec les modes Partie simple et Partie simple à 2, mettez votre talent à rude épreuve dans le mode Défi, ou essayez de survivre au mode Quêtes où chaque niveau est différent.
<br><br>
Vous pouvez aussi choisir le mode Multijoueur pour deux à quatre joueurs, et jouer entre amis, avec l'ordinateur, ou les deux. Coopérez pour éliminer toutes les gemmes ou affrontez-vous pour voir qui est vraiment le champion à Actionloop Twist.
<br><br>
Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413250/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
