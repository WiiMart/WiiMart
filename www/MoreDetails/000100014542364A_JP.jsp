...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『メタルスラッグ』『メタルスラッグ２』『メタルスラッグＸ』に続く、
『メタルスラッグ』シリーズの第４弾。今回もマルコやターマといったおなじみのキャラクターが、様々な武器を駆使して戦場を駆けることになります。見所は、なんといってもよりパワーアップしたスラッグたち。これまでのメタルスラッグやスラグノイドはもちろん、スラグマリナー、ドリルスラッグ、エレファントスラッグなどの新スラッグの続々登場し、よりド派手な戦闘が楽しめます。もちろん隠しアイテム探しや捕虜救出といった要素も健在である他、選ぶルートによって、マップが分岐するといったフィーチャーもあるため、何度も繰り返して遊べことができます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルスラッグ3</span></div>
</div>
