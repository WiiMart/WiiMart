...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A retro classic from Capcom's arcade line-up in 1985, EXED EXES is a vertically-scrolling shooter that's sure to bring back fond memories. Dodge bullets! Collect fruit! And go for high scores in one of the most furious sci-fi insectoid shoot 'em ups ever made.</div>
  <div id="image02">
