...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Relax your mind with the ancient game of tiles. 
<br><br>
...
<br><br>
Sit back, relax and enjoy the endless challenge with this Mahjong game collection. Additional brain-sharpening challenges come with the extra mini-games "Memory" and "Matching".</div>
  <div id="image02">
