...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">テクノロジーが発達した近未来を舞台にした、一人称視点の臨場感あふれるボクシングゲームです。マザーコンピュータ「ゼア」による人類征服計画を知ったあなたは、計画を阻止するべく敵地に乗り込み、ボクシングで戦います。試合は１ラウンド３分で最大１２ラウンドまで。ＫＯ勝ち、または１ラウンドに３回ダウンを奪うとＴＫＯ勝ちとなり、次の対戦へ進めます。左右のジャブとパワーをためて打つストレート、フック、さらに「ダイナマイトアッパー」や「サンダーブロー」などの３種類の「必殺パンチ」を駆使して攻撃します。上下のガードと左右へのスリッピングで防御しながら、立ちはだかる敵ボクサー「マルシアノ」「ミック」「サムソン」を倒していきます。数々のテクニックを使いこなして勝ち進み、最強の敵「デジタル・チャンプ」を倒してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">デジタルチャンプ バトルボクシング</span></div>
</div>
