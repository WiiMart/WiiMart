...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SAUVEZ BLOBOLONIA!<br> Blob (de son vrai nom Blobert), visiteur intergalactique originaire de la planète Blobolonia, est à la recherche d'un jeune terrien capable de l'aider à sauver son monde natal.
<br><br>
Rejoignez-le dans une aventure palpitante! Explorez des grottes mystérieuses remplies de trésors puis partez combattre le roi maléfique sur Blobolonia. Blob adore les sucreries et change d'apparence selon le type de bonbon qu'il dévore. Utilisez ses différentes transformations afin de franchir des obstacles à première vue insurmontables!
<br><br>
A Boy and His Blob est une odyssée merveilleuse et originale pleine de rebondissements et de personnages amusants.
<br><br>
