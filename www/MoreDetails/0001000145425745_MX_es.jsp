...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juego de acción de desplazamiento de pantalla situado en la ciudad de Washington, publicado originalmente en 1991. El jugador toma el papel de un súper guerrero que debe luchar contra fantasmas del pasado traídos al presente. La característica principal de este título es la habilidad de cambiar de personaje a mitad del juego. Si liberas a un personaje encarcelado mientras luchas contra el enemigo, dicho personaje estará disponible para tu uso.
<br><br>
La clave de una estrategia victoriosa es ir cambiando entre el perro ninja, el samurai o el ninja dependiendo de la situación. Puedes, además, coger objetos como armas y orbes que te confieren la capacidad de realizar ataques mágicos. La aventura no se limita solamente al mundo real, sino que prosigue en un universo paralelo donde los escenarios se convierten en un camino frenético, sin un momento para el aburrimiento.
<p>(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425745/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
