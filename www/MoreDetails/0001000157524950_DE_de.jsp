...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157524950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In „Rainbow Islands: Towering Adventure!“ steuern die Spieler Bubby oder Bobby, die über Regenbogen-Magie verfügen, um die sieben übergangslosen Gebiete eines Turmes zu erklettern, während sie Feinde mit ihren Regenbogen-Kräften besiegen. <br><br>

Bossgegner, die vom Superwissenschaftler Dr. Crescent gesteuert werden, erwarten die Spieler am Ende eines jeden Gebietes. Spurte durch jedes Gebiet in der vorgegebenen Zeit, um den regenbogenfarbenen Kometen zu treffen!<br><br>

Das Spiel verfügt über drei Spielmodi. Du kannst die Geschichte von Hollys Kometen im Story-Modus erleben, im Challenge-Modus versuchen, angefangen bei 0 m so hoch wie möglich zu klettern, oder im Time-Attack-Modus ein Gebiet aussuchen und es im Kampf gegen die Zeit erklettern. <br><br>

„Rainbow Islands: Towering Adventure!“ ist ein fesselndes Actionspiel, bei dem du auf Regenbögen bis in den Himmel kletterst!<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
