...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158494850')", "wiiSelectSound()");
...
<br><br>Rage of the Gladiator è un gioco di combattimento fantasy in cui devi lottare per sopravvivere nell'arena. Prova la tua forza battendo tutti i tuoi avversari!<br><br>
Caratteristiche:<br>
- Uno dei più sontuosi giochi per WiiWare! Incredibile grafica 3D, animazioni, effetti luce, ombre ed effetti speciali.<br>
- Il gioco è completamente doppiato da attori e ciascun boss ha la sua personalità!  <br>
- Impara nuove mosse finali, scatena meteore infuocate e potenti tornado, oppure trasformati in un gigante!  <br>
- Personalizza il protagonista. Specializzati in tre tipi di abilità: attacco, difesa o magia, per acquisire nuovi poteri!  <br>
- Musica epica. Goditi gli adrenalinici capolavori del leggendario compositore Sean Beeson!<br>
- Una grande rigiocabilità. Completa il gioco per sbloccare la modalità Sfida, in cui i boss sono molto più potenti e hanno nuove abilità!<br>
- Supporta l'accessorio Wii MotionPlus.<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
