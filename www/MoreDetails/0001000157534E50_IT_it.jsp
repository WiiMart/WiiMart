...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157534E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dopo 16 anni, arriva il seguito più atteso: SONIC THE HEDGEHOG 4 Episode I! <br>Con elementi di gioco migliorati, compreso il classico Sonic Spin Dash e il versatile Homing Attack, Sonic 4 riprende da dove Sonic & Knuckles terminava. Con la sconfitta di Eggman, Sonic e Tails partono per una vacanza e Sonic si dedica alla scoperta di nuove aree e territori.<br> Il Dr. Eggman, intanto, ha intenzioni ben più sinistre. Furioso per la distruzione del Death Egg e per il fallimento dei suoi piani per mano di un porcospino blu, Eggman mette in atto tutti i suoi piani più malvagi. Nel tentativo di liberarsi di Sonic, perfeziona le proprie creazioni.<br> Preparati per il prossimo capitolo di una nuova saga 2D: per fan vecchi e nuovi.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534E50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534E50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SONIC THE HEDGEHOG<sup>TM</sup> 4</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Episode I</span></div>
  </div>
