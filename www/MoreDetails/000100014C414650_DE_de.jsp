...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Spiele einen bis an die Zähne bewaffneten einsamen Krieger, der auf eine streng geheime Mission geschickt wurde, um seine Kameraden aus feindlicher Gefangenschaft zu retten.
<br><br>
Bei dem in den USA als Rambo: First Blood II (in Europa als Secret Command) auf dem SEGA MASTER SYSTEM erschienenen Titel lieferst du dir wilde Gefechte mit gegnerischen Soldaten, Raketenwerfer-Trupps, Panzern und anderen Gegnern, die alles versuchen, um dich an der Rettung der Geiseln zu hindern. Du kannst dich im Kampf auf dein Maschinengewehr und deinen Compoundbogen mit Explosivpfeilen verlassen, die dir den Sieg sichern werden!
<br><br>
Räume alles aus dem Weg! Spiele mit einem Freund im Zweispieler-Modus, um doppelte Schusskraft zu haben!
<br><br>
