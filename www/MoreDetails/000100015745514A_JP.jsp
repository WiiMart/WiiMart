...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015745514A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">必要なのは「かたむきスピリッツ（バランス感覚）」だけ！Wiiリモコンを傾けてボールを操りゴールを目指そう！<BR>順番にクリアする、ランダムにステージをクリアする、タイムアタックに挑戦する…どのモードからチャレンジするかは、あなた次第！<BR>バランスWiiボードを使って、より直感的な操作が可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015745514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015745514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">かたむきスピリッツ</span></div>
</div>
