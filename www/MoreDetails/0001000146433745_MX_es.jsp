...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“¡Listos! Hut hut hut...” Nintendo ha llegado al campo de fútbol americano con el poderoso clásico juego de NES Play Action Football.  Presentando una distinguida vista aérea que casi crea un campo en 3-D, la acción es más basada en simulación que cualquier otro juego de galería de su tiempo.  ¡Juega cuartos de 15-minutos (en tiempo acelerado) y hasta substituye a jugadores cuando los jugadores en el campo se cansen!  ¿Quieres más opciones? Cada uno de los ocho equipos disponibles tienen múltiples jugadas de pases y corridas para que elijas cuando estés en la ofensiva, al igual que una gran selección de esquemas de defensiva que podrás usar cuando estés a cargo del balón.  Además de poder ver dos equipos completos en pantalla a la misma vez sin disminuir la velocidad, escucharás comentarios durante partes cruciales del partido.  ¡Forma parte del equipo, y ve si tienes lo suficiente para ganar el Power Bowl!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146433745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146433745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">NES Play Action Football<sup>TM</sup></span></div>
</div>
