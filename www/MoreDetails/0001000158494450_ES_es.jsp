...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494450')", "wiiSelectSound()");
...
<br><br>
Seis pilotos se enfrentan en un programa de TV gigante. El lord inglés, la belleza fría rusa, el desperado mejicano, la francesa excéntrica, el prodigio japonés y el buldócer americano. ¡Sea cual sea tu elección, tendrás que conducir y disparar al mismo tiempo para cruzar la línea de meta antes que los demás!
<br><br>El juego incluye:<br><br>
- Veinte emocionantes circuitos que recorrer.<br>
- Seis grandes islas temáticas que te harán sentir como en un enorme parque de atracciones.<br>
- Partidas con hasta ocho jugadores simultáneos compartiendo los mandos.<br>
- Experimenta un modo de juego completamente diferente: ¡conduce con una mano y apunta con la otra!<br>
- Una gran cantidad de contenidos adicionales: bonificaciones, trofeos y carreras contrarreloj.
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494450/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Racers' Islands</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Crazy Racers Demo</span></div>
  </div>
