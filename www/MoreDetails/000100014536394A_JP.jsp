...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">宇宙辺境警備隊の腕利き「ファイター」となって、邪悪な生命体「オクティ族」に迫害された「パケット族」を救い出すシューティングゲームです。フロア内にいるすべてのオクティを倒すと次のフロアに進めます。
方向キーによる８方向への移動で敵の攻撃をかわしながら、波動銃を使って応戦します。１ステージは６フロアで構成されており、フロア１～４は複数のモンスターが行く手を阻む「オクティ」フロア。フロア５は少数の敵しか登場しないボーナスステージ「カプセル」フロア。フロア６はボスステージの「グレート・オクティ」フロアとなっています。全８ステージ４８フロアを戦い抜いてオクティ族を壊滅させてください。また、フロアとフロアの間には「シールド」の数を増やせる「ルーレット」で運試しをすることもできます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バラデューク<sup>TM</sup></span></div>
</div>
