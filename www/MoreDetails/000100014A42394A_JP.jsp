...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">学校の七不思議をもとに血も凍るような話が展開するサウンドノベル形式のアドベンチャーゲーム。プレイヤーは６人の語り手の中から一話ずつ怖い話を聞き、それを追体験していきます。語り手を選ぶ順番や、話の途中に用意されている選択肢によってシナリオが変化します。背景や登場人物のグラフィックに実写を使用しており、プレイヤーの恐怖感を煽ります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42394A/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42394A/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">学校であった怖い話<sup>&reg;</sup></span></div>
</div>
