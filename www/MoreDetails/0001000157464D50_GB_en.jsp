...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157464D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Have fun with all your friends and family as you take on some very exciting challenges! This is an interactive board game for one to eight players of all ages. The object of the game is to complete all the challenges set by Family & Friends Party.<br>
The first to complete them all is the winner!
<br><br>
How to Play?<br>
Teams take turns to play. The team selected in each turn must complete a specific challenge. The challenge will be played by one or two players in the team depending on the type of challenge you have been given. Nevertheless, the other players in the team can help and support you. You can never get enough help!<br>
The object of the game is to complete all the challenges set by Family & Friends Party. There are six different “Single” challenges. These challenges must be played cooperatively by members of the same team.  Sometimes, Family & Friends Party will also suggest playing “Versus” challenges, which must be played competitively by all the teams at the same time.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464D50/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464D50/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
