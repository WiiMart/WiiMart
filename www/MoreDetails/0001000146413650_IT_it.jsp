...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Unisciti a Donkey Kong Jr. per un'interessante lezione di matematica! In questo gioco educativo per NES, dovrai saltare e arrampicarti per raccogliere numeri e simboli che ti serviranno per ottenere il numero indicato da Donkey Kong.
<br><br>
Metti alla prova la tua mente matematica nella modalità per un giocatore oppure sfida un amico ai numeri nella modalità per due giocatori. Metti in difficoltà il tuo avversario sgraffignando i numeri che gli servono!
...
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Donkey Kong Jr. Math<sup>TM</sup></span></div>
</div>
