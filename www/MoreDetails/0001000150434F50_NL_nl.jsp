...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit zijwaartsscrollend schietspel brengt je naar een wereld ontsprongen uit de geest van een krankzinnige demon. Je ziel is plotseling afgedwaald naar de duistere wereld die in ieders hart schuilgaat. De enige manier om te ontsnappen is je een weg te banen langs de groteske monsters die je pad blokkeren in 5 CAUSES (levels).<br><br>
Neem het op tegen de gevaren van deze psychedelische wereld met behulp van drie verschillende soorten schoten en de satellietfunctie. Door middel van powerups kun je je schoten veranderen in een waaiervormige straal, een satellietlaser en meer. Elk soort schot kan met drie niveaus worden verhoogd. Je kunt ook vijandelijk vuur afweren door de satellieten naar wens te verplaatsen.<br><br>
Gebruik deze mogelijkheden op de juiste manier om te ontsnappen uit deze vreemde en surrealistische wereld.
...
<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434F50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434F50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Psychosis</span></div>
</div>
