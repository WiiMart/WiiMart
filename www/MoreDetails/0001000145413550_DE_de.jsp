...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aus der Kampfspiel-Serie „Fatal Fury“ erscheint nun der vierte Teil, welcher erstmals 1995 als Arcade-Version veröffentlicht wurde. In der Originalversion konnte man den Kampf auf eine zweite Spielebene in den Hintergrund verlagern.<br><br>
Dieses Mal wurde der Kampf auf drei Ebenen erweitert. Man kann zeitweise beliebig von der zentralen Kampfebene auf die vordere oder die hintere wechseln.<br><br>
Durch rhythmisches Drücken der Spieltasten kannst du ganz einfach Combo-Techniken ausführen. Du wirst auch von den "Versteckten Fähigkeiten" begeistert sein, die sogar den beliebten Super-Special-Move aus früheren Spielen übertreffen. Die Special-Moves der Charaktere wurden zudem leicht verändert und sind jetzt besser als je zuvor. Genieße die verbesserte Wendigkeit der Charaktere und eine Spieltiefe, die dir eine Fülle von taktischen Möglichkeiten bietet – für knallharten Spielspaß.
<br><br>
Englischer, spanischer oder japanischer Bildschirmtext stehen zur Auswahl.</div>
  <div id="image02">
