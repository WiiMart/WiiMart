...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Scatta sul campo da hockey, evita la mischia e tira in porta il puck prima che suoni la sirena! Questo è uno dei giochi di sport più famosi di Nintendo. La ragione di tanta popolarità sta nella sua capacità di offrire un'esperienza diretta e divertente, che però richiede al giocatore anche abilità tattica per assemblare la propria squadra prima della partita. Per ogni membro del tuo team, infatti, è possibile scegliere una di tre differenti categorie di peso. Questa scelta determinerà la capacità della tua squadra di pressare l'avversario o di reagire di fronte a pericolosi contrattacchi. Alla fine del secondo tempo potresti anche assistere a uno spettacolo sorprendente...
