...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cuando el renombrado científico del siglo XXI, Doc Yoshiyama, se enamoró de una de sus creaciones de inteligencia artificial, un “C-Life”, se conectó a sí mismo a su ordenador fusionando el núcleo del programa con su ADN. Y así nació Pulseman, su "hijo", mitad humano mitad C-Life. La mente de Doc Yoshiyama se distorsionó cuando volvía al mundo real y se convirtió en el malvado Doc Waruyama. 
<br>
Pulseman tiene la habilidad de utilizar la electricidad como arma y, gracias a su ataque Voltecker, usarla como medio de transporte rápido para luchar contra el Grupo Galáctico de Doc Waruyama a lo largo de 7 excitantes fases. 
<br>
Descubre por qué este gran clásico obtuvo premios que lo encumbraron como uno de los mejores juegos publicados para SEGA MEGA DRIVE. ¡No lo dejes escapar!
<br><br>Textos de pantalla en inglés, con algunos caracteres en japonés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
