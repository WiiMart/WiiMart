...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『Ｍｉｉコンテストチャンネル』は、家族や友達そっくりのキャラクター「Ｍｉｉ（ミー）」がさらに楽しく使えるようになるチャンネルです。<BR><BR>

“投稿広場”で自分のＭｉｉを他の人に見てもらったり、他の人が作ったＭｉｉを自分のＷｉｉに持ち帰ることができます。<BR><BR>

また“コンテスト”では、テーマに沿ったＭｉｉを作って応募したり他の人が応募したＭｉｉを審査、入賞者のＭｉｉを持ち帰ることもできます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014841504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014841504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｍｉｉコンテストチャンネル</span></div>
</div>
