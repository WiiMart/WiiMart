...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Urban Champion™ est un jeu de combat dans lequel deux costauds échangent des coups jusqu'à ce que l'un d'eux tombe dans une bouche d'égout. Il est possible d'affronter un ami, et le jeu nécessite un minimum de stratégie pour éviter de se faire mettre KO trop rapidement. Si vous voulez gagner, il est vital de garder un œil sur votre jauge d'endurance, celle-ci diminue chaque fois que vous essayez de frapper votre adversaire et même si vous le manquez! Ce jeu est donc bien plus technique qu'il ne le semble au premier abord. Urban Champion™ est également apprécié pour ses nombreux détails humoristiques et ses animations.<br><br>Le texte à l'écran sera en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414E50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414E50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Urban Champion<sup>TM</sup></span></div>
</div>
