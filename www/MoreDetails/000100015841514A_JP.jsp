...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『グラディウス』シリーズでありながら異彩を放つシューティングゲーム『沙羅曼蛇』の中でも、特に大がかりなアレンジが施されているＭＳＸ版です。ゲーム内容は『沙羅曼蛇』を元にしつつ、ステージ構成、ゲームシステム、そしてストーリーにおいて、『グラディウス２』から引き継ぐＭＳＸ版独自の要素を多く盛り込んでいます。パワーカプセルをストックすることによるパワーアップのほか、ステージ上の特定の位置に現れるカプセルやアイテムを取ることで追加パワーアップが可能となり、強化装備や特殊アイテムを使うことができます。『グラディウス』シリーズでも１、２を争う難易度に対し、パワーアップをうまく使って、より優位に戦闘を繰り広げてください。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841514A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841514A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">沙羅曼蛇</span></div>
</div>
