...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157424E45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The village residents are hungry for the latest in foliage fashion, and it’s up to you—the new barber—to fix them up. Use the tools of your trade: scissors, clippers, spray can, and more, in this humorous, first-of-its-kind “first-person-groomer” game.
<p>
...
<p>
A tasty nibble of a game, it is bite-sized barbering at its finest, in only minutes a day.</div>
  <div id="image02">
