...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D4D4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「マッスル行進曲」は先頭を走るキャラクターが開けた穴をうまくすり抜け、ライバルたちを追い抜き、プロテインを盗んだキャラクターを捕まえるゲームです。<BR>穴をすり抜けることに成功すると少しずつスピードが上がるので、素早くWiiリモコンとヌンチャクを操作してください。<BR>また、他にも3回ミスをするまでに何枚の壁をすり抜けられるかを競うモードもあります。このモードは最大4人で交代しながらプレーすることができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D4D4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マッスル行進曲<sup>TM</sup></span></div>
</div>
