...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Deze bijgewerkte versie van het fotokanaal is een gratis, optionele verbetering van het originele fotokanaal en bevat de volgende nieuwe mogelijkheden en veranderingen:
<br><br>
<b>Een pictogram instellen voor het fotokanaal</b>
<br>
Je kunt nu je favoriete foto die je op een SD-kaart of op het Wii-prikbord hebt staan, instellen als pictogram van het fotokanaal in het Wii-menu.
<br><br>
<b>Ander formaat van geluidsbestanden</b>
<br>
Het muziekformaat voor diashows is veranderd van MP3 naar AAC. (AAC-bestanden bieden over het algemeen een betere geluidskwaliteit in een even groot bestand als MP3-bestanden.)
<br><br>
Opmerkingen:
<br>
- Wanneer je het fotokanaal 1.1 hebt gedownload, is het niet langer mogelijk om MP3-bestanden af te spelen. Je kunt terugkeren naar de oorspronkelijke versie van het fotokanaal door het fotokanaal 1.1 te wissen, waardoor fotokanaal 1.0 wordt teruggezet.
<br><br>
- Wii-systemen die vanaf december 2007 zijn uitgebracht, bevatten reeds het fotokanaal 1.1 en kunnen niet worden teruggezet naar fotokanaal 1.0.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000048415A41/FFFD0026" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000048415A41/FFFD0027" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fotokanaal 1.1</span></div>
</div>
