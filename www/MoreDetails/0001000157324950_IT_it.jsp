...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157324950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Benvenuto in FISHIE FISHIE, qui potrai giocare premendo un solo pulsante!<br>
Vivrai un'esperienza straordinaria che metterà a dura prova i tuoi riflessi.<br>
Il gioco dispone di vari tutorial che ti insegneranno non solo a controllare il tuo pesciolino, ma anche le diverse modalità di gioco.<br>
In FISHIE FISHIE, sarai un pesce che deve mangiare sempre. Dovrai superare le varie modalità di gioco il più velocemente possibile. Ogni secondo è prezioso.<br>
Per vincere, dovrai superare più di cento livelli distribuiti su diverse modalità di gioco: "Story (Storia)", "Soccer (Calcio)", "Capture the star (Conquista la stella)", "Survival (Sopravvivenza)", "Skill (Abilità)" e una sfida su vasta scala.<br>
Potrai giocare da solo o con un massimo di quattro persone sulla stessa console. In cooperazione o tutti contro tutti. Ogni mezzo è ammesso per vincere!
<br><br>
