...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A brand-new shooter in the “Star Soldier” tradition!
<br><br>
You’re an SIA (Special Interception Airforce) pilot flying the heavy assault fighter, “Soldier Blade”. Face the Zeograd invasion force with weapon attacks that change each time you grab a power-up item. You can unleash 3 different kinds of attack depending on the colour of the power-up item.
<br><br>
New features, such as the “Gunbody” option for avoiding enemy attacks, and the “Burst Out” system, which has a different effect depending on your power-up level, add a strategic element which requires you make snap decisions about which items to grab, and when to use special attacks.
<br><br>
Awesome boss battles await you at the end of each operation! Play in “CHALLENGE”, and try to get as many points as you can in a limited amount of time. With all these great features, things are sure to heat up!</div>
  <div id="image02">
