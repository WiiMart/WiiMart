...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Andross heeft de aanval geopend op het Lylat-stelsel en alleen Fox McCloud en het Star Fox team staan nog in zijn weg. Stap in je Arwing gevechtstoestel, Landmaster tank of Blue Marine onderzeeboot en schiet de legers van Andross aan flarden!
<br><br>
Vecht je door 15 uiteenlopende levels: door de lucht, in de ruimte, over land en onder de zeespiegel. Ontdek verborgen routes in vooruitscrollende missies en schakel over op de All Range-stand in de 360-graden missies, waarin je wilde loopings en gevaarlijke U-bochten maakt om de vijand af te schudden.
<br><br>
Lylat Wars bevat ook een VS.-stand waarbij maximaal vier spelers het tegen elkaar op kunnen nemen in drie opwindende speltypen: Point Match, Battle Royal en Time Trial.
<br><br>In het spel kan worden gekozen voor Engelse, Duitse of Franse schermteksten.
