...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La pandilla malvada conocida como "Guilty Zero" controla la ciudad y te toca a ti, como miembro de los Contratribes, deshacerte de todos sus pandilleros. Elige uno de los tres personajes diferentes y lucha contra los pandilleros en las calles de Nueva York. Avanza por el juego y elimina a los matones y al jefe de cada nivel utilizando todo tu arsenal de patadas, puñetazos, llaves y otras técnicas para derrotar a tus enemigos. Cuando tu barra de resistencia llegue a cero, podrás continuar la partida, pero las continuaciones son contadas. ¿Lograrás contener la amenaza de "Guilty Zero" y devolver la paz a las calles de Nueva York?</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A433745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A433745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Combatribes<sup>TM</sup></span></div>
</div>
