...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードで好評を博したシューティングゲーム「ギャラガ」の進化版。広大な宇宙を舞台にした全２９ラウンドを、敵本拠地「惑星ギャラガ」を目指して戦い抜きます。ゲームは数ラウンド毎に「ターン」として区切られ、背景や敵の種類が変化。さらに「ターン」の区切りでは、おなじみの「ギャラクティック・ダンシング」も健在です。また「ディメンション（次元）」という新要素が追加され、攻略ルートも選択可能。ゲーム中に出現するカプセルを集め、分岐点で「ディメンション・ワープ」を行うことで、より手ごたえのある敵にもチャレンジできます。このほかにも「トリプルファイター」への合体やスクロール面、巨大ボスの登場など、システムから演出にいたるまで、あらゆる面が大きくパワーアップされています。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041574A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041574A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ギャラガ<sup>TM</sup>’８８</span></div>
</div>
