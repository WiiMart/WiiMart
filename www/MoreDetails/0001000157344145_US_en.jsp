...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157344145')", "wiiSelectSound()");
...
<p>
SEASON MODE<br>
The Season Mode is a series of linked tournaments with 10 tournaments to play of mixed game types. The objective is to make it to the top and become Number 1 ranked. Play through each event in turn, and after each one you are awarded a world ranking position and achievement rewards.
<p>
MULTIPLAYER<br>
