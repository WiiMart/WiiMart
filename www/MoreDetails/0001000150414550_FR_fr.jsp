...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Super Star Soldier est un shoot’em up old-school à scrolling (défilement) vertical. En plus du mode NORMAL GAME, vous pouvez jouer aux modes 2 min et 5 min ainsi qu’à un mode où vous pouvez voir les meilleurs scores.<br>Il y a 8 niveaux différents dans le mode NORMAL GAME avec un boss qui vous attend à chaque fin de niveau (sauf dans le niveau 7).<br>Commandées par Mother Brain, des troupes d’élites alien ont décidé d’envahir la Terre ! Prenez le contrôle de votre intercepteur polyvalent Neo Caesar, puis à l’aide de votre arsenal composé de 4 armes classiques et de 2 armes spéciales, dispersez cette vermine extra-terrestre aux quatre coins de l’univers !<br><br>Le texte à l'écran sera en anglais.</div>
  <div id="image02">
