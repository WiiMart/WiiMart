...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157524945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En “Rainbow Islands: Towering Adventure!”, los jugadores tomarán el control de Bubby o de Bobby, quienes usan el arco iris como arma. Ellos deberán escalar las 7 divertidas áreas de una torre que llega hasta el cielo mientras se defienden de sus enemigos usando sus poderes arco iris. Terribles jefes, controlados por el genio científico Dr. Crescent, esperan a los jugadores al final de cada área. ¡Apresúrate para lograr alcanzar a Holly, la estrella del color del arco iris! Existen 3 modos de juego. Podrás disfrutar la historia de la estrella Holly en el modo historia. En el modo desafío tendrás que llegar tan alto como puedas, empezando desde el suelo. Finalmente, en el modo contrarreloj podrás elegir un área para ver cuánto tardas en llegar a la cima. “Rainbow Islands: Towering Adventure!", ¡es un alucinante juego de acción en donde usarás el poder del arco iris para llegar al cielo!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">RAINBOW ISLANDS<sup>TM</sup>:</span></div>
</div>
