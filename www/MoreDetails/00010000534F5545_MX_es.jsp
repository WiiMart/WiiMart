...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">No es posible descargar este canal.<br><br>Si quieres actualizar tus datos de guardado de The Legend of Zelda: Skyward Sword, descarga y usa elCanal Actualización de datos de The Legend of Zelda: Skyward Sword.</div>
  <div id="image02">
    <img src="/oss/ccs/00010000534F5545/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canal Actualización de datos (2)</span></div>
</div>
