...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157534145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Onslaught" es un FPS (juego de tiros en primera persona) que te sitúa en medio de una futurista guerra entro los humanos e insectos alienígenas. Te convertirás en parte de la Fuerza de Élite de Asalto Interestelar, luchando contra un enorme asalto de formas de vida alienígenas. Disfruta de la emoción de vencer oleada tras oleada de alienígenas con ametralladoras, granadas y muchas armas más. Siente como se acelera tu corazón al luchar contra gigantescos jefes alienígenas. Además del modo normal, "Onslaught" incluye modos que te permiten jugar contra rivales de todo el mundo utilizando la Conexión Wi-Fi de Nintendo. Únete a otros 3 jugadores en el Modo Batalla Libre. O compite en mapas especiales para ver quien puede conseguir la mayor puntuación eliminando enemigos antes de que se agote el tiempo en el Modo Batalla Conexión Wi-Fi de Nintendo.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534145/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Onslaught<sup>TM</sup></span></div>
</div>
