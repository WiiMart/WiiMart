...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157504950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un jeu rempli d'action qui se déroule dans le monde des circuits automobiles !
Durant le jeu, votre équipe de mécanos doit réparer des véhicules mais aussi des mystérieux CÉKOI !
Réparez les CÉKOI  avec votre équipe composée des légendaires et ravissantes mécanos (hum, hum) !<br><br>
Un système de jeu simple !<br>
Sélectionnez un mécano en l'attrapant avec le bouton A de la télécommande Wii puis relâchez le bouton lorsque le pointeur est sur une PIÈCE endommagée pour que le mécano la répare.
Contrôlez vos mécanos tout en les aidant avec la télécommande Wii pour réparer complètement le CÉKOI et le faire sortir du stand le plus rapidement possible !
Vous pouvez jouer au mode normal avec l'une des deux règles disponibles. En mode anormal, les joueurs s'affrontent en équipe. En mode classement, vous devez surpasser les records des joueurs du monde entier.
Chaque mode peut se jouer avec un maximum de 4 télécommandes Wii. Jouez en équipe avec vos amis ou en famille pour faire les meilleurs scores !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504950/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504950/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pit Crew Panic!<sup>TM</sup></span></div>
</div>
