...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">今なお人気を誇る横スクロールアクションゲーム「魔界村」の続編です。騎士「アーサー」の活躍で消滅したはずの魔界が、大魔王「ルシファー」の魔力で復活。プリンセスの魂や王国の平和を取り戻すべく、アーサーは再び戦いへと身を投じます。戦いの舞台は「処刑場」や「火炎の村」など全５面。武器攻撃とジャンプで行く手を阻む魔物を倒し、罠を乗り越えルシファーの城をめざします。各ステージの最後に出現するボスを倒すとステージクリアです。また、「金の鎧」を着ると魔法が使用可能になります。使用武器によって発動する魔法は異なりますが、敵を一掃する「雷」や２人で攻撃できる「分身」など、便利で強力な魔法がそろっています。ＰＣエンジンスーパーグラフィックス専用ソフトとして発売され、ハードの性能をフルに発揮した表現が話題となりました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015044434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015044434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">大魔界村<sup>&reg;</sup></span></div>
</div>
