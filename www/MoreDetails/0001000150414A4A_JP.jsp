...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公と仲間２人の３人組で冒険するＰＣエンジン初の本格的ＲＰＧ。仲間候補は攻撃魔法を得意とするライム、防御や回復魔法を得意とするカオス、魔法は使えないが超怪力で様々な武器を使いこなすバロン、素早い動作で武器も魔法も使いこなすマイスト、取柄はないが何か秘められた力を持っていそうなロミナの５人。それぞれ個性を持った仲間の中から、誰を選ぶかで戦闘方法が大きく変わります。この仲間たちと伝説の剣「ネクロマンサー」を探し出す冒険の旅です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">邪聖剣ネクロマンサー<sup>&reg;</sup></span></div>
</div>
