...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157344F4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">家族みんなで難問や良問にチャレンジ。対戦クイズ形式で家族そろって楽しめます。漢字問題や計算問題も含め国語、算数、社会、理科の問題２，０００問以上を厳選収録。<BR>ニンテンドーDSに接続すれば漢字の問題は書いて答え、計算の問題は数字入力で答えることができるので楽しさの幅が広がります。<BR>テレビのクイズ番組に参加するように家族で楽しめます。<BR><BR>※ニンテンドーDSを使用してプレーする場合は、人数分のニンテンドーDSが必要になります。（最大4人まで）</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157344F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157344F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">シカクいアタマをマルくする。</span></div>
</div>
