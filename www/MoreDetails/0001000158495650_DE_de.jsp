...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158495650')", "wiiSelectSound()");
...
<br><br>Denkst du, du wärst der nächste große Musik-Superstar? Mit Mix Superstar hast du jetzt alle nötigen Werkzeuge direkt zur Hand. Mit deiner Nintendo Wii kannst du deine eigenen lizenzfreien, musikalischen Meisterwerke erstellen, mixen und aufnehmen. Das Spiel bietet dir über 1 000 Dance-, Hip-Hop- und Techno-Loops mit diversen Instrumenten wie Schlagzeug, Bass, Synthesizer und Gitarre und hat sogar Gesang-und Stimmen-Tracks im Gepäck.
<br><br>
Wenn du den nächsten Hit erstellt hast, ist es an der Zeit damit anzugeben. Mix Superstar gibt dir die Möglichkeit, deine musikalischen Werke zu exportieren und auf deinen Rechner herunterzuladen, damit du sie unterwegs mitnehmen kannst. Du kannst auch über WiiConnect24 deine Hits an deine Wii-Freunde schicken und mit ihnen zusammen an den Stücken arbeiten!
<br><br>
Sowohl das USB-Mikrofon von Logitech als auch Wii Speak werden voll unterstützt, damit du deinen eigenen Gesang aufnehmen kannst.
<br><br>
Mit der Nintendo Wi-Fi Connection Pay & Play kannst du deine Erfahrung als Komponist mit weiteren Loop-Packs aus einer Vielzahl an
Genres noch erweitern.<br><br>Auf geht's, lass es krachen!</div>
  <div id="image02">
