...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Remember the timeless classic, Galaga? Say hello to its successor, as the arcade version of Gaplus hits Virtual Console!
<br><br>
...
<br><br>
The aliens are coming, and you're the only line of defence we have. Be brave, captain!</div>
  <div id="image02">
