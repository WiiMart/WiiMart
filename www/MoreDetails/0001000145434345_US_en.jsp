...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This game is an improved version of Metal Slug 2. While based on Metal Slug 2, it adds the new "Iron Lizard" weapon that chases enemies and the "Drop Shot" weapon whose shots bounce, it adds many new enemies, and it allows for readjustments of game difficulty by changing the positioning of bosses and other things. It also includes several arranged production features such as changed backgrounds and some rearranged background music. It's a solidly enjoyable gameplay experience, and Metal Slug fans might make some new discoveries if they look for differences from Metal Slug 2 as they play.</div>
  <div id="image02">
