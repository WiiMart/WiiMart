...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Participa en un total de 18 eventos Olímpicos en este título tipo acción/deportes. Los jugadores competirán en 6 categorías de eventos que incluyen tiro, tiro con arco, remo, natación, y atletismo. El juego tiene un modo de Olympics (Olímpico), en donde participarás en todos los eventos en el transcurso de unos pocos días, y un modo de Training (Entrenamiento), en donde podrás elegir eventos individuales para jugar. Tras practicar en el modo de Training, ¡ve por el oro en el modo de Olympics y bate récords mundiales! Dependiendo de tu habilidad y cuanto juegues, podrás disfrutar del juego de muchas formas distintas. Reúne a tus amigos y juega en competiciones de hasta 5 jugadores y sácale aún más jugo a este gran juego.
<p>
Para luchar con múltiples jugadores, tienes que conectar la misma cantidad mandos de Wii o Controles de Nintendo GameCube que la cantidad de jugadores. Para jugar con cinco jugadores, necesitarás al menos un Control de Nintendo GameCube.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150423945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150423945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
