...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157435350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Grab your Wii Remote and take a shot at this virtual billiard game! Enjoy “Matchups”, playing classic favourites such as “Snooker”, “9 Ball”, “8 Ball” and “Rotation”, as well as walk-through trick shots in “Puzzle” mode.<br><br>
This game offers two types of controls, allowing you to virtually “Strike” the cue ball with your Wii Remote, or use the buttons to adjust the strength of your shot and then “Strike”.
Put in time honing your skills in “Practice” mode, learning all the cool techniques you need to be a true hustler.<br><br>
Use the edit feature to create your own challenge and nail the trick shot you have always dreamed of sinking. Pull off an amazing shot and show everyone who’s the biggest shark in the pool!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435350/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435350/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
