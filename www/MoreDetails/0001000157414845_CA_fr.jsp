...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157414845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Trenches Generals deploys to the Wii console and is taking no hostages. Trenches Generals has been designed for the Wii console from the ground up to be an immersive and engaging experience, and provides a twist on the tried and true castle defense genre with its own personal style.
<p>
