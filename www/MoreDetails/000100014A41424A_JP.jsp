...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マス目の左と上に表示された数字を手がかりに、隠された絵を浮かび上がらせるパズルゲーム「ピクロス」。初心者用に遊び方を教えてくれるモードはもちろん、２人プレイで協力して問題を解いたり、難問が出題されるワリオのスーパーピクロスも楽しめます。最大マス目は２５×２５、問題数は全部で３００問と遊び応えも十分です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マリオのスーパーピクロス<sup>TM</sup></span></div>
</div>
