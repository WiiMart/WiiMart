...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750584A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">海に浮かぶとある無人島に、高飛び込みが大好きなペンギンが住んでいます。みなさんはそのペンギンとなって、スリルいっぱいのハイダイビングを楽しみましょう。<BR>落下中、次々と現れるリングをくぐると得点が入ります。得点はリングの種類やくぐった瞬間のスピードで変化します。たくさんのリングを素早くくぐり高得点を目指しましょう。<BR>操作は簡単。Wiiリモコンを左右に傾けるとペンギンが左右に移動します。小さなお子様や普段あまりゲームをしない人も、気軽に遊んでいただけます。②ボタンの加速機能と①ボタンの減速機能を使うと、さらに高得点が狙えます。<BR>ステージは氷山や洞窟など全７種類。ぶつかると失神してしまう雪山などの障害物や、おじゃまキャラクターがゲームを盛り上げます。<BR>対戦モードでは家族やお友達と一緒に、最大4人まで同時に遊ぶことが出来ます（人数分のWiiリモコンが必要です）。<BR>ルールは単純。一番多くリングをくぐった人が勝ちです。他のプレイヤーの妨害に注意してひたすらリングをくぐりましょう。<BR>１人用モードの各ステージのスコアはWi-Fiランキング対応で、全国のプレイヤーと競うことが出来ます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750584A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750584A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">みんなでとびこめ！ペンギンダイビング</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">フーパールーパー</span></div>
  </div>
