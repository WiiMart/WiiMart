...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Just when Mega Man X thought he had defeated all the Mavericks in his previous adventure, he must now lead the fight against a new threat: A band of Maverick Reploid rebels known as X-Hunters - plus eight new and deadlier Mavericks!
 <br><br>
Fortunately, Dr Light has supplied state-of-the-art upgrades. Seek out the capsules to equip X with a Double Charge Shot, Body Armour and more. X can also ride in vehicles like the Mobile Attack Armour and Mobile Attack Cycle. And of course, X can use the abilities of defeated Mavericks, to turn the enemies' weapons against them!</div>
  <div id="image02">
