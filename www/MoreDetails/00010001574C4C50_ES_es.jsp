...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C4C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Entra en el mundo de Little Tournament Over Yonder. Juega en el papel de un joven Príncipe o una joven Princesa liderando a tu equipo en numerosas batallas. Planifica y despliega tus unidades para conseguir ventajas estratégicas. Lanza batallas en tiempo real entre unidades y lucha con esfuerzo, con rapidez e inteligencia. Crea tu equipo; contrata nuevas unidades con diferentes poderes; haz que ganen experiencia en el campo de batalla para subir de nivel.
<br><br>
Este juego es una mezcla de planificación estratégica y lucha rápida en tiempo real. Es el juego para el guerrero definitivo, aquel que utiliza tanto la mente como los músculos.
<br><br>
Participa en un desafío de Torneo de un jugador para obtener la gloria o desafía a tu amigo en un combate Versus de dos jugadores.
<br><br>
