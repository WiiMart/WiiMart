...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157525550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">RUNNER: il platform action più frenetico e divertente di WiiWare!<br>
<br>
Gareggia sulla luna, abbatti pareti di cristallo e scivola sotto lumaconi lunari mangiatutto! Attraversa le Miniere robotiche e sconfiggi il Robominatore! Sfreccia nella metropoli alla ricerca dei tuoi amici, che ti affiancheranno nello scontro con il boss finale!<br>
<br>
RUNNER è il quarto capitolo della premiata serie BIT.TRIP, acclamata dalla critica.<br>
<br>
• Controlla CommanderVideo mentre corre, salta, scivola, tira calci e molto altro ancora!<br>
• Gameplay coinvolgente come non mai!<br>
• Emozionanti sfide moderne e retrò suddivise in oltre 50 livelli!<br>
• Con la partecipazione speciale del gruppo del momento: gli Anamanaguchi!<br>
<br>
Accompagna CommanderVideo nell'epico viaggio di BIT.TRIP RUNNER!<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
