...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El legendario juego matamarcianos ha vuelto! Gate of Thunder es un juego de disparos de desplazamiento horizontal que te pone en la piel del agente especial infiltrado “Hawk”, cuya misión es detener al peligroso ejército de luchadores “Obbellon”. Entrarás en acción cuando “Hawk” se suba a su nave “Hunting Dog” y se dirija hacia el enemigo.
<br><br>
Usa las 3 armas a tu disposición para abrirte paso en cada fase con la ayuda de las naves aliadas “Wild Cat”. Usa las diferentes opciones de mejora que puedes equipar para dirigir tu ataque. Tendrás que disparar por delante y por detrás para sobrevivir durante las 7 fases. ¡Los jugadores expertos en juegos de disparos que tengan ganas de un desafío pueden seleccionar los modos “HARD” o “DEVIL” para disfrutar de mucha más acción! 
<br><br>
