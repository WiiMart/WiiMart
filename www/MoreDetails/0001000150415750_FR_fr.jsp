...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Voici le nouvel opus du célèbre jeu d’arcade Galaga.<br><br> Aux confins de l’espace, pilotez à travers 29 zones pour atteindre la forteresse ennemie située sur la planète Galaga. Les niveaux sont divisés en plusieurs zones, avec des ennemis et des décors différents. Sans oublier la célèbre "Galactic Dancing" qui apparaît à la fin de chaque niveau. Grâce aux dimensions, vous pouvez désormais décider de votre trajectoire d'attaque. Récoltez les capsules pour ouvrir les "Dimension Warps" aux intersections et défiez des ennemis encore plus redoutables ! <br><br>Doté de nombreuses nouveautés telles que le triple vaisseau, les décors défilant ou encore les vaisseaux-mère Galaga, Galaga ‘90 est un chef d’œuvre au panthéon des shoot’em up !
