...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este canal es para los jugadores de The Legend of Zelda™: Skyward Sword.<BR>
<BR>
Algunos jugadores han experimentado un problema en la parte del juego donde se obtienen las estrofas del Cantar del Héroe, precisamente después de conseguir la estrofa del dragón del trueno en el desierto. Debido a este problema, los eventos relacionados con las estrofas del Cantar del Héroe en el bosque y el volcán no se desencadenan. Si tus datos de guardado se han visto afectados por este problema, no podrás avanzar en el juego. El objetivo de este canal es devolver los datos de guardado afectados a su estado normal para que puedas continuar jugando.<BR>
<BR>
Si no has jugado a The Legend of Zelda: Skyward Sword, no necesitas utilizar este canal.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435245/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canal Actualización de datos</span></div>
</div>
