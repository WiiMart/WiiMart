...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157564950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paradiso violino è un video gioco per quelle persone che amano la musica e vogliono diventare violinisti. È un gioco pensato per tutta la famiglia, in modo che quattro giocatori possano giocare simultaneamente. I giocatori possono essere: direttori d’orchestra, violinista, violinista e violoncellista, possono interpretare musica allegra o dolce musica classica.<br><br>
Il gioco include una piccola orchestra che necessita interpretazione musicale e talento dei giocatori.<br>
Da solo o con quattro persone puoi sempre vivere una nuova esperienza per ogni partita.<br>
Abbondanti e splendidi effetti visivi aumentano mentre aumenta anche il tuo impegno.<br>
Controlli semplici, ma sofisticati. Ti divertirai dall’inizio e non sarà mai abbastanza per te.
Una varietà e selezione di più di 50 pezzi musicali diversi.<br>
Iniziamo a giocare e a divertirci adesso, con uno stile particolare di musica con un tocco di funk!
