...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157574145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En el año 2013 los disturbios civiles en todo el mundo empujaron a los líderes mundiales a fusionar la policía y los militares en una sola fuerza. El Departamento de Control es una agencia de las Naciones Unidas que cuenta con tecnología secreta que estuvo escondida del público durante décadas. Existe un grupo que se opone a ella, “la resistencia”, compuesta de ex miembros militares que se negaron a unirse al Departamento. Marco es uno de ellos, y el juego cuenta su historia. Nos unimos a Marco ya que se encuentra desplegado en una misión para destruir a los dispositivos de interferencia de comunicaciones colocados alrededor de la ciudad. En la creación de este juego queremos reflejar el realismo de una guerra urbana, por lo tanto la mayoría de la época de Marco se cubre detrás de las paredes y otros obstáculos. También asegúrate de que derrotes a todos tus enemigos antes de intentes acceder a la siguiente etapa.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157574145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157574145/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">WarMen Tactics</span></div>
</div>
