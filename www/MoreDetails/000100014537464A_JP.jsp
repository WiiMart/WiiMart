...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ドラゴンと化して地上と空中の敵を撃ちながら空を飛ぶ縦スクロール型シューティングゲーム「ドラゴンスピリット」の続編です。聖剣の力によりドラゴンに姿を変えた勇敢なる２人の戦士「ヒューイ」と「シリア」を操作して、汚染された大地に巣食うバイオモンスターを倒し、平和な大地を取り戻してください。対空用と対地用ファイヤーの２つの攻撃の使い分けはもちろん、対空用ファイヤーを撃たずにドラゴンのエネルギーをためると、威力増大の「溜め撃ち」も発射可能。地上にある「卵」や点滅する敵を破壊すると取ることができるバラエティに富んだパワーアップアイテムも健在です。２人同時プレイも可能で、協力プレイの楽しさが存分に味わえます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
