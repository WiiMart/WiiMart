...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157564945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Violin Paradise es un juego diseñado para un máximo de cuatro personas. Los jugadores pueden elegir ser un director, un violinista, un violista o un chelista, ya que tienen la tarea de representar algunas de las más bellas piezas clásicas de la historia. 
<p>
El juego incluye una microorquesta, la cual ayuda a los jugadores a disfrutar de una presentación en grupo y el placer del logro. Comencemos el juego y disfrutemos de tocar música clásica y composiciones modernas de manera divertida. El ambiente de juego cambia de manera dinámica y puede enriquecerse con más objetos si juega exitosamente. Verifique el fondo y observe si el mismo cambia a medida que se juega.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
