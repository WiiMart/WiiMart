...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Double Dungeons is a dungeon RPG that features smooth-scrolling 3-D game play. Two players can play at the same time, which makes this game truly stand out from the rest. There are 22 unique scenarios, spread out among 6 levels. The higher the level is, the harder the scenario. Because each scenario is independent, you can choose to start the game from any scenario other than the final one. Defeat monsters in each dungeon to gain experience while searching for the “key” that opens the door to the room with the boss. Buy equipment at the shop, team up with characters, and defeat the boss to clear a scenario. Conquer all 21 scenarios from levels 1 through 5 to obtain passwords. Obtain all of them to make your way to the final scenario!</div>
  <div id="image02">
