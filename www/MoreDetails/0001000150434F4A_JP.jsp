...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">悪魔が創り出した精神世界を舞台にした横スクロール型シューティングゲームです。プレイヤーはサイケデリックな背景を舞台に、３種類のショットや自機オプションの「サテライト」を駆使して戦います。ショットは入手したアイテムによって変化し、それぞれが３段階までレベルアップ。「サテライト」は装備する位置を自由に変えることができ、敵に接触させながらの攻撃や防御も可能です。状況に合わせてこれらの武器を使いわけ、グロテスクな敵キャラクターが待ち構える５つのステージを突破してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パラノイア<sup>TM</sup></span></div>
</div>
