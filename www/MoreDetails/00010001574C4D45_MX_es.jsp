...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C4D45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Estas preparado para sobrevivir a todo tipo de trampas y descubrir todos los secretos de LA-MULANA?
<br><br>
LA-MULANA es el juego más completo de "acción y exploración arqueológica" jamás creado. 
<br><br>
¡Toma el control de el Profesor Lemeza y su inseparable látigo para descubrir los misterios de la Humanidad!.
Enfréntate a todo tipo de trampas, enemigos y Guardianes en la mayor aventura creada para WiiWare.
<br><br>
En LA-MULANA explorarás extensos templos y lo mas importante, tendrás sensación de una total inmersión. 
Cada mecanismo, trampa o puzle que soluciones, será un gran logro.
<br><br>
Características:
<br><br>
- El mejor juego de "acción y exploración arqueológica".<br>
- Más de 40 horas de juego.<br>
- Cientos de puzles y secretos por descubrir.<br>
- Gran variedad de armas y objetos para usar.<br>
- Usa el portátil  "Mobile Super X", para ejecutar software de ayuda.<br>
- Gran cantidad de enemigos con espectaculares guardianes.
<br><br>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4D45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4D45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
