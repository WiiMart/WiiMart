...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Con la aplicación Transferencia de datos de Wii, puedes mover conjuntamente los siguientes datos desde una consola Wii a una consola Wii U:<br><br>

• datos de guardado de programas de Wii<br>
• programas de WiiWare y sus datos de guardado<br>
• programas de la consola virtual y sus datos de guardado<br>
• contenido adicional de programas<br><br>

• Wii Points<br>
• historial de movimientos del Canal Tienda Wii<br><br>

• personajes Mii<br><br>

Para llevar a cabo la transferencia, además de una consola Wii y una consola Wii U, necesitarás lo siguiente:<br><br>

• conexión a internet<br>
• una tarjeta SD o SDHC con al menos 512 MB de espacio libre<br><br>

Advertencias sobre la transferencia de datos<br><br>

• Una vez transferidos, los datos se borrarán de la consola Wii.<br><br>

• No es posible transferir datos de una consola Wii U a una consola Wii. Una vez completado el proceso, no podrás volver a transferir los datos a la consola Wii.<br><br>

• La transferencia de datos se llevará a cabo de forma conjunta. No es posible transferirlos individualmente.<br><br>

• Los programas que vinieran preinstalados en la consola Wii no se transferirán.<br><br>

• La consola Wii U no es compatible con WiiConnect24. Las funciones de los programas que requieran el uso de este servicio ya no estarán disponibles tras la transferencia.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435450/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435450/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Transferencia de datos de Wii</span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Canal de Wii</div>
</div>
</body>
</html>
