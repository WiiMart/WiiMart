...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Únete al escuadrón y ¡cobra alas! Despega en un avión biplano y atraviesa los aros que señalan el curso de vuelo predeterminado, o planea serenamente en un ala delta aprovechando las corrientes térmicas para alcanzar las alturas. Si buscas algo un poco más emocionante, abróchate el cinturón de autopropulsión y navega a través de un campo repleto de obstáculos. Y si buscas aún más emoción, practica el paracaidismo a unos 3800 pies de altura. Cumple con objetivos específicos dentro del límite de tiempo para ganar puntos (o tal vez hasta otro turno) y obtén una certificación en ocho clases distintas. A medida que avances, tus objetivos se volverán más rigurosos y el clima hará más difícil el navegar por los aires. Si logras triunfar, tu premio será la oportunidad de pilotear un helicóptero en una misión de rescate. ¡Ponte a prueba!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A435645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A435645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
