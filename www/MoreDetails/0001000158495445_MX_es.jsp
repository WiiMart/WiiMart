...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495445')", "wiiSelectSound()");
...
<p>
Cuando se trata de disparos rápidos, sólo hay dos categorías de personas: los tiradores rápidos... ¡y los muertos! Ahora tienes la oportunidad de saber cuál es tu postura: en pie o tumbado, como podría ser el caso. Te enfrentarás a los mejores tiradores rápidos en ese negocio, incluyendo a uno de los más rápidos del mundo, Wes Flowers. ¡Desenfunda tu Wii Remote y enséñeles quién es verdaderamente el tirador más rápido en ese tiroteo de acción en vivo! Incluso puedes enfrentarte a un amigo en modalidades de multijugadores y ver quién dispara más rápido. Necesitarás una velocidad considerable y una precisión impresionante para enfrentarte a esos tiradores... ¡Entonces, prepárete para un poco de acción real de disparo rápido!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495445/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495445/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
