...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Algunos clásicos nunca mueren! Alien Crush es un juego de pinball con una acción de pinball muy realista y unos gráficos “biomecánicos” soberbios. Completo y con una función para golpear la máquina, ¡este juego te hace sentir como si jugaras al de verdad! ¡Las bolas extras y los puntos de bonificación son la clave para conseguir grandes puntuaciones! Aparte de la Pantalla Principal, hay también toda clase de Pantallas de Bonificación, como “Ciempiés”, “Alien”, “Ojos” y “Calavera”. Todas estas emocionantes y complicadas pantallas tienen sus objetivos, y si los completas, ¡te darán enormes bonificaciones!<br>¡Lleva a cabo montones de trucos mientras disfrutas de una intensa acción de pinball!<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
