...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">サッカー、ラグビー、アメフトなどのスポーツが合体した、前代未聞のネオスポーツゲーム。柔道、カポエラ、ボクシングといった世界各国の格闘技のエキスパートチームが勝ち抜き戦に挑戦します。ボールを相手陣地へ運んでゴールもしくはタッチダウンすれば得点、それ以外の難しいルールは一切なし。ドロップキックやクロスチョップ、過激な空中殺法など、ボールを奪うためなら選手同士の接触は無制限です。スピード、パワー、スタミナなど試合の流れを左右するさまざまな要素も考慮しつつ相手ゴールをめざしましょう。コンピュータ戦はもちろんですが、特にプレイヤー同士による２Ｐ対戦での白熱したバトルはメガドライブ史上屈指の面白さと、高い評価を得ている名作です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43424A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">レッスルボール<sup>&reg;</sup></span></div>
</div>
