...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157494E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「直感！ばらんす★らびりんす」は、Wiiリモコンを傾けて、入り組んだ迷路を抜けてゴールを目指すアクションパズルゲームです。バランス感覚を必要とするので、頭だけでなく、体も使って家族みんなで楽しめる内容です。バランスWiiボードにも対応しており、自分の体重を使ってゲームを進めていくこともできます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157494E4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157494E4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">直感！ばらんす★らびりんす</span></div>
</div>
