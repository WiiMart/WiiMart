...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gedurende vele jaren was Gunstar 9 een vredige planeet. Totdat de wrede dictator, Colonel Red, de oudere broer van de Gunstar-tweeling ontvoerde en, met behulp van gedachtebeheersing, tot zijn slaaf maakte. Neem het op tegen tal van verschillende vijanden en eindbazen, en weerhoud de dictator ervan zijn “Golden Silver the Destructor” te gebruiken en de planeet te vernietigen!<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans<br>Het spel is voorzien van Engelse schermteksten.<br>Geen ondersteuning van de interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Gunstar Heroes<sup>TM</sup></span></div>
</div>
