...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡La popular e imperecedera saga Castlevania regresa con un nuevo capítulo repleto de acción que retoma la épica lucha entre el legendario clan Belmont y las fuerzas de las tinieblas lideradas por el mismísimo conde Drácula! Un clásico atemporal considerado como uno de los mejores capítulos de la saga gracias a sus detallados escenarios, su magistral ajuste de dificultad y su inolvidable banda sonora.
<br><br>
Guía al cazavampiros Richter, el heredero del clan Belmont, a través de 13 intensas fases llenas de trampas mortales y secretos por descubrir. Empuña el legendario látigo transmitido de generación en generación y emplea una serie de objetos y de poderosos ataques especiales para acabar con la amenaza de Drácula y sus hordas maléficas.
<br><br>
Además, si rescatas a Maria Renard, que se encuentra prisionera en algún lugar desconocido, ¡podrás elegirla como personaje jugable! ¡Cazar vampiros nunca había sido una experiencia tan divertida!
<br><br>
Textos de pantalla en inglés, con algunos caracteres en japonés.</div>
  <div id="image02">
    <img src="/oss/ccs/000100015141504C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141504C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">CASTLEVANIA </span></div>
</div>
