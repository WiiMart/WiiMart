...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prepárate para disfrutar de toda la acción de un deporte extremo en 1080°: TenEighty Snowboarding. Este clásico de Nintendo 64 es uno de los simuladores de snowboard más fieles y sencillos de manejar, ¡y te permite disfrutar de este deporte desde la comodidad de tu sofá!
<br><br>
1080° Snowboarding cuenta 
 con seis enormes circuitos
 llenos de sitios en los que 
 realizar las más de veinticinco 
 acrobacias posibles. Dispondrás
 de seis modos de juego
 diferentes: desde el eslalon
 paralelo contra la consola
 o contra un amigo hasta la contrarreloj,
 pasando por el modo acrobacias y el 
 modo práctica, que te permitirá 
 perfeccionar tus movimientos.
<br><br>
Unos asombrosos gráficos en 3D (que representan a la perfección diferentes condiciones atmosféricas, reflejos y distintos tipos de luz) y una banda sonora ambiental completan este juego de deportes de invierno con el que cualquiera puede disfrutar.
<br><br>Textos de pantalla en inglés, alemán, japonés o francés.<br>La función de vibración del juego original no está disponible.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414F50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414F50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">1080°<sup>TM</sup>: TenEighty </span></div>
</div>
