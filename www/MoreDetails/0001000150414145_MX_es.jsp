...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Bomberman ‘93, la emocionante y mejorada versión que siguió al Bomberman original!  ¡Con 8 rondas en 6 pantallas, el Modo Normal para un jugador, con sus 48 rondas diferentes, te ofrecerá toda la diversión que necesitas! Revienta a todos tus enemigos y encuentra la salida antes del tiempo límite para pasar a la siguiente fase.  ¡Por primera vez, la función  patada” aparece en esta versión de Bomberman y puedes usar tácticas realmente astutas durante tu partida! ¡Usa las trampas y nuevos objetos a tu favor para terminar el juego con un récord perfecto! Hasta 5 jugadores pueden jugar en el Juego de Batalla, ¡Y todos los nuevos trucos y mecanismos (como la cinta transportadora) garantizarán una batalla reñida!<p>Al luchar con múltiples jugadores, debes conectar la misma cantidad de Controles Remotos Wii o Controles Nintendo GameCube que el número de jugadores. Para jugar con 5 jugadores, necesitarás al menos 1 Control Nintendo GameCube.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
