...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スーパーファミコン版がんばれゴエモンシリーズの第二弾。主人公の「ゴエモン」、相棒の「えびす丸」、そしてに新たにからくり忍者の「サスケ」が加わり、３人で冒険を進めます。ダメージを受けてライフゲージが無くなるとプレイヤーアウト、チャレンジ数が０になるとゲームオーバーです。「町ステージ」で情報やアイテムを入手し、「道中ステージ」の横スクロールアクションを制限時間以内にクリア、「城ステージ」のさまざまな仕掛けを突破して、城を支配するからくりメカを倒してください。また本作から巨大ロボットの「ゴエモンインパクト」が登場。敵基地をなぎ倒してゆく「高速インパクトステージ」や、迫り来る巨大ロボをやっつける「インパクトボスステージ」は迫力満点。前作以上に、さまざまなおバカな要素が盛り込まれています。２人同時プレイにも対応しています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">がんばれゴエモン<sup>&reg;</sup>２</span></div>
</div>
