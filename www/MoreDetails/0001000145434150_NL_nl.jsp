...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“Real Bout Fatal Fury 2: The Newcomers” is gebaseerd op dezelfde spelmechanismen van de vorige delen en biedt een verbeterde versie van de 2-lijnen strijd alsook vele nieuwe features, zoals “Break Shot”, waarbij een block kan worden geannuleerd voor verscheidene manoeuvres. Daarnaast zal een personage’s sway line oplopen naarmate deze blijft lopen en wanneer een personage wordt neergehaald zal deze weer snel op zijn voeten komen te staan als de speler de meter en knoppenactie precies goed timet.
Er zijn 2 nieuwkomers: de kung-fu meester Li Xiang Fei en de bokser Rick Strowd. Geese Howard zal ook weer verschijnen als speelbaar personage. Kies uit 22 vechters en test je skills!
