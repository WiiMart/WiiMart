...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157465850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">C'est surtout pendant la saison froide que l'on rêve de se prélasser devant un bon feu de cheminée. Mais tout le monde n'a pas cette chance. Ton nouveau WiiWare Feu de bois chaleureux apporte une touche de magie et d'intimité à l'ambiance de la pièce !
<br><br>
Choisis les bûches et empile-les avec la télécommande Wii. Il ne te reste plus qu'à gratter l'allumette pour que ton salon se remplisse immédiatement d'une ambiance chaleureuse. Tu peux choisir parmi six foyers : feu pur, feu de camp, cheminée rustique, cheminée classique, cheminée élégante ou zen.<br>
Attise et entretiens le feu pour qu'il ne perde pas de sa puissance. Ajoute de nouvelles bûches qui se consument comme dans un vrai feu. Tu as juste envie de te relaxer ? Pas de problème : le mode Majordome ajoute automatiquement de nouvelles bûches et le mode Nonstop utilise des bûches qui ne se consument pas.
<br><br>
Un crépitement chaleureux et des flammes vacillantes pour un plaisir incomparable - et pas seulement en hiver !

<br><br>
-  6 foyers : feu pur, feu de camp, cheminée rustique, cheminée classique, cheminée élégante ou zen<br>
-  Ambiance sonore douce<br>
-  Moteur physique réaliste grâce à la technologie PhysX® by NVIDIA<br>
-  4 modes de jeu : Majordome (les bûches s'ajoutent automatiquement), Nonstop (les bûches ne se consument pas), Standard (feu préparé dans une cheminée au choix), Individuel (choix des bûches et placement personnalisé dans la cheminée)<br><br>
Texte écran en français.</div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Feu de bois chaleureux</span></div>
</div>
