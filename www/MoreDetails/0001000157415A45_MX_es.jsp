...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157415A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Todos a bordo! Mejora tu intelecto y ¡embárcate en una búsqueda épica a bordo de The Amazing Brain Train! Impulsado por tu energía mental, ¡el Brain Train del Profesor Fizzwizzle te llevará en una aventura para aumentar tu cerebro! ¡Prueba tu mente poderosa y veamos hasta qué punto puedes llegar!<br>
• 15 juegos de entrenamiento cerebral en 5 categorías:<br> 
*Buscar - Encuentra la solución, ¡más tu talento escondido!<br>
*Planificación - Piensa por delante, ¡a la victoria!<br>
*Espacial - ¡Serás un maestro de la manipulación mental!<br>
*Memoria - ¡Aprovecha al máximo su potente memoria!<br>
*Números - ¡Hazte un ninja numérico<br>
• Tres formas distintas de jugar<br>
• Toneladas de características extra<br></div>
  <div id="image02">
    <img src="/oss/ccs/0001000157415A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157415A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Amazing Brain Train!</span></div>
</div>
