...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気の横スクロール型シューティングゲーム『グラディウス』を元にＫＯＮＡＭＩ自身がパロディとして作り出した『パロディウス』シリーズの元祖で、今もなお高い評価を受けているシューティングゲームです。“夢と希望のプログラマー”である「タコ」が地球に夢を取り戻すため、４人のスペースファイターとともに、敵である「バグ」退治に立ちあがります。『グラディウス』シリーズおなじみのパワーカプセルによるパワーアップのほか、さまざまな色のカプセルやベルを取ることで、残機が１機増えたり、一定の間時間を止めたりザコには無敵になるなど、バリエーション豊富なパワーアップが可能です。またスペースファイターたちには、「ゴエモン」や「ビッグバイパー」など他のＫＯＮＡＭＩゲームの主人公たちが登場。タコを含む５人の中から、好きなキャラクターを選んで出撃できます。パワーアップをうまく利用して最終ステージで待つボス「バグ」を倒してください。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000158414B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158414B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パロディウス</span></div>
</div>
