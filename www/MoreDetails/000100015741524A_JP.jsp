...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015741524A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">囲碁のルールを知らない入門者から、さらなる棋力の向上をめざす有段者まで楽しめる、囲碁講座や問題を中心とした本格囲碁ソフトです。<BR><BR>
本ソフトには講座に即した練習問題と、ヨセや詰碁、布石、攻め合いなどの総合問題集があわせて２７００問以上収録されています。<BR>
初級向けのコンピュータとの練習対局や、Ｗｉｉリモコン１つでの２人対局もできるので、対局しながら棋力を高められます。<BR><BR>
またニンテンドーＷｉ－Ｆｉコネクションを使って、全国のプレイヤーと対局ができます。<BR>
熟練度に応じて対局相手を選ぶことができますので、実力が近い人と気軽に対局が楽しめます。フレンドとの通信対局も可能です。<BR><BR>
※講座・講座内問題はパソコン向けソフト「囲碁塾」、総合問題集は同じく「棋力アップシリーズ」、定石集は同じく「お気軽囲碁対局Ⅳ」に収録された内容をこのソフト向けに再編集したものです。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015741524A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015741524A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">通信対局　囲碁道場２７００問<sup>TM</sup></span></div>
</div>
