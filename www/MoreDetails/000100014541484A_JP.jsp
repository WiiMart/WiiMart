...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９２年にリリースされた、メジャーリーグを意識した野球ゲームです。「ベースボールスターズ　プロフェッショナル」の続編にあたり、プレイヤーは自分のチームを選んで、全世界にまたがる架空の２リーグ１２チームの頂点をめざします。ボタン連打で走塁がスピードアップ、オート守備にすれば慣れないうちでも白熱したゲーム展開に。長打が期待できる「パワーバット」を選手に持たせることができたり、信じられないほどの剛速球を投げるピッチャーが登場したり、オーナーの意向で１打席だけ登場する「スペシャルプレイヤー」が出現したりと、とにかくパワフルでダイナミックな野球が楽しめます。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541484A/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541484A/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ベースボールスターズ２</span></div>
</div>
