...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Final Soldier è uno sparatutto a scorrimento verticale appartenente alla famosa serie Star Soldier.
Nel 23esimo secolo alcuni invasori provenienti dal futuro attaccano improvvisamente la Terra. A bordo di un caccia costruito dagli scienziati terrestri ti alzi in volo per affrontare il nemico.
<br><br>
Raccogli unità di potenziamento, quali laser, lanciafiamme e missili, ed equipaggia la tua nave per sferrare diversi tipi di attacco. Per ognuna di queste armi potrai scegliere fra tre configurazioni diverse. Anticipa i colpi del nemico e alterna le armi con destrezza per respingere i tuoi avversari. Oltre alla modalità di gioco normale, potrai realizzare punteggi record servendoti delle modalità 2 MINUTE GAME (Gioco in 2 minuti) e 5 MINUTE GAME (Gioco in 5 minuti). Final Soldier è una miscela equilibrata di tutti gli elementi che caratterizzano la serie: un appuntamento imperdibile!
<br><br>Il testo all'interno del gioco è in inglese e parzialmente in giapponese.</div>
  <div id="image02">
