...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F4C4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"ルールは簡単、でも奥が深くて誰でもハマれる"、世界中で楽しまれている「オセロ」がWiiウェアに登場。<BR>1人でコンピュータと対戦したり、2人でオセロの対戦を楽しむことができるのはもちろんのこと、ニンテンドーWi-Fiコネクションに接続して無料で通信対戦が楽しめます。<BR><BR>◆1人でオセロ<BR>１人で１０段階の強さのコンピュータを相手にじっくり「オセロ」が遊べます。<BR><BR>◆2人でオセロ<BR>１台で２人対戦が楽しめます。<BR><BR>◆Wi-Fiでオセロ<BR>ニンテンドーWi-Fiコネクションに接続して、離れた場所にいる友達や見知らぬ人たちと通信対戦が楽しめます。<BR>通信対戦の結果は記録され、成績によって段位や称号が手に入ります。<BR>また、対戦成績をランキングに登録して、勝利数などを競うことも可能です。<BR><BR>1人でも2人でも、通信対戦でも、「オセロ」を思う存分楽しめます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4C4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4C4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">オセロ</span></div>
</div>
