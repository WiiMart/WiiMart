...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este es un juego de carreras diferente, en el que dirigirás a dos policías de la unidad especial Chase H.Q. del NYPD, persiguiendo criminales a toda velocidad e intentando sacar sus coches de la carretera.
<br><br>
La primera mitad de cada fase consiste en conducir tu coche en una acelerada persecución, seguida de una secuencia de acción en la segunda mitad. Una vez alcances el vehículo buscado activarás tus luces y sirenas, para a continuación intentar detener al delincuente chocando contra él.
<br><br>
Usa las distintas marchas de forma inteligente, maniobrando a través de calles llenas de tráfico y curvas pronunciadas. ¡No choques contra nada, o perderás velocidad! También tendrás a tu disposición las unidades turbo, que durante un tiempo te proporcionarán mayor velocidad y más potencia para desplazar otros vehículos. 
<br><br>
