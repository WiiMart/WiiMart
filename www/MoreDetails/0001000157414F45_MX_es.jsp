...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Very Hungry Caterpillar's ABCs (El ABC de la pequeña oruga glotona) es un juego educativo, basado en el libro para niños The Very Hungry Caterpillar, que permite a padres y niños familiarizarse con el inglés básico mientras disfrutan juntos de una partida.
<p>
El juego consta de 4 modos e incluye un divertido alfabeto con coloridas letras e ilustraciones de Eric Carle, y un cuestionario de palabras diseñado para niños de preescolar que incluye sustantivos como números, colores, formas y nombres de animales, también se incluyen verbos y adjetivos como “run” (correr), “eat” (comer) y “big” (grande). Los jugadores jóvenes también pueden participar en divertidas actividades tales como borrar partes de una pantalla a color para mostrar una ilustración oculta o poner una cantidad de imágenes de animales en la pantalla. Los padres pueden usar el menú “To The Parents” (Para los padres) para comprobar el progreso del niño en el aprendizaje de las palabras del vocabulario.
<p>
Toda la familia disfrutará con las ilustraciones llenas coloridas de Eric Carle, el internacionalmente aclamado autor de ilustraciones para libros infantiles.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414F45/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414F45/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Very Hungry</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Caterpillar's ABCs</span></div>
  </div>
