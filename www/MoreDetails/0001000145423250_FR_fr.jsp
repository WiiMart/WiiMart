...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jeu de combat sorti en 1997, c’est le sixième episode de la série Fatal Fury. Reprenant le système des volets précédents, il introduit, entre autres, un système évolué de combat sur deux plans, améliore la jauge de puissance et supprime la sortie du ring, permettant ainsi une plus grande diversité de stratégies. En plus des 15 personnages de l’épisode précédent (Geese mis à part), Tung Fu Rue, Cheng Sinzan, Laurence Blood et Wolfgang Krauser viennent s’ajouter au casting.19 personnages véritablement spéciaux, qui vont se battre pour déterminer le plus fort d’entre eux.
