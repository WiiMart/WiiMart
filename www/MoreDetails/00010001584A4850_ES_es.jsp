...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001584A4850')", "wiiSelectSound()");
...
<br><br>
Plaint Splash convierte tu TV en un lienzo interactivo en el que niños de todas las edades pueden disfrutar pintando con el Wii Remote. Hasta cuatro personas pueden dibujar al mismo tiempo, permitiendo que toda la familia participe en la creación de pinturas fantásticas usando simplemente los Wii Remotes.
<br><br>
Escoge entre diferentes pinceles y herramientas y punta en todos los colores del arco iris, o activa el Modo Splash, en el que basta con agitar el Wii Remote para pintar en la pantalla - el modo ideal para los más pequeños de la casa.
<br><br>
Puedes guardar tus pinturas en una tarjeta SD y copiar tus creaciones a otros aparatos como un ordenador, para imprimirlas o mandarlas por correo electrónico.
<br><br>
