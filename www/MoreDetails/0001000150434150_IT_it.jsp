...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In questo sparatutto in prima persona in tempo reale dovrai avanzare in una labirintica stazione spaziale e sconfiggere i micidiali mostri che l’hanno invasa.
<br><br>
Sei un membro dei DEBUGGERS, un gruppo di soldati d’élite che sono stati inviati a compiere un’ispezione su una stazione spaziale disabitata. Hai a disposizione 100 minuti per entrare, distruggere i mostri presenti in ciascuna sezione, raggiungere il livello centrale e disattivare il meccanismo di auto-distruzione.
<br><br>
Ogni mostro che ti lasci sfuggire rende la sezione centrale più pericolosa, quindi dovrai agire rapidamente per liberare ciascuna sezione.
Lotta per sopravvivere mentre il tempo scorre inesorabile e scopri la verità sugli eventi che sono accaduti nella stazione spaziale!
