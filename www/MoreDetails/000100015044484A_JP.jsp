...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードで人気を博した「ラスタンサーガ」の、シリーズ２作目となるサイドビュータイプのアクションゲームです。ある時、大地を治める力を秘めた「賢者の石」が、魔族によって持ち去られてしまいました。この世が魔族に支配されるのを阻止するため、プレイヤーは一人の若者「ラスタン」となり、天空にそびえる神殿「スカイ・スクレイパー」に向かいます。それぞれのステージでは、襲い掛かる魔物を倒しながら、タイマーが０になるまでにボスを倒し、賢者の石を取り戻さなければなりません。冒険の途中では、敵を倒したり特定の場所を攻撃することでアイテムが出現します。アイテムには体力やタイマーを回復するものをはじめ、ラスタンの装備を変更したり強化できるものもあるので、これらをうまく活用することが攻略のポイントです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015044484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015044484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">RASTAN SAGA<sup>&reg;</sup> 2</span></div>
</div>
