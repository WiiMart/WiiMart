...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paru en 1991, ce jeu de base-ball est d'un genre tout à fait unique. Dans un futur proche, le base-ball a pris un aspect cybernétique et le championnat se compose de douze équipes divisées en deux ligues. Tous les matchs ont lieu dans le stade <br>« Cyber Egg », où l'aire de home run est particulièrement petite tandis que la surface de jeu est inhabituellement grande. Entre autres particularités, le terrain comporte des zones d'arrêt qui immobilisent toute balle y atterrissant, ainsi que des mines paralysantes apparaissant au fil de la partie. Il est également possible d'acheter des armures spéciales qui servent à améliorer les capacités des joueurs. Une fois passée la surprise des premiers instants et après avoir maîtrisé les particularités de ce jeu, vous en viendrez à apprécier tous les rebondissements !<br><br>Texte écran en anglais.</div>
  <div id="image02">
