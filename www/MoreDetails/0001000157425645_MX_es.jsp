...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157425645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Llega a todo gas SPOGS Racing™, un nuevo juego de carreras de D2C Games™ en el que encontrarás carreras arcade clásicas, controles sencillos de manejar, vehículos novedosos y mejoras instantáneas con Crash N’ Grab™ (choca y agarra). Móntate en el vehículo, ponte en marcha, y modifica tu bólido mientras compites contra otros jugadores en una experiencia de carrera totalmente extravagante en tu consola Wii™. Tanto si eres un jugador casual como un piloto empedernido, SPOGS Racing™ tiene diversión para todos y es una descarga imprescindible para tu biblioteca digital de juegos de WiiWare™.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157425645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157425645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
