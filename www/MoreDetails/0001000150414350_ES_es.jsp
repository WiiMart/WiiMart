...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dungeon Explorer es un action RPG multijugador donde hasta 5 jugadores pueden jugar a la vez. La historia sucede en mazmorras subterráneas y puedes escoger entre 8 tipos diferentes de personajes : Fighter (Guerrero), Thief (Ladrón), Warlock (Hechicero), Witch (Bruja), Bishop (Obispo), Elf (Elfo), Bard (Bardo), o Knome (Enano). Dependiendo del personaje, los tipos de magia que puedes usar, tu poder de ataque y tu movimiento variarán. Para sobrevivir, debes conocer todo sobre los puntos débiles de tus enemigos. También deberás saber los atributos especiales de cada hechizo mágico y usarlos de la forma más ventajosa. En partidas en equipo, trabajar juntos es la clave para la victoria.<br><br>Para luchar con varios jugadores, tienes que conectar tantos mandos de Wii o mandos de Nintendo GameCube como jugadores haya.<br>Para jugar con cinco jugadores, necesitarás al menos un mando de Nintendo GameCube.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
