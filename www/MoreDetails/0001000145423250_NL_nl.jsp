...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit is een vechtspel dat uitgegeven werd in 1997. Het is het zesde deel in de Fatal Fury serie. Het systeem is gebaseerd op vorige delen van de serie en dit deel wordt er ook een geavanceerder twee-lijnig gevecht geintroduceerd, is het krachtmetersysteem verbeterd, het “uit-de-ring”-systeem afgeschaft en zijn er nog meer aanpassingen aangebracht die er voor zorgen dat je meer uiteenlopende strategieën kunt toepassen. Naast de 15 personages van vorige delen (behalve Geese) hebben ze ook Tung Fu Rue, Cheng Sinzan, Laurence Blood en Wolfgang Krauser toegevoegd aan het totale raster van 19 personages die allemaal de titel “Special” eer aan doen. Ze zullen het hier uit moeten vechten om te bepalen wie er de krachtigste vechter is.
<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145423250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145423250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">REAL BOUT FATAL FURY SPECIAL</span></div>
</div>
