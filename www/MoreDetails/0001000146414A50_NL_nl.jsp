...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sprint over het ijs, vermijd de opstootjes en schiet de puck in het net voordat de periode is afgelopen. Ice Hockey is een van de meest geprezen sportspellen van Nintendo. De reden hiervoor is dat het een opwindende maar rechttoe rechtaan spelervaring biedt. Toch is hierbij nog een flinke dosis tactisch inzicht nodig, omdat je aan het begin van de wedstrijd je eigen team moet samenstellen. Voor elke speler uit je team kun je kiezen uit drie verschillende gewichtsklassen. Dit heeft invloed op de druk die jouw team uit weet te oefenen en de snelheid waarmee het weet te reageren op gevaarlijke counteraanvallen. Bovendien krijg je aan het eind van de tweede periode zo nu en dan een verrassende show voorgeschoteld.
<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ice Hockey</span></div>
</div>
