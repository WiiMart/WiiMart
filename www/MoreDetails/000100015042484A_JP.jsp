...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公が「石頭」を武器に大活躍する、好評の「ＰＣ原人シリーズ」第２弾です。さらなる繁栄を遂げた「恐竜王国」を舞台に、おなじみの「ＰＣ原人」をあやつって
敵の親玉「キングタマゴドン３世」に立ち向かいます。ゲームは「ジャンプ」と「ボンク（頭突き）」を武器に、敵の攻撃をかわしながらゴールを目指して進んで行く、横スクロールタイプのコミカルアクション。前作と同様に、原人はステージ上に出現する「肉」を食べると２段階に変身し、攻撃力も２倍、３倍とパワーアップします。ゲーム中に隠されているボーナスステージは全部で８種類。これに加えて、ボスを倒した後に出現する「恐竜列車」のグレードは、それぞれのラウンドで集めた「スマイルマーク」の数で変化します。「三角跳び」や「大車輪」など新たなアクションも追加され、バラエティーに富んだ全７ラウンドの冒険が繰り広げられます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042484A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042484A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＰＣ原人２</span></div>
</div>
