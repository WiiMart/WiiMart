...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dans ce jeu d’action à défilement vertical sorti en 1992 par ADK, vous incarnez l'un des trois personnages suivants: Joe (de la famille des ninjas de Koga), Rayar (combattante maîtrisant les techniques ninjas d’Iga) et Ryu (descendant de Kotaro Fuma). Traquez Spider à travers sept époques différentes (l’âge de pierre, l’Egypte des pharaons, l’ère Sengoku, etc.) et empêchez-le de plonger le monde dans le chaos!
<br><br>
Découvrez une variété incroyable d'attaques! Chaque héros dispose d’un tir normal, d’un coup spécial infligeant des dommages à tous les ennemis présents à l’écran, ainsi que d’une technique ninja pouvant être activée grâce à une combinaison précise. De plus, si vous parvenez à trouver trois peintures japonaises, votre personnage acquiert la faculté de se transformer en bête féroce capable de porter des attaques dévastatrices. 
<br><br>
Accomplissez votre mission seul ou demandez à un ami de vous rejoindre dans cette quête défiant les limites du temps!
<br><br>
