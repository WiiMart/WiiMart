...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公「クロービス」を操作し、ドラゴンにさらわれた「セリア姫」を助け出す、横スクロール型アクションゲーム。冒険の舞台となるのは、ドラゴン山までの分かれ道や、魔物がひそむ洞窟、墓場、塔などのダンジョンです。最終目的地のドラゴン山に待ち受けるドラゴンを倒してください。クロービスは剣を振り、手に入れたスクロール（呪文書）でファイヤーボールを駆使します。バラエティに富んだ敵キャラクター、さまざまな効果を持つアイテム群、「かぶと割り」「垂直斬り」に代表されるテクニックなど、今でもたくさんのファンを持つゲームです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドラゴンバスター<sup>&reg;</sup></span></div>
</div>
