...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ordyne es una nueva versión del popular juego de acción que incluye un modo de juego cooperativo simultáneo para 2 jugadores así como imágenes impresionantes y música de fondo pegajosa.  El malvado Kubota ha secuestrado a la novia del Dr. Tomari, Kana, y se ha llevado el gigantesco reactor nuclear Ordyne. Para recuperarlos, el Dr. Tomari y Felix su asistente toman sus naves de combate y se dirigen a perseguirlos.  Esquiva enemigos y avanza a través de 7 niveles diferentes que se desarrollan en tierra, mar y aire. Reúne los Cristales de enemigos vencidos y úsalos para comprar objetos o adiciones para tu nave en el Space Inn.  ¿Tienes lo necesario para vencer al líder en el final de cada nivel y alcanzar a Kubota en el último nivel, Kubota World?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150413845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150413845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ORDYNE<sup>TM</sup></span></div>
</div>
