...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157464E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fish Tank ist eine Mischung aus Match 3- und Puzzle-Spiel. Der Bildschirm scrollt dabei nicht vertikal, sondern ausschließlich horizontal. Es basiert auf dem Prinzip der Arcade-Spiele, wobei hier Schwärme von bunten Fischen gesammelt werden sollen, statt der üblichen Juwelen oder Blöcke. Alles spielt sich horizontal ab und nicht vertikal, was man bei derartigen Spielen gewohnt ist.
<br><br>
Noch mehr? Bitte sehr!<br>
- 24 Erfolge zum Freispielen<br>
- 24 herausfordernde Stufen<br>
- Neun verschiedene Extras, die die Spielerfahrung bereichern<br>
- Vierspieler-Modus<br>
- Zwei Spielmodi: „Spiel“ und „Erfolge“<br>
- Eine Extra-Trophäe für den besten Goldmedaillensammler
<br><br>
