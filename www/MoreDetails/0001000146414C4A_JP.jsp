...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコン初の野球ゲーム。選べるのはどこか懐かしさを感じさせる６つのチーム。投球やバッティングの操作はシンプルで、守備もコンピュータにおまかせと、単純操作ながら、プレイヤー同士の本格的な２人対戦プレイも楽しめます。ファミコン野球ゲームの原点ともいえるソフト。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ベースボール</span></div>
</div>
