...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157564950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Violin Paradise es un juego para los que aman la música y sueñan con convertirse en violinistas! Un juego diseñado para toda la familia, en el que hasta cuatro personas pueden jugar simultáneamente. Es posible jugar como conductor de orquesta, violinista, violista y violonchelista, quienes en conjunto interpretan música vívida y alegre o suave música clásica.<br><br>
El juego incluye una micro orquesta que ofrece el disfrute de la interpretación musical y el deleite del  talento de los jugadores.<br>
Siempre habrá una nueva experiencia en cada partida de uno a cuatro jugadores simultáneos.<br>
Abundantes y esplendidos efectos visuales, que incrementan mientras tu desempeño mejora.<br>
Los controles son simples pero sofisticados. Habrá diversión desde el principio y nunca sera suficiente.<br>
Una variedad y selección de mas de 50 piezas de composiciones musicales.<br>
¡Empecemos el juego y la diversión ahora! ¡Con un estilo muy singular de música clásica y un toque de funk!
