...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">INTERNATIONAL KARATE is a simulation of a karate tournament where two people can play against each other or one can compete against the computer. During the game, you will fly around the world to various locations. In all stages of the game you will be watched over by the wise old judge who will award you either a half point or a full point, depending on how successful a hit has been.</div>
  <div id="image02">
