...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157584245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sigue a Ben Tennyson en Ben 10 Alien Force: The Rise of Hex, donde se encuentra en medio del plan diabólico de Hex para controlar la tierra. Utilizando los poderes del Omnitrix los jugadores pueden transformar a Ben en 10 formas alienígenas diferentes, las cuales incluyen Gélido, Mono araña y por primera vez, Estrella Polar, mientras lucha contra Hex y sus secuaces. Escoge entre 10 aliens diferentes para superar plataformas por 15 niveles y completando puzles y retos en camino. Combate contra los villanos amenazadores y jefes en la aventura nueva de Ben. Disfruta el mundo de Ben 10 Alien Force con personajes en 3D, presentados en un entorno vibrante de estilo 2D.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157584245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157584245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
