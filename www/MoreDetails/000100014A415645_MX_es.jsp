...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Los Piratas Espaciales, agentes despiadados del malvado “Cerebro Madre”, han robado el último Metroid de un centro de investigación, y una vez más el Cerebro Madre amenaza a la seguridad de la galaxia! Samus Aran deberá usar su increíble arsenal de armas de alta tecnología para rescatar al Metroid mortal que está escondido en las profundidades del cavernoso planeta Zebes. Super Metroid incluye gráficos excelentes, y una variedad de enemigos y mundos que explorar. El ángulo de visión lateral va a ser familiar para muchos jugadores, pero ahora hay nuevas armas y elementos, incluyendo el “Grappling Beam”, que permite que Samus cruce grandes precipicios, y el “X-Ray Scope”, que revela pasajes secretos.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A415645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A415645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Metroid<sup>&reg;</sup></span></div>
</div>
