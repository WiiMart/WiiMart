...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157453645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Eres un entrenador de delfines. Utiliza la varita mágica (Wii Remote y Nunchuk) para realizar  exhibiciones de delfines fieles a la realidad. Enseña trucos a tu delfín y diviértete contemplando a tu delfín nadando y jugando elegantemente con diferentes escenas, música y ángulos. Este juego te permite entrenar a tu delfín, competir en exhibiciones de delfines y observar a tu delfín nadando en libertad. También puedes comprar juguetes como pelotas y aros para que tu delfín juegue con ellos y hacerte amigo de otros delfines que tienen diferentes colores y personalidades usando el servicio Pay & Play de la Conexión <nobr>Wi-Fi</nobr> de Nintendo.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157453645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157453645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">My Dolphin</span></div>
</div>
