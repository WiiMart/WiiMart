...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157424C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BUBBLE BOBBLE Plus! ist ein einfaches und doch fesselndes Actionspiel, bei dem du die Blasen spuckenden Drachen Bub und Bob steuerst, die ihre Feinde in Blasen fangen und dann zerplatzen lassen. <br><br>

Du kannst die 100 Runden des Standardmodus spielen, die alle getreu dem Spielhallen-Vorbild gestaltet wurden, oder dich an den 100 neuen Runden des Spezialmodus versuchen, der es bis zu vier Spielern erlaubt, in allen Leveln mit aufregenden neuen Extras wie neuen Feinden und Leveldesigns zu spielen. Und dann sind da noch die Runden Standard Plus und Spezial Plus.<br><br>

Erlebe das Originalende des Spiels, indem du die in jedem Level versteckten Rätsel löst und den Endgegner besiegst.<br><br>

Und um das noch zu toppen, kannst du 100 weitere Runden Spaß dazu bekommen, indem du die Zusatzinhalte „Profi-Modus-1“ und „Profi-Modus-2“ erwirbst.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
