...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juega la legendaria segunda parte de Sonic The Hedgehog, diseñada especialmente para la consola Sega Master System. La aventura comienza cuando Sonic regresa a casa en su isla, justo a tiempo para darse cuenta de que el Dr. Eggman (alias el Dr. Robotnik) ha raptado a Tails. De hecho, el nefasto Doctor Eggman ha capturado a todos los animales amigos de Sonic y los ha colocado dentro de trajes robóticos que controlan sus acciones. A cambio de su liberación, le ha exigido a Sonic que le entregue las seis Esmeraldas Chaos que están escondidas en la isla. Explora minas abandonadas, corre a toda velocidad en túneles bajo el agua y planea entre las nubes para obtener las esmeraldas... ¡Y, cuando las encuentres, enfréntate con el Dr. Eggman para poner fin a sus maléficos planes de dominar el mundo!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
