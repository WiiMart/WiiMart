...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157425250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pirates: The Key of Dreams is a frantic nautical shoot-em-up. Sail your way across the Caribbean, cannons blazing, looting booty, running blockades, and ultimately, battling Blackbeard himself.
<br><br>
...
<br><br>
Play against three of your scurvy friends or AI opponents in pitched multiplayer battles over 35 levels, in seven themed environments.  Choose from different ship types that reflect your play style. Play in turbo mode if you're Pirate enough!</div>
  <div id="image02">
