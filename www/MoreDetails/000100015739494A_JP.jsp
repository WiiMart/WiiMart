...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015739494A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">危険空域はWiiリモコンのみでプレイするアクションゲームです。画面上の宇宙船をリモコンで誘導します。リモコンで操作できるのは画面上に表示される「ポインター」です。ポインターを宇宙船に近づけるとスピードが遅くなり、放すと早くなります。上手に誘導して、制限時間内に迷路を抜けることが出来ればステージクリアとなります。迷路は巨大宇宙船の内部や小惑星内の洞窟があり、敵の砲台や複雑な鍾乳石がプレイヤーの行く手を阻みます。<BR><BR>また、最大４人で遊ぶことができるマルチプレイモードを収録しています。シングルモードクリアしたステージを遊ぶことが出来ます。制限時間内に一番早くゴールを目指すモードや、スコアを競うモード、そしてプレイヤー全員で１つのハイスコアを狙うモードがあります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015739494A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015739494A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">危険空域</span></div>
</div>
