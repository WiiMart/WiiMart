...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">鋼の教えと闇を司る魔が支配する「ゼテギネア」と呼ばれる時代を舞台とするシミュレーションＲＰＧ「オウガバトルサーガ」シリーズの第三弾です。画期的なリアルタイムシミュレーションゲームとして圧倒的な支持を得たシリーズ１作目『伝説のオウガバトル』のシステムをベースにさまざまな新要素を加え、刻々と変化するゲームフィールド上での息をつかせぬ白熱バトルが展開されます。プレイヤーである主人公は指揮官として多くのユニット（部隊）に指令を与え、キャラクターたちは指令に応じてみずから判断して戦闘をおこなうため、まさに一軍の将として多くの部隊を思うままに動かせます。シナリオをクリアしていくうちに増えていく仲間は多くの職業や種族からなり、本作独自の職業「ソルジャー」や、新システム「レギオン」なども登場。成長とクラスチェンジを重ねて、自分なりの軍団を編成することができます。また主人公は、物語を進める上で避けて通れない選択を迫られ、その究極の選択を繰り返すことで物語が変化していきます。全８章からなる「オウガバトルサーガ」の６章に当たる、壮大なスケールと重厚な物語をお楽しみください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">オウガバトル<sup>&reg;</sup>６４</span></div>
</div>
