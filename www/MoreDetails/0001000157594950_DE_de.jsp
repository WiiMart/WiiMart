...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157594950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Hilf Vektor dabei, der bösen CPU und ihren Spähern, Jägern und Kommandos zu entkommen.
<br><br>
Vektor ist im Inneren der CPU schon so lange gefangen, dass es sich wie eine Ewigkeit anfühlt – du bist seine einzige Hoffnung auf eine Flucht. Bei seiner Reise durch die CPU hilfst du Vektor dabei, seine Erinnerungen wiederzufinden und feindliche Schiffe zu zerstören. Doch Vorsicht: Je weiter Vektor vordringt, desto verschlagener agiert die CPU!
<br><br>
Arbeite mit Vektor zusammen, um ihn aus den Klauen der gemeinen CPU zu befreien. Führe ihn durch das Labyrinth im Inneren der CPU und weiche dabei den Spähern, Jägern und Kommandos aus. Du musst dich schnell bewegen, da sich die CPU deinem Fluchtplan schnell anpassen kann. Im Verlauf des Spiels programmiert Vektor für sich neue Fähigkeiten, damit du es mit der wachsenden Macht der CPU aufnehmen kannst – sein Schicksal liegt jedoch in deinen Händen.
<br><br>
