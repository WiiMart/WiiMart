...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファイアーエムブレムシリーズ第５作目です。物語の舞台は前作『ファイアーエムブレム　聖戦の系譜』に登場した
ユグドラル大陸のトラキア半島。故国を追われたリーフ王子による、レンスター王国復興のための「聖戦」が語られます。

『聖戦の系譜』の外伝的作品である本作では、プレイヤーはリーフを中心とする軍隊を操作し、次々に巻き起こる戦乱をえがいた各マップを攻略。
前作では語られなかった人間関係や歴史にスポットが当たっており、より深い世界観を堪能することができます。
行動次第でマップ数が変化するシナリオでは、新たな仲間との出会いやそこでしか語られないエピソードが楽しめます。<BR>

また、新たに「体格」パラメータや「疲労」の要素、「捕える」<BR>「かつぐ」などのシステムが搭載され、シミュレーションゲームとしても
シリーズ屈指の高難易度を誇っており、高度な戦略が要求されますが、クリアしたときの達成感もひとしおです。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43454A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43454A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイアーエムブレム<sup>&reg;</sup>　トラキア７７６</span></div>
</div>
