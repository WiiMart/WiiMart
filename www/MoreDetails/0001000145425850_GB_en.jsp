...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Originally released in 1993, Sengoku 2 is a belt scrolling beat 'em up game. The characters are warriors that have been summoned by a sorceress princess to take down a dark lord while battling through various epochs. As in the previous version, you can transform your characters, but unlike its predecessor, you don't have to save your ally to be able to transform into them, but rather you can change among the Ninja, Tengu and Ninja Dog freely right from the beginning. Furthermore, one of the new elements to this version is the incorporation of build up attacks and defence, giving a more tactical twist to this action brawler.</div>
  <div id="image02">
