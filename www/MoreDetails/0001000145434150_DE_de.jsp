...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">„Real Bout Fatal Fury 2: The Newcomers“ ist der siebte Teil der Fatal Fury-Reihe, welcher 1998 erstmals veröffentlicht wurde. Basierend auf dem schon bekannten Spielprinzip vorangegangener Spiele bietet „Real Bout Fatal Fury 2: The Newcomers“ eine Vielzahl neuer Features wie z. B. eine weiterentwickelte Version des 2-Ebenen-Kampfsystems oder den „Break Shot“, ein System, mit dem du für verschiedene Moves einen Block abbrechen kannst. Außerdem passt sich deine Ausweichebene an deine Bewegung an. Wird dieses Mal ein Charakter ausgeknockt, kann ein geschickter Spieler durch Drücken der Knöpfe zum richtigen Zeitpunkt den Charakter wieder auf die Füße bringen.
Und schließlich werden zwei Newcomer vorgestellt: Die Kung-Fu-Meisterin Li Xiang Fei und der Boxer Rick Strowd. Auch Geese Howard kehrt dabei als spielbarer Charakter zurück. Wähle aus den 22 Kämpfern und miss deine Kräfte!
<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
