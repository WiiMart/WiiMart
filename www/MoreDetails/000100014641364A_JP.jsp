...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ドンキーコングジュニアを操作して、たし算、ひき算、かけ算、わり算を使って、算数をしながら楽しく遊ぶソフトです。ドンキーコングが出題した計算式を解くゲームと、数字と＋－×÷を集めてドンキーコングが出した「答え」に計算の結果を合わせるゲームの２種類があります。２人対戦では、相手が欲しがっている数字を先に取ったり邪魔をしたりして、駆け引きも楽しめます。

<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドンキーコング<sup>&reg;</sup>ＪＲ．の算数遊び</span></div>
</div>
