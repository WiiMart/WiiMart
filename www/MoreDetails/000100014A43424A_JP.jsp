...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おなじみのスーパーマリオがアクション要素満載のＲＰＧになって登場。コマンド式ＲＰＧのシステムを基本にしながら、ジャンプして足場に飛び移りながら移動したり、ブロックを叩いてアイテムを見つけたりと、マリオならではのアクション性が加わりました。戦闘では、それぞれに行動が割り当てられた４つのボタンからひとつを選んで決定する、シンプルなコマンド入力。さらに、タイミング良くボタンを押す「アクションコマンド」で攻撃やわざをパワーアップできます。直感的でわかりやすいシステムとあわせて、マリオのアクションの魅力がつまった独自性のあるＲＰＧに仕上がっています。
<BR>新たな敵の登場や意外なストーリー展開などマリオシリーズのなかでも異色のタイトルですが、マリオの世界をふくらませてＲＰＧとしての楽しさをも打ち出し、これ以降のマリオのＲＰＧシリーズの原点となりました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43424A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーマリオ<sup>&reg;</sup>ＲＰＧ</span></div>
</div>
