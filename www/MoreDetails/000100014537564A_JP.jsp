...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">前後左右の移動ならびに旋回が可能な近未来の戦車（ビークル）の操縦席に乗り込み、多数の障害物が乱立するバトルフィールドの中で敵機との攻防を繰り広げる、３Ｄ対戦シューティングゲームです。機銃とミサイルの２種類の武器を駆使して敵機を攻撃し、シールド残量をなくして撃破してください。ラウンド開始時に表示される敵機をすべて撃破すると、ラウンドクリアとなり次のラウンドに進みます。<BR><BR>※通信対戦プレイはできません。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サイバースレッド<sup>&reg;</sup></span></div>
</div>
