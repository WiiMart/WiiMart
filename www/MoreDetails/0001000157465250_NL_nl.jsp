...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157465250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Frogger Returns bevat de spannende uitdaging van het arcadespel Frogger en voegt er een dimensie aan toe! Het klassieke top-down 2D-spel is aangevuld met kleurrijke grafische 3D-voorstellingen, een nieuw perspectief, gloednieuwe levels, nieuwe vijanden en spelbeïnvloedende power-ups om te ontwijken en te gebruiken! Speel samen met een vriend(in) en race naar de overwinning.
<br>
<br>
- Verbeterde grafische weergave. Het klassieke Frogger-spel met een geheel nieuwe look.
<br>
<br>
- Gloednieuwe levels. De oorspronkelijke reis van Frogger van de snelweg naar huis verloopt in vier fasen met een gloednieuw avontuur.
<br>
<br>
- Meervoudige spelmodi. Verbeter je topscores, race tegen de klok of zorg gewoon dat Frogger thuiskomt. Speel zoals jij wilt!
<br>
<br>
- Nieuwe bazen en tactieken. Nieuwe vijanden en power-ups veranderen je strategie.
<br>
<br>
- Speel met een vriend(in)! Speel samen en race tegen een vriend(in).<br>
