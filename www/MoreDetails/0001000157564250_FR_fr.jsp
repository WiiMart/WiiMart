...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157564250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP VOID est le troisième opus de la saga Arcade Rétro BIT.TRIP. 
<br><br>
BIT.TRIP VOID est une exploration rythmique et musicale répondant à nos vies et humeurs de tous les jours. Dans ce nouveau concept, que connaissent parfaitement les joueurs, l’utilisateur peut se déplacer où il le souhaite à l’écran et interagir avec la musique de différentes manières. L’esthétique du jeu classique demeure… La présence et l’absence de couleurs sont pleinement explorées.
<br><br>
Optez pour le mode Co-op à 4 joueurs et plongez dans le rythme avec un ami ! Voyez si vous pouvez survivre aux Temps et améliorez votre propre BIT.TRIP.<br><br>Texte écran en anglais.</div>
  <div id="image02">
