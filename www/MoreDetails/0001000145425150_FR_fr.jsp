...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti en 1996, « Ninja<br>Master's » se déroule dans le monde imaginaire de<br>« Zipangu ». Le joueur peut choisir parmi 10 ninjas et guerriers différents. Chaque personnage peut utiliser une grande variété d’armes. De plus, comme les Supers attaques de chaque personnage changent s’il est armé ou non, le joueur doit agir en conséquence. Les dommages augmentent en même temps que la Barre de super pouvoir. Il existe également des techniques mortelles telles que le « Pouvoir fatal », le « Super pouvoir ultime », le « Super pouvoir des ténèbres » et le<br>« Combo des ténèbres » !<br><br>Texte écran en anglais.</div>
  <div id="image02">
