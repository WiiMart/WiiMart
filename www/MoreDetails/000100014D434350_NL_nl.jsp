...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jij bent de kroonprins van het Orakiaanse koninkrijk Landen en verloofd met Maia, een vrouw uit een rivaliserend koninkrijk. Maar op je trouwdag wordt Maia ontvoerd en begin je aan een tocht vol onverwachte wendingen waarin je opnieuw kennismaakt met personages en locaties uit eerdere Phantasy Star-games. Dit epische verhaal overbrugt meerdere generaties van personages en je keuzes zullen de voortgang van het verhaal op dramatische wijze beïnvloeden, waardoor het een prima spel is om meerdere keren te voltooien. In Phantasy Star III is niet alles wat het lijkt. Speel het zelf en zie hoe het verhaal zich ontvouwt.
