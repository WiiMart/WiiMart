...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F5345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Daddy, Mommy, Sarah and Billy are putting the pedal to the metal in Family Slot Car Racing! Race through three racing circuits, each composed of multiple race tracks and even bonus tracks! You can race against a friend for some friendly one-on-one racing action! Choose among multiple slot cars with varying designs to see which has the best grip and speed! As you progress you’ll unlock new courses and even new slot cars to help you reach the top of the racing circuit. Do you have it in you to be the fastest racer on four wheels?</div>
  <div id="image02">
