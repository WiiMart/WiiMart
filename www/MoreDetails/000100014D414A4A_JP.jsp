...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファンキーな宇宙人、トージャムとアールが未知の星「地球」で冒険を繰り広げるアクションアドベンチャーゲーム。プレイするたび姿を変える迷路世界を旅して、墜落のショックでバラバラになった宇宙船のパーツを探します。待ち受けるのは地球に住む奇妙な生物、地球人たち。芝刈り親分に買い物ママ、オタク軍団にドリルを振り回す歯医者さんまで、さまざまな地球人が行く手をさえぎります。道端に落ちているプレゼントは、何が入っているかわからない「ひみつ道具」。翼をつけて空を飛んだり、浮き輪で海原を進んだり、ジャマする敵はトマトを投げてやっつけて、次の世界へと繋がるエレベーターを目指します。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">トージャム＆アール<sup>TM</sup></span></div>
</div>
