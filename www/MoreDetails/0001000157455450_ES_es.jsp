...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157455450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juegos de libros ilustrados: Una aventura desplegable es un juego de mesa con una característica particular. En lugar de jugarse sobre un tablero tradicional, la acción discurre sobre fantásticos mundos que emergen de un libro con ilustraciones desplegables.
<br><br>
Otra peculiaridad es que aquí no usarás dados para moverte, sino cartas con múltiples y variados efectos. Y ten también muy en cuenta las monedas, que te servirán para comprar más cartas o para canjearlas por puntos al final de la partida.
<br><br>
Hasta cuatro jugadores podrán participar en la aventura y ponerse en el papel de intrépidos personajes como el pirata Filibús o el ninja Hanzo. Enfréntate a tus amigos o a la consola con el ojo siempre puesto en el Grimorio: ¡sus poderes pueden cambiar el curso de la partida en cualquier momento!
<br><br>
Puede que el mundo de Juegos de libros ilustrados: Una aventura desplegable solo tenga dos dimensiones, ¡pero la tercera la pones tú!
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455450/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157455450/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Juegos de libros ilustrados<sup>TM</sup>: </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Una aventura desplegable</span></div>
  </div>
