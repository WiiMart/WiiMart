...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En esta emocionante secuela del popular juego Fighter's History, la acción vuelve a desarrollarse en el torneo de artes marciales Great Grapple, aunque esta vez serán trece los luchadores que medirán sus fuerzas en una serie de espectaculares enfrentamientos.
<br><br>
El juego incluye una amplia variedad de ataques especiales, un sistema de puntos débiles que asigna una parte especialmente vulnerable a cada combatiente y la posibilidad de controlar a Clown y Karnov, los jefes de la anterior entrega.
<br><br>
Además, si reúnes ciertas condiciones especiales, podrás batirte con Ox, el toro que aparecía en la fase de bonificación de Karate Champ, uno de los juegos clásicos de Data East.
<br><br>
