...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Brave five rounds of haunting, nightmarish dreams in this take on the classic arcade puzzler. To save his dearly beloved from the malicious demon that controls her dreams and holds her captive, our brave hero plunges himself into the nightmare to vanquish this evil foe. Deftly use the arrow items and control the angle of the ball to shatter the blocks that descend from the top of the screen. Set your sights on the joints holding the blocks together and knock off multiple blocks in one exhilarating blow! As you drop more and more blocks, their shapes will change, allowing you to earn bonus points. You must use your concentration and reflexes to defeat the demon and save your beloved!</div>
  <div id="image02">
