...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015733344A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">バルコニーで昼寝をしていたら、窓に鍵がかけられていて部屋に戻れなくなっちゃったぞ。トイレにも行きたくなってきたし…。屋根を伝っていけば隣の女子大生の部屋のベランダに出れる。非常事態だからね…しかたがない！助けを求めよう！と、思ったが、屋根に出る扉にも鍵がかけられていた。おかしい…これは何かの陰謀なのか？<BR><BR>＠SIMPLEシリーズVol.4 THE密室からの脱出は、周りにある様々なアイテムを駆使して閉鎖された空間から脱出を試みる”脱出アドベンチャー”です。ステージは全部で３ステージ。最初のステージとなるのは昼寝をしていた「バルコニー」。そこでアイテムを探し出し、組み合わせて脱出を図ります。手に入れたアイテムお使う際にはWiiリモコンを回したり、振ったりとWiiならではの操作が用意されています。無事、バルコニーから隣に住む女子大生の部屋へとたどり着く事が出来るのか？そして、女
子大生の部屋で待ち受けているものとは…？はたして本当に陰謀なのか？</div>
  <div id="image02">
    <img src="/oss/ccs/000100015733344A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015733344A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">@SIMPLEシリーズ　Vol.4</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">THE 密室からの脱出</span></div>
  </div>
