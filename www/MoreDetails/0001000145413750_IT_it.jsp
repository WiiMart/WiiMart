...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pubblicato nel 1996, "Samurai Showdown 4" è il quarto della serie "Samurai Showdown". Basato fondamentalmente sul gioco precedente, "Samurai Showdown 3: Lame Insanguinate", questo titolo promette battaglie ancora più spettacolari, grazie a un cambiamento sostanziale del sistema della barra dell'ira, un miglioramento del sistema delle combo e altre innovazioni. Inoltre il finale varia in base al tempo impiegato per completare il gioco: per vedere un lieto fine il giocatore dovrà lottare anche contro il tempo! Questa volta due nuovi personaggi fanno la loro comparsa. Kazuki Kazama e Sogetsu Kazama portano a 17 il numero di guerrieri che si sfidano per stabilire chi è il più forte.<br><br>Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
