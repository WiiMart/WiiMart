...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ese maldito monstruo está otra vez sembrando el caos en Gradius y los planetas cercanos. Tu destino es poner fin a sus fechorías... A menos que te guste vivir como una ameba.
<br><br>
Tienes un papel importante en el diseño de las funciones y el armamento de Vic Viper, tu nave. Aprovecha tu experiencia y tu extraordinaria puntería para usar el arma correcta en el momento apropiado; bombas múltiples, ráfagas de láser, torpedos de fotones y muchas más. Si lo consigues, conquistarás a las gárgolas de la galaxia y superarás los obstáculos de los diez niveles sin problemas. Justo cuando creas que has superado cada nivel, aparecerá un horrible enemigo que hará todo lo posible por que su nivel sea lo último que veas en la vida. Elige el nivel de dificultad entre los tres disponibles y pon a prueba tu habilidad para eliminar alienígenas.
<br><br>
La versión de Gradius III de Super Nintendo se considera una de las mejores de la serie.
<br><br>
