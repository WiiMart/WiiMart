...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158494B50')", "wiiSelectSound()");
...
<br><br>No longer is the planet Monsteca the harmonious world it once was, overrun by a robotic army set out to rule and conquer. Monsteca natives, the Stompies have no choice but to run or be captured. Unable to defend themselves against such heavy machinery, the Stompies must rely on the strength of their herd to work together and defeat the meddling robots.
<br><br>
...
<br><br>
You guide the Stompies towards 'Energy Orb' bonuses to increase the communal power of the herd. With this energy, feed the Astromaggot who will fly them to safety.<br><br>
<ul>
<li>A fun full 3D strategy game with a strong sense of flow.</li>
<li>Twenty levels to conquer with hours of gameplay.</li>
<li>Achievement mode for added challenge.</li>
<li>The only game with Astromaggots!</li>
</ul></div>
  <div id="image02">
