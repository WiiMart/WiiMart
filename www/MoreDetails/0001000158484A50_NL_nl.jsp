...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158484A50')", "wiiSelectSound()");
...
<br><br>
ThruSpace is een uniek 3D-puzzelspel dat je ruimtelijke inzicht en reactievermogen stevig op de proef stelt. Manoeuvreer een Keydron, een simpele geometrische vorm, op hoge snelheid door de gaten in opeenvolgende muren. Draai de vorm om door de gaten te passen. Voor iedere muur die je passeert, verdien je punten. Bovendien kun je kristallen oppikken om je score op te krikken.
<br><br>
Als je de basisprincipes onder de knie hebt, kun je leren om trucs en combo’s uit te voeren. Bepaalde gaten zijn groter dan de Keydron, maar als je de volledige ruimte weet te vullen met zijn schaduw alvorens erdoorheen te gaan, verdien je extra punten.
<br><br>
Speel drie spelstanden: Normal (normaal), Endless (oneindig) en Trick Challenge (trucuitdaging). Je kunt drie van je beste pogingen opslaan als herhaling, en ze in het speltype Keydron Memories nog eens bekijken. Ook kun je je scores publiceren in het online klassement, om je prestaties te vergelijken met die van andere spelers overal ter wereld!<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484A50/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
