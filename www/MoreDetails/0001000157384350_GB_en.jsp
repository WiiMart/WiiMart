...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157384350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP CORE continues the BIT.TRIP saga in this retro-arcade-style game. 
<br><br>
BIT.TRIP CORE adds up to an exciting action/rhythm game that’s best played while zoning out on the tunes and letting the visuals swallow you whole. The experience is inspired by games from the 80s, only with a modern twist. The gameplay is entirely new to the series, leaving the single-axis controls of BIT.TRIP BEAT behind in favour of the ability to control two axes.
<br><br>
If the difficulty gets you down, grab a friend and play cooperatively with 2-player multiplayer. Make it to the end and you’ll have journeyed one step further to completing your BIT.TRIP.</div>
  <div id="image02">
