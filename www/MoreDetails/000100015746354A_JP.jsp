...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015746354A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大人気のおきらくシリーズ第６弾。今度はみんなでトランプの定番ゲーム「大富豪」で対戦しましょう。<BR><BR>おきらくシリーズ初のWi-Fi対戦対応ゲーム。はなれた友達同士でわいわい楽しく遊んだり、見知らぬ人たちとランキングを競いましょう。Wi-Fi対戦中は対戦相手に定型メッセージを出したり、キャラクターの表情を自由に変えて、コミュニケーションを取ることが可能です。<BR><BR>「大富豪」のほかにも、家族でわいわい遊べるトランプの「スピード」や「神経衰弱」も遊べます。<BR><BR>追加コンテンツでは新しいカードの絵柄を増やすことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015746354A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015746354A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おきらく大富豪Wii</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">本格Wi-Fiネット対戦</span></div>
  </div>
