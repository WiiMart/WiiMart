...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un samurái fantasma ha vuelto del inframundo en este juego de plataformas de acción. En una antigua guerra, Kagekiyo derrotó al shogun Yoritomo y a su clan. Pero sus espíritus no fueron destruidos por completo y ahora, en el mundo conocido como el “Lado Oscuro”, aguardan el momento de revivir. Para desbaratar sus planes, Kagekiyo tiene que abrirse paso a través de 7 zonas y alcanzar el “corazón del Lado Oscuro”, donde Yoritomo le espera.<br><br>
Utiliza las “Armas Espíritu” para mejorar tu espada, u otros objetos como las “Velas” para recuperar salud y repeler a las hordas enemigas.
Cada zona no está protegida solo por un jefe, también incluye demonios y hasta samuráis del siglo XII. ¡Prepárate para un poco de acción uno contra uno! 
