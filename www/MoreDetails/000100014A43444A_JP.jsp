...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大きな口で何でも吸い込んでしまう食いしん坊な「カービィ」が活躍する、横スクロールアクションゲーム「星のカービィ」シリーズの５作目。ストーンやアイスなど８つのコピー能力や、ハムスターの「リック」やフクロウの「クー」といった６匹の仲間の能力を生かして、ステージの攻略をめざします。カービィの住む星「ポップスター」に突如、邪悪な黒い雲が現われ、デデデ大王やその手下にのりうつって悪事を働きはじめました。「ポップスター」の平和を取り戻すため、カービィは仲間と協力して冒険に旅立ちます。カービィの行く先には、草原の世界や海の世界など６つのレベル、全３６ステージが用意されており、各レベルの最後にはボスが待ち構えています。２人同時プレイにも対応しており、１Ｐがカービィを、２Ｐが「グーイ」を操作して協力してステージを攻略することができるほか、１人プレイ時でもコンピュータの操作するグーイが一緒に冒険をしてくれます。水彩画のような、淡い色使いのグラフィックが特徴です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">星のカービィ<sup>&reg;</sup>３</span></div>
</div>
