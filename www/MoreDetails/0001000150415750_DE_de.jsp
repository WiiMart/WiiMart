...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dies ist die aktualisierte Version des Shooter-Klassikers “Galaga“.<br><br> In den Weiten des Weltraums angesiedelt, kämpfst du dich durch alle 29 Runden, um die gegnerische Festung auf dem Planeten Galaga zu erreichen. Spiel-Level beinhalten einige Runden mit wechselnden Gegnern und Hintergründen. Als Krönung gibt es auch das nostalgische “Galactic Dancing”, das das Ende eines Levels markiert. Du kannst deine Angriffsroute durch den neuen Zusatz “Dimensions” festlegen. Sammle Kapseln, um “Dimension Warps” in Nebensektionen zu öffnen und es mit noch härteren Gegnern aufzunehmen.<br><br> Die Aufnahme des "Triple Fighter", die scrollenden Hintergründe, "Boss Galaga" und die neuen Systemeffekte machen Galaga '90 zu einem Meisterstück.
