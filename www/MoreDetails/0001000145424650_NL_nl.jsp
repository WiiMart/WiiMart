...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SPIN MASTER is een spannend zijwaartsscrollend actiespel waarin je in de huid kruipt van de avonturier Johnny. 
<br><br>
Dr. De Playne heeft Johnny's gedeelte van een schatkaart gestolen en zijn vriendin Mary ontvoerd! Om ze terug te vinden moet Johnny gevaarlijke gebieden trotseren. Voltooi vijf verschillende levels, elk met een unieke eindbaas. Aan het einde van elk level ontvang je een stukje van de schatkaart. Als je alle stukjes weet te verzamelen, staat je een verrassing te wachten!
<br><br>
Spring en voer aanvallen uit om verder te komen in het spel. Maak gebruik van de verschillende speciale aanvallen, zoals charge-aanvallen, schuifaanvallen en superbomaanvallen, om de gevechten nog intenser te maken. Bovendien kan een andere speler meedoen, voor een dubbele dosis avontuur!<br>
