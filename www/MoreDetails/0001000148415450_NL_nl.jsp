...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000148415450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Op zoek naar de nieuwste info over nog uit te komen spellen? Wil je weten welke titels het beste bij je passen? Dan is het Nintendo-kanaal precies wat je nodig hebt!
<br><br>
Het Nintendo-kanaal bevat regelmatig bijgewerkte informatie over nieuwe titels voor de Wii, de Nintendo DS, WiiWare en de Virtual Console. Je kunt spellen in actie zien in video’s en exclusieve kijkjes achter de schermen. Bovendien kun je ontdekken welke andere spellen je worden aangeraden op basis van wat andere gebruikers ervan vinden.
<br><br>
Als je een WiiWare- of Virtual Console-titel ziet die je leuk lijkt, kun je direct naar het Wii-winkelkanaal gaan om hem te downloaden. Het Nintendo-kanaal kan ook worden gebruikt om Nintendo DS-demoversies draadloos van je Wii naar je Nintendo DS te versturen!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415450/FFFD0018" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415450/FFFD0020" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Nintendo-kanaal</span></div>
</div>
