...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Join the Flight Club to take to the skies and experience a variety of aerial activities! Take off and pilot a biplane through rings along a predetermined flight path or drift serenely in a hang glider, catching thermal currents to gain altitude—just make sure to stick the landing in both cases. Looking for more speed? Strap on the rocket belt to blast your way around an obstacle course, and if that's not enough, reach maximum velocity as you tackle a skydiving lesson at 3,800 feet. Complete specific objectives within a set time limit to score points (and maybe even a bonus chance) and obtain certification in eight different lessons. Your goals will become more challenging and weather conditions will make controlling your vehicle more difficult as you progress. If you succeed, you will be rewarded with the opportunity to pilot an attack helicopter on a daring rescue mission. It's time to earn your wings!</div>
  <div id="image02">
