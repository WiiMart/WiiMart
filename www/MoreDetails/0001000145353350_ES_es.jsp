...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lucha para abrirte paso a través de un mundo lleno de color y acción en este clásico de las salas recreativas publicado en 1987.<br>
Explora fases enormes, llenas de secretos por descubrir, e invierte el dinero que consigas en objetos que te ayudarán a vencer a los poderosos jefes de este emocionante juego que continúa la tradición iniciada por Ghosts'n Goblins.
<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145353350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145353350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Black Tiger</span></div>
</div>
