...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La Reine des Vortex a survécu et elle a suivi Ecco jusqu'à la Terre pour s'y construire un nouveau repaire. Celui-ci a par erreur divisé le cours du temps en deux en utilisant la machine à remonter le temps pour tenter de sauver son groupe. Il doit maintenant résorber la fracture temporelle avant que le Vortex n'aspire un futur mécanisé et mort et le fasse devenir réalité.
<br><br>
Explorez à fond ce monde avec Ecco, rejoignez l'univers marin et résolvez les énigmes afin de repousser la menace extra-terrestre.
