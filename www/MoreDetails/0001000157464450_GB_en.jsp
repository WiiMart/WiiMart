...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157464450')", "wiiSelectSound()");
...
<BR><BR>Use the Wii Remote to move and swipe pinballs, ropes, logs, crates, carts, switches, fans and all sorts of other items to help create a safe path to the exit. Make sure you keep the Furries safe from strange galactic creatures, spiky pits, huge explosions, giant drops and becoming the main dinner of the evil Furax!</div>
  <div id="image02">
