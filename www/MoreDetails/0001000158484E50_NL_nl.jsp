...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158484E50')", "wiiSelectSound()");
...
<br><br>
Treed binnen in de originele wereld van Chronos Twins DX en beleef een fantastisch avontuur vol vernieuwende ideeën die nooit gezien zijn in een ander spel. Dankzij het spelsysteem Dual Gameplay zal je Nec in twee verschillende tijdperken tegelijk besturen. Chronos Twins DX test je intelligentie en behendigheid met een mengeling van actie, platforms, avontuur en puzzels.<br><br>
Als je graag wordt uitgedaagd door een spel, twijfel dan niet... Chronos Twins DX is het spel dat je zoekt.<br><br>
Bijzondere kenmerken:<br>
• Verken een onbekende wereld en ontdek een schat aan verdoken geheimen.<br>
• 19 niveaus in een fantastische omgeving vol buitenaardse wezens en spectaculaire leiders aan het einde van elke fase.<br>
• Speel tegelijk in twee verschillende werelden om verder te gaan en doorsta de uitdagingen die in een enkele wereld onmogelijk zouden zijn.<br>
• Wijzig het verleden door objecten te verschuiven, mechanismen te activeren... en het heden verandert in realtime.<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
