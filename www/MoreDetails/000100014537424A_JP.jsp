...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">前作「ディグダグ」の地底から、海に浮かぶ島へと舞台を移した戦略的島崩しゲームです。主人公「ディグダグ」を操作し、モンスターを退治します。モンスターにモリを刺し、空気を送りこんでパンクさせたり島を崩して海に沈めてください。島にある杭の上でボタンを押して島にヒビを入れると、小さい方の島が崩落して、その上にいる敵をすべて海に落として倒すことができます。高得点が得られる「ベジタブルターゲット」のほか「魚」など新たなアイテムも追加されました。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ディグダグⅡ<sup>&reg;</sup></span></div>
</div>
