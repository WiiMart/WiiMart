...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８０年にアーケードゲームとして登場した『パックマン』は、ステージクリア型のアクションゲームです。ゴーストをうまく避け、迷路に並んだクッキーを片っ端から食べ尽くして、ステージを進めていきます。クッキーをパクパク食べる愛らしい姿とパワークッキーで攻守逆転する痛快さは、多くのファンを魅了し、日本だけに留まらず海外でも史上空前の大ヒットを巻き起こしました。初登場以後も様々なシリーズ作が世に出され、今なお根強い人気を誇る、歴史ある名作です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641584A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641584A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パックマン<sup>&reg;</sup></span></div>
</div>
