...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este es un video juego de lucha, distribuido en 1993, en el que 15 diferentes personajes se enfrentan. El reparto incluye los ocho personajes originales de Fatal Fury 2, así como tres nuevos personajes (Billy, Axel and Laurence) y un nuevo jefe final (Wolfgang). Finalmente, tres personajes de la serie original Fatal Fury (Duck, Dan y Geese) han regresado a la lucha. También, si se cumplen ciertas condiciones especiales, el personaje invitado Ryuu Sakazaki  hará una aparición. Continuando el atractivo del juego anterior con sus enfrentamientos en dos líneas, movimientos especiales y sus ataques finales, y mejorando aún más la fórmula de la serie, este juego verdaderamente merece el título ‘Especial’.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FATAL FURY SPECIAL</span></div>
</div>
