...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミリーコンピュータディスクシステムから誕生したパズルゲーム「エッガーランド」シリーズの４作目。主人公のロロはエッガー大王にさらわれた最愛のララを助け出すため、エッガー大王の魔獣軍団が支配する「魔獣の塔」に挑みます。ロロにできることは、エッガーショットで敵を一時的に玉子にすることと、エメラルドフレーマーを動かして攻撃を防ぐこと。敵につかまらないように逃げながら、エッガーショットやエメラルドフレーマーの使い方を工夫したり、敵や地形の特性をうまく利用してステージを攻略します。シンプルなルールながらも、パズルゲームの醍醐味である知恵と機転をフルに生かしたプレイを楽しむことができます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アドベンチャーズ　オブ　ロロ</span></div>
</div>
