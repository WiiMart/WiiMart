...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mettiti alla prova con Columns, un antico gioco fenicio. Gemme multicolori cadono dalla cima dello schermo dentro una buca e sarà tuo compito  riordinare il più velocemente possibile le gemme in file da tre o più. Se le tue gemme si accumuleranno fino a raggiungere la cima il gioco finirà.<br><br>Il testo all'interno del gioco è in inglese.<br>Non supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
