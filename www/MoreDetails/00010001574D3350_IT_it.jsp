...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574D3350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Come per tutti gli scontri più accesi, nessuno sa dove, quando e come abbia avuto origine questa rivalità, ma questo gruppo di scimmie combatte fin dall'alba dei tempi. Hanno scelto di lottare secondo l'antica arte del Lancio della banana e ora ciascuna di queste bande di primati furiosi
è determinata ad annientare i nemici in una pazza guerra alla frutta.
<br><br>
Controlla una delle otto scimmie e unisciti alle tue alleate in otto ambientazioni diverse. In modalità per giocatore singolo, intraprendi campagne di difficoltà crescente che vanno dalla sopravvivenza alla lotta a colpi di noce di cocco, o affronta una battaglia a tempo, a squadre o un deathmatch standard.
<br><br>
Collega altri telecomandi Wii per affrontare fino a tre avversari, oppure collega la Wii Balance Board per raggiungere l'apice del divertimento.
<br><br>
Che vinca la scimmia migliore.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3350/FFFD0010" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3350/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
