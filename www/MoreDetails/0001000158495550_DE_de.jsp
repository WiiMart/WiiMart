...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158495550')", "wiiSelectSound()");
...
<br><br>Der Fußball der Zukunft! Zerstöre die Verteidiger-Blöcke und schieße den Ball ins Tor, um das Spiel zu gewinnen, aber pass auf, dass dich die gegnerischen Verteidiger nicht erwischen!<br><br> 
...
- Besondere Level-Features wie animierte Blöcke, explodierende Blöcke, Schildblöcke, unsichtbare Blöcke und gefährliche 3-D-Verteidiger
<br><br> 
- 9 herausfordernde Endgegner
<br><br> 
- Level-Editor zum Bauen eigener Level: Bis zu 100 benutzerdefinierte Level lassen sich speichern
<br><br> 
