...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158495745')", "wiiSelectSound()");
...
<p>
Planet Zethos has fallen under the military control of Thau-Phi, a rogue Artificial Intelligence. Its absolute control of all automated systems on the surface includes a legion of labor robots, now acting as an impenetrable and selfless army protecting the A.I. core. The only hope of liberating it without paying a steep price in Confederation lives lies in the crew of the DST Horizon, an elite mercenary group currently selling its sophisticated combat expertise to the highest bidder.
<p>
