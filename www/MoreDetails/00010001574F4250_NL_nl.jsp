...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574F4250')", "wiiSelectSound()");
...
<br><br>
In Art Style: ORBIENT is het heelal je speelveld. Je begint als een kleine ster. Door middel van de zwaartekracht slinger je jezelf door de kosmos, terwijl je andere sterren absorbeert om je eigen omvang te vergroten of ze in een baan om je heen laat draaien.
<br><br>
Maar de ruimte kent vele gevaren, waaronder asteroïden en zwarte gaten die je reis tot een abrupt einde kunnen brengen. 50 ontspannende, maar uitdagende levels maken van ORBIENT een onvergetelijke speelervaring!
<br><br>
