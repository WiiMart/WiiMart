...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157413245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The classic puzzle game Magnetica is now available on WiiWare™, with its own unique “twist” on the puzzle-game experience. You’re surrounded by marbles marching slowly, but surely, down a track. Use a launcher (piloted by a Mii™ of your choice!) to shoot marbles with matching colors and wipe them out before they reach the end of the track. Control couldn’t be simpler, as all you need to do is twist the Wii Remote™ controller to aim and press the A Button to shoot. And the game play remains as addictive and deep as you’ve come to expect in Nintendo’s puzzle games, with five varied play modes available, advanced mechanics such as the ability to lob marbles, and a never-ending supply of combos. This definitely isn’t your typical game of marbles!</div>
  <div id="image02">
