...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Estira, dobla y suelta para lograr la libertad! Boingz te da la oportunidad de conocer a estos personajes adorables, elásticos y de colores que están perdidos en un mundo extraño y buscan las puertas mágicas que los llevarán de vuelta a casa. Boingz, una verdadera experiencia enloquecedora, te ofrece 30 niveles de diversión de plataformas y lógica. Los Boingz son pequeñas criaturas flexibles que se pueden estirar y mandar de un lado a otro como gomas elásticas. El trabajo en equipo es esencial, ya que todos los Boingz tendrán que colaborar para resolver los rompecabezas del juego. Además, muchos de los Boingz han caído en un profundo sueño, así que tendrás que dirigir a los Boingz más fuertes para que despierten a sus amigos. Explora escenarios irreales, vuela por el aire como un trapecista, camina por el fondo del mar, ¡y recoge Twinklies para impulsar tus elásticos viajes!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Boingz</span></div>
</div>
