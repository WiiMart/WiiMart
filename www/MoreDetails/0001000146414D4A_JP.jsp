...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ワリオが出すモンスターをキャサリンの爆弾で消していくアクションパズルゲーム。同じ色のモンスターを３つ以上並べると消えるという簡単ルール。しかし、モンスターの種類によって「タテ」「ヨコ」「ナナメ」と並べ方が決まっており、戦略性も試されます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワリオの森<sup>&reg;</sup></span></div>
</div>
