...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157564250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP VOID è il terzo capitolo della saga arcade in stile rétro di BIT.TRIP.
<br><br>
BIT.TRIP VOID è un'esplorazione sinestetica del ritmo e della musica, elementi con cui conviviamo quotidianamente. Il giocatore può muoversi in completa libertà sullo schermo, interagendo con la musica in modo completamente nuovo, grazie a un metodo di comando inedito per la serie ma assolutamente intuitivo per gli appassionati di videogiochi. Esplorerai il colore e l'assenza di colore sotto ogni aspetto, pur mantenendo la classica meccanica di gioco.
<br><br>
Parti in modalità cooperativa per 4 giocatori per un viaggio attraverso il ritmo! Sopravviverai all'assalto delle Pause per prolungare al massimo il tuo BIT.TRIP?<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
