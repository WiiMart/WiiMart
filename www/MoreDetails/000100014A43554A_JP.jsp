...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">重厚で緻密な世界観が人気を集めるシミュレーションロールプレイングゲーム「オウガバトル」シリーズの２作目です。プレイヤーの目的は覇権をめぐる戦いに揺れるヴァレリア島の内戦を終結させること。過酷な状況の中、民衆を指揮し、真の平和を取り戻すことができるのか、巧みな戦術（タクティクス）が運命の結末を導きます。
高低差を持ち多彩な地形が表現された立体的なマップ上に、さまざまなクラスからなるユニット（キャラクター）を配置。同じ画面でおこなわれる移動と戦闘は、敵味方を問わず「ウェイト」と呼ばれる特定の数値を消費した順に行動するウェイトターンシステムとなっており、常に変化する戦況に対応するための柔軟な戦略が求められます。ユニットは戦闘で経験を積むと強くなっていき、クラスチェンジをすることで、さらに強く成長していきます。物語はプレイヤーがとった行動により変化し、最終的にはエンディングも異なったものとなるなど、プレイヤーの選択がゲームを大きく左右します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">タクティクスオウガ<sup>&reg;</sup></span></div>
</div>
