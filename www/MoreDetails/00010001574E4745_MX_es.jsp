...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574E4745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bang Attack es un divertido puzle a todo color para jóvenes y no tan jóvenes. No hay necesidad de aprender cómo se juega al Bang Attack. Simplemente, basta con jugar para hacerse con la idea. Encuentra objetos iguales y golpéalos con tu martillo. Cuando tengas suficientes puntos, podrás usar el Wii Remote para empezar a usar el martillo GRANDE. ¿Que te encuentras un plátano por el camino? ¡Dale un buen golpe y deshazte de él! ¿Tienes dos Wii Remotes? Juega contra otra persona y descubre quién es el verdadero campeón. No se llega a ser un campeón así como así. Hay que combinar estrategia y velocidad en el momento exacto. Utiliza los objetos especiales para estorbar a tu contrincante, porque ése es el único modo de ganar. Bang Attack tiene 40 niveles, y se juega en 4 mundos locos. Esto te garantiza muchas horas de diversión con Bang Attack. Bang Attack es un juego con el que toda la familia disfrutará jugando.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E4745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E4745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bang Attack</span></div>
</div>
