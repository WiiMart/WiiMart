...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000148434645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El Canal Wii Speak permite a los amigos Wii conversar o enviarse mensajes con grabaciones de voz sin importar cuánta sea la distancia que les separa. Mira como tus personajes Mii te representan en la pantalla de tu televisor y activa los modos “Hablar en grande” y “Cambiar voz” cuando quieras amenizar tu conversación. ¿Tienes una foto que quieres mostrar? Envíala a tus amigos durante su conversación y comparte la historia de la foto a la vez. Teniendo un máximo de cuatro consolas Wii permitidas en una conversación, siempre tendrás algo de qué hablar.
<p>
¡Descarga el Canal Wii Speak hoy y comienza a hablar!
<p>
Se necesita un encaminador inalámbrico compatible o un Conector USB Wi-Fi de Nintendo y una conexión de banda ancha a Internet. Para obtener más información, visita nintendo.com.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434645/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434645/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
