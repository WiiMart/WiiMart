...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De legendarische Griekse god Zeus wekt je tot leven en geeft je een belangrijke opdracht: red zijn dochter Athena uit de onderwereld! Onderweg verzamel je de Spirit Balls die je vijanden hebben laten vallen. Deze vergroten niet alleen je kracht, maar zorgen er ook voor dat je je in allerlei mythische wezens kunt veranderen, elk met zijn eigen krachtige aanvalsbewegingen!<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans<br>Het spel is voorzien van Engelse schermteksten.<br>Geen ondersteuning van de interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
