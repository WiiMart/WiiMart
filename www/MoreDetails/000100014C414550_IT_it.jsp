...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Impersona Alex Kidd in questo gioco a piattaforme degli anni '80, e parti alla ricerca di tuo fratello Egle, misteriosamente scomparso. Lungo il cammino, ti imbatterai nei mostri e negli scagnozzi inviati dal malvagio Janken the Great (Janken il Grande) con il solo scopo di ostacolarti. La vera caratteristica di questa avventura è però costituita dai combattimenti effettuati a colpi di morra cinese: sasso, carta e forbici. Con 16 livelli da superare prima di poter salvare Egle, questo classico metterà di sicuro alla prova la tua abilità e il tuo acume!
<br><br>
Attenzione: 
Alex Kidd in Miracle World è presentato nella sua versione originale del 1986. Le successive modifiche, comprese quelle della versione per SEGA MASTER SYSTEM, non compaiono in questa versione.
<br><br>
