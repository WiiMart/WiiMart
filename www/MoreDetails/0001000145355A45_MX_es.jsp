...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000145355A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Prepárate para experimentar la máxima velocidad en Super Hang-On!
<p>
Esta secuela del juego para SEGA “Hang-On” está basada en el éxito de carreras para arcade de 1987. Super Hang-On pondrá tus habilidades como motociclista a prueba. Recorre 48 desafiantes pistas localizadas en cuatro continentes y experimenta la emoción única que proporciona el juego de arcade mientras pasas las metas a gran velocidad en una carrera contra el reloj y contra tus oponentes. ¡Disfruta la emoción de las carreras en motocicleta y gánate un lugar en la cima de las clasificaciones en este clásico juego que todos deben tener!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145355A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145355A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Hang-On</span></div>
</div>
