...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un jeu de simulation old school qui vous met à la tête d’une armée futuriste dans un conflit acharné pour la conquête de la lune ! Des règles simples qui permettent aux joueurs débutants de s’initier rapidement aux jeux de stratégie ! Les règles et des informations peuvent être consultées à l’écran titre (en anglais). Les combats se déroulent au tour par tour, ce qui permet de peaufiner sa stratégie avant d’avancer ses troupes. De même, les unités sont déjà décidées avant chaque niveau. Commandez vos troupes habilement pour qu’elles vous mènent jusqu’à la gloire !
Maîtrisez les différents types de terrains pour encercler efficacement l’ennemi et remporter la victoire !
Mettez un terme aux ambitions de l’Empire AXIS à travers 16 niveaux palpitants !
