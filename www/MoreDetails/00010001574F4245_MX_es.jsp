...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F4245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Explora el universo como nunca lo habías hecho en Art Style: ORBIENT. Toma el control de la gravedad y la antigravedad y mueve tu pequeña estrella con cuidado a través de 50 fases ubicadas en múltiples galaxias. Choca con otras estrellas para absorberlas y conseguir que tu propia estrella aumente de tamaño, o captura las estrellas en tu órbita y haz que se conviertan en tus satélites. ¡Ten cuidado! Espacio no está vacío, y tú tendrás que evitar golpear los obstáculos o ser absorbido por un agujero negro. Si te apetece relajarte a la vez que aceptas un desafío, ¡este es tu juego! ¡Es una combinación de controles simples, sonido atmosférico y entornos originales para crear una experiencia única!
<p>
La serie de Art Style ofrece un diseño elegante, gráficos pulidos y controles simples, creando una experiencia que se centra principalmente en un estilo de juego divertido y atractivo.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Art Style<sup>TM</sup>: ORBIENT<sup>TM</sup></span></div>
</div>
