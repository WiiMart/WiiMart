...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574F4150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Papà, mamma, Sarah  e Billy
sono tornati per divertirsi 
ancora insieme e questa volta
si gioca a glide hockey!<br><br>

Potrai migliorare e perfezionare
le tue abilità in questo gioco in
una palestra, in un parco forestale,
in spiaggia, in un parco divertimenti 
o addirittura in un acquario artico!<br><br>

Family Glide Hockey si caratterizza
per la grafica accurata e le musiche 
accattivanti, oltre che per i tipi di match, 
amichevoli o competitivi.<br><br>

Scegli tra “Modalità Giocatore singolo”
o “Modalità Scontro” (fino a 4 giocatori),
oppure metti alla prova le tue
capacità con minigiochi come
 “Glide hockey caotico!”,
“Addestramento glide hockey!”, o
 “I colori del glide hockey!”.<br><br>

Il testo all’interno del gioco è in
italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4150/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4150/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
