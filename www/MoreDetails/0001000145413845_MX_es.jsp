...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego nunca fue estrenado en el NEOGEO en el hemisferio Occidental. Es posible que material no esencial al juego exista que sea desconocido por nuestros consumidores, inclusive el texto y sonido en algún lenguaje extranjero.
<p>
Iron Clad es un juego de disparos  desarrollado por SAURUS en 1996. Controlas una nave de guerra y al Iron Clad para luchar contra la República de la Máscara de Hierro y salvar al Reino de Chop. El mayor atractivo en este juego es  descubrir  todas las maneras en las que puedes atacar a tus enemigos. Tu armamento incluye tres armas principales, que se pueden mejorar recolectando ítems, un ataque sostenido que puedes utilizar cuando Iron Clad está conectado a tu nave, tres tipos de ataques físicos que puedes utilizar para mostrar tu poder en el combate cercano, una explosión  que destruye todas las balas enemigas, y disparos que cambian dependiendo de si Iron Clad está conectado o no a tu nave. Una gran gama de armas espera a ser parte de tu arsenal. ¡Puedes inclusive escoger el nivel que deseas, para satisfacer tu sed de combate  y poder ver un final diferente cada vez que juegas! Te divertirás mucho jugando una y otra vez para ver todos los finales y la variedad en este juego.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145413845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145413845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">IRONCLAD</span></div>
</div>
