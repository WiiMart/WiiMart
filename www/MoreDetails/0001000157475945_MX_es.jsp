...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157475945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gyrostarr te desafía y hasta con tres jugadores adicionales a pilotear las naves en una serie de retorcidos circuitos de tecnoplasma repletos de curvas, mientras te enfrentas a una gran variedad de enemigos mortales alienígenas a unas velocidades de vértigo. Mientras luchas y piloteas la nave tendrás que recoger energía suficiente para activar las antiguas puertas del teletransporte que hay al final de cada circuito. Triunfa, y puedes pasar al siguiente circuito aún más mortal. ¡Falla, y las puertas del teletransporte se cierran, destruyendo la nave! Mejora tu nave recogiendo armas, coordina tus ataques con tus amigos para disparar poderosas ráfagas combinadas y usa tu gancho para recoger energía y mejoras en mitad de un combate. Controla tu nave con el mando de Wii, el Nunchuk™ o el mando clásico, o usa el sistema de control en parejas para que dos jugadores usen un mando de Wii junto con un Nunchuk o un mando clásico al mismo tiempo. Gyrostarr te ofrece 50 niveles de acción intensa, poderosas armas, circuitos de bonificación de alta velocidad y desafíos para hasta cuatro jugadores. ¡Gyrostarr es el desafío definitivo!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157475945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157475945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Gyrostarr<sup>TM</sup></span></div>
</div>
