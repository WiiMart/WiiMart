...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495450')", "wiiSelectSound()");
...
<br><br>Cuando se trata del arte de desenfundar, solo hay dos categorías de personas: los rápidos... ¡y los muertos! Ahora tienes la oportunidad de descubrir cuál será tu postura: de pie o tumbado, como podría ser el caso. ¡Demuestra lo que vales enfrentándote a los tiradores más hábiles del Oeste, entre los que se incluye Wes Flowers, uno de los más rápidos del mundo!
<br><br>
¡Desenfunda tu mando de Wii y enséñales quién es el tirador más rápido en este juego de acción! Incluso puedes enfrentarte a un amigo en modo multijugador y ver quién lo hace más rápido.
<br><br>
Necesitarás una velocidad considerable y una precisión impresionante para enfrentarte a esos tiradores... ¡Prepárate para desenfundar rápido si quieres ganar!
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495450/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fast Draw Showdown</span></div>
</div>
