...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードなどで人気を呼んだ「ワンダーボーイ」シリーズ第三弾です。ジャンプアクションの前半戦と、ドラゴンに乗って戦うシューティングになる後半戦とで構成された１つのラウンドを、６種類のパワーアップアイテムを駆使して戦い、全１４ラウンドの突破をめざします。各ラウンドの最後にはユニークな巨大ボスが個性的な攻撃を仕掛けてきます。今回の物語は、前作『モンスターワールド』の主人公「ブック」の冒険が伝説になった時代。元気がとりえの少年少女「レオ」と「プラプリル」はドラゴンから洞窟に眠る伝説の武器と防具を与えられ、再びやってきた侵略者から世界を守るために戦います。レオを操作する１人プレイだけでなく、プラプリルを加えて２人同時の協力プレイも可能です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワンダーボーイⅢ　モンスターレア<sup>TM</sup></span></div>
</div>
