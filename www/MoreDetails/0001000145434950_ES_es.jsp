...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Metal Slug 4 es la quinta entrega de la serie Metal Slug, en la que tendrás que elegir entre cuatro distintos mercenarios para hacer frente al grupo terrorista “Amadeus” a base de saltos y disparos, a la vez que recoges objetos para recargar tus armas. Como en versiones anteriores, podrás montar vehículos y luchar a matar contra tus enemigos. Además, Metal Slug 4 introduce el completamente nuevo sistema de medallas, un modo de puntuar que da un giro de tuerca a la acción. Y si fuera poco, nuevos objetos y personajes que otorgan un aire fresco al universo Metal Slug.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
