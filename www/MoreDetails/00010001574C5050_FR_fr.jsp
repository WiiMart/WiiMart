...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574C5050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LONPOS, un jeu de puzzle captivant et facile à prendre en main, vous permettra de tester votre logique et votre concentration, seul ou avec d'autres joueurs. Vous disposez de plusieurs pièces de formes différentes que vous devez toutes placer sur un plateau de manière à le remplir en les faisant pivoter ou en les retournant à l'aide de la télécommande Wii.
<br><br>
Dans le mode normal, vous devez résoudre les puzzles aussi vite que possible pour gagner des points. Dans le mode continu, le moindre faux pas vous sera fatal tandis que dans le mode coopération, vous devez vous relayer avec un autre joueur pour placer les pièces et compléter le puzzle. En mode bataille, affrontez jusqu'à trois adversaires.
<br><br>
