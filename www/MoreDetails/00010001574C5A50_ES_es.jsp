...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">lilt line es un galardonado juego en el que las carreras se combinan con el ritmo de una original banda sonora y con una estética visual que te fascinará.
<br> <br>
Controla el ritmo de la línea y haz todo lo posible para mantenerte en la pista mientras tratas de llegar a la meta. Pulsa el botón para seguir el ritmo de temas musicales de 16 bits desarrollados por superestrellas del género.
<br> <br>
¡Descubre una carrera alucinante hasta la línea de llegada que te sorprenderá!<br><br>
El juego incluye:<br><br>
• 15 niveles en los que las carreras se mezclan con la música.<br>
• Una nueva manera de jugar basada en el ritmo.<br>
• Controles asociados al mando de Wii.<br>
• Una banda sonora espectacular.
<br> <br>
A veces un videojuego muy bueno es simplemente INCREÍBLE.
