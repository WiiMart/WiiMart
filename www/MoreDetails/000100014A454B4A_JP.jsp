...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「旧約・女神転生　女神転生I・II」は、ファミコン用ソフトとして発売されたロールプレイングゲーム「デジタル・デビル物語　女神転生」と「デジタル・デビル物語　女神転生II」をリメイクし、１本のソフトにまとめたタイトルです。<BR>「女神転生I」では主人公"中島朱実"となり、ヒロインの"白鷺弓子"と共に３Ｄダンジョンを探索しながらゲームを進行します。主人公は自らが開発した悪魔召喚プログラムを使うことによって、悪魔を使役して戦わせることができます。悪魔は戦闘中に会話を行うことによって仲魔にでき、仲魔は邪教の館で合体させることによって、より強力な仲魔を作り出す事ができます。<BR>「女神転生II」では前作から数十年後の世界で救世主となり、東京を悪魔から救うべくゲームが進行します。前作の基本システムを踏襲しつつ、東京の各地を２Dフィールド上で移動したり、悪魔３体による３身合体等といった新しい要素も追加されています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A454B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A454B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">旧約・女神転生</span></div>
</div>
