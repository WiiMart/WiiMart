...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158495650')", "wiiSelectSound()");
...
<br><br>Vous voulez la gloire et la célébrité? Avec Mix Superstar, créez, mixez et enregistrez vos propres chefs-d’œuvre musicaux, libres de droits, sur votre Wii. Vous trouverez plus de 1 000 boucles de Dance, de Hip Hop et de Techno pour plusieurs instruments tels que la batterie, la basse, le synthétiseur, la guitare, et même des enregistrements vocaux. <br><br>
  
Une fois que vous avez composé votre tube, il est temps de le faire connaître au monde entier. Mix Superstar vous permet d’exporter vos créations musicales et de les télécharger ensuite sur votre ordinateur afin de les avoir toujours sous la main. Grâce au WiiConnect24, vous pouvez envoyer vos tubes à vos amis Wii et même mixer des morceaux avec eux!<br><br>
  
Le jeu est aussi compatible avec le Microphone USB Logitech et le Wii Speak, vous permettant d'effectuer vos propres enregistrements vocaux.<br><br> Vous pouvez également obtenir de nouvelles boucles reflétant divers genres musicaux grâce au Pay & Play de la connexion <br>Wi-Fi Nintendo, pour créer des morceaux encore plus sensationnels!
  <br><br>
Devenez la plus grande star du monde!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mix Superstar</span></div>
</div>
