...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１人で遊んでも２人で遊んでも興奮度満点の大ヒットアクションシューティングゲーム。主人公の熱血レッドとクールなブルーを待ち受ける帝国軍の面々は、ひとクセもふたクセもある個性派揃い。ファイヤー、レーザーといった武器を合成させた１０種類のショットとキックやジャンプ、スライディング、投げ飛ばしといったアクションを駆使した攻撃で敵を倒し、帝国による破壊神復活を阻止するため、奪われた４つの秘石を取り戻します。今も名作を生み出し続ける職人集団トレジャーのデビュー作です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ガンスターヒーローズ<sup>TM</sup></span></div>
</div>
