...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Arcade Essentials es una colección de cinco juegos arcade clásicos. Los juegos están avalados por el tiempo y son algunos de los más populares de la historia.  Todos ellos se han reencarnado en una versión moderna con mejoras en la mecánica del juego, gráficos con estilo y efectos de sonido. Súbete y disfruta jugando sin parar. Sumérgete en estos juegos clásicos como hacías hace muchos años.
<p>
- 5 juegos arcade clásicos en un solo pack <br>
- Muchos niveles para desbloquear, clasificaciones de récords y otras características excepcionales que te mantendrán entretenido<br>
- Gráficos y efectos de sonido modernos y elegantes
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
