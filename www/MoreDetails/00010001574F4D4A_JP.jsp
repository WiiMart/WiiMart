...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F4D4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『世界の面白パーティゲーム２』は、世界の国の中で、特徴のある職業をモチーフとしたゲームです。<BR>浮き釣り、闘牛士、ビル清掃、探検家、宇宙飛行士の5つのゲームが楽しめます。<BR>1人でも、2～4人の多人数でも、プレイできます。<BR>ゲームによっては、WiiモーションプラスやバランスWiiボートに対応しています。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4D4A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">世界の面白パーティゲーム２</span></div>
</div>
