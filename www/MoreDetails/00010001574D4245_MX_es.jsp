...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D4245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Con tres maneras distintas de jugar y la habilidad de jugar simultáneamente a través de tres ventanas distintas en la misma pantalla, el siempre cambiante ambiente de Maboshi’s Arcade crea una atmósfera sin igual. Cada uno de los modos de juego está basado en algunas de las figuras geométricas más conocidas (el círculo, la línea y el cuadrado) y ofrece la misma meta: obtener un millón de puntos. Usa los controles intuitivos para derrotar a los enemigos en Circle Mode, esquiva y avanza a través de Stick Mode, o traza un camino con fuego al esquivar varios obstáculos en Square Mode. Todo mientras utilizas objetos que te dan habilidades nuevas y observas cuáles son los efectos que tienen las otras pantallas sobre la que estás usando. También encontrarás a los personajes Mii™, la opción de volver a ver tus partidas anteriores y enviarlas a tus amigos Wii™ a través del servicio WiiConnect24™, y la habilidad de descargar una versión del juego a tu consola Nintendo DS™. ¡Con tantas opciones, nunca querrás dejar este juego de arcade!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D4245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Maboshi's Arcade<sup>TM</sup></span></div>
</div>
