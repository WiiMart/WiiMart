...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Experience the Capcom arcade game that spawned a multitude of clones as the original Commando comes to your living room courtesy of the Virtual Console Arcade service. Take control of Super Joe and (eight-directionally) shoot your way upwards into the enemy's territory, using grenades to wreak havoc with enemy placements in this seminal genre creator.</div>
  <div id="image02">
