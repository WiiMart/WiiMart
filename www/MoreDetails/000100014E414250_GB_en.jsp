...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The crazy power slides and vicious red shells are back! Mario Kart 64 was one of the earliest hits of the Nintendo 64 and is still considered by many as one of the best episodes of Nintendo's classic kart series. Several reasons justify such a high reputation. The 4-player multiplayer provides some of the most entertaining sessions ever. The driving experience has been refined with the addition of several advanced techniques. And the various tracks are filled with clever ideas and hidden shortcuts.
<br><br>
Unfortunately, for technical reasons, it will be impossible to save "ghost data" (replay data of your best times in Time Trials mode) in this version. We apologise for the inconvenience.</div>
  <div id="image02">
