...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574C5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LostWinds is a fresh, enchanting adventure that lets you wield the awesome powers of Enril the wind spirit - from raging tornados to the gentlest breeze – to guide and protect Toku, a young boy who is the only one who can help you release the curse placed upon the world of Mistralis and its people by evil Balasar.<br><br>
 
Mistralis is a stunningly presented, magical land full of wonder and intrigue that bursts to life with your every action and exploration. LostWinds’ novel, playful controls let you use Enril’s elemental powers to jump and glide Toku through Mistralis’ different regions, buffet and smash enemies and solve puzzles on their journey to a dramatic showdown.<br><br>
 
Bursting with new gameplay ideas that embrace the Wii controller, LostWinds puts the power of the wind in the palm of your hand.</div>
  <div id="image02">
