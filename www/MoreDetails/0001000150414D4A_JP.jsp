...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">勇者「フレイ」が闇の皇帝に奪われた８つの「メダリオン」と、さらわれた「ララン姫」を取り返すべく、冒険の旅に出るアクションロールプレイングゲームです。<br>「魔法のコンパス」と人々からの情報を頼りに迷宮の入口を探し出し、そこに待ち受けるボスを倒していきます。主人公が冒険する舞台は、ボスから「メダリオン」を取り戻していくことで「地上」から「地下」、「海」、「空」と、次々に広がって行きます。また、それぞれの迷宮には、謎解きやトラップがあちこちに仕掛けられており、ブロックを動かしたり壁を爆破したりすることで、秘密の部屋が姿を現します。なかには強力な装備や宝物が隠されているため、マップを手がかりに隅々まで探索することが攻略のポイントです。セーブ機能への対応をはじめ、ほどよい難易度と経験値の要素をなくしたスピーディーな展開で、誰でも気軽に本格派ロールプレイングゲームが楽しめます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414D4A/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414D4A/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ニュートピア</span></div>
</div>
