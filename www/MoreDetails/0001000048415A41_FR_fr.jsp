...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cette mise à jour de la chaîne photos vous propose, gratuitement et si vous le souhaitez, les nouveautés suivantes:
<br><br>
<b>Personnalisation de l'icône de la chaîne photos</b>
<br>
Modifiez l'icône de la chaîne photos dans le menu et mettez-y la photo que vous préférez en la prenant sur le bureau Wii ou sur une carte SD. 
<br><br>
<b>Nouveau format des fichiers audio</b>
<br>
Le format des fichiers audio du diaporama a changé. De MP3, il est passé en AAC. (Les fichiers offrent une qualité audio supérieure pour une taille équivalente.)
<br><br>
Remarque:
<br>
- Après avoir téléchargé la version 1.1 de la chaîne photos, vous ne pourrez plus lire de fichiers audio au format MP3. Vous pouvez revenir à la version précédente en effaçant la chaîne photos 1.1. Ceci restaurera automatiquement la version 1.0. 
<br><br>
- Les consoles Wii sorties à partir de décembre 2007 disposent de la version 1.1 de la chaîne photos. Sur ces consoles, le retour à la version 1.0 est impossible.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000048415A41/FFFD001E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000048415A41/FFFD001F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chaîne photos 1.1</span></div>
</div>
