...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Eight different teams representing various nations are vying to become the POWERBALL champions, and you control one of the eight in your quest for the championship. A hybrid of games like rugby and football, POWERBALL is played on a 100-yard field. Try to score by either carrying the ball into your opponent’s end zone or kicking it into your opponent’s net for points. This one- or two-player game offers both exhibition and league play. Jump into a game of POWERBALL and try a brand-new sport!</div>
  <div id="image02">
