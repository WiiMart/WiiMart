...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157534A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The ultimate Spot The Difference game on WiiWare with 160 scenes, 3 levels of difficulty, and 1,600 differences to spot!<br>
<br>
Play either solo or with friends (up to 4 players): find out who's the best spotter!<br>
<br>
Browse through odd and attractive scenes on various categories: Landscapes, Pets, Playtime and Yummy!<br>
<br>
4 game modes are available:<br>
<br>
- Arcade:<br>
  Scenes appear in random order: spot 5 differences in each.<br>
<br>
- Time Attack:<br>
   Spot one difference in each scene for as long as the timer runs!<br>
<br>
- Select scenes:<br>
  Play with scenes of your choice and find 5 differences in each.<br>
<br>
- Multiplayer:<br>
  Play against your friends (up to 4 players).</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534A50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
