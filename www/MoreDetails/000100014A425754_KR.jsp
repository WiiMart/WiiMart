...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">중장기병(어설트 슈츠) 「AS117」을 타고 총 7개의 스테이지를 돌파하는 SF액션게임입니다. 고갈된 자원을 둘러싸고 거대 진영이 대립하는 가까운 미래를 무대로, 플레이어는 장갑기병소대의 일원으로 전투에 참가합니다. 작전 개시 브리핑에서 상황 및 공격목표를 확인한 후 출격하십시오. 기기에 장비되어 있는 실드와 총 4종의 무기를 구사하여 스테이지 클리어를 목표로 합니다. 각 무기는 스테이지에 존재하는 「파워 칩」을 모으면 레벨3까지 강화할 수 있습니다. 특정 무기를 집중적으로 강화할지 전체를 동시에 업그레이드할지는 플레이어의 판단에 달려 있습니다. 입체감 넘치는 BGM을 비롯하여 벽에 남는 탄흔과 흩어지는 탄피, 긴박한 전투 상황에서의 통신 등 실감나는 연출이 대담한 스토리 전개에 한층 재미를 더해 줍니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A425754/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A425754/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">중장기병 발켄</span></div>
</div>
