...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cratermaze is een grappig actiespel dat zich in een parallelle wereld afspeelt.<br> Tijdens een reis door de tijd ontmoeten jij en je vrienden Kublai, de handlanger van de slechte Zenzombie. Hij sluit je vrienden op in een afgezonderd deel van het ruimte-tijdcontinuüm.
Vecht je een weg door zestig levels vol doolhoven om je vrienden te bevrijden.
In de doolhoven, waarvan de thema's uiteenlopen van de prehistorie tot de toekomst, liggen dinosaurussen, ninja’s, robots en nog meer vijanden op de loer.
Ontloop hen door gaten te graven waar ze vervolgens in vallen. Maak de gaten dicht om de genadeklap te geven!
Verzamel alle kisten binnen de tijdslimiet om de sleutel te bemachtigen en door te gaan naar het volgende level.<br> 
Speciale voorwerpen als schoppen en springplanken maken van Cratermaze een unieke speelervaring!
...
<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150423650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150423650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Cratermaze</span></div>
</div>
