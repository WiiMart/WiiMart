...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574C584A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パソコン用シューティングゲーム「PHALANX」がWiiウェアで登場。当時の仕様に近づけて製作した「X68モード」に加え、新たにシステムやキャラクターを加えた「Wiiモード」を収録しました。もちろん、あのなつかしのキャラクターや巨大戦艦、隠しステージも健在です。さらにある条件を満たすと･･･<BR>また、難易度設定もできるので自分にあったレベルで遊ぶこともできます。なつかしさと新しさの2つの要素がミックスしたPHALANXをお楽しみください。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C584A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C584A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＰＨＡＬＡＮＸ(ファランクス)</span></div>
</div>
