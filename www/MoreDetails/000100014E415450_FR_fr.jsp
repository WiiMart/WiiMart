...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Considéré comme l’un des meilleurs jeux sur Nintendo 64, Mario Tennis est de retour sur la console virtuelle!
Les commandes simples et intuitives de ce titre vous feront apprécier le tennis comme si vous étiez sur un court! 
<br><br>
Vous disposez de tout un arsenal de coups pour vaincre votre adversaire: volée, lob, revers surpuissant, coups liftés ou slicés... Jouez selon les règles du tennis dans divers modes de jeu tels que Tournament ou Piranha Challenge.
<br><br>
Choisissez parmi 16 adorables personnages celui qui vous correspond le mieux: chacun a des qualités uniques pour briller sur le court! Bébé Mario est incroyablement rapide et Donkey Kong a une force de frappe terrible, tandis que les effets de Boo sont particulièrement déstabilisants! 
Découvrez les secrets qui se cachent dans le mode un joueur ou éclatez-vous avec vos amis en mode multijoueur: dans les deux cas, vous ne lâcherez plus votre manette!
<br><br>
