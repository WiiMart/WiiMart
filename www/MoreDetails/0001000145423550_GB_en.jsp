...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Last Blade is a fighting game originally released in 1997, set in the "Bakumatsu" period of Japanese history, where ten-plus swordsmen are fighting for different purposes. Similar to its predecessors from the "Samurai Shodown" series, released by the same company, The Last Blade differs in that when selecting a character you are able to choose between two sword types; the damage-focused "Power", or "Speed" which promotes speedy play. In addition, "Repel" allows players to deflect the enemy's attacks, and "Sublime Slash" which cancels "Super Slice" and can be combined with "Super Secret Slice", are just some of the elements that add to the multitude of manoeuvres that this game offers. Be sure not to miss out on the power-moves like "Super Secret Slice" and "Hidden Secret Slice"!</div>
  <div id="image02">
