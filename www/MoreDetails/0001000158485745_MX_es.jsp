...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158485745')", "wiiSelectSound()");
...
<p>
BIT.TRIP VOID es la tercera parte de la saga arcade retro BIT.TRIP. BIT.TRIP VOID es una exploración sinestésica de ritmo y música, los cuales forman parte de nuestra vida diaria y estado de ánimo. Con un sistema de control nuevo en la serie, pero del todo familiar para los jugadores, el jugador tiene completa libertad para moverse por la pantalla adonde desee, interactuando con la música de maneras nuevas. La jugabilidad clásica sigue ahí, pues el color -y su ausencia- se exploran al máximo. ¡Embárcate en un juego cooperativo de 4 jugadores y piérdete en el compás con un amigo! Intenta sobrevivir a los ataques de los Compases y avanza en tu propio BIT.TRIP.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158485745/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158485745/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BIT.TRIP VOID</span></div>
</div>
