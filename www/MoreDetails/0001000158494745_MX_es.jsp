...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494745')", "wiiSelectSound()");
...
<p>
¡Bienvenido a Urbanix, un juego inspirado por los juegos clásicos de computadora! Juegas como Urbanix, un pequeño tractor que tiene que construir una ciudad en un terreno vacío. Evita a tus enemigos, atrapa a los destrozacasas y ahuyéntalos (intentarán echar a perder tu partida). Juega en la Tierra, el Polo Norte o en la Luna. Cada lugar tiene una mecánica de juego diferente, así que tendrás que adaptar tu estrategia. Tienes que ser preciso, rápido y recoger bonificaciones por el camino para así ser el ganador.
<p>
- Juego mejorado basado en clásicos de hace décadas<br>
- 3 mundos diferentes con distintos modos de juego<br>
- 150 niveles que se desarrollan en todos los mundos<br>
- Difícil modo multijugador
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494745/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494745/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
