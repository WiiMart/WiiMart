...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157504745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to Snowpack Park! You’ve arrived hoping to hang out with some of the local penguins and learn how to take care of them. However, a recent storm has just sent the residents of the park fleeing to various islands throughout the area, and there are only a few penguins to be found.
<p>
Take control of either a Mii character or one of the characters already prepared for the game and brave various terrain and unexpected obstacles as you travel from island to island, finding penguins and bringing them back safely to the park. But getting them back is just the beginning. The penguins have different moods, which will go up and down depending on how much interaction they have with you, and if a penguin's mood gets too bad, it will leave the park. To prevent that from happening, you must learn how to feed, pet, and play games with the penguins in order to keep them happy.
<p>
Throughout the park, you’ll also find fun minigames to play with the penguins, headwear pieces for the penguins to wear, fish for them to eat, blowfish to roll up into snowballs, and a variety of other useful things. You can even collect photos of yourself and the penguins by visiting one of the park's photo-taking locations. Prepare yourself for a heartwarming Antarctic adventure!</div>
  <div id="image02">
