...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In diesem Zweikampf-Puzzle räumst du das Spielfeld von fallenden Klumpen aus so genannten Puyo frei, indem du Ketten von mindestens vier gleichfarbigen Puyo zu einer geraden Linie oder zu einem von verschiedenen geometrischen Mustern anordnest. Sobald du eine Puyo-Kette von deinem Feld wegräumst, fällt ein zufälliges blockierendes Puyo-Element auf die gegnerische Seite – was die Sache im Zweispieler-Modus extra-knifflig macht! Je mehr Puyo du wegräumst, desto mehr füllt sich das gegnerische Feld. Gelingt es dir, das Feld deines Kontrahenten bis oben hin zu füllen, gewinnst du. Dank seiner spannenden Story hält dieses Spiel jede Menge Spaß für einen oder zwei Spieler bereit.
