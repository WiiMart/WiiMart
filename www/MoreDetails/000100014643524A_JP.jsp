...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">南の海に浮かぶ謎の「冒険島」で冒険を繰り広げる横スクロール型のアクションゲームです。プレイヤーは「高橋名人」を操作して、悪の大王「キュラ」にさらわれた心の恋人「ティナ」を助けるため、森や洞窟などの全８エリアにいどみます。ひとつのエリアは４つのラウンドで構成されており、それぞれに名人の行く手を邪魔する多くの敵が待ち受けています。さらにプレイ中は時間とともに名人の「バイタリティ」が減っていくので、「フルーツ」や「ミルク」で回復しながらゴールをめざさなければなりません。
ところどころに落ちているタマゴからは、「オノ」やしばらくの間無敵になる「ハニー」などが手に入ります。いろいろなアイテムをうまく利用してラウンドを走破し、各エリアの最後に待ち構えているキュラ大王を倒せば、そのエリアはクリア。敵にぶつかったり穴に落ちたりバイタリティを失ったりしてミスにならないよう気をつけながら、８度に及ぶキュラ大王との戦いを突破し、ティナを救い出してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">高橋名人の冒険島<sup>TM</sup></span></div>
</div>
