...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ホラー映画さながらの迫力の演出とグラフィックで大ヒットした人気アクションゲームの、その後の物語をえがいた続編です。恋人ジェニファーの生死をめぐり、惨劇の館で主人公「リック」と悪霊たちとの戦いが再び始まります。前作の操作や面白さを踏襲しつつ、映画的な演出やギミックが大幅に追加されています。「リック」は、パンチやスライディングキック、鉄パイプやチェーンソーなどさまざまな攻撃・武器を駆使して、襲い来る悪霊たちを倒しながら、恋人ジェニファーを救い出すべく「隠された館」へと向かいます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スプラッターハウス<sup>&reg;</sup> ＰＡＲＴ２</span></div>
</div>
