...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157525150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Caratterizzato da più di 30 animali sfuggenti come rinoceronti lanosi, cervi, lupi e alci irlandesi, Deer Drive Legends WiiWare vi porterà negli angoli più sperduti della terra a caccia degli animali più selvaggi, alcuni dei quali raramente avvistati e molti estinti da tempo. Questi animali sono rapidi, mortali e non aspettano altro che trasformarti nella loro cena. Affronta terribili avversari, come il T-Rex, la tigre dai denti a sciabola e il Gastornis. Con la possibilità di scegliere fra diverse armi come l'arco più silenzioso, il fucile da cecchino per le lunghe distanze o quello ad alta potenza, Deer Drive Legends è il gioco di caccia esclusivo che stavi aspettando!</div>
  <div id="image02">
