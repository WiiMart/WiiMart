...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９１年にリリースされた横スクロール型アクションゲームです。ダルマ一族の侵略によって窮地におちいった惑星ラギを救うため、昆虫人間（インセクタリアン）のブルーが立ち上がります。葉っぱ、爆弾、ブーメランなどの多彩な武器のほか、ジャンプや自在に体の大きさを変えられる特殊能力を駆使しながら各ステージを進み、ダルマ一族を撃退しましょう。ステージには分岐の要素もあり、一度攻略しただけではゲームの全貌が明らかにならないので、繰り返してプレイが楽しめます。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ラギ</span></div>
</div>
