...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157424450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Brain Drain est un jeu de puzzles passionnant.<br>
Reconstituez les pièces mélangées d'un puzzle selon le modèle.<br>
Défi : 200 puzzles avec temps prédéfini à battre pour les résoudre.<br>
Course : 4 niveaux de difficulté. Plein de puzzles et de meilleurs temps à battre.<br>
Aléatoire : des puzzles à résoudre tranquillement, à l’infini...<br><br>Texte écran en français.</div>
  <div id="image02">
