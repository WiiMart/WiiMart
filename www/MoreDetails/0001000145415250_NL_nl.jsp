...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit fascinerende golfspel, oorspronkelijk uitgegeven in 1996, plaatst jou in de rol van een van de 6 professionele golfers! Doe mee op een aantal golfbanen verspreid over de hele wereld en reis naar Japan (Fujiyama Oriental Golf Club), Amerika (Grand Canyon Golf Course), Oostenrijk (Blue Lagoon Golf Course) en Duitsland (Baden Golf Course).
<br><br>
Dit spel bevat twee spelstanden. De eerste is de “Stroke Play”-stand, waarin je 18 holes speelt en de beste score probeert te halen. De tweede spelstand is “Match Play”, waarin twee spelers het tegen elkaar opnemen om te zien wie de meeste holes van de 18 wint en de overwinning behaalt.
<br><br>
Dit spel bevat kleurrijke banen en een intuïtief spelontwerp, dus waar wacht je nog op? Je caddie?
<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">NEO TURF MASTERS</span></div>
</div>
