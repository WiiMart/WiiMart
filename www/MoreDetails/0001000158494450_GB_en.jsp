...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158494450')", "wiiSelectSound()");
...
<br><br>
Six drivers are in confrontation in a gigantic TV show: an English lord, a dangerous beauty from Russia, a Mexican desperado, a French eccentric, a Japanese prodigy and an American bulldozer... Whatever your choice is, you will have to drive and shoot simultaneously to be the first crossing the finishing line!
<br><br>
- 20 different races to drive through<br>
- 6 thematic islands resembling amusement parks<br>
- Up to 8 players with a controller share option<br>
- Unique gameplay: drive with 1 hand, aim with the other<br>
- Tons of content to discover: items, trophies, time trials...</div>
  <div id="image02">
