...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８６年に発売されたＭＳＸオリジナルの縦スクロール型シューティングゲームです。怪物「ヒュドノス」にさらわれた姫「アフロディテ」を助け出すべく、主人公「ポポロン」を操作し、弓矢を使って魔物たちを倒しながら８つのステージのクリアをめざします。スピードアップや透明化などのパワーアップができるパワークリスタルや、新しい武器を選択できるウェポンクリスタルなどをうまく利用し、各ステージの最後に待つボスキャラを撃破してください。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000158414D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158414D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">魔城伝説</span></div>
</div>
