...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パーツを組み合わせてカスタマイズできる小型ロボ「カスタムロボ」によるバトルをテーマとする、ロボットアクションロールプレイングゲームです。主人公はカスタムロボ「レイⅡ」を手に入れたことをきっかけにカスタムロボバトルの世界に足をふみいれ、親友や強敵たちとの出会いと対戦の中でバトルの腕をみがいていきます。ゲームのポイントは、カスタマイズと、アクションバトル。相手のロボやホロセウムの特徴を見極めて作戦を練り、パーツごとに異なる攻撃方法や移動能力によって、自分のロボをカスタマイズ。３Ｄ空間「ホロセウム」でのバトルでは、簡単操作ながら熱いアクションと駆け引きが繰り広げられます。本作「Ｖ２」では、主人公の成長をたどる「シナリオ」モードが充実の二部構成となり、またプレイヤー４人までがタッグを組んで対戦可能な「２ｏｎ２バトル」も新たに登場。シナリオでも対戦でも、カスタマイズとアクションの組み合わせしだいで無限の戦略性を生み出すカスタムロボバトルの魅力を、存分にお楽しみください。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">カスタムロボ<sup>&reg;</sup>Ｖ２</span></div>
</div>
