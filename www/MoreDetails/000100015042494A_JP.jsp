...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">敵の攻撃を避けながら、頭突きで敵を倒していく横スクロールアクションゲーム「ＰＣ原人シリーズ」の第三弾。毎度こりない悪の親玉「キングタマゴドン３世」のたくらみに気づいたＰＣ原人が「恐竜王国」の平和を守るため三度立ち向かいます。今回の恐竜王国は全７ラウンド。随所に遊び心満載な仕掛けが設けられ、可愛くてコミカルな敵キャラたちが登場します。８種類あるボーナスステージは「プチフラワー」を入手するか、各ステージのボスを倒し「ニコニコチップ」１６個分と交換することでプレイ可能。ラウンド中に出現する赤と青の「キャンディー」は原人のサイズを変化させる新アイテムで、大きさを変えることでステージ上の難関ポイントを突破したり、取りにくい１ＵＰを入手することができます。また、「ボンク（頭突き）」や「三角跳び」などのテクニックや「肉」や「ばね花」も前作から引き続き健在で、プレイヤーを楽しませてくれます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＰＣ原人３</span></div>
</div>
