...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Extraterrestres misteriosos han invadido el planeta Corliss, lentamente agotando sus recursos. Toma control del prototipo de la nave Axelay y utiliza su gran variedad de armamento avanzado para luchar contra las fuerzas del enemigo. Juega a través de múltiples niveles de acción abarcando desde planetas hasta estaciones espaciales, te encontrarás contra todo esto en tu camino hacia cuartel general de los extraterrestres. ¡Ten cuidado de no distraerte mucho con las excelentes gráficas del juego (incluyendo los fenomenales efectos de desplazamiento) o la fantástica música, ya que eres la ultima línea de defensa de Corliss! ¡Pilotea a Axelay usando los famosos controles de Konami y experimenta lo que muchos consideran un clásico del genero de tiroteo!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A425345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A425345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">AXELAY<sup>&reg;</sup></span></div>
</div>
