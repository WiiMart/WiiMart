...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">サイバトロンのシティーコマンダー「ウルトラマグナス」を操り、デストロンの野望を打ち砕く、横スクロール型アクションゲームです。ウルトラマグナスはヒト型とトレーラー、２つの形態にトランスフォーム（変形）することができます。場面に応じて変形を使いこなし、「エネルゴンキューブ」でパワーアップしながら、さまざまなメカニカル生命体やデストロンの巨大な敵が待ち受ける全１０ステージのクリアをめざしてください。サイバトロン総司令官・コンボイがなぜ死んでしまったのか、このゲームのすべてをクリアすることで、その死の謎が解き明かされます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146454C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146454C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">トランスフォーマー</span></div>
</div>
