...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750524A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">空中に浮かび回転する赤・青・緑など（最大８色）の色とりどりのキューブの集合体「キューブリオ」に向かって、キューブを発射し、同じ色を４つ以上つなげて消していくシューティングパズル。それが『ＣＵＢＥＬＥＯ』 （キューブリオ）です。<br><br>
操作方法は、ポインターで狙いをつけたキューブに向けて、手持ちのキューブをＡボタンで発射するだけ！<BR>
キューブをバンバン発射し、上手く色をつなげてどんどん消しましょう！<br><br>
ステージ上にあるキューブを全て消すとクリアになる「ＳＴＡＧＥ」モードと、ゲームオーバーになるまでにどれだけのキューブを消せるかを競う
「ＥＮＤＬＥＳＳ」モードがあります。<br><br>
同じ色のキューブを４つ以上つなげて消すごとにスロットが表示されます。スロットの絵柄がそろうとボーナスタイムがスタート！　ゲームのテンポががらりと変わります。<br><br>
シンプルアート感覚のグラフィックと独特なボイスがかもし出す、エレクトロ・ポップな空間。<br>
Ａｒｔ　Ｓｔｙｌｅ<BR>
<div align="right">『ＣＵＢＥＬＥＯ』。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015750524A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750524A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">ＣＵＢＥＬＥＯ<sup>TM</sup></span></div>
  </div>
