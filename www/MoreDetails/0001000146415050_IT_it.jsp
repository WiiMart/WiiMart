...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Manda la palla in buca con Mario (e Luigi, se giochi in modalità multigiocatore) in questo classico di simulazione sportiva datato 1992.
<br><br>
In NES Open Tournament Golf, scegli tra tre percorsi internazionali nel Regno Unito, negli Stati Uniti e in Giappone e tre diversi tipi di gioco: Gara a colpi, Gara a buche e Torneo.
<br><br>
Nello schermo del percorso, imposta tutto per il tiro perfetto, scegliendo la mazza adatta e calcolando la direzione e il vento, poi passa all'azione e colpisci, calcolando bene i tempi.
