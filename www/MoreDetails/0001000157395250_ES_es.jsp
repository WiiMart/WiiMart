...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157395250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Vas a celebrar una fiesta en Navidad y quieres llamar la atención de tus invitados? ¿Quieres enviar tarjetas de felicitación y evitar el engorro de tener que pegar los sellos? Aquí tienes la solución: ¡crea tarjetas navideñas y envíalas con esta aplicación de WiiWare!
<br><br>
Con Happy Holidays Christmas podrás crear tus propias tarjetas de Navidad virtuales y mandarlas directamente a las consolas Wii de tus amigos.
<br><br>
Añade un árbol y adornos, elige el marco, las pegatinas y la música, y escribe un mensaje a los amigos que tengas en la agenda.
<br><br>
Puede que estas navidades no nieve, pero con esta nueva y divertida aplicación, ¡seguro que son muy felices!
<br><br>
...
Como algunos de los servicios en línea de la consola Wii han dejado de estar disponibles el 28 de junio de 2013, ya no es posible acceder a las funciones en línea de este programa por medio de WiiConnect24.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157395250/FFFD000D" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157395250/FFFD000E" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
