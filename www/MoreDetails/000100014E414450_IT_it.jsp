...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Andross ha attaccato il Sistema Lylat: Fox McCloud e la squadra Star Fox sono i soli in grado di contrastarlo. Hai a disposizione il caccia Arwing, il carro armato Landmaster e il sottomarino Blue Marine. Utilizza il mezzo più opportuno per polverizzare l'esercito di Andross.
<br><br>
In questa avventura dovrai superare 15 livelli e combattere nell'aria, nello spazio, sulla terra e sott'acqua. Trova i passaggi nascosti nelle missioni a scorrimento laterale. Nella modalità All-Range potrai eseguire incredibili manovre a 360°, avvitamenti mozzafiato e inversioni a U per cercare di seminare i nemici!
<br><br>
Lylat Wars presenta anche una modalità multigiocatore nella quale un massimo di quattro giocatori possono affrontarsi nelle emozionanti sfide Point Match, Battle Royal e Time Trial.
<br><br>Il testo all'interno del gioco può essere visualizzato in inglese, tedesco e francese.
<br>La funzione rumble del gioco originale non è disponibile.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Lylat Wars<sup>TM</sup></span></div>
</div>
