...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Se advierte de que este juego tiene contenido de naturaleza violenta y está clasificado “M” (Maduro, para adultos) por el ESRB.
<p>
SPLATTERHOUSE 2 es la continuación de SPLATTERHOUSE, publicada sólo para SEGA GENESIS. Unos meses después de haber escapado de la primera mansión en SPLATTERHOUSE, el personaje principal, Rick, se vuelve a encontrar con la Terror Mask (Máscara del Terror) y debe utilizar sus poderes para rescatar a su amada Jennifer. Rick tendrá que dar puñetazos, navajazos, aplastar y hasta usar la sierra eléctrica contra enemigos terroríficos en la mansión encantada para poder salir vivo.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
