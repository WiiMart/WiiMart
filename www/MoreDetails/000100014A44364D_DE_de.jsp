...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Der aufregende Klassiker „The Ignition Factor“ ist zurück, dieses Mal für Virtual Console!
<br><br>
Du steuerst einen mutigen Feuerwehrmann durch gewaltige Infernos und versuchst, Menschen aus lichterloh in Flammen stehenden Gebäuden zu retten! Mit professioneller Ausrüstung kämpfst du dich heldenhaft durch die Szenarien, egal ob du Objekte eintreten, am Seil klettern oder springen musst. Du kommst einfach überall hin.<br>
Doch die Zeit ist dein Gegner, denn die Feuer breiten sich stetig aus, und deine Sauerstoffreserve wird langsam knapp! Unterschiedliche Feuerarten wollen variabel bekämpft werden; du solltest deine Ausrüstung also optimal nutzen, um ein erfolgreicher Retter zu sein! Lösche alle Flammen, indem du dich auch der Hilfe von Kollegen und des Feuerwehrautos bedienst.<br>
Behältst du einen kühlen Kopf in dieser sich ständig ändernden Umgebung? 
