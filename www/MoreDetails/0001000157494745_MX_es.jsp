...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157494745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prepárate para gritar “Incoming!” mientras con furia evades misiles y balas de cañón que vuelan.<p>
El objetivo de Incoming! es el derrotar a tu oponente destruyendo sus tanques utilizando el arsenal que tienes a tu disposición. Arsenal avanzado estará disponible en los diferentes niveles del juego.<p>
Incoming! es de gran diversión para que dos personas jueguen competitivamente.<p>
¿Puedes derrotar a los tanques de tus adversarios antes de que ellos conquisten los tuyos? Acumula poderes para darle a tu arsenal esa ventaja táctica. Tus disparos deben ser rápidos y tu puntería exacta para aclamar la victoria.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157494745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157494745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Incoming!</span></div>
</div>
