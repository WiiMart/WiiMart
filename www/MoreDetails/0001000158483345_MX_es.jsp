...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483345')", "wiiSelectSound()");
...
<p>
Frobot está programado para amar, no para la guerra, pero cuando sus cinco novias fueron robo-secuestradas no pierde un segundo para pelear en las calles. ¡Hazte camino hasta el Funkytown hasta el cuartel general BotBlocker y devuelve lo que es tuyo!<br>
• Arde Chica Arde - ¡Gana armas especiales y poderosas incluyendo el Robo Hustle dash y el disco bola Jivestalker para ayudar al personaje!<br>
• La gran Venganza - ¡Viaja através del modo historia lleno de acción, aventura, y rompecabezas físicos agotantes para rescatar tus novias!<br>
• Superfreak - ¡Busca tomar el poder oculto y mejora tu estilo!
<p>
¡Es un pelea hasta el ultimo Afro en la arena multiplaya de Frobot! Enfréntate hasta tres de tus amigos en un TV para ver quien gana la fama.<br>
• Está lloviendo Armas - ¡Accede a un arsenal expandido de armas funky incluyendo la granada Bomba Bajo y el escudo Para-corazón!<br>
• Haz el Baile Disco - ¡Desbloquea mapas multiplaya al termina los niveles de playa solo en tiempo record!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Frobot</span></div>
</div>
