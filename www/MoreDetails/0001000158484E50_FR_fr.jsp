...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158484E50')", "wiiSelectSound()");
...
<br><br>
Entre dans le monde original de Chronos Twins DX, où tu vivras une aventure fantastique pleine d'idées jamais vues encore dans un jeu vidéo. Grâce au système de jeu Dual Gameplay, tu pourras contrôler Nec dans deux mondes temporels en même temps. Chronos Twins DX est un mélange d'action, de plate-forme, d'aventure et d'énigmes qui mettront ton intelligence et tes aptitudes à l'épreuve.<br><br>
Si tu aimes les défis, Chronos Twins DX est fait pour toi.<br><br>
Caractéristiques:  <br>
• Explore un monde inconnu dans lequel tu découvriras un nombre infini de secrets cachés. <br>
• 19 niveaux aux environnements fantastiques avec des extraterrestres et des boss de fin de niveau. <br>
• Modifie le passé en changeant certains objets de place, en tuant certaines créatures... et le présent changera en temps réel. <br>
• Observe de quelle manière le temps passe tout en progressant dans ton aventure. <br>
• Trouve la clé d'incroyables casse-têtes temporels.<br><br>Texte écran en français.</div>
  <div id="image02">
