...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Empuña con firmeza tu fiel látigo y ábrete camino a través de numerosos niveles que recrean a la perfección las clásicas y emocionantes aventuras del inigualable Indy! Por fin podrás revivir las mejores y más famosas escenas de las películas: la impactante roca gigante de En busca del arca perdida, el frenético "viaje" en vagoneta de Indiana Jones y el templo maldito y, por supuesto, no podían faltar las tres míticas pruebas de Indiana Jones y la última cruzada, ni René Belloq y el Coronel Vogel. ¡Ración triple de acción y aventura en un juego único!
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A433450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A433450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Indiana Jones<sup>&reg;</sup>'</span></div>
</div>
