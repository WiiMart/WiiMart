...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574A4B45')", "wiiSelectSound()");
...
<p>
- More than 40 levels spread all over Easter Island<br>
- Tons of different board shapes<br>
