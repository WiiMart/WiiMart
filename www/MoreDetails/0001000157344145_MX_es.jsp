...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157344145')", "wiiSelectSound()");
...
<p>
MULTIJUGADOR<br>
En Arcade Sports, dos jugadores pueden enfrentarse en partidas uno contra uno en una consola Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157344145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157344145/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Arcade Sports<sup>TM</sup></span></div>
</div>
