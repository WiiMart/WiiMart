...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ｈｕカードソフト第一弾として、ＰＣエンジンと同時リリースされた横スクロール格闘アクションゲームです。舞台は中国。プレイヤーは功夫の達人「王」となり、功夫界における最大の拠点を乗っ取った“暗黒皇帝”を倒すため、次々と現れる敵をパンチやキック、とび蹴りなどで倒しながらステージを進んで行きます。各ステージにはそれぞれ３人のボスが待ち構えており、全てのボスを倒せばステージクリアとなります。行く手をさえぎる「毒蛾」や「棍棒」などに混じって現れる、体力回復をもたらすアイテムや、回復アイテムの「ウーロン茶」を上手く利用して全４ステージを戦い抜きます。発売当時の常識をはるかに超えた巨大なキャラクターは迫力満点。リアルなタッチで描かれるボスとの一騎打ちは、まさにカンフー映画そのものの緊張感です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE 功夫<sup>&reg;</sup></span></div>
</div>
