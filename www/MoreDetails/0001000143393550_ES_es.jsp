...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Durante los últimos tres días, los sistemas informáticos militares de las mayores potencias mundiales han registrado fallos de seguridad. Alguien ha conseguido acceder a los ordenadores que controlan el lanzamiento de misiles, y solo hay una persona capaz de una manipulación a esta escala: el profesor Elvin Atombender.
<br><br>
Unas cuantas incursiones en las redes informáticas de varias instituciones financieras le sirvieron para amasar la fortuna con la que construyó una vasta fortaleza subterránea, repleta de complejos ordenadores. Recluido en ella, Elvin pasó cuatro años trabajando para infiltrarse en los sistemas informáticos militares de todo el mundo. Y como ya sabes, lo ha conseguido.
<br><br>
Según los cálculos de nuestro ordenador, descifrar los códigos de lanzamiento necesarios para desencadenar la hecatombe nuclear le llevará exactamente seis horas. Este es el tiempo del que dispones para completar tu misión.
<br><br>
