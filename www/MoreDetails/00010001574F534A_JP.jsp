...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F534A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大人気のおきらくシリーズ第４弾です。今度は家族がスロットカーレースバトルに挑みます。<BR><BR>Wiiリモコンやヌンチャクのボタンひとつでかんたんにあそべます。<BR>アクセル・ブレーキをうまくつかってランキング１位を目指しましょう。<BR>家族や友達をあつめてワイワイできるレースゲームです。<BR><BR>またボーナスゲームをクリアすると最大３２種類のスロットカーでバトルをすることができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F534A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F534A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おきらくスロットカーレーシングWii</span></div>
</div>
