...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">International Karate +  ist eine Weiterentwicklung des Originals International Karate. Die grundlegendste Änderung besteht darin, dass sich nun drei Kämpfer auf dem Bildschirm befinden (und fünf im Pause-Modus).
<br><br>
Es gibt 16 verschiedene Angriffstechniken, die mithilfe der Wii-Fernbedienung ausgeführt werden. Sie können mit einiger Übung zu einem fließenden, ununterbrochenen Bewegungsablauf kombiniert werden. Die Handhabung ist einfach zu lernen, so dass sehr schnell Fortschritte in der Steuerung der Spielfiguren erreicht werden.
<br><br>
Die Gegner können von hinten und von vorne am Kopf, an der Brust, am Bauch, am Schienenbein und an den Füßen angegriffen werden, wobei rückwärtige Angriffe nur mit der halben Punktzahl gewertet werden.
<br><br>
