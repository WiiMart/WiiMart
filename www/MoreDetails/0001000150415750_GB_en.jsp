...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is an updated version of the classic arcade shooter, Galaga. Set in the vast reaches of space, fight your way through all 29 Rounds to reach the enemies’ stronghold on Planet Galaga.<br><br> The game's Levels are divided into different Rounds with changing enemies and backgrounds. To top it off, the nostalgic "Galactic Dancing” lives on to mark the end of each Level. With the new addition of Dimensions, you can choose your attack route. Collect Capsules to open Dimension Warps at branch sections to take on even tougher enemies.<br><br> Galaga ‘90’s inclusion of the Triple Fighter, scrolling backgrounds, Boss Galaga and even new system effects make it nothing less than a masterpiece.</div>
  <div id="image02">
