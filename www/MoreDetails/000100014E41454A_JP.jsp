...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ピーチ姫をさらっていったクッパを追ってマリオが冒険に旅立つアクションＲＰＧ。ロールプレイングゲームでありながら、ボタンを押すタイミングなどでバトルの展開が変化するアクション性を採り入れたバトルシステムによって、誰にでも遊びやすく、立体的な空間とペラペラで可愛らしいデザインのキャラクターによる楽しい演出がたくさん盛り込まれています。手作りのお芝居を見るようなほのぼのとした温かみが魅力で、また、メインストーリーをふくらませる数々のイベントやミニゲームも冒険をより楽しいものにしてくれます。

<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マリオストーリー<sup>&reg;</sup></span></div>
</div>
