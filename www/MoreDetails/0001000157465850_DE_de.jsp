...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157465850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Besonders in der kalten Jahreszeit sehnt sich jeder nach einem lauschigen Kaminfeuer. Doch nicht alle haben die Möglichkeit, sich vor eines zu kuscheln. Dein neues WiiWare-Kaminfeuer verzaubert jeden Raum mit einer stimmungsvollen Atmosphäre! 
<br><br>
Wähle aus verschiedenen Holzscheiten und stapele diese mit der Wii-Fernbedienung. Jetzt nur noch das Streichholz anzünden und schon wird dein Zuhause von einer warmen Gemütlichkeit erfüllt. Insgesamt stehen dafür sechs Feuerstellen zur Verfügung. <br>
Schüre und pflege das Feuer, damit es nicht an Kraft verliert. Lege frische Holzscheite nach, die wie bei einem echten Feuer abbrennen. Möchtest du dich einfach nur entspannen? Kein Problem: Im Butler-Modus werden automatisch neue Scheite nachgelegt und im Nonstop-Modus brennen die Holzscheite nicht ab. 
<br><br>
Behagliches Knistern und ein real animiertes Feuer lassen keine Wünsche offen – nicht nur in der kalten Jahreszeit!

<br><br>
- Sechs Feuerstellen: Feuer Pur, Lagerfeuer, Rustikaler Kamin, Klassischer Kamin, Eleganter Kamin, Zen Kamin
 <br> 
- Kuschelige Sound-Atmosphäre
  <br>
- Realistische Physiksimulation durch PhysX® by NVIDIA
 <br> 
- Vier Spielfunktionen: Butler (Holzscheite werden automatisch nachgelegt), Nonstop (Holzscheite verglühen nicht), Standard (vorgefertigtes Feuer in frei wählbarem Kamin), Individuell (Holzscheite selbst wählen und im Kamin platzieren)<br><br>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Kaminfeuer</span></div>
</div>
