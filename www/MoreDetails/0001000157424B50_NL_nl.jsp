...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157424B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ARKANOID Plus! is een nieuwe versie van de originele arcadehit. Spelers moeten gekleurde blokken vernietigen door met een ruimteschip (de VAUS) een energiebal over het scherm te bewegen. De game bestaat uit tal van nieuwe modi en instellingen die de gameplaybeleving op revolutionaire wijze veranderen: de "Arcade Mode" bestaande uit 61 rondes verdeeld over linker- en rechterversies met twee baastypes aan het einde van een ronde; de "VS Mode" waarin spelers het tegen een vriend(in) of de computer opnemen; en de altijd spannende "Time Mode" waarin spelers tegen de klok vechten om de rondes te voltooien. Tel daarbij de subtiele verschillen op die voortkomen uit de keuze van “Lives” (levens) of “Barrier” (barrière) Regels en een overdaad aan spannende items, en dan weet je dat je urenlang blokbrekend plezier te wachten staat!<br><br>

Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424B50/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ARKANOID Plus!</span></div>
</div>
