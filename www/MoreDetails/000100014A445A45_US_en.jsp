...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Return to a time of classic action and adventure. Young Benjamin embarks on a quest to reclaim the stolen crystals that are the key to balancing the four elements of the world. Experience this treasured game from the Super Nintendo Entertainment System, and save the world once more!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A445A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A445A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FINAL FANTASY<sup>&reg;</sup> MYSTIC QUEST<sup>&reg;</sup></span></div>
</div>
