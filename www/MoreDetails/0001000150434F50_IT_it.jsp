...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In Psychosis, uno sparatutto a scorrimento laterale ambientato in un mondo creato dalla mente di un demone perverso, la tua anima si ritrova improvvisamente a vagare in quelle regioni oscure che esistono nel cuore di ognuno di noi. La tua sola via d’uscita consiste nel farti strada distruggendo le grottesche creature che ti bloccano il passaggio nei cinque CAUSES (livelli).<br><br>
Dovrai affrontare i pericoli di questo mondo psichedelico facendo uso dei tre tipi di sparo e dei satelliti opzionali. Utilizzando i potenziamenti potrai cambiare il tuo sparo in un Raggio ad ampio spettro, in un Laser generato da un satellite e molto altro ancora. Ogni tipo di sparo può essere potenziato fino al terzo livello. Puoi anche bloccare il fuoco nemico ruotando i tuoi satelliti nella posizione desiderata.<br><br>
Utilizzare queste funzioni sarà la chiave del tuo successo nella fuga da questo mondo strano e surreale. 
