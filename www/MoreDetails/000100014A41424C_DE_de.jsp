...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mehr als zehn Jahre, bevor Picross DS erschien, gab es bereits Mario's Super Picross für Super Nintendo. Dieses klassische Bildrätselspiel, das bisher nicht außerhalb Japans erhältlich war, umfasst Hunderte von entspannenden aber auch herausfordernden Kniffelaufgaben.
<br><br>
Jedes Picross-Rätsel besteht aus einem Raster von Kacheln, aus denen ein Bild entsteht, wenn die richtigen weggemeißelt werden. Im Mario-Hauptspielmodus bedeutet jeder Fehler den Verlust wertvoller Zeit. Bei den schwierigeren Wario-Rätseln gibt es kein Zeitlimit, allerdings werden Fehler nicht angezeigt.
<br><br>
Wie bei Picross DS auch gibt es bei Mario's Super Picross eine Speichermöglichkeit, die es ermöglicht, ein Rätsel zu einem späteren Zeitpunkt fortzusetzen. Darüber hinaus gibt es eine Auswahl an Hintergrundliedern.
<br><br>Bildschirmtext enthält Japanisch.
<br><br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41424C/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41424C/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mario’s Super Picross<sup>TM</sup></span></div>
</div>
