...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157545845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The deck is shuffled, the blinds are in, and it’s your move. Call, raise, or even bluff your way all in with Texas Hold’em Tournament. You’ll start off in the small Nevada gaming halls and work all the way up to the Las Vegas Championship. With multi-round no-limit hold’em gameplay, there are hours of serious poker action awaiting you. With full Mii™ character support, you can really bring yourself to the table!</div>
  <div id="image02">
