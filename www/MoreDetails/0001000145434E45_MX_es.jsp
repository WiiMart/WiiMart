...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sengoku 3 es un juego de acción de desplazamiento de pantalla publicado originalmente en 2001. Elige uno de los 4 personajes disponibles para jugar y adéntrate en una aventura por todo el mundo, en la que tendrás que destruir a los espíritus malignos despertados por la luna roja. Esta secuela trae consigo una nueva dinámica de juego distinta a la de sus predecesoras al incorporar a una barra ninja (shinobi), que al llenarse permite lanzar gran cantidad de Ataques Ninja contra los enemigos.
<br><br>
El nuevo sistema permite realizar ataques tanto armado como desarmado, además de hacer combos, lo que incrementa el poder de tu personaje. Utiliza técnicas de alto nivel ninja y combos para acabar con tus enemigos en la nueva y emocionante aventura de esta épica serie.
<p>(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434E45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434E45/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SENGOKU 3</span></div>
</div>
