...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Diviértete como antes con esta colección de cinco juegos de arcade clásicos que nunca pasan de moda! Vuelve a descubrir algunos de los juegos más populares de la historia, todos ellos con mejoras en la mecánica de juego, gráficos a la última y efectos de sonido alucinantes. Da el paso y disfruta jugando sin parar… ¡como en los viejos tiempos!
<br><br>La colección incluye:<br><br>
- Cinco juegos de arcade clásicos.
<br><br>
- Niveles que desbloquear, tablas con las mejores puntuaciones y otros divertidos elementos que impedirán que te aburras.
<br><br>
- Gráficos y efectos de sonido actualizados y atractivos.
<br><br>
