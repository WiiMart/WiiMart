...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015746464A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">海外で人気の「クレイジーゴルフ」をテーマにした、誰にでも楽しめるパターゴルフゲームです。アメリカ、アジア、ヨーロッパを舞台に27種のトリッキーなホールが待ち受けます。Wiiリモコンをゴルフクラブのように持って、スウィング。 ベストスコアを目指しましょう。<BR>1人から最大4人までプレイ可能で、Wiiリモコン1つでも複数人でプレイできます。ご家族・お友達、みんなで楽しめるパーティーゴルフゲームです。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015746464A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015746464A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
