...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157504345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Es Little Mac contra Doc Louis! ¿Tienes lo que se necesita para enfrentarte con tu viejo amigo y entrenador? ¡Sube al cuadrilátero y descúbrelo! Demuéstrale que tienes las habilidades para luchar en World Video Boxing Association.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Doc Louis's Punch-Out!!<sup>TM</sup></span></div>
</div>
