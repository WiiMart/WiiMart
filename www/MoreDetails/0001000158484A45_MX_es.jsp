...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484A45')", "wiiSelectSound()");
...
<p>
ThruSpace es un emocionante rompecabezas en donde deberás mover y girar un objeto llamado keydron para poder atravesar un espacio en la pared. Obtendrás puntos cuando logres que el keydron pase a través de los espacios. Cuando domines esta técnica podrás obtener combinaciones (cuando tocas dos cristales al mismo tiempo) y trucos (cuando giras el keydron para crear la forma del espacio y lo atraviesas con la sombra). Estas combinaciones y trucos son la clave para obtener las mejores puntuaciones.
<p>
Refina tu técnica en los diferentes modos de juego (Normal, Infinito, Desafío de los trucos), dale una repasada a la reglas en el tutorial o mira las repeticiones de las partidas que hayas guardado. A medida que progreses en el juego, se incrementará el número disponible de keydron, fases, niveles y de papel tapiz. Además podrás conectarte al Internet (requiere una conexión de banda ancha) y registrar las mejores puntuaciones en las estadísticas a través de la Conexión Wi-Fi de Nintendo y comparar las puntuaciones con las de otros jugadores de ThruSpace.
<p>
Fácil de jugar, difícil de dominar... ¿crees tener la técnica y los reflejos necesarios para superar los cada vez más complejos desafíos de ThruSpace?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484A45/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484A45/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ThruSpace<sup>TM</sup></span></div>
</div>
