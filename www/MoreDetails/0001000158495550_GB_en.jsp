...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158495550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is a demo version, so it is possible that it does not contain all features present in the full version.<br> 
Please note that you cannot save the progress of your game in the demo version.
<br><br>Soccer of the future; destroy the defender blocks and smash the ball into the goal to win, but watch out for the enemy defenders out to destroy you!<br><br> 

A built-in game editor offers unlimited level design possibilities, or play through the 90 game levels over several different play modes, including Arcade and Customisable Tournaments.<br><br> 

- 90 Levels of goal scoring, block breaking fun<br><br> 

- Special level features including animated blocks, exploding blocks, shield blocks, invisible blocks and deadly 3D defender enemies<br><br> 

- 9 challenging end of zone Bosses to defeat<br><br> 

- Level Editor to build your own levels. Up to 100 user created levels can be stored<br><br> 

- Tournament Mode allows you to create your own unique tournaments using game levels or your own levels<br><br> 

- Special Power-Ups & Super Power-Ups to help (or hinder) you on the way to the goal, including lasers, bombs, flaming power balls and multiple balls and bats<br><br> 

- A wealth of Special Achievements and secrets to unlock</div>
  <div id="image02">
