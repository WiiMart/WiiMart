...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Street Fighter® II: The World Warrior ist die Spielesensation, die 1990 nicht nur das Prügelspiel-Genre, sondern die gesamte Videospielwelt revolutionierte. Bei der vorliegenden Fassung handelt es sich um die SNES-Originalversion des Arcade-Meilensteins mit allen acht ursprünglichen Kämpfern, jeder mit eigener Persönlichkeit, eigener Vorgeschichte und Endsequenz. Ob Ryu, Chun-Li oder Guile - die individuellen Stärken, Stile und Spezialtechniken jedes Kämpfers machen Street Fighter® II zu einem wahrhaft einzigartigen Arcade-Erlebnis: Finde deinen Liebling und werde zur Legende im Street Fighter®-Universum!
<br><br>
Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414A50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414A50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Street Fighter<sup>&reg;</sup> II</span></div>
</div>
