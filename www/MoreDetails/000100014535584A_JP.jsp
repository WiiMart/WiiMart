...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気アクションパズル「ぷよぷよ」シリーズ第２作の元祖アーケード版です。シンプルなルールはそのままに「相殺」（そうさい）ルールが初めて採用され、対戦がいっそう白熱！　シリーズ中でも特に人気が高い作品です。さらに本作は『ぷよぷよ』（アーケード版）と同様、「ニンテンドーWi-Fiコネクション」に対応。インターネットを使って、離れた場所にいるぷよぷよ仲間や見知らぬ誰かといつでも対戦することができます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ぷよぷよ通<sup>TM</sup></span></div>
</div>
