...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157424C4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">バブルボブルＷｉｉは、泡吐き怪獣「バブルン」「ボブルン」を操作して泡で敵を包んで割る、単純爽快なアクションゲームです。<BR>懐かしいアーケード版を再現した「スタンダードマップ」全１００ラウンドと、ステージ構成や新たな敵キャラクターなどの新要素を取り入れた、最大４人同時プレイ可能の「アレンジマップ」全１００ラウンドをプレイできます。それぞれのモードで裏面のスーパーマップも楽しめます。<BR>各ラウンドに隠された謎解きを解明し、最終ラウンドのボスを倒し真のエンディングを目指しましょう。<BR>又、各モードでのハイスコアにチャレンジする「ランキングモード」で、Ｗｉ－Ｆｉランキングに登録し、世界のプレイヤーとスコアを競いあうことができます。<BR>更に、追加コンテンツ「エキスパートマップ１」「エキスパートマップ２」を購入する事で、新たなボスとの対決ができる、全５０ラウンドを、お楽しみ頂けます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424C4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424C4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＢＵＢＢＬＥ　ＢＯＢＢＬＥ　Ｗｉｉ</span></div>
</div>
