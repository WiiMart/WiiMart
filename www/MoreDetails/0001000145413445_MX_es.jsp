...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego de pelea fue publicado en 1995 como una secuela del juego del año anterior, Samurai Shodown II. Aunque éste es el tercer capítulo en la serie, la historia sucede entre el primer y segundo juego. Los jugadores pueden elegir entre 12 samurai que buscan vencer a Zankuro Minazuki. Junto con mejoras pequeñas a la versión anterior, como la habilidad de pulsar botones para llenar el medidor de Rabia y la habilidad de bloquear al saltar, también se puede elegir entre estilos de combate Slash y Bust para cada personaje. Cada estilo tiene su propio número de movimientos especiales para usar, lo que efectivamente duplica la cantidad de personajes jugables.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145413445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145413445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SAMURAI SHODOWN III</span></div>
</div>
