...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９９年にリリースされた格闘ゲーム。前年にリリースされた「月華の剣士」の続編で、地獄門を巡る物語も本作でクライマックスを迎えます。今回は１６名の個性的な剣士達が登場し、２種（力と技）の剣質、敵の攻撃を跳ね返す「弾き」、一発逆転の「超奥義」や「潜在奥義」、特定の必殺技をキャンセルして超奥義につなぐ「昇華」など前作同様の要素に加え、空中弾き、空中受身、ダウン回避などの新要素も盛り込んでいます。これらの導入でより戦術的駆け引きが楽しめることでしょう。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014543454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014543454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">幕末浪漫第二幕 月華の剣士</span></div>
</div>
