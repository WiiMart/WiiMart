...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Métete en la piel de Sonic o Tails en Sonic Chaos, el primer título de Sonic de 8 bits en el que Tails aparece como personaje seleccionable.
<br><br>
El Dr. Eggman (también conocido como Dr. Robotnik), ha robado la Chaos Emerald roja para crear armas nucleares, lo que ha roto el equilibrio de las Chaos Emeralds y las ha transportado a un universo paralelo. Como resultado, la tierra natal de Sonic, llamada South Island, ¡se está hundiendo en el océano!
<br><br>
Corre a toda velocidad por los distintos niveles en busca de las seis Chaos Emeralds. Lleva a cabo Embestidas y Acelerones rápidos con Sonic, o vuela y haz Torbellinos con Tails mientras exploras cada rincón para restablecer el orden en Sonic Chaos. Este juego salió originalmente para SEGA MASTER SYSTEM.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414D50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414D50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sonic Chaos<sup>TM</sup></span></div>
</div>
