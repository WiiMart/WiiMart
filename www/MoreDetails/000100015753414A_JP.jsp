...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753414A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「MADSECTA」は、近未来を舞台とした未確認昆虫型宇宙生物と人間の戦いを、自分がまるで戦場で戦っているかのような臨場感で楽しめるFPS（一人称シューティング）ゲームです。<BR><BR>プレイヤーは対異生物特殊部隊の一員となって、襲い来る圧倒的な量の宇宙生物を殲滅する作戦に参加します。<BR>「
サブマシンガン」や「グレネード」などの多彩な武器を駆使しながら、圧倒的な量の宇宙生物を一掃する爽快感と、ミッションをクリアしていくと現れる巨大ボスとの緊張感溢れる激しい攻防が本作の魅力です。<BR>また、画面に付いた敵の体液をふき取る動作など、Wiiならではの操作で臨場感をさらに彩ります。<BR><BR>また、通常のゲームモードのほかに、Wi-Fiコネクションに接続することで最大4人まで協力プレイが可能な「フリーバトルモード」や、専用のフィールドで制限時間内に倒した敵のポイント数で競う「ランキングバトルモード」など、世界中のライバル達と楽しめるゲームモードを収録しています。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MADSECTA</span></div>
</div>
