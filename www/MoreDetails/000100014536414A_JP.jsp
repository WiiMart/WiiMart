...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機を左右に操作して、画面上方に現れる敵を撃破していく画面固定型のシューティングゲームです。最大の特徴は３種類の自機を合体できる「ドッキング」システム。それぞれの自機が持つ特性に注意して敵と戦い、３種類すべてを残してゲームを進めると合体のチャンスが。ドッキングがうまく成功すると、最大３機が合体してパワーアップした状態でゲームを続けることができます。体当たりで攻撃してくる個性的な敵を
すべて撃ち落とすと、次の面に進みます。合体シューティングというジャンルを作り出し、耳に残る名サウンドや画期的なゲーム性で一世を風靡しました。<BR><BR>詳細は、<Center>http://www.hamster.co.jp/products/vca.htm</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ムーンクレスタ</span></div>
</div>
