...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157385750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Crée et envois d'amusantes
cartes d'Halloween.
<br>
Utilise toute ton imagination et habille ton personnage avec différents costumes, puis décore la carte, en choisissant l'arrière-plan, la musique et plein d'autocollants.
<br>
Avec la télécommande Wii, tu peux naviguer facilement dans les différents menus et ajouter les autocollants, dans la position et la taille de ton choix.
<br>
Une fois que la carte est terminée, écris un message personnel et envoie-la à tes amis.
<br>
Essaie ce nouveau programme très simple et très sympa !
Suis le rapide didacticiel et apprends à t'en servir correctement !
<br><br>
...
Certains services en ligne proposés sur la console Wii ayant été désactivés le 28 juin 2013, les fonctions en ligne de ce logiciel utilisant WiiConnect24 ne sont plus disponibles.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157385750/FFFD0010" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157385750/FFFD0011" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
