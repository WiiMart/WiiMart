...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494550')", "wiiSelectSound()");
...
<br><br>Cinco pollitos en tu bando, cinco en el otro. ¡BUM!
<br><br>
Vence al equipo de pollitos rival... ¡pero de una forma totalmente diferente! En chick chick BOOM lanzas pianos, elefantes rosas y pollitos sumo, o invocas medusas gigantes y ovnis de verdad.
<br><br>
Traza líneas en la arena para defenderte de los ataques del rival: tu creatividad, tu coordinación y el uso que hagas de la tinta serán factores clave. Una mazorca y una piñata también te echarán una mano. ¡Va en serio!
<br><br>
Juega solo o con tus amigos; en equipo o unos contra otros. Para que no decaiga, tienes varios modos de juego y arenas, cada una con su ataque especial.
<br><br>
Características:
<br>
• Un jugador y multijugador: 1-4 (en equipo o unos contra otros).
<br>
• Movimientos ofensivos: más de veinte divertidos ataques.
<br>
• Tres arenas: la ciudad, el barco y el fantasbosque.
<br>
• Quince equipos: cinco disponibles inicialmente y diez más desbloqueables.
<br>
• Tres modos de juego: duelo, tiempo y Pro.
<br>
• Récords: se guardarán las mejores puntuaciones... para que las batas.
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494550/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494550/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
