...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157495350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le avventure di Guybrush in alto mare continuano, con i soldati appestati che mettono sotto assedio gli innocenti abitanti di Spinner Cay. Mentre cerca di difendere i Sireni e al tempo stesso di sfuggire al persistente cacciatore di pirati che lo insegue, Guybrush riesce a raggiungere la sua amata moglie e il suo acerrimo nemico, ma la loro riunione si rivela breve. Ora Guybrush deve concentrarsi per sconfiggere il Virus di LeChuck prima che faccia ulteriori danni. Mentre il possente pirata cerca di trovare una cura, le acque diventeranno sempre più torbide in questo avvincente capitolo dell'epica saga.<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
