...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">King of Fighters ’98 is het 5de deel in de vechtspellenreeks dat werd uitgegeven als een compilatie nadat de rust was wedergekeert na de epische Orochi Sage. King of Fighers ’98 heeft in totaal 38 personages, welke kunnen worden opgesplitst in 12 teams plus 2 individuele personages. Ditmaal zien we de terugkomst van het langverwachte Sports Team. De gameplay is vrijwel hetzelfde als bij de voorganger ’97, waarin spelers geavanceerde of extra modi kunnen selecteren die bij hun individuele stijl past. Een voorbeeld van een kleine vernieuwing is bijvoorbeeld meer aanpasmogelijkheden waar de fans heel blij mee zijn, en betere vechtmechanismen.<br><br>De software is voorzien van Engelse schermteksten.</div>
  <div id="image02">
