...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157445045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El doctor está listo! Esta versión especial de sólo multijugador de Dr. Mario Online Rx está disponible una vez que un amigo que posee la versión completa del juego te la ha enviado. Después de que la descargas, puedes disfrutar de la acción clásica de rompecabezas de Dr. Mario gratis. Empareja vitaminas con las bacterias del mismo color para salvar al mundo de esas bacterias desagradables. ¡Es una receta para la diversión que quieres llenar en seguida!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157445045/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157445045/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
