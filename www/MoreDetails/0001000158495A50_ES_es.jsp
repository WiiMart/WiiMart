...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495A50')", "wiiSelectSound()");
...
<br><br>3D Pixel Racing es un juego de carreras que recuerda los clásicos de la historia de los videojuegos.<br>
Están disponibles varios modos de juego, desde las clásicas carreras en solitario hasta las excitantes carreras de persecución.<br>
El juego cuenta con 10 pistas, 11 coches y 10 pilotos. ¡Completa varios desafíos para desbloquear los contenidos ocultos!<br>
¡Disfruta del modo multijugador con pantalla compartida donde pueden jugar hasta 4 amigos al mismo tiempo!  <br>
Modos de juego: carreras en solitario, campeonato, captura la bandera, persecución y contrarreloj.<br>Condiciones atmosféricas: sol, niebla, lluvia y nieve. 
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495A50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495A50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">3D Pixel Racing</span></div>
</div>
