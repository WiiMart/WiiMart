...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In the year 200X, the notorious Dr. Wily, now reformed and working for the forces of good, works hand in hand with Dr. Light to build a new type of peacekeeping robot. When a new set of eight Robot Masters escapes the lab to wreak havoc on the world at large, only Mega Man can save the day! This time, Mega Man must rely on his new slide move and his canine companion Rush to conquer the stages and vanquish evil. A new character, Proto Man, adds to the mystery and appeal of this seminal title in the famous action-game series.</div>
  <div id="image02">
