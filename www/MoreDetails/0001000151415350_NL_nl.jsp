...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lords of Thunder is een zijwaartsscrollend schietspel waarin je de rol van een legendarische krijger op je neemt, terwijl je vijanden vernietigt op heavymetalmuziek. Je vijanden willen The Dark One, Zaggart, die opgesloten is onder de zes continenten van Mistral, tot leven wekken. Het is jou, Landis, nazaat van Dyu, om ze te stoppen.<br><br>
Je kunt zelf de volgorde kiezen waarin je de 6 levels aanpakt. Voordat je aan een level begint, kies je een van de vier magische wapenuitrustingen en gebruik je je verzamelde kristallen om voorwerpen te kopen. Het kiezen van de juiste wapenuitrusting is cruciaal.
Neem het op tegen vijanden, zoals een vuurspugende zeeslang en een gigantisch insect.<br><br> Of je nu op een razend tempo aan het knallen bent of het kasteel van een eindbaas probeert binnen te sluipen, de intensiteit van Lords of Thunder zal je omverblazen.
...
<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000151415350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151415350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Lords of Thunder</span></div>
</div>
