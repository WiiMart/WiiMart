...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574D4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Che cos'è MaBoShi: L'arcade delle tre forme? Si tratta di un gioco che ne contiene tre. Sembrano semplici, ma nascondono un gameplay molto profondo.
<br><br>
Questo gioco si basa su tre forme: il cerchio, la barra e il quadrato. Grazie alla presenza di tre finestre di gioco, fino a tre persone possono giocare contemporaneamente, usando solo il pulsante A o la pulsantiera +. Ciò che avviene in ogni finestra influenzerà il gioco che si svolge nelle altre.
<br><br>
Nei tre giochi l'obiettivo è lo stesso: ottenere un milione di punti! Ma il modo per riuscirci è diverso in ogni modalità. Nella Modalità Cerchio dovrai colpire i nemici con la sfera, nella Modalità Barra dovrai zigzagare verso il traguardo e nella Modalità Quadrato dovrai farti strada attraverso labirinti di blocchi da incendiare.
<br><br>
MaBoShi: L'arcade delle tre forme ti permette di usare i Mii, inviare e ricevere replay tramite WiiConnect24 e contiene anche una versione per DS per giocare quando vuoi!
<br><br>
Il testo all'interno del gioco è in italiano.
<br/><br/>
Le funzioni online di questo software utilizzabili tramite WiiConnect24 non sono più disponibili, poiché parte dei servizi online della console Wii non è più operativa dal 28 giugno 2013.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4250/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">L'arcade delle tre forme</span></div>
  </div>
