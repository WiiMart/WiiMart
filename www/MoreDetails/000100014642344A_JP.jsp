...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">歴史あるビリヤードを未来派感覚にアレンジした異色のボールゲームです。ルールは簡単。キューを使って盤上の白い手玉を突き、番号の付いた的玉に命中させてポケットに落とすだけです。盤面の形状は３０種とバラエティに富み、ボールの配置は２パターン、さらにボールの動きを決める摩擦係数なども変更できるので、多種多様なプレイが楽しめます。またシングルプレイだけではなく、ＣＰＵ対戦や２人対戦プレイにも対応しています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642344A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642344A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＬｕｎａｒＢａｌｌ</span></div>
</div>
