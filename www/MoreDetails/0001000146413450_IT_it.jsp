...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Shigeru Miyamoto, il creatore di Mario, è anche l'autore di questo gioco d'azione poco conosciuto in cui dovrai aiutare l'eroico draghetto Tamagon a sconfiggere il male.
<br><br>
Raccogli i punti Boa-Boa che trovi lungo il percorso e sconfiggi i nemici investendoli con una fiammata! Non dimenticarti di tenere d'occhio il demone che si trova nella parte superiore dello schermo: basta un suo cenno e i suoi scagnozzi sposteranno il labirinto nella direzione indicata al solo scopo di intrappolarti fra due muri!
<br><br>
Se hai l’impressione che qualcosa del genere ti sia già capitata, forse è perché hai già incontrato il demone in Super Smash Bros. Brawl: lì compare in qualità di assistente e ti tira lo stesso scherzo.
<br><br>
Il testo all'interno del gioco è in inglese.
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Devil World<sup>TM</sup></span></div>
</div>
