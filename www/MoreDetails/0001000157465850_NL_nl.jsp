...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157465850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Zeker in het koude jaargetijde zit iedereen graag bij een knusse open haard. Maar niet iedereen heeft de mogelijkheid zich er bij eentje behaaglijk neer te vlijen. Je nieuwe WiiWare Knus Haardvuur verandert elke kamer in een sfeervolle omgeving!
<br><br>  
Kies uit verschillende houtblokken en stapel deze met de Wii-afstandsbediening op elkaar. Nu nog de lucifer aansteken en al snel wordt het knus en gezellig bij je thuis. Je kunt uit zes verschillende open haarden kiezen: Puur vuur, Kampvuur, Rustiek, Klassiek, Elegant en Zen-haard. <br>  
Wakker het vuur aan en houdt het gaande, zodat het niet aan kracht verliest. Leg er nieuwe houtblokken op, die net zo opbranden als bij een echte open haard. Wil je je alleen maar gewoon ontspannen? Geen probleem, in het speltype Butler worden houtblokken automatisch op het vuur gelegd en in het speltype Non-stop branden de blokken niet op.
<br>  <br>    
Behaaglijk geknisper en een levensecht vuur, wat kun je je nog meer wensen? En niet alleen als het zo koud is!

 <br>  <br>   
• 6 open haarden: Puur vuur, Kampvuur, rustieke haard, klassieke haard, elegante haard en Zen-haard.<br>  
• Knusse geluiden<br>  
• Realistische simulatie dankzij PhysX® van NVIDIA Technologie<br>  
• 4 spelopties: Butler (houtblokken worden automatisch op het vuur gelegd), Non-stop (houtblokken branden niet op), Standaard (kant-en-klaar vuur in een haard die je zelf kunt kiezen), Individueel (houtblokken zelf kiezen en in de haard leggen)<br><br>    
Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Knus Haardvuur</span></div>
</div>
