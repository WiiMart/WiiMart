...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">天使ピットが闇の女神メデューサから光の女神パルテナを救い出し、エンジェランドに平和を取り戻すため、冒険を繰り広げるアクションシューティングです。豊富なアイテムを利用して、歯ごたえのある縦・横４つのステージを乗り切ります。ゲームオーバー時のピットの一言「ヤラレチャッタ」もこのゲームで話題になった名セリフの一つです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">光神話　パルテナの鏡<sup>&reg;</sup></span></div>
</div>
