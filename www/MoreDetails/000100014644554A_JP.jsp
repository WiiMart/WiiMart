...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「くにおくん」率いる熱血高校のドッジボール部員６名を操作し、花園高校や世界の強豪８チームを相手にドッジボールの勝ち抜き戦にいどみます。通常のドッジボールのルールとは異なり、３人の内野選手が体力の尽きるまで戦う変則ルールで、ダッシュやジャンプ、キャラクターそれぞれに設定された個性的な必殺シュートなどを駆使して戦います。さらに、お互いにチームを選択しての２人対戦や、４人まで同時に遊べるバトルロイヤル対戦もあり、複数人でお楽しみいただけます。熱血高校スポーツシリーズの第一弾でもあり、シンプルながら奥深いゲーム性は、ファミコン用スポーツ対戦ゲームとして人気を博しました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">熱血高校ドッジボール部<sup>&reg;</sup></span></div>
</div>
