...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157385750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Crea divertidas tarjetas de Halloween y envíalas!
<br><br>
Usa tu imaginación para vestir a tu personaje con diferentes disfraces. Luego, decora la tarjeta eligiendo el fondo y la música. También podrás elegir entre muchas pegatinas.
<br>
Usa el mando de Wii para navegar por los diferentes menús y añadir las pegatinas. Podrás elegir la posición y el tamaño que quieras.
<br>
Una vez acabada, escribe una nota y envíasela a tus amigos.
<br>
Prueba este nuevo y fácil programa.
¡Sigue el sencillo tutorial para aprender a usarlo correctamente!
<br><br>
...
Como algunos de los servicios en línea de la consola Wii han dejado de estar disponibles el 28 de junio de 2013, ya no es posible acceder a las funciones en línea de este programa por medio de WiiConnect24.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157385750/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157385750/FFFD000D" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
