...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157524250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Robocalypse - Beaver Defense est un « tower defense », ou jeu de stratégie, qui offre des armes brutales et des moyens de destruction hilarants dans un monde de robots belliqueux et railleurs.<br><br> Les joueurs créent des tours puis les placent de manière à éliminer des vagues de robots ennemis pendant que des robots héros dirigés par le joueur servent d’unités d’armes mobiles capables de tirer de violents coups de feu sur toutes les zones du champ de bataille. 
<br><br>Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Robocalypse<sup>TM</sup> - </span></div>
</div>
