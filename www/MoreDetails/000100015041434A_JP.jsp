...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">地下迷宮を舞台にしたアクションＲＰＧ。ダンジョン内に仕掛けられたトラップを攻略し、次々と現れる敵を倒します。キャラクターはファイター、シーフ、ウォーロック、ウイッチ、バード、ビショップ、エルフ、ドワーフの８種類から選択可能で、使える魔法や攻撃力、移動能力が異なります。それぞれの特性や敵の弱点をうまく利用することがダンジョン攻略のポイント。最大５人まで遊べる多人数プレイではチームワークが勝利のカギです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダンジョンエクスプローラー<sup>&reg;</sup></span></div>
</div>
