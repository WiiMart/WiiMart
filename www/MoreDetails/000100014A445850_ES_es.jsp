...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Aero the Acrobat, el acróbata extremo, se pone en marcha una vez más para detener al malvado ex payaso, Edgar Ektor! ¡Aero ha entrado en un nuevo mundo encantado y deberá usar toda su habilidad acrobática para detener un complot criminal conocido como “Plan B”! ¡Únete a Aero y conoce a nuevos amigos (y enemigos) en un mundo hecho a medida para sus aventuras de altos vuelos!
<br><br>
¡45 niveles de diversión acrobática desenfrenada!<br> ¡Pantallas de bonificación, desafíos y zonas secretas!<br>
¡Con nuevos enemigos y voces originales digitalizadas!<br>
¡Prueba la función de contraseña y regresa a cualquier mundo que ya hayas pasado!<br>
¡Las pantallas de snowboarding añaden una nueva dimensión al estilo de Aero!<br>
¡Nuevos movimientos y técnicas de combate para los ataques!
<br><br>
