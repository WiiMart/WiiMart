...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">赤い頭巾をかぶった「忍者くん」を操り、敵を倒していくステージクリア型のアクションゲームです。宝物を狙って魔物たちがお城へ侵入した事にいち早く気づいた忍者くんは、たった一人で魔城へ乗り込み、奪われた宝物を取り戻すために戦いを始めます。武器は手裏剣のみですが、上から敵を踏みつけたり、ジャンプで体当たりすることで気絶させたりすることができ、シンプルながらもさまざまな戦い方が用意されています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">忍者くん 魔城の冒険</span></div>
</div>
