...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年に発売された格闘ゲームで、神々による戦いをモチーフにしています。プレイキャラは、スサノオ、孫悟空、弁財天、チチ＆ネネ、イグレット、シーナ、酒天童子、紊天（びんてん）といった具合で、古今東西＆オリジナルの神々が登場。本作最大の特徴は、多彩な駆け引きが楽しめることです。コマンドによる必殺技はもちろん、空中ダッシュ、空中ガード、ガードキャンセル、ふっとばし攻撃、打撃回避、投げ受け身、コンビネーション。さらにゲージを溜めることで使用可能になる、天変地異技や超神拳技にも注目です。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">神凰拳</span></div>
</div>
