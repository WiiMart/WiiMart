...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">高機動武装ヘリ「スーパーサンダーブレード」を操作し、バルカンとホーミングミサイルを駆使して武装ゲリラと戦うシューティングゲームです。各ステージは２種類のシーンから構成され、３Ｄシーンでは迫り来る敵を撃破しながら障害物をかわして奥へと突き進み、２Ｄシーンではボスである巨大兵器を上空から奇襲します。戦いの決め手となるのは、ヘリならではのホバリングアクション。スピードを自在に調節して、洞窟の中や工場パイプの間をくぐり抜け、敵の本拠地をめざします。セガ体感ゲーム第七弾として話題を呼んだアーケードゲームを家庭用ゲーム向けに再構築、メガドライブ本体との同時発売でそのデビューを飾りました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーサンダーブレード<sup>TM</sup></span></div>
</div>
