...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157505945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Salta y rueda con Pallurikio, un juego de plataformas lleno de acción y de ritmo trepidante, fácil de aprender, pero difícil de dominar. Mientras juega a un misterioso juego de mesa que encontró con sus amigos, Rusty es absorbido en un vórtice dimensional y se ve arrojado a un mundo asombroso y místico, donde toma el aspecto del redondo y vivaz Pallurikio. Usando el Wii Remote para apuntar a la pantalla, haz saltar y rodar a Pallurikio y ayúdale a encontrar el camino a través de más de 50 tentadores niveles, mientras sobrevive a todo tipo de obstáculos y artimañas que le acechan al atravesar la Bakumbala Jungle, los lejanos confines de Palluro Prime y muchos otros extraños escenarios. Con simulación física, modo Time Attack, cartas coleccionables y cohetes espaciales para lanzar, ¡Pallurikio es un juego que no querrás perderte!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
