...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Te encuentras solo con tus armas, y la estrecha playa de Blood Beach es lo único que te separa de la Armada Imperial Japonesa. Enfrentado a una mayoría numérica abrumadora, tu única alternativa es luchar y vencer.
<br><br>
Aunque cuentas con un arsenal increíble (dispones de una ametralladora Browning M2, un cañón M1 de 40 mm y una metralleta Thompson), las fuerzas japonesas no cejarán en su empeño de recuperar las Islas Salomón, y te lanzarán todo lo que tengan (aviones “Zero” y “Betty” e incluso acorazados Takao) para conseguir su objetivo.
<br><br>
