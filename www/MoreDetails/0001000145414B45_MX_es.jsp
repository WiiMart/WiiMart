...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Estrenado en 1991 por SNK, BURNING FIGHT es un juego de acción horizontal con combate de mano a mano. En su búsqueda de Casterora, líder de un sindicato enorme que ha escapado de Nueva York a Osaka, los protagonistas son tres detectives: Duke, Ryu, y Billy. Cada personaje pelea usando una combinación de golpes, patadas, saltos, y su propia movimiento especial activado al oprimir simultáneamente los botones de salto y ataque. Estas técnicas letales tienen una fuerza masiva de destrucción, pero también consumen una gran cantidad de energía. Por esta misma razón, los jugadores tendrán que usar sus movimientos especiales en el momento ideal. Por suerte para los detectives, podrás encontrar nuevas armas y salud adicional al romper objetos como casetas telefónicas y señales de la calle que encontrarás por el camino. Un jefe te esperará al final de cada nivel, y tendrás que derrotarlo para continuar tu misión. También podrás enfrentarte a las pandillas con un amigo, ¡pero ten cuidado! Los ataques de un jugador pueden dañar al otro, así que debes estar pendiente de dónde está tu compañero durante la batalla. ¡Acaba con el reino de terror de Casterora de una vez por todas!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414B45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414B45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BURNING FIGHT</span></div>
</div>
