...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157503750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Starry Night ti consente di osservare i corpi celesti stando comodamente davanti alla TV e usando il telecomando Wii.<br><br>

Il gioco presenta tre modalità principali.<br>
La Modalità Osservatorio contiene circa 20.000 corpi celesti, fino a stelle di magnitudine 7. Puoi modificare impostazioni come mostrare la latitudine e longitudine delle costellazioni, la velocità a cui trascorre il tempo ed altro.<br><br>

Nella Modalità Planetario puoi intraprendere 11 itinerari diversi che trattano argomenti come stelle, nebulose e altri corpi celesti.<br><br>

La Guida ai corpi celesti contiene dati specifici e mitologia sui corpi celesti e le costellazioni, oltre a un utile glossario di termini astronomici usato nell'osservazione.<br><br>

My Starry Night è un gioco in cui puoi ammirare il cielo stellato mentre impari a conoscere i corpi che lo popolano.<br><br>
Vieni a osservare le misteriose stelle che popolano il cielo.

<br><br>
Le informazioni sui corpi celesti sono aggiornate a giugno 2010.<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157503750/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157503750/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">My Starry Night<sup>TM</sup></span></div>
</div>
