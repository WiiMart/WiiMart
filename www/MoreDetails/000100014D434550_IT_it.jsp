...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In questo nuovo episodio della serie Fantasy Zone, caratterizzato soprattutto dallo scorrimento laterale, Opa-Opa deve vendicare la morte del padre.<br><br> In ogni livello, dovrà annientare tutti gli Enemy Generator (Generatori di nemici) per far comparire il guardiano del livello, il Menon Guardian, e proseguire nel gioco. Ogni nemico eliminato ti permette inoltre di accumulare oro con il quale comprare armi più potenti e migliorare l’armamentario a disposizione. Usa saggiamente il tuo oro: ogni boss di fine livello rappresenta una sfida diversa!
<br><br>
