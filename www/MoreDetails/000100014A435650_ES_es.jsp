...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Felicidades, acabas de aterrizar en la elitista academia de vuelo Pilotwings! Ya puedes disfrutar de uno de los grandes clásicos de Super Nintendo, un fantástico simulador de vuelo que elevó el género a cotas nunca alcanzadas con anterioridad y que lleva la impronta del mítico Shigeru Miyamoto.
<br><br>
Ponte a los mandos de distintos tipos de aeronaves y asciende en el escalafón de la academia. Surca los cielos con un biplano, atraviesa las esferas flotantes y acaba con un aterrizaje perfecto. Lánzate al vacío con la única ayuda de un paracaídas y exhibe tus habilidades descendiendo hasta el lejano objetivo. O vuela sin motor con el ala delta aprovechando las corrientes térmicas. ¡Puedes incluso experimentar con el cinturón cohete!
<br><br>
Si demuestras que estás preparado, desbloquearás niveles extra que te enfrentarán a desafíos de altos vuelos. A los mejores pilotos se les propone una peligrosa misión de rescate en helicóptero. Con Pilotwings... ¡el cielo es el límite!
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A435650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A435650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pilotwings<sup>TM</sup></span></div>
</div>
