...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Alex mantiene la esperanza de que su padre, el rey Thor, quien está secuestrado, regrese al reino de Planet Aries. Cuando recibe noticias sobre que su padre continúa con vida y se encuentra cautivo en el planeta Paperock, Alex acude a su rescate. A lo largo de 11 niveles, pelearás con enemigos y evitarás obstáculos mientras ganas monedas con las que comprar objetos especiales y vehículos. Al final de cada fase te encontrarás con un jefe final y te adentrarás en el mundo "piedra, papel y tijera". Derriba los símbolos correctos y estarás más cerca de traer al rey Thor de vuelta a casa.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D415845/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D415845/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Alex Kidd<sup>TM</sup></span></div>
</div>
