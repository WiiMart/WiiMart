...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SPIN MASTER è un avvincente gioco di azione a scorrimento che ti vede nei panni di Johnny, temerario avventuriero.
<br><br>
Il tuo scopo è recuperare la mappa del tesoro che il malefico Dr. De Playne ti ha sottratto e Mary, la tua amata, che questi tiene in ostaggio.
Il gioco è suddiviso in 5 livelli, ciascuno con un boss finale, colorato e singolare, da affrontare. Solo sconfiggendo i vari boss è possibile ottenere, uno ad uno, i pezzi della mappa. E una volta messo insieme ogni singolo elemento, preparati a una sorpresa ancora più grande.
<br>
Oltre ai due comandi più usati, attacco e salto, avrai a disposizione una gran varietà di attacchi speciali che renderanno le battaglie spettacolari e divertenti. Qualche esempio? Attacco caricato, scivolata, bomber e tanti altri. Raddoppia, infine, l’avventura in modalità a due giocatori!
<br><br>
