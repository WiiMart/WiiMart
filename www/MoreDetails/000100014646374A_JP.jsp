...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコン版の『がんばれゴエモン』シリーズ第三弾。
今回はシリーズ初のロールプレイングゲームです。
何者かに盗まれた家宝の黄金キセルを探すため、仲間と力を合わせ、冒険を進めていきます。
敵からダメージを受けると体力が減り、仲間全員の体力が０になるとゲームオーバーです。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014646374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">がんばれゴエモン外伝</span></div>
</div>
