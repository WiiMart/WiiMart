...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D5850')", "wiiSelectSound()");
...
<br><br>
Pueden jugar uno o dos jugadores. En este último caso, uno controlará a Max y otro el rotulador mágico.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
