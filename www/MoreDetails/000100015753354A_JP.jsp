...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753354A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">最強を誇る「銀星」シリーズに五目並べが登場。個性豊かな５人の対戦者がプレイヤーを待ち受けます。多彩なルール設定で、初心者から上級者までお楽しみいただけます。また最大10個の対局データの保存や、初心者の方には安心のヒント、研究にも使える棋譜再生など、対局を楽しむための豊富な機能を搭載しています。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753354A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753354A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">最強銀星五目並べ</span></div>
</div>
