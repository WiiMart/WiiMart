...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juego de puzle publicado por Data East en 1997.
<br><br>
Métete en los zapatos de un payaso y elimina las bolas apiladas en lo alto de la pantalla. Para ello, atrae las bolas de arriba y dispáralas de vuelta. Alinea columnas de tres o más bolas del mismo color para eliminarlas. Las bolas irán descendiendo a medida que pase el tiempo, y el juego terminará cuando toquen el suelo, ¡así que procura no relajarte! Muévete rápidamente para destruir todas las bolas que puedas y, cuando seas un experto, utilízalas para formar combos y reacciones en cadena.
<br><br>
Las reglas de esta edición son básicamente las mismas que las de las anteriores, pero en esta ocasión podrás elegir entre dieciséis personajes y tendrás acceso al nuevo modo "Magical Journey". ¡Disfruta con el divertido mundo de MAGICAL DROP III!
<br><br>
