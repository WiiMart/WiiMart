...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Basado en el tercer juego de la serie de arcade extremadamente popular, Donkey Kong 3 introduce a un exterminador llamado Stanley, quien desesperadamente intenta proteger las flores de su invernadero de Donkey Kong. Armado solo con su pulverizador, Stanley tiene que forzar a Donkey Kong a que suba más y más arriba sobre las vigas del invernadero hasta que Donkey Kong esté fuera de la pantalla y así alcances el siguiente nivel. Como es de esperar, Donkey Kong no está dispuesto a moverse sin una pelea, así que decide enviar oleadas de insectos, abejas, y otras criaturas hacia Stanley. Pero no es tan fácil como simplemente rechazar a los insectos. Stanley también tiene que protegerse de los proyectiles que Donkey Kong le lanza. Si Stanley es lo suficiente bueno, agarrará un pulverizador contra insectos todavía más fuerte y obligará a Donkey Kong a moverse. ¡La mezcla de todo esto ofrece una diversión frenética que todos pueden disfrutar!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146455545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146455545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Donkey Kong<sup>TM</sup> 3</span></div>
</div>
