...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ディスクシステム用ソフトとして１９８９年に発売されたホラーサスペンス調アドベンチャーゲーム『ファミコン探偵倶楽部ＰＡＲＴⅡ　うしろに立つ少女』前編・後編を、「ファミ探」シリーズ１０周年を記念してスーパーファミコン（ニンテンドウパワー）用にリメイクしたものです。基本的なシナリオはそのままに、「あらすじ機能」「メモ機能」などシステム面を再設計してプレイしやすくなりました。<BR>サウンドやグラフィックもディスクシステム版当時のイメージを踏襲しつつもより洗練されたものになったほか、演出面も向上しており、本格推理ファンもお楽しみいただける内容です。プレイヤーは探偵事務所の助手となって、ある女子高生の殺人事件を調査するうちに、学校に伝わる「うしろの少女」という不気味なうわさ話にたどり着きます。どこにでもある、ありふれた学校の怪談が彼女の死とどんな関係があるのか。さまざまな人物から話を聞くなどして情報を集め、事件解決をめざしましょう。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43494A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファミコン探偵倶楽部<sup>&reg;</sup>ＰＡＲＴⅡ</span></div>
</div>
