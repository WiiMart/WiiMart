...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157425345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Pop tu objetivo consiste en explotar burbujas. Puede parecer un poco simple, pero hay muchas cosas que puedes hacer para lograr una buena puntuación y pasarlo bien: <p>
...
4 modos diferentes de juego. <p>
También hay tablas con las mejores puntuaciones en línea y mensajes de WiiConnect24 para mantenerte informado acerca del progreso de tus amigos y para poder alardear de tus propias puntuaciones.</div>
  <div id="image02">
