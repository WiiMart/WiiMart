...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">いろいろなものを吸い込んで身体で持ち運ぶことができる主人公「はっくん」を操作して「虹のかけら」を集めていく、アクションパズルゲームです。ブロックや色などを吸って運び、吸ったブロックをはいて足場を作ったり、吸った色をブロックに注入して動きを変化させたりしながら、「虹のかけら」をすべて集めると面クリアです。面のプレイ中には、現在の状態を一時的に保存できるクイックセーブを使って、いつでもその状態からやり直すことが可能。１０ステージ全１００面をクリアするとさらに難しいＥＸＴＲＡ面が待っていたり、無駄な動きをせずに少ない手順でクリアすると高ポイントを得られるなど、シンプルながらもやればやるほど長く楽しめます。各ステージにひとつずつ隠れている「紫まっくん」とのバトル面をすべてクリアすると、便利な隠しコマンドを知ることもできます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">すってはっくん<sup>TM</sup></span></div>
</div>
