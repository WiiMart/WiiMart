...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「餓狼伝説」シリーズの中でも名高い、１９９３年に発売された２Ｄ対戦格闘ゲームです。サウスタウンの支配者として裏の世界を知る誰もが恐れる男「ギース・ハワード」が復活し、自らの座を奪った異母兄弟の「ヴォルフガング・クラウザー」、そして「テリー・ボガード」「アンディ・ボガード」に復讐の炎を燃やします。前作『餓狼伝説２』の進化した２ラインシステムや「超必殺技」などを受け継ぎ、ゲームスピードの向上や連続技の導入など多くの新要素や調整がほどこされてパワーアップ。大幅に増えた合計１５名ものキャラクターのそれぞれ異なる個性的な必殺技を駆使して、新たな伝説をつくりあげてください。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">餓狼伝説スペシャル</span></div>
</div>
