...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574E4B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Are you also in love with those unforgettable arcade classics where the only goal is to vanquish all opponents to reach the next stage? Niki - Rock 'n' Ball is a new interpretation of those games with a completely innovative and unique gaming mechanism. Roll along with Niki through fantastic worlds, find all the ZeLeLi pearls, and liberate your village from cuddly as well as evil monsters before it is too late! Timing is everything! Jump in the nick of time to avoid landing amid barbs and hop about across the stages thanks to the realistic gaming physics. Snap on the ZeLeLi amulet, transform yourself into Niki Rock, and force even the most obstinate monster to its knees! Explore all the stages and win valuable medals while dribbling through them alone or along with a friend. Play Niki - Rock 'n' Ball with all the familiar controls in the Retro style, or experience the novel controls in the Wii style!</div>
  <div id="image02">
