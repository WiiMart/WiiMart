...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157545850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The deck is shuffled, the blinds are in and it’s your move. Call, Raise or even bluff your way All-In with Texas Hold’em Tournament.  Build your poker skills by playing against five computer opponents.<br><br>Texas Hold’em Tournament also lets you play multiplayer poker with up to five friends, and with full Mii™ support, you can really bring yourself to the table! Start off in the small Nevada gaming halls and work your way up to the Las Vegas Championship. With multi-round no-limit hold’em gameplay there are hours of serious poker action awaiting you!</div>
  <div id="image02">
