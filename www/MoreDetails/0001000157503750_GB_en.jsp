...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157503750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Starry Night is a game that allows you to observe celestial bodies from the comfort of your TV using the Wii Remote.<br><br>

There are 3 main modes.<br>
Observation Mode that contains approx. 20,000 celestial objects up to stars of the 7th magnitude. You can change different settings like displaying the latitude and longitude of constellations, how fast time elapses, and more.<br><br>

In Planetarium Mode, you can take 11 different tours that cover various subjects like stars, nebulae, constellations, and other celestial objects.<br><br>

The Celestial Guidebook contains detailed information and mythology on celestial objects and constellations as well as a helpful glossary of astronomy terms used in observation.<br><br>

My Starry Night is a game where you can enjoy looking at the night sky while learning about the objects that it contains.<br><br>
Come; take a deep look into the mysterious stars that fill the sky.

Information on celestial objects is up-to-date as of June 2010.</div>
  <div id="image02">
