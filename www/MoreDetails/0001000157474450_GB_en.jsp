...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157474450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Awesome classic 2D space shooting action! Take control of the space ship Vic Viper and blast through levels filled with hundreds of enemies, obstacles and massive bosses! Collect power-up capsules to boost your weapon system, from simple speed-ups to bombs to lasers to multiple copies of your ship and its weapons!
<br>
<br>
FEATURES
<br>
<br>
An entirely new episode in Konami’s cult shooting game series.
<br>
<br>
Score Attack Mode with online hi-scores – compare your performance with your friends!
<br>
<br>
Expandable weapon system with Speed-Up, Missiles, Spread Bombs, 2-Way Missiles, Double Shot, Vertical Shot, Tail Gun, Laser, Twin Laser, Ripple Shot, Option, Shield and Force Field.
<br>
<br>
Replays – record and play back your missions.</div>
  <div id="image02">
