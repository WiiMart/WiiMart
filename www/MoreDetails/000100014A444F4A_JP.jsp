...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコンディスクシステム用ソフト『ふぁみこんむかし話　新・鬼ヶ島』の続編にあたり、主人公（男の子と女の子）のお供だった３匹の動物たちが、ふたりに出会う前のお話が語られるテキストアドベンチャーゲームです。前編では、第一話で犬の「りんご」が、第二話で猿の「まつのすけ」が主人公になります。新たな要素として、コマンド選択の代わりにアクションやパズルなどのミニゲームで物語を進めるシーンが追加され、かわいい動物たちの世界をじっくり楽しんでいただけるようになりました。もとはスーパーファミコンでゲームを受信して楽しむ「サテラビュー」の番組として放送されたものを、スーパーファミコン用ソフトにしたものです。<BR><BR>詳細は、<BR><center>http://www.nintendo.co.jp/vc/</center><div align="right">をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A444F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A444F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">平成　新・鬼ヶ島<sup>TM</sup>　前編</span></div>
</div>
