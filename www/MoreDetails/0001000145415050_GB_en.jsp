...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This thrilling action game from ADK sees you taking on the role of one of three ninjas as they face off with the nefarious Spider and his chaotic time-travelling actions. Play as Joe of the Koga clan, Rayar of the Iga clan, or Ryu, descendant of the famous ninja Fuma Kotaro. Traverse seven time periods covering cavemen, Egyptians, samurai and much more!
<br><br>
This fast-paced game sports a variety of ninja techniques. Each ninja has a normal attack, a deadly attack that inflicts damage on all enemies on screen, and even special ninja attacks performed by using special button combinations. But that's not all, if you collect three scrolls you can temporarily take on the form of a beast to unleash even more powerful attacks!
<br><br>
Work alone or grab a friend to join you in your ninja quest! Remember, time is of the essence!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
