...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En al año 2025 estalla una guerra entre los humanos y una raza alienígena hostil. Lucia, de 16 años, y los demás pilotos de los cazas galácticos de la Federación de la Tierra deben unirse a la lucha. Cuando los alienígenas secuestran a Ken, el padre de Lucia, esta decide tomar cartas en el asunto y se hace con el prototipo de un nuevo caza galáctico, el Gley Lancer, para intentar salvar a su padre. En este juego de disparos de desplazamiento lateral debes meterte en la piel de Lucia, al mando del Gley Lancer, para rescatar a su padre y acabar con los malvados alienígenas que pretenden destruir la especie humana.
<br><br>
Textos de pantalla parcialmente en japonés.</div>
  <div id="image02">
