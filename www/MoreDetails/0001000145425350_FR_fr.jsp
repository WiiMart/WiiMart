...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti en 1996, Art of Fighting 3 : la voie du guerrier est un jeu de combat se situant à Grasshill Valley, où se déroulent de nombreux drames et batailles entre les protagonistes. En plus des personnages principaux Ryo et Robert, cette version comprend de tous nouveaux combattants. Art of Fighting 3 : la voie du guerrier comprend des combos aériens puissants, des parades plus efficaces, la possibilité de faire tomber l’adversaire et un système de combat à un round appelé "Ultimate K.O.". De plus, les graphismes sont basés sur la technique de capture des mouvements, les rendant plus souples qu’avant et rendant le jeu ce jeu de combat le plus innovant de tous les temps. <br><br>Texte écran en anglais.</div>
  <div id="image02">
