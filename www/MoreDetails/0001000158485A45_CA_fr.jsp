...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158485A45')", "wiiSelectSound()");
...
<p>
Special Features:<br>
• Explore an unknown world where you'll discover many hidden secrets.<br>
• 19 levels packed full of alien beings and spectacular final bosses.<br>
• Play in two worlds simultaneously and solve challenges that would otherwise be impossible to finish in only one world. <br>
• Change the past by moving items or defeating creatures, and the present will change accordingly in real time.<br>
