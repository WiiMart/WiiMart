...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La fameuse simulation dans laquelle vous incarnez le maire d'une ville pour lui faire atteindre la taille d'une mégalopole. Cette  version, co-développée par Maxis et Nintendo, est considérée comme la meilleure adaptation du jeu original. Elle ne sortit tout d'abord que sur Super Nintendo et possède quelques éléments additionnels. Les saisons modifient l'aspect de votre ville. Quelques personnages bien connus de Nintendo apparaissent également si le joueur atteint un certain niveau dans le jeu. Cette version comporte également quelques missions supplémentaires dans le mode scénario. SimCity™ est également connu comme étant un des jeux offrant les meilleures musiques de la Super Nintendo.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414646/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414646/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
