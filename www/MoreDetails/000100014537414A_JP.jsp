...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ゼビウス」に登場する敵キャラクター「グロブダー」を自機の戦車として操作し、フィールド内の敵の破壊をめざす、固定画面型アクションシューティングゲーム。シールドを張って敵の攻撃を防ぎつつ、エネルギーの消費と回復に注意しながら、キャノン砲を使って敵の戦車や砲台を攻撃していきます。敵を一箇所に誘導し、敵を破壊した際にできる爆発に他の敵を巻き込む「誘爆」というテクニックを使うことで、通常よりも高得点が得られます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">グロブダー<sup>&reg;</sup></span></div>
</div>
