...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Double Dungeons is een rollenspel waarin je soepel scrollende 3D-kerkers verkent. Double Dungeons kan door twee spelers tegelijkertijd worden gespeeld, waardoor het met kop en schouders uitsteekt boven de rest. Er zijn 22 unieke scenario’s, verdeeld over 6 levels. Hoe hoger het level, des te moeilijker het scenario. Omdat elk scenario onafhankelijk is, kun je het spel beginnen vanuit elk gewenst scenario, behalve het laatste (level 6).
<br><br>
Versla de monsters in elke kerker om ervaringspunten te verzamelen, terwijl je de sleutel zoekt waarmee je het vertrek van de eindbaas in kunt. Koop je uitrusting in de winkel, werk samen met spelpersonages en versla de eindbaas om een scenario te voltooien. Doorloop alle 21 scenario’s van level 1 t/m 5 om wachtwoorden te verzamelen. Je hebt ze allemaal nodig om toegang te krijgen tot het laatste scenario!
<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Double Dungeons</span></div>
</div>
