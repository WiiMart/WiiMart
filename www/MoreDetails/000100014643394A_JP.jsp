...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミリーコンピュータで１９９１年に発売された、近未来の地球が舞台のコマンド選択式アドベンチャーゲームです。作業用ロボットのオペレーターをしている日向忠は、メタルスレイダーという戦闘用人型兵器のなかでも伝説的な存在である「グローリー」を予期せず手に入れ、機体に隠されていた「創造主を捜せ、地球は危機に瀕している」という謎のメッセージを発見します。忠は妹とガールフレンドとともに宇宙へと旅立ち、わずかな手がかりを元に、出会った人たちから情報を得ながら、メッセージの真相を追求していきます。ファミリーコンピュータの限界に挑戦したグラフィックは、登場人物の感情をこまやかに表現し、メタルスレイダーの戦闘シーンでは迫力のある展開を味わえます。物語の区切りとなるパスワードが忠のセリフとして表現されたのも、当時としては画期的でした。緻密にえがかれたグラフィックと、キャラクターの会話を中心とした練り込まれたシナリオにより、手に汗握る壮大なＳＦストーリーが繰り広げられます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルスレイダーグローリー<sup>&reg;</sup></span></div>
</div>
