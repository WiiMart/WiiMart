...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Het revolutionaire Street Fighter® II definieerde in de jaren negentig de standaard voor vechtspellen. Street Fighter® II: The World Warrior was het eerste deel in de Street Fighter® II-serie en wordt algemeen beschouwd als een van de beste spellen aller tijden. De originele acht ‘world warriors’, onder wie Ryu, Chun-Li en Guile, maken hun opwachting, met elk hun eigen vaardigheden, snelheid, speciale vechttechnieken en een uniek einde, waardoor de spelervaring voor elk personage compleet anders is. Kies je eigen spelfiguur en word de held van het Street Fighter®-universum!
<br><br>
