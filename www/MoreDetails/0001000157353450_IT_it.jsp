...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157353450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Divertiti con tutta la famiglia e partecipa alle diverse modalità di gioco!<br>
5 Spots Party è un gioco di abilità adatto a tutti che si basa sul famoso gioco delle 5 differenze da trovare.
<br><br>
Nelle sue tre modalità di gioco, lo scopo è quello di trovare il maggior numero di differenze nelle immagini che vengono presentate. Nelle modalità party dovrai competere con altri giocatori e scoprire il maggior numero di errori possibile. Nella versione per un giocatore, dovrai trovare le differenze prima che il tempo scada per superare i record del gioco.
<br><br>
Fino a dove credi di poter arrivare?
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157353450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157353450/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">5 Spots Party</span></div>
</div>
