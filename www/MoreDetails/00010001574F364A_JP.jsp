...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F364A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大人気のおきらくシリーズ第３弾です。<BR>今度は家族がかいぞくになってすごろくバトル！<BR><BR>Ｗｉｉリモコンでサイコロを振ったり、おそってくるいんせきを打ち返したりと家族や友達を集めてワイワイもりあがること間違いなしのパーティゲームです！<BR>さらに有償の追加コンテンツで新しいマップやコスチュームをふやすことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F364A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F364A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おきらくすごろくWii</span></div>
</div>
