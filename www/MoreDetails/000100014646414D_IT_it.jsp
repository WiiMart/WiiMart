...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il mondo è avvolto dall’oscurità.
I venti hanno smesso di soffiare... I mari sono in tempesta... La terra sta marcendo...
Ma la gente crede in una profezia, aspettando pazientemente che si compia.
“Quando l’oscurità avvolgerà il mondo, quattro Guerrieri della Luce appariranno...”
Dopo un lungo viaggio, giunsero infine quattro giovani viaggiatori... ognuno dei quali stringeva tra le mani un cristallo.
<br><br>
Questa è la versione originale rilasciata negli Stati Uniti.<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014646414D/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646414D/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FINAL FANTASY<sup>&reg;</sup></span></div>
</div>
