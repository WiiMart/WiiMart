...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The countdown has begun! You have just three days to save the land of Termina from destruction by its own moon, which is being pulled out of its orbit by a mysterious evil force!
<br><br>
...
<br><br>In-game text can be set to English, German, French or Spanish.</div>
  <div id="image02">
