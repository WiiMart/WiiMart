...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In this NES action game, a port of the hit arcade original, you play a crack Special Forces soldier tasked with parachuting into the South American jungle on a dangerous mission to rescue hostages.
<br><br>
...
<br><br>
The game features different ending sequences (and cash bonuses for your troops!) depending on how many hostages you manage to save. Will the President of the United States be happy with your performance? Put your finger on the trigger and find out!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
