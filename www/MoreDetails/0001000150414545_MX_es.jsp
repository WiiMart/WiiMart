...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Super Star Soldier es un clásico juego de tiroteo. Además del JUEGO NORMAL, hay modos de Time Attack de 2 y 5 minutos, y un modo en el que puedes revisar los mejores puntajes. El JUEGO NORMAL está compuesto de 8 distintos niveles, y en cada nivel (excepto al nivel 7), un jefe te espera al final.  La Escuadra de Ataque Especial, dirigida por el Cerebro Matriz, ha lanzado una invasión masiva sobre la Tierra. Lleva tu pequeño guerrero, el Neo Caesar, con un arsenal de 4 armas normales y 2 armas especiales y ¡Hazlos volver por donde vinieron!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Star Soldier<sup>TM</sup></span></div>
</div>
