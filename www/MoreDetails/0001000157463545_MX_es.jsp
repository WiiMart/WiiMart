...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157463545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Papá, Mamá, Sarah y Billy han vuelto para una buena partida de cartas! ¡Prueba suerte en uno de los tres juegos de cartas! ¡Elige entre Daifugo, Speed y Memory! Family Card Games presenta atractivos gráficos tipo cómic y una simpática música, además de reñidas partidas amistosas. ¡Juega tú solo a Daifugo, o con hasta tres otros jugadores al azar en una partida online! ¡Consulta tu clasificación y compite con jugadores de todo el mundo! ¡También puedes jugar a Speed y Memory! Comprueba tus reflejos y destreza con las cartas contra otro jugador en Speed para ver quién es más rápido. Memory pondrá a prueba tu capacidad mental cuando trates de recordar dónde están las parejas de cartas. ¿Tienes lo necesario para ser el más rápido y el más listo de tus amigos y familiares?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157463545/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157463545/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
