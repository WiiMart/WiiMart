...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A vertically scrolling shooter from the well-known “Star Soldier" Series.
In the 23rd century, invaders from the future suddenly attack Earth. Controlling a fighter created by the world’s best scientists, you rise to meet the enemy. Collect and equip power-up units to launch a variety of attacks, such as lasers, flamethrowers and missiles. Each weapon has three different attack types. Anticipate enemies’ strikes and deftly switch between weapons to defeat the invaders! In addition to “NORMAL GAME”, there are also “2 MINUTE GAME” and “5 MINUTE GAME” score attack modes. The most perfectly balanced game in the series, “Final Soldier” is a title you don’t want to miss.<br><br>In-game text will include some Japanese.</div>
  <div id="image02">
