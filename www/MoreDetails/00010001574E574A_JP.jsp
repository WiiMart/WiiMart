...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574E574A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大人気シルエットパズル「ハメコミ　LUCKY PUZZLE Wii」が帰ってきました。<BR>今度はちょっと難しい？問題は総入れ替えした約３００問、さらに新モード「ラッキーナンバー」によりあなたのひらめきに挑戦します。もちろん全てのモードで最大4人まで同時にプレイすることができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E574A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E574A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ハメコミ　ラッキーパズルWii　リターン</span></div>
</div>
