...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157554E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Maak je klaar om “UNO” te roepen op je Wii! Het wereldberoemde kaartspel is natuurgetrouw gereproduceerd voor Wii en heeft daarnaast ook nog eens opwindende nieuwe regels. Dankzij een multiplayerstand op één Wii-systeem is het spelen van UNO nog nooit zo leuk en gemakkelijk geweest. Zorg dus dat je als eerste al je kaarten kwijt bent!
<br><br>
• Het nummer-1-kaartspel voor plezier met vrienden en familie is opnieuw gemaakt, met de klassieke identiteit en spelregels die iedereen kan begrijpen! <br>
• Pas de spelregels aan en ontdek nieuwe manieren om UNO te spelen, zoals “UNO 7-0”, “UNO Challenge”, “Jump In” en nog veel meer.
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554E50/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
