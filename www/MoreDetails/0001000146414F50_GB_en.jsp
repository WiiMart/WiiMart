...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">To save his world from rampaging demons, Dana goes on a dangerous quest to find Solomon's Key and seal the monsters away. An audacious mix between an action game and a giant puzzle, Solomon's Key™ is one of the toughest challenges on the NES, but also one of its most endearing adventures. The player is required to combine logic and cunning reflexes to unravel all the mysteries of each room. Several secrets ought to be unlocked by the brightest minds, and only a few have been deemed worthy of seeing all the different endings. Will you be clever enough?</div>
  <div id="image02">
