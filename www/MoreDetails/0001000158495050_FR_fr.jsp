...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158495050')", "wiiSelectSound()");
...
<br><br>
Avec les PooYoos, une joyeuse bande d'adorables bébés animaux, votre enfant découvrira en s'amusant les apprentissages indispensables à son développement : chiffres, lettres, repérage dans l'espace, formes, couleurs... Le jeu l'invitera aussi à danser avec ses nouveaux amis et lui offrira de belles récompenses. Avec deux niveaux d'interactivité, il pourra jouer quels que soient son âge et son niveau, autour des thèmes de la magie et des couleurs.
<br><br>
Ce jeu a été conçu pour être utilisé par des enfants qui ne maîtrisent pas encore la lecture.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495050/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495050/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Episode 3 - Demo</span></div>
  </div>
