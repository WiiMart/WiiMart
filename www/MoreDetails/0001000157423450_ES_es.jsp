...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157423450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Desenfunda tu revólver para ver quién es el más rápido del Oeste. Ajusta tu precisión y velocidad a medida que aparezcan los objetivos enfrente de ti. Apunta y dispara para obtener más puntos. Puedes disparar a cualquier elemento, así que asegúrate de explorar todo el escenario para conseguir más puntos. Identifica a tus enemigos de entre todos los personajes que aparezcan y no dispares a los ciudadanos inocentes. Participa en un asalto al tren típico del Lejano Oeste o desafía tus habilidades en otros entornos característicos del Oeste a medida que aumenta la dificultad. A medida que avances por los desafíos, ganarás recompensas y medallas, en una adictiva acción sin descanso. Juega en modo multijugador con hasta dos jugadores donde tú y tu compañero combinaréis puntos o jugaréis uno contra el otro para averiguar quién es el más rápido del Lejano Oeste.
