...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ゲームボーイ版で生まれたカービィシリーズの続編。主人公のカービィを操作して、敵を倒したり、避けながらステージクリアを目指すアクションゲームです。カービィが敵を吸い込むと相手の能力をコピーして攻撃できるのが最大の特徴。カービィの代名詞となっているコピー能力が初めて登場したソフトです。<BR>
カービィのコピー能力のアクションはもちろん、デデデ大王やメタナイトといった敵キャラはどれもかわいらしくて個性的。簡単操作でアクションが苦手な人でも安心して遊べます。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641384A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">星のカービィ<sup>&reg;</sup>　夢の泉の物語</span></div>
</div>
