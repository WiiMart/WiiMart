...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is the fourth installment in the World Heroes fighting game series, released in 1995. In this game, 16 figures from across history fight for the title of the world's strongest.
<p>In previous installments, the amount of time you held a button down determined the strength or weakness of an attack, but that system has been removed in this game.
<p>In addition to the more orthodox fighting game approach of allowing weak, middle, and strong attacks using different buttons, this game includes the all-new elements of the Hero Gauge, Extra Attacks, and Guard Breaker Attacks, adding an exciting new layer of strategy to the gameplay experience.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415A45/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415A45/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
