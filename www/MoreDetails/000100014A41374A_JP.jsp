...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アクション要素とシミュレーション要素を密接に融合させた画期的なシステムが評判を呼び、今でも根強い人気を誇るスーパーファミコン初期の名作。プレイヤーは神となり、魔物がはびこる荒廃した地に降りて、魔物を全て倒すことで魔王サタンに滅ぼされた世界を復活させていきます。魔物を倒していくアクションモードと、人々を導き土地を開拓して人口を増やし、町を発展させるクリエイションモードの２つのモードがあります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アクトレイザー</span></div>
</div>
