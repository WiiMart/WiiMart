...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Initially released in 1990, NAM 1975 is a third-person “shoot 'em up”, action game.<p>The player takes the role of an American Special Forces soldier fighting through a harsh battlefield while moving left and right in front of the screen as enemies in the background shoot fiercely at the protagonist.
<p>Essentially, you fight with machine guns and other firearms, as well as hand grenades and the like; however, you can pick up new weapons from items. Not to mention, you can move at high speed while dashing, enabling you to get out of sticky situations if used adeptly.
<p>
