...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158484A50')", "wiiSelectSound()");
...
<br><br>
ThruSpace è un rompicapo 3D che metterà a dura prova la tua percezione dello spazio e i tuoi riflessi. Muovi e fai ruotare a velocità elevata una semplice forma geometrica, la Cubochiave, per farla passare attraverso dei varchi nelle pareti per guadagnare punti. E non dimenticare di raccogliere i cristalli per raggiungere un punteggio ancora più elevato!
<br><br>
Divertiti a creare figure e combo che ti consentiranno di aumentare ulteriormente il tuo punteggio: ruota la Cubochiave in modo da descrivere una sagoma che corrisponda completamente alla forma del varco.
<br><br>
In ThruSpace sono disponibili tre modalità di gioco: Normale, Senza limiti e Traccia le figure. Inoltre, è possibile salvare sino a un massimo di tre replay di gioco e rivederli nella sezione Memorie della Cubochiave. Aggiorna la Classifica Mondiale con i tuoi punteggi e tieni d'occhio la tua posizione: competerai con giocatori di tutto il mondo!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484A50/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
