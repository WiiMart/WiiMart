...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年にアーケードゲームの移植作として発売された、戦場を舞台にしたアクションゲームです。敵は無限、味方はゼロ。そんな戦争映画さながらの絶望的な状況のなか、プレイヤーはピストルや手榴弾、装甲車、戦車などを駆使して敵軍に攻め込みます。戦場は４つのフィールドで構成。左右の山からも敵が攻めてくる「谷間」、戦車や装甲車が攻めてくる「草原」、地面の不発弾が邪魔をする「砂漠」、一番奥に戦車が待ち受ける「敵陣」。いずれもバラエティ豊かで、奥に進むほど敵の攻撃が激しくなったり、地形に邪魔されて進みにくくなったりと、戦略性も試されます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＦＲＯＮＴ ＬＩＮＥ</span></div>
</div>
