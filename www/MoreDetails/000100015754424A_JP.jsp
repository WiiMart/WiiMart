...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015754424A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">音楽にノッて、タンバリンを叩いて色んなものを作り出す、今までとちょっと違った新感覚の音楽シュミレーションゲームがついに誕生しました。なんでも作れる不思議なタンバリンを持っているバリンちゃんを操り、街の人たちの家や銅像、お城をエレガントに建てましょう。いつの間にかびっくりするものが出来てしまうことも・・・。子供から大人まで、そして音楽ゲームが初めての方から、かなり得意な方まで楽しめる内容になっています。是非、あなたの力で街を豪華にしてみてください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015754424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015754424A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファンタジックタンバリン</span></div>
</div>
