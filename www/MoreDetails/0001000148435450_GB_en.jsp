...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wii System Transfer allows you to transfer the following data from a Wii console to a Wii U console as a set:<br><br>

• save data for Wii software<br>
• WiiWare titles and their save data<br>
• Virtual Console titles and their save data<br>
• add-on content for software<br><br>

• Wii Points<br>
• Wii Shop Channel account activity<br><br>

• Mii characters<br><br>

To transfer data, you will need a Wii console set, a Wii U console set, and the following:<br><br>

• Internet connection<br>
• One SD/SDHC Memory Card with at least 512 MB of free space<br><br>

Caution:<br><br>

• Once transferred, the data will be lost from your Wii console.<br><br>

• Data cannot be transferred from a Wii U console to a Wii console. Once data has been transferred from a Wii console to a Wii U console, it cannot be transferred back.<br><br>

• All data that can be transferred will be transferred as a set. It is not possible to transfer individual items separately.<br><br>

• Any software that was pre-installed on the Wii console at the time of purchase will not be transferred.<br><br>

• Wii U does not support WiiConnect24. Some software features may no longer be available after transferring software to a Wii U console.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii System Transfer</span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Wii Channel</div>
</div>
</body>
</html>
