...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Der legendäre Sci-Fi-Shooter ist zurück! Gate of Thunder ist ein horizontal scrollender Shooter, in dem du die Kontrolle über den Sonderagenten Hawk übernimmst. Seine Mission ist es, die tödliche Armee der Obbellon-Jäger aufzuhalten. Übernimm mit Hawk die Kontrolle über sein Schiff, die Hunting Dog, und dann auf ins Gefecht.
<br><br>
Kämpfe dich mit deinen drei Waffen durch die Level. Du wirst dabei von Versorgungsraum-<br>schiffen unterstützt, welche die notwendigen Power-Up-Items abwerfen. Du kannst zwischen verschiedenen Power-Up-Optionen wechseln, um die Richtung deines Angriffs zu ändern. Schieß um dich, damit du durch die 7 Level kommst.
Echte Fans des Shooting-Genres, die eine Herausforderung suchen, haben die Wahl zwischen den Schwierigkeitsgraden “HARD” und “DEVIL” für noch härtere Action!
<br><br>
