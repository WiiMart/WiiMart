...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">King of Fighters '98 is the 5th installment in the fighting game series released as a compilation after the dust settled from the epic Orochi Sage. King of Fighters '98 features a total of 38 characters, which can be broken down into 12 teams plus 2 individual characters. This time around, we see the long-awaited return of the Sports Team. The gameplay follows the same idea as its predecessor, '97, where players can select either advanced or extra modes to match their individual styles. Some minor changes include higher customizability, much to the fans' rejoice, and better fighting mechanics.</div>
  <div id="image02">
