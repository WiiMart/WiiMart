...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Street Fighter Alpha 2 explodes on-screen with lightning-fast gameplay and amazing innovations. Alpha Counters and the incredible Custom Combo System create a new standard for all fighting games. 
<br><br>
...
<br><br>
All your favourite warriors are back for more. Previously hidden characters Dan, Akuma, and Bison are joined by five new fighters: Rolento, Gen, Sakura, and classic favourites Dhalsim and Zangief.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
