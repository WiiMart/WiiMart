...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Control a clown to catch and throw back balloons hurled from the top of the screen in this puzzle action game released by Data East in 1997. If you line up three or more balloons of the same colour in a row vertically they will burst, but if you’re not quick enough the balloons will squash the clown, meaning it's game over! Once you’ve caught the hang of bursting balloons, next you need to master combos and chains.
<br><br>
The basic rules of the game haven’t changed since MAGICAL DROP II, but with 16 characters to play as and a new Magical Journey mode, there is so much more to explore in MAGICAL DROP III!</div>
  <div id="image02">
