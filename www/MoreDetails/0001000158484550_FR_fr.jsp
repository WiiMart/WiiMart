...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158484550')", "wiiSelectSound()");
...
Veuillez noter que vous ne pouvez pas sauvegarder votre progression dans cette version démo.</b><br><br>BIT.TRIP BEAT remet le rétro au goût du jour grâce à la télécommande Wii. Renvoyez les pixels qui défilent à l’écran dans ce jeu musical.
<br><br>
Laissez-vous charmer par son design à l'ancienne, ses commandes traditionnelles, son mode multijoueur allant jusqu’à 4 joueurs et sa bande sonore 8-bit. Mais attention, car à l’instar des jeux traditionnels, la difficulté est au rendez-vous! Si vous n’avez pas froid aux yeux, alors n’hésitez pas à découvrir ce premier titre de la saga BIT.TRIP...<br><br>
Tout a un commencement.
Nous existions avant de nous transformer. La vie engendre le rythme, et le rythme engendre la vie.
Nous sommes des êtres d’information.
L’apprentissage est inhérent à toute chose.
Nous communiquons en bits et en octets.
Et nous existerons à nouveau une fois que nous aurons cessé d'exister... une fois que notre BIT.TRIP sera terminé.<br><br>
