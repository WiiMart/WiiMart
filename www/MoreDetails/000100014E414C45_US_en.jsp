...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Choose from an all-star cast of Nintendo characters in a frantic melee to prove who will be the ultimate brawler. Utilize the easy to learn, but hard to master controls to battle it out in the single-player mode, earning point bonuses and unlocking hidden characters along the way, or enter VS Mode to take on up to three other players simultaneously. Inflict damage using each character's unique set of special moves or familiar items and power-ups, eventually winning by knocking your opponents off the screen in one of the interactive stages, each with a Nintendo theme. Need a moment to catch your breath? Polish your skills in Training Mode or destroy targets in Bonus Stages specific to each character. Are you ready to test your mettle against all comers, including the powerful Master Hand?</div>
  <div id="image02">
