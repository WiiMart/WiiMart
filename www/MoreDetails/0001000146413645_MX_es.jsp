...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Aprender puede ser divertido, especialmente cuando juegas con Donkey Kong Jr.! Practica sumas, restas, multiplicación, y división dirigiendo a Junior, un lindo monito que deberá subir y bajar por las lianas para recoger números y símbolos matemáticos y resolver los problemas de matemática que le da su papá. Compite con un amigo en una carrera resolviendo problemas en el Juego A, o agrega más retos en el Juego B. ¡Por supuesto que también podrás practicar jugando solo! ¡Este juego es perfecto para jugadores menores que buscan una manera divertida de desarrollar su habilidad matemática!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Donkey Kong Jr.<sup>TM</sup> Math</span></div>
</div>
