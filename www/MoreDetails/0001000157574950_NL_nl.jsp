...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157574950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Begin de zoektocht naar Wally, zijn vrienden en andere dingen in Where's Wally? Fantastic Journey 1!<br> Gebaseerd op de populaire boekenreeks “Where's Wally?”, Fantastic Journey 1 staat voor ultiem ZOEK-EN-VIND PLEZIER in de magische werelden van The Gobbling Gluttons, The Battling Monks, The Carpet Flyers en meer!  Daag je vrienden uit of speel alleen, op zoek naar verborgen voorwerpen. Wees op je hoede voor hindernissen en andere verrassingen die het spelplezier verhogen!<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157574950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157574950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Where's Wally?<sup>&reg;</sup></span></div>
</div>
