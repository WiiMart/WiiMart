...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">縦スクロール面と横スクロール面を交互に攻略するシューティングゲームです。プレイヤーは戦闘機「アクスレイ」を操作し、イーリス恒星系を闇の帝国の魔の手から奪還します。ステージをクリアするごとに装備できる特殊武器が増えていき、その中から３種類を自由に選んで戦うことができます。特殊武器を使用中は、敵の弾に当たっても、使用していた特殊武器が使えなくなる代わりに撃墜されずに戦いを続けることができます。敵に占領された、全６ステージを構成する各惑星を全て奪還し、敵の本拠地を破壊してください。縦スクロール面の擬似３Ｄ表現も特徴的です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アクスレイ<sup>&reg;</sup></span></div>
</div>
