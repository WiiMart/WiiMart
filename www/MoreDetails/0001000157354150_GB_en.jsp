...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157354150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to 5 Arcade Gems, a collection of five wacky arcade games. You can play alone or together with your friends - you will definitely find something for your taste, be it a medieval knights game or ultra-modern space shooter. <br><br>
- Compete with other knights to beat the Evil Wizard's challenge in Templar Bashing.
<br>- No hazard gets in the way of the dutiful Pizza Jungle Delivery company, not even the fierce savages who won't tip! 
<br>- Outsmart your competitors in RC Buggy Madness. 
<br>- Demonstrate your skills and reflexes in Lumberjack Trials.
<br>- And of course, no adventure is complete without some deep space alien-bursting action in Whirling Rangers.</div>
  <div id="image02">
