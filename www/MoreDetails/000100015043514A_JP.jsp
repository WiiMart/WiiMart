...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アンドロイドの戦いをえがく縦スクロール型のシューティングゲームです。宇宙暦Ｘ２９８１Ｙ。人類が世界規模の戦争を続ける中、自我を持った戦闘アンドロイド「アウラ」が他のアンドロイドたちを従え、人類に対して反逆をはじめました。地下都市にまで追いつめられ逃げ場を失った人類は、超戦闘アンドロイド「サイコチェイサー」を開発し最後の望みを託します。プレイヤーはサイコチェイサーを操りアウラの要塞に突入、アウラの破壊をめざします。要塞内部を駆け抜けながら、さまざまな方向から襲いかかる敵に対し、特徴の異なる４種類の武器をすばやく切りかえて応戦してください。また敵を倒すと出現する「サイコエナジー」は、各ステージ開始前の「セルフモニター画面」で自由に配分することが可能で、それぞれの武器を状況にあわせてパワーアップさせることができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サイコチェイサー</span></div>
</div>
