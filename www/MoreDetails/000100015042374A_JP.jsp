...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">群雄が割拠する戦国時代を舞台とした本格派の４人打ち麻雀です。<br>「クイタン」「ウラドラ」「われめ」など、細かなルールの設定が可能で、対戦相手を自由に選べる「ノーマルモード」と地方の領主として近隣の勢力と戦い天下統一を目指す「合戦モード」の２種類の遊び方が楽しめます。お馴染みの「織田信長」や「豊臣秀吉」といった戦国大名をはじめ、「ねね」や「淀君」などの同時代を代表する女性たちも加わった、総勢１２名の歴史上のキャラクターが登場。それぞれのキャラクターには、独特の打ち筋や場面ごとの個性的なセリフが用意されており、対局をより一層盛り上げます。特殊なアイテムやイカサマなしの真剣勝負は、まさに実戦そのものの緊張感が味わえます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">戦国麻雀<sup>&reg;</sup></span></div>
</div>
