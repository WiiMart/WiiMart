...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100014843444A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『デジカメプリントチャンネル』は、任天堂株式会社とプリントサービスを提供する富士フイルム株式会社とが共同で行うサービスです。<BR><BR>デジタルカメラや携帯電話で撮影した画像を、写真やアルバム、名刺にして購入することができます。<BR>また、マリオシリーズ・キャラクターを使ったデザインに変更したり、Ｍｉｉを使った自分だけの名刺を作成することもできます。<BR><BR>撮影画像を保存したＳＤメモリーカードをＷｉｉ前面のＳＤカードスロットに差し込み、『デジカメプリントチャンネル』で使用する画像を選んで、購入する商品をご注文いただくと、後日お客様の自宅または指定の住所へご注文の商品をお届けします。<BR><BR>※プリントサービスの生産・販売は富士フイルムイメージングシステム株式会社にて運営いたします。<BR><BR>※注文には、クレジットカードと、パソコンもしくは携帯電話のメールアドレスが必要になります。<BR><BR>【商品の概要】<BR>■デジカメプリント：<BR>写真データを一般的なＬサイズプリントに仕上げます。<BR>■Ｗｉｉフォトブック<BR>　（スクエアタイプ）：<BR>ヨコとじとタテとじの２種類があり、贈りものやインテリアとしても楽しめます。必要な写真データの目安は約２０枚です。<BR>■Ｗｉｉフォトブック<BR>　（スタンダードタイプ）：<BR>フレームに写真をあてはめるだけで、Ａ４サイズの写真集が作れます。必要な写真データの目安は約４０枚です。<BR>■Ｗｉｉ名刺：<BR>お気に入りの写真データを１枚使って、名刺を作成できます。写真が無くても、Ｍｉｉを使った名刺は作成できるので、まずは試してみませんか？</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">デジカメプリントチャンネル</span></div>
</div>
