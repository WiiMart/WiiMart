...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158494850')", "wiiSelectSound()");
...
<br><br>"Rage of the Gladiator" ist ein Kampfspiel in einer Fantasiewelt, bei dem Sie in der Arena an die Grenzen Ihrer Kräfte gehen müssen.<br>
Features:<br>
- Eines der schönsten WiiWare-Spiele aller Zeiten! Umwerfende 3D-Grafiken, Animationen, Schatten, Licht- und Spezialeffekte.<br>
- Komplett vertont: Jeder Endgegner hat seine eigene Persönlichkeit und wird Sie gnadenlos verspotten!<br>
- Ausgefallene Finishing-Moves: Beschwören Sie einen Feuermeteor oder einen Tornado und verwandeln Sie sich in einen Koloss, der zehnmal größer ist als Sie selbst!<br>
- Charakteranpassung: Spezialisieren Sie sich innerhalb der Fertigkeitenbäume – Offensive, Defensive oder Magie – um neue Kräfte zu erhalten!<br>
- Epische Musik: Freuen Sie sich auf mitreißende Meisterwerke des legendären Komponisten Sean Beeson!<br>
- Hoher Wiederspielwert: Spielen Sie das Spiel durch, um den Challenge-Modus freizuschalten, in dem Endgegner neue Fähigkeiten haben und so eine neue Herausforderung darstellen!<br>
