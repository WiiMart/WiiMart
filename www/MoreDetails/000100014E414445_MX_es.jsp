...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toma los controles de tu “Arwing” y completa quince misiones para alcanzar tu objetivo final: un duelo en “Venom”, planeta del tirano interplanetario Andross. A través de tu aventura deberás cumplir difíciles objetivos para poder alcanzar y conquistar cada misión. Roza la superficie de un mar alienígena, zigzaguea a través de los cañones de concreto de una metrópolis futurista, o esquiva planetoides del tamaño de montañas. Entre misiones, podrás disfrutar de películas en 3-D que muestran la historia del equipo de mercenarios espaciales de Star Fox en su lucha contra el malvado simio emperador, Andross.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Star Fox<sup>TM</sup> 64</span></div>
</div>
