...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157544550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tales of Elastic Boy ti stupirà con un modo innovativo e unico di giocare, che sfrutta al meglio le possibilità offerte dal telecomando Wii.
<br><br>
Per compiere la tua missione e salvare il pianeta, dovrai viaggiare per molte terre, sconfiggere diversi nemici, incontrare amici inaspettati e risolvere enigmi rompicapo.
<br><br>
Sfrutta le tue braccia allungabili per dondolare e dare pugni, rotola più veloce che puoi o salta sui nemici. Basato su un motore fisico complesso e realistico, Tales of Elastic Boy ti offre un'esperienza di gioco originale e coinvolgente, che troverai semplice da imparare, ma non altrettanto facile da dominare! Che tu sia un giocatore di platform classici o uno che ama sperimentare generi nuovi, Tales of Elastic Boy è il gioco che fa per te! Gioca in modalità a singolo giocatore o sfida i tuoi amici in cinque diverse modalità straordinarie.
 <br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544550/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
