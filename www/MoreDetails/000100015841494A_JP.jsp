...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パズルと縦スクロールシューティングが絶妙に融合したパズルゲームです。画面の上からおりてくるさまざまな形状のブロック「クォース」に自機のブロックピースを発射すると、当たったところでブロック同士が同化して一体になります。ブロックは四角形（正方形や長方形）になると消えるので、欠けたブロックを埋めるようにブロックピースを発射し、すべてのブロックを消してステージクリアをめざします。多くのブロックを一度に消せば高得点が得られますが、自機が位置する画面の一番下のラインにブロックが達してしまうとゲームオーバーとなるので要注意です。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クォース</span></div>
</div>
