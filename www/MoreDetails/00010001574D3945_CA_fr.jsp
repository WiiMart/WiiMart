...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D3945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Happy Hammerin' is a party game suitable for friends and families to compete against each other by bashing moles using the Wii Remote! Swing the Wii Remote like a hammer and let off some steam as you frantically try and bash the moles popping up all over the screen. Play against the CPU or go head-to-head with up to four players. Players can challenge themselves in three different modes: Mole Adventure (1-2P), Mole Marathon (1P) and Party Battle (1-4P). Mole Adventure consists of 4 stages with 3 difficulty types. The faster you bash, the more points you get. Register your scores online and compete against the best mole bashers from around the world.</div>
  <div id="image02">
