...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Corre l'anno 2112 e la Terra è stata invasa da esseri malvagi. Nei panni di un motociclista solitario, devi sconfiggere gli invasori in diverse gare, mentre vai alla ricerca dei superstiti. Sei l'ultima speranza per il pianeta Terra. Sei Mach Rider!
<br><br>
Nella Gara di combattimento, cimentati su 10 percorsi ad alta velocità e sconfiggi i nemici usando la mitragliatrice o spingendoli contro gli ostacoli. Nella modalità Gara di resistenza, metti alla prova le tue capacità di sopravvivenza sfidando il tempo. Se invece vuoi goderti un percorso senza l'assillo dei nemici, scegli la Gara in solitario.
<br><br>
In Mach Rider puoi anche trovare la modalità Creazione che ti permetterà di dare forma ai percorsi che hai sempre sognato. Inoltre, questa versione per Virtual Console ti offre la possibilità di salvare i percorsi che hai creato, una funzione che non era presente nella versione originale per NES.
...
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mach Rider<sup>TM</sup></span></div>
</div>
