...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機（マイタンク）を操作して司令部を守りながら敵を倒していくシューティングゲームです。バトルフィールド上の敵タンクを全滅させると次のフィールドに進みます。司令部を破壊されるとゲームオーバー。操作するマイタンクが撃たれないようにするだけでなく、司令部に迫る敵タンクがいないか、フィールド全体を見ながらプレイすることが重要です。赤い敵を倒して出現するアイテムを取るとさまざまな効果が得られ、防弾壁さえ破壊できるスーパータンクに変身することもできます。また、２人同時プレイでは、守備と攻撃の役割を分担するか、一緒に守るか、それとも２人とも攻めに転じるか、状況に応じてパートナーと協力しながら戦います。地形やアイテムを利用する戦略性、協力も対戦も楽しめる２人同時プレイ、障害物を配置してオリジナルのバトルフィールドを作ることができる「ＣＯＮＳＴＲＵＣＴＩＯＮ」モードを搭載するなど、シンプルながら奥が深いタイトルです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146434F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146434F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バトルシティー</span></div>
</div>
