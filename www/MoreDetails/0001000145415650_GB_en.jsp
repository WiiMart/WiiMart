...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Engage in battle once more in this classic fighting game from 1995.<br><br> The main characters from classic series Fatal Fury, Ikari Warriors, Psycho Soldier and Art of Fighting return, ready to continue the fight from King of Fighters '94. Joining them is Iori Yagami, a rival of hero Kyo Kusanagi, ready to leave his mark on the continuing story - and on Kyo!<br><br> Three-on-three team battles, a power gauge that unleashes devastating blows and the series' unique one-shot reversal super special moves all make the jump from the '94 release. But it doesn't stop there, use the new "Team Edit" ability to add a new dimension of strategy to your bouts!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
