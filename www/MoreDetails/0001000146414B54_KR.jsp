...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">수수께끼를 풀어 나가면서 액션을 펼치는 액션 어드벤처의 원점이라고 말할 수 있는 『젤다』의 첫번째 시리즈. 대마왕 가논에게 점령당한 왕국의 평화와 젤다 공주를 되찾기 위해 주인공 링크가 8개로 갈라진 「트라이포스」의 조각을 찾아 모험을 떠는 액션 어드벤처.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414B54/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414B54/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">젤다의 전설<sup>TM</sup></span></div>
</div>
