...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157525850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El Mega Man original 2D clásico regresa en Mega Man 10!
<br><br>
Este último título de Mega Man hace que la serie vuelva a sus raíces con la acción retro, las plataformas y los gráficos y sonidos clásicos 8-bits. Redescubre la experiencia Mega Man con los nuevos jefes finales de inspiración clásica, cada uno con sus propias armas únicas y puntos débiles.
<br><br>
Es el año 20XX y un brote sospechoso de Roboenza, una gripe Robot, se está propagando por todo el mundo y afectando a los robots. Las personas, que cuentan con la ayuda de los robots desde hace años, no saben cómo salir adelante sin ellos. Un mes después del brote, la situación empeora. Algunos robots infectados han perdido el control e intentan hacerse con la ciudad y destruirla. Mega Man ha de hacer frente a esta siniestra amenaza y llegar al fondo de este misterio viral.
<br><br>
