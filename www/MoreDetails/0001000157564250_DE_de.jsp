...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157564250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP VOID ist die dritte Ausgabe der BIT.TRIP-Saga im Retro-Arcade-Stil.
<br><br>
BIT.TRIP VOID ist eine synästhetische Erkundung von Rhythmus und Musik. Die ist Teil unseres täglichen Lebens und unserer Stimmungen. Mit einem in der Serie noch nie da gewesenen Steuersystem, das den Spielern jedoch sehr bekannt vorkommen dürfte, erhält man vollkommene Bewegungsfreiheit am Bildschirm und kann mit der Musik auf brandneue Arten interagieren. Die klassische Gameplay-Ästhetik besteht weiterhin, da die Farben – sowie die Abwesenheit von Farben – zur Gänze ausgeschöpft werden.
<br><br>
Spiele im 4-Spieler-Co-Op-Modus und verliere Dich zusammen mit Freunden in den Beats! Versuche, den Ansturm der Beats zu überstehen und Deinen eigenen BIT.TRIP voranzutreiben.<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
