...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157325950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wer hätte nicht gern einen Kamin zu Hause?
<br><br>
Jetzt können Sie Ihr Fernsehgerät in einen Kamin verwandeln. Mit wirklichkeitsgetreuer Grafik und einem Feuer, an dem Sie sich fast die Finger verbrennen.
<br><br>
Bereiten Sie das Feuerholz vor, zünden Sie das Feuer an und schüren Sie es. Oder wählen Sie die Option “Automatisch”, damit Sie das Kaminfeuer auf dem Bildschirm haben, während Sie mit Ihrer Familie essen, eine Party mit Freunden feiern oder mit Ihrem Partner dinieren. Es gibt Kamine für jede Gelegenheit!
<br><br>
Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157325950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157325950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">My Fireplace</span></div>
</div>
