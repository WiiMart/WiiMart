...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157425645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Coming at you full throttle is SPOGS Racing™, an all-new racer from D2C Games™ featuring classic arcade racing, pick-up-and-play controls, all-new racing vehicles, and Crash N’ Grab™ instant upgrades. Jump in, gear up, and modify your ride on the fly as you compete head-to-head for a totally outrageous arcade racing experience on your Wii™ console. Whether you’re a casual gamer or hard-core racer, SPOGS Racing™ features fun for all and is a must-have download for your WiiWare™ digital game library.</div>
  <div id="image02">
