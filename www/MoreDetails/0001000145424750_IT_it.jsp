...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pubblicato nel 1997, "The King of Fighters '97" è il quarto titolo della serie "The King of Fighters". Come nei capitoli precedenti, anche questa volta numerosi protagonisti e personaggi popolari di giochi come "Fatal Fury", "Ikari Warriors" "Psycho Soldier" e "Art of Fighting" si trovano a competere per stabilire chi è il più forte in assoluto. Anche questo titolo porta una ventata d'aria fresca e l'elenco dei personaggi selezionabili subisce qualche ritocco. Tra le novità va segnalata sicuramente la possibilità di selezionare Chizuru Kagura (boss nel titolo precedente), Ryuji Yamazaki (popolare personaggio della SNK), Blue Mary, Billy Kane e nuovi personaggi come Yashiro Nanase e Shingo Yabuki. Inoltre, prima di iniziare la partita, al giocatore viene chiesto di scegliere tra la modalità "Advanced" e la modalità "Extra". Questa scelta influenza lo stile di gioco in maniera decisiva.<br><br>Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE KING OF FIGHTERS '97</span></div>
</div>
