...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157545750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Benvenuti nel West! Venite a vedere! Qui potrete visitare le più tipiche contrade del West con i grandi saloon, l'ufficio dello sceriffo... Incontrerete dal classico dottore ubriaco all'onnipotente signore della regione, dagli eroici pioneri agli uomini (e alle donne) che hanno costruito la nazione con lacrime e sudore.
<br><br>
Diverse questioni non possono tuttavia essere facilmente risolte, e tra queste vi è la costante contesa tra contadini e allevatori. E sebbene i contadini possano contare sulla simpatia della maggioranza, gli allevatori di bestiame hanno dalla loro le maggiori risorse: più denaro, più uomini e più forza. Solo un pistolero speciale come Fenimore Fillmore può ardire a mettersi dalla parte dei contadini contro il resto dei colleghi al soldo del rancher, tra i personaggi più sinistri e spietati del gioco.
<br><br>
Il testo all'interno del gioco può essere visualizzato in inglese, francese, spagnolo e tedesco.</div>
  <div id="image02">
