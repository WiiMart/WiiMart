...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Coge el balón y pásate al fútbol original de NES. Compite a nivel internacional con un puñado de las mejores selecciones. A diferencia de otros juegos más modernos, donde la emoción se pierde entre un sinfín de botones y comandos, todo el mundo puede disfrutar de Soccer. Sus controles son sencillos y el sistema de disparo a puerta es tan inteligente como eficaz. El espectáculo del intermedio sigue siendo una curiosidad que en su tiempo gozó del aprecio del público y que esperamos lo siga teniendo hoy también.<br><br>
