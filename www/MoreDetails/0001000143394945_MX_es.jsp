...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Los depósitos de almacenaje de la Federación han sido asaltados por los piratas, extrayendo de ellos valiosos minerales, joyas, munición y armamento bélico de última generación. La Federación te ha encomendado la misión de recuperar y devolver todo este material en un almacén en un tiempo limitado. Si tienes éxito serás recompensado con una nave y puntos extra.  La nave pirata ha activado todos los sistemas de defensa planetaria con los que tendrás que negociar, así como con los mismos piratas. Si fracasas en la búsqueda del botín dentro del tiempo marcado o si el valor de la carga recuperada es insuficiente, serás penalizado con una de tus naves Cybernoid.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143394945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143394945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
