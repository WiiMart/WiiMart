...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">STREET FIGHTER II': SPECIAL CHAMPION EDITION was het eerste Street Fighter-spel voor de SEGA MEGA DRIVE. De Street Fighter-serie kan beschouwd worden als een van de eerste series die het competitief spelen van vechtspellen populair maakte.
<br><br>
Deze versie van het spel bevat zowel de CHAMPION- als HYPER-spelstanden uit de twee edities die zijn uitgebracht voor de speelhallen. Daarnaast introduceerde het een exclusieve Group Battle-stand, die tegenwoordig in de meeste vechtspellen te vinden is.
<br><br>
Speel als een van de twaalf verschillende vechters, elk met een eigen onderscheidende vechtstijl, in de spelstand voor één speler of daag een vriend uit in dit legendarische en klassieke vechtspel.
<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434C50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434C50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
