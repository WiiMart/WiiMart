...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574A4345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡JellyCar 2, el exitoso juego de plataformas y conducción está aquí y llega cargado con más de 30 niveles, tres modos de juego y mucho más! Juega uno contra uno en cooperación con los modos de multijugador Bandera, Joyas, y Soga. Publica tus mejores puntuaciones, tiempos, y saltos más largos en el Salón de la Fama. ¡Con tanta exquisitez esponjosa, querrás conducir tu Jelly Car 2 por la ciudad!
<p>
Clásico:<br>
¡Conduce tu coche esponjoso y usa tus habilidades especiales para recorrer esponjosos mundos! 
<p>
Fábrica de gelatina:<br>
En este juego de habilidad, tu objetivo es guiar las piezas que caen hasta las rampas correspondientes. Toca las palancas para abrir distintos caminos y guiar a cada pieza por las cintas transportadoras. 
<p>
Salto Largo:<br>
¡Vas a saltar una gran distancia y necesitas velocidad! ¡Cuidado con los objetos que pueden ralentizarte, y busca objetos que puedan darte impulso! 
<p>
Modo fábrica:<br>
¡¡Crea y juega en tus propios puzles!! ¡Elige rampas, ruedas, palancas y mucho más!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574A4345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574A4345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">JellyCar 2</span></div>
</div>
