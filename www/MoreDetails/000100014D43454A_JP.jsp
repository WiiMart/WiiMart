...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パステルカラーで彩られた世界が舞台のシューティングゲームです。初代「ファンタジーゾーン」の雰囲気やプレイ感覚を継承しつつ、新しい８つの惑星でかわいらしいキャラクターたちとの戦いが繰り広げられます。敵を倒してコインを集め、ショップでお買い物をするパワーアップシステムはそのままに、カルテットミサイルやウルトラボムなど、便利な装備もいろいろ追加されました。主人公「オパオパ」は、新たに現れた敵「ダークメノン軍」の正体を解き明かし、ファンタジーゾーンの平和を取り戻すことができるでしょうか。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーファンタジーゾーン<sup>TM</sup></span></div>
</div>
