...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484545')", "wiiSelectSound()");
...
<p>
BIT.TRIP BEAT trae la moda en acción mientras que usted utiliza el sensor de movimiento del Wii Remote para rebotar las notas al ritmo. Las representaciones visuales retro, el juego clásico, el juego multijugador, y un sonido de 8 bits te pondrá en la zona para mover tu mundo. ¡Pero pon atención! Como la mayoría de los juegos clásicos, los desafíos son poderosos. Si puedes permanecer calmado mientras que la dificultad aumenta, descubrirás los principios de la saga de BIT.TRIP BEAT.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484545/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484545/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
