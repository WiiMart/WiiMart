...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ボスコニアンシリーズ３作目の縦スクロール型シューティングゲーム。プレイヤーは戦闘機「フェニックス」を操り、敵の本拠地「惑星ボスコニアン」をめざします。戦闘中は赤と青の２色交互に変化するカプセルでレベルアップが可能です。赤はパワーアップ、青はボム機能を持つオプションが付加され、組み合わせによって１６パターンの攻撃フォーメーションに変化します。ミス時に出現する緑のカプセルを取れば、攻撃形態を引き継ぐことも可能です。さらに自機には破壊力抜群の兵器「フェニックスブラスター」が搭載されており、ボタンをためてからはなすと強力な貫通攻撃ができます。全７ラウンドを舞台に繰り広げられる戦いは、カプセル数とミスの回数で次のラウンドレベルが決まるため、プレイヤーの腕前に合わせて難易度が変化します。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルブラスター<sup>TM</sup></span></div>
</div>
