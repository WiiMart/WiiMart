...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das Basketballspiel Double Dribble für das NES basierte auf dem erfolgreichen Spielhallen-Klassiker von 1986.
<br><br>
Bei Double Dribble kann der Spieler zwischen vier verschiedenen Teams, drei Schwierigkeitsstufen und vier verschiedenen Rundenzeiten wählen. Spiele gegen den Computer oder fordere mit einem zweiten Controller einen Freund heraus!
<br><br>
Double Dribble war eines der ersten Sportspiele mit Zwischensequenzen und Sprachausgabe und zeigte den Sport im Vergleich zu vielen anderen Spielen dieser Zeit überraschend realitätsnah. Egal, ob du die Aufregung von damals wiedererleben willst oder das Spiel beim ersten Mal verpasst hast - Virtual Console bietet jetzt jedem die Möglichkeit, diesen Klassiker selbst zu spielen.
<br><br>
Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146445150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146445150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Double Dribble<sup>TM</sup></span></div>
</div>
