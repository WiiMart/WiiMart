...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157544D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡ADVENTURE ISLAND The Beginning llega a Wii con nuevas habilidades y elementos! 
Aprende a utilizar las nuevas habilidades mientras exploras Adventure Island de costa a costa.<br><br>

Encuentra los melones dorados que hay escondidos en cada nivel y en los minijuegos.
Cuando encuentres un melón dorado podrás conseguir objetos que te ayudarán en tu aventura.<br>
Los objetos que compres aumentarán tu poder de ataque o te permitirán ir a sitios donde antes no podías.<br><br>

Reúne una serie de requisitos mientras juegas a cualquiera de los modos para conseguir un "logro de Master Higgins". Si lo haces, conseguirás un traje de Master Higgins.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544D50/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544D50/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
