...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ordyne is a port of the popular side-scrolling arcade shooter that includes simultaneous 2-player co-op play as well as impressive visuals and catchy background music.  The evil Kubota has kidnapped Dr. Tomari’s fiancée Kana and taken the colossal nuclear reactor Ordyne. In order to reclaim them, Dr. Tomari and his assistant Felix take to their battleships and head in pursuit.  Avoid enemies and advance through 7 different levels that take place on land, sea, and air. Collect Crystals from defeated enemies and use them to buy items or upgrades for your ship at the Space Inn.  Do you have what it takes to defeat the boss at the end of each level and ultimately reach Kubota in the final stage, Kubota World?</div>
  <div id="image02">
