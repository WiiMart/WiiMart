...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego de lucha, publicado en 1994, fue el primero de la legendaria saga King of Fighters y marcó el camino del resto. A diferencia de los juegos de lucha convencionales, en los que las peleas son individuales, The King of Fighters ’94 te permite elegir uno de los ocho equipos formados por tres personajes de juegos clásicos de SNK como Fatal Fury, Ikari Warriors, Psycho Soldier y Art of Fighting. 
<br><br>
Las reglas del juego son de lo más sencillo: elige un equipo nacional, decide en qué orden combatirán tus luchadores y enfréntate a otro equipo hasta derrotarlo. Además de los movimientos especiales normales, cada luchador tiene una barra de poder que se carga para efectuar un demoledor “movimiento desesperado”. Esta barra se rellenará cuando recibas daño, así que aunque te estén dando una soberana paliza, ¡podrás ser capaz de darle la vuelta a la tortilla!
<br><br>
Con gráficos detallados, una animación fluida y una música y efectos de sonido excepcionales, este clásico es un título indispensable para cualquier fan de los juegos de lucha.
<br><br>
