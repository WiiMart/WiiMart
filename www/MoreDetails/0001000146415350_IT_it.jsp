...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pilota la tua navetta Solvalou e distruggi le forze di Xevious! Usa i missili Zapper per affrontare i nemici volanti e le bombe Blaster per colpire i bersagli a terra. Elimina Andor Genesis, le fortezze volanti nemiche, per ottenere punti bonus! Nemici unici, un’interessante colonna sonora, numerosi ambienti che scorrevano in verticale e tantissime meccaniche di gioco segrete differenziavano Xevious dagli altri sparatutto dell'epoca. Xevious è stato pubblicato per NES ed è diventato immediatamente un classico.<br><br>

In una partita per due giocatori, questi si danno il turno per controllare la propria navetta Solvalou. Il cambio avviene quando una navetta viene abbattuta.<br>
Nella partita per 2 giocatori sono necessari 2 controller.
