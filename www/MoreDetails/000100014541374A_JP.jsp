...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年にリリースされた格闘ゲームで、『サムライスピリッツ』シリーズの第４弾。前作『サムライスピリッツ 斬紅郎無双剣』をベースに、怒りゲージシステムの大幅な変更や、連続技などの強化を盛り込み、より派手な戦いが楽しめます。また、プレイ時間によってエンディングが変化する仕組みなどもあり、グッドエンディングを見るためには時間とのシビアな戦いも要求されます。今回は風間火月、風間蒼月といった新キャラを迎え、総勢１７人の侍が腕を競います。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
