...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157425350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In Pop, tutto ciò che conta è far esplodere le bolle! Il che può sembrare semplice, ma ci sono molti particolari da imparare per totalizzare punteggi alti e massimizzare il divertimento:<br> 

-Crea catene di bolle dello stesso colore per totalizzare punteggi alti<br>
-Utilizza i power-up per migliorare il tuo punteggio o per ostacolare un avversario<br>
-Gonfia le bolle per creare enormi esplosioni e catene<br>
-Gioca da solo o con i tuoi amici, sullo stesso schermo<br>
-Entra a partita già iniziata<br>
-Conquista i badge<br>
-4 differenti modalità di gioco <br><br>

Esistono anche tabelle on-line indicanti i punteggi record e messaggi WiiConnect24 in linea per tenersi aggiornati sui progressi degli amici e per esibire i propri. <br><br>
