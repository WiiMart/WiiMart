...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">配信中のアクションロールプレイングゲーム「ニュートピア」の続編。平和を取り戻した世界に、再び魔王復活のきざしが表れはじめたところから物語は始まり、プレイヤーは前作の主人公の息子として新たな冒険に挑みます。「魔法のコンパス」と人々からの情報を頼りに迷宮を探し出し、そこに待ち受けるボスを倒して行くシステムで、フィールドや迷宮内にはさまざまな仕掛けがあり、重要な情報やアイテムが隠されています。岩を動かしたり壁を爆破したりして秘密の部屋を見つければ、冒
険をさらに有利に進めることが可能です。セーブ機能への対応はもちろん、初心者でも安心して遊べる適度な難易度やスピーディーな展開、そしてグラフィックや操作性もさらに向上し、本格派ＲＰＧがますます身近になりました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ニュートピア Ⅱ</span></div>
</div>
