...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494545')", "wiiSelectSound()");
...
<p>
Cinco pollitos en tu bando, cinco en el otro. ¡BUM!
<p>
Vence al equipo de pollitos rival... pero ¡como nunca antes! En chick chick BOOM lanzas pianos, elefantes rosas y pollitos sumo, o invocas babosas medusas gigantes y ovnis de verdad. Traza líneas en la arena para defenderte de los ataques del rival: el uso que hagas de la tinta, tu creatividad y coordinación serán claves. Una mazorca y una piñata también te echarán una mano. ¡Va en serio!
<p>
Juega solo o con tus amigos; en equipo o unos contra otros. Para mantener las cosas interesantes, tienes varios modos de juego y arenas, cada una con su ataque especial.
<p>
Características:<br>
• Un jugador y multijugador: 1-4 (en equipo o unos contra otros)<br>
• Movimientos ofensivos: más de veinte divertidos ataques<br>
• Tres arenas: la ciudad, el barco y el bosque embrujado<br>
• Quince equipos: cinco disponibles inicialmente y diez más desbloqueables<br>
• Tres modos de juego: duelo, tiempo y Pro<br>
• Récords: se guardarán las mejores puntuaciones... para que las rompas
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494545/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494545/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">chick chick BOOM</span></div>
</div>
