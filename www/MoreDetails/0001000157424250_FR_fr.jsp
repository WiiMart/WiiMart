...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157424250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ce jeu de snowboard mêlant course et action est compatible avec la Wii Balance Board™.<br><br> Descendez les pistes en ramassant des objets pour attaquer vos adversaires. La bataille va être rude pour la première place !<br><br>

Les vêtements et lunettes des personnages sont signés Oakley. Retrouvez la collection 2008 du fabriquant dans le jeu ! De plus, vous descendrez les pistes au rythme des sons électro des nouveaux artistes du genre: 80kidz !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424250/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424250/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
