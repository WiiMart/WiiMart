...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157525150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Con más de 30 animales difíciles de alcanzar, incluidos rinocerontes lanudos, venados de cola blanca, lobos y alces irlandeses, Deer Drive Legends WiiWare te transporta a los rincones más inhóspitos de la tierra para cazar algunos de los animales más salvajes que pocas veces han sido observados por el ojo humano —incluso se creía que varios estaban
extinguidos—. ¡Estos animales son rápidos, letales y están ansiosos por convertirte en su cena! Participa en cruentas batallas de poder contra el temido T. Rex, los gatos que se defienden con sables y los Gastornis. Con varias armas para elegir, como rifles de francotirador, ballestas y escopetas de gran potencia, ¡Deer Drive Legends WiiWare es el juego de cacería más moderno que estabas esperando!</div>
  <div id="image02">
