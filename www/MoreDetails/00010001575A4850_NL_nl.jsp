...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001575A4850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Zoo is een dierensim waarbij je in de huid kruipt van een dierenfokker die dieren moet grootbrengen waarvan je normaal alleen maar kunt dromen. Voor een eenvoudige connectie met de natuur heb je alleen maar een Wii-afstandsbediening nodig. 
<br><br>
Er zijn in totaal 12 soorten dieren (4 soorten zijn apart verkrijgbaar). Kies je favoriete dieren en breng ze groot.
Voer ze, aai ze en maak hun verblijven schoon. Dit is een fantastische manier om een band te scheppen. 
<br><br>
De persoonlijkheid van elk dier verandert op basis van de manier waarop je voor ze zorgt. Zie hoe de dieren met de dag verwender of gulziger worden. Sommige dieren krijgen een baby. Zodra deze geboren wordt, moet je een extra mond voeden. 
<br><br>
De tijd in het spel verstrijkt sneller dan in het echt en de diersoorten zijn op andere tijdstippen actief: sommige overdag en andere 's nachts. Soms is het leuk om gewoon uit te rusten om te kijken wat ze doen. 
<br><br>
Dus waar wacht je nog op? Het is tijd om je eigen dierentuin te creëren. <br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4850/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A4850/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">My Zoo<sup>TM</sup></span></div>
</div>
