...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">INTERNATIONAL KARATE simula un torneo di karate e prevede due modalità di gioco: nella prima due partecipanti si sfidano tra loro in un torneo; nella seconda un solo giocatore compete contro il computer.
<br><br>
Durante il gioco compirai il giro del mondo, raggiungendo le più svariate destinazioni.
<br><br>
Durante ogni combattimento sarai osservato da un saggio giudice, che deciderà se attribuirti un punto o mezzo punto valutando l'abilità delle tue mosse.
<br><br>
