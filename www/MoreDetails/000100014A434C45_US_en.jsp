...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Good and evil battle for a young warrior's heart. There is one force in the universe that keeps good and evil in perfect balance. It is called the tree of Mana. But a magic sword has tricked a young warrior into upsetting this balance, spreading evil throughout the land. Thus, the warrior must undertake a dangerous journey to find the seeds of the Mana tree which have been hidden for centuries. Only then can perfect harmony be restored. In this incredible adventure, things are not as they seem. Magic swords release evil as well as fight it. Treasure chests hold booby traps. Monsters are friends and friends are enemies. Potions give power, black magic takes it away. Dragons fly, weapons change. It's a world turned upside down that you must help the warrior make right. And the only way to succeed is to solve the Secret of Mana.</div>
  <div id="image02">
