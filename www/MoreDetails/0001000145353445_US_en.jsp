...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">GHOSTS'N GOBLINS is a classic game that packs a heavy punch (and lance). Experience the smash arcade hit from 1985 as you help Arthur defeat hordes of monsters in his attempt to rescue the princess. The first (and possibly only) game in which taking a hit reduces you to your underwear.</div>
  <div id="image02">
