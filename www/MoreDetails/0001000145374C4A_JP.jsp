...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">コズモポリスの戦闘機「ハイパービート」を操作して、盗賊団「コズモギャング」を撃退していく、固定画面型シューティングゲームです。整列して画面上から降りてくるコズモギャングを下から撃破して、ステージ内のすべてのコズモギャングを撃退すると１面クリアとなり、火山や海や山そして宇宙空間など、さまざまなステージで戦いを繰り広げます。また、敵機を撃破してアイテムを取ることも可能。スペシャルフラッグを取ると自機が一機増えるなど、色々なアイテムを有効に使って戦うこともできます。ボーナス面もあり、２人同時プレイも可能です。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145374C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145374C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">コズモギャング・ザ・ビデオ<sup>&reg;</sup></span></div>
</div>
