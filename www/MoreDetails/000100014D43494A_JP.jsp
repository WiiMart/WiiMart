...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">メガドライブのハード性能の限界に挑戦した、手ごたえ満点の横スクロール型シューティングゲーム。プレイヤーは翼族の戦士となって魔族のモンスター軍団と戦います。武器は、３パターンあるショットと、「ライトニングボルト」「オーラシールド」などアイテムを取得して３段階にレベルアップも可能な８種類の魔法。雨あられと弾が降りそそぐ、激しい攻撃をくぐり抜けながら、幻想的な異世界を攻略してください。<BR>「人間機関車」「海底船長」など、おぞましくも魅力的なデザインと動きで迫る１１体の巨大ボスの圧倒的存在感も本作の特徴です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ジノーグ<sup>TM</sup></span></div>
</div>
