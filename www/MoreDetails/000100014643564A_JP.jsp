...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マリオとルイージがヘルメットとハンマーを身につけ、ビルの解体作業を請け負う「レッキングクルー」となって壁をたたき壊していくアクションゲームです。１人プレイではマリオ、２人プレイではプレイヤー２がルイージを操作します。それぞれのステージ（ＰＨＡＳＥ）で、決められた壁などを全てたたき壊すとステージクリア。しかしビルに住み着くモンスターたちが、そうはさせまいと襲いかかってきます。モンスターたちをかわしながら壁を壊していくアクション性はもちろんのこと、壊す順番や敵の動きなどをよく考えないとクリアできないパズル性も、このゲームの特長です。周囲の壁を破壊するダイナマイトをうまく活用し、壁の向こうから邪魔をしてくる「ブラッキー」にも気をつけて、１００ステージ制覇をめざしてください。「ＤＥＳＩＧＮ」（デザイン）モードを選べば、自作のステージをデザインしてプレイしたり、作成したステージを４つまでセーブすることもできます。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">レッキングクルー<sup>&reg;</sup></span></div>
</div>
