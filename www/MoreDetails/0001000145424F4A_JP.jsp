...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年にリリースされた格闘ゲームで、『風雲黙示録』の続編にあたる作品です。前作同様武器を用いた格闘家達が腕を競うという設定はそのままですが、今回は１チーム２名によるタッグバトルを採用。チームメイトの片方が倒れると負けてしまう一本制なので、タッチワークを活かした戦略が求められます。タッチは特定のエリアでしか行えないため、このエリアをめぐる攻防が重要となります。他にもガードキャンセル、しゃがみガードを崩す中段攻撃といった新要素が加わった他、超必殺技のコマンドが全キャラ共通になって遊びやすくなった点もうれしいところ。ロサやキムといった新キャラクターも必見です。
<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">風雲スーパータッグバトル</span></div>
</div>
