...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157424750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bang Attack is a fun colourful puzzle game for young and old alike! You don't have to learn how to play Bang Attack. Simply pick it up as you go along. The objective is to find identical objects and then smash them with your little hammer. Once you have enough points, you can use the Wii Remote™ to swing with the BIG hammer. If there is a banana in the way, simply whack it off the screen!
<br><br>
Do you have two Wii Remotes? If so, you can challenge another player to decide the real champ! Don't think that becoming a champion is easy though; you will have to deploy tactics and speed at precisely the right moment. Use the special bonus objects to hinder your opponent, because that’s the only way you’re going to win!
<br><br>
In Bang Attack you can enjoy 40 levels over four crazy worlds to guarantee hours of Bang Attack-ing fun. Bang Attack is a game the whole family will love to play!</div>
  <div id="image02">
