...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157475045')", "wiiSelectSound()");
...
<p>
Also make sure to visit every day and see your aquarium change—your fish will grow and new fish may be born. Life continues in your aquariums even while the Wii console is turned off!</div>
  <div id="image02">
