...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Appuyez sur l'accélérateur et partez à l'aventure sur les routes du continent américain! Traversez la Californie, l'Arizona et rejoignez la capitale, Washington. Pied au plancher, vibrez lors de courses urbaines électrisantes; admirez de célèbres décors, tels que le pont du Golden Gate, le Grand Canyon ou encore la Maison Blanche.
<br><br>
Inspiré du célèbre jeu d'arcade, Cruis’n USA offre une large gamme de véhicules, des bolides des années 60 aux voitures de sport italiennes. Parcourez seul les 14 stages à travers le pays ou affrontez un ami en mode deux joueurs.<br><br>Texte écran en anglais.</div>
  <div id="image02">
