...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157325445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este es un juego para fiestas que permite que hasta 4 personas jueguen a la vez. Los jugadores se convertirán en reclutas en un campamento de entrenamiento militar a las órdenes del Sargento Instructor Mindstrong y recibirán un entrenamiento abrumador que fortalecerá su mente. Las reglas son sencillas, pero la concentración y el pensamiento rápido son cruciales para jugar este juego y quedar como una verdadera máquina de pensar. La mejor manera de jugar este juego es con amigos y familiares.</div>
  <div id="image02">
