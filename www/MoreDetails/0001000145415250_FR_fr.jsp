...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ce jeu de golf est paru en 1996. Vous incarnez l'un des 6 joueurs disponibles pour jouer sur des parcours situés aux quatre coins du globe, comme au Japon (le Club de Golf Oriental Fujiyama), aux Etats-Unis (le parcours de Golf du Grand Canyon), en Autriche (le parcours du Lagon Bleu) et en Allemagne (le parcours de Golf Baden).
<br><br>
Vous avez le choix entre deux modes de jeu. Le premier est le mode "Stroke-Play" dont le but est d'obtenir le meilleur score en jouant les 18 trous. Le second est le mode "Match-Play", dans lequel deux joueurs s'affrontent sur un parcours pour voir qui peut remporter le plus de trous. Ce mode permet de jouer contre un ami.
<br><br>
