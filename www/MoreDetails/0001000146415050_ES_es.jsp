...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dale fuerte a la bola con Mario (y Luigi, cómo no, en el modo para dos jugadores) en este clásico simulador deportivo de 1992.
<br><br>
En NES Open Tournament Golf podrás elegir entre tres recorridos internacionales: Reino Unido, EE.UU. y Japón; y tres tipos de juego diferentes: Stroke Play, Match Play y Tournament.
<br><br>
Elige el palo adecuado y ajusta tu golpe según la dirección y la velocidad del viento en la pantalla del hoyo. Luego pasa a la pantalla del golpe y realiza el lanzamiento con precisión.
