...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">名作シューティングゲーム「グラディウス」の続編です。「バクテリアン」との壮絶なる死闘から２年後、新たな敵「ゴーファー」の侵攻を受けたグラディウス軍は、再び超時空戦闘機「ビックバイパー」の発進命令をくだします。本作のビックバイパーは、かつての「第１次グラディウス戦役」よりさらにパワーアップした最新型。プレイヤーは複数用意された「ウェポンモジュール」と「シールド」の組み合わせから、ステージの特徴や自分の得意とする攻撃パターンを考えて装備をセレクト。バリエーションに富む攻撃で、迫りくる敵を撃破していきます。シリーズ屈指の完成度を誇る本作品では、「人工太陽」ステージをはじめ、おなじみの「モアイ」ステージ、従来のボス達が次々に登場する通称「ボスラッシュ」にいたるまで、手ごたえ抜群の全９ステージを忠実に再現。スピード感あふれるハードなＢＧＭもプレイを熱く盛り上げます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">グラディウス<sup>&reg;</sup>Ⅱ GOFERの野望</span></div>
</div>
