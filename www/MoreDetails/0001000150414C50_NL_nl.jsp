...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit is een splinternieuwe schietervaring in de traditie van Star Soldier!<br>
Je bent een piloot van de SIA (Special Interception Airforce) die het zware gevechtsvliegtuig Soldier Blade bestuurt. Treed het invasieleger van Zeograd tegemoet met wapens die veranderen bij iedere power-up. Afhankelijk van de kleur van de power-up die je oppakt, kun je drie verschillende soorten aanvallen uitvoeren.<br>
Zaken als de Gunbody, om vijandelijke aanvallen te ontwijken, en de Burst Out, waarvan het effect afhangt van je power-up-niveau, voegen een strategisch element toe. Beslis snel welke voorwerpen je oppakt en wanneer je speciale aanvallen gebruikt. Elke missie sluit je af met een bloedstollend gevecht tegen een eindbaas.<br>
Je kunt ook spelen in de CHALLENGE-stand en zoveel mogelijk punten proberen te halen binnen de tijdlimiet. 
Zin in al deze nieuwe uitdagingen? Maak dan je borst maar nat!
<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414C50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414C50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Soldier Blade<sup>TM</sup></span></div>
</div>
