...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ハンマーで上段のフロアを崩し、邪魔する敵を倒しながら、雪山の頂上を目指すアクションゲーム。登場するキャラクターはコミカルでかわいらしく、滑る床や落ちてくるツララなど仕掛けも盛りだくさんです。２人プレイでは、協力しあうつもりが、相手の邪魔をしていつのまにか競い合ってしまうことも。１人でも２人でも、協力しても競っても楽しいファミコン初期のゲームです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642454A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アイスクライマー<sup>&reg;</sup></span></div>
</div>
