...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157465250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Frogger Returns retoma el éxito del clásico arcade Frogger y lo lleva a otra dimensión!<br>
Los viejos gráficos en 2D han sido reemplazados por coloridos gráficos en 3D. Además, encontrarás nuevos niveles, enemigos y bonificaciones que cambiarán la estrategia de juego. Por si fuera poco, ahora también cuentas con un modo multijugador para que te enfrentes a tus amigos.
<br>
<br>
- Niveles completamente nuevos. Atraviesa las cuatro etapas del viaje de Frogger desde la carretera hasta la casa.
<br>
<br>
- Varios modos de juego. Supera tus récords, compite contrarreloj o guía a Frogger hasta su hoja de nenúfar. ¡Juega a tu manera!
<br>
<br>
- Nuevos jefes y tácticas. Los nuevos enemigos y bonificaciones te obligarán a variar tus estrategias.
<br>
<br>
-¡Juega con un amigo a través del modo multijugador! <br>
<br>Textos de pantalla en español.</div>
  <div id="image02">
