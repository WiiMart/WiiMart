...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574A4B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un día, el Profesor “H”, un experto en la Isla de Pascua de fama mundial, recibió una extraña carta de la capital Hanga Roa. Era un grito de socorro de un desconocido y decía que algo malo estaba sucediendo en la isla. Sin dudarlo, el Profesor, su ayudante Joel y su nieta Ivie se dirigieron rápidamente a la isla, donde les aguardaban una multitud de rompecabezas, misterios y misiones. ¿Puedes ayudarle a revelar el mayor secreto de la Isla de Pascua?
<p>
- Más de 40 niveles repartidos por toda la Isla de Pascua<br>
- Montones de tableros de diferentes formas<br>
- Una historia de intriga sobre los misterios de la Isla de Pascua
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574A4B45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574A4B45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Jewel Keepers: Easter Island</span></div>
</div>
