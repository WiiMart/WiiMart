...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157424B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ARKANOID Plus! è la nuovissima versione dell’originale titolo per sale giochi. Prendi il comando della tua nave spaziale VAUS e respingi la sfera d’energia per distruggere tutti i blocchi presenti sullo schermo. L’esperienza di gioco è arricchita da nuove modalità e impostazioni che rendono questo titolo veramente imperdibile! Scegli “Arcade” per esplorare 61 round divisi nei gruppi A e B: due diversi boss pronti a scatenarsi ti attendono nell’ultimo livello. Cerca di tener testa a un amico o alla CPU nella modalità “Versus”; spassatela con la “Sfida a tempo” e completa i round in un lasso di tempo limitato. Decidi se seguire la regola “Vite” o “Barriera”, scopri tutti i bonus e affronta ore e ore di puro divertimento!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
