...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157414E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Arriva finalmente su WiiWare la versione più divertente dell'amato passatempo domenicale, il trascorrere la giornata con una lente d'ingrandimento puntata a osservare un formicaio!<br><br> Dovrai addestrare la tua colonia di super formiche usando i divertentissimi strumenti. Fulmina, brucia e gestisci le tue formiche per renderle abbastanza forti e numerose da poter sopravvivere a prove sempre più pericolose! Proteggi il tuo territorio dagli attacchi delle coccinelle, dei ragni e delle altre creature ostili. <br><br>Scuoti il telecomando Wii per calpestare le formiche con un martello oppure usalo come metal detector alla ricerca d'oro e altri tesori.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
