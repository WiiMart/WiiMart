...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Pokémon Snap no tendrás que capturar Pokémon con la Poké Ball, sino que deberás utilizar una cámara de fotos. Métete en la piel de Todd, un joven fotógrafo que ayuda al profesor Oak en su investigación sobre los Pokémon haciéndoles fotos desde un vehículo especialmente diseñado para ello: el ZERO-ONE.
<br><br>
Recorre Isla Pokémon y haz fotos de los Pokémon en su hábitat natural. Muchos Pokémon son algo tímidos y tendrás que utilizar objetos especiales, como una flauta o comida, para poder fotografiarlos.
<br><br>
El profesor Oak puntuará tus fotos según la pose y el tamaño de los Pokémon, ¡así que prepárate para poner a prueba tu pericia con la cámara!
<br><br>
Además, la versión de Pokémon Snap para la consola virtual es compatible con el tablón de Wii. ¡Ahora podrás compartir tus fotos de Pokémon favoritas con tus amigos!<br>La función de vibración del juego original no está disponible.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414B53/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414B53/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
