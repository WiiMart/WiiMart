...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９１年にリリースされたファンタジーアクションです。プレイヤーは魔神ナウシズを倒すために、村、塔、城、海岸など全7ステージを戦い抜くことになります。ゲームは三人称視点の画面で展開され、プレイフィールドは非常に個性的。方向キーで勇者の移動（左右）や盾による防御（上中下）、武器攻撃、魔法攻撃を使うことができる他、武器ボタンと魔法ボタンの同時押しで強力な特殊攻撃を繰り出すこともできます。各ステージの合間に獲得したＧＯＬＤで武器を購入したり、経験値をためることでキャラクターが成長したりといった具合に、ＲＰＧの要素も盛り込まれています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クロスソード</span></div>
</div>
