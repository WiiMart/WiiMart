...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157414550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Around the World" is een casual game met een geografische content. Het spel bestaat uit een single player-modus om je geografische kennis te verbeteren en een multiplayermodus om te strijden met je vrienden en familie.<br><br>
Deze partygame draait om twee soorten games waarbij de speler binnen een bepaalde tijd een antwoord moet geven:<br>
- de quiz waarbij de speler vragen beantwoordt door uit verschillende mogelijkheden het juiste antwoord te kiezen<br>
- het spel "wijs de locatie zo precies mogelijk aan" waarbij de speler een bepaalde plek precies moet aangeven.<br><br>
In dit spel komt geografie op een leuke manier aan bod door middel van verschillende onderwerpen, zoals monumenten, geschiedenis, sport, kunst, literatuur en mensen.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414550/FFFD0017" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414550/FFFD0018" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
