...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">주인공 마리오가 납치된 연인 레이디를 구하러 가는 내용의 액션 게임입니다. 동키콩은 끊임없이 나무통을 굴리며 공격해 오지만, 점프로 피하면서 위로 이동하여 레이디가 있는 곳에 도달하면 게임 클리어입니다. 전체 3개의 스테이지로 구성되어 있는, 기념할만한 마리오의 데뷔작입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414154/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414154/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">동키콩<sup>TM</sup></span></div>
</div>
