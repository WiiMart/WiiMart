...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Kijk films en series via streaming vanaf Netflix direct op je tv via je Wii-console.  Kijk zo vaak en wanneer je maar wilt.  Download en installeer Netflix om van start te gaan. Nieuwe Netflix-leden kunnen vandaag aan de slag met hun gratis maand. Altijd opzegbaar. Netflix-lidmaatschap vereist  Service beschikbaar in bepaalde landen.  Ga naar netflix.com voor details.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434C50/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
