...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157545050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tetris, le grand classique du jeu
de puzzle naturellement addictif.
Il allie simplicité et stratégie pour
vous amuser ainsi que votre famille
et tous vos amis durant des heures
illimitées ! Ce jeu WiiWare transcende le jeu original pour vous proposer différents modes à 1 joueur ou multijoueur uniques, comme Escalade, Course, Ombre ou des modes utilisant le Wii Balance Board. Exploitant parfaitement les possibilités "pointer et tirer" de la télécommande Wii, la maniabilité a été optimisée pour garantir une jouabilité sans égale.<br><br>Texte écran en français.<br>Compatible avec la Wii Balance Board.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545050/FFFD0011" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545050/FFFD0012" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
