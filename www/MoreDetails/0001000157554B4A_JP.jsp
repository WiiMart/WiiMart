...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157554B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">3種類の右脳を刺激するトレーニングを家族みんなで対戦ゲーム感覚で取り組むことで、脳を鍛えます。お子様の知育として、お父さんやお母さんのアタマの体操として、家族一緒に取り組んでください。瞬間視力や図形認識力、記憶力、思考力等を手軽にトレーニングできます。最大4人まで参加できる対戦型に特化したトレーニングで家族一緒に取り組めます。収録されているトレーニングは次の3種類。思考力や図形認識力などを鍛える『カタチおなじかな？』瞬間視力や図形認識力などを鍛える『アイテムとれるかな？』瞬間視力や記憶力などを鍛える『すうじみえるかな？』各トレーニングにはレベルが7段階設定されています。また、これらのトレーニングはバラバラでも行えますが、すべてのトレーニングをバランスよく行える『うのうマラソン』を収録しています。この機能を利用すると3つのトレーニングをバランスよく行えるほか、得意な分野、苦手な分野にかたよることがないので対戦もより盛り上がります。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">右脳キッズ</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">おきがる右脳トレーニング</span></div>
  </div>
