...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Te superan increíblemente en número y tu única alternativa es luchar y ganar. Estás solo, con tus armas, y lo único que te separa de la Armada Imperial Japonesa es el estrecho terreno de "Blood Beach". Aunque cuentas con un increíble arsenal (M2 Browning, 40mm M1 y por supuesto tu Thompson), la Armada Imperial Japonesa te lanzará todo lo que esté a su alcance ("Zeros", "Bettys" e incluso acorazados Takao), en su empeño metódico e implacable de recuperar las Islas Salomón. Los récords serán guardados para los niveles de dificultad Easy, Normal o Hard.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424845/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424845/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
