...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">World Heroes 2 Jet est sorti en 1994, c’est le 3ème épisode de cette série de jeux de combat prolifique. Choisissez parmi 16 combattants composés de héros historiques et de vilains. Battez-vous pour devenir l’homme le plus fort de l’histoire ! Il y a deux modes dans cette version : le "Tournoi des titans", dans lequel vous faites un combat en trois manches durant toute une journée et si vous êtes vainqueur, vous passez au jour suivant. Le mode Entraînement World Heroes quant à lui vous permet de vous battre contre n’importe quel adversaire. De plus, il est désormais possible de courir et de faire un pas rapide en arrière, chose qui n’était pas possible d’effectuer dans les versions précédentes. A cela s’ajoute la possibilité de contrer, rendant le jeu plus agressif, plus rapide et plus agréable à jouer. Il existe également quatre types différents de compétitions, apportant de la profondeur de jeu.<br><br>Texte écran en anglais.</div>
  <div id="image02">
