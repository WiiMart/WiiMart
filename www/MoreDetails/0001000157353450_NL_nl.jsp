...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157353450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Vermaak je met de hele familie en neem het tegen elkaar op in de verschillende spelmodi!<br>
5 Spots Party is een behendigheidsspel voor alle leeftijdscategorieën en is gebaseerd op het bekende spel waarin u de 5 verschillen zoekt.
<br><br>
In de drie spelmodi moet je het maximum aantal verschillen in de weergegeven afbeeldingen vinden. In de party-modi neem je het op tegen andere spelers en zoek je het maximum aantal fouten. In de modus 1 Speler zoek je de verschillen voordat de tijd op is om de records van het spel te verbreken.
<br><br>
Hoe ver denk je dat je kunt geraken?
<br><br>
