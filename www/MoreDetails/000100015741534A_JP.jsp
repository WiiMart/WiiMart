...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015741534A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">コンピュータとの対局や、通信対局、詰将棋などが楽しめる、本格将棋ソフトです。<BR><BR>
コンピュータとの対局では、強さを６段階で設定でき、初心者から上級者までやり応え十分な対局が楽しめます。<BR><BR>
またニンテンドーＷｉ－Ｆｉコネクションを使って、全国のプレイヤーと対局ができます。<BR><BR>
初級・中級・上級の３段階のレベルで対局相手を募集できるので、実力が近い人と気軽に対局が楽しめます。フレンドとの通信対局も可能です。<BR><BR>
そのほか、２００問以上の詰将棋や基本から学べる将棋講座も収録しています。<BR><BR>
※コンピュータ対局のＡＩには、<BR>
　北陸先端大学院大学の<BR>
　ＴＡＣＯＳを使用しています。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100015741534A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015741534A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">通信対局　早指将棋三段<sup>TM</sup></span></div>
</div>
