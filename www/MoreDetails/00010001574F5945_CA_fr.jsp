...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F5945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Get ready for the most spectacular journey through time in the history of video games!!<br>
Accompany Bit Boy Kubi through a crazy pixelated adventure and battle hordes of nasty monsters in:<br>
<br>
4-bit dungeons,<br>
8-bit caves,<br>
16-bit strongholds,<br>
32-bit labyrinths,<br>
64-bit arenas and<br>
128-bit worlds!!<br>
<br>
Rescue Kubi's friends!! <br>
Set off in the ultimate pursuit of fruits and highscores!!<br>
Grab a friend for even more fun in Cooperative mode!!<br>
<br>
The Wii Remote™ controller is your joystick - let the arcade adventure begin!!<br></div>
  <div id="image02">
