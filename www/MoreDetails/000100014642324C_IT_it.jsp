...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Scopri sulla Virtual Console l'eccezionale seguito del gioco più venduto di tutti i tempi!
<br><br>
Super Mario Bros.: The Lost Levels, in origine disponibile solo in Giappone per il Famicom Disk System, accresce l'esperienza del gioco precedente con nuovi livelli entusiasmanti, con nemici e ostacoli più infidi e con tantissimi mondi segreti tutti da scoprire.
<br><br>
Questa versione del gioco è stata già disponibile sulla Virtual Console in occasione di un precedente Hanabi Festival, ma solo per un breve periodo. Ora non ci sono più limiti di tempo: puoi scaricare il gioco quando vuoi! 
