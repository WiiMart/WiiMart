...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157474445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ábrete paso a través de niveles llenos de naves espaciales alienígenas y otras criaturas mundanas en este juego retro de disparos y de desplazamiento horizontal. Escoge cuidadosamente tus armas y mejóralas para crear un devastador arsenal de armas de la era espacial para ayudarte en tu desafiante misión. Los jugadores podrán publicar sus puntajes más altos en tablas de líderes a nivel mundial a través de la Conexión Wi-Fi de Nintendo y ver su rango en comparación con todos los otros jugadores de Gradius ReBirth. Prueba tus habilidades con Gradius ReBirth y mira a ver si tienes lo que hace falta para ganarle a este juego de disparos lleno de acción.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157474445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157474445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
