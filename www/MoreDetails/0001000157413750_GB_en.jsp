...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157413750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toribash is the online fighting game where you make all the moves! Use precision motion control to create any move you want – the only limit is your imagination! Manipulate your fighter’s joints for maximum impact and take out your opponents with precise hits. Boost your joints for that added speed and strength to hit harder then grab your opponents and slam them to the ground.
<br><br>
Want to make your own fight movies? Just jump into the replay editor. You can enter replays at any point in time and review your fight to catch that mind-blowing move you missed.
<br/><br/>
