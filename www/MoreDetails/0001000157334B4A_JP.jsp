...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157334B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『すりぬけアナトウス』は、「カタマリ」がせまりくるカベをすりぬけていく、スピード感あふれる「疾走すりぬけパズル」です。<BR><BR>

プレイヤーは、せまってくるカベにぶつからないよう、カタマリを回転させて、カベにあいた穴をすりぬけていきます。<BR>
カタマリは立体です。どう回転させれば、すりぬけられるのか？　を考え、すばやくカタマリを回転させて、アクセル全開で穴に飛び込みます。<BR><BR>

ゲームモードは、３つあります。<BR>
制限時間内にクリアするべく、アクセルをかけ続けるスリルを味わう「ステージクリアモード」。<BR>
閉ざされた通路から広大な宇宙へ向けて、ノンストップでスピードが加速し続ける「エンドレスモード」。<BR>
特殊ルール「トリック」を決めるまで穴が開かないスリルが連続する「トリックチャレンジモード」。<BR>
これらに加え、ニンテンドーＷｉ－Ｆｉコネクションによるランキング機能と、ゲームをプレイしながら素早く操作を覚えられるチュートリアルもついています。<BR><BR>

そして、カタマリが先へ進めば進むほど、アクセル全開で疾走するスピード感とギリギリですりぬけるスリリング感が増していきます。爽快感あふれる、新感覚のすりぬけパズルをぜひお楽しみ下さい。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157334B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">すりぬけアナトウス<sup>TM</sup></span></div>
</div>
