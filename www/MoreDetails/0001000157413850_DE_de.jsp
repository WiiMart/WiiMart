...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157413850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Begib dich in diesem einzigartigen Spiel der innovativen Art Style-Serie auf eine Reise in eine mikroskopisch kleine Welt.
<br><br>
Du bist ein winziger Organismus mit Tentakeln und deine Aufgabe besteht darin, zu wachsen! Schwimme durch die Ursuppe und verwende deine Tentakel, um andere Organismen mit der jeweils passenden Farbe zu absorbieren. Gelingt dir dies, wachsen deine Tentakel. Stimmt die jeweilige Farbe nicht überein, verlierst du das Tentakel und einen Punkt Lebensenergie.
<br><br>
Drehe dich mit deinem Organismus durch die Umgebung, achte dabei aber auf deine rotierenden Tentakel und vermeide, Organismen mit einer nicht passenden Farbe zu absorbieren.
<br><br>
In diesem Spiel stehen dir drei Spielmodi mit entspanndem, aber auch herausforderndem Spielgeschehen zur Verfügung. Die Steuerung erfolgt über einfache Bewegungen der Wii-Fernbedienung (alternativ kann auch der Classic Controller verwendet werden). Ein mikroskopisches Meisterwerk!
<br><br>
Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413850/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157413850/FFFD0012" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Art Style<sup>TM</sup>: PENTA TENTACLES<sup>TM</sup></span></div>
</div>
