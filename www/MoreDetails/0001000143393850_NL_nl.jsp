...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De androïde bemanning van een intergalactisch ruimtevrachtschip heeft zich tegen zijn meesters gekeerd en de menselijke bemanning volledig uit de weg geruimd.
<br><br>
Een androïde prototype met de naam Influence Device is aan boord van het schip gestraald om je te helpen opnieuw de controle over de situatie te verkrijgen. Gebruik het Influence Device om de androïdes te vernietigen door ze neer te schieten of te rammen. 
<br><br>
Neem tijdelijk controle over de moederborden van de vijandelijke androïdes om hun energie en wapens tegen hun eigen soort te gebruiken. Vernietig alle androïdes op elk van de 16 dekken van het ruimtevrachtschip!
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143393850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143393850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Paradroid<sup>TM</sup></span></div>
</div>
