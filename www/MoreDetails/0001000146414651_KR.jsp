...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">파이프에서 나오는 적들을 아래에서 두드려서 기절시키고 몸으로 부딪혀 쓰러뜨리는 액션 게임입니다. 게임의 진정한 재미는 협력 플레이에서 느낄 수 있는데 그 이유는 협력을 하다 보면 어느샌가 뜨거운 배틀로 이어지기 때문이라는데……. 아케이트에서 이식된 게임으로 마리오가 처음으로 주인공으로 등장하는 게임입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414651/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414651/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">마리오브라더스<sup>TM</sup></span></div>
</div>
