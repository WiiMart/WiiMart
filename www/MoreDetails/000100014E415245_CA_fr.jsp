...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Link must save the world! This time, he finds himself trapped in Termina, an alternate version of Hyrule that is doomed to destruction in just three short days. Link must race to recover the Ocarina of Time (which allows him to manipulate time in multiple ways), defeat challenging bosses in dungeons spread across Termina, and discover the key to the mystery of Majora’s Mask. Along the way he’ll obtain new weapons and items and help other characters (some strangely familiar) in their everyday lives. In addition, Link must utilize a wide assortment of masks scattered throughout Termina, each with its own specific use or power. Never before has three days offered so much in the way of action, mind-boggling puzzles, and depth—The Legend of Zelda: Majora’s Mask is an adventure unlike any other!</div>
  <div id="image02">
