...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ＳＤガンダムワールド　ガチャポン戦士　スクランブルウォーズ』は、１９８７年に発売されたシミュレーションゲームです。「機動戦士ガンダム」シリーズのモビルスーツを操作し、拠点を確保してユニットを生産しながら敵軍本拠地の占領または敵の全滅を目指すことが目的です。ユニットの移動や生産を行うシミュレーションパートとアクションによる戦闘パートに分かれており、このアクションとシミュレーションが融合したゲームシステムが人気を集めました。以後、この第一作を皮切りにシリーズとして展開されていきました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
