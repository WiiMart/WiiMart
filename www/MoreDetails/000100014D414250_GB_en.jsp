...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Test your hand at the ancient Phoenician game of Columns. Multicoloured gems drop from the top of the screen into a pit and it is up to you to quickly arrange the order of the jewels as they fall into lines of three or more. If your gems pile up and reach the top, the game is over.<br><br>Does not support Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
