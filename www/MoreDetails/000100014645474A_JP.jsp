...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">新宿歌舞伎町に事務所を構える私立探偵「神宮寺三郎」を主人公とした、本格的推理アドベンチャーゲーム。十数タイトルを数える長寿シリーズ“探偵　神宮寺三郎”の３作目です。神宮寺の助手「御苑洋子」の旧友の招待で訪れたオートバイレース観戦で彼らが直面する、旧友の突然の悲報と、その夫である著名ライダーの失踪。複雑な人間関係が絡み合いながら無気味な広がりを見せる難事件に二人が挑みます。神宮寺と洋子が別行動をとる本作では、操作に行き詰まった神宮寺に洋子が重要な情報をもたらすこともあり、彼女の活躍はその後のシリーズにも同様に受け継がれていきます。リアリティあふれる世界観と、魅力的なキャラクター達、決して色あせることのない本格ハードボイルドの世界観、人間模様が織りなすドラマをお楽しみください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">探偵神宮寺三郎<sup>TM</sup></span></div>
</div>
