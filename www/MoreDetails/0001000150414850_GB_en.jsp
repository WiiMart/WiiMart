...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This upgraded edition to the famous “Lode Runner” series includes a 5 player versus mode. A large amount of gold has been stolen from the Time Machine Research Centre, and the group responsible has used a time machine to escape and hide the gold throughout time. The Centre has sent an elite team of “Runners” out to retrieve the stolen gold.
<br><br>
In addition to the familiar PUZZLE mode, the game features a BATTLE mode, where up to 5 players can compete, and an EDIT mode where you can create your own original stages.
You can enjoy BATTLE mode in a number of different ways – be the last one standing to win in SURVIVAL, and grab items from enemies and flee to win in ESCAPE. With 4 players, you can separate into 2 teams to do battle in TAG MATCH.
<br><br>When battling with multiple players, you must connect the same number of Wii Remotes or Nintendo GameCube Controllers as the number of players.
To play with 5 players, you will need at least one Nintendo GameCube Controller.</div>
  <div id="image02">
