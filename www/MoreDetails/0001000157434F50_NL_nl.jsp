...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157434F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welkom bij de avonturen van Cocoto Fishing Master. Bereid je voor op een compleet nieuwe ervaring op het Wii-systeem!
Kruip in de huid van Cocoto en reis de hele wereld rond op zoek naar vijf millenniumvissen!
Alleen zij kunnen voorkomen dat de magische ketel vol met lava overloopt en zo de wereld vernietigt!<br>

Dankzij Cocoto Fishing Master voor de Wii, is vissen nog nooit zo leuk geweest:<br>

- Gebruik de Wii-afstandsbediening en de Nunchuk als echte vishengel om meer dan 30 verschillende vissen te vangen. <br>
- Ontdek 5 betoverende meren in 4 verschillende werelden in Cocoto’s universum. <br>
- Confronteer gigantische bazen om elk stukje standbeeld te vinden waarmee je de grote koning Geo uit zijn lange slaap kunt wekken.<br>
- Ontmoet Cocoto’s vrienden: verkoop je vis aan Baggy en koop nieuwe visuitrusting in Neuro’s winkel.<br><br>

Het spel kan in Frans, Engels, Duits, Spaans of Italiaans gespeeld worden.</div>
  <div id="image02">
