...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">World Heroes 2 Jet, originariamente rilasciato nel 1994, è il terzo titolo della profilica serie di combattimento a incontri. Scegli tra uno dei 16 condottieri disponibili tratti figure storiche, eroi leggendari o famosi combattenti e fatti strada per diventare il guerriero più forte del pianeta! Ci sono due modalità di gioco in questo capitolo, “Tournaments of Titans Mode”, in cui combatterai tre incontri in un giorno e, se avrai successo, proseguirai al giorno successivo e “World Heroes Training Mode”, in cui combatterai con qualunque avversario tu voglia. Inoltre, con l’aggiunta dello scatto e del passo all’indietro, non presenti nel titolo precedente, insieme a un sistema di counter che spinge il giocatore a un gameplay più dinamico, World Heroes 2 Jet è ancora più divertente da giocare. In più, con quattro diversi tipi di competizione tra cui scegliere, il livello delle tue battaglie sarà più profondo che mai.<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415450/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415450/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">WORLD HEROES 2 JET</span></div>
</div>
