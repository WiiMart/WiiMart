...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La primera aventura 3D de Kirby lleva a la portentosa bola rosa
más allá de Dream Land, hacia las estrellas, donde luchará para salvar a sus amigos de un nuevo y mortífero enemigo: Dark Matter.
<br><br>
Este bonito y colorido juego de
plataformas tiene todos los elementos de acción que te gustaría encontrar en un juego de Kirby. Trágate a tus enemigos para copiar sus habilidades (como fuego, hielo o electricidad) o combínalas para crear efectos aun más poderosos. ¡Pruébalas todas y verás qué resultados más sorprendentes!
<br><br>
En tu misión explorarás
planetas hechos de lava, agua o incluso dulces. Lucha contra enormes jefes mientras buscas los fragmentos de cristal diseminados. Kirby 64 también incluye tres minijuegos extra en los que pueden participar hasta cuatro jugadores.<br><br>Textos de pantalla en inglés.<br>La función de vibración del juego original no está disponible.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414D50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414D50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Kirby 64<sup>TM</sup></span></div>
</div>
