...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ábrete paso a través de una estación espacial con forma de mazmorra y derrota a los monstruos en este juego de disparos en primera persona.
<br><br>
Eres un miembro de élite de los Debuggers, un grupo de soldados especialistas cuya misión es inspeccionar una estación espacial remota. Tienes exactamente 100 minutos para entrar, destruir a los monstruos que merodean en cada bloque, llegar hasta el nivel más bajo y desactivar el detonador automático.
<br><br>
Con cada monstruo que se te escape, será más difícil sobrevivir en el bloque central, así que la velocidad será clave para preservar las instalaciones y cada bloque.
Experimenta el suspense de la supervivencia mientras el tiempo corre y descubres la verdad sobre lo que ocurrió...
