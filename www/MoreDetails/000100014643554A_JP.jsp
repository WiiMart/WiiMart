...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミリーコンピュータディスクシステム用ソフトのスポーツゲーム第一弾。男子と女子、８つの国からチームの選択が可能。Ａ・Ｂボタンを駆使して、サーブやレシーブ、アタックといった基本テクニックから、クイック攻撃やバックアタックなどの多彩な攻撃を繰り出すことができます。お互いにどんな攻撃を仕掛けてくるのかを読み合って、熱い対戦プレイも楽しめます。<BR>１５点制のルールも懐かしい。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バレーボール</span></div>
</div>
