...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mike and Spike Bonanza are enjoying their favourite television show, when the picture crackles and a shadowy figure of a mysterious stranger appears on-screen. This individual asks them to collect certain items, that he has placed inside various buildings, to test his security force. If they return the items successfully, Mike and Spike will be rewarded.
<br><br>
The two of them say that they will get the job done in only three minutes. However, little do they know that each building is packed full of security guards, who will raise the alarm if they are caught red-handed. Fortunately both Mike and Spike are equipped with bullets that can knock the guards unconscious for a few seconds. A huge reward will be given out if Mike and Spike are apprehended.
<br><br>
Help the infamous Bonanza Bros. infiltrate a number of different locations, ranging from banks to mansions to casinos, but don't get caught!<br><br>Does not support Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
