...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">手にした者に無限の力を授けるという聖剣「ラングリッサー」と魔剣「アルハザード」をめぐる戦いを描いた、シミュレーションＲＰＧです。物語は主人公「エルウィン」が旅の途中に立ち寄った村での争いに加勢するところからはじまります。プレイヤーはエルウィンと仲間たちが率いる全ての部隊を指揮して勝利を目指します。敵の部隊が「歩兵」なら「騎馬」で攻めるなど、相手が苦手とする属性の部隊をぶつけて戦いを優位に進め、複数の部隊で弱点を補いながら、地形効果や魔法による支援を活用して、困難な戦局を打ち破ってください。また本作では、プレイヤーの行動によって物語が分岐する「マルチストーリーシステム」を採用。
「帝国」や「闇の軍勢」に加担してかつての仲間と戦ったり、自ら世界制覇に乗り出したりと、数多くのドラマを楽しむことができます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">デア ラングリッサー<sup>&reg;</sup></span></div>
</div>
