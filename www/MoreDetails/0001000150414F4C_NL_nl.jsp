...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Een verticaalscrollend schietspel uit de bekende Soldier-serie.
In de 23ste eeuw wordt de aarde plotseling aangevallen door indringers uit de toekomst. In een gevechtsvliegtuig, ontwikkeld door de slimste wetenschappers ter wereld, neem je het op tegen de vijandelijke belagers. Verzamel bonusvoorwerpen waaronder lasers, elektronstralen, vlammen en raketten, en stel ze in de OPTIONS in om verschillende aanvallen te gebruiken. In SET-UP kun je voor elk van deze wapens kiezen uit drie verschillende soorten. Anticipeer de vijandelijke aanvallen en wissel snel tussen je wapens om de indringers te verslaan! Naast NORMAL GAME zijn er ook nog de 2 MINUTE GAME- en 5 MINUTE GAME-spelstanden waarin je zo veel mogelijk punten moet scoren. Final Soldier is de perfecte mix van alle andere spellen uit de serie en een titel die je niet wilt missen.
<br><br>Het spel is voorzien van Engelse schermteksten met wat Japans.<br>
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414F4C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414F4C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Final Soldier</span></div>
</div>
