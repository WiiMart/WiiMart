...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Catturato l'ultimo Metroid, la galassia è in pace. Ma quando i Pirati Spaziali rubano la larva per i loro scopi malvagi, la cacciatrice di taglie Samus Aran deve entrare in azione ancora una volta!
<br><br>
Torna nel labirintico mondo sotterraneo del pianeta Zebes ed esploralo ancora più in profondità, utilizzando nuove abilità come il Raggio Gancio e il Visore Raggi X. Affronta boss enormi con un arsenale incredibile di raggi, missili e bombe.
<br><br>
Super Metroid è uno dei più famosi giochi d'azione in 2D mai sviluppati. Ha preparato il terreno per la serie di Metroid Prime con il suo sistema innovativo di mappe, una varietà di armi differenti, le tute e un'infinità di segreti da scoprire.<br><br>Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
