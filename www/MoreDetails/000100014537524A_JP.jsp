...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ナムコシアター」で上演中の活劇「ワンダーモモ」の主人公を操作し、ステージ上を左右に移動しながら全１６ステージを演じるアクションゲームです。はるかかなたロリコット星からやってきた正義のヒロイン「モモ」は、「ワンダーパワー」で「ワンダーモモ」に変身し、怪人軍団「ワルデモン」から地球を守るために戦います。モモは敵を倒すとワンダーパワーがたまり、戦闘能力が高く必殺技も使えるワンダーモモへと変身可能になりますが、ワンダーパワーがなくなるとモモにもどってしまうため、いつ変身するかがカギとなります。４ステージで１話の物語となり、各ステージのボスを倒すとステージクリアです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワンダーモモ<sup>&reg;</sup></span></div>
</div>
