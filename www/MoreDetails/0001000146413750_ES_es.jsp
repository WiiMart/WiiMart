...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mario & Yoshi es un juego de puzles para NES en el que deberás ordenar fichas de personajes y reconstruir cáscaras de huevo para liberar al Yoshi atrapado en el interior.
<br><br>
Mueve a Mario hacia la derecha y hacia la izquierda y haz que recoja los Goomba, Boo, Blooper y los Floro Piraña que caen. Atrápalos entre dos medias cáscaras de huevo y libera a un Yoshi. ¡Cuantos más atrapes, más grande será el Yoshi liberado y mayor será tu bonificación!
<br><br>
Luigi se sumará a las partidas multijugador en las que una pantalla dividida permitirá jugar a dos jugadores simultáneamente. 
