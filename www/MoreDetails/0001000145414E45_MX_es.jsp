...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lanzado por SNK en 1992, FATAL FURY 2 es el segundo juego de la famosa serie de peleas. Además de Terry, Andy, y Joe, quienes aparecieron en el juego original, otros 5 nuevos luchadores de todo del mundo se reúnen para pelear por el título del campeonato. Una novedad de esta versión son los peligrosos obstáculos, que son específicos para cada nivel, y la habilidad de hacer ataques de desesperación cuando la fuerza del personaje está baja. Estas técnicas mortales te dan la oportunidad de tener una ventaja contra tu oponente cuando estás a punto de ser derrotado con un solo golpe. Además de todo esto, la batalla de dos líneas, muy popular en la versión anterior, ha sido dramáticamente mejorada. Presionar simultáneamente el botón de ataque débil y el de ataque fuerte permite al jugador que su luchador se mueva a otra línea por si mismo, o lanzar un ataque para golpear a su oponente a otra línea. Este concepto, único para este título de la serie, permite al jugador aprovechar la profundidad de la pantalla para crear peleas más emocionantes. ¿Puedes probar una vez más que eres el rey de los luchadores?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414E45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414E45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FATAL FURY 2</span></div>
</div>
