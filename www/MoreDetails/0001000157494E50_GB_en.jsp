...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157494E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Get lost in The Incredible Maze!  <br><br>Simply tilt your Wii Remote to navigate a series of exciting and twisted mazes.  Entering the maze could not be easier, but finding your way out will require a keen eye and a steady hand.  Obstacles and traps are around every corner, so move your ball around the maze without falling off the edge.  But watch out, there are lots of surprises in store.  You can hunt for gems in a timed challenge, or test your abilities in a race against the clock.  The Incredible Maze is also compatible with the Wii Balance Board so you can really put your weight into it.  <br><br>This is the way in, but you’ll have to find your own way out.</div>
  <div id="image02">
