...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ghosts'n Goblins es una aventura llena de acción... ¡y lanzas!<br>
Prueba el juego que catapultó a Capcom a lo más alto de la industria de los juegos recreativos en 1985. Ayuda a Arthur a abrirse paso a través de hordas de monstruos para rescatar a la princesa.<br>
 ¡Diviértete con el primer (y posiblemente único) juego en el que quedas en ropa interior al recibir un golpe!
