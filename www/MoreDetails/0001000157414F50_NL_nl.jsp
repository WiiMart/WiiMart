...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157414F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Very Hungry Caterpillar’s ABC is een educatief spel waarmee ouders en kinderen de basisbeginselen van de Engelse taal op een speelse manier onder de knie kunnen krijgen.<br><br>

Het spel bestaat uit vier delen waaronder een grappige alfabetgrafiek met kleurrijke letters,  afbeeldingen van Eric Carle en een woordenschatquiz gericht op kinderen tot zes jaar. Deze laatste bestaat uit zelfstandige naamwoorden als cijfers, kleuren, vormen, dierennamen, eenvoudige werkwoorden en bijvoeglijke naamwoorden als “run” (lopen), “eat” (eten) en “big” (groot)<br><br>

Ouders en verzorgers kunnen het “To The Parents” menu gebruiken om te kijken hoe goed de woordenschat van hun kinderen is.<br><br>

De hele familie zal zeker genieten van de kleurrijke illustraties van Eric Carle, de internationaal gelauwerde auteur van prentboeken.
<br><br>De software is voorzien van Engelse schermteksten.</div>
  <div id="image02">
