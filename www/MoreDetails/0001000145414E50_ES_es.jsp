...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fatal Fury 2 es un juego de lucha publicado por SNK en 1992. Además de Terry, Andy y Joe, que ya aparecieron en el primer Fatal Fury, otros cinco nuevos luchadores compiten en esta ocasión por el campeonato. En aquel juego, cuando los luchadores se quedaban sin fuerzas durante el combate y estaban al borde de la derrota, tenían que seguir luchando a pesar de estar en clara desventaja. Ahora, sin embargo, cuando pierden fuerza y el indicador parpadea en color rojo, pueden hacer uso de una técnica especial que permite alcanzar la victoria en el último momento con un solo golpe. Además, el combate en 2 planos, que suscitó un gran interés en la anterior entrega, también ha sido radicalmente mejorado. Al pulsar simultáneamente el botón de ataque débil y el de ataque fuerte, el jugador podrá cambiar de plano a su luchador o lanzar al otro luchador de un plano a otro, lo que permite disfrutar del combate utilizando toda la profundidad de la pantalla.
<br><br>
Un sistema de juego revolucionario, gráficos coloridos y una excelente banda sonora, hacen de Fatal Fury 2 un título de obligada presencia en cualquier colección de juegos.
¿Estás preparado para convertirte en el rey de los luchadores? ¡Pues entonces, adelante!
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414E50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414E50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fatal Fury 2<sup>TM</sup></span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">NEOGEO</div>
</div>
</body>
</html>
