...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157594945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ayuda a Vektor a escapar de las garras de la malvada CPU y de su ejército de Patrullas, Cazadores e Interceptores.
<p>
Vektor está atrapado en tu Unidad Central de Procesamiento. No está muy seguro de cómo ha llegado hasta allí ni de cuánto tiempo lleva cautivo, pero sí sabe que necesita tu ayuda para escapar. La CPU ha desactivado la habilidad de Vektor para moverse libremente... pero él es un experto en programación. Trabaja con Vektor para que consiga huir de las garras de la CPU. Guíalo hacia la libertad a través del laberinto de la CPU evitando a Patrullas, Cazadores e Interceptores enemigos. Tienes que moverte rápido: la CPU reacciona a gran velocidad y hará lo imposible por impedir que Vektor escape. Él puede crear códigos que te darán las habilidades necesarias para combatir la creciente potencia de la CPU, pero eres tú quien decidirá su destino en última instancia.
<p>
*30 niveles de acción, aventura arcade retro<br>
*Impúlsate y ábrete camino a través de cada nivel<br>
*Evade, escapa y destruye a los enemigos<br>
*Descubre la historia detrás del encarcelamiento de Vektor
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157594945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157594945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">escapeVektor<sup>TM</sup>: Chapter 1</span></div>
</div>
