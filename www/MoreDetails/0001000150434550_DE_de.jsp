...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Power Golf ist eine perfekte Kombination aus einfacher, aber realistischer Steuerung und toller Grafik. Schlag dich durch 18 Löcher und insgesamt drei Spielmodi, als Einzelspieler im Zählspiel, im Mehrspieler-Modus beim Lochspiel oder im Wettkampf.
<br><br>
Bestreite die Turniere mit einer von drei verschiedenen Spielfiguren – als Anfänger, Fortgeschrittener oder Profi. Windstärke und Gefälle stellen bei jedem Loch eine zusätzliche Herausforderung dar. Miss dich mit anderen Spielern im normalen Match, oder spiele mit einem deiner Clubs im einzigartigen Club Match.
<br><br>
Bis zu drei Spieler können im Wettkampf-Modus gegeneinander antreten, und durch die Handicap-Einstellung können selbst Anfänger atemberaubende Abschläge machen, die denen von Profis in nichts nachstehen.
<br><br>
