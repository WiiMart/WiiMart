...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das Kampfspiel World Heroes wurde 1992 veröffentlicht und lässt dem Spieler die Wahl zwischen acht verschiedenen Charakteren, die an historische Figuren angelehnt sind. Unter ihnen sind der japanische Ninja Hanzou, die französische Kämpferin Janne und der russische Magier Rasputin, die gegeneinander um den Weltmeistertitel als bester Kämpfer antreten. 
<br><br>
Bei diesem Spiel wird je ein Knopf zum Schlagen, Treten und Werfen verwendet, die Bewegungen werden mit dem Steuerkreuz ausgeführt. Ein einzigartiges System steuert die Stärke des Angriffs je nachdem, wie lange die Knöpfe gedrückt werden. 
<br><br>
Neben dem normalen Kampfmodus steht auch der Death Match-Modus zur Auswahl, in dem es Minen, elektrische Abgrenzungen und andere gefährliche Objekte gibt, so dass dem Spieler eine große Abwechslung geboten wird.
<br><br>
Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">World Heroes<sup>TM</sup></span></div>
</div>
