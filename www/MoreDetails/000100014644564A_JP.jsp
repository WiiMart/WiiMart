...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８９年に発売され、のちに続く“くにおくん”の『ダウンタウン』シリーズの第一弾として今なお人気の、傑作アクションゲームです。「熱血高校」３年生の“くにお”が、突如として近隣高校を支配した“りゅういち”“りゅうじ”兄弟率いる「冷峰学園」に対し、「花園高校」の番長“りき”とともに多彩な攻撃を駆使していどみます。敵対する各校の生徒や“ごうだ”“にしむら”といった番長など、個性豊かなキャラクターが独特のセリフ表示とあわせて登場。倒した敵から得られるお金で様々なアイテムを購入、使用するとキャラクターを成長させることができるロールプレイングゲーム要素も、支持を集めました。多くのゲームファンの記憶に残る熱き闘いが、今よみがえります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダウンタウン熱血物語<sup>&reg;</sup></span></div>
</div>
