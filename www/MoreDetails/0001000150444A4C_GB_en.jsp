...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is the classic PCEngine (Turbografx16) version of the timeless classic two-player fighting game! A large capacity HuCARD was used to port the arcade version, allowing a faithful recreation of the dynamic game and its features, including bonus stages and sound effects. 
<br><br>
In the game, players select one of twelve characters and face opponents in a no-holds-barred battle to decide the top fighter in the world. Master a character’s traits, special moves and combos to defeat your rivals around the world! 
<br><br>
V.S. Battle mode contains a convenient handicap feature, allowing even a novice player to take on a seasoned veteran and enjoy an intense, head-to-head combat experience!
<br><br>
In-game text will include some Japanese.</div>
  <div id="image02">
