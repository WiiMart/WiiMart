...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit zijwaartsscrollende schietspel is het laatste deel in de Fantasy Zone-serie en plaatst je in de huid van het hoofdpersonage Opa-Opa, die eropuit is om de dood van zijn vader te wreken. Om dit te doen moet je een aantal Enemy Generators uitschakelen om de verschillende levels te voltooien en de Menon Guardian aan het eind van het level te vernietigen.<br><br>
Door je vijanden te verslaan verdien je goud dat je kunt gebruiken om betere wapens, uitbreidingen en andere voorwerpen te kopen. Denk goed na voordat je je goud uitgeeft, want elke eindbaas vormt weer een unieke uitdaging!
<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Fantasy Zone<sup>TM</sup></span></div>
</div>
