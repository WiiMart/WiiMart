...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Kruip in de huid van een eenzame, tot de tanden bewapende soldaat, en begeef je achter vijandelijke linies op een geheime missie om je medesoldaten te bevrijden.<br><br>                                                                     Dit spel werd in de VS op het SEGA MASTER SYSTEM uitgebracht als Rambo: First Blood II (in Europa als Secret Command). Verdedig je tegen felle aanvallen van vijandelijke soldaten, rakettroepen, tanks en andere vijanden, die jou ervan proberen te weerhouden de gijzelaars te redden. Gebruik je vertrouwde machinegeweer en een compoundboog, uitgerust met explosieve pijlen, om de overwinning te behalen.<br><br>                                                   Laat niets je tegenhouden!  Speel samen met een vriend in de stand voor twee spelers voor dubbel zoveel vuurkracht!<br><br>Het spel is voorzien van Engelse schermteksten.<br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Secret Command<sup>TM</sup></span></div>
</div>
