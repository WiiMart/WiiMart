...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界の強豪を相手に３分間一本勝負で挑むボクシングアクションゲームです。国内ではニンテンドウパワーのゲーム書き換えシステムのみで発売されました。対戦相手の繰り出すパンチを、上下のガード、スウェーやダッキングでうまく防御して、すばやくフェース（顔）やボディーにパンチをヒットさせていきます。対戦相手には個性豊かな全１６人のボクサーが登場し、中には強烈な特殊攻撃を仕掛けてくるキャラクターもいるので要注意。相手の動きのくせを見きわめてダメージを最小限におさえ、パンチをヒットさせてガッツメーターをいっぱいまでためていきましょう。いつでもスペシャルパンチを出せる状態をキープしながら戦うのが攻略のカギです。画面をところ狭しと大暴れする大きなキャラクターをノックアウトする爽快感で、ボクシングの醍醐味を思う存分楽しめます。またボクサーたちの一部は、ファミコン版や、Ｗｉｉ版「ＰＵＮＣＨ－ＯＵＴ！！」にも登場します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーパンチアウト！！<sup>TM</sup></span></div>
</div>
