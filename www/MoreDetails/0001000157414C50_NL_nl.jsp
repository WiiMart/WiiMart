...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157414C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Doorbreek de snelheid van het licht in dit unieke racespel uit de Art Style-serie, dat het genre herdefinieert.
<br><br>
In Art Style: light trax bestuur je een lichtstraal en neem je het op tegen andere lichtstralen in een race naar de eindbestemming. Je lichtstraal beweegt automatisch vooruit, zodat je je kunt concentreren op snelheid. Wissel van baan om een voorsprong op te bouwen en gebruik wrijvingsenergie om je tegenstanders in te halen. Snel voort over circuits met wisselende 2D- en 3D-aanzichten, raak spurtpanelen om meer snelheid te maken en ontwijk obstakels zodat je geen seconde verliest. 
<br><br>
De twee belangrijkste spelstanden zijn de Campaign-stand (waarin je series races probeert te winnen) en de Freeway-stand (waarin je binnen een bepaalde tijd een zo groot mogelijke afstand af probeert te leggen). Als je goede resultaten boekt, speel je extra standen en onderdelen vrij.
<br><br>
Een eenvoudige besturing, uitdagende gameplay en een spetterende elektronische soundtrack maken van Art Style: light trax een racespel dat zijn tijd lichtjaren vooruit is.
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414C50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414C50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
