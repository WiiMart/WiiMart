...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574D4F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">C’est un mystère époustouflant, défiant toute pesanteur !
<br><br>
Les Moki se font dévorer par des Gromblins gloutons, et c’est à vous de guider ces petits malheureux en toute sécurité. Tordez, tournez et retournez l’environnement pour regrouper les Moki dans une série de casse-tête ! En chemin, vous allez devoir rencontrer des fosses mortelles, des lames tournantes et une pesanteur instable. Faites rouler les Moki le long de rampes, attrapez-les avec des crochets et propulsez-les avec des jets pour les guider en toute sécurité vers les portails. Défiez vos compétences sur plus de 100 niveaux complètement uniques !<br><br>Texte écran en français.</div>
  <div id="image02">
