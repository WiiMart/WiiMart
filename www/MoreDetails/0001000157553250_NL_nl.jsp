...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157553250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Met "Successfully Learning Mathematics Year 3", kunnen kinderen uit de tweede klas en Freddy de kleine vampier al spelend vraagstukken oplossen en wiskunde studeren. Freddy de kleine vampier motiveert kinderen en geeft ze hints. Er is dus geen druk om te presteren.
<br><br>
Als beloning voor al dat studeren, krijg je nieuwe levels met leuke bonus games. Studeren en spelen worden de ideale combinatie!
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157553250/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157553250/FFFD0011" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Successfully Learning </span></div>
</div>
