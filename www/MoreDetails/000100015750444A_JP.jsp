...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750444A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「珍道中!!ポールの大冒険」は昔懐かしの横スクロール型アクションゲーム・・・<BR>と思いきや、なぜか突発的に様々なお笑いネタが飛び出す、これまでにない“お笑いネタ収集アクションゲーム”です。<BR>お笑いネタは、見ると同時にアルバムに追加され、リプレイ機能でいつでも楽しむことができます。但し、お笑いネタの中には一定の条件を満たさなければ見ることができないものが多数あります。レアネタを発掘し、アルバムをコンプリートさせることがこのゲームの最大の目的です。<BR>家族やお友達をお客様に迎えて、皆様でゲーム楽しんでください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750444A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750444A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">珍道中!!ポールの大冒険<sup>TM</sup></span></div>
</div>
