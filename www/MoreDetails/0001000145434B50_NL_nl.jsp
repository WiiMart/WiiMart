...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">NAM 1975 is een third-person “shoot ‘em up”-spel dat oorspronkelijk werd uitgegeven in 1990. De speler vecht zich een weg door een ongenadig slagveld door naar links en rechts te manouvreren op de voorgrond, terwijl hij fel beschoten wordt door de vijanden op de achtergrond. Je strijdt normaal gesproken met machinegeweren en andere vuurwapens, zoals handgranaten etcetera. Je kunt echter ook nieuwe wapens vinden door voorwerpen op te pakken. Daarnaast kun je een sprintje trekken om uit benarde situaties te proberen te ontsnappen.<br><br>De software is voorzien van Engelse schermteksten.</div>
  <div id="image02">
