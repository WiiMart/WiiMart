...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157343845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bienvenido a ShadowPlay. ¡Deja volar tu imaginación y crea fascinantes sombras usando objetos cotidianos! Juega y experimenta: transforma una piña en un monstruo, un plátano en un delfín... ¡el único límite es tu imaginación! ShadowPlay reta a los jugadores a transformar sombras en más de 100 figuras únicas y sorprendentes. 
<p>
Conforme se hacen disponibles nuevos desafíos, los jugadores tendrán que encontrar soluciones más creativas para resolverlos. ¡Nunca más verás una rebanada de pizza de la misma manera! Al ganar una ronda, los jugadores pasarán al siguiente nivel y obtendrán otro objeto para utilizarlo en el modo Free Play (Juego libre), donde puedes desatar tu imaginación y crear tus propias sombras. Tus amigos y familiares pueden también participar para ayudarte con cualquier acertijo gracias al modo Local Co-Op (Cooperación local). ShadowPlay brinda toneladas de diversión para jugadores de todas las edades.
<p>
¿Cómo juegas con las sombras en ShadowPlay?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157343845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157343845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ShadowPlay</span></div>
</div>
