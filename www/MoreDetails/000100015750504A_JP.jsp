...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ｗｉｉリモコンを振るだけの体感操作で手軽にピンポンをプレイできます。選手はオートで移動してくれるのでどなたでも楽しめます。お手軽なだけではなく、左右へのうちわけや強力な必殺スマッシュなどゲーム的な面白さもギュギュッとつめてお届け。画面分割による２人対戦プレイも熱くなれますし、試合に疲れたらピンポンを題材にしたミニゲームも遊べます。家族みんなで一緒に『おきらくピンポン』を楽しんでください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750504A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750504A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おきらくピンポンWii</span></div>
</div>
