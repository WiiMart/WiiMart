...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パステルカラーの美しい世界を舞台に、かわいいキャラクターが次々と登場する、一風変わったシューティングゲーム。主人公「オパオパ」は、宇宙の通貨危機を招いた敵の野望をくじくため、「ファンタジーゾーン」へと向かいます。登場するラウンド（惑星）は全部で８つ。それぞれの惑星で前線基地をすべて破壊すると、ボスが登場。ボスを倒すと次の惑星へと進みます。どのボスも意外な攻撃方法で挑戦してきますので、弱点を探しましょう。敵を倒すと現れる大小３種類のコインを集めると、ジェットエンジン、７ウェイショット、ヘビーボムといった強力な装備や、残機数が増えるアイテムなどをショップで買うことができます。戦略的にアイテムを購入し、状況に合わせてオパオパをパワーアップさせるのが攻略のコツです。苦労の末にたどり着いた最終惑星に待ち受ける、真のボスの正体とは？アーケードに始まり数々のゲーム機に移植された人気作の、セガ・マークⅢ版です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C41424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C41424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファンタジーゾーン<sup>TM</sup></span></div>
</div>
