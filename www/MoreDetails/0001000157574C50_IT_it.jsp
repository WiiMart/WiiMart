...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157574C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Vestirai i panni di Frankie, l'eroe della storia. Frankie è un orfanello che deve aiutare il suo pro-pro-prozio, il professor Frankenstein, a costruire uno strano dispositivo.<br>
A questo scopo, il professore gli affida un "Vaporizzatore", un marchingegno in grado di risucchiare i "vaporini", strane nuvole che distruggono i dispositivi meccanici che incontrano, e di scavare tesori.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157574C50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157574C50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Will of Dr. Frankenstein</span></div>
</div>
