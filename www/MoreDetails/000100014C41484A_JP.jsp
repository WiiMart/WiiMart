...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">セガ体感ゲームシリーズ第二弾タイトルとしてアーケードで人気を呼んだシューティングゲームを、ハード性能をいかして再現したセガ・マークⅢ版です。プレイヤーは超能力戦士「ハリアー」となって、ドラゴンランドに現れた魔物たちと戦います。地平線の彼方から続々と現れる魔物たちを「超能力キャノン」で撃ち落としてください。
全１８ステージの戦いの中では、凶悪なドラゴンや一つ目のマンモス、近未来戦闘機など、奇妙で魅力的な敵が続々と登場します。さらに最終ステージではアーケード版には無かったオリジナルの新ボスキャラクターが登場し、ハリアーと最後の死闘を繰り広げます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C41484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C41484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
