...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Double Dribble è un gioco di pallacanestro 5 contro 5 per NES, basato sull'omonimo classico da sala giochi del 1986.
<br><br>
Il gioco mette a disposizione quattro squadre selezionabili e offre la possibilità d'impostare la lunghezza della partita e la difficoltà. Affronta il computer o prendi un secondo controller e sfida un tuo amico sul campo!
<br><br>
Grazie al parlato, ai filmati e alla capacità del gioco di ricreare il feeling di una partita di basket con estrema accuratezza, Double Dribble può essere considerato un precursore dei giochi sportivi moderni. La Virtual Console ti offre la possibilità di provare questo classico per la prima volta o di rivivere le stesse emozioni di allora.
<br><br>
