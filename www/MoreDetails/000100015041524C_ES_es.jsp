...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En este juego de desplazamiento vertical, todo un clásico del género, tendrás que abrirte paso a través de un extraño mundo habitado por tronchantes enemigos.
<br><br>
Acompaña a TwinBee y WinBee, que surcan los cielos con una difícil misión: liberar el planeta de la amenaza que suponen los malvados invasores alienígenas. Pero no va a ser un camino de rosas; deberás superar seis fases plagadas de extraterrestres chiflados. Podrás elegir entre el modo individual, en el que controlarás a TwinBee, y el cooperativo para dos jugadores, en el que WinBee se sumará a la acción.
<br><br>
Por si fuera poco, cuentas con todo un arsenal de ataques a tu disposición, algunos de ellos tan poderosos como el Súper disparo, además de otros exclusivos del modo para dos jugadores, como el Ataque doble y el Ataque explosivo. Dispara a las campanas que veas aparecer para convertirlas en diferentes objetos. ¡Reúne todos los que puedas para aumentar el alcance de tus armas y hacer que esos alienígenas salgan zumbando!
<br><br>
Textos de pantalla en inglés con algunos caracteres en japonés.</div>
  <div id="image02">
    <img src="/oss/ccs/000100015041524C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041524C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">DETANA TWIN BEE</span></div>
</div>
