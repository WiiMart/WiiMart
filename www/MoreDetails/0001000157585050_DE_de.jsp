...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157585050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paint Splash verwandelt Ihren Fernseher in eine interaktive Leinwand, auf der sich Kinder aller Altersgruppen am Malen mit der Wiimote erfreuen. Bis zu vier Benutzer können gleichzeitig malen, so dass die ganze Familie an der Entstehung fantastischer Gemälde, nur durch das Benutzen der Wiimote, teilnehmen kann.
<br><br>
Wählen Sie verschiedene Pinsel und Werkzeuge, malen Sie in allen Farben des Regenbogens oder aktivieren sie den Splash Modus, in dem das schütteln der Wiimote einfach Farbe auf den Bildschirm spritzt, ideal für die jüngsten Mitglieder der Familie.
<br><br>
Sie können Ihre Bilder auf der SD Karte speichern und Ihre Kreationen einfach auf andere Medien, wie zum Beispiel ihren Heimcomputer, zum Ausdrucken und Verschicken übertragen.
<br><br>
