...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Burning Fight, in 1991 uitgegeven door SNK, is een zijwaartsscrollend vechtspel. Duke, Ryu en Billy, drie detectives en de hoofdrolspelers van dit verhaal, zijn op het spoor van Casterora, een gigantisch syndicaat dat van New York naar Osaka is gevlucht. Ieder personage gebruikt een combinatie van stoten, trappen en sprongen. De dodelijke technieken die elk personage kan toepassen, worden geactiveerd door de spring- en aanvalsknoppen tegelijk in te drukken. De dodelijke technieken brengen enorme schade toe, maar gebruiken ook een groot deel van je energie. Spelers moeten deze technieken dus op het juiste moment toepassen. Het spel bevat een stand voor meer spelers, maar let goed op, want spelers kunnen ook elkaar raken. Houd dus in de gaten waar je partner zich in het heetst van de strijd bevindt.<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414B50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414B50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Burning Fight<sup>TM</sup></span></div>
</div>
