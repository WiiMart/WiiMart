...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A port of the arcade version of Street Fighter, the legendary fighting game that started it all! 
<br><br>
...
<br><br>
Power up your attack to three different levels - the longer you hold a button, the stronger your attack! Input a series of button commands to perform special attacks and deal serious damage to your opponent!
Combine your normal and special attacks effectively to fight your way to victory!</div>
  <div id="image02">
