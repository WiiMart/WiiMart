...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pac-Man hat einen Auftritt in Pac-Attack, einem witzigen und verrückten Puzzlespiel!
<br><br>
Das Ziel von Pac-Attack ist einfach: Halte deinen Bildschirm von fallenden Blöcken und Geistern frei. Um die Blöcke zu entfernen, musst du sie waagerecht aneinanderfügen. Sobald du eine waagerechte Linie fertig gestellt hast, verschwindet sie. Für die Geister brauchst du allerdings Pac-Mans Hilfe. Pac-Man taucht nämlich immer mal wieder auf, um etwas zu verputzen. Deine Aufgabe ist es nun, die Geister als Snacks für ihn aufzureihen. Pac-Man verschlingt Geister, bis er von einem Block aufgehalten wird oder keine Geister mehr da sind. Er bewegt sich dabei nur waagerecht und abwärts. Auf einer ebenen Oberfläche geht er in die Richtung, in die sein Mund gerichtet ist.
<br><br>
Du kannst aus 3 Spielmodi wählen: 1P Normal Mode (Einspieler-Modus), 2P Versus Mode (Zweispieler-Modus) und dem herausfordernden 1P Puzzle Mode (Einspieler-Puzzlemodus).
<br><br>
Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424C50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424C50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
