...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The local arcade is packed with kids, all lining up to play the latest, most realistic video game they've ever seen. It's called Wild Side, and it uses holographic images to immerse the player in a strange world. But there's a problem - kids are literally getting sucked into the game, and now several of them are trapped.
<br><br>
It's up to you as Kid Chameleon, the best gamer in town, to get yourself sucked in so that you can defeat the game's boss, and bring your friends back to reality. Throughout the game you'll be able to take several different forms (Berzerker, Micromax, Maniaxe, Skycutter) which will make you much more powerful. The game contains more than 100 levels and 1,850 screens, so your skills will definitely be put to the test!
<br><br>Supports Wii Component cable Interlace Mode.</div>
  <div id="image02">
