...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157413245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El juego clásico de rompecabezas Magnetica está ahora disponible en WiiWare™, con su propia versión extraordinaria en la experiencia de juegos de rompecabezas. Estás rodeado por gemas que marchan lentas, pero seguras siguiendo una línea. Utiliza un cañón (¡dirigido por un Mii™ de tu elección!) para disparar gemas con los mismos colores y aniquilarlas antes que ellas alcancen la desembocadura de la línea. Los controles no podrían ser más sencillos. Todo lo que necesitas hacer es girar el mando de Wii para apuntar y oprimir el Botón A para disparar. La experiencia del juego sigue siendo muy adictiva y profunda como siempre esperas de juegos de rompecabezas de Nintendo, con cinco modos de juego disponibles y mecanismos avanzados como la capacidad de lanzar globos con las gemas y un suministro interminable de cadenas. ¡Este definitivamente no es un juego típico de gemas!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157413245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Magnetica<sup>TM</sup> Twist</span></div>
</div>
