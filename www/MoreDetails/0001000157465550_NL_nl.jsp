...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157465550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De LEGENDE begint hier - speel Furry Legends, het dynamische platform-avontuur en meest pluizige spel ooit!  Begin dit gekke avontuur en los de leuke natuurkunde puzzels op in Furland, een schitterende wereld in 3D.<br>
