...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Boulder Dash, lanzado originariamente en 1984, es uno de los grandes juegos clásicos para computadora, además de ser uno de los pocos que fue llevado desde las computadoras personales hasta las salas de juegos (normalmente ocurre al contrario). El héroe del juego es el valiente buscador de oro Rockford. Debe excavar cuevas para recoger diamantes y, al mismo tiempo, intentar evitar peligrosas criaturas y obstáculos, como rocas que se despeñan. Estará en constante peligro de ser atrapado por una avalancha o de morir a causa de una explosión subterránea. Estrategia y planificación son las claves de la victoria en Boulder Dash. Una vez que hayas conseguido el número indicado de piedras preciosas, se te revelará la puerta de acceso al túnel de salida y Rockford podrá explorar una nueva cueva.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143394845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143394845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
