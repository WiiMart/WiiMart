...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM"><b>Esto es una demo. Es posible que no estén disponibles todas las funciones de la versión completa.</b><br><br>
<b>Cuando termine la demo accederás automáticamente al Canal Tienda Wii. Es posible que tengas que esperar unos momentos.</b><br><br>Vive con NyxQuest: Kindred Spirits la asombrosa historia de Nyx, una enigmática muchacha alada que deberá descender de los cielos en busca de Ícaro, su gran amigo desaparecido.<br>
<br>
Sobrevuela las ruinas de la antigua Grecia y evita caer a las abrasadoras arenas, o sucumbir bajo las garras de crueles arpías e hidras...<br>
<br>
Necesitarás la ayuda de Zeus y otros dioses para invocar los poderes del Olimpo, que te permitirán lanzar rayos, alterar el escenario y doblegar los vientos a tu voluntad. Con tus propios movimientos de muñeca y apuntando a la pantalla podrás llevar a cabo estas y otras hazañas en la más novedosa y divertida aventura de plataformas para la Wii. ¡Vuela, apunta y dispara, y aprovecha al máximo el potencial que te ofrece el mando de Wii!<br>
<br>
Juego para uno o dos jugadores. ¡Juega con tu mejor amigo y maximiza tus posibilidades! Mientras uno controla a Nyx, el otro ayudará con los poderes de los dioses.<br>
<br>
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Versión de prueba</span></div>
  </div>
