...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">定番「ソルジャーシリーズ」に連なる、縦スクロールタイプのシューティングゲームです。舞台は２３世紀。突如地球に侵攻してきた未来からの敵に、各国の科学力を結集して生み出された戦闘機「零式ドライアード」が立ち向かいます。自機はゲーム中に現れる「パワーアップユニット」を取ることで「オプション」を装備したり、「レーザー」や「Ｅビーム」「ファイヤー」「ミサイル」といった多彩な攻撃を繰り出すことが可能です。<br>さらに「SET-UP」では難易度の設定をはじめ、パワーアップで使用する武器をそれぞれ３つのタイプから自由に選ぶこともでき、敵の攻撃を見極めながら上手く武器を切り換え、立ちふさがる敵を倒します。ゲームは通常の「NORMAL GAME」以外に、おなじみのキャラバンモード「2 MINUTE GAME」「5 MINUTE GAME」も用意されています。シリーズ中、最も絶妙なチューニングを施されたといわれるスコアアタックは、正に手応え十分です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルソルジャー<sup>&reg;</sup></span></div>
</div>
