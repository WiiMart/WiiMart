...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494350')", "wiiSelectSound()");
...
<br><br>
Encarnas a los dioses más fabulosos de cuatro grandes mitologías: nórdica, egipcia, romana y japonesa. Un grupo de insolentes humanos se ha propuesto construir una torre para quitarte tu puesto, y esto es algo que no puedes permitir.
<br><br>
Utiliza tus numerosos poderes para impedírselo, ¡pero ten cuidado y no los hieras, ya que necesitas creyentes para sobrevivir!
<br><br>
- Campaña para un jugador con 60 niveles.<br>
- Dieciséis dioses con poderes específicos.<br>
- Cuatro jefes histéricos a los que vencer.<br>
- Cuatro mitologías distintas que descubrir.<br>
- Dieciséis trofeos especiales para los jugadores expertos.<br>
- Un modo especial para dos jugadores con pantalla compartida.
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494350/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
