...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Aquarium 2 es la secuela del exitoso título de WiiWare, My Aquarium. Esta vez el tema es el misterio de las profundidades marinas.
<br><br>
¡Puedes criar fascinantes criaturas de todas las formas y tamaños, como peces abisales y medusas luminosas, usando tan solo el mando de Wii! 
<br><br>
Como en el original, puedes personalizar tu acuario y elegir qué peces meter y dónde colocar diversos adornos.
También puedes elegir entre distintas luces de colores para iluminar tu acuario. ¡Con el tiempo, los peces podrían procrear y tendrías un nuevo banco que criar! ¡Crea tu propio acuario y disfruta de interminables horas de relajante entretenimiento! 
<br><br>
¡Esta secuela incluye más peces y objetos que el original! Y como antes, puedes conectarte al Canal Tiempo para reflejar el tiempo real.
<br><br>
¡Sumérgete y contempla las maravillosas criaturas del profundo mar azul!<br><br>Textos de pantalla en español.
<br/><br/>
Como algunos de los servicios en línea de la consola Wii han dejado de estar disponibles el 28 de junio de 2013, ya no es posible acceder a las funciones en línea de este programa por medio de WiiConnect24.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324F50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
