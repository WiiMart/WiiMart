...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">勇者の末裔アリオスと邪龍ダルダンディスとの戦いをえがいたアクションＲＰＧです。主人公のアリオスがモンスターとの戦いで味方とはぐれ、さいはての島にたどり着いた場面から物語は始まります。プレイヤーはアリオスとなって「イシュタリア」を旅し、道中で出会う仲間たちとともに各地で起こる異変を解決します。本作はレベルアップではなく、より強力な装備を身につけることで強くなり、その熟練度が高いほど本来の力が発揮されます。熟練度は敵にダメージを与えたり、敵からダメージを受けたりすることで高くなります。戦闘は、フィールドでは上から見下ろす視点のトップビュータイプ、ダンジョンの奥では横視点のサイドビュータイプとなっており、場所によって異なった戦略が必要となります。壮大なストーリーと美しいイベントシーンが人気を博しました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">風の伝説ザナドゥ</span></div>
</div>
