...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La chaîne Internet vous propose une nouvelle manière de naviguer sur le web: installez-vous dans votre canapé avec votre télécommande Wii.
<br><br>
Consultez vos e-mails, cherchez les derniers jeux Wii ou actualisez vos sites de réseaux sociaux avec votre Wii!*
<br><br>
La chaîne Internet est désormais compatible avec Adobe Flash Lite 3.1, ce qui va vous permettre de visualiser bien plus de vidéos qu’avant.**
<br><br>
<b>* que Nintendo ne peut aucunement être tenu responsable de toute perte ou tout dommage résultant de votre utilisation de la chaîne Internet, ou bien de votre incapacité à vous connecter. </b>
<br><br>** que certains contenus Flash peuvent ne pas être compatibles.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414450/FFFD0021" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414450/FFFD0022" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chaîne Internet</span></div>
</div>
