...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit kanaal is bedoeld voor spelers van The Legend of Zelda: Skyward Sword.
<br><br>
Dit kanaal repareert opgeslagen spelgegevens die de voortgang kunnen belemmeren in de ‘Song of the Hero’-quest wanneer de ‘Thunder Dragon's Song’ uit het woestijngebied als eerste wordt bemachtigd. De overige onderdelen van de quest in de vulkaan- en bosgebieden kunnen dan niet naar behoren worden uitgevoerd. Als je The Legend of Zelda: Skyward Sword niet hebt gespeeld, hoef je dit kanaal niet te gebruiken.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435250/FFFD0011" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
