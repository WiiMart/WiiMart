...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">주인공 커비를 움직여 적을 쓰러뜨리거나 피하며 스테이지 클리어를 노리는 액션 게임입니다. 별의 커비 시리즈에서 처음으로 3D로 등장한 이번 작품은 편리한 조작성을 그대로 살리면서 다채롭고 색다른 세계가 펼쳐집니다. 빨아들이기, 뱉기, 카피하기와 같은 간단한 조작과 더불어 2가지의 카피 능력을 섞을 수 있는 카피 믹스 시스템이 새롭게 등장했습니다. 7가지의 기본 능력에 28가지의 믹스 능력을 더한 총 35가지의 카피 능력을 상황에 맞게 활용하며 7개의 스테이지를 클리어하십시오.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414D54/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414D54/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">별의 커비<sup>TM</sup> 64</span></div>
</div>
