...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157444F50')", "wiiSelectSound()");
...
<br>
<br>
Play using any combination of Wii Remotes, Nunchuk accessories and Classic Controllers.
<br>
<br>
