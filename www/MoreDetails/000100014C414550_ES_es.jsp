...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Métete en la piel de Alex Kidd en este juego de plataformas y busca a Egle, tu hermano perdido. Para encontrarle tendrás que luchar contra el malvado Janken the Great, que enviará monstruos y secuaces para detener tu avance. En esta aventura podrás jugar a "piedra, papel o tijera" contra los aliados de Janken para derrotarlos. Los 16 niveles que tendrás que superar para rescatar a Egle hacen de este clásico el desafío perfecto para tu habilidad e intelecto.
<br><br>
Nota: 
Esta versión de Alex Kidd in Miracle World es como la versión arcade de 1986. Las modificaciones incluidas en la versión de SEGA MASTER SYSTEM no aparecen en esta versión.
<br><br>
