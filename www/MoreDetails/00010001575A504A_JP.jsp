...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001575A504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">お伽噺の世界が舞台のアクションシューティングゲームです。お馴染みのキャラクターを操作して、襲い掛かるゾンビを排除します。昔懐かしくも新しい「ゾンビ　イン　ワンダーランド」のハジマリはじまり！！</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A504A/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A504A/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゾンビ　イン　ワンダーランド</span></div>
</div>
