...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Bienvenido a «FISHIE FISHIE», el único juego que se juega con un solo botón!<br>
Vivirás una experiencia extraordinaria que someterá tus reflejos a una dura prueba.<br>
El juego incluye una serie de tutoriales que te enseñarán no solo cómo guiar a tu pez sino también cuáles son las reglas de los diferentes modos de juego.<br>
Con «FISHIE FISHIE», jugarás a ser un pez que debe alimentarse continuamente. Además, tendrás que dominar varios modos de juego en el menor tiempo posible. Cada segundo cuenta.<br>
Para ganar, deberás superar unos cien niveles distribuidos en 7 modos de juego: «histórico», «fútbol», «captura de la estrella», «supervivencia», «recorrido con obstáculos» y una gran carrera.<br>
Podrás jugar solo o formar parte de un grupo de 4 jugadores que compiten en la misma pantalla. En equipo o cada quien por su lado, todo vale para ganar.
<br><br>
