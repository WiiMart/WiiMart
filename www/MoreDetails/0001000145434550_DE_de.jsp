...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das 1999 veröffentlichte Arcade-Spiel „The Last Blade 2” ist die Fortsetzung von „The Last Blade”, das im Vorjahr veröffentlicht wurde. Es knüpft am Ende des vorherigen Spiels an und bringt die Kämpfe an den Pforten der Hölle auf den Höhepunkt.<br>
Dieses Mal kannst du aus 16 einzigartigen Kämpfern und aus zwei verschiedenen Schwerttypen (Stärke und Attacke) wählen. Mit dem defensiven Blocksystem kannst du gegnerische Schwertstreiche blocken, und wie im vorherigen Spiel kannst du mit "Sublime Slash" spielverändernde Spezialattacken wie "Super Slice" oder "Hidden Secret Slice" aufheben und mit "Super Secret Slice" kombinieren. Außerdem gibt es neue Features mit denen du Attacken aus der Luft blocken und abwehren kannst, und die dir erlauben nach einem Knockdown weiterzukämpfen. Bring deine Kämpfe auf ein neues Level!<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
