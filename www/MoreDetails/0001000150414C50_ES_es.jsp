...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Un shooter totalmente nuevo al estilo de Star Soldier!<fr>
Pilota el caza de asalto Soldier Blade de la SIA (Special Interception Airforce). Enfréntate a los invasores de Zeograd y potencia tus armas recogiendo diversos objetos de mejora. Podrás lanzar 3 tipos de ataques distintos dependiendo del color del objeto que cojas.<fr>
Novedades, como la opción “Gunbody” para evitar ataques y el sistema “Burst Out” con distintos efectos dependiendo del nivel de mejora, añaden un toque estratégico que te obligará a decidir rápidamente qué objeto coger y cuándo usar los ataques especiales.<fr>
¡Te esperan increíbles batallas contra poderosos enemigos al final de cada operación!<fr>
Juega el desafío (CHALLENGE) e intenta conseguir tantos puntos como puedas en el menor tiempo posible.
Con todas estas grandes novedades, ¡las cosas se pondrán al rojo vivo!
