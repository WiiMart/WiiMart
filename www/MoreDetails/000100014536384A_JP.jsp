...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機（ファイター）を操り、次々に現れる敵機（ギャラガ）をビームで撃墜し、画面上の敵を一掃して次の面へチャレンジする、固定画面型のＳＦシューティングゲームです。敵機の捕虜となった自機を救い出すことで２機合体のデュアルファイターになるといったパワーアップシステムをうまく活用してステージを攻略してください。攻撃中のギャラガや、編隊を組んだボスを倒すとスコアが上がり、すべてのギャラガを倒すとステージクリアです。また、数面ごとにボーナスステージの「チャレンジングステージ」が登場し、より多くの得点を稼ぐことができます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536384A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536384A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ギャラガ<sup>&reg;</sup></span></div>
</div>
