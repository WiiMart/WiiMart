...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157535A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sneezies is an overload of cuteness!
<br><br>
...
<br><br>
Play through 45 relaxing levels of Sneezies in the Classic Mode, or unleash your skills in the 15 Challenge Mode levels.</div>
  <div id="image02">
