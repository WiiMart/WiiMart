...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Play the popular Sonic The Hedgehog sequel, made specifically for the Sega Master System. Sonic returns home to his island just in time to see Dr. Eggman (aka Dr. Robotnik) run off with Tails. In fact, Dr. Eggman has kidnapped all of Sonic’s animal friends and placed them in robotic mind-controlling suits. He demands the six Chaos Emeralds, hidden on the island, in exchange for their safe return. Explore underground mine shafts, dash through underwater tunnels, and hang glide through the clouds in Sonic’s search for the Chaos Emeralds. Once Sonic’s found them all, he must face off with Dr. Eggman and thwart the evil scientist's plan for global domination!</div>
  <div id="image02">
