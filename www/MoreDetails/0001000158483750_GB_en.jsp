...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158483750')", "wiiSelectSound()");
...
<br><br>
LIT is a horror puzzle game that requires the Wii Remote and Nunchuk attachment. It contains 30 levels, 5 boss battles, replay modes, and several unlockables including multiple endings, Dark Mode timed challenges, and an unlockable character.</div>
  <div id="image02">
