...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le dixième opus de la légendaire saga Castlevania retrace la lutte épique du clan Belmont contre les forces obscures du seigneur des vampires, le tout-puissant Dracula! Ce classique est considéré par tous les fans comme l’un des meilleurs de la série, autant pour ses graphismes et sa jouabilité inégalée que pour ses différents thèmes musicaux inoubliables.
<br><br>
Incarnez Richter, chasseur de vampires et héritier de la famille Belmont. Traversez 13 niveaux remplis de pièges mortels et de mystérieux secrets gardés par des ennemis maléfiques.
Utilisez votre fouet légendaire, transmis de génération en génération aux descendants du clan Belmont, ainsi que de redoutables attaques pour détruire Dracula et ses hordes de créatures malfaisantes.
<br><br>
Sauvez Maria durant le jeu pour l’utiliser en tant que personnage jouable! Le massacre de vampires n’a jamais été aussi fun!
<br><br>
Le texte à l'écran est en anglais, et contient du japonais.</div>
  <div id="image02">
