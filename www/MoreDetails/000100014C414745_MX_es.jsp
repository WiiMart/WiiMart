...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Basado en la versión de Sonic para SEGA GENESIS, Sonic The Hedgehog fue recreado como el primer juego de Sonic para SEGA MASTER SYSTEM. Esta versión está muy lejos de ser una simple adaptación. Incluye nuevos escenarios, enemigos, algunas zonas diferentes y un mapa de niveles. La diferencia más notable fue que las Chaos Emeralds se tenían que recoger dentro de ciertos escenarios en lugar de los escenarios especiales. ¡Recorre las seis zonas, incluyendo zonas especiales exclusivas en la versión para SEGA MASTER SYSTEM, y enfréntate al Dr. Eggman (también conocido como Dr. Robotnik) al final de cada una!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
