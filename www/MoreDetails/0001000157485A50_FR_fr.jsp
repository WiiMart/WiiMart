...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157485A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La planète Zethos est tombée sous le contrôle militaire de Thau-Phi, une intelligence artificielle devenue incontrôlable. Sa domination est absolue et s'étend à tous les systèmes automatisés de la planète, y compris les légions de robots travailleurs désormais réunis en une armée impénétrable de machines de combats prêtes à se sacrifier.
<br><br> 
Les seuls capables de libérer la planète tout en évitant à la Confédération d'essuyer de lourdes pertes sont l'équipage de la DST Horizon, un groupe de mercenaires d'élite mettant leur expertise du combat au service du plus offrant.
<br><br>
Horizon Riders vous permet de contrôler l'un des quatre membres de la brigade dans leur mission pour vaincre Thau-Phi. Déplacez-vous à grande vitesse à travers la surface de Zethos sur un surf puissant et détruisez la cyber armée avec un arsenal d’armes futuristes !
