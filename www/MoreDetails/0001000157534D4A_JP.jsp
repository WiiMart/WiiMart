...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157534D4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「元祖」相撲ゲームとして一世を風靡した「つっぱり大相撲」が２２年の時を超えてWiiウェアに登場。<BR>基本はWiiリモコン横持ちの簡単操作。Wiiリモコンを上下左右に傾けることで華麗な投げや吊り技を体感的に繰り出せます。<BR>「ひとりでつっぱり」モードでは“ちゃんこ”や“けいこ”のミニゲームを繰り返すことで力士の能力や体型までも変化。似顔絵チャンネルで作成したMiiの顔を使った力士を作成することもできます。<BR>おなじみのコミカル技やプロレス技もさらにパワーアップ。世界で展開される本場所を豪快に戦いぬいて、横綱を目指しましょう。<BR>あなたの育てたオリジナル力士や強敵「手雲山」などのＣＯＭ力士を使用して２人対戦も楽しめます。<BR>さあ、あなたも「つっぱり大相撲Wii部屋」に入門しましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534D4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">つっぱり大相撲</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Wii部屋</span></div>
  </div>
