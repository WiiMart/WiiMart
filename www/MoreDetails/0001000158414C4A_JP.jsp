...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">海兵隊所属の２人の「魂斗羅」ビル・ライザー上等兵とランス・ビーン上等兵となり、さまざまな銃器を駆使して戦う、アクションシューティングゲームです。西暦２６３１年、ニュージーランド沖ガルガ諸島に謎の隕石が墜落。その２年後、人類滅亡をたくらむ「レッド・ファルコン」と名乗る謎の侵略者にガルガ諸島が占拠され前線基地となっていることが、地球海兵隊指令部の極秘の調査で判明します。プレイヤーはビルまたはランスを操作して、敵基地の内部に侵入し、すべての前線基地とその中枢の破壊をめざします。アーケード版の移植ながら、家庭用向けに大幅にアレンジが加わっています。特徴的な３Ｄ画面も再現されています。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000158414C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158414C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">魂斗羅</span></div>
</div>
