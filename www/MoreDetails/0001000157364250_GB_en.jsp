...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157364250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Evil aliens called Cannoids have seized control of Earth’s empty cans, and are using them to destroy the planet! As Mack, Plant 530’s top technician, only you can save the world from an ecological emergency with the help of your trusty recycling cannon!
<br><br>
...
<br><br>
Simple Wii Remote controls (including the option to use the Wii Zapper) allow anyone to play the role of Eco Shooter, while advanced players will enjoy racking up huge scores using the combo system, linking consecutive hits for more points. Put all your skills to the test to preserve the planet once and for all in the unforgiving Challenge Mode.
<br><br>
Do you have what it takes to put a dent in the Cannoids’ plans?</div>
  <div id="image02">
