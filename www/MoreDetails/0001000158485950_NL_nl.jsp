...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158485950')", "wiiSelectSound()");
...
<br><br>
BIT.TRIP FATE is een zijwaartsscrollende shoot-em-up op rails, waarin CommanderVideo over de Vibe rijdt om zijn lot te ontdekken.
<br><br>
CommanderVideo heeft de hulp nodig van de vrienden die hij maakte in BIT.TRIP RUNNER om de Mingrawn Timbletot, die de wereld gemuteerd heeft in een lelijke technologische nachtmerrie, te dwarsbomen. 
<br><br>
Bundel je krachten met Junior Melchkin, CommandgirlVideo en andere om CommanderVideo's macht te versterken en de wereld te redden.
<br><br>
Of je nou alleen of samen met een copiloot speelt, je hebt een vaste hand nodig om over de Vibe te navigeren en je wapens op de zieke zielen te richten die je willen vernietigen.
<br><br>
