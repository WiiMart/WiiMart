...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９０年にリリースされたボウリングゲームで、スコア、フラッシュ、ストライク９０という３種類のボウリングを楽しめます。キャラクターの立ち位置を決めて、ゲージの動きに合わせてタイミングよくボタンを押すだけ、という簡単操作ですが、一方でプレイキャラクターの利き腕やボールの重さを選べたり、ストレート、フック、スライスといった微妙なコントロールが行えたりと、ボウリングならではの面白さがしっかりと盛り込まれています。またスペアやストライクなどの獲得時や、投球前のキャラクターのユニークな動きなど、ゲームを盛り上げる演出も必見。さらに４人までのマルチプレイに対応しています。
<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">リーグボウリング</span></div>
</div>
