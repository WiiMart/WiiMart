...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気格闘ゲーム『餓狼伝説』シリーズの第四弾です。本作では画面の奥に移動できる２ラインバトルから３ラインに拡張しつつも、画面の奥や手前に移動した際には一定時間で自動的にメインラインに戻ってくる
スウェーラインとしてリニューアルが施されました。さらにボタンをテンポ良く押すことで簡単に連続技を発動できるコンビネーションアーツ、前作でも人気の超必殺技やそれを凌駕する潜在能力のほか、キャラクターの必殺技のマイナーチェンジなども盛り込み、今まで以上に軽快で奥深い駆け引きが楽しめます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">餓狼伝説３　～遥かなる闘い～</span></div>
</div>
