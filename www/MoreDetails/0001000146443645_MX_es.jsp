...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lolo y Lala han regresado en esta nueva versión del popular juego de rompecabezas The Adventures of Lolo. A su regreso del Haunted Castle (Castillo Embrujado), el Great Devil secuestra a Lala y reta a Lolo a rescatarla de nuevo. Ahora él debe asumir el reto del Great Devil en la Torre y los laberintos del Castillo. Afortunadamente, Lala pudo analizar cada uno de los laberintos mientras era llevada a la torre y dejó pistas en las Jewel Boxes (Cajas de Joya) de cada cuarto. Cada Joya que Lolo consigue contiene información que le ayudará en el siguiente cuarto. Para ganar, él también tendrá que empujar losas, recoger Heart Framers (Enmarcadores de Corazones), convertir temporalmente a los enemigos en Eggs (Huevos) con sus Magic Shots (Disparos Mágicos), y evitar ataques enemigos moviendo Emerald Framers (Enmarcadores de Esmeraldas). Con tu ayuda, ¡Lolo y Lala trabajarán juntos para escapar de las garras del Great Devil y derrotarlo!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146443645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146443645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ADVENTURES OF LOLO 2</span></div>
</div>
