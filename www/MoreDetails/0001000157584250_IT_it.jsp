...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157584250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ben 10: Alien Force - The Rise of Hex segue le avventure di Ben Tennyson, che si ritrova coinvolto nel piano malvagio di Hex per controllare il pianeta Terra. Sfruttando i poteri dell' Omnitrix, i giocatori possono trasformare Ben in dieci alieni differenti compresi Big Chill, Spider Monkey e, per la prima volta in assoluto, Lodestar, mentre combatte Hex e i suoi sgherri.
<br><br>
Scegli tra 10 tipi diversi di alieni per arrivare fino al 15° livello, risolvendo rompicapi e enigmi lungo tutto il percorso. <br><br>
  
Affronta nemici spietati e temibili boss di fine livello nell'ultimissima avventura di Ben!

<br><br>
Sperimenta il mondo di Ben 10: Alien Force con personaggi in 3D in una vivace ambientazione 2D.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157584250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157584250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ben 10: Alien Force</span></div>
</div>
