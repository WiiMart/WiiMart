...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157503450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Willkommen in der Welt der Pooyoos, dem ersten lustig-poetischen Gehirntrainer für Kinder von 3 bis 6 Jahren.
<br><br>
Mit den Pooyoos, einer fröhlichen Rasselbande niedlicher Babytiere, werden Ihrem Kind Grundlagen für seine Entwicklung vermittelt: Zahlen, Buchstaben, Lateralisation, Formen, Farben und mehr. Die Kinder tanzen mit ihren neuen Freunden und können so großartige, interaktive Belohnungen bekommen. In den zwei interaktiven Levels können Ihre Kinder – unabhängig von Alter und Wissensstand – innerhalb der Themen Magie und Farben spielerisch tätig werden.
<br><br>
Dieses Spiel wurde für Kinder entwickelt, die noch nicht lesen können. <br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157503450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Lernen mit den PooYoos</span></div>
</div>
