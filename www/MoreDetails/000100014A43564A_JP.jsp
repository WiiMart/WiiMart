...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スカイスポーツスクール「フライトクラブ」受講生となり、スーパーファミコンの機能を存分にいかしてさまざまなスカイスポーツを体験することができる、スカイスポーツシミュレーションゲームです。ターゲットへの着地の正確さを競う「ＳＫＹＤＩＶＩＮＧ」や「ＲＯＣＫＥＴＢＥＬＴ」のほか、「ＬＩＧＨＴＰＬＡＮＥ」など乗り物に乗り込んでおこなう種目も楽しめます。初めは比較的操作のしやすい「ＬＩＧＨＴＰＬＡＮＥ」と「ＳＫＹＤＩＶＩＮＧ」のみ選べますが、フライトテストにクリアしていくことでさまざまな種目に挑戦できるようになります。合格点をクリアしてライセンス取得をめざしてください。きびしい訓練を乗り越えゴールドライセンスを手にできるとエキスパートコースが用意され、より上級者向けのエリアでプレイすることもできます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パイロットウイングス<sup>TM</sup></span></div>
</div>
