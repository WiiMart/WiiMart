...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マイカー（自車）を操作して、ラウンド上にあるフラッグを集めるアクションゲームです。すべてのフラッグを集めると次のラウンドに進みます。迷路状のラウンドには複数のレッドカー（敵車）が走っていてマイカーを追いかけてきますが、マイカーには攻撃手段がないので逃げることしかできません。レッドカーやあちこちに配置された岩に当たらないよう、レーダーで位置を把握し、ＦＵＥＬ（燃料）の残りに気をつけてフラッグを集めてください。時にはボタンで煙幕を発生させてレッドカーをスピンさせ、うまくかわしましょう。ただしＦＵＥＬは時間の経過のほか、煙幕の使用でも大きく減少してしまいます。燃料切れになるとスピードがかなり落ち、レッドカーに追いつかれてしまうため要注意です。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ニューラリーX<sup>&reg;</sup></span></div>
</div>
