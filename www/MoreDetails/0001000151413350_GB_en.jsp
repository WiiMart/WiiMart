...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">An entire planet becomes your laboratory in this large-scale simulation game! Help foster new life and promote its evolution into life forms of higher intelligence. Guide civilization along the path of evolution until it can achieve “Exodus”, the ultimate goal of settling on another planet! 
<br><br>
The main challenge of the game is to adjust atmospheric and geological parameters and maintain a comfortable environment for the life forms native to your planet. Small organisms called Prokaryote and Trichordate will grow and evolve into a multitude of life forms. Making a drastic change is a recipe for disaster. The key to success is to make small, careful adjustments and watch how the life forms react.
<br><br>
For an extra challenge, SimEarth also includes planets with environments different from Earth such as Mars and Venus. Try your hand at terraforming these planets with harsh conditions into a world where life can thrive!</div>
  <div id="image02">
