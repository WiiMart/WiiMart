...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157544D45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ADVENTURE ISLAND: The Beginning comes to the Wii console with exciting new skills and elements! Learn how to use new skills while exploring Adventure Island from coast to coast. Search for Golden Melons hidden throughout the stages and minigames. When obtaining Golden Melons, you'll be able to purchase various items to help you on your adventure. Items purchased will increase your attack power or enable you to reach places you couldn't get to before. Fulfill certain requirements while playing in any of the modes to achieve a Master Higgins Feat. You will be awarded a Master Higgins costume for doing so.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544D45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544D45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ADVENTURE ISLAND<sup>&reg;</sup></span></div>
</div>
