...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Andross hat eine Attacke auf das Lylat-System gestartet, und nur Fox McCloud und das Star Fox-Team stellen sich ihm entgegen. Steige in deinen Arwing-Fighter, den Landmaster oder dein Blue Marine-U-Boot, und pulverisiere die gegnerischen Streitkräfte von Andross.
<br><br>
Schlage dich durch 15 verschiedene Level und kämpfe in der Luft, im All, auf der Erde und unter dem Meer. Meistere actiongeladene Missionen
in der linearen oder offenen Formation - in letzterer kannst du den vollen Bewegungsradius
von 360 Grad ausnutzen. Bewege dich dabei frei durch das Gelände und schüttle Gegner mit gewagten Wendemanövern ab. Entdecke alternative Routen, die sich dir je nach deiner Spielweise öffnen.
<br><br>
Lylat Wars enthält auch einen VS-Modus für bis zu vier Spieler, die in drei spannenden Spielvarianten gegeneinander antreten können: Match, Battle Royal und Zeitmatch.
<br><br>Keine Unterstützung der Rumble-Funktion des Originals.</div>
  <div id="image02">
