...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Es tiempo de reclamar tu merecido lugar como campeón de la arena Gravitronix, ¡pero prepárate para hacerle frente a 7 otros jugadores que quieren el mismo título! Vence a tus oponentes con cuatro proyectiles diferentes y los poderosos rayos de tu plataforma de gravedad. Intercepta ataques y apunta cuidadosamente hacia puntos vulnerables. Desvía proyectiles entrantes o captúralos y cárgalos con energía para lograr ataques explosivos devastadores. Juega con un amigo en el mismo equipo y lucha en modo de campaña o con hasta ocho jugadores en una sola Wii en modo versus en una batalla todos contra todos. Personalice cada partida con diferentes opciones como inundar la arena con proyectiles o hacer el juego alocadamente rápido. Más allá de cómo te guste jugar, ¡llama a tus amigos y diviértete con Gravitronix!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424F45/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424F45/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Gravitronix</span></div>
</div>
