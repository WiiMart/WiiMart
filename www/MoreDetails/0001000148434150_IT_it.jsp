...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il Canale Jam with the Band Live ti permette di suonare con gli amici su una console Wii, usando la tua TV come speaker!
<br><br>
Scarica e avvia questo canale, poi seleziona "Come collegarsi" per dettagli su come impostare una sessione musicale Band Wii.
<br><br>
Suona i tuoi brani preferiti da solo o in compagnia! Puoi anche cantare, ma nota che la tua voce non potrà essere sentita tramite la TV.
<br><br>
Ogni giocatore deve avere una console Nintendo DS, anche se è necessaria una sola scheda di gioco Jam with the Band. I giocatori senza scheda di gioco possono collegarsi usando la modalità download DS.
<br><br>
Testo a schermo in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434150/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434150/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canale Jam with the Band<sup>TM</sup> Live</span></div>
</div>
