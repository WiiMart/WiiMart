...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157444E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">【ディシプリン＊帝国の誕生】は、犯罪者収容施設“ディシプリン”を舞台に、その模擬運用試験を描いたアドベンチャーゲーム作品です。プレイヤーは自ら参加を志願したyou。言葉を話す謎のコントローラー“youコン”を携え、収容者として監視されながらの生活を送ります。収容者達との交流を通して、youは次第に“ディシプリン”の秘密に迫っていきます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444E4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444E4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ディシプリン＊帝国の誕生</span></div>
</div>
