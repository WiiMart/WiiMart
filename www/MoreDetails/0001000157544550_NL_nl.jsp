...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157544550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tales of Elastic Boy laat je kennis maken met een unieke en vernieuwende manier van spelen, die optimaal gebruik maakt van de mogelijkheden van de Wii-afstandsbediening. Om je speurtocht te voltooien en je planeet te redden moet je niet alleen door allerlei landen reizen en vijanden verslaan, maar ook ontmoet je vrienden en moet je pittige puzzels oplossen.
<br><br>
Gebruik je uitrekbare armen om te zwaaien en te slaan, zo snel mogelijk te rollen en bovenop je vijanden te springen. Tales of Elastic Boy biedt een totaal originele en verslavende spelervaring. Hoe je het spel moet spelen heb je zo onder de knie, maar een echte meester erin worden is een fikse uitdaging. Tales of Elastic Boy is een spel voor iedereen, of je nu fan bent van klassieke platformspellen of dat je geïnteresseerd bent in vernieuwende concepten. Speel het spel solo of daag je vriend(inn)en uit in 5 verschillende, verbazingwekkende speltypes.
<br><br>
Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544550/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Tales of Elastic Boy</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Mission 1</span></div>
  </div>
