...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paru en 1996, ce jeu de combat est le quatrième volet de la série Samurai Shodown. Bien que repris de Samurai Shodown III, le système de rage et les combos ont été améliorés pour un maximum d'impact. Comme nouveauté notable, cet épisode introduit un temps limite avec deux variantes de fin. Pour voir la bonne fin, vous devrez gagner une course contre-la-montre.
Deux nouveaux personnages, Kazuki et Sôgetsu Kazama, font leur apparition et s'ajoutent à un répertoire plus grand que jamais. En tout, ce ne sont pas moins de 17 combattants qui croisent le fer !<br><br>Texte écran en anglais.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
