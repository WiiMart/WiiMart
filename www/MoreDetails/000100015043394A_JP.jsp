...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パタパタと羽ばたく姿が可愛らしいキウィの「ティキ」が主人公のアクションゲームです。プレイヤーは「ティキ」を操作し、さまざまな武器や乗り物を駆使して、ハンター「ヒョウアザラシ」にさらわれたガールフレンド「ピューピュー」や仲間たちの救出をめざします。ステージにはトゲが密集しているエリアや、水に潜るエリアなど危険がいっぱい。
行く手を阻む敵を「弓矢」などで攻撃しながら、敵の攻撃やトゲに触れないようにステージを進み、カゴにとらわれている仲間を探します。またステージ中に登場する「風船」は、さまざまなタイプが存在し、ジャンプでは届かない高い場所へ昇ることができる、攻略に欠かせない乗り物です。割れてしまわないように注意して操作し、
ティキを仲間のところへ導いてください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE NEWZEALAND STORY<sup>&reg;</sup></span></div>
</div>
