...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In diesem Plattformspiel aus den Achtzigern suchst du als Alex Kidd nach deinem verschollenen Bruder Egle. Um ihn zu finden, musst du die Monster und Schergen besiegen, die der böse Janken the Great auf dich hetzt. Besiege sie in einem klassischen Spiel: „Schere, Stein, Papier“. Du musst 16 Level meistern, um Egle zu retten! In diesem Klassiker sind Geschick und Köpfchen gefragt!
<br><br>
Hinweis: 
Alex Kidd in Miracle World wird wie in der ursprünglichen Ausgabe von 1986 präsentiert. Änderungen, die in der eingebauten SEGA-MASTER-SYSTEM-Version enthalten sind, erscheinen nicht in dieser Ausgabe.
<br><br>
