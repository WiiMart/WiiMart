...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Elige un personaje de entre todo un elenco de estrellas de Nintendo en este combate frenético que definirá quién es el luchador definitivo. Utiliza una serie de controles fáciles de aprender pero difíciles de dominar y lucha en el modo de un jugador (single-player mode) para conseguir puntos de bonificación y desbloquear personajes escondidos. Entra en el modo VS (VS mode) para enfrentarte simultáneamente contra otros tres jugadores como máximo. Causa daño a tus rivales usando los ataques especiales de cada personaje o aprovéchate de los objetos o habilidades para vencerlos sacándolos de la pantalla de juego que siempre tiene un tema relacionado con Nintendo. ¿Necesitas tomarte un descanso? Pule tus habilidades en el modo entrenamiento (Training Mode) o elimina los objetivos  en las fases de bonificación especiales para cada personaje. ¿Estás listo para probar tu temple contra los diferentes adversarios incluido el poderoso enemigo final Master Hand?</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414C45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414C45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
