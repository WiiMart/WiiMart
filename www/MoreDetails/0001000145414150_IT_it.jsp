...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo fantastico picchiaduro a incontri è del 1991. Il giocatore può scegliere il proprio personaggio fra i tre combattenti a disposizione: Terry Bogard, Andy Bogard e Joe Higashi.
<br><br>
Nei panni del personaggio scelto, il giocatore dovrà sconfiggere numerosi avversari per le strade di Southtown, nel tentativo di arrivare ad affrontare il cattivo più forte di tutti, Geese Howard.
<br><br>
Tra le caratteristiche di gioco spiccano le potenti mosse speciali di ogni personaggio. Inoltre, lo schermo di gioco presenta due piani differenti e i combattenti possono passare dall'uno all'altro per schivare gli attacchi dell'avversario.
La modalità a due consente ai giocatori sia di combattere l'uno contro l'altro che di cooperare contro i personaggi controllati dalla CPU. Questa funzionalità è ormai famosa poiché sfrutta un sistema unico nel settore dei picchiaduro.
<br><br>
Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414150/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414150/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FATAL FURY</span></div>
</div>
