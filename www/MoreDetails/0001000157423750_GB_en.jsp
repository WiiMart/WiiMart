...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157423750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Take a trip across America to make your dreams come true in a pool tournament worth millions. 
<br>
Visit the most colourful bars and meet seven of the coolest players on the circuit: from country music star Travis to Alison the biologist and John the sheriff. <br>Learn the tricks of the trade through tutorials along the way, while advanced players can take on challenges to show off their trick-shot abilities.<br> Keep things interesting with three sets of rules.</div>
  <div id="image02">
