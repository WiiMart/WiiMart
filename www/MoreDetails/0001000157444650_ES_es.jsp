...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Prepárate para defender tu castillo ante el implacable ejército de los crayones invasores!
<br><br>
Para evitar que los invasores destruyan tu precioso castillo, apunta el mando de Wii hacia las tropas enemigas y presiona y mantén presionado el Botón A (o el Botón B) para levantarlos. Con el enemigo en la mano, ya puedes lanzarlos por los aires alzando rápidamente el mando de Wii y soltando el botón.
<br><br>
Algunos enemigos son demasiado pesados como para levantarlos, por lo que hay que usar una táctica diferente para derrotarlos.
<br><br>
En Defend Your Castle pueden jugar de 1 a 4 jugadores en una mezcla de juego cooperativo y competitivo. Los jugadores pueden entrar o salir de una partida en progreso rápida y fácilmente. Simplemente activa un mando de Wii adicional y comienza a jugar. El juego adaptará automáticamente el nivel de dificultad apropiado para cada jugador.
<br><br>
