...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ábrete paso a través de interminables cuevas por explorar en busca de la legendaria pirámide subterránea y sus abundantes tesoros. 
<br><br>
Para completar tu aventura, tendrás que saltar de soga en soga, subir y bajar escaleras, atravesar terrenos inestables y barrancos a la carrera, utilizar elevadores, carros de minas y barcos. A medida que avances por estos peligrosos lares irás recogiendo llaves, bombas, bengalas, tesoros, sacos con dinero y otros objetos de valor. 
<br><br>
Ten cuidado con las columnas de vapor, los murciélagos venenosos y los vengativos fantasmas de los spelunker que acechan en cada esquina de este descomunal laberinto subterráneo.
<br><br>
