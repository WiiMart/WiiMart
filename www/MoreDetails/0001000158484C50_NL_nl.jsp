...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158484C50')", "wiiSelectSound()");
...
<br><br>
Dit is een demoversie. Mogelijk bevat deze versie niet alle functies uit de volledige versie.<br>
In deze demoversie van het spel kun je je voortgang niet opslaan.
<br><br>
Spring, ren en vlieg!
<br><br>
Verken samen met Jett Rocket de prachtige planeet Yoroppa en ontdek waarom het door de kwaadaardige 'Power Plant Posse' werd aangevallen. Bezoek tropische eilanden, giftige moerassen en ijskoude gletsjers. Scheur het water op met je jetboat, spring met je parachute van enorme rotsen, race met je snowboard door ijskoude gebieden en schiet de lucht in met je jetturbine. Je zult alles op alles moeten zetten om terug te vechten en Yoroppa te redden!
<br><br>
Wees gewoon Jett Rocket in dit epische en futuristische 3D-actieavontuur!<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484C50/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484C50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Jett Rocket</span></div>
</div>
