...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158484345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is a demo version. It is possible that it does not support every feature of the full version.
<p>
Step into the royal shoes of the Darklord's daughter as she installs traps and monsters inside her tower to fight back the endless waves of invading adventurers in this world-conquest RPG. Placing the floors inside your demonic tower with monsters and traps, called Artifacts, is your only hope to keep the adventurers from destroying the Dark Crystal on the top floor. Fly your tower across the land and conquer every stage on your way to dominating the entire world!
<p>
Please note that you cannot save the progress of your game in the demo version.
<p>
After you play the demo, you will be taken to the Wii Shop Channel. This may take a few minutes.</div>
  <div id="image02">
