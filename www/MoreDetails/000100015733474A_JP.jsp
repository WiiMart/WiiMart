...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015733474A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大ヒットシリーズ『逆転裁判』シリーズの第３弾。珈琲の似合う謎の男、ゴドー検事との法廷バトルを中心に、ドキドキハラハラの傑作ミステリーをお届けします。人気キャラクター・御剣怜侍ももちろん登場！Wiiリモコンを突きつけて「異議あり！」と叫べば、あなたはもうこの物語の主役です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015733474A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015733474A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">逆転裁判<sup>&reg;</sup> 3</span></div>
</div>
