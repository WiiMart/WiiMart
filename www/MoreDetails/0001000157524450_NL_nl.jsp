...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157524450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Je zult een scherp oog moeten hebben en snel van geest moeten zijn om deze Word Searcher puzzels met 100 thema's te voltooien. Word Searcher bevat leuke woorden uit verschillende categorieën inclusief anatomie, wereldsteden en Amerikaanse presidenten. Het spel heeft een groot aantal onderwerpen waaruit je kunt kiezen zodat er altijd wel een puzzel is waarmee jij je zult vermaken. Verder zullen deze verslavende puzzels ook helpen bij het verbeteren van jouw woordenschat, geheugen en vaardigheden voor probleemoplossing. Houd je eigen scores bij en probeer deze te verbeteren door keer op keer te spelen aangezien woorden elke keer weer in een andere volgorde gezet worden. Gebruik jouw puzzelvaardigheden en versla alle 100 puzzels vandaag!
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524450/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524450/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Word Searcher</span></div>
</div>
