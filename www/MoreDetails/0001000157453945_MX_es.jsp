...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157453945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Alien Crush Returns es la encarnación definitiva del popular clásico de los juegos de pinball de Turbografx, Alien Crush. Luciendo innovadoras características en el juego y el control, ¡esta es una experiencia que no querrás perderte en tu consola Wii! Con toda la simplicidad de una bola rodando y la emoción de las aletas moviéndose de un juego de pinball estándar, Alien Crush Returns tiene todos los elementos visuales y digitales que podrías esperar en un videojuego incluyendo grotescos e impactantes campos de juego además de trucos únicos con las Action Balls que redefinen la diversión y la emoción del pinball. Incluso puedes golpear la máquina con tu mando de Wii. Además, puedes conectarte a través de la Conexión Wi-Fi de Nintendo para disfrutar de una gran variedad de funciones tales como acción para cuatro jugadores, competiciones para conseguir la puntuación más alta y descargar niveles extra.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157453945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157453945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ALIEN CRUSH RETURNS<sup>TM</sup></span></div>
</div>
