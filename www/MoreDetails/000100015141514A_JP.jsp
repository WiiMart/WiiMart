...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「イセルハーサ」と呼ばれる架空の世界を舞台に繰り広げられるファンタジックＲＰＧ。幼いころに父王を殺害された「ファーレーン王国」の「セリオス王子」が、仲間とともに王位をめぐる闘いに身を投じていきます。シナリオは全部で６章。プレイヤーはセリオスを操作して２Ｄフィールドを探索し、その中で遭遇するイベントやコマンド選択式の戦闘によってキャラクターを成長させていきます。レベルアップ時には「ボーナスポイント」を振り分け、それぞれのステータスを調整可能。攻撃回数やクリティカル率など、各キャラクターの個性を考えながら、自分なりのパーティーをつくり上げることができます。さらに、戦闘時にコンピュータに操作をまかせる「オートバトル」機能も搭載。攻撃はもちろん、回復やアイテムの使用など簡単な設定を行うだけで、ボリュームたっぷりの冒険も快適にプレイを進められます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141514A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドラゴンスレイヤー<sup>&reg;</sup> 英雄伝説</span></div>
</div>
