...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157494745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Be prepared to yell “Incoming!” while furiously avoiding flying cannonballs and missiles.<p>
The goal of Incoming! is to defeat your opponent by destroying their tanks using the arsenal you have at your disposal. Advanced arsenal becomes available at different levels of the game.<p>
Incoming! is great fun for two people to play competitively.
Can you defeat your opponent tanks before they conquer yours?  Collect power-ups to give your arsenal that tactical advantage.  Your firing must be quick and your aim true to claim victory.</div>
  <div id="image02">
