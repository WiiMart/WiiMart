...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001584A4750')", "wiiSelectSound()");
...
<br><br>
Willkommen in der Welt von Gnomz. Gnomz ist ein neues, aufregendes Kampfspiel für WiiWare™. In Gnomz können bis zu vier Spieler in drei verschiedenen Spielmodi gegeneinander und/oder gegen die KI antreten.<br><br>
Features: <br><br>
