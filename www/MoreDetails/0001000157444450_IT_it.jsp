...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157444450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Diner Dash, il gioco gestionale numero uno per PC, arriva finalmente su WiiWare! Guida Flo, un'ex impiegata che si è dedicata alla ristorazione, a costruire un impero gastronomico in quattro tavole calde uniche! Affronta altri giocatori in competizioni testa a testa online, dove la tua squadra si confronta con altri sei giocatori per scoprire chi è il migliore!
<br><br> 
I giocatori diventano Flo che corre per fare sedere i clienti, prende gli ordini, consegnare cibo, accettare i pagamenti e pulire i tavoli il più efficientemente possibile entro il tempo limite. Se l'indicatore si svuota completamente, il cliente lascerà il ristorante.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444450/FFFD0013" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444450/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
