...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157424B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ARKANOID Plus! ist die rundum erneuerte Version des Arcade-Klassikers. Mit Hilfe eines Raumschiffs namens VAUS dirigiert der Spieler einen Energieball über das Spielfeld, um farbige Blöcke zu zerstören. Das Spiel enthält neue Modi und Einstellungen, die die Spielerfahrung drastisch verändern: Der „Arcade“-Modus besteht aus 61 Runden, die in linke und rechte Versionen aufgeteilt sind und mit zwei Endgegnern in der letzten Runde aufwarten. Im „Duell“-Modus können Spieler entweder gegen einen Freund oder den Computer antreten. Im gnadenlos nervenaufreibenden „Zeit“-Modus müssen die Runden innerhalb einer vorgegebenen Zeit absolviert werden. Raffinierte Unterschiede zwischen den Spielregeln und etliche aufregende Gegenstände sorgen für viele Stunden unschlagbaren Spielspaß!<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
