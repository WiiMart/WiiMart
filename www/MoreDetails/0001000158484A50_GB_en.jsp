...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158484A50')", "wiiSelectSound()");
...
<br><br>
ThruSpace is a unique 3D puzzle game that will put your spatial awareness and reaction times to the ultimate test. Steer a Keydron, a simple geometrical shape, at high speed through gaps in a series of walls, rotating it to the correct angle to fit through. The more walls you pass through, the more you score. Plus, you can pick up crystals to boost your points.
<br><br>
Once you've mastered the basics, learn how to do tricks and combos. Some gaps are bigger than the Keydron, but you can fill the entire space with the Keydron's shadow before passing through it, upping your score further.
<br><br>
There are three modes to enjoy: Normal, Endless and Trick Challenge; and you can save three of your best runs as replays and watch them again in Keydron Memories mode. Plus, upload your scores to the online leaderboard and see how you stack up with players from across the world!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484A50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
