...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Weird things are happening on Planet Nebulus. Someone or something has begun building huge towers on the seafloor without a construction license! Your mission is to ascend each of the eight cylindrical towers, passing various obstacles, and trigger the tower's destruction mechanism to demolish the evil threat. Praised at the time for its graphical innovation, this is considered to be the most outstanding game from Hewson in 1987. Don't miss out on this classic favorite!</div>
  <div id="image02">
