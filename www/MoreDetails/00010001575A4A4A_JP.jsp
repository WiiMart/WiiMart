...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001575A4A4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">一人称視点の本格的柔道体感ゲームです。ヌンチャクとWiiリモコンを、あなたの左右の腕として操作します。まずは相手をつかみ、姿勢を崩して技を掛ける機会を窺います。相手がバランスを崩したら、隙を突いて豪快な投げ技を決め一本勝ちを狙いましょう。一本が決まらなくても、技ありや有効ポイントを取得して優勢勝ちを狙ったり、相手のスタミナを奪い押さえ込みを狙うなど、様々な戦術が可能です。能力値の異なる20選手たちから、あなたのスタイルにあった選手を選び、いろんな大会を勝ち抜いて、世界一を目指しましょう。画面分割による2プレイヤー対戦も可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4A4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A4A4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">＠SIMPLEシリーズ　Vol.5</span></div>
</div>
