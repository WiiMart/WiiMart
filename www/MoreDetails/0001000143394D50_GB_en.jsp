...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pitstop II was the first racing game that brought the thrill of battling an opponent, the excitement of fighting for the lead out on the track and the suspense of struggling to be the first out of the pits to the computer screen. 
Third-person graphics and a split-screen display allowed up to two players to experience the challenge of car racing head-to-head.
<br><br>
Six of the world´s toughest race tracks are waiting, from Brands Hatch and its hairpin turns to the mile-long straight of Vallelunga. You can practice against the computer, but nothing will compare to the fun of racing against another person. That´s the whole story behind Pitstop II. It´s simple - car racing was never meant to be a solo sport!</div>
  <div id="image02">
