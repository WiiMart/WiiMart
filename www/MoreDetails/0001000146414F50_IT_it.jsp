...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Per salvare il proprio mondo dall'invasione dei demoni, Dana va alla ricerca della Chiave di Salomone con la quale rinchiuderli per sempre. Mix audace tra un gioco d'azione ed un enorme puzzle, Solomon's Key™ viene ricordato come uno dei giochi più difficili per NES ma anche come una delle sue avventure più belle. Il giocatore deve unire logica e riflessi pronti per svelare tutti i misteri di ogni stanza. Le menti più brillanti riusciranno a svelare alcuni dei segreti del gioco, ma solo pochi saranno in grado di vedere tutti i finali differenti. Tu ci riuscirai?<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
