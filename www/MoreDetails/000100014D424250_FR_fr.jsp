...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le Dr Eggman (aussi connu sous le nom de Dr Robotnik) est parti en quête des Emeraudes du Chaos pour activer sa terrible nouvelle invention, le Death Egg. Un après-midi, il lance l’offensive sur l'île où elles sont enterrées et transforme les animaux sans défense qui l'habitent en drones esclaves travaillant à sa solde...
<br><br>
Heureusement, Sonic est là pour entraver ses plans. Et cette fois, il n'est pas seul dans la bataille: son ami Tails l'accompagne ! Ensemble, ils se lancent dans l'action pour récupérer les Emeraudes du Chaos avant leur diabolique ennemi.
