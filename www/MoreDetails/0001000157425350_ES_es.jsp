...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157425350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Pop tu objetivo consiste en explotar burbujas. Puede parecer un poco simple, pero hay muchas cosas que puedes hacer para lograr una buena puntuación y pasarlo bien:<br><br>

- Encadenar burbujas del mismo color para lograr muchos puntos.<br>
- Utilizar poderes especiales para mejorar tu puntuación u obstaculizar a un rival.<br>
- Hinchar burbujas para crear grandes explosiones y cadenas.<br>
- Jugar por tu cuenta.<br>
- Jugar con amigos en la misma pantalla.<br>
- Unirte a una partida en curso.<br>
- Desbloquear emblemas.<br>
- 4 modos diferentes de juego.<br><br>

También hay tablas con las mejores puntuaciones en línea y mensajes de WiiConnect24 para mantenerte informado acerca del progreso de tus amigos y para poder alardear de tus propias puntuaciones.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157425350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157425350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
