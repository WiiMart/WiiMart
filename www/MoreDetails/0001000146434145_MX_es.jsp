...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Star Soldier, el estándar de juegos de tiroteo de acción vertical, fue el juego original que dio luz a la larga serie de juegos de Soldier. Métete dentro de la flotante estación espacial habitada por gigantescas computadoras conocidas como Starbrain. Tu misión: detener la invasión galáctica de Starbrain al pilotar a Caesar, una nueva, compacta nave espacial, a través de 16 niveles mortales. Colecciona las cápsulas de poder para aumentar los tres atributos de tu nave: capacidad de disparo, velocidad de movimiento, y estrategias defensivas. Derrota a las olas de enemigos o usa la función innovadora de Trap Zone para volar bajo una superficie terrestre para esquivar los ataques del enemigo. ¡Conquista cada nivel para llegar hasta la confrontación final con Starbrain!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146434145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146434145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Star Soldier</span></div>
</div>
