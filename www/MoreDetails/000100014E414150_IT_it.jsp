...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Invitato al castello della Principessa Peach, Mario scopre che ancora una volta è stata rapita da Bowser e dai suoi scagnozzi. Ma qualcosa è cambiato... Stavolta l’avventura è in 3D! Scopri i segreti del castello della Principessa Peach e trova tutte le 120 stelle mentre guidi Mario in una nuova dimensione in quest’indimenticabile titolo di lancio del Nintendo 64. Considerato da molti come uno dei migliori videogiochi di tutti i tempi, rimane fedele allo spirito della serie e nonostante Mario acquisti molte nuove mosse, resta semplice da controllare. Questo gioco segna anche l’introduzione dello stick analogico come uno standard nei videogiochi.<br><br>Il testo all'interno del gioco può essere visualizzato in inglese, tedesco e francese.</div>
  <div id="image02">
