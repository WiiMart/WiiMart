...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157324F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Aquarium 2, the sequel to the hit WiiWare title, My Aquarium, is here.<br><br>

This time, the theme is the mysterious deep sea.<br><br>
...
<br><br>
Like the original, you can customize your aquarium, and choose which fish to put in and where to place various decorations.
You can also choose from a variety of coloured lights to illuminate your aquarium. In time, your fish might breed to give you a whole new school to raise! Create your very own aquarium for endless hours of relaxing fun and entertainment!
<br><br>
This sequel features a larger selection of fish and objects than the original! And like before, you can link up to the Forecast Channel to reflect the actual weather.
<br><br>
...
As some of the Wii console’s online services were discontinued on 28th June 2013, online features for this software, using WiiConnect24, are no longer available.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324F50/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
