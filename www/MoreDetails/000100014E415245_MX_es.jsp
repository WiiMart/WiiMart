...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Link debe salvar el mundo! Esta vez está atrapado en Termina, un mundo alternativo parecido a Hyrule que está destinado a la destrucción en solo tres días. Link debe apresurarse para recuperar la Ocarina del Tiempo (la cual le permite controlar el tiempo de distintas maneras), derrotar a enormes jefes repartidos por Termina y resolver el misterio de la máscara de Majora. En su viaje, obtendrá nuevas armas y objetos, y ayudará a otros personajes (algunos de los cuales le resultarán bastante familiares) en sus vidas diarias. Además, Link debe utilizar una gran variedad de máscaras repartidas por toda Termina, cada una con un poder y propósito específico. Nunca antes había sido posible encontrar tanta acción, enigmas y profundidad en solo tres días. ¡The Legend of Zelda: Majora’s Mask es una aventura distinta a todas las demás!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E415245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E415245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
