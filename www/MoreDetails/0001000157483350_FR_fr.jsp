...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157483350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Imagine la scène...
<br><br>
Tu emménages dans ta nouvelle maison et tout est parfait, sauf une seule pièce. Tu as une idée de la décoration, mais tu ne sais pas t'y prendre.
<br><br>
Qu'est-ce que tu fais ? Tu appelles l'équipe de Home Sweet Home !
<br><br>
Avec Home Sweet Home, tu
pourras mettre en oeuvre tes
talents de décorateur et choisir
les modèles de meubles et les
couleurs qui blufferont tes
clients.
<br><br>
Avec une interface et des commandes simples, un style graphique très sympa, Home Sweet Home te permet d'exploiter ta veine créatrice. Pour créer un véritable foyer, il n'y a que Home Sweet Home !<br><br>Texte écran en français.</div>
  <div id="image02">
