...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dieser klassischen Sportsimulation von 1992 begibst du dich zusammen mit Mario (und Luigi, im Zwei-Spieler-Modus) aufs Grün.
<br><br>
In NES Open Tournament Golf stehen dir drei internationale Plätze (England, USA und Japan) und drei verschiedene Spielvarianten (Stroke Play, Match Play und Tournament) zur Verfügung.
<br><br>
Bereite deinen Schlag auf dem 2D-Bildschirm durch Auswahl des richtigen Schlägers und Anpassen des Schlags an Windgeschwindigkeit und<br>
-richtung vor. Schalte dann zum Abschlagbildschirm und beachte bei deinem Schlag das richtige Timing.
<br><br>Englischer Bildschirmtext.
<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415050/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415050/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">NES Open Tournament Golf<sup>TM</sup></span></div>
</div>
