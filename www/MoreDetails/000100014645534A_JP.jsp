...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公のグルッピーを操作して、隠された金塊を探し出すアクションゲームです。ゲームの舞台となる「クルクルランド」には不思議な力がはたらいており、
グルッピーは自由に動き回ることができません。角を曲がるには、ステージ内に設置されたターンポストをつかんで、グルッピーをクルクル回転させてください。ターンポストに手をかけたり、手を離したりするタイミングが操作のコツです。ステージ内の特定の場所を通ると隠された金塊が現れ、金塊をすべて見つけ出すと、ステージクリアです。２人での協力プレイにも対応しています。なお、このソフトは１９９２年４月２８日に発売されたディスクシステム版で、１９８４年発売のファミコンカセット版と比べ、新たなステージやモード、「ボスウニラ」というキャラクターなどが追加されており、よりパワーアップした内容になっています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クルクルランド<sup>TM</sup></span></div>
</div>
