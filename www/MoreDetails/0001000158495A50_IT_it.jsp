...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158495A50')", "wiiSelectSound()");
...
<br><br>3D Pixel Racing è un gioco di guida che ricorda i classici della storia dei videogiochi.
Sono disponibili varie modalità di gioco, dalla gara singola fino alle entusiasmanti gare a inseguimento.<br>
Il gioco comprende ben 10 piste, 11 automobili e 10 piloti: completa le diverse sfide e sblocca tutti i contenuti nascosti!<br>
Lanciati in divertenti partite multigiocatore su schermo condiviso e sfida gli amici in avvincenti gare per quattro giocatori!  <br>
Modalità di gioco: Gara singola, Campionato, Cattura la bandiera, Inseguimento e Prova a Tempo. <br>
Condizioni meteo variabili: Sole, Nebbia, Pioggia, Neve.
<br><br>
