...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">現代に生きる忍者が、テクニカルな技を駆使して難関をクリアしていく「Ｓｈｉｎｏｂｉ－忍－」シリーズの中でも、もっとも多彩な技とステージが人気を呼んだ傑作です。世界支配をもくろむ悪のシンジケート「ＮＥＯ　ＺＥＥＤ」の野望を阻止するため、正義の忍、ジョー・ムサシの戦いが再び繰り広げられます。ＮＥＯ　ＺＥＥＤには、忍
者、軍隊、生体兵器、機動メカといったさまざまな敵が登場し、ムサシの行く手を阻みます。「Ｓｈｉｎｏｂｉ－忍－」シリーズおなじみの二段ジャンプからの八双手裏剣はもちろん健在。ダッシュ移動に三角跳び、ぶら下がりといった新アクションやダッシュ斬りと飛び蹴りの新たな攻撃アクションが加わり、多彩な攻略が楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ･スーパー忍II<sup>TM</sup></span></div>
</div>
