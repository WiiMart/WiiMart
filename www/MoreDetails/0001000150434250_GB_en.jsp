...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This side-scrolling shooter includes a total of 6 'scenes', spanning areas from the Earth to the Moon. The story begins with a comet discovered in the vicinity of Pluto, headed on a collision course with Earth. Mankind narrowly succeeds in diverting the comet’s course, and it crashes into the Moon. However, investigations into the damage uncover that what hit the moon was not a comet, but a gigantic mothership!
<br><br>
Power-up your ship, destroy enemies and fight your way through the bosses in an attempt to reach the Moon’s core to protect the Earth from alien invasion. Enjoy the unique world of Dead Moon, including various stages with beautiful backgrounds, a power-up system that increases your attack as well as your defence, and boss battles that require you to alter your ship’s direction to fight them!</div>
  <div id="image02">
