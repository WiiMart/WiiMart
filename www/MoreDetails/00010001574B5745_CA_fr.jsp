...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B5745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Great hidden object fun for kids and adults! Quickly find items in every stage to complete this adventure! Work together or compete in each stage to find the necessary items that will help the game’s hero find a way home. From seashells to sparkling jewels, do your best to find the hidden objects as fast as you can! During this adventure you will also confront ghosts and a dragon in some action stages. Lots of items for each stage and lots of excitement can be found in this hidden object game!
<p>
Each stage can be played by up to four players for great gaming fun. Family and friends can work together to get a quick clear time or compete to see who is the best at finding hidden objects in every stage! Play and enjoy together!</div>
  <div id="image02">
