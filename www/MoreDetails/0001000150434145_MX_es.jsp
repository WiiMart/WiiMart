...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ábrete paso a través de una estación espacial y derrota a los monstruos que merodean en este videojuego de primera persona con tiempo real. Eres un miembro de los Debuggers, un grupo élite de soldados especialistas en todo. Asignado para inspeccionar una estación espacial no tripulada, tienes exactamente 100 minutos para entrar, destruir a los monstruos que se esconden en cada bloque, llegar hasta el nivel más bajo y desactivar el detonador automático ubicado allí. Con cada monstruo que dejes escapar, te será más difícil sobrevivir en el bloque central, así que la velocidad es clave para preservar las instalaciones y a cada bloque. Experimenta la emoción de sobrevivir mientras el tiempo avanza y descubres la verdad de los eventos que ocurrieron.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
