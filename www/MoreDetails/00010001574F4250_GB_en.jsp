...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574F4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Art Style series – exclusive to WiiWare – brings you unique games that are simple to control yet are filled with rich gameplay, and atmospheric sound and visuals.
<br><br>
In Art Style: ORBIENT, the universe is your playground. Beginning as a tiny star, you must use gravitational forces to propel yourself through the cosmos, absorbing other stars to increase your size or capturing them within your orbit.
<br><br>
But space is a dangerous place, filled with hazards such as asteroids and black holes that could bring your journey to a premature end. With 50 relaxing but challenging stages to enjoy, ORBIENT is an experience that’s truly out of this world!</div>
  <div id="image02">
