...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B4B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おなじみ「黒ひげ危機一発」がWiiウェアで登場します。みんなでワイワイ遊べる「みんなで黒ひげ！モード」や、一人でじっくり楽しめる「とことん黒ひげ！モード」。そして「黒ひげ」の代わりに「Mii」がタルに入るなど、Wiiならではのモードや演出でパワーアップしたハラハラ、ドキドキ感を楽しめる、バラエティパーティーゲームです。<BR>「みんなで黒ひげ！モード」では１人から最大４人まで同時にプレイすることができます。各プレイヤーが順番に樽へ剣をさしていき、より多く剣をさすことを競うモードです。ハズレ穴に剣をさして黒ひげを飛ばしてしまうとゲームオーバーになります。<BR>「とことん黒ひげ！モード」は１人プレイ専用のモードです。通常の「黒ひげ危機一発」ゲームとはことなり、ハズレ穴が複数あります。ステージごとに、ハズレ穴の数が表示されるので、制限時間内にハズレ穴以外の全ての穴に剣をさすか、全てのハズレ穴を見つけることができればステージをクリアできるアクションパズル的なゲームです。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B4B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B4B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">黒ひげ危機一発Wii</span></div>
</div>
