...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">フランスのパリからセネガルのダカールまでの過酷な１３,０００キロを走破する「パリ・ダカールラリー」をモデルにしたレースゲーム。時間によって変わる背景、あふれるスピード感、迫力のクラッシュシーン、エンジンやミッション類の故障までもが忠実に再現され、本格的なラリーを体感できます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ビクトリーラン<sup>&reg;</sup></span></div>
</div>
