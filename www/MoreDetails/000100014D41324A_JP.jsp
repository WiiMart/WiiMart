...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">かわいらしい恐竜たちが、宇宙人相手に大暴れする、コミカルだけど奥が深い、誰でもすぐに楽しめるリアルタイム・シミュレーションゲームです。プレイヤーはこの世界の守り神となって恐竜の卵を育て、大地に雨を降らして草食恐竜を増やしていきます。パワーが集まれば今度は肉食恐竜を使って一気に攻め込み、星を侵略してきた宇宙人を追い出すことが目的です。プレイヤーが育てるのは、のんき者の「すてご」、守りは万全の「とりけら」、俊敏なハンター「あろ」、勝気な暴れん坊「てぃらの」、そしてタマゴを食べてしまうお調子者「ぴーちゃん」。５種類の恐竜を使い分け、ときにはパワーを使って「かみなり」や「じしん」、「こうずい」といった天変地異を起こし、領土を拡大していきます。弱肉強食の世界を再現した画期的なシステムは楽しさ満点です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダイナブラザーズ<sup>TM</sup></span></div>
</div>
