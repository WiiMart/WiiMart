...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９１年にＳＮＫからリリースされた横スクロール型の格闘アクションゲームです。ニューヨークから大阪へ逃亡した巨大シンジケート「キャステローラ・ファミリー」を追って、デューク、リュウ、ビリーの三人の刑事が活躍します。プレイヤーは三人のいずれかを操作し、パンチ、キック、ジャンプを組み合わせて戦います。ジャンプボタンと攻撃ボタンを同時押しすると、各キャラクターに個別に用意された必殺技が繰り出せます。必殺技は大きな破壊力を発揮しますが、体力を消耗するので、ここぞという時のみ使っていきましょう。２人同時プレイにも対応していますが、お互いの攻撃が命中してしまうので、乱戦時には仲間との位置関係に気をつけてください。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バーニングファイト</span></div>
</div>
