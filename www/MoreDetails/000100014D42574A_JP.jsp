...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">落ちものパズルの名作『コラムス』が、最大５人同時対戦プレイも可能なパーティーゲームになって登場。タテ・ヨコ・ナナメに宝石を３つ並べて消していくシンプルなルールはそのままに、対戦ゲームとしてパワーアップしました。相手に段を送りこむ２～５人対戦はもちろん、ポカスカじゃんけんの結果がフィールドに影響を与える「２対２」、１人の相手を２人で攻める「２対１」といった特殊な対戦プレイも可能です。１人プレイでは、コンピュータが操るキャラと対戦する「ピラミッドコラムス」を収録しています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">コラムスⅢ<sup>TM</sup>　対決！コラムスワールド</span></div>
</div>
