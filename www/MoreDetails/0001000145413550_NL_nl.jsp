...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Deze vierde game in de Fatal Fury-vechtreeks werd uitgebracht in 1995.<br><br>
Eerdere delen in de serie speelden zich af op twee lagen. Je kon rondlopen en knokken op de voorgrond en op de achtergrond. In deze aflevering is daar een derde laag aan toegevoegd - na een tijdje op de voor- of achtergrond ga je nu automatisch terug naar de hoofdlaag in het midden.<br><br>
Ook nieuw zijn de Combination Arts (de mogelijkheid om combinatieaanvallen uit te voeren door ritmisch op de knoppen te drukken), Hidden Abilities (superieure versies van de populaire Special Moves en Super Special Moves uit eerdere delen), kleine aanpassingen aan de Special Moves van alle personages en nog veel meer. Daarmee biedt deze aflevering de uitgebreidste strategische en tactische mogelijkheden in de Fatal Fury-reeks tot nu toe.<br><br>
In het spel kan worden gekozen voor Engelse, Spaanse of Japanse schermteksten.<br>
