...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年にリリースされたNEOGEOのサッカーシリーズ「得点王」の第４弾。参加チームはシリーズ最多の全８０ヶ国、さらには４タイプのチームバランスを選択できるため、プレイヤーは自分の好みに応じたチームを選べるようになっています。ゲームモードも初心者から上級者まで幅広く対応。どのモードでも世界大会をモチーフに、世界一を目指すまでの道のりを楽しむことができます。前作同様、フリーキック時やシュートチャンス時などの状況に応じて異なるアングルが用意されていたり、更にはボール支配によりオフェンス選手の能力が高まる「エキサイトゲージシステム」が新システムとして導入されるなど、より戦略的なプレイができるようになっています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">得点王 炎のリベロ</span></div>
</div>
