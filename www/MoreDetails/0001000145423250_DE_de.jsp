...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ein 1997 veröffentlichtes Kampfspiel aus der Arcade-Reihe Fatal Fury. Um größere Vielfalt an Strategien zu ermöglichen, wurde zusätzlich zum schon bekannten Spielprinzip aus vorangegangenen Spielen das zwei Ebenen-Kampfprinzip weiterentwickelt, das Energiebalken-System verbessert und das Ring-Out-System dieses Mal weggelassen. Zu den schon bekannten 15 Kämpfern (mit Ausnahme von Geese), werden dieses Mal vier weitere Kämpfer vorgestellt, die dem Namen Special alle Ehre bereiten: Tung Fu Rue, Cheng Sinzan, Laurance Blood und Wolfgang Krauser. Sie werden gegeneinander um den Titel des stärksten Kämpfers antreten.
