...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574B4650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Is your Kung Fu strong enough?
<br><br> 
...
<br><br>
Kung Fu Funk is played using Wii Remote and optionally the Nunchuk. You will have to perform all kinds of Kung Fu to progress. If you decide you don't want to use the Nunchuk you can just unplug it at anytime to play one handed.</div>
  <div id="image02">
