...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ghosts'n Goblins is een klassiek spel waarin je rake klappen (en lanssteken) uitdeelt. Beleef het spel dat Capcom in 1985 naar de top van de speelhalindustrie bracht en help Arthur hordes monsters te verslaan in zijn poging om de prinses te redden. Het eerste (en mogelijk enige) spel waarin je letterlijk in je hemd wordt gezet als je wordt geraakt.
<br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145353450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145353450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
