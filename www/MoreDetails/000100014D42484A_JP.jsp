...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">みんなで楽しめるパズル＆アクション・パーティーゲームの決定版『タントアール』が一段とパワーアップ。「奥様は窓」「二酸化ガンマン」「ロイヤル猿～ン」など、まったく新しい２０種類以上のミニゲームが４種類のモードで楽しめます。『ボナンザブラザーズ』でもおなじみのデコボココンビがやってきた今度の舞台は中世の世界。魔王を倒すためにレベルアップを重ねながら賢者の石を集めるという、ＲＰＧさながらの演出が楽しい「クエストモード」を搭載。４人対戦プレイが楽しい「コンペモード」ではドラゴン城を目指します。１人でも４人でも、何度でも楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">イチダントアール<sup>TM</sup></span></div>
</div>
