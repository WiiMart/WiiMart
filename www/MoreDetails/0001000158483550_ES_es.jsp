...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483550')", "wiiSelectSound()");
...
<br><br>
¡Corre, salta, pon el mundo al revés!
<br><br>
And Yet It Moves es un galardonado juego de plataformas en el que deberás correr y saltar a través de un mundo hecho de papel. Para ayudarte a superar los retorcidos y alucinantes niveles, posees la habilidad de girar el mundo a voluntad: las paredes se convertirán en suelos y las pendientes en plataformas, ¡pero ten cuidado, un inofensivo montón de piedras puede convertirse en un peligro cuando se pone al revés!<br><br>
Usa el mando de Wii como una varita mágica para inclinar el mundo. Explora ambientes bellamente elaborados. Sobrevive a 20 niveles desafiantes, llenos de extrañas criaturas, trampas y misterios.
<br><br>
¡Pon tu mundo del revés con And Yet it Moves!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483550/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483550/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
