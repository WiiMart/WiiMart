...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Usa paneles triangulares de distintos colores para crear un mosaico de vitrales en Art Style: ROTOHEX. Debes rotar triángulos mientras caen de la parte superior de la pantalla para agrupar seis paneles del mismo color, creando así un hexágono (HEX) de un solo color. Una vez que el HEX haya sido formado desaparecerá, permitiendo que los paneles existentes puedan ocupar ese espacio y evitando que se llene la zona de juego. Los dos estilos de control intuitivos y la claridad del objetivo te permiten enfocarte en las tácticas del juego, lo cual es vital, pues el espacio disponible se llenará de paneles antes de que te des cuenta. ¡Los múltiples modos de juego disponibles (que se desbloquean mientras avanzas en el modo SOLO), los paneles especiales puestos a tu disposición y la habilidad de jugar con un amigo de manera cooperativa o competitiva, permiten que siempre exista un nuevo HEX por crear!
<p>
Los juegos de la serie Art Style contienen diseños elegantes, elementos gráficos refinados y controles fáciles de dominar, creando una experiencia de juego enfocada únicamente en divertir y entretener.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444845/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444845/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Art Style<sup>TM</sup>: ROTOHEX<sup>TM</sup></span></div>
</div>
