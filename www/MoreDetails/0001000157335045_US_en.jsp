...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157335045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Triple Throwing Sports is the most advanced recreational throwing game available for WiiWare, immersing the player in the world of competitive projectile throwing.
<p>
Most Olympic events consist of activities that are traditionally derived from hunting and combat skills. Over time these practices have evolved into a variety of competitive sports that include Javelin, Discus, Shot Put and Hammer.
<p>
As with real life throwing events you will have full control over the aim of the projectile. You must also take into account the angle, release point and power as these can all influence the success of the throw.</div>
  <div id="image02">
