...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158494A50')", "wiiSelectSound()");
...
<br><br>Nell'anno 2112 le folle sono affascinate dalle corse a velocità estreme. Le tecnologie antigravitazionali da corsa più avanzate hanno introdotto il cambiamento di fase. Il segreto per restare vivi è, infatti, un abbinamento di fase perfetto tra veicolo e tracciato.
<br><br>
Preparati per una nuova esperienza di corsa a velocità mozzafiato. Raggiungi i limiti delle tue capacità per vincere le corse e infrangere i record. Sfida i tuoi amici in una gara su schermo condiviso senza esclusione di colpi. Gareggia contro avversari senza scrupoli e sfreccia ai vertici di tutte le leghe.
<br><br>
Scalda i motori, il futuro è adesso...<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494A50/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
