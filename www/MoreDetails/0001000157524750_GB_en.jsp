...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157524750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rage of the Gladiator is a fantasy-based fighting game where you must fight for your life in the arena.  Prove yourself by conquering all opponents!<br><br>
Features include:<br>
...
- Supports both Wii MotionPlus, and regular Wii Remote!</div>
  <div id="image02">
