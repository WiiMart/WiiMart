...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bomberman ’93 è l’eccitante seguito, potenziato, dell’originale Bomberman!<br>La modalità per un giocatore "Normal mode" offre sei round, ognuno contenente otto livelli, per un totale di 48 divertentissimi livelli differenti! Distruggi tutti i tuoi nemici e trova l’uscita nascosta prima che scada il tempo per passare al livello successivo. In questa versione di Bomberman appare per la prima volta l’abilità "kick" (calcia) e potrai davvero iniziare ad utilizzare le tattiche di gioco più intelligenti! Sfrutta le trappole e i nuovi strumenti per ottenere un punteggio perfetto! Fino a cinque giocatori possono sfidarsi nel Battle Game (battaglia) e con tutte le nuove sorprese (come il nastro trasportatore): la lotta sarà durissima!<br><br>Quando giochi nella modalità per più giocatori, il numero di telecomandi Wii dev'essere uguale al numero di giocatori.<br>Per giocare in cinque, è necessario utilizzare almeno un controller per Nintendo GameCube.<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
