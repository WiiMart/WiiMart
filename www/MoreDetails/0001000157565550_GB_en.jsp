...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157565550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Join Mr. Bumblebee in his first big adventure!<br><br>

Pass huge flowers and the crowd cheering in the grandstand - The waterfall! Quick, to the left, or your wings will get wet! Oh, there's Junky Punkie again, the little pest! Good thing you just collected that turbo – now you can fly way faster than all the other insects!<br><br>

Features:<br>
	•	Suitable for any age thanks to adjustable game speed!<br>
	•	Beautifully hand-drawn graphics!<br>
	•	Play alone or with up to four players!<br>
	•	Choose from four different game modes on six tracks!</div>
  <div id="image02">
