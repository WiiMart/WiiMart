...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">伝説の聖剣「ラングリッサー」と魔剣「アルハザード」の２つの秘剣をめぐるドラマをえがく、大人気シミュレーションＲＰＧシリーズ第二弾。前作の主人公レディンの子孫である剣士のエルウィンは、旅先の村で巫女のリアナを救ったことから、帝王ベルンハルト率いる帝国軍や闇の軍勢たちと運命の戦いを繰り広げることになります。
連続する２０以上のシナリオで構成されたストーリーは、前作の４倍の容量を使った壮大なボリューム。エルウィンのもとへと集まる仲間たちを指揮し、さまざまな勝利条件のシナリオをクリアしていきましょう。システムも前作から大きくパワーアップし、属性や地形を考慮しながら戦略性の高いシミュレーションバトルが楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ラングリッサーⅡ<sup>TM</sup></span></div>
</div>
