...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９５年にリリースされた格闘ゲームです。『ワールドヒーローズ』シリーズでは４作目にあたり、歴史上の人物１６名がエントリーをして世界最強の座を賭けて戦います。前作まではボタンの押し時間で攻撃の強弱を決定していましたが、今作からは個別のボタンや同時押しで弱中強威力の攻撃の使い分けを可能としているほか、ヒーローゲージ、エクストラアタック、ガードはじき攻撃といった新要素を盛り込み、よりエキサイティングな駆け引きが楽しめるようになっています。<BR>※ボタンの配置により、Wiiリモコンではプレイしづらい場合があります。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワールドヒーローズパーフェクト</span></div>
</div>
