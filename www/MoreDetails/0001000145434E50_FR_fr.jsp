...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sengoku 3 est un jeu d’action à scrolling vertical　sorti à l’origine en 2001. Choisissez l’un des 4 personnages et partez autour du monde tuer les esprits maléfiques réveillés par la lune rouge. Cette suite propose un jeu plus dynamique en incluant une jauge “ninja” (shinobi) qui, lorsqu’elle est remplie, vous permet d’exécuter des attaques « Arts Ninja » contre vos ennemis. Ce nouveau système vous permet d’exécuter des attaques à mains nues et armées pour créer des enchaînements et augmenter la puissance de vos attaques. Utilisez les Arts ninja ainsi que les enchaînements afin de décimer les ennemis, dans le dernier volet bourré d’action de cette série épique.<br><br>Texte écran en anglais.</div>
  <div id="image02">
