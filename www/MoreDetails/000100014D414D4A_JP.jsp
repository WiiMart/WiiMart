...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">重厚なＢＧＭと、状況に応じて変化する多彩なプレイ画面が楽しいアクションＲＰＧ。「力のセント・ヴァーミリオン」アーネスト国王によって滅ぼされた「知識のセント・ヴァーミリオン」フョードル国王の忘れ形見である主人公。世界に散らばった８つの指輪を集め、魔から世界を救う長い旅が始まります。街から街への移動やダンジョン探索は３Ｄ視点、街は見下ろしの２Ｄ画面で展開。さらに通常の戦闘は８方向移動アクション、巨大なボスキャラとの戦闘は左右移動の騎士アクションとなります。数々の人気アーケードゲームを作り出したセガ・ＡＭ２研のスタッフが、初めて手掛けたＲＰＧとしても話題になりました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ヴァーミリオン<sup>TM</sup></span></div>
</div>
