...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気シリーズ第２弾にして、メガドライブ史上でも特に高い評価を得ている横スクロールタイプの格闘アクションゲームです。かつて街を暴力と犯罪の支配から解放したアクセル、アダム、ブレイズ。しかし倒したはずのシンジケートが再び蘇り、アダムを拉致して３人の抹殺を宣言しました。新たにプロレスラーのマックス、アダムの弟・サミーという心強い味方を加え、友情と平和をかけた果てしない死闘が始まります。サイズが大きくなり迫力を増したキャラクターや新たに加わった多彩な必殺技、さまざまな場所で繰り広げられるステージ展開など、すべての面がパワーアップ。前作で好評を博した古代祐三による音楽も、もちろん健在です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ベア･ナックルII<sup>TM</sup></span></div>
</div>
