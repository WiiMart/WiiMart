...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">L'empire Bydo est de retour! Plus puissants et maléfiques que jamais, les Bydo se dirigent vers la Terre. A bord de votre chasseur R-90, vous êtes le seul qui puisse les arrêter.
<br>
Contrairement à ses prédécesseurs, R-Type III:™ The Third Lightning a été conçu spécifiquement pour la Super Nintendo et exploite au mieux le Mode 7 pour générer des environnements en mouvement (rotations, déformations, inversions).
<br>
Dans R-Type III sont aussi apparues deux nouvelles Forces (Shadow Force et Cyclone Force) venues s'ajouter à la Round Force, qui peuvent s'attacher à l'avant ou l'arrière de votre appareil afin de vous fournir une puissance de feu accrue, spécialement si vous les couplez avec les nombreux objets disponibles. De plus, le laser peut désormais être utilisé en mode Hyper. Mais utilisez-le avec parcimonie pour ne pas faire surchauffer votre appareil.
<br>
Si vous avez aimé le premier<br>
R-Type™ sur Turbografx, vous allez adorer R-Type III:™ The Third Lightning, une bombe qui ressurgit du passé et qui sera un des bijoux de votre collection sur console virtuelle.
<br><br>Le texte à l'écran sera en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">R-TYPE Ⅲ<sup>TM</sup></span></div>
</div>
