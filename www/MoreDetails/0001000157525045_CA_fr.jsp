...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157525045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Burn the Rope is a challenging game where you try to burn as much rope as you can in each level. There’s a catch! The fire only burns upwards, leaving you to rotate the level to keep your flame alive! As you progress through the levels, you’ll encounter bugs crawling along the rope. Different bugs have different reactions to the flame. For example, the ant changes the color of the flame so you can burn different colored ropes, and the spider shoots out a web bridge so you can access parts of the level that you could not before.
<p>
Burn the Rope is incredibly fun. You will actually feel like you’re burning a rope, yet there’s no need for a fire extinguisher!
<p>
