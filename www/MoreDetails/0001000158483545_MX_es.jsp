...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483545')", "wiiSelectSound()");
...
<p>
¡Corre, salta, y gira el mundo al revés!
<p>
And Yet It Moves es un galardonado juego de plataformas basado en física en la que corres y saltas a través de un mundo hecho de papel. ¡Para ayudar en la solución de los niveles alucinantes, posees la capacidad única para hacer girar el mundo a voluntad! Las paredes se vuelven suelos, las diapositivas se convierten en plataformas - ¡pero un montón de rocas inofensivas se convierten en un peligro cuando se gira el revés!
<p>
Usa el Wii Remote como una varita mágica para inclinar el mundo. Explora entornos bellamente diseñados. Sobrevive 20 desafiantes niveles llenos de extrañas criaturas, trampas y rompecabezas. Desbloquea niveles de bonificación, modos de juego competitivos y modificaciones sorprendentes que cambian el juego entero.
<p>
¡Da vuelta tu mundo al revés con And Yet It Moves!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483545/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483545/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">And Yet It Moves</span></div>
</div>
