...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bases Loaded es el juego de béisbol con parecido a un juego de Galería y sin fin de opciones para los jugadores. Selecciona uno de los doce equipos, fija tu alineación eligiendo entre 30 jugadores (cada uno con diferentes niveles de destreza), y luego juega un partido sencillo o trata de ganar el campeonato. Al jugar, la pantalla se dividirá en dos diferentes vistas: una desde la base meta mientras estás bateando y la otra desde la posición del lanzador en estilo televisión (único en su tiempo) mientras que tu equipo juega en el campo. Las excelentes gráficas y control del juego añaden a la emoción mientras decides que tiro lanzarás (¡hasta puedes provocar al bateador al pegarle con la bola!), al controlar todas las posiciones en el campo, o hasta al esforzarte a dar un buen tiro. Así que asume tu parte y descubre por que este es uno de los juegos de béisbol más populares en el NES. ¿Podrás lograr sobresalir?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146444645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146444645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bases Loaded</span></div>
</div>
