...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157505250')", "wiiSelectSound()");
...
<br><br>
Art Style: CUBELLO is een 3D-puzzelspel waarin zowel je ruimtelijk inzicht als je reactievermogen op de proef worden gesteld! Het doel is simpel: verwijder de gekleurde blokken in je ‘Cubello’ door overeenstemmende blokken te schieten met de Wii-afstandsbediening.
<br><br>
De Cubello draait echter constant rond, dus zorg dat je goed richt en de juiste inschattingen maakt om de blokken op de juiste manier te elimineren en de puzzel te voltooien. Als je op zoek bent naar een echte uitdaging, moet je de Endless Mode (oneindige spelstand) zeker uitproberen!
<br><br>
