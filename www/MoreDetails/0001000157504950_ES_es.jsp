...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157504950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un juego repleto de acción en un circuito de carreras.
Durante el juego, el personal de boxes no solo tendrá que reparar los vehículos, ¡además tendrá que hacer frente a varios COMO SE LLAMEN!
¡Un grupo de bellezas se encargan de reparar el COMO SE LLAME!<br><br>
¡Los controles son muy simples!<br>
Hay que agarrar a un miembro del grupo con el Botón A del mando de Wii y soltar el botón cuando el puntero esté sobre la pieza dañada. El miembro del grupo comenzará las reparaciones.
¡Asigna tareas de reparación a los miembros de tu equipo y ayúdales utilizando el mando de Wii para sacar de boxes a un COMO SE LLAME totalmente reparado!
En Modo normal se puede jugar utilizando una de las dos reglas; en Modo atípico los jugadores compiten entre sí en dos equipos y en Modo clasificación te enfrentas a jugadores de todo el mundo para conseguir el mejor récord.
Cada modo se puede jugar con un máximo de 4 mandos de Wii, diviértete con tus amigos y tu familia. ¡Trabaja en equipo para batir récords!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504950/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504950/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
