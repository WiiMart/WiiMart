...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158494F50')", "wiiSelectSound()");
...
This game has been designed for use by children who have not yet grasped reading.</div>
  ...
  <div id="image01">
    <img src="/oss/ccs/0001000158494F50/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
