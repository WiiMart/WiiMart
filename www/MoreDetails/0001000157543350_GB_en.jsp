...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157543350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">High speed, side-scrolling action for 1 to 4 players!  Take control of business man Hitoshi Susumu who is behind schedule and won't stop running until he gets to his ultimate dance party! Avoid samurais, T-Rexes, cowboys and all manner of esoteric obstacles using just one button! Challenge your friends and maximize your score in this crazy new game experience that is unlike anything else!
<br>
<br>
FEATURES
<br>
...
<br>
<br>
Bizarre, comical and humorous unlike anything else out there
<br>
<br>
Accessible one button controls which are easy to learn but challenging to master
<br>
<br>
Colourful graphics with super smooth motion-captured animations
<br>
<br>
9 levels to master including the Moon, jungle and a city
<br>
<br>
4 player split-screen action for the ultimate party experience</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157543350/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157543350/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
