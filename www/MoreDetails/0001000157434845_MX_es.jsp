...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157434845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tu paciencia será la clave para enfrentarte a los mejores jugadores del mundo en “Chess Challenge!”. Perfecciona tus habilidades en el ajedrez jugando contra la computadora en modalidades de dificultad múltiples o utilizando la CWF de Nintendo, para empezar a subir en la tabla de clasificación mundial. Gana juegos en línea e incluso, compara tu clasificación en el ajedrez con jugadores en el mundo examinando la tabla de clasificación en línea. Si no tienes tiempo para jugar una partida de ajedrez en vivo con tus amigos, “Chess Challenge!” te permite también jugar hasta con cinco amigos Wii utilizando WiiConnect24. ¡Con el soporte total Mii, puedes realmente darles vida a tus juegos! Empieza practicando con algunos juegos informales y ábrete el camino hacia arriba en partidas formalmente clasificadas según el sistema de puntuación ELO. ¡Con todas estas opciones de juego, te esperan serias acciones de ajedrez!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157434845/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157434845/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
