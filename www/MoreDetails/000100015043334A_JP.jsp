...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">横スクロール型シューティングゲーム「スーパーダライアス」のＨｕカード版です。異星人の襲撃によって滅亡の危機を迎えた惑星「ダライアス」の人々は、新天地への望みを託して戦闘機「シルバーホーク」を発進させます。プレイヤーは「シルバーホーク」を操り、襲来する敵を対空用ショットと対地用ボムで撃破していきます。また赤・青・緑のアイテムを一定数集めることで、自機の攻撃力・防御力の段階的なパワーアップが可能です。ステージ分岐によるマルチエンディング方式を採用しており、クリアするルートによって３パターンのエンディングを迎えることができます。水棲生物をモチーフとした巨大なボスが登場する全２６ステージの美麗な戦闘シーンの数々は迫力満点です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダライアスプラス</span></div>
</div>
