...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157434E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">東京の街並みを本物そっくりに再現した、楽しさ満載のアバターライフシミュレーションゲームです。プレイヤーはさまざまな人と出会ったり、話題のお店で働いてみたり、東京の街を自由気ままに楽しみながらそれぞれの夢を叶えていきます。さらに、アバターを自由にカスタマイズして自分自身を反映させることで、リアルな東京ライフを楽しむことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157434E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157434E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">東京シティー★ナイツ</span></div>
</div>
