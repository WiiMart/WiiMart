...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">メルヘンチックなキャラクターや背景が印象的な、サイドビュータイプのアクションゲームです。ルアクーヨ王国の王子、赤ん坊のウパは、妖精にもらったガラ・スウォードを手に、人の夢を盗む魔獣ザイーを倒す冒険へと旅立ちます。近づいてくる敵にガラ・スウォードを振ると、敵は風船のようにふくらみ、宙に浮かびます。ふくらんだ敵は、頭突きで飛ばして他の敵にぶつけたり、上に乗って高い場所へジャンプすることができます。ライフや残り時間がなくなったり穴に落ちたりするとミスとなり、ウパの残り数が０になるとゲームオーバーです。お菓子でできたワールドや、機械でできた迷路のようなワールドなど、全部で７つのワールドをクリアし、魔獣ザイーの魔の手から王国を救ってください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146454D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146454D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バイオミラクル　ぼくってウパ<sup>&reg;</sup></span></div>
</div>
