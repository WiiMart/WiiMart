...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">生産したさまざまな部隊を率いて勝利をめざす、人気戦略シミュレーション『ファミコンウォーズ』の２作目です。縦・横に移動するシンプルなマップとわかりやすいゲームシステムは前作からそのまま引き継ぎ、ウォーシミュレーション入門としてはじめての方でもお手軽に楽しめます。自軍の部隊を動かして施設を占領しながら敵軍と戦い、敵軍の首都を占領するか敵軍を全滅させると勝利です。本作では新たに「研究所」や「駅」という施設が登場し、 「列車砲」など新しい種類の部隊も生産できるようになりました。また前作のレッドスター軍とブルームーン軍のほか、新たにグリーンアース軍、イエローコメット軍が加わり、さらに、特徴的な７種類の思考ルーチンが「将軍」として敵軍を率います。新施設の配置された「ニュー２Ｐマップ」や４人で遊べる「４Ｐマップ」モードが追加され、戦いの舞台として選べるマップの数もバラエティも大幅アップ。４つの軍で争うことはもちろん、勢力間で同盟を結び、２対２や１対３で協力プレイを楽しむこともできます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーファミコンウォーズ<sup>TM</sup></span></div>
</div>
