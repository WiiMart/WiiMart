...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B5450')", "wiiSelectSound()");
...
<br>
<br>
- Las armas incluyen ametralladoras, escopetas, misiles teledirigidos y armas láser.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
