...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157413250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo puzzle game del 2007 per Nintendo DS approda su WiiWare, ma con una marcia in più! Seleziona il tuo Mii preferito e assumi il controllo del cannone, puntando il telecomando Wii verso lo schermo e ruotandolo. Dovrai eliminare gruppi di 3 o più gemme dello stesso colore, prima che raggiungano la fine del percorso.
<br><br>
Entra subito in azione con le modalità ALLENAMENTO e DUETTO, metti alla prova le tue capacità con la modalità MARATONA e cerca di sopravvivere alla modalità MISSIONI, nella quale ogni livello prevede una differente strategia di gioco!
<br><br>
Oppure divertiti IN COMPAGNIA, modalità alla quale possono partecipare fino a quattro giocatori. Affronta i tuoi amici, il computer, oppure combina queste due possibilità. Collabora con gli altri Mii per eliminare le gemme, oppure sfidali per scoprire chi di voi è il grande Actionloop Master!
<br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413250/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
