...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ソニックがボール役になった誰でも楽しめるアクションピンボールゲームです。悪の天才科学者「ドクター・エッグマン」の要塞からカオスエメラルドを手に入れ、４つの世界をエッグマンの手から救い出すことが目的。フリッパーをうまく使ってソニックを弾き、各ステージのボスをやっつけます。フリッパーにはじかれるだけではなく、ソニックのアクロバティックなアクションは健在。多彩なステージもプレイヤーを飽きさせません。  <BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソニックスピンボール<sup>TM</sup></span></div>
</div>
