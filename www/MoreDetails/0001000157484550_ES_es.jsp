...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157484550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El famoso Hércules ha aceptado un desafío como ningún otro! Nuestro héroe tendrá que vencer a sus adversarios en una carrera a lo largo de reinos mitológicos y llegar el primero a la cima del Monte Olimpo.<br><br>

Puedes jugar como Hércules y ayudarle a devolver el trofeo sagrado, o jugar como cualquier otro de los múltiples personajes mitológicos, desde un sátiro a Poseidón, y conseguir el trofeo para ti.
<br><br>
Corre 3 copas a lo largo de 10 pistas ubicadas en 5 paisajes míticos y utiliza un increíble armamento fantástico para derrotar a tus adversarios: rayos de Zeus, tridentes, bolas de fuego y mucho más.<br><br>

¡Reúne a tus amigos para disfrutar de acción multijugador en pantalla dividida de 2 a 4 jugadores en los modos Campeonato, Carrera sencilla o Batalla!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
