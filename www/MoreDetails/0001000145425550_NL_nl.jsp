...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit oorspronkelijk in 1991 uitgegeven honkbalspel is niet zoals andere honkbalspellen. In de nabije toekomst zijn er twee liga’s met in totaal twaalf teams waaruit de speler kan kiezen en daarmee voor het kampioenschap kan gaan. De wedstrijden worden gehouden in het exclusieve Cyber Egg Stadium, waarin de homerunzone schrikbarend klein is en het buitenveld enorm wijd. Er is zelfs een stopzone waarin ballen worden gestopt zodra ze daar terecht komen. Naarmate het spel vordert worden er Crackers (mijnen) geïnstalleerd. Tijdens het spel kan er ook uitrusting worden aangeschaft om je spelers mee te versterken. Dit alles zorgt voor een unieke honkbalervaring. Je zult waarschijnlijk eerst een beetje versteld staan, maar zodra je eraan gewend bent en strategieën begint te vormen zul je misschien zelfs kunnen genieten van alle curveballs die in jouw richting worden geworpen.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">2020 SUPER BASEBALL</span></div>
</div>
