...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This shooter is the sequel to the masterpiece, "GRADIUS". Two years after its last epic battle, the GRADIUS army recommissions the "VIC VIPER" super-dimensional warplane to combat the invasion of a new nemesis known as "GOFER". Piloting the latest model of the VIC VIPER, players can select between multiple weapons and shields to tackle the varying stages and enemy attack patterns they come up against. With a total of 9 stages, this perfect port of the original boasts one of the longest adventures in the series and also features more trademark fast-paced music to accompany the intense action!<br><br>In-game text will include some Japanese.</div>
  <div id="image02">
