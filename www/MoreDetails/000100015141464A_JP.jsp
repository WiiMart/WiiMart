...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">昆虫たちが平和に暮らす「リファレンス王国」を舞台に、 かぶとむし族の王子「ダイナス」がとかげ軍団の将軍「サラマンダ」に立ち向かう、横スクロール型のアクションＲＰＧです。プレイヤーは「ダイナス」を操作して、てんとうむしの「スキャナ」や、くわがたむしの子「ガタロ」をおともに、各ステージにしかけられた数々のアクションにいどみます。とかげ軍団の攻撃には、宝箱から得られるアイテムでダイナスの攻撃力を上げて応戦。さらに「特殊アイテム」を入手することで、危険な砂漠地帯や海の中も探索可能になります。ゲーム中はアクション以外にも、スフィンクスとの三択クイズや、「オカリナ」で正しいメロディーを吹くと開く扉など、楽しい謎やトラップが満載。ひとつのゲームに色々な楽しさを詰め込んだ、よくばり＆ぜいたくな作品です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141464A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">超英雄伝説 ダイナスティックヒーロー<sup>&reg;</sup></span></div>
</div>
