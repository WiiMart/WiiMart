...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El malvado Dr. Eggman (Alias: Dr. Robotnik) se topa con una dimensión alternativa en la que unos extraños pájaros, conocidos como Flickies, tienen la habilidad de viajar a cualquier parte. Para poder encontrar las Esmeraldas del caos, el Dr. Eggman transforma los Flickies en robots para ayudarlo a reunir sus codiciadas gemas.  ¡Pero nuestro erizo favorito, Sonic, tendrá que intervenir y salvar al mundo! Métete en la piel de Sonic o Tails en esta aventura en 3D y recoge los anillos dorados para ayudar a liberar a los Flickies y derrotar al doctor.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D425545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D425545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sonic 3D Blast<sup>TM</sup></span></div>
</div>
