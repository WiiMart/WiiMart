...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ギリシャ神話をモチーフとした重厚な世界観と練り込まれたストーリー、個性豊かな登場人物や多彩な仕掛けが魅力のロールプレイングゲームです。人間の運命を司る女神「モイライ」は人間の未来を案じ、魂のみで９０００年もの間封印されていた青年を事件探求の旅に向かわせます。プレイヤーは体を持たない主人公を操作し、旅の途中に出会うさまざまな人間や動物の体を借りて、世界を救うため、さらには失われた自らの肉体を取り戻すために冒険を進めます。乗り移ることができる生き物の数は１００近くにおよび、その姿や居場所もさまざま。乗り移った体によって戦闘でできることが異なり、体を使いこなせば新たな技を覚えることも可能です。また、時間の流れや天気によっても戦闘状況が一変するので、同じ敵と戦っても全く異なる戦局を体験できます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ヘラクレスの栄光<sup>&reg;</sup>Ⅳ</span></div>
</div>
