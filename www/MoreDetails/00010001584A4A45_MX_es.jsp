...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001584A4A45')", "wiiSelectSound()");
...
<p>
Érase una vez... un lugar llamado Creepyland, donde zombis y vampiros convivían pacíficamente. Los vampiros mantenían secos a los zombis chupándoles su sangre y los zombis se comían a los vampiros que morían de viejos o enfermedad. Pero un fatídico día, todo esto cambió...
<br><br>
Ponte en la piel de un valiente vampiro, lidera la lucha contra los despiadados zombis y destruye todo lo que encuentres a tu paso, incluido el escenario. 
<br><br>
Dispondrás de multitud de armas e ítems que te ayudarán en tu aventura.
<br><br>
Modo historia con tres ambientaciones diferentes y enemigos finales.
<br><br>
Modo cooperativo y tres modos multijugador con hasta cuatro jugadores para que juegues en familia o con tus amigos.
<p>(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001584A4A45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001584A4A45/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Vampire Crystals Demo</span></div>
</div>
