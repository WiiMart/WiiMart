...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ＣＧアニメーションと立体的な画面が特徴的な横スクロールアクションゲーム。パワフルなドンキーとすばしっこいディディーコング、時にはアニマルフレンドたちと一緒に、多彩なアクションでコースクリアと隠されたステージやボーナス面を探してコース攻略率１００％を目指します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパードンキーコング<sup>&reg;</sup></span></div>
</div>
