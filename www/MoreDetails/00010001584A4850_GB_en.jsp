...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001584A4850')", "wiiSelectSound()");
...
<br><br>
Paint Splash turns your TV into an interactive canvas where kids of all ages can enjoy painting using the Wii Remote. Up to four people can paint at the same time so the entire family can participate in creating fantastic paintings using just your Wii Remotes.
<br><br>
Choose between several brushes and tools and paint in all the colours of the rainbow or activate Splash Mode where shaking the Wii Remote simply splashes paint on the screen, ideal for the youngest members of the family.
<br><br>
You can save your paintings on an SD card and transfer your creations to other devices such as a computer for printing and emailing.</div>
  <div id="image02">
