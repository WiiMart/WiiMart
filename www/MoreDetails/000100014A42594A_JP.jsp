...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ため押しでパワーをチャージして撃つショット「波動砲」や着脱自在の無敵装備「フォース」などの特徴的なシステムと、緻密で独特なグラフィックが話題を呼んだ横スクロール型シューティングゲーム「Ｒ－ＴＹＰＥ」シリーズの一作です。かつて人類が送り出した次元戦闘機「Ｒ－９」により絶滅したはずのバイド帝国が、数年後に異次元空間で急激な変化を遂げよみがえりました。逆襲にたかぶる新生バイド帝国を打ち破るべく、人類は強化型の戦闘機「Ｒ－９改」を送りこみます。最強武器「フォース」とともに、５種類のレーザーなど強化アイテムを使いこなして、全７ステージを戦い抜いてください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＳＵＰＥＲ　Ｒ－ＴＹＰＥ<sup>&reg;</sup></span></div>
</div>
