...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toma el control de la nave espacial Opa-Opa y avanza a través de varios niveles fantásticos mientras tratas de destruir todas las bases enemigas de cada fase. Cuando hayas destruido las bases, tendrás que vencer al jefe del nivel para pasar al siguiente. Si utilizas las pistolas y bombas adecuadamente, podrás derrotar a tus enemigos y explorar todos los escenarios divertidos de este juego de acción horizontal. También puedes comprar armas actualizadas para tu nave en la tienda. Varios juegos de SEGA han hecho referencia a la nave Opa-Opa durante los años; ¡ahora puedes jugar el juego que lo empezó todo!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fantasy Zone</span></div>
</div>
