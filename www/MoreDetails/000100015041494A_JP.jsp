...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">オノやブーメランを投げたり、時にはスケボーに乗ったり、高橋名人を操作して各エリアのＧＯＡＬ（ゴール）を目指す横スクロール型アクションゲーム。新冒険島はオリジナルの７つのステージで構成。各ステージの最後のエリアに待ち構える全てのボスを倒して、連れ去られた子供たちを解放することが目的です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041494A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041494A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">高橋名人の新冒険島<sup>TM</sup></span></div>
</div>
