...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードで大ヒットした人気対戦格闘ゲーム『ストリートファイターⅡ』シリーズ４作目です。グラフィックを一新したほか、キャミィなど４人のキャラクターが追加されました。メガドライブ史上最大容量となる４０メガビットROMを搭載したこの移植版では、トーナメントバトル、グループバトル、チャレンジバトルなどさまざまな戦いを楽しむことができます。バーチャルコンソール版ではニンテンドーWi-Fiコネクションにより当時の通信対戦を再現。オンラインで日本中のプレイヤーたちといつでも対戦を行うことが可能です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
