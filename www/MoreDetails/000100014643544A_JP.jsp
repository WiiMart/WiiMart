...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">現在までさまざまな続編が登場してきた人気アクションゲーム「ロックマン」シリーズの第一弾です。高い難易度でありながら、好きな順番で各ステージに挑戦できる構成や、それぞれのボスに設定された弱点武器などの斬新なシステムが好評を博しました。２００Ｘ年、工業用ロボットの第一人者であるライト博士によって作られた６体のロボットが、悪の天才科学者・ワイリー博士に改造されて暴走を始めました。ライト博士に、息子のようにかわいがられていた家庭用ロボット「ロック」は、戦闘用ロボット「ロックマン」となり、ワイリーの手によって暴走させられた６体のロボットの回収に向かいます。ワイリーの野望を打ち砕き世界の平和を守るため、「ロックマン」の戦いが始まります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン<sup>&reg;</sup></span></div>
</div>
