...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494145')", "wiiSelectSound()");
...
<p>
Toma el control de la vibrante línea de ritmo y dirígela por la pista mientras corres hacia la meta, inclinando el Wii Remote y pulsando el botón al compás de la dinámica música creada por 16bit, las superestrellas de este género musical. Tienes que ver para creer esta carrera con música electrónica hasta la línea de llegada. Pulsa cualquier botón al compás de la música a medida que las líneas verticales de percusión se cruzan con tu línea de ritmo. Evita las paredes y atraviesa las líneas de percusión para llegar al final del nivel, ¡y avanzar hacia mayores desafíos!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494145/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494145/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
