...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Nachdem Zeus, der Sagen umwobene griechische Gott, dich wieder zum Leben erweckt hat, ziehst du aus, um seine Tochter Athena aus der Unterwelt zu retten. Sammle auf deinem Weg die Spirit Balls auf, die deine Gegner zurücklassen! Sie geben dir Kraft und ermöglichen dir die Verwandlung in verschiedene mythische Lebensformen mit mächtigen Angriffskräften.<br><br>Englischer Bildschirmtext<br>Interlace-Modus mit dem Wii-Komponenten-Video-Kabel wird nicht unterstützt.</div>
  <div id="image02">
