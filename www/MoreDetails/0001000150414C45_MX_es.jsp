...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Un juego de disparo totalmente nuevo al estilo de “Star Soldier”!  Eres el piloto del caza de asalto “Soldier Blade” de la SIA (Special Intercepción Airforce). Enfréntate a los invasores de Zeograd con armas que cambian cuando coges un objeto de mejora. Puedes lanzar 3 tipos de ataques distintos dependiendo del color del objeto que cojas.  Novedades, como la opción “Gunbody” para evitar ataques, y el sistema “Burst Out”, con distintos efectos dependiendo del nivel de mejora, añaden un toque estratégico que requiere que decidas rápidamente qué objeto coger, y cuándo usar los ataques especiales.  ¡Te esperan increíbles batallas contra jefes al final de cada operación!  Juega el “DESAFÍO”, e intenta conseguir tantos puntos como puedas en el menor tiempo posible.  Con todas estas grandes novedades, ¡la cosa se pondrá que arde!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414C45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414C45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Soldier Blade<sup>&reg;</sup></span></div>
</div>
