...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You are Prince Ali, who has discovered a buried gold armlet. This armlet once belonged to a wizard who waged a long war against the evil wielder of a silver armlet. The silver armlet was used to create chaos and destruction, while the gold armlet had the power to summon four spirits: the water spirit "Dytto," the fire spirit "Efreet," the shadow spirit "Shade," and the plant spirit "Bow." To stop the person who has discovered the ancient silver armlet and is once again using it for evil, Prince Ali travels the land of Oasis, gradually acquiring the ability to summon the four spirits. Use your wits and speed to claim the silver armlet!</div>
  <div id="image02">
