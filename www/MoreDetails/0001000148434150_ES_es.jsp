...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El Canal Jam with the Band Live te permitirá montar tu propia "jam session" en la consola Wii... ¡utilizando tu televisión como amplificador!
<br><br>
Basta con descargar y acceder a este canal, y después seleccionar "Cómo conectarse" para recibir más información sobre cómo montar una Jam session Wii.
<br><br>
Toca tus canciones favoritas en solitario o con tus amigos, ¡e incluso anímate a cantar! (Eso sí, tu voz no se oirá a través del televisor.)
<br><br>
Hace falta una consola Nintendo DS por cada jugador, pero solo necesitarás una tarjeta de juego de Jam with the Band; los jugadores sin tarjeta de juego pueden conectarse mediante la descarga DS.
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434150/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434150/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canal Jam with the Band<sup>TM</sup> Live</span></div>
</div>
