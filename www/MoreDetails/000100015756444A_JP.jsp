...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015756444A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「あいうえ・おーちゃん」は、　親子の会話が広がる学習ソフト。ごっこ遊び感覚で、楽しい時間が共有できます。<BR>本ソフトはゲームとドリルがセットになった「いろまぜミキサー」ひとつが遊べます。そのほか29このゲームを追加で購入（有料）することもできます。<BR><BR>■自分の部屋が作れる<BR>好きな部屋を作って、おーちゃんと遊べます。いつも部屋にいて、電話やテレビからも語りかけてくれます。<BR><BR>■Wiiリモコンは魔法の杖<BR>Wiiリモコンをふって、ゲーム開始。付属の「いろまぜミキサー」で、ゲームとドリルが楽しめます。<BR><BR>■きょうだいで楽しめる<BR>３歳から７歳まで、月齢でレベルが変わり、設定の変更も可能。２歳半くらいから親子で楽しめます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015756444A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015756444A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">あいうえ・おーちゃん</span></div>
  </div>
