...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Speed into the future with F-Zero!  Pick one of four proton-powered hover cars—each with its own acceleration curve and design modifications—then race across 15 racecourses filled with challenges and pitfalls.  Strategy plays a big part in this speed fest, so you will need to find shortcuts, elude hazards, and snag power-ups if you want to beat the competition.  Keep an eye out for sand, land mines, magnets, and other trouble spots, but always be ready to get a boost from a speed or jump plate.  You'll need split-second reflexes to control these speed machines of tomorrow, so get ready for an experience that's out of this world!</div>
  <div id="image02">
