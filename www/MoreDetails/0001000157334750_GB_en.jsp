...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157334750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Phoenix Wright's third adventure comes to WiiWare!  The courtroom drama continues in Trials and Tribulations. New colourful characters, dramatic stories and gameplay - the defence never rests!  <br><br>
 
The third game in the popular Ace Attorney handheld franchise comes to WiiWare.  Five shocking new cases in first person perspective! "Psyche-Lock" feature - some witnesses hide the truth!  Use a line of questioning to reveal their inconsistent testimony. <br><br>

Two game play modes: <br><br>

Investigations - survey crime scenes, interview witnesses and gather evidence.<br><br>

Court - present findings, listen to testimonials, and examine witnesses.</div>
  <div id="image02">
