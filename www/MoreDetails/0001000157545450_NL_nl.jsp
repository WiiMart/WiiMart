...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157545450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Zijn naam is Toki Tori. Zijn bezigheid? Eieren verzamelen.<br><br>

In dit puzzel-/platformspel gebruikt de speler allerlei voorwerpen, waaronder de Telesprong, de Zelfrijzende Rots en de Slakkenslokker. Om de meer dan 70 levels uit te spelen, dienen deze voorwerpen op slimme wijze gebruikt en gecombineerd te worden. En de levels lopen op van makkelijk tot breinbrekend, wat zorgt voor vele uren puzzelplezier.<br><br>

Toki Tori maakt volledig gebruik van alles wat de Wii te bieden heeft. Zo zet het de Wii-afstandsbediening in voor een unieke besturing, die de speler op een nieuwe en ontspannen manier laat spelen. Een tweede speler kan helpen, door hints op het scherm te tekenen. Het spel maakt zelfs op unieke wijze gebruik van het Wii-prikbord!<br><br>

In het kort, Toki Tori:<bt><br>

- is een puzzel/platform-spel;<br>
- zorgt voor vele uren speelplezier;<br>
- gebruikt meerdere Wii-afstandsbedieningen voor een nieuwe speelstijl;<br>
- gebruikt het Wii-prikbord;<br>
- heeft Nederlandstalige spelteksten en handleiding</div>
  <div id="image02">
