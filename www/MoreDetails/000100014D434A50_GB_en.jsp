...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Splatterhouse 2, released only on the SEGA MEGA DRIVE, is the sequel to the popular Splatterhouse. It was one of the first games to have truly violent content.<br><br>A few months after escaping the first mansion in Splatterhouse, Rick once again encounters the Terror Mask, and must use its powers to rescue his beloved Jennifer. Rick will need to punch, slash, smash and chainsaw his way through waves of unspeakable horrors and terrifying bosses, navigating a gruesomely haunted mansion in order to rescue his girlfriend and escape with his life!</div>
  <div id="image02">
