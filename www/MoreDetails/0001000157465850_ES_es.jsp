...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157465850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En la estación más fría del año es cuando a uno más le apetece el fuego acogedor de una chimenea. Sin embargo, no todo el mundo tiene la posibilidad de acurrucarse frente a una en su hogar. ¡Tu nueva chimenea de WiiWare da un toque especial a cualquier habitación!
<br><br>
Puedes escoger entre diferentes tipos de leña y apilarla con el mando de Wii. Después solo tienes que encender la cerilla y tu hogar se convertirá en un espacio cálido y agradable. Dispones de un total de seis ambientes diferentes: fuego puro, fogata, chimenea rústica, chimenea clásica, chimenea elegante y chimenea zen.<br>
Aviva el fuego y procura que no se apague. Coloca troncos nuevos que se quemarán como si se tratase de un verdadero fuego. ¿Lo único que quieres es relajarte? No hay problema: en el modo mayordomo los troncos se van reponiendo automáticamente y en el modo continuo la leña nunca acaba de consumirse.
<br><br>
¡Te esperan un agradable sonido crepitante y un fuego real como la vida misma para que no te falte nada, incluso cuando no hace frío!

<br><br>
- Seis ambientes diferentes: fuego puro, fogata, chimenea rústica, chimenea clásica, chimenea elegante y chimenea zen.<br>
- Sonido ambiental acogedor.<br>
- Simulación física realista gracias a la tecnología PhysX® by NVIDIA.<br>
- Cuatro funciones de juego: mayordomo (los troncos se reponen automáticamente), continuo (los troncos no se consumen), estándar (fuego creado previamente en la chimenea que elijas), individual (escoge tú mismo la leña y ponla en la chimenea).<br><br>
 Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157465850/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157465850/FFFD000E" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mi chimenea</span></div>
</div>
