...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Negli ultimi 3 giorni i sistemi informatici militari delle più grandi potenze del mondo hanno riscontrato dei problemi di sicurezza. In tutti i casi l'infiltrato ha raggiunto l'unità che controlla il lancio dei missili. Esiste una sola persona capace di una simile impresa: il professor Elvin Atombender.
<br><br>
Forte delle fortune ammassate durante incursioni in vari istituti finanziari, il professore ha costruito un'enorme fortezza sotterranea completamente informatizzata. Qui, isolato dal resto del mondo, Elvin ha trascorso gli ultimi quattro anni cercando di penetrare i sistemi informatici delle forze armate di tutto il mondo. Con successo.
<br><br>
Il nostro computer stima che tra esattamente sei ore Elvin riuscirà ad ottenere i codici di lancio per un attacco missilistico che distruggerà il mondo intero. 
Questo è il tempo che ti resta per completare la tua missione!
<br><br>
