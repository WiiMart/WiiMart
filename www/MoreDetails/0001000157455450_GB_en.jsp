...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157455450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">PictureBook Games: A Pop-Up Adventure is a board game with a difference: instead of using a typical game board, it takes place in an animated pop-up book complete with charming paper cut-out characters!
<br><br>
...
<br><br>
In PictureBook Games: A Pop-Up Adventure, the world might be flat but there’s still plenty of depth!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455450/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157455450/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
