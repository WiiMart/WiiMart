...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157474C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gene Labs es un juego de rompecabezas de estilo arcade ambientado en el mundo de los experimentos genéticos. Un nuevo virus, capaz de modificar genéticamente cualquier organismo viviente, se está esparciendo por todo el mundo. La única esperanza es curar las células infectadas inyectando una solución antivirus bajo un microscopio.
<p>
El objetivo del juego es distribuir la solución antivirus entre todas las células visibles bajo un microscopio, antes de que las células sean infectadas por un mortal virus y sus mutaciones. Arrastra la solución sobre las células infectadas para eliminar los virus y sanar las células antes de que se infecten con el virus.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157474C45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157474C45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Gene Labs</span></div>
</div>
