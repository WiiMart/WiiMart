...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８９年１月４日に発売されたファミリーコンピュータ用アクションゲームで、『がんばれゴエモン!からくり道中』の続編。主人公を操作して敵をやっつけ、いろいろな障害を乗り越えてください。日本諸国を旅してカラクリ城を探し出し、財宝を手に入れましょう。<BR><BR>○関所を通るには、通行手形を３つ集めてください。<BR>○がまぐちやひょうたんを飛び越えて、小判やアイテムを手にいれましょう。<BR>○店で品物を買って、パワーアップしましょう。<BR>○プレイヤーはライフ制です。敵からダメージを受けるとライフメーターが減り、ライフメーターがなくなると１回アウトとなり、プレイヤー数が減ります。<BR><BR>プレイヤーが全てアウトとなるとゲームオーバーとなります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">がんばれゴエモン２</span></div>
</div>
