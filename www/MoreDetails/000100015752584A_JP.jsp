...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015752584A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ありがとうございます。ロックマンはファンの皆様に支えられ、記念すべきシリーズ10作目を出すことができました。今回は、より多くのユーザーに気軽に老舗の味を楽しんでいただきたいというコンセプトのもと、8ビット風グラフィック＆サウンドを継承しつつ、シリーズ初となるイージーモードを搭載しました。もちろんファンサービスも忘れておりません。前作では追加コンテンツだったブルースが最初から使用できるほか、タイムアタックではリプレイ機能を搭載。世界ランカーのプレイ動画を楽しめます。さらにマニアも納得の追加コンテンツも用意してあります。ロックマン、20年以上続く面白さがここにあります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015752584A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015752584A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン<sup>&reg;</sup>１０</span></div>
</div>
