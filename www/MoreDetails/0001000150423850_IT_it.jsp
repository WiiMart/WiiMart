...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prova questo sparatutto a scorrimento verticale che ha entusiasmato pubblico e critica con le sue incredibili qualità tecniche e di giocabilità.
Prendi i comandi dell’“Incrociatore Stellare Gunhed” e affronta lo “Squadrone Oscuro“ che vuole invadere la Terra. Raccogli i potenziamenti per la tua astronave e affronta 9 LIVELLI di gioco in cui dovrai abbattere schiere di avversari e sconfiggere i boss nemici che ti sbarreranno l’accesso all’area successiva.
<br><br>
Come gli altri titoli della serie “Soldier”, Blazing Lazers miscela azione ad alta velocità, duelli contro avversari letali e una colonna sonora coinvolgente. Inoltre il “Tuono distruttivo”, che può spazzare via tutti i nemici in un’unica ondata, ti regalerà tantissimi momenti di soddisfazione! Con il suo livello di difficoltà perfettamente bilanciato, Blazing Lazers è uno sparatutto che divertirà e impegnerà sia gli appassionati del genere che i giocatori meno esperti!
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150423850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150423850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Blazing Lazers</span></div>
</div>
