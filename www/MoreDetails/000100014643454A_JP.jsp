...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８７年にファミリーコンピュータ・ディスクシステム用として発売されたアクションＲＰＧです。プレイヤーは超能力を持つエスパーの少年となって、自分の住む世界とは別のふしぎな世界で５つのワールドを冒険します。世界に点在する村で住人と話して情報を得ながら、３段階の「銃」と数々の超能力を駆使して敵を倒し、ナルシス族にさらわれたレンガ村の村長の娘「アリス」を助け出します。ナルシス族のボス「ギーラ・サウザン」を倒し、自分の世界へ帰るために、この世界の謎を解き明かしてください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エスパードリーム<sup>&reg;</sup></span></div>
</div>
