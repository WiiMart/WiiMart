...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157564B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">バンバン☆キッズは水鉄砲で相手と戦うコミカルなＦＰＳゲームです。
プレイヤーが戦う、公園、ビーチ、広場、自然公園などの各マップはゲーム開始時に自動生成され、毎回異なった戦略で遊ぶことができます。<BR>ゲームモードは、ひとりで遊ぶミッションモードとＣＰＵ対戦、ふたりで遊ぶ画面分割対戦があります。<BR>また、ニンテンドーWi-Fiコネクションに接続すると、世界中の相手と最大８人で遊んだり、ランキングへの参加もできます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バンバン☆キッズ<sup>TM</sup></span></div>
</div>
