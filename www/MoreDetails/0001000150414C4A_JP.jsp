...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">名作「スターソルジャー」の系譜に連なる、縦スクロールシューティングゲーム。SIA(Special Interception Airforce)特別迎撃空軍のパイロットとして、重戦闘機「ソルジャーブレイド」をあやつり、押し寄せる敵に立ち向かいます。自機はゲーム中に現れるパワーアップアイテムを取ることで、色に応じた３種類の攻撃を繰り出すこ
とが可能。また、敵弾を防ぐことができるオプション「ガンボディ」やパワーアップの状態と連動する「バーストアウト」システムの追加により、アイテムのとり方や特殊攻撃のタイミングなど、戦略的な判断も重要です。戦闘はシリーズ特有の爽快感にあふれ、あらゆる場面に散りばめられた大小多数の演出は必見です。そして各オペレーションの最後に持ちうけるボスキャラが、さまざまな仕掛けでプレイにアクセントを与えます。シリーズでお馴染みの「キャラバンモード」も搭載されており、スコアアタックも楽しめます。<br><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414C4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソルジャーブレイド<sup>&reg;</sup></span></div>
</div>
