...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">２人のヒーローが悪の組織に闘いをいどむ、横スクロール型格闘アクションゲームです。プレイヤーはホークとトニーの２人の刑事から１人を操作し、犯罪組織「ＪＡＤＯＨ」にとらえられたホークの恋人を救出するため、闇の九龍街の５つのステージを闘います。港、廃屋、異人街などで次々と襲いかかってくる「ＪＡＤＯＨ」の手下を打ち倒し、各ステージのボスと対決して、「ＪＡＤＯＨ」の総本部「ジャポネスク・ガーデン」をめざします。コマンド入力で繰り出す技は「投げ技」「連続技」「ジャンプ技」そして「必殺技」に分けられます。ただしホークは空手、トニーはパワー系と攻撃スタイルが異なるため、同じ入力でもキャラによって違う技となる点がポイントです。
サイズの大きいキャラクターが放つ必殺技は、豪快にして華麗。臨場感あふれるサウンドがハードボイルドな雰囲気を一層盛り上げます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クレスト オブ ウルフ</span></div>
</div>
