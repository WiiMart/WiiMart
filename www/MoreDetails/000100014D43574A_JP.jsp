...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">セガ体感ゲームシリーズ第８弾の移植となる３Ｄシューティングゲームです。遠い銀河の果て、平和な日々を送っていた「ジュノス恒星系」に突如侵略を始めた「第四帝国」に対抗するため、銀河連邦が誇る最新鋭戦闘機「ＴＲＹ－Ｚ」が、さまざまな星や宇宙空間を舞台に戦いを繰り広げます。ロックオンミサイルとバルカンの２種類のショットとスピードコントロールを駆使して、洞窟や要塞の中を進み、各惑星に建造された５つのコアを破壊すれば、敵最終要塞の待つハイパースペースへと進むことができます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ギャラクシーフォースⅡ<sup>TM</sup></span></div>
</div>
