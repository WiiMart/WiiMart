...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Si respira aria di leggenda sulla Virtual Console: è in arrivo Gaplus, il seguito del mitico Galaga!
<br><br>
Come nel celebre predecessore, comandi un'astronave in missione solitaria, alle prese con una miriade di invasori alieni. Il pianeta Terra è spacciato senza il tuo aiuto! Missione impossibile? Niente affatto! Potrai potenziare la tua nave con numerose Testate Blaster, fra cui la Falange e il Sidewinder. Alcune di esse ti permetteranno di catturare dei nemici e schierarli al tuo fianco!
<br><br>
Gli alieni stanno per sferrare l'attacco: armati di coraggio e annientali, sei la nostra unica speranza!
<br><br>
