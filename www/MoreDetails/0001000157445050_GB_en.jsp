...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157445050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">With the Dr. Mario Demo, you can sample some of the online action of Dr. Mario for WiiWare.
<br/><br/>
This demo allows you to connect to a friend who has the full version of the game (Dr. Mario & Germ Buster) to play two-player matches against each other via Nintendo Wi-Fi Connection.
<br/><br/>
Please note that this online demo does not include any offline single player or multiplayer modes, or the Germ Buster mode.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157445050/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157445050/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
