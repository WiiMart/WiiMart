...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Jam with the Band Live Channel lets you set up your very own jam session on a Wii console – using your TV as a speaker!
<br><br>
Simply download and start this Channel, then select "How to Connect" for more details on how to set up a Wii Jam Session.
<br><br>
Play your favourite tunes either solo or with friends! You can even perform on vocals. (Please note that your voice will not be heard through the TV.)
<br><br>
One Nintendo DS is required for each player, but only one Jam with the Band Game Card is needed - players without a Game Card can connect using DS Download Play.</div>
  <div id="image02">
