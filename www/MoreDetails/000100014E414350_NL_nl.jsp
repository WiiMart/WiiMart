...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Legend of Zelda: Ocarina of Time, dat in de winter van 1998 wereldwijd werd uitgebracht, was direct een hit en vestigde in rap tempo zijn reputatie als een van de beste spellen aller tijden.
<br><br>
Als de legendarische held Link reis je door Hyrule en zelfs door de tijd om de plannen van Ganondorf te dwarsbomen. Je gebruikt diverse wapens en handige snufjes, vecht tegen reusachtige bazen en lost pittige puzzels  op die worden gerekend tot de beste uit de Zelda-reeks.
<br><br>
Ocarina of Time heeft op briljante wijze het 2D-bovenaanzicht van de oudere klassieke Zelda-avonturen naar 3D vertaald, waardoor het uitgroeide tot een schoolvoorbeeld van spelontwerp, dat tegenwoordig nog steeds nagevolgd wordt.
<br><br>
Maar de aantrekkingskracht van ‘Ocarina’ schuilt niet alleen in zijn filmische beelden en baanbrekende vechtsysteem – de epische verhaallijn, memorabele personages, magnifiek ontworpen kerkers en gevarieerde spelactiviteiten zijn minstens zo indrukwekkend. Kortom, een meesterwerk!
<br><br>In het spel kan worden gekozen voor Engelse, Duitse of Franse schermteksten.</div>
  <div id="image02">
