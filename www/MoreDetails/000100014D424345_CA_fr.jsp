...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The local arcade is packed with kids, all lining up to play the latest, most realistic video game they've ever seen. It's called Wild Side, and it uses holographic images to immerse the player in a strange world. But there's a problem... Kids are literally getting sucked into the game, and now several of them are trapped. Throughout more than 100 levels, you'll take on several different forms, such as a Berzerker, a Micromax, a Maniaxe, or a Skycutter, which will make you much more powerful. It's up to you, Kid Chameleon, the best gamer in town, to get yourself inside the game so that you can defeat the game’s boss and bring your friends back to reality.</div>
  <div id="image02">
