...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Esta es la versión para PCEngine (Turbografx) del clásico juego de lucha para dos jugadores. 
Para la adaptación se utilizó en su momento una HuCARD de gran capacidad, permitiendo recrear fielmente el dinamismo del arcade original y sus características, incluyendo sus fases bonus y sus efectos de sonido.
<br><br>
Los jugadores podrán elegir uno de los doce personajes y hacer frente a sus adversarios en una lucha sin cuartel para determinar quién es el mejor luchador. 
¡Domina los movimientos especiales y combos de un personaje para derrotar a rivales de todos los rincones del mundo! 
<br><br>
El modo “V.S. BATTLE” incluye una útil función de hándicap. 
¡Utilizando esta función para modificar el rendimiento de un personaje, un jugador inexperto puede enfrentarse en igualdad de condiciones a un jugador veterano y disfrutar de una intensa experiencia en un combate mano a mano! 
<br><br>
Textos de pantalla en inglés con algunos caracteres en japonés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150444A4C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150444A4C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">STREET FIGHTER<sup>TM</sup> II': </span></div>
</div>
