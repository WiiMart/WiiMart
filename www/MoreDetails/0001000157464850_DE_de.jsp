...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157464850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lenke einen endlosen Flugzeugstrom in diesem Megahit mit Suchtfaktor von Firemint!
Schlüpfe in die Rolle eines Fluglotsen auf einem Flughafen mit Hochbetrieb. Führe alle Flugzeuge sicher auf den Boden und verhindere Zusammenstöße!
<br><br>
Klingt leicht? Je mehr Flugzeuge ankommen, desto wichtiger werden eine kluge Strategie, gutes Augenmaß und Fingerspitzengefühl, um das Chaos zu beherrschen. Zeige einfach mit der Wii-Fernbedienung auf die Flugzeuge und ziehe einen Pfad zu ihrer Landezone. Im Drop-in/Drop-out-Mehrspielermodus für bis zu vier Spieler kannst du den Luftraum sogar zusammen mit Freunden oder deiner Familie überwachen!
<br><br>
Erlebe fünf verschiedene Flughäfen, darunter das australische Outback und einen Flugzeugträger. Spiele mit zehn unterschiedlichen Flugzeugtypen wie Jets, Wasserflugzeugen und Helikoptern.
Flight Control kannst du in nur einer Minute beherrschen – aber glaub ja nicht, dass du auch so schnell damit wieder aufhörst!
<br><br>
Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464850/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464850/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Flight Control<sup>TM</sup></span></div>
</div>
