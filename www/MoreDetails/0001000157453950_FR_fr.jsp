...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157453950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Alien Crush Returns est l'ultime réincarnation d'Alien Crush, le légendaire jeu de flipper sur Turbografx. Avec une jouabilité totalement remaniée, il s'agit d'une expérience exceptionnelle Wii à ne manquer sous aucun prétexte ! <br><br>Alien Crush Returns possède tous les éléments caractéristiques d'un véritable flipper, recréés dans un univers graphique au style biomécanique unique ! Le nouveau système "Action Ball" renouvelle le concept du genre pour enrichir considérablement le jeu et ajouter une dose d'action supplémentaire.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157453950/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157453950/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
