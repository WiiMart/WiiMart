...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ギリシャ神話の世界をモチーフにした縦スクロール型シューティングゲームです。遠い昔。オリンポスの長「ゼウス」によって倒された恐ろしい邪獣「デュポン」が復活し、月の女神「アルテミス」を連れ去ってしまいました。プレイヤーは若き太陽神「アポロン」を操作し、愛するアルテミスを救うべく、天馬ペガサスに乗って戦いの旅に出ます。チャプター（ステージ）は全部で７つ。各チャプターの最後には、「メデューサ」「セイレン」「ケルベロス」など、神話の有名な魔物たちがボスとして待ち受けており、
ボスを倒すと次のチャプターに進みます。ゲージをためて発射するパワーアップ弾や、自機と一緒に攻撃するオプションなどのアイテムを駆使しながら、打倒デュポンをめざして戦いましょう。各チャプタークリア時に登場するアルテミスのグラフィックも話題を呼びました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">フェリオス<sup>&reg;</sup></span></div>
</div>
