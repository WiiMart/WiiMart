...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８８年にＭＳＸ２用ソフトとして発売された、縦スクロール式シューティングゲームです。プレイヤーは最新鋭戦闘機「ＡＬＥＳＴＥ（アレスタ）」に乗り込み、突如暴走した環境維持コンピュータ「ＤＩＡ５１」を破壊するため８つのエリアを攻略していきます。メインウェポンのノーマルショットと、プラズマボール、レーザーといった特徴の異なる８種類のサブウェポンの中から１つを組み合わせて使用することで、多彩な攻撃をおこなうことができます。また、サブウェポンはゲーム中にアイテムを獲得することで自由に変更することができ、装備中のサブウェポンアイテムを複数獲得することで、攻撃力の強化も可能です。プレイヤーの遊び方次第でゲームの難易度がリアルタイムで変化することと、独特のグラフィックが人気を呼んだ、ＭＳＸソフトの代表作の一つです。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ALESTE</span></div>
</div>
