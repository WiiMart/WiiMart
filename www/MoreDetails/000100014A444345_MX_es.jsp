...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La emoción de Street Fighter Alpha 2 llega a tu pantalla con toda la acción rápida y elementos innovadores que brindó este título en su momento. Las nuevas formas para realizar contraataques especiales rápidos (Quick Move Reversals), contraataques Alpha (Alpha Counters) y el increíble sistema de combos (Custom Combo System) lograron establecer un nuevo estándar para los juegos de pelea. Usa tus habilidades al máximo y descubre los nuevos movimientos y contraataques ocultos de cada personaje. Neutraliza los ataques de tu oponente con los contraataques Alpha altos y bajos, ejecuta increíbles combos personalizados para crear un arsenal completo de ataques. Todos tus guerreros favoritos regresan para un nuevo combate. Los personajes Dan, Akuma y Bison que anteriormente estaban ocultos ahora aparecen y a ellos se les unen cinco nuevos combatientes: Rolento, Gen, Sákura y también Dhalsim y Zangief que son clásicos favoritos.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A444345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A444345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Street Fighter<sup>&reg;</sup> Alpha 2</span></div>
</div>
