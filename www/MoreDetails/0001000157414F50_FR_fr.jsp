...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157414F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Very Hungry Caterpillar's ABCs est un jeu éducatif qui permet aux parents et aux enfants de se familiariser avec l'anglais de base tout en appréciant un jeu ensemble.<br><br>

Le jeu se compose de quatre parties, incluant un alphabet amusant mettant en vedette des lettres colorées et des images d'Eric Carle, ainsi qu’un quiz de vocabulaire à destination des enfants d'âge préscolaire qui comprend des mots tels que les nombres, les couleurs, les formes, les noms d'animaux et des verbes simples et des adjectifs tels que "run" (courir), "eat" (manger) et "big" (gros).<br><br>

Les parents peuvent utiliser le menu “To The Parents” pour vérifier les progrès de leurs enfants dans leur apprentissage des mots de vocabulaire. <br><br>

Votre famille entière est sûre d'apprécier les illustrations colorées d’Eric Carle, l'auteur de livres d'images de renommée internationale. 
