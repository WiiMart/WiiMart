...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Te presentamos Family Go-Kart Racing, ¡el nuevo juego de carrera de Arc System Works! La familia vuelve otra vez: ¡Billy, Sarah, Papá, Mamá, además de las nuevas adiciones, Tía y Abuelito! ¡Escoge entre los seis miembros de la familia y seis karts para enfrentarte en doce pistas emocionantes e ir a la deriva al camino hacia la victoria! ¡Inclina el Wii Remote, y compite contra el reloj en Time Attack (Ataque Contrarreloj) para batir tus récords personales, o compite contra la familia entera en una carrera Grand Prix! Maneja por los caminos entre las Snowy Slopes (Cuestas Nevadas), pela goma en el World Bazaar (Bazar Mundial), y va-va-vaya por la medalla de oro en el Go-Go Rollercoaster (La Montaña Rusa)! ¡Establece tu puesto como el jefe de la familia maniobrando contra tus parientes con ítems especiales como Acceleration (Acceleración) y Lightning (Relámpago) para pasar por tus oponentes! ¡O desencadena la Bowling Bomb (Bomba de Boliche) y destruye al kart enfrente de ti!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464B45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464B45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Family Go-Kart Racing</span></div>
</div>
