...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">吸血鬼とベルモンド一族の長きに渡る確執をえがいた、人気シリーズ１０作目の横スクロール型アクションゲーム。一族最強のヴァンパイアハンター「リヒター・ベルモンド」が、百年の時を経てよみがえった悪魔城の主「ドラキュラ伯爵」と対決します。プレイヤーは「リヒター」を操作して、悪魔城の全９ステージに仕掛けられた数々のトラップや謎にいどみます。先祖伝来の「ムチ」や、破壊力抜群の「アイテムクラッシュ」などを駆使して敵を倒してください。伯爵との対決までの道のりには、全部で４つの隠しステージが存在。また、あるステージの途中で「マリア」を救出すると、２人目のキャラクターとして選択可能になります。耽美でゴシックホラーな世界観をはじめ、すぐれたゲームバランスやＣＤ音源を生かしたＢＧＭなどが話題となりました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">悪魔城ドラキュラ<sup>&reg;</sup>X 血の輪廻</span></div>
</div>
