...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157505550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">„PUZZLE BOBBLE Plus!“ ist ein einfaches aber gleichzeitig ungemein fesselndes Puzzle-Spiel, in dem eine Ansammlung bunter Blasen mit der höchsteigenen Blasenkanone zum Platzen gebracht werden muss! Sobald mehr als drei Blasen derselben Farbe zusammengefügt werden, platzen sie. Das Spiel bietet zwei verschiedene Modi: den Puzzle-Modus, in dem die 135 Level des Spiels auf der Jagd nach Highscores und Bestzeiten absolviert werden, und den Battle-Modus, in dem sich Spieler mit Freunden oder computergesteuerten Gegnern erbitterte Puzzleschlachten liefern können. <br><br>

Wem all das noch nicht genügt, der kann noch 270 weitere Level in den beiden erhältlichen zusätzlichen Spielinhaltspaketen erwerben, also jeweils 135 brandneue Level! „PUZZLE BOBBLE Plus!“ bietet eine süchtig machende Kombination aus leichtem Einstieg und hoher Spieltiefe. Auf geht's!<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
