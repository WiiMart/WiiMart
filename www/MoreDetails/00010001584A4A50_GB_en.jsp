...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001584A4A50')", "wiiSelectSound()");
...
<br><br>
Once upon a time... in a place called Creepyland, where zombies and vampires coexisted peacefully, vampires kept the zombies well drained by sucking their blood and zombies ate vampires that died from old age or illness. But on a fateful day, all this changed...<br>
Transform yourself into a brave vampire and lead the fight against the ruthless zombies. Destroy everything you come across, including the stage. <br>
You will have lots of weapons and items to help you in your adventure.<br>
Story mode with three different worlds and final enemies. <br>
Co-op mode and three multiplayer modes for up to four players so you can play with your friends and family.</div>
  <div id="image02">
