...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001575A5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A crumbling mansion is home to a most peculiar picture book. Gather your courage and open the door to this odd, unsettling, and slightly scary tale. Solve innovative puzzles by using the Wii Remote to throw animated paper bears into the picture book's unusual pages. Grab all of the red sweets found inside with careful placement of your bears and clever manipulation of the unique environments. Delve into the unfolding drama of Pina, the mysterious young girl residing in the mansion. Thirty exciting and challenging stages await you!<br><br>

The simultaneous release "Chaotic Conflicts" is a parallel game with its own tale and battle-oriented stages. Complete both games to uncover an even deeper mystery...</div>
  <div id="image02">
