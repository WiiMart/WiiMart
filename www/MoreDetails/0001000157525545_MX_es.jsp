...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157525545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP RUNNER: ¡El juego de acción y plataformas más rápido y emocionante disponible en WiiWare!
<p>
...
<p>
¡Únete a CommanderVideo en BIT.TRIP RUNNER en su viaje más épico!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157525545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157525545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
