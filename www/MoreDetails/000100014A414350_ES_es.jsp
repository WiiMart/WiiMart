...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En el año 2560, el trofeo más codiciado es el del campeonato F-Zero. Pilotos de todos los rincones de la galaxia arriesgan el pellejo por el primer puesto a los mandos de sus veloces naves en peligrosos circuitos de toda la galaxia. Descubre o revive el inolvidable juego de carreras de Super Nintendo. Exprimiendo hasta la última gota el efecto especial denominado "Mode 7", F-Zero™ redefinió la noción de velocidad en los juegos de carreras. Los circuitos, plagados de trampas mortales, deben ser apurados al máximo por jugadores ávidos de arañar tiempo al reloj en el modo de entrenamiento. Su banda sonora es una de las más famosas del mundo de los videojuegos. <br><br>Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
