...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157505050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Erlebe mit Family Table Tennis das schnellste Tischtennisspiel der Welt!

Eine ebenso intuitive wie aufregende Steuerung sorgt für nervenzerreißende Tischtennisduelle mit der ganzen Familie.

Meistere die Steuerung und die Spezialangriffe und spiele spektakuläre Bälle!
<br><br> 
Zwei Spielmodi: Einzelspieler und Duell für einen oder zwei Spieler.

Drei exklusive Minispiele zum Trainieren deiner Fähigkeiten.
<br><br>
Wähle zwischen vier Spielerprofilen.

Auch du kannst am unglaublichsten Turnier aller Zeiten teilnehmen.  <br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505050/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
