...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This updated version of the Mii Contest Channel includes the ability to call all your previously-posted Miis in the Posting Plaza, and support for Parental Controls.
<br><br>
The Mii Contest Channel works together with the Mii Channel, letting you share your favourite Miis with other Wii owners, and take part in fun, themed Contests.
<br><br>
Visit the Posting Plaza to view the latest and most popular Miis, and post your own Miis for others to see. If any Miis catch your eye, simply save them to your Favourites list or even ‘take them home’ by importing them to the Mii Channel.
<br><br>
And if you want to put your Mii-making talents to the test, or simply play judge, check out the Mii Contests. Contests are themed around a certain character or subject, and are updated regularly with fresh Mii-making challenges.
<br><br>
You might even receive a souvenir photo of your Mii, simply by taking part. And who knows? Gain enough votes and you can become a Master Mii Artisan!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415050/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415050/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mii Contest Channel</span></div>
</div>
