...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Upon its release in 1992, Super Mario World™ set the benchmark for platform games throughout the 90s. Simple to play yet challenging to master, Super Mario World™ stands the test of time with its 70+ levels riddled with secrets. Join Mario and Luigi on their trek through Dinosaur Island to rescue Princess Peach from the diabolical Bowser. Also lending a hand is Yoshi, seen here for the first time as a ride for our heroes, who can gobble up enemies and spit fireballs. Super Mario World™ also introduced the cape power-up that bestows the power of flight, and also the option to hold a power-up in reserve for when you need it most. Renowned by press and public alike as one of the greatest games ever made, Super Mario World™ is a true classic now available on Virtual Console.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
