...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is a fighting game released in 1993, pitting 15 different fighters against each other. The cast includes the original eight characters from Fatal Fury 2, as well as three new characters (Billy, Axel and Laurence) and a new boss (Wolfgang). Finally, three characters from the original Fatal Fury (Duck, Dan and Geese) have returned to the fight. By building on the appeal from the previous game with its two-line battles, special moves, and powerful finishers, and further improving on the series' formula, this game is truly worthy of the title "special." Also, if certain special conditions are met, special guest Ryuu Sakazaki will make an appearance, which in itself is noteworthy.</div>
  <div id="image02">
