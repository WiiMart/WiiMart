...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bomberman '93 is the exciting, powered-up version that followed the original Bomberman!  With 6 rounds, each containing 8 stages, the single-player Normal Mode provides all the fun you can handle in its 48 different stages!  Blast all of your enemies and find the hidden exit within the time limit to progress to the next stage.  The “kick” function appears for the first time in this version of Bomberman, and you can really start using cunning tactics in your game play!  Make the most of the traps and the new items to beat the game with a perfect record!  Up to 5 players can play in the Battle Game, and all the new tricks and devices (like the conveyor belt) are sure to guarantee a heated battle!<p>When battling with multiple players, you must connect the same number of Wii Remotes or Nintendo GameCube Controllers as the number of players.  To play with 5 players, you will need at least 1 Nintendo GameCube Controller.</div>
  <div id="image02">
