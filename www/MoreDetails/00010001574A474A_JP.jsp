...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574A474A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">あの『人生ゲーム』が家族や友達みんなでお気楽、気軽に遊べます。<BR><BR>■ゲームルール<BR>アジアを舞台に短い時間で手軽に遊べる人生ゲームです。<BR>ゲーム中に起こるイベントはテキストで展開。素早いテンポで短時間で遊べます。<BR><BR>8人のカワイイキャラと8種類の職業の中から自分のキャラクターを選んで、ゲームスタート。<BR>マップ上での転職は行えないので、最初の職業選択は慎重に。<BR>マップはゴールマスがない周回型となっています。
順番にルーレットを回してマスを進みマップのコースを周回しましょう。<BR>全てのプレイヤーがルーレットを15回まわした時点でゲーム終了。最後のプレイヤーの順番が終わったときに一番多くのお金を手にしたプレイヤーが勝ちとなります。<BR><BR>■ご注意<BR>※本Wiiウェア『人生ゲーム』はWii専用ディスク『人生ゲームWii EX』を再構成した商品となります。遊べるマップなどのゲーム内容やルールが一部異なりますので、ご注意ください。<BR>※このソフトはボードゲームの『人生ゲーム』とは、内容や遊び方が異なります。<BR>※このソフトには「結婚・出産」イベント、ミニゲームは収録されておりません。<BR>※遊ぶ事が出来るボードは、アジアマップのみとなります。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574A474A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574A474A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">人生ゲーム</span></div>
</div>
