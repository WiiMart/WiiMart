...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rejoin Alex Kidd in this platformer from the 1980s. Help Alex in a race against time to find the twelve missing zodiac signs hidden in six challenging levels including toyland, the robot factory, and an outer-space level, all complete with crazy enemies.</div>
  <div id="image02">
