...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157554250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bereid je voor op een gloednieuwe ervaring... bij het spelen van je favoriete bordspel! Ubongo is een spel voor de hele familie. De regels zijn eenvoudig: je lost puzzels op om gekleurde edelstenen te bemachtigen.
<br><br>
Dit bordspel is een enorm succes in landen als Duitsland, waar Ubongo een van de bestverkochte bordspellen is. Er zijn 1.000.000 exemplaren van verkocht in Duitsland en het spel heeft vele prijzen gewonnen, waaronder de prijs voor het Beste Familie Spel in Zweden en Spel van het Jaar in Noorwegen en Finland.
  <br>Het spel is speelbaar op vier verschillende manieren:
<br><br>
History Mode (verhaal) <br>
Quick Game (snel spel) <br>
Time Attack (race tegen de klok) <br>
Multiplayer (Speel tegen drie vrienden op hetzelfde systeem.)<br><br>
Het spel is voorzien van Engelse schermteksten.<br></div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554250/FFFD0019" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554250/FFFD001A" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
