...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アメリカで大ヒットしたロボットアクションシューティング。まるで生き物のようななめらかな動きは必見です。毒物に汚染された地球を再び青く美しい姿に戻すために開発された、惑星清掃用ロボット“オーボット”。反乱によって地球上のロボットたちを配下に従えた、悪のオーボット「ウォーヘッド」の野望を砕くため、人類最後の希望であるオーボット「ベクターマン」が大冒険をします。腕に付いたショットと脚についたブースト機能を駆使して、立ちふさがる敵を倒し、ステージ最後に待つボスを倒せばステージクリア。さらにベクターマンは、パワーアップパーツを手に入れることで変身することができ、通常の人型ロボットからジェット形態やバギー形態、サカナ形態など、さまざまな変身を駆使してゴールを目指します。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ベクターマン<sup>TM</sup></span></div>
</div>
