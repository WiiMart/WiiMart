...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157495545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Inkub, eres el responsable de la defensa de las incubadoras. Cada incubadora está conectada a un sistema de soporte vital por medio de tuberías de carbono transparente. Durante años, diferentes organismos, virus y bacterias, han formado colonias que atacan a las especies de cada incubadora.
<p>
Tu objetivo es el de repeler el ataque de estos organismos y mantener a salvo los huevos de las incubadoras. Cuentas para ello con un arsenal de armas, minas y bloqueadores a tu disposición. Durante el juego se irán desbloqueando todas ellas: cañones láser, proyectiles, bloqueadores, minas y ralentizadores. Utilízalos colocándolos a lo largo del tubo para repeler el ataque de los enemigos.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157495545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157495545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Inkub</span></div>
</div>
