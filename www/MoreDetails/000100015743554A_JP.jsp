...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015743554A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ｗｉｉリモコンを本能のままにフリフリして遊ぶ、あつ～いミニゲームがたくさんつまったパーティーゲームです。シンプル操作で誰でもかんたんに遊ぶことができますので、ひとりプレイはもちろん、家族と、ともだちと、みんなでリビングに集まって、あつ～く盛り上がることができます。Ｗｉ－Ｆｉランキング対応ゲームでは、日本全国だけでなく世界中のプレイヤーたちが集まるランキングに、ハイスコアを登録することができます。<BR><BR>■少しだけゲーム紹介<BR>『フリフリラップ』体内時計で正確に秒数をカウント（コンマ１秒の世界）<BR>『フリフリアンサー』あなたの集中力に挑戦（エンドレスモードも？）<BR>『フリフリダッシュ１』フリフリして、「だるまさんがころんだ」（動いちゃダメ）<BR>『フリフリダッシュ２』フリフリして、「つなわたり」（矢に注意）<BR>『フリフリキッス』シャイなアイツの背中を押して、あの娘にぴったりキッス作戦（フリ加減が重要）<BR>『フリフリボンバー』強すぎず弱すぎず、フリフリのバランス（けっこう必死）<BR><BR>※この他にも６ゲーム、あわせて１２ゲームが収録されています。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015743554A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015743554A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">あつい１２ゲーム</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">フリフリパーティー！</span></div>
  </div>
