...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">戦闘歩兵服に身を包んだ主人公チェルノブが、地球侵略をたくらむ未知の侵略者デスタリアンを倒し、とらわれの妹を救い出すために走り続けるアクションシューティングゲームです。３段階にパワーアップする６種類の武器と舞い上がるようなジャンプを駆使し、スクロールし続けるステージで襲いくる敵と戦います。最終目的地はデスタリアンの本拠地・ニューヨーク。アーケード版で登場以来、世界観や操作方法などの個性的なゲーム性とキャラクターが話題を呼び、演出面をパワーアップしてメガドライブに移植された作品です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">チェルノブ<sup>&reg;</sup></span></div>
</div>
