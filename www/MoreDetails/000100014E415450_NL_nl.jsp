...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mario Tennis, een van de meest verslingerende spellen voor de Nintendo 64, is nu verkrijgbaar voor de Virtual Console!
<br><br>
De besturing is eenvoudig en intuïtief, waardoor je echt het gevoel krijgt dat je tennis speelt. Zet je tegenstander op het verkeerde been met een mix van volleys, lobs, smashes en effectballen. Het spel, waarin de officiële tennisregels worden gehanteerd, bevat verschillende spelstanden, zoals de standaard Tournament-stand en de knotsgekke Piranha Challenge.
<br><br>
Kies een speler uit 16 verschillende Nintendo-personages. Ze beschikken allemaal over unieke vaardigheden, waarmee ze een streepje voor hebben op hun tegenstander. Zo is Baby Mario razendsnel, Donkey Kong ongelofelijk krachtig, en kan Boo een gemene effectbal geven!
<br><br>
Probeer alle geheimen te vinden in de stand voor één speler, of nodig je vrienden uit voor een verhit tennistoernooi. Dit is een spel dat je wilt blijven spelen!
<br><br>
