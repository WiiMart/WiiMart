...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sexta entrega de la saga King of Fighters, lanzada originalmente en 1999. Esta vez, entrará en escena un nuevo protagonista con una historia completamente nueva. En lugar de los equipos de tres miembros del formato previo, los nuevos grupos estarán conformados por cuatro luchadores, de los cuales tres pelearán, mientras que el restante realizará el papel de Striker. Como en versiones anteriores, puedes soltar Súper Ataques Especiales cuando las barras estén al máximo. Sin embargo, se ha introducido una nueva característica por medio de la cual usando tres acciones de poder podrás activar el Modo Contador, que aumenta la fuerza de ataque, o el Modo Armadura, que aumenta la fuerza defensiva. Las tácticas aplicables a cada situación han sido también mejoradas. King of Fighters 99 presenta 32 luchadores jugables. ¿Cuál de ellos se coronará campeón en esta edición?</div>
  <div id="image02">
