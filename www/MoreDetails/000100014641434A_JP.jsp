...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコン初期に発売されたピンボールゲームのソフト。さまざまな仕掛けが設置された台にボールを打ち出し、フリッパーでボールを弾き、仕掛けに当てて高得点を狙います。ピンボールの台は上下２画面あり、上の台と下の台では仕掛けが異なります。特定の場所にボールを入れるとマリオが登場する特別な台も楽しめます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ピンボール</span></div>
</div>
