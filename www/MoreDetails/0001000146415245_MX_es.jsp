...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Al otro lado de la galaxia hay un planeta distante conocido como Gradius. La pacífica existencia de Gradius ha terminado a consecuencia de una intensa invasión espacial por una raza conocida como el Bacterion. Para poder salvar el planeta, la nave de combate hiper-espacial Vic Viper ha sido desplazada para luchar contra la invasión de Bacterion. Pilotea la Vic Viper a lo largo de siete etapas, disparando y esquivando a través de obstáculos mortales, mientras elevas el poder de tu nave con varios poderes, incluyendo misiles, láser, opciones y escudos.  El objetivo del Vic Viper es la fortaleza enemiga, Xaerous. La única manera acabar la guerra es entrando a las profundidades de las fuerzas enemigas y destruyendo su núcleo. ¡De esa manera el Vic Viper despega hacia las profundidades lejanas del espacio!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Gradius<sup>&reg;</sup></span></div>
</div>
