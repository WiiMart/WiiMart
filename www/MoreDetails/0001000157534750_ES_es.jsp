...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157534750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SAMEGAME es un simple pero a la vez absorbente juego de puzle donde eliminas bloques iguales en grupos de 2 o más.<br><br>

Consigue una puntuación alta eliminando más bloques a la vez. Si eliminas toda la cuadrícula, podrás seguir jugando con otro diseño completamente nuevo. ¡Eliminar todos esos bloques es la clave para acumular puntos!<br><br>

Ajusta la dificultad en el juego para un jugador probando diferentes tamaños de cuadrícula y números de colores. ¡Juega a tu manera!<br><br>

Hasta 4 jugadores se pueden enfrentar en cualquiera de los 3 modos multijugador. "Fame Game", la opción más sencilla, es similar a la versión para un jugador. "Shame Game" obliga a los jugadores a conseguir la puntuación más baja. "Blame Game" es un todos contra todos puesto que todo el mundo busca bloques en una misma cuadrícula.<br><br>

Escoge entre diferentes tipos de bloques, gráficos de fondo y música para personalizar tu experiencia de juego.<br><br>

SAMEGAME: Fácil de aprender, fácil de jugar... ¡pero difícil de dominar!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534750/FFFD000D" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534750/FFFD000E" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
