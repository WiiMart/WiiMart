...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157464E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fish Tank est une combinaison du genre très populaire Match 3 avec le style des jeux de réflexion. C'est aussi un jeu d'arcade, mais au lieu d’assortir des pierres précieuses ou des blocs, vous assemblez des bancs de poissons de même couleur. Pour y arriver, vous devez assembler des poissons identiques en groupes de quatre ou plus et appuyer sur le bouton correspondant pour les retirer du filet. Le jeu comporte un scrolling horizontal au lieu du scrolling vertical habituel dans ce type de jeu.
<br><br>
Vous en voulez plus ? Voilà :<br>
- 24 défis à réussir<br>
- 24 niveaux stimulants<br>
- 9 puissances augmentées différentes pour améliorer votre expérience du jeu<br>
- Mode coopératif à 4 joueurs<br>
- 2 modes de jeu : Play et Challenges<br>
- 1 trophée supplémentaire vers la fin du jeu pour les meilleurs collecteurs de médailles d'or !
<br><br>Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464E50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464E50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fish Tank</span></div>
</div>
