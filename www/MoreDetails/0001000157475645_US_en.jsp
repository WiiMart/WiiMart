...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157475645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A music-based game like no other, Groovin' Blocks adds innovative musical game-play to an addictive action/puzzle game foundation. Play to the rhythm of the music to increase your score, and try to hit "Superbeats" to double your multiplier! Go for the high score in each of the 27 stages, as you collect stars to unlock 15 levels of power-ups! Groovin' Blocks features three skill levels, from the accessible Casual to the fiendish Hard mode. Play with your friends in Co-op mode, or against them head-to-head. Head-to-head brings it up a notch, as the power-ups now become attacks on your opponent! Play head-to-head with people of all skills with a golf-style handicapping system.</div>
  <div id="image02">
