...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157443950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Castlevania The Adventure ReBirth revisits the traditional action-platform style of the early Castlevania games delivering exciting arcade gameplay and visceral thrills. 
<br><br>
...
<br>
Set forth in search of Castlevania and the destruction of  Dracula!</div>
  <div id="image02">
