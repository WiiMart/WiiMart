...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157395550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome on board ! <br>
You will find here four fabulous games to try your luck with: <br>
- Slot Machine <br>
- Roulette <br>
- Blackjack <br>
- “Video” Poker <br>
Once on the deck, you will be able to choose : <br>
- Competition mode <br>
- Quick Play mode <br>
If you beat a record, you will have to enter your name in order to appear in this highscores table. But fear the bankruptcy!</div>
  <div id="image02">
