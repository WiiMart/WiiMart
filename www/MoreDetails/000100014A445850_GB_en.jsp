...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The aerialist extreme, Aero the Acrobat, bounds back into the spotlight once again to stop the wicked industrialist, Edgar Ektor! Aero has entered a new realm of enchantment and must now use all his acrobatic prowess to foil a criminal plot known only as "Plan B!" Join Aero as he discovers new friends (and enemies) in a world custom-built for his high-flying adventures!
<br><br>- 45 Levels of wild acrobatic fun, including: Bonus Rounds, Chance Stages, and Hidden Chambers!<br>
- New villains and original digitised character voices!<br>
- Password Feature allows you to return to any world!<br>
- Chillin' Snow Boarding Stage adds a new twist to Aero's style!<br>
- New moves and fighting techniques for Aero's attacks!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
