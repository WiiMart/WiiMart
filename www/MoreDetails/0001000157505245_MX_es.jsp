...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157505245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Art Style: CUBELLO combina los elementos de estrategia y juego de rompecabezas tradicional con la precisión y los reflejos necesarios de un juego de disparos. Al iniciar cada nivel, varios cubos de distintos colores forman un objeto grande (un Cubello), el cual flota y rota mientras juegas. Lanza cubos adicionales de tu cargador y trata de unir cuatro o más del mismo color, quitándolos así del Cubello y eventualmente dejando únicamente el núcleo. Acepta el reto de los modos Stage o Endless y observa lo que ocurre cuando se activa la modalidad Bonus Time. Los controles y objetivos simples permiten que cualquiera pueda jugar, mientras que la profundidad del juego agradará a jugadores expertos, quienes se encontrarán rápidamente cautivados por el mundo único de Art Style: CUBELLO.
<p>
Los juegos de la serie Art Style contienen diseños elegantes, elementos gráficos refinados y controles fáciles de dominar, creando una experiencia de juego enfocada únicamente en divertir y entretener.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Art Style<sup>TM</sup>: CUBELLO<sup>TM</sup></span></div>
</div>
