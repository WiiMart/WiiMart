...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年に発売された、現在人気の２Ｄ格闘ゲームの原点とも言える作品です。ときは中国清朝も末期。カンフーの達人「李（リー）」は、中国全土で悪業を重ねる「チャーハン一族」撲滅のため、彼らの城である「メンマの塔」へとのりこみます。しかしリーの行手には、棒術使いや鎖使いなど次々と強敵が立ちはだかります。
十字キーとパンチ、キックボタンを組み合わせて繰り出される多彩な技を駆使して、次から次に襲いくる攻撃をくぐり抜け、敵を打ち倒してください。はたしてリーは、チャーハン一族を倒し中国に平和をとり戻すことができるのでしょうか。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">イー・アル・カンフー<sup>&reg;</sup></span></div>
</div>
