...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574C544A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ここは暗闇に乗っ取られてしまった学校。Wiiリモコンの懐中電灯の明かりで、謎を照らし出しましょう。<BR><BR>「スクール オブ ダークネス」は明かりをつけて進路を確保しながら、主人公ジェイクを脱出へと導く３Dアクションパズルゲームです。闇に足を踏み入れると絶体絶命。電力の使いすぎに注意し、パチンコや発炎筒などのアイテムを上手に使いながら、ガールフレンドのレイチェルを探し出しましょう。時には教師の姿をした凶暴なクリーチャーとも対峙しなくてはなりません。<BR><BR>5つのボスバトルを含む30ステージ以上を収録。マルチエンディング、時間制限がある高難易度のDARKモードや隠しキャラクターなどの追加要素もあります。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C544A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スクール オブ ダークネス</span></div>
</div>
