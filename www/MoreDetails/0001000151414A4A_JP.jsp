...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ＰＣエンジンの人気作「イメージファイト」の続編にあたる、手応え抜群の縦スクロールシューティングゲームです。かつての「月戦争」から３年。突如として射手座方向宙域に出現した「エイリアンフォース」が、地球へ向けて侵攻を開始しました。プレイヤーは国連宙軍パイロット「ショウ・サワムラ」となって、軌道戦闘機「ＯＦ－１　ダイダロス」や後継機の「ＯＦ－３　ガルーダ」を操縦し、仮想現実ステージ「イメージファイト」で厳しい戦闘訓練を積みます。訓練時の平均破壊率９０％を達成したら、いよいよ実戦ミッション開始です。本作で新たに追加された「特殊攻撃パーツ」をはじめ、補助攻撃システムの「ポッド」やこれを飛ばして敵を破壊する「ポッドシュート」、速度チェンジを利用した「バックファイヤー」などのテクニックを上手に使って難関を突破してください。地球到達の「Ｘ－ＤＡＹ」まで猶予はあと２年。残された時間の中で人類の存亡を賭けた戦いが再び始まります。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000151414A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151414A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">イメージファイト<sup>&reg;</sup>Ⅱ</span></div>
</div>
