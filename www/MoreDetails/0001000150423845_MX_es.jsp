...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Blazing Lazers es un videojuego de desplazamiento vertical que fue alabado por superar los límites del hardware de su época. Los jugadores controlan el extraordinario poder del Caza Espacial Gunhed para combatir al Escuadrón Oscuro que está invadiendo a la Tierra.  Recolecta objetos especiales y aumenta la fuerza de combate de tu nave para abrirte paso entre los enemigos y derrotar a los jefes de las 9 áreas.  Por supuesto, como parte de la serie "Soldier”, el juego contiene una buena combinación de alta velocidad y música de fondo, unida al Field Thunder ¡que puedes utilizar para destruir a los enemigos de un solo golpe!  ¡Con sus afinados niveles de dificultad, Blazing Lazers es un videojuego que todos pueden disfrutar!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150423845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150423845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
