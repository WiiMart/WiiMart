...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">주인공 커비를 조작하여 적을 쓰러뜨리거나 도망치면서 스테이지를 클리어하는 액션 게임입니다. 커비가 적을 빨아들이면 상대의 능력을 카피해 공격할 수 있는 것이 최대 특징. 커비의 대명사가 된 카피 능력이 처음으로 등장한 소프트입니다. 커비의 카피 능력 액션은 물론이고, 디디디 대왕이나 메타나이트와 같은 적 캐릭터도 모두 귀엽고 개성이 넘칩니다. 조작이 간단해 액션 게임을 잘 못하는 사람도 쉽게 즐길 수 있습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413854/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413854/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">별의 커비<sup>TM</sup> 꿈의 샘 이야기</span></div>
</div>
