...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157445650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Voodoo Dice es un juego muy innovador, una mezcla de acción y puzle en un universo 3D. Se trata de un reto que te lleva a resolver varios puzles de una forma nueva, única y divertida.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
