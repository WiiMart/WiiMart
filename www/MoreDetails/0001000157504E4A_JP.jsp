...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157504E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">家族や友達と手軽に遊べる玩具が、Wiiウェアでお茶の間にやってきます。『ポンジャン』は、麻雀のルールを簡素化し、子供から高齢者まで誰でも楽しく遊べるテーブルゲームです。さらに、ニンテンドーDSをコントローラーとして使う事で最大4人まで一緒に遊べます。<BR><BR>＜モード紹介＞<BR>■ノーマルポンジャン<BR>ポンジャンを通常のルールで遊ぶ事ができます。<BR><BR>■スシポンジャン<BR>寿司ネタを題材にした「スシポンジャン」を遊ぶ事ができます。<BR>高級食材パイ、お茶パイといった、ノーマルポンジャンにはないルールが追加されています。<BR><BR>■オリジナルポンジャン<BR>自分だけの「役」を14個作って遊ぶ事ができます。いつものポンジャンでは考えられないような自分だけの「役」を自由に作る事ができます。<BR><BR>※多人数プレイについて<BR>本ソフトで多人数プレイを行うためには、人数分のニンテンドーDS（DS Lite、DSi含む）が必要です。<BR>本ソフトだけで、複数人でプレイすることはできません。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504E4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504E4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ポンジャンWii</span></div>
</div>
