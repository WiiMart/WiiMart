...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">カービィと仲間たちが登場する、ゲームボーイで人気を博したかわいいアクションパズルが、豪華なグラフィックをはじめ大幅にパワーアップしたスーパーファミコン版です。画面上に積み重なっている「星」を、リック、カイン、クーの３匹の仲間ではさんでキャッチして、たくさんの星を集めてください。シンプルな操作で初心者から上級者まで誰もが簡単に楽しめます。ストーリーにしたがってコンピュータと次々に対戦していく１人用の「おはなし」モードのほか、「タイムアタック」や「チャレンジ」、全１００面の「ラウンドクリア」、白熱の「ＶＳ」モードなど５種類のモードで遊べます。また、各プレイヤーとの対戦成績が一目でわかる「きろく」画面で、個人成績や各ゲームの記録も残すことができます。連続消しをするとカービィたちがかわいいアクションを見せてくれます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A444D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A444D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">カービィのきらきらきっず<sup>TM</sup></span></div>
</div>
