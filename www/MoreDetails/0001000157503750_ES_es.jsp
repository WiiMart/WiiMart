...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157503750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Starry Night es un juego que permite observar los cuerpos celestes desde la comodidad de tu televisor con el mando de Wii.<br><br>

Hay 3 modos principales.<br>
Modo Observación: contiene unos 20 000 objetos celestes hasta estrellas de magnitud 7. Puedes cambiar ajustes como mostrar la latitud y la longitud de las constelaciones o la velocidad a la que transcurre el tiempo.<br><br>

Modo Planetario: en él puedes ver 11 recorridos que tratan temas como estrellas, nebulosas, constelaciones y otros objetos celestes.<br><br>

Guía Celeste: contiene información detallada y mitología sobre los objetos celestes y las constelaciones, así como un glosario de los términos que se utilizan en observación.<br><br>

My Starry Night es un juego con el que disfrutarás viendo el cielo nocturno mientras aprendes los objetos que contiene.<br><br>
Venga, mira bien las estrellas misteriosas que pueblan el cielo.<br><br>


La información sobre los objetos celestes está actualizada a fecha de junio de 2010.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
