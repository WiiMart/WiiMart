...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自慢の石頭と多彩なアクションで突き進むアクションゲーム「原人」シリーズのスーパーファミコン版第１弾です。キングタマゴドンIII世の罠にかかって、見たこともない場所に飛ばされてしまった原人。恐竜王国へ戻る道を探すため、街や洞窟、果ては宇宙を舞台に大冒険のスタートです。プレイヤーは原人を操作して、ステージを進んでいきます。邪魔する敵はボンク（頭突き）で攻撃！肉を食べると２段階に変身してさらに強力な攻撃ができます。原人の行く手にはいろんな仕掛けが待ち受けています。「根性登り」や「大車輪」などのアクションのほか、体のサイズが変わる「キャンディー」なども駆使しながら、難関をクリアしてください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">超原人<sup>&reg;</sup></span></div>
</div>
