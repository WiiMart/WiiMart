...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Esta es una versión actualizada del clásico juego de tiroteo “Galaga”. Situado en los vastos confines del espacio, lucharás a través de las 29 Rondas para llegar a la fortaleza enemiga en el Planeta Galaga. Los niveles del juego consisten en unas cuantas rondas, con enemigos y fondos que cambian. Además, la nostálgica “Galactic Dancing” (“Danza Galáctica”) sigue ahí marcando el final de cada nivel. Con la nueva adición de las dimensiones, podrás escoger tu ruta de ataque. Recoge cápsulas para abrir “dimension warps” (“túneles dimensionales”) en las bifurcaciones y enfrentarte a enemigos aún más duros. La inclusión en Galaga ‘90 de triple caza, los fondos móviles, el “Jefe Galaga” y hasta más efectos del sistema, lo convierten nada menos que en una obra maestra.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150415745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150415745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
