...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157423550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Prepárate para la locura del mejor juego de romper bloques! Block Breaker Deluxe es una reinvención del clásico juego arcade de romper ladrillos con un moderno estilo gráfico, un entorno divertido y un exclusivo modo multijugador. Animados personajes y fantásticos gráficos proporcionan las características distintivas de la vida nocturna de la jet set, como un bar de moda, un club de baile, un casino y más. Ladrillos especiales, múltiples extras, armas secretas, diferentes tamaños de pala y variación en la velocidad de la bola, hacen de este fascinante juego todo un desafío. ¡La furia de Block Breaker Deluxe ha llegado!<br><br>
