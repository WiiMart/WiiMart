...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気プロレスゲームシリーズ第二弾。個性的な１６人のレスラーたちが集い、リング上で激突します。前作のゲームシステムを受け継ぎつつ、レスラーは一新、技もより多彩になったほか、好きなレスラーでタッグを組むことも可能となりました。ゲームモードは４種類。自由に試合をおこなう「ＥＸＣＩＴＥ　ＳＥＲＩＥＳ」、勝ち抜き戦でチャンピオンをめざす「ＷＯＲＬＤ　ＣＨＡＭＰＩＯＮ　ＳＥＲＩＥＳ」、５人のチームで戦う「ＥＬＩＭＩＮＡＴＩＯＮ　ＭＡＴＣＨ」、そして新モードの「ＳＵＰＥＲ　ＴＯＵＲＮＡＭＥＮＴ」では全てのレスラーがトーナメントに参戦。４人までの同時プレイにも対応しており、白熱した戦いが楽しめます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイヤープロレスリング<sup>&reg;</sup>  2nd BOUT</span></div>
</div>
