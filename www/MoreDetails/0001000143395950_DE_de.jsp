...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">INTERNATIONAL KARATE ist die Simulation eines Karateturniers, in dem zwei Spieler gegeneinander spielen können oder ein Spieler gegen den Computer antritt.
<br><br>
Während des Spiels fliegst du um die Welt zu verschiedenen Orten.
<br><br>
In allen Etappen des Spiels wacht ein weiser alter Kampfrichter über dich, der dir je nachdem wie erfolgreich der Treffer war, entweder einen halben oder ganzen Punkt gibt.
<br><br>
