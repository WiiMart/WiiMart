...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ninja Combat is een zijwaartsscrollend vechtspel en werd oorspronkelijk in 1990 uitgegeven. Je bestuurt Joe (in de spelstand voor één speler) en Hayabusa (in de spelstand voor twee spelers) en neemt het op tegen een groep boosaardige ninja’s die bekendstaat als de Kage Ichizoku. Deze ninja’s houden zich hoog boven een grote, futuristische stad op in hun thuisbasis: de Ninja Tower.
<br><br>
Naast standaardaanvallen, sprongen, speciale technieken en het gebruik van typische ninjavoorwerpen waarmee je alle tegenstanders op het scherm kunt raken, moet je de wapens en voorwerpen gebruiken die je in het spel tegenkomt.
<br><br>
Naarmate je verder komt in het spel zullen er ook betrouwbare bondgenoten opduiken, waaronder Musashi, Kagero en Gembu, zodat je in elk level een personage kunt kiezen. Ninja Combat bevat ook een spelstand voor twee spelers waarin je samen met een vriend kunt spelen!
<br><br>
Het spel is voorzien van Engelse schermteksten.<br>
Handleiding alleen beschikbaar in het Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414D50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414D50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ninja Combat</span></div>
</div>
