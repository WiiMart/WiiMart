...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001584A4650')", "wiiSelectSound()");
...
<br><br>Arca: todo empieza y termina en esta ciudad olvidada.<br>
Mientras huían de sus perseguidores, Celia y Nemo se precipitan a las profundidades hasta ese lugar condenado. Completamente sola, la joven despierta en un sitio desconocido, una metrópolis habitada únicamente por sombras.<br>
Acompaña a Celia en un sobrecogedor viaje por el apasionante mundo de Anima Beyond Fantasy, una aventura que os conducirá hasta los más profundos secretos de la ciudad... y de su propia alma.
<br><br>
Incluye: <br>
• Más de 21 secciones interconectadas que ofrecen más de 8 horas de juego. <br>
• Apasionantes adversarios: 12 tipos de enemigos y 4 jefes finales diferentes. <br>
• Infinidad de técnicas de combate: domina múltiples combos y ataques especiales. <br>
• Una emocionante banda sonora. <br>
• Una sobrecogedora historia: desvela los secretos de Arca a través de los relatos escritos por Carlos García y las escenas dibujadas por el conocido artista Wen Yu Li.
<br><br>
