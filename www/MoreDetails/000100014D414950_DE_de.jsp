...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aus den Tiefen des Universums ertönt ein Hilferuf: Fantasyland wurde von zerstörerischen Streitmächten eingenommen. Schon bald ist Space Harrier, bewaffnet mit seinem Laser, zur Stelle: Er muss die Truppen bezwingen, um den Untergang von Fantasyland zu verhindern! Fliege und sprinte durch 12 spannende Level, an deren Ende jeweils ein gefährlicher Boss auf dich wartet!
<br><br>
