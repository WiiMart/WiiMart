...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aus der Serie „The King of Fighters“ erscheint nun der vierte Teil, der erstmals 1997 als Arcade-Version veröffentlicht wurde. Beliebte Charaktere aus den Spielen FATAL FURY, IKARI WARRIORS, PSYCHO SOLDIER und ART OF FIGHTING treten auf und kämpfen um den Titel des stärksten Kämpfers. Auch dieses Mal kann man die Charaktere wechseln und sogar Endgegner aus früheren SNK-Spielen auswählen, wie zum Beispiel Ryuji Yamazaki, Blue Mary, Billy Kane, sowie aus neueren Charakteren wie Yashiro Nanakase und Shingo Yabuki. Außerdem kann man dieses Mal zu Spielbeginn zwischen den zwei Modi ADVANCED (Fortgeschrittener Modus) und EXTRA (Extra-Modus) wählen, was den Charakter des Spiels und deine Taktik unterschiedlich beeinflussen wird.<br><br>Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
