...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Pon a prueba tus habilidades para el combate Pokémon y para resolver rompecabezas frente a los mejores entrenadores de Pueblo Puzle (Puzzle Village)! Para triunfar necesitarás buenos reflejos, pues solo con dedos rápidos podrás eliminar las piezas que aparecen, combinándolas según sus colores. Cuantas más piezas elimines al mismo tiempo, más puntos conseguirás.
<br><br>
Intenta formar grandes combos
o reacciones en cadena para obstaculizar a tu oponente (ya sea la consola o un amigo) y conseguir medallas de los entrenadores rivales. ¡Así te convertirás en el campeón de los puzles Pokémon (Pokémon Puzzle Master)!
<br><br>
Además de estos enfrentamientos, te esperan muchos otros interesantes desafíos, desde el modo 3D hasta los puzles que la Universidad Puzle (Puzzle University) tiene preparados para que te exprimas el cerebro. ¿Estás preparado para un nuevo tipo de combate Pokémon?
<br><br>
