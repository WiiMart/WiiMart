...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157345450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Je staat op het punt de meest verslavende uitdaging van de afgelopen jaren aan te gaan. Baan jezelf een weg door vijftien hersenbrekende levels waarin je met behulp van kosmische energieballen onmogelijke figuren moet namaken. Race tegen de klok en manoeuvreer rond obstakels om de juiste vakjes te activeren. Spaceball: Revolution stelt je vaardigheden en je concentratievermogen tot het uiterste op de proef. In Spaceball: Revolution kun je in de verschillende moeilijkheidsgraden Makkelijk, Normaal, Gevorderd en Expert je score vergelijken met de beste spelers ter wereld.
<br>
Spaceball: Revolution daagt je uit, durf je de uitdaging aan te nemen? <br><br>Het spel is voorzien van
Nederlandse schermteksten.</div>
  <div id="image02">
