...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This classic ninja-action game first appeared in arcades in 1985 and became instantly popular. As the Iga ninja named “Kage," players embark on an action-packed quest as they move toward a magic castle where the Princess "Kiri" is held captive by "Yohshirou Yukikusa." To stay alive, move vertically and horizontally through forest and castle environments and execute massive jumps, all the while using throwing-star knives and a sword to take down hordes of enemies.</div>
  <div id="image02">
