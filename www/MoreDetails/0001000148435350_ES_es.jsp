...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Con la aplicación Transferencia Wii U, puedes mover conjuntamente los siguientes datos desde una consola Wii a una consola Wii U:<br><br>
...
• La consola Wii U no es compatible con WiiConnect24. Las funciones de los programas que requieran el uso de este servicio ya no estarán disponibles tras la transferencia.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435350/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435350/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Transferencia Wii U</span></div>
</div>
