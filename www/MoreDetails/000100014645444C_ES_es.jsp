...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Conviértete en Dig Dug, el héroe que excavando arriba y abajo, a derecha e izquierda, vence a todos los enemigos que se cruzan en su camino. Para completar cada fase tendrás que vencer a los tenaces Pookas y a los Fygars, unos dragones que habitan en las profundidades del subsuelo. 
<br><br>
Puedes derrotar a los enemigos de varias maneras. Intenta alcanzarles con la manguera de tu bomba de aire para inflarlos a continuación, o haz caer piedras sobre ellos. Obtendrás puntos extra si recoges fruta o si vences a enemigos que se encuentran en zonas especialmente profundas. Tenlo en cuenta, si eres de los que disfrutan batiendo marcas.
<br><br>
Además de la acción propia de las tradicionales máquinas recreativas, este clásico tiene elementos de estrategia: ¡intenta atraer varios enemigos hasta dejarlos en una posición tal que puedas alcanzarlos a todos con una sola roca!
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014645444C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645444C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">DIG DUG<sup>TM</sup></span></div>
</div>
