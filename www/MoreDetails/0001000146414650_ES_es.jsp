...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En el videojuego que inauguró la serie más famosa de todos los tiempos, Mario y Luigi tienen que vérselas con todos los enemigos que se encuentran a su paso. Tu objetivo es acabar con el mayor número de enemigos posible y conseguir monedas sin resultar dañado. Mario Bros.™ supone el estreno de Luigi, hermano de Mario, que hace su aparición en la modalidad multijugador. Además, en este juego se asientan algunas de las características más genuinas de la serie: nuestro héroe es ahora fontanero en lugar de carpintero —oficio que ejercía en Donkey Kong™—, se enfrenta a enemigos tortugáceos y recoge monedas en pantallas especiales. ¡Pero ojo!: no es posible saltar sobre los enemigos como en episodios posteriores, de modo que tendrás que buscar otras formas de neutralizarlos. <br><br>Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
