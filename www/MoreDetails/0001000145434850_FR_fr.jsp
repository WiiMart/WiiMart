...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">King of Fighters '98 est la cinquième version du jeu de combat après l’épique saga Orochi. King of Fighters '98 comprend au total 38 personnages, divisés en 12 équipes, ainsi que 2 combattants. Nous retrouvons, enfin, l’équipe des sportifs. La jouabilité est reprise de l’édition 97, dans laquelle, vous pouvez sélectionner un style de jeu parmi deux (avancé ou extra) pour correspondre au mieux aux combattants. Certains changements mineurs ont été apportés : comme une meilleure personnalisation pour le bonheur des fans et des mécaniques de combat améliorés. <br><br>Texte écran en anglais.</div>
  <div id="image02">
