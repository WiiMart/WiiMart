...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157564F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prepárate para liberar al roquero que llevas dentro con Rock N’ Roll Climber. Escala un muro de piedra utilizando una combinación de controles innovadora para dirigir los movimientos de tu personaje usando el Wii Remote y el Nunchuk. Si quieres una experiencia más intensa, el título también te permite usar tu Wii Balance Board. Sube hasta la cima de una diversa gama de recorridos que van desde un muro de piedra a cubierto en el nivel Pop hasta escalada de cataratas en el nivel Heavy metal (cuidado con las piedras cubiertas de musgo. ¡Son resbalosas!). Además de la satisfacción que tendrás al llegar a la cima, puede que seas recompensado con tu propia guitarra.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564F45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564F45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
