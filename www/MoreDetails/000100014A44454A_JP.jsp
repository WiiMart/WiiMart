...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">行く手に立ちふさがる敵を倒しながら進んでいく進んでいく横スクロール格闘アクション「ファイナルファイト」シリーズの第三弾。「スーパーメガクラッシュ」という超必殺技や「ダッシュ」、ステージ途中での分岐点など、前作までに無かった要素が複数追加されました。暴力集団「マッドギア」の壊滅から数年後、マッドギアの元下部組織「スカルクロス」による「メトロシティ」への市全面侵攻がはじまります。メトロシティの市長ハガー、格闘技の達人であるガイ、女刑事のルシア、謎の青年ディーンの４人を操作し、様々なアイテムを駆使してそれぞれのステージの最後に待ち構えるボスを倒せばステージクリアです。２人での同時プレイも楽しむことができます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファイト<sup>&reg;</sup> タフ</span></div>
</div>
