...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ryo Sakazaki debe rescatar a su hermana Yuri, que ha sido secuestrada por el mafioso Mr. Big en este juego de lucha de 1992. Junto a su mejor amigo, Robert, deberá derrotar a varios enemigos en Southtown hasta alcanzar el combate final contra el misterioso Mr. Karate.
<br><br>
La pasión con la que trabajaron los creadores del juego queda de manifiesto en los elementos únicos que obligan a los jugadores a emplear diferentes estrategias en lugar de solo golpear rápidamente los botones. Estos elementos incluyen la "barra de espíritu" que se vacía tras realizar un movimiento especial y los "movimientos desesperados" que solo se pueden utilizar cuando el luchador tiene poca vida.
<br><br>
Ciertas características como el que los luchadores muestren el daño recibido a medida que se desarrolla el combate, el zoom de la cámara y las voces en off que aparecen en las secuencias del juego contribuyeron a que Art of Fighting se convirtiera en toda una obra maestra de los juegos de lucha.
<br><br>
Textos de pantalla en inglés, japonés o español.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
