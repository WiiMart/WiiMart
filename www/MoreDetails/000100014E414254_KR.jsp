...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">마리오와 루이지 등 8명의 캐릭터가 서킷을 질주합니다. 코스는 서킷뿐 아니라 고개, 해변, 눈길, 귀신의 집 등 흥미진진한 코스가 많이 준비되어 있습니다. 레이싱 중에 얻은 아이템으로 상대방을 공격하거나 방해하다 보면 이 게임의 진정한 재미를 느낄 수 있습니다. 컨트롤 스틱으로 핸들을 조작하고, 전략적으로 아이템을 사용하여 1위를 노려 보세요.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414254/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414254/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">마리오 카트 64<sup>TM</sup></span></div>
</div>
