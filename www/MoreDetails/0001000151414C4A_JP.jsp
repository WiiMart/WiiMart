...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１５世紀の大航海時代のヨーロッパを舞台に繰り広げられる海洋冒険シミュレーションゲームのＰＣエンジン版です。中世、世界の大部分が未知の時代。プレイヤーは商家の当主として、国王の命により「ワールドアトラス（世界大地図帳）」の作成という大事業にいどみます。ゲームでは、国王と結んだ「貿易特権契約」を活かし、各地との貿易で資金を増やしながら未開地域の探索を繰り返します。どの地域を探索するか、どの都市と貿易するかはすべてプレイヤーの自由です。まだ見ぬ大陸や産物、伝説の秘宝を発見するべく、勇敢な提督たちの率いる「冒険船団」を派遣して、徐々に探索の範囲を広げていきます。そしてこのゲームの大きな特徴は、探索の報告を信じるか信じないかで世界の姿が変わっていくというところです。襲いかかる難関や災害を乗り越えて、あなただけの「ワールドアトラス」を完成させてください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000151414C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151414C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アトラス<sup>&reg;</sup></span></div>
</div>
