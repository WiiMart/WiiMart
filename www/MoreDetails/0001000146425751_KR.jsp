...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">주요 파트로만 구성된 로봇들로 활기차게 스테이지를 누비며, 코믹한 움직임과 익살스런 디자인을 즐길 수 있는 로봇 격투 대전 액션 게임입니다. 어느 날 갑자기 로봇으로 세계 정복을 하겠다고 선언한 「못텐마이어 박사」. 그의 로봇에 대항할 수 있는 것은 친구 「차칸스키 박사」의 개그 로봇 「스카퐁」밖에 없습니다. 스카퐁은 동료 로봇을 구하고 세계의 평화를 지키기 위해 싸웁니다. 나쁜 로봇과의 1:1 대전은 박력 만점! 펀치와 킥은 물론, 각 로봇 특유의 개성 넘치는 다양한 필살기를 사용할 수 있습니다. 어려운 조작도 「매뉴얼」 모드에서 연습해 볼 수 있으므로 걱정 없습니다. 1P 퀘스트 모드를 진행하면 다른 모드에서 사용할 수 있는 로봇이 늘어나고, 최대 36종류 중 마음에 드는 로봇을 선택해서 대전할 수 있습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146425751/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146425751/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">조이 메카 파이트<sup>TM</sup></span></div>
</div>
