...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157444450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Diner Dash, het allerbeste actiepuzzelspel voor de pc, is nu verkrijgbaar op het WiiWare! Begeleid Flo, een voormalige kantoormedewerkster, terwijl ze een imperium opbouwt met vier unieke wegrestaurants! Neem het online op tegen andere spelers! Als je de uitdaging wilt aangaan, speel je samen een Team Dash-spel, waarbij je het als team tegen zes andere spelers moet opnemen om te kijken welk wegrestaurant het beste is! <br><br> 

Kruip in de huid van Flo en werk zo efficiënt mogelijk om klanten naar hun zitplaats te begeleiden, bestellingen aan te nemen, eten te serveren, af te rekenen en de tafels af te ruimen – binnen de tijdslimiet. Als je van een traditionele besturing houdt, kun je ook gebruikmaken van een point-and-clickbesturing en sneltoetsen. De klanttevredenheid wordt aangegeven door een hartmeter, die leger wordt als de klanten hun geduld verliezen. Als de meter volledig leeg is, verlaat de klant het restaurant.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444450/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444450/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Diner Dash<sup>&reg;</sup></span></div>
</div>
