...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">シンプルながらも本格的な操作性と、全編を通じてのさわやかなグラフィックが魅力のゴルフゲームです。自然豊かな１８ホールを舞台に、１人プレイ専用の「ＳＴＲＯＫＥ　ＰＬＡＹ」、ホールごとに勝敗を競う「ＭＡＴＣＨ　ＰＬＡＹ」、競技形式の「ＣＯＭＰＥＴＩＴＩＯＮ」の３種類のゲームモードで競い合います。プレイヤーは、平均的、初心者向き、上級者向きの３人から使用するキャラクターを選んで、風向きやグリーンの傾斜を考えながら、それぞれのホールにチャレンジします。「ＭＡＴＣＨ　ＰＬＡＹ」モードでは、通常の「ＮＯＲＭＡＬ　ＭＡＴＣＨ」に加えて、勝者が敗者からクラブを１本奪うことができるというユニークなプレイ方式「ＨＥＬＬ　ＭＡＴＣＨ」を搭載。「ＣＯＭＰＥＴＩＴＩＯＮ」モードは最大３人までがエントリー可能で、実力差が気になる対戦でも「ハンディ制度」で白熱したプレイを楽しめます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パワーゴルフ<sup>&reg;</sup></span></div>
</div>
