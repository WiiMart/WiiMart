...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574E504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">すぐスロDUO「ニューパルサーR＆V」は、シリーズ累計40万台を出荷した人気パチスロ機「ニューパルサー」シリーズから、「ニューパルサーR」と「ニューパルサーV」の2機種を同時収録。パチスロのプレイ動作をWiiリモコンにて完全再現！片手による簡単操作で、MAXBET、レバーON、停止ボタンといった一連の動作をWiiリモコンにてプレイできます。また視点カメラの変更もWiiリモコンにてスムースに行えます。シミュレーションモードでは、「オートプレイ」「スランプグラフ」「ステータス表示」などの攻略機能はもちろん、「機種情報」「成立フラグ（役）」「取りこぼし」表示などパチスロ初心者向けの機能も多数収録した充実の内容となっております。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E504A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E504A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">すぐスロDUO「ニューパルサーR&amp;V」</span></div>
</div>
