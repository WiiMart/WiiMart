...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157465750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wanneer onze heldin Follie op weg is naar haar tante met een vracht geheimzinnige Flowerworks-zaadjes, raakt haar ruimteschip uit de koers en ze stort neer op een uiterst saai stuk van de planeet Elilia .<br> <br>

Ga met Follie op verkenning uit en help haar om haar zaadjes terug te vinden en de wereld om te toveren! Je komt hierbij vreemde bewoners tegen. Sommigen helpen Follie, maar anderen, zoals de lastige tuinkabouters, hinderen haar in haar ontdekkingsavontuur.<br> <br>

'Flowerworks: Follie's Adventure' is een avontuur voor een of twee spelers met een combinatie van kleurrijk vuurwerk, verkennen, kweken van bloemen en veel speelplezier. Het bestaat uit avonturenspel, vrijspel en instructiespel, vijf moeilijkheidsgraden en een 20 uur durend avontuur.<br> <br>

'Flowerworks: Follie's Adventure' is een uitgebreidere versie van het originele ‘Flowerworks’, nu ook geschikt voor twee spelers, met nieuwe beginners- en gevorderden niveaus, ingebouwde ondersteuning in vier talen (Engels, Frans, Spaans en Duits) en nog meer verrassingen.</div>
  <div id="image02">
