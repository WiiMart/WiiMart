...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157344B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wiiリモコンの性能を最大限生かしたガンアクションゲームです。<BR><BR>森や川など様々な場所へ向かいミッションをクリアしていきます。<BR>最高難度の"Professional"をみごとクリアし、最強の狩人を目指してください。<BR><BR>またとにかく鹿を狩り続けるインスタントモードではハンティングのスキルアップやスコアアタックを行うことができます。<BR><BR>また最大４人でのプレイも可能なので、家族や友人を集めてスコアを競い合って遊ぶことも可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157344B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157344B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">鹿狩</span></div>
</div>
