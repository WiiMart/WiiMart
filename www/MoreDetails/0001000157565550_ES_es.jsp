...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157565550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Acompaña al Sr. Bumblebee en su primera gran aventura.<br><br>

Pasamos junto a flores gigantescas, mientras el público anima en las gradas. ¡Cuidado! ¡Una cascada! Ahora, ¡rápido!, ¡a la izquierda!, que no se te mojen las alas. ¡Vaya, ya está ahí otra vez ese mosquito repugnante! Menos mal que has conseguido el turbo, y así puedes volar mucho más rápido que los demás insectos.<br><br>

Características:<br>
	•	Adecuado para cualquier edad, pues la velocidad se puede ajustar.<br>
	•	Preciosos gráficos dibujados a mano.<br>
	•	Pueden jugar de uno a cuatro jugadores.<br>
	•	Cuatro modos de juego y seis circuitos diferentes.
<br><br>
