...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Power Golf hace gala de una combinación de controles sencillos pero realistas y gráficos excelentes. Completa los 18 hoyos en cualquiera de los 3 modos de juego: el modo Stroke Play para un jugador y los modos Match Play o Competition para varios jugadores.
<br><br>
Participa en los torneos con uno de los 3 personajes distintos: principiante, intermedio y avanzado. La fuerza del viento y los desniveles del campo añaden más dificultad a cada hoyo. Compite contra otros jugadores en el Normal Match estándar, o apuéstate uno de tus palos en el único Club Match.
Pueden enfrentarse hasta 3 jugadores en el modo Competition, y se incluye una opción de handicap para ayudar a los jugadores novatos a realizar golpes tan impresionantes como los de sus rivales más avanzados. 
