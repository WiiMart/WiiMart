...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001584A4745')", "wiiSelectSound()");
...
<p>
Welcome to the world of Gnomz. Gnomz is a new exciting arcade fighting game for WiiWare. Gnomz allows up to four players to play against each other and/or AI-controlled opponents in three different game modes.
<p>
Game features:<br>
*Real-time action multiplayer gnome battle platformer<br>
*25 gnomish action-packed arenas<br>
*Hours of gnome bashing, smashing, bumping, and dumping<br>
*Up to four players fighting locally<br>
*Magical power-ups, flying elephants, rainbows, and glowing reindeer<br>
*Smash Match, Capture the Sock, Socker (sock collector)...and much more
<p>
