...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158494750')", "wiiSelectSound()");
...
<br><br>
Welkom bij Urbanix, een game gebaseerd op klassieke computergames! Kruip achter het stuur van Urbanix, een piepkleine tractor die een stad moet bouwen op een leeg veld. Ontwijk vijanden en vang en verjaag indringers die je spel willen verpesten. Speel op de aarde, op de Noordpool of op de maan: alle locaties hebben hun eigen gameplay waardoor je telkens je strategieën moet aanpassen. Ga nauwkeurig en snel te werk, verzamel bonussen en win!
<br><br>
- Verbeterde gameplay, gebaseerd op de klassiekers van vroeger
<br><br>
- 3 verschillende werelden met hun eigen gameplay
<br><br>
- 150 levels, verspreid over meerdere werelden
<br><br>
- Meeslepende multiplayer <br><br>
