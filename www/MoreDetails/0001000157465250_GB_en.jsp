...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157465250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Frogger Returns takes the heart-pounding challenge of arcade Frogger and takes it into the next dimension! Classic top-down 2D gameplay is updated with colourful 3D graphics, a new perspective, all-new levels, new enemies and game-changing power-ups to dodge and use! Local multiplayer lets you race a friend to victory.
<br>
<br>
