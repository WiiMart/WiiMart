...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158495050')", "wiiSelectSound()");
...
<br><br>Welkom in de wereld van de PooYoos, de eerste leuke en vrolijke braintrainer voor kinderen van 3-6 jaar oud.
<br><br>
Samen met de PooYoo's, een gezellig groepje schattige babydiertjes, maakt je kind kennis met allerlei dingen die goed zijn voor zijn ontwikkeling: cijfers, letters, vormen, kleuren en nog veel meer. Bovendien wordt de lateralisatie gestimuleerd. Kinderen kunnen samen met hun nieuwe vriendjes dansen en krijgen allerlei interactieve beloningen. Dankzij twee niveaus wat betreft interactiviteit kan je kind ongeacht leeftijd en niveau activiteiten rondom tovenarij en kleuren spelen.
<br><br>
Dit spel is speciaal ontwikkeld om gebruikt te worden door kinderen die nog niet kunnen lezen. <br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495050/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Leren met de PooYoo's</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Aflevering 3 - Demo</span></div>
  </div>
