...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Par une nuit sombre et orageuse dans le royaume de Granseal, un voleur subtilise deux joyaux dans la Tour des Anciens. Il déclenche alors une chaîne d’événements menant à la résurrection de Zeon, le roi démoniaque.
<br><br>
Le roi de Granseal tombe soudain malade, la princesse est kidnappée et une porte menant à Arc Valley, là où se trouve la tour du roi démoniaque, est ouverte. Le jeune épéiste Bowie, se rendant compte du danger pour Granseal, doit diriger la Shining Force jusqu’à l’épée sacrée et les joyaux volés, et protéger Granseal contre les armées de Zeon.
<br><br>
