...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">前作「ストリートファイターⅡターボ」から一年後、さまざまな点が大きく進化した新たな作品として発売されました。前作でプレイヤーキャラクターとして「四天王」が使用できるようになったのに加え、本作では新たなキャラクター「サンダー・ホーク」「フェイロン」「キャミィ」「ディージェイ」が参戦。多彩なゲームモードや、既存のキャラクターには新しい技も追加されました。ある者は世界一の格闘家をめざし、またある者は自分の失われた記憶をたどるため、合計１６人がそれぞれの目的のために拳をまじえます。今再び「真の最強の座」をめぐり、戦いの火蓋が切って落とされます。人気２Ｄ対戦格闘ゲーム「ストⅡ」シリーズの、スーパーファミコン最後の作品です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーストリートファイター<sup>&reg;</sup>Ⅱ</span></div>
</div>
