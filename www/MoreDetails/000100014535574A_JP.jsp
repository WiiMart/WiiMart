...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気シリーズ「モンスターワールド」の原点となる名作アーケードゲームです。モンスターに支配された世界を救うため、ブック少年はドラゴン討伐の冒険へと旅立ちます。敵を倒してコインを集め、ショップで武器や防具、魔法アイテムを買いそろえてパワーアップ！　ドラゴン城を目指しましょう。アクションとＲＰＧの美味しいところ取りした斬新なゲームデザインは、いまだ多くのゲームファンに愛されています。一部キャラクターを変えるなどして、さまざまなゲーム機に移植されてきましたが、本作はそれらすべてのオリジナルとなるアーケード版です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワンダーボーイ　モンスターランド<sup>TM</sup></span></div>
</div>
