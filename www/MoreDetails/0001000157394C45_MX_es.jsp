...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157394C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">No hay razón para que Papá Noel haga todo el trabajo en Navidad, ¿no te parece? Hoy Papá Noel se va a divertir un poco... ¡y quiere que lo acompañes! Para ayudar a Papá Noel a decorar los árboles, debes quitar todos los regalos y adornos que él vaya apilando. Cuando logras conectar regalos de manera consecutiva sin equivocarte, obtienes puntos extra. ¡Qué buena noticia! Te conviene recoger la mayor cantidad posible de bastones de caramelo, ya que cuando tienes suficientes, Papá Noel te otorga una estrella especial que te ayuda a completar el nivel. ¡Puede estar seguro de que las estrellas harán el juego mucho más divertido!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157394C45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157394C45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Christmas Clix</span></div>
</div>
