...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157455150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Will you be tough enough to complete all 64 levels?<br><br>

The aim of the game is to get the ball to the exit of the level.
To move the ball you have to tilt the playfield by tilting the Wii Remote,
you can also play using the Wii Balance Board.
The ball is fragile, so don't let it fall too far. 
There or many types of ball in the game, some are more fragile than others.
Try to avoid deadly obstacles like spikes or acid pools.<br><br>

You also have 25 goals to accomplish. Completing them will increase your progress percentage.
The difficulty of the game will adjust itself according to your skill level.<br><br>

Each level has its own highscores. Can you be top on each one!<br><br></div>
  <div id="image02">
