...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753544A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界中でファンの多い、トランプの１人遊びのジャンル「ソリティア」。１００以上のルールがあるこのソリティアゲームの中から、配られるカードが明暗を分ける「天使のソリティア」、山札からめくる３枚のカードが鍵となる「クロンダイク」、根気と推理力が勝負の「タワーオフ」、最も代表的なルールを採用するこの３つのゲームをパックしました。１回のプレイはほんの数分、ちょっとした息抜きに遊べるゲームです。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753544A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">天使のソリティア</span></div>
</div>
