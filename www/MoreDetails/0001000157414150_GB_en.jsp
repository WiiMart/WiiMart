...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157414150')", "wiiSelectSound()");
...
<br><br>
Pursue Cseom around three constellations, each with ten Cubes. You'll have some really hard puzzles to solve at the end! Play with other gamers to see who will be first to get the Cube working again, or play for the Bonus Cubes.</div>
  <div id="image02">
