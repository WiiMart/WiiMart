...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Disfruta junto con tus amigos en juegos multijugador y compite por conseguir la mayor puntuación usando tu Mii™ y otros personajes! Elige entre seis modos diferentes para uno o varios jugadores, como Speed Catch, que prueba tu habilidad para atrapar una pelota rápida; o Bomb Catch, un juego eliminatorio para hasta 4 jugadores. Elige entre varios personajes o usa tu Mii™ para jugar. ¡Desbloquearás nuevas sorpresas si completas, tanto Let's TAP como con Let's CATCH!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324B45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324B45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
