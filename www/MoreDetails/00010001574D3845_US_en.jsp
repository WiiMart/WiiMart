...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D3845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A brand-new addition to the Bomberman series is available on WiiWare! Up to eight players can battle online simultaneously via Nintendo® Wi-Fi Connection. Simple controls make this a great game for family and friends to enjoy anytime. New items can be triggered by shaking the Wii Remote™ controller for excitement never before experienced in a Bomberman title! You can even take the intensity up another notch by adding your own Mii™ caricatures to the mix. Battle results can be recorded on Nintendo Wi-Fi Connection Ranking, so see how you stack up against others around the globe! This title will prove to be a blast for everyone—from those who've never touched a Bomberman game to the Bomberman masters!</div>
  <div id="image02">
