...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ハードなＳＦ世界を舞台にした横スクロール型のシューティングゲームです。惑星「アリエス」を襲撃した超犯罪組織「オベロン」を倒すため、銀河特装の秘密隊員「ホーク」が、新鋭戦闘機「Ｈｕｎｔｉｎｇ　Ｄｏｇ」に乗り込み、敵の機動要塞に向けて出撃します。プレイヤーは、味方機「Ｗｉｌｄ　Ｃａｔ」からの補給を受けながら自機を強化。ノーマル装備の「レーザー」をはじめ、広範囲への攻撃ができる「ウェーブ」、高威力の「ナパーム」と、状況に合わせて３つの武器を使い分けて進んでいきます。
パワーアップ時に装備される「オプション」は、攻撃方向を瞬時に切り替え可能。前方はもちろん、背後からの攻撃にもすばやく対処しつつ全７ステージのクリアをめざします。また難易度設定では、敵の攻撃がさらに激しい「ＨＡＲＤ」「ＤＥＶＩＬ」モードが用意されており、腕に覚えのあるプレイヤーにも遊びごたえ抜群です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゲート オブ サンダー<sup>&reg;</sup></span></div>
</div>
