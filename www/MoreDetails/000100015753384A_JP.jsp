...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753384A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「みんなで対戦パズル 上海Wii」は、麻雀牌を使ったパズルゲームです。<BR>「ひとりで上海」と「みんなで上海」の２つのゲームモードがあります。<BR>「ひとりで上海」はおなじみの上海を楽しめます。<BR>「みんなで上海」は1～４人で同時に行う対戦上海です。(1人でプレイする場合はＣＯＭが対戦者となります。)<BR>家族や友達みんなで、わいわいがやがやと、パズルゲーム上海を遊びながら牌を取り合うパーティーゲームモードです。<BR>一番多く牌を取ったプレイヤーが勝ちとなります。<BR>アイテムを使って相手をじゃましたり、自分が有利になったり、横取りアイテムを使ったりと白熱した対戦が楽しめます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753384A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753384A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">みんなで対戦パズル　上海Wii</span></div>
</div>
