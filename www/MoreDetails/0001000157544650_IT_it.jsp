...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157544650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il cerchio della serie BIT.TRIP si chiude con l'uscita di BIT.TRIP FLUX, l'avventura finale di CommanderVideo!<br><br>
Afferra il telecomando Wii, guida la più classica delle racchette elettroniche nel ritorno alle origini di CommanderVideo.<br><br>
Gioca da solo o in modalità cooperativa a due giocatori: affronterai nuove sfide che non daranno tregua neanche ai veterani di BIT.TRIP!<br><br>
Impugna la racchetta elettronica che ha dato inizio al fenomeno BIT.TRIP e lanciati nella sfida:<br><br>
• Nuovi power-up, come la Fullscreen Paddle!<br>
• Nuovi tipi di Beat, tra cui gli Avoid Beat!<br>
• Checkpoint di metà livello!<br>
• L'esperienza di gioco classica di BIT.TRIP BEAT con in più la modalità Meta Mode!<br>
• Bit Shifter di ritorno come ospite d'onore con la sua chip music!<br><br>  
Rimani accanto a CommanderVideo nella sua ultima missione prima del ritorno a casa!
<br><br>
