...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le Dr. Robotnik a pris le contrôle du Mont Mobius qu'il a transformé en base mécanique. La Veg-O-Fortress, alimentée par la puissance du magma qui coule sous le volcan, confère au docteur le pouvoir de changer les animaux sans défense en robots. Sonic doit détruire cette forteresse pour les libérer.
<br><br>
La seule solution est de déclencher une éruption. Sonic sait qu’il peut y arriver en retirant les Chaos Emeralds qui ont un effet stabilisateur. Le Dr. Robotnik connaît également l’influence des Emeralds sur la montagne, et c’est pour cela qu’il a mis au point un flipper de défense pour empêcher quiconque de prendre les joyaux.
<br><br>Le texte à l'écran sera en anglais.
<br>Incompatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D415450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D415450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sonic Spinball<sup>TM</sup></span></div>
</div>
