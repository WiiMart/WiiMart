...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157534750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SAMEGAME è un semplice ed avvincente puzzle game dove elimini dei blocchi abbinati in gruppi di 2 o più.<br><br>

Totalizza i punteggi maggiori eliminando più blocchi alla volta. Se riesci ad eliminare l'intero campo di gioco, puoi continuare a giocare con un nuovo layout. Eliminare tutti i blocchi è la chiave per totalizzare punti!<br><br>

Imposta la difficoltà in un gioco ad 1 giocatore provando diverse misure e diversi numeri di colori per i campi di gioco: gioca a modo tuo!<br><br>

Fino a 4 giocatori possono sfidarsi in una delle 3 modalità multigiocatore: "FameGame" è la scelta più semplice, molto simile alla versione ad 1 giocatore; "ShameGame" dove le regole sono invertite ed i giocatori devono mirare al punteggio più basso ed infine "BlameGame" dove tutti competono su un unico campo di gioco.<br><br>

Scegli tra diversi tipi di blocchi, grafiche di fondo e musica per personalizzare il tuo gioco.<br><br>

SAMEGAME: facile da imparare e facile da giocare... ma difficile smettere!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534750/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534750/FFFD0015" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
