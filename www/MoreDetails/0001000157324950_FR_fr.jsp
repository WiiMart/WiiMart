...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157324950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bienvenue dans FISHIE FISHIE, le jeu seul jeu qui se joue avec un unique bouton.<br>
Vous allez vivre une expérience extraordinaire qui mettra vos réflexes à rude épreuve.<br>
Le jeu comprend une série de tutoriels qui vont vous apprendre à diriger votre poisson ainsi que les règles des différents modes de jeux.<br>
Dans FISHIE FISHIE, vous incarnez un poisson qui doit sans cesse se nourrir. Vous devrez également venir à bout de plusieurs modes de jeux et ceci le plus rapidement possible. Chaque seconde compte.<br>
Pour gagner, vous devrez réussir une centaine de niveaux repartis dans 7 modes de jeux : "histoire", "football", "capture l’étoile", "survie", "parcours d’adresse" ainsi qu’une grande compétition.<br>
En solo ou à 4 sur le même écran, tous les moyens sont bons pour gagner!
