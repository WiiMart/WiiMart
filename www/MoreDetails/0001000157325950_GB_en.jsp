...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157325950')", "wiiSelectSound()");
...
<br><br>
Now you can turn your television into a fireplace, equipped with realistic graphics and a fire that will almost burn you.
<br><br>
Prepare the wood, light the fire and stoke it. Or, if you prefer, choose the ‘automatic’ option to have the fireplace on your screen while you eat with your family, celebrate a party with friends or dine with your partner...there are fireplaces for every occasion!</div>
  <div id="image02">
