...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574D5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">il mondo di miffy è un mondo in 2D che ruota intorno al personaggio creato da Dick Bruna.<br>
Ne il mondo di miffy, il bambino gioca nei panni di Miffy e esplora diversi luoghi per portare a termine piccoli compiti. Interagisce così con gli amici e con gli oggetti nell'ambiente circostante divertendosi con una serie di minigiochi educativi.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5750/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D5750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">il mondo di miffy</span></div>
</div>
