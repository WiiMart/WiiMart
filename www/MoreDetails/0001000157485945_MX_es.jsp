...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157485945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Únete a una campaña militar peligrosa en América del Sur, la continuación de un conocido juego de tiroteo, Heavy Fire: Special Operations. Conviértete en recluta de fuerzas especiales y participa en la operación para acabar con tráfico de armas. Heavy Fire aporta una diversión de arcade clásica, dotada de gráfica espectacular y características excitantes y novedosas.
<p>
Desarticula el cartel Fuerza de Voluntad, traficante de armas en el continente. Invita a un amigo para disfrutar de una apasionante partida de 2 jugadores. Experimenta un juego cada vez más dinámico, pasando por varias condiciones atmosféricas y localizaciones del corazón de la selva. Destruye elementos a tu alrededor, ejecuta misiones adicionales de agilidad y enfréntate a enemigos con armas nuevas y potentes. Para la actividad de la organización paramilitar con un arsenal bien equipado y varios vehículos a tu disposición. Usa Wii Remote™ o Wii Zapper™ y entrégate al juego. ¡El precio es más alto que nunca!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157485945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157485945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Heavy Fire: Black Arms</span></div>
</div>
