...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Baby Bowser has snatched the Super Happy Tree and cast a spell on Yoshi’s Island, turning it into a picture book! Only six Yoshis remain, so it falls to them to reclaim the tree and restore happiness to the world.
<br><br>
...
<br><br>Text in-game can be set to English, German or French.</div>
  <div id="image02">
