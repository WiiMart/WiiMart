...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157414F4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「はらぺこあおむしのＡＢＣ」は、お子さまと一緒に楽しみながら英語に親しむことが出来る英語知育ゲームソフトです。<BR>カラフルなアルファベットとエリック・カールのイラストが楽しいアルファベット表や、数字／色や形の名前、様々な動物の名前などの名詞から、「走る」「食べる」「大きい」「小さい」といった簡単な動詞や形容詞など、就学前児童の興味にあわせて単語を収録した単語クイズなど４つのコーナーがあります。<BR>「保護者メニュー」ではお子さまがどれくらいの単語を覚えているのか確認することができます。<BR>世界で最も人気の絵本作家　エリック・カールの色彩豊かなイラストの世界をご家族そろってお楽しみください。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414F4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">はらぺこあおむしのABC</span></div>
</div>
