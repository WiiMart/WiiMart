...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">シューティングゲームの傑作「グラディウス」の続編。「超時空戦闘機ビックバイパー」が「サラマンダ軍」の侵攻を食い止めるために敵の母星へと向かいます。ステージごとにスクロール方向が縦・横交互に切り替わり、プレイヤーは「パワーアップアイテム」で自機を強化しながら敵を撃破していきます。各ステージの最後で待ち構えるボスを破壊するとステージクリア。燃えさかる「高密度エネルギー」ステージをはじめ、火山弾が降りそそぐ「地底火山」や「小惑星」など、前作以上に趣向をこらした６ステージがアーケード版から忠実に移植されています。攻略が難しいポイントで力をあわせて立ち向かうことができる２人同時プレイも可能です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
