...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieses Action-Rätselspiel wurde 1996 von Data East veröffentlicht.<br>
Die Regeln lassen sich blitzschnell in die Tat umsetzen. Oben am Bildschirm erscheinen kunterbunte Kugelreihen. Du steuerst einen Clown, der die Kugeln nach Farben sortiert. Hat er drei gleichfarbige übereinander gestapelt, lösen sich diese auf.<br>
Der Spaßfaktor des Rätselspiels erhöht sich zusätzlich durch knifflige Extrakugeln: „Spezialkugeln“ (in vier Farben), die alle Kugeln einer Farbe verschwinden lassen oder „Pfeilkugeln“, die sämtliche Kugeln in Pfeilrichtung aus dem Weg räumen. „Schaumkugeln“ stellen sich dir als Hindernisse in den Weg. Die „Regenbogenkugeln“ kannst du als Spezialkugeln für alle Farben einsetzen.<br>
Im „VS CPU-Modus“ erscheinen ständig drollige Gegner, die dir das Leben schwer machen, und im „Puzzle-Modus“ kannst du auch allein spielen. Der integrierte 2-Spieler-Modus garantiert stundenlangen Spielspaß mit deinen Freunden.
<br><br>
