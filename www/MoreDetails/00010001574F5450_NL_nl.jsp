...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574F5450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Overturn Mecha Wars is een één-tegen-één toernooi waarin door de spelers bestuurde futuristische mechs met een flink arsenaal aan high-tech wapens het tegen elkaar moeten opnemen.
<br>
Het doel van het spel is de tegenstander te raken en tegelijkertijd zijn inkomende aanvallen te ontwijken, totdat er een winnaar overblijft.
<br>
Spelers kunnen kiezen uit acht robots en deze volledig naar eigen inzicht aanpassen. Er is daarbij keuze uit diverse speciale wapens die beschikbaar komen naarmate de speler verder komt in het toernooi.
<br>
Het spel kan door twee spelers worden gespeeld via een gedeeld scherm.
<br>
Spelers kunnen hun mechs ook besturen door hun gewicht te verplaatsen op het Wii Balance Board!
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F5450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F5450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Overturn Mecha Wars</span></div>
</div>
