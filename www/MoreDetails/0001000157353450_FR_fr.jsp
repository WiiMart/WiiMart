...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157353450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Amuse-toi avec toute ta famille et participe aux différents modes de jeu !<br>
5 Spots Party est un jeu d’habileté pour tous les publics basé sur le célèbre jeu qui consiste à chercher les 5 différences.
<br><br>
Dans les 3 modes du jeu, l’objectif consiste à trouver le plus grand nombre de différences dans les images présentées. Dans les modes Party, tu dois rivaliser avec
d'autres joueurs et découvrir le
plus grand nombre d'erreurs
possibles. Dans le mode 1 Joueur, tu dois trouver les différences avant que le temps imparti ne se soit écoulé pour battre les records du jeu.
<br><br>
Jusqu’où crois-tu que tu pourras arriver ?
