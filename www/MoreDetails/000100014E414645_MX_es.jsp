...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Elige entre 30 vehículos de carrera flotantes, incluyendo versiones actualizadas del Blue Falcon y otros vehículos de F-Zero original, y prepárate para una de las carreras más rápidas de todos los tiempos! Corre hasta la meta en carriles que tuercen y doblan a través del aire. ¡Pero tienes que evitar a los otros 29 carros en la pista o sufrir las consecuencias! Si te sientes con un estado de ánimo competitivo, intenta ganar la copa Grand Prix, obtener el tiempo de vuelta más rápido en el modo de Prueba de Tiempo, o destruir a la competencia en una Carrera Mortal. También puedes retar a tres amigos en modo Versus. ¡Con cinco modos de juego distintos, vehículos y pistas escondidas, y una música de juego excelente, F-Zero X representa uno de los mejores juegos de carrera de todos los tiempos!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">F-Zero<sup>&reg;</sup> X</span></div>
</div>
