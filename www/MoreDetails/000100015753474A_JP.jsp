...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753474A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「さめがめ Wii」は、同じ色で２個以上くっついたコマを選んで消していく、シンプルかつ熱中度の高いパズルゲームです。<BR><BR>できるだけコマをたくさんつなげて消すと高得点で、さらに画面内の全てのコマを消せれば、コマが再配置されてそのままゲームが続けられます。<BR>なるべくたくさんくっつけて全部消す。これが高得点をとる秘訣です。<BR><BR>１人用のモードは、盤面の大きさやコマの色数などの難易度を変えられます。自分の好きなルールで思う存分楽しんで下さい。<BR><BR>対戦モードには、最大４人まで遊べるゲームを３つ用意しました。<BR>「VSさめがめ」は、１人用モードに近い最もシンプルなゲームです。<BR>「VSかめ⇔ざめ」は、最も低い得点のものが勝つという、少し頭を悩ませるゲームです。<BR>「BATTLEおりゃがめ」は、１つの盤面で全員一斉にコマを取り合うという最も熱いゲームになっています。<BR><BR>ゲームのコマの種類、背景、BGMなどもいくつか用意したので、好きなものを選んで楽しんでください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753474A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753474A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">さめがめ Wii</span></div>
</div>
