...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This game was not previously released on the NEOGEO in the Western hemisphere. There may be nonessential material in the game that is unfamiliar to consumers, including foreign-language audio and text.
<p>
Iron Clad is a side-scrolling shoot ‘em up developed by SAURUS in 1996. You operate a war ship and team with the mighty Iron Clad in order to fight the Iron Mask Republic and save the Kingdom of Chop. The biggest appeal of this game comes from discovering all the ways you can attack your enemies. Your weaponry includes three main blast weapons upgradable by collecting more items, a charged attack you can use when Iron Clad is attached to your ship, three types of melee weapons you can brandish to show off your strength in close-range combat, a bomber that clears all enemy bullets, and finally shooting patterns that change based on whether the Iron Clad is attached or disconnected from your ship. And not surprisingly, a vast array of weaponry lies in wait to be part of your arsenal. You can even select the stages you want, feeding your hunger for combat and allowing you to see different endings for each play through! You can have a blast playing over and over again to see all the endings and variety this game has to offer.</div>
  <div id="image02">
