...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158494D50')", "wiiSelectSound()");
...
<br><br>HoopWorld: BasketBrawl is een drie-tegen-drie basketbalspel met een arcadetwist! Unieke personages en prachtige natuurlijke locaties zetten de juiste stemming terwijl vechtacties en willekeurige power-ups het spel van snelheid en afwisseling voorzien. Kies je favoriete team en 'basket-vecht' je over de hele wereld om de onbetwiste wereldkampioen te worden. Speel alleen of met een vriend(in) en kijk of jij de koplopers van het HoopWorld-klassement kunt verslaan. Ben je er klaar voor? <br>
Lang geleden werd er door de Elders, een volk dat de magische kracht van de natuur vereerde, een netwerk van heilige tempels over de hele wereld gebouwd.<br>
Duizenden jaren zijn voorbij gegaan en van de ooit zo glorieuze tempels is weinig meer over. De energie klopt echter nog altijd onder het oppervlak en trekt avonturiers uit de verste uithoeken van de wereld aan. Beïnvloed door de onbekende kracht, zijn enkele vrienden begonnen om de ruïnes tot sportzalen om te bouwen met de wetenschap dat zij de eeuwenoude zielskrachttest van de Elders zullen moeten voltooien. Een test die tegenwoordig beter bekend staat als... basketbal.<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494D50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494D50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">HoopWorld<sup>TM</sup>: BasketBrawl</span></div>
</div>
