...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo gioco di pallacanestro 3 contro 3 ti farà vivere la fantastica atmosfera di una partita di basket da strada! Scegli una delle 10 squadre rivaleggianti per il titolo di formazione più forte del mondo!
<br><br>
Potrai provare l’ebbrezza di giocare a pallacanestro usando comandi semplici, che ti consentiranno di eseguire spettacolari schiacciate, passaggi a mezz’aria per finalizzare un canestro e di andare a segno dopo aver conquistato un rimbalzo. Inoltre, caricando la barra dell'energia, potrai sbalordire tutti con un super colpo capace di superare qualsiasi difesa e fare tremare la terra intera.
<br>
Questo gioco unisce con successo le regole di base della pallacanestro con mosse speciali tipiche dei videogiochi.
<br><br>
