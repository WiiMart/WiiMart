...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">King of Fighters '98 es la quinta entrega de esta célebre saga de juegos de lucha, publicada como una compilación tras asentarse el polvo desde el épico Sabio Orochi. King of Fighters '98 presenta un total de 38 personajes, que pueden dividirse en 12 equipos, más 2 personajes individuales. Esta vez, podemos ver también el largamente esperado retorno del Equipo Sports. El modo de juego sigue el mismo patrón de su predecesor, la versión '97, en el que los jugadores pueden elegir entre el Modo Avanzado o Extra para combatir de acuerdo a su estilo individual. Algunos de los cambios menores incluyen mayor personalización para disfrute de los fans, así como una mejor mecánica de lucha.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
