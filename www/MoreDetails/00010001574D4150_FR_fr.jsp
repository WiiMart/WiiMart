...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574D4150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dans Magnetis, tout est question d'attraction !
<br><br>
Connectez des aimants ensemble pour créer des explosions électriques. Dans ce puzzle frénétique, il vous faudra réfléchir vite et anticiper les connexions à venir afin de générer de grandes réactions en chaîne pour cumuler plus de points !
<br><br>
Pour vous débarrasser des blocs et marquer des points, vous devez former des lignes en reliant un aimant gauche à un aimant droit de même couleur en utilisant des blocs porteurs. Plus une ligne est grande, plus elle rapporte de points.
<br><br>
Jouez avec vos amis dans un mode coopératif, ou affrontez jusqu'à 4 joueurs en mode bataille. Qui fera le plus gros score ?
<br><br>
