...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483650')", "wiiSelectSound()");
...
<br><br>
Una sonda exploradora ha sido enviada a un extraño planeta de la galaxia para que este sea explorado.
 <br><br>
Tras un forzoso aterrizaje en la superficie del mismo, nuestro protagonista pierde las habilidades de las cuales disponía para cumplir su misión. Ayúdale a recuperarlas mediante unas extrañas criaturas que han tomado su interior mecánico... ¡descubre la verdad que oculta su nueva misión!
<br><br>
Podrás disfrutar de un completo modo aventura, desempeñándote en la superficie del planeta al explorar diversos caminos y descubriendo los múltiples secretos que se esconden en él, tomando el papel de la sonda exploradora.
<br><br>
Dentro de la sonda exploradora podrás manejar a unas diminutas criaturas que ayudarán a reparar las zonas dañadas tras el accidente, recuperando así habilidades y accediendo a sus archivos de memoria.
<br><br>
Si no puedes avanzar por el interior del robot deberás buscar piedras de ámbar en el exterior para obtener nuevas criaturas y progresar así por sus circuitos internos.
