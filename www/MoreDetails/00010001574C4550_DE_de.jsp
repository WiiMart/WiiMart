...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574C4550')", "wiiSelectSound()");
...
<br><br>
Mit den Pooyoos, einer fröhlichen Rasselbande niedlicher Babytiere, werden Ihrem Kind Grundlagen für seine Entwicklung vermittelt: Zahlen, Buchstaben, Lateralisation, Formen, Farben und mehr. Die Kinder tanzen mit ihren neuen Freunden und können so großartige, interaktive Belohnungen bekommen. Es gibt zwei Schwierigkeitsstufen, so dass die Kinder ihrem Alter und ihren Fähigkeiten entsprechend spielen können.
<br><br>
Dieses Spiel wurde für Kinder entwickelt,  die noch nicht lesen können.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
