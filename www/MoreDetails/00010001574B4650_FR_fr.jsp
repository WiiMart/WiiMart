...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574B4650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Votre technique sera-t-elle assez bonne?
<br><br>
Kung Fu Funk est un jeu un peu farfelu inspiré des films d'arts martiaux des années 1970. Relevez le défi avec deux ou trois autres joueurs pour voir qui maîtrisera le Kung Fu. Vous devrez surmonter toutes sortes d'épreuves dans trois modes loufoques. Comme dans les films de Kung Fu, il vous faudra tout d'abord maîtriser l'art zen: ce mode vous permettra de vous familiariser avec les commandes. Une fois votre Kung Fu maîtrisé, vous entrerez dans le mode entraînement, un montage de film qui consiste en une série de mini-jeux tous plus fous les uns que les autres. Enfin, une fois votre technique perfectionnée, vous entrerez dans le mode combat où vous deviendrez maître de Kung Fu et vous ouvrirez votre propre dojo-discothèque.<br><br>Texte écran en français.</div>
  <div id="image02">
