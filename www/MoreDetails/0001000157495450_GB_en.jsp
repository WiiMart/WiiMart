...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157495450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A hidden object game for everyone has come to WiiWare!!
<br><br>
Do your best and try to find 12 particular items among a crowd of objects on screen as fast as you can!  From big fish to tiny earrings.  Easy to find items to very well hidden items.  Lots of items and lots of fun can be found in this hidden object game!  
Unlike most other hidden object games, play along with friends and family and compete to see who is best at finding the hidden objects in each stage! (Up to 4 players)
<br><br>
With 10 stages in total and over 277 different items there is plenty of searching fun to enjoy!  Also, with many items changing position each time you play, you can enjoy each stage again and again!
<br><br>
Play and enjoy together!!
A hidden object game for everyone!!</div>
  <div id="image02">
