...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157395250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stai organizzando una festa per Natale e vuoi impressionare i tuoi ospiti? O vuoi semplicemente inviare delle cartoline d'auguri senza dover leccare i francobolli? Abbiamo la soluzione che fa per te: crea e spedisci dei divertenti biglietti natalizi con questa applicazione WiiWare unica!
<br><br>
Happy Holidays Christmas ti permette di realizzare dei divertenti biglietti natalizi da scambiare con i tuoi amici direttamente tramite la console Wii!
<br><br>
Aggiungi un albero e delle decorazioni, scegli le cornici, le etichette e la musica, quindi scrivi un messaggio per gli amici presenti nella tua rubrica Wii.
<br><br>
Forse non riceverai l'auto sportiva che avevi chiesto, ma questa applicazione renderà comunque il tuo Natale più allegro!
<br><br>
...
Le funzioni online di questo software utilizzabili tramite WiiConnect24 non sono più disponibili, poiché parte dei servizi online della console Wii non è più operativa dal 28 giugno 2013.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157395250/FFFD0015" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157395250/FFFD0016" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
