...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dies ist die PCEngine (Turbografx16)-Version des 2-Spieler-Kampfklassikers, mit dem alles angefangen hat.
Für die Portierung wurde seinerzeit eine HuCARD mit großer Kapazität benutzt, die eine originalgetreue Umsetzung des dynamischen Arcade-Spiels, samt all seiner Features wie Bonus-Stages und Sound-Effekte, ermöglichte.
Wähle einen von zwölf Charakteren aus und stelle dich deinen Gegnern in einem erbitterten Duell, um den besten Kämpfer zu ermitteln.
Meistere die Spezialangriffe und Combos eines Charakters, um deine Rivalen auf der ganzen Welt zu besiegen!
Im „V.S. BATTLE“-Modus steht ein nützliches Handicap-Feature zur Verfügung. 
Mit diesem Feature können die Fähigkeiten eines Charakters eingestellt werden, damit auch Neulinge einen mitreißenden Kampf gegen erfahrene Spieler austragen können. 
<br><br>
Englischer Bildschirmtext – enthält japanische Elemente.</div>
  <div id="image02">
