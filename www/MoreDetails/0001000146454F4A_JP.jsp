...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ヘリック共和国軍と暗黒軍（ガイロス帝国）との戦いをえがいたシミュレーションゲーム。プレイヤーは両軍どちらかの司令官になり、メカ生体「ゾイド」を操って、敵軍のボス・ゾイドの撃墜をめざします。シミュレーションパートは、コンピュータの順番を待たずに行動できる「リアル」と、コンピュータと交代で２回ずつ行動する「コウタイ」という、二つのモードが選べます。ターンにより「地殻変動」が起こり地形が変化、戦況も変化していきます。自軍ゾイドと敵軍ゾイドが重なると、バトル開始です。バトルは２Ｄアクションシューティング。体当たりと武器を使用して、相手のＨＰをゼロにすれば勝利です。マークⅡ化したゾイドなら間接攻撃が可能なパワーアップ武器が使えます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146454F4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146454F4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ZOIDS黙示録</span></div>
</div>
