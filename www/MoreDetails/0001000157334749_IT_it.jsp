...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157334749')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La terza avvventura di Phoenix Wright arriva su WiiWare!  Il successivo atto del dramma in aula va in scena in "Trials and Tribulations". Personaggi nuovi di zecca, nuovi casi criminali e gameplay - la difesa non dà un attimo di tregua!<br><br>

Il terzo capitolo della popolare saga di Ace Attorney arriva su WiiWare.  Cinque nuovi scioccanti casi vissuti in prospettiva soggettiva!  Funzione "Psyche-Lock - Alcuni testimoni nascondono la verità! Utilizza argomentazioni logiche per rivelare la contraddittorietà delle loro testimonianze. <br><br>
 
Due modalità di gioco:<br>
- Investigazione: indaga sulle scene del delitto, interroga testimoni e raccogli prove<br>
- Corte: presenta le prove, ascolta e esamina le testimonianze<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334749/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157334749/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Phoenix Wright<sup>TM</sup> Ace Attorney<sup>TM</sup></span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Trials and Tribulations (Testo in italiano)</span></div>
  </div>
