...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157505150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Protöthea is een scrollende shooter game in bovenaanzicht met totaal vrije beweging waarbij de speler de gezagvoerder is van een laatste-generatie ruimteschip. Je opdracht is de “Maqno 01” asteroïde te vernietigen en korte metten te maken met de plannen voor “The Core”. 
<br><br>
Ubisofts Protöthea voegt nieuwe concepten toe aan een geliefde klassieke speelstijl waarbij een mix van spelgenres ontstaat en maakt optimaal gebruik van de mogelijkheden van de Nintendo Wii-afstandsbediening zowel wat betreft graphics als besturing.
<br><br>
Ongeacht je leeftijd of ervaring, je neemt met plezier het commando over het schip op je en blaast je in 10 uitdagende missies een weg door 4 verschillende werelden. Gebruik je wapens en de speciale bonusvoorwerpen om je missie te voltooien. Oh ja, vergeet niet dat je de tijd kunt vertragen waardoor je in het voordeel bent ten opzichte van de vijand!!<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505150/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505150/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Protöthea<sup>TM</sup></span></div>
</div>
