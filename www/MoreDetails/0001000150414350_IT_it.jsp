...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dungeon Explorer è un GDR d’azione dove fino a cinque giocatori possono giocare insieme contemporaneamente. La storia si svolge all’interno di labirinti sotterranei e potrai scegliere uno fra otto tipi differenti di personaggi: Fighter (guerriero), Thief (ladro), Warlock (stregone), Witch (strega), Bishop (vescovo), Elf (elfo), Bard (bardo) o Knome (nano). I tipi di magie che potrai utilizzare, la forza dei tuoi attacchi e il tuo movimento varieranno a seconda del personaggio scelto. Per sopravvivere, dovrai conoscere bene le debolezze dei tuoi nemici. Dovrai conoscere anche gli attributi speciali di ogni incantesimo e utilizzarli per trarne il massimo vantaggio. Nelle partite cooperative, lavorare insieme è la chiave per vincere.<br><br>Quando giochi nella modalità per più giocatori, il numero di telecomandi Wii dev'essere uguale al numero di giocatori.<br>Per giocare in cinque, è necessario utilizzare almeno un controller per Nintendo GameCube.<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
