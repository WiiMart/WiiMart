...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001584A4450')", "wiiSelectSound()");
...
<br><br>
Racing game thrills meet platformer charm in MotoHeroz, a side-scrolling racer built with simple controls and engaging physics. The result is a new kind of racing adventure! Players race, chase, and rally their way through a brightly coloured world, competing against their friends for the fastest times, entering daily races, and hunting for secrets and coins. Simple but effective physics deliver an addictive gaming experience. Single player story mode presents memorable characters and rich visuals. Thrill to a two to four player party mode that’s easy to pick up and play! Ghost race against the Leader Boards, join a Buddy League, and compete online in daily competitions. It’s MotoHeroz, for WiiWare.</div>
  <div id="image02">
