...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Met Wii U-overdrachtssoftware kun je de volgende gegevens als één geheel overdragen van een Wii-systeem naar een Wii U-systeem:<br><br>

• Opgeslagen gegevens voor Wii-software<br>
• WiiWare-titels en bijbehorende opgeslagen gegevens<br>
• Virtual Console-titels en bijbehorende opgeslagen gegevens<br>
• Aanvullende content voor software<br><br>

• Wii Points<br>
• Je activiteiten in het Wii-winkelkanaal<br><br>

• Mii-personages<br><br>

Om gegevens over te dragen heb je een Wii-systeem en een Wii U-systeem nodig, evenals:<br><br>

Een internetverbinding<br>
Een SD-/SDHC-kaart met ten minste 512 MB vrije ruimte<br><br>

Belangrijke informatie over de gegevensoverdracht:<br><br>

• Overgedragen gegevens worden permanent van je Wii-systeem verwijderd.<br><br>

• Gegevens kunnen niet worden overgedragen van een Wii U-systeem naar een Wii-systeem. Zodra gegevens zijn overgedragen van een Wii-systeem naar een Wii U-systeem, kunnen ze niet worden teruggezet.<br><br>

• Alle overdraagbare gegevens worden als één geheel overgedragen. Het is niet mogelijk om de afzonderlijke onderdelen apart over te dragen.<br><br>

• Software die op het moment van aankoop op je Wii-systeem was voorgeïnstalleerd, wordt niet overgedragen.<br><br>

• WiiConnect24 wordt niet door het Wii U-systeem ondersteund. Sommige softwarefuncties zijn mogelijk niet langer beschikbaar nadat de software naar een Wii U-systeem is overgedragen.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435350/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435350/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii U-overdrachtssoftware</span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Wii-kanaal</div>
</div>
</body>
</html>
