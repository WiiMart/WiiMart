...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Motoroader es un juego de carreras futurista que permite que hasta 5 jugadores compitan entre ellos! Usa el dinero obtenido al ganar carreras para mejorar tu máquina. No solo puedes cambiar las ruedas (TIRE) y el chasis (BODY) de tu vehículo, ¡además puedes añadir partes especiales (SPECIAL)! ¡Salta por encima de grandes obstáculos (HOPPER) y aparta a tus rivales con la onda expansiva del nitro (NITRO)!
¿Qué juego multijugador estaría completo sin objetos de ataque? ¡Lanza granadas (GRENADE) hacia delante o deja caer bombas (BOMBER) para hacer volar por los aires a tus adversarios!
¡Vence a tus rivales en los 8 circuitos (HEATS) y conviértete en el campeón!
<br><br>Para jugar con varios jugadores, deberás conectar tantos mandos de Wii o mandos de Nintendo GameCube como jugadores haya.
