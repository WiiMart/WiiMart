...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B424A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ニンゲ」をキューブの上にバランスよく投げよう！<BR><BR>
『きみとぼくと立体。』は、まるで人間のような生き物「ニンゲ」をキューブ（立体）の上に投げてバランスよく乗せていく、新しい感覚のアクションゲームです。
ゆらゆらと傾くキューブの上に、指定された数のニンゲを乗せるとステージクリアです。<BR><BR>
乗せたニンゲのバランスによって、キューブは傾きます。バランスが悪くなり、傾きが大きくなると、ニンゲは倒れたり、滑ってキューブから落ちてしまいます。楽しく動きまわるニンゲの場所を見て、キューブのバランスが良くなるよう、上手に投げ入れましょう。<BR><BR>
１人用ゲームのほか、２人で協力してプレイするゲームもあります。<BR>
操作を簡単に覚えるための、チュートリアルも収録されています。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B424A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">きみとぼくと立体。<sup>TM</sup></span></div>
</div>
