...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界征服をたくらむ悪の天才科学者「爆田（ばくだ）博士」は、自らが生み出した悪の軍団を使い、手始めに「新田４丁目」への侵攻を開始しました。その野望を阻止するため突如現れたのが、「アルファ遊星人」より力を授かった正義の使者「ベラボーマン」です。「新田４丁目」は全２２ステージで、地上を舞台とするアクションステージと、水中を進んで行くシューティングステージの２種類があります。アクションステージでの操作は、ボタンを押している長さによってジャンプや攻撃の距離が変化するというユニークなシステムが特徴です。さらに、敵を倒すと現れる「福」マークを集めていくと、「福引男」から回復アイテムやパワーアップアイテムを手に入れることができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
