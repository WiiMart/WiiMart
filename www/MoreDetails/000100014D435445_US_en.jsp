...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In this zany 2-D fighter, it's just another day for a humble traveling circus troupe when a meteor crash-lands in their camp. The otherworldly orb, made entirely out of interstellar clay, contaminates all the circus employees, turning them into bizarrely superpowered versions of themselves. Choose from among the unique clay creatures, such as Bonker, the cheerfully manic clown, or Blue Suede Goo, the mild-mannered Elvis impersonator turned violent vocalist. Master their "Claytalities," like the operatic Helga's deadly high note and Bad Mr. Frosty's fists of snowball fury!</div>
  <div id="image02">
