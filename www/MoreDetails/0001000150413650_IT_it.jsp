...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Penetra da solo in territorio nemico e metti in salvo il Presidente, rapito da un gruppo di terroristi! In questo sparatutto con visuale isometrica vestirai i panni di un membro delle forze speciali e dovrai eliminare i nemici usando numerose armi, tra cui mitragliatori e granate. Recupera gli altri ostaggi per ottenere informazioni preziose, armi e vari oggetti essenziali. Alla fine di ciascun livello dovrai affrontare e sconfiggere il boss che ti sbarra l’accesso all’area successiva.
<br><br>
Questa favolosa conversione del popolarissimo classico offre migliorie grafiche, una trama ancor più coinvolgente, azione intensa e senza tregua. Accetta la sfida e cimentati anche nella seconda parte dell’avventura, non presente nella versione arcade originale!
