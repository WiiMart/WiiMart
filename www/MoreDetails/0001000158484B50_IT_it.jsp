...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158484B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">IMPORTANTE: Alcune caratteristiche della versione del prodotto non sono supportate in questa demo. La demo non permette il salvataggio dei dati del gioco, pertanto non potrete continuare il vostro gioco sulla versione finale del prodotto. La versone completa ha 10 livelli. Nella versione demo è possibile giocare solo su uno di questi livelli.
<br><br>
Nel corso degli ultimi cinque secoli, centinaia di navi, di tutte le bandiere, sono state sommerse dal potere dell'oceano. Navi mercantili, barche di pirati, navi da guerra... finite ricoperte di corallo in fondo agli oceani di tutto il pianeta.
<br><br>
Ma ciascuna portava con sé segreti che per anni sono rimasti nascosti. Segreti che hanno rappresentato un mistero... finora.
<br><br>
