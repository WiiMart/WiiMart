...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">隣り合う左右のパネルを入れ替え、３つ以上の同じパネルをタテかヨコにそろえて消していくアクションパズルゲームです。カーソルを動かして入れ替えるパネルを選び、ａ／ｂボタンを押して入れ替えましょう。せり上がるパネルがフィールドの上までつまってしまうと、ゲームオーバーです。攻略の基本は、一度に４つ以上のパネルを消す「同時消し」と、消えたところに落ちたパネルが次のパネルとそろってまた消える「連鎖消し」です。中でも決め手となるのは「アクティブ連鎖」。このゲームではパネルが消えていく間にもほかのパネルを操作できるので、空いたところにパネルが落ちてくるまでに連鎖消しを仕込むことも可能です。簡単操作でわかりやすく単純なルールながら、極めるまでは奥が深く、難易度もゲームモードも多彩で手ごたえ十分。特にストーリーモードや２人対戦プレイでは、同時消しや連鎖消しをすると、相手に「おじゃまパネル」を送って邪魔をすることができるので、熱く盛り上がれます。同時消しや連鎖消しをマスターして、 ゲームを有利に進めましょう。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424F4A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424F4A/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パネルでポン<sup>&reg;</sup></span></div>
</div>
