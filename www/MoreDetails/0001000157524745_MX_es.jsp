...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157524745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rage of the Gladiator es un juego de fantasía donde deberás de luchar por tu vida en la arena. ¡Ponte a prueba y conquista  a todos los oponentes!
Características:
<li> ¡Uno de los juegos más increíbles de WiiWare jamás vistos! Increíbles gráficas en 3D, animaciones, iluminación de sombras y efectos especiales.
<li> Actuación con voz. ¡Cada jefe tiene su propia personalidad y se burlará de ti sin misericordia!
<li> Increíbles movimientos finales. ¡Invoca un feroz meteoro, un salvaje tornado o transfórmate en un coloso 10 veces más grande que tú!
<li> Personaliza tu personaje. ¡Especialízate en una habilidad - Ofensiva, Defensiva o Mágica para ganar nuevos poderes!
<li> Música épica. ¡Disfruta de obras maestras del legendario compositor Sean Beeson!
<li> Excelente para jugar más de una vez. ¡Termina el juego para desbloquear el modo reto, donde los jefes son mucho más fuertes y tienen nuevas habilidades!
<li> Inclusive, soporta el accesorio Wii MotionPlus™!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
