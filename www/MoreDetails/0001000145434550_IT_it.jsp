...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Last Blade 2, rilasciato per la prima volta nel 1999, è il seguito del gioco di combattimento a incontri The Last Blade. Il gioco parte da dove il titolo precedente si era fermato e conduce la storia delle porte dell'inferno al suo apice. Questa volta saranno 16 gli spadaccini che prenderanno parte allo scontro. Scegli tra due differenti tipi di spade (Forza e Velocità). Devia gli attacchi del nemico con "Contrasto", riuscendo persino a deviare attacchi letali come "Super Fendente Segreto" o "Fendente segreto nascosto" con un "Fendente Sublime" che si connette al "Super Fendente Segreto", proprio come nel titolo precedente. Tra le nuove caratteristiche introdotte si annoverano la possibilità di difendersi e di contrastare in aria e il recupero istantaneo. Grazie a tutte queste nuove funzionalità, potrai portare il livello dei tuoi scontri ancora più in alto!<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
