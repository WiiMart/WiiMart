...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D3445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Think you can be the next big music star? Well now you’ve got all the tools right at your fingertips with Mix Superstar. Create, mix and record your own royalty-free musical masterpieces right on your Wii Console. There are over 1,000 Dance, Hip Hop and Techno loops included across multiple instruments like Drum, Bass, Synth, Guitar and even voice tracks. 
<p>
Once you’ve got that next hit created, it’s time to show it off. Mix Superstar allows you to export your music creations, and download them to your computer so you can take them on-the-go. You can also use the WiiConnect24 service to send those hits to your Wii Friends and even collaborate on mixes!
<p>
Also included is full support for both the Logitech USB Microphone and the Wii Speak accessory (sold separately)so you can lay down your own vocals.

Nintendo Wi-Fi Connection Pay & Play service even allows you to enhance your music creation experience with additional loop packs from a variety of genres.

Now go on and make some noise!</div>
  <div id="image02">
