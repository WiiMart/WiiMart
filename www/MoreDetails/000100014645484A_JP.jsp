...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">新宿歌舞伎町に事務所を構える私立探偵「神宮寺三郎」を主人公とした、本格的推理アドベンチャーゲーム。十数タイトルを数える長寿シリーズ“探偵　神宮寺三郎”の４作目です。新宿中央公園で一匹の犬を見かけた神宮寺三郎が思い出したのは、一年前、とある夏の日に起きた二つの事件。神宮寺三郎は消えた絵画の捜索を依頼され、調査をはじめます。一方、助手の「御苑洋子」は歌舞伎町で迷子になっていた少年を保護し、母親を探します。調査が進むにつれ、交わることなどないと思われる二つの事件が、それぞれの傷を浮き彫りにしながら、やがて複雑に絡み合っていきます。リアリティあふれる世界観と、魅力的なキャラクター達、決して色あせることのない本格ハードボイルドの世界観、人間模様が織りなすドラマが本作の魅力です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
