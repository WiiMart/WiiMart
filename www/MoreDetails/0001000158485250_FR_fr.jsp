...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158485250')", "wiiSelectSound()");
...
<br><br>
La légende démarre ici. Plonge dans le monde dynamique de Furry Legends, le jeu de plate-forme le plus poilu qui ait vu le jour !<br>
Lance-toi dans une aventure délirante et relève les défis basés sur des effets dynamiques dans le monde fantastique de Furland en 3D.<br>
Furland, un endroit aussi comique qu’étrange, est peuplé de créatures délirantes : crabes à cinq yeux, vaches toutes rondes, lapins fous, ainsi que les adorables Furballs.<br>
Contrôlez des personnages duveteux dotés de pouvoirs spéciaux tels que la capacité à manipuler le temps, qui permet d'influencer l’environnement où les effets physiques font loi.<br><br>
Pourras-tu sauver Furland et ses adorables Furballs ?<br>
Lance-toi dans l’aventure dès maintenant avec le jeu le plus poilu et poilant du siècle !<br><br>
