...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157564345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The world’s most-played casino card game makes its WiiWare debut with highly detailed characters, true-to-life animations, and advanced artificial intelligence—making V.I.P. Casino: Blackjack the most realistic blackjack game ever made. This game broke the mold of traditional card games and their static 2-D interface by integrating an animated 3-D interface into the table, thus creating a visually impressive look and a play style that feels just right. Use the Wii Remote’s motion controls to hit, stand, and bet. Play to earn achievements like High Roller, Power Player, Card Shark, Elite Gambler, and many more! In multiplayer matches, it’s a competitive battle of wits against the dealer. Up to four players can join in, and whoever gains the largest bankroll in a predetermined number of hands wins!</div>
  <div id="image02">
