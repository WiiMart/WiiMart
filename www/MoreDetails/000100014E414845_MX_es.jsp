...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El malvado Baby Bowser ha hechizado a Yoshi’s Island™ convirtiéndola en un álbum de fotografías. Todavía peor, alguien se ha robado el Super Happy Tree, y esto hizo que la isla se hiciera obscura y triste. ¡Jugadores tendrán que controlar a los seis Yoshis, cada uno de ellos de diferente color, y viajar a través de las seis “páginas” (mundos) de aventuras de plataforma para recuperar el árbol y para que la isla regrese a su normalidad! Presentando modelos enormes de los personajes y colores brillantes y vibrantes, los diferentes ambientes del juego (como el de los bosques, cuevas, montañas y océanos) tomarán vida con una apariencia única de “2 ½-D.” Come frutas, esquiva a los enemigos y los obstáculos, y lanza huevos de los suministros infinitos de Yoshi para ayudar en tu misión de arruinar el plan malévolo del temible Baby Bowser. Si eres los suficientemente bueno, podrás obtener mejores puntuaciones al cuidadosamente elegir al fruta que quieras comer. ¡Y quien sabe, tal vez hasta te topes con los misteriosos Yoshis de color blanco y negro!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Yoshi's Story<sup>TM</sup></span></div>
</div>
