...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">1985年11月15日に発売された、忍者の「じゃじゃ丸くん」を主人公にしたアクションゲームです。妖怪たちを操る悪者「なまず太夫」にさらわれた「さくら姫」を救うため、じゃじゃ丸くんを操作して、手裏剣を武器に妖怪たちを倒していきます。
登場する妖怪たちは、見た目・動きともに個性的で魅力的なキャラクターばかり。どうやって倒すか、いかに高得点を獲得するか、いろいろと考えながら繰り返しあきずに楽しめるゲームです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">忍者じゃじゃ丸くん</span></div>
</div>
