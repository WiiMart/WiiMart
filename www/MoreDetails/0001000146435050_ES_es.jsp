...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Balloon Fight, de NES, fue un éxito de recreativa a principios de los años ochenta. En el juego, encarnas a un héroe aficionado a los globos que tiene que reventar los globos de sus enemigos antes de que ellos revienten los suyos.
<br><br>
Los enemigos que caigan usarán un paracaídas, así que tendrás que golpearlos de nuevo para que caigan al agua o para que sean devorados por un hambriento pez. Pero cuidado: ¡el pez también irá a por ti!
<br><br>
Balloon Fight cuenta con un modo de dos jugadores en el que podrás competir con el otro jugador o colaborar con él. Además, también dispone de un modo de supervivencia de desplazamiento lateral llamado Balloon Trip.
<br><br>Textos de pantalla en inglés.
<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146435050/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146435050/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Balloon Fight<sup>TM</sup></span></div>
</div>
