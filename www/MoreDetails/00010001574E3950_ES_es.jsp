...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574E3950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El ejército ha vuelto para buscar a una nueva generación de reclutas! La serie clásica de estrategia por turnos MILITARY MADNESS, también llamada NECTARIS, irrumpe en WiiWare con un montón de nuevas funciones. Coordina estrategias o búrlate de tus enemigos en los modos multijugador equipo o versus para hasta 4 personas, en línea o no. Personaliza la nueva unidad de Comandante seleccionando entre 20 habilidades únicas mientras lidera tus fuerzas en multijugador. Gánate el respeto aumentando tu rango a medida que avanzas en los marcadores en tu misión para demostrar que eres el mejor general que existe. ¡Es el juego más descabellado de la serie!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E3950/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E3950/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
