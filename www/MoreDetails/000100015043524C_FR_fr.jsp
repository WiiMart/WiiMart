...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rassemblez jusqu'à quatre de vos amis et rivalisez d’adresse lors d’une authentique partie de billard à la maison! Choisissez parmi 6 types de jeu, telles que le JEU DE LA 9, ROTATION ou CAROM (billard français).
Calculez le coup parfait grâce au mode SIMULATION ou sélectionnez le mode ACTION pour comprendre vos points faibles.
<br><br>
Le réalisme et la maniabilité de Break In combleront aussi bien les amateurs que les habitués des salles de billard feutrées!
Apprenez à maîtriser les angles grâce au mode TECHNIQUE pour réaliser d’incroyables "trick shots". Recevez les conseils des plus grands experts pour défier les champions.
Avec Break In, devenez un véritable artiste du tapis vert!
