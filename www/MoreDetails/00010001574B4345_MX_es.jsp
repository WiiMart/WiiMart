...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B4345')", "wiiSelectSound()");
...
<p>
La poderosa aura protectiva que te rodea te será de gran ayuda, absorbiendo todos los disparos del mismo color del aura. Puedes cambiar el color de tu aura protectiva presionando el botón, pero ten cuidado: si el enemigo te dispara con el color equivocado, ¡morirás! ¡Enfréntate a Rika y libera Estaria de su amenaza!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B4345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B4345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
