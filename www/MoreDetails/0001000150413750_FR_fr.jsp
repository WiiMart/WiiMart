...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un classique du genre ! Alien Crush renouvelle le genre du flipper par l'esthétisme de ses graphismes « biomécaniques ». Secouez la table pour retrouver les sensations d’un véritable flipper ! Obtenez les bonus et les extra billes pour augmenter vos points au compteur ! En plus du niveau principal, accédez à de nombreux niveaux bonus excitants comme « Centipède », « Alien », « Œil » ou « Crâne ». Complétez les conditions spécifiques à chaque niveau pour obtenir des bonus incroyables !<br>Frappez les cibles du plateau et enchaînez astucieusement les nombreuses séquences du jeu pour battre le meilleur score!<br><br>Texte écran en anglais.</div>
  <div id="image02">
