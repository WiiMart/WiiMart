...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El reino antiguo y hermoso de la tierra de las maravillas ha sido lanzado en el caos por un feroz dragón que escupe fuego llamado "MEKA dragón." El dragón y sus monstruosos secuaces conquistan el pasivo mundo, en paz, convirtiéndola en la tierra del monstruo. Incapaz de defenderse de la embestida, ¡el pueblo clama por un héroe para salvarlos! Wonder Boy se embarca en un increíble viaje a través de diferentes entornos y mazmorras. ¡Él colecciona armas de gran alcance y hechizos, para librar a la tierra de los malvados monstruos y derrotar al dragón!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145355745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145355745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wonder Boy in Monster Land<sup>TM</sup></span></div>
</div>
