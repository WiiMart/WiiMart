...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158493745')", "wiiSelectSound()");
...
<p>
Liight es un juego de acertijos en donde usas luces de colores y sombras para resolver los acertijos y hacer música. Cada acertijo en Liight es una combinación única de luces de colores y "objetivos" presentados en un tablero especial. Si cubres completamente un objetivo con una luz del mismo color, el objetivo se iluminará y tocará música. Un acertijo se resuelve cuando todos los objetivos estén iluminados y tocando música juntos. ¡Cada acertijo hace una canción diferente cada vez que juegues!
<p>
El modo "Sin parar" en Liight es un juego de acertijo rápido que usa los mismos conceptos básicos que aprendes en el modo "Resolver" en una constante lucha para obtener el máximo record. Liight también tiene el modo "Crear" para que hagas tus propios acertijos de la manera que quieras, y el modo "Compartir", ¡para que los envíes a tus amigos Wii usando WiiConnect24!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158493745/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158493745/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Liight</span></div>
</div>
