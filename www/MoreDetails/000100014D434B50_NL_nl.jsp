...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Phantasy Star IV is het vierde deel in SEGA’s epische Phantasy Star-serie, een van de meest uitgebreide en populaire RPG-series voor de SEGA MEGA DRIVE.
<br><br>
In het jaar 2284 na de oorlog wordt de planeet Motavia opnieuw geteisterd door vreemde wezens. Het is aan de dappere mannen en vrouwen van de Hunters Guild om ze uit te roeien! Jij speelt Chaz Ashley, een onervaren Hunter die zijn training nog maar net heeft voltooid. Chaz wordt bijgestaan door Alys Brangwin, een sluwe veteraan die vanwege haar mooie verschijning (en haar bekwaamheid met haar dubbele zwaarden) een behoorlijke reputatie heeft opgebouwd. Deze twee Hunters gaan er, samen met een gevarieerde groep andere personages, op uit om hun planeet te redden – en uiteindelijk het hele zonnestelsel.
<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434B50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Phantasy Star<sup>TM</sup> IV</span></div>
</div>
