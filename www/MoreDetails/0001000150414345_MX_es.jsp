...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dungeon Explorer es un RPG de acción para múltiples jugadores en el que hasta 5 jugadores pueden jugar a la vez. La historia sucede en calabozos subterráneos y puedes escoger entre 8 tipos de personajes diferentes: Fighter (Guerrero), Thief (Ladrón), Warlock (Hechicero), Witch (Bruja), Bishop (Obispo), Elf (Duende), Bard (Bardo), o Knome (Gnomo). Los tipos de magia, poder de ataque, y los movimiento que puedes usar variarán dependiendo del personaje. Para sobrevivir, debes conocer todo acerca de las debilidades de tus enemigos. También debes conocer los atributos especiales de cada hechizo y usarlos de la forma más eficiente. En partidas en equipo, trabajar juntos es la clave para la victoria.
<p>Al luchar con múltiples jugadores, debes conectar la misma cantidad de Controles Remotos Wii o Controles Nintendo GameCube que el número de jugadores. Para jugar con 5 jugadores, necesitarás al menos 1 Control de Nintendo GameCube.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414345/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414345/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
