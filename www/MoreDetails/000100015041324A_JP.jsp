...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８７年にアーケードゲームで発売された横スクロールタイプのアクションゲーム。地獄に落ちてしまった主人公「たろすけ」が、エンマ大王の裁きを受けるために５つの世界に分かれた地獄へ冒険に旅立ちます。時には頭越えジャンプでかわしたり、数々の困難を乗り越え、行く手をさえぎる妖怪たちを、気合いをためた強力な気合い弾で退治します。ステージの最後ではご先祖さまの「もんもたろー」を呼び出し、待ち構えている門番との戦い、そして最終ステージの「輪廻界」では、どんな行いをしたかによって、５種類のエンディングが用意されている等、遊び応えタップリの内容になっています。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">妖怪道中記<sup>TM</sup></span></div>
</div>
