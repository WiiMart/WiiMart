...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015748554A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ゴーストがたくさん潜む屋敷に忍び込んで、宝さがしをしたり、ゴーストを退治したり、友達や家族みんなで楽しむことができるパーティーゲームです。Wiiリモコンを使って、ゴーストを追い払ったり、魔法を使うこともできます。協力プレイと対戦プレイの両方をお楽しみいただけます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015748554A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015748554A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゴーストマンションパーティ</span></div>
</div>
