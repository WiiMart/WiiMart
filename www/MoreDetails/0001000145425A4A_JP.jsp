...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９５年にリリースされた格闘ゲームで、『餓狼伝説』シリーズの第５弾。前作「餓狼伝説３」のシステムをベースにしつつも、スウェーボタンを独立させたり、コンビネーションアーツを進化させたコンビネーションアタックの導入、リングアウトなどの要素を盛り込んだことで、よりスピーディでテンポのよいプレイが楽しめるようになりました。前作でボスとして登場した秦兄弟、シリーズを通して人気のビリー・カーンやダック・キングなどが新たに使用可能となり、総勢１６名の格闘家が最強の座を目指してしのぎを削ります。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
