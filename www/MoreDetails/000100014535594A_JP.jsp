...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">さまざまなゲーム機で発売されたぷよぷよシリーズの原点ともいえる初代『ぷよぷよ』の元祖アーケード版です。同じ色のぷよぷよを４つつなげて消していくシンプルなルールで、行く手をはばむゆかいなキャラクターたちと対戦していくアクションパズルゲームです。もちろん２人対戦プレイも楽しめます。さらに今回のバーチャルコンソールアーケード版では「ニンテンドーWi-Fiコネクション」に対応。インターネットに接続すれば、おともだちや見知らぬ誰かと、いつでも『ぷよぷよ』対戦することができます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ぷよぷよ<sup>TM</sup></span></div>
</div>
