...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157455450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">PictureBook Games: A Pop-Up Adventure is een uniek bordspel: het speelt zich niet af op een normaal spelbord, maar in een tot leven gewekt pop-upboek, compleet met leuke personages van papier!
<br><br>
In plaats van dobbelstenen gebruik je kaarten die allerlei mogelijke effecten hebben om je over het spelbord te verplaatsen. Je verzamelt tijdens het spelen ook munten die je kunt gebruiken om meer kaarten te kopen. Je kunt deze na het voltooien van een speelveld ook inwisselen voor bonuspunten!
<br><br>
Het spel kan worden gespeeld met maximaal vier spelers, elk in de rol van een leuk personage, zoals de piraat Silver of de ninja Ninzo. Neem het op tegen je vrienden of tegen computergestuurde tegenstanders (of een combinatie daarvan), maar pas op: als je op het magische boek stuit, zetten diens mysterieuze effecten de spelwereld misschien wel op zijn kop!
<br><br>
De wereld van PictureBook Games: A Pop-Up Adventure is plat, maar er is voldoende diepgang!
<br><br>
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">A Pop-Up Adventure</span></div>
  </div>
