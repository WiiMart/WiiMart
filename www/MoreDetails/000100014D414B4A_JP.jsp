...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードでも大ヒットした『忍』シリーズをベースに作られた爽快ニンジャアクションゲーム。手裏剣、忍者刀、そして必殺の忍術を使う忍者「ハヤテ」は、ニューヨークを舞台に頼れるパートナーの忍犬「ヤマト」とともに秘密結社「ユニオンリザード」と戦います。燃えさかるダウンタウンで、街を見渡す橋の上で、そびえ立つ自由の女神の像の前で、暗闇に包まれた洞窟の中で、捕らえられた子供たちを救出しながら敵の本拠地を目指します。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">シャドー･ダンサー<sup>TM</sup></span></div>
</div>
