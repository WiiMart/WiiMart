...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574F5950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bereid je voor op een ongekend spectaculaire tijdreis door de geschiedenis van de videospelletjes!! <br>
Vergezel Bit Boy Kubi op zijn waanzinnige pixel-retro-avontuur en bevecht meutes gemene monsters in: <br>
<br>
- 4-bit ondergrondse kerkers, <br>
- 8-bit grotten, <br>
- 16-bit bastions, <br>
- 32-bit doolhoven, <br>
- 64-bit arena’s en <br>
- 128-bit werelden!! <br>
<br>
Red de vriendjes van Kubi!! <br>
Leef je uit in de ultieme jacht op fruit en topscores!! <br>
Speel in de Coöperatieve modus samen met een vriend(in) voor nóg meer fun!! <br>
<br>
De Wii-afstandsbediening is je joystick, het arcade-avontuur kan beginnen!! 
<br><br>
