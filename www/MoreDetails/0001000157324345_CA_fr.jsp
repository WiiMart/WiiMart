...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157324345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Just like your body, your brain needs to be exercised to stay in shape. Maintaining it has now become easy and so much fun! Boost your brain and relieve stress through various minigames in a personal session to get a detailed evaluation. Challenge your friends' brains in exciting party games to see who is the smartest! Test all your brain's abilities in Visual, Memory, Logic, Math, and Focus minigames. Compare yourself with friends by challenging their brains in three multiplayer modes. Develop your resistance to stressful situations that could happen in real life. Use a customized Mii™ character to set personal sessions. Choose your favorite personal coach. Track your overall performance with detailed statistics and graphs. The special Kid Test and Senior Test modes will gather everyone around the game.</div>
  <div id="image02">
