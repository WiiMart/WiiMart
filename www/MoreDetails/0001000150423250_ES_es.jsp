...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Es la continuación del título de RPG de acción Neutopia, que ya está disponible. La historia comienza con la resurrección del maléfico demonio Dirth.<br><br>
Este juego continúa donde lo dejó el primero, controlarás al hijo del héroe principal. Necesitarás confiar en tu brújula mágica y reunir información para encontrar entradas a los laberintos y derrotar a los jefes.
Atraviesa los campos, que pueden ser traicioneros y encuentra información y objetos. Mueve bloques y destruye muros para descubrir habitaciones secretas.<br><br>
Como en el original, este juego tiene función de guardado, una dificultad muy bien ajustada y una historia con mucho ritmo; es un RPG que cualquiera puede disfrutar.
Disfruta los gráficos y controles mejorados de este fantástico título.
