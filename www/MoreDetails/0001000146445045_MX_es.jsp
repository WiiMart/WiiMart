...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Con el palo en mano e infinita confianza, predices ganarte la copa, ganar el titulo de MVP, aparecer en las portadas de las revistas más importantes de deportes y salir con una linda modelo (no en esa misma orden necesariamente). ¡Pero pronto descubrirás que en esta liga nada se regala, y antes que alcances tu metas primero tendrás que meter el disco en la red y anotar todavía más! Necesitarás la destreza de un jugador hábil y la brutalidad de un despiadado contrincante. ¡Defiende a tu propia cancha de las implacables jugadas poderosas o presiona al portero del otro equipo al enviarle uno de tus propios tiros! ¡No se te olvide defenderte cuando la ira eructe por que en cuando se quiten los guantes los golpes comenzarán! ¡Así que ponte tus patines de acero y prepárate a darte a conocer o a que te pongan en el hielo!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146445045/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146445045/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
