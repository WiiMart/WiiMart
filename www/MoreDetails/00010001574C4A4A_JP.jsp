...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574C4A4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">このゲームは勇者を志す若者が主人公です。レベルアップや様々なイベントを通じて立派な勇者を育てる、勇者育成アドベンチャーゲームで、自分の育成した勇者で武術大会に参加する武術大会モードも搭載しています。<BR><BR>シナリオモードでは、経験値稼ぎ、お金稼ぎ、装備の購入、イベント、パーティー編成などの要素を網羅しつつ、移動や雑魚敵との戦闘といった部分は簡略化し、アドベンチャー形式で進行します。<BR><BR>武術大会モードでは、シナリオモードで育成した勇者で武術大会に参戦することができます。あらかじめ用意された、ルールの決められた様々な大会トーナメントに参加したり、ルールを自分で決めて大会を主催したりすることができ、主催した大会に自分の育成した勇者で参加することも可能です。また、前作「ボクも世界を救いたい」で育成した勇者で武術大会に参加することもでき、前作のセーブデータがあれば、セーブデータコンバート機能により、パスワード入力なしで前作で育成した勇者を登録することができます。<BR><BR>自分好みの勇者を作る過程を堪能しつつ、その勇者がどれほどの勇者なのか、武術大会での腕試しをお楽しみください。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4A4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4A4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ボクも世界を救いたい</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">BATTLE　TOURNAMENT</span></div>
  </div>
