...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157554E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Prepárate para decir "UNO" en tu consola Wii! Ahora tienes el juego de cartas mundialmente famoso, reproducido a la perfección en tu consola Wii, con emocionantes nuevas reglas. Gracias al modo multijugador, jugar a UNO es más fácil y divertido que nunca. ¡Sé el primero en deshacerte de tus cartas!
<br><br>
• El juego número uno para la diversión entre amigos o con la familia, recreado para respetar la identidad del juego clásico y con reglas que son fáciles de entender para todos.<br>
• Te permite personalizar las reglas del juego y descubrir nuevas maneras de jugar a UNO, como "UNO 7-0", "Reto UNO", "Jump-In" y más.
<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554E50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
