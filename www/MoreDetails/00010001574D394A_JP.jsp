...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D394A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ご存知モグラたたきが装いも新たにＷｉｉウェアで登場です。<BR>Ｗｉｉリモコンを画面に向けると現れるハンマーを、モグラ目がけて上から下に振り下ろすだけの簡単操作。小さなお子様から、あまりゲームをやらない大人の方まで、すぐに楽しく遊べます。<BR>ひたすらモグラを叩き連続ボーナスによる高得点をねらう「とことんモグラたたき」、コミカルでトリッキーな動きのモグラ（？）を叩く「モグラアドベンチャー」、最大４人まで対戦できる「みんなでバトル」の３モードをご用意しました。<BR><BR>「とことんモグラたたき」と「モグラアドベンチャー」はＷｉ－Ｆｉランキング対応です。高得点が出たらランキング登録して全国のユーザーと競い合えます。<BR>「みんなでバトル」はみんなで同時に遊べるモグラたたきです。叩いた数で勝負する「数ルール」と、叩いたモグラの色をそろえて対戦相手にダメージを与える「色ルール」が選べます。どちらもハンデの設定もできるので子供からお年寄りまで幅広く対戦を楽しめます。（対戦人数分のＷｉｉリモコンが必要です。）<BR><BR>操作は簡単でも楽しめる要素が一杯のモグラたたき「たたいて！モグポン」を是非体験してみてください。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D394A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D394A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">たたいて！モグポン</span></div>
</div>
