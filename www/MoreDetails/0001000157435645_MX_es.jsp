...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157435645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cave Story te lleva a un mundo en el que una curiosa raza de inocentes criaturas, llamadas Mimiga, viven libres.
<p>
...
La única esperanza para las Mimiga está en ti, un muchacho tranquilo que no puede recordar su propio nombre. ¡Toma el control y aprende los orígenes de este mundo y salva a las Mimiga del villano!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
