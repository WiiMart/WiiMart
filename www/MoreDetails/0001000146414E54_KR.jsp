...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">상하 펀치와 강약 펀치를 상황에 맞게 활용하며 라이벌과 대전을 펼치는 패밀리컴퓨터용 대전 격투 게임입니다. 화면 끝에 있는 맨홀에 상대를 떨어뜨리면 승리합니다. 위에서 떨어지는 화분에 맞으면 기절을 하는 독특한 연출도 게임의 재미를 더해 줍니다. 대전 플레이를 통해 뜨거운 승부를 펼칠 수도 있습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414E54/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414E54/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">도시의 챔피언<sup>TM</sup></span></div>
</div>
