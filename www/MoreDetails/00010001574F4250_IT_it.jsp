...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574F4250')", "wiiSelectSound()");
...
<br><br>
In Art Style: ORBIENT il tuo campo di gioco è l’universo. Inizi il tuo viaggio come una piccola stella e dovrai dominare le forze di gravità e di antigravità per muoverti attraverso il cosmo, assorbire altre stelle per aumentare le tue dimensioni o catturarle nella tua orbita, facendone tuoi satelliti.
<br><br>
Ma fai attenzione: lo spazio nasconde molte insidie. Gli asteroidi e i buchi neri potrebbero far finire il tuo viaggio attraverso l’universo prima del previsto. Con i suoi 50 rilassanti ma avvincenti livelli, ORBIENT offre di certo un’esperienza di gioco dell’altro mondo!
<br><br>
Il testo all’interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
