...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157545050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tetris Party is een verraderlijk simpel, zeer verslavend puzzelspel dat jou en al je vrienden en familie zeker urenlang zal vermaken. Dit WiiWare-spel bevat nooit eerder geziene variaties op Tetris voor één of meerdere spelers. Test je kunnen met tal van nieuwe speltypes zoals "Veldklimmer", "Levelracer" en "Schaduw" of een van de originele Wii Balance Board-modi. En meerdere modi geven de speler de kans om gebruik te maken van de unieke mik-en-schiet-capaciteiten van de Wii-afstandsbediening.<br><br>Voorzien van Nederlandstalige schermteksten.<br>Ondersteunt het Wii Balance Board</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545050/FFFD0019" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545050/FFFD001A" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
