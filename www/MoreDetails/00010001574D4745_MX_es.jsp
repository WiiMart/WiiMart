...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D4745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Mart Racer, corre alrededor del supermercado para encontrar los items de tu lista de compras antes de que tus rivales lo hagan. Usa tu Wii Remote como la barra del carrito para controlarlo mientras corres adentro de diferentes tiendas. Elimina tu competencia tirándoles por la cabeza objetos y robando items de sus carritos. ¡Y ten cuidado con los guardias de seguridad! El primer jugador en completar su lista de compras debe correr hacia las cajas para ganar. Y hasta 4 jugadores pueden jugar en línea via la Conexión Wi-Fi de Nintendo.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D4745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mart Racer</span></div>
</div>
