...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bomberman ‘93, ¡la emocionante y mejorada versión que siguió al Bomberman original!<br>Con 8 rondas en 6 pantallas, el modo de un jugador, Normal Mode, te ofrecerá toda la diversión que necesites con sus 48 pantallas diferentes. Revienta a todos tus enemigos y encuentra la salida antes del tiempo límite para pasar a la siguiente fase. La función  patada  aparece por primera vez en esta versión de Bomberman, ¡y puedes usar tácticas realmente astutas durante tu partida! ¡Usa las trampas y nuevos objetos a tu favor para terminar el juego con un récord perfecto! Hasta 5 jugadores pueden jugar en el Battle Game, ¡y todos los nuevos trucos y mecanismos (como la cinta transportadora) garantizarán una batalla reñida!<br><br>Para luchar con varios jugadores, tienes que conectar tantos mandos de Wii o mandos de Nintendo GameCube como jugadores haya.<br>Para jugar con cinco jugadores, necesitarás al menos un mando de Nintendo GameCube.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
