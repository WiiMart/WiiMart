...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">コミックの世界に迷い込んだ人気マンガ家「スケッチ･ターナー」が、コマからコマへと渡り歩いて恐ろしいミュータントたちと戦う、斬新な世界設定のアクションゲームです。コミックの中に隠された数々の秘密を解き明かし、無事に元の世界へ戻ることが目的。敵キャラクターはミュータントのボス「モータス」の手で描かれて登場し、物語はどのコマへ進むかで変化します。ターナーの武器は基本的に自分自身のみ。自分がデザインしたミュータントたちを豊富な連続コンボでなぎ倒していきます。アメリカンコミックそのままの雰囲気を存分に楽しめる、メガドライブ晩年に発売された傑作ゲームです。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">コミックスゾーン<sup>TM</sup></span></div>
</div>
