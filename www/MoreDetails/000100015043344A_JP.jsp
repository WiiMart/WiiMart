...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">空前のブームとなったシューティングゲームの元祖「スペースインベーダー」のＰＣエンジン移植作。本作ではオリジナル版とアレンジ版のふたつが収録されています。プレイヤーは「砲台」を操作して、降下してくるインベーダーを攻撃し、インベーダーが地上にたどり着く前に全滅させるとクリアとなります。上空に出現する「ＵＦＯ」は高得点のチャンスですので、逃さず撃墜してください。アレンジ版ではインベーダーやステージの種類が増えたほか、ＵＦＯを撃墜すると出現するアイテムで自機がさまざまにパワーアップするなど、オリジナル版にはなかった要素が追加されています。また、アレンジ版では敵の中心に弾を当てた方が高得点になりますので、うまく狙ってハイスコアをめざしてください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スペースインベーダーズ<sup>&reg;</sup>　復活の日</span></div>
</div>
