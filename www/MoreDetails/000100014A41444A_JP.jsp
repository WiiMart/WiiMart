...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ゼルダの伝説シリーズの３作目。光と闇の二つの世界を行き来しながら、ハイラルを我が物にしようと企む司祭アグニムを倒し、捕らえられた娘達を救出して、邪悪の王ガノンからハイラルを救うことが冒険の目的。敵とのバトルや謎解きに、走る、開ける、押す、投げる、といった主人公の多彩なアクションを駆使することが攻略のコツです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゼルダの伝説<sup>&reg;</sup>　神々のトライフォース</span></div>
</div>
