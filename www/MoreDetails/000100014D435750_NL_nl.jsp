...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dit speelhalachtige schietspel neem je plaats in de cockpit van een TRX-5 Quasar. Vlieg over het oppervlak van vijf verschillende planeten en vecht tegen vijanden in gebieden die variëren van een vredige tuin tot omgevingen bestaand uit vuur of ijs. Neem het, laagscherend over elke planeet, op tegen vijandelijke robots, schepen en kanonnen. Vernietig vervolgens het buitenaardse fort op elke planeet door het controlecentrum op te blazen. Als onderdeel van de Galaxy Force is het jouw missie om de buitenaardse invasie af te weren en de vrede in het zonnestelsel te handhaven!
<br><br>
Het spel is voorzien van Engelse schermteksten.
<br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
