...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157335245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Triple Running Sports es el mas avanzado juego recreacional de corredores disponible para WiiWare. Sumergiendo al jugador en el mundo competitivo de corredores.
<p>
La mayoria de  los eventos consiste en actividades que son tradicionalmente derivados de la caza y el combate. A traves del tiempo se ha desarrollado una variedad de deportes competitivos que incluyen 100m, 400m planos, vallas y la carrera de los 1500m.
<p>
Igual que en la vida real en los eventos de carreras tendras total control sobre la velocidad al correr. Debes tomar en cuenta la meta final y la sincronizacion al saltar las vallas por que esto puede influenciar en el triunfo de salto.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157335245/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157335245/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Triple Running Sports</span></div>
</div>
