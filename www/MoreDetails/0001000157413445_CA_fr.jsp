...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157413445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The frantic fun of WarioWare is available for the first time on the WiiWare service! WarioWare: D.I.Y. Showcase is intended as a showcase for all the different WarioWare: D.I.Y. products, including microgames, music, and four-panel comics—all with simple controls using only the Wii Remote controller. Use the Game Blender and its many modes to play microgames featuring Wario, ninjas, animals, and even classic Nintendo franchises. Or check out the Music section to listen to or play a selection of songs using a character from Balloon Fight. In addition to the bevy of preloaded products, you can also play with products made in the Nintendo DS game WarioWare: D.I.Y. or received from friends, and games downloaded from the NinSoft Store. So let your creativity run wild and start setting up D.I.Y. Friends—even Wario would be impressed with the possibilities for new content!</div>
  <div id="image02">
