...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ロックマンX」シリーズの第一弾。<BR>西暦２１ＸＸ年。人間と人間的な思考をもった「レプリロイド」と呼ばれるロボットが共存する世界。<BR>電子頭脳に支障をきたしたロボットは「イレギュラー」と呼ばれ、それらを取り締まるレプリロイドは「イレギュラーハンター」と呼ばれました。<BR>イレギュラーハンターの一員である主人公「エックス」が所属する部隊、第17部隊は、イレギュラーハンター最強といわれ、優れた頭脳を持つ隊長「シグマ」に率いられていました。<BR>ある日、その「シグマ」がレプリロイドたちに命令を下します。<BR>「人間を抹殺しろ！人間は我々の敵だ！」<BR>この命令によって、レプリロイドたちの強烈な反乱が開始されます。<BR>エックスは戦友である「ゼロ」とともにシグマの反乱を収めるため戦いを挑みます。<BR>従来の「ロックマン」シリーズ同様にボスを倒し、特殊武器が入手できるほか、ステージに隠されたパーツを集めることでダッシュなどのアクションが使用可能になるパワーアップシステムを導入し、より多彩なアクションが可能になった作品です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A45424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A45424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン<sup>&reg;</sup>X</span></div>
</div>
