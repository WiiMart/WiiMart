...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">敵を倒すか回避しつつ、画面内に配置されたすべてのカギの取得をめざすアクションゲームです。さらわれたガールフレンドの「ルミナ」を追いかけ、主人公「チャップ」が辿り着いたのは、悪魔の支配する迷宮でした。プレイヤーはチャップを操作し、ＲＯＵＮＤ内にあるすべてのカギを集めるとＲＯＵＮＤクリアです。チャップの邪魔をしてくる敵は、倒すことができる壁（石版）を倒してやっつけることができます。敵や敵の攻撃に当たるとミスになり、残り数が０の時にミスになるとゲームオーバーです。制限時間を過ぎると「使い魔」が出現し、チャップをしつこく襲ってきますので、なるべく制限時間内にＲＯＵＮＤクリアをめざしてください。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロンパーズ<sup>&reg;</sup></span></div>
</div>
