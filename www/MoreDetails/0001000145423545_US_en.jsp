...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Last Blade is a fighting game originally released in 1997, set in the "Bakumatsu" period of Japanese history, where ten-plus swordsmen are fighting for different purposes. Similar to its predecessors from the "Samurai Showdown" series, released by the same company, The Last Blade differs in that when selecting a character you are able to choose between two sword types; the damage-focused "Power", or "Speed" which promotes speedy play. In addition, "Repel" which allows players are able to deflect the enemy's attacks, and "Sublime Slash" which cancels "Super Slice" and can be combined with "Super Secret Slice", are just some of the elements that add to the multitude of maneuvers that this game offers. Be sure to not miss out on the power-moves like "Super Secret Slice" and "Hidden Secret Slice"!</div>
  <div id="image02">
