...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Driift Mania es la experiencia definitiva en juegos de carreras multijugador. Desafía a tus amigos en emocionantes carreras y alocados modos de juego. Adapta tu conducción a los diferentes entornos para ganar.
<p>
CARACTERÍSTICAS<br>
Frenético juego de carreras con vista superior para entre 1 y 8 jugadores.<br>
Elige entre 32 vehículos de 4 categorías (pequeña, media, pesada, especial).<br>
12 pistas y 3 circuitos que se basan en 4 ambientes (ciudad, colina, nieve, oasis).<br>
7 modos, incluyendo los modos tradicionales para un jugador, de carrera en equipo y de campeonato multijugador, y otros modos absurdos como VIP, Meteorito, Patata fría y Contaminación.<br>
El juego admite cualquier combinación de Wii Remotes, Nunchuks y Classic Controllers.<br>
Divertidos gráficos de dibujos animados.<br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444F45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444F45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">DRiiFT Mania</span></div>
</div>
