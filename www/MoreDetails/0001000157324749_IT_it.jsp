...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157324749')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Phoenix Wright è tornato! <br><br>

L’atmosfera in tribunale si fa tesa con l'implacabile procuratore distrettuale Franzisca von Karma. Nuovi personaggi a tutto tondo e storie avvincenti per un gameplay ancora più appassionante: la difesa non si riposa mai! <br><br>

- Quattro nuovi sconvolgenti casi! <br>
- Nuova caratteristica "lucchetto psichico": scopri i segreti più nascosti dei testimoni grazie agli interrogatori! <br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324749/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324749/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
