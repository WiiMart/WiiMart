...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Revisit this puzzle action game released by Data East in 1996! The rules are simple: control the clown and pull in and throw back the balloons that appear on-screen. Line up three or more balloons of the same colour in a vertical row and watch them burst! Some balloons feature unique characteristics. Special balloons, which come in all four colours, pop every balloon of the same colour. Arrow balloons burst everything in the direction their arrow is facing. Rainbow balloons have the same effect as special balloons, but can be thrown against a balloon of any colour. And then there are bubble balloons, which simply just get in your way. Together, these provide you with great chains and combos that make a puzzle game so much fun.<br><br> Choose between VS CPU Mode, full of battles with a host of comical characters, and Puzzle Mode, where you’ll enjoy a one-player challenge. Both modes support player-versus-player action, meaning you can have a great time together with friends.</div>
  <div id="image02">
