...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">MAGICAL DROP III est un jeu de réflexion édité par Data East en 1997.
<br><br>
Contrôlez un clown et formez des colonnes de 3 bulles de même couleur afin de les faire disparaître. Comme les bulles descendent au fur et à mesure de la partie, le clown risque de se faire écraser si vous ne l'aidez pas ! Le but est donc d'agir vite et bien pour faire disparaître les bulles, tout en essayant de déclencher un maximum de réactions en chaîne.
<br><br>
Bien que les règles du jeu restent les mêmes que dans le volet précédent, le nombre de personnages jouables s’élève maintenant à 16, et un nouveau mode de jeu "Magical Journey" a été ajouté. Découvrez un nouvel épisode plus riche en couleurs que jamais !
<br><br>
