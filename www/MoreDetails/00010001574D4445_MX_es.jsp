...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D4445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">No hay mucho tiempo... El mundo tiembla porque las fuerzas de la naturaleza se inquietan. ¿Puedes cambiar todo esto? En este juego dinámico de rompecabezas, tienes que abrir camino para que tus MadStones elementales vayan al fondo de la pantalla. Los bloques se pueden romper al golpearlos directamente o por la fuerza de los objetos que colapsan. El principiante intenta romper frenéticamente bastantes bloques mientras que el maestro crea cascadas de caídas que se desplomen con pocos golpes. ¡Dos lados luchan por la dominación! ¡Grandes fuerzas se robustecen- solo para ser despedidas en una confrontación final que agita el mundo! Experimente el místico viaje para un jugador o rete a un amigo en el modo competitivo de dos jugadores.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D4445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MadStone</span></div>
</div>
