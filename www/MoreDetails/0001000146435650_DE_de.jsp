...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Im NES-Klassiker Wrecking Crew tauscht Mario sein Klempnerwerkzeug gegen einen Vorschlaghammer ein und übernimmt Abrissarbeiten!
<br><br>
Dein Ziel ist es, alle zerstörbaren Objekte in Leveln voller Gegner abzureißen und dabei eine möglichst effektive Route durch die jeweiligen Gerüst- und Leitersysteme zu finden.
<br><br>
Wrecking Crew gehörte zu den „programmierbaren“ Spielen des NES und enthält dementsprechend einen Modus zum Erstellen eigener Level. Und bei Virtual Console hast du sogar die Möglichkeit, von dir erstellte Level zu speichern, was in der Originalversion nicht möglich war.
