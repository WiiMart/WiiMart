...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is the shooter to end all shooters!
<p>
The year is 20XX. An armada of the alien Azyma Empire has descended upon Earth to destroy it. Earth's only hope lies in its newest combat spaceship, "XA-1", with its revolutionary ability to learn and develop itself through combat, without requiring any special items. The ship is outfitted with a wide range of devastating weapons, along with two detachable satellites to protect and support you. Take the ship out and destroy the Azyma invaders!</div>
  <div id="image02">
