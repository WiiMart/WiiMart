...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This channel cannot be downloaded.<br><br>If you want to update your save data for The Legend of Zelda: Skyward Sword, please download and use the Legend of Zelda: Skyward Sword Save Data Update Channel.</div>
  <div id="image02">
    <img src="/oss/ccs/00010000534F5545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
