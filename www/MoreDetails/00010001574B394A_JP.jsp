...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B394A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">かわいい仔犬たちのアクションが楽しい爽快アクションパズルゲーム。<BR>上から落ちてくるカラフルな仔犬のピースを、同じ色の犬小屋に入れて得点をゲットします。同じ色の仔犬を大量につなげて一気に消す一気消しや大量連鎖で気分爽快！同じ犬小屋をつなげで得点がアップする「小屋アップ」や、ピンチのときの必殺技「くるりんスマッシュ」で一発逆転を狙うことができます。ゲーム中には5つのコースを勝ち抜く「ひとりでくるりん」や最大4人までの対戦が楽しい「対戦くるりん」など、多彩なモードで楽しめます。1日1回くるりんの成長がグラフで分かる「まいにちくるりん」モードでは、ハイスコアをWi-Fiランキングに登録して全国のプレイヤーとスコアを競うことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B394A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B394A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">みんなであそぼう！仔犬でくるりん</span></div>
</div>
