...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cratermaze es un juego de acción cómica situado en un mundo paralelo.<br> Durante un viaje en el tiempo, tú y tus amigos os encontráis con Kublai, un esbirro del malvado 
Zenzombie, el cual captura a tus amigos en un punto separado en el continuo espacio-tiempo.
Ábrete paso a través de 60 fases para salvarlos.
Dinosaurios, ninjas, robots y otros enemigos moran en los laberintos que van desde los tiempos primitivos hasta el futuro.
Escapa de ellos cavando agujeros para que caigan en ellos. ¡Entiérralos para eliminarlos!
Recoge todos los cofres del tesoro dentro del tiempo límite para conseguir la llave y salir hacia la siguiente fase.<br>
Con objetos como palas y plataformas elevadoras, ¡Cratermaze lleva la jugabilidad a niveles increíbles! ¡Prepárate para una experiencia de juego inolvidable! 
