...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157444D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo classico si appresta a conquistare il mondo Wii offrendo la possibilità di giocare online e una nuova modalità Sterminavirus! Distruggi tutti i virus contenuti nel flacone disponendo le capsule che cadono in modo tale da formare una fila dello stesso colore. Più virus elimini, più le capsule cadono in fretta.
<br><br>
In Dr. Mario, affronta il computer nella modalità per un giocatore o sfida un amico in quella per due giocatori.
<br><br>
In Sterminavirus (basato sull'esercizio contenuto in More Brain Training del Dr. Kawashima), fino a quattro giocatori possono afferrare, far ruotare e posizionare le capsule usando il loro telecomando Wii, mentre i loro Mii li incitano. Chi avrebbe mai detto che la lotta contro i germi sarebbe stata così entusiasmante?
<br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444D50/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444D50/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dr. Mario<sup>TM</sup> &amp; Sterminavirus</span></div>
</div>
