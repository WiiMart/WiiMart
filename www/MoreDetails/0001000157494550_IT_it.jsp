...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157494550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In questo terzo capitolo, Guybrush va a fondo, all'interno di un gigantesco lamantino! Mentre è alla ricerca dell'anti-vudù La Esponja Grande, Guybrush incontra un'insolita banda di naufraghi, tra cui l'esploratore disperso De Cava e un familiare teschio demoniaco.<br><br> Questo avvincente episodio risponderà ad alcuni urgenti quesiti e ne proporrà altri ancora. Intanto, quest'avventura in 5 parti si affaccia al suo epico climax!<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
