...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157534D45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Olvídate de dietas y obsesiones por la salud! ¡Llega un juego rebosante de comida, gordura y lucha! Coloca el mando de Wii en posición horizontal, e inclínalo hacia la izquierda, hacia la derecha, hacia delante o hacia atrás para realizar toda clase de levantamientos y lanzamientos como en el sumo real. También hay movimientos ocultos como suplex o scrapbusters introducidos para mayor diversión. ¡Utiliza todos los movimientos que aprendas en los torneos alrededor del mundo para llegar a la cima del sumo y convertirte en yokozuna! En modo un jugador, come mientras juegas o entrénate con minijuegos para fortalecer a tu luchador y cambiar su apariencia. ¡También puedes usar tus propios personajes Mii en tus luchadores! En modo dos jugadores, lucha con otro usando los luchadores por defecto o los jugadores que has creado. ¡Engulle! ¡Engorda! ¡Lucha para convertirte en el luchador de sumo más fuerte en Eat! Fat! FIGHT!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534D45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534D45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
