...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Vuoi sapere come ci si sente su un vero ring? Prova Super Punch-Out!! È il seguito per Super Nintendo della storica simulazione di pugilato.
<br><br>
Scala la classifica WVBA (World Video Boxing Association) affrontando i personaggi che hanno reso celebre la versione arcade e quella per NES, ai quali si aggiungono tanti avversari nuovi di zecca! 
<br><br>
Per vincere il campionato dovrai batterti contro 16 pugili, ciascuno con la propria tecnica e con punti deboli specifici che dovrai sfruttare appieno se non vuoi finire al tappeto! È anche possibile allenarsi contro un singolo pugile, grazie alla modalità Time Attack.
<br><br>
Gli effetti sonori d'atmosfera e la coloratissima grafica completano il quadro: è in arrivo il match del secolo... e il protagonista sei tu! 
...
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Punch-Out!!<sup>TM</sup></span></div>
</div>
