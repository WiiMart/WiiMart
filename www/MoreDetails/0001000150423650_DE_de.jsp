...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cratermaze ist ein lustiges Action-Spiel in einer Parallelwelt.<br> Auf einer Zeitreise werden du und deine Freunde mit “Kublai“, einem Anhänger des bösen “Zenzombie“, konfrontiert. Er fängt deine Freunde in einem Raum-Zeit-Kontinuum.
Kämpfe dir den Weg frei durch 60 Labyrinth-Runden und rette deine Freunde. Dinosaurier, Ninjas, Roboter und andere Gegner bedrohen dich in den Irrgärten, die von der Urzeit bis zur Zukunft reichen. Lass Gegner in Löcher fallen, um zu entkommen und begrabe sie, um sie endgültig auszuschalten. Sammle innerhalb des Zeitlimits alle Truhen und erhalte dadurch die benötigten Schlüssel, um zur nächsten Runde zu gelangen.<br>
Spezielle Objekte wie Schaufeln und Sprung-Plattformen machen Cratermaze zu einem unvergesslichen Spielerlebnis! 
