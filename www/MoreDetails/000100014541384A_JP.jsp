...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機と連動するロボット兵器「超鉄ブリキンガー」を駆使し、軍事国家の兵器群を相手に戦う横スクロール型シューティングゲーム。黒海沿岸の平和な独立小国「チョップ王国」に、世界征服を狙う隣国「鉄仮面共和国」が突如として攻めてきます。戦う術を持たず、破壊と略奪がもたらされたチョップ王国に、爆炎とともに「鉄生ル者（くろがねなるもの）」超鉄ブリキンガーが降り立ちます。敵機を撃墜して獲得する武器やＰｏｗでブリキンガーを強化し、合体と分離を使い分けながら、数々の大型兵器を突破してチョップ王国の平和を取り戻してください。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">超鉄ブリキンガー</span></div>
</div>
