...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001584A4945')", "wiiSelectSound()");
...
<p>
Cuatro gnomos valerosos se embarcan en un viaje tan épico que ni siquiera saben a dónde van. Únete a Bumb, Berzerk, Speedster y Uncle Time y corre, vuela, rebota, planea y ábrete paso a mamporros con ellos por el reino mágico de Gnomia hasta llegar a su misterioso destino. Puedes ayudarlos a salvar el reino, encontrar una princesa y coleccionar cientos de preciados calcetines perdidos.
<p>
¡Corre más rápido que un conejo asustado! ¡Salta agujeros grandes de una gran zancada! ¡Sé más poderoso que un elefante furibundo!
<p>
Características del juego:<br>
*Saltos, destrozos, planeos, vuelos, caídas y velocidad<br>
*Juego sencillo e intuitivo<br>
*Dificultad desafiante de tipo "ensayo y muerte"<br>
*80 niveles en el reino mágico de Gnomia
<p>
Y también:<br>
*Pantalones para planear<br>
*Cascos con cuernos<br>
*Distorsión temporal<br>
*Excedente de calcetines
<p>
Un viaje demasiado épico para que los Gnomz crean en él. Una carrera demasiado rápida para cualquiera. Un juego demasiado divertido para que te lo pierdas.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001584A4945/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001584A4945/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">2 Fast 4 Gnomz</span></div>
</div>
