...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157524E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">●BIT.TRIPシリーズ第４弾！<BR>今度はリズム＋横スクロールアクション！いろんなアクションを使ってリズム星人を操作してゴールにたどり着くのが目的のゲームです。<BR>ルート上に配置されている「モードアップ」アイテムをゲットすると、画面やＢＧＭが豪華になっていく、オシャレ系のリズムアクションゲームです。<BR><BR>●簡単操作で誰でもできる！<BR>ゲーム開始後にずっと右に向かって走っていくリズム星人に「ジャンプ」や「スライディング」などの指示を与えて、障害物をしのいでいきます。<BR>すべてのアクションがいずれかのボタンを一回押すだけで実行可能、組み合わせて使用するなどのことはないので、誰でも簡単にプレイすることができます。<BR><BR>●遠く険しいゴールへの道のり<BR>ゴールに向かうルート上で、障害物に引っかかってしまうと、強制的にスタート地点へ戻されてしまいます。いわゆる「やりなおし」です。一人前のリズム星人になるには、遠く険しい道のりを「一発クリア」しなければいけません。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524E4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524E4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">～リズム星人の激走～</span></div>
  </div>
