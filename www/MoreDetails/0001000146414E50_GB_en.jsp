...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Urban Champion™ is an addictive fighting game in which two tough guys trade fists until one of them falls in a manhole. It is possible to compete against another friend, and the game requires a bit of strategy to avoid getting knocked down too fast. If you want to succeed, one important aspect to take into account is your stamina, which decreases every time you try to hit your enemy - even if you miss! Therefore the game is more technical than it looks at first. Urban Champion™ is also well appreciated for its several humorous details and animations.</div>
  <div id="image02">
