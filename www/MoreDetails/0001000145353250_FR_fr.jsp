...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ce classique du jeu de tir à défilement vertical est peut-être l'un des meilleurs opus de Capcom avant l'ère Street Fighter. Avec ses milliers d'imitations et ses apparitions sur toutes les plateformes jamais créées, on ne présente plus les biplans de la Seconde guerre mondiale ayant fait le succès de 1942. Et aujourd'hui, pour la première fois sur Wii, découvrez le jeu dans sa version originale et inégalée !
