...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Moto Roader es un juego de carreras futuristas que permite que hasta 5 jugadores compitan entre sí!  ¡Usa el dinero que obtengas al ganar una carrera para poder mejorar tu máquina! ¡No solo puedes cambiar las “LLANTAS” y el “CHASIS” de tu vehículo, también puedes añadir partes “ESPECIALES”! ¡Saltar por encima de grandes obstáculos con una “HOPPER” (TOLVA) y apartar a tus rivales con la onda expansiva de la increíble velocidad “NITRO”!  ¿Qué juego para varios jugadores estaría completo sin elementos de ataque?  ¡Usa “GRANADAS”, que puedes lanzar hacia adelante, y “BOMBARDEROS”, que puedes tirar hacia atrás, para derribar y volar por los aires a tus rivales!  ¡Maniobra mejor que tus rivales en las 8 PISTAS y conviértete en campeón!<p>
Al luchar con múltiples jugadores, debes conectar la misma cantidad de Controles Remotos Wii o Controles Nintendo GameCube que el número de jugadores. Para jugar con 5 jugadores, necesitarás al menos 1 Control de Nintendo GameCube.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Moto Roader<sup>TM</sup></span></div>
</div>
