...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015741324A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「みんなでパズループ」は、同じ色のジュエルストーンを３つ以上そろえて消していく、シンプルなアクションパズルです。操作はＷｉｉリモコンをひねってＡボタンで発射するだけの簡単操作。迫りくるジュエルストーンを次々と消していきましょう。<BR><BR>●モードは全部で５種類。<BR><BR>表示が大きくて見やすい「ひとりでかんたん」「ふたりでかんたん」は、はじめてパズループをプレイする方にオススメです。<BR><BR>「ひとりでとことん」はレベル１００を目指して、ひたすらジュエルストーンを消していきます。「ひとりでお題」は、全６４ステージ以上あるさまざまなお題をクリアしていきます。どちらも一人でコツコツとパズループを極めたい人向けのモードです。<BR><BR>「みんなで遊ぶ」は、４人までプレイできます。一緒に協力しながら、わいわいとステージクリアしていく「きょうりょく」は、声を掛け合うチームワークがポイントです。チームに分かれて競いあう「たいせん」には、３種類の対戦ルールがあり、アイテムの使い方が勝負の分かれ目となります。「みんなで遊ぶ」は、一人でもコンピュータを相手にプレイすることが可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015741324A/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015741324A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">みんなでパズループ<sup>TM</sup></span></div>
</div>
