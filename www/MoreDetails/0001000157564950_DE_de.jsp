...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157564950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Violin Paradise ist ein Spiel für alle die Musik lieben und schon immer davon geträumt haben ein Geiger zu werden!
Das Spiel ist für die ganze Familie und kann von vier Mitspielern besetzt als  Dirigent, Geiger, Bratscher und Cellist gleichzeitig gespielt werden um zusammen lebhafte oder ruhige klassische Musik zu spielen.<br><br>
Das Spiel beinhaltet ein Mikro-Orchester, was dem Spieler das Gefühl einer echten Vorstellung verleiht.<br><br>
Egal ob solo oder als Quartett, du kannst jedesmal einen total neuen Auftritt genießen.<br>
Außerdem gibt es reichlich fantastische visuelle Effekte, die sich mit deiner Entwicklung steigern.<br>
Die Steuerung ist simpel aber augeklügelt. Du wirst von Anfang an Spaß und nie genug davon haben.<br>
Du kannst aus mehr als 50 verschiedenen Stücken wählen.<br>
Nun starte das Spiel! Und viel Spaß dabei, wenn du einzigartige, klassische Musik mit funky Beats spielst!
