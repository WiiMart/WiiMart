...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157345450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Estás a punto de probar la experiencia más adictiva de los últimos tiempos. Ábrete camino por quince endiablados niveles en los que tendrás que reconstruir figuras imposibles ayudado por bolas de energía espaciales. Juega contra el tiempo y los obstáculos para activar las casillas correctas. Spaceball: Revolution pondrá a prueba tu habilidad y tu concentración hasta límites extremos. Spaceball: Revolution te ofrece la posibilidad de comparar tu puntuación con los mejores jugadores del mundo en los diferentes modos de dificultad: Fácil, Normal, Difícil y Maestro.
<br>
 Spaceball: Revolution te reta. ¿Estás preparado?<br><br>Textos de pantalla en español.</div>
  <div id="image02">
