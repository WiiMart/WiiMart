...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157575250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The famed Excitebike series makes another leap forward in this WiiWare-exclusive racer that brings you the gameplay you’ll love from the NES classic, plus Wii motion controls, 3D graphics and all-new online features.
<br><br>
Compete in races around the world, making daredevil jumps and smooth landings by tilting your Wii Remote to gain essential speed boosts. Watch out for obstacles like hills that grow before you in an instant, and pull wheelies over opponents’ heads to beat them to the finish line.
<br><br>
In World Tour mode, compete for cups across four international cities, each with four unique tracks.
<br><br>
And if you feel like becoming a track designer yourself, try the easy-to-use Track Editor to make your own dream course. You can even share your courses online with friends!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157575250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157575250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
