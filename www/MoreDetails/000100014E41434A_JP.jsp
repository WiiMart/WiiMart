...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ＮＩＮＴＥＮＤＯ６４で初めて発売された「ゼルダシリーズ」の５作目。３Ｄならではの操作感と多彩なアクション、奥深い謎解きや時間に合わせて変わるハイラルの風景がプレイヤーを魅了するアクションアドベンチャーゲームです。主人公のリンクは、敵の弱点や攻略のヒントを教えてくれる相棒ナビィとともに、魔王ガノンドロフによって荒らされたハイラル王国の平和を取り戻すために冒険に旅立ちます。時の神殿の台座にマスターソードを抜き差しすることで子供と大人の世界を行き来することができ、子供の世界では使えなかったアイテムを大人の世界で使うなど、アイテムの使い分けが謎解き攻略のカギとなります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゼルダの伝説<sup>&reg;</sup>　時のオカリナ</span></div>
</div>
