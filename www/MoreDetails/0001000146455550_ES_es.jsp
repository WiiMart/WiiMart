...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La acción fluye a raudales en Donkey Kong 3, un clásico en el que controlarás a Stanley, cuyo invernadero ha sufrido la invasión del peligroso simio y de una plaga de insectos rabiosos.
<br><br>
Armado con un bote de spray, tu misión consiste en repeler a Donkey Kong, que desciende peligrosamente hacia el invernadero, mientras evitas que los insectos te roben las flores.
<br><br>
Esquiva los cocos que DK te lance y trata de hacerte con el bote de súper spray, que incrementará la potencia de tus ataques y tus posibilidades de conseguir un nuevo récord de puntos.
<br><br>
