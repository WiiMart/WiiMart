...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ninja JaJaMaru-kun, que significa 'pequeño ninja determinado', salió a la venta en Japón en 1985 para Famicom (NES). El protagonista de este juego de acción, el ninja JaJaMaru, utiliza shuriken (estrellas ninja) para derrotar a sus enemigos y rescatar a la princesa Sakura, secuestrada por el malvado Lord Namazu.
<br><br>
Utiliza los objetos especiales (¡incluso puedes cabalgar una rana!) para completar tu aventura y enfréntate a diversos fantasmas y monstruos japoneses en este juego de acción clásico que sale por primera vez de Japón y está disponible en la consola virtual.
<br><br>
Textos de pantalla en inglés, con algunos caracteres en japonés.
