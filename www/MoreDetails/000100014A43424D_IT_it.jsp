...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Arriva finalmente in Europa questo leggendario GdR! Ideato dai maestri dei giochi di ruolo di Square (ora Square Enix), Super Mario RPG è un gioco complesso ma di grande giocabilità.
<br><br>
Aiuta Mario e i suoi amici (c'è anche Bowser!) in questa fantastica avventura e sconfiggi Smithy, il nuovo nemico che minaccia il Regno dei Funghi.
<br><br>
Affronta i nemici, lancia incantesimi e utilizza gli strumenti a tua disposizione per proseguire nel gioco. E fai attenzione: incontrerai molti altri personaggi del mondo Nintendo prima di arrivare a un’elettrizzante conclusione!<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
