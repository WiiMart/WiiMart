...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gioco di combattimento a incontri rilasciato da ADK nel 1993 in cui sono presenti 14 personaggi selezionabili come Hanzou, Janne o Capitan Kidd che richiamano i grandi eroi della storia mondiale. Una delle semplici ma strategicamente sostanziali peculiarità di questo titolo è la possibilità di riflettere all'avversario sia le mosse a distanza sia i lanci. Un'altra rara caratteristica inclusa in questo gioco di combattimento a incontri è la presenza di due modalità di gioco, ognuna caratterizzata da differenti tipi di regole. La modalità normale, dove la vittoria sull’avversario è calcolata al meglio dei tre incontri, e la modalità  Deathmatch, ancora più estrema rispetto al titolo originale, con un sistema di gioco che prevede 10 round per partita ad eliminazione diretta. Due modalità di gioco che ti permetteranno di vivere battaglie emozionanti e coinvolgenti come non mai!<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">WORLD HEROES 2</span></div>
</div>
