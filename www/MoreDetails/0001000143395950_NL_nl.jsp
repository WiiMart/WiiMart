...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">INTERNATIONAL KARATE is een simulatie van een karatetoernooi, waarin twee mensen het tegen elkaar op kunnen nemen of één persoon tegen de computer kan vechten.
<br><br>
Gedurende het spel zul je de wereld overvliegen naar verschillende locaties.
<br><br>
Gedurende het hele spel wordt toezicht op je gehouden door de wijze oude scheidsrechter die je zal belonen afhankelijk van hoe succesvol een aanval was, hetzij met een half punt, hetzij met een heel punt.
<br><br>
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143395950/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143395950/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
