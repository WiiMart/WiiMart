...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９１年にリリースされたアクションゲーム。ＣＩＡ特殊部署の少佐ロイ・ハートとなって、ビルを占拠した史上最悪のテロ集団ゾルゲ・キングと戦い、８人の幹部を暗殺するのが目的です。ロイ・ハートは、パンチ、キック、銃などを駆使してテロリストと戦い、捕らわれている人々を助けることで体力や弾薬の補充、武器マシンガンを獲得できます。監視カメラを避けて移動すれば敵の数が減るなど、スパイゲームならではの要素が緊張感を演出します。敵を倒すことで経験値が溜まり、一定の値になるとロイ・ハートがレベルアップするというＲＰＧ的な要素もあります。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ・スーパースパイ</span></div>
</div>
