...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">怪物に連れ去られてしまった恋人「ジェニファー」を救うため、主人公「リック」が「ヘルマスク」の力を借りて、次々と襲いかかる怪物と戦う横スクロール型アクションゲームです。<BR>「ナタ」や「ショットガン」といったさまざまな武器を駆使し、ステージの最後に待ち構えるボスを倒していきます。<BR>不気味なキャラクターや、恐怖感を盛り上げるＢＧＭといったホラー映画を思わせる演出が、あらゆる場面でプレイヤーの緊張感を高めます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スプラッターハウス<sup>&reg;</sup></span></div>
</div>
