...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484645')", "wiiSelectSound()");
...
<p>
World of Goo es un juego que combina elementos de construcción con rompecabezas y está hecho enteramente por dos personas, utilizando un reconocido motor de física. Manipula objetos vivos de goma que hablan y se contraen para construir estructuras, puentes, balas de cañón, zeppelines y lenguas gigantes. A las millones de bolas de Goo que viven en el hermoso mundo de Goo les encanta explorar y son muy curiosas, pero ignoran que se encuentran en un juego y que son extremadamente deliciosas.
<p>
La Corporación World of Goo está obligada bajo contrato a declarar que todos son ganadores y celebra de manera entusiasta las oportunidades que todos tienen para construir Goo de una manera equitativa. 
<p>
...
Después de jugar, irás al Canal Tienda Wii. Esto puede tardar unos minutos.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484645/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484645/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">World of Goo<sup>TM</sup></span></div>
</div>
