...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">わんぱく少年「ボーイ」が、ガールフレンドの「ティナ」をさらった「キング」を追って冒険の旅に出るアクションゲームです。タマゴを割って手に入れたオノを武器に、敵や障害物をかわし、バイタリティに気をつけてフルーツをゲットしながら、草原や海、洞窟などさまざまなエリアを駆け抜けます。４面ごとに待ち受けるボスを倒しながら、全１０エリア・４０面をクリアしてください。アーケードでヒットした「ワンダーボーイ」からステージ数などをパワーアップしたセガ・マークⅢ版で、「モンスターワールド」ほかシリーズ化もされた人気シリーズ第１作です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C41434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C41434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーワンダーボーイ<sup>TM</sup></span></div>
</div>
