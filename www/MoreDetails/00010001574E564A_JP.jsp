...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574E564A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">長方形を７つに分割したピースを動かして、シルエットの形と一致するようにはめこむ・・・基本のルールはたったこれだけ。ピースを組み合わせてシルエットの形を見つける過程の中で、柔軟な思考力と図形を見る目が試されます。シンプルながらも、挑戦するとつい誰もが夢中になってしまう魅力があります。シンプルなパズルモードの他にも対戦モードや次々出題されるパズルを素早く解いていくスピードモード、シルエット名を当てるクイズモードなどボリュームも盛りだくさん。全てのモードで最大4人まで同時にプレイすることができます。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E564A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E564A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ハメコミ　LUCKY PUZZLE Wii</span></div>
</div>
