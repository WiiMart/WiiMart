...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">자신의 전투기(파이터)를 조종하여 차례로 나타나는 적 전투기(갤러그)를 빔으로 격추하는 게임으로, 화면상의 적을 모두 없앤 후 다음 스테이지에 도전하는 스테이지형 SF 슈팅 게임입니다. 갤러그의 포로가 된 파이터를 구하면 2개의 전투기가 합체한 듀얼 파이터로 변신합니다. 이 듀얼 파이터는 당시의 슈팅 게임에서는 처음으로 등장했던 획기적인 파워 업 시스템이기도 합니다. 일정 스테이지마다 보너스 스테이지가 등장하며 끊임없는 재미를 줍니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146425254/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146425254/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">갤러그<sup>&reg;</sup></span></div>
</div>
