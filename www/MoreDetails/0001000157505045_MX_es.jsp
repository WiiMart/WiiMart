...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157505045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Es hora de una diversión para toda la familia... y ¡¿qué es más divertido que jugar tenis de mesa?! Al igual que con una familia real, puedes elegir tu personaje de un elenco de cuatro, entre los que se encuentran los siguientes: Papi, Mami, Sarah o Billy. El juego incluye cuatro etapas fantásticas de tenis de mesa donde no importa si eres jugador de tenis de mesa bajo techo o al aire libre. Elige lugares como un gimnasio, un parque boscoso, una playa o hasta un parque de diversión. Elige juegos individuales, de competencia o un "minijuego". Y si los modos individuales y de competencia no son suficientes, puedes elegir entre tres "minijuegos" entre los que se encuentran los siguientes: "Target TT", "Thrilling TT" y "Matching TT". ¡Los atractivos gráficos animados y la encantadora música, además de la superdivertida acción, te mantendrán a ti y a tu familia jugando desde el amanecer hasta el atardecer! ¡Preparen sus raquetas!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505045/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505045/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Family Table Tennis</span></div>
</div>
