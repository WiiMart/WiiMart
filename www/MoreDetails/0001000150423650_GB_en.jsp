...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cratermaze is a comical action game set in a parallel world.<br> While on a trip through time, you and your friends are confronted by Kublai, henchman of the evil Zenzombie. He traps your friends at a separate point in the space-time continuum.
Fight your way through 60 Rounds of mazes to save your friends.
Dinosaurs, ninjas, robots and other enemies lurk within the mazes, spanning from primitive times to the future.
Escape them by digging holes to drop them into. Fill in the holes to finish them off!
Collect all the chests within the time limit to get the key and exit to the next Round.<br>
With special items such as Shovels and Spring Platforms, Cratermaze takes its gameplay to new heights, making for an unforgettable gaming experience!</div>
  <div id="image02">
