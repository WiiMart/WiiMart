...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157495450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un jeu d'objets cachés pour tous sur WiiWare !
<br><br>
Faites de votre mieux et essayez de trouver 12 objets particuliers parmi une foule d'éléments à l'écran aussi vite que vous le pouvez ! Aussi bien des gros poissons que des boucles d'oreilles minuscules, ainsi que des objets facilement repérables et d'autres bien mieux dissimulés.  Beaucoup d'objets et beaucoup de fun sont au rendez-vous dans ce jeu d'objets cachés ! 
<br><br>
Contrairement à la plupart des autres jeux d'objets cachés, vous pouvez jouer avec vos amis et votre famille et les affronter pour voir qui  trouve le plus d'objets cachés dans chaque niveau ! (jusqu'à 4 joueurs)
<br><br>
Avec 10 niveaux au total et plus de 277 objets différents, il y a de quoi s'amuser ! De plus, avec les nombreux objets qui changent de position chaque fois que vous rejouez, vous pouvez profiter de chaque niveau encore et encore !
<br><br>
Jouez et amusez-vous ensemble !
Un jeu d'objets cachés pour tous !
<br><br>
Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157495450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157495450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">"Aha! I Found It!"</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Hidden Object Game</span></div>
  </div>
