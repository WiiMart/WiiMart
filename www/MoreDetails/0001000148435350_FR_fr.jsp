...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ce logiciel déplace en une fois les données suivantes depuis une console Wii vers une console Wii U :<br><br>

• Les données de sauvegarde des logiciels Wii<br>
• Les WiiWare et leurs données de sauvegarde<br>
• Les jeux de la console virtuelle et leurs données de sauvegarde<br>
• Les contenus additionnels des logiciels<br><br>

• Les Wii Points<br>
• L'historique des activités de la chaîne boutique Wii<br><br>

• Les Mii<br><br>

Pour transférer les données, vous avez besoin d'une console Wii U, d'une console Wii et du matériel suivant :<br><br>

• Connexion Internet<br>
• Une carte SD/SDHC d'une capacité de 512 Mo ou plus<br><br>

Attention :<br><br>

• Les données transférées sont effacées de la console Wii.<br><br>

• Les données ne peuvent pas être transférées d’une console Wii U vers une console Wii. Une fois transférées, les données ne peuvent pas être retransférées vers la console Wii dont elles sont issues.<br><br>

• Toutes les données sont transférées en une fois. Elles ne peuvent pas être transférées individuellement.<br><br>

• Les logiciels préinstallés sur la console Wii au moment de son achat ne sont pas transférés.<br><br>

• La console Wii U n’est pas compatible avec WiiConnect24. Les fonctionnalités des logiciels utilisant WiiConnect24 ne seront plus disponibles après le transfert.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435350/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435350/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Transfert Wii U</span></div>
</div>
