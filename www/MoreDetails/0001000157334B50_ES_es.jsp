...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157334B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ThruSpace es un puzle en 3D que pone a prueba tus reflejos y tu orientación espacial como nunca has imaginado. Consiste en guiar a toda velocidad una figura geométrica, el poliedron, a través de los huecos de una serie de paredes, rotándolo de manera que encaje en cada uno de ellos. Cuantas más paredes, más puntos. ¡Y no te olvides las combotronitas, gemas que multiplican tu puntuación!
<br><br>
...
Tienes tres modos de juego, cada uno con diferentes desafíos: fásico, sin fin e ingenio y figuras. Puedes guardar hasta tres partidas o repeticiones de la jugada y verlas siempre que quieras en los registros poliedrónicos. ¡Mide tu habilidad con jugadores de todo el mundo enviando tus puntuaciones a la clasificación mundial!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334B50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Puzle 3D a alta velocidad</span></div>
  </div>
