...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Esta edición mejorada del famoso “Lode Runner” incluye un modo multijugador para 5 jugadores. El oro ha sido robado del Centro de Investigaciones de la Máquina del Tiempo y los responsables usaron una máquina del tiempo para escapar y esconder el oro a través del tiempo. El Centro manda a un equipo de elite de “Runners” para que vayan a recuperar el oro.
Además del modo PUZZLE, el juego tiene un modo BATTLE, donde hasta 5 jugadores podrán competir y un modo EDIT, para crear tus propias pantallas.
<br><br>
Puedes disfrutar del modo BATTLE de muchas maneras. Sé el último en quedar en pie para ganar en SURVIVAL. Coge los objetos de los enemigos y escapa para ganar en ESCAPE. Con 4 jugadores, podréis formar 2 equipos para luchar en TAG MATCH.
<br><br>Para luchar con varios jugadores, tienes que conectar tantos mandos de Wii o mandos de Nintendo GameCube como jugadores haya.
