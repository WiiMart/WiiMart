...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">高いゲーム性と精密なグラフィックが多くのファンを唸らせた、幕末を舞台に繰り広げられるサイドビューアクションゲームです。プレイヤーは抜け忍「月影」として、父の仇討ちと自分の出生の秘密を探るため、敵忍者たちとの激しい戦いに身を投じて行きます。オリジナルの「アーケードモード」と、ライフ制となった「ＰＣエンジンモード」の２つのモードが選択でき、縦横無尽に飛びかう敵忍たちとの戦いに「刀」「手裏剣」「爆弾」「鎖鎌」の４種類の武器を駆使して挑みます。アイテムを取ることで個別にパワーアップする武器を局面に応じて瞬時に切り替えることが、全７ステージ攻略のカギとなります。落下する天井やあらゆる箇所から出現する敵などに対し、分身の術や多彩な攻撃で切り抜ける姿は正に忍者アクションの醍醐味です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">最後の忍道<sup>&reg;</sup></span></div>
</div>
