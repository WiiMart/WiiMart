...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">カービィがボールとなって敵を倒し、ゴールのカップを目指していく、ゴルフとビリヤードの要素があるゲームです。ボールになったカービィをショットして敵を倒し、障害物を避けながらカービィをカップインすれば１ホールが終了。触れた敵のコピー能力をうまく使うと、打数を少なくすることができます。点取り合戦では白熱の対戦モードも楽しめ、少し立体的になった丸くてかわいらしいカービィの姿も魅力です。

<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">カービィボウル<sup>&reg;</sup></span></div>
</div>
