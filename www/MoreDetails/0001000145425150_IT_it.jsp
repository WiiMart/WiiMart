...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rilasciato per la prima volta nel 1996, “Ninja Master's” è un gioco di combattimento a incontri ambientato nel mondo immaginario di “Jipangu”. I giocatori sono chiamati a selezionare uno tra i 10 differenti ninja e guerrieri per poter mettere alla prova tutta la propria forza. La caratteristica principale del gioco è la possibilità che ha ogni personaggio di utilizzare una vasta gamma di armi. In più, dato che gli attacchi speciali variano in base al personaggio e al fatto che lo stesso sia armato o disarmato, il giocatore dovrà adattare di volta in volta le proprie azioni di gioco a seconda della situazione. Il danno, inoltre, aumenterà in concordanza con la Barra di super potenza... E ci sono così tante tecniche mortali imperdibili come “Modalità super definitiva”, “Super potenza oscura” e “Combo oscura”!<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">NINJA MASTER'S			</span></div>
</div>
