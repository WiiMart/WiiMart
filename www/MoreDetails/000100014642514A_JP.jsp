...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">黄金の騎士ギルを操作して、悪魔ドルアーガを倒し、塔の最上階にとらわれた巫女カイを救出するアクションロールプレイングゲームです。迷路に落ちている鍵を拾い、扉を開けば上の階に進めます。通路をふさぐ敵は剣を使って倒し、敵の放つ呪文は盾で受けて防ぎます。各階に隠された宝を手に入れることで、ギルがパワーアップしたり、仕掛けられた数々の罠に対抗したりできます。宝箱の出現方法は、「特定の敵を倒す」「特定の位置に移動する」等のスタンダードなものから、「何もせずにしばらく待つ」「わざと体力を減らす」といった意外なものまでさまざま。取るとマイナス効果のあるアイテムもあり、宝箱とアイテムの情報こそが攻略のカギです。アイテムによって主人公が成長するという斬新な要素と宝箱の出現条件の難しさから大きな話題となりました。家庭用に移植された本作では新たな要素が加わり幅広い人気を集め、今でも根強い人気を誇ります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642514A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642514A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドルアーガの塔<sup>&reg;</sup></span></div>
</div>
