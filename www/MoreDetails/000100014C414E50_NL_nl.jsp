...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Kruip opnieuw in de huid van de heldhaftige Alex Kidd in dit platformspel uit de jaren '80! Vind de twaalf wonderballen om de sterren boven de planeet Aries weer op hun plek terug te zetten, in een race tegen de klok! Speel twaalf rondes in zes uitdagende levels, vol met maffe vijanden, waaronder een speelgoedland, een robotfabriek en een level in de ruimte!<br><br>
Het spel is voorzien van Engelse schermteksten.<br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414E50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414E50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Alex Kidd: The Lost Stars<sup>TM</sup></span></div>
</div>
