...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego de plataforma de acción horizontal fue originalmente lanzado en 1990 como uno de los primeros juegos para NEOGEO. Elta, un mago y ultimo descendiente del famoso Magician Lord, se embarca en una épica aventura para salvar al mundo del malvado Gul-Agieze. Elta tendrá que luchar a través de ocho niveles, reuniendo los ocho tomos de poder que serán la clave para derrotar a Gul-Agieze y sus malévolos planes. Los poderes ofensivos y las habilidades para saltar de Elta podrán ser fortalecidos al obtener orbes en uno de los tres colores (elementos) que aparecen durante el progreso del juego. El efecto varía considerablemente dependiendo en la combinación de los elementos, y Elta tiene la habilidad de transformarse a seis diferentes formas (Waterman, Dragon Warrior, Shinobi, Samurai, Raijin, o Poseidon). ¿Podrás ayudarle a Elta para convertirse en el nuevo Magician Lord?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
