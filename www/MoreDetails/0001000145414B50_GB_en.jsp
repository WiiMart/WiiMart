...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Released in 1991 by SNK, Burning Fight is a side-scrolling hand-to-hand combat action game. 
Duke, Ryu and Billy are three detectives in pursuit of Casterora, a huge crime syndicate that has fled from New York to Osaka. Each playable character fights using a combination of punches, kicks and jumps. Players also have a range of lethal techniques at their disposal, which are activated by simultaneously pressing the jump and attack buttons. You'll need to think carefully before unleashing a lethal technique because, although they have enormous destructive force, they also consume a great deal of energy. You'll need to use all your wisdom and skill to time the use of these techniques well!
Burning Fight has a multiplayer feature, but be careful - attacks can damage not only your enemies but your allies too! So keep an eye on where your partner is in the heat of the battle!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
