...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Olvídate de todo con el juego de fichas más antiguo del mundo. 
<br><br>
Mahjong incorpora 30 disposiciones en 3D de este tradicional juego de combinaciones, cada una con millones de opciones distintas. El estilo y la interfaz del juego están diseñados para facilitar una interacción intuitiva con el mando de Wii. Además, para acercar o alejar la imagen basta con pulsar un botón. Los gráficos pueden personalizarse con seis temas diferentes para las fichas y una amplia variedad de fondos.
<br><br>
Siéntate, relájate y disfruta de un sinfín de desafíos con esta selección de lo mejor del mahjong. Y para completarlo, ponte a prueba con los minijuegos extras "Memoria" y "Parejas".<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D5A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mahjong</span></div>
</div>
