...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157575450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">I giochi classici possono trascendere le loro origini platform ed evolversi nel mondo dei giochi di nuova generazione. BurgerTime World Tour è una nuova versione del classico arcade con un’innovativa ambientazione cilindrica rotante in 3D e una fantastica meccanica tradizionale. 
<br><br>
L’asse di rotazione consente di vedere attraverso il livello cilindrico, introducendo una componente strategica nel trovare il modo più veloce di completare un hamburger. Ora Peter può lanciare le verdure infuriate e questo facilita l’atterraggio su un pezzo di hamburger, assegnando punti bonus.  
<br><br>
I nuovi elementi platform, i boss e oltre 20 livelli rendono il nuovo BurgerTime più succoso che mai. Mantieni l’atmosfera di BugerTime in un mondo 3D molto più vasto. Fuggi dalle verdure infuriate e crea il tuo BurgerTime World!
<br><br>
