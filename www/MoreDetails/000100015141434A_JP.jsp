...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">独特の怪しい世界観で、各方面を騒然とさせた「ぷちキレる」筋肉派シューティングゲームです。「筋肉こそ最高の美徳」とするビルダー星帝王「ボ帝ビル」の暴挙を阻止するため、天界の住人「イダテン」と「ベンテン」がビルダー軍の撃滅に乗り出します。プレイヤーはイダテンとベンテンのどちらかを選び、心強い肉体派オプション「アドン」と「サムソン」とともに、その肉体美を惜しげもなく披露しながら全５ステージを戦い抜きます。迫りくるビルダー軍の攻撃にはショットボタンを押しっぱなしで「男らしく」応戦、ここ一番では男の一撃「メンズビーム」がさく裂！ゲーム中は、プレイヤーはもちろん２人のオプションもそれぞれにパワーアップが可能。敵を倒すと出現する「プロテイン」を摂取すると「ビルドアップ」の掛け声も高らかに攻撃力がアップし、暑苦しくもマッチョな闘いがさらにヒートアップします。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">超兄貴</span></div>
</div>
