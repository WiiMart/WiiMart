...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157465250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mit Frogger Returns eröffnet sich eine vollkommen neue Dimension des spannenden Arcadespiels Frogger! Das klassische 2D-Gameplay in Top-Down-Perspektive wurde mit neuer bunter 3D-Grafik, einer neuen Ansicht, neuen Levels, neuen Feinden und Power-Ups aufgepeppt, die das Blatt im Spiel unerwartet wenden können! In lokalen Mehrspieler-Partien können Sie gegen einen Freund um den Sieg kämpfen.
<br>
<br>
- Neue Levels. In vier Abschnitten wird Froggers bekannte Reise über die Autobahn nach Hause zu einem völlig neuen Abenteuer.
<br>
<br>
- Verschiedene Spielmodi. Versuchen Sie Ihre Punkterekorde zu knacken, spielen Sie gegen die Uhr oder bringen Sie Frogger einfach sicher nach Hause. Die Entscheidung liegt bei Ihnen!
<br>
<br>
- Neue Bosse und Taktiken. Durch neue Feinde und Power-Ups ergeben sich unterschiedliche Strategien.
<br>
<br>
- Spielen Sie mit einem Freund! In lokalen Mehrspieler-Partien können Sie gegen einen Freund antreten.<br>
<br>Deutscher Bildschirmtext.</div>
  <div id="image02">
