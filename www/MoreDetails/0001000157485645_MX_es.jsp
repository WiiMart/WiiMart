...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157485645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">High Voltage Hot Rod Show es un trepidante juego en el que 4 jugadores queman el asfalto en diversos recorridos, ejecutan acrobacias y consiguen el impulso para vencer la competición. Todos aprenden a dominar sus Hot Rods en las rampas, derrapando, saltando y con otros trucos, mientras esquivan los obstáculos y atraviesan los Boost Rings (anillos de aceleración) que llenan sus Boost Meters (indicadores de aceleración). Los jugadores podrán enfrentarse a 7 rivales con la inteligencia artificial en el modo Championship (campeonato) o conseguir los mejores tiempos en Time Trials (pruebas contrarreloj). Éstos se publicarán en una tabla de puntuaciones mediante la Conexión Wi-Fi de Nintendo y se compartirán con jugadores de todo el mundo. El modo de multijugador es compatible con hasta 4 jugadores con la pantalla dividida. ¡High Voltage Hot Rod Show es un juego adictivo que aprovecha al máximo la tecnología de la consola Wii!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157485645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157485645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">High Voltage Hot Rod Show<sup>TM</sup></span></div>
</div>
