...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este cómico juego de acción presenta a los dos detectives chapuzas, J.J. y Jeff, en su viaje a través de 6 campos. Un día, reciben una petición en su oficina para aceptar un caso que requiere que “rescaten a un acaudalado hombre que ha sido secuestrado”. Elige entre dos personajes y parte en solitario para adelantarte a tu compañero y solucionar el día.
<br><br>
Cada campo está dividido en 4 áreas donde los enemigos y la incompetencia de tu compañero serán los obstáculos principales entre tú y tu objetivo. Hay muchos objetos en cada área. Patea varios sitios para que aparezcan. ¡Salta y ábrete paso a base de spray hasta la meta!
Disfruta de los pequeños sketches en las habitaciones ocultas, para recuperar vitalidad mientras te entretienes con su encanto surrealista.
