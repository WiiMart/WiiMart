...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードで人気を博した横スクロール型シューティングゲーム「ダライアスⅡ」をスーパーファミコン向けにアレンジしたタイトル。滅亡の危機から惑星オルガに逃れ、銀河連邦を築くまでに復興した人類は、再び宿敵ベルサーの攻撃を受けます。プレイヤーは戦闘機「シルバーホーク」を駆り、対空用ショットと対地用ボムで敵を撃破していきます。また、敵キャラ”ヤズカ”を６機倒すことで、赤・青・緑のパワーアップアイテムが出現、これらを取ることで自機をパワーアップすることができます。７ラウンド１２ゾーンのステージでは、各ゾーンの最後に水棲動物をモチーフとした総勢１１体の巨大ボスとの戦いが待ち受けています。シリーズ伝統のステージ分岐も健在です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">DARIUS TWIN<sup>TM</sup></span></div>
</div>
