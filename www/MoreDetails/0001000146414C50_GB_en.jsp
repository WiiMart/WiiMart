...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Baseball is extremely popular in Asia and America, however it remains relatively unknown in the rest of the world. With Baseball, Nintendo gives you the chance to discover this much-loved sport. Upon its release on NES, Baseball was considered one of the best sports simulations available because of its accessibility and cute graphics, and it still remains a good introduction to the rules of the sport. The game features six different teams to choose from. In Japan, these represented the six teams of the Central League, featuring the most popular teams in the country. In the international version, those teams were replaced by the six most popular teams of the North-American league at the time of the game's release.</div>
  <div id="image02">
