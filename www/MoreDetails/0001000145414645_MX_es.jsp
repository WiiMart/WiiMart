...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El Planeta de Raguy ha sido invadido por la tribu Daruma, convirtiendo un lugar hermoso y lleno de paz a un lugar lleno de contaminación. Este juego de acción horizontal, lanzado en 1991, narra la historia de una criatura llamada Blue y su misión por salvar su planeta y evitar que sus habitantes se conviertan en esclavos. Utiliza el arma principal de Blue, una hoja, para poner de cabeza a tus enemigos y luego arrojarlos a otros miembros de la tribu Daruma, destruyendo a cualquiera en tu camino. También existen otras armas adicionales como las bombas o bumeranes, y podrás reunir flores mientras progresas para comprar otros objetos especiales como miel o alas para nadar. Blue también tiene la habilidad especial de cambiar de tamaño cuando él quiera – ¡si esta muy grande y no cabe en cierto lugar, encógelo para que quepa! Las gráficas coloridas y alegres, combinadas con un sin fin de objetos escondidos, aseguran una experiencia muy divertida y un juego que se puede jugar repetitivamente. ¡Ayúdale a Blue para que una toda sus fuerzas y elmine al la tribu Daruma!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BLUE'S JOURNEY</span></div>
</div>
