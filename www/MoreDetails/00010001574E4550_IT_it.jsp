...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574E4550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Diventa il re della pesca! I pinguini sono affamati e hanno bisogno del tuo aiuto per nutrirsi. Cattura tutti i pesci che puoi prima che qualcuno te li porti via! <br>
In questo gioco elettrizzante la strategia è fondamentale. Cerca di non farti intrappolare dagli altri pinguini e raggiungi le distese ghiacciate che contengono più pesce. Da 1 a 4 giocatori in contemporanea possono divertirsi con Penguins & Friends... sempre che riescano a resistere al freddo polare.
<br><br>
Come si gioca<br>
Lo scenario è formato da blocchi di ghiaccio sotto i quali si trova un determinato numero di pesci (1, 2 o 3). I blocchi di ghiaccio sono esagonali e formano una struttura simile ad un alveare. La disposizione di partenza dei blocchi di ghiaccio può cambiare, creando così differenti scenari di gioco.<br>
In base al numero totale dei giocatori e alle dimensioni dello scenario, ogni giocatore possiede un determinato numero di pinguini che vengono usati come pedine.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E4550/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E4550/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
