...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">総勢２８人の強豪レスラーたちが集い、「世界一決定戦」に挑む、人気プロレスゲームのシリーズ第三弾です。プレイヤーは、多彩なプロレス技を駆使して試合を勝ち抜き、王座獲得をめざします。試合は、打撃や投げ技などで先に相手の体力を奪うことで優位に展開します。特に関節技は、腕や脚にダメージを蓄積させる有効な攻撃ですので、積極的に狙ってください。組み合った時に技をかけるにはタイミングが重要なので、繰り返し練習して感覚を覚えることが上達のポイントです。また、今作では「レスラーエディット」モードを初搭載。能力値と持ち技を設定し、豪快なパワータイプや華麗なテクニックタイプなど、好みのスタイルであなただけのオリジナルレスラーを作ることができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015044474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015044474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイヤープロレスリング<sup>&reg;</sup>３</span></div>
</div>
