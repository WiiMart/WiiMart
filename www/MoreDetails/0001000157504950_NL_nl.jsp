...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157504950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Een aktievol spel op het racecircuit.
In het spel moet de pitsploeg wagens, maar ook DINGESSEN repareren!
De DINGES-reparaties worden uitgevoerd door een pitsploeg met legendarische schoonheden!<br><br>
Eenvoudige besturing! <br>
Als je een teamlid 'grijpt' met 
de A-knop van de Wii-
afstandsbediening en loslaat
wanneer de aanwijzer zich 
boven het beschadigde
onderdeel bevindt, begint het
teamlid met de reparatie.
Wijs reparaties toe aan de teamleden en geef ondersteuning met de Wii-afstandsbediening om gerepareerde DINGESSEN zo snel mogelijk de pits uit te krijgen!
Er is een normale modus die je met 2 regelsets kan spelen, een abnormale modus waarin je teams maakt die het tegen elkaar moeten opnemen, en een klassementsmodus waarin je het tegen spelers uit de hele wereld opneemt voor de hoogste score.
Elke modus kan met maximaal 4 Wii-afstandsbedieningen worden gespeeld, zodat je een team kunt vormen met vrienden en familie. Kort gezegd kan jouw teamwerk tot uitstekende resultaten leiden!<br><br>Voorzien van Nederlandstalige schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504950/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504950/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
