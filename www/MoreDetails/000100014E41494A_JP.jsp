...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">キラキラと輝く透明感あふれる水上を駆け抜け、タイムやテクニックを競う本格派のレースゲームです。プレイヤーは個性的な４人の男女のなかからライダーを１人選んで参戦します。ハンドリング・グリップ・エンジンなど、マシンのセッティングを調整し、自分にビッタリのオリジナルマシンを作り上げることも可能。レースでライバルと競うだけではなく、ジャンプをしながら空中で回転をしたり、走行中にマシンの上で逆立ちするといった演技を競うモードも搭載し、華麗なアクロバットに挑戦することもできます。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ウエーブレース<sup>&reg;</sup>６４</span></div>
</div>
