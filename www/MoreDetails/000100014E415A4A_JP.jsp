...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マリオやルイージ、ピーチなど、マリオシリーズでおなじみのキャラクターたちが登場するパーティゲームです。スゴロク式のボードマップとミニゲームが合体。最大４人で遊べます。全６４個のミニゲームは操作がやさしく初心者でも楽しめ、ジャンルもレースやアクションなど盛りだくさん。さらに、ボードマップ上ではさまざまなイベントが発生します。思わず笑ってしまうようなイベントから
一発逆転のビックリイベントまで最後まで息が抜けません。従来のボードゲームにはない、ドキドキ感やスリルをお楽しみください。<BR><BR>
詳細は、<BR>
<center>http://www.nintendo.co.jp/vc/</center>
<div align="right">をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E415A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E415A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マリオパーティ<sup>&reg;</sup>２</span></div>
</div>
