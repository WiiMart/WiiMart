...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dopo Metal Slug, Metal Slug 2 e Metal Slug X arriva Metal Slug 3, il quarto titolo della serie Metal Slug.  Anche stavolta Marco, Tarma e compagni scendono in campo con un arsenale di armi impressionante. Come sempre, le vere star del gioco sono i numerosi mezzi corazzati a disposizione. Oltre ai classici Metal Slug e Slugnoid, nuovi mezzi come gli Slugmariner, i Drill Slug e gli Elephant Slug contribuiscono a ravvivare l'atmosfera e rendere l'esperienza di gioco ancora più emozionante. Oggetti nascosti e prigionieri da salvare sono sparsi come al solito un po' dappertutto, mentre le biforcazioni che caratterizzano alcuni livelli invogliano a rigiocare più volte lo stesso scenario.
<br><br>
