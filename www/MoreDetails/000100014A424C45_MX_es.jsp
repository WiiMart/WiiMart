...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El hábitat natural de Pac-Man son los laberintos, pero en Pac-Attack hace una inusual aparición en un divertido y trepidante juego de puzle. Para esta ocasión tan especial se han refrescado las convenciones del género y se ha añadido al cóctel uno de los personajes más icónicos del mundo de los videojuegos. El objetivo es simple: vaciar la pantalla de fantasmas y de los bloques que caen desde arriba alineándolos horizontalmente para que desaparezcan. Pero para deshacerte de los fantasmas necesitarás la ayuda del voraz Pac-Man, que afortunadamente se dejará caer de cuando en cuando para tomar un aperitivo. Tu labor consiste en alinear los fantasmas para que Pac-Man se los coma: sólo se detendrá cuando choque con un bloque o se le acaben los fantasmas. Su rango de desplazamiento en la pantalla de juego se limita a horizontal o hacia abajo, con lo que las posibilidades estratégicas se multiplican. Puedes elegir entre tres modos de juego: 1 Player Normal, 2 Player VS. y el desafiante 1 Jugador Puzzle. ¿Te apetece engullir unos cuantos fantasmas?</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424C45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424C45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pac-Attack</span></div>
</div>
