...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９２年にリリースされたヒストリカルな世界観の対戦格闘ゲームです。服部半蔵、ジャンヌ、ラスプーチンなど歴史上の著名人を模した８人のキャラクターが参戦し、世界最強の座を賭けて戦います。操作はレバー（スティックまたは十字ボタン）とパンチ、キック、投げの３ボタンで行いますが、攻撃の強弱はボタンを押している時間の長さで決定されるという、独特のシステムが特長です。また通常の対戦以外に、地雷、電流ロープなどが設置されたデスマッチモードも収録。多彩な戦いが楽しめます。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワールドヒーローズ<sup>&reg;</sup></span></div>
</div>
