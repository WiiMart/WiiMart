...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158494F50')", "wiiSelectSound()");
...
<br><br>
Samen met de PooYoo's, een gezellig groepje schattige babydiertjes, maakt je kind kennis met allerlei dingen die goed zijn voor zijn of haar ontwikkeling: cijfers, letters, vormen, kleuren en nog veel meer. Bovendien wordt de lateralisatie gestimuleerd. Kinderen kunnen samen met hun nieuwe vriendjes dansen en krijgen allerlei interactieve beloningen. Alle kinderen kunnen, ongeacht hun leeftijd, dankzij de twee interactie-niveau’s de activiteiten over planten en muziek spelen.
<br><br>
Dit spel is speciaal ontwikkeld om gebruikt te worden door kinderen die nog niet kunnen lezen. <br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  ...
  <div id="image01">
    <img src="/oss/ccs/0001000158494F50/FFFD0016" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Aflevering 2 - Demo</span></div>
  </div>
