...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">地獄からよみがえった平家の武士「平景清」が活躍するアクションゲームの第二弾です。前作「源平討魔伝」で景清によって打ち倒された「源頼朝」とその一派。しかしその魂は消滅せず、地の底で魔族復興の時をうかがっていました。ふたたびよみがえった景清は、頼朝の野望を打ち砕くため、「魔界日本」の７つのステージを進み、頼朝のいる「鎌倉あぎと」をめざします。プレイヤーは「命の玉」や「ロウソク」で体力を回復させながら、大きなキャラクターで表現された臨場感たっぷりの横スクロールステージを進み、さまざまな剣技を使い分けて襲いかかる敵を倒していきます。さらに「神器アイテム」を手に入れることで、「毒」や「雷」を無効化したり、５種類の必殺剣を使用することも可能です。また本作でも「義経」「弁慶」といった源氏方の猛者たちが、ステージを守るつわものとして登場。火牛を操る「木曽義仲」や、前作でおなじみの「鬼姫」なども新たにボスキャラとして加わり、より迫力に満ちた一騎打ちを堪能することができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">源平討魔伝<sup>&reg;</sup> 巻ノ弐</span></div>
</div>
