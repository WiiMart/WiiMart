...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De NES-klassieker Balloon Fight, een succes in de arcadehallen van begin jaren ’80, geeft je de controle over een heldhaftige ballonvaarder die de ballonnen van zijn vijanden moet laten knallen voordat zij de kans krijgen hetzelfde bij hem te doen!
<br><br>
Neerstortende vijanden klappen een parachute open, dus raak ze een tweede keer om ze in het water of de bek van een hongerige vis te doen belanden. Maar let goed op: deze vis aast ook op jou!
<br><br>
Balloon Fight bevat ook een stand voor twee spelers met een coöperatieve en een competitieve stand, en een zijwaartsscrollende overlevingsstand, ‘Balloon Trip’ genaamd.
