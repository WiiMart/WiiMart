...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">縦スクロールシューティングの定番として、数多くの続編を生み出した「ソルジャーシリーズ」の原点。「ブレイン軍」の人工頭脳に制御された浮遊大陸を舞台に、プレイヤーは敵の侵攻に立ち向かうべく、最新鋭の小型戦闘機「シーザー」に乗り込んで全１６ステージの戦いに挑みます。自機はステージ上の「Ｐマーク」から現れるパワーカプセル」を取ることで３段階の強化が可能。段階ごとに攻撃力はもちろん、移動速度や防御力も同時にパワーアップします。押し寄せる敵を倒し、時には大陸の裏側に潜ることができる「トラップゾーン」を利用して敵の攻撃をかわしながら、各ステージを支配しているボス「スターブレイン」の破壊を目指します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スターソルジャー<sup>&reg;</sup></span></div>
</div>
