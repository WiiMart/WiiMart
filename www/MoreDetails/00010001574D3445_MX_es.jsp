...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D3445')", "wiiSelectSound()");
...
<p>
También se incluye asistencia técnica integral para el Logitech USB Micrófono y el Wii Speak para que puedas realizar tus propias grabaciones de voz. 

Y ahora, ¡manos a la obra, y a hacer ruido!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
