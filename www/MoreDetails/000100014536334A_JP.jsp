...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">現代に生きる忍者「ジョー・ムサシ」と、闇の世界を牛耳る犯罪シンジケート「ＺＥＥＤ」との戦いをえがくアクションゲームです。「ＺＥＥＤ」に連れ去られた子供忍者を救い出しながら、シンジケートの兵士たちを倒し、アジトへと向かいます。ムサシは、近くの敵には格闘術や刀を、遠くの敵には手裏剣を使って攻撃します。また、ピンチのときは必殺の忍術を使って画面内の敵を一掃することもできます。ミッションの最後には巨大なボスが登場。忍者軍団を乗せたヘリコプターや、仏像に守られた巨大コンピュータなど奇想天外な戦いも見ものです。さまざまなハードに移植された人気シリーズの始まりとなる、アーケードで登場した１作目です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SHINOBI　忍</span></div>
</div>
