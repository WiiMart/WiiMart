...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ドラゴンの支配するイザンデ王国に捕われたオルセア王国の王女「クレア姫」を救い出すため、オルセア王に集められた「４人の勇者」が立ち向かう、縦スクロール型フォーメーションロールプレイングゲームです。ステージは全部で５つ。４人それぞれに用意されたステージを冒険し、最終ステージでは４人がフォーメーションを組んで戦います。４人それぞれの個性的な攻撃方法を駆使して、各種ステータスをアップさせながら、草原や砂漠、海、山、謎のワープゾーンなどバラエティに富んだステージをクリアし、ドラゴンの打倒をめざします。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146435A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146435A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">キングスナイト<sup>&reg;</sup></span></div>
</div>
