...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158484B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">IMPORTANT: Some features of the product version are not supported in this demo. The demo does not allow you to save game data, so you will not be able to continue your game on the final product version. The complete version has 10 levels. In the demo version you can only play one of these levels.
<br><br>
Over the past five centuries, hundreds of ships flying every ensign have succumbed to the power of the ocean. Merchant boats, pirate ships, navy vessels... all of them have ended up covered with coral at the bottom of the oceans around the planet.
<br><br>
But all of them guarded secrets that remained hidden over the years. Secrets that have always been a mystery... until now.</div>
  <div id="image02">
