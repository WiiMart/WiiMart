...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">World Heroes 2 is a fighting game released in 1993 by ADK, featuring characters based on heroes throughout history like Hanzou, Janne and Captain Kidd - there are 14 characters in all from which to choose.
<p>
...
<p>
One unusual aspect is the introduction of two game modes, each with different sets of rules. Normal Mode is the standard best-of-two bouts type match, and Death Match Mode is more extreme then that of the previous title, with a 10 count, sudden death system. These two modes make for thrilling and fervent battles that will keep you playing over and over!</div>
  <div id="image02">
