...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">数あるスポーツゲームの中でも「世界初のゲートボールゲーム」として、ひときわ異彩を放ったユニークなタイトルです。プレイヤーは２チームに分かれ、各ゲートに順番にボールを通過させ、中央のゴールポールに当てて得点を競います。シンプルなルールでありながら、作戦次第で敵チームをどんどん追い込めるという奥深い戦略性が、この競技独特の魅力です。プレイの先を読んで「タッチ」や「スパーク」といったゲートボール特有のワザを華麗に決めれば、コートを味方チームの独壇場にすることも可能です。さらに「通常プレイ」モードのほか、試合状況を自在にシミュレートすることができる「練習モード」や「ルール解説」モードもあり、初心者でも安心してプレイに臨むことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">あっぱれ！ゲートボール</span></div>
</div>
