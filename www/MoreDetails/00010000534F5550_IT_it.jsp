...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Impossibile scaricare questo canale.<br><br>Per aggiornare i dati di The Legend of Zelda: Skyward Sword, scarica il "Canale Aggiornamento dati di The Legend of Zelda: Skyward Sword".</div>
  <div id="image02">
    <img src="/oss/ccs/00010000534F5550/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
