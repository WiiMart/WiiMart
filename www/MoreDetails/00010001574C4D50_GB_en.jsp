...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574C4D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Are you ready to survive all types of traps and discover all the secrets of LA-MULANA?
<br><br>
LA-MULANA is the most complete "archaeology action and exploration" game ever created. 
<br><br>
Take control of Professor Lemeza and his inseparable whip to discover the mysteries of Humanity!
Face all types of traps, enemies and Guardians in the greatest adventure ever created for WiiWare
<br><br>
In LA-MULANA you will explore vast temples and, most importantly, you will have the feeling of total immersion.<br><br> 
Each mechanism, trap or puzzle you solve will be a great achievement.
<br><br>
Features:
<br><br>
- The best "archaeology action and exploration" game.<br>
- Over 40 hours of play.<br>
- Hundreds of puzzles and secrets to be discovered.<br>
- Wide variety of weapons and objects you can use.<br>
- Use the "Mobile Super X" computer to run help software.<br>
- Large quantity of enemies with spectacular Guardians.<br></div>
  <div id="image02">
