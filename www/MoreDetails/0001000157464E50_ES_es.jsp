...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fish Tank es un divertido juego de puzle en el que deberás combinar elementos del mismo color. Sin embargo, en esta ocasión no tendrás que juntar gemas o bloques, sino que deberás reunir bancos de peces de colores. Para conseguirlo, deberás combinar cuatro peces iguales o más y pulsar el botón correspondiente para sacarlos de la red. ¡Además, el juego no se desarrolla verticalmente, sino horizontalmente, con lo que resulta especialmente original!
<br><br>
¿Quiéres más? Aquí lo tienes: <br>
 - 24 objetivos que desbloquear <br>
 - 24 desafiantes niveles <br>
 - 9 potenciaciones para mejorar tu experiencia de juego<br>
 - modo de juego para 4 jugadores<br>
 - 2 modos de juego: Play y Challenges<br>
- ¡un trofeo especial al mejor coleccionista de medallas de oro
