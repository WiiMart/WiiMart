...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157505150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Protöthea ist ein Scroll-Shooter mit totaler Bewegungsfreiheit, bei dem der Spieler ein hochmodernes Raumschiff steuert, um den Asteroiden "Maqno 01" zu zerstören und die Pläne von "The Core" zu durchkreuzen.
<br><br>
Ubisofts Protöthea bietet neue Konzepte im klassischen Spielstil und nutzt die Möglichkeiten der Wii-Konsole von der Grafik bis zur Steuerung konsequent aus.<br><br>
Spieler aller Altersklassen können ihr Raumschiff in den zehn spannenden Missionen durch vier verschiedene Welten navigieren. Mit dem Waffenarsenal und den Bonus-Gegenständen können sie sich der Mission stellen und wenn sie die Zeit verlangsamen, können sie dem Gegner immer einen Schritt voraus sein.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
