...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157423545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Prepárate para la locura del mejor juego de romper bloques! Block Breaker Deluxe es una reinvención del clásico juego arcade de romper ladrillos con un moderno estilo gráfico, un entorno divertido y un exclusivo modo multijugador. Animados personajes y fantásticos gráficos proporcionan las características distintivas de la vida nocturna de la alta sociedad, como un bar de moda, un club de baile, un casino y más. Ladrillos especiales, múltiples extras, armas secretas, diferentes tamaños de pala y variación en la velocidad de la bola, hacen de este fascinante juego todo un desafío. ¡La furia de Block Breaker Deluxe ha llegado!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157423545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157423545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Block Breaker Deluxe<sup>TM</sup></span></div>
</div>
