...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157535550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You are about to enter the battle for the future in a world governed by the law of the jungle. As you move through the stages your character evolves, and your weapons and shooting abilities change.<br><br> First you start by throwing weapons by hand, then proceed to using tools where you can have a taste of many different types of projectiles. Cooperative 2 player mode is also available.<br><br>The controls are simple! Move the character with the Control Stick and the crosshairs with the Wii Remote, and shoot down the targets while dodging enemy attacks. Getting hit by an enemy bullet or touching an enemy close to you will count as a miss. With each miss, you will lose one heart from the bottom indicator of the screen, and losing all hearts will end the game.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157535550/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
