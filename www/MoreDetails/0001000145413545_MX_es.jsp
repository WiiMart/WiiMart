...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juego de lucha lanzado en 1995 y cuarta entrega de la saga Fatal Fury. En el original, introducía un plano de fondo al que los personajes podían desplazarse, una característica completamente innovadora en los juegos de este tipo. En esta ocasión, los planos no son dos, sino tres en total, uno en la parte posterior y otro en la anterior. No obstante, se ha adoptado el sistema “sway line”, que al cabo de un rato devuelve a los luchadores al plano principal. Además, solo tienes que pulsar un botón en el momento justo para encadenar tus golpes, haciendo realidad combos espectaculares. Se han realizado cambios menores en las famosas técnicas mortales y en los poderes latentes que las superaban, lo que contribuye a un conjunto más ágil y con mucha mayor profundidad que traerá horas de diversión a tu casa.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145413545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145413545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FATAL FURY 3:</span></div>
</div>
