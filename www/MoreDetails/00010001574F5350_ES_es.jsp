...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F5350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Papá, Mamá, Sarah y Billy están pisando el pedal hasta el fondo con Family Slot Car Racing!
<br>
Corre a través de tres circuitos, ¡cada uno compuesto de múltiples pistas de carreras e incluso con pistas de bonificación!
<br>
Puedes competir contra un amigo en un amistoso uno contra uno.
<br>
Elige entre distintos coches con variados diseños para ver cual tiene mejor velocidad y sepas controlar mejor.
<br>
Mientras progresas, podrás desbloquear nuevos circuitos e incluso nuevos coches que te ayudarán a alcanzar el cénit de las pistas de carreras.
<br>
¿Tienes lo que vale para ser el más rápido en cuatro ruedas?
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F5350/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F5350/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
