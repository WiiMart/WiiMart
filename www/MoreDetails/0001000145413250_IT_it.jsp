...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Nel secondo episodio della serie Metal Slug pubblicato da SNK nel 1998, potrai impersonare Marco, Tarma, Eri e Fio per portare a termine la tua missione: annientare l’armata ribelle del generale Morden.
<br><br>
Proprio come avveniva nel capostipite della serie, anche in Metal Slug 2 velocità e riflessi sono indispensabili per completare i vari livelli ma questa volta puoi contare su un arsenale molto più vasto dove spiccano: una mitragliatrice, un fucile a pompa e una pistola laser. Il tuo personaggio subirà inoltre alcuni cambiamenti di stato e si trasformerà in una mummia quando viene colpito dall'alito velenoso delle mummie; o diventerà obeso se colleziona troppi cibi-bonus: in questo stato sarai più lento ma i tuoi attacchi saranno molto più efficaci.
<br><br> 
Se hai bisogno di qualcuno che ti copra le spalle, non devi fare altro che reclutare un amico e dare il via alla tua missione.
<br><br>
Il testo all'interno del gioco è in inglese.<br>Il tutorial è disponibile anche in portoghese, spagnolo e giapponese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
