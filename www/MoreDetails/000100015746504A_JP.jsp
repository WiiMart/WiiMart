...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015746504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ひらめきカードバトル メクルカ」は、本格的なカードバトルが誰でも気軽に遊べる、神経衰弱風カードバトルです。自分のデッキからカードを引いて戦う普通のカードバトルと違い、常に相手とカードを取り合う楽しみをプラス。ゲットしたカードを使っての戦略は奥深く、本格的カードバトルの面白さはそのままに誰でも手軽に遊ぶことができます。５０種類あるカードの中から強力なものを引き当てれば、驚くような大逆転が起きることも。実力と運の絶妙なゲームバランスが、ドラマティックな展開を生み出して飽きさせません。ステージ数もデフォルトの４０種類に加え、ステージエディット機能を搭載。短時間で決着がつくので何度も繰り返し遊びやすく、複数のモードでの多彩なＣＯＭ戦に加えて、ニンテンドーＷｉ－Ｆｉコネクションで気軽に対人戦が楽しめ、モード別のランキングで他のプレイヤーと記録を競うこともできます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015746504A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015746504A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ひらめきカードバトル メクルカ</span></div>
</div>
