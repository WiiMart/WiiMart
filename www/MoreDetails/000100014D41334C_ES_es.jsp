...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El objetivo de este juego, en el que te enfrentarás a la consola o a otro jugador, es despejar de la pantalla las piezas que caen, llamadas Puyo, agrupando cuatro o más en posiciones adyacentes. Lo que hace de este juego una competición tan estimulante es que, cuando consigues eliminar una cadena de Puyo, cae una pieza al azar en la pantalla de tu adversario. Cuantos más Puyo elimines, más se llenará la pantalla de tu adversario y, si logras que las piezas lleguen a la parte superior de su pantalla, ¡habrás ganado la partida! Una intrigante historia completa la diversión, tanto para uno como para dos jugadores.
<br><br>Textos de pantalla parcialmente en japonés.
