...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157385750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Crea e spedisci divertenti biglietti augurali per Halloween!
<br>
Scatena la fantasia vestendo il  tuo personaggio con diversi costumi e decora il tuo biglietto scegliendo lo sfondo, le musiche e tantissimi adesivi.
<br>
Usando il telecomando Wii potrai facilmente navigare tra i vari menu ed inserire gli adesivi, scegliendone inoltre la posizione e le dimensioni.
<br>
Quando avrai realizzato la tua cartolina, personalizzala scrivendo un messaggio e spediscila ai tuoi amici.
<br>
Facile e divertente, cimentati anche tu con questa nuova applicazione.
Un breve tutorial ti insegnerà come poterla utilizzare al meglio da subito!
<br><br>
...
Le funzioni online di questo software utilizzabili tramite WiiConnect24 non sono più disponibili, poiché parte dei servizi online della console Wii non è più operativa dal 28 giugno 2013.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157385750/FFFD0014" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157385750/FFFD0015" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Happy Holidays</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Halloween</span></div>
  </div>
