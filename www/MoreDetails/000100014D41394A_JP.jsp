...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">時は２６世紀。軌道上のステーション・コロニーを管理する企業連合との全面戦争により荒廃化した地球を舞台にした本格的サイバーパンクＳＦシミュレーションゲームです。復興のために誕生した「運び屋」と呼ばれる者たちのひとりが偶然拾った機械を巡り、大きな陰謀が動き出します。キャラクターコンセプトを末弥純、メカニ
ックを青井邦夫がデザイン。そして日本ＳＦ界の重鎮・野田昌宏が監修を行った本作は、まるで上質の海外ＳＦ小説を読んでいるかのような体験を味わえます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ハイブリッド･フロント<sup>TM</sup></span></div>
</div>
