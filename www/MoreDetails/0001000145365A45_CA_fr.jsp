...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The classic vertical-scrolling shooter and a huge nationwide hit! Exhilarating play in which you can shoot down enemy units one after another with a single button. Hidden special bonuses scattered in all 25 areas. 1,000,000 bonus points for solving the biggest mystery. Rapid fire gained by docking with an ally unit, the PURSER. With various elements and rapid-fire play requiring strong and agile finger control, this is the mother of all shooters! Various settings (customizing the starting number of Final Stars, the difficulty of the game, etc.) are available!</div>
  <div id="image02">
