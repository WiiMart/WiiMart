...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードで大人気を博した横スクロール型シューティングゲーム「ダライアス」をＰＣエンジンＣＤ－ＲＯＭ２向けに移植したタイトルです。異星人の襲撃を受けて死の星と化した惑星「ダライアス」で、生き残りの「プロコ」と「ティアット」が戦闘機「シルバーホーク」で脱出を計ります。プレイヤーはシルバーホークを操作して、襲来する敵や敵弾をかいくぐり、対空・対地ウエポンで包囲網を撃破していきます。３種類のパワーカプセルを集めることで段階的に武器のレベルアップが可能です。ただし、１回のミスで集めたカプセルを全て失ってしまうので注意が必要です。分岐ルートの選択によってゾーンの組み合わせは変化し、いずれのゾーンもアーケード版にも劣らぬ美麗な仕上がりです。巨大ボス戦艦は総勢２６体に増えて、やり込み要素も充実。さらに、ＢＧＭはドルビーサラウンドに対応しており、迫力の立体音響を楽しむことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーダライアス</span></div>
</div>
