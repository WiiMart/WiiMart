...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dem 1992 von SNK veröffentlichten Kampfspiel „Fatal Fury 2“ kannst du nicht nur die aus dem Vorgänger bekannten Charaktere Terry, Andy und Joe spielen, sondern es treten noch fünf weitere Kämpfer zum Wettstreit um den Meisterschaftstitel an. Wenn im Vorgänger die Charaktere in einem Kampf an Stärke verloren, sanken dadurch ihre Chancen auf den Sieg und sie hatten einen bleibenden Nachteil. Verlieren sie jedoch in „Fatal Fury 2“ an Stärke und ihre Anzeige blinkt rot, können sie auf eine besonders wirkungsvolle Technik zurückgreifen. So haben sie noch die Möglichkeit, ihren Gegner mit einem einzigen Schlag auszuschalten.<br><br> Darüber hinaus wurde der schon im ersten Spiel der Serie sehr beliebte Kampf auf zwei Ebenen stark ausgebaut. Der Spieler kann seinen Kämpfer auf die zweite Ebene springen lassen oder den Gegner durch einen Angriff auf eine andere Ebene schleudern. Diese Aktionen stehen den Spielern in diesem Teil der Serie erstmals zur Verfügung.
<br><br>
