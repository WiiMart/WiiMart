...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484550')", "wiiSelectSound()");
...
Ten en cuenta que no podrás guardar la partida en la versión de prueba.<br><br>¡Lo retro vuelve a estar de moda con BIT.TRIP BEAT! Aprovecha el sensor de movimientos incorporado en el mando de Wii para mantener el compás en este juego lleno de ritmo.   <br><br>
Gráficos a la vieja usanza con la jugabilidad de antaño, aderezados con un modo multijugador de hasta 4 participantes y una banda sonora de 8 bits para ponerte a tono y soltarte la melena. ¡Pero estate al loro! Al igual que en la mayoría de los juegos clásicos, las pruebas que deberás superar son de aquí te espero. Si logras mantener el tipo a medida que aumenta la dificultad, descubrirás el génesis de la saga de BIT.TRIP...   <br><br>
Todo tiene un origen, ya sea oval o gallináceo. De la vida surgió el ritmo, y del ritmo la vida. Somos meros procesadores de información. Todo deriva hacia el aprendizaje. Nos comunicamos en bits y bytes. Y en partículas nos convertiremos una vez que se haga la nada. Una vez que BIT.TRIP sea cosa del pasado.<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484550/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484550/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BIT.TRIP BEAT</span></div>
</div>
