...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158485950')", "wiiSelectSound()");
...
<br><br>
BIT.TRIP FATE ist ein seitlich scrollendes Shoot ‘em up, bei dem CommanderVideo einem festgelegten Weg  folgt, um das Glück zu finden.
<br><br>
