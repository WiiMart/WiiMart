...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157544D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ADVENTURE ISLAND The Beginning comes to the Wii with exciting new skills and elements!<br>
Learn how to use new skills while exploring Adventure Island from coast to coast.<br><br>

Search for Golden Melons hidden throughout the stages and Mini Games.
When obtaining Golden Melons, you'll be able to purchase various items to help you on your adventure.<br>
Items purchased will increase your attack power or enable you to reach places you couldn't get to before.<br><br>

Fulfill certain requirements while playing in any of the modes to achieve a "Master Higgins Feat". You will be awarded a Master Higgins costume for doing so.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544D50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544D50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
