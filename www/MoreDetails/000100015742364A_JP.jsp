...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742364A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">様々なジャンルから出題されるクイズを、テレビのクイズ番組に出演した感覚で楽しむことができるゲームです。自分や家族にそっくりなMiiを使って、クイズ王決定戦を繰り広げましょう。クイズに答えるだけでなく、一発逆転ルーレットで追加賞金を獲得したり失ったり、臨場感あふれるプレイが楽しめます。数々の人気クイズ番組の作家、田中健一氏監修による3000問以上のクイズを収録。1人でクイズに回答するシンプルプレイの他、最大4人まで参加可能なマルチプレイによって、家族や友達同士で楽しむのにも最適です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742364A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742364A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">TVショーキング</span></div>
</div>
