...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年に登場し『難しいのにやめられない』という不思議な魅力で、
今なお高い人気を誇る、伝説の横スクロールアクションゲームシリーズの第一作です。魔界へと連れ去られた王女を救い出すため、単身魔界へと挑む「アーサー」を操作して、迫りくる魔物に挑みましょう。<BR><BR>詳細は、<Center>http://www.capcom-onlinegames.jp/category/wii.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">魔界村</span></div>
</div>
