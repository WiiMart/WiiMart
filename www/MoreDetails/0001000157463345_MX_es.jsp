...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157463345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Una colección de juegos clásicos en lápiz y papel. ¡Los favoritos de siempre para toda la familia!
<p>
LOS JUEGOS<br>
• Squares – Los cuadrados<br>
• Nine Men’s Morris – El molino<br>
• Safe Cracker – La caja fuerte<br>
• Matchsticks – Los cerillos<br>
...
<p>
CARACTERÍSTICAS<br>
• Incluye 8 difíciles juegos clásicos.<br>
• Muchas reglas diferentes y variaciones de los juegos. ¡Hay un montón de maneras de jugar!<br>
• Diversión para toda la familia: pueden jugar hasta 4 jugadores en los torneos.<br>
• 20 recompensas especiales y secretas para desbloquear.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157463345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157463345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Family Games<sup>TM</sup></span></div>
</div>
