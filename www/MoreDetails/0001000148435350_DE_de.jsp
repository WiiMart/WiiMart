...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mit dieser Software kannst du folgende Daten als Paket von einer Wii-Konsole auf eine Wii U-Konsole übertragen:<br><br>

• Speicherdaten für Wii-Software<br>
• WiiWare-Titel samt Speicherdaten<br>
• Virtual Console-Titel samt Speicherdaten<br>
• Zusätzliche Inhalte für Software<br><br>

• Wii Points<br>
• Kontobewegungen des Wii-Shop-Kanals<br><br>

• Mii-Charaktere<br><br>

Für den Transfervorgang werden eine Wii-Konsole, eine Wii U-Konsole sowie Folgendes benötigt:<br><br>

• Internetverbindung<br>
• Eine SD/SDHC Memory Card mit mindestens 512 MB freiem Speicherplatz<br><br>

Wichtige Hinweise zum Datentransfer:<br><br>

• Auf eine Wii U-Konsole übertragene Daten werden von der Wii-Konsole gelöscht.<br><br>

• Daten können nicht von einer Wii U-Konsole auf eine Wii-Konsole übertragen werden. Einmal auf eine Wii U-Konsole übertragene Daten können nicht wieder zurückverschoben werden.<br><br>

• Übertragbare Daten werden als Paket übertragen. Software oder Speicherdaten können nicht einzeln übertragen werden.<br><br>

• Software, die auf der Wii-Konsole bereits vor dem Kauf installiert war, wird nicht auf die Wii U-Konsole übertragen.<br><br>

• WiiConnect24 wird von Wii U nicht unterstützt. Nach dem Transfer einer Software auf eine Wii U-Konsole sind einige Funktionen dieser Software möglicherweise nicht mehr verfügbar.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435350/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435350/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii U-Transfersoftware</span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Wii-Kanal</div>
</div>
</body>
</html>
