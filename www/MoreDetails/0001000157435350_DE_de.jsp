...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157435350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Greif dir die Wii-Fernbedienung und versuche ein paar Stöße mit diesem virtuellen Billardspiel! Genieße „Matchups“ mit „Snooker“,  „9 Ball“, „8 Ball“ und „Rotation“, sowie Trickshots im Puzzle-Modus.<br><br>
Es gibt zwei Kontrollarten, die Kugel zu stoßen. Entweder man stößt virtuell mit der Wii-Fernbedienung zu oder man benutzt zuerst die Knöpfe, um die Stärke festzulegen und stößt dann zu.
Verbessere deine Fähigkeiten im Trainings-Modus und lerne dort all die genialen Techniken, die man als wahrer Spieler benötigt.<br><br>
Erstelle deine eigenen Herausforderungen mit den Editierungsfunktionen und versenke den Trickshot deiner kühnsten Träume!
Lege einen krassen Stoß hin und zeige allen, wer hier die Hosen an hat!<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
