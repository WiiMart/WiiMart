...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１チームが６人で構成され、２人対戦もできるサッカーゲーム。左右にスクロールする２画面分のフィールドで点を取り合います。ハーフタイムになればチアガールが登場し、雰囲気を盛り上げてくれる演出も。パスやドリブルを効果的に使うことがシュートを決めるコツです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641494A/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641494A/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サッカー</span></div>
</div>
