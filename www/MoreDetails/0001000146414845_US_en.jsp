...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Slam a serve, fire a blazing backhand, and smash a forehand volley on your way to winning the victory cup!  You can choose between five different levels of difficulty, ranging from Beginner all the way up to Advanced.  If you want to become a true champ, be ready to show off your most brilliant lobs and most powerful smashes!  Play a singles match or grab a partner for doubles, and then choose your opponent.  You control the moves in tennis action so intense, you'll almost believe you're at center court!</div>
  <div id="image02">
