...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D3345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Controlling one of eight monkeys, you will do battle with up to seven others across eight differently-themed landscapes. In single player, battle through three increasingly difficult campaigns of missions ranging from survival to coconut fights or have a one-off battle against the clock, as a team, or in a standard deathmatch.
<p>
Connect additional Wii Remotes to battle against up to three additional players or compete against anyone or your friends using Nintendo Wi-Fi Connection. Connect an optional Wii Balance Board accessory to add more mayhem to the fun.</div>
  <div id="image02">
