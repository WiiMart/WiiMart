...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157505550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">« PUZZLE BOBBLE Plus! » est un jeu simple et addictif dans lequel vous devez faire éclater des grappes de bulles multicolores avec votre canon à bulles ! À chaque fois que vous regroupez trois bulles ou plus de la même couleur, elles explosent ! Jouez en solo, et tentez de terminer les 135 niveaux du jeu en un temps record avec le meilleur score, ou lancez-vous dans le mode combat pour affronter d’autres joueurs.<br><br>

Si tout cela ne satisfait pas votre appétit de bulles, vous pouvez acheter deux packs de contenu supplémentaire et prolonger votre aventure grâce à 270 niveaux additionnels, soit 135 niveaux par pack ! « PUZZLE BOBBLE Plus! » est intuitif et suffisamment vaste pour vous donner envie d’y revenir, alors qu’attendez-vous ?<br><br>Texte écran en français.</div>
  <div id="image02">
