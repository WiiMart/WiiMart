...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Impossible de télécharger cette chaîne.<br><br>Pour mettre à jour les données de sauvegarde de The Legend of Zelda: Skyward Sword, veuillez télécharger la chaîne de mise à jour des données The Legend of Zelda: Skyward Sword.</div>
  <div id="image02">
    <img src="/oss/ccs/00010000534F5550/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chaîne de mise à jour des données</span></div>
</div>
