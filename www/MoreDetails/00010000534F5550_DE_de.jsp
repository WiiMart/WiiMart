...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieser Wii-Kanal kann nicht heruntergeladen werden.
<br><br>
Um das Update der Speicherdaten von The Legend of Zelda: Skyward Sword durchführen zu können, lade bitte den "The Legend of Zelda: Skyward Sword Speicherdaten-Update-Kanal" herunter.</div>
  <div id="image02">
    <img src="/oss/ccs/00010000534F5550/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
