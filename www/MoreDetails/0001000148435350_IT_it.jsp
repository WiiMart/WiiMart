...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Trasferimento dati Wii U permette di trasferire in blocco i seguenti dati da una console Wii a una console Wii U:<br><br>

• dati di salvataggio di software per Wii<br>
• titoli WiiWare e relativi dati di salvataggio<br>
• titoli della Virtual Console e relativi dati di salvataggio<br>
• contenuti aggiuntivi per software<br><br>

• Wii Points<br>
• riepilogo delle operazioni del Canale Wii Shop<br><br>

• Mii<br><br>

Per trasferire i dati sono necessari un set base della console Wii e un set base della console Wii U, oltre a:<br><br>

una connessione Internet<br>
una scheda SD/SDHC con almeno 512 MB di spazio libero<br><br>

Attenzione:<br><br>

• Una volta trasferiti, i dati sulla console Wii non saranno più recuperabili.<br><br>

• Non è possibile trasferire dati da una console Wii U a una console Wii. Una volta trasferiti da una console Wii a una console Wii U, non è possibile riportarli sulla console di origine.<br><br>

• Tutti i dati trasferibili saranno trasferiti in blocco. Non è possibile trasferire singoli elementi.<br><br>

• Tutti i software preinstallati sulla console Wii al momento dell'acquisto non verranno trasferiti.<br><br>

• Il Wii U non è compatibile con WiiConnect24. Dopo il trasferimento dei dati a una console Wii U, alcune funzioni potrebbero non essere più disponibili.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435350/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435350/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Trasferimento dati Wii U</span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Canale Wii</div>
</div>
</body>
</html>
