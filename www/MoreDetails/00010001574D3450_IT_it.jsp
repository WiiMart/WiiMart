...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574D3450')", "wiiSelectSound()");
...
Allora, che aspetti? Comincia a farti sentire! <br><br>Il testo all'interno del gioco è in italiano.
<br/><br/>
