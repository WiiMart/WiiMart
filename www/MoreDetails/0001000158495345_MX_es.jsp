...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495345')", "wiiSelectSound()");
...
<p>
La serie BIT.TRIP completa el círculo con BIT.TRIP FLUX, la aventura final de CommanderVideo.
<p>
Agarra el Wii Remote y prepárate para un juego clásico con paleta de CommanderVideo volviendo a su origen. Ya juegues solo o en modo cooperativo de dos jugadores, harás frente a nuevos retos que harán llorar hasta a los más expertos BIT.TRIPPERS. Disfruta de nuevos retos presentados en forma del familiar juego con paleta que comenzó el fenómeno llamado BIT.TRIP.
<p>
• ¡Nuevos potenciadores, incluida la paleta de pantalla entera!<br>
• ¡Nuevos tipos de compases, incluyendo compases a evitar!<br>
• ¡Puntos de control en mitad de nivel!<br>
• ¡Juego clásico BIT.TRIP BEAT con todos los Modos, incluido el nuevo Modo Meta!<br>
• ¡Bit Shifter repite como artista chiptune invitado!
<p>
Ve con CommanderVideo hasta que complete su misión y vuelva a... casa.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495345/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495345/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BIT.TRIP FLUX</span></div>
</div>
