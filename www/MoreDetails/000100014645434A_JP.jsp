...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自由と平和を愛する鳥たちの国バードランドに住む若者「バロン」とそのライバル「マックス」が大空を自在に飛び回る、横スクロール型シューティングゲームです。プレイヤーはバロンとマックスが乗りこむ複葉機を操作し、待ち受ける多くの敵を突破して、与えられたミッションを遂行します。司令部や戦艦、空母などの爆撃目標は、
フィールドに置かれた爆弾を低空飛行で拾い、頭上から落とすことで破壊できます。ミッションの最後にうまく基地に着陸すれば、次のミッションに進めます。基本テクニックは宙返りで敵の後ろに回りこんで撃ち落とすこと。敵から攻撃を受けると墜落してしまいますが、墜落中にボタン連打で復活できる場合もあるので、最後まであきらめないことが重要です。２人同時プレイも可能で、仲間が墜落しそうになったら、後ろから弾を当てて救助することもできます。プロ野球選手の応援歌でも使用されるなど、軽快なノリのＢＧＭが有名になりました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スカイキッド<sup>&reg;</sup></span></div>
</div>
