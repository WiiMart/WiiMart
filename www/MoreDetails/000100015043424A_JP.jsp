...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">地球から月までを舞台に繰り広げられる、全６シーンの横スクロールシューティングゲームです。月面に直撃した彗星の正体は調査の結果、異星人の巨大戦艦だったという、悪夢のような事実が判明しました。プレイヤーは異星人の侵略から地球を守るため、敵を撃破しながら月の最深部を目指します。多重スクロールで表現された美しい背景をはじめ、耐久力と連動したパワーアップシステムや敵を中心に自機の方向が反転するボス戦など、一味違った演出で独特の世界観を楽しむことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">デッドムーン 月世界の悪夢</span></div>
</div>
