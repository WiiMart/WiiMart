...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juega a pasarte la bola con tus amigos en este juego multijugador y compite con tu Mii y con otros personajes para lograr la máxima puntuación. Elige entre 6 diferentes modos de juego para un jugador o para varios jugadores, como el modo Speed Catch, que pondrá a prueba tus habilidades para coger una bola rápida, y el modo Bomb Catch, un juego eliminatorio para un máximo de 4 jugadores. Escoge entre una variedad de personajes o bien usa tu propio Mii para jugar a otros conocidos juegos de pasar la bola. Y si tienes tanto Let’s TAP como Let’s CATCH, ¡podrás desbloquear características especiales!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
