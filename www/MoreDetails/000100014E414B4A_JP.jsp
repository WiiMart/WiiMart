...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">野生のポケモンだけが暮らす島「ポケモンアイランド」で、ポケモンのありのままの姿を写真におさめることが目的の、一風変わった「カメラアクション」ゲームです。プレイヤーは少年カメラマンとなり、万能ビークル「ゼロワン号」に乗りこんで、島の各地に暮らすポケモンの撮影に挑戦します。ゼロワン号はコース上を自動で移動するので、シャッターチャンスは限られています。３６０度まわりに注意をはらい、地形を利用したり、どうぐを使ったりして、ポケモンたちの意外な一面をねらってみましょう。オーキド博士の研究所では、撮影した写真を博士にチェックしてもらって「ポケモンレポート」を作成。写っているポケモンのポーズや動き、大きさなどによって得点が変わるので、高得点をめざしてベストショットをとらえてください。写真はほかにも「アルバム」に保存することができるので、お気に入りの写真で自分だけのアルバムを作ることもできます。また、バーチャルコンソール版では「ギャラリー」の写真を自分のＷｉｉ伝言板に送る機能が追加されています。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ポケモンスナップ<sup>&reg;</sup></span></div>
</div>
