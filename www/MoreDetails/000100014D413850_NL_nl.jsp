...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De koningin van de Vortex blijkt nog lang niet verslagen te zijn. Zij is Ecco naar de aarde gevolgd en heeft daar een nieuwe kolonie gesticht. Toen Ecco de tijdmachine gebruikte om zijn school te redden, splitste hij de loop van de tijd in tweeën. Ecco moet deze splitsing nu ongedaan zien te maken voordat de alternatieve toekomst, een uitgestorven mechanische wereld die door de Vortex is leeggezogen, realiteit wordt!
<br><br>
Het is Ecco’s taak om opnieuw de hoogten en diepten van zijn wereld te verkennen om allerlei zeewezens te ontmoeten, puzzels op te lossen en een einde te maken aan het buitenaardse gevaar!
<br><br>
Het spel is voorzien van Engelse, Franse, Duitse en Spaanse schermteksten.
<br>
...
Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D413850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D413850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ecco: The Tides of Time<sup>TM</sup></span></div>
</div>
