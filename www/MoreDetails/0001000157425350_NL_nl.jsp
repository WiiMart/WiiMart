...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157425350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pop gaat helemaal over bubbels schieten! Het klinkt misschien eenvoudig, maar u kunt uw score en uw speelplezier op vele manieren verhogen:<br>

Maak een ketting van dezelfde bubbelkleur voor meer punten<br>
Gebruik power-ups om uw score te verbeteren of een tegenstander te hinderen<br>
Pomp bubbels op om enorme explosies en kettingen te creëren<br>
Speel solo<br>
Speel met vrienden op hetzelfde scherm<br>
Doe mee met een spel dat gaande is<br>
Ontsluit badges<br>
4 Verschillende manieren om te spelen<br><br>

Er zijn ook online-tabellen voor hoge scores en WiiConnect24-berichten, zodat u weet hoe uw vrienden spelen en u zelf indruk op hen kunt maken.<br><br>Het spel is voorzien van Engelse, Duitse, Franse, Spaanse en Italiaanse schermteksten.</div>
  <div id="image02">
