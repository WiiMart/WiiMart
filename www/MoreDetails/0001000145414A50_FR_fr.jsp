...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti en 1996, Metal Slug de SNK est un jeu d’action militaire à défilement horizontal dans lequel vous contrôlez Marco (mode un joueur) et Tarma (mode deux joueurs), tous deux membres de l’équipe des forces d’opérations spéciales Peregrine Falcon, mieux connue sous le nom de PF. Vous devez vaincre le General Morden et récupérer une arme volée, le Metal Slug.
<br><br>
Tirez et sautez pour progresser d’un niveau à l’autre, déployez des armes telles que des mitrailleuses, des fusils d’assaut, des lance-roquettes, des jets de flammes; emparez-vous du Metal Slug qui apparaît fréquemment au cours du jeu. La bataille n'en sera que plus facile. Profitez enfin de la fonction multijoueurs vous permettant de passer un excellent moment avec vos amis.
<br><br>
Texte écran en anglais. Tutoriel également disponible en portugais.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
