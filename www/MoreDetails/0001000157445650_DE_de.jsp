...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157445650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Voodoo Dice ist ein innovativer Mix aus Action- und Puzzle-Mechaniken in einer 3D-Welt. Es fordert den Spieler heraus, Puzzles in einzigartiger und interessanter Weise zu lösen.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
