...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574E4550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You can become the fishing king! The penguins are hungry and need your help to feed themselves. Catch all the fish you can before someone steals them from you!<br>
Strategy is fundamental in this exciting game. Keep moving ahead of the other penguins so that you don’t get trapped and try to get to the ice flows that hold more fish. Between 1 and 4 players can play ‘Penguins & Friends’ at the same time – providing they can handle the polar cold.
<br><br>
How to Play?<br>
The board is made up of ice blocks that have a set number of fish (1, 2 or 3) under them. The ice blocks are hexagonal and form a structure like a beehive. The starting position of the ice blocks can change, creating different game boards.<br>
Each player has a set number of penguins (according to the total number of players in the game and the size of the board) which serve as markers.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E4550/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E4550/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
