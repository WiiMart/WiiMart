...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wave Race 64 salió a la venta con la consola Nintendo 64 y se convirtió rápidamente en todo un éxito debido a sus tremendos gráficos en tres dimensiones y a sus posibilidades de juego fuera borda.
<br><br>
En el modo campeonato disfrutarás de 9 circuitos: desde las aguas tranquilas de Sunny Beach hasta las enormes olas de Marine Fortress. Cada circuito está repleto de obstáculos que tendrás que evitar y de rampas con las que podrás hacer impresionantes acrobacias.
<br><br>
Compite contra un amigo en el modo dos jugadores, rebaja tus tiempos en el modo contrarreloj o practica todas tus volteretas, giros y pinos en el modo acrobacias. Si lo haces excepcionalmente bien, puede que incluso consigas montar a lomos de un delfín.<br><br>Textos de pantalla en inglés o en alemán.</div>
  <div id="image02">
