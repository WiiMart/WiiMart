...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157414C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Scopri come gareggiare alla velocità della luce in questo gioco della straordinaria serie Art Style!
<br><br>
In Art Style: light trax, comandi un raggio luminoso che gareggia contro altri. Il raggio si muove automaticamente, dandoti modo di concentrarti su velocità e cambi di corsia che ti permettono di sfruttare la vicinanza agli altri raggi per accumulare energia e superarli. Corri su percorsi che alternano tratti in 2D a tratti in 3D, tocca i pannelli turbo per andare più veloce ed evita gli ostacoli che ti farebbero perdere secondi preziosi. 
<br><br>
Sono presenti due modalità principali: Gran Premio, costituita da una serie di gare e Autostrada, nella quale dovrai coprire quanta più distanza possibile in un certo tempo. Ottenendo buoni risultati, sbloccherai nuove modalità e funzioni.
<br><br>
I comandi semplici danno vita a una sfida coinvolgente, resa ancora più avvincente dalla colonna sonora elettronica. Art Style: light trax è avanti anni luce.
<br><br>
