...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Power Golf sports a perfect combination of simple yet realistic controls and beautiful graphics. Swing away on 18 lush holes in the single player Stroke Play mode or the multi-player Match Play and Competition modes.
<br><br>
Enter in tournaments as one of 3 different characters - beginner, intermediate, and advance. Wind strength and the slope of the green add extra challenges to each hole. Compete against other players in the standard Normal Match, or ante up one of your clubs in the unique Club Match.
<br><br>
Up to 3 players can play in Competition mode and a handicap feature is included to help novice players pull off breathtaking shots just like their advanced rivals.</div>
  <div id="image02">
