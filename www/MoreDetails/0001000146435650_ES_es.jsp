...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Wrecking Crew, el clásico de NES, Mario deja a un lado la fontanería para ejercer como... ¡ingeniero de demoliciones!
<br><br>
Tu objetivo será demoler todos los obstáculos de cada nivel. Tendrás que encontrar la ruta más destructiva entre las escaleras, los andamios y los innumerables enemigos.
<br><br>
Wrecking Crew forma parte de los juegos de NES que te permiten editar tus propios niveles. Además, en la consola virtual, podrás guardar los niveles que edites, algo que no era posible en el juego original.
