...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８６年にリリースされたアクションゲームです。ツッパリ同士の喧嘩をテーマにした異色の内容で、プレイヤーは正義の不良くにおくんとなって、不良、暴走族、スケ番などとバトルを繰り広げることになります。８方向レバーと、左右への攻撃ボタン、ジャンプボタンで「くにお」を操作します。くにおくんの動きは実に多彩。パンチ、後ろ蹴り、ジャンプキック、敵に馬乗りになってのパンチ、つかんでヒザ蹴り、投げなど、簡単操作で激しい戦いを楽しめます。ステージは全部で4つ。最後はどんな戦いが待ち受けているのでしょうか。<BR><BR>詳細は、<Center>http://www.vc-arcade.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">熱血硬派くにおくん</span></div>
</div>
