...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157585245')", "wiiSelectSound()");
...
<br><br>
This time, you'll travel to the ocean in this smash-hit fishing game series. With 20 kinds of fish to catch and over 40 missions, every fishing enthusiast will want to reel this title in!
