...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157484550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le célèbre Heracles doit s'atteler à une nouvelle épreuve, bien plus redoutable que tout ce qu'il a connu jusqu'ici ! Notre héros devra se mesurer à ses ennemis dans une course de chariots à travers d'incroyables royaumes mythologiques pour atteindre le sommet du mont Olympe !<br><br>

Incarnez Heracles pour l'aider à rapporter le trophée sacré, ou jouez un des nombreux autres personnages mythologiques tels que Satyre ou Poséidon pour vous emparer de cette incroyable récompense !<br><br>

Foncez à travers 3 championnats répartis sur 10 circuits dans 5 paysages mythiques et utilisez de fantastiques armes magiques contre vos adversaires : trident, boule de feu, tonnerre de Zeus et bien plus.<br><br>

Réunissez vos amis pour des parties intenses de 2 à 4 joueurs en écran partagé en mode Championnat, Course Simple ou Bataille !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157484550/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157484550/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Heracles Chariot Racing</span></div>
</div>
