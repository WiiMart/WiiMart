...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483950')", "wiiSelectSound()");
...
<br><br>
En ColorZ controlarás varias naves alienígenas para limpiar planetas infestados de virus. Sumérgete en un original videojuego que despertará en ti capacidades psicomotrices insospechadas.<br><br>

Absorbe los virus que sean del mismo color que tu nave, ¡pero ten cuidado con los demás! Si lo necesitas, fusiona astutamente tus naves para crear colores nuevos. Pasa rozando a los enemigos para conservar tu combinación y mejorar tu puntuación máxima.<br><br>

Descubre una forma diferente de jugar gracias al modo multijugador, y comparte una experiencia cooperativa única con tus amigos. ¡Unid vuestras fuerzas, sincronizad vuestros movimientos y fusionaos en emocionantes partidas en las que podrán participar hasta tres jugadores a la vez!<br><br>

Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ColorZ</span></div>
</div>
