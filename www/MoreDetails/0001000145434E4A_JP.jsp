...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">２００１年にリリースされたベルトスクロールアクションゲーム。プレイヤーは４人の初期キャラクターから１人を選び、赤い月の夜に目覚めた荒ぶる魂の浄化の為、世界各国を駆け巡ります。前作からゲームシステムを一新、武器と素手、敵を倒すごとに貯まる忍ゲージで使用できる数種類の忍術を駆使して戦っていきます。武器、素手、忍術を使い分け、上手くコンボを繋げることで自キャラクターの攻撃力が上がるシステムも搭載。攻撃力の上がった忍術やコンボで敵を討ち倒していく、爽快感のあるアクションゲームが楽しめます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434E4A/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434E4A/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">戦国伝承2001</span></div>
</div>
