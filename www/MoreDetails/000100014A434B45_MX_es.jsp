...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Experimenta una de las franquicias emblemáticas de la industria de los videojuegos con esta perfecta reproducción del clásico de arcade! Dispara a la multitud de invasores que marchan frenéticamente haca ti. Muévete rápido pero con cuidado, usa las barreras como protección, evita los misiles que disparan los extraterrestres e intenta destruirlos a todos antes de que lleguen a la parte inferior de la pantalla. Revive la nostalgia al elegir entre los varios modos que simulan versiones diferentes del juego de arcade (tales como de gabinete vertical, o en blanco y negro). Si quieres demostrarle tus habilidades superiores a alguien más, prueba el nuevo modo VS y descubre quién puede detener a la amenaza extraterrestre primero. Lo mejor de todo es que encontrarás una experiencia de juego en su máxima expresión, ¡y sin la necesidad de gastar monedas!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434B45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434B45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SPACE INVADERS<sup>&reg;</sup>:</span></div>
</div>
