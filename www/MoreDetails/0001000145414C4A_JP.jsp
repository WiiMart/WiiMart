...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１２人の格闘家が最強武闘大会「キング・オブ・ファイターズ」の頂点の座をめざして戦う対戦格闘ゲームです。リョウ・サカザキ、ロバート・ガルシアら前作の登場人物に加え、リョウの妹のユリなど新たなキャラクターも参戦します。気力ゲージを消費して繰り出す必殺技、相手の気力を減らすことができる挑発コマンドなど、気力をめぐる駆け引きに独特の魅力を持つ基本システムは前作同様。新たにボタンの押し時間によって攻撃の強弱が変化したり、投げられてもタイミングよくボタンを押すことで受け身がとれるなどのシステムが加わり、前作以上に白熱の戦いが楽しめます。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">龍虎の拳２</span></div>
</div>
