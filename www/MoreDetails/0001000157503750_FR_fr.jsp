...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157503750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Starry Night permet d'observer les corps célestes sur votre téléviseur à l'aide de la télécommande Wii.<br><br>

Il y a 3 grands modes :<br>
- Observation : environ 20 000 corps célestes (jusqu'à des étoiles de magnitude 7). Modifiez différents paramètres tels que l'affichage de la latitude et de la longitude des constellations, la vitesse à laquelle le temps passe, et bien plus encore.<br><br>

- Planétarium : 11 parcours couvrant différents sujets tels que les étoiles, les nébuleuses, les constellations et d'autres corps célestes.<br><br>

- Guide céleste : des informations détaillées et mythologiques sur les corps célestes et les constellations ainsi qu'un glossaire pratique sur les termes astronomiques.<br><br>

My Starry Night est un jeu alliant le plaisir de regarder le ciel nocturne à celui de découvrir les corps qu'il contient.<br><br>
Venez voir de plus près les étoiles qui emplissent notre ciel.<br><br>


Les informations concernant les
corps célestes ont été mises à 
jour au mois de juin 2010.<br><br>Texte écran en anglais.</div>
  <div id="image02">
