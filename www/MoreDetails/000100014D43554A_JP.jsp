...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気のロールプレイングゲーム「英雄伝説」シリーズ第一弾のメガドライブ版です。「ファーレーン王国」を襲った悲劇から１０年。つかの間の平和を取り戻した世界の影で、王位継承者・セリオス王子に魔の手が迫ります。２Ｄフィールドでの移動とコマンド選択式の戦闘は、誰にでも快適に楽しむことができます。メガドライブ版は、オリジナルであるパソコン版のイメージを残した美しいＦＭ音源サウンドや、フル画面での移動・戦闘システムなどが特徴です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
