...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574E5650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Multiplayer tangram action!<br>
Try your hand at the newest addicting puzzle craze to come out of Japan!<br>
NEVES Plus provides simple, mind-bending tangram-based game play.<br>
You and up to three others can work together to move, rotate, and flip the seven Lucky stones into each of the 500+ silhouette puzzles. Or, you can challenge one another in any of the multiplayer modes such as Versus, Speed, Lucky Number, and Party Mode! <br>
Whether you play every mode by yourself or with friends, NEVES Plus is set to charm you with its deceptively harder-than-they-look silhouette puzzles. <br><br>
* 500+ Silhouette puzzles.<br>
* Five game modes.<br>
* Every mode can be played with up to 4 players.</div>
  <div id="image02">
