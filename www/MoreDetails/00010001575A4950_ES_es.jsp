...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001575A4950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rubik's Puzzle Galaxy: RUSH es un juego de rompecabezas 3D con más de 70 desafiantes niveles. Los jugadores deben guiar Cubos a puntos de salida de colores.<br>
<br>
Usando los controles intuitivos del mando de Wii, los jugadores arrean cubos de color con Transportadores, Tele-transportadores, Señales de Alto, Señales Direccionales y Divisores.<br>
<br>
RUSH además incluye el Cubo de Rubik original. Los jugadores intentan resolver alguno de los 4 tamaños diferentes de Cubos en solitario o contra otro jugador, o aprender a resolver el Cubo de Rubik clásico.<br>
<br>
RUSH:<br>
- Más de 70 niveles rompe-cerebros.<br>
- Esquema de control del mando de Wii hecho a la medida.<br>
- Transportadores, Tele-transportadores, Señales de Alto, Señales Direccionales, Divisores y más.<br>
- Ambientes estilizados.<br>
- El Cubo de Rubik clásico en 4 tamaños.<br>
- Tutorial de cómo resolver el Cubo de Rubik original.<br>
- Tablas de líderes online.
