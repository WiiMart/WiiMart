...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Link returns to Hyrule to search for the Triforce and to awaken Zelda from an endless sleep. Embark on a quest to find the Triforce of Courage and save Hyrule from ruin. Learn magic spells, talk to people in towns to get clues, collect items to increase your power, and explore six palaces where the underlings of the evil Ganon await you. This sequel to the Adventure classic uses a side-scrolling visual engine unique to the series for more technical combat, and features more in-depth world roaming as Link encounters townsfolk while on his quest.</div>
  <div id="image02">
