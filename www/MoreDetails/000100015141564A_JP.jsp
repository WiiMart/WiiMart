...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おなじみのボンバーマンが繰り広げる、落ち物パズルゲームです。３個一組で上から落ちてくるボンバーマンを同じ色でタテ・ヨコ・ナナメに３つ以上並べて消していき、
先に相手側のボンバーマンが最上段まで積み上がれば勝ちです。ボンバーマンを消すと爆弾がせり上がってくるので、どんどん消して爆弾を集め、火のついた赤爆弾が降ってきたら一気に爆破しましょう。相手にお邪魔な「コゲボン」を送りこんで妨害することができます。勝利の秘訣は連鎖消しのテクニックをマスターすること。連鎖消しをおこなうと「デカ爆」メーターが早くたまり、超強力な広域爆発でボンバーマンなどを大量に吹き飛ばすことができます。全１６ステージの１人専用「ＳＴＯＲＹモード」をはじめ、最高５人まで対戦できる「みんなでボバる！」、そして連鎖消しの修行モード「ボバる寺への道」の３つのモードが搭載されており、自由に選んでプレイが可能。「パニくる！」「ボバる！」を合言葉に、いつも以上に過激でにぎやかなボンバーワールドが楽しめます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ボンバーマン<sup>&reg;</sup> ぱにっくボンバー</span></div>
</div>
