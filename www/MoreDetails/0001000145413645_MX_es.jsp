...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">He aquí la tercera entrega de la saga de juegos de lucha “The King of Fighters”, publicada en 1996. 
...
<p>
Esta entrega presenta significativos cambios respecto a los títulos anteriores. Podrás encontrar saltos de diferentes alturas, escapes de emergencia atrás y adelante, además de la capacidad de defenderte en el aire. Es posible revisar los controles para hacer los movimientos más fáciles de ejecutar, y han sido reducidos los proyectiles, cuya idea como acercamiento efectivo ha sida eliminada de este título, lo que supone el mayor punto de inflexión de la serie.</div>
  <div id="image02">
