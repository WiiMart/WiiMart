...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La prima apparizione di Ninja JaJaMaru-kun (che significa "piccolo ninja determinato") risale al 1985, quando il gioco uscì in Giappone per il Famicom, la versione giapponese del NES.
<br><br>
In questo gioco di azione, vesti i panni di un ninja di nome JaJaMaru, che utilizza i suoi shuriken (stelle da lancio) per sconfiggere i mostri e liberare la Principessa Sakura dalle grinfie del malvagio Lord Namazu.
<br><br>
Nel corso della tua avventura, raccoglierai degli oggetti speciali (inclusa una rana gigante che potrai cavalcare!) che ti aiuteranno ad avanzare attraverso livelli popolati da tipici mostri e fantasmi giapponesi. Questo classico gioco di azione, disponibile per la prima volta al di fuori del territorio giapponese, è un'offerta esclusiva della Virtual Console.
<br><br>
Il testo all'interno del gioco è in inglese e parzialmente in giapponese.
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014641514C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641514C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ninja JaJaMaru-kun</span></div>
</div>
