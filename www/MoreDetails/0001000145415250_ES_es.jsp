...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En este juego de golf lanzado en 1996 puedes elegir uno de los seis jugadores disponibles para competir en diversos campos de golf alrededor del mundo, incluyendo Japón (Fujiyama Oriental Golf Club), Estados Unidos (Grand Canyon Golf Course), Austria (Blue Lagoon Golf Course) y Alemania (Baden Golf Course).<br><br> El juego presenta dos modos. En el primero, llamado ‘Stroke Play’, debes intentar obtener la mejor puntuación jugando los 18 hoyos completos. El segundo es el modo ‘Match Play’, donde dos jugadores compiten por rondas para ver quién gana más hoyos de un total de 18 (en este modo podrás enfrentarte a un amigo).
<br><br>
