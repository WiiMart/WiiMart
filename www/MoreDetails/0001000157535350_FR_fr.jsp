...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157535350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Avec Solitaire, jouez à 18 des variantes les plus populaires de ce jeu de cartes : Klondike, Freecell, Spider, Pyramid, Yukon, etc. Configurez la plupart des jeux de manière à suivre les règles auxquelles vous êtes habitués et apprenez à jouer à de nouvelles versions du Solitaire grâce aux indications données à l'écran.
<br><br>
Les joueurs souhaitant comparer leurs scores peuvent voir les statistiques. Il est également possible de sauvegarder son statut ou encore de personnaliser son jeu grâce aux nombreux fonds d'écran qui s'offrent à vous. Le style et l'interface du Solitaire ont été conçus pour interagir agréablement avec la télécommande Wii.
<br><br>
Installez-vous confortablement, détendez-vous et savourez les défis que vous propose cette collection de jeux de Solitaire.
<br><br>
