...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Alien Crush is a pinball game that features realistic pinball action and superb “biomechanical” graphics.  Complete with a function to nudge the machine, this game feels like you’re playing on a real pinball machine!  Extra balls and bonus points are your keys to getting high scores.  Pull off all kinds of tricks while enjoying intense pinball action!</div>
  <div id="image02">
