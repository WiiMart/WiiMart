...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157325450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ce party game permet de jouer à 4 joueurs simultanément. Les joueurs sont de nouveaux élèves officiers qui reçoivent des ordres du sergent instructeur et suivent un entraînement pour renforcer leur mental. 
<br><br>
Les règles sont simples mais la concentration et la vivacité d’esprit sont les clés pour jouer à ce jeu et devenir des machines à penser dures et sans états d’âme. Vous apprécierez encore plus ce jeu en jouant entre amis ou en famille.
