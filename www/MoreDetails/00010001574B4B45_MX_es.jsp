...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B4B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Basado en el popular juguete Pop-Up Pirate™, los jugadores se turnan para clavar espadas en un barril en el que está atrapado su Capitán e intentan ver quién puede poner más espadas en el barril. Clava una espada en el agujero equivocado y enviarás a volar a tu Capitán, lo que te hará perder el juego. Las características únicas de la consola Wii se suman a la diversión y contribuyen a este divertidísimo juego para reuniones. ¡Intenta cambiar al Capitán y colocar tu Mii™ personalizado dentro del barril para reírte de verdad!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B4B45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B4B45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Party Fun Pirate<sup>TM</sup></span></div>
</div>
