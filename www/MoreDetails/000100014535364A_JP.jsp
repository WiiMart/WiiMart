...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年に登場した、カプコンゲームの第５弾。多彩なキャラクターが登場する縦画面シューティングゲームです。大量に出現する敵キャラクターからの激しい攻撃をかいくぐり、ＥＸＥＳ軍の秘密兵器「ＥＸＥＤ ＥＸＥＳ」を破壊しましょう。隠しアイテムやボーナスステージを駆使して、
さらなるハイスコアを狙うのも、このゲームの醍醐味のひとつです。<BR><BR>詳細は、<Center>http://www.capcom-onlinegames.jp/category/wii.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エグゼドエグゼス</span></div>
</div>
