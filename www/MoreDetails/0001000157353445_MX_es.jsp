...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157353445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Diviértete con tu familia y compite en los distintos modos de juego! 5 Spots Party es un juego de habilidad apto para todas las edades, basado en el famoso juego de buscar las 5 diferencias. El  objetivo del juego consiste en encontrar el máximo número de diferencias en las imágenes que se te presentan. En los modos party deberás competir con otros jugadores y descubrir el máximo número de errores. En el modo para 1 Jugador, deberás encontrar las diferencias antes de que el tiempo termine para poder superar los récords del juego. ¿Qué tan lejos crees que puedes llegar?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157353445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157353445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
