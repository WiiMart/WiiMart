...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158494A45')", "wiiSelectSound()");
...
<p>
In the year 2112 the masses are fascinated by extreme high speed races. The latest antigrav racing technology introduced phase shifting. Perfect phase matching of track and racing machine is the key to stay alive.
<p>
Prepare yourself for a whole new racing experience at breakneck speeds. Push your skills to the limit to win races and beat records. Challenge your friends to an all-out split-screen competition. Compete against ruthless opponents and race to the top of all leagues. Warm up your engines, the future is now...
<p>
