...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気ステルスアクションゲーム「メタルギア」シリーズの第一弾。特殊部隊ＦＯＸＦＯＵＮＤの新入隊員「ソリッド・スネーク」に下された初の任務は、軍事国家「アウターヘブン」に潜入し、捕虜となった「グレイ・フォックス」を救出、彼から情報を聞き出し最終兵器「メタルギア」を破壊することです。「不必要な戦闘を回避し、敵に発見されないよう隠れながら進む」というシステムが、当時のアクションゲームとして非常に斬新で話題となりました<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルギア</span></div>
</div>
