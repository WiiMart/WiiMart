...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B544A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">なつかしの名作アクションシューティングゲーム「魂斗羅」がWiiウェアに登場！伝説の兵士”魂斗羅”のビル上等兵を操作して進むアクションシューティングゲームで、二人同時プレイが可能であることや高い難易度も特徴です。<BR>過去何度もシリーズ作が発売され未だに根強い人気を誇り、熱狂的なファンから支持を受けています。<BR>特徴的な複数の武器を使い分けて、敵を倒していきましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B544A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">魂斗羅 ReBirth</span></div>
</div>
