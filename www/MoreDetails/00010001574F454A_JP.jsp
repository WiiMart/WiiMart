...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F454A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ヒントの数字を元にマスを塗って絵を完成させていくパズルゲームです。雑誌「お絵かきロジック」の世界文化社から提供された本格的な問題を、Ｇモード独自のシステム「イージーフォーカスシステム」「オートカウンタ」を使って気軽に楽しむことができます。すべての問題を解いた後も、追加コンテンツを購入することで、新たな問題にチャレンジが可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F454A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F454A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">お絵かきロジック</span></div>
</div>
