...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C4D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Estás preparado para sobrevivir a todo tipo de trampas y descubrir todos los secretos de LA-MULANA?
<br><br>
LA-MULANA es el juego más completo de acción y exploración arqueológica jamás creado. 
<br><br>
¡Toma el control del Profesor Lemeza y su inseparable látigo para descubrir los misterios de la humanidad!
Enfréntate a todo tipo de trampas, enemigos y guardianes en la mayor aventura creada para WiiWare.
<br><br>
En LA-MULANA explorarás extensos templos y lo más importante: tendrás sensación de una total inmersión.  
...
- Cientos de puzles y secretos que deberás descubrir. <br>
