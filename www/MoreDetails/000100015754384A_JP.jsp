...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015754384A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">新感覚“攻める”ブロック崩しです。<BR>ボールを下に落とさない様に慎重に守り抜く、ブロック崩しはそういうものだと思っていませんか？<BR>このゲームはちがいます。制限時間内ならいつでも、どこでも、３６０°好きな方向にボールを弾くことができます。<BR><BR>ボールの動きは一定時間経過で遅くなり、反射神経ゲームが苦手な方でも狙って弾いて壊しまくることができます。<BR>ミスを気にせず、ブロックを壊す爽快感を存分にお楽しみください。<BR><BR>ブロックも新感覚の“動く”ブロックです。<BR>硬さの違う3種類のブロック、画面上の全てのブロックを破壊するスペシャルブロック、バリアと対になった解除ブロックなどが様々なフォーメーションで動き回ります。<BR><BR>ゲームを進めると、特殊能力を持ったボールが手に入ります。<BR>画面上のブロックを一瞬で破壊する「しんくうは」、ちいさなボールを放出して次々ブロックを破壊する「ぶんしん」、そして壊せるブロックなら全てつらぬく「かんつう」。ブロックの動きを見極めて、ここぞというところで発動し、高得点を狙いましょう。<BR><BR>全15ステージとミニゲームのスコアはWi-Fiランキング対応で、スコアを全国のユーザーと競えます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015754384A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015754384A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">はじいて！ブロックラッシュ</span></div>
</div>
