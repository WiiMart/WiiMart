...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ドラゴン族の王子「パコ」を操作して「マーベルランド」と呼ばれる遊園地を進み、地底族の王「モウル」にさらわれた４人の守護精を助け出すべく冒険を繰り広げる、横スクロール型アクションゲームです。宝箱やごみ箱の中に入っているアイテムを取るとパコをパワーアップさせることができます。４つあるワールドの最後にはボスが待ち構えていてパコとミニゲームで勝負します。ボス戦をクリアしたあとにはボーナスステージで高得点をめざしてください。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マーベルランド<sup>&reg;</sup></span></div>
</div>
