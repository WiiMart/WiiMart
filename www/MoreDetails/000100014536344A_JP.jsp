...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スパイ映画風アクションシューティングゲーム「ローリングサンダー」の続編です。プレイヤーは、ＷＣＰＯ特殊工作部隊「ローリングサンダー」の工作員「レイラ」と「アルバトロス」となって、拳銃と華麗なスパイアクションを駆使し、復活した悪の秘密組織「ネオゲルドラ」の野望を打ち砕いてください。「ネオゲルドラ」の本部まで、全部で８ステージです。「ＢＵＬＬＥＴ」と書かれた看板の部屋で拳銃の弾数を補充したり、「ＡＲＭＳ」と書かれた部屋でマシンガンを入手すると連射も可能になります。前作で捕らわれていたレイラをプレイヤーとして選べるようになり、２人同時プレイも可能になりました。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ローリングサンダー2<sup>&reg;</sup></span></div>
</div>
