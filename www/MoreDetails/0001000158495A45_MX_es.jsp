...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495A45')", "wiiSelectSound()");
...
<p>
3D Pixel Racing es un juego de carreras que recuerda los clásicos de la historia de los videojuegos.
<p>
Están disponibles varios modos de juego, desde las clásicas mono carreras hasta las excitantes carreras de persecución. El juego cuenta con 10 pistas, 11 coches, 10 pilotos: completa varios desafíos para desbloquear los contenidos ocultos. ¡Disfruta del modo multijugador con pantalla compartida donde pueden jugar hasta 4 amigos al mismo tiempo! Modos de Juego: Mono carrera, Campeonato, Captura la bandera, Persecución, Prueba a tiempo.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495A45/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495A45/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
