...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Points guardados y contenido descargable, como títulos de WiiWare o Virtual Console, desde una consola Wii a esta consola Wii U. Para transferir los datos desde tu consola Wii, necesitarás una tarjeta SD o una tarjeta SDHC con al menos 512 MB de memoria libre. 
<br><br>
Los datos que se transfieran a la consola Wii U serán borrados de la consola Wii de origen y no podrán transferirse de vuelta.
<br><br>
También debes saber que no es posible transferir algunos programas. Solo podrás jugar los programas que no se puedan transferir en la consola Wii de origen.
<br><br>
Los Wii Points solo se pueden canjear en el Canal Tienda Wii. 
<br><br>
Para preparar la transferencia de datos, abre el menú de Wii en la consola Wii U para empezar el modo Wii y después abre la aplicación Transferencia de datos de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435345/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435345/FFFD000A" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
