...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157424B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ARKANOID Plus! est la toute nouvelle version du célèbre jeu d’arcade. Vous devrez une nouvelle fois détruire des briques de couleur à l’aide de votre vaisseau VAUS !<br><br> Découvrez de nouveaux modes et paramètres qui changeront radicalement votre expérience de jeu. Vous pourrez ainsi parcourir les 61 rounds du mode « Arcade » et vaincre deux types de boss suivant le chemin que vous aurez choisi, affronter des amis ou vous mesurer à la console grâce au mode<br> « Match », et tenter de terminer plusieurs rounds en un temps limité avec le mode « Contre-la-montre ». Décidez de suivre la règle « barrière » ou « vies », collectez une multitude d’objets, et embarquez pour des heures de fun !<br><br>Texte écran en français.</div>
  <div id="image02">
