...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158483450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit is een demoversie. Mogelijk bevat deze versie niet alle functies uit de volledige versie.<br>
In deze demoversie van het spel kun je je voortgang niet opslaan.
<br><br>
Heb je ooit gedroomd dat je tekeningen echt waren? In dit spel zijn ze dat ook!
<br><br>
Op een dag ontvangt Max een mysterieuze marker per post. Zich van geen kwaad bewust, tekent hij een gek paars monster. Zodra hij echter de marker van het papier haalt, komt het monster tot leven en springt het van de ene tekening naar een andere tekening. Nu het monster ontsnapt is en Max’s tekeningen verknoeit, heeft Max geen andere keuze dan het monster te achtervolgen.
<br><br>
Gewapend met de fantastische Magic Marker, moet jij het monster door vijftien inventieve en uitdagende levels achtervolgen. Je zult echter over meer dan alleen inzet en een goed reactievermogen moeten beschikken om alle uitdagingen te overwinnen. Met de magic marker kun je naar hartelust binnen het spel tekenen om Max te helpen bij het verslaan van vijanden, het overwinnen van obstakels en het oplossen van puzzels. Als je trappen, wip-waps, ballonnen, surfboards en alle andere voorwerpen die je maar kunt bedenken tekent, voeren jouw creaties interacties uit met de omgeving, waardoor elke creatie uniek wordt en geen enkel spel hetzelfde zal zijn.
<br><br>
Speel het spel in je eentje of met twee spelers, waarbij één speler Max bestuurt en de andere de Magic Marker.</div>
  <div id="image02">
