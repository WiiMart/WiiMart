...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157414C4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">暗闇に浮かぶ立体的なコース。<BR>そのコースに走る一筋のラインをコントロールし、並走する他のラインよりも先にゴールインをめざすレースゲーム。それが<BR>『Ｌｉｇｈｔｓｔｒｅａｍ』（ライトストリーム）です。<BR><BR>コース上の複数のレーン（＝ラインが通る事ができる道）をＷｉｉリモコンの十字ボタンで他のラインに衝突しないように移動しながら、トップをめざします。<BR><BR>他のラインとレースをおこない、順位を競う「ｃａｍｐａｉｇｎ」モードと、制限時間内に目的地をめざす「ｆｒｅｅｗａｙ」モードがあり、ゲームを進めることで、さらに新たなモードが出現します。<BR><BR>交差するラインによって描き出される色鮮やかな軌跡と、リズミカルなサウンドが織りなすハイスピード空間。<BR>Ａｒｔ　Ｓｔｙｌｅ<BR> <div align="right">『Ｌｉｇｈｔｓｔｒｅａｍ』。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414C4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414C4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Ｌｉｇｈｔｓｔｒｅａｍ<sup>TM</sup></span></div>
  </div>
