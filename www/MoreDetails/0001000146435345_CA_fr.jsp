...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In this action-packed sequel to the popular Contra, players have little time to think. Experience run-and-gun game play at its best as you take control of Mad Dog or Scorpion and once again battle the forces of Red Falcon. Stages feature a combination of perspectives (side scrolling, top down, etc.) and intense battles against huge bosses. Utilize a variety of powerful weapons and tap in to your killer instinct to survive the deadly waves of enemies. And if you’re scared, recruit a friend to help you. Because if your trigger finger lacks stamina, then Earth will lack a future!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146435345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146435345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super C<sup>TM</sup></span></div>
</div>
