...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Use this application to transfer save data, stored Wii Points, and downloadable software such as WiiWare and Wii Virtual Console titles from your Wii to this Wii U. In order to move the data from your Wii, you will need an SD Card or SDHC Card with over 512 MB of available memory.<br>
Please note that some software cannot be moved.  Software that cannot be moved can be played only on the source Wii console.
<br><br>
Data moved to the Wii U console will be erased from the source Wii console and cannot be restored.
<br><br>
Wii Points are redeemable only within Wii Shop Channel. The source Wii must download the Wii U Transfer Tool application from the Wii Shop Channel.
<br><br>
To begin the data transfer, start Wii mode on the Wii U console by opening the Wii Menu and then open the Wii System Transfer application.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
