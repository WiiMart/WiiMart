...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Join Donkey Kong Jr. for a maths lesson with a difference! In this educational NES game, swing and jump around the stage, collecting numbers and symbols to calculate the correct figure displayed by Donkey Kong.
<br><br>
Put your mathematical skills to the test in single-player mode or challenge a friend to a two-player maths race. You can even pester your opponent by grabbing numbers before they do!
