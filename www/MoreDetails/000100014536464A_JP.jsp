...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機「ギャラクシップ」を左右に操り、編隊を組んで襲いかかってくるエイリアンをコスミックミサイルで撃破していくシューティングゲームです。エイリアンは、画面上方で編隊を組んで待機し、１発ずつミサイルを撃ちながら降下していきます。降下してきたエイリアンを撃墜し損なった時は、画面上方から再度あらわれます。すべてのエイリアンを撃墜できれば１ラウンドクリア。また、エイリアンは待機時と飛行時とで得点が異なり、飛行中に撃墜する方が得点が高いので、いかに高得点をねらうかがポイントです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ギャラクシアン<sup>&reg;</sup></span></div>
</div>
