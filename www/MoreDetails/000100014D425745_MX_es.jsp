...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego de uno o múltiples jugadores expande la experiencia de juego de los dos títulos originales de Columns, ofreciéndole a los participantes algunos ataques adicionales para enfrentar a sus adversarios durante la partida. Como en el Columns original, las joyas caen en un recipiente y tú tienes que girarlas y manipularlas para formar grupos de tres o más joyas en una línea vertical, horizontal o diagonal para evitar que se acumulen y lleguen a la parte superior de la pantalla. En Columns III puedes encontrar joyas mágicas especiales que harán cosas como aumentar la barra de compresión del adversario o reducir la tuya, añadiendo un elemento estratégico adicional a la partida. Éste es un juego genial para jugar con amigos, ¡así que descárgalo hoy y entra en acción!
<p>
Para luchar con múltiples jugadores, tienes que conectar la misma cantidad mandos de Wii o Controles de Nintendo GameCube que la cantidad de jugadores. Para jugar con cinco jugadores, necesitarás al menos un Control de Nintendo GameCube.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D425745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D425745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Columns III<sup>TM</sup></span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Revenge of Columns</span></div>
  </div>
