...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En Zombies Ate My Neighbors podrás encarnar a dos valientes jóvenes: Zeke y Julie. Ambos tienen las mismas características y controles. Si juegan dos jugadores, cada uno podrá elegir a un personaje, pero no podrán escoger al mismo personaje. Cada jugador empieza el juego con tres vidas. Perderás una vida cuando se agote tu barra de salud. Hay dos maneras de obtener vidas extra: Encontrando las vidas extra que se encuentran ocultas en los diferentes niveles o por medio de puntos que ganarás cada vez que rescates una víctima. Prepara tu pistola de agua para la aventura que te espera en 48 niveles plagados de hormigas gigantes, científicos locos, y bebés gigantes, además de siete niveles extra (pon atención a los signos de interrogación).</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A413645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A413645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Zombies Ate My Neighbors<sup>TM</sup></span></div>
</div>
