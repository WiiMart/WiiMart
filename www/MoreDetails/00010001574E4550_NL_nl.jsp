...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574E4550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jij kunt de koning van het vissen worden! De pinguïns zijn uitgehongerd en hebben je hulp nodig om eten te vinden. Vang alle vis voordat iemand anders dit doet! 
Strategie is vitaal in deze spannende game. Blijf de andere pinguïns voor zodat je niet vast komt te zitten en baan je een weg naar de ijsstromen die grote hoeveelheden vis bevatten. ‘Penguins & Friends’ kan door maar liefst 4 personen tegelijk worden gespeeld, op voorwaarde dat zij bestand zijn tegen het koude poolklimaat.
<br><br>
Hoe er moet worden gespeeld:<br>
Het spelbord is opgebouwd uit ijsblokken, onder elke blok ijs zit een bepaald aantal vissen (1, 2 of 3). De ijsblokken zijn zeshoekig en vormen samen een bijenkorfachtige structuur. De positie van deze ijsblokken kan veranderen naarmate het spel vordert, waardoor ook het spelbord verandert. 
Elke speler heeft een bepaald aantal pinguïns (afhankelijk van het aantal spelers dat deelneemt aan het spel en de grootte van het spelbord) die fungeren als pionnen.<br><br>Het spel is voorzien van Engelse, Franse, Duitse, Spaanse of Italiaanse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E4550/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E4550/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Penguins &amp; Friends</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Hey! That’s my Fish!</span></div>
  </div>
