...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">セガ・マークⅢで発売された、２人のゲリラ戦士が活躍するアクションシューティングゲームです。戦闘に長けた２人の兵士「阿修羅」と「毘沙門」を操作して、四方から攻撃してくる敵を倒しながら、ジャングルの奥深くにとらわれた捕虜たちの救出へと向かいます。バズーカ兵、スナイパー、火炎放射兵など多数の兵隊や戦車を有した敵軍は、密林地帯や田園など各所に要塞を築いて待ち構えています。２人の武器は強力な弾丸を発射するＭ－６０と、弓をひいて攻撃する必殺のボンバーアロー。途中で助けた捕虜からパワーアップアイテムを獲得しながら、難攻不落の最終要塞をめざしてください。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C41464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C41464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">阿修羅<sup>TM</sup></span></div>
</div>
