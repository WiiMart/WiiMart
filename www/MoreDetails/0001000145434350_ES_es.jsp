...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego es una versión mejorada de Metal Slug 2. Mantiene el mismo sistema de juego que Metal Slug 2, añadiendo además nuevas e increíbles armas como el “Lagarto de Hierro”, que persigue a los enemigos, y el “Tiro Rebote”, cuyos disparos rebotan en el suelo. Además de esto, aumenta la cantidad de nuevos enemigos, y la dificultad del juego puede adaptarse al nivel del jugador cambiando, entre otras cosas, la posición de los jefes. Incluye también nuevos fondos de pantalla y nuevas músicas. Una experiencia de juego única e inolvidable. Los fans de Metal Slug podrán hacer sorprendentes descubrimientos comparando con buen ojo ambas entregas.
