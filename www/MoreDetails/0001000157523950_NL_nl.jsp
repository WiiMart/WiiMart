...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157523950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fans van Mega Man hoeven niet langer meer te wachten! De klassieke Blue Bomber die in 1987 voor het eerst te zien was, is nu terug met de 9e game in deze klassieke serie. Het is tijd voor een nieuw avontuur voor Mega Man met graphics, muziek en gameplay in de oude vertrouwde 8-bit-stijl!
<br><br>
Het spel is voorzien van Engelse schermteksten.<br></div>
  <div id="image02">
    <img src="/oss/ccs/0001000157523950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157523950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mega Man<sup>TM</sup> 9</span></div>
</div>
