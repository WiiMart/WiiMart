...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">祖母の七回忌で田舎に集まった親戚同士で語られる恐怖体験が展開するサウンドノベル形式のアドベンチャーゲーム。「七回忌で恐い話しをすると死者が蘇るっていうよな」何気ないこの一言から、暗く長い夜が静かに更けてゆきます･･･
あなたは複数の語り手から恐い話を聞き、それを追体験していきます。
誰から恐い話を聞くのか、さらには恐い話を追体験する中でのあなたの選択により、複雑に絡み合った結末が変化していきます。また、おぞましくリアルな実写やＢＧＭ・音声は、あなたの恐怖を増幅させることでしょう。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A454A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A454A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">晦－つきこもり</span></div>
</div>
