...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157575245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prepárate para enfrentarte al peligro de las rampas, obstáculos inusitados y a otros corredores en la más reciente entrega de la reconocida franquicia Excitebike, disponible exclusivamente en el servicio WiiWare. Elige entre varios ángulos de cámara mientras aterrizas exitosamente usando los nuevos controles sensibles al movimiento y compite en carreras alrededor del mundo en cuatro circuitos de campeonato. Mejor aún, usa la Conexión Wi-Fi de Nintendo para invitar a amigos a participar en carreras, o si te sientes osado, enfréntate a cualquiera que busque un enfrentamiento. ¿Quieres crearte tu propio desafío? Usa el intuitivo editor de circuitos para elegir entre los obstáculos disponibles y arma tu circuito ideal, después comparte tu obra maestra con amigos (y vice versa) para ver quién es el mejor creador de circuitos en esta versión nueva de un clásico. Después de todo, recuerda que una vez que has aprendido a andar en moto, jamás lo olvidarás...</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157575245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157575245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Excitebike<sup>TM</sup>: World Rally</span></div>
</div>
