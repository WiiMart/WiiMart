...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158495450')", "wiiSelectSound()");
...
<br><br>When it comes to fast draw there’re only two types of people: the quick...and the dead! Now you have the chance to find out where you stand, or lie, as the case may be. You’ll go up against the best quick draws in the business, including one of the world’s fastest, Wes Flowers.
<br><br>
...
<br><br>
You’ll need some serious speed and awesome accuracy to take on these gunslingers...so get ready for some real fast draw action!</div>
  <div id="image02">
