...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The legendary sci-fi shooter is back! Gate of Thunder is a horizontal side-scrolling shooter that places you in control of special undercover agent Hawk, whose mission is to stop the deadly army of Obbellon fighters. Jump into the action as Hawk boards his ship, the Hunting Dog, and heads out towards the enemy.
<br><br>
Use all 3 of the weapons at your disposal effectively to blast through stages while receiving support from ally Wild Cat ships. Switch through equippable power-up “Options” on the fly to change the direction of your attack. You’ll have to blast in front and behind you to make it through all 7 stages. Hardcore shooting game fans looking for a challenge can select HARD or DEVIL mode to make the action even more intense!</div>
  <div id="image02">
