...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ブロック（石）を作ったり消したりする「換石の術」とファイヤーを出す「火球の術」を駆使しながら、立ちはだかる敵を倒して、扉を開けるためのカギを手に入れて出口に向かう、面クリア型アクションパズルゲームの名作。難解なパズルは全部で５０ステージです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソロモンの鍵<sup>&reg;</sup></span></div>
</div>
