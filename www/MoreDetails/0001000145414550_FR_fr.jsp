...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ce jeu de combat ultra-violent et rapide, se déroulant à l’ère des samouraïs, est devenu l’un des jeux de son époque dont on a le plus parlé depuis sa sortie en 1993. Douze sabreurs, venant du monde entier et possédant chacun leurs propres caractéristiques, se battent avec acharnement afin d’affronter le maléfique Amakusa Shiro Tokisada.
<br><br>
La jauge de colère qui augmente à mesure que vous prenez des coups est sans doute la fonctionnalité la plus originale du jeu. Une fois la jauge pleine, votre puissance d'attaque augmente, vous permettant d’assouvir votre vengeance sur votre adversaire!
<br><br>
Avec sa musique japonaise d'époque, ses personnages et ses arrière-plans détaillés ainsi qu’une large gamme de coups à maîtriser, Samurai Showdown est un jeu faisant date dans l’histoire des jeux de combat.
<br><br>
Texte écran en anglais.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SAMURAI SHODOWN<sup>TM</sup></span></div>
</div>
