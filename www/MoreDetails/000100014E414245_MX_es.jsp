...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dale a lo todo lo que da el pedal con el digno sucesor del clásico juego de Super NES, Super Mario Kart. Mario Kart 64 presenta nuevas y espectaculares gráficas, una tonelada de nuevos y únicos power-ups, y una impresionante versión del modo legendario de Batalla. Con pistas mejoradas y con un revolucionario modo de cuatro jugadores, Mario Kart 64 garantiza ganarse el corazón de los amantes a las carreras. El juego incluye 20 pistas diferentes, llenas de bajadas y subidas, valles, rampas, túneles y puentes. ¡Controles precisos y suaves -- que son características de todos los juegos del creador de Mario, Shigeru Miyamoto -- te harán regresar una y otra vez a esta aventura en ruedas!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
