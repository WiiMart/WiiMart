...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Una fiel adaptación de la versión arcade de “STREET FIGHTER”, el legendario juego de lucha con el que comenzó todo. Los jugadores controlan a RYU o a KEN y se enfrentan a singulares luchadores provenientes de todo el mundo. El primer luchador en eliminar a su rival y ganar dos rondas será el ganador. Potencia tu ataque hasta 3 niveles distintos—cuanto más tiempo mantengas pulsado el botón, mayor fuerza tendrá tu ataque. ¡Introduce comandos para realizar ataques especiales e infligir más daño a tu rival! ¡Combina eficazmente tus ataques normales y especiales y ábrete paso a puñetazos hasta la victoria!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000151424245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151424245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fighting Street<sup>&reg;</sup></span></div>
</div>
