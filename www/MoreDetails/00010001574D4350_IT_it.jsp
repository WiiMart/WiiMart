...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574D4350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il pianeta Monsteca non è più il mondo armonioso che era una volta: ora, infatti, è stato invaso da un esercito di robot che hanno lo scopo di comandare e conquistare. I nativi di Monsteca, gli Stompy, non hanno altra scelta se non scappare o essere catturati. Incapaci di difendersi da questi robot, gli Stompy devono fare affidamento sulla forza del branco per collaborare e riuscire a sconfiggerli.<br><br>
Prendi il controllo degli Stompy, mostri carini, anche se non particolarmente brillanti, i quali, una volta svegliatisi, hanno bisogno di aiuto per evitare di essere catturati dai robot che li stanno invadendo. È tuo dovere guidarli attraverso ciascun livello. <br><ul>
<li>Un divertente gioco di strategia in 3D, rapido e intellettualmente stimolante.</li>
<li>Colonna sonora interattiva.</li>
<li>Venti livelli da conquistare con ore di gioco.</li></ul><br>
