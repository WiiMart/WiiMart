...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Solomon's Key ist ein Action-Puzzlespiel, bei dem du den Zauberer Dana kontrollierst und in ein Labyrinth eintauchst, um nach einem magischen Buchband mit dem Namen Solomon's Key zu suchen, der dir bei deiner Aufgabe behilflich sein wird, die auf die Welt losgelassenen bösen Geister zu vertreiben.
<br><br>
Ziel des Spiels ist, mithilfe der Knöpfe Blöcke entstehen oder verschwinden zu lassen und verschiedene Techniken einzusetzen, um Schlüssel zu finden, mit denen du die Türen passieren kannst. Einstellungen, wie z. B. Anzahl der Leben und Schwierigkeitsgrad, können geändert werden.
<br><br>
Das Spiel ist bereits auf einer Vielzahl von Plattformen erschienen, aber die Arcade-Version zielt besonders auf die Action-Elemente des Spiels ab, was es umso faszinierender macht und Spielern aller Geschicklichkeitsstufen, vom Anfänger bis zum Meister, eine Herausforderung bietet.
<br><br>
Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145364E50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145364E50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Solomon's Key<sup>TM</sup></span></div>
</div>
