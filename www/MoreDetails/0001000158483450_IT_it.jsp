...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158483450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questa è una versione demo e potrebbe non contenere tutte le funzioni presenti nella versione completa.<br> 
Attenzione: non è possibile salvare i progressi di gioco nella versione demo.
<br><br>
Hai mai desiderato che i tuoi disegni diventassero realtà? In questo gioco il tuo desiderio si può avverare!
<br><br>
Un giorno Max trova nella cassetta della posta un misterioso Pennarello. Non sapendo bene di cosa si tratta, la prima cosa che disegna è un bizzarro mostro viola. Ma non appena il Pennarello si alza dalla carta, il mostro prende vita e balza fuori dal foglio, finendo in un altro disegno. Con il mostro a piede libero che si da un gran da fare con i disegni di Max, Max non può fare altro che inseguirlo.
<br><br>
Con l’aiuto di un’arma straordinaria, il Pennarello magico, dovrai seguire il mostro attraverso quindici fantasiosi ed entusiasmanti livelli. Tuttavia avrai bisogno di qualcos'altro, oltre a buona volontà e riflessi pronti, per affrontare le sfide che ti attendono. Con il Pennarello magico potrai disegnare a tuo piacimento dentro al gioco per aiutare Max a sconfiggere i nemici, superare gli ostacoli e risolvere i rompicapi. Mentre disegnerai scale, altalene, mongolfiere, tavole da surf e qualsiasi cosa tu riesca a immaginare, le tue creazioni interagiranno con l’ambiente fisico. Pertanto, ogni creazione sarà unica e ogni partita diversa dall’altra.
<br><br>
Gioca in modalità singola o doppia, con un giocatore che controlla Max e l’altro il Pennarello magico.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483450/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483450/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Max &amp; the Magic Marker</span></div>
</div>
