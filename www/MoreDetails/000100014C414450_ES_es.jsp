...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Phantasy Star es un juego pionero en el género del rol que apareció originalmente en SEGA MASTER SYSTEM. 
<br><br>
Podrás volver a disfrutar de este clásico en el que juegas como Alis, la intrépida protagonista que desea vengar la muerte de su hermano a manos del cruel dictador King Lassic.
Lleva a Alis y sus tropas a través de los ambientes repletos de construcciones del sistema solar Algol, en un intento de derrotar a King Lassic y liberar a los ciudadanos de Algol. 
<br><br>
Sumérgete en dinámicos combates por turnos con dragones, demonios, gigantes y magos empleando armas únicas como puñales brillantes, ballestas y, cómo no, ¡hechizos mágicos!
<br><br>
