...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La mecánica de juego de Bubble Bobble era totalmente innovadora cuando llegó a las salas recreativas como juego de puzles y acción en 1986. Los dos dragones, Bub y Bob, eran los protagonistas y derrotaban a los enemigos atrapándolos en pompas que luego rompían. 
<br><br>
Pese a que el juego solo tenía 100 niveles, contaba con características ocultas como el hecho de que no se podía ver el “auténtico final” del juego en el modo para un jugador. Además, tenía trucos que llevaban al jugador a niveles especiales y aparecían muchos objetos diferentes. Estos factores fueron una de las claves para que el juego se convirtiera en un éxito de ventas.
<br><br>
En cada nivel había corrientes de aire invisibles que cambiaban la trayectoria de las pompas de forma impredecible. Los jugadores se veían obligados a entender estas características mientras jugaban y esto contribuyó a que el juego fuera revolucionario en su día.
<br><br>
