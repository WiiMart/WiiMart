...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ecco de dolfijn is zijn vrienden kwijt! Verken de uitgestrekte oceaan en help hem ze terug te vinden. Vergeet niet af en toe naar de oppervlakte te gaan om lucht te happen en kijk goed uit voor vijanden, gedurende je ontdekkingstocht door de enorme dieptes van de onderwaterwereld. Ecco’s unieke sonarvaardigheid verschaft je nuttige informatie over de andere schepsels die je onder water vindt.<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans<br><br>Het spel is voorzien van Engelse schermteksten.<br>Geen ondersteuning van de interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ecco the Dolphin<sup>TM</sup></span></div>
</div>
