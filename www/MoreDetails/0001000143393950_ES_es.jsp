...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El sistema solar ha sido invadido!
<br><br>
Quince acorazados están acabando con los recursos minerales de los núcleos planetarios, cada uno buscando un metal diferente para usarlo como combustible en sus unidades interestelares.
<br><br>
Destruye las patrullas de ataque enemigas, neutraliza las defensas de superficie de los acorazados enemigos y aterriza en ellos para destruirlos y escapar a continuación.
<br><br>
Vuelve al pasado con este juego clásico, originalmente desarrollado para Commodore 64 por el pionero de los "shoot'em up" Andrew Braybrook, mientras viajas por el espacio a toda velocidad.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143393950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143393950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Uridium<sup>TM</sup></span></div>
</div>
