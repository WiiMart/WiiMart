...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">３人一組のチームを選択し他のチームと勝ち抜き戦をおこなう２Ｄ対戦格闘アクションゲームの第二弾。「餓狼伝説」「怒」「サイコソルジャー」「龍虎の拳」などの作品から、主役級キャラクターが３人一組のチームを組んで参戦し腕を競います。主人公「草薙京」のライバル「八神庵」の登場や、カウンター攻撃、チームエディットなど、前作に無かった要素が複数追加されました。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ・キング・オブ・ファイターズ '95</span></div>
</div>
