...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157465850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">We all long for a cosy open fire, particularly during the cold season, but not everyone is able to snuggle in front of a warming blaze. Your new WiiWare open fire will fill every room with a magical and cosy atmosphere!
<br><br>
Select from a variety of logs and use the Wii Remote to stack them up. Now, light the match and your home will soon be snug and glowing. There are 6 fireplaces available: fire alone, campfire and rustic, classic, elegant and Zen fireplaces.<br>
...
- Cosy, fireside sounds<br>
- Realistic physics simulation with PhysX® by NVIDIA Technology<br>
- 4 game functions: Butler (logs are placed on the fire automatically), Non-stop (logs never burn down), Standard (a ready-made fire in any fireplace), Individual (players select the logs and put them in the fireplace)</div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Cosy Fire</span></div>
</div>
