...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">幻想的な世界観と滑らかなスクロールが印象的な３Dシューティングゲーム「スペースハリアー」のデザインを一新したシリーズ３部作の最終章。未知の敵によって侵略を受けたファンタジーランドを舞台に、超能力戦士ハリアーの最後の戦いが始まります。ユニークなボスが登場する１２のステージはどこからでも遊ぶことができ、すべてのステージをクリアすると最終ステージが登場します。真の敵「ダークハリアー」とは一体何者！？<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スペースハリアーⅡ<sup>TM</sup></span></div>
</div>
