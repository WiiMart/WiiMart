...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324753')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Phoenix Wright ha vuelto! <br><br>

La tensión dramática de la sala del tribunal sube de temperatura con la fiscal del distrito, Franziska von Karma. Con nuevos personajes pintorescos, nuevas historias dramáticas y novedades en el juego, ¡la defensa nunca descansa! <br><br>

- ¡Cuatro nuevos casos impactantes! <br>
- Nueva función de “Psicocandados”: ¡utiliza el interrogatorio para revelar declaraciones ocultas! <br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324753/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324753/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
