...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gerade als Mega Man X dachte, er hätte alle Kampfroboter in seinem vorherigen Abenteuer besiegt, muss er schon gegen eine neue Bedrohung in den Kampf ziehen: eine Gruppe von Reploid-Kampfroboter-Rebellen namens X-Jäger und acht neue, noch gefährlichere Kampfroboter!
<br><br>
Glücklicherweise hat Dr. Light X mit modernsten Aufrüstungen ausgestattet. Spüre die Kapseln auf, um X mit einem Doppel-Aufladeschuss, einer Panzerrüstung und anderen Power-Ups auszurüsten. Außerdem kann X sich hinter das Steuer von Maschinen wie der mobilen Angriffsrüstung und dem mobilen Angriffsgleiter setzen. Und natürlich kann er die Spezialwaffen besiegter Kampfroboter verwenden, um die Gegner mit ihren eigenen Waffen zu schlagen!<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A454850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A454850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mega Man X2<sup>TM</sup></span></div>
</div>
