...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157425650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SPOGS Racing, le tout nouveau jeu de course signé D2C Games débarque sur les chapeaux de roue ! Véritable ovni, ce bolide vidéoludique vous fera découvrir des courses arcades classiques, des commandes intuitives, des véhicules de compétition comme vous n'en avez jamais vus et le système d'améliorations instantanées du mode Crash N' Grab. Faites chauffer votre moteur, brûlez de la gomme et modifiez votre bolide à la volée tout en affrontant vos adversaires lors de courses endiablées qui vous feront vivre une expérience inoubliable sur votre console Wii. Que vous soyez un joueur occasionnel ou un hardcore gamer, SPOGS Racing est le jeu indispensable à télécharger pour votre bibliothèque numérique de jeux WiiWare.
<br><br>
Le texte à l'écran sera en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157425650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157425650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SPOGS Racing<sup>TM</sup></span></div>
</div>
