...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">逃走する犯人車両を追いかけ逮捕するカーアクションゲーム『チェイスＨ．Ｑ．』の続編。プレイヤーは特殊捜査チームの刑事となって覆面パトカーに乗り込み、犯人逮捕に向かいます。本部のナンシーから無線で逃走中の犯人の情報を受け取ったらゲームスタート。ターボをうまく使って、コース上の一般車や障害物を避けながら、はるか前方を走る犯人車両を追跡します。犯人車両を発見したら、犯人の車にダメージを与えて停止させてください。今作では体当たりのほか、ハンドガンや支援ヘリが落とすバズーカなどでも攻撃ができます。華麗なドライビングテクニックと正確な射撃で、制限時間内に犯人逮捕を成功させてください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015044454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015044454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｓ．Ｃ．Ｉ．</span></div>
</div>
