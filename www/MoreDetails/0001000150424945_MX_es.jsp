...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El terco héroe ha regresado por más acción vertical al tercer episodio de las populares series de Bonk. Otra vez dependerá de Bonk el destruir los planes del malvado e implacable King Drool. Hay 7 Rondas a lo largo de “El Reino de los Dinosaurios”, cada una repleta de entretenidos trastos y cómicos enemigos. Consigue un Flower Copter (Helicóptero Flor) o cambia 16 Smileys al final de cada Ronda para jugar hasta ocho fases de bonificación distintas. Puedes cambiar el tamaño de Bonk con los nuevos caramelos rojos o azules. Dependiendo de la situación, puedes cambiar tu tamaño para abrirte paso a través de un callejón sin salida o para obtener objetos inalcanzables. ¡Y eso no es todo! ¡Consíguete a un amigo y unan sus mentes para derrotar al King Drool en el nuevo modo de 2-jugadores!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
