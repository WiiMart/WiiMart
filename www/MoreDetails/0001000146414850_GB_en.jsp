...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Don't be fooled by the simple and charming graphics; Tennis is one of the most technical games on the NES! Although the commands are not too complex, only those who master their backhands, serves and volleys will win the final tournament. A friend can also join for hectic doubles against the computer. Those who are familiar with Nintendo will notice that a famous character makes a guest appearance in the umpire's chair. He performed in a similar profession in a few other Nintendo sports games; can you name them all?</div>
  <div id="image02">
