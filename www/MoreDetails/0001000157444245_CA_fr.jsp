...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157444245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Derby Dogs is a dog raising/breeding/competing sim that lets the player raise dogs by feeding them and training them in a variety of exercises that help raise particular stats of the dog being trained. You can also frequent the dog shop to rent dogs or buy new dog houses or meals for your dogs. Your dogs can compete in races on a myriad of courses to achieve titles and prize money, and you can breed your dogs to create even better dogs.
<p>
Can you become the best handler around and raise a dog that can triumph over all the competition?</div>
  <div id="image02">
