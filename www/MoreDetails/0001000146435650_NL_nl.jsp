...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In de NES-klassieker Wrecking Crew verwisselt Mario zijn loodgieterspet voor een helm om in de rol te stappen van een slopende bouwvakker!
<br><br>
Het is jouw doel om alle obstakels in elk door vijanden overspoeld level te slopen, terwijl je de meest verwoestende weg door een netwerk van ladders en steigers neemt.
<br><br>
Wrecking Crew was onderdeel van de 'Programmable Series' van de NES, dus is er ook een stand waarin je je eigen levels kunt ontwerpen. Daarnaast geeft deze versie voor de Virtual Console je de mogelijkheid om je ontwerpen op te slaan, wat niet mogelijk was in het originele spel.
