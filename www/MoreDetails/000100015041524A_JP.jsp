...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">かわいらしい世界観で人気の「ツインビー」シリーズの５作目にあたる、縦スクロールシューティングゲームです。邪悪な異星人「イーバ」に侵略されつつある「惑星メル」からのＳＯＳを受け取った「ツインビー」と「ウインビー」が、惑星を救うために飛び立ちます。コミカルな敵キャラが行く手を阻む全６ステージを、１人プレイではツインビー、２人協力プレイではツインビーとウインビーを操作して戦います。空中の敵はショット、地上の敵にはボムで攻撃。ほかにも威力抜群の「ビッグショット」や協力プレイならではの「ツイン攻撃」「ガッチンコ攻撃」など、バラエティに富んだ攻撃技が使えます。さらにステージ中に出現する「ベル」は、ショットを当てることでパワーアップなどの効果を持つさまざまなアイテムに変化。上手に集めれば攻撃の幅が大きく広がります。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">出たな！！ツインビー<sup>&reg;</sup></span></div>
</div>
