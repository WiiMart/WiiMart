...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ナムコアリーナ」を舞台に、世界のチームを相手に戦うアイスホッケーのゲームです。選手を操作し、敵ゴールにシュートを決めてください。複数の選手を２本のスティックで同時に操作することができます。敵ゴールにシュートを決めれば得点が入り、自分のゴールにシュートを決められると敵に得点が入ります。タイムアップ時に、敵よりも得点が高ければ勝利となり、次の試合またはピリオドへ進めます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">フェイスオフ<sup>&reg;</sup></span></div>
</div>
