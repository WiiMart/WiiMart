...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157583450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In "Successfully Learning: English Year 5" worden leerlingen via speelse, uitdagende oefeningen onderwezen in de Engelse taal. De kleine vampier Freddy motiveert de kinderen en helpt hen met tips.
<br><br>
Alle opgaves zijn gebaseerd op het huidige leerplan Engels.
<br><br>
"Successfully Learning: English Year 5" is te spelen in het Engels, Duits, Spaans, Frans, Italiaans en Turks.</div>
  <div id="image02">
