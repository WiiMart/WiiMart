...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">前作「メタルスラッグ」から数年後の世界をえがいた、１９９８年発売の横スクロール型ミリタリーアクションゲームです。突如発生したクーデターを鎮圧するために、マルコとターマ、そして新主人公であるエリやフィオが活躍します。前作と同様にジャンプ、ショット、手榴弾などを駆使しながら各ステージを攻略しますが、今回はレーザーガンや、新たな乗り物が多数登場し、バラエティーに富んだ戦いが楽しめます。ほかにも、食料アイテムを取ることで太ってしまうものの攻撃力が増加したり、ミイラの攻撃を受けると自分もミイラになってしまったりといった、ユニークな演出も見どころのひとつです。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルスラッグ２</span></div>
</div>
