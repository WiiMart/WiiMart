...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ヒーロー「カメレオン キッド」が、ホログラム世界の中で９つの特殊能力を駆使して戦う、横スクロールアクションゲームです。幾重にも連なるステージを戦うカメレオンキッドの武器は、ブロックを叩くと出てくるヘルメット。頑丈な体が自慢のアイアンキッド、体当たりで壁を破壊できるクラッシュキッド、日本刀で戦うサムライキッド、重戦車に乗ってガイコツを飛ばすスカルキッド、小さなハエになるフライキッド、ホッケーマスク姿でオノを投げるアックスキッドなど、姿ばかりか武器も能力も多彩な９つの姿に変身できます。全部で１００以上あるラウンドをクリアするためには、それぞれが持つ能力をうまく使い分けることが必要です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">カメレオン キッド<sup>TM</sup></span></div>
</div>
