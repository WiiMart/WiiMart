...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este es el futuro cercano, recursos están disminuyendo, y los poderes mayores del mundo disputen sobre territorio. Pilotea al Cybernator G5-E para la brigada 95 de los marinos mecanizados, y lánzate a la guerra. Antes de cada misión te pondrán al tanto de todos los detalles y confirmarán a tus objetivos, luego tendrás que esforzarte para pasar los siete niveles, utilizando las herramientas de tu traje equipado o los cuatro tipos de armas. Podrás posiblemente restaurar el poder de una arma especifica hasta un máximo de tres niveles al reunir todos los “power chips” (“chips de poder”) de los enemigos derrotados. Tu decidirás si quieres reforzar una arma especifica o reforzar todas las armas simultáneamente, agregando un poco del elemento de estrategia a este juego repleto de acción. La poderosa música de fondo, el ambiente militar (busca por los orificios que las balas han dejado en las paredes, y la tensa comunicación durante el combate), y el intenso desarrollo de la historia se combinan para darle al mundo de Cybernator una sensación de ciencia ficción que nunca olvidarás.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A425745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A425745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
