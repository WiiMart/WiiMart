...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157413745')", "wiiSelectSound()");
...
<p>
• Challenge fighters around the world.<br>
• Relive your glorious fights from any angle using the replay editor.<br>
• Pull off spectacular moves using Wii Remote motion controls.</div>
  <div id="image02">
