...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157485845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Helix es uno de los juegos basados en el ritmo de la música más innovadores jamás diseñados para la consola Wii. Mueve el mando de Wii en el aire para realizar unos 30 movimientos fascinantes. Te quedarás con la boca abierta con los alucinantes gráficos de fondo que se mueven al ritmo de la música. Disfruta de su increíble "replay value" con decenas de canciones diferentes para elegir y tres niveles de dificultad. ¡Intenta desbloquear todas las canciones!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157485845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157485845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Helix<sup>TM</sup></span></div>
</div>
