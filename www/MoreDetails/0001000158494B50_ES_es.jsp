...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494B50')", "wiiSelectSound()");
...
<br><br>El planeta Monsteca ya no es el mundo tranquilo de siempre: acaba de ser invadido por un ejército de robots dispuestos a conquistarlo. A los habitantes de Monsteca, los Stompies, no les queda más opción que huir o dejarse capturar. Al no poder defenderse por sí solos de semejantes enemigos, deberán confiar en la fuerza de su manada para trabajar unidos y derrotar a estos entrometidos robots.
<br><br>
Asumirás el control de los Stompies, unos monstruos adorables pero no demasiado inteligentes que, una vez despiertos, necesitan ayuda para no ser capturados por los robots invasores. A ti te corresponde guiarlos con éxito a través de cada nivel.
<ul>
<li>Un divertido juego de estrategia en 3D de gran fluidez.</li><li>Una experiencia dinámica que estimula la inteligencia.</li>
<li>Una emocionante banda sonora.</li>
<li>Veinte niveles que garantizan horas y horas de juego.</li><li>Modo de trofeos para aumentar el reto.</li><li>El único juego con Astromaggots.</li></ul>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494B50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494B50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Monsteca Corral</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Monsters vs Robots Demo</span></div>
  </div>
