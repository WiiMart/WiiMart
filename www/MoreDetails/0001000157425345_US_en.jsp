...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157425345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pop is all about popping bubbles! It may sound simple, but there are lots of things you can do to get a high score and have fun. Just keep an eye on the timer, because when it runs out, it's game over! Each bubble is worth both points and time, so try to fill up your timer first, then focus on scoring high. You can then start to chain the same color of bubble for big points by popping bubbles of the same color. This is a great way to increase your score. Friends can join you in a game of Pop too! Whenever you are playing, all they need to do is connect their Wii Remote and then join in the action. Watch out because they may start using power-ups to hold you back! If they do, try to pump up some bubbles or detonate a nuke, as this will create a shock wave that will destroy any matching colors of bubbles it touches. Finally, there are badges for completing certain objectives, online high-score tables, and WiiConnect24 messages so you can keep up with your friends’ progress and boast about your own.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157425345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157425345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pop<sup>TM</sup></span></div>
</div>
