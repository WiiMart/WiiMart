...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000148434650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Avec la chaîne Wii Speak et l'accessoire Wii Speak, connectez jusqu'à 4 consoles Wii via la connexion Wi-Fi Nintendo pour pouvoir communiquer avec vos amis dans le monde entier!
<br><br>
Pour vous représenter dans les conversations, affichez vos Mii créés en utilisant la chaîne Mii. Les lèvres des Mii bougent chaque fois que le microphone capte des sons. Pour surprendre vos amis, amusez-vous à modifier vos voix! Pendant les conversations, présentez à vos amis des photos enregistrées sur votre bureau Wii ou sur une carte SD. Vous pouvez aussi envoyer à vos amis Wii des messages audio en y joignant une photo.
<br><br>
NOTE: une fois que vous acceptez le partage d'informations de la chaîne Wii Speak, les amis Wii sélectionnés ont la possibilité de voir votre statut de connexion, et notamment avec qui vous communiquez. Quand vous rejoignez la conversation qu'un de vos amis Wii entretient avec ses propres amis, vous pouvez tous voir vos Mii et surnoms respectifs, sans que vous ne vous soyez mutuellement enregistrés comme amis Wii. Vous pouvez à tout moment désactiver ce partage d'informations. Référez-vous au mode d'emploi pour plus de détails.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434650/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434650/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chaîne Wii Speak<sup>TM</sup></span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Chaîne Wii</div>
</div>
</body>
</html>
