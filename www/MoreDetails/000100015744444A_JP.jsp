...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744444A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Diner Dash（ダイナーダッシュ）は、ウェイトレスのFloを操作してレストランを繁盛させていくアクションパズルゲームです。<BR> わがままなお客様達を座席に案内し、オーダーを取って料理を運び、食べ終わったらお会計。そして最後に片付けと手際よく作業をこなしていきましょう。<BR> 来店するお客様はさまざま、気長に待ってくれる人もいれば、短気ですがチップを多くくれたりする人もいますので、それぞれに合わせた対応が必要です。満足してもらえればさらに追加でチップをもらえるので、お店の設備を増やしたり、Floをパワーアップさせることが出来ます。<BR> 店内を縦横無尽に駆け巡るFloを操作して、古ぼけたレストランを繁盛させましょう！全てはあなたの腕次第！？</div>
  <div id="image02">
    <img src="/oss/ccs/000100015744444A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744444A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">DINER DASH（ダイナーダッシュ）</span></div>
</div>
