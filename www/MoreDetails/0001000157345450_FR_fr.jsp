...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157345450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tu es sur le point de débuter l’expérience la plus addictive de ces dernières années. Franchis quinze tableaux diaboliques, dans lesquels tu dois reconstruire des figures impossibles à l’aide de balles d’énergie spatiale.<br><br> Affronte le chronomètre et les obstacles pour activer les bonnes boîtes. Spaceball: Revolution va mettre tes capacités et ta concentration à rude épreuve.<br><br> Avec Spaceball: Revolution tu peux comparer ton score avec celui des meilleurs joueurs du monde dans les différents niveaux de difficulté : Facile, Normal, Avancé et Maître.
<br>
Spaceball: Revolution te lance un défi. Sauras-tu le relever ?<br><br>Texte écran en français.</div>
  <div id="image02">
