...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">上からどんどん落ちてくるブロックを操作して、高く積みあがらないように消していくパズルアクションゲーム。ブロックは「コンテナ」「コズモ」「ボール」の３種類で構成され、コンテナは横一列に６つ並べると消え、コズモは転がるボールに触れると消すことができます。基本テクニックは、ブロックを回転させて落とし方を工夫し、コンテナの間にボールが転がる道となるようにコズモを並べること。コズモの一本道ができたら、ボールを転がして一気消しです。さらにコズモの上に乗っていたコンテナが横一列にそろえば連鎖で消すこともでき、スコアアップが狙えます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
