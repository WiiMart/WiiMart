...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界中のゲームファンが夢中になった音速ハリネズミ「ソニック」のデビュー作。ボタン１つと移動の操作だけで楽しめるスピード感満点のアクションゲームです。悪の天才科学者ドクター・エッグマンにとらわれた仲間たちを救い出し、スペシャルステージに隠された「カオスエメラルド」を手に入れるのが目的です。水と緑の野原、地下神殿、ピンボールで彩られた街など、次々と変化する６つのステージにはたくさんのルートが存在し、秘密のルートを探し出す楽しみもあります。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div><BR>JASRAC許諾番号：<BR>6727723183Y43030</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソニック・ザ・ヘッジホッグ<sup>TM</sup></span></div>
</div>
