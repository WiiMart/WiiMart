...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「リブル」と「ラブル」という矢印の形をした２つのキャラクターを操作し、間をつなぐラインで敵を囲んでやっつけるアクションゲームです。ある日、魔法使い「ホブリン」によって畑のキノコを「マシュリン」に変えられてしまった村の住民は、村に伝わる魔法の道具「リブル・ラブル」を使って畑を守ることにしました。畑にある杭にラインをひっかけて形を変え、敵をラインで囲むと、魔力「バシシ」が発生して敵を倒すことができます。各シーズンに２０匹いる「マシュリン」をすべてバシシするとシーズンクリア。シーズンをクリアするたびに春夏秋冬と季節が進み、難易度が上昇していきます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">リブルラブル<sup>&reg;</sup></span></div>
</div>
