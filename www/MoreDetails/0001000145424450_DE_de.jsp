...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieses Puzzlespiel wurde 1997 veröffentlicht.
<br><br>
Der Spieler steuert einen Clown, der Kugeln auffängt, die kontinuierlich oben am Bildschirm erscheinen und diese dann wieder hochwirft. Indem er drei gleichfarbige Kugeln senkrecht übereinander stapelt, lösen sich diese auf. Da die Kugeln mit der Zeit immer weiter nach unten rücken, wird der Clown, wenn du bummelst, von den Kugeln erdrückt und das Spiel ist vorbei.
<br><br>
Mit schnellen und präzisen Zügen kannst du die Kugeln abräumen und, wenn du dich erstmal eingespielt hast, Kaskaden auslösen. Die Grundregeln sind die gleichen wie im Vorgängerspiel, allerdings ist die Anzahl der Spielfiguren in der dritten Version auf 16 angestiegen und es gibt einen neuen Modus, nämlich „Magical Journey“. Das MAGICAL DROP-Universum wirkt dadurch noch viel tiefgründiger.
<br><br>
