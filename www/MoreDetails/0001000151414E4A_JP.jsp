...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">近未来の月面を舞台にしたウォーシミュレーションゲーム「ネクタリス」の続編です。「ネクタリス戦役」から１０年。敗北したガイチ帝国の将校や科学者達は、極秘裏に武装蜂起の準備と新兵器の開発を進めていました。プレイヤーは連合国軍特殊部隊の司令官となって、開発されている新兵器を調査し、同時に武装蜂起を阻止しなければなりません。戦場となるステージは、新たに火星マップを加えた全２４面。プレイヤーは自軍のユニット（部隊）に指令を出し、勝利条件（敵基地の占領、または敵部隊の全滅）の達成をめざします。ターン制やステージごとに決まっているユニットなど、シンプルながらも戦略そのものの面白さを楽しめる基本ルールは前作と同様。与えられたユニットの能力を把握し、「地形効果」や味方ユニットの「支援効果」を活用しながら戦いを進め、自軍を勝利にみちびいてください。前作「ネクタリス」も同時に収録されているなど、発売当時はＣＤ－ＲＯＭならではの容量を活かした特典も話題となりました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000151414E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151414E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ネオ・ネクタリス<sup>&reg;</sup></span></div>
</div>
