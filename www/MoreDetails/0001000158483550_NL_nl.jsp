...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158483550')", "wiiSelectSound()");
...
<br><br>
Ren, spring en zet de wereld op zijn kop.
<br>
And Yet It Moves is een bekroond, op fysica gebaseerd platformspel waarin je door een papieren wereld rent en springt. Om je door de breinbrekende levels heen te helpen, beschik je over de unieke gave om de wereld naar hartenlust te draaien! Wanden worden vloeren, hellingen worden platformen – maar een onschuldige hoop stenen wordt levensgevaarlijk als je hem omkeert!
<br>
Gebruik de Wii-afstandsbediening als een toverstaf om de wereld te kantelen. Verken prachtig ontworpen omgevingen. Overleef 20 uitdagende levels vol vreemde wezens, vallen en puzzels. 
<br>
Zet je wereld op zijn kop met And Yet It Moves.
<br><br>
