...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">An update is available that will make it easier for future users to download this channel. If you last updated this channel after January 30th, 2008, you will not see any changes if you update now.  For more details, see support.nintendo.com.
<p>
By now, you’re probably familiar with the Mii™ Channel, a fun place where you can make Mii characters that look just like your family and friends. The Check Mii Out™ Channel lets you take Miis farther than ever before—even around the world!
<p>
Visit the Posting Plaza, and submit your Miis so that other users can see them. If they’re popular enough, you could even become a Mii Artisan! Want a new Mii, but don’t feel like creating one? Use the search options to browse through all of the Miis that have been posted, and take home your favorites! Ever created a Mii to match a specific idea? The Check Mii Out Channel takes this one step further and lets users submit their creations based on unique themes in contests. Will your Mii stand out against the crowd? You can even help judge Miis to find the winners!
<p>
The Check Mii Out Channel is the ultimate playground for Miis to come together and play! Tap into your inner Mii artist, and let everyone see the results. Ready to get started?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415045/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415045/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Check Mii Out<sup>TM</sup> Channel</span></div>
</div>
