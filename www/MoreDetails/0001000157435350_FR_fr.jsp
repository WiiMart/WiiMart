...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157435350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Attrapez votre télécommande Wii et essayez donc ce jeu de billard ! Jouez à différents types de "parties" classiques telles que le "snooker", "billard américain", "jeu de la 8" ou "jeu en rotation". Vous pouvez également essayer des coups artistiques en mode "Puzzle".<br><br>
Ce jeu offre deux types de contrôle, qui vous permettent de "frapper" virtuellement la blanche avec votre télécommande Wii ou d'utiliser les boutons pour ajuster la force de votre coup puis "frapper".
Améliorez-vous avec le mode "Entraînement" pour apprendre toutes les techniques nécessaires et devenir un véritable pro.<br><br>
Utilisez les fonctions de modification pour créer vos propres défis et réalisez le coup dont vous avez toujours rêvé. Montrez à tout le monde que c'est vous le champion du tapis vert !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435350/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435350/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
