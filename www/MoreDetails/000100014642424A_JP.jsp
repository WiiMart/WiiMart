...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スーパーバイク「ロードマシーン」で激走するレースゲームです。水たまりやオイル、岩やドラム缶、マキビシなどの障害物を避け、敵のバイクを倒しながら、ゴールをめざします。バックミラーに映る敵の姿に注意しつつ、アクセルとブレーキだけでなく４段階のシフトチェンジを駆使し、巧みなハンドリングで走り抜けるのがコース攻略のカギ。コースのパーツを組み合わせることでオリジナルのコースを作ることもできます。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マッハライダー<sup>&reg;</sup></span></div>
</div>
