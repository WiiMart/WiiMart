...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744524A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">とことんハマれる穴掘りアクションゲーム「ミスタードリラー」がWiiウェアに登場。<BR><BR>ドリル１つで世界中の地面を掘りすすむ「ミスタードリラー」は簡単操作で最高のスリルを味わうことのできるアクションゲームです。<BR><BR>「ミスタードリラーワールド」では特徴的な８つの国のステージを用意。基本的な遊びのステージから、多数のホワイトブロックが行く手を阻むステージ、エアの減りがとっても早いステージ、どこまでも掘り進める∞ステージなどがあり、バラエティー豊かなゲームになっています。<BR><BR>それぞれのステージで３つの難易度を用意しましたので、初心者でも上級者でも自分の腕前に合わせて楽しむことができます。<BR><BR>もちろん、初めて遊ぶ人でも大丈夫。すんなりルールが理解できるように「チュートリアル」も搭載しました。だれでもすぐにドリラーの基本操作を覚えることができます。<BR><BR>さあ、全部で２４種類のステージを掘って掘って掘りまくりましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015744524A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744524A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ミスタードリラーワールド</span></div>
</div>
