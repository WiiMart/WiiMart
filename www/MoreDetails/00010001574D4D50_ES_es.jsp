...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D4D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">MUSCLE MARCH es un estrafalario juego japonés de acción lleno de fornidos culturistas a quienes les han robado la proteína en polvo, ¡así que Tony y su musculosa tropa deberán detener a los ladrones! Elige entre una serie de cinceladas superestrellas y lleva a estos villanos a la justicia. Cuando un ladrón huya, atravesará muros mientras posa: imítalo para pasar por el agujero y atraparlo. ¡La proteína volverá a ser tuya!
<br><br>
Flexiona tus músculos solo o con hasta tres amigos en 
divertidas partidas por turnos.
<br><br>
¿No te basta con posar unos minutos? ¡El modo infinito dejará tus músculos a punto de reventar!
<br><br>
Además, será el primer juego de WiiWare en incluir un oso polar con una braga náutica.
<br><br>
