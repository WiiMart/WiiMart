...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750374A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「プラネタリウム」はWiiで気軽に天体観測を楽しめるソフトです。<BR><BR>大きく3つのモードがあります。<BR>7等星までの約2万個の星をシュミレートし、星座や赤経/赤緯の表示、時間の経過速度の設定などを自由に選んで天体を眺めることができる天体観測モード。<BR><BR>星や星雲、星座、天体についての11の番組を見れるプラネタリウムモード。<BR><BR>天体、星座の情報や神話、天体観測で使う用語などをまとめた天体図鑑。<BR><BR>ゆっくり星空を眺めて楽しむ、天体についての知識を学ぶこともできるプラネタリウムソフトです。<BR><BR>いつも空で輝いている星の奥深く不思議な世界を覗いてみませんか？</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750374A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750374A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">PLANETARIUM</span></div>
</div>
