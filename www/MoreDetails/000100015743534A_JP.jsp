...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015743534A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ｗｉｉリモコンを使って体感的に楽しめるビリヤードゲームです。９ボール、８ボール、ローテーション、スヌーカーの競技での「対戦」と、トリックショットを攻略する「パズル」で遊べます。<BR>Ｗｉ－Ｆｉコネクションに接続することで離れた場所の友達同士や世界中のプレイヤーとＷｉ－Ｆｉ対戦を行うことができます。<BR>操作はWiiリモコンを「つきだして」ショットする体感的な方法の他にボタン操作だけでショットの強さを決めてショットする、ふたつのやり方を選ぶことができます。体感的な操作が苦手な方も安心です。<BR>ビリヤードゲームをあまりプレイしたことがない方は「練習」モードでかっこいいテクニックを身につけましょう。<BR>「パズル」モードでは手ごたえ十分な問題を用意していますが、思い描くトリックショットをしてみたいという方には、オリジナルの問題を作成できるエディット機能はいかがでしょうか。魔法のようなショットを披露すれば、あなたはきっとショーの主役です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015743534A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015743534A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">キュースポーツ～Ｗｉ－Ｆｉ対戦ビリヤード</span></div>
</div>
