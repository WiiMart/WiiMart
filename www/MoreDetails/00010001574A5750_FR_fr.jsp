...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574A5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Découvrez le meilleur puzzle du monde, désormais disponible sur Wii ! <br><br>Assortissez trois gemmes brillantes à la fois pour les faire exploser, ou plus de trois pour obtenir de puissantes gemmes colorées qui augmenteront votre score avec des réactions en chaîne et de magnifiques combos.<br> <br>Relevez tous les défis en mode Classique ou jouez contre la montre en mode Action. Pour encore plus de fun, faites travailler votre cerveau avec des puzzles à facettes multiples ou relaxez-vous en mode Zen pour une partie infinie. <br><br>Du divertissement 18 carats à chaque partie !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574A5750/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
