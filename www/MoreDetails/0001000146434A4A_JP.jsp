...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ＳＤガンダムワールド　ガチャポン戦士２　カプセル戦記』は、１９８９年にファミリーコンピュータで発売されました。「機動戦士ガンダム」シリーズのモビルスーツを操作し、拠点を確保してユニットを生産しながら敵軍本拠地の占領または敵の全滅を目指すことが目的です。前作同様ユニットの移動や生産を行うシミュレーションパートとアクションによる戦闘パートに分かれており、アクションとシミュレーションを融合したゲームシステムはそのままに、登場機体の増加はもちろん１ターンで移動出来るユニット数が最大１２体増え、ＣＰＵ思考時間の大幅な減少するなど様々な点で前作から改良されています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146434A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146434A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SDガンダムワールド</span></div>
</div>
