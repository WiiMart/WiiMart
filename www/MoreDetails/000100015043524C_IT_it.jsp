...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Riunisci fino a quattro amici per giocare un'autentica partita a biliardo, rimanendo comodamente seduto in poltrona! Scegli tra sei tipi di gioco, come 9BALL (Palla 9), ROTATION (Pool continuo) e CAROM (Boccette), che viene giocato su un tavolo sprovvisto di buche. 
Usa la modalità SIMULATION (Simulazione) per calcolare il tiro perfetto o seleziona ACTION (Azione) per scoprire la causa dei tuoi errori. Con tutte queste opzioni a disposizione, qualunque giocatore, principiante o esperto, potrà disporre di tutti gli elementi necessari per giocare un'entusiasmante partita a biliardo!
Ma non è tutto! Seleziona TECHNIQUE (Tecnica) per allenarti con i tuoi angoli o prova un colpo ad effetto! Fatti aiutare dalla CPU e affina le tue abilità. Con Break In diventerai in breve tempo un vero professionista!
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/000100015043524C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043524C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Break In</span></div>
</div>
