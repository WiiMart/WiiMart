...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">未来の月面戦争を舞台にした本格派シミュレーションゲーム。初心者でも安心してプレイできるシンプルなルールで戦略そのものの面白さが楽しめます。ゲームの進行はターン制で、プレイヤーは部隊を動かす前にじっくりと作戦を練ることが可能。また、ステージ毎に登場するユニットが決まっているのも特徴で、限られた戦力の下でそれぞれの采配が際立ちます。戦闘を有利に展開していくには地形や包囲効果の利用がポイントです。敵の全滅、もしくは収容所(敵拠点)の占領を目標に各ステージを攻略し、全１６ステージを戦い抜きます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ネクタリス<sup>&reg;</sup></span></div>
</div>
