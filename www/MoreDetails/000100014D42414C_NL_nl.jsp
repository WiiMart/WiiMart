...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Nadat de bekende 21ste-eeuwse wetenschapper Dr. Yoshiyama verliefd werd op "C-Life", een van zijn eigenhandig gecreëerde kunstmatige intelligenties, uploadde hij zichzelf naar zijn computer om dichter bij haar te kunnen zijn. Daar smolt zijn DNA samen met de programmakern van C-Life en zo ontstond Pulseman, half mens en half kunstmatige intelligentie. De terugkeer van Dr. Yoshiyama naar de normale wereld tastte helaas zijn geest aan, waardoor hij veranderde in de kwaadaardige Dr. Waruyama. 
<br>
Pulseman kan elektriciteit als wapen gebruiken, bijvoorbeeld in de vorm van zijn Volteccer-aanval, waarmee hij zich snel kan verplaatsen. Met behulp daarvan neemt hij het in zeven maffe levels op tegen Dr. Waruyama en zijn Galaxy Gang.
<br>
Ontdek waarom deze klassieker wijd en zijd beschouwd werd als een van de beste spellen voor de SEGA MEGA DRIVE!
<br><br>Het spel is voorzien van Engelse schermteksten met wat Japans.
<br>
