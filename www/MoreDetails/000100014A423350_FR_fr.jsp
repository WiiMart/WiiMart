...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Voici le premier épisode de la désormais légendaire série Harvest Moon, sorti sur Super Nintendo en 1998. Transformez vos quelques champs et vos étables vides en une ferme florissante pour atteindre votre but ultime: le mariage!
<br><br>
Vous pourrez planter et moissonner différentes céréales, acheter, élever vaches et poules, puis faire des bénéfices en les vendant. Peut-être trouverez-vous l'âme sœur parmi les jeunes filles du village, mais il vous faudra embellir votre modeste maison si vous voulez qu'elle s'installe un jour chez vous!
<br><br>
Chaque année vous apportera son lot d'événements et de célébrations, tandis que vous contemplerez le cycle des saisons et des moissons avec votre joli petit chien. Harvest Moon va réveiller le fermier qui sommeille en vous. Vous ne pourrez plus vous en passer!
<br><br>
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">(Version anglaise)</span></div>
  </div>
