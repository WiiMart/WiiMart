...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A retro classic from Capcom's arcade line-up in 1985, Exed Exes is a vertically-scrolling shooter that's sure to bring back fond memories. Dodge bullets! Collect fruit! And go for high scores in the most furious sci-fi insectoid shoot 'em up ever made.</div>
  <div id="image02">
