...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">メガドライブを代表する横スクロール格闘アクションゲームのシリーズ最終作。アクセル、ブレイズ、サミー、初登場のサイボーグ科学者・ザンの４人から操作キャラクターを選び、魔の原子「ラクシン」をめぐり繰り広げられるシンジケートとの最後の戦いに立ち向かいます。成長要素も加わり一層バリエーション豊かになったアクションの数々とイベントシーンをはさんで展開する物語はシリーズ最高のボリュームとなり、シナリオ分岐も追加されました。これまでのシリーズ作品と比べ格段に美しくなったグラフィックと豊富なキャラクターが、ドラマチックなストーリーを盛り上げます。２人プレイでは、異なるキャラクター同士での協力プレイが可能。ほかにも、意外な隠しプレイヤーキャラや、シリーズではおなじみの古代祐三による鮮烈な音楽など、さまざまな進歩を遂げた完結編です。。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42514A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ベア･ナックルⅢ<sup>TM</sup></span></div>
</div>
