...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157523945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Fans de Mega Man, la espera ha llegado a su fin! El clásico héroe azul que debutó en 1987 regresa en esta novena entrega de la saga. Una nueva aventura de Mega Man al más puro estilo 8-bits; gráficos, música, jugabilidad... ¡todo tal y como lo recuerdan!</div>
  <div id="image02">
