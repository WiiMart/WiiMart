...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157504250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pub Darts is a simple darts simulation which uses the Wii's unique controls to mimic dart throwing motion. The game is set in a local pub where the players will settle in to play some of their favourite dart games including 501, Cricket, Around the Clock, Killer, and Baseball. <br><br>Controls function just like throwing a real dart and players are able to create their own personal profiles including selecting their avatar image from a collection of creative characters and also selecting the design they would like displayed on the dart flights.</div>
  <div id="image02">
