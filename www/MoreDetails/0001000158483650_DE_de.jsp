...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158483650')", "wiiSelectSound()");
...
<br><br>
Eine Weltraum-Erforschungssonde wurde auf den Planeten nc85 Klasse N in der Galaxie Alpha Centaury gesandt, um das Verschwinden einiger Sonden aufzuklären und mehr Informationen über den Planeten zu sammeln.
<br><br>
