...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In deze uit de kluiten gewassen actie-RPG is Mario misschien wel tweedimensionaal, maar zijn avontuur is allesbehalve mager! Paper Mario combineert op unieke wijze de platformcapriolen van onze heldhaftige loodgieter met een hilarische zoektocht vol vreemde personages en grappige uitdagingen.
<br><br>
Paper Mario (in 2001 uitgebracht en geprezen door de critici) neemt je mee op een uitermate speelbare tocht door het Mushroom Kingdom om de Star Spirits te redden, die door de op macht beluste Bowser gevangen zijn genomen.
<br><br>
Onderweg neem je het op tegen vijanden in vermakelijke gevechten, waarbij er om de beurt wordt aangevallen. Je werkt samen met partners met elk hun eigen vaardigheden, ontdekt geheime minigames en helpt zelfs iemand een taart te bakken!  
<br><br>Het spel is voorzien van Engelse schermteksten.
<br>De Rumble-functie van het origineel wordt niet ondersteund.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Paper Mario<sup>TM</sup></span></div>
</div>
