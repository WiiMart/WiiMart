...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157445050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dr. Mario Demo vous donne un aperçu en ligne des possibilités offertes par le WiiWare Dr. Mario.
<br><br>
Cette version vous permet d'affronter un ami qui possède la version complète du jeu (Dr. Mario & Bactéricide) via la connexion Wi-Fi Nintendo.
<br><br>
Attention, cette version démo en ligne ne vous permet ni de jouer hors ligne (à un ou deux joueurs), ni de jouer à Bactéricide.
<br><br>
Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157445050/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157445050/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
