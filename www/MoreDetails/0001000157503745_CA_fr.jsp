...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157503745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Planetarium is a game that allows you to observe celestial bodies from the comfort of your TV using the Wii Remote controller. There are three main modes:
<p>
...
<p>
My Planetarium is a title where you can enjoy looking at the night sky while learning about the objects that it contains. Come and take a deep look into the mysterious stars that fill the sky.
<p>
