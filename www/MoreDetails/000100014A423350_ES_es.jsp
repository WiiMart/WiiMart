...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Harvest Moon salió a la venta para Super Nintendo en 1998 y es el primer juego de la ya legendaria saga de simuladores de granja. Deberás comenzar de cero con unos pocos terrenos y establos vacíos, y tendrás que progresar poco a poco hasta alcanzar el objetivo final del juego: ¡casarte! 
<br><br>
Siembra y recoge diferentes cultivos; compra y cría vacas y gallinas, y gana dinero vendiendo todo lo que produces. Puedes intentar ligar con varias chicas del pueblo, ¡pero tendrás que mejorar tu casa si quieres que alguna dé el gran paso y se mude contigo!
<br><br>
Con vacaciones y acontecimientos especiales, cultivos y paisajes que cambian con cada estación y un simpático perro que permanecerá siempre a tu lado, ¡este adictivo juego sacará el granjero que llevas dentro!
