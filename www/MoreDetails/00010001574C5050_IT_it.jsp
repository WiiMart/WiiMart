...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574C5050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LONPOS è un puzzle game che sfiderà le tue capacità logiche e di concentrazione e al quale potrai giocare da solo, insieme a un amico o sfidando altri amici. Lo scopo è di sistemare nello schema tutti i pezzi di forme diverse che compaiono accanto a esso, muovendoli e girandoli con il telecomando Wii.
<br><br>
Potrai scegliere fra diverse modalità: la modalità normale, in cui sfidi l’orologio tentando di risolvere i puzzle il più in fretta possibile; la modalità continua, in cui una sola mossa falsa può costarti la partita; la modalità cooperativa, in cui disponi i pezzi alternandoti con un amico; la modalità sfida, in cui fino a un massimo di quattro giocatori si sfidano.
<br><br>
La tua materia grigia avrà un bel po’ di puzzle con cui misurarsi!
<br><br>
