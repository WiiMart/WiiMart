...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001584A4850')", "wiiSelectSound()");
...
<br><br>
Paint Splash transforme votre téléviseur en une toile interactive où les enfants de tous âges peuvent découvrir de la peinture en utilisant la Wiimote. Jusqu'à quatre personnes peuvent peindre en même temps. Ainsi toute la famille peut participer à la création des peintures fantastiques.
<br>
Faites votre choix parmi plusieurs brosses et outils de peinture, utilisez toutes les couleurs de l'arc en ciel ou activer le mode Splash où secouant la télécommande Wii et les éclaboussures de peinture apparaîtront sur ​​l'écran ! Idéal pour les plus jeunes membres de la famille.
<br><br>
Vous pouvez enregistrer vos peintures sur une carte SD et transférer vos créations à d'autres périphériques comme par exemple un ordinateur, pour imprimer et envoyer des emails.
<br><br>
Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001584A4850/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001584A4850/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Paint Splash</span></div>
</div>
