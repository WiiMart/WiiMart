...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『この度、豪血寺家主催の格闘技大会を挙行することに決定した。この大会で優勝した者には、豪血寺家頭主の座をその日から五年間与えるものとする。また、その期間が終了すると同時に、再び頭主の座を賭けて格闘技大会を行うこととする。』<BR><BR>格闘ゲーム“豪血寺一族”シリーズの第一弾です。ストーリーモードでは８人の個性あふれるキャラクターの中から１人を選び、頭主となるべく大会優勝を目指します。その他にもプレイヤー同士で対戦を行える「Ｖ．Ｓ．ＭＯＤＥ」をはじめ、「ＬＩＦＥ　ＡＴＴＡＣＫ」「ＰＲＡＣＴＩＣＥ」「ＫＡＲＡＯＫＥ」等のモードをお楽しみ頂けます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A45474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A45474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">豪血寺一族</span></div>
</div>
