...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「メカドラゴン」との戦いに臨み、邪悪な呪いで醜い怪物の姿に変えられた勇者が、どんな呪いも解くといわれる「サラマンダー・クロス」を手に入れて元の人間の姿に戻るために冒険する、横スクロールタイプのアクションロールプレイングゲームです。広大なフィールドを探索しながら、お金やアイテムを集めてキャラクターをパワーアップしていきます。冒険の途中でドラゴン（ボス）を倒すたびに、勇者は「リザードマン」「マウスマン」「ピラニアマン」「タイガーマン」「ホークマン」といった様々な怪物の姿に変身させられてしまいます。それぞれが持つ特殊能力と、各フィールドで入手できる特殊なアイテムをうまく利用して、徐々に冒険の範囲を広げていきます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アドベンチャーアイランド</span></div>
</div>
