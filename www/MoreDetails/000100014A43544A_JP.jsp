...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「古の時代、力こそが全てであり、鋼の教えと闇を司る魔が支配する、ゼテギネアと呼ばれる時代があった」　重厚で緻密な世界観が人気を集めるシミュレーションロールプレイングゲーム「オウガバトル」シリーズの１作目です。プレイヤーは、ナイトやウィザード、グリフォンなど多様で特徴的なキャラクターから編成されたユニット（部隊）を指揮し、反乱軍のリーダーとして、神聖ゼテギネア帝国の圧政に苦しむ民衆を解放していきます。ゲームはリアルタイムで進行するため、複数の敵味方が同時に行動する、リアルで緊張感のある戦いが楽しめます。広大なマップ上を進軍するそれぞれのユニットに、適切な指示を与えることが重要です。キャラクターは戦闘で経験を積むことで強くなっていき、クラスチェンジをすることで、さらに強く成長していきます。また、プレイヤーがとった行動により変化するマルチエンディングとなっており、民衆を救った勇者となるか、帝国と変わらぬ暴君となるか、さまざまな結末が用意されていることも本作の魅力です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">伝説のオウガバトル</span></div>
</div>
