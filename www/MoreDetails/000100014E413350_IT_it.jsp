...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bomberman, eroe dell'infanzia per eccellenza, torna su Wii con tutta l'azione della versione originale!
<br><br>
Una navicella spaziale inaspettatamente piovuta dal cielo si abbatte sul pianeta Bomber! Bomberman si reca nell'area dell'impatto per verificare l'accaduto, ed è lì che il nostro eroe incontra Pibot, il pilota robot visibilmente sconvolto e disorientato. Pibot gli rivela che i generali dell'Impero Garaden hanno attaccato il pianeta Primus Star e rapito la principessa Millian, prelevata a forza dalla navicella.
Informato dell'accaduto, Bomberman promette di mettersi subito alla ricerca della principessa, a costo di attraversare l'intera galassia.
<br><br>
Bomberman potrà contare su una riserva infinita di bombe e di power-up che lo aiuteranno lungo il suo percorso. Attraverserà ben cinque pianeti, si ricongiungerà al fedele Louie e scoprirà diversi oggetti e veicoli speciali! Spara, vola, esplora gli abissi marini e piazza strategicamente le tue bombe: attraversa la galassia e salva la principessa Millian!
<br><br>
Il testo all'interno del gioco è in inglese.<br>La funzione rumble del gioco originale non è disponibile.</div>
  <div id="image02">
