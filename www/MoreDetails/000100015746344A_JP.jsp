...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015746344A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ファイナルファンタジーIV ジ・アフターイヤーズ　-月の帰還-』は、「ファイナルファンタジーIV」のその後の物語を描いた作品です。<BR>ストーリーは章立てで展開され、前作の主人公セシルとローザの息子セオドアを軸に、リディア編やエッジ編など、各キャラクターにスポットを当てたストーリーを追加配信いたします。<BR> このゲームの特徴として、追加配信される全てのストーリーを順番にプレイしていく必要はありません。思い入れのあるキャラクターのストーリーなど、好きなストーリーだけを自由な順番でプレイしても最終的な物語に到達することが可能です。<BR> バトルシステムはアクティブタイムバトルを継承するとともに、月の満ち欠けがバトルに影響する【月齢】システムや、アビリティを組み合わせ、味方との連携技により繰り出す【バンド】システムを採用。臨場感あふれるバトルを楽しむことが出来ます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015746344A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015746344A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FINAL FANTASY IV</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">THE AFTER YEARS 月の帰還</span></div>
  </div>
