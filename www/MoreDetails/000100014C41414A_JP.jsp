...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">伝説の人気格闘マンガをゲーム化したアクションゲームです。核戦争で崩壊した世界。一子相伝の暗殺拳「北斗神拳」の伝承者ケンシロウは、恋人ユリアを救い出すため、強敵たちと戦います。ゲームは、モヒカンなどの戦闘員たちと戦いながらゴールをめざす横スクロールステージの通常戦と、ひとまわり大きなキャラで１対１の一騎打ちを行うボス戦の２つのパートで展開。ボス戦では最後の一撃を決めれば、北斗神拳奥義で敵を粉砕します。南斗聖拳のシンとの戦いから始まるストーリーは、トキとの出会いや聖帝サウザー戦を経て、拳王ラオウとの決戦をむかえます。ハート様やフォックス、ウイグル獄長ら人気キャラクターも中ボスとして登場するなど、原作に忠実な展開と爽快感のある内容は、原作ファンからも高い評価を受けました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C41414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C41414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
