...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機（マイタンク）を操作して司令部を守りながら敵を倒していく固定画面型の戦略的シューティングゲーム『バトルシティー』を進化させたゲームです。マイタンクを４方向に操作して弾を発射し、敵を全滅させればラウンドクリア。マイタンクが全滅させられるか、司令部が破壊されるとゲームオーバーです。パワーアップやツインショットなどのさまざまなアイテムを手に入れてマイタンクをパワーアップさせながら、全３６面のラウンドをクリアしてください。前作同様、２人協力プレイも可能です。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">タンクフォース<sup>&reg;</sup></span></div>
</div>
