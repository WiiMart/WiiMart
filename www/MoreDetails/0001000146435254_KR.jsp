...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">남쪽 바다의 수수께끼의 섬 「어드벤처 아일랜드」에서 모험을 펼치는 횡스크롤 액션 게임입니다. 플레이어는 주인공을 조작하여 악의 대왕 「큐라」에게 납치 당한 마음속 연인 「티나」를 구하기 위해 숲이나 동굴 등 모두 8개의 에리어에 도전합니다. 하나의 에리어는 4개의 라운드로 구성되어 있으며 각각 주인공의 모험을 방해하는 많은 적들이 도사리고 있습니다. 또한 플레이 중에는 시간의 흐름에 따라 주인공의 「체력」이 점점 줄어들기 때문에 「과일」이나「우유」로 체력을 회복하면서 골을 향해 나아가야 합니다. 가끔씩 길에 떨어져 있는 알을 깨면 「도끼」나 일정 시간 무적 상태가 되는 「하니」와 같은 아이템을 획득할 수 있습니다. 여러 가지 아이템을 적절하게 이용해서 4개의 라운드를 지나 각 에리어의 마지막에 기다리고 있는 큐라 대왕을 쓰러뜨리면 그 에리어는 클리어하게 됩니다. 적에게 부딪히거나 함정에 빠지거나 체력을 잃는 등 실수하지 않도록 조심하면서 큐라 대왕과 8번의 대결에서 승리해 티나를 구해 냅시다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146435254/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146435254/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Hudson's Adventure Island<sup>&reg;</sup></span></div>
</div>
...
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">패밀리컴퓨터</div>
</div>
</body>
</html>
