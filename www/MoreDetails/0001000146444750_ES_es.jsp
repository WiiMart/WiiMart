...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">GHOSTS'N GOBLINS ya era un famoso juego de máquina recreativa antes de dar el salto a NES en 1986. Al igual que las continuaciones que le seguirían, GHOSTS'N GOBLINS representa un considerable desafío para aquellos valientes dispuestos a ponerse en la piel del caballero Arthur y adentrarse en un territorio plagado de monstruos y demonios con el fin de rescatar a la princesa secuestrada. 
<br><br>
Elige tus armas cuidadosamente y aprovecha las ventajas que cada una puede aportar en diferentes situaciones. Atraviesa las seis puertas que te separan de Astaroth, ¡y asegúrate de que nunca olvide la lección de caballería que le darás!
<br><br>
GHOSTS'N GOBLINS es un juego técnicamente muy avanzado para su época, que formó en torno a sí un universo único e inolvidable. Todos los ingredientes de la aventura están preparados. Y tú, ¿te atreves con la prueba? 
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146444750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146444750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">GHOSTS'N GOBLINS<sup>TM</sup></span></div>
</div>
