...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ninja Commando, das 1992 von ADK veröffentlicht wurde, ist ein vertikal scrollendes Action-Spiel. Drei Charaktere stehen dem Spieler zur Auswahl: Joe, ein Koga-Ninja-Kämpfer, Rayar, eine Meisterin der Iga-Ninja-Technik und Ryu, ein Nachkomme des Ninja-Bosses Fuma Kotaro. Gemeinsam machen sie Jagd auf Spider, den Händler des Todes, der die Welt mithilfe einer Zeitmaschine ins Chaos stürzen will. Gekämpft wird in sieben Zeitaltern wie etwa in der Steinzeit, dem alten Ägypten oder im mittelalterlichen Japan.<br><br> Eine der Stärken dieses Spiels sind die verschiedenen Angriffsarten. Jeder der Helden verfügt über einen Standardangriff, einen Spezial-Move, der allen Gegnern auf dem Bildschirm Schaden zufügt und Ninjatechniken, die durch spezielle Tastenkombinationen ausgeführt werden. Durch die Aufnahme von drei Schriftrollen können sie sich zusätzlich verwandeln und einen Superangriff ausführen. Darüber hinaus kannst du dich im Zweispielermodus mit einem Freund ins Getümmel stürzen.
<br><br>
