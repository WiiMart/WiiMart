...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La Terra è minacciata dai Ruffian, mutanti creati artificialmente per far fronte alla scarsità di risorse alimentari, che si sono rivoltati contro i loro signori. Nei panni di un giovane guerriero della resistenza, devi affrontare un'orda di mostri biogenetici e forze militari corrotte nella tua battaglia per salvare il pianeta.
<br><br>
Puoi sperimentare l'azione senza tregua di questo classico per Nintendo 64 creato dai maestri degli sparatutto di Treasure Co. Ltd. e per la prima volta disponibile fuori dal Giappone.
<br><br>
Lotta per terra, cielo e mare. Raccogli energia, tempo e punti bonus, ma ricorda che per guadagnarti il diritto a continuare a giocare e affrontare l'ira degli enormi boss finali dovrai abbattere quanti più nemici possibile. Inoltre, puoi invitare un amico a giocare con te. Lui controllerà l'arma da fuoco mentre tu muoverai il personaggio.
<br><br>
Questa versione è stata aggiornata appositamente per la Virtual Console ed include il testo dei menu e del tutorial, nonché della sequenza finale, in lingua inglese.
<br><br>
La funzione rumble del gioco originale non è disponibile.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414A4C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414A4C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sin and Punishment</span></div>
</div>
