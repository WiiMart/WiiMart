...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157413450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jouez à des mini-jeux loufoques avec vos amis et montrez vos créations WarioWare sur grand écran! WarioWare: Do It Yourself – Showcase est le complément idéal du jeu WarioWare: Do It Yourself sur Nintendo DS.
<br><br>
Ce WiiWare vous permet de transférer sur votre console Wii les mini-jeux, les disques et les BD que vous avez créés sur votre console Nintendo DS et de vous amuser en utilisant la télécommande Wii à la place du stylet. Il contient également une sélection de mini-jeux exclusifs: jouez-y sur votre téléviseur ou téléchargez-les sur votre console Nintendo DS pour les emmener partout avec vous!
<br><br>
...
Certains services en ligne proposés sur la console Wii ayant été désactivés le 28 juin 2013, les fonctions en ligne de ce logiciel utilisant WiiConnect24 ne sont plus disponibles.</div>
  ...
  <div id="image01">
    <img src="/oss/ccs/0001000157413450/FFFD0027" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
