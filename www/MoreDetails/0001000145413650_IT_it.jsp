...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo è il terzo capitolo della serie di giochi di combattimento a incontri “King of Fighters”. Fu rilasciato nel 1996. La serie KOF si caratterizza per la presenza di un cast di personaggi SNK di primissimo livello, prelevati da giochi come “Fatal Fury”, “Ikari Warriors”, “Psycho Soldier” o “Art of Fighting”, che si contendono il titolo di combattente più forte del mondo. 
<br><br>
Il titolo aggiunge importanti variazioni alle meccaniche di gioco dei precedenti capitoli. Presenta salti lievi, medi e alti, capriole d’evasione in avanti e indietro e aggiunge la guardia a mezz’aria. La possibilità di revisionare i comandi rende l’esecuzione delle mosse meno complessa, e sono stati ricalibrati i danni dei colpi a lungo raggio, riducendoli. Questo capitolo si libera dell’idea che un approccio basato sulla ripetizione dei colpi a lungo raggio possa essere efficace, segnando così un considerevole punto di svolta nella serie.
<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145413650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145413650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE KING OF FIGHTERS '96</span></div>
</div>
