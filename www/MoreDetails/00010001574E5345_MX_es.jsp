...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574E5345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Uh oh! Los científicos están siendo atacados por una horda de monstruos viciosos. Utilice la física para machacar las repugnantes criaturas antes de que se acercasen. Aplástelos, ensártelos, estállelos y haz todo lo posible para ayudar a nuestros amigos científicos a sobrevivir.
<p>
Usa el Wii Remote para construir trampas con objetos al azar, cuerdas y elásticos. Use mulles y explosivos para la destrucción adicional. Completa casi treinta niveles en 4 zonas y luego intente batir el reto especial en cada uno. ¿Lograrás salvar a los científicos de los horrores de la dimensión oscura?
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E5345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E5345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
