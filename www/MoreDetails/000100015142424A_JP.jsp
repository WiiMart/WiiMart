...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大人気を博した対戦格闘ゲームシリーズの原点であるアーケード版「ストリートファイター」のＰＣエンジン移植作です。プレイヤーは「リュウ」や「ケン」を操作して、世界各地の個性的なファイターを相手に戦います。試合は相手の体力を奪い、２ラウンド先取した方の勝利です。
基本の攻撃となるパンチとキックは、ボタンを押す長さで威力が弱・中・強の３段階に変化します。また、コマンド入力により「波動拳」「昇竜拳」「竜巻旋風脚」といったシリーズを代表する強力な必殺技を出すことも可能。通常攻撃と必殺技を駆使して戦い、ファイターたちの頂点をめざして勝ち抜いてください。当時は家庭用ゲーム機で初のＣＤ－ＲＯＭソフトとして発売され話題となりました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015142424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015142424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイティング・ストリート<sup>&reg;</sup></span></div>
</div>
