...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界各地で支持されている、アクションパズルゲームの代表作「ロードランナー」の続編です。プレイヤーは主人公の「ランナー」を操作して、敵の「ロボット」に捕まらないよう、ステージに配置された「金塊」を集めます。すべての「金塊」を回収してステージから脱出できればクリアです。
本作では従来のシンプルなルールはそのままに、パズル要素が一段とパワーアップ。世界のユーザーから投稿されてきたという「超難問」の５０ステージが待ち受けています。発売当時は、パッケージに「警告！ロードランナー未経験者お断り！」と書かれていたり、最終ステージまでのパスワードをすべて送ることで「チャンピオンカード」という認定証が授与されたりと、その難易度ゆえの商品展開も話題になりました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146464B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146464B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">チャンピオンシップ・ロードランナー<sup>&reg;</sup></span></div>
</div>
