...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El Canal Internet te propone una nueva forma de navegar por la red de redes: ¡desde tu sofá y usando el mando de Wii!
<br><br>
En un par de movimientos de muñeca, podrás leer tu correo electrónico, buscar los últimos lanzamientos para Wii o actualizar tus redes sociales.
<br><br>
A partir de ahora, el Canal Internet es compatible con Adobe Flash Lite 3.1, lo que te permitirá ver todavía más vídeos.* 
<br><br>
<b>Nota: Nintendo no asume ningún tipo de responsabilidad por las pérdidas o los daños que puedan derivarse del uso del Canal Internet o de la imposibilidad de conectarse a internet.</b>
<br><br>* Algunos elementos Flash podrían ser incompatibles.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414450/FFFD001D" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414450/FFFD001E" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
