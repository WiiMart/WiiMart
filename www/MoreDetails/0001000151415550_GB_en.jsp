...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Join young Adam and Laura as they embark on a fantastic adventure in this comical action-shooting game! You can either play alone as Adam, or play together with a friend controlling Laura.
<br><br>
The game consists of 14 Rounds, each consisting of two Scenes. First is the Action Scene, where you must use your Power Boost Weapons against cute monster enemies while avoiding obstacles and pits as you head for the gate at the end. This is followed by the exhilarating Shooting Scene, a side-scrolling shoot 'em up where you shoot down flying enemies and take out the monstrous end boss to clear the Round!
<br><br>
As well as cute, colourful graphics, Monster Lair features an acclaimed music score, reproduced exactly as it was on the original CD-ROM game.</div>
  <div id="image02">
