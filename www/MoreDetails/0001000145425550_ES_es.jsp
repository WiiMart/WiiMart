...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego, originalmente publicado en 1991, se encuentra muy lejos de los típicos juegos de béisbol. Elige un equipo de un total de doce participantes, inscríbete en una de las dos ligas y lucha por el campeonato. Los partidos se celebran en el exclusivo Estadio Cyberoval, cuya zona de home run está peligrosamente reducida y la zona limpia es inusualmente ancha. Existe también una zona de parada, en la que se detiene toda bola que entra en ella. A medida que avanza el juego, serán instalados unos petardos (minas) que harán de los partidos una locura. Además, se pueden comprar armaduras durante el juego para reforzar a los jugadores, todo ello a fin de disfrutar de una experiencia única. Puede que te sorprenda al principio, pero una vez que te acostumbres y comiences a crear tus estrategias, empezarás a disfrutar todas las bolas con efecto que te lancen.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
