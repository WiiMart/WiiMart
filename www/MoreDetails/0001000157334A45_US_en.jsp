...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157334A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Triple Jumping Sports is the most advanced recreational jumping game available for the WiiWare service, immersing the player in the world of competitive jumping.
<p>
Most events consist of activities that are traditionally derived from hunting and combat skills. Over time these practices have evolved into a variety of competitive sports that include Long Jump, High Jump and Pole Vault.
<p>
As with real life jumping events you will have full control over the speed, height, angle and distance of the jump. All of these will influence the success of the jump.</div>
  <div id="image02">
