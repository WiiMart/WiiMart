...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo canale è destinato ai giocatori di The Legend of Zelda: Skyward Sword.
<br><br>
Questo canale è stato creato per riparare i dati di salvataggio che, date determinate condizioni, impediscono ai giocatori di portare a termine l'avventura "Melodia dell'impavido": se la Melodia del drago del fulmine viene acquisita per prima, può risultare impossibile recuperare le altre parti della Melodia dell'impavido. Se non giochi a The Legend of Zelda: Skyward Sword, questo canale non ha per te alcuna utilità.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435250/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
