...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pitstop II è stato il primo gioco di corse a introdurre l’adrenalina di gareggiare contro un avversario, l’eccitazione di combattere per la prima posizione e la suspense nel vedere chi sarà il più veloce a uscire dai box. Inoltre, la visuale in terza persona e lo schermo diviso a metà permettono a due giocatori di vivere l'emozione di una gara condotta testa a testa.
<br><br>
Sei circuiti fra i più duri al mondo ti stanno aspettando: dai tornanti di Brands Hatch fino al lungo rettilineo di Vallelunga. Puoi allenarti gareggiando contro il computer ma se vuoi assaporare il puro divertimento, non ti resta che sfidare un amico!
<br><br>
Questa è l'essenza di Pitstop II: nessuno ama correre da solo.
<br><br>
