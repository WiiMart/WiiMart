...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Considerado mundialmente uno de los mejores juegos producidos para la consola Sega Master System, y con algunas de las mejores animaciones en la versión original, Wonder Boy III: The Dragon’s Trap es la secuela directa de Wonder Boy in Monster Land. Este juego da comienzo justo donde terminó el anterior, y es el primero de la serie en el que Wonder Boy puede desplazarse libremente utilizando varias formas animales. Como en versiones anteriores del juego, Wonder Boy puede comprar varias armas, armaduras y objetos que le ayudarán en su aventura. ¡Añade esta joya a tu colección de Sega Master System!</div>
  <div id="image02">
