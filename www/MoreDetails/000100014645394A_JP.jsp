...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコン世代を代表する人気キャラクター「くにおくん」が大活躍する熱血高校スポーツシリーズです。氷上の格闘技とも形容されるアイスホッケーをベースに、個性的な必殺シュートやバラエティ豊かな登場チーム、そしてハチャメチャなラフプレイなど、くにおくんらしいアレンジが加えられた爽快なアクションスポーツゲームを楽しめます。くにおくんが活躍する舞台は、今度の対抗試合に負けると廃部になってしまう弱小熱血高校ホッケー部。落ち込むキャプテン「よういち」を見かねたくにおくんは、
ともにインターハイをめざします。独特な操作感で表現されたスピーディーなホッケーの競技性と、さらにテクニカルになったラフプレイが特徴です。また、各チームのユニフォームを選択することで特殊な能力を使うことができるようになるなど、バラエティに富んだプレイも楽しめます。シリーズおなじみの対戦、協力プレイでは、最大４人までの同時プレイも可能です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">いけいけ！熱血ホッケー部</span></div>
</div>
