...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主要なパーツだけで表現されたロボットたちがいきいきと動き回る、コミカルな動きと愛嬌のあるデザインが楽しいロボット格闘対戦アクションゲームです。突然ロボットによる世界征服を宣言したワルナッチ博士。彼のロボットに対抗できるのは、親友のイーモン博士のお笑いロボット「スカポン」しかいません。スカポンは仲間のロボを救いだし世界の平和を守るために戦います。ワルロボとの１対１の対戦は手ごたえ満点。パンチやキックはもちろん、ロボットの個性あふれるさまざまな必殺技が使えます。難しい操作も、充実の練習モード「マニュアル」で研究できるので安心です。１Ｐクエストモードを進めるとほかのモードで使えるロボットが増え、最大３６タイプの中からお気に入りを選んで対戦することもできます。当時流行しはじめた２Ｄ格闘ゲームを、ファミコンで誰でも楽しめるように実現した意欲作です。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ジョイメカファイト<sup>TM</sup></span></div>
</div>
