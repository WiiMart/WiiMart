...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158484C50')", "wiiSelectSound()");
...
Salta, corri e vola!
<br><br>
Lascia che Jett Rocket esplori il bellissimo pianeta Yoroppa e scopra perché sia stato attaccato dalla malvagia "Power Plant Posse". Visita isole tropicali, paludi nauseanti e ghiacciai gelati. Naviga sull'oceano sulla tua Barca a propulsione, gettati con il paracadute da enormi rupi, corri a tutta velocità per le regioni artiche sullo Snowboard a propulsione, oppure schizza in cielo con la Turbina a propulsione. Per combattere e salvare Yoroppa ti serve tutto ciò che hai!
<br><br>
Vesti i panni di Jett Rocket in questo futuristico gioco di azione-avventura in 3D!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484C50/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
