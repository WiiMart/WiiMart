...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Shock Troopers: 2nd Squad is een militair actiespel dat voor het eerst werd uitgegeven in 1998. Kies een van de vier huursoldaten en baan je al vechtend een weg door de obstakels heen door te springen en  schieten met verschillende wapens om te voorkomen dat een groot bedrijf helemaal van stapel loopt. Het op prijg gestelde scoresysteem van het vorige spel is weer aanwezig; alleen de personages zijn allemaal nieuw. Andere grote aanpassingen zijn de mogelijkheid om voertuigen te kunnen besturen en het feit dat je alleen routes hoeft uit te kiezen op belangrijke punten in het spel, waardoor het spelsysteem nog intuïtiever en makkelijker te managen is.<br><br>De software is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434750/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434750/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SHOCK TROOPERS ２ND SQUAD<sup>TM</sup></span></div>
</div>
