...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">オオカミにさらわれた子ブタの「プーヤン」を取り戻すため、ママとお兄さんの「ブーヤン」たちが協力して戦いを挑むアクションゲームです。風船につかまって続々と押し寄せるオオカミたちは、そのままにしておくとハシゴをのぼってかみついてきたり、ガケの上から岩を落としてきたりするので、弓矢や肉を上手に使って撃ち落さなければなりません。一方、オオカミもママに向かって石を投げてくるので、ゴンドラの屋根やかごの部分で防御します。決まった数のオオカミを倒すか、ピンク色の「ボスオオカミ」を倒せば、ステージクリア。童話のような世界観とかわいいキャラクターに加え、絶妙に計算されたゲームバランスが人気を呼んだヒット作です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">プーヤン<sup>&reg;</sup></span></div>
</div>
