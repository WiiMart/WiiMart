...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La première aventure en 3D de Kirby emmène notre puissante tête rose de Dream Land dans les étoiles où elle doit sauver ses amis d'un nouvel ennemi: le terrible Dark Matter.
<br><br>
Dans un décor frais et coloré, retrouvez les actions de Kirby que vous aimez tant. Avalez vos ennemis pour copier leurs capacités (le feu, la glace, etc.). Associez certaines d'entre elles pour obtenir des effets encore plus puissants. Essayez plusieurs formules, vous serez surpris!
<br><br>
Durant votre aventure, vous parcourrez des planètes faites de lave, d'eau ou encore de neige! Affrontez des boss géants tout en ramassant les éclats de cristaux que vous trouverez sur votre chemin. Kirby 64 offre également trois mini-jeux bonus pouvant rassembler jusqu'à quatre joueurs.<br><br>Texte écran en anglais.<br>La fonction vibration d’origine n’est pas disponible.</div>
  <div id="image02">
