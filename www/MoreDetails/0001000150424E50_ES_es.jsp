...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ninja Spirit es un juego de acción de desplazamiento lateral que sorprendió al mundo de los videojuegos con sus gráficos de precisión y gran jugabilidad. En este juego, el ninja Moonlight se enzarza en una batalla para vengar la muerte de su padre y desvelar los secretos de su nacimiento.
<br><br>
Elige entre el ARCADE MODE original y el PC-ENGINE MODE, que incluye una barra de vida. Usa 4 tipos de armas —katana, shuriken, bombas y kusarigama— para luchar contra tus enemigos. Coge objetos de mejora e intercambia tus armas para obtener ventaja. Ten en cuenta los ataques de tus enemigos y las características de tu arma para poder completar las 7 fases.
<br><br>
Usa tus habilidades y ataques para superar todos los enemigos y trampas. ¡Esto es verdadera acción ninja!
