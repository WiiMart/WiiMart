...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lords of Thunder es un shooter de acción horizontal que te mete en el papel de un guerrero legendario, destruyendo a enemigos acompañado de melodías heavy metal. Los enemigos planean revivir al “The Dark One, Zaggart” quien fue confinado bajo los seis continentes de Mistral. Ahora depende de Landis, descendiente de Dyu, el detenerlos. Tú escoges el orden de las seis fases. Antes de cada fase, selecciona una de las cuatro armaduras mágicas y utiliza cristales para comprar objetos. Seleccionar la armadura correcta para cada fase es la clave. Enfréntate a enemigos asombrosos como la serpiente marina que escupe fuego y un insecto gigante. Tanto si es disparar como irrumpir en la fortaleza del jefe, quedarás asombrado por la intensidad de Lords of Thunder.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000151415345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151415345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
