...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mit Mario & Yoshi hast du ein herausforderndes NES-Puzzlespiel gefunden, in dem du fallende
Charaktere ordnest und Eierschalen zusammensetzt, um Yoshis schlüpfen zu lassen.
<br><br>
Bewege Mario einfach hin und her, und tausche die Tabletts, um die fallenden Gumbas,
Buu Huus, Bloopers und Piranha-Pflanzen aufzufangen. Setze Eierschalen zusammen, damit aus dem fertigen Ei ein Yoshi schlüpft. Dieser ist umso größer, je mehr Kreaturen du dabei zwischen den Eierschalen einschließt. So erhöhst du auch deinen Bonus!
<br><br>
Bei Mario & Yoshi gibt es sogar einen Zwei-Spieler-Modus. So ist Luigi dann auch mit von der Partie.
<br><br>Englischer Bildschirmtext.
<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mario &amp; Yoshi<sup>TM</sup></span></div>
</div>
