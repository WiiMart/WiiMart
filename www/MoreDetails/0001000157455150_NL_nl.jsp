...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157455150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In EQUILIBRIO is het de bedoeling om de bal naar het eindpunt brengen. Als het eindpunt bereikt is, is het level klaar.<br>
Om de bal te verplaatsen, moet je het decor overhellen.Gebruik de Wii-afstandsbediening horizontaal. Als je de Wii-afstandsbediening overhelt, helt het decor ook over. Je kunt ook met het Wii Balance Board spelen.<br><br>
De bal is breekbaar dus laat hem niet van te hoog naar beneden laten vallen en vermijd dodelijke obstakels zoals scherpe punten en zuurbaden.
Je zult speciale ballen tegenkomen, hun gedrag worden tijdens het spel uitgelegd. De ballen hebben verschillende eigenschappen, de ene is gevoeliger dan de andere.<br>
Elk level heeft zijn eigen scorebord, probeer steeds de beste te zijn. Ben je goed genoeg om 64 levels door te komen?<br><br>
Je moet ook 25 opdrachten uitvoeren. Hierdoor gaat het percentage van de vooruitgang omhoog. De moeilijkheidsgraad wordt aangepast naar gelang de resultaten die je behaald hebt.<br><br>
Voorzien van Nederlandstalige schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157455150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">EQUILIBRIO</span></div>
</div>
