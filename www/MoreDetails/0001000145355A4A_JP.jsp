...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">セガ体感ゲームシリーズ第５弾となるバイクレースゲームです。体感ゲームの元祖『ハングオン』を大幅にパワーアップした続編で、今度は全世界を舞台にしたレースに挑戦します。難易度別に分かれたアジアやヨーロッパなど４種類のコースと、名曲ぞろいの４種類の音楽が選択可能。アップダウンの激しいコースを、新要素である「ターボ」を使うことで最高時速３２４キロで走り抜けます。バーチャルコンソールアーケード版では、通常のＷｉｉリモコンやクラシックコントローラに加え、ヌンチャクやWiiハンドルでの操作にも対応しており、専用筐体を使っていたアーケード版の雰囲気を味わうことができます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145355A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145355A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーハングオン<sup>TM</sup></span></div>
</div>
