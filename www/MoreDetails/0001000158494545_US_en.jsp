...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158494545')", "wiiSelectSound()");
...
<p>
Five chicks on your side, five chicks on the other...BOOM!
<p>
Beat the opposing chick team, but there is a twist! In chick chick BOOM, you throw pianos, pink elephants, and sumo chicks or summon slimy giant jellyfish and real UFOs. Draw lines in the arena to defend against your opponent's attacks—the skill lies in your use of ink, creativity and timing! And extra help is provided by a corncob and a piñata. Yes, really!
<p>
...
<p>
Features:<br>
• Single and Multiplayer: 1-4 (in a team or against each other)<br>
• Offensive Moves: More than 20 entertaining attacks<br>
• Three Arenas: City, Ship, and Haunted Wood<br>
• 15 Teams: Five available immediately and 10 others to unlock<br>
• Three Game Modes: Duel Mode, Time Mode, and Pro Mode<br>
