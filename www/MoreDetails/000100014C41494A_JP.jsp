...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">変化に富んだ大自然のコースをオフロードバイクで駆け抜けるアクションレースゲームです。アーケードで人気を呼んだ「セガ体感ゲーム」シリーズ第二弾の同名タイトルをベースにしたマスターシステム版です。コースに点在するジャンプ台を上手に利用しながら、ライバルのバイクやオフロードカーを追い抜きつつ、公道、海岸、雪道、遺跡地帯など全部で１０あるステージを転戦していきます。ステージクリア後は獲得ポイントに応じてパーツを購入し、バイクをチューンナップすることもできます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C41494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C41494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エンデューロレーサー<sup>TM</sup></span></div>
</div>
