...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">1987年にアーケードに登場して以来、斬新なゲームシステムと独特の世界観で一世を風靡した「R-TYPE」シリーズ。
その正統な続編として1993年にスーパーファミコンでオリジナル作品として発売されたのが「R-TYPEⅢ」。
3種類のフォースと9種類のレーザー、メガ波動砲に加え、波動砲の連射が可能となるハイパードライブモードを駆使して、襲いくる異形の攻撃型生命体“バイド”から地球を守ることがこのゲームの目的となります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｒ－ＴＹＰＥ Ⅲ<sup>&reg;</sup></span></div>
</div>
