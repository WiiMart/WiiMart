...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９０年にリリースされた横スクロールアクションゲーム。剣と魔法の世界を舞台に、魔法使いエルタが世界を救う冒険を繰り広げます。プレイヤーはショットとジャンプを駆使してゲームを進めますが、プレイ中に出現するエレメンタルを獲得することで変身し、攻撃力やジャンプ力を強化できます。獲得したエレメンタルの組み合わせによって効果が異なり、ウォーターマン、ドラゴンウォーリア、シノビ、サムライ、ポセイドンといったさまざまな姿に変身することが可能。状況に合わせてうまくエレメンタルを組み合わせるのが攻略のコツです。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マジシャンロード</span></div>
</div>
