...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157413545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡La situación es crítica, detective! Cinco diamantes de valor incalculable han sido robados en los museos más importantes del mundo. El Jefe quiere lo mejor de ACME en este caso, y con ello se refiere a ti, detective. Está convencido de que puedes poner fin a los malvados planes de Carmen Sandiego de una vez por todas.
<p>
Carmen Sandiego y V.I.L.E. han vuelto y solo tú puedes desbaratar sus planes. Viaja por el mundo, resuelve acertijos matemáticos y enfréntate a la ladrona más famosa del planeta. Resuelve el caso "Island of Diamonds" en el Story Mode (Modo de historia) para un jugador. Perfecciona tus habilidades matemáticas en el Practice Mode (Modo de práctica) para un jugador. Desafía a familiares y amigos a resolver acertijos contra reloj en Multiplayer Mode (Modo multijugador). Con Carmen Sandiego: Adventures in Math, tu destreza matemática será la mejor arma para luchar contra el crimen. Ideal para niños de 10-11 años. Los acertijos incluyen aritmética, lógica ¡y mucho más!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157413545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Island of Diamonds</span></div>
  </div>
