...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158494350')", "wiiSelectSound()");
...
<br><br>
You embody major Gods from the most fabulous mythologies: Scandinavian, Egyptian, Roman and Japanese. As a god, you have enough power to rule the humans.  All but cheeky ones! Some of them want to enter your domain. They have decided to build a tower to confront you.
<br><br>
...
- 2-player special mode in split screen</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494350/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
