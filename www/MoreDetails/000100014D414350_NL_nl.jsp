...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dr. Robotnik is hard op weg alle muziek en plezier op Mobius uit te roeien met zijn gigantische, robotiserende Mean Bean Steaming Machine. Breng bonen van dezelfde kleur bij elkaar, versla Robotniks bewakers en word de held van de dag, voordat de kwade geleerde alle inwoners van Beanville in robots verandert!<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans<br>Het spel is voorzien van Engelse schermteksten.<br>Geen ondersteuning van de interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414350/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414350/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dr. Robotnik’s</span></div>
</div>
