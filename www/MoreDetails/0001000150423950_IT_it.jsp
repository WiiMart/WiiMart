...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dimostra la tua abilità in ben 18 eventi olimpici in quest’entusiasmante gioco sportivo. Cimentati in 6 tipi di eventi sportivi che comprendono: TIRO AL BERSAGLIO, TIRO CON L’ARCO, CANOTTAGGIO, NUOTO e ATLETICA LEGGERA （TRACK ＆ FIELD）.
<br><br>
Il gioco comprende una modalità OLIMPIADI, in cui gli atleti devono affrontare tutte le prove, e una modalità ALLENAMENTO che ti permetterà di scegliere l’evento da giocare.
Migliora le tue capacità tecniche e atletiche con l’ALLENAMENTO e affronta la modalità OLIMPIADI per vincere quante più medaglie d’oro possibili e per stabilire nuovi record mondiali!
<br><br>
Divertiti da solo o con i tuoi amici! Fino a 5 giocatori possono sfidarsi e vivere tutte le emozioni di una vera competizione agonistica! Sei pronto per gareggiare?
<br><br>Quando giochi nella modalità per più giocatori, il numero di telecomandi Wii dev'essere uguale al numero di giocatori.
...
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150423950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150423950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">World Sports Competition</span></div>
</div>
