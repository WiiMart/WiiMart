...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mah-Jongg, el antiguo pasatiempo, ha sido reinventado como un videojuego interactivo en el que cada pareja de fichas que retires podría ser la última. Descubre su encantadora música, las divertidas animaciones y los emocionantes obstáculos incluidos en este juego de mesa que te enganchará durante horas.
<br><br>
Este título clásico te desafía para que encuentres parejas de fichas de forma que se eliminen hasta vaciar el tablero. ¡Juega al Shanghai II tradicional o lleva el juego a una nueva dimensión con Dragon’s Eye! 
<br><br>
No te dejes engañar por la simplicidad de las reglas. ¡La profundidad y complejidad de este desafío se convertirán en tu nueva obsesión!
<br><br>
