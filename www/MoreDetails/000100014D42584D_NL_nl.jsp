...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De diepzee-avonturen van Ecco komen tot leven voor een nieuwe generatie spelers! In dit kindvriendelijke spel gaat onze jonge held Ecco Jr. naar open zee met een aantal verschillende taken die hij moet voltooien om zijn doel te bereiken. Samen met zijn vrienden, Tara de kleine orka en Kitnee de jonge dolfijn, maakt Ecco Jr. kennis met zeeleeuwen, zeepaarden en andere oceaanbewoners tijdens zijn zoektocht naar Big Blue. Laat je kinderen kennismaken met de tijdloze Ecco the Dolphin-serie en download Ecco Jr. vandaag nog!
<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42584D/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42584D/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ecco<sup>TM</sup> Jr.</span></div>
</div>
