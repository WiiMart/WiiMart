...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100014843484A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『出前チャンネル』は、Ｗｉｉを使って近所のお店から出前をとることができる、夢の街創造委員会株式会社提供のサービスです。<BR><BR>
Ｗｉｉに登録した住所をもとに、出前が可能なお店が、ピザやおすしなど料理のジャンル別に表示されます。写真を見ながらお好きな料理をご注文ください。<BR><BR>
また、当日注文だけでなく、明日以降の予約注文をしたり、ご注文金額などに応じてお店の特典を受けたりすることもできます。<BR>
（一部店舗を除く）<BR><BR>
商品の代金は、配達したお店の方に直接現金でお支払いください。<BR><BR>
※クレジットカードや<BR>
　Ｗｉｉポイントでのお支払いは<BR>
　できません。<BR><BR>
ゲームをしていておなかがすいた…そんなとき、出前チャンネルでおなかを満たしてみませんか？<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100014843484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">出前チャンネル</span></div>
</div>
