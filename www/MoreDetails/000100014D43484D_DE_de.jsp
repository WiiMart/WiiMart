...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">MUSHA ist ein Spiel für SEGA MEGA DRIVE. Bei Scrolling-Shooter-Fans findet es aufgrund der intensiven und packenden Action großen Anklang. 
<br>
Im Spiel schlüpfst du in die Rolle des Mädchens Terri und bestehst Abenteuer in deiner M.U.S.H.A.-Panzerung (Metallic Uniframe Super Hybrid Armor). Terri muss einen außer Kontrolle geratenen Intellicomputer namens Dire 51 zerstören, der einen Großangriff auf die Menschheit plant. 
<br>
Setze Spezialwaffen wie "Laserstrahl", "Radioaktive Bomben" und "Defensivdetonator" ein, um den Feind zu besiegen. Nutze in sieben spannenden Levels Angriffsoptionen für sechs Arten von Formationsfeuer und zerstöre Dire 51 ein für allemal!
<br><br>
