...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">硬派なキャラクターで人気の「くにおくん」が、ドッジボールで対決する人気対戦スポーツゲームのＰＣエンジン版です。通常のドッジボールのルールとは異なり、ボールをぶつけて選手の体力をゼロにすることで敵選手を倒すことができます。制限時間内にコート内にいる敵選手を全員倒せば勝利となります。超強力な２種類の「必殺シュート」を使いこなすことが勝利への近道です。ＰＣエンジン版オリジナルの「くえすともーど」は、いたずら者の宇宙人を探すという一風変わった内容です。各国を飛び回りドッジボールで対戦。試合に勝つと敵チームのエースが仲間になり、宇宙人の行方のヒントをもらえます。試合の中で敵チームに隠れている宇宙人を見つけてください。２人での対戦プレイも可能です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015044414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015044414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">熱血高校ドッジボール部<sup>&reg;</sup> PC番外編</span></div>
</div>
