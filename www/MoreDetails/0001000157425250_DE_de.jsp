...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157425250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pirates: The Key of Dreams ist ein rasantes Ballerspiel auf dem Wasser. Sie kreuzen unter Segeln durch die Karibik, lassen die Kanonen sprechen, machen fette Beute, umgehen Blockaden und nehmen es zu guter Letzt mit Schwarzbart persönlich auf.
<br><br>
Der Spieler schlüpft in die Rolle eines Kapitäns, der in streng geheimer Mission als unbarmherziger Pirat ausgeschickt worden ist und den "The Key of Dreams" wiederbeschaffen soll, ein wertvolles und mit einem gefährlichen Fluch belegtes Artefakt. Es gilt zum einen, Schiffbrüchige zu retten, um die Mannschaft des eigenen Schiffs zu verstärken, und zum anderen, durch Erledigung der Aufgaben Erfahrung zu sammeln, um Fertigkeiten rund um Navigation, Waffen, Panzerung und Kartografie zu verbessern. Sammeln Sie zunehmend
mächtigere Waffen, darunter Raketen, Minen, Kettenkugeln, Sägeblätter und ein Flammenwerfer, um Ihren Feinden mit handfester
Zerstörungskraft zu begegnen.
<br><br>
Bestreiten Sie Arena-Multiplayer-Kämpfe in sieben thematisch ausgestalteten Umgebungen und 35 Leveln gegen bis zu drei Freunde oder KI-Gegner. Wählen Sie Ihr Schiff entsprechend Ihrem Spielstil unter verschiedenen Schiffstypen aus. Und wenn Sie Pirat genug sind, spielen Sie im Turbo-Modus!
<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157425250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157425250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pirates: The Key of Dreams</span></div>
</div>
