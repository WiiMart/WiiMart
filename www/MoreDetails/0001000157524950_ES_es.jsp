...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157524950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En “Rainbow Islands: Towering Adventure!”, los jugadores tomarán el control de Bubby o de Bobby, quienes usan el arco iris como arma. Ellos deberán escalar las 7 divertidas áreas de una torre que llega hasta el cielo mientras se defienden de sus enemigos usando sus poderes arco iris.<br><br>

Terribles jefes, controlados por el genio científico Dr. Crescent, esperan a los jugadores al final de cada área. ¡Apresúrate para lograr alcanzar a Holly, la estrella del color del arco iris!<br><br>

Existen 3 modos de juego. Podrás disfrutar la historia de la estrella Holly en el modo historia. En el modo desafío tendrás que llegar tan alto como puedas, empezando desde el suelo. Finalmente, en el modo contrarreloj podrás elegir un área para ver cuánto tardas en llegar a la cima.<br><br>

¡“Rainbow Islands: Towering Adventure!" es un alucinante juego de acción en donde usarás el poder del arco iris para llegar al cielo!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
