...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８６年に発売されたファミコン版「スターソルジャー」の続編ソフト。小型戦闘機「ネオ・シーザー」を使って、地球を侵略するマザーブレイン率いる最強軍団と戦います。ノーマルゲームは全８ステージから構成され、ステージ７を除く各ステージの最後にはボスキャラが待ちうけています。連射が気持ちいいシューティングゲームの定番。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041454A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041454A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパースターソルジャー<sup>&reg;</sup></span></div>
</div>
