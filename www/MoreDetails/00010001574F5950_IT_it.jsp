...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574F5950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Preparati per il viaggio più spettacolare nella storia dei videogiochi!! <br>
Accompagna Kubi il Bit Boy in una pazza avventura pixellosa e affronta orde di mostri malvagi in: <br>
<br>
- sotterranei a 4 bit, <br>
- caverne a 8 bit, <br>
- roccaforti a 16 bit, <br>
- labirinti a 32 bit, <br>
- arene a 64 bit e <br>
- mondi a 128 bit!! <br>
<br>
Salva gli amici di Kubi!! <br>
Vai alla ricerca dei frutti e stabilisci nuovi record!! <br>
Chiama un amico e divertitevi in modalità Cooperativa!! <br>
<br>
Usa il telecomando Wii come joystick e che l'avventura arcade abbia inizio!!
<br><br>
