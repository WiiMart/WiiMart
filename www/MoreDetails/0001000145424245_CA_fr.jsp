...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">FIGHTER'S HISTORY DYNAMITE is a fighting game that was released in 1994. In this sequel to the well-loved FIGHTER'S HISTORY, the action takes place once again at the martial arts tournament the Great Grapple. This time, thirteen combatants have emerged to test their skills against the best of the best. Notable playing features include a wide range of secret attacks, a weak spot system that assigns a vulnerable area to each fighter, and the introduction of the original bosses Clown and Karlov as playable characters. The bull from the bonus stage of the Data East classic Karate Champ will also make a special appearance if you are able to clear certain secret conditions.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FIGHTER'S HISTORY DYNAMITE</span></div>
</div>
