...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le Mah-Jongg prend un coup de jeune dans cette version interactive où chaque mouvement de tuiles pourrait bien être le dernier ! Découvrez la musique envoûtante, les animations soignées et les défis passionnants de ce jeu de plateau dont vous ne pourrez plus vous passer. 
<br><br> 
Le principe de ce classique est simple : vous devez éliminer toutes les tuiles du plateau en les associant par paires identiques. Vous pouvez jouer au traditionnel Shanghai II ou vous lancer dans un défi unique avec Dragon’s Eye ! 
<br><br> 
Mais méfiez-vous : le jeu se révèle plus sophistiqué qu’il n’y paraît et risque fort de devenir votre nouvelle passion ! 
<br><br>
