...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９０年にリリースされたパズルゲームです。プレイヤーは上から落ちてくる様々な形のブロックをうまく並べて消し、塔の最上階を目指す主人公の通り道を作ります。無事に画面の上まで主人公が到着すれば次のステージへと進めますが、各ステージには初期配置として既にある程度のブロックが並べてある他、３倍の耐久力を持った特殊なブロック、浮遊機雷や高圧線といったトラップなども多数登場。あの手この手で主人公の行く手を妨害します。華麗なブロックさばきはもちろん、ゲージを溜めることで使用可能になるライトニングボールなどを駆使しながら、全１２０面を攻略してください。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ジョイジョイキッド</span></div>
</div>
