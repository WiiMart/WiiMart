...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El Red Baron, de la nación que ama la paz y la libertad, Bird Land, se enfrenta en lo alto de los cielos con su rival Blue Max en este juego de acción horizontal tipo shooter.  Derrota al sin fin de enemigos que te esperan mientras completas tu misión, utilizando movimientos como el de “loop-the-loop” para derrotar al enemigo de espaldas, Vuela bajo para poder agarrar bombas y tirarlas sobre los puestos de comando, buques de guerra, u otros objetivos designados para destruirlos. Luego aterriza cuidadosamente en una base para proceder a la siguiente misión. Ten cuidado del fuego enemigo – ya que te hará chocar, a menos que puedas recuperarte al rápidamente oprimir los botones. Podrás hasta jugar con una segunda persona y volar simultáneamente, algunas veces ayudándose entre si y otras compitiendo contra cada uno.  ¡Prepárate y lánzate a los cielos, pero asegúrate que la música de fondo (la que instantáneamente se hizo popular cuando el juego fue estrenado originalmente) te distraiga de llegar a tu meta!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146454345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146454345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SKYKID<sup>TM</sup></span></div>
</div>
