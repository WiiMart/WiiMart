...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157423245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Háganse a un lado, típicos héroes de acción! Strong Bad ha llegado para enseñarte cómo se hace una artesanal pieza maestra de cine, Dangeresque 3: The Criminal Projective. Serás Dangeresque, un policia corrupto que busca un poco de acción y sacos llenos de dinero. ¿Podrá nuestro héroe permanecer vivo para vencer a sus archienemigos, salvar al mundo y conseguir a la chica? Parece que va a tener que saltar... Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157423245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157423245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
