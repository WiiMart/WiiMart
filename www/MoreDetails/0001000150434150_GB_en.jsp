...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Make your way through a dungeon-like space station and defeat the prowling monsters, in this real-time first-person shooter.
<br><br>
You’re a member of the elite Debuggers, a group of multi-talented warriors, and have been assigned to inspect an unmanned space station. You have exactly 100 minutes to get in, destroy the monsters lurking in each Block, make your way to the lowest level and deactivate the automatic detonator placed there.
<br><br>
With each monster that you let slip by, the Core Block becomes harder to survive in, so speed is crucial in saving the facility and each separate Block.
Experience the thrill of survival as the timer ticks away and you uncover the truth of the events that have occurred...</div>
  <div id="image02">
