...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750544A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファンタジックシリーズ第２弾！迫り来るキューブを壊していく新感覚シューティングパズルゲームが登場！惑星を全て四角くしようとたくらむ「ギャラクシー一族」との壮絶な戦いを繰り広げる『ストーリーモード』、制限時間内にどこまでキューブを消せるか争う自分との戦い『チャレンジモード』、家族や友達と戦うことができる『２人対戦モード』、全国のプレイヤーと戦うことができる『Wi-Fi対戦モード』など、パズルゲームとは思えない大ボリュームでお届け！目指せ「キューブマスター」！！</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750544A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファンタジックキューブ</span></div>
</div>
