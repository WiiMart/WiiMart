...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157545245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP BEAT brings retro action back as you use the Wii Remote controller’s motion sensor to bounce beats in this rhythm game. Retro visuals, classic game play, four-player multiplayer, and an 8-bit soundtrack will get you in the zone and rock your world. Pay attention, though! Like most classic games, the challenges are mighty. If you can stay cool as the difficulty increases, you’ll discover the beginnings of the BIT.TRIP saga...<br>
Everything comes from something.<br>
We were before we became. From life comes rhythm, and from rhythm comes life.<br>
We are beings of information.<br>
Everything is a conduit for learning.<br>
We communicate in bits and bytes.<br>
And we will return to something once we become nothing.<br>
After our BIT.TRIP is complete.</div>
  <div id="image02">
