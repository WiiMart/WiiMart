...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157585050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paint Splash trasforma la tua TV in una tela interattiva dove bambini di ogni età possono divertirsi a dipingere utilizzando il Wii Remote. Possono dipingere sino a quattro partecipanti contemporaneamente così che tutta la famiglia possa creare dei dipinti fantastici utilizzando solamente il Wii Remote.
<br>
