...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574D5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">le monde de miffy est un jeu en 2D inspiré du personnage créé par Dick Bruna. Dans le monde de miffy, le joueur incarne Miffy : il explore différents univers et doit remplir des objectifs simples en interagissant avec des amis ou des objets à travers des mini-jeux éducatifs.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5750/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">le monde de miffy</span></div>
</div>
