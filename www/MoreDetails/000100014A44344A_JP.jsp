...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">２人同時プレイが楽しめる横スクロール格闘アクションゲーム。舞台は架空の街ネオ・シスコ。謎の格闘家キンターク率いる組織「ジョウカル」によってさらわれた妹、ユリアの救出のため、ネオ・シスコ警察のリック・ノートン、そして２人の兄貴的な人物であるネオ・シスコ州警察巡査部長ダグラス・ビルドが立ち上がる。ノートンはスピードを生かしたスライディングやキック攻撃、ビルドは元プロレスラーならではのパワーあふれる技を駆使して闘う。路上に落ちているアイテムを利用した攻撃も可能。一定量のダメージを受けると怒りは頂点に達し、怒りモードが発動する。この間は全身が発光して無敵状態になり、大技を繰り出せるようになる。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ラッシング・ビート</span></div>
</div>
