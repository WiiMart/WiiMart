...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015745394A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">PCエンジンで人気を博したアクションピンボールゲーム「エイリアンクラッシュ」が、Wiiならではの操作感と新たなゲーム性を加えて「エイリアンクラッシュ・リターンズ」として甦りました。<BR>発射装置からボールを発射してフリッパーでボールを打ち返すという単純明快なピンボールの魅力に、ゲームならではの要素“アクションボール”や美しくもグロテスクな世界観がプレイヤーを魅了します。<BR>また、実際のピンボールのテクニックである「盤面揺らし」をWiiリモコンで再現。<BR>さらに、Wi-Fi機能を使えば、最大4人までの対戦プレイやランキング、エクストラステージのダウンロードなども楽しむことが可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015745394A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015745394A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
