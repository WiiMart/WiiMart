...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti à l’origine en 1990, NAM 1975 est un jeu de tir à la troisième personne. Vous incarnez un soldat des Forces Spéciales Américaines sur un champs de bataille des plus hostile. Déplacez vous sur l’écran, de gauche à droite, afin d’éviter les ennemis acharnés　qui proviennent de l’arrière-plan. Votre arme de prédilection: la mitraillette. Des grenades et autres projectiles sont également à votre disposition. Obtenez de nouvelles armes grâce aux bonus. Pour vous sortir des situations les plus casse-coups, une seule solution: courir! <br><br>Texte écran en anglais.</div>
  <div id="image02">
