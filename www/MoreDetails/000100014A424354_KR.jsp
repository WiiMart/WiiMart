...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">커비가 볼이 되어 적을 쓰러뜨리고 최종적으로 컵 인을 목표로 하는 골프와 당구의 요소가 있는 게임입니다. 볼이 된 커비를 움직여서 적을 쓰러뜨리고 장애물을 피하면서 커비를 컵 인시키면 1홀이 종료됩니다. 부딪친 적의 카피 능력을 잘 활용하면 타수를 줄일 수 있습니다. 두 명의 플레이어가 획득한 점수를 겨루는 대전 모드도 즐길 수 있으며 둥글고 귀여운 커비의 모습도 매력적입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424354/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424354/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">커비 볼<sup>TM</sup></span></div>
</div>
