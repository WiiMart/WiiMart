...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157524650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Reel Fishing ha vuelto! Esta secuela del famoso juego de pesca te lleva a nuevos escenarios con prístinas aguas repletas de peces con un aspecto y movimiento superrealistas.<br> ¡Utiliza una amplia variedad de cebos para pescar a los astutos peces, y disfruta de una pesca más realista y natural que nunca gracias a las mejoras introducidas en el sistema de control! ¡No te confíes!<br> ¡Tendrás que utilizar todos los recursos que estén a tu alcance para superar las 30 misiones que te ofrece Reel Fishing Challenge II y demostrar que eres un as de la pesca!  <br><br>
