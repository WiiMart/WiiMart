...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157485250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Heron: Steam Machine gaat over een fabriek waar rubber eendjes worden gemaakt met een gigantische stoommachine. Deze stoommachine heeft vier verschillende meters, en om te voorkomen dat de stoommachine zal exploderen, moeten deze meters goed in de gaten worden gehouden.
<br><br>
Door het aanleggen van een buis verdien je punten. Dit zal de druk van de betreffende meter doen zakken. Op deze manier moet je de stoommachine operationeel houden. Wanneer de druk te groot wordt, en een van de meters zijn maximum bereikt, zal de stoommachine exploderen en is het spel voorbij.
<br><br>
In de multiplayer mode moet je samenwerken om de stoommachine draaiende houden. Het veld zal verdeeld worden onder het aantal spelers dat mee doet aan het spel, elk met een eigen achtergrondkleur. Elke speler is verantwoordelijk voor zijn of haar eigen veld, en dus zal je moeten samenwerken om een complete buis aan te leggen.
<br><br>
