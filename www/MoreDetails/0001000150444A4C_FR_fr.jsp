...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un classique parmi les versions de Street Fighter II venu tout droit de la PCEngine (Turbografx16). A l’époque, la grande capacité de la HuCARD permit d'adapter fidèlement le jeu d'arcade avec ses niveaux bonus et ses superbes effets sonores.
<br><br>
Choisissez entre douze personnages et affrontez vos rivaux dans un combat sans merci pour devenir le champion des champions. Maîtrisez les coups spéciaux des personnages et combinez-les pour vaincre vos adversaires venus du monde entier!
<br><br>
Dans le mode « V.S. BATTLE », vous disposez d’une fonction de handicap qui vous permet d’ajuster la force de chaque combattant. Ainsi, un joueur novice et un joueur expérimenté peuvent se mesurer l’un à l’autre dans un match à égalité de force! 
<br><br>
