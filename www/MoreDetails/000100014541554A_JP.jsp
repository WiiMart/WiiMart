...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年にリリースされた対戦型シューティングゲームです。ゲームは左右に分割された画面上で行われ、画面上から押し寄せてくる敵を、ショット、溜め撃ち、ボムなどで倒していきます。本作では敵キャラは爆発すると周りにいる敵を誘爆 ( 連鎖 ) する性質があり、積極的に連鎖を作ることで対戦相手の画面にお邪魔キャラを送り込んで、相手のプレイを妨害できます。ちなみに相手から送り込まれてきたお邪魔キャラを撃ち返すこともできるので、状況によっては壮絶なお邪魔キャラ応酬が展開されます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ティンクルスタースプライツ</span></div>
</div>
