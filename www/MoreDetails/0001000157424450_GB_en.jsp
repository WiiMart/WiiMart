...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157424450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Brain Drain is a funny and addictive puzzle game.<br>
You have to place the elements of a scrambled puzzle according to a given model.<br>
Three game modes:<br>
Challenge: have 200 fixed puzzles with preset best times to solve and beat.<br>
Race: 4 difficulties. A stream of puzzles and best time tables to beat.<br>
Random: relaxed random puzzling, endless...</div>
  <div id="image02">
