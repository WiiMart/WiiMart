...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574F5450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Overturn Mecha Wars is a head-to-head fighting tournament where players control futuristic mechs loaded with high-tech weapons.
<br>
The aim of the game is to blast the opponent while trying to avoid their incoming attacks, aiming to be the last one standing.
<br>
Players can customise each of the eight machines, selecting from an array of special weapons that players accumulate as they progress through the tournament. 
<br>
The game can be played with one or two players locally (split screen).
<br>
Players can also control their mechs by shifting their weight around on the Wii Balance Board!
<br>
Overturn Mecha Wars supports English, French and German languages.</div>
  <div id="image02">
