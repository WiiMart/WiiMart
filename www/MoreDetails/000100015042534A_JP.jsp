...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">悪の妖術師「チューマンフー」にのっとられた「聖なる塔」を舞台に、仙人見習いの少女「リンリン｣｢ランラン｣が活躍する、一風かわったアクションパズルゲームです。プレイヤーは各ラウンドに配置された４色のボールを押したり引いたりして、同じ色のプレート上まで移動させます。塔の中では敵配下の魔物たちがプレイヤーの行く手をさえぎりますが、ボールをキックする事で、敵を倒したり壁を壊すことも可能です。ピンチを切り抜け、全てのボールを決められたプレートに移動させるとラウンドクリアとなり、続く新たなラウンドに挑戦できます。また、通常のプレイのほかにも、２Ｐ対戦のミニゲーム｢キックボール｣や、オリジナルステージを作成できる｢エディットモード｣があり、一味ちがった楽しみ方も用意されています。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BE BALL<sup>&reg;</sup></span></div>
</div>
