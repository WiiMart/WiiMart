...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In un regno dove la musica è l’unico linguaggio, un malvagio tiranno giunto dal nord si è impossessato del castello, al cui interno ha imprigionato la regina e nascosto tutti gli strumenti musicali della terra!
<br><br>
Il nostro eroe, Milon, decide di combattere il malvagio tiranno per salvare la regina e recuperare le sue magiche Sfere di cristallo. Ad aiutarlo in questa impresa avrà solo la sua abilità e delle bolle magiche. Aiuta Milon a compiere la sua ardua missione: scopri le porte nascoste, trova gli oggetti segreti e sconfiggi i feroci nemici! Controlla sempre le stanze del castello dove puoi acquistare oggetti e suggerimenti. 
<br><br>
Infine cerca i Carillon, grazie ai quali Milon sarà trasportato in un livello bonus! Per ogni strumento musicale che troverai all'interno di questi livelli, si aggiungerà una voce alla musica di sottofondo del videogioco. Cerca di scovare tutti e sette gli strumenti, in modo da creare una colonna sonora degna di questo videogioco epico!
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014642534D/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642534D/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Milon's Secret Castle</span></div>
</div>
