...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">City Connection fue lanzado en 1988 para la NES. En este juego, un joven de California conduce por carreteras de todo el mundo su 4x4 hecho a medida con el objetivo de recorrerlas hasta el último rincón. Los tramos que vayas completando irán cambiando de color, pero cuidado, porque tendrás que eludir los coches de policía, los gatos estorbo y los brotes de bambú que aparecerán en tu camino.
<br><br>
