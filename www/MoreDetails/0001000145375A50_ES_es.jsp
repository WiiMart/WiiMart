...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En The Tower of Druaga, un clásico de los que marcaron época, deberás acometer el desafío de rescatar a tu amada en una torre plagada de peligros.
<br><br>
Gilgamesh, Gil para los amigos, está en apuros. Quien ha secuestrado a Ki, su prometida, no es ni más ni menos que el abyecto demonio Druaga. Para salvarla tendrá que llegar a la cima de la torre, lo que implica superar sesenta niveles enrevesados y sembrados de todo tipo de trampas.
<br><br>
Pertrechado solamente con su espada y su escudo, Gil se las verá con monstruos y laberintos y deberá encontrar la llave que da acceso a cada uno de los pisos. Entretanto, tendrá tiempo de explorar el terreno y, con un poco de suerte, encontrar los tesoros que la torre oculta en sus entrañas. Aunque solo consiguiera apoderarse de unos pocos de esos tesoros, Gil sabe que se haría rico... pero para eso habrá que salir con vida de la torre.
<br><br>
Ki depende de ti, así que no te lo pienses más: ¡Acepta el reto de The Tower of Druaga!
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145375A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145375A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Tower of Druaga<sup>&reg;</sup></span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Virtual Console Arcade</div>
</div>
</body>
</html>
