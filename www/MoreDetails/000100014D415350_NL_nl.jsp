...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In het jaar 2049 is de mensheid gedwongen om de zwaar vervuilde aarde te verlaten en op zoek te gaan naar andere planeten om te koloniseren. De mechanische Orbots blijven achter om de rotzooi op te ruimen. Wanneer er bij WarHead, de leider van de Orbots, een paar stoppen doorslaan en hij een oorlog onder de robots veroorzaakt, is VECTORMAN, piloot van een vuilnisschip, de enige die bereid is om de strijd met hem aan te gaan.
<br><br>
In dit oorlogsavontuur verander je in een supersnelle trein, een boormachine, een robotvis of een krachtige woestijnbuggy. Rust jezelf uit met wapens en gebruik gedaanteveranderingen en power-ups om WarHead te verslaan en de vrede op aarde te herstellen.
<br><br>De handleiding is alleen beschikbaar in het Engels, Frans, Duits, Spaans en Italiaans.<br>Het spel is voorzien van Engelse schermteksten.<br>Geen ondersteuning van de interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D415350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D415350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">VECTORMAN<sup>TM</sup></span></div>
</div>
