...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157424450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Brain Drain è un gioco di puzzle divertente e avvincente.<br>
Devi posizionare i pezzi di un puzzle disordinato prendendo come modello un’immagine.<br>
Ci sono tre modalità di gioco:<br>
- Sfida: 200 puzzle con dei record prefissati da risolvere e battere. <br>
- Gara: 4 livelli di difficoltà. Una serie di puzzle e record da battere. <br>
- Casuale: gioca con tranquillità in modo casuale e infinito.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424450/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424450/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Brain Drain<sup>TM</sup></span></div>
</div>
