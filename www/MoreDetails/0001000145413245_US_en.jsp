...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Released in 1998 by SNK, Metal Slug 2 is a side-scrolling military-action game. Players choose from Marco, Tarma, Eri, and Fio and then set their sights on wiping out Morden's newly remobilized Rebellion Army. Just like the original Metal Slug, players blaze a trail by shooting and jumping, but Metal Slug 2 adds a new arsenal for you to command, including a heavy machine gun, a shotgun, and even a laser gun, providing players a battle rich with variety to enjoy. Not only that, but battle effects are packed in as well--players turn into mummies after getting caught in poison gas coughed up by mummies. Characters also turn fat, but get an attack-strength upgrade, after picking up too many food items. Naturally, as two-player action is supported, players can have a blast with their friends as well.</div>
  <div id="image02">
