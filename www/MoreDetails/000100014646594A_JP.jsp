...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ロックマン」シリーズの第五弾。<BR>２０ＸＸ年、Dr.ワイリーとの戦いに明け暮れるロックマンも、前回の戦いから２ヶ月が経ち、しばらくの休息をとっていました。しかし、ライト博士からの連絡で事態は急変します。「はっきり確認はできんが、ブルースが謎のロボット軍団を率いて都市を攻撃しているらしいんじゃ！」急いで引き返したロックマンが見たものはライト博士をさらっていくブルースの姿でした。<BR>ブルースはなぜライト博士をさらったのか、なぜロボット軍団を率いて都市を攻撃したのか、謎のロボット軍団を率いるブルースＶＳロックマンの戦いの火ぶたは今、切って落とされた。<BR>「エディー」に続くサポートキャラ「ビート」、ライフエネルギーと武器エネルギー両方を回復できる「ミステリー缶」が初めて登場した作品です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン<sup>&reg;</sup>５</span></div>
</div>
