...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９７８年にアーケードゲームとして登場し、社会現象を巻き起こしたシューティングゲームです。<BR>迫りくるインベーダーをビーム砲台で迎撃してください。<BR>すべてのスペースインベーダーを撃ち落とせば、ステージクリアです。<BR>ビーム砲台のストックがなくなったり、インベーダーに陣地を占領されてしまうとゲームオーバーになります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014536594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
