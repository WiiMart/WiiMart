...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574E4545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Conviértete en el rey de la pesca! Los pingüinos están hambrientos y necesitan de tu ayuda para alimentarse… ¡Atrapa el mayor número de peces posible antes de que alguien te los gane! En este apasionante juego la estrategia es primordial. Avanza mas rápido que los otros pingüinos para no quedarte encerrado e intenta acceder a los témpanos de hielo que guardan más peces. En Penguins & Friends pueden participar de 1 a 4 jugadores. ¿Cómo se juega? El tablero está compuesto por trozos de hielo bajo los cuales hay un determinado número de peces (1, 2 o 3). Estos trozos de hielo son hexagonales y forman una estructura similar a una colmena. La posición inicial de dichos trozos de hielo podrá ser cambiada para crear distintos tableros de juego. Cada jugador dispone de un número determinado de pingüinos (dependiendo del número de jugadores de la partida y del tamaño del tablero) los cuales harán la función de fichas para jugar.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E4545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E4545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
