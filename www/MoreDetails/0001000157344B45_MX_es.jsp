...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157344B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Pon a prueba tu habilidad como cazador en Deer Captor!
<p>
Deer Captor es un juego de acción con pistola de luz que ofrece una experiencia de caza que atrapa. Después de elegir entre un rifle o una ballesta, los jugadores pueden poner a prueba su puntería, tratando de capturar gran variedad de fauna salvaje, como ciervos, liebres y milanos, cómodamente desde su salón. Trata de conseguir una puntuación alta en el Modo Instantáneo, donde el objetivo es capturar tantos animales como puedas durante el tiempo límite, o pon a prueba tu valor en el Modo Misión, donde debes cumplir una serie de objetivos para subir hasta lo más alto del mundo de la caza.
<p>
Juega contra tus amigos y familiares en competencias amistosas, o incrementa tu puntuación en el modo de un jugador en la clasificación online para dártelas de buena.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157344B45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157344B45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Deer Captor</span></div>
</div>
