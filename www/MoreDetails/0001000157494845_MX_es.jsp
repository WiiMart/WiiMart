...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157494845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Play with Birds es un juego original de pájaros animados que ofrece a los usuarios de todas las edades la experiencia única de jugar como un ave. Vuela por la ciudad, completa una docena de minijuegos para pájaros, como Birdman, Catch Thief!, Bird race!, y muchos otros. ¡Obtén la fama y encuentra a otra ave con la que compartir un nido!
<p>
Play with Birds se centra en las aventuras de un joven pájaro de ciudad, a lo largo de su vida, desde que sale del cascarón hasta que encuentra a un compañero con quien crear un nido y formar una familia. ¡Completa los minijuegos, obtén la fama en la comunidad aviaria, construye un nido y crea una familia!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157494845/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157494845/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Play with Birds</span></div>
</div>
