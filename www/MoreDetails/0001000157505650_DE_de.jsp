...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157505650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In einem zerfallenden Herrenhaus verbirgt sich ein äußerst sonderbares Bilderbuch. Nimm all deinen Mut zusammen und öffne die Tür zu dieser merkwürdigen, beunruhigenden und auch etwas gruseligen Geschichte. Wende in rasanten Kämpfen das Blatt, indem du mit der Wii-Fernbedienung animierte Papierbären in die Seiten dieses ungewöhnlichen Bilderbuchs wirfst. Nutze alle dir zur Verfügung stehenden Mittel, um die im Buch zu findenden, blau glitzernden Juwelen gegen Kina, den geheimnisvollen, im Herrenhaus lebenden Jungen, zu verteidigen.<br><br>

Zeitgleich wird auch „Puzzling Pages“ veröffentlicht, ein parallel verlaufendes Spiel mit einer eigenständigen Geschichte und Kapiteln, in denen sich alles ums Puzzeln dreht. Vollende beide Spiele, um ein noch größeres Rätsel aufzudecken...<br><br>

Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Chaotic Conflicts</span></div>
  </div>
