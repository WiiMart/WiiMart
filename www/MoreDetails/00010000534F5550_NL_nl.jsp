...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit kanaal kan niet worden gedownload.<br><br>
Download het ‘The Legend of Zelda: Skyward Sword Save Data Update-kanaal’ om de gegevens van The Legend of Zelda: Skyward Sword bij te werken.</div>
  <div id="image02">
    <img src="/oss/ccs/00010000534F5550/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
