...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001575A4950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rubik's Puzzle Galaxy: RUSH is a 3D puzzle game with more than 70 challenging levels. Players need to guide Cubes to colour coded exit points. Using the Wii Remote’s intuitive controls, players herd the coloured cubes along by using Conveyor Belts, Warps, Stop Signs, Directional Signs and Splits.<br>
<br>
RUSH also includes the original Rubik’s Cube as a bonus. Players can attempt to solve one of the four different size Cubes alone or against a second player, or learn how to solve the classic Rubik’s Cube.<br>
<br>
RUSH:<br>
- More than 70 brain-busting levels<br>
- Tailor-made Wii Remote control scheme<br>
- Conveyor Belts, Warps, Stop Signs, Directional Signs, Splits, and more<br>
- Stylish environments<br>
- Classic Rubik's Cube in four sizes<br>
- Tutorial on how to solve the original Rubik's Cube<br>
- Online leaderboards</div>
  <div id="image02">
