...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574E5350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Uh Oh! The scientists are being attacked by a vicious horde of monsters. Use physics to splat those nasty creatures before they get close. Squash them, skewer them, blow them up and do whatever you can to help our scientist friends survive. <br><br>
Use the Wii Remote to build traps out of random objects, rope and elastic. Use springs and explosives for extra destruction. Complete almost thirty levels across four zones and then try and beat the special challenge in each. <br><br>
Will you manage to save the scientists from the horrors of the dark dimension?</div>
  <div id="image02">
