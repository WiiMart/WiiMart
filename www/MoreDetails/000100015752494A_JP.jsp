...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015752494A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『レインボーアイランド タワーリング アドベンチャー』は、不思議な力、ニジイロ魔法を持つ「バビー」と「ボビー」を操作して虹で敵を倒しながら、地上から天まで届くつタワーを登り、継ぎ目のない７つのエリアをクリアするのがゲーム目的です。<BR>各エリアの終盤には科学の力を持つ「ミカヅキ博士」が操作するボス敵が待ち構えています。制限時間内に各エリアに到達して最終エリアに登場する、ニジイロ彗星「ナナれぼし」を目指しましょう。<BR>ゲームモードは３種類。ストーリーを楽しむ「ストーリーモード」。高度０ｍからどこまで登れるかの限界に挑戦する「チャレンジモード」。エリアを選択して、のぼる速さに挑戦する「タイムアタックモード」が楽しめます。
虹を操作して、どんどん上空まで登る爽快なアクションゲームです。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015752494A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015752494A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
