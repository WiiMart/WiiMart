...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574A4B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un día, el profesor “H”, un experto en la Isla de Pascua de fama mundial, recibió una extraña carta procedente de Hanga Roa, capital de esta misteriosa isla. Era un grito de socorro de un desconocido y decía que algo malo estaba sucediendo en la isla. Sin dudarlo, el profesor, su ayudante Joel y su nieta Ivie se dirigieron rápidamente a la isla, donde les aguardaban multitud de rompecabezas, misterios y misiones. ¿Puedes ayudarles a revelar el mayor secreto de la Isla de Pascua?
<br><br>
El juego incluye:<br>
- Más de 40 niveles repartidos por toda la Isla de Pascua.
<br>
- Montones de tableros de diferentes formas.
<br>
- Una intrigante historia sobre los misterios de la Isla de Pascua.
<br><br>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Guardianes de joyas:</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">la Isla de Pascua</span></div>
  </div>
