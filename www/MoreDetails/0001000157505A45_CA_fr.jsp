...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157505A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bruiser and Scratch are stranded in a strange world with a dark secret. Their only hope to find a path home is to unravel the mystery of this place, one oversized puzzle at a time. Along the way, they make new friends and meet up with old adversaries, each of whom plays a role in their journey. Bruiser and Scratch offers a number of tutorial levels to bring the player up to speed gradually. The story unfolds over 48 puzzles and six landscapes. And for players who can't get enough, Challenge mode offers 75 additional puzzles that range from child's play to mind-bogglingly difficult.</div>
  <div id="image02">
