...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">囚われたプリンセスを救いだすための王宮へ挑む、アラビアの世界観を持つアクションアドベンチャーです。王宮のダンジョンには、多くの罠と敵が待ち受けています。主人公のライフ初期値は３で、ダメージを受けると１減り、０になるとゲームオーバーです。ライフは回復薬で１回復、全快薬で最大回復＋最大値１アップします。後半ほど敵が強いため、全快薬を多く取り、ライフの最大値を増やすほうがよいでしょう。
各ステージの扉に入るとクリアとなり、パスワードが表示されます。そのパスワードを入力して、途中からゲームを再開することが可能です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
