...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Prepárate para ir a la cima de la montaña en uno de los primeros juegos de snowboard más realistas que se han creado! Comienza en la cabaña y selecciona entre cinco personajes, cada uno/una con sus propios atributos y trucos especiales. Luego dale un vistazo a la gran variedad de tablas disponibles y elige a la que mejor le quede a tu personaje y a tu estilo. Una vez que obtengas el equipo necesario, podrás elegir entre seis diferentes modos de juego incluyendo Match Race, Trick Attack, y 2-Player Versus. Elige una ruta y prepárate para ir a velocidades tan altas que hasta se te olvidará que está haciendo frío. Introduce personajes secretos, y tablas, agrega diferentes condiciones del tiempo y nieve, además de múltiples caminos en cada ruta, y una variedad de trucos que tendrás que perfeccionar – todo esto con controles tan sólidos como una piedra – y terminaras con la receta perfecta para el mejor entretenimiento que podrás disfrutar durante cualquier estación del año. ¡Es toda la diversión y emoción del deporte, menos los moretones y el frío!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414F45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414F45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">1080°<sup>&reg;</sup> SNOWBOARDING</span></div>
</div>
