...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego de peleas publicado en 1994 sigue las aventuras de quince samuráis en diferentes aventuras. El sistema de rabia, el cual fue popular en el primer juego, ha sido expandido y mejorado. Ahora el poder de ataque no solo se eleva, sino que el jugador puede usar técnicas especiales que rompen el arma del oponente y lo obligan a pelear desarmado. El juego también permite usar técnicas de movimiento como esquivar, embestir y agacharse, permitiendo más estrategias. Un detalle interesante de este juego es que la voz de uno de los nuevos personajes, Cham Cham, fue interpretada por la actriz de doblaje Reiko Chiba, un ídolo de la comunidad de los videojuegos.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SAMURAI SHODOWN 2</span></div>
</div>
