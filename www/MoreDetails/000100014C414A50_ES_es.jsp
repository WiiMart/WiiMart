...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Disfruta con la popular segunda parte de Sonic The Hedgehog, diseñada especialmente para la consola SEGA MASTER SYSTEM, que supuso el debut en la serie de Tails, el inseparable compañero de Sonic.
<br><br>
La aventura comienza cuando nuestro héroe regresa a su casa... ¡y se encuentra con que el doctor Eggman está raptando a Tails delante de sus narices! De hecho, el maléfico doctor (más conocido como Robotnik) ha capturado a todos los animales del lugar y los ha embutido en trajes robóticos para lavarles el cerebro. A cambio de su liberación, le ha exigido a Sonic que le entregue las seis Chaos Emeralds que hay escondidas en la isla. 
<br><br>
Ayuda a Sonic a explorar minas abandonadas, recorrer a toda velocidad túneles sumergidos y planear entre las nubes para hacerse con las Chaos Emeralds... ¡Cuando las encuentre, deberá plantar cara al malvado doctor Eggman y poner fin a sus maléficos planes de dominar el mundo!
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414A50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414A50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sonic The Hedgehog<sup>TM</sup> 2</span></div>
</div>
