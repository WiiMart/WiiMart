...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">忍者型マシーン「ＮＩＮＪＡ」と「ＫＵＮＯＩＣＨＩ」を操作して敵を倒しながら進む、横スクロール型アクションゲームです。舞台は魔王「バングラー」による独裁政治で荒廃した世界。対抗する革命派のリーダー「マルク」は、独裁者を打倒するべく２体のマシーンを送り込みます。プレイヤーはＮＩＮＪＡとＫＵＮＯＩＣＨＩから１体を選び、苦無（くない）や手裏剣で攻撃しながら、防御のかまえや回転ジャンプといったアクションを駆使して進みます。忍者服が破れて内部のメカが露出してしまうとダメージが２倍になるため、火炎や爆風などには注意が必要です。制限時間内にラウンドの最後に出現するボスを倒すとラウンドクリア。次々と現れる強敵を撃破し、バングラーを倒してください。多彩なアクションや、三味線をサンプリングした独創的なＢＧＭが話題となりました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE NINJAWARRIORS<sup>&reg;</sup></span></div>
</div>
