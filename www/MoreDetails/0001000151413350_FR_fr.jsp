...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Faites de la planète votre laboratoire de recherche dans ce jeu de simulation unique ! Développez de nouvelles formes de vie et faites-les évoluer pour créer une vie intelligente. Menez-les jusqu’à l’« Exode », l’objectif ultime, et contribuez au peuplement de nouvelles planètes !
<br><br>
Gérez les paramètres atmosphériques et géologiques de la planète pour créer un environnement propice au développement de vos créatures. Les petits organismes procaryotes et tribrachiidés grandiront pour évoluer en une multitude de formes de vie. Attention, le moindre changement peut mener au désastre ! Veillez donc à ajuster progressivement vos paramètres tout en observant attentivement la réaction de vos créatures !
<br><br>
Pour corser un peu le jeu, SimEarth propose également des planètes avec un environnement différent de celui de la Terre, telles que Mars ou Vénus. Devenez un spécialiste de la terraformation et transformez ces planètes hostiles en véritables oasis de vie !
<br><br>
Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000151413350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151413350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SimEarth<sup>TM</sup>: </span></div>
</div>
