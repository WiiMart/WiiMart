...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LEGEND OF HERO TONMA liet zien dat niet alleen mannen geweldige computerspellen kunnen maken: dit actiespel is ontworpen en ontwikkeld door een team dat geheel uit vrouwen bestond. Je bestuurt de magiër Tonma, die naar een andere wereld moet reizen om de prinses te redden, zoals gebruikelijk voor de helden in spellen van toen.<br><br>
Vecht je een weg door zeven levels en maak gebruik van Tonma’s spring- en schietvaardigheden. Verzamel bonusvoorwerpen en ‘barrières’ om sterker te worden en je vijanden te overwinnen. Gebruik deze kracht om aan het einde van elk level de indrukwekkende bazen te verslaan, die je proberen tegen te houden de prinses te bereiken.<br><br>
Dit zeer gedetailleerde spel creëert met komische beelden een grappige sfeer en zorgt ervoor dat spelers steeds terugkomen voor meer krankzinnige en opwindende actie.
...
<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424D50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424D50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">LEGEND OF HERO TONMA</span></div>
</div>
