...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574A4650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bienvenue dans le monde de Gnomz, le tout nouveau jeu de combat arcade pour le service WiiWare™. Gnomz permet à 4 joueurs maximum de s'affronter ensemble et/ou contre l'IA autour de trois différents modes de jeu. <br><br>
