...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157545450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Toki Tori es su nombre y reunir huevos es su misión!<br><br>

En este juego de lógica y plataformas, los jugadores pueden utilizar objetos, como el Teletransportador, la Roca instantánea™ y el Absorbe-babosas. Para resolver los más de 70 niveles del juego, necesitarán un gran ingenio para usar y combinar estos objetos. El juego va aumentando de dificultad, lo que resulta en docenas de interesantes horas de juego.<br><br>

Toki Tori aprovecha al máximo las opciones que ofrece la consola Wii. Utiliza un sistema de control único del mando de Wii, que ofrece a los jugadores un nuevo estilo de juego más relajante. También puedes recibir la ayuda de un segundo jugador, que puede dibujar pistas mientras estás jugando. Este juego también utiliza el tablón de Wii de un modo único.<br><br>

Toki Tori:<br><br>

- es un juego de lógica/platformas<br>
- ofrece docenas de horas de juego<br>
- utiliza múltiples mandos de Wii para un nuevo estilo de juego<br>
- utiliza el tablón de Wii<br>
- incluye los diálogos y el manual en Español</div>
  <div id="image02">
