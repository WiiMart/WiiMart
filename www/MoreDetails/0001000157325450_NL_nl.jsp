...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157325450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit is een partygame waaraan maximaal vier spelers tegelijk mee kunnen doen. Spelers kruipen in de huid van gloednieuwe Brain Cadets en volgen bevelen op van een drilsergeant tijdens een breinbrekende training.
<br><br>
De regels zijn eenvoudig, maar concentratie en snel denkwerk zijn vereist om je tot een sterke, goedgeoliede denkmachine te ontwikkelen. Dit spel is het leukst als het met vrienden en familie wordt gespeeld.
