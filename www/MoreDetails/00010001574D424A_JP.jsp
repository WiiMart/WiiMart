...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D424A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「○（まる）」「／（ぼう）」<BR>「□（しかく）」の３つの図形をモチーフにした３種類のゲームをプレイしながら、１００万点を目指します。<BR><BR>
○（まる）と／（ぼう）と□（しかく）を操り、敵をはじいたり、消したりすることで点数が獲得できます。各ゲームには倍率アイテムなどさまざまな仕掛けが出現し、高得点も狙えます。<BR><BR>画面には３つのゲームウインドウがあり、最大３人まで同時にプレイできます。それぞれのゲームウインドウは、違う種類のゲームでも影響しあうようになっています。隣の画面からの影響で敵が倒れて得点が増えたり、またゲームオーバーになることもあり、互いに及ぼす思わぬ影響がゲーム展開を左右します。<BR><BR>また、自分のプレイをリプレイデータとして保存することができます。リプレイデータはＷｉｉフレンドに送信することもできます。これらのリプレイデータを自分がプレイしていないゲームウインドウで再生して、そこからの影響を受けながらゲームを楽しむことができます。<BR><BR>同じ内容の３つのゲームを遊べるニンテンドーＤＳ版を、ニンテンドーＤＳへダウンロード配信することもできます。（プレイ人数１人）</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">カタチのゲーム まるぼうしかく<sup>TM</sup></span></div>
</div>
