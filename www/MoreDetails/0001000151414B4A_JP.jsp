...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">筋肉派シューティングゲームとして異彩を放つ「超兄貴」シリーズの続編で、ボディビルのポーズを決めて敵を撃破してゆく「ポージングゲーム」です。前作で脇役に甘んじていた「アドン」と「サムソン」が今回の主役。消息不明になった「イダテン」を探すため、「ベンテン」が２人をビルダー星系へ送り出します。プレイヤーは自機である彼らを十字ボタンとコマンド入力で操作し、鍛え抜かれた肉体から放たれる愛の力「ポージング」を駆使して全４ステージを闘い抜きます。時の番人が定めた制限時間内で、どれだけ正確にかつ華麗に技を決められるかがポージングの真骨頂。マッチョなノリがさらに深まる本作では、「汗汗乱舞」や「男魂」といった汗が吹き出そうな技の数々に加え、男の一撃「メンズビーム」も健在です。ベンテンが運ぶアイテムでパワーアップしながら、究極の肉体美を表現してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000151414B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151414B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">愛・超兄貴</span></div>
</div>
