...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Power Golf hace gala de una combinación de controles simples pero realistas y hermosos gráficos. Golpea hacia los 18 hoyos en alguno de los tres modos de juego: el de un jugador, el modo STROKE PLAY, y los modos multijugador MATCH PLAY y COMPETITION. Entra en los torneos con uno de los 3 personajes distintos: principiante, intermedio y avanzado. La fuerza del viento y los desniveles del campo añaden desafíos extra a cada hoyo. Compite contra otros jugadores en el NORMAL MATCH estándar, o apuéstate uno de tus palos en el único CLUB MATCH. Hasta 3 jugadores pueden jugar en el modo COMPETITION, y se incluye una opción de handicap para ayudar a los jugadores novatos a realizar golpes tan impresionantes como los de sus rivales más avanzados.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
