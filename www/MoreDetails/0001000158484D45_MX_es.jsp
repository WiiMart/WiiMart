...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484D45')", "wiiSelectSound()");
...
<p>
¡Agarra tu Wii Remote y construye una pila en equilibrio en este juego de puzles de física! Los juegos de puzles tienen que ser adictivos. Esa era nuestra máxima prioridad durante el desarrollo del juego. Por eso diseñamos 100 niveles que no solo pondrán a prueba tus habilidades, sino también tu imaginación. El juego es fácil de jugar y difícil de dejar. Juega solo o invita a un amigo a jugar en cualquier momento a una partida cooperativa con un segundo Wii Remote. Incluso hay un modo "versus" de pantalla partida especial para dos jugadores para aumentar la diversión.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484D45/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484D45/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
