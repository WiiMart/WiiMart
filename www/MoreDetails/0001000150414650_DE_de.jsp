...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Der Rennspiel-Hit Victory Run lässt die berühmte Paris-Dakar-Rally wieder aufleben: ein wildes, realistisches Rennerlebnis von der französischen Hauptstadt bis in den Senegal, in dem nur die besten Piloten bestehen, denn Karosserieschäden, Motorenversagen oder Getriebeschaden verlangen auch abgebrühten Fahrern das Letzte ab!<br>Dynamische Landschaften, umwerfendes Geschwindigkeitsgefühl, explosive Crashs – jeder Meter der 13 000 km langen Rennstrecke wird für echte Rally-Fans zum staubigen Vergnügen!<br><br>Englischer Bildschirmtext</div>
  <div id="image02">
