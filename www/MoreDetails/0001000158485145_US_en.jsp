...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158485145')", "wiiSelectSound()");
...
<p>
Zombie Panic in Wonderland is a frantic third-person shooter with large doses of humor. 
<p>
