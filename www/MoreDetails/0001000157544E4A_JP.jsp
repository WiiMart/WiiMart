...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157544E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おきらくシリーズ第７弾。今度はみんなでテニス対決。<BR>最大４人同時対戦可能で、基本操作はWiiリモコンを振るだけの、簡単お手軽テニスゲームです。プレイヤーが１人の時は視点切り替えが可能です。<BR>１人で遊ぶならコンピュータ相手に勝ち抜き戦。２ゲーム先取３セットマッチでげんき君一家と対決します。<BR>みんなで遊ぶならフリー対戦。シングル、ダブルス、セット数やゲーム数を自由に設定する事ができます。<BR>さらに、普通のテニスとはちょっと違った対決も可能。続けたラリーの数が得点になり、１００点先取で勝利です。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544E4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544E4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おきらくテニスWii</span></div>
</div>
