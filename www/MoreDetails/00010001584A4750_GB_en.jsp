...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001584A4750')", "wiiSelectSound()");
...
<br><br>
Welcome to the world of Gnomz. Gnomz is a new exciting arcade fighter for the WiiWare™ service. Gnomz allows up to four Players to play against each other and/or AI opponents in three different game modes.<br><br>
Game features:<br><br>
...
* up to 4 players (+ 4 AI)  fighting locally<br>
* magical power-ups, flying elephants, rainbows and glowing reindeer<br>
* Smash Match, Capture the Sock, Socker (sock collector)<br>
