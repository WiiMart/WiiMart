...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157504745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Bienvenido a Snowpack Park! Has llegado con la intención de pasar un rato con algunos de los pingüinos locales y aprender a cuidarlos. Sin embargo, recientemente hubo una tormenta y los residentes salieron huyendo del parque a otras islas cerca del área y solo has podido encontrar algunos pingüinos.
<p>
Toma control de un personaje Mii™ o de uno de los personajes incluidos en el juego y supera varios terrenos y obstáculos inesperados mientras viajas de isla en isla, encontrando pingüinos y llevándolos de regreso a la seguridad del parque. Pero llevarlos de regreso es solo el comienzo. Los pingüinos tienen diferentes estados de ánimo, que cambiarán dependiendo de cuanta interacción tengan contigo. Si el humor de un pingüino se vuelve insoportable, se irá del parque. Para prevenir que eso pase deberás aprender a alimentar, acariciar y jugar con los pingüinos para poder mantenerlos felices.
<p>
Alrededor del parque encontrarás divertidos minijuegos para jugar con los pingüinos así como, diferentes atuendos para la cabeza que ellos se podrán poner, pescados para que coman, peces falsos que se convierten en bolas de nieve y una variedad de otras cosas útiles. Hasta puedes coleccionar fotos de los pingüinos y de ti mismo al visitar los lugares llamados Photo Spot (espacio para fotos). Prepárate para una aventura reconfortante en Antártica.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Snowpack Park<sup>TM</sup></span></div>
</div>
