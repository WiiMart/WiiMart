...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157564645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Guía a la famosa liebre de los puzles por cientos de emocionantes niveles, encuentra y usa objetos increíbles, supera obstáculos y consigue zanahorias para ganar. Descubre el secreto de las seis zanahorias doradas y conoce a nuevos amigos que te ayudarán durante tu maravilloso viaje. Bobby Carrot te transportará a la época dorada del juego de consolas clásico con sus magníficos gráficos 2D y sus sencillos controles. Relájate y disfruta de esta aventura de puzles para toda la familia que pondrá a prueba tus habilidades mentales.
<p>
Características:<br>
- 15 horas de aventura<br>
- Basada en una serie de juegos galardonada<br>
- Amplia y variada banda sonora<br>
- Más de 70 niveles<br>
- Descarga de más niveles (contenido adicional)<br>
- Función de guardado rápido<br>
- 3 ranuras de guardado
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bobby Carrot Forever</span></div>
</div>
