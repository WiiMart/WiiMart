...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Apprezzato dai giocatori di ogni età per l'ottima giocabilità, World Class Baseball è generalmente considerato il miglior gioco di baseball mai realizzato per il Turbografx. Sfida il computer in “OPEN MODE” o gioca contro un amico nel “VERSUS MODE”.
Personalizza la tua squadra in “EDIT MODE” o assisti a una partita tra due squadre controllate dal computer in “WATCH MODE”. WCB contiene tutto quello che ci si aspetta da un gioco di baseball.<br><br>
Naturalmente, c’è anche tanta azione per un solo giocatore! La modalità di spicco è la “PENNANT MODE”: scegli una squadra tra quelle di maggior rilievo in diversi paesi del mondo e battiti per vincere il campionato nazionale. Fai piazza pulita delle avversarie e riprendi le tue partite quando vuoi grazie al sistema di password. Dopo aver vinto il campionato della tua serie, preparati a scontrarti con le vincitrici degli altri campionati per conquistare il titolo mondiale!
<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150435650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150435650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">World Class Baseball</span></div>
</div>
