...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９８年にリリースされた格闘ゲームで、『ザ・キング・オブ・ファイターズ』シリーズの第５弾。これまでの「オロチ編」が一段落し、シリーズ集大成として本作が登場。出場チームは１２チーム＋２名で総勢３８名、今回は久々にスポーツチームが復活した。ゲームシステムについては前作「’９７」を踏襲しており、プレイヤーは自分のスタイルに合わせて、ゲーム開始時にアドヴァンストモードかエキストラモードを選択して戦うことになる。マイナーチェンジではあるものの、各種調整が行われている点はファンには評価が高く、よりバランスのとれた戦いが楽しめるようになっている。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014543484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014543484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ・キング・オブ・ファイターズ '98</span></div>
</div>
