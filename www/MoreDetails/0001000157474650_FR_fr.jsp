...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157474650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les Amies rêvent toutes de devenir reine des patinoires. Si elles arrivent à remporter tous les défis, elles gagneront les patins d'or et la couronne de la reine des patinoires. Peux-tu les aider à réaliser leur rêve ? <br><br>
  
Choisis un personnage parmi les Amies proposées et aide-la à patiner sur les différentes patinoires ainsi que dans d'autres lieux magiques. Sur le chemin qui mène à la couronne, tu peux gagner des costumes et accessoires fabuleux.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157474650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157474650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Girlfriends Forever</span></div>
</div>
