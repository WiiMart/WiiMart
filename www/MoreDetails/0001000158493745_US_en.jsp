...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158493745')", "wiiSelectSound()");
...
<p>
Nonstop mode in Liight is a fast-paced arcade puzzle game that uses the same basic concepts you learn in Solve mode in a constant struggle for a high score. Liight also has a Create mode to make your own puzzles any way you want, and a Share mode to send them to your Wii™ Friends who also have the game using the WiiConnect24™ service!
<p>
