...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">西暦２００Ｘ年、突如侵略してきた悪の宇宙帝国「亜空魔団」を倒すため、下町の天才科学者「豪徳寺博士」によって設計された史上最強のサイボーグ「シュビ
ビンマン」。半ばムリヤリ「シュビビンマン」に改造されてしまった魚屋の青年「太助」と普通の女子高生「キャピ子」は、地球を守るため、町外れに出現した敵の要塞を目指して戦います。ゲームは２人同時プレイが可能な横スクロールタイプのアクション。修理や買い物をする「マップモード」と、敵と戦ってお金を集める「アクションモード」を交互に繰り返して進んで行きます。攻略ルートはプレイヤーが自由に選ぶことができ、どの町を通っていくかで展開が変わるので、時には遠回りをして着実にパワーアップすることも攻略のポイントです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">改造町人シュビビンマン</span></div>
</div>
