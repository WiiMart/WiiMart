...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158494F50')", "wiiSelectSound()");
...
<br><br>Benvenuto nel mondo di Impara con i PooYoo, il primo gioco d'intelligenza poetico e divertente dedicato ai bambini da 3 a 6 anni di età.
<br><br>
Insieme ai PooYoo, un'allegra banda di cuccioli, il tuo bambino imparerà divertendosi tutte le abilità necessarie al suo sviluppo: numeri, lettere, lateralizzazione, forme, colori e molto altro. I bambini potranno ballare con i loro nuovi amici e riceveranno numerose ricompense interattive. Grazie ai due livelli di interattività, il gioco è adatto a bambini di età e capacità diverse e permetterà 
loro di approfondire temi quali musica e natura.
<br><br>
Questo gioco è stato pensato per bambini che non padroneggiano ancora la lettura. <br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494F50/FFFD0001" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494F50/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Impara con i PooYoo</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Episodio 2 - Demo</span></div>
  </div>
