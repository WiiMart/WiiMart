...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158483950')", "wiiSelectSound()");
...
<br><br>
Ga met ColorZ aan boord van je ruimteschepen en vernietig de virusplaag die een aantal planeten teistert. Ontdek nieuwe ervaringen met deze gameplay en beleef onverwachte psychomotorische mogelijkheden.<br><br>

Je kunt virussen van je eigen kleur vernietigen, maar pas op voor andere kleuren! Indien nodig kun je je verschillende ruimteschepen combineren om nieuwe kleuren te creëren. Scheer rakelings langs vijandige ruimteschepen om je combo te behouden en je hi-score te boosten.<br><br>

Ontdek een nieuwe dimensie van het spel met de multi-player modus en beleef een unieke ervaring door samenwerking met je vrienden. Bundel je krachten met de anderen, synchroniseer je bewegingen en combineer je tactiek voor een opwindend spel met maximum 3 spelers.<br><br>
