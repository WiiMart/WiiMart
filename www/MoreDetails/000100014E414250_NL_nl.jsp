...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De waanzinnige driftmanoeuvres en de levensgevaarlijke rode schilden zijn terug! Mario Kart 64 was een van de eerste hits op de Nintendo 64 en wordt nog steeds door velen beschouwd als een hoogtepunt in Nintendo's klassieke kartserie. En die reputatie heeft het spel niet voor niets. De multiplayer-stand kan met vier spelers worden gespeeld en biedt ongeëvenaard spelplezier. De manier waarop je de karts bestuurt is verder verfijnd door het toevoegen van diverse geavanceerde technieken en de circuits bevatten talloze extra’s en verborgen binnendoorweggetjes.
<br><br>
Helaas kun je in deze versie geen ’ghost data’ (coureur die je beste tijden in de Time Trial-stand laat zien) opslaan.
<br><br>
