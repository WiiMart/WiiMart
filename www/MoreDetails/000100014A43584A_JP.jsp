...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">激動の戦国時代を駆け抜けた群雄たちの生きざまをえがく戦略級歴史シミュレーションゲームです。プレイヤーは、織田信長や武田信玄、伊達政宗をはじめとする
戦国大名の中から一人を選択し、他の大名たちとの合戦で勝利を重ねて天下統一をめざします。プレイヤーは、まず開墾・治水・商取引といった内政を実行して領国を富ませていきます。また、徴収した金や米をもとに軍備増強を図り、兵士を雇って訓練し、足軽・騎馬・鉄砲に振り分けて戦闘部隊を編成します。さらに、不戦同盟を結んだり、他国の民を寝返らせたり、忍者を送って大名暗殺を画策するなどの外交手腕も重要となります。万全の体制が整ったら、いよいよ敵国へと攻め込みます。勝利を得るためには、地形をうまく利用するなど、戦術的な用兵が必要になってきます。戦闘に勝ち進んで日本全国を平定し戦国の覇者をめざしてください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパー信長の野望・全国版</span></div>
</div>
