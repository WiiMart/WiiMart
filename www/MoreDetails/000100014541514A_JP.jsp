...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９３年にＡＤＫより発売された格闘ゲームで、ハンゾウ、ジャンヌ、キャプテンキッドなど、歴史上の英雄をモチーフとした１４名が激しい戦いを繰り広げます。本作の特徴は、投げ返しや飛び道具の跳ね返しといったシンプルながらも奥の深いシステム。さらに、当時の格闘ゲームでは珍しく、ライフ制２本先取の通常モードと、前作よりさらに過激になった１０カウント制１本勝負のデスマッチモードの２種類のルールで戦うことができます。これによりプレイヤーは熱く、スリリングな戦いを楽しむことができるでしょう。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワールドヒーローズ２</span></div>
</div>
