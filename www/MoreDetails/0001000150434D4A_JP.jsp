...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">かわいらしい小型ヘリコプター「ミスターヘリ」が主役の、全方向スクロールシューティングゲーム。マッドサイエンティストに支配された星を救うため、火山地帯や地下生物のすみかを突破し、大ボスがひそむ惑星深部をめざします。プレイヤーは「金ヘリ」や「忍ヘリ」などのユニークな敵が飛び交う全６ステージを、制限時間内にクリアしていきます。飛来する敵の攻撃を上下左右にかわしつつ、頭上にミサイル、両サイドにショットガン、足もとに爆弾を投げつけ敵を撃破してください。特定のブロックを破壊すると出現する「水晶」を集めると、「ショップ」でパワーアップアイテムを購入することもできます。通常モードの他に、難易度が高めのアーケードモードも用意されており、初心者から上級者まで幅広く「大冒険」を楽しむことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ミスターヘリの大冒険</span></div>
</div>
