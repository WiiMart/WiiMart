...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Kirby’s Dream Course puts a new spin on the sport of golf, with Kirby as the ball and his enemies as obstacles! There are eight different courses to conquer, each containing eight levels packed with obstacles like water, spikes, conveyor belts and trampolines.
<br><br>
In each level, take out all the enemies by rolling Kirby into them, and then head for the hole that appears. You can adjust the angle of Kirby’s movement, add spin and power, and also copy the powers of enemies; such as using a parasol to float, ice to freeze water or fire to burn bad guys to a crisp!
<br><br>
As well as the challenging single-player mode, Kirby’s Dream Course also features a two-player mode in which you can compete against a friend.
