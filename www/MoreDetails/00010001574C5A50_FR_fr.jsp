...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574C5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">lilt line est un jeu de course et de rythme qui a déjà été récompensé pour sa bande son ainsi que son esthétique visuelle.
<br><br>
Prenez le contrôle d'une ligne de rythme aux allures de ruban et atteignez la fin de la piste audio le plus vite possible: inclinez la télécommande Wii et appuyez en rythme sur une bande sonore démoniaque composée de hits 16 bits.<br><br>
   
C'est une véritable course contre le rythme: l'essayer c'est l'adopter!<br><br>
   
• 15 niveaux de courses musicales intenses<br>
• Jeu de rythme<br>
• Utilise les fonctionnalités de la télécommande Wii<br>
• Récompensé pour sa bande son<br><br>
   
Parfois, il arrive qu'un jeu vidéo soit tout simplement GENIAL.
