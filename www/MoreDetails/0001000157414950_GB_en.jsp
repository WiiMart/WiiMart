...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157414950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to the home of 101 mind-blowing games for all tastes! Whether you like puzzle games, sport games or fast-paced arcade action, you'll definitely find something to suit you here! 
Jump in - tens of hours of games await you.
<br><br>
Features: <br><br>
-    101 games in different genres <br><br>
-    Taking full advantage of unique Nintendo Wii controls <br><br>
-    High-score tables, unlockable levels <br><br>
-    Tens of hours of gameplay accessible to everyone</div>
  <div id="image02">
