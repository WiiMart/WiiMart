...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「へべれけ」は、１９９１年９月２０日に発売された個性的なキャラクター達が活躍するアクションゲームです。<BR><BR>はるか昔、平和だったこの世界も、いつの日か大きな戦争をはじめてしまいました。その戦いは、まわりの世界を巻き込み、時空はねじれ、世界は崩壊してしまったのです。主人公の“へべ”は、戦いのあおりを受け、時空の裂け目に落ちてしまいました。へべは悲嘆にくれたのですが、やがて気をとりなおし、元の世界へ帰る冒険をはじめる決意をしました。この世界のどこかには、３人の仲間が隠れています。仲間を見つけ出し、巧みに使い分け、不思議なへべワールドを冒険しましょう<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">へべれけ<sup>&reg;</sup></span></div>
</div>
