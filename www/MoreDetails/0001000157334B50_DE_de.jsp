...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157334B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ThruSpace ist ein einzigartiges 3D-Puzzlespiel, bei dem dein räumliches Denken und deine Reaktionszeit auf die ultimative Probe gestellt werden. Steuere einen als Keydron bezeichneten Spielstein mit hoher Geschwindigkeit durch Lücken in aufeinanderfolgenden Barrieren. Das geht nur, indem du den Keydron rechtzeitig blitzschnell drehst. Deine Punktzahl erhöht sich mit der Zahl der passierten Barrieren und zudem mit Kristallen, die du sammeln kannst.
<br><br>
Sobald du mit dem Spiel vertrauter bist, kannst du dich Tricks und Combos widmen. Meistere Tricks, indem du alle Felder einer Lücke mit dem Schatten des Keydrons abdeckst, bevor du die Lücke passierst. Das bringt zusätzliche Punkte.
<br><br>
Es gibt drei Spielmodi: Zeitlimit, Endlosmodus und Trickmodus. Du kannst deine besten Durchgänge als Replay-Video speichern und sie dir im Keydron-Album ansehen. Außerdem kannst du deine Punkte online in die Weltrangliste eintragen und dich so mit anderen Spielern aus der ganzen Welt messen!<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334B50/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157334B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">3D-Hochgeschwindigkeitspuzzle</span></div>
  </div>
