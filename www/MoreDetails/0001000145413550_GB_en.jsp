...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Released in 1995, this is the 4th game in the Beat 'Em Up series "Fatal Fury". <br>
Previous releases in the Fatal Fury series utilised a two-plane battle system allowing you to move and fight between the foreground and background planes on-screen. This has been revamped from previous Fatal Furies to a three-plane format (foreground, background and main plane) known as the "Oversway System". Characters will automatically move back to the main line after a certain period of time in the foreground or background planes.<br><br>
Other introduced features include Combination Arts (the ability to execute combo attacks with simple rhythmic button taps), Hidden Abilities (superior versions of previous instalments popular Special Moves and Super Special Moves), minor tweaks to all the characters Special Moves and plenty more. This episode provides the deepest strategies and tactics in the Fatal Fury Series to date for your enjoyment.<br><br>
In-game text can be set to English, Spanish or Japanese.</div>
  <div id="image02">
