...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157544650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La serie BIT.TRIP llega a su final con BIT.TRIP FLUX: la aventura final de CommanderVideo.  <br><br>
Coge el mando de Wii y prepárate para un juego clásico con pala en el que CommanderVideo regresa al punto donde todo comenzó.<br><br>
Ya juegues solo o en modo cooperativo con otro jugador, tendrás que hacer frente a nuevos retos que podrán a prueba a los BIT.TRIPPERS más expertos.<br><br>
Afronta nuevos desafíos en esta emocionante aventura, en la que se repite el popular juego con pala con el que comenzó el fenómeno BIT.TRIP.<br><br>
El juego incluye:<br>
- ¡Nuevos potenciadores,
incluida una pala que cubre toda
la pantalla!<br>
- ¡Nuevos tipos de
beats, incluyendo algunos que
deberás evitar!<br>
- ¡Puntos de
control en mitad de nivel!<br>
- ¡El juego clásico BIT.TRIP BEAT
con todos los modos, incluido un
nuevo modo meta!<br>
- ¡Bit Shifter
regresa como artista chiptune
invitado!<br><br>
Acompaña a CommanderVideo y ayúdale a finalizar su misión para volver así... a casa.
<br><br>
