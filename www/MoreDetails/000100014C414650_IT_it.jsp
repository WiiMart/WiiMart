...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Nel ruolo di un guerriero solitario armato fino ai denti, dovrai lanciarti in una missione top secret dietro le linee nemiche per liberare i tuoi compagni d'armi!
<br><br>
In questo storico sparatutto, pubblicato per SEGA MASTER SYSTEM negli Stati Uniti con il titolo di Rambo: First Blood II (in Europa come Secret Command), sarai catapultato in un frenetico assalto contro carri armati, artiglieria pesante e una miriade di soldati nemici, ognuno dei quali è disposto a tutto pur di metterti i bastoni fra le ruote! Usa la tua fedele mitragliatrice e il tuo arco, equipaggiato con frecce dalla punta esplosiva, per respingere i loro attacchi.
<br><br>
Non permettere a nessuno di intralciare il tuo cammino! Gioca insieme a un amico nella modalità a due giocatori per raddoppiare la potenza di fuoco!
<br><br>
