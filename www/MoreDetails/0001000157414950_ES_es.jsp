...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un paquete de 101 juegos para todos los gustos. 
Rompecabezas, frenéticos juegos de acción de arcade, carreras, deportes, cocina, disparos, sudoku y mucho más. 
¡Esta colección satisfará todas tus necesidades en cuanto a juegos! <br><br>
Características:  <br>
- Más de 100 juegos de distintos géneros. <br>
- Controles excepcionales de la consola Wii de Nintendo.  <br>
- Clasificaciones con puntuaciones máximas y fases que puedes desbloquear. <br>
- Decenas de horas de juego para toda la familia.<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">101-in-1 Explosive Megamix</span></div>
</div>
