...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574C5050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LONPOS is een eenvoudig en tegelijkertijd uitdagend puzzelspel dat je gevoel voor logica en concentratievermogen behoorlijk op de proef stelt. Je kunt het alleen spelen of samen met (of tegen) andere spelers. Het doel is om puzzelstukken van verschillende vorm in een doos te passen door ze te verplaatsen en te draaien met de Wii-afstandsbediening, zonder dat er stukken overblijven.
<br><br>
In Normal Mode vecht je tegen de klok en scoor je punten door zo snel mogelijk puzzels op te lossen. Probeer ook eens Continuous Mode, waar je bij één misser eruit ligt. In Cooperative Mode kun je met een vriend(in) om de beurt puzzels voltooien en in Versus Mode strijd je tegen maximaal drie tegenstanders. 
<br><br>
LONPOS zit boordevol puzzels die je grijze cellen flink aan het werk zetten.
<br><br>
