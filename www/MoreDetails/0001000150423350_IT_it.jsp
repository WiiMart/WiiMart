...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Devil’s Crush è lo spettacolare seguito dell’acclamato Alien Crush. Devil’s Crush vanta molte migliorie rispetto al predecessore, tra cui movimenti ancora più fluidi ed effetti speciali perfezionati.
<br><br>
Lancia in campo la biglia d’acciaio con il Devil Shooter e colpisci i bersagli per incrementare il tuo punteggio. Usa con maestria le palette assieme a spinte controllate per evitare di perdere la biglia. Soddisfa determinate condizioni e guadagnati l’accesso alle sei aree bonus che ti daranno una montagna di punti, se completate tutte con un PERFECT!
<br><br>
Immergiti nella terrificante atmosfera del gioco accentuata da minacciosi avversari, tra cui Cavalieri Scheletro erranti, Stregoni e il Volto Gigante di una dea che si trasforma in un serpente!
