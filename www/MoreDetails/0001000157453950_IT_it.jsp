...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157453950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Alien Crush Returns è l'ultima versione del famoso Alien Crush per Turbografx, un classico dei flipper. Vanta un modo di gioco innovativo anche nei controlli: un'esperienza Wii che non puoi assolutamente perdere! <br><br>Con la semplicità di una biglia infuocata e delle azioni entusiasmanti di un normale flipper, Alien Crush Returns ha tutti gli elementi visivi e digitali che puoi immaginare in un videogame come i grotteschi e sbalorditivi campi di gioco e la trovata delle singolari Action Ball: tutti elementi che rinnovano il divertimento del flipper.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157453950/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157453950/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
