...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157485A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Planet Zethos has fallen under the military control of Thau-Phi, a rogue Artificial Intelligence. Its absolute control of all automated systems on the surface includes a legion of labour robots, now acting as an impenetrable and selfless army protecting the A.I. core.
<br><br>
The only hope of liberating it without paying a steep price in Confederation lives lies in the crew of the DST Horizon, an elite mercenary group currently selling its sophisticated combat expertise to the highest bidder.
<br><br>
Horizon Riders allows players to control any of the four squad members on their mission to defeat Thau-Phi, dashing at high speeds through the surface of Zethos on powerful hoverboards while destroying the renegade cybernetic army with their advanced futuristic arsenal.</div>
  <div id="image02">
