...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157544D4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">新アクション＆新要素をひっさげて、生まれ変わった高橋名人がWiiで登場。<BR>ステージに隠されたゴールドメロンを集め、新アクションを手に入れ冒険島をスミからスミまで探索しましょう。<BR>また、ミニゲームもありますので、友達とワイワイ楽しめます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544D4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">高橋名人の冒険島<sup>&reg;</sup>Wii</span></div>
</div>
