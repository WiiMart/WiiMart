...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">World Heroes 2 est un jeu de combat développé en 1993 par ADK, dont les combattants sont des figures historiques comme Hanzou, Janne ou Captain Kidd. Ils sont 14 au total. Le gameplay est à la fois profond et simple car vous avez la possibilité d’esquiver ou de renvoyer les projectiles. L’originalité de cet épisode vient de l’introduction de deux modes de jeu distincts : le mode Normal en deux rounds et le mode Duel à mort, plus extrême, avec un décompte (10 secondes) et un système de mort subite. Ces deux modes rendent le jeu plus excitant, vous promettant des heures et des heures de jeu !<br><br>Texte écran en anglais.</div>
  <div id="image02">
