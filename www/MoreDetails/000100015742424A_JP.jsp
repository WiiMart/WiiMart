...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742424A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">多人数対戦を基本とした、バランスWiiボード対応のバトルスノーボードレースゲームです。<BR>プレイヤーを操作し、アイテムを使ってライバルたちを攻撃したり、ライバルたちの攻撃から身を守りながら、一位を目指しましょう。<BR>Wi-Fi機能を使えば最大四人までの対戦と、ランキングへの参加を楽しむことができます。<BR><BR>ゲーム中にキャラクターが着用しているウェア・ゴーグルのデザインは、「OAKLEY」2008年モデルを使用。<BR>メイン楽曲は「80kidz」が提供しています。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742424A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Board Warriors<sup>TM</sup></span></div>
</div>
