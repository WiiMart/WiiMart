...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Devil’s Crush est la suite de l’incontournable jeu de flipper Alien Crush et vous propose une pléiade de nouveaux effets spéciaux et une animation plus fluide que jamais.
<br><br>
Lancez la bille sur le plateau avec le "Devil Shooter", puis utilisez les flippers ou secouez la machine démoniaque pour faire des scores d’enfer! Débloquez les 6 différents niveaux bonus puis tentez un "perfect" pour obtenir un maximum de points.
<br><br>
Le plateau de Devil’s Crush est rempli d’ennemis tous aussi diaboliques les uns que les autres, des chevaliers squelettes aux sorciers, sans parler de la tête géante de déesse qui se transforme en serpent infernal!
