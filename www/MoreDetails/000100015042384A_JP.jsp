...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ＰＣエンジンのハード性能を極限まで生かした、縦スクロール型シューティングゲームです。プレイヤーは驚異的な火力を持つ新型戦闘機を操作し、地球侵攻を開始した「ダークスコードロン」に立ち向かいます。多様なウェポンを使いこなし、パワーアップアイテムで自機の戦闘力を高めながら、押し寄せる敵をなぎ払い、全９エリアをクリアしてください。スピード感あふれる演出や、ドラムの効いたノリの良いＢＧＭ、複雑な軌跡をえがいて敵を一掃する「フィールドサンダー」など、爽快感は抜群。ほどよくチューニングされた難易度で、誰もが手軽に本格的なシューティングを楽しむことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブレイジングレーザーズ</span></div>
</div>
