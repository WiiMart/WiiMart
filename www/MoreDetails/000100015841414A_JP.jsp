...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">浮かび上がるようなジャンプで敵をかわしながら戦う独特の操作感が楽しい、横スクロール型アクションゲームです。プレイヤーは卵型ロボット「エナ」を操って、惑星エギー上に次々と投下される補給物資を回収します。ゲームは全２０ステージで構成されており、各ステージとも一定数の補給物資が投下された時点で自動的にステージクリアとなる独自のゲームシステムとなっています。ハイスコアを狙うなら物資の回収率を上げる必要がありますが、すべての補給物資を回収しなくてもステージクリアが可能なので、敵から逃げることを中心にプレイすることもできます。攻撃を受けるか時間の経過とともにエナのエネルギーが減少し、ゼロになるとゲームオーバー。地上の現地住民は攻撃すると敵に変身してしまいますが、もう一度攻撃して点滅したところを回収するとエナのエネルギーを回復できます。忘れずに回収することが攻略のコツです。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">EGGY</span></div>
</div>
