...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Enfrenta curvas increíbles, vueltas cerradas, y saltos peligrosos mientras montas hacia la línea final para ganar el campeonato Excitebike. Corre contra el cronómetro o reta a un rival. Debes mantener la concentración mientras vuelas por el aire y evitar que te pasen los otros competidores. Mantén la calma bajo presión o tu motocicleta se recalentará. Si te cansas de correr en el circuito, crea tu propio circuito usando el modo de “Diseño”. Ahí tendrás acceso a todas las rampas, montículos, puentes y otros obstáculos que ofrece Excitebike.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
