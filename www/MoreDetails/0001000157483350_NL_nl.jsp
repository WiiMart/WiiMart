...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157483350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stel je eens voor... elke kamer in je nieuwe huis is perfect ingericht, behalve eentje. Een blanco canvas waar je je eigen stempel op kunt drukken, maar je weet niet goed hoe.
<br><br>
Wiens hulp roep je in? Het Home Sweet Home-team!
<br><br>
Met Home Sweet Home kun je je verborgen talenten als ontwerper ontwikkelen. Je kiest het meubilair, de patronen en kleuren om een adembenemend meesterwerk te creëren.
<br><br>
De game heeft een simpele besturing, leuke graphics en een gebruiksvriendelijke interface waarmee je je creatieve kant kunt ontplooien. Denk eraan, een huis is pas een huis als het Home Sweet Home-team het heeft ontworpen!<br><br>Voorzien van Nederlandstalige schermteksten.</div>
  <div id="image02">
