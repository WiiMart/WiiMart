...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158484550')", "wiiSelectSound()");
...
In deze demoversie van het spel kun je je voortgang niet opslaan.<br><br>Met behulp van de Wii-afstandsbediening kun je de beats terugslaan in dit ritmespel, BIT.TRIP BEAT.
<br><br>
Retrographics, een klassieke gameplay, een tot 4-spelers multiplayermodus en een 8-bit soundtrack brengen je terug in de sfeer van toen en zetten je wereld ondersteboven.
Maar let op! Zoals in de meeste klassieke spellen zijn ook hier de uitdagingen moeilijk. Als je je kalmte kan behouden, wanneer de moeilijkheidsgraad blijft stijgen, dan kan je de beginselen van de BIT.TRIP BEAT saga ontdekken...<br><br>
Alles komt van iets.
We waren voordat we werden. Van leven ontstaat ritme en van ritme onstaat leven.
We zijn informatiewezens.
Alles is een excuus om te leren.
We communiceren in bits en bytes.
En we keren terug als iets wanneer we niets worden, nadat we onze BIT.TRIP voltooid hebben.<br><br>
