...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In questo gioco arcade ricco d’azione, che ha dato il via alla più famosa serie nella storia dei videogiochi, Mario e Luigi devono fare piazza pulita di tutti i nemici. Il tuo obiettivo è di eliminarne quanti più possibile e raccogliere monete senza essere colpito. Come suggerisce il titolo, Mario Bros.™ segna la prima apparizione di Luigi, il fratello di Mario, quando due giocatori competono insieme. Il gioco, inoltre, introduce diversi elementi tipici della serie. Ora Mario è un idraulico (non più un carpentiere come in Donkey Kong™), affronta nemici simili a tartarughe e può raccogliere monete nei livelli bonus. Attenzione però, non puoi ancora saltare direttamente sui nemici come negli episodi successivi. Scopri il modo per renderli inoffensivi. <br><br>Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
