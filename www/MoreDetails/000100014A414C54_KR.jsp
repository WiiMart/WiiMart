...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">에일리언 전투 전문가인 빌(랜스)이 되어 에일리언에게 점령 당한 지구를 구하는 액션 게임입니다. 스테이지를 옆에서 보는 「사이드뷰 스테이지」와 위에서 내려다 보는 「탑뷰 스테이지」, 2종류의 스테이지가 있으며 각각 구사할 수 있는 액션과 조작 방법 등이 다릅니다. 스테이지를 진행하며 여러 가지 아이템(폭탄, 탄환 등)을 모아 보스를 물리치는 것이 목표입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414C54/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414C54/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">CONTRA Ⅲ: THE ALIEN WARS</span></div>
</div>
