...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">横スクロールシューティングゲームの名作「グラディウスⅡ」の続編です。ファミコン版の前作からグラフィックやサウンドが大幅にパワーアップ。超時空戦闘機「ビックバイパー」を操縦し、破壊神バクテリアンの強大なダーク・フォースによる侵略に立ち向かいます。砂漠や火山、植物地帯など前作にも増してさまざまな趣向がこらされたステージを進み、最後に待ち受けるボスを倒すとステージクリアです。パワーアップする装備をこまかく選べる「エディットモード」の搭載など、ますます進化した自機のパワーアップシステムにより、自分なりの攻略法でゲームを進める楽しみが増しました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414D4A/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414D4A/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">グラディウス<sup>&reg;</sup>Ⅲ</span></div>
</div>
