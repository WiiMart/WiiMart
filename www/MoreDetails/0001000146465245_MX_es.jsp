...
<p>
Tras regresar a la ciudad élfica de Eolis, situada en la base del Árbol del Mundo, descubres que tu ciudad natal se enfrenta a un grave peligro: los pozos que suministraban agua a la ciudad se han secado, hay monstruos sembrando el caos por todas partes y el antaño espléndido Arbol del Mundo ha comenzado a marchitarse. Con los últimos fondos de la corona en tu bolsillo y las esperanzas de toda Eolis puestas en ti, embárcate en un épico viaje repleto de obstáculos, enemigos y peligros hacia las capas superiores del Árbol del Mundo para averiguar el origen del mal que lo atenaza. ¡Blande distintas armas, utiliza poderosos hechizos y habla con los aldeanos para obtener información mientras exploras territorios llenos de sorpresas en tu viaje hacia la cima del mundo!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146465245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146465245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
