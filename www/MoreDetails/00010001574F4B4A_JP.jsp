...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F4B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">家庭用カラオケとして大ヒット中の『カラオケJOYSOUND Wii』が待望のWiiウェア版になって新登場。<BR>マイクエコーや鳴りもの、本格採点はもちろん、新しい歌唱ステージにクールなデザイン、新搭載の一括予約機能で、さらに楽しく使いやすくなりました。<BR>また、無償の１日歌い放題チケット付きで、ソフトを買ったその日からオンラインカラオケがお楽しみいただけます。<BR><BR>※本ソフトを充分お楽しみいただくには、別売のカラオケJOYSOUND Wii専用マイクが必要です。<BR>※無償の１日券は初回（１度）限りの使用となります。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">カラオケＪＯＹＳＯＵＮＤ　Ｗｉｉ</span></div>
</div>
