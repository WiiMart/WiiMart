...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Grab your katana and get ready to unleash your samurai skills on your opponents!<br><br> 
Released in 1994, Samurai Shodown 2 is commonly regarded as one of SNK's finest games. The popular rage system from the first game makes a return, with the addition of special techniques that can break the opponent's weapon and force the opponent to fight unarmed.<br><br>
Gameplay has been greatly expanded since the first game and players can employ a wide range of movement including forward and backward rolls, plus a groundbreaking parry system. New characters and some of the most thriling beat'em up action around combine to make an utter classic.</div>
  <div id="image02">
