...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Famoso por su sólido manejo, World Class Baseball es el juego de béisbol definitivo para la TurboGrafx. Compite contra la computadora en OPEN MODE (Modo Libre) o juega con un amigo en VERSUS MODE (Modo Versus). Diseña tu equipo en EDIT MODE (Modo de Edición) e incluso asiste a un partido entre dos equipos controlados por la consola en WATCH MODE (Modo de Observación). WCB ofrece una experiencia única jugando béisbol. ¡También hay mucha acción para un solo jugador! La opción principal es PENNANT MODE (Modo de Torneo), donde elegirás un equipo de una de las ligas del mundo y competirás por conquistar la liga de tu equipo. Gánale a tus rivales y guarda tu progreso con contraseñas para coronarte campeón. ¡Tras ganar tu liga, enfréntate a los otros campeones de liga en las explosivas series por el campeonato mundial!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150435645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150435645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
