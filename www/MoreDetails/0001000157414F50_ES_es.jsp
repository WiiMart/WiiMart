...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Very Hungry Caterpillar's ABCs (El ABC de la pequeña oruga glotona) es un juego educativo que permite a padres y niños familiarizarse con el inglés básico mientras disfrutan juntos de una partida.<br><br>

El juego consta de 4 modos e incluye un divertido alfabeto con coloridas letras e ilustraciones de Eric Carle, y un cuestionario de palabras diseñado para niños de edad preescolar que incluye sustantivos como números, colores, formas y nombres de animales, también se incluyen verbos y adjetivos como “run” (correr), “eat” (comer) y “big” (grande).<br><br>

Los padres pueden usar el menú “To The Parents” (Para los padres) para comprobar el progreso del niño en el aprendizaje de las palabras del vocabulario.<br><br>

Toda la familia disfrutará con las ilustraciones llenas coloridas de Eric Carle, el internacionalmente aclamado autor de ilustraciones para libros infantiles.
<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414F50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414F50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
