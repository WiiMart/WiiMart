...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sommige klassiekers zijn onverslaanbaar! Alien Crush is een superrealistisch flipperspel met waanzinnige ‘biomechanische’ beelden. Met dit spel lijkt het net alsof je achter een echte flipperkast staat. Je kunt de kast zelfs een zetje geven. Met extra ballen en bonuspunten moet je proberen de hoogste score te halen. Behalve het hoofdveld, zijn er allerlei bonusvelden, zoals ‘Centipede’, ‘Alien’, ‘Eyeball’ en ‘Skull’. Deze opwindende en uitdagende velden hebben allemaal hun eigen doelen, die je enorme bonussen kunnen opleveren… als je ze tenminste haalt!<br>Haal op deze kast onnavolgbare trucs uit en ga volledig op in dit intense flipperspel!
<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150413750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150413750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Alien Crush<sup>TM</sup></span></div>
</div>
