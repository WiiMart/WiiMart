...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Partez à l'aventure avec le roi des singes dans ce jeu à défilement horizontal bourré d'action ! Passez rapidement d'une plate-forme à l'autre pour liquider de redoutables ennemis ! Avec son concept résolument original, ce classique décalé dans la grande tradition des jeux d'arcade ressort pour la première fois en Occident, depuis ses débuts en 1984.
