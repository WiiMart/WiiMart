...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158483650')", "wiiSelectSound()");
...
<br><br>
You can enjoy a complete adventure mode that takes place in different locations around the planet, exploring different paths and discovering the many secrets hidden in the planet.
<br><br>
Inside the exploratory probe, you can control tiny creatures that will help you to repair the areas damaged by accident, thus recovering skills and accessing memory files.
<br><br>
If you cannot move through the interior of the robot you must find amber rocks on the outside in order to obtain new creatures and progress through the internal circuits.</div>
  <div id="image02">
