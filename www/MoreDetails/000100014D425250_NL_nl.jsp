...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dit vervolg op de originele klassieker maak je wederom deel uit van de Rolling Thunder-eenheid van Interpol en is het jouw taak om de terugkeer van de kwade organisatie Geldra te verhinderen. De organisatie staat tegenwoordig bekend als Neo-Geldra en wordt geleid door de nieuwe baas Gimdo, die van plan is een aantal waardevolle satellieten te vernietigen.
<br><br>
In dit spel voor een of twee spelers kun je kiezen om als Leila of Albatross te spelen, beiden personages uit het oorspronkelijke spel. Schiet je door de diverse levels en probeer de misdadige plannen van Gimdo en de rest van Neo-Geldra te blokkeren. Gebruik je kogels goed en zorg ervoor dat Rolling Thunder trots op je kan zijn!
...
<br>Het spel is voorzien van Engelse schermteksten.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D425250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D425250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Rolling Thunder<sup>TM</sup> 2</span></div>
</div>
