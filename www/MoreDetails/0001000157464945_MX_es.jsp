...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La experiencia que ofrece Reel Fishing Challenge trae diversión y desafíos para pescadores novatos y expertos por igual. Pon a prueba tu destreza y descubre nuevas clases de peces al enfrentar el desafío del modo misión o relájate y disfruta del juego a tu propio ritmo en el modo de juego libre. No importa en qué modo juegues: la hermosura de los gráficos y lo natural del entorno le darán vida a la experiencia de pescar. Elige entre una variedad de atractivas carnadas y pesca todos los peces que puedas: son muchos, y algunos son muy astutos. ¡Cada uno de los peces se parece tanto en aspecto y comportamiento a un pez de verdad que esta experiencia es lo más cercano que estarás a una pesca de la vida real sin tener que ponerte botas de pescador!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
