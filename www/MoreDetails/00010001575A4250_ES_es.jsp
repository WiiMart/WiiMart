...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001575A4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cricket Challenge es un juego de deporte estilo arcade que te permite ponerte en la piel de un bateador de un partido de cricket. <br><br>Usa el mando de Wii como si fuera un bate de cricket de verdad y controla las acciones del bateador para realizar golpes, 6s, sobrepasar los límites y probar una gran variedad de tiros.
<br><br>
El partido se desarrolla en un campo rodeado de edificios y apartamentos ubicados en un exuberante terreno cubierto de hierba que da un toque informal al juego.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A4250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Cricket Challenge</span></div>
</div>
