...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001584A4750')", "wiiSelectSound()");
...
<br><br>
Bienvenido al mundo de Gnomz. Gnomz es un nuevo juego "arcade" de lucha del servicio WiiWare™. Gnomz permite que hasta cuatro jugadores jueguen entre sí o contra la inteligencia artificial (IA) en tres modos de juego diferentes.<br><br>
Características del juego:<br><br>
* juego de plataformas y combates entre gnomos en tiempo real;<br>
* 25 zonas de lucha repletas de acción gnómica;<br>
* horas de aporrear, aplastar y entrechocar gnomos y deshacerse de ellos.<br>
* hasta 4 jugadores (+ 4 IA) luchando localmente;<br>
* mejoras mágicas, elefantes voladores, arcoíris y renos brillantes;<br>
* Capture the Sock (Captura el calcetín), Smash Match (Duelo de apisonadoras) y Socker (Coleccionista de calcetines);<br>
