...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">音速ヒーロー・ソニックと仲間のテイルスが伝説の浮遊島を駆け抜ける、ハイスピードアクションゲームのシリーズ第三弾。巨大要塞デスエッグの墜落した浮遊島を舞台に、ドクター・エッグマンとソニックのカオスエメラルドをめぐる戦いが、すべて１ボタンアクションの簡単操作で楽しめます。今作ではソニックのライバル、ナックルズがついに登場。ソニックにも３種類のパワーアップバリアや新アクションが追加されました。また、より多彩になった各ステージのルート分岐で、前シリーズをはるかに上回るボリュームとなり、シリーズではじめてセーブ機能を搭載。最短ルートや隠し部屋探しも一層楽しくなりました。ソニックシリーズならではの便利な２人プレイもますます充実。プロペラ飛行するテイルスにつかまれば空中移動もできるので、家族やお友達を誘ってプレイすれば難関ステージもクリアしやすくなります。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソニック･ザ･ヘッジホッグ３<sup>TM</sup></span></div>
</div>
