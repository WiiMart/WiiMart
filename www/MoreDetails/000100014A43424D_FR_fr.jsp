...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ce fantastique jeu de rôles arrive pour la première fois en Europe! Réalisé par des experts en jeux de rôles de Square (Square Enix aujourd'hui), Super Mario RPG est à la fois facilement maîtrisable et satisfaisant par sa profondeur.
<br><br>
Rejoignez Mario et ses amis (même Bowser!) dans une formidable quête contre Smithy, un nouvel ennemi qui menace le Royaume Champignon!
<br><br>
Affrontez vos ennemis, utilisez divers sorts et objets afin de progresser dans votre quête. De nombreux personnages de Nintendo vous attendent pour votre plus grand plaisir!<br><br>Texte écran en anglais.</div>
  <div id="image02">
