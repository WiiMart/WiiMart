...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100014843494A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『Ｗｉｉの間』は、あなたや家族のＭｉｉが集まった、テレビの中のお茶の間を通して、映像を中心としたコンテンツを体験することができる、新しい情報配信サービスです。<BR><BR>
家族のＭｉｉがそろったリビングには大きなテレビがあり、様々な映像や情報が自動的に流れます。<BR><BR>
また有名人のＭｉｉなどが「コンシェルジュＭｉｉ」としてリビングに訪れ、映像をおすすめしてくれたりもします。<BR><BR>
リビングからは「Ｗｉｉの間ショッピング」「いろんな間」「ホームシアター」などへ移動することができます。<BR><BR>
「Ｗｉｉの間ショッピング」では、お買い物が楽しめます。ここでしか買えない商品も盛りだくさんです。<BR><BR>
「いろんな間」には、さまざまな企業やテーマの間があり、ちょっとお得な情報を見れたり、いろんな体験ができたりします。<BR><BR>
「ホームシアター」では、Ｗｉｉポイントで映画やアニメなどの作品をレンタルして見ることができます。<BR><BR>
あなたもぜひ『Ｗｉｉの間』の世界をのぞいてみませんか？<BR><BR>
※映像によっては、<BR>
　ニンテンドーＤＳｉに<BR>
　保存できないものがあります。<BR><BR>
※ニンテンドーＤＳｉに<BR>
...
　必要です。（無料）<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100014843494A/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843494A/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｗｉｉの間<sup>TM</sup></span></div>
</div>
