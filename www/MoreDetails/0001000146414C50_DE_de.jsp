...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Trotz seiner rasenden Beliebtheit in Japan und den USA spielt Baseball in unseren Breiten noch eher eine Außenseiterrolle. Jetzt ist es dank Nintendo möglich, diesen faszinierenden Weltsport auf neue Art zu entdecken: Baseball wurde wegen seines Charmes und seiner unkomplizierten Steuerung schon zum Zeitpunkt seines Erscheinens auf dem NES als eine der besten Sportsimulationen gehandelt. Es bietet auch heute noch eine interessante Einführung in die Regeln dieses Sports. Die zur Verfügung stehenden Mannschaften richten sich dabei nach der Länderversion des Spiels: Die sechs beliebtesten Teams der japanischen Central League werden in unserer Version durch die sechs US-Mannschaften vertreten, die beim Erscheinen des Spiels in Nordamerika am populärsten waren.
<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414C50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414C50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Baseball</span></div>
</div>
