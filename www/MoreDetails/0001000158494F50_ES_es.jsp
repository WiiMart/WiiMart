...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494F50')", "wiiSelectSound()");
...
<br><br>Bienvenidos a Aprender con los PooYoos: el primer juego de agudeza mental para niños de 3 a 6 años.
<br><br>
Con los PooYoos, una alegre banda de adorables animalitos, los niños se divertirán y aprenderán elementos básicos para su desarrollo: números, letras, lateralización, formas, colores y muchas cosas más. Los niños podrán bailar con sus nuevos amigos y conseguir montones de premios interactivos. Con dos niveles de interactividad, los niños podrán jugar, sean cuales sean su edad y nivel, a actividades relacionadas con la música y las plantas.
<br><br>
Este juego está diseñado para niños que aún no saben leer. <br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494F50/FFFD0001" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494F50/FFFD000E" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Aprender con los PooYoos</span></div>
</div>
