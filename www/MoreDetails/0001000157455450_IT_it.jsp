...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157455450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Giochi da tavolo animati: Un'avventura pop-up! è un gioco da tavolo che non ha bisogno del tavolo! Invece di usare il normale tabellone, questo gioco prende vita in un libro pop-up tridimensionale, con sfavillanti effetti speciali e pedine di carta animate!
<br><br>
Al posto dei dadi, per muoverti sul percorso userai delle carte magiche dai risultati inaspettati. Procedendo nel gioco raccoglierai anche preziose monete che ti serviranno a comprare nuove carte o a recuperare punti alla fine della partita!
<br><br>
Fino a quattro giocatori possono divertirsi insieme nei panni di simpatici personaggi come il pirata Silver o il ninja Ninzo. Sfida i tuoi amici o gli avversari computerizzati (oppure entrambi!), ma fai attenzione: dietro alcune caselle si nasconde il Libro incantato, che con misteriose magie può ribaltare la situazione in ogni momento!
<br><br>
Giochi da tavolo animati: Un'avventura pop-up! aggiunge una nuova dimensione ai giochi da tavolo come li hai conosciuti finora!
<br><br>
Testo a schermo in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455450/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157455450/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Giochi da tavolo animati<sup>TM</sup>: </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Un'avventura pop-up!</span></div>
  </div>
