...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">３ＤアクションＲＰＧとして話題を呼んだ『ゼルダの伝説　時のオカリナ』の続編となる、シリーズ６作目です。前作から数ヶ月後、主人公リンクは、冒険の終わりで別れた大切な友達を探す旅の途中で、ハイラルとは違う次元に存在する世界に迷い込んでしまいます。そこは３日後に月が落ちてきて滅びてしまう世界「タルミナ」でした。どこかで会ったような人々が住む不思議な世界で、クロックタウンを中心とするさまざまな土地を冒険します。同じ３日間を何度も繰り返しながらゲームを進めていくシステムや、「ゴロン」「ゾーラ」「デクナッツ」などの「仮面」をかぶることでさまざまな特殊能力を使うことができるようになるお面システム、タルミナの住人に関するイベントを記録する団員手帳など、前作とは一味違う面白さが詰まっています。また、Ｚ注目システム、乗馬や弓矢などの爽快アクション、オカリナをはじめとする楽器演奏など、前作で好評のシステムも引き続き登場。時のオカリナで何度も時間をさかのぼりながら、世界に広がる謎を解き明かし、月の落下を止めて世界を救ってください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゼルダの伝説<sup>&reg;</sup>　ムジュラの仮面</span></div>
</div>
