...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">So you want to be mayor?  Well, here’s your opportunity!  Begin with empty land, start a town, name it after yourself, and build it into a city. Then see if you can sustain enough growth to build your city into a megalopolis!  As mayor, you have the tools to overcome any challenge.  Whether it's taxes, zoning, crime, transportation, fire control, pollution, natural disasters, or other critical issues, the duties as mayor are yours.  For a change of pace, try saving a city burdened with problems by playing one of the eight built-in scenarios. Time is passing and every decision you make has future consequences—so get to work!</div>
  <div id="image02">
