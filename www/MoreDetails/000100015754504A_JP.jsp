...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015754504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パズルゲームの代名詞、あの「テトリス」がWiiウェアに登場。<BR>ひとりで、みんなで、世界中でテトリス。<BR><BR>■ゲームのルール<BR>テトリミノと呼ばれるブロックをフィールドにすきまなく積み、<BR>ラインを作って消していくパズルゲームです。<BR>この基本的なルールのほかにも、テトリスパーティだけのアイテムや<BR>オリジナルルールで遊ぶ様々なモードが搭載されています。<BR><BR>■多彩なモードと遊び方<BR>ひとりでじっくり遊ぶなら「ひとりでテトリス」、みんなでワイワイ遊ぶなら「みんなでテトリス」、<BR>世界中のプレイヤーやフレンドと対戦するなら「ニンテンドーWi-Fiコネクション」、<BR>テトリス初心者なら「やさしいテトリス」、ちょっと変わったスタイルで遊ぶなら「バランスWiiボードでテトリス」と、5つのモードに17種類の遊び方が用意されており、TPOに合わせて楽しむ事ができます。<BR><BR>■ワールドランキングに挑戦<BR>ニンテンドーWi-Fiコネクションで対戦した結果や各モードで出した記録は<BR>ワールドランキングに登録することができます。世界中のプレイヤーや<BR>フレンドと腕を競いましょう。<BR><BR>■公式サイトURL<BR>http://tetrisparty.jp</div>
  <div id="image02">
    <img src="/oss/ccs/000100015754504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015754504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
