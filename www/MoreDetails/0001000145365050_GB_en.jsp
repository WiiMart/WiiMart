...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Originally released in arcades as "Shadow Warriors" in Europe, this fast-paced brawler is hailed as a cult classic - and now you can enjoy it in your own home!
<br><br>
You take on the role of a ninja, dispatched to the American gangland city of "Jungle" to take down an evil assassination syndicate. But they're not going down without a fight! You'll need all of your ninja skills, such as the Flying Neck Throw and the Hang Kick, to defeat them. This version allows you to select your starting amount of lives, along with the difficulty level of the game, for an improved, custom experience.
<br><br>
Ninja warriors meet Western gangs in this action classic. Pick it up and hit the streets!</div>
  <div id="image02">
