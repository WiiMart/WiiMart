...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">거품을 쏘는 공룡 「버블룬」과 「보블룬」을 조종하여 펼치는, 퍼즐의 요소가 가미된 액션 게임입니다. 거품을 쏘아 적을 가둔 후 다가가서 거품에 부딪히면 적을 쓰러뜨릴 수 있고, 모든 적을 쓰러뜨리면 스테이지 클리어입니다. 각 스테이지에는 보이지 않는 공기의 흐름이 있어 거품이 이동하는 방향이 다릅니다. 공기의 흐름과 다양한 아이템을 잘 활용하여 총 100개의 스테이지를 클리어해 보세요. 2명이 동시에 플레이할 수 있고, 또 2인 플레이 시에만 등장하는 특수한 엔딩이 있으므로 함께 즐기면 더욱 재미있습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146433354/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146433354/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">버블보블</span></div>
</div>
