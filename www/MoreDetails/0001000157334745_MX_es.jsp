...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157334745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Phoenix Wright ha vuelto, en el tercer juego en la licencia popular de consolas portátiles Ace Attorney llega a WiiWare! ¡Como Phoenix Wright, jugarás a través de cinco nuevos casos escandalosos en la perspectiva de primera persona! El juego ofrece 2 modos únicos de jugar. En el modo de investigación, examinarás escenas de crímenes, entrevistarás a testigos, y recopilarás evidencia. Después, presentarás resultados, escucharás testimonios, y examinarás a los testigos en el modo tribunal.  Trials and Tribulations también incluye la táctica de "Psique-Cerradura" que permite que Phoenix Wright utilice una línea de interrogación para revelar inconsistencias en el testimonio de los testigos.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157334745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
