...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157324650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Patienten, die ein Rehabilitationsprogramm absolviert haben kennen das Problem: Viele Übungen, die notwendig und wichtig für den Verlauf der Heilung sind, sind oft monoton und langweilig. Besonders, wenn es um den Bereich der Körperbalance und des Gleichgewichtes geht, ist Abwechslung nur selten gegeben.<br /> 
Hier kann Physiofun Balance Training helfen. Das Programm hilft, Balanceübungen kurzweilig zu gestalten.<br />
Physiofun Balance Training ist zudem optimal geeignet für die Nachsorge von Patienten, die Physiotherapeuten und Reha-Zentren besucht haben. Statt des Einsatzes teurer Spezialgeräte können auf kurzweilige Art wichtige Übungen für Nachsorgepatienten, etwa mit Fuß-, Knie- oder Hüftbeschwerden durchgeführt werden.<br /><br /> 
Physiofun Balance Training vereint dabei viele Funktionen: Neben Tests wie der Messung des Körperschwerpunktes und der Körperbalance bietet der „Phyiso-Modus“ die Möglichkeit, komplexe Trainingspläne für physiotherapeutische Übungen zu erstellen. <br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324650/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324650/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Balance Training</span></div>
</div>
