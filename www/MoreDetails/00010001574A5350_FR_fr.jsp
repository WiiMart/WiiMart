...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574A5350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jungle Speed® est un jeu de
cartes pour toute la famille, 
dans lequel les refléxes, la 
rapidité et un oeil vif vous 
permettront de prendre le
dessus.<br><br>
Retournez votre carte, observez
vos adversaires et saisissez le 
totem au bon moment pour
gagner le jeu. Au moment même
où vous pensez que vous l'avez
gagné, une nouvelle carte peut
temporairement changer les 
règles et vous mettre de côté.<br><br>
Le jeu commence quand la 
première personne retourne une
carte. Les cartes sont retournées 
une à une jusqu'à ce que deux 
cartes ayant le même symbole 
soient exposées. Les joueurs 
dont les cartes ont le même symbole 
font alors un duel pour saisir le 
totem qui se trouve au milieu de
la table. Le perdant obtient les 
cartes du gagnant et celles qui se 
trouvent dans le pot. <br><br>La première 
personne qui parvient à se 
débarrasser de toutes ses
cartes, grâce à sa patte volante, 
gagne le jeu.<br><br>Texte écran en français.</div>
  <div id="image02">
