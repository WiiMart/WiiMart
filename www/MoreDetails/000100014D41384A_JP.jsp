...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">時空を越えるイルカ、エコーとなって、大海原を泳ぎ回る壮大なスケールの海洋冒険アクションゲーム第二弾。かつて、クリスタルの力を授かり宇宙の平和を救ったエコーは、暗黒惑星ボルテックスのクイーンから地球の危機を救うため、未来からの使者の力を借りて再び冒険へと向かいます。今度の冒険の舞台は、これまで以上に奇妙な世界。天空へと続くチューブを進んで空を泳ぎ、不思議なリングを潜り抜けて世界へ旅します。エコーが新たに得た力、変身能力を駆使し、さまざまな謎を解き明かしながら、いろいろな海や空を旅していきます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エコー・ザ・ドルフィン２<sup>TM</sup></span></div>
</div>
