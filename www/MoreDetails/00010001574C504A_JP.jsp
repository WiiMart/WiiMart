...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574C504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LONPOSはシンプルで奥深く、老若男女誰でも楽しめる頭脳パズルです。ゲームは縦５マス、横１１マスの長方形のボックスにいくつかのブロックが最初からはめ込まれている状態でスタートします。プレイヤーは、まだはめ込まれていないブロックを駆使して、ボックスの空きスペースを完全に埋める事ができたらゲームクリアです。LONPOSには様々なモードが収録されています。１人で問題に挑戦する「SINGLE」モードには、制限時間内にクリアを目指す「BASIC GAME」と、一度置いたブロックは移動できないルールで、どこまでクリアできるかを目指す「CONTINUOUS」の２つがあります。「VERSUS」モードでは、２種類の対戦ルールが用意され、どちらも最大２人でニンテンドーWi-Fiコネクションでの通信対戦が可能です。さらに、２人協力プレイモードも収録しております。各モードの結果はニンテンドーWi-Fiコネクション上のランキングで全国順位を確認することが可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C504A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C504A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
