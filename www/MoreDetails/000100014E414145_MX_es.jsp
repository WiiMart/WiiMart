...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Una mañana soleada en el Reino de los Hongos, Mario va a visitar a la princesa, pero se encuentra con que su castillo está misteriosamente vacío. Saltando a través de los cuadros que hay colgados en las paredes, entra en 15 mundos mágicos en tu aventura para recoger las 120 Power Stars robadas por el malvado Bowser y salvar la situación. Los vastos mundos de este juego abundan en obstáculos formidables, elementos ocultos, puzles y más de 30 tipos de enemigos. ¡Aprovecha la amplia gama de movimientos de Mario, incluidos correr, saltar, nadar, pisotear y dar puñetazos, e incluso dar un salto de carnero hacia atrás!  Las gorras especiales le dan poderes de corta duración, incluida la capacidad de volar. Super Mario 64 tiene un control de cámara inigualado que hace que aventurarte en el mundo de 3D sea sencillísimo incluso para los principiantes.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414145/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414145/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Mario 64<sup>TM</sup></span></div>
</div>
