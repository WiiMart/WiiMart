...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">江戸時代が舞台の痛快時代劇アクションゲーム。“権べ” と “田吾”という２人の働き者の農民が、悪代官に立ち向かう異色のストーリーで、田園地帯、お墓・池、代官屋敷の塀、そして屋敷の内部と、４ステージで構成されます。プレイヤーを操作して敵の忍者を避けたり倒したりしながら、各面に落ちている８枚の小判を全て拾ってステージをクリアしていきます。プレイヤーの武器は草刈り用のカマだけですが、画面上に落ちているアイテムを拾うと一時的にパワーアップできます。協力しながら戦うことのできる、２人同時プレイもおすすめです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641594A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641594A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">いっき<sup>TM</sup></span></div>
</div>
