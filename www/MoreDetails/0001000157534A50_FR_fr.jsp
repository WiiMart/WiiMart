...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157534A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le nec plus ultra des jeux de différences est maintenant sur WiiWare avec 160 scènes, 3 niveaux de difficulté et 1.600 différences à trouver!<br>
<br>
Jouez en solo ou avec des amis (jusqu'à 4 joueurs) pour savoir qui a le meilleur sens de l'observation!<br>
<br>
Découvrez des scènes étranges et attrayantes dans diverses catégories: Paysages, Animaux, Loisirs et Miam-Miam!<br>
<br>
4 modes de jeu sont disponibles:<br>
<br>
- Arcade: <br>
Les scènes apparaissent de manière aléatoire: pour chacune d’elles, trouvez les 5 différences. 
 <br><br>
- Time Attack: <br>
Trouvez une différence dans chaque scène avant que le temps ne soit écoulé! 
 <br><br>
- Sélectionner des scènes: <br>
Jouez avec les scènes de votre choix et trouvez les 5 différences dans chacune d’elles. 
 <br><br>
- Multijoueur: <br>
Jouez contre vos amis (jusqu'à 4 joueurs).<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534A50/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Trouvez Les Différences !</span></div>
</div>
