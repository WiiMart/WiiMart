...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ces trois derniers jours, des pannes ont été détectées dans les systèmes de sécurité des ordinateurs militaires des grandes puissances mondiales. Quelqu’un a eu accès à l’ordinateur central à partir duquel sont déclenchées les attaques de missiles. Une seule personne est capable de manipuler un tel ordinateur: le Professeur Elvin Atombender.
<br><br>
Après s'être enrichi en piratant les systèmes informatiques de plusieurs institutions financières, le Professeur Elvin Atombender a construit un gigantesque abri souterrain rempli d’ordinateurs. C’est là, dans le plus grand secret, qu’Elvin a travaillé pendant quatre ans à déchiffrer les systèmes de sécurité des ordinateurs militaires du monde entier. Avec succès on dirait...
<br><br>
Dans exactement six heures, Elvin aura déchiffré le code de lancement des missiles.
Six heures, c’est le temps qu'il vous reste pour mener à bien votre mission.
<br><br>
