...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157464B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おきらくシリーズ第８弾。今度はレース場で対決。<BR><BR>最大４人同時プレイ可能、Ｗｉｉリモコンをカートのハンドルに見立てて直感操作。ハンドルコントロールがうまくなくても大丈夫。「ボーリングボム」や「エスパーねんりき」などのアイテムを使って一発逆転をねらえます。<BR>
「げんきくん」や「のぞみちゃん」に加え、新キャラの「おねえさん」と「おじいちゃん」も追加。６人のキャラクターと一緒に１位を目指しましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おきらくカートWii</span></div>
</div>
