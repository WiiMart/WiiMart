...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Use this application to transfer save data, stored Wii Points, and downloadable software such as WiiWare and Wii Virtual Console titles from this Wii to a Wii U console. In order to move the data, you will need an SD Card or SDHC Card with over 512 MB of available memory and a target Wii U console.
<br><br>
...
<br><br>
Wii Points are redeemable only within Wii Shop Channel.
<br><br>
To prepare for the data transfer, start Wii mode on the target Wii U console by opening the Wii Menu and then open the Wii System Transfer application.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435345/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435345/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
