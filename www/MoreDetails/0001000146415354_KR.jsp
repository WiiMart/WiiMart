...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">1990년에 패밀리컴퓨터용으로 발매된 종스크롤 슈팅 게임입니다. 공중의 적을 공격할 수 있는 미사일과 지상의 적을 공격할 수 있는 폭탄을 이용하여 혹성 「제비우스」를 공략해 나갑니다. 흑백 배경이 주류를 이루었던 발매 당시에는 푸른 강과 바다, 초록빛 숲 등 선명한 색채로 표현된 그래픽의 참신함으로 호평을 얻었으며 이후에 발매된 슈팅 게임에 큰 영향을 주었습니다. 스테이지 내에 감춰진 요소들을 찾아 내어 잘 활용해 보세요.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415354/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415354/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">제비우스<sup>&reg;</sup></span></div>
</div>
