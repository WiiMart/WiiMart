...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Entra in un mondo di pura magia in questo gioco d'azione a scorrimento orizzontale del 1990. Vesti i panni di Elta, l'ultimo dei signori della magia. Il malvagio mago Gal Agiese sta cercando di far risorgere Az Atorse, dio della distruzione. Spetta ad Elta recuperare otto tomi mistici in grado di sigillare per sempre questo dio del male.
<br><br>
Nella sua forma normale, Elta può utilizzare solo un attacco standard; ha però l'abilità di trasformarsi in vari e potenti avatar una volta ottenuti degli oggetti speciali chiamati Elementali. La varietà di queste trasformazioni, tra le quali spiccano un Drago Guerriero sputafuoco, Poseidone, capace di evocare le onde, o un possente Samurai, rendono l'azione di gioco una delle caratteristiche più emozionanti e uniche di questo titolo.
<br><br>
Usa saggiamente queste trasformazioni per farti strada attraverso otto livelli ricchi d'azione, porre fine a quest'era oscura e riportare la pace nel mondo.
<br><br>
