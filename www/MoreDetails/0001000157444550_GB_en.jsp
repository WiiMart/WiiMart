...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157444550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Discover the fascinating world of astrology and let the stars guide you with Magic Destiny. Get ready for an exciting experience you will not forget in a hurry.
...
Venture into this captivating, magical world if you dare.</div>
  <div id="image02">
