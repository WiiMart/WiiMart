...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574D4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Qu'est-ce que MaBoShi: l'arcade des trois formes? Trois jeux en un seul! D'une apparente simplicité, il vous réserve pourtant bien des surprises.
<br><br>
A partir de trois formes de base - le cercle, la barre et le carré - vous allez pouvoir vous amuser jusqu'à trois joueurs à la fois, le tout simplement avec le bouton A et la manette +. Mais attention, le mode interactif va vous étonner...
<br><br>
L'objectif reste le même: atteindre un million de points, quant aux moyens... vous pouvez écraser vos ennemis avec le mode cercle, les envoyer valser en mode barre ou vous frayer un chemin dans le labyrinthe du mode carré.
<br><br>
Créez vos Mii préférés avec MaBoShi: l'arcade des trois formes et envoyez vos vidéos à vos amis grâce à WiiConnect 24. Vous pouvez même télécharger une version sur votre DS pour emporter MaBoShi: l'arcade des trois formes partout avec vous!
<br><br>
Le texte à l'écran sera en français.
<br/><br/>
Certains services en ligne proposés sur la console Wii ayant été désactivés le 28 juin 2013, les fonctions en ligne de ce logiciel utilisant WiiConnect24 ne sont plus disponibles.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4250/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">l'arcade des trois formes</span></div>
  </div>
