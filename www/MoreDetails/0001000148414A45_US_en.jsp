...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">An update is available that will make it easier for future users to download this channel. If you last updated this channel after October 9th, 2007, you will not see any changes if you update now.  For more details, see support.nintendo.com.
<p>
Some people like cats, others prefer dogs. Some like their eggs boiled, others fried. Everybody has their own opinion, and now there’s a way to find out exactly what other people are thinking. The results may surprise you! 
<br><br>
The Everybody Votes Channel brings you regularly updated questions upon which you can vote, simply by choosing one of the two answers provided. You can then check the results and see how your opinion compares with others in your own country and abroad. You can also see how much you have your finger on the public’s pulse, by predicting which answer will get the most votes. 
<br><br>
The Everybody Votes Channel is available for free, so gather your family around, share your opinions and discover what people really think!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Everybody Votes</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Channel</span></div>
  </div>
