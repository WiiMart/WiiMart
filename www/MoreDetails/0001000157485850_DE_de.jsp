...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157485850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Helix ist eines der innovativsten Musik- und Rhythmusspiele, das je für Wii entwickelt wurde!
<br><br>
Sie bewegen die Wii-Fernbedienungen durch die Luft und können damit über 30 außergewöhnliche Moves ausführen.
<br><br>
Lassen Sie sich von atemberaubenden, im Rhythmus pulsierenden Hintergrund-Visualisierungen faszinieren!
<br><br>
Eine Menge Songs in drei Schwierigkeitsgraden sorgen für einen hohen Wiederspielwert. Versuchen Sie, alle Songs freizuschalten!
<br><br>Hinweis: Es wird empfohlen, das Spiel mit zwei Wii-Fernbedienungen zu spielen.
