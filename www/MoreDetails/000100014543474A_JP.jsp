...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９８年にリリースされたミリタリーアクションゲームです。プレイヤーは巨大企業の暴走を止めるために、４人の傭兵から１人を選択してメインショット、ウェポン、ジャンプを駆使して戦います。前作で好評だった得点システム等はそのままに、今回はプレイキャラを一新した上で、操作可能な乗り物が登場し、ルート選択は要所で選ぶだけになるなど、大幅なゲームシステムの変更が行なわれ、より遊びやすく、そして手応えのある内容に仕上がっています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014543474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014543474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ショックトルーパーズ</span></div>
</div>
