...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157594950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Help Vektor escape the clutches of the evil CPU & its army of Patrols, Hunters and Interceptors.
<br><br>
Vektor has been locked inside your Central Processing Unit. He is not sure how he got there or how long he has been there but he needs your help to escape. The CPU has disabled Vektor's ability to move around independently but he is an expert coder.
<br><br>
Work with Vektor to help him escape the evil clutches of the CPU. Direct him through the CPU's labyrinth, avoiding enemy Patrols, Hunters and Interceptors. You must move fast as the CPU can adapt quickly to your escape. Vektor will code new abilities for you to combat the increasing power of the CPU, but his fate lies in your hands.
<br><br>
-30 levels of Retro Arcade Adventure action!<br>
-Boost and Blast your way through each level<br>
-Evade, escape and destroy enemies<br>
-Uncover the story behind Vektor's imprisonment</div>
  <div id="image02">
