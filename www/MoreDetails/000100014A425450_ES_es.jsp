...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Eres Bren McGuire, líder de las Fuerzas Interplanetarias Unidas y tu misión es salvar el planeta de Katakis de un ser llamado Machine, fuente de toda la maldad del universo. Tu único recurso será el traje de asalto Turrican.
<br><br>
Gracias al arsenal del traje de asalto Turrican, que dispone de armas como el rayo congelante, tienes el poder de todo un ejército. Usa todas las armas y los poderes para superar los 12 niveles, liberar a los inocentes habitantes del planeta Katakis y eliminar al malvado Machine.
<br><br>
