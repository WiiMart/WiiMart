...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157505550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“PUZZLE BOBBLE Plus!” is a simple but hugely addictive puzzle game in which you must try to burst a multicoloured mass of bubbles with your very own bubble launcher! Every time you make a group of 3 or more bubbles of the same colour, they pop! There are 2 game modes available: 1P PUZZLE, where players tackle the game’s 135 stages in pursuit of a new high score or best time; and BATTLE, in which players take on friends or computer-controlled opponents. <br><br>

And if all of that doesn’t satisfy your passion for popping, there are a total of 270 extra stages waiting for you in the 2 purchasable add-on content packs! That’s 135 new stages per pack! “PUZZLE BOBBLE Plus!” is simple to get into and deep enough to keep you coming back for more, so what are you waiting for!?</div>
  <div id="image02">
