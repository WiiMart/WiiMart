...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気レースゲーム「マリオカート」の第２弾。マリオやルイージなどおなじみのメンバー８人がサーキットで大暴れ。レーシングコースは、サーキットはもちろんのこと、峠、ビーチ、雪道、お化け屋敷などエキサイティングなコースがたくさん用意されています。レース中にゲットするアイテムで相手を攻撃したり邪魔したりするのもこのソフトの醍醐味。コントロールスティックによる華麗なハンドルさばきと戦略的なアイテム攻撃で、１位通過を目指します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マリオカート<sup>&reg;</sup>６４</span></div>
</div>
