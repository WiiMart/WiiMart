...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157324F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Aquarium 2, the sequel to the hit WiiWare title, "My Aquarium," is here. This time, the theme is the mysterious deep sea. With a single Wii Remote controller, you can raise fascinating creatures of all shapes and sizes, including deep-sea fish and glowing jellyfish! Like the original, you can customize your aquarium, and choose which fish to put in and where to place various decorations. You can also choose from a variety of colored lights to illuminate your aquarium. In time, your fish might breed to give you a whole new school to raise! Create your very own aquarium for endless hours of relaxing fun and entertainment!
<p>
This sequel features a larger selection of fish and objects than the original! And like before, you can link up to the Forecast Channel to reflect the actual weather. You can send your aquariums to registered friends via WiiConnect24. What's more, add-on content will be available for purchase later. Come dive in and see all the wonderful creatures of the deep blue sea!</div>
  <div id="image02">
