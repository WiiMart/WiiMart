...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ghosts 'N Goblins is a classic game that packs a heavy punch (and lance). Experience the game that helped catapult Capcom to the top of the arcade industry back in 1985 as you help Arthur defeat hordes of monsters in his attempt to rescue the princess. The first (and possibly only) game in which taking a hit reduces you to your underwear.</div>
  <div id="image02">
