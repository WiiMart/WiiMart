...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574B4B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">● What is Pop-Up Pirate!?<br>
...
Use these hints to guide your sword thrusts, staying away from the dangerous holes. For every successful sword thrust, extra time will be added to the total time remaining.</div>
  <div id="image02">
