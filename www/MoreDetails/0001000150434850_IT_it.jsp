...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Affronta i tuoi incubi peggiori nei cinque livelli di questo gioco in stile "rompi-il-mattone" e distruggi tutti gli oggetti presenti sullo schermo. Per salvare la tua amata e sconfiggere il demone che ne controlla i sogni e la tiene prigioniera, dovrai gettarti a capofitto nell’oscurità. Usa abilmente le frecce e controlla l’angolo d’impatto della sfera per distruggere i blocchi che scendono dalla parte superiore dello schermo!
<br><br>
Centra gli oggetti che sostengono più blocchi, per farli crollare tutti insieme con un colpo preciso! Man mano che prosegui nel gioco, i blocchi cambieranno forma e scenderanno più numerosi, dandoti l’opportunità di guadagnare punti bonus e rendendo la sfida sempre più difficile e divertente.
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Drop Off</span></div>
</div>
