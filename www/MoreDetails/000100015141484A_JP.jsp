...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「釣り」をテーマにしたロールプレイングゲームです。主人公は、妹の病気に効くという「川のぬし」を釣り上げるため、川岸のあちこちで魚釣りをはじめます。ときおり遭遇する動物と戦って主人公を成長させながら、魚の集まる釣り場を探しましょう。釣り場を見つけて竿（さお）を構えたらアタック開始！川のせせらぎや鳥のさえずりなどの自然の音を聞きながら、ウキの動きに注意し、ヒットしたら糸を引くタイミングに気をつけて、魚を釣り上げます。魚が釣れないときは「エサ」を替えたり「寄せえ」をまいたりなど、実際の釣りさながらのさまざまな工夫を試してみるのが有効です。ゲーム中に登場するのは実在する５４種類もの魚たち。釣った魚を「魚屋」に売り、そのお金で釣具をそろえて新たな魚に挑んでいくというロールプレイングゲームならではのシステムは、釣りファンならずともやり込み度たっぷりです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">川のぬし釣り 自然派</span></div>
</div>
