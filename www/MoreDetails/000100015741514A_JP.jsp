...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015741514A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">井出洋介氏監修のマージャンソフトがＷｉｉウェアに登場。一人用のコンピュータ対局はもちろん、遠く離れたプレイヤーとのＷｉ－Ｆｉ対局も楽しめます。<BR>Ｗｉ－Ｆｉ対局をすると、対局相手の打ち筋を覚えた分身（Ｍｉｉ）が一人用の対局相手としてやってきます。さらに、勝敗によってレーティング・段位が上下したり、振り込まないように固く打ち続けると「危険予知者」など打ち方によって称号を入手できたり、通信対局をすれば楽しみが広がります。<BR>
井出名人監修のＡＩが、どの牌を切るとよいか、どの牌が相手にとって安全かのアドバイスをくれる「サポート」や「安全牌予測」など、サポート機能も充実。<BR>
次に何を切るかを考える「井出名人問題」も受信して挑戦ができ、マージャンの実力アップにも役立ちます。（過去に配信された問題も挑戦することが可能です）<BR><BR>

【健康麻将とは】<BR>
「健康麻将（マージャン）」は、ゲーム本来の面白さを追及したマージャンです。世代や地域などによって異なるルールやマナーを統一し、誰でも気軽にマージャンを楽しめるよう考えられました。<BR>
ゲーム内では健康麻将ルールで統一されています。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015741514A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015741514A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">役満<sup>TM</sup>Ｗｉｉ　井出洋介の健康麻将</span></div>
</div>
