...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Donkey Kong and Diddy Kong go on a quest to recover their bananas stolen by King K. Rool. This jaw-dropping platform game revived the popular Donkey Kong™ franchise and is one of the biggest hits of the Super Nintendo. Donkey Kong Country™ uses pre-rendered 3D graphics which impressed gamers all over the world upon its release. The game is not only a visual feast but also offers quite a decent challenge for advanced players. Although the main adventure is enjoyable for everyone, finding all its secrets will require a lot of time and dedication.<br><br>In-game text can be set to English, German or French.
<br>Supports Wii Component cable Interlace Mode</div>
  <div id="image02">
