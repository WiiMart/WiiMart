...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Boulder Dash, sorti pour la première fois en 1984, est rapidement devenu un grand classique du jeu vidéo. Il fait partie de ce très petit nombre de titres qui ont été adaptés de leur plate-forme PC originale sur des bornes d'arcade (et non le contraire comme pour la plupart des autres jeux).
<br><br>
Le héros de cette aventure est l'explorateur Rockford, qui doit creuser dans des grottes et récupérer les pierres précieuses qu'elles recèlent, en évitant les créatures impitoyables et les chutes de rochers. Il est sans cesse menacé d'être écrasé par un rocher, emporté par une avalanche ou carbonisé par une explosion.
<br><br>
Organisation et stratégie sont donc les clefs pour maîtriser toute la "physique" de Boulder Dash. Une fois que le nombre de pierres précieuses à recueillir est atteint, la porte d'un mystérieux tunnel fait son apparition, et Rockford peut alors explorer une nouvelle grotte.
<br><br>
