...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lanzado por SNK en 1991, King of the Monsters es un juego de acción/pelea que ofrece batallas entre monstruos enormes mientras destruyes ciudades. Escoge uno de los seis monstruos y viaja por Japón, parando para pelear en ciudades famosas con el objetivo de ser el máximo ganador. Además de los golpes, patadas, y otros movimientos normales, cada personaje tiene la habilidad de usar maniobras más devastadoras, tales como lanzar llamas y disparar rayos, para derrotar a sus oponentes. El juego también incorpora elementos de lucha libre, ya que tendrás que agotar completamente a tu oponente y mantenerlo en el suelo durante el conteo de tres para ganar. Además de jugar individualmente contra la computadora, la opción de multiplayer (multi-jugador) te permitirá jugar uno contra uno o en equipos de dos jugadores contra la computadora. ¡Acepta el desafío para obtener el título de King of the Monsters!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414F45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414F45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">KING OF THE MONSTERS</span></div>
</div>
