...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">麻雀初心者でゲームセンター「ＹＯＵ＆ＭＥ」の店員である御崎恭子が、父の開発したスーチーペンダントの力によって、プロ並の腕前を持つ美少女雀士「スーチーパイ」に変身、個性的過ぎるライバルたちと戦っていく麻雀ゲームです。モードはスーチーパイが難事件解決に挑む「ストーリーモード」、ルールを自由に設定して遊ぶ「フリー対戦」、日頃の練習成果をトーナメント戦で試す「女王位モード」の３種類。ストーリーモードでは「パネルマッチ」というミニゲームの成果によって得られたアイテムを使うことによって、「積み込み」などができ、対局を有利に進めることができます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">美少女雀士スーチーパイ<sup>TM</sup></span></div>
</div>
