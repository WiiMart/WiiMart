...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">音速のヒーロー「ソニック」がマスターシステムで繰り広げるもうひとつの冒険。サウスアイランドを舞台に、ドクター・エッグマンとのカオスエメラルドをめぐる戦いをえがいたアクションゲームです。初代メガドライブ版『ソニック・ザ・ヘッジホッグ』をマスターシステム向けにアレンジしたもので、携帯用ゲームマシン「ゲームギア」用として発売されました。物語はメガドライブ版と同じですが、「ブリッジ」「ジャングル」などのオリジナル・ゾーンを含む６つのゾーンがソニックを待ち受けているほか、古代祐三氏による多数の追加ＢＧＭが冒険を盛り上げます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div><BR>JASRAC許諾番号：<BR>6727723185Y43030</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C41474A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C41474A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソニック・ザ・ヘッジホッグ<sup>TM</sup>（マスターシステム版）</span></div>
</div>
