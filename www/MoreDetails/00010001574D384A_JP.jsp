...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D384A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">対戦が熱いバトルゲームに特化した「ボンバーマン」シリーズの最新作がWiiウェアに登場します。<BR>今作は、Wi-Fi通信を使ってなんと最大８人までのバトルを気軽に楽しむことができます。操作もシンプルなので、家族や友人といつでもすぐにプレイすることが可能です。<BR><BR>また、Wiiリモコンを振ることで発動する新しいアイテムも搭載し、今までにないドキドキ、ハラハラした駆け引きが充実。さらに、自分で作成したMｉｉを使用しバトルに参加できるので、今まで以上に熱の入ったバトルになること間違いなしです。<BR><BR>バトルの結果は、Wi-Fiランキングに登録できるので、世界中のプレイヤー達と自分の実力を競うことができます。今までボンバーマンをプレイしたことのない人から、腕に自信のある人まで幅広く楽しめる一本となっています。<BR><BR>※ご注意<BR>本Wiiウェア「Wi-Fi８人バトル ボンバーマン」はWii専用ディスク「ボンバーマン」に収録されております「バトルゲーム」を抜粋した商品となります（一部ステージ除く）。また、Wii専用ディスク版とWiiウェアで通信対戦が可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wi-Fi８人バトル ボンバーマン</span></div>
</div>
