...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157424450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Brain Drain ist ein witziges und süchtig machendes Puzzle-Spiel.<br>
Du musst die Elemente eines durcheinandergebrachten Puzzles nach einem vorgegebenen Modell neu arrangieren.<br>
Drei Spielmodi :<br>
Herausforderung : Hier findest du 200 fertige Puzzles.<br>
Rennen : Eine Flut von Puzzles und Bestzeiten, die man schlagen muss.<br>
Willkürlich : Entspanntes willkürliches Puzzeln ohne Ende.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
