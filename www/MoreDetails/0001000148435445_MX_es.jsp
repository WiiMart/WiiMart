...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">U. Para transferir los datos desde tu consola Wii, necesitarás una tarjeta SD o una tarjeta SDHC con al menos 512 MB de memoria libre. 
<br><br>
...
<br><br>
Los Wii Points solo se pueden canjear en el Canal Tienda Wii. Debes descargar la aplicación Transferencia Wii U desde el Canal Tienda Wii de la consola Wii de origen.
<br><br>
Para comenzar la transferencia de datos, abre el menú de Wii en la consola Wii U para empezar el modo Wii y después abre la aplicación Transferencia de datos de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435445/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435445/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
