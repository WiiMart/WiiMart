...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ogre Battle 64: Person of Lordly Caliber è un GdR tattico per Nintendo 64 che, grazie alla sua storia accattivante, ai molteplici finali tutti da scoprire e a un sistema di classi decisamente rivoluzionario, ha saputo conquistare i cuori dei fan del genere per oltre un decennio.
<br><br>
Il gioco segue le peripezie di Magnus Gallant, un ufficiale fresco di nomina dell’Armata Palatina, che viene messo di stanza nella pericolosa regione meridionale della sua terra natia. Giunto a destinazione, Magnus diventa testimone delle condizioni in cui versano le classi più disagiate, vittime di un’élite tirannica che pensa solo a difendere i propri privilegi. Con lo scoppio della guerra civile il nostro protagonista dovrà fare una scelta difficile: tradire le sue nobili origini in nome della libertà o continuare a chiudere gli occhi di fronte a una società corrotta.
<br><br>
