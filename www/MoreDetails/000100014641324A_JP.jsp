...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードゲームとして登場し、１９８５年にファミコン版が発売されたシューティングゲームです。まるで実際に戦闘機を動かしているような、少しずつコントローラの操作に遅れて反応する独特の操作感が特徴。弾数に制限はあるが連射のできる「シングルビーム」と、連射はできないが弾数に制限の無い「デュアルビーム」を使い分けることが攻略のカギです。ほかのシューティングゲームとは異なる、一筋縄ではいかない難易度が当時話題になりました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エクセリオン</span></div>
</div>
