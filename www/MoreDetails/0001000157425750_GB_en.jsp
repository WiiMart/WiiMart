...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157425750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The critters have escaped and the barnyard is in chaos!  It’s up to you to quickly corral the animals in this puzzle action challenge!  You’ll have to mend fences in a hurry to keep all the critters safe and satisfied!  But the fun doesn’t stop with the farmland; more than 50 challenging levels take you to several exotic locations, including the Outback, the icy Arctic and more!  There’s even a series of mini-games for when the critters get you down: Snowball Soccer, Predator Rampage, Chicken Catch, and Fence Trap. Up to four players can compete or cooperate as the critters run wild.  So roll up those sleeves and grab a friend – those critters won’t catch themselves!</div>
  <div id="image02">
