...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ActRaiser es una obra maestra del diseño de videojuegos que fué lanzada al mercado en los primeros días del sistema Super Nintendo. Su constante popularidad proviene de la revolucionaria combinación de acción y simulación en su dinámica de juego. El jugador hace el papel del Maestro, un dios derrocado cuyo idílico mundo ha caído bajo el control del Maligno. Despojado de su poder divino, el Maestro debe encontrar la manera de acabar con el reinado del Maligno y reconstruir su mundo desolado.<p>
La dinámica de juego se alterna entre dos modos: Acción y Simulación. En el modo de Acción, el Maestro debe enfrentarse a situaciones imposibles para dominar seis territorios. Al dominar un territorio se desbloquea el modo de Simulación. En este modo, el Maestro debe supervisar el desarrollo y la repoblación del territorio que ha recuperado. Al hacer esto, ganará seguidores  que restaurarán gradualmente su fuerza divina, dándole el poder para recuperar el territorio siguiente y, finalmente, derrotar al Maligno.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A413745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A413745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ActRaiser<sup>TM</sup></span></div>
</div>
