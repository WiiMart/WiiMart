...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『写真チャンネル１．０復旧プログラム』は、
Ｗｉｉ用ソフト「大乱闘スマッシュブラザーズＸ」によるＷｉｉ本体の更新にともない、
「写真チャンネル」のバージョンが１．０（ＭＰ３形式対応）から
１．１（ＡＡＣ形式対応）に更新され、
元に戻すことができなくなる症状を復旧するプログラムです。
本症状が発生し「写真チャンネル」でＭＰ３ファイルを
ご利用いただけなくなったお客様は、このソフトをご使用ください。<BR><BR>
...
このソフトをご使用の際は、復旧処理を完了するためにＷｉｉ本体の更新が必要となります。
画面の指示に従い、Ｗｉｉ本体の更新をおこなってください。<BR><BR>

このソフトによる復旧後は「大乱闘スマッシュブラザーズＸ」を起動していただいても
本症状が発生することはございません。<BR>
また、復旧後にショッピングチャンネルより写真チャンネル１．１へ
再び更新いただくことも可能です。<BR><BR>

写真チャンネル１．０の動作をご確認いただいた後は、
このソフトを消去していただいても構いません。
その際は、Ｗｉｉオプションのデータ管理画面より消去してください。<BR><BR>

写真チャンネルのバージョンについての詳細は、<BR>
http://www.nintendo.co.jp/wii/q_and_a/112.html<BR>
をご覧ください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">写真チャンネル１．０復旧プログラム</span></div>
</div>
