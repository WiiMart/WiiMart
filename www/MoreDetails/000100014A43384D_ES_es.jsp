...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Descubre la historia del caballero oscuro Cecil, capitán de las Alas Rojas, las fuerzas de élite de Baronia, a medida que se embarca en un viaje lleno de pruebas, traición, amistad, pérdidas y descubrimiento de sí mismo. Acosado por las dudas acerca de la motivación real de su rey, ¿podrá Cecil apartarse del camino de la oscuridad y la destrucción?
<br><br>
Aunque originalmente fue lanzado para SNES en América del Norte con el título de FINAL FANTASY II, si se sigue un orden cronológico dentro de la serie, este juego correspondería en realidad al FINAL FANTASY IV.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43384D/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43384D/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FINAL FANTASY<sup>&reg;</sup> II</span></div>
</div>
