...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wander through miles of uncharted caves in search of the legendary underground pyramid and its vast treasures.  To complete your adventure, you will swing from ropes and ladders, run across unstable terrain and down ravines, as well as operate elevators, mining carts, and rafts.  You will collect keys, bombs, flares, jewels, sacks of gold coins, and other valuable items as you navigate the hazardous terrain.  But beware of the scalding steam vents, poisonous bats, and the avenging spirits of dead spelunkers that lurk in every corner of this massive underground labyrinth.
<p>
Spelunker TM & Game  © Timothy G. Martin. All rights reserved. Tozai Games is a trademark of Tozai Inc. registered in the US and/or other countries.</div>
  <div id="image02">
