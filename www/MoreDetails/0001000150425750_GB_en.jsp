...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Air “Zonk” is a spin-off of the popular Bonk’s Adventure series. This side-scrolling shooter retains the same cartoonish style of Bonk, but is set in a cyberpunk-esque future. The powered-up Zonk gathers his friends to form "Team Cool" and they set out to stop King Drool in his plan to conquer the world.
<br><br>
Choose from 3 levels of difficulty and 3 types of Friend Modes. Shoot King Drool's cyber robots and avoid their fire while collecting the Air Bones to unleash a variety of attacks. Enjoy unique moves like combining with a friend to create an invincible hybrid form or blasting enemies with a charged attack!
<br><br>
Air "Zonk” is also filled with humour, like the wacky theme song that plays when posting a huge score, or at GAME OVER!</div>
  <div id="image02">
