...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Street Fighter Alpha 2 llega a tu pantalla con un ritmo de juego vertiginoso e innovaciones asombrosas. Los contraataques Alpha y los increíbles combos personalizados marcarán un antes y un después en el género de los juegos de lucha. 
<br><br>
Lleva tus habilidades al límite mientras descubres nuevos movimientos y contraataques para cada personaje. Neutraliza los ataques de tus oponentes con contraataques Alpha altos y bajos y lleva a cabo increíbles combos personalizados para desencadenar una serie de ataques a una velocidad endiablada. 
<br><br>
Todos tus luchadores preferidos han vuelto con ganas de más. A Dan, Akuma y M. Bison, que eran personajes ocultos anteriormente, se les unen cinco nuevos contendientes: Rolento, Gen, Sakura, además de los favoritos de siempre Dhalsim y Zangief.
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A444350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A444350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Street Fighter<sup>TM</sup> Alpha 2</span></div>
</div>
