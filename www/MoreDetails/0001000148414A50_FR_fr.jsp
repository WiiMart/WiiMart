...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Certains préfèrent les chiens, d'autres les chats. Les uns aiment les œufs à la coque, tandis que les autres les préfèrent sur le plat. Nous avons tous des avis différents, et il existe désormais un moyen de connaître précisément celui des autres. Et vous serez surpris des résultats!
<br><br>
Sur la chaîne votes, vous pouvez répondre à des questions mises à jour régulièrement en choisissant tout simplement une des deux réponses proposées. Vous pouvez ensuite consulter les résultats et comparer votre réponse à celle des autres, que ce soit dans votre pays ou dans le monde entier. Vous pouvez aussi essayer de deviner quelle réponse recueillera le plus de voix de la part du public.
<br><br>
La chaîne votes est gratuite: toute votre famille peut se retrouver pour que chacun donne son avis sur la question et découvre ainsi ce qu'en pensent vraiment les autres!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414A50/FFFD0021" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414A50/FFFD0027" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chaîne votes</span></div>
</div>
