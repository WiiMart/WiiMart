...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">緑の恐竜のような外見を持つ「ワギャン」を操作する横スクロール型アクションゲームのスーパーファミコン版第一弾。ワギャンランドに再び現れた悪の天才科学者ドクターデビルを倒し、捕らえられてしまった仲間と島の平和を取り戻すため、主人公のワギャンが冒険の旅に出ます。迫り来る敵には、口から発する「ワッ」「ギャー」といった声による音波砲で攻撃をしてしびれさせることができます。しびれた敵にはジャンプして乗ることもでき、それによって行動できる範囲が広がります。各ステージの最後に待ち構えているボス戦では、シリーズでおなじみのしりとりや神経衰弱といったミニゲームで勝負をおこないます。さらに今作ではモザイク当てという新しいゲームも加わりました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーワギャンランド<sup>TM</sup></span></div>
</div>
