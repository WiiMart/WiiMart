...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">R-TYPE es un clásico arcade de disparos de desplazamiento lateral desarrollado en 1987 por Irem. El juego tiene lugar en el siglo XXII y eres la última esperanza de la humanidad para acabar con el malvado Imperio Bydo. Tu nave se llama "Arrowhead" de tipo R-9a y está equipada con un láser estándar, aunque en cada misión hay disponibles actualizaciones y mejoras especiales.  Navega a través de ocho desafiantes niveles que pondrán a prueba los reflejos del mejor de los jugadores. La versión de SEGA MASTER SYSTEM también incluye un exclusivo nivel secreto que no se encuentra en ninguna otra versión.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414F45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414F45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
