...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157455645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Viral Survival es un juego de acción de “evasión” donde controla una unidad especial de ADN y tendrá que esquivar ataques de virus enemigos. Si salva a una unidad de ADN aliada, se conectará a la cola de su unidad. Cuantas más salves, más puntos podrá acumular. ¡Hay otros cuatro modos de juego donde podrá disparar al enemigo y competir por el número de enemigos abatidos, o salvar a 128 unidades de ADN en el menor tiempo posible en un modo de ataque cronometrado! Su puntuación en cada uno de los cinco juegos pasará a una clasificación global en internet. ¡Hazlo lo mejor posible para convertirte en el número uno del mundo!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157455645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Viral Survival<sup>TM</sup></span></div>
</div>
