...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158484F50')", "wiiSelectSound()");
...
<br><br>
Usa il telecomando Wii e costruisci una torre che stia in equilibrio, in questo rompicapo basato su elementi di fisica.
<br><br>
L'obiettivo considerato principale nella creazione del gioco è stato quello di rendere il rompicapo accattivante e coinvolgente. Con ben 100 livelli, questo gioco non metterà soltanto a dura prova le tue abilità, ma anche la tua immaginazione. 
<br><br>
Gioca in solitaria o fai partecipare un amico in qualsiasi momento, con la modalità Cooperativa e un secondo telecomando Wii. È inoltre disponibile una modalità Testa a Testa, a schermo condiviso per due giocatori, che raddoppierà il divertimento.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484F50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484F50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Art of Balance</span></div>
</div>
