...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アクションロールプレイングゲーム「ドルアーガの塔」の続編です。ドルアーガから奪い返したブルークリスタルロッドを持って塔から脱出してください。カイとギルの協力プレイゲームですが１人でも遊べます。カイが敵と戦いながら鍵を手に入れ、コールギルの呪文でギルを呼んで、ふたり一緒に次の部屋へとすすみ、塔から脱出するとゲームクリアです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">イシターの復活<sup>&reg;</sup></span></div>
</div>
