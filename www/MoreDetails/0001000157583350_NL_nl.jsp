...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157583350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In "Successfully Learning: English Year 4" worden leerlingen via speelse, uitdagende oefeningen onderwezen in de Engelse taal. De kleine vampier Freddy motiveert de kinderen en helpt hen met tips.
<br><br>
Alle opgaves zijn gebaseerd op het huidige leerplan Engels.
<br><br>
"Successfully Learning: English Year 4" is te spelen in het Engels, Duits, Spaans, Frans, Italiaans en Turks.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157583350/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
