...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157444850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De Art Style-serie (exclusief via WiiWare) biedt een aantal unieke spellen die eenvoudig te leren zijn, maar tegelijkertijd barsten van de diepgang en sfeervolle beelden en geluiden.
<br><br>
Art Style: ROTOHEX is een puzzelspel met een hoog tempo voor een of twee spelers. Sorteer de gekleurde driehoekjes die in het speelveld vallen en draai ze rond om zeshoeken van dezelfde kleur te creëren en ze te laten verdwijnen. Naarmate het aantal kleuren toeneemt, neemt ook de moeilijkheidsgraad toe.
<br><br>
Voltooi de Solo Mode (stand voor 1 speler) om nieuwe spelstanden vrij te spelen, waaronder Endless Mode (oneindige stand) waarin je uithoudingsvermogen wordt getest, of de Sprint Mode (sprintstand) voor echte experts. Daarnaast kun je het in VS Mode (competitieve stand) opnemen tegen een vriend, om te beslissen wie de nummer één is!
<br><br>
