...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mike Jones is een gewone jongen op een buitengewoon avontuur! Mike is door zijn oom, een archeoloog, uitgenodigd op zijn tropische eiland, maar als hij daar aankomt, ontdekt hij dat zijn oom is ontvoerd. Mike zweert hem terug te vinden en de duistere geheimen van het paradijs te onthullen.
<br><br>
In StarTropics speel je op twee verschillende manieren. In de reislevels beweeg je Mike te voet over het eiland of in de duikboot van zijn oom. In de vechtlevels onderzoek je met behulp van allerlei wapens en voorwerpen grotten vol monsters.
<br><br>
Toen StarTropics oorspronkelijk werd uitgebracht, bevatte het spel een brief van Mike’s oom die je nodig had om verder in het spel te geraken. Voor de Virtual Console-versie is deze brief toegevoegd aan de handleiding, die je kunt raadplegen via het HOME-menu.<br><br>Het spel is voorzien van Engelse schermteksten.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146433650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146433650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">StarTropics<sup>TM</sup></span></div>
</div>
