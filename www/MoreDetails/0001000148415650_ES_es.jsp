...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Si no se te ocurre cómo divertirte, si no sabes qué cocinar o si simplemente quieres saber con qué color vestirte, ahora ya puedes consultar todos los días el Canal La fortuna te sonríe para obtener consejos y recomendaciones.
<br><br>
Este canal es la forma más divertida para que tanto tú como tus amigos y familiares consultéis consejos diarios sobre relaciones, actividades, alimentación e incluso para que descubráis vuestro color de la suerte. Hasta seis personas pueden registrar sus personajes Mii y su fecha de nacimiento para recibir recomendaciones sobre el estilo de vida que pueden llevar según lo que les vaticine el horóscopo.
<br><br>
Puedes descubrir además qué te depara la suerte si consultas las predicciones diarias que se ofrecen en cinco categorías diferentes: amor, trabajo, estudios, relaciones y dinero. La suerte para el día siguiente se da a conocer cada noche, así que puedes saber de antemano si te espera una jornada fabulosa.
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415650/FFFD001A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415650/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canal </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">La fortuna te sonríe</span></div>
  </div>
