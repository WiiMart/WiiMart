...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157564B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Scopri il lato comico degli sparatutto in prima persona con Water Warfare, usando armi ad acqua per combattere e inzuppare i tuoi avversari. Ogni mappa a tema (parco giochi, spiaggia, piazza o parco naturale) viene generata automaticamente all'inizio del gioco, permettendoti di elaborare nuove strategie ogni volta!<br><br> Le modalità di gioco includono missioni per giocatore singolo, partite contro avversari CPU e sfide per due giocatori in split screen.
<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564B50/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564B50/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
