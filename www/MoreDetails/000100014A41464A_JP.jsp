...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">プレイヤーが市長となって街を発展させる都市育成シミュレーションゲーム。市長は産業・交通・公安・災害など、多くの面に目を向けて街を育て、まずは人口５０万人の都市を目指します。シムシティーの中に居住する「シム」とよばれる住人たちの不平不満に応え、様々なハプニングを乗り越えながら、「シム」からの人望を集め、人口を増やしていきます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">シムシティー<sup>TM</sup></span></div>
</div>
