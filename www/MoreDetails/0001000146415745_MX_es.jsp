...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este es un juego de acción de espías con desplazamiento multi-direccional que es un éxito del pasado. Controla a un espía e inmiscúyete en un edificio para robarte los documentos secretos escondidos. Usa una pistola, patadas, un ascensor, e incluso las luces para derrotar a los guardias del edificio. ¡La acción de tiroteo está llena de emociones! Deberás usar tu velocidad y precisión de tiempo para subirte a los ascensores, moverte entre pisos, robar documentos secretos, y escapar del estacionamiento en el sótano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Elevator Action</span></div>
</div>
