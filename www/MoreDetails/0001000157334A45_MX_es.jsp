...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157334A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Triple Jumping Sports es el mas avanzado juego reacreacional de salto disponible para el servicio WiiWare. Sumergiendo al jugador  en el mundo competitivo del salto.
<p>
La mayoria de los eventos consisten en actividades que son tradicionalmente derivadas de la caza y el combate. A traves del tiempo se han desarrollado una variedad de deportes competitivos que incluyen el salto de longitud, salto de altura y salto con pértiga.
<p>
Igual que en la vida real en los eventos de salto tendras total control sobre la velocidad, altura, angulo y distancia del salto, todo esto influirá en el triunfo del salto.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334A45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157334A45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Triple Jumping Sports</span></div>
</div>
