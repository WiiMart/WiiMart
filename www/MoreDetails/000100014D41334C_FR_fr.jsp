...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dans ce jeu de réflexion sous forme de duel, vous devez faire disparaître les Puyo, des espèces de grosses gouttes tombant sur votre grille. Pour ce faire, vous devez aligner les Puyo ou les utiliser pour former des figures géométriques. Ces groupes doivent être constitués de Puyo de même couleur.<br><br>Le jeu est d'autant plus stimulant que lorsque vous faites disparaître un groupe de Puyo, des Puyo différents tombent sur la grille de votre adversaire et l'encombrent. Ainsi, plus vous éliminez de Puyo, plus la grille de l'adversaire se remplit. Si vous réussissez à la remplir complètement, vous avez gagné. Un scénario mystérieux rend le jeu encore plus amusant, que ce soit pour un ou deux joueurs. 
<br><br>Le texte à l'écran contient du japonais.
