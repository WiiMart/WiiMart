...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">誰でもすぐに楽しめるミニゲームを次々とクリアしていく、パズル＆アクション・パーティーゲームの決定版。ハッとしてフラワー、忍者どこじゃ？、迷い道くねくね、アニマルサウンドシャワーなど、見ているだけで楽しく、一目でルールがわかる、その名の通り盛りだくさんのミニゲームは、最大４人までのプレイも可能です。あの『ボナンザブラザーズ』の２人組が探偵に扮し、刑務所を脱走したボス一味を一網打尽にするため大活躍する、アーケードでも大ヒットした人気シリーズです。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">タントアール<sup>TM</sup></span></div>
</div>
