...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015749434A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ニックスクエストはヌンチャクでプレイヤーを操作しながら、Ｗｉｉリモコンの「神の力」で道を切り開く、新感覚の横スクロールアクションゲームです。幻想的なサウンド、光と影が織りなす質感あふれるグラフィックによって古代ギリシャ神話の世界を再現。地上に墜ちた盟友イカロスを救うためニックスは冒険に旅立ちます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015749434A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015749434A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ニックスクエスト</span></div>
</div>
