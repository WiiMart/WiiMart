...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rilasciato nel 1995, Real Bout Fatal Fury è il quinto gioco della serie di giochi di combattimento a incontri Fatal Fury. Pur mantenendo lo stesso impianto di gioco dei precedenti capitoli, questo titolo vede l’introduzione dello Sway Button, il perfezionamento del sistema di esecuzione delle combo e l'inclusione delle eliminazioni per ring-out, favorendo così un gameplay ben più variegato e veloce. In Real Bout Fatal Fury si possono selezionare 16 personaggi giocabili tra cui i fratelli Qín (i boss del precedente capitolo) o personaggi prediletti dal pubblico quali Billy Cane o Duck King. Prendi parte a questa battaglia senza esclusione di colpi!<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425A50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425A50/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">REAL BOUT FATAL FURY</span></div>
</div>
