...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001584A4950')", "wiiSelectSound()");
...
<br><br>Vier dappere gnomen beginnen aan een reis, die zo episch is dat ze geen idee hebben waar ze heengaan.<br>
Ga samen met Bumb, Berzerk, Speedster en Uncle Time op stap en vlieg, ren, stuiter, zweef en mep je een weg door het magische land Gnomia om naar hun mysterieuze bestemming te gaan.
Je kunt ze helpen het koninkrijk te redden, een prinses te vinden en honderden elegante verdwenen sokken te verzamelen.
<br><br>
Ren sneller dan een op hol geslagen konijn!<br>
Spring in één klap over grote gaten!<br>
Word sterker dan een tierende olifant!<br>
Schaf 2 Fast 4 Gnomz aan!
