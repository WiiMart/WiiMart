...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157464745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Frogger Returns takes the heart-pounding challenge of arcade Frogger and takes it into the next dimension! Classic top-down 2D gameplay is updated with colorful 3D graphics, a new perspective, all-new levels, new enemies and game-changing power-ups to dodge and use! Local multiplayer lets you race a friend to victory.<br>
• Enhanced graphics. Classic Frogger gameplay gets a brand new look.<br>
• All-new levels. Four stages take the original journey of Frogger from highway to home through an all-new adventure.<br>
• Multiple gameplay modes. Attack your top scores, race against the clock, or just get Frogger to his home pad. Play how you like!<br>
• New bosses and tactics. New enemies and power-ups change up your strategy.<br>
• Play with a friend! Local multiplayer lets you race a friend.</div>
  <div id="image02">
