...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">伝説の＜大破壊＞によって、人類の文明が崩壊した近未来。世界最強のモンスターハンターになることを夢見て旅に出た、名もない少年の冒険を描くRPGです。神様も魔法も存在しない荒廃した未来世界で、主人公に戦う力を与えてくれるのは、メカニックやソルジャーといった仲間たち。そして、クルマ。主人公は、戦車から救急車まで、さまざまなクルマを手にいれ乗りこなして、奇怪なモンスターたちがうろつく広大な世界を冒険します。人助けをするもよし、お金もうけに走るもよし、さっさと引退して平和に暮らすもよし、どこでどんな旅をするかはプレイヤーの自由です。ＷＡＮＴＥＤモンスターと呼ばれる、特に強い賞金首モンスターを倒せば、莫大な賞金と名声を手にいれることができます。賞金で自分の戦車を改造してさらに強くして、さらなる強敵に挑む･･････<BR>そんな冒険を続けていくうちに主人公は、人類滅亡の原因となった＜大破壊＞の秘密を知ることになるでしょう。『なぜ人類の文明は破壊されなければならなかったのか？』世界最強のモンスターハンターになった主人公は、その問いかけにどう答えるのでしょうか。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146464A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146464A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルマックス</span></div>
</div>
