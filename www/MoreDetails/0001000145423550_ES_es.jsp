...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Last Blade es un juego de lucha publicado originalmente en 1997. Está inspirado en el periodo “Bakumatsu” de la historia de Japón, en el que diez espadachines luchan por diferentes motivos. Similar a la serie predecesora “Samurai Shodown”, publicada por la misma compañía, se distingue principalmente en que, cuando seleccionas personaje, puedes elegir entre dos tipos de espada: “Poder”, diseñada para causar el mayor daño, y “Velocidad”, pensada para combates de velocidad extrema. Además de estas características, encontrarás elementos como el “Rechazo”, que permite al jugador rechazar los ataques del enemigo con más facilidad, y “Corte Sublime”, que anula el “Súper Corte” y puede ser combinado con el “Corte Súper Secreto”, los cuales son solo algunos de los elementos nuevos de la multitud de posibilidades que ofrece el juego. ¡Asegúrate de usar los poderosos movimientos como “Corte Súper Secreto” y “Corte Secreto Oculto”!
<br><br>
