...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「夕ご飯、何を食べる？」「今日は何して遊ぶ？」<BR><BR>
『きょうとあしたの占いラッキーチャンネル』は、日々の生活で迷いがちなことについて、みちしるべ（アドバイス）を知ることができるチャンネルです。<BR>
恋愛運や仕事運などの基本的な運勢を占えるほか、「仲良し占い」「食のみちしるべ」など、このチャンネルならではのオリジナルな占いを遊ぶことができます。<BR><BR>
「仲良し占い」では、登録した生年月日をもとに、選んだ人たち全員でのその日の相性を占います。相性が最高の日に一緒に遊びにでかけたり、協力して何かに取り組んだり、予定をたてるのに利用してみてください。<BR><BR>
「食のみちしるべ」は、その日のオススメ食材やジャンルなどのキーワードを占いで導きます。導かれたキーワードからその日のメニューを考えてみるのも面白いですよ。<BR>
「みちしるべ」には「食」のほかに、「何して遊ぶ？」を占う「遊のみちしるべ」、「何をキレイにすると運気があがる？」を占う「美のみちしるべ」があります。<BR><BR>
バラエティに富んだ占いがたくさん入った『きょうとあしたの占いラッキーチャンネル』で占い遊びをしてみませんか？</div>
  <div id="image02">
    <img src="/oss/ccs/000100014841564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014841564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">きょうとあしたの占いラッキーチャンネル</span></div>
</div>
