...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742344A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">西部劇をモチーフにした、ガンアクションゲームです。プレイヤーは保安官となって、目の前に現れる標的を次々と撃ちぬいてゆきます。間違えて善良な市民を撃たないように気をつけてください。全６ステージの美しい西部を舞台に、３種類のシューティング・チャレンジが楽しめます。２種類のマルチプレイヤーモード：チームモードで２人で協力して大量得点を目指すことも、対戦モードで友人と競い合うこともできます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワイルドウエストガンズ</span></div>
</div>
