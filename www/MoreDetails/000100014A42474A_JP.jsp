...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ダンジョン探索型ＲＰＧとして人気を博した『トルネコの大冒険』に続く「不思議のダンジョン」シリーズの第二弾。不思議のダンジョンは、挑戦するたびにダンジョンの形が変わり、何度でも新しい冒険を体験することができます。プレイヤーが１つ行動するまでモンスターも動かないターン制のシステムやダンジョンで倒れてもやり直しができない緊張感が特徴。危険なワナや個性的なモンスターが多数待ち受けるダンジョンで、さまざまな武器や道具を駆使して、黄金のコンドルが棲むといわれるテーブルマウンテンの登頂を目指します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42474A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42474A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">不思議のダンジョン２</span></div>
</div>
