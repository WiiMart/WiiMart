...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157434950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En CRYSTAL DEFENDERS R1, deberás desplegar
unidades diversas como soldados o magos
negros para detener cada oleada de monstruos
y evitar que escapen del área con los cristales de tu grupo.<br><br>
Hay muchos tipos diferentes de unidades para elegir. Algunas se especializan 
 en poderosos ataques de corto alcance, mientras que otras pueden usar
 magia desde lejos o están equipadas con fuertes arcos, con lo que podrán derribar 
 a enemigos aéreos. Coloca a tus unidades en lugares estratégicos para que sus habilidades innatas estén a tu favor.<br><br>
...
CRYSTAL DEFENDERS R1 incluye una gran variedad de niveles, cada uno con su propio diseño y dificultad. ¿Podrás defenderlos todos sin perder ni un solo cristal?<br><br>Textos de pantalla en español.</div>
  <div id="image02">
