...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157544B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">TV Show King vuelve para una segunda entrega. Hay más de 8000 preguntas divididas en 12 categorías, que incluyen conocimiento general, deportes, cine, música y más... ¡Y eso sin contar las preguntas que puedes crear tú mismo! Aquí tienes todo lo que necesitas para competir con tus amigos o con jugadores de todo el mundo gracias a la Conexión Wi-Fi de Nintendo.
<p>
• Compite con tus amigos en una partida para cuatro con el modo multijugador local, o juega en línea contra jugadores de todo el mundo a través de la Conexión Wi-Fi de Nintendo: ¡un programa sin fin!<br>
• Diviértete y aprende con las preguntas de imágenes. Por ejemplo, puedes identificar una obra de arte o descubrir la posición exacta de un país en el mapa.<br>
• Creador de preguntas: por primera vez, crea tu propio quiz y envíalo en línea. O aún mejor, descarga nuevos paquetes de preguntas creados por otros jugadores y disfruta de un desafío sin fin.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544B45/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544B45/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">TV Show King 2</span></div>
</div>
