...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Nell'anno 2025 sorge un conflitto fra la specie umana e una pericolosa razza aliena. Lucia, una ragazza di 16 anni, si unisce alla lotta assieme agli altri piloti dei caccia stellari della Earth Federation. Quando il padre di Lucia, Ken, viene rapito dagli alieni, la ragazza decide di impadronirsi di un nuovo prototipo di caccia, il "Gley Lancer", per volare in suo soccorso. In questo sparatutto a scorrimento orizzontale, salta nella cabina di pilotaggio del Gley Lancer, assumendo il ruolo di Lucia, e salva tuo padre annientando i malvagi alieni intenzionati a estinguere la razza umana!
<br><br>
Il testo all'interno del gioco include caratteri giapponesi.</div>
  <div id="image02">
