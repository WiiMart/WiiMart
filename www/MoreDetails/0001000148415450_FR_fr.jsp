...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000148415450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Vous voulez connaître les dernières infos sur les prochains jeux à sortir? Vous voulez trouvez des titres à vos goûts? La chaîne Nintendo est faite pour vous!
<br><br>
Cette chaîne vous propose des informations régulièrement mises à jour sur les nouveautés pour la Wii, la Nintendo DS, la console virtuelle et les nouveaux WiiWare. Vous y trouverez aussi des vidéos vous présentant des démonstrations de jeux et des reportages exclusifs en coulisses. La chaîne Nintendo vous donne également la possibilité, grâce aux avis donnés par les utilisateurs, de bénéficier de recommandations pour d'autres jeux qui pourraient vous plaire.
<br><br>
Si vous repérez un WiiWare ou un titre de la console virtuelle qui vous intéresse, vous pouvez accéder directement à la chaîne boutique Wii pour les télécharger. Vous pouvez même utiliser la chaîne Nintendo pour transférer des démos de jeux DS sur votre Nintendo DS, par le biais de communications sans fil!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415450/FFFD0010" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415450/FFFD001E" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chaîne Nintendo</span></div>
</div>
