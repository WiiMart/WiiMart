...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">音楽が言葉として使われている星を舞台に、魔人によってさらわれた王女を救うため、主人公ミロンが大活躍するアクションゲームです。ミロンは「バブル」で敵を倒したりブロックを壊したりして、隠されたドアやアイテムを探し出し、魔獣を倒してさらに城の奥へと進んで行きます。「楽器箱」を見つけるとプレイできるボーナスステージは、見つけた楽器に応じてＢＧＭが充実していき、最終的に７つの楽器によるアンサンブルへと発展する仕掛けは、音楽をテーマにした作品ならではの演出です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">迷宮組曲<sup>&reg;</sup></span></div>
</div>
