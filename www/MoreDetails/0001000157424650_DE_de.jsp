...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157424650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP FATE ist ein seitlich scrollendes Shoot ‘em up, bei dem CommanderVideo einem festgelegten Weg  folgt, um das Glück zu finden.
<br><br>
CommanderVideo braucht etwas Unterstützung von seinen Freunden aus BIT.TRIP RUNNER, wenn er die Pläne von Mingrawn Timbletot vereiteln will, der die Welt in ein hässliches Hightech-Szenario verwandelt hat.
<br><br>
Arbeite mit Junior Melchkin, CommandgirlVideo und anderen zusammen, um die Fähigkeiten von CommanderVideo zu erweitern und die Welt zu retten.
<br><br>
Ob du nun den Einzelspielermodus benutzt oder dich mit einem Copiloten zusammentust – du brauchst eine ruhige Hand, um das Schiff zu steuern und mit deinen Sprengladungen die verlorenen Seelen aufzuhalten, die dich vernichten wollen.
<br><br>
Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
