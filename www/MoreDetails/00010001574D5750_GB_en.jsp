...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">miffy’s world is a 2D game world based on the character authored by Dick Bruna. <br> In miffy’s world the player plays as miffy, exploring different locales and performing small quests, interacting with friends and objects, and accessing a series of educational mini-games.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D5750/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">miffy's world</span></div>
</div>
