...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157504345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">It's Little Mac Vs. Doc Louis! Do you have what it takes to spar with your friend and long-time trainer and prove you have the skills to fight in the World Video Boxing Association? Step into the ring and find out.</div>
  <div id="image02">
