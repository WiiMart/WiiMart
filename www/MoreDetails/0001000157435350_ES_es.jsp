...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157435350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Coge tu mando de Wii y juega a este juego de billar virtual! Disfruta de las "Partidas", jugando a los clásicos más famosos como el "Snooker", "Bola 9", "Bola 8" y "Rotación", además de superar tiros especiales en el modo "Puzle".<br><br>
Este juego ofrece dos tipos de control, permitiéndote "Golpear" virtualmente la bola blanca con tu mando de Wii, o utilizar los botones para ajustar la fuerza de tu tiro y después "Golpear".
Dedícale tiempo a mejorar tus habilidades en el modo "Práctica", aprendiendo así todas las técnicas guays necesarias para ser un auténtico ganador.<br><br>
Utiliza la característica de edición para crear tus propios desafíos y consigue realizar el tiro que siempre habías soñado lograr. ¡Realiza un tiro asombroso y muéstrale a todos quién manda en el billar!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435350/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435350/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
