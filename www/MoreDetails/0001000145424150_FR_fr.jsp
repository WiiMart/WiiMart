...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">MAGICAL DROP II est un casse-tête passionnant, édité en 1996 par Data East.<br><br> Le principe est simple : formez des lignes de 3 bulles ou plus afin de les faire exploser ! Il vous suffit de faire descendre une bulle et de la renvoyer en l'air dans la direction souhaitée. Outre la bulle magique qui fait disparaître toutes celles de même couleur, ou encore la bulle fléchée qui pulvérise celles qu'elle vise, vous pouvez également provoquer des réactions en chaîne et des combos. Attention toutefois aux bulles piégées qui ne feront que vous barrer la route !<br><br> Différents modes de jeu vous attendent : entraînez-vous en solo grâce au mode Puzzle, ou défiez des adversaires contrôlés par l'ordinateur en mode VS CPU. Un autre joueur peut vous rejoindre à tout moment pour des duels explosifs !
