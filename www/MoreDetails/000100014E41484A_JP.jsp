...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マリオシリーズに登場する「ヨッシー」が主人公として活躍するスクロール型アクションゲームの第二弾。絵本に閉じこめられてしまった世界を舞台に、生まれたばかりのカラフルなちびヨッシーたちがみんなのしあわせを取り戻すために冒険します。ヨッシーお得意の飲みこみアクションは今回も大活躍。ほかにも、ふんばりジャンプにヒップドロップ、タマゴを投げたり周囲をくんくんしてみたり、どれもコミカルでユニークなアクションばかり。にこにこメーターでヨッシーたちのごきげんに気をつけながら、コースの中にちりばめられたフルーツを３０個集めてまわればコースクリアです。絵本の最後のページにあるというベビークッパのお城をめざして６つのページを乗りこえ、「スーパーしあわせのツリー」を取り戻しましょう。まさに本物の絵本のような手ざわりが感じられる、見ているだけでも楽しい「手作り感覚」の世界観が特徴的な、ヨッシーシリーズの代表作です。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41484A/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ヨッシーストーリー<sup>&reg;</sup></span></div>
</div>
