...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157323245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“¡Listo, apunta y dispara!” aspira burbujas desde tu submarino para cazar peces y mostrarlos en tu acuario personal. Pesca y colecciona exóticos peces en profundidades marítimas como el Golfo de México, las Islas Ryukyu, la Gran barrera de coral y más. Intenta esquivar las especies que acechan en las profundidades para sabotear tu búsqueda de vida marina de todo el mundo y aumentar tu colección acuática.
<p>
Características:<br>
• Navega a través de 30 niveles de juego, todos ellos con desafíos y obstáculos únicos. ¡Ten cuidado con las superficies irregulares, las peligrosas medusas, las algas paralizadoras y más!<br>
• Colecciona miles de peces de distintas regiones como la Gran barrera de coral, el Golfo de México, la Dorsal mesoatlántica, la Meseta Kerguelen, las Islas Ryukyu y los Siete Mares.<br>
• Gana peces de bonificación coleccionables a medida que avanzas en el juego.<br>
• Presume de la fabulosa colección de tu acuario personal.<br>
• Desbloquea trofeos al completar con éxito cada región.
<p>
(Contenido del juego disponible en inglés y francés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157323245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157323245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Planet Fish<sup>TM</sup></span></div>
</div>
