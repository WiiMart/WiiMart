...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Disfruta del  fútbol de verdad  al dirigir a tu equipo en todo el campo.  Elige entre siete equipos internacionales: Estados Unidos, Gran Bretaña, Francia, Alemania, Brasil, Japón y España, y realiza todos los saques, saques de banda, tiros a la meta y tiros de esquina que podrías ver en un partido amistoso de verdad.  Puedes elegir el nivel de habilidad del equipo adversario, en una escala de uno a cinco, de modo que tus oponentes mejoren a medida que mejora tu equipo.  Elige un equipo en la computadora o juega contra un amigo.  ¡Puedes incluso elegir la duración del partido, y a medida que queda menos tiempo, esfuérzate por hacer el gol de la victoria!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414945/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414945/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Soccer</span></div>
</div>
