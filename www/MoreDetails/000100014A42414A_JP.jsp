...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">時は近未来。対消滅兵器によって陸地のほとんどを失った地球を舞台に、地球全土の支配を企むゾルゲフ率いる帝国軍とそれに対抗する連合軍（通称「ミリティア」）との戦いを描くリアルタイム型シミュレーションゲームです。プレイヤーは連合軍の司令官となり、与えられたオペレーション（作戦）をひとつずつクリアしていきます。
オペレーションは各地ごとで展開される局地戦です。戦力を配置し、設備を整え、戦費や敵軍の動きに注意を払いながら、リアルタイムに進行する戦場を臨機応変に戦い抜き、勝利を目指します。自軍と敵軍が交互に戦略を進めるターン制のシミュレーションゲームと違い、自軍と敵軍が同時に戦略を進めていくのが大きな特徴で、緊張感溢れる戦闘が魅力です。常に敵の動きをチェックし、対応策を練り、隙を突いて攻撃する。素早い判断力と実行力が勝利へのカギです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ミリティア<sup>&reg;</sup></span></div>
</div>
