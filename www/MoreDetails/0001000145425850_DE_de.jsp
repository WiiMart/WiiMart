...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Erstmals veröffentlicht 1993, Sengoku 2, ein belt-scrolling, beat 'em up Spiel. Die Charaktere sind Krieger, die von einer Zaubererprinzessin versammelt wurden, um den dunklen Herrscher zu besiegen, während sie sich durch verschiedene Epochen kämpfen. Wie in der vorherigen Version ist es möglich die eigenen Charaktere zu transformieren, aber im Gegensatz zum Vorgänger müssen nicht alle Verbündeten gerettet werden, um sich in diese zu transformieren. Vielmehr ist es möglich gleich von beginn an frei zwischen dem Ninja, Tengu und Ninja Dog zu wechseln. Außerdem fügt eines der neuen Elemente in dieser Version, die Verbindung von aufbauenden Angriffen und Verteidigungen, einen höheren taktischen Kniff zu diesem Action-Schlager hinzu.
<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425850/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425850/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SENGOKU 2</span></div>
</div>
