...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機「ソルバルウ」を操作して、敵機や敵の要塞を攻撃して破壊する
縦スクロール型シューティングゲームです。空中の敵には「ザッパー」、地上の敵には「ブラスター」で攻撃していきます。空中と地上へ別々の攻撃手段を使い分けるというスタイルは、縦スクロールシューティングのスタンダードのひとつとなりました。また、多数登場する敵の精緻な動き、美しく広大なマップ、印象的なサウンドは当時のプレイヤーに大きな衝撃を与え、創り込まれた世界観と隠された謎の数々とともに今も多くのファンを魅了しています。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゼビウス<sup>&reg;</sup></span></div>
</div>
