...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Super Star Soldier es un shooter vertical clásico. Además del NORMAL GAME, hay Time Attack Modes de 2 min y 5 min, y un modo en el que las mejores puntuaciones pueden ser comprobadas.<br>El NORMAL GAME está compuesto de 8 pantallas distintas, y en cada pantalla (excepto la pantalla 7), un jefe te espera al final.<br>La escuadra de ataque especial, dirigida por el Cerebro Madre, ha lanzado una invasión masiva sobre la Tierra. Coge tu pequeño caza, el Neo Caesar, con un arsenal de 4 armas regulares y 2 armas especiales, ¡y hazlos volver por donde vinieron!<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
