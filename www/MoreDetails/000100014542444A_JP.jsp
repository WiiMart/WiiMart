...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９７年にリリースされたパズルゲームです。プレイヤーはピエロを操作して、画面上部から迫り来る玉を吸い取ったり発射したりして、同色の玉をタテに３つ以上並べてどんどん消していきます。時間とともに玉が下降してくるので、のんびりしているとピエロが玉で押しつぶされてしまいゲームオーバーに…。すばやく的確な動きで玉を消しつつ、慣れてきたら連鎖を狙っていきましょう。基本ルールは前作と同じですが、この「３」では登場キャラクターが１６人に増え、新たに「すごろくモード」を追加。より奥深いマジカルドロップの世界を堪能いただけます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マジカルドロップⅢ</span></div>
</div>
