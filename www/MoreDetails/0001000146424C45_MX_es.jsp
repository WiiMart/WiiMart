...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego clásico de rompecabezas ha sido una referencia mundial para los videojuegos desde el momento de su creación hasta el día de hoy, produciendo muchas versiones y artículos relacionados durante todo este tiempo. El jugador controla al héroe, o "Runner", quien reúne pepitas de oro dispersadas en cada nivel, mientras evita ser capturado por los robots enemigos. La acción es simple, pero los niveles están diseñados como rompecabezas de dificultad creciente, y ninguno de los 50 niveles es tan fácil como parece. El Runner escapa de sus enemigos cavando agujeros en el piso a la derecha y a la izquierda de su posición - al hacer esto, él puede crear caminos hacia sitios que parecían inaccesibles a primera vista. Los jugadores tienen que usar la cabeza para  reunir todas las pepitas de oro en cada nivel si quieren escapar al siguiente. Además del modo normal, esta versión del juego introduce un Modo de Edición que permite a los jugadores diseñar sus propios niveles, creando un juego más divertido.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424C45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424C45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
