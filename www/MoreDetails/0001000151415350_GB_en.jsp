...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lords of Thunder is a side-scrolling shooter that has you take the role of a legendary warrior, blasting enemies to heavy metal tunes. Enemies are plotting to revive Zaggart, the Dark One, who was sealed beneath the six continents of Mistral. It's up to Landis, the descendant of Dyu, to stop them.<br><br>
You choose the order in which you attack the 6 stages. Before each stage, select one of four magic sets of armour and use the crystals you collect to buy items. Selecting the right armour for each stage is the key.<br><br>
Face awesome enemies, including a fire-spewing sea serpent and a giant insect. Whether it’s the fast-paced shooting action, or breaking into the boss fortresses, you’ll be blown away by the intensity of Lords of Thunder.</div>
  <div id="image02">
