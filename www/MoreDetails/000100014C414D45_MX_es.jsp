...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juega siendo Sonic o Tails en Sonic Chaos, un juego que fue lanzado for primera vez para la consola Sega Master System. El Dr. Eggman (también conocido como Dr. Robotnik), ha robado la Esmeralda del Caos roja (Chaos Emerald) para crear armas nucleares, lo que ha desequilibrado las otras Esmeraldas del Caos y las ha transportado a un universo paralelo. Como resultado, la tierra natal de Sonic, llamada South Island, ¡se está hundiendo en el océano! Elige a Sonic o a Tails y corre a toda velocidad por los distintos niveles en busca de las seis Esmeraldas del Caos. Realiza distintos movimientos, como Strike Dashes (embestidas) y Super-Peel Outs (sprints) siendo Sonic, o Spin Dash (gira) y Fly (vuela) siendo Tails mientras exploras cada rincón para restablecer el orden en Sonic Chaos.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414D45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414D45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
