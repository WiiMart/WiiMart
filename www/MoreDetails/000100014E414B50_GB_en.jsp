...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In Pokémon Snap, you capture Pokémon not with a Poké Ball but with a camera! As budding young photographer Todd, help Professor Oak research Pokémon by taking pictures of them from your purpose-built vehicle, the ZERO-ONE.
<br><br>
Travel across Pokémon Island and snap the Pokémon on their home turf. However, many Pokémon are camera-shy, so you’ll need to use special items like food or a flute to bring them out into the open.
<br><br>
...
<br><br>
Also, the Virtual Console version of Pokémon Snap has been enhanced to work with the Wii Message Board – so now you can share your favourite Pokémon pics with your friends!<br><br>Original Rumble Pak functionality not available.</div>
  <div id="image02">
