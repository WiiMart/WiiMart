...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157335445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pearl Harbor Trilogy - 1941: Red Sun Rising is the first title in a trilogy of air-combat action games for WiiWare™.
<p>
...
<p>
Featuring two campaigns spanning the early years of the Pacific War, you can play as either the United States Naval Air Force or the Imperial Japanese Navy Air Force. You can also choose to practice your combat skills in the Avenging Ace or Survival dogfight modes.</div>
  <div id="image02">
