...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">夢の国「サブコン」に迷い込んでしまったマリオたちが冒険するアクションゲームです。マリオやルイージだけではなく、ピーチ姫やキノピオをキャラクターとして使用でき、また、地面に埋まっている野菜や敵をひっこ抜いて投げつける独特のアクションで楽しめます。最大の特徴は選択したキャラクターによって能力が異なるところ。バランスの良いマリオ、ジャンプ力のあるルイージ、空中で長く飛ぶことができるピーチ姫、パワーのあるキノピオと個性のあるキャラクターを使い分け、コースクリアを目指します。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーマリオ<sup>&reg;</sup>ＵＳＡ</span></div>
</div>
