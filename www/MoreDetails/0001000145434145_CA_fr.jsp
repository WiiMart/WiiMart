...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Real Bout Fatal Fury 2: The Newcomers" is the 7th installment in the Fatal Fury fighting game franchise, and was first released in 1998. Based on the same game mechanics as previous installments, "Real Bout Fatal Fury 2: The Newcomers" boasts an evolved version of the 2-line battle, as well as many new features such as: "Break Shot" - a guard cancel system that is available for several moves; also, when a character continues walking, their sway line accumulates; and when a character is knocked down, if the player expertly times the gauge and button action, the character will swiftly get back on their feet. <br><br>
This time around 2 newcomers have been introduced: Li Xiang Fei the Kung-Fu master and a boxer by the name of Rick Strowd. And Geese Howard makes reappearance as playable character. Chose from 22 fighters and test your might!
