...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Publicado en 1996, Art of Fighting 3: The Path of the Warrior es un juego de lucha escenificado en Grasshill Valley, donde toman lugar dramas y batallas entre varios luchadores. Aparte de los protagonistas, Ryo y Robert, esta versión contiene toda una serie de nuevos personajes. Art of Fighting 3: The Path of the Warrior viene con poderosos combos aéreos, maniobras de bloqueo mucho más eficientes, la habilidad de infligir daño a oponentes caídos y un sistema de combates de una ronda llamado “Ultimate K.O.”. Además, los gráficos están basados en la tecnología de captura de movimiento, con lo cual logra un estilo de lucha más auténtico y hace de este juego uno de los más innovadores juegos de lucha en 2D.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
