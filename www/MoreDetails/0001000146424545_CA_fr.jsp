...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">As Popo, use your trusty mallet to work your way up the mountain. Chip away at the blocks overhead, then jump up through the resulting hole to the mountain's next level. Once Popo reaches the top level, he enters a fast-moving bonus stage in which he can pick up veggies and, hopefully, reach the summit for a big-point payoff. Of course, not everyone's supportive of Popo's pastime. Toppies fill Popo's holes, so jump through the gaps quickly. It's easy to slip off some of the icy levels as Polar Bears, Toppies, and other ferocious fauna don't want you up there. There are 32 challenging peaks to scale--face them alone or with a friend!</div>
  <div id="image02">
