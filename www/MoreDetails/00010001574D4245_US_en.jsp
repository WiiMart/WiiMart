...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D4245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Featuring three distinct modes and simultaneous play across three game windows, the constantly changing environment of Maboshi’s Arcade creates an atmosphere unlike any other. Each of the modes is based on one of three familiar shapes (circle, stick, and square) and offers the same goal: score a million points. Use the intuitive controls to bash enemies in Circle mode, weave your way through Stick mode, or burn a path around obstacles in Square mode—all while dealing with power-up items and keeping watch on what effects the other game windows may have on your own. Also featuring Mii™ characters, action replays that you can send to your Wii™ Friends via WiiConnect24™, and the ability to download a version to a Nintendo DS™, you may never want to leave this arcade!</div>
  <div id="image02">
