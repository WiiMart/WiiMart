...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Play through a total of 18 Olympic events in this action/sports title. Players compete in 6 categories of events that include shooting, archery, rowing, swimming, and track and field. The game features Olympics mode, where you play all the events over the course of a few days, and Training mode, where you can choose individual events to play. After practicing in Training mode, go for the gold in Olympics mode and break world records! Depending on your play time and ability, you can enjoy the game a number of different ways. Gather friends and play in competitions with up to 5 players to get even more out of this great game.
<p>
