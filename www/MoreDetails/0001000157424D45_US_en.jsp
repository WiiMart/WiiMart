...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157424D45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Pokémon phenomenon debuts on WiiWare with My Pokémon Ranch, a game that lets you watch as Pokémon and Miis interact with each other for the first time. Enjoy the relaxing Ranch life by viewing your Ranch and its Pokémon, taking pictures, and sending those pictures to your friends via the Wii Message Board. The more Pokémon and Miis that you bring to your Ranch, the more fun it becomes!
<p>
My Pokémon Ranch can be linked with the Nintendo DS™ Pokémon® Diamond version and Pokémon® Pearl version Game Cards to deposit the Pokémon you’ve caught in these games to your Ranch! You can deposit a maximum of 1,000 Pokémon from up to eight different Game Cards! Make your Ranch more lively by playing with your friends and family!</div>
  <div id="image02">
