...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157414C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La série Art Style vous présente un jeu de course original qui vous fait voyager plus vite que la lumière!
<br><br>
Dans Art Style: light trax, vous contrôlez un rayon de lumière qui se mesure à d'autres rayons dans des courses effrénées. Votre rayon de lumière avance automatiquement, à vous de gérer sa vitesse et sa position sur la piste pour accumuler de l'énergie et laisser vos adversaires sur place. Prenez garde aux changements de perspective, profitez des panneaux d'accélération et évitez les obstacles pour ne pas perdre de précieuses secondes.
<br><br>
Vous avez le choix entre deux modes de jeu principaux: le mode grand prix (séries de courses), et le mode autoroute (course d'orientation contre la montre). En fonction de vos performances, vous pouvez avoir accès à de nouveaux modes de jeu.
<br><br>
Plus rapide que la lumière, Art Style: light trax vous permet de vous détendre tout en testant vos réflexes grâce à des commandes simples et une musique d'ambiance captivante.
<br><br>
