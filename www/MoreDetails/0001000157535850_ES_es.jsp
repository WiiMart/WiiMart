...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157535850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stunt Cars se desarrolla en circuitos de carreras elevados, que no otorgan al jugador ninguna oportunidad de salirse de la trazada. Se puede usar el Turbo para hacer que el coche vaya más deprisa, pero solo se puede usar por un breve periodo de tiempo.
<br>
Conforme avanzas por las cuatro copas del campeonato, podrás acceder a las funciones especiales desbloqueables como los premios a la mejor conducción y nuevos vehículos para competir.
<br><br>
CARACTERÍSTICAS PRINCIPALES:
<br><br>
- 24 pistas salvajes y desafiantes con grandes saltos, rampas y túneles.
<br><br>
- Hasta 4 jugadores en carreras multijugador con pantalla dividida.
<br><br>
- Escoge entre 6 coches distintos, con características diferentes de velocidad, aceleración y peso.
<br><br>
- Premios por logros en carreras: 12 en total, entre los que se encuentran Gold Hero (Héroe de oro), Track Warrior (Guerrero de las pistas), Stopwatch Pro (Profesional del cronómetro), Stunt Champion (Campeón de acrobacias).
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157535850/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157535850/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Stunt Cars<sup>TM</sup></span></div>
</div>
