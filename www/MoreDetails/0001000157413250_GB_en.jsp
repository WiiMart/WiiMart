...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157413250')", "wiiSelectSound()");
...
<br><br>
Or, if you’re in a party mood, try Multiplayer Mode for up to four players! You can play with friends, against the computer, or a combination of both. Work together to clear the Gemstones or compete to see who’s the Actionloop Twist master!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413250/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
