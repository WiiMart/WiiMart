...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La primera parte en las extremamente populares series de juegos de pelea fue estrenado en 1993. Elige entre doce espadachines con altas características individuales y que pelean furiosamente, para últimamente confrontarte al malévolo Amakusa Shio Tokisada. Cada personaje ostenta su propia arma específica, pero tienes que tener cuidado de no perderla durante la batalla. Algunos de los luchadores también entran a la mezcla con compañeros animales, los cuales ofrecen un aspecto único a la acción frenética.  Otra de las funciones significantes del juego es el medidor de enojo, el cual indica el nivel de enojo sentido por cada de los combatientes tras ser lesionado repetitivamente. Si el enojo alcanza el nivel máximo, la habilidad de ataque del personaje aumentará, causando una confrontación más intensa. A través de todo esto, el sistema refinado de cámara fácilmente se acerca y se aleja del campo de batalla, mostrando la locura de la pelea y al mismo tiempo demostrando el fondo animado (¡ve como le pegan al árbitro!). ¡Despierta al espíritu samurai interno y prepárate para un nuevo tipo de batalla!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SAMURAI SHODOWN</span></div>
</div>
