...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">World Heroes 2 Jet, juego publicado originalmente en 1994, es la tercera entrega de  la prolífica y afamada saga de videojuegos de lucha World Heroes. En ella deberás elegir entre 16 héroes o villanos históricos y combatir para alcanzar el título de mejor luchador de todos los tiempos. Esta versión se divide en dos modos de juego: “Modo Torneo de Titanes” y “Modo Entrenamiento World Heroes”. En el primero, realizarás tres combates al día; si los superas, avanzarás a la siguiente jornada. En el segundo, podrás enfrentarte ante cualquier oponente. Añade también novedades técnicas como la carrera y el paso atrás, elementos ausentes en las versiones anteriores, además de un sistema de conteo para hacer aún más emocionante la lucha. Y si fuera poco, escoge entre cuatro tipos de competición para elegir, a cada cuál más intenso.
<p>(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415445/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
