...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ドンキーコングの続編、今度はマリオによってオリに閉じ込められたドンキーコングを息子のジュニアが救出するアクションゲーム。敵の攻撃をよけながらカギを集めて、ドンキーコングを助け出します。ジャングル風のステージでツルを上り下りするアクションが特徴的。今となっては珍しい、マリオが悪役として登場するゲームです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドンキーコング<sup>&reg;</sup>ＪＲ．</span></div>
</div>
