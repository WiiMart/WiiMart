...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157454E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Hai le carte in regola per sfidare in pista i tuoi avversari?
<br><br>
TNT Racers è un divertente gioco di corse per più giocatori, che unisce nuovissime funzioni ad un'azione di corsa rapidissima. Grazie alla modalità fantasma, tutti i giocatori rimangono in corsa, anche quando uno dei piloti è chiaramente in svantaggio. Ma la funzione più accattivante sono gli oggetti da lasciare sul circuito, che alla fine decidono le sorti della corsa. Trofei, fantastici percorsi e oggetti mozzafiato: questo gioco è una vera iniezione di adrenalina. Acquista subito la tua copia di TNT Racers e scendi in pista per sfidare i tuoi avversari!
<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157454E50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157454E50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">TNT Racers</span></div>
</div>
