...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157335245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Triple Running Sports is one of the most advanced recreational running game available for the WiiWare service, immersing the player in the world of competitive running.
<p>
Most events consist of activities that are traditionally derived from hunting and combat skills. Over time these practices have evolved into a variety of competitive sports that include 100m, 400m Sprints, Hurdles and the 1500m race.
<p>
As with real life running events you will have full control over the pace of the race. You must also take into account the finish line surge and the timing of hurdle jumps as these can all influence the success of the race.</div>
  <div id="image02">
