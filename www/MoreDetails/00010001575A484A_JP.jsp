...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001575A484A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アニマル ライフは、普段は飼うことが難しい動物をWiiリモコン1つで簡単・気軽に育てることができる育成ゲームです。<BR><BR>動物は全部で12種類（内4種類は有料追加コンテンツ）、自分の好きな動物を選び、育てましょう。<BR><BR>動物たちに食事をあげたり、撫でたり、飼育場の掃除をして、触れ合うことができます。<BR><BR>さらにプレイヤーが動物たちにどのように接したかによって、彼らの性格も甘えん坊や食いしん坊などに変わっていきます。<BR>大人になりオスとメスを同じ飼育場で育てれば、赤ちゃんが誕生することもあります。<BR>もちろん、生まれた赤ちゃんもプレイヤーが育てることができます。<BR><BR>ゲーム内では、現実より早いスピードで時間が流れています。<BR>動物たちは、昼行性・夜行性の違いで、活動時間が違います。<BR>動物たちの生態を観察する楽しさもあります。<BR><BR>色々な動物を育てて、あなただけの動物園を作りましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A484A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A484A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アニマル ライフ</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">動物ふれあい生活</span></div>
  </div>
