...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Invité par la princesse Peach dans son château, Mario se rend compte qu'elle a été enlevée par Bowser et ses sbires. Cependant, quelque chose est différent... cette fois l'aventure est en 3D. Découvrez les secrets du château de Peach et trouvez les 120 étoiles en amenant Mario dans une nouvelle dimension avec ce titre inoubliable de la Nintendo 64. Considéré comme l'un des meilleurs jeux de tous les temps, Super Mario 64™ sut rester fidèle à l'esprit de la série, notamment en restant toujours aussi maniable malgré l'ajout de nouveaux mouvements. Ce jeu démontra toute l'utilité du stick directionnel qui devint par la suite un standard dans les jeux vidéo.</div>
  <div id="image02">
