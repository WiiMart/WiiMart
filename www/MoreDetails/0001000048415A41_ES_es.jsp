...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Esta actualización gratuita y opcional del Canal Fotos cuenta con las siguientes novedades:
<br><br>
<b>Icono personalizable</b>
<br>
Podrás cambiar el icono del Canal Fotos que aparece en el menú de Wii. Elige tu foto favorita de una tarjeta SD o del tablón de Wii. 
<br><br>
<b>Cambio de formato de archivos de sonido</b>
<br>
Se ha sustituido el formato MP3 por el formato AAC para los archivos de sonido que se pueden reproducir durante la presentación en forma de diapositivas. Los archivos AAC presentan mejor calidad de sonido con el mismo tamaño que los archivos MP3. 
<br><br>
Atención:
<br>
- Cuando hayas descargado la versión 1.1 del Canal Fotos, no podrás reproducir archivos de sonido con formato MP3. Si borras la versión 1.1 del Canal Fotos, recuperarás la versión anterior del canal (1.0). 
<br><br>
- Las consolas Wii a la venta a partir de diciembre de 2007 incluyen la versión 1.1 del Canal Fotos y no permiten volver a la versión anterior del canal (1.0).</div>
  <div id="image02">
    <img src="/oss/ccs/0001000048415A41/FFFD001A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000048415A41/FFFD001B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canal Fotos 1.1</span></div>
</div>
