...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">本作は『メタルスラッグ２』のアレンジバージョンです。『２』をベースにしつつ、敵を追尾する「アイアンリザード」や弾がバウンドする「ドロップショット」といった新しい武器を追加し、新たな敵も多数登場、さらにボスなどの配置を変更することでゲームの難度を調整しています。他にも背景の変更、ＢＧＭの一部再編集といった演出面でのアレンジやリメイクも楽しめ、ゲームとしての面白さは折り紙つきです。さらに“メタスラファン”であれば『２』との違いを探しながらプレイすると新たな発見があるかもしれません。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014543434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014543434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルスラッグX</span></div>
</div>
