...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Neutopia 2 è il seguito di “Neutopia”, l’acclamato gioco di ruolo già disponibile per il download.
Il malvagio demone “Dirth” è tornato!<br><br> Tu impersoni il figlio dell’eroe principale del primo episodio e devi riprendere la caccia al demone iniziata da tuo padre. Usa la "bussola magica" e le informazioni che otterrai durante il gioco per entrare in enormi labirinti e sconfiggere i boss che li popolano.
Esplora il vasto e talvolta insidioso mondo di Neutopia 2, raccogli informazioni e oggetti e trova l’accesso a stanze segrete spostando blocchi e distruggendo pareti.<br><br> La grafica arricchita, il nuovo sistema di controllo e la trama avvincente fanno di Neutopia 2 un titolo che migliora sotto tutti gli aspetti il già ottimo predecessore.
La pratica funzione di salvataggio, il livello di difficoltà perfettamente bilanciato e la storia coinvolgente rendono Neutopia 2 un GdR adatto a tutti i giocatori. 
