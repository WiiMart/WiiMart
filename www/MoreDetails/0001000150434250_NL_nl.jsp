...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit zijwaartsscrollende schietspel bevat zes verschillende ‘scènes’, verdeeld over het gebied tussen de aarde en de maan.
Het verhaal begint wanneer nabij Pluto een komeet wordt ontdekt en deze recht op de aarde lijkt af te koersen. Het lukt de mensheid ternauwernood de komeet te ontwijken, die tegen de maan te pletter slaat. Onderzoek naar de schade wijst echter uit dat het geen komeet was, maar een reusachtig moederschip.
<br><br>
Rust je schip uit, vernietig vijanden en vecht je een weg langs eindbazen in een poging de kern van de maan te bereiken en de aarde tegen een buitenaardse invasie te beschermen. Ontdek de unieke wereld van Dead Moon met onder meer gevarieerde levels met fraaie achtergronden, een systeem om zowel je aanval als je verdediging op te voeren en baasgevechten waarin je je schip goed zult moeten besturen om een kans te maken!
...
<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dead Moon</span></div>
</div>
