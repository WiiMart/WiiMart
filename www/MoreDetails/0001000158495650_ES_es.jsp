...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495650')", "wiiSelectSound()");
...
<br><br>¿Piensas que tienes lo que hace falta para ser una superestrella? ¡Mix Superstar te ofrece todo lo que necesitas para demostrar lo que vales!<br><br> Esta aplicación incluye más de 1000 bucles de Dance, Hip Hop y Tecno para varios instrumentos, como la batería, el bajo, el sintetizador o la guitarra, e incluso grabaciones de voz para que crees, mezcles y grabes tus propias canciones en tu consola Nintendo Wii.
<br><br>
Cuando hayas creado tu obra maestra podrás darla a conocer. Exporta tus creaciones musicales a tu ordenador para tenerlas siempre a mano, o utiliza WiiConnect24 para enviarlas a tus amigos Wii. ¡Incluso podrás colaborar con ellos para crear otras mezclas!
<br><br>
El programa es compatible con el micrófono USB de Logitech y con Wii Speak, que te permitirán incorporar tu propia voz a los temas que compongas.
<br><br>Además, gracias al servicio Pay & Play de la Conexión Wi-Fi de Nintendo, podrás descargar paquetes con bucles extra de varios estilos de música que te permitirán crear muchos más temas.<br><br>
Vamos, ¿a qué esperas para saltar al estrellato?</div>
  <div id="image02">
