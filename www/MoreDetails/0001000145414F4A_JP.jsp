...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９２年に発売された、モンスター同士の戦いをテーマにプロレステイストを盛り込んだアクションゲームです。プレイヤーは６種類のモンスターからひとつを選んで日本各地を転戦し、その頂点をめざします。各キャラクターは、パンチやキックといった通常攻撃のほか、それぞれが持つ火炎攻撃やビーム攻撃などのより強力な必殺技を駆使して敵と戦います。ただし、敵の体力をゼロにした上で３秒間フォールしなければ、勝利とはなりません。また、こちらがフォールされたときはボタンを連打して切り抜けましょう。２人プレイにも対応しており、１対１の対戦プレイや、ＣＰＵを相手にした２対２のタッグマッチも可能です。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">キング・オブ・ザ・モンスターズ</span></div>
</div>
