...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C5045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Buscas un juego que tenga el reto de un rompecabezas, pero que pueda ser jugado por cualquiera? No busques más, LONPOS es ese juego, pues contiene una mecánica de juego simple y una gran variedad de rompecabezas por resolver. Cada rompecabezas gira alrededor de un campo de juego rectangular que cuenta con 55 espacios y usando un conjunto de doce piezas. Tu meta será colocar cada pieza dentro del campo de juego para llenarlo. Entre más alto sea el nivel de dificultad, mayor será el número de piezas que deberás colocar correctamente dentro del campo de juego. Enfrenta el desafío de los dos modos para un jugador o invita a un amigo a jugar contigo otros modos en los que ambos podrán cooperar o competir uno con el otro. Cuando sientas que conoces bien el juego, usa la Conexión Wi-Fi de Nintendo para medirte con otros jugadores de LONPOS, o para buscar nuevos retos y experiencias al descargar nuevos rompecabezas y fondos de pantalla.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C5045/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C5045/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">LONPOS</span></div>
</div>
