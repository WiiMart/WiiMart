...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157525245')", "wiiSelectSound()");
...
<p>
Features:<br>
- Complete 12 levels, defeating numerous enemies and visiting different locations in medieval England<br>
- Search for hidden objects to get bonus points<br>
- Fight with super villains, such as the Sheriff of Nottingham<br>
- Replay the game to improve your score in the High Score Table</div>
  <div id="image02">
