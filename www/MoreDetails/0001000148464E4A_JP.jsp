...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『Wii Fit からだチェックチャンネル』は、自宅のリビングであなたのからだの状態をチェックできるチャンネルです。<BR>
<BR>
登録した指導者からの質問に答えると、回答内容とともに『Wii Fit』の測定データが指導者に送信されます。<BR>
指導者はそれらの内容からあなたのからだの状態をチェックし、あなたの健康をサポートします。<BR>
<BR>
また、相談したいことがあれば指導者にメールを送ることもできます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148464E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148464E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii Fit<sup>TM</sup> からだチェックチャンネル</span></div>
</div>
