...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気ロールプレイングゲーム「英雄伝説」シリーズ第二弾のメガドライブバージョンです。前作で「イセルハーサ」の世界を救ったファーレーンの王子、セリオス。今回は彼の息子「アトラス」が、大規模な地震とともに起こった新たな世界の危機を救うべく、旅の仲間たちと冒険を繰り広げます。セリオス、ディーナほか、前作の登場人物たちも、大きく成長した姿で登場してドラマを盛り上げ、前作で残された謎も明らかになります。基本システムはシリーズを踏襲しており、２Ｄフィールドによる移動とコマンド選択式の戦闘による快適なシステムと、心躍るＦＭサウンドも健在です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドラゴンスレイヤー<sup>&reg;</sup>　英雄伝説Ⅱ</span></div>
</div>
