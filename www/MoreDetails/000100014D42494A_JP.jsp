...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">トレジャーハンターのライルが、小さな相棒フライデーとともに幻の財宝を求めて大冒険の旅に出るアクションＲＰＧです。「ＤＤＳ－５２０」と呼ばれる独自の立体システムにより表現されたフィールドは、街もダンジョンもすべての場所が「高さ」を持った立体空間。転がりせまる岩、空中通路、立体迷路など３Ｄならではの仕掛けの数々がプレイヤーを苦しめ、魅了します。「シャイニング」シリーズの制作スタッフによる魅力的なキャラクターたちとイベントたっぷりのストーリー展開で多くのファンを生んだ、メガドライブ史上でも特に高い人気を誇るタイトルです。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ランドストーカー<sup>TM</sup>　皇帝の財宝</span></div>
</div>
