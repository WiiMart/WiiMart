...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年にリリースされたアクションゲームです。プレイヤーは権べ（１P）か田吾（２P)を操作して、横暴な代官を懲らしめるために一揆を起こします。各ステージでは、忍者、鉄砲隊、いのしし、亡霊、腰元など、多彩なキャラクターが襲い掛かってきますが、カマや竹やりで攻撃し、足を使ってかわして、８枚の小判を回収しましょう。無事に全ての小判を回収するか、代官を捕まえると次のステージへと進めます。果たして、あなたは横暴な代官に、一泡吹かせることができるのでしょうか。<BR><BR>詳細は、<Center>http://www.vc-arcade.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">いっき</span></div>
</div>
