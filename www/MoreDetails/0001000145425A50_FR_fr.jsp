...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Real Bout Fatal Fury est sorti en 1995. Il s’agit du cinquième episode de la série de jeu de combat. Tout en étant basé sur les anciennes versions, ce nouvel épisode ajoute un bouton indépendant pour le changement de plan, un système d’attaques combinées plus évolué ainsi que la sortie du ring. Le jeu est plus rapide et plus agréable à jouer. Real Bout Fatal Fury comprend 16 combattants jouables dont les frères Qin (le boss de l’épisode précédent), ainsi que Billy Cane et Duck King. Ces derniers étant demandés par les joueurs. Participez à une compétition acharnée pour en atteindre le sommet ! <br><br>Texte écran en anglais.</div>
  <div id="image02">
