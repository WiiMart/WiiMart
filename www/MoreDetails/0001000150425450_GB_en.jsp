...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">China Warrior is a side-scrolling action game that was released around the same time as the PC Engine (Turbografx) was in Japan. It’s up to the Kung Fu master Wang to defeat the Dark Emperor, who stands at the top of the Kung Fu world in China. Punch and jump kick your way through all the enemies between you and the three bosses of each stage.<br>
Skilfully fight your way through all 4 stages. Be sure not to miss the recovery items while dodging enemy attacks!<br>
China Warrior boasts character size and detail rivalling all the other games at the time of its release!<br>
The one-on-one fights against the game’s realistic bosses will get you so excited that you’ll feel like you’re in the middle of a Kung Fu movie!</div>
  <div id="image02">
