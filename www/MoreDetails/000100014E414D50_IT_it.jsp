...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La prima avventura di Kirby in 3D porta il nostro batuffolo rosa ad avventurarsi tra le galassie, oltre i confini del regno di Dream Land, per salvare i suoi amici da un nuovo pericoloso nemico: Dark Matter.
<br><br>
Questo grazioso platform dai colori vivaci è ricchissimo di azione. Ingoia i nemici per copiare le loro abilità (ad esempio quelle del fuoco, del ghiaccio o dell'elettricità) e combinale tra loro per potenziarne gli effetti! Potrai ottenere risultati sorprendenti!
<br><br>
Mentre cerchi i frammenti di cristallo dispersi, esplorerai pianeti composti da lava, acqua o persino dolciumi e affronterai giganteschi boss finali! Kirby 64 include inoltre tre minigiochi bonus, ai quali possono partecipare un massimo di quattro giocatori.<br><br>Il testo all'interno del gioco è in inglese.<br>La funzione rumble del gioco originale non è disponibile.</div>
  <div id="image02">
