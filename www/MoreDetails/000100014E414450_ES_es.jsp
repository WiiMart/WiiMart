...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Andross ha lanzado su ataque definitivo sobre el sistema Lylat! Solo Fox McCloud y el equipo Star Fox pueden detenerlo. ¡Reduce a cenizas el ejército de Andross con el Arwing, el Blue Marine o el Tanque!
<br><br>
Lucha en 15 niveles diferentes en el aire, sobre la tierra, bajo el agua o en el espacio. Descubre rutas ocultas y vuela a tus anchas en el modo libre. ¡Podrás hacer maniobras como toneles y vueltas para zafarte de los ataques de tus enemigos!
<br><br>
Lylat Wars también tiene un modo VS de hasta cuatro jugadores con tres divertidos tipos de partida: Point Match (partida por puntos), Battle Royal (desafío) y Time Trial (contrarreloj).
<br><br>Textos de pantalla en inglés, alemán o francés.
