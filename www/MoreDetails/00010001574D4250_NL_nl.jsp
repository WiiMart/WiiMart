...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574D4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wat is MaBoShi: The Three Shape Arcade precies? Het is één spel, maar eigenlijk zijn het er drie! MaBoShi is gemakkelijk onder de knie te krijgen, maar kent toch ook veel diepgang.
<br><br>
MaBoShi: The Three Shape Arcade werkt met drie basisvormen: de cirkel, de balk en het vierkant. In elk van de drie spelvensters kan een andere speler tegelijkertijd een ander spel spelen door slechts op de A-knop te drukken of de richtingsknop te gebruiken. De gebeurtenissen in het ene spel hebben echter wel degelijk invloed op de andere spellen.
<br><br>
In elk spel is het doel hetzelfde: probeer een miljoen punten te scoren. Hoe je dit bereikt, is voor ieder spel echter verschillend. Zo moet je in de cirkelstand tegen vijanden botsen, in de balkstand je een weg naar boven slingeren en in de vierkantstand alle obstakels in brand steken.
<br><br>
In MaBoShi: The Three Shape Arcade kun je je Mii-personages gebruiken, je prestaties opslaan als herhalingen en via WiiConnect24 naar je vrienden versturen, en zelfs een Nintendo DS-versie downloaden om overal en altijd te kunnen spelen!
<br><br>
Het spel is voorzien van Engelse, Franse, Duitse, Spaanse en Italiaanse schermteksten.
<br/><br/>
De onlinefuncties van software die gebruik maken van WiiConnect24 zijn niet langer beschikbaar omdat een deel van de online diensten op het Wii-systeem op 28 juni 2013 is stopgezet.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4250/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D4250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MaBoShi<sup>TM</sup></span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">The Three Shape Arcade</span></div>
  </div>
