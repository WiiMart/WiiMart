...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９１年にリリースされた縦スクロールのシューティングゲームです。前作は１９８５年にアーケードゲームとしてリリースされ、ショットやミサイルのほか、アーマーを装備して戦うといったユニークな内容は、多くのシューティングファンに支持されました。その続編となる本作ではプレイスタイルに合わせて２種類の操作方法から選べたり、新型アーマーなども登場するほか、協力プレイにも対応。より戦略的で派手なシューティングが楽しめるようになっています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ASOⅡ ～ラストガーディアン～</span></div>
</div>
