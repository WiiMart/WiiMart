...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Om de wereld te redden van horden plunderende demonen, vertrekt Dana voor een gevaarlijke missie om de sleutel van Solomon te zoeken, waarmee de monsters kunnen worden opgesloten. Solomon’s Key™ is een combinatie van een actiespel en een gigantische puzzel. Deze titel staat bekend als een van de moeilijkste, maar meest meeslepende spellen voor de NES. De speler moet logisch denkvermogen en razendsnelle reflexen combineren om de mysteriën van elke kamer te ontrafelen. Een aantal geheimen zal door de knapste koppen ontdekt worden, maar slechts een enkeling is waardig genoeg om elk mogelijk einde te vinden. Durf jij het aan?<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
