...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un shooter de acción horizontal que se juega en un mundo creado en la mente de un demonio. Tu alma de repente deambula por el malvado mundo que existe en el corazón de todos. La única salida es abrirte paso destrozando a las criaturas grotescas que bloquean tu camino en 5 causes (niveles). Tienes que enfrentarte a los peligros de este mundo psicodélico usando los 3 tipos de Disparo y la opción de los satélites. Con mejoras, puedes cambiar tus disparos con un rayo de amplia cobertura, un láser generado por satélite y muchos más. Cada tipo de disparo puede ser mejorado hasta 3 niveles. También puedes bloquear el fuego enemigo rotando los satélites hasta la posición deseada. El cómo uses estas opciones será la clave para escapar de este mundo extraño y surrealista.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434F45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434F45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
