...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744494A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">全１００面を収録したブロックくずしゲームです。ルールは簡単。パドルから放たれたボールを、落下させずに打ち返してプレイエリア内にある各色のブロックをすべて破壊すればゲームクリア。ボールに強烈な回転をかけるスカッシュ打ちや、ブロックを破壊すると出現する様々なアイテムを駆使して、ブロックを破壊する爽快感を楽しめます。１００面を順番に攻略していくアーケードモードではハイスコアをランキングに登録して全国のプレイヤー達と競うことが可能です。連続破壊によるボーナス得点でハイスコアを目指しましょう。また、面を自由に選べて、二人プレイも可能なフリープレイモードも収録しています。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015744494A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744494A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">＠ＳＩＭＰＬＥシリーズ　Ｖｏｌ．１</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">ＴＨＥブロックくずしｎｅｏ</span></div>
  </div>
