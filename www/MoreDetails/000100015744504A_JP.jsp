...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「フレンドタイセン限定版」を送ってくれたお友達とアクションパズル「Ｄｒ．ＭＡＲＩＯ」のＷｉ－Ｆｉ対戦が楽しめます。<BR><BR>

「Ｄｒ．ＭＡＲＩＯ」のルールは簡単。落ちてくるカプセルを操作して、同じ色のウィルスとカプセルをタテ・ヨコに揃えて消すだけ。シンプルな操作で誰もが楽しめるパズルゲームです。<BR><BR>

※この「フレンドタイセン限定版」は、「Ｄｒ．ＭＡＲＩＯ ＆ 細菌撲滅」を持ち、さらにフレンドコードをお互いに登録しているお友達とプレイすることができるソフトです。本ソフトに１人用モードはありません。また、本ソフト同士でのＷｉ－Ｆｉフレンド対戦はできません。<BR><BR>

※「フレンドタイセン限定版」は無料です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015744504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｄｒ．ＭＡＲＩＯ<sup>&reg;</sup></span></div>
</div>
