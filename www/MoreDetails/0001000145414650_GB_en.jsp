...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In this horizontally-scrolling platform classic from 1991, you play as a hero named Blue as he sets out to save his home planet of Raguy from the invading Daruma tribe, who have polluted the planet's environment and turned its inhabitants into slaves. 
<br><br>
Not only does Blue have a variety of weapons such as bombs and boomerangs at his disposal, he also has the unique ability to change size at will. Another standout feature that gives the game incredible replay value is the branching level system. If you want to see every level and witness the full extent of the havoc wreaked upon Raguy by the Daruma, you'll have to try out the multiple routes through the game.
<br><br>
Featuring cute characters, bright, colourful graphics and an irresistibly upbeat soundtrack, Blue's Journey is a feel-good slice of vintage platforming fun.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
