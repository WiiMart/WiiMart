...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Devil’s Crush es la emocionante segunda parte del juego original de pinball Alien Crush. Tiene un movimiento de bola más suave aún y efectos especiales mejorados.
<br><br>
Lanza la bola por el tablero con el “Disparador Diabólico”, y usa las aletas y golpea la máquina para mantener la bola en juego y conseguir así una mayor puntuación. Completa ciertas condiciones para jugar hasta 6 pantallas de bonificación distintas.
¡Consigue un “Perfecto” en estas para ganar grandes cantidades de puntos!
<br><br>
El siniestro tema del juego se ve aumentado con sus enemigos... ¡Desde caballeros esqueléticos ambulantes y taumaturgos oscuros hasta un hermoso rostro que pasa de diosa a serpiente!
