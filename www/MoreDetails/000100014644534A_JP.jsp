...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">プレイヤーみずからが探偵となって事件を調査し解決する、コマンド選択式の推理アドベンチャーゲームです。画面に映し出される場面を参考に、登場人物たちへの聞き込みを重ねながら、推理をはたらかせて自分の行動を選び、捜査を進めていきます。明神村の財閥・綾城家の当主キクの死が疑惑を呼び、綾城家にまつわる「死人よみがえりの伝説」が浮かび上がるなか、さらなる新たな事件が起こります。プレイヤーは、事件の真相だけでなく主人公の記憶喪失というもうひとつの謎、そして怨霊伝説に隠された真実についても、同時に解き明かさなければなりません。スリリングな物語と個性的な登場人物たちによる、丁寧に作り込まれた骨太の長編ミステリーです。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファミコン探偵倶楽部<sup>&reg;</sup></span></div>
</div>
