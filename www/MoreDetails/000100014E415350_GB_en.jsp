...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Put pedal to metal and hang on for a wild ride across the highways of America! Race along LA freeways, across the deserts of Arizona and to the nation’s capital Washington DC, experiencing the thrills of street racing while taking in famous sights like the Golden Gate Bridge, the Grand Canyon and the White House.
<br><br>
Based on the hit arcade game, Cruis’n USA features a wide selection of cars, from ‘60s muscle motors to Italian-styled sports models. Compete solo in a 14-stage cross country marathon, or go head-to-head with a friend in split-screen two-player mode.</div>
  <div id="image02">
