...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">It is the near future. Resources are dwindling and the major powers of the world are locked in a territorial dispute. As Pacific States Marine Corps soldier Jake, you must lead your platoon on a deadly mission to destroy the enemy's ultimate weapon.
<br><br>
Pilot your Cybernator G5-E (a five-storey tall mechanised humanoid Assault Suit) through seven exciting stages, using the suit’s destructive arsenal of weaponry. As you progress through the game, you will also be able to power each weapon up to a maximum of three levels. It's up to you whether to power up one specific weapon or all weapons simultaneously, adding an element of strategy to the non-stop action.
<br><br>
The powerful background music, military atmosphere and intense story development combine to give the world of Cybernator a gritty, sci-fi feel that you won’t soon forget.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
