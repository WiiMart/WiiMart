...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The droid crew of a galactic space freighter have turned against their masters and eradicated every human crew member!
<br><br>
...
<br><br>
Take temporary control of an enemy droid's circuitry to use its energy and armaments against its own kind. Your aim: Eliminate all droids on each of the space freighter's 16 decks!</div>
  <div id="image02">
