...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Una fiel adaptación de la versión arcade de Street Fighter, el legendario juego de lucha con el que comenzó todo.
<br><br>
Los jugadores controlan a Ryu o a Ken y se enfrentan a singulares luchadores provenientes de todo el mundo. El primer luchador que deje fuera de combate a su rival y se imponga en dos rondas será el ganador.
<br><br>
Potencia tu ataque hasta 3 niveles distintos (cuanto más tiempo mantengas pulsado el botón, más fuerte será tu ataque). ¡Pulsa diferentes combinaciones de botones para realizar ataques especiales e infligir más daño a tu rival! ¡Combina eficazmente tus ataques normales y especiales y ábrete paso a puñetazos hasta la victoria final!
<br><br>
