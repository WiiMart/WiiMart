...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157485250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Heron: Steam Machine is a game about a factory where rubber duckies are being produced by a large steam engine. On this steam engine, there are four different gauges which you will have to watch carefully.
<br><br>
...
<br><br >
In Multiplayer, you are able to cooperate with friends in maintaining the steam machine. When you play with two, three or four players, the screen is divided into sections with different background colours. Each player is able to solve his or her own part of the puzzle. Players are restricted to their own section of the screen, so you will have to work together to make the pipes fit properly!</div>
  <div id="image02">
