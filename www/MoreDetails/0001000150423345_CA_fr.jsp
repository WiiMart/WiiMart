...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Devil’s Crush is the exciting sequel to the hit pinball game, Alien Crush, and features even smoother ball movement and enhanced special effects. Shoot the ball onto the board with the Devil Shooter, then use flippers and nudging to keep it in play and rack up a high score. Complete certain conditions to play up to 6 different bonus stages. Get a “Perfect Clear” on those to earn a huge amount of points! The game’s ominous theme is enhanced by its enemies--wandering skeleton knights, sorcerers, and even a giant face that changes from a goddess to a sinister serpent!</div>
  <div id="image02">
