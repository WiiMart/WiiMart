...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157534150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Onslaught" es un FPS (juego de disparo en primera persona) que te sitúa en medio de una futurista guerra entre los humanos e insectos alienígenas.<br><br>

Te convertirás en parte de la
Fuerza de Élite de Asalto
Interestelar, luchando contra una
sobrecogedora invasión de formas
de vida alienígenas. Disfruta de la emoción de acribillar oleada tras oleada de alienígenas con ametralladoras, granadas y muchas más armas. Siente como se acelera tu corazón al luchar contra gigantescos jefes alienígenas.
<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534150/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
