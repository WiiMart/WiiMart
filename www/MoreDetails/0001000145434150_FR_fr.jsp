...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">« Real Bout Fatal Fury 2: The Newcomers » est la 7e version de la franchise Fatal Fury. Le jeu est sorti en 1998. Basé sur les mécaniques de jeu des épisodes précédents, « Real Bout Fatal Fury 2: The Newcomers » comprend une version évoluée du combat sur deux plans, ainsi que de nouvelles fonctionnalités, comme le « Contre », un système de casse-garde disponible pour de nombreux mouvements, ou encore la possibilité pour un personnage de passer d'un plan à l'autre s'il continue de marcher. Et lorsqu’un personnage est mis à terre, si le joueur appuie au bon moment sur le bouton, le personnage se relève. Pour cette version, deux nouveaux combattants rejoignent le casting : Li Xiang Fei, maître en Kung-Fu et Rick Strowd, boxeur. Geese Howard est également jouable. Choisissez votre combattant parmi les 22 disponibles et testez votre force !
