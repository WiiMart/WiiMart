...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Ninja Master's" es un juego publicado originalmente en 1996 que toma acción en el país ficticio de Zipangu. Podrás elegir entre diez diferentes ninjas y guerreros con los que poner a prueba tus habilidades. La característica principal de este juego es la posibilidad de cada personaje de utilizar una amplia gama de armas. Además, como los súper ataques de cada personaje varían dependiendo de si están o no armados, necesitarás adaptarte a cada situación que presente el juego. El daño causado aumenta según la barra de súper poder. Existen además muchísimas técnicas mortales, como el "Golpe Súper Mortal", el "Poder Último", el "Súper Poder Oscuro" o el "Combo Oscuro". ¡No dejes de utilizar ninguna!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
