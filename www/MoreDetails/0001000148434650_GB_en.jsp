...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000148434650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">With the Wii Speak Channel and the Wii Speak accessory, up to four Wii consoles can connect via Nintendo Wi-Fi Connection, so you can speak to your friends anywhere in
the world!
<br><br>
Use your own Miis, created using the Mii Channel, to represent you in conversations. The Miis will move their lips to match the sound picked up by the microphone, and you can surprise your friends by using the voice changer for fun effects! You can show photos from an SD Card or your Wii Message Board during conversations, and also send voice messages with a photo to your Wii Friends.
<br><br>
Please note: when you activate data sharing in the Wii Speak Channel, selected Wii Friends can see your online status, including who you are talking to. When you join a friend’s conversation with their friends, you will see each other's Miis and Nicknames, even if you are not registered with each other as Wii Friends. You can deactivate data sharing at any time. See the Operations Guide for more details.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii Speak<sup>TM</sup> Channel</span></div>
</div>
