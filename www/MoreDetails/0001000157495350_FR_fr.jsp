...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157495350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les aventures de Guybrush continuent dans les hautes mers, tandis que les pirates vérolés assiègent les innocents habitants de Spinner Cay . Entre défendre les autochtones et échapper aux pirates à sa poursuite, Guybrush réussit à rejoindre son épouse bien-aimée et son ennemi juré, mais leur réunion est de courte durée. A présent, Guybrush doit se concentrer à enrayer  la vérole de LeChuck, avant que plus de mal ne soit fait. Et tandis que le puissant pirate s'approche d'un remède, les eaux deviennent plus troubles dans ce palpitant chapitre de cette saga épique.<br><br>Texte écran en anglais.</div>
  <div id="image02">
