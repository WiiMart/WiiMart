...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157533745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Players can bring the exciting “Slots” experience home. Choose from six adventure-themed five reel bonus slots, or try your luck with classic Cherries or Diamonds slots. Win big jackpots and earn access to VIP suites. Players can use winnings to purchase vibrant merchandise to customize their suites. As players progress, they can win multiple awards and achievements. 
<p>
...
*High Roller Suites: Live like a V.I.P. while customizing your own high roller suite with artwork, pool tables, trophies, furniture and much more.<br>
*Bonus Games: Six great games to challenge your nerves. Play the bonus games separately to increase your winnings.<br>
*Unlockables: Achievement trophies are tracked and awarded for exceptional play.</div>
  <div id="image02">
