...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157594950')", "wiiSelectSound()");
...
<br><br>
Vektor está atrapado en tu CPU. No está muy seguro de cómo ha llegado hasta allí ni de cuánto tiempo lleva cautivo, pero sí sabe que necesita tu ayuda para escapar. La CPU ha desactivado la habilidad de Vektor para moverse libremente... pero él es un experto en programación.
<br><br>
Ayuda a Vektor a escapar de las garras de la CPU. Guíalo hacia la libertad a través del laberinto de la CPU evitando a patrullas, cazadores e interceptores enemigos. Tendrás que moverte rápido: la CPU reacciona a gran velocidad y hará lo imposible para impedir que Vektor escape. Él puede crear códigos que te darán las habilidades necesarias para combatir la creciente potencia de la CPU, pero eres tú quien decidirá su destino en última instancia.
<br><br>
