...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">科学と魔法の混在する世界「ガイア大陸」を舞台に、ＲＰＧの要素を取り入れた戦略シミュレーションゲームです。魔力を科学技術でコントロールして手に入れた強大な軍事力で突如大陸各地へ侵攻を開始した「ヴェルダース」連邦。プレイヤーはヴェルダース連邦に対抗する「ディアースレ」連邦軍を指揮する装甲騎士軍団長「エルビン・ランバート」として大陸各地にユニットを配置し、同時に戦争終結のカギ「ガイアクリスタル」についての情報を集めます。敵の編成や地形を考えながら戦略を組み立て、最終目標である敵国首都「ヴェルデラード」の占領を目指します。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ガイフレーム</span></div>
</div>
