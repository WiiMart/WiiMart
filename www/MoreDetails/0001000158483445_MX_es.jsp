...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483445')", "wiiSelectSound()");
...
<p>
Max & the Magic Marker es un juego de plataformas y resolución de enigmas basado en las leyes de la física. Aunque ha sido diseñado para todo tipo de jugadores, sigue planteando un reto a aquellos jugadores con más experiencia. En Max & the Magic Marker encontrarás un juego de plataformas clásico con un toque de originalidad: dispondrás de un marcador mágico que te permitirá dibujar libremente en el juego. Todo lo que dibujes se hará real y podrás interactuar con ello en el juego. Debes ayudar a Max a derrotar a sus enemigos, superar obstáculos y resolver enigmas. 
<p>
En el juego, podrás:<br>
- Resolver enigmas con múltiples soluciones<br>
- Recoger orbes escondidos para desbloquear más sorpresas<br>
- Explorar 15 niveles en 3 mundos únicos 
<p>
Un día, Max recibió un misterioso marcador por correo. Lo primero que dibujó fue un monstruo, pero tan pronto como levantó el marcador del papel, el monstruo cobró vida y saltó hacia otro dibujo. Para detenerlo, Max se dibujó a sí mismo en la página y comenzó su persecución. 
<p>
El juego ha ganado varios premios, incluido el "Independent Games Festival 2010 (IGF) D2D Vision Award" (premio D2D Vision del festival de juegos independientes de 2010).</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483445/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483445/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
