...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ドラゴンスレイヤー」シリーズの５作目となるアクションＲＰＧです。１つのゲームでたくさんの物語が楽しめるシナリオシステムと、７つの星を組み合わせて生み出す１２０種類の魔法などのこまやかなプレイヤー作成システムが、高い評価を得ました。プレイヤーは、剣と魔法の町「ペンタウァ」に集まった冒険者たち「ソーサリアン」となって、戦士・魔法使い・ドワーフ・エルフという４種のクラスを織り交ぜた４人のパーティメンバーを作成し、謎解きいっぱいの冒険へ出発します。本タイトルには「灰色のダンジョン」「天空の滝」「ツイン・アイランズ」ほか、すべてメガドライブ版オリジナルとなる全部で１０ものシナリオが収録されており、最終シナリオ「邪神の砦」以外ならどのシナリオからでも始めることができます。物語を彩る、ドラマチックで美しい音楽の数々も話題となりました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソーサリアン<sup>&reg;</sup></span></div>
</div>
