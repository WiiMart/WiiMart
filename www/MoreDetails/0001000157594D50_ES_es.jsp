...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157594D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Yummy Yummy Cooking Jam es un frenético juego de cocina en el que deberás servir en el menor tiempo posible los platos que los comensales te irán pidiendo. Esta tarea puede resultar sencilla, pero los clientes tienen poca paciencia y en el camino encontrarás multitud de incómodos insectos para entorpecer la noble misión de llenar la barriga de nuestros pequeños gourmets. <br><br> El juego dispone de un Modo Carrera donde tu objetivo será el de convertirte en el mejor chef de la ciudad. Para ello, deberás mostrar tu valía cocinando en cuatro grandes restaurantes: el restaurante de perritos calientes, el restaurante de hamburguesas, la pizzería y el restaurante mexicano. <br><br> Diviértete en familia con Yummy
Yummy dando de comer a los más sorprendentes personajes: vampiros, ninjas, extraterrestres y mafiosos.
Ponte el gorro de chef, afila los cuchillos y calienta los fogones porque tendrás que demostrar a todo el mundo quién es el cocinero más hábil y rápido.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157594D50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157594D50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Yummy Yummy </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Cooking Jam</span></div>
  </div>
