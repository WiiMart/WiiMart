...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ワンダーボーイ　モンスターランド』に始まる横スクロール式アクションＲＰＧ「モンスターワールド」シリーズの完結編であり、集大成とも言える作品です。勇者になりたての女の子「アーシャ」と不思議ないきもの「ペペログゥ」が、力をあわせて世界を救う冒険を繰り広げます。前作までとは異なるアラビアンナイト風の世界を舞台に、氷のピラミッドや天空の神殿など仕掛けいっぱいのダンジョンの奥にとらわれた精霊たちを助け出していきましょう。アーシャをはじめとした登場キャラクターたちのかわいらしい豊富なアニメーションは、まさに職人芸。プレイするのはもちろんのこと、見ているだけでも楽しくなってきます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">モンスターワールドⅣ<sup>TM</sup></span></div>
</div>
