...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おもちゃのキャラクター「ピノ」と「アチャ」を操作して、ＢＯＸ（ステージ）のどこかに隠された４つのハートを時間内に集めるアクションゲームです。
子供たちが寝静まったあとの、おもちゃの世界。魔女は魔法を使って、悪の心を持つコピーおもちゃを仕向けてきました。ピノとアチャはとらわれた仲間のおもちゃたちを救いに魔女の城に向かいます。ビンに入ったハートを４つ集めると扉が開き、扉に入ると次のＢＯＸへ進むことができます。制限時間がなくなるとＢＯＸの端から壁が現れ、動ける場所が狭くなってしまいます。箱やビンに隠された武器などのさまざまなアイテムを手に入れながら、魔女が待ち受ける最終ＢＯＸまでたどり着き、仲間のおもちゃたちを救ってください。２人協力プレイも可能です。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">トイポップ<sup>&reg;</sup></span></div>
</div>
