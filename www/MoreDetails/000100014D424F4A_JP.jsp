...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">剣と魔法のファンタジーアクションゲームの第三弾にして、メガドライブシリーズ完結作です。二度の悪夢を引き起こした伝説の武器ゴールデンアックスは、神々へ戻される旅の途中、魔王ダムド＝ヘルストライクの手に落ちてしまいました。老ギリウスは４人の勇者、すなわち傭兵カイン・青龍刀の使い手サラ・巨人プラウド・獣人クロノスへ魔王討伐の命を下します。前作から一新されたプレイヤーキャラ、ルート分岐システムによって展開するマルチストーリーで大幅ボリュームアップ。新たな攻撃やコマンド必殺技の導入に加え、白熱の２人同時プレイでは協力攻撃や共同魔法など多彩なシステムを搭載し、１人でも２人でも、そして何度でも楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゴールデンアックスⅢ<sup>TM</sup></span></div>
</div>
