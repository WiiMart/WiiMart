...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">壮大なストーリーとゲームシステムが人気のアクションＲＰＧ「風の伝説ザナドゥ」の続編であり完結編です。強大な敵、ダルダンディスとクレーネ・ジュエルとの戦いから３年後の世界。主人公「アリオス」は、新大陸の調査に出かけた「リュコス」が行方不明だと知らされ、「ダイモス」とともに捜索に出発しました。本作では前作の舞台であった「イシュタリア」を離れ、「アシュナール大陸」を舞台に冒険がはじまります。 前作でも好評だった、レベルアップのない装備の熟練度による個性的な成長システムは改良が加えられ、より「心地よい」ゲーム性を実現。グラフィックも緻密に描き込まれ、さらに美しくパワーアップしました。サイドビューに切り替わるボス戦ではアクション性を強化し、通常の攻撃のほか、コマンド入力による「必殺技」を追加。また、連れて行く仲間を選択し、２Ｐ側で操作することも可能になり、協力プレイを楽しむこともできます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">風の伝説ザナドゥ Ⅱ</span></div>
</div>
