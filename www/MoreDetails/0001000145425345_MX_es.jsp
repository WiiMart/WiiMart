...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Publicado en 1996, THE PATH OF THE WARRIOR ART OF FIGHTING 3 es un juego de lucha escenificado en Grasshill Valley, donde toman lugar dramas y batallas entre varios luchadores. Aparte de los protagonistas, Ryo y Robert, esta versión contiene toda una serie de nuevos personajes. THE PATH OF THE WARRIOR ART OF FIGHTING 3 viene con poderosos combos aéreos, maniobras de bloqueo mucho más eficientes, la habilidad de infligir daño a oponentes caídos y un sistema de combates de una ronda llamado “Ultimate K.O.”. Además, los gráficos están basados en la tecnología de captura de movimiento, con lo cual logra un estilo de lucha más auténtico y hace de este juego uno de los más innovadores juegos de lucha en 2D.
<p>(Contenido del juego disponible en inglés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425345/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE PATH OF THE WARRIOR ART OF FIGHTING 3</span></div>
</div>
