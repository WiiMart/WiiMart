...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157524C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In the year 2112 the masses are fascinated by extreme high speed races. The latest antigrav racing technology introduced phase shifting. Perfect phase matching of track and racing machine is the key to stay alive.
<p>
