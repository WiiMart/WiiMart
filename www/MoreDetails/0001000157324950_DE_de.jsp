...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157324950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Willkommen bei „FISHIE FISHIE”, dem einzigen Spiel, das mit nur einer Taste gespielt werden kann.<br>
Du wirst etwas wirklich Außergewöhnliches erleben, das deine Reflexe auf die Probe stellen wird.<br>
Das Spiel enthält eine Reihe von Übungen, die dir zeigen, wie du deinen Fishie und die verschiedenen Spielmodi steuerst.<br>
In „FISHIE FISHIE” spielst du einen Fisch, der die ganze Zeit fressen muss. Außerdem musst du mehrere unterschiedliche Spielmodi schnellstmöglich absolvieren. Jede Sekunde zählt.<br>
Um zu gewinnen, musst du mehr als einhundert Levels in verschiedenen Spielmodi meistern: „Story”, „Fußball”, „Den Stern erobern”, „Überleben”, „Fertigkeit” und einen großen Wettbewerb.<br>
Du kannst allein spielen – es können aber auch bis zu vier Spieler am selben Bildschirm spielen. Ob Koop-Modus oder jeder Fishie für sich selbst, um zu gewinnen, sind alle Mittel erlaubt.
<br><br>
Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FISHIE FISHIE</span></div>
</div>
