...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le monde sombre dans les ténèbres.
Les vents s'essoufflent, les océans se déchaînent, la terre s'assèche...
Pourtant, certains croient en une prophétie, un présage qui attendrait d'être réalisé.<br>« Quand les ténèbres voileront la terre, surgiront les quatre Guerriers de la Lumière. » <br>Après un long périple, quatre jeunes voyageurs font leur apparition...
Et chacun d'entre eux porte un cristal.
<br><br>
Ce titre est un import de la version américaine originale du jeu.
