...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157414F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Very Hungry Caterpillar's ABCs is an educational game, based on the children's book The Very Hungry Caterpillar, that allows parents and children to learn basic English while enjoying a game together.
<p>
The game consists of four parts, including alphabet flash cards featuring colored letters and pictures by Eric Carle and a vocabulary quiz for preschool-aged children that includes words such as numbers, colors, shapes, names of animals, and simple verbs and adjectives such as "run," "eat," and "big." Young players can also engage in fun activities such as erasing parts of a colored screen to reveal a hidden illustration or placing a variety of animal stamps on the screen. Finally, parents can use the "To The Parents" option to check the progress of their children in remembering vocabulary words.
<p>
Your whole family is sure to appreciate the colorful illustrations by Eric Carle, internationally renowned as the creator of beautifully illustrated and innovatively designed picture books for children.</div>
  <div id="image02">
