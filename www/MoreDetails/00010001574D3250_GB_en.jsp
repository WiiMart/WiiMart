...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574D3250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Have you always dreamed of having a cute little baby to lovingly care for? Well, now is your chance.
<br><br>
Suddenly, it has arrived. Your little bundle of joy smiles at you gleefully, and you have to do everything you can to make sure it is provided for, and develops and grows healthily. Changing, bathing and feeding are as much a part of your duties as shopping, preparing meals, rocking your baby to sleep, playtime, dressing, stroking and teaching it to crawl and walk. But above all, what your little angel needs is your love and attention.
<br><br>
All this, plus an enormous selection of toys, clothes and other objects will make your little one the happiest baby in the whole wide world!</div>
  <div id="image02">
