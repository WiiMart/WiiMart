...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">お持ちのWii本体に保存されているセーブデータとWiiウェア、Wiiバーチャルコンソールソフト等のダウンロードソフト、登録済みのWiiポイント等をこの本体にまとめて引っ越し（移動）をします。<BR><BR>引っ越しをするためには引っ越し元となるWii本体セットと空き容量が512MB以上のSD/SDHCメモリーカード１枚が必要です。<BR>
※一部引っ越しができないソフトがあります。引っ越しができないソフトは、元のWii本体でのみご利用いただけます。 <BR>
※引っ越しをしたデータはWii本体から消去され、戻すことはできません。<BR>
※WiiポイントはWiiショッピングチャンネルでのみご利用いただけます。 <BR><BR>
引っ越し元のWii本体では、Wiiショッピングチャンネルから【Wii Uへの引っ越し】を受信する必要があります。<BR>
※引っ越しをする際には、この本体のWiiメニューで【Wiiからの引っ越し】をはじめて、準備をする必要があります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wiiからの引っ越し</span></div>
</div>
