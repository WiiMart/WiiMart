...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In questo platform classico a scorrimento orizzontale, pubblicato nel 1991, rivesti i panni di un eroe di nome Blue, la cui missione consiste nel salvare il suo pianeta di origine, Raguy, dalla tribù dei Daruma, che ha inquinato l'ambiente e ridotto in schiavitù i suoi abitanti. 
<br><br>
Oltre a disporre di una grande varietà di armi, come bombe e boomerang, Blue possiede la straordinaria capacità di modificare le sue dimensioni a piacimento. Un'altra caratteristica di spicco del gioco è la diversificazione dei suoi percorsi, che consente di completarlo più volte senza stancarsi. Per poter esplorare tutti i livelli e vedere coi tuoi occhi le proporzioni della devastazione causata dai Daruma, dovrai seguire tutti i percorsi che si snodano attraverso il gioco.
<br><br>
I suoi graziosi personaggi, assieme a una grafica piacevole e colorata e a una colonna sonora irresistibilmente allegra, rendono Blue's Journey un gradevole platform vecchio stile che ti regalerà molte ore di divertimento!
<br><br>
Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BLUE'S JOURNEY<sup>TM</sup></span></div>
</div>
