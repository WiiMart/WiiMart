...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F4645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El Profesor Lexis acaba de terminar su máquina más grandiosa, ¡la tecnología con el diseño más moderno con energia eficiente! Sin embargo, al momento que accionó el interruptor para la primera prueba oficial, la máquina explotó y rocío en todas partes todo el combustible multicolor del profesor. Él, ahora necesita tu ayuda para recoger el precioso combustible y reparar el daño causado antes de que el simposio mundial de energía comience. Gira tu control Wii Remote para colocar tablas de madera, embudos y portales de transportación de partículas para guiar los fluidos de nuevo a los canales correctos de colección y repara los daños en estos locos treinta niveles. El profesor aún tendrá que hacer frente a la peligrosa tarea de mezclar líquidos para crear nuevos colores de combustible. ¡Sólo asegúrate de contener el derrame antes de causar un desbordamiento!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Overflow</span></div>
</div>
