...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lunar Pool réinvente le traditionnel jeu de billard en lui donnant une touche futuriste. Les règles sont simples. Il vous suffit de pousser la bille blanche afin de faire tomber dans les poches les billes de couleur numérotées.
<br><br>
Avec 30 tables différentes, 2 configurations de départ pour chacune, plus la possibilité de régler le degré de frottement de la bille, la durée de vie de ce jeu est quasiment illimitée! Lunar Pool vous offre également un mode deux joueurs, alors n'hésitez pas à mesurer vos progrès contre différents adversaires.
