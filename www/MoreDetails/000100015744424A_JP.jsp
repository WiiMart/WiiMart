...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744424A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ダービードッグ』は、犬のレースゲームです。プレイヤーは、犬に命令を与える「ハンドラー」となり、犬を育ててレースに参加し優勝を目指します。このゲームでは以下のようなことを楽しめます。<BR><BR>● レース<BR>犬に「ゴー」「ジャンプ」「スロー」の3つの命令を与えて優勝を目指します。<BR><BR>● 育てる<BR>トレーニングやエサを選択し、犬を育てます。<BR><BR>● ブリーディング<BR>育てた犬を親にして、新しい犬を誕生させます。<BR><BR>● Wi-Fiレース対戦、ランキング（無料）<BR>ニンテンドーWi-Fiコネクションを利用して、離れた場所にいるプレイヤーとレースで競い合います。最大8人のプレイヤーで対戦できます。ランキングでは自分の順位を確認できます。<BR><BR>● 追加コンテンツ「マイ犬小屋」（有料）<BR>有料の追加コンテンツとして用意されている犬小屋を購入すれば、多くの犬を育てることができるようになります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015744424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744424A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダービードッグ</span></div>
</div>
