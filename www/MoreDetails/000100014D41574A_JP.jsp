...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">社会現象にもなった大ヒット３Ｄ対戦格闘ゲームの２Ｄ版。八極拳、ジークンドー、パンクラチオン、プロレスなど、さまざまな技を持った格闘家たちが、最強の頂を目指し戦いを繰り広げます。オリジナルのアーケード版の操作感覚や各キャラクターの多彩な技の数々もできる限り忠実に再現。アーケード版で身に付けたテクニックを存分に発揮することができます。アキラ、パイ、ラウ、ウルフ、ジェフリー、影丸、サラ、ジャッキーの８人の登場キャラクターすべてを倒せば、おなじみのボス、デュラルが待ち受けています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バーチャファイター２<sup>TM</sup></span></div>
</div>
