...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015752394A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファンの皆様、お待たせいたしました。１９８７年に初登場したロックマンのオリジナルシリーズが、長い沈黙を破って登場します。<BR>今回のシリーズ９作目は、ファミコン時代にこだわって制作いたしました。音もグラフィックもファミコンの雰囲気を再現。<BR>攻略性の高いステージ、バラエティ豊かな特殊武器、ユニークな敵キャラクター、そして手ごわいボスたち、これらのロックマン スタイルは、もちろん踏襲。<BR>過去のロックマンシリーズを制作したスタッフたちも開発に参加しています。またロックマンの生みの親、稲船敬二によってデザインされたボスも登場します。<BR>他に、やりこみを自慢できる数々のチャレンジ項目や、オンラインによるランキングで、世界中のプレイヤーと記録を競うことができます。<BR>さらにロックマン９を楽しめる追加コンテンツも用意されています。<BR>新しいけど懐かしいロックマン。少年の日のドキドキをもう一度味わってみてください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015752394A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015752394A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン９</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">野望の復活！！</span></div>
  </div>
