...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015745544A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「飛び出す絵本」の世界を舞台にしたスゴロクタイプのボードゲームです。プレイヤーはサイコロの代わりに、カードとコインを使って進み、ゴールをめざします。マップクリア時の順位と集めたコインの数に応じてもらえるポイントの合計で、勝敗が決まります。<BR>
カードには、「移動」に使うものから「カードを奪う」のように他人をジャマするものまで、さまざまな種類があります。コインは、カードと組み合わせて進む数を増やすことなどに使えるだけでなく、最後に持っている枚数が勝敗を左右することがあるため、その使いかたがカギとなります。<BR>
このゲームの最大の特徴は、プレイヤーが特定のマスに止まった時にマップ上の「魔法の本」が開く瞬間です。「魔法の本」が開くと「飛び出す絵本」をコンセプトにデザインされた「紙神（かみがみ）」がランダムに現れ、マップ上のすべてのプレイヤーに影響をおよぼします。<BR>
自分が進むのか、相手のジャマをするのか、はたまたコインを集めて一発逆転を狙うのか？　カケヒキはアナタしだい！<BR>
助け合ったり、おジャマをしたり、遊んでいるうちに相手とのキズナを感じるかもしれません……<BR>
Ｗｉｉリモコン１つで、１人から最大４人まで遊べます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015745544A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015745544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">あそべる絵本</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">とびだスゴロク！<sup>TM</sup></span></div>
  </div>
