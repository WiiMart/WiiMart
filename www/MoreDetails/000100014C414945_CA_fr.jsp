...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Enduro Racer, based off the popular SEGA arcade game and redesigned for the SEGA Master System, takes you on an intense set of adrenaline-designed courses containing diverse and rough terrain that will test your skills and reaction times to the limits. Ride as fast as you can to pass as many cars and bikes as possible while also avoiding obstacles and pitfalls such as debris on the road. Take jumps off of ramps and try to keep your speed up, but make sure to keep an eye on your bike so it doesn’t blow up in your face! Are you ready for the challenge?</div>
  <div id="image02">
