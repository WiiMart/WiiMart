...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157425050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Use your imagination!
<br><br>
...
<br><br>
Use items and multipliers in combos to fight your way to the top of the high scores and find the perfect way to solve a level!
<br><br>
Go crazy in the three completely different game modes of PLÄTTCHEN - twist 'n' paint with more than 300 levels. Twist yourself along with your friends cooperatively or against each other through the many multiplayer modes.</div>
  <div id="image02">
