...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Salta a la pista, esquiva a los rivales y mete el disco en la portería antes de que suene la sirena! Este es uno de los juegos de Nintendo que mejores críticas ha recibido. La explicación de su popularidad está en haber sabido combinar una gran sencillez en el manejo con cierto componente estratégico en la formación de los equipos. Cada participante debe crear la alineación de su equipo con jugadores de tres complexiones distintas. La composición del equipo influirá en su rendimiento tanto a la hora de presionar como en defensa. Además, tal vez presencies un espectáculo sorprendente al final de la segunda parte...
