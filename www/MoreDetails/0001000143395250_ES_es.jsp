...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">International Karate + es una continuación de IK original, cuya característica más destacable es la aparición simultánea de tres luchadores en la misma pantalla (¡y cinco cuando el juego está en pausa!)
<br><br>
Con el mando de Wii se pueden realizar los 16 movimientos diferentes de que disponen los karatecas. Practicando un poco, todos estos ataques y saltos se pueden encadenar hábilmente en una secuencia de movimientos para que la acción transcurra sin descanso. Los controles son lo suficientemente sencillos como para que los jugadores puedan aprenderlos rápidamente. Tras un cierto periodo de práctica, y con algo de experiencia, es posible efectuar complejas combinaciones de movimientos.
<br><br>
Se puede golpear a los contrincantes en la cabeza, el pecho y el estómago, o en las espinillas y en los pies, tanto desde delante como por detrás, aunque la puntuación concedida a cada golpe se reduce a la mitad cuando el ataque es por la espalda.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143395250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143395250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">International Karate +<sup>TM</sup></span></div>
</div>
