...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is a side-scrolling shooter played in a world created from the mind of a twisted demon. Your soul has suddenly wandered into that evil world that exists in every person’s heart. The only way out is to blast your way past the grotesque creatures that block your path in five "causes" (stages). You must face the dangers of this psychedelic world by making full use of three shot types and the satellite option. With power-ups, you can change your shots to a wide-coverage beam, a satellite-generated laser, and more. Each shot type can be powered up to three levels. You can also block enemy fire by rotating the satellites to a desired position. How you use these features will be the key to successfully escaping this strange and surreal world.</div>
  <div id="image02">
