...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">L'affreux sorcier Agahnim a pris le contrôle du royaume d'Hyrule. Il a la ferme intention de libérer Ganon, retenu prisonnier dans le monde des ténèbres. Incarnez le légendaire héros Link et mettez un terme aux projets maléfiques d'Agahnim avant qu'il ne soit trop tard!
<br><br>
Le jeu The Legend of Zelda: A Link to the Past a profondément marqué la série des Zelda. Outre la vaste quête qui se déroule dans deux mondes opposés, on y découvre une multitude d'armes et objets, d'innombrables monstres et une aventure épique basée sur la lutte du bien contre le mal.
<br><br>
Le chef-d'œuvre de Shigeru Miyamoto a introduit nombre de nouvelles idées que l'on retrouve encore dans les derniers épisodes de la série. Quant à l'inoubliable bande-son de Koji Kondo, elle est souvent considérée comme la meilleure de sa carrière. Voilà pourquoi <br>A Link to the Past est devenu un classique Nintendo incontournable.
<br><br>Le texte à l'écran sera en français.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414446/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414446/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Legend of Zelda<sup>TM</sup>: A Link to the Past<sup>TM</sup></span></div>
</div>
