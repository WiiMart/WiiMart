...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年に登場した、カプコン初のアクションシューティングゲームです。
独特の世界観、攻撃に高低差をいかしたゲーム性、そして斬新な見下ろし型の視点とリアルなグラフィックが好評を博し、大ヒットとなりました。特殊訓練を受けた兵士「スーパージョー」となり、実行不可能とも思える任務を見事達成しましょう。<BR><BR>詳細は、<Center>http://www.capcom-onlinegames.jp/category/wii.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">戦場の狼</span></div>
</div>
