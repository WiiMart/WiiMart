...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574A4650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welkom in de wereld van Gnomz. Gnomz is een nieuw en spannend arcade vechtspel voor de WiiWare™-dienst. In Gnomz kunnen maximaal vier spelers in drie verschillende speltypes tegen elkaar en/of de computer spelen.<br><br>
Kenmerken:<br><br>
