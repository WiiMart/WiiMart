...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742414A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「バクたん」という爆弾をブロックにしかけ、爆破してブロックを消すパズルゲームです。一度の起爆でブロックを全部消せばステージクリアとなります。爆風に巻き込んで他のバクたんを起爆する「連鎖爆破」や、爆破で落としたブロックの衝撃で起爆する「衝撃爆破」など、バクたんの特性を踏まえてじっくり考えてください。<BR>パズルの合間にはおかしな物語が展開します。ふしぎな世界に迷い込んだ女の子のヒナタと一緒に、さまざまなエリアでパズルうさぎの挑戦を受けることになります。パズルを解いて無事にもとの世界に帰してあげてください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742414A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742414A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バクたん</span></div>
</div>
