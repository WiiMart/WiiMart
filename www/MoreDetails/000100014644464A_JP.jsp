...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８７年に発売され「燃えプロ」の愛称で親しまれた野球ゲームです。センター方向からの視点、選手たちの個性的なフォーム、審判のコールや歓声を再現した音声システムなど、プロ野球ファンにはたまらない演出が満載。強打者の一発はバントですらホームランになるなど、数々の摩訶不思議なプレイも話題を呼びました。１人プレイでは個性的な１２球団での白熱したペナントレースを楽しめます。２人対戦プレイ時に使うことができるスペシャルチームも用意されています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">燃えろ！！プロ野球<sup>&reg;</sup></span></div>
</div>
