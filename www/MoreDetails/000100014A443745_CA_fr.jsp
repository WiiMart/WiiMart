...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Adventure Island is a mysterious and beautiful land that has many hidden dangers. As hero of the island, Master Higgins protects its inhabitants from many deadly creatures. He has restored peace to the uncharted island on many occasions. But something terrible has happened. While Master Higgins and Jeanie Jungle were stargazing, a dangerous entity known only as Dark Cloak turned Jeanie to stone. Master Higgins must venture toward Dark Cloak’s castle at the foot of Ice Mountain to rescue her!</div>
  <div id="image02">
