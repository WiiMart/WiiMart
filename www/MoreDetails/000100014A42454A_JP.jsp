...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードゲームの人気作をスーパーファミコン用として移植した、かわいらしいデザインが特徴的なパズルゲームです。上から降りてくるいろいろな玉（ドロップ）を下にいるプレイヤーが吸い取ったり、投げたりして、同じ色の玉を３つ以上縦に並べて消していきます。「ひとりモード」「ふたりモード」「とことんモード」「かんがえモード」といった４つの遊び方があり、対戦モード（ひとりモード、ふたりモード）では、先に玉がフィールドの最下段を超えてせり出した方が負けとなります。また「かんがえモード」は、問題ごとに指定された操作回数以内で画面上のすべての玉を消すというルールの詰めパズルモードです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42454A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42454A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マジカルドロップ</span></div>
</div>
