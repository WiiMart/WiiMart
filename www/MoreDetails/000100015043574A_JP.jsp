...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">多くのシューティングファンを魅了してきたアイレム制作の手応え抜群の縦スクロールシューティングゲームです。まず、プレイヤーは「イメージプロジェクター」とよばれる戦闘シミュレーションで、５段階の飛行訓練をクリアし、主人公機の「ダイダロス」を操縦するための高度なテクニックを身に付けなければなりません。訓練課程終了時の撃破率が９０％を越えれば見事合格。いよいよ宇宙空間に出て全３ステージの実戦プロジェクトへ参戦です。補助攻撃システムの「ポッド」やこれを飛ばして敵を破壊する「ポッドシュート」、速度チェンジを利用した「バックファイヤー」など、オリジナリティ溢れる攻撃を駆使して、突如地球の侵略を開始したエイリアンに果敢に挑みます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">イメージファイト<sup>&reg;</sup></span></div>
</div>
