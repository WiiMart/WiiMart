...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157325050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Le programme de rééducation du périnée de Physiofun a été élaboré en collaboration avec Thomas Claus et l'équipe médicale du Dr. Becker Klinikgesellschaft. Son objectif consiste à vous aider à localiser votre périnée et à le muscler. Renforcé et en pleine forme, il remplira de nombreuses fonctions. Il peut même contribuer à améliorer la posture et donner un nouvel élan à votre vie.<br><br> Vous remarquerez qu'un périnée musclé contribue également à votre bien-être général. <br><br> Vous pouvez effectuer des exercices spécifiques avec votre nouveau-né. Tout en étant très agréables, ils contribueront à renforcer vos liens avec votre enfant; ils sont par ailleurs efficaces pour fortifier l'ensemble de votre musculature et en particulier votre périnée.

<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157325050/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157325050/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Programme de rééducation du périnée</span></div>
</div>
