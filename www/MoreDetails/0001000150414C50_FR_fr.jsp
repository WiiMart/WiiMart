...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un shoot’em up dans la plus pure tradition des « Star Soldier » !<br>
Dans ce nouvel opus, incarnez un pilote de la prestigieuse SIA, les forces aériennes spéciales d’intervention. <br>À bord de votre fidèle intercepteur d’assaut « Soldier Blade », combattez l’invasion par Zeograd. Améliorez votre armement en récoltant l’un des 3 bonus. De nouveaux éléments de jeu sont là pour ajouter un peu de piment stratégique à l’action ! L’option <br>« Gunbody » vous permet d’éviter les attaques ennemies tandis que le système « Burst Out » possède des effets différents selon le niveau de puissance de votre arme !<br> Récoltez les bonus et exécutez les attaques spéciales judicieusement !<br>
Les incroyables boss de fin de niveau vous promettent des combats d'anthologie !<br>
Essayez également le <br>« CHALLENGE » et obtenez le meilleur score en un minimum de temps !<br>
