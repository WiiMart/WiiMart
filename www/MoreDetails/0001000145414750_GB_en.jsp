...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This seminal beat 'em up, released in 1994, was the first King of Fighters game and set the template for the whole series. Unlike the usual one-on-one fight system, King of Fighters '94 lets you choose one of eight teams, each made up of three fighters from such SNK classics as Fatal Fury, Ikari Warriors, Psycho Soldier and Art of Fighting.
<br><br>
The rules are simple - choose a country-based team and set the play order of your characters, then fight until one team has been vanquished! As well as the usual variety of special moves, each fighter has a power gauge that can be charged up to perform a devastating Super Desperation Move. This gauge builds up every time a fighter takes a hit, so even if you're taking a real beating you might get a chance to turn the tables!
<br><br>
With crisp, detailed graphics, fluid animation and stirring music and sound effects, this arcade-perfect port is a must-have for any fighting game fan.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
