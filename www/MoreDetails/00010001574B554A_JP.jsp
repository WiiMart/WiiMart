...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B554A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ダウンタウン熱血どっじぼーる』は、ダウンタウンシリーズの開発スタッフがお届けする、力の限りボールをぶつけ合うひと味違った「格闘式ドッジボール」です。ダウンタウンシリーズでお馴染みの個性豊かなキャラクターたちには専用のAIを搭載。仲間や試合の状況に合わせて細かい行動をとりゲームを盛り上げます。メンバーをあつめてチームをカスタマイズ。作戦変更でAIをチューニングしてCOM観戦、おまかせ操作、マイキャラなりきりモードなど。ルール、アクション、ステータスのバランスも一新されて、初心者から上級者まで楽しめます。操作はシンプルで感覚的。必殺シュートや連携プレーを繰り出そう！</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B554A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B554A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダウンタウン熱血どっじぼーる</span></div>
</div>
