...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sonic The Hedgehog è stato il primo gioco di Sonic per SEGA MASTER SYSTEM. Questa versione, tratta da quella originale per SEGA MEGA DRIVE, presentava nuove zone, nuovi mostri finali e una mappa del livello. La principale novità era però che i Chaos Emeralds si trovavano in specifici livelli e non nei Livelli Speciali. 
<br><br>
Sfreccia attraverso 6 livelli, compresi quelli speciali che comparivano solo nella versione per SEGA MASTER SYSTEM, e affronta il Dr. Eggman (alias Dr. Robotnik) al termine di ciascuno di essi!<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
