...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157495450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Un juego de objetos escondidos ha llegado a WiiWare!
<br><br>
¡Da lo mejor de ti e intenta encontrar 12 objetos determinados entre una multitud tan rápido como puedas! Desde grandes peces a pequeños pendientes. Objetos fáciles de encontrar y otros muy bien  escondidos. ¡Puedes encontrar un montón de objetos y de diversión en este juego!
<br><br>
¡Podrás jugar con amigos y familiares y competir para saber
quién es el mejor buscador en cada nivel! (Hasta 4 jugadores)
<br><br>
Con 10 niveles en total y más de 277 objetos diferentes podrás divertirte mucho buscando.
¡Además, muchos objetos cambian de posición cada vez que juegas con lo que podrás disfrutar de cada nivel una y otra vez!<br>
¡¡Juega y disfruta con tus amigos!!
<br><br>
