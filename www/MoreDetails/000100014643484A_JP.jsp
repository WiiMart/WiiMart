...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">プレイヤーは主人公“フラッピー”となって、ストーンやキノコを操り手ごわい敵をかわしながら、“ブルーストーン”をゴールまで運びます。じっくり考えるパズルの楽しさと、手に汗にぎるアクションの面白みが合わさった、世代を超えて楽しめるアクションパズルゲームです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FLAPPY</span></div>
</div>
