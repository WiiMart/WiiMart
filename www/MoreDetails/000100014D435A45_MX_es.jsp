...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mah-Jongg, el antiguo pasatiempo, ha sido reinventado como un videojuego interactivo en el que cada movimiento de ficha que hagas podría ser el último. Descubre su música encantadora, las animaciones divertidas y los obstáculos emocionantes incluidos en este juego de mesa que te enganchará durante horas. Este clásico de Genesis te desafía para que encuentres parejas de fichas de forma que se eliminen y así, vaciar el tablero. Juega al Shanghai II tradicional o lleva el juego a una nueva dimensión con Dragon’s Eye. No te dejes engañar por la simplicidad de las reglas: la profundidad y complejidad de este desafío se convertirán en tu nueva obsesión.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D435A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D435A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
