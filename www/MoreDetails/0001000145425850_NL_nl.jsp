...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sengoku 2 is een scrolling vechtspel dat oorspronkelijk werd uitgegeven in 1993. De personages zijn krijgers die zijn opgeroepen door een tovenaarsprinses om de dark lord te vernietigen door verschillende tijdperken heen. Je kunt net zoals in de vorige versie je personages transformeren, maar ditmaal hoef je je bondsgenoot niet te redden om in hem te kunnen transformeren. In deze versie kun je vrijuit wisselen tussen de Ninja, Tengu en Ninja Hond vanaf het begin. Daarnaast is een van de nieuwe elementen in dit spel het gebruik van samengestelde aanvallen- en verdedigingsmanouevres, welke een tactische twist geven aan deze actievechter.<br><br>De software is voorzien van Engelse schermteksten.</div>
  <div id="image02">
