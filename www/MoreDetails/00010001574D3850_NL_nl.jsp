...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574D3850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Er is een gloednieuwe aanvulling op de "Bomberman"-reeks voor WiiWare! Door de eenvoudige bediening is dit een geweldig spel om te spelen met vrienden en familie!<br><br>

Door te schudden met de Wii-afstandsbediening activeer je nieuwe voorwerpen voor meer actie dan ooit tevoren in Bomberman! Je kunt de intensiteit zelfs nog verder verhogen door je eigen Mii-personages toe te voegen!<br><br>

Dit wordt een klapper voor iedereen - van degenen die nog nooit een Bomberman game hebben gespeeld tot de Bomberman-meesters!<br><br>Voorzien van Nederlandstalige schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3850/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
