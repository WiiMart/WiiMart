...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100014843464A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『Ｗｉｉスピークチャンネル』は「Ｗｉｉスピーク」を使って遠く離れた友だちと会話を楽しんだり音声つきメッセージを友だちに送ったりすることができるＷｉｉチャンネルです。<BR><BR>

Ｗｉｉフレンドになった友だち同士、最大４台のＷｉｉ本体で、「Ｗｉｉスピーク」をつなげて『Ｗｉｉスピークチャンネル』を使うと、お互いのリビングとリビングがつながり、その場にいるような感覚で会話が楽しめます。<BR>
受話器などは使わず、室内にいる全員が会話に参加できます。また、通話料金は無料です（※）。<BR><BR>
...
会話中には、ＳＤカードやＷｉｉ伝言板に入っている写真をみんなに送って、一緒に見ることもできます。<BR><BR>

もうひとつの機能として、友だちがＷｉｉフレンドであれば、『Ｗｉｉスピークチャンネル』を持っていなくても、Ｗｉｉ伝言板へ音声つきメッセージを写真と一緒に送ることができます。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100014843464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｗｉｉスピークチャンネル</span></div>
</div>
