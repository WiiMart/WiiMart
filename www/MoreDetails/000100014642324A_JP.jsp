...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「スーパーマリオブラザーズ」の第二弾。シリーズの中でも最も難易度が高く、クリアするには前作よりもさらに高度なアクションテクニックが要求されます。プレイヤーはマリオとルイージを選択でき、前作と変わらない標準的な操作感のマリオと、高くジャンプできる代わりに滑りやすいルイージと、キャラクターの違いで攻略の難易度も変化します。ディスクシステム用ソフトの書換数は歴代ナンバーワンの名作。

<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーマリオブラザーズ<sup>&reg;</sup>２</span></div>
</div>
