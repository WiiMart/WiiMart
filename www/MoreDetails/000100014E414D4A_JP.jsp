...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公のカービィを操作して、敵を倒したり避けたりしながらステージクリアをめざすアクションゲームです。今作は「星のカービィ」シリーズ初の３Ｄグラフィックで描かれていますが、従来の操作性を維持しながら、より奥行きや広がりのある世界が表現された内容となっています。<BR>「すって、はいて、コピーして」のカンタン操作はそのままに、今作から２種類のコピー能力を混ぜる「コピー能力ミックス」というシステムが新たに加わりました。７種類の基本能力とミックス２８種類、計３５種類の能力を使い分け、７つのステージをクリアしてください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414D4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">星のカービィ<sup>&reg;</sup>６４</span></div>
</div>
