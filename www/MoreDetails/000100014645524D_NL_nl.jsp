...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De intergalactische avonturier en scholier Mike Jones keert terug voor een nieuw avontuur. Deze keer reist hij niet door de ruimte, maar door de tijd!
<br><br>
Dit vervolg op StarTropics (ook beschikbaar voor Virtual Console) werd oorspronkelijk alleen uitgebracht in Noord-Amerika, als een van de laatste titels voor de NES. Het spel volgt de belevenissen van Mike terwijl hij door verschillende periodes in de geschiedenis reist, van de steentijd tot het wilde westen!
<br><br>
Je zult niet alleen historische personages tegenkomen, zoals Leonardo da Vinci en Cleopatra, maar je zult het ook opnemen tegen degenen die erop uit zijn om Zoda (de buitenaardse leider die door Mike tijdens zijn eerste avontuur werd verslagen) te wreken. Staat Zoda op het punt om opnieuw te verrijzen?
<br><br>
