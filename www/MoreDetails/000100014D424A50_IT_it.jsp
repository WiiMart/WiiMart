...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“Ghouls'n Ghosts” è il seguito del popolare gioco d’azione “Ghosts'n Goblins”, realizzato prima per le sale giochi e successivamente per Mega Drive.
<br><br>
Durante una notte di luna piena, tre anni dopo la battaglia con Astaroth, un raggio di luce trapassa la Principessa e la sua anima viene strappata via proprio sotto gli occhi di Arthur. Per salvare l’anima della sua sposa, il cavaliere Arthur dovrà combattere malvagie creature non-morte di ogni tipo, utilizzando moltissime armi, potenti magie e nuove abilità.
