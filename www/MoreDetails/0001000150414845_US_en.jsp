...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This upgraded edition to the famous Lode Runner series includes a 5-player versus mode. Gold funds have been stolen from the Time Machine Research Center, and the group responsible used a time machine to escape and hide the gold throughout time.  The center sends an elite team of “Runners” to go and retrieve the gold.<p>
In addition to the familiar Puzzle mode, the game features Battle mode, where up to 5 players can compete, and Edit mode, where you can create your own original stages.<p>
You can enjoy Battle mode in a number of different ways. Be the last one standing to win in Survival. Grab items from enemies and escape to win in Escape. With 4 players, you can separate into two teams to do battle in Tag Match.<p>
When battling with multiple players, you must connect the same number of Wii Remotes or Nintendo GameCube Controllers as the number of players.
To play with five players, you will need at least one Nintendo GameCube Controller.</div>
  <div id="image02">
