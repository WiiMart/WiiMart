...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mach dich auf den Weg durch eine verliesartige Raumstation und besiege die herumschleichenden Monster in diesem Shooter aus der Ego-Perspektive.<br><br>
Du bist Mitglied des Elitekommandos “Debuggers”, einer Gruppe von unerschrockenen Kämpfern, die eine unbewohnte Raumstation untersuchen sollen. Du hast genau 100 Minuten Zeit, um hineinzugelangen, die Monster in jedem Block zu vernichten, bis zur untersten Ebene vorzudringen und den automatischen Sprengsatz zu deaktivieren.
<br><br>
Mit jedem Monster, das dir entkommt, wird es schwieriger, im Kernblock zu überleben. Somit ist Geschwindigkeit unverzichtbar, um die Anlage und jeden einzelnen Block zu sichern.
Erlebe den Nervenkitzel des Überlebens, während dir die Zeit davonläuft und du der Wahrheit hinter den Ereignissen auf den Grund gehst.
