...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prodotto nel 1992 da SNK, Fatal Fury 2 è un picchiaduro dove oltre a Terry, Andy e Joe, altri 5 personaggi si affrontano per il titolo finale. Nell’episodio precedente, se un personaggio perdeva energia durante un combattimento, aumentavano le sue possibilità di sconfitta. Ora invece, se l’energia diminuisce e la barra lampeggia, i personaggi possono ricorrere a una particolare tecnica micidiale: un colpo della disperazione con cui sperare di ottenere la vittoria. A questo vanno aggiunti i miglioramenti apportati alla possibilità di muoversi su due piani, una prerogativa già apprezzata nel primo episodio. Premendo contemporaneamente i pulsanti per l’attacco debole e l’attacco forte, puoi spostare il tuo personaggio sull’altro piano di gioco o scaraventarvi l’avversario con un attacco. Un’interessante caratteristica che ti permette di sfruttare al meglio la profondità dello schermo durante un combattimento!
<br><br>
