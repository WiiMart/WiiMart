...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157554845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Bienvenido a Grill-off with Ultra Hand! En 1966 Nintendo introdujo la primera Ultra Hand al mundo. La gente quedó fascinada con este pequeño brazo de plástico que podía alcanzar objetos distantes. ¡Ahora la Ultra Hand regresa en forma de juego para la consola Wii™ con Grill-off with Ultra Hand! Usa la Ultra Hand para agarrar las piezas de carne de la parrilla y colocarlas en el plato que tienes enfrente. ¡Simplemente asegúrate de agarrar la carne antes de que se queme! Intenta batir tu propio récord en 1P Mode (modo para un jugador) o compite contra un amigo en VS Mode (modo VS). ¡Manos a la parrilla!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Grill-off with Ultra Hand!<sup>TM</sup></span></div>
</div>
