...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este programa es una versión de prueba, por lo que algunas funciones de la versión completa del programa podrían no estar disponibles aquí.<br> 
Ten en cuenta que no podrás guardar la partida en la versión de prueba.
<br><br>¡Prepárate para el fútbol del futuro! Destruye los bloques de defensa y lanza el balón a la portería para alzarte con la victoria, pero ten cuidado... ¡tendrás que hacer frente a distintos enemigos que harán todo lo posible para acabar contigo! <br><br> 

Gracias al editor incorporado podrás diseñar todo tipo de fases, o si lo prefieres, puedes tratar de superar las 90 fases del juego en los distintos modos de juego disponibles. <br><br> El juego incluye:<br><br>

- Noventa niveles para divertirte marcando goles y rompiendo bloques.<br><br> 

- Fases llenas de elementos sorprendentes, como bloques animados, explosivos, de escudo e invisibles, y letales defensas enemigas en 3D que deberás destruir.<br><br> 

- Nueve poderosos jefes a los que derrotar.<br><br> 

- Un editor incorporado que te permitirá diseñar tus propias fases, y capacidad para almacenar hasta 100 fases distintas.
<br><br> 
- El modo Torneo te permite preparar tus propios torneos utilizando las fases del juego o las que hayas creado.
<br><br> 
- Consigue distintos tipos de potenciadores que te ayudarán (o te perjudicarán) a la hora de conseguir tu objetivo, como láseres, bombas, balones en llamas y balones y palas múltiples.<br><br> 

- Un montón de logros y secretos que desbloquear.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495550/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Soccer Bashi<sup>TM</sup></span></div>
</div>
