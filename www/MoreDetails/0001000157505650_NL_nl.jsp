...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157505650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Een vervallen villa is het decor van een uiterst vreemd prentboek. Verzamel al je moed en open de deur naar dit eigenaardige en tikkeltje beangstigende verhaal. Ga de strijd aan door met de Wii-afstandsbediening geanimeerde papieren beren naar de pagina’s van het boek te gooien. Gebruik al je hulpmiddelen om de blauwe edelstenen die je hebt gevonden te beschermen tegen Kina, het mysterieuze jongetje dat de villa bewoont. Er staan je maar liefst dertig spannende en uitdagende levels te wachten!<br><br>

Het gelijktijdig uitgegeven "Puzzling Pages" is een parallelle game met zijn eigen verhaal en puzzelgeoriënteerde levels. Speel beide games om een nóg merkwaardiger mysterie te onthullen ...<br><br>
