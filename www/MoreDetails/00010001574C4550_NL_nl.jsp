...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574C4550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welkom in de wereld van de PooYoo's, de eerste leuke en vrolijke braintrainer voor kinderen van 3-6 jaar oud.
<br><br>
Samen met de PooYoo's, een gezellig groepje schattige babydiertjes, maakt je kind kennis met allerlei dingen die goed zijn voor zijn ontwikkeling: cijfers, letters, vormen, kleuren en nog veel meer. Bovendien wordt de lateralisatie gestimuleerd. Kinderen kunnen samen met hun nieuwe vriendjes dansen en krijgen allerlei interactieve beloningen. Er zijn twee niveaus wat betreft interactie, dus kinderen kunnen altijd spelen, ongeacht hun niveau of leeftijd.
<br><br>
Dit spel is speciaal ontwikkeld om gebruikt te worden door kinderen die nog niet kunnen lezen.<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4550/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4550/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Aflevering 1</span></div>
  </div>
