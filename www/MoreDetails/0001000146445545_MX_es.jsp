...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En el juego de Super Dodge Ball, tomarás el control del equipo de los EE.UU. de Dodgeball y viajarás alrededor del mundo en el intento de ser los mejores jugadores de Dodgeball. Entra a los campos de juego en todas partes del mundo y usa una combinación de disparos normales y super para vencer a tu oponente. ¡Pero ten cuidado, ya que algunos campos de juego tienen superficies que pueden afectar tu equilibrio! Maneja al equipo como tu creas necesario, y cambia de personajes con otros jugadores que mejor encajen con tu estilo de juego. Dos jugadores podrán disfrutar un partido de cara a cara o jugar una energética ronda de Bean Ball, con seis personajes. Hay tres niveles de dificultad (Easy, Medium, y Hard); el que elijas dependerá en tus habilidades y valor. ¿Tienes lo que se necesita para llevar al Equipo EE.UU. a ganar el trofeo principal y ganar el campeonato mundial de dodgeball?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146445545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146445545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Dodge Ball<sup>TM</sup></span></div>
</div>
