...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015732474A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大ヒットシリーズ『逆転裁判』シリーズの第２弾。さらなるドキドキハラハラと、法廷での熱いバトルをお届けします。人気キャラクター・御剣怜侍や狩魔冥も活躍し、物語はさらにパワー＆ヒートアップ。Wiiリモコンを突きつけて「異議あり！」と叫ぶ快感をお楽しみ下さい。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015732474A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015732474A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">逆転裁判<sup>&reg;</sup> 2</span></div>
</div>
