...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157524245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ambientado en un mundo de robots sarcásticos y luchadores, Robocalypse™ - Beaver Defense ofrece un temerario arsenal para la más escandalosa destrucción en un juego de estrategia defensiva. Los jugadores pueden crear torres y colocarlas de forma estratégica para aniquilar oleadas de robots enemigos, mientras los robots-héroes controlados por el jugador actúan como unidades móviles de armamento y proporcionan una poderosa potencia de fuego en todas las zonas del campo de batalla.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Robocalypse<sup>TM</sup> - Beaver Defense</span></div>
</div>
