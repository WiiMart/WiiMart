...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">STREET FIGHTER II': SPECIAL CHAMPION EDITION was the first Street Fighter game released on the SEGA GENESIS. The Street Fighter series can be considered one of the first fighting games to popularize competitive video-game fighting. This version of the game contains both the CHAMPION and HYPER rule sets, from the two editions released in the arcades. It also introduced an exclusive Group Battle mode that is now a general feature in most fighting games. Play as one of twelve different characters, each with their own distinctive fighting style, either fight in single-player mode or challenge a friend in this legendary classic fighting game.</div>
  <div id="image02">
