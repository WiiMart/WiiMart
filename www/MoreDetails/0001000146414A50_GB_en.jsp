...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dash onto the hockey rink, avoid the brawls and shoot the puck into the net before the siren call! This is one of Nintendo's most acclaimed sports games. The reason for its popularity is that it offers a fun and straightforward experience, yet also requires tactical skills from players who have to build their own team before the match. For each member of your team, it is possible to select between three different weight classes. This will impact how good your squad is at countering opponents and reacting to dangerous counter-attacks. You might also witness a surprising show at the end of the second period...</div>
  <div id="image02">
