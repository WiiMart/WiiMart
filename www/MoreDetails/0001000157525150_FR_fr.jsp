...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157525150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Avec plus de 30 espèces d’animaux insaisissables comme par exemple des rhinocéros laineux, des biches à queue blanche, des loups et des élans, Deer Drive Legends WiiWare vous emmène aux quatre coins du monde pour chasser quelques-uns des animaux les plus sauvages n'ayant que rarement été aperçus par l'homme. Parmi ces animaux, certains sont même considérés comme disparus. Ces animaux sont rapides, très dangereux et seraient bien contents de faire de vous leur repas ! Engagez-vous dans de violents combats contre des boss de fin de niveau tels que le redoutable T-Rex, les tigres aux dents de sabre et les
Gastornis. Avec un choix varié d'armes telles que des fusils automatiques, des arbalètes et des fusils de chasse de gros calibres, Deer Drive Legends WiiWare est un tout nouveau jeu de chasse comme vous en espériez depuis longtemps !</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157525150/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157525150/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Deer Drive Legends</span></div>
</div>
