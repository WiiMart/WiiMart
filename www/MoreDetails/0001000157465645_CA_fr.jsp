...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157465645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The ultimate soccer game comes back to WiiWare!
<p>
Soccer Up is a fun soccer game that allows you total control of any action of your team players: control the ball to dribble and shoot with effect to confuse the goalkeeper and score a goal! The ball has inertia and will move freely over the field. Show your ability to control it and make short and long passes. Choose the height, effect and power before shooting to the goal. Become a soccer master and make your rival defenders tremble! Each country has its own national team. You can create your own team with the in-game editor: give it the name you like, choose its equipment and most importantly, play with your Mii characters.
<p>
Features:<br>
- Free Control Ball, the ball has inertial free movement and you’ll need to control it first.<br>
- Total control of height, direction and effect in each pass and shot you make.<br>
