...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157564B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Water Warfare est un jeu de tir à la première personne amusant où le but est d'arroser ses adversaires avec des pistolets à eau. Chaque carte (terrain de jeu, place ou parc naturel) est générée automatiquement au début de la partie. Tu peux donc penser à de nouvelles stratégies à chaque fois que tu joues ! Le jeu te propose des missions solo, des batailles contre la console et un mode deux joueurs en écran partagé.
<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564B50/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564B50/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
