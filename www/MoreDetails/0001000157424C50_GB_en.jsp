...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157424C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BUBBLE BOBBLE Plus! is a simple yet exhilarating action game where you control the bubble blowing dragons Bub and Bob, trapping enemies in bubbles and then popping them.<br><br>

You can play all 100 of the Standard Mode rounds, which faithfully recreate the nostalgic arcade game, or try 100 new Arrange Mode rounds, which allow up to four players to play on stages with exciting new features such as new enemies and stage layouts. There are also Super Mode rounds for you to enjoy.<br><br>

Obtain the true ending by solving puzzles hidden on each stage to defeat the final boss. <br><br>

On top of all that, you can enjoy a further 100 rounds, facing off against new boss characters by purchasing the “Expert Mode 1” and “Expert Mode 2” add-on content.</div>
  <div id="image02">
