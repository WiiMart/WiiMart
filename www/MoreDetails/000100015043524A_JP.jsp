...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">最大４人まで遊べる本格ビリヤードゲームです。ポケット競技の「９ボール」をはじめ、「８ボール」「ローテーション」「カットゲーム」「ﾎﾞーラード」そして「四つ球」
といった、全６種類のゲームが収録されています。これらのゲームは、指定された位置やパワーで正確にショットできる「シミュレーション」モードと、実際のプレイで起こりがちなミスショットが再現された「アクション」モードで遊ぶことができるので、初心者から腕に覚えのある上級者までビリヤードの醍醐味を存分に味わうことができます。また「テクニックモード」では、決められたボール配置での練習や、ファンシーショットにも挑戦可能です。コンピュータのお手本を参考にして華麗なショットを成功させてください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブレイクイン</span></div>
</div>
