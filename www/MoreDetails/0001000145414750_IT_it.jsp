...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pubblicato nel 1994, questo primo picchiaduro della serie King of Fighters ha posto le basi per i giochi successivi. A differenza dei normali sistemi di lotta uno contro uno, The King of Fighters '94 ti permette di scegliere tra otto squadre, composte ciascuna da tre lottatori presi in prestito da classici SNK come Fatal Fury, Ikari Warriors, Psycho Soldier e Art of Fighting.
<br><br>
Le regole sono semplici: scegli la squadra di una nazione, stabilisci l'ordine dei personaggi e combatti fino a quando uno dei team non viene battuto! Oltre alle tradizionali mosse speciali, ogni lottatore può effettuare una devastante Super Desperation Move, la cui efficacia dipende dal livello di carica della propria barra di energia. La barra si ricarica ogni volta che viene ricevuto un colpo, così, anche se stai prendendo una bella batosta, hai sempre la possibilità di ribaltare la situazione!
<br><br>
Grazie alla sua grafica nitida e dettagliata, all'animazione fluida, alla colonna musicale e agli effetti sonori entusiasmanti, questo classico da sala giochi è un must per i fan dei picchiaduro.
<br><br>
