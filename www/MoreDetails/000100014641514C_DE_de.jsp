...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Ninja JaJaMaru-kun" (bedeutet "Entschlossener kleiner Ninja") wurde ursprünglich 1985 für Famicom (= NES) in Japan veröffentlicht. Das Actionspiel dreht sich um die Abenteuer des Ninjas JaJaMaru, der mit Shuriken (Wurfsternen) die Monster bekämpft, die ihn davon abhalten wollen, die Prinzessin Sakura aus den Klauen des bösen Fürsten Namazu zu befreien.
<br><br>
Auf deinem Weg durch eine große Anzahl von Leveln mit einer Vielzahl japanisch anmutender Geister, Monster und Items kannst du sogar die Unterstützung eines Riesenfroschs gewinnen, auf dem du reiten kannst. Dieses klassische Action-Spiel ist erstmalig außerhalb Japans für die europäische Wii Virtual Console erhältlich.
<br><br>Englischer Bildschirmtext - enthält japanische Elemente.
