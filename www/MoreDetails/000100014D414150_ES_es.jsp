...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cuando Zeus, el legendario dios griego, te devuelve la vida, te lanzas a una misión para rescatar a su hija Atenea del inframundo. Durante el camino, recoge las Spirit Balls arrojadas por los enemigos para incrementar tu fuerza y transformarte en diferentes criaturas mitológicas con sus poderosos ataques.<br><br>Textos de pantalla en inglés.<br>Incompatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
