...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">J.J. e JEFF, due investigatori pasticcioni, sono i protagonisti di questo esilarante gioco d’azione. Un giorno ai due viene richiesto di “salvare un ricco uomo d'affari che è stato rapito”. Scegli il personaggio che preferisci e attraversa i 6 livelli che compongono il gioco, cercando di arrivare alla soluzione del mistero.
<br><br>
Ciascun livello è diviso in 4 aree, colme di nemici, trappole ed elementi che potrai prendere a calci per trovare gli utili oggetti nascosti qua e là. Come se ciò non bastasse, dovrai fronteggiare anche l'incompetenza dell’altro investigatore. Entra nelle stanze segrete e recupera energia mentre assisti a divertentissimi intermezzi. Salta, evita i nemici e usa il potente attacco “spray” per portare a termine la tua missione!
