...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"Uncharted Waters: New Horizons" es un juego que se desarrolla durante la era de los descubrimientos, la época dorada de la exploración global europea ocurrida a principios del siglo XVI. Podrás elegir entre seis personajes para jugar, cada cual tiene una historia y una motivación distinta. Tu personaje podrá navegar por los océanos libremente, visitando una gran variedad de puertos exóticos y haciendo nuevos descubrimientos extraordinarios.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A435945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A435945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Uncharted Waters: New Horizons</span></div>
</div>
