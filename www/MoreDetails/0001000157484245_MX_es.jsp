...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157484245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Huberto el Osito es el videojuego familiar en que tendrás que luchar contra conejos astutos. Engáñalos en 8 disciplinas como batalla nevosa, ir de trineo, decoración del árbol de Navidad, pescar, persecución de conejos y más. Crea su Osito como te guste. Elige su nombre, sexo y vístelo con un montón de ropa y accesorios. Juega sólo o compite con familia y amigos en uno de los múltiples modos del juego. ¡Hasta 16 jugadores pueden participar en un concurso! Gracias a los diversos niveles de dificultad, cada uno puede disfrutar el videojuego.  Esta colección de los deportes de invierno da alegría a cada familia con el acompañamiento de una banda sonora de Navidad.</div>
  <div id="image02">
