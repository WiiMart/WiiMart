...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Zwei Jahre sind vergangen, seit Arnold und Sonya in Shockmen verwandelt wurden. Der Aufforderung des Professors folgend “zu ihren Körpern zurückzukehren”, begeben sich beide zum Labor. Auf dem Weg dorthin werden sie von einem mysteriösen Gegner attackiert. Nach nur knappem Sieg erfahren sie durch eine TV-Meldung, dass eine Invasion des “RYO EMPIRE” bevorsteht. Im Labor angekommen erfahren sie dann, dass der Professor entführt wurde und ziehen los, um ihn zu retten.
<br><br>
Shockman ist ein Action-Shooter mit 8 Stufen in der Seiten-Ansicht: “Action-Stufen”, in denen du Springen und Super-Techniken nutzen kannst und “Schieß-Stufen” mit horizontalem Scrolling.
<br><br>
Das Spiel baut die gute Story des Vorgängers aus und verfügt über kooperative Elemente wie “Geteiltes Leben” und einen kraftvollen “Team Shockbeam”, der benutzt werden kann, wenn zwei Spieler gleichzeitig spielen.
