...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">全１８種目ものオリンピック競技が楽しめるアクション・スポーツゲームです。競技は「射撃」<br>「アーチェリー」「ボート」「水泳」「フィールド」「トラック」の６ジャンルに分かれており、プレイヤーはアスリートとして各競技に挑みます。ゲームには数日間にわたって全種目をおこなう「オリンピック」モードや好きな競技を個別に選べる「トレーニング」モードなどがあります。「トレーニング」モードで苦手な競技の練習を積んでから「オリンピック」モードの制覇を目指したり、それぞれの競技で世界記録に挑戦するなど、遊びたい時間や腕前によってさまざまな楽しみ方が可能です。さらに５人までの同時プレイにも対応し、友だちを集めて勝敗を競えばゲームの魅力がますます広がります。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042394A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042394A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パワースポーツ<sup>&reg;</sup></span></div>
</div>
