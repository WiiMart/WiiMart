...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744484A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">赤・青・緑など最大８色に彩られた正三角形のパネルを同じ色で６枚そろえて、正六角形＝ＨＥＸを作って消していくパズルゲーム。それが『ＤＩＡＬＨＥＸ』（ダイアルヘックス）です。<br><br>
操作方法は、ポインターでダイアルを移動して、ＡまたはＢボタンで回転させるだけ！<BR>
テンポ良くダイアルを回転させて、どんどん六角形を作って消していきましょう！<br>
（Ｗｉｉリモコンの横持ちプレイにも対応しています）<br><br>
プレイできるモードには、規定の数の六角形を作ればクリアとなる「ＳＯＬＯ」モードと、ゲームオーバーになるまで、ひたすら六角形を作ってパネルを消し続ける「ＥＮＤＬＥＳＳ」モードがあります。<br>
さらに、「ＳＯＬＯ」モードをクリアすると新たなモードがオープンします。<br><br>
各モードでは、１人プレイだけでなく、２人で六角形を作っていく協力プレイが可能です。<br>
また、自分と相手のステージの一部が共有された特別なステージで対戦をおこなう「ＶＳ」モードがあります。共有ステージでの駆け引きを制して、相手をゲームオーバーに追い込むと勝利となります。<br><br>
ステンドグラスを思わせる色彩豊かなグラフィックと透明感のあるサウンドが織り成す、きらびやかな世界。<br>
Ａｒｔ　Ｓｔｙｌｅ<br>
<div align="right">『ＤＩＡＬＨＥＸ』。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015744484A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744484A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ａｒｔ Ｓｔｙｌｅ<sup>TM</sup>シリーズ</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">ＤＩＡＬＨＥＸ<sup>&reg;</sup></span></div>
  </div>
