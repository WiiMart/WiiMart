...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９３年にリリースされたサイドビューのアクションゲームです。プレイヤーは冒険家のジョニーとなって、ドゲード博士に盗まれた宝の地図の切れ端の奪還と、さらわれたメアリーの救出に向かいます。ゲームは５ステージで構成されており、ステージの最後には個性的なボスキャラが登場します。見事クリアーすれば地図の切れ端が手に入ります。そして地図が完成すると……？<BR>基本アクションである通常攻撃やジャンプに加え、気合い攻撃、スライディング攻撃、ボンバーなど多彩な攻撃が用意されており、派手で爽快な戦いが楽しめます。２人同時プレイも可能です。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ミラクルアドベンチャー</span></div>
</div>
