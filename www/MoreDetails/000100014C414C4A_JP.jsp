...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">集めたお金で武器を買ってパワーアップする人気シューティングゲームの第二弾です。前作の戦いから１０年後、主人公「オパオパ」は、ファンタジーゾーンを襲う新たな侵略軍に立ち向かいます。新要素「ワープゾーン」を使って、迷路になったステージを探索しながら、侵略軍の真の黒幕をめざします。全部で８つのラウンド、ボスはすべて一新。お金を貯めてショップで購入するおなじみのパワーアップも新装備が多数追加されたほか、新アイテム「ボトル」で体力を増やすこともできるようになりました。果たしてオパオパは行方不明の父と再会することができるのでしょうか？　前作以上の華やかなグラフィックとＦＭサウンド対応のＢＧＭが話題を呼びました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファンタジーゾーンⅡ　オパオパの涙<sup>TM</sup></span></div>
</div>
