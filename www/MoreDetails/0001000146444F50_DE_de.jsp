...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In diesem NES-Actionspiel, einer Umsetzung des Arcade-Hits, springst du als Soldat der Special Forces über dem südamerikanischen Dschungel ab, um unter Einsatz deines Lebens Geiseln zu retten. 
<br><br>
Du steuerst ein Fadenkreuz aus der Ego-Perspektive und schaltest mithilfe deiner Maschinenpistole und Granaten Gegner aus. Jeder der sechs Einsätze hat ein eigenes Missionsziel; deine Leistung in den Missionen beeinflusst den Ausgang des Spiels. Es ist jedoch nicht damit getan, den Bildschirm mit Kugeln zu durchlöchern – du musst auch so viele Geiseln wie möglich herausholen! 
<br><br>
Abhängig davon, wie viele Geiseln du rettest, endet das Spiel auf unterschiedliche Weise (und deine Truppen bekommen unterschiedlich viel Geld gutgeschrieben!). Wird der Präsident der Vereinigten Staaten mit deiner Leistung zufrieden sein? Schalte auf Dauerfeuer und finde es heraus!
<br><br>
