...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das 1991 von SNK herausgebrachte „King of the Monsters“ ist ein Kampfspiel, in dem monströse Kreaturen gegeneinander antreten. Der Spieler wählt eines von sechs Monstern aus und reist mit ihm durch Japan, um sich in zahlreichen Kämpfen an die Spitze der Rangliste vorzuarbeiten. Neben den üblichen Attacken wie Schlägen oder Tritten stehen jedem Charakter auch noch verheerendere Angriffsformen wie etwa Flammen- oder Strahlenangriffe zur Verfügung.<br><br> In diesem Spiel gibt es sogar Wrestling-Elemente: Den Sieg erringt derjenige, der die Kraft des Gegners völlig erschöpft hat und seine Schultern drei Sekunden auf den Boden drückt. Wirst du vom Gegner am Boden gehalten, solltest du mehrfach einen Knopf drücken, damit dein Charakter um sich tritt und ihn abschüttelt.<br><br> Außer dem normalen Spiel gegen den Computer stehen auch Spieler-gegen-Spieler-Kämpfe und Partnerkämpfe gegen den Computer zur Auswahl. 
<br><br>
