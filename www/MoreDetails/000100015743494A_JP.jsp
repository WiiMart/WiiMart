...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015743494A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">クリスタル・ディフェンダーズR1は、ソルジャーや黒魔道士などのキャラクターをマップに配置し、迫りくるモンスターからクリスタルを守るゲームです。<BR>マップの入口からモンスターが出現し、出口に向かって進軍します。キャラクターを配置して、モンスターの侵攻を阻止しましょう。<BR><BR>キャラクターには、行動範囲は狭いが攻撃力の高いソルジャー、射程距離は広いが攻撃間隔が長い黒魔道士、空を飛ぶ敵に強い弓使い、など様々います。<BR>モンスターとの相性を考えてうまく配置しましょう。<BR><BR>モンスターが出口に到達すると、クリスタルを奪われます。<BR>クリスタルを全て奪われてしまうとゲームオーバーです。<BR>
<BR>クリスタル・ディフェンダーズR1では、マップの形状や出現するモンスター、難易度の異なる多数のステージを収録しています。<BR>クリスタルを１つも奪われずに全ステージクリアすることを目指してがんばってください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015743494A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015743494A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
