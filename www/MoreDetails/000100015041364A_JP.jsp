...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">敵に拉致された大統領を救い出すため、単身多くの敵が待ち受ける戦場に乗り込むトップビュータイプのアクションシューティングです。プレイヤーは特殊部隊の兵士として、「マシンガン」や「手榴弾」をはじめとする数々の武器で敵に立ち向かいます。また、作戦中は味方の捕虜を救出することで、重要なアイテムや武器、情報を手に入れることができます。手に入れた武器や装備を上手く利用しながら、各ステージの最後に登場するボスを倒せばステージクリアです。好評を博したアーケード版からの移植作ですが、ストーリーや演出などのあらゆる面がさらにパワーアップされ、より進化を遂げた戦場アクションが楽しめます。ファンの間で話題になった「アツイゼ アツイゼェー アツクテ シヌゼェーッ！」に代表される独特のセリフ回しも必見です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ならず者戦闘部隊 ブラッディウルフ</span></div>
</div>
