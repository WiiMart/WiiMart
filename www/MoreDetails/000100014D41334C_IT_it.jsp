...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">L'obiettivo di questa sfida per due giocatori consiste nel ripulire la propria griglia dalle piccole creature a forma di goccia, chiamate puyo, che la riempiono cadendo dall'alto. Per essere eliminati, i puyo devono formare delle catene di quattro o più elementi dello stesso colore, che possono essere disposti in linee orizzontali o in precisi motivi geometrici. Quel che rende appassionante questo rompicapo è il fatto che, quando elimini una catena dalla tua griglia, un elemento a caso viene inviato nella griglia del tuo avversario. Quanti più puyo elimini, tanto più si riempie la griglia del tuo avversario. Quando riesci a inviare abbastanza elementi da colmarla fino al vertice, hai vinto la partita. Una intrigante storia di fondo rende questo gioco un piacevole diversivo per uno o due giocatori!
<br><br>Il testo all'interno del gioco contiene caratteri giapponesi.
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41334C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41334C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Puyo Puyo<sup>TM</sup> 2</span></div>
</div>
