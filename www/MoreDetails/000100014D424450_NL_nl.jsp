...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Kort na het einde van Death Adders schrikbewind dient het volgende gevaar zich aan. De vrede in het land wordt opnieuw bedreigd, ditmaal door ’Dark Guld’, van wie gedacht werd dat hij gevangen zat. Hij heeft echter de Golden Axe in handen gekregen en gebruikt hem voor zijn eigen snode plannen. Samen met zijn volgelingen zorgt hij voor een enorme chaos.
<br><br>
Het is dus opnieuw aan de brute barbaar Ax-Battler, de onverschrokken amazone Tyris-Flare en de meedogenloze dwerg Gilius Thunderhead om met behulp van hun magische krachten de onderdrukking een halt toe te roepen en de Golden Axe terug te winnen. Nu krijg jij de mogelijkheid Guld en zijn handlangers tegen te houden en de vrede terug te brengen!
<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Het spel is voorzien van Engelse schermteksten.
<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Golden Axe<sup>TM</sup> II</span></div>
</div>
