...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157524250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ambientato in un mondo di robot sarcastici e combattivi, Robocalypse - Beaver Defense offre armamenti pazzi e fragorosa distruzione in un gioco di tipo "tower defense". <br><br>I giocatori creano e collocano strategicamente delle torri per annientare le orde di robot nemici, mentre i robot eroi controllati dal giocatore funzionano come unità armate mobili e portano un'enorme potenza di fuoco in tutti i punti del campo di battaglia. 
<br><br>
