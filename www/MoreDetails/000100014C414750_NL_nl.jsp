...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sonic The Hedgehog, gebaseerd op de oorspronkelijke SEGA MEGA DRIVE-versie, werd herschapen als het eerste Sonic-spel voor het SEGA MASTER SYSTEM, met nieuwe levels, eindbazen, een aantal verschillende zones en een levelkaart.
<br><br>Zoals je je misschien kunt herinneren, was een van de meest merkbare verschillen dat je de Chaos Emeralds in bepaalde levels moest vinden, in plaats van in de Special Stages.
<br><br>
Ren door 6 Zones, waaronder Special Zones die alleen beschikbaar waren voor de SEGA MASTER SYSTEM-versie, en neem het op tegen Dr. Eggman (ook bekend als Dr. Robotnik) aan het einde van elke Zone!<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
