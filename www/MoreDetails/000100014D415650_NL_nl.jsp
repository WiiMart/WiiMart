...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Monster World was een vredig en vriendelijk oord, totdat het op een kwade dag door een leger BioMeka-monsters werd binnengevallen. Je speelt Shion, een jonge man die gezworen heeft de vijandige indringers te verslaan en de vrede in het land te herstellen.
<br><br>
Je valt vijanden aan met zwaarden en speren, en verdedigt je met schild en harnas tegen inkomende projectielen. Al reizend door de vele gebieden in Monster World praat je met de stedelingen, verzamel je geld om voorwerpen te kopen en vind je allerlei wapens en magie. Hoe verder je in het spel geraakt, des te krachtiger je wapens en uitrusting (waaronder laarzen en pantserbekleding) zullen worden.
...
<br>Geen ondersteuning van de interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D415650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D415650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wonder Boy in Monster World<sup>TM</sup></span></div>
</div>
