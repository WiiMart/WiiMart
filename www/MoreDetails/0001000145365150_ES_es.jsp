...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En 1986 hizo su aparición en los salones recreativos este juego de acción de desplazamiento lateral.
<br><br>
Estamos en el año 19XX d.C., y la raza humana se encuentra al borde de la aniquilación por culpa del ancestral Señor de las Bestias, ahora resucitado.
En un intento por detenerlo trajeron de nuevo a la vida a Rygar, un guerrero legendario, que ahora deberá luchar para salvar a la humanidad.
Ármate con tu fiel escudo y utiliza todas tus habilidades para abrirte paso a través de 27 intrincadas fases. No olvides recoger todo lo que veas: ¡el juego está repleto de bonificaciones ocultas!
<br><br>
Revolucionario en su día, este juego recibió maravillosas críticas gracias a sus increíbles
gráficos, que quedan patentes, entre otros detalles, en las puestas de sol y las cascadas.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
