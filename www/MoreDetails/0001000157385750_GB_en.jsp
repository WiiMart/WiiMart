...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157385750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Create and send fun Halloween Cards!
<br>
Use all your imagination and dress your character with different costumes, then decorate the card choosing the background, the music and lots of stickers.
<br>
With the Wii Remote you can easily navigate through the different menus and add the stickers, in the position and size of your choice.
<br>
Once the card is finished, write a personal note and send it to your friends.
<br>
Try out this easy and fun new software!
Follow the quick tutorial to learn how to properly use it!
<br/><br/>
As some of the Wii console’s online services were discontinued on 28th June 2013, online features for this software, using WiiConnect24, are no longer available.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157385750/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157385750/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
