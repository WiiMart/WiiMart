...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157445050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In de Dr. Mario Demo kun je een indruk krijgen van hoe het er online aan toe gaat in Dr. Mario voor WiiWare.
<br><br>
Met deze demoversie kun je verbinding maken met een vriend of vriendin die de volledige versie van het spel heeft (Dr. Mario & Germ Buster), en tegen elkaar spelen via de Nintendo Wi-Fi Connection.
<br><br>
De spelstanden voor één of meer spelers en de Germ Buster-stand zijn niet in deze online demoversie inbegrepen.
<br><br>
Het spel is voorzien van Engelse, Franse, Duitse, Italiaanse en Spaanse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157445050/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157445050/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dr. Mario<sup>TM</sup> Demo</span></div>
</div>
