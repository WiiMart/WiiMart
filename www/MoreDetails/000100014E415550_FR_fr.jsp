...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jouez au golf avec Mario et ses amis! Choisissez parmi 14 personnages, chacun avec une puissance de tir et un style de swing particuliers. Vous pouvez même importuner vos adversaires pour les déconcentrer!
<br><br>
Mario Golf inclut de nombreuses fonctions, 10 modes de jeu différents (tournoi, parcours contre la montre, minigolf, etc.), ainsi que 6 longs parcours où vous pouvez gagner des points d'expérience pour progresser.
<br><br>
Avec des commandes simples à utiliser et un mode de compétition à 4 joueurs, impossible de ne pas prendre goût au golf!
<br><br>
