...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Beleef een van de meest herkenbare spelseries in deze naadloze overzetting van de speelhalklassieker!
<br><br>
Neem het veld met indringers onder vuur terwijl het genadeloos dichterbij komt. Wees snel maar voorzichtig en gebruik de schilden om je te beschermen tegen de raketten die op je worden afgeschoten. Probeer alle aliens te vernietigen voordat ze de onderkant van het scherm bereiken.
<br><br>
Versterk het gevoel van nostalgie door te kiezen tussen standen die verschillende versies van het speelhalspel nabootsen (zoals ‘upright cabinet’ of ‘black and white’). Of als je wilt bewijzen dat je beter bent dan een van je vrienden, probeer je de nieuwe VS Game Mode om te zien wie er het snelst een buitenaardse invasie kan terugdringen.
<br><br>
Kortom, dit is videogames spelen in zijn puurste vorm, en je hebt er niet eens muntjes voor nodig!
<br><br>
Het spel is voorzien van Engelse schermteksten.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434B50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Space Invaders</span></div>
</div>
