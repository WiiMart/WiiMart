...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157335345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Triple Shot Sports es el juego más avanzado de tiro deportivo para WiiWare, sumergiendo al jugador en el mundo del tiro deportivo competitivo.

La mayoría de los eventos competitivos consisten en actividades que tradicionalmente se deriva de la caza y habilidades de combate. Con el tiempo estas prácticas se han convertido en una gran variedad de deportes competitivos que incluyen tiro con arco, tiro con pistola y rifle.
 
Con el control total del arma, tendrá una experiencia como en la vida real. También deberá tener en cuenta las condiciones meteorológicas dominantes y el patrón de respiración del deportista ya que pueden influir tanto en la precisión del tiro.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157335345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157335345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Triple Shot Sports</span></div>
</div>
