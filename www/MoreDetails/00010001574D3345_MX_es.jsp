...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D3345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Controlas uno de los ocho monos y tendrás que luchar con hasta siete simios en ocho entornos de diferente temática. En el modo para un jugador tendrás que pelear en tres campañas cada vez más difíciles cuyas misiones van desde la supervivencia a la lucha de cocos. También tendrás que combatir en una batalla contra el reloj, en equipo o en un duelo a muerte estándar.
<p>
Conecta más Wii Remotes para enfrentarte con hasta tres jugadores o compite contra amigos y desconocidos a través de la Conexión Wi-Fi de Nintendo. Conecta una Wii Balance Board para añadir más dinamismo a la diversión.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
