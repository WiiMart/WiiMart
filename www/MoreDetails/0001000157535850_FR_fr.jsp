...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157535850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les courses de Stunt Cars se déroulent sur des pistes surélevées où le joueur peut tomber dans le vide à tout moment. Les voitures disposent d'un turbo augmentant leur vitesse, mais son utilisation est limitée dans chaque course.
<br><br>
A mesure que vous progressez dans les 4 championnats, vous débloquerez des bonus, comme des trophées pour récompenser votre pilotage et de nouveaux véhicules.
<br><br>
PRINCIPALES CARACTERISTIQUES :
<br><br>
-   24 pistes aussi endiablées qu’ardues remplies de sauts vertigineux, de rampes et de tunnels
<br>
-   4 joueurs peuvent s’affronter en écran partagé
<br>
-   Sélectionnez une voiture parmi 6 modèles plus ou moins performants en termes de vitesse, d’accélération et de poids
<br>
-   Remportez différents prix (il en faut 12 pour gagner) dont Gold Hero, Track Warrior, Stopwatch Pro et Stunt Champion
