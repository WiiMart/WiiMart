...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パイプから出現する敵キャラたちを床の下から突き上げて気絶させ、体当たりして倒していくアクションゲーム。協力プレイのはずがいつの間にか熱いバトルになってしまう２人同時プレイが醍醐味。アーケード版から移植された、マリオが主人公となった初のタイトルです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マリオブラザーズ<sup>&reg;</sup></span></div>
</div>
