...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This single-player or multiplayer experience expands upon the game play of the original two Columns titles by giving players some extra attacks to spring on their opponents during the game. As in the original Columns, jewels fall into a bin, and you have to twist and manipulate them to form matches of three or more in a vertical, horizontal, or diagonal line to keep the jewels from stacking up and reaching the top. In Columns III, you can get special magical jewels that will do things like raising your opponent’s crush bar or lowering yours, adding an extra element of strategy to the game. This is a great game to play with friends, so download it today and jump into the action!
<p>
When battling with multiple players, you must connect the same number of Wii Remotes or Nintendo GameCube Controllers as the number of players. To play with five players, you will need at least one Nintendo GameCube Controller.</div>
  <div id="image02">
