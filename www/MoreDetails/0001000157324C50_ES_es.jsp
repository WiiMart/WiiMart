...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bloons es un emocionante juego de puzles que se basa simplemente en el hecho de que reventar globos es divertido. Ábrete un camino reventando globos a través de docenas de niveles desconcertantes en esta emocionante aventura de puzles. Los globos tendrán una disposición nueva en cada nivel; intenta reventar todos los que puedas con los dardos disponibles. Busca globos, bloques y dardos especiales, y diviértete descubriendo lo que hacen. Bloons es un gran juego con el cual puedes jugar durante solo unos minutos, o bien pasarte horas sentado en el sofá mientras vas abriéndote camino a través de los 70 niveles existentes. Y como bonificación adicional, ¡hemos incluido un editor de niveles con el que puedes crear tus propios puzles de globos!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324C50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324C50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bloons<sup>&reg;</sup></span></div>
</div>
