...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">꿈의 나라에서 마리오 일행이 모험을 펼치는 액션 게임입니다. 마리오와 루이지뿐만 아니라 피치공주와 키노피오로도 플레이할 수 있으며, 땅에 묻힌 채소나 적을 뽑고 던지는 등의 독특한 액션을 즐길 수 있습니다. 선택한 캐릭터에 따라 능력이 다르다는 점이 가장 큰 특징입니다. 골고루 잘하는 마리오, 점프력이 좋은 루이지, 공중에서 오래 나는 피치공주, 힘센 키노피오를 적절히 사용하여 코스를 클리어합니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146425951/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146425951/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">슈퍼 마리오<sup>TM</sup> USA</span></div>
</div>
