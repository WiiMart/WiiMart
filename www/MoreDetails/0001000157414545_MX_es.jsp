...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Around the World es un juego sobre geografía para todo el público. Incluye un modo individual, para que sigas ampliando tus conocimientos sobre la materia, y un modo multijugador, para competir con familiares y amigos. De una forma amena y distendida, el juego aborda la geografía como un todo, en el que tienen cabida desde la historia y los monumentos hasta el deporte, el arte, la literatura y los temas de sociedad.
<p>
La filosofía del juego combina dos formatos distintos, en los que el jugador dispone de un tiempo limitado:<br>
- Las preguntas: el jugador debe responder eligiendo la respuesta correcta entre un gran número de opciones.<br>
- “Indicar el sitio más cercano”: el jugador debe situar un lugar dado de la forma más precisa posible.</div>
  <div id="image02">
