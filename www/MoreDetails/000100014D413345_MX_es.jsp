...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El objetivo de este juego de rompecabezas para dos jugadores es despejar tu cuadrícula de formas descendientes, llamadas puyos, formando cadenas de cuatro o más puyos del mismo color (en una línea recta o una de varias formas geométricas). Lo que hace desafiante a esta competencia de dos jugadores es el hecho de que cuando tú despejas una cadena de puyos de tu cuadrícula, ésta suelta una pieza o relleno al azar en la cuadrícula de tu adversario. Mientras más puyos despejes, más llenarás la cuadrícula de tu adversario y si puedes llenarla hasta el tope, has ganado el juego. Una historia de fondo intrigante hace de ésta una experiencia divertida para uno o dos jugadores.
<p>
Este juego nunca fue estrenado en el Genesis en el hemisferio Occidental. Es posible que material no esencial al juego exista que sea desconocido por nuestros consumidores, inclusive el texto y sonido en algún lenguaje extranjero.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D413345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D413345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Puyo Puyo 2</span></div>
</div>
