...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157505150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Protöthea è uno sparatutto a scorrimento verticale con movimento libero dove il giocatore, grazie al controllo completo di una nave stellare di ultima generazione, deve distruggere l'asteroide "Maqno 01" e porre fine ai piani de “Il Nucleo”.
<br><br>
Con Protöthea, Ubisoft introduce nuovi concetti in uno stile classico, mescolando i generi e sfruttando appieno le caratteristiche della console Wii, dalla grafica ai comandi.
<br><br>
I giocatori di tutte le età e con diversi livelli di esperienza potranno mettersi al comando della propria nave, attraversando quattro mondi diversi in dieci missioni impegnative. Usa il tuo arsenale e gli oggetti speciali bonus per portare a termine la missione, e ricordati che puoi anche rallentare il tempo per avvantaggiarti sul nemico.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
