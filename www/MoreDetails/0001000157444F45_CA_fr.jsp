...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157444F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Driift Mania is the ultimate top-down multiplayer racing experience! Challenge your friends in fast and exciting races and some totally crazy game modes! You will need to adapt your driving skills to the different racing environments if you want to succeed!
<p>
FEATURES<br>
Fast-paced top-down racer for 1 to 8 players.<br>
Choose from 32 different vehicles in 4 categories (small, medium, heavy, special).<br>
12 different tracks and 3 arenas based on 4 themed environments (city, hills, snow, oasis).<br>
7 game modes including traditional single-player, team race and multiplayer championship as well as crazy modes like VIP, Meteorite, Cold Potato and Contamination.<br>
Play using any combination of Wii Remotes, Nunchuks and Classic Controllers.<br>
Fun cartoon-style graphics.</div>
  <div id="image02">
