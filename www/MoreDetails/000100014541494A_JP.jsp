...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９４年にリリースされた横スクロール型のアクションゲームです。プレイヤーはスペース・バウンティー・ハンターの「ロディー」と「キャシー」となって、自分達の母星を襲撃した宇宙海賊「キャプテン・クラプトン」の打倒をめざします。手前と奥の２ラインを自由に行き来できるユニークなシステムが特長で、２人同時プレイにも対応。
ジャンプ、銃撃、投げ技、コマンド入力型の必殺技など、多彩な攻撃を駆使してさまざまなステージを攻略していきます。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">トップハンター</span></div>
</div>
