...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158485950')", "wiiSelectSound()");
...
<br><br>
CommanderVideo will need a little help from the friends he made in BIT.TRIP RUNNER to thwart the Mingrawn Timbletot who has mutated the world into an ugly technological nightmare.
<br><br>
Join forces with the Junior Melchkin, CommandgirlVideo, and others to increase CommanderVideo’s power and save the world.
<br><br>
Whether you play in single-player or team up with a co-pilot, you’ll have to have a steady hand to navigate the vibe and aim your blasters at the twisted souls out to destroy you.</div>
  <div id="image02">
