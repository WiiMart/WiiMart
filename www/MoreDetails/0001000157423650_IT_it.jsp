...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157423650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sfida i tuoi amici e la tua famiglia e diventa il "Re dello Show”! Il tuo Mii dovrà provare a rispondere correttamente a domande interessanti e divertenti. Da domande più classiche quelle più originali affrontando temi di storia e geografia, scienze e natura o anche sport e divertimento! Per rendere la sfida più interessante, userai il tuo telecomando Wii in modi del tutto originali: Potrai "far luce” sulla risposta giusta usando il telecomando Wii come una torcia, oppure potrai usarlo per “grattare” le risposte e svelare quella corretta! A questo gioco, essere solo intelligenti non basta!
TV Show King metterà a dura prova il tuo cervello per farti guadagnare montagne di dollari! E se ti senti abbastanza fortunato, sfida la dea bendata girando la ruota! Potrai aumentare il tuo capitale... oppure perdere tutto. 
Arriva in finale e scopri chi vince più denaro nell'ultimo e deciso duello! E ora, preparati... e inizia a giocare con TV Show King!!<br><br>

I testi sullo schermo saranno in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157423650/FFFD0012" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157423650/FFFD0013" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
