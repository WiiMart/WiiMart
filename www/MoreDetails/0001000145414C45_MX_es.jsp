...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lanzado en 1994 por SNK, ART OF FIGHTING 2 se trata de 12 personajes que compiten por ganar el campeonato del luchador más fuerte: el King of Fighters (rey de los luchadores). Cada personaje tiene diferentes tipos de técnicas mortales en su arsenal, y los jugadores tendrán que usarlas para luchar contra sus adversarios. Sin embargo, al igual que en la versión original, ART OF FIGHTING, el uso de una técnica mortal disminuye la carga de energía mental. Por esta razón, los jugadores tendrán que utilizar esta técnicas cuidadosamente. También podrán provocar al enemigo para agotar su energía mental, e incluso suprimir las técnicas del enemigo si lo hacen con éxito. Este tipo de ataque y defensa con energía mental es una característica que distingue a ART OF FIGHTING 2 en los juegos de lucha. Además, y haciendo aún más importante la estrategia que necesitarás para ganar, un ataque se hará más fuerte o débil dependiendo del momento en que se oprima un botón. Aunque un jugador sea derribado, puede ponerse a la defensiva oprimiendo un botón en el momento adecuado. ¡Todo esto culmina en una intensa experiencia que no encontrarás en ningún otro juego!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414C45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414C45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ART OF FIGHTING 2</span></div>
</div>
