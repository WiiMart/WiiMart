...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F5450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Overturn Mecha Wars es un torneo de lucha cara a cara donde los jugadores controlan máquinas futuristas cargadas de armas ultratecnológicas.
<br>
El objetivo del juego es acabar con el rival intentando esquivar sus ataques para sobrevivir.
<br>
Los jugadores pueden personalizar cada una de las ocho máquinas, eligiendo entre la variedad de armas disponibles que vayan acumulando a lo largo del torneo. 
<br>
Se trata de un juego ideado para 1 o 2 jugadores in situ (pantalla dividida).
<br>
¡Y con la Wii Balance Board, los jugadores podrán controlar sus máquinas inclinándose a un lado y a otro!
