...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000148415450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Suchst du Informationen zu den neuesten Spielen? Möchtest du wissen, welche Spiele deinem Geschmack entsprechen könnten? Dann ist der Nintendo-Kanal genau das Richtige für dich!
<br><br>
Im Nintendo-Kanal findest du aktuelle Informationen zu Wii-, Nintendo DS-, WiiWare- und Virtual Console-Titeln. Du kannst dir exklusive Videos zu Spielen und Hintergrundberichte ansehen und erhältst außerdem Spieleempfehlungen, die auf der Bewertung von anderen Nutzern basieren.
<br><br>
Wenn du einen WiiWare- oder Virtual Console-Titel siehst, der dich interessiert, kannst du ihn direkt im Wii-Shop-Kanal herunterladen. Außerdem kannst du mit dem Nintendo-Kanal drahtlos DS-Spieledemos von deiner Wii-Konsole auf dein DS-System übertragen!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415450/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415450/FFFD001B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Nintendo-Kanal</span></div>
</div>
