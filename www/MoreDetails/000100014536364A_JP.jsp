...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">美しいグラフィックと軽快なＢＧＭが人気を呼んだ、横スクロールタイプのシューティングゲーム。天才科学者「泊博士」が、「悪人クボタ」にさらわれた婚約者「香奈」と原子変換装置「オーダイン」を取り戻すため、助手の「サンデー・珍」と共に「マイシップ」に乗り込んでクボタを追います。マイシップを操作し「ボム」や「ビーム」で敵を倒しながら、空中、水中、洞窟などを舞台にした全７ラウンドを攻略します。敵を倒して「クリスタル」を集めれば、「空中ＩＮ」でアイテムを購入し、マイシップをグレードアップさせることができます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
