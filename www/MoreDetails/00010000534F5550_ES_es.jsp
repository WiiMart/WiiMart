...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">No es posible descargar este canal.<br><br>Para actualizar los datos de The Legend of Zelda: Skyward Sword, es necesario descargar el Canal Actualización de datos de The Legend of Zelda: Skyward Sword.</div>
  <div id="image02">
    <img src="/oss/ccs/00010000534F5550/FFFD0011" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
