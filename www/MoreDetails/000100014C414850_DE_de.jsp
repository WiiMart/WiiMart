...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Space Harrier wurde in den 80er Jahren als Arcade-Spiel veröffentlicht. Es stammt aus der Feder von AM2, dem Entwickler von OutRun und Afterburner. Eingefleischte Arcade-Fans schätzen Space Harrier wegen seiner unverwechselbaren Grafik und des schnellen Gameplays.
<br><br>
Die Version für das SEGA Master System gilt als gelungene Umsetzung der Arcade-Version und enthält alle 18 Level packender Action.
<br><br>
Als Space Harrier musst du dich durch DRAGON LAND kämpfen, am Ende eines jeden Levels einen Endgegner besiegen und den Frieden im Land wiederherstellen. Hast du das Zeug zum Helden? Mach dich bereit!
<br><br>
