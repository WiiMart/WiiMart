...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157324950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welkom bij "FISHIE FISHIE", de enige game die je maar met één knop kunt spelen.<br>
Een unieke beleving die al je reflexen op de proef stelt.<br>
De game bevat tal van lessen die je niet alleen leren hoe je jouw vis moet besturen, maar je ook de verschillende gamemodi uitleggen.<br>
In "FISHIE FISHIE" ben jij een vis die andere visjes zo snel mogelijk moet proberen op te eten. Elke seconde telt.<br>
Om te winnen moet je honderd levels verdeeld over zeven gamemodi uitspelen: “story” (verhaal), “soccer”(voetbal), “capture the star”(pak de ster), “survival” (overleving), “skill”(vaardigheid) en een grote competitie.<br>
Je kunt in je eentje spelen of met maximaal vier mensen op hetzelfde scherm. In de co-op modus, of elk visje voor zichzelf, is alles geoorloofd om te winnen.
<br><br>
