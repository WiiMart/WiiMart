...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">妖怪たちを退治しながら地獄を行く和風アクションゲームです。ある日、地獄界を治める閻魔大王が乱心し、妖怪たちが好き勝手に暴れはじめました。天上界でその様子を見ていたお釈迦様は、人間界の高僧「覚蓮坊（かくれんぼう）」に閻魔大王を討つように命じます。プレイヤーは覚蓮坊を操作して、三途の川や血の池などを進み閻魔大王の洞窟をめざします。邪魔をする敵には退魔の力を持つ「魔破珠」で攻撃。魔破珠はボールのようにバウンドするので、障害物を利用して敵にぶつけたり、アイテムを取って敵を一掃する「スペシャル珠」として使ったりすることもできます。各ステージの奥にいる地蔵に触れると次のステージに進むことができますが、ステージによってはボスが地蔵を隠し持っていますので、ボスを倒して地蔵を取り返してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015044464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015044464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">地獄めぐり</span></div>
</div>
