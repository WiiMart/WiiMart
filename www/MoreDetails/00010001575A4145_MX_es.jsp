...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001575A4145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Zombii Attack es un juego de supervivencia arcade. En una metrópolis infectada e invadida con zombies hambrientos, debes mantenerte vivo armado sólo con una honda gigante y municiones como yunques, neumáticos, bombas experimentales altamente explosivas, e incluso los mismos no-muertos.
<p>
La acción es vertiginosa y frenética. Debes tomar elementos de forma rápida y dispararlos con la honda a los zombies antes que ellos te coman. Usa el Wii Remote para movimientos realistas y naturales de carga y fuego. Localiza y destruye los escondites secretos de zombies con el fin de obtener armas especiales, municiones, armaduras y mucho más. Tu decides, ¡comer o ser comido!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A4145/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Zombii Attack</span></div>
</div>
