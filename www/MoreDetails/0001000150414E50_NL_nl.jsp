...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Military Madness is een futuristisch simulatiespel, dat je midden in een oorlog op de maan plaatst. De regels zijn eenvoudig, zodat zelfs beginnende spelers al snel van dit strategische oorlogsspel kunnen genieten!
In het titelscherm zie je gemakkelijk te begrijpen en gedetailleerde aanwijzingen.
Military Madness speel je om de beurt, waardoor je je tactiek kunt bepalen voordat je een zet doet.
De eenheden zijn in elk level van tevoren bepaald. Je kunt je dus volledig concentreren op het voeren van het commando.
Gebruik het terrein in je voordeel, omsingel de vijand en eis de overwinning op!
Vecht je door alle 16 levels heen en maak korte metten met je tegenstander!
<br><br>
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.
<br>De spelteksten zijn in het Engels.</div>
  <div id="image02">
