...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieses Kampfspiel kam 1991 auf den Markt.  Der Spieler sucht sich einen der drei Kämpfer Terry Bogard, Andy Bogard oder Joe Higashi aus.  Der gewählte Kämpfer tritt an vielen Orten zu Straßenkämpfen an, immer mit dem Ziel, Geese Howard zu bezwingen, den stärksten Kämpfer Southtowns. Jeder der Kämpfer verfügt über ganz individuelle Kampftechniken.<br><br> Der Bildschirm ist in zwei Tiefenebenen geteilt, wobei die eine näher, die andere weiter entfernt zu sein scheint.  Der Modus für zwei Spieler erlaubt es den Spielern sowohl gegeneinander zu kämpfen als auch einander zu helfen. Dieser Titel ist sehr bekannt, da er eines der ausgefallensten Steuerungssysteme im Kampfspiel-Genre bietet.
<br><br>
