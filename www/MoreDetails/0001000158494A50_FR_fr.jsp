...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158494A50')", "wiiSelectSound()");
...
<br><br>En l'an 2112, les foules sont fascinées par des courses à vitesse extrême. La dernière technologie de course antigravité a intégré un système de phases. Une correspondance parfaite entre le circuit et la machine est la clé pour rester en vie.
<br><br>
Prépare-toi à découvrir une nouvelle façon de faire la course, à une vitesse inimaginable. Repousse tes limites pour remporter la victoire et faire tomber les records, défie tes amis dans des compétitions acharnées, affronte des adversaires impitoyables et file jusqu'au sommet de chaque ligue.
<br><br>
Faites chauffer les machines. Le futur, c'est maintenant...<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494A50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
