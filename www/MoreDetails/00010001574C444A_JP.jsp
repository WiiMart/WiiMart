...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574C444A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ボクも世界を救いたい」は、勇者になる前の若者が主人公で、レベルアップや様々なイベントを通じて立派な勇者を育てる、勇者育成アドベンチャーゲームです。また、自分の作った勇者の活躍を見守る、シミュレーションモードも搭載しています。<BR><BR>育成モードでは、経験値稼ぎ、お金稼ぎ、装備の購入、イベント、パーティー編成などの要素を網羅しつつ、移動や雑魚敵との戦闘といった部分は簡略化し、「どのダンジョンに行くか」、道具屋で「何を買うか」といった選択に絞ったアドベンチャー形式で進行します。<BR><BR>シミュレーションモードでは、魔王が世界征服をたくらみ、勇者が魔王を倒すことを目標としている、そんな世界に自分の作った勇者を送り込み、どんな活躍をするのか見守ることができます。シミュレーションモードには複数の勇者が登録可能で、自分の作った勇者を複数登録したり、勇者をパスワード化して他人と交換したりすることで、他人の作った勇者を登録する事も出来ます。<BR><BR>自分好みの勇者を作る過程を堪能しつつ、その勇者がどんな活躍をするのか、また、他人の作った勇者とどのように絡み合うのかを見届けてください。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C444A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C444A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
