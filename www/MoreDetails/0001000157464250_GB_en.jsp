...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157464250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sandy Beach is a fully 3D sandcastle building game that utilizes the Wii remote to form and detail elaborate sand castles, images of which can then be captured and saved to your photo gallery. Players will be able to enjoy co-op play as they design their sandcastle on the tranquil shores of Sandy Beach. 
...
After successfully defending your castle use your metal detector to search for hidden treasures to adorn your sandcastle or even find additional cannon to aid in warding off the pesky crabs.</div>
  <div id="image02">
