...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574E3950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das Militär ist zurück und sucht eine neue Generation von Rekruten! Die klassische zugbasierte Strategiereihe MILITARY MADNESS, alias NECTARIS, jetzt auch auf WiiWare mit zahlreichen neuen Funktionen. Koordinieren Sie Strategien oder verhöhnen Sie Ihre Gegner im Team (offline oder online) oder im 4-Spieler-Multiplayer-Modus. Sie können die neue Kommandanten-Einheit mit 20 einzigartigen Fertigkeiten bearbeiten, um im Multiplayer die Oberhand zu erhalten. Zeigen Sie wer der beste General ist und kämpfen Sie sich in der Rangliste von Rang zu Rang, aber seien Sie dabei stets wachsam. Dies ist das bisher wahnsinnigste Spiel der Reihe!<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E3950/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E3950/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
