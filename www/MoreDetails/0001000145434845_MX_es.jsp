...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">King of Fighters '98 es la quinta entrega de esta célebre saga de juegos de lucha, publicada como una compilación tras asentarse el polvo desde el épico Sabio Orochi.
<br><br>
King of Fighters '98 presenta un total de 38 personajes, que pueden dividirse en 12 equipos, más 2 personajes individuales. Esta vez, podemos ver también el largamente esperado retorno del Equipo Sports. 
<br><br>
El modo de juego sigue el mismo patrón de su predecesor, la versión '97, en el que los jugadores pueden elegir entre el Modo Avanzado o Extra para combatir de acuerdo a su estilo individual. 
<br><br>
Algunos de los cambios menores incluyen mayor personalización para disfrute de los fans, así como una mejor mecánica de lucha.
<br><br>
(Contenido del juego disponible en inglés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434845/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE KING OF FIGHTERS '98</span></div>
</div>
