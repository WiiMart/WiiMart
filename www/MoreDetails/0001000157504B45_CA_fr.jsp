...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157504B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prepare to experience the intensity of a real Texas Hold’Em poker tournament online with opponents around the world! Up to 6 players can play wild poker parties thanks to an Online mode that also allows you to create your own tournaments. You can challenge opponents of any skill level you wish and enter the circle of the best poker players on WiiWare. Of course, there’s plenty in the single-player modes as well. Whether a novice or veteran, you’ll enjoy Tournament, Cash Game, and Heads-up modes with simple, fun Wii Remote controls. Hit the tables as one of 6 fun and charismatic characters, or import your own Mii character to really put on your poker face. Take on the most prestigious casinos where the other players won’t hesitate to taunt or comment, creating a very realistic poker atmosphere! Even if you’ve never played poker before, you can learn all the rules and strategies with the Advanced Tutorial, learning everything from winning hands and betting to bluffing.</div>
  <div id="image02">
