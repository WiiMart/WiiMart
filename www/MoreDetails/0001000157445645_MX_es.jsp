...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157445645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Voodoo Dice es un intrincado juego de puzle que, combinando acción y una mecánica tipo rompecabezas en un mundo en 3D, pondrá a prueba tus neuronas para resolver pruebas de un modo único e interesante. Adéntrate en un universo divertido y original lleno de estilo y sensaciones propias, viaja entre diferentes mapas, derrota a tus enemigos y resuelve enigmas.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157445645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157445645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Voodoo Dice</span></div>
</div>
