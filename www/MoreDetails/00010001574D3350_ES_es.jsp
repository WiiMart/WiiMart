...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D3350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Como pasa en casi todas las rivalidades, nadie sabe realmente dónde, cómo o cuándo empezó, pero estos monos no han dejado de pelear desde que tienen memoria. El estilo de lucha que han elegido es el antiguo arte del lanzamiento de plátano y, ahora que son enemigos declarados, están decididos a sobrevivir a los demás en la terrible lucha que es esta guerra de fruta.
<br><br>
Controlas uno de los ocho monos y tendrás que luchar con hasta siete simios en ocho entornos de diferente temática. En el modo para un jugador tendrás que pelear en tres campañas cada vez más difíciles cuyas misiones van desde la supervivencia a la lucha de cocos. También tendrás que combatir en una batalla contra el reloj, en equipo o en un duelo a muerte estándar.
<br><br>
Conecta más mandos de Wii para enfrentarte con hasta tres jugadores. Conecta una Wii Balance Board para añadir más dinamismo a la diversión.
<br><br>
Que gane el mejor mono.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3350/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3350/FFFD0015" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
