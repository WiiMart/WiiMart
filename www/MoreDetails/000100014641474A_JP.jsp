...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">日本のみならず世界中のゲームファンを虜にし、ファミコンブームの火付け役となったご存知スーパーマリオシリーズの第一作。全世界で約4,000万本もの販売を記録したアクションゲームの代表作。跳ぶ、走る、投げる、ブロックを叩いて壊す…多彩なアクションでマリオやルイージが大魔王クッパにさらわれたピーチ姫を助け出す大冒険が楽しめます。裏技や隠しアイテムを探すのも楽しい。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーマリオブラザーズ<sup>&reg;</sup></span></div>
</div>
