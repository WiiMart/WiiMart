...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Súbete al monopatín y participa en cinco competiciones extremas!
<br><br>
El modo descenso incluye una carrera normal y un peligroso recorrido por los callejones de la ciudad. Si compites en estilo libre, lo único que importa son los puntos, así que lánzate a la rampa e intenta realizar tantas acrobacias como puedas. También puedes comprobar lo alto que eres capaz de llegar en la prueba de salto. ¿Serás capaz de abrirte un hueco entre los mejores? Si quieres descansar de tanta competición, ¡coge una barra y acaba con tu rival en el duelo! (Niños, no hagáis esto en casa.)
<br><br>
Puedes jugar solo o retar a un amigo en todos los modos de juego de este clásico de NES. ¡Prepárate para una acción sobre monopatín nunca vista!
<br><br>
