...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スケート上手なペンギンくんが、南極大陸を舞台にゴールを目指すアクションゲームです。氷穴、クレバス、ひょうきんなアザラシなど、行く手をさえぎる障害を、ジャンプやスケートテクニック、フラッグを取ることで手に入る“ペギコプター”などを駆使して切り抜けます。制限時間内に南極大陸に広がる各国の基地へ到達し、大陸一周を目指します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146434E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146434E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">けっきょく南極大冒険<sup>&reg;</sup></span></div>
</div>
