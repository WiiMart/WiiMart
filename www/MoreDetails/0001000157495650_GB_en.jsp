...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157495650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Space Invaders are back, and this time they're out to get even!<br><br>

Take control of a UFO and make those Earthlings pay by unleashing your fleet of heroic invaders against their puny tanks, fighter jets and artillery.<br><br>

Use your invaders' five attack types and the might of the mother ship to rack up high scores, then upload them via Nintendo Wi-Fi Connection and see where you stand in the worldwide rankings!</div>
  <div id="image02">
