...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Samurai Shodown IV: Amakusa’s Revenge is the fourth installment in the Samurai Shodown series launched in 1996. The combat system is essentially the same as in the third installment, Blades of Blood, with tweaks added to enhance the combat experience, such as a vastly altered Rage Explosion System and more powerful chain combos. The ending also changes depending on the time taken to clear the game, encouraging players to improve their skills and speed if they want to see the One True Ending. Players can choose from 17 samurai warriors, including new characters Kazuki Kazama and Sogetsu Kazama, to battle their way through the game.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
