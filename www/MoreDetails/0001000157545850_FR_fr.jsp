...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157545850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les cartes ont été mélangées et les enchères sont placées : à vous de jouer ! Suivez, relancez ou bluffez et misez tous vos jetons dans le Texas Hold’em Tournament. Devenez un pro du poker en affrontant cinq adversaires virtuels. <br><br>Avec Texas Hold’em Tournament, jouez aussi des parties à plusieurs en invitant jusqu’à cinq amis. Grâce à sa compatibilité Mii™, vous serez véritablement présent à la table de jeu ! Commencez dans les petits casinos du Nevada et progressez jusqu’au championnat de Las Vegas. Avec le mode no-limit en coups multiples, préparez-vous pour des heures de poker !<br><br>Texte écran en anglais.</div>
  <div id="image02">
