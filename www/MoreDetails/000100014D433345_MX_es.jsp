...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Los valerosos Street Fighters están listos para desafiarte en la versión clásica para Genesis de Super Street Fighter II: The New Challengers! Enfréntate en torneos eliminatorios con la nueva bola de fuego de Ryu y con el nuevo Dragon Punch de Ken. ¡Lucha uno contra uno en modo local o pelea contra otros aspirantes en reñidas batallas online!
<p>
Elige entre 16 luchadores distintos de todo el mundo, que incluyen a los 12 originales y a 4 nuevos contendientes:<br>
- Cammy: una agente de las fuerzas especiales británicas, dispuesta a lanzar a sus rivales por los aires.<br>
- T. Hawk: un guerrero indígena de México que acecha a sus presas desde arriba.<br>
- Fei-Long: una estrella de acción de Hong Kong, dispuesto a utilizar su poderoso Dragon Kick.<br>
- Dee Jay: un luchador de kickboxing jamaicano que busca inspiración para su música.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D433345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D433345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Street Fighter 2<sup>TM</sup>:</span></div>
</div>
