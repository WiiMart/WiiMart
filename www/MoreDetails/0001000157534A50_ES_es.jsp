...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157534A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Demuestra que no se te escapa una con este divertido juego de WiiWare, que incluye 160 escenas, tres niveles de dificultad y 1600 diferencias. 
Juega solo o con tus amigos y descubre quién tiene mejor ojo. Diviértete analizando las curiosas y atractivas escenas repartidas en las distintas categorías: Paisajes, Animales, Tiempo de juego y Riquísimo.   
Disfruta con los cuatro modos de juegos disponibles:   <br>
- Arcade:  <br>
  Trata de descubrir cinco diferencias en escenas aleatorias. 
 <br><br>
- Time attack: <br>
   Descubre la diferencia que contiene cada escena antes de que se agote el tiempo.  
 <br><br>
- Seleccione escenarios: <br>
  Juega con tus escenas favoritas y descubre cinco diferencias en cada una. 
 <br><br>
- Varios jugadores:<br>
 Juega contra tus amigos (hasta 
 un máximo de cuatro jugadores).<br><br> Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534A50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">¡Descubra las diferencias!</span></div>
</div>
