...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９４年にリリースされた格闘ゲーム。西の剛、東の条と呼ばれる二人の不良の対決と、それに関係する人々の戦いを描いた作品で、プレイヤーは８人の個性豊かなキャラクターから一人を選んで戦うことになります。本作の特徴は、格闘ゲームでありながらステージに奥行きがあるため、敵の突進技などを画面の奥や手前に移動して回避したり、画面奥の車に登ってからジャンプ攻撃をしたりと、立体的な戦いが繰り広げられるという点でしょう。他にも落ちている武器を拾って戦ったり、連続して攻撃を命中させたりガードしたりすることで体力を回復できたり、ほとんどの必殺技が多段ヒットだったりと、“痛快”の名が示す通り爽快で独特な戦いが楽しめます。一撃必殺のガンガン必殺も必見！<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">痛快GANGAN行進曲</span></div>
</div>
