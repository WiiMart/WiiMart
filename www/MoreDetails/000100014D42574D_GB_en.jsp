...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This single-player or multi-player experience expands upon the gameplay of the first two Columns titles by giving players extra attacks to spring on their opponents during gameplay.  As in the original Columns, jewels fall into a bin and you have to twist and manipulate them to match three or more jewels in a vertical, horizontal or diagonal line to keep them from stacking up and reaching the top.<br><br>In Columns III, you can get special magical jewels that can do things like raising your opponent’s crush bar or lowering yours, adding an extra element of strategy to the game. This is a great game to play with friends, so download today and jump into the action!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
