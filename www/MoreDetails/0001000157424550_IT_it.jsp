...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157424550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Forza! È ora di Beer Pong! 
Questo gioco entusiasmante 
adesso è anche per WiiWare™!
Gareggia con i tuoi amici o con
il computer a questo divertente gioco.<br><br>

È possibile giocare su di un tavolo 
regolamentare fino a 4 giocatori.
Effettua tiri consecutivi per ricevere
bonus speciali (Fireball o Roll-Backs) 
e cerca di dominare il gioco vincendo
insieme con la tua squadra il titolo di 
Campione di Beer Pong.<br><br>

Nella modalità Speed Pong, fino a 3
giocatori possono sfidarsi 
contemporaneamente.
Velocità e strategia rappresentano
gli elementi essenziali di questo gioco
dal passo veloce.
Batti i tuoi avversari usando una miriade
di Power-Ups che li sconfiggeranno.<br><br>

Il primo che riempirà per intero una tazza
sarà il vincitore.<br><br>
