...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157344150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ARCADE SPORTS bestaat uit een selectie van vier volledige klassieke arcade sportspellen als Air Hockey, Bowling, Pool en Snooker.
<br>
AIR HOCKEY<br>
- Standaardregels
<br>
...
POOL<br>
- 9-Ball<br>
- 8-Ball (Britse & Amerikaanse regels)<br>
- 6-Ball<br>
...
SPEELMODI
<br>
De volgende speelmodi zijn beschikbaar:
<br><br>
PRACTICE<br>
In deze modus kun je een oefenspel spelen en je vaardigheden verbeteren.
<br>
VERSUS MATCH<br>
Een één-tegen-één ‘vriendschappelijke’ wedstrijd tegen een wedstrijdopponent in elk speltype.
<br>
SEASON MODE<br>
De ‘Season Mode’ is een serie aaneengesloten toernooien waarin tien toernooien met verschillende speltypes moeten worden gespeeld. Het doel is om de eerste plaats te veroveren op de ranglijsten.
<br>
MULTIPLAYER<br>
In Arcade Sports kunnen twee spelers tegen elkaar spelen in een ‘versus’ wedstrijd op één Wii-systeem.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
