...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157504250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pub Darts est une simulation de fléchettes simple qui tire profit des commandes uniques de la Wii pour reproduire le mouvement spécifique du jet de fléchette. Les parties se déroulent dans un pub local où les participants peuvent jouer à l'un de leurs jeux favoris comprenant le 501, le Cricket et d'autres.<br><br> Avant de jouer à l'un de ces 5 jeux, il faut créer un profil. Un profil vous permet de créer un personnage et de choisir un design d'aileron. Vous pouvez sauvegarder votre profil et l'utiliser à chacune de vos parties.<br><br>Texte écran en français.</div>
  <div id="image02">
