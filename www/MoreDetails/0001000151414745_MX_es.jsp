...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El legendario juego de acción de ciencia-ficción ha regresado! Gate of Thunder es un juego de disparo de desplazamiento horizontal que te pone al mando del agente especial encubierto “Hawk”, cuya misión es detener al mortal ejército de luchadores “Obbellon”. Entra en acción cuando “Hawk” se suba a su nave “Hunting Dog” y se dirija hacia el enemigo. Atraviesa por los niveles mientras usas las 3 armas a tu disposición y recibes ayuda de las naves aliadas de “Wild Cat”. Cambia las opciones de los power-ups para dirigir tu ataque. Tendrás que disparar por delante y por detrás para sobrevivir durante las 7 fases. ¡Los aficionados de los juegos de disparo que buscan un desafío, pueden seleccionar los modos “HARD” o “DEVIL” para experimentar una acción más intensa!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000151414745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151414745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
