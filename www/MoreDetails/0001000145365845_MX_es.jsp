...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“Rise from your grave!”(¡Sal de tu tumba!). Cuando Zeus, el legendario dios griego, te revive con sus famosas palabras, te embarcas en una misión para rescatar a su hija, Atenea, de las manos del Dios malvado del Infierno, Neff. Para sobrevivir a la ola de enemigos mitológicos, deberás cazar los lobos de tres cabezas que habitan cada etapa y coger las Spirit Balls (Bolas Espíritu) que suelten. Las Spirit Balls aumentan tu fuerza y te permiten transformarte en una variedad de criaturas, entre las que se incluyen Werewolf (hombre-lobo), Weredragon (hombre-dragón), Werebear (hombre-oso), Weretiger (hombre-tigre), y la forma suma, el Golden Werewolf (hombre-lobo dorado). Cada criatura posee ataques poderosos que son necesarios para acabar con los planes de Neff.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145365845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145365845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Altered Beast<sup>TM</sup></span></div>
</div>
