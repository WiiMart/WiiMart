...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">多彩なアクションとドラマティックなストーリー展開が魅力の、横スクロールタイプの忍者アクションゲームです。主人公「リュウ・ハヤブサ」は決闘に敗れた父の仇討ちのため、ハヤブサ家に伝わる「龍剣」を手に、単身アメリカへ渡ります。本作は全６章で構成されており、ひとつの章は複数のステージに分かれています。プレイヤーはリュウ・ハヤブサを操作し、基本となる龍剣での攻撃に加え、「手裏剣」や「炎波の術」といった忍術を駆使しながら、ステージを進んでいきます。また、ジャンプ時には壁や看板などにはりつくことができ、そこからさらにジャンプする「壁蹴りジャンプ」も可能。壁から壁へ飛び移る華麗な忍者アクションでステージを攻略してください。各章の最後に待ち構えるボスを倒すと、映画さながらのビジュアル・シーンが楽しめます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">忍者龍剣伝<sup>&reg;</sup></span></div>
</div>
