...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Esta edición mejorada de las famosas series de Lode Runner incluye un modo versus para 5 jugadores. El oro ha sido robado del Centro de Investigaciones de la Máquina del Tiempo y  el grupo responsable uso una máquina de tiempo para escapar y esconder el oro a través de los años. El Centro manda a un equipo de elite “Runners” para que vayan a recuperar el oro.<p>
Además del familiar modo ”Puzzle”, el juego tiene un modo “Battle”, donde podrán competir hasta 5 jugadores y el modo “Edit”, para crear tus propios niveles.<p>
Puedes disfrutar del modo “Battle” de muchas maneras. Sé el último en quedar en pie para ganar en “Survival”. Agarra los objetos de los enemigos y escapa para ganar en “Escape”. Con 4 jugadores, podrás formar 2 equipos para luchar en “Tag Match”.<p>
Para luchar con múltiples jugadores, tienes que conectar la misma cantidad de Controles Remotos Wii o Controles de Nintendo GameCube que la cantidad de jugadores.
Para jugar con cinco jugadores, necesitarás al menos un Control de Nintendo GameCube.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">TurboGrafx16</div>
</div>
</body>
</html>
