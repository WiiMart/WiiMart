...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157545450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toki Tori sammelt für sein Leben gern Eier!<br><br>

In diesem Puzzle-/Plattformspiel spielst du mit tollen Objekten wie z. B. einem Teleporter, dem Sofort-Stein™ und einem Schneckensauger. Im Spiel musst du durch geschickten Einsatz und clevere Kombination von Objekten mehr als 70 Levels absolvieren. Diese enthalten unterschiedlich schwere Aufgaben, von kinderleicht bis hin zu extrem knifflig. Dutzende Stunden anspruchsvollen Puzzle-Spielspaßes sind also garantiert.<br><br>

Toki Tori nutzt die Möglichkeiten der Wii-Konsole optimal aus. Die einzigartige Spielsteuerung über die Wii-Fernbedienung ermöglicht Spielern einen neuen und entspannten Spielstil. Ein zweiter Spieler kann dir helfen, indem er Hinweise zeichnet. Im Spiel kommt sogar die Wii-Pinnwand auf einzigartige Weise zum Einsatz!<br><br>

Toki Tori :<br><br>

- ist ein Puzzle-/Plattformspiel<br>
- bietet Dutzende Stunden Spielspaß<br>
- nutzt mehrere Wii-Fernbedienungen<br>
- nutzt die Wii-Pinnwand<br>
- kommt mit Spieltexten und einem Handbuch auf Deutsch</div>
  <div id="image02">
