...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おなじみ音速ハリネズミのソニックが、奥行きのある立体フィールドで活躍するアクションゲーム。かわいい小鳥たちが暮らす「フリッキーアイランド」を舞台に、「カオスエメラルド」をめぐってソニックとエッグマンの戦いが繰り広げられます。斜め見下ろしで表現された３Ｄステージを縦横無尽に駆けまわり、フリッキーたちをエッグマンから助け出していきます。すべてのフリッキーをビッグリングに逃がした後は、エッグマンの強力メカとの対決が待ち受けます。懐かしの名作アクション『フリッキー』をベースとした新たなゲームシステムや、ハードの限界を超えたオープニングムービーなど、オリジナリティあふれるメガドライブ最後期の作品です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソニック３Dブラスト<sup>TM</sup></span></div>
</div>
