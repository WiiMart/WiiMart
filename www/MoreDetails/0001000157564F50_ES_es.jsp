...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157564F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Serás capaz de alcanzar la cumbre del rock y convertirte en una estrella? Con Rock N' Roll Climber pondrás a prueba tu equilibrio y tu coordinación, siempre en pos de un objetivo: ¡llegar a ser el mejor escalador del mundo!
<br><br>
Valiéndote del mando de Wii, del Nunchuk y también, opcionalmente, de la Wii Balance Board, podrás mover pies y manos de forma independiente, aproximándote poco a poco a la cima y a la guitarra, el trofeo que obtendrás si completas con éxito la escalada.
<br><br>
Practica tus habilidades en un muro de entrenamiento y disfruta la emocionante experiencia de escalar una ladera en la selva, una cascada o una peligrosa montaña. ¡Deberás combinar velocidad y concentración a partes iguales para llegar a la cima sin caerte y dentro del tiempo previsto!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564F50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
