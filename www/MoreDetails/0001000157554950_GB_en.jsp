...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157554950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In "Successfully Learning: Mathematics Year 2", pupils will solve exciting maths problems with the little vampire Freddy to learn maths in a playful way. The little vampire Freddy motivates the children and helps with tips to ensure learning without pressure.
<br><br>
As a reward for hard study, you can unlock new levels of a funny bonus game. So learning and play becomes a perfect combination!</div>
  <div id="image02">
