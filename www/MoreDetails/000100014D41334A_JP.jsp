...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気落ち物パズルゲームシリーズ『ぷよぷよ』の第２弾。おじゃまぷよ同士を打ち消し合う「相殺」システムにより息の長い対戦が楽しめるほか、いざというときに役立つ「クイックターン」やおじゃまぷよのパワーアップ版「固ぷよ」など、「通」にはなくてはならない新システムの数々がゲームを盛り上げる、シリーズのなかでも特に人気が高い作品。一度始めるとなかなかやめられない面白さと、スリリングで熱い対戦プレイが魅力です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
