...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">鳥の飛行機乗り「バロン」と「マックス」を操作して、襲いかかる敵を倒したり敵の攻撃を避けながら左方向へとミッションを進めていく、横スクロール型シューティングゲームです。中には、爆弾でないと倒せない敵もいますので、フィールド上に置かれた爆弾を低空飛行で回収しましょう。特に特徴的な操作が、ボタンひとつで繰り出せる「宙返り」。敵の攻撃を回避したり、敵の後ろに回り込んで攻撃するなど、さまざまな場面で宙返りを活かすことが戦いのカギを握ります。「ＬＡＮＤ　ＨＥＲＥ」と書かれた基地に着陸できるとミッションクリアになり、次のミッションに進むことができますが、着陸に失敗すると燃料不足となり墜落してしまいます。２人プレイも可能で、同時に同じミッションに挑戦できます。空中と地上の敵を分担して倒すなど、助け合ってプレイすると、効率よくミッションをクリアできます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
