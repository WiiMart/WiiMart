...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sengoku 3 wurde erstmals 2001 veröffentlicht. Wähle einen der 4 Anfangscharaktere zum spielen aus und begib dich auf ein Abenteuer rund um die Welt, um böse Geister zu zerstören, welche vom Roten Mond erweckt wurden. Diese Fortsetzung bringt eine neue Spieldynamik zu der ihrer Vorgänger, indem sie eine Ninja (Shinobi) Anzeige einführt. Diese Anzeige erlaubt es, wenn voll gefüllt, verschiedene unterschiedliche Ninja-Attacken gegen die Feinde durchzuführen. Das neue System erlaubt dir bewaffnete und unbewaffnete Attacken angepasst auszuführen und Kombinationen (Combos) zu verbinden. Nutze die wirkungsvollen Ninja-Künste und Kombinationen um deine Feinde zu dezimieren, in dieser Action-geladenen letzten Instanz dieser epischen Spielreihe.<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
