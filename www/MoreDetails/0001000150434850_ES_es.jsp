...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Enfréntate a cinco rondas de trampas y pesadillas en este juego rompebloques. Para salvar a su amada del malvado demonio que controla sus sueños y la mantiene prisionera, nuestro valiente héroe se adentra en la pesadilla para derrotarlo.
<br><br>
Usa con destreza los objetos flecha y controla el ángulo de la bola para destruir los bloques que descienden desde la parte superior de la pantalla. ¡Fija tu blanco en las uniones que mantienen los bloques unidos y elimina muchos de un solo golpe! A medida que te deshagas de más y más bloques, sus formas cambiarán, y podrás ganar más puntos de bonificación.
