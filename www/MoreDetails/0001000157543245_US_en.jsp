...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157543245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Target Toss Pro: Bags is a new video game based on beanbag toss—the nation's hottest backyard and tailgate sensation. Bags, or Cornhole as they call it in some parts of the country, originated in the Midwest in the 1960s and has since become a staple at outdoor social events from coast to coast. Bags is a deceptively simple, yet extremely competitive game where players try to toss beanbags into a hole in a slightly raised platform or "box" for points, similar to horseshoes. Whether at a tailgate party or a summer barbeque, the game has become a social focal point, and the unmistakable thud of bags hitting the box is now a universal party sound track.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157543245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157543245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Target Toss Pro: Bags</span></div>
</div>
