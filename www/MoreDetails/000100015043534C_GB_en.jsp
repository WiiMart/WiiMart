...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Set in the near future, Digital Champ is a first-person boxing title that plunges players into the raw intensity of the ring! Determined to thwart Mother Computer’s plot to conquer mankind, you infiltrate the enemy’s domain, using your boxing skills to vanquish your foes.<br><br>
Each round is three minutes, with a total of 12 rounds in a match. Advance to the next contest either with a KO or by flattening an opponent three times in a round for a TKO. Use an arsenal of left and right jabs, hooks, power charged crosses and three different kinds of Devastator punches. Deftly block and slip your opponent’s attacks and look for your chance to knock him out. Master these techniques and take down the greatest opponent of them all, Digital Champ!</div>
  <div id="image02">
