...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157594950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aidez Vektor à échapper au méchant Processeur et à ses Patrouilleurs, Chasseurs et Intercepteurs.
<br><br>
Vektor est enfermé dans le Processeur de votre ordinateur. Il ne sait pas comment ni depuis combien de temps il est arrivé là, mais il a besoin de vous pour s'échapper. Le Processeur a privé Vektor de toute possibilité de déplacement, mais celui-ci est un programmeur de génie.
<br><br>
Faites équipe avec Vektor et aidez-le à se tirer des griffes du Processeur. Guidez-le dans le dédale du Processeur tout en évitant les Patrouilleurs, les Chasseurs et les Intercepteurs ennemis. Vous devez faire vite, car le Processeur réagit très rapidement à votre tentative d'évasion. Vektor programmera de nouvelles aptitudes afin de vous permettre de combattre le Processeur, mais son sort demeure entre vos mains.
