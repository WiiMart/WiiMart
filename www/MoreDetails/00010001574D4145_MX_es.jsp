...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D4145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡En Magnetis™, todo es cuestión de atracción! Conecta los imanes para crear explosiones eléctricas. Para resolver este frenético puzle tendrás que pensar rápidamente y anticipar las próximas conexiones para generar grandes reacciones en cadena y ganar la máxima puntuación. Para deshacerte de los bloques y ganar puntos, tienes que crear líneas conectando imanes derechos a imanes izquierdos del mismo color, usando los bloques conductores. Cuanto más larga sea la línea, más puntos ganarás. Juega con tus amigos en el modo cooperativo o enfréntate a ellos en el modo batalla, en el que pueden competir hasta 4 jugadores.</div>
  <div id="image02">
