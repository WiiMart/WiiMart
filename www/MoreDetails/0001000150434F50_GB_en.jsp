...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Enter a world created by the mind of a twisted demon in this side-scrolling shooter!
<br><br>
Your soul has stumbled into the evil world that exists in everybody’s heart. The only way out is to blast your way past the grotesque creatures that block your path in 5 Causes (stages).
You must face the dangers of this psychedelic world, making full use of 3 Shot types and a satellite option. With power-ups, you can change your Shot type  to a wide-coverage Beam, a satellite-generated Laser and more. You can also block enemy fire by rotating the satellites to the desired position.
<br><br>
Will you have the skill to escape this strange and surreal world?</div>
  <div id="image02">
