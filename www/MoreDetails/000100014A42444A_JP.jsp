...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気アクションゲーム「スーパードンキーコング」シリーズの第二弾。ワニのキャプテンクルール率いる海賊軍団にさらわれたドンキーコングを助けるため、相棒のディディーコングがガールフレンドのディクシーコングと一緒にクレムリン島にのりこみます。リアルに表現されいきいきと動きまわる二人を操作し、ステージクリアはもちろん、ＤＫコインやボーナスステージを攻略して、完全クリアをめざします。ディディーとディクシーを状況に応じて入れかえ、それぞれの特徴を生かしたアクション、協力してくれるアニマルフレンドなどをうまく使いこなすことが、ステージ攻略のコツです。また本作ではおたがいを持ち上げて投げつける新アクション「チームアップ」も登場、二人そろってこそ最高の力が発揮され、行動の幅も広がります。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42444A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパードンキーコング<sup>&reg;</sup>２</span></div>
</div>
