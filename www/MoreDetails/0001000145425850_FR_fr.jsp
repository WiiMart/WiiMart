...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti à l’origine en 1993, Sengoku 2 est un jeu de combat où vous aurez la possibilité d´esquiver vos adversaires. Les héros sont des guerriers, invoqués par une princesse sorcière, qui ont pour but de mettre fin au régne d’un seigneur des ténèbres en se battant à travers plusieurs époques. Tout comme dans l’épisode précédent, ils peuvent se transformer, mais cette fois vous n’avez pas besoin de sauver votre allié pour y parvenir. Dès le début, vous pouvez librement choisir entre trois transformations : Ninja, Tengu ou Chien ninja. De plus, cette version comprend de nouveaux éléments tels que des techniques de defense et d’attaque intégrées, donnant un tournant plus tactique à ce jeu d’action.<br><br>Texte écran en anglais.</div>
  <div id="image02">
