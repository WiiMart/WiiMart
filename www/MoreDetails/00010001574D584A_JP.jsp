...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D584A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「らくがき☆ヒーロー」は暖かみある2Dの世界観のアクション・アドベンチャーゲームです。不思議なペンを使って好きならくがきを描くと、それが時には傘に、時には橋になったりします。絵の中の世界のなぞを解き、「ザ・モンスター」を追いかけて、見事平和を取り戻しましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D584A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D584A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">らくがき☆ヒーロー</span></div>
</div>
