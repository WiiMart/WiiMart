...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015741554A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">コンピュータや世界のプレイヤーとの対局ができる
本格チェスソフトです。<BR><BR>

相手の強さを１０段階で設定できるコンピュータとの対局では、
世界トップクラスの思考プログラムを搭載していますので、
初心者でも、ワールドクラスの実力を持った上級者でも、
手ごたえのある対局が楽しめます。<BR>
ゲームに使用するチェス盤と駒のデザインは変更することができ、
コンピュータに勝利していくことでさらに増えていきます。<BR><BR>

ニンテンドーＷｉ－Ｆｉコネクションを使えば、フレンドとの
通信対局はもちろん、全国・世界のプレイヤーのなかから選ばれる
自分の実力に合った相手と気軽に真剣勝負が楽しめます。<BR><BR>

また、１つのＷｉｉリモコンを交互に使った２人対局も可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015741554A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015741554A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">通信対局　ワールドチェス<sup>TM</sup></span></div>
</div>
