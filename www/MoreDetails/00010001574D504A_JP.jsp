...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D504A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ヒラメキと偶然が言葉をつむぎだす、知的好奇心くすぐるパズルゲーム。ルールはかんたん。文字をつなげて、言葉を作るだけです。<BR><BR>オリジナルの辞書には、常識的な言葉から流行語まで、１３万語を収録。自由に言葉を作っているうちに、偶然知らない言葉もできて、思わぬ大連鎖が起きることも。<BR><BR>今作は、対戦モードが充実。お茶の間で対戦する「ふたりで対戦」のほか、「コンピューターと対戦」、シリーズ初の「Ｗｉ－Ｆｉ対戦」もお楽しみいただけます。<BR><BR>操作方法は３種類。画面をポイントして直感的に操作する「ポインティング」のほか、リモコンをタテやヨコに持つ操作方法でも遊べます。<BR><BR>１人用２００ステージ、対戦５０ステージにＷｉ－Ｆｉ対戦まで遊べて、お値段なんと１０００Ｗｉｉポイント。Ｗｉｉウェア版発売記念特別価格です。<BR><BR>詳細は、<Center>http://namco-ch.net/mojipittan/index.php</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D504A/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D504A/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ことばのパズル　もじぴったん<sup>&reg;</sup>Wii</span></div>
</div>
