...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マリオやルイージ、ピーチなど、マリオシリーズでおなじみのキャラクターたちが登場するテニスゲームです。総勢１０名以上のキャラクターはそれぞれパワーやスピードが異なるので、自分のプレイスタイルに合わせて選んでください。操作はシンプルで、移動に使うスティックと２つのボタンだけ。すぐにゲームに慣れラリーを楽しむことができます。２つのボタンのコンビネーションで繰り出されるトップスピンやスライスボール、さらにスマッシュ、ロブやドロップ、ボレーなどの数々の球種。これらを使い分けることで駆け引きがうまれ、対戦が盛り上がります。また、リングショットやパックンチャレンジ、相手を邪魔するアイテムが使えるクッパステージなども用意され、普通のテニスとは違った楽しみかたもできます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マリオテニス<sup>TM</sup>６４</span></div>
</div>
