...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Splatterhouse 2 is het vervolg op Splatterhouse, exclusief uitgegeven voor de SEGA MEGA DRIVE. Dit spel wordt beschouwd als een van de eerste echt ‘gewelddadige’ games.
<br><br>
Een paar maanden nadat hij uit het eerste huis is ontsnapt in Splatterhouse, stuit het hoofdpersonage Rick wederom op de Terror Mask en moet hij de krachten van dit masker gebruiken om zijn vriendin Jennifer te redden. Rick moet slaan, houwen, beuken en zelfs kettingzagen gebruiken om de onvoorstelbare verschrikkingen en angstaanjagende eindbazen in het spookhuis te overleven.
<br><br>
