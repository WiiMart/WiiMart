...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157464E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fish Tank is een combinatie van een razend populair drie-op-een-rij genre met een puzzelvideogamestijl. Het is een puzzelspel in arcadevorm, waarin je geen diamanten of blokken op een rij zet, maar groepen kleurrijke vissen verzamelt. De gameplay verloopt horizontaal, niet verticaal zoals je misschien gewend bent van andere spellen van deze aard.<br><br>

Wil je meer? Alsjeblieft:<br>
 - 24 prestaties voor het oprapen, <br>
- 24 uitdagende levels <br>
- 9 verschillende bonussen die de game-ervaring verbeteren <br>
- 4 spelers die samen kunnen spelen<br>
- 2 speltypen: "Play" en "Challenges" <br>
- 1 extra trofee op het einde van het spel voor de beste verzamelaar van gouden medailles!
