...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Es el año 2112 y la Tierra ha sido atacada por fuerzas extraterrestres. Métete en el papel de un motorista solitario que lucha contra los alienígenas invasores mientras corre de sector en sector buscando supervivientes. Eres la última esperanza del planeta. ¡Eres Mach Rider!
<br><br>
En la Carrera de lucha, tendrás que recorrer 10 niveles sobre una autopista y eliminar a tus enemigos con disparos o con maniobras ofensivas. En la Carrera de resistencia, pon a prueba tu habilidad contra el reloj. También puedes probar la Carrera en solitario para correr sin enemigos.
<br><br>
Mach Rider cuenta con un modo de diseño en el que podrás crear tus propias pistas. En la versión de la consola virtual, podrás incluso guardarlas. En la versión de NES, esto no era posible.
