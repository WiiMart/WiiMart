...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bereite dich auf den aufregenden Nervenkitzel des Spielehits 1080°: TenEighty Snowboarding vor. Dieser Nintendo 64-Klassiker hat eine einfache Steuerung und ist eine der überzeugendsten Snowboard-Simulationen überhaupt - und spielbar von deinem warmen Wohnzimmer aus!
<br><br>
1080°: TenEighty Snowboarding wartet mit sechs riesigen Strecken auf, in denen du mit mehr als 25 ausgefallenen Tricks dein Können unter Beweis stellen kannst. Sechs verschiedene Spielmodi werden dir geboten, darunter das Rennen gegen den Computer oder gegen einen Freund, das Zeitfahren, der
Trick-Modus, der Wettbewerb-Modus und der Trainingsmodus.
<br><br>
Beeindruckende 3D-Grafik (mit wechselnden Licht- und Wetterverhältnissen) und ein stimmungsvoller Soundtrack runden dieses winterliche Spaßpaket ab.<br><br>Keine Unterstützung der Rumble-Funktion des Originals.<br>Deutscher, englischer, japanischer oder französischer Bildschirmtext stehen zur Auswahl.</div>
  <div id="image02">
