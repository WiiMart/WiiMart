...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157465750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mentre la nostra eroina Follie è in viaggio per andare a trovare la
zia con un carico di semi di Flowerworks, la sua navicella spaziale
perde la rotta. Follie è costretta ad un atterraggio di
emergenza su un'area particolarmente brulla del pianeta Elilia. <br>
<br>
Esplora questa nuova area insieme a Follie e aiutala a recuperare i suoi
semi per trasformare il pianeta da deserto a favoloso giardino!
Incontrerai strani abitanti: alcuni aiuteranno Follie nella sua
missione, altri la ostacoleranno, come i dispettosi nani da
giardino. <br>
<br>
Flowerworks: Follie's Adventure è un'avventura per uno o due
giocatori che mette insieme fiori che sbocciano, fuochi
d'artificio colorati e tanto altro divertimento. Include le modalità Avventura,
Partita Rapida e un Tutorial, cinque livelli di difficoltà e 20 ore di
avventura epica. <br>
<br>
Flowerworks: Follie's Adventure è una versione migliorata
dell'originale Flowerworks, con una modalità per due giocatori, 
due nuovi livelli di difficoltà, Principiante ed Esperto, e tante altre sorprese.<br><br>
  Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157465750/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157465750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Flowerworks<sup>&reg;</sup>: </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Follie's Adventure</span></div>
  </div>
