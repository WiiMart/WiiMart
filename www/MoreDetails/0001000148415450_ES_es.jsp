...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000148415450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Buscas información sobre nuevos títulos? ¿Quieres saber cuáles te podrían gustar? ¡Entonces el Canal Nintendo es lo que necesitas!
<br><br>
El Canal Nintendo contiene información actualizada sobre los lanzamientos de Wii, Nintendo DS, WiiWare y la consola virtual. También podrás ver vídeos de los juegos, descubrir contenido exclusivo sobre su desarrollo y recibir recomendaciones de títulos que se ajusten a tus gustos basadas en las valoraciones de los usuarios.
<br><br>
Si te interesa algún título de WiiWare o de la consola virtual, podrás acceder directamente al Canal Tienda Wii para descargarlo. Además, ¡el Canal Nintendo te ofrece la posibilidad de descargar demos para Nintendo DS a través de tu consola Wii!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415450/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415450/FFFD001D" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
