...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paper Mario is a graphically innovative game that breaks the confines of the RPG genre. Now slimmed down, everyone's favorite plumber flips, spins, jumps, and hammers his way through scads of exotic worlds that teem with a huge and hugely entertaining supporting cast. Players control numerous characters, both old and new, in a complex, nonlinear story that follows different scenarios depending on player choices. A dizzying collection of spells, attacks, skills, and special items can be collected by players willing to thoroughly explore the lush 3-D environments!</div>
  <div id="image02">
