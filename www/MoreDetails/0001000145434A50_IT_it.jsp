...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gioco di combattimento a incontri rilasciato nel 1999, è il sesto capitolo della serie King of Fighters. In questo capitolo si faranno strada nuovi protagonisti per una storia completamente nuova. Rispetto alla precedente meccanica di gioco che prevedeva la selezione di 3 membri della squadra, da questo capitolo i personaggi selezionabili sono ben 4, 3 personaggi utilizzabili in combattimento e uno di supporto chiamato “Striker”. Come nelle precedenti versioni, puoi utilizzare le Super Mosse Speciali non appena la tua barra si riempie. Tuttavia, usando 3 barre di potenza puoi entrare nella modalità Counter che incrementa l’attacco, o nella modalità Armor, che incrementa la difesa. Le tecniche sfruttabili nelle differenti situazioni sono state anch’esse potenziate. King of Fighters 99 presenta 32 personaggi selezionabili. Pensi di avere l’abilità necessaria per affrontare questa sfida?<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434A50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434A50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE KING OF FIGHTERS '99</span></div>
</div>
