...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This classic vertically-scrolling shoot 'em up is perhaps Capcom's finest moment in the pre-Street Fighter era. Spawning a million clones and appearing on almost every format ever made, 1942's WWII bi-plane action needs no introduction. And now, for the first time on the Wii, the original and best version.</div>
  <div id="image02">
