...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001584A4750')", "wiiSelectSound()");
...
<br><br>
Bienvenue dans le monde de Gnomz, le tout nouveau jeu de combat arcade pour le service WiiWare™. Gnomz permet à 4 joueurs maximum de s'affronter ensemble et/ou contre l'IA autour de trois différents modes de jeu. <br><br>
Caractéristiques du jeu : 
<br><br>
- jeu de plateforme de combat de gnomes multijoueur en temps réel ;<br>
- 25 arènes gnomesques débordant d'action ;<br>
- des heures à cogner, écraser, matraquer et plaquer des gnomes ;<br>
- jusqu'à 4 joueurs (+ 4 joueurs contrôlés par l'IA) s'affrontant en local ;<br>
- des bonus magiques, des éléphants volants, des arcs-en-ciel et des rennes scintillants ;<br>
- Smash Match (Extermination), Capture the Sock (Capturez la chaussette), Socker (Collectionneur de chaussettes) ;<br>
- et bien plus encore...
