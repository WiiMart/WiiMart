...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157414C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieser revolutionär gestaltete<br> Art Style-Titel eröffnet neue Rennspiel-Dimensionen!
<br><br>
In Art Style: light trax kontrollierst du eine Spektrallinie, mit der du blitzschnell gegen andere Linien auf verschiedenen Rennstrecken antrittst. Durch die automatische Beschleunigung musst du dich auf strategische Spurwechsel und Überholmanöver konzentrieren. Die minimalistische 2D-Grafik wird durch 3D-Effekte und treibende Beats stimmig unterstützt. Nutze die zahlreichen Extras der Rennstrecken und hüte dich vor ihren Hindernissen, um wertvolle Sekunden herauszuholen! 
<br><br>
Es ist dir freigestellt, ob du in Gruppen von jeweils drei Rennstrecken antrittst oder im Freeway-Modus innerhalb eines Zeitlimits möglichst weit durch die Dimensionen reist. Dein Erfolg wird mit weiteren Spielmodi und Funktionen belohnt.

<br><br>
Die einfache Steuerung, das motivierende Gameplay, angelegt in einer chilligen Retro-Optik mit coolem Electronic Soundtrack, machen aus Art Style: light trax eine futuristische, konkurrenzlos stylische Rennspielerfahrung.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
