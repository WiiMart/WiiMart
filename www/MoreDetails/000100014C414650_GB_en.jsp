...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Whether you recognise this game by its US title (Rambo: First Blood II) or its European title of Secret Command, this SEGA MASTER SYSTEM classic lives on through Virtual Console!
<br><br>
Play as a lone warrior, armed to the teeth, sent on a top secret commando mission behind enemy lines to liberate your comrades at arms! Battle frenzied attacks from enemy soldiers, rocket troops, tanks and other enemies doing everything they can to stop you from saving the hostages.  Use your trusty machine gun and compound bow, equipped with explosive-tipped arrows, to pave the way to victory.  Let nothing stand in your path!
<br><br>
To add even more to the fun, you can play with a friend in two-player mode for double the firepower!</div>
  <div id="image02">
