...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157494450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Are you a Vampire Hunter? Are you ready to battle legions of undead foes including zombies, ghouls, werewolves and more? You will need to wield an arsenal of jaw-dropping powerful weaponry with skill and intelligence.
<br><br>
...
<br><br>
Enemies in Dracula - Undead Awakening have one thing in common. Undead, lycanthrope, mutant, and many more – they’re all after your flesh. Not to worry though – you come bearing “gifts”. Well, as long as you think of sharp, explosive, devastatingly destructive weaponry and ammo as “gifts”.</div>
  <div id="image02">
