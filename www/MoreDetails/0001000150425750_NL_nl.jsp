...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Air "Zonk" is nauw verwant aan de Bonk’s Adventure-serie. Dit zijwaartsscrollende schietspel heeft dezelfde cartoonstijl als Bonk, maar vindt plaats in een cyberpunkachtige toekomst.
Zonk is tot de tanden toe gewapend en vormt samen met zijn vrienden Team Cool. Hun doel is het dwarsbomen van King Drools plan de wereld te veroveren.
<br><br>
Kies uit 3 moeilijkheidsniveaus en 3 verschillende ‘Friend Modes’. Bevecht en ontwijk de cyberrobots van King Drool en verzamel ‘Air Bones’, waarmee je allerlei aanvallen kunt uitvoeren. Samen met een vriend kun je bepaalde speciale trucs uitvoeren, zodat je bijvoorbeeld tijdelijk onoverwinnelijk wordt of je wapen oplaadt voor een superaanval.
<br><br>
Air "Zonk" zit vol humor: luister maar eens naar het grappige liedje dat je hoort wanneer je een hoge score haalt of als het spel voorbij is!
<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150425750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150425750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Air "Zonk"</span></div>
</div>
