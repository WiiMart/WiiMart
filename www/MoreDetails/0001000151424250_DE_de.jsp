...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Eine Adaptierung der Arcade-Version von „Street Fighter“, dem legendären Kampfspiel, mit dem alles begann. Der Spieler steuert Ryu oder Ken und tritt gegen Kämpfer aus aller Welt an. Der erste Kämpfer, der seinen Gegner ausknockt und zwei Runden gewinnt, wird zum Sieger gekürt. Deine Angriffsfähigkeit lässt sich um drei Level erhöhen – je länger du einen Knopf gedrückt hältst, desto stärker der Angriff.<br>
Durch verschiedene Spezialangriffe kannst du deinem Gegner erhöhten Schaden zufügen!
Kombiniere deine normalen und deine Spezialangriffe für den sicheren Weg zum Sieg!
<br><br>
