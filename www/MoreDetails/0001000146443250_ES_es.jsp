...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Double Dragon es uno de los juegos de lucha más célebres de todos los tiempos y se ha convertido en un clásico de obligada referencia para otros títulos “beat’em up” que vendrían posteriormente. Originalmente solo apareció como máquina recreativa, pero fue tal su éxito que se lanzaron conversiones para muchas otras plataformas.
<br><br>
El juego nos presenta a dos hermanos, Billy y Jimmy Lee, cuya misión es salvar a Marian, la novia de Billy, quien ha sido secuestrada por los Black Warriors. Estos son una banda de expertos en artes marciales que busca por todos los medios aprender los secretos del SouSetsuKen, una técnica de lucha que los dos hermanos dominan.
<br><br>
Double Dragon cuenta con un modo de juego donde dos jugadores pueden cooperar para avanzar en la aventura, y ofrece un extenso repertorio de técnicas de lucha, que incluye puñetazos, patadas, diversas armas y objetos interactivos. La historia irá llevando al jugador a través de numerosos escenarios, desde los suburbios de la ciudad hasta montañas inaccesibles.
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146443250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146443250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Double Dragon</span></div>
</div>
