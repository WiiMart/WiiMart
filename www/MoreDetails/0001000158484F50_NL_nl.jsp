...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158484F50')", "wiiSelectSound()");
...
<br><br>
Pak je Wii-afstandsbediening en bouw een stevige stapel in deze fysicagebaseerde puzzel!
<br><br>
Puzzelgames moeten verslavend zijn. Dat was onze belangrijkste drijfveer tijdens de ontwikkeling van het spel. Daarom hebben we 100 levels ontwikkeld die niet alleen je vaardigheden, maar ook je verbeeldingskracht op de proef zullen stellen. Het spel is makkelijk te leren, maar moeilijk om neer te leggen.
<br><br>
Speel alleen of nodig een vriend of vriendin uit om met een tweede Wii-afstandsbediening met je mee te doen. Er is zelfs een uitgebreide gedeelde "versus" modus voor twee spelers voor nog meer speelplezier.<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
