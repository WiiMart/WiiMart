...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Esta es la conversión para NES de la exitosa máquina recreativa Operation Wolf. En este juego de acción serás un soldado de asalto entrenado en las fuerzas especiales, con la peligrosa misión de lanzarte en paracaídas sobre la selva sudamericana para rescatar a un grupo de rehenes. 
<br><br>
El juego se desarrolla desde una perspectiva en primera persona, lo cual te permite dirigir el punto de mira con el que intentarás abatir a tus enemigos, bien sea usando una ametralladora o granadas. Cada una de las seis misiones tiene un objetivo específico, y el resultado de cada una de ellas dependerá de tu actuación. No te puedes limitar a llenar la pantalla de balas: ¡tienes que sacar con vida al mayor número de rehenes posible!
<br><br>
El juego cuenta con diferentes finales (¡y recompensas económicas para las tropas!) dependiendo de cuántos rehenes hayas conseguido rescatar. ¿Quedará satisfecho con tu actuación el presidente de los Estados Unidos? ¡Coge las armas para comprobarlo!
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146444F50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146444F50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">OPERATION WOLF<sup>TM</sup></span></div>
</div>
