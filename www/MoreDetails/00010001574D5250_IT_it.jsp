...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574D5250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pneumatici che fischiano, odore di gomma bruciata, scariche d'adrenalina e nemici che mangiano la polvere: queste sono le emozioni per cui vivono i veri piloti. Tuttavia, il mondo di Monochrome Racing offre qualcosa in più: la passione per il colore! In un mondo in cui ogni cosa è in bianco e nero, il colore è tutto. Esso è la tua benzina, la tua velocità, ti rende più forte e ti fa diventare il leader assoluto del mondo di Monochrome Racing.<br>
- Più di 80 piste da completare <br>
- Più di 10 auto da scegliere e potenziare <br>
- Numerosi potenziamenti e bonus che rendono il tuo veicolo più forte e i tuoi nemici più deboli<br>
- Immergiti nel misterioso mondo monocolore!
