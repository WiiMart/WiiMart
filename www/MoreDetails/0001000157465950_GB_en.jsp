...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157465950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A collection of classic family pen and paper game favourites. Timeless favourites for all the family.<br><br>

THE GAMES<br>
• Squares (Dots)<br>
• Nine Men’s Morris (Mills)<br>
• Safe Cracker<br>
• Matchsticks<br>
...
KEY FEATURES<br>
• Includes 8 super addictive classic games<br>
• Numerous rule sets & game variations – so many ways to play!<br>
• Fun for all the family - up to 4 players can compete in Tournament mode<br>
