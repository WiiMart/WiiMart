...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Una batalla galáctica comienza! El Imperio BYDO de mutantes extraterrestres ha regresado con malvadas intenciones y extraordinario poder. Ahora el malvado imperio está preparado para lanzar un nuevo ataque sobre la Tierra. Sólo el revolucionario R-9, la forma de defensa más avanzada del planeta, se encuentra entre estos monstruos y la perdición. Lucha a través de siete etapas desafiantes – recolectando objetos especiales mientras avanzas – en tu camino hacia el jefe de cada etapa. ¿Es el Imperio BYDO invencible? Necesitarás rápidos reflejos, movimientos intutitivos ¡y una gran dosis de suerte cósmica para mantenerte! Mejor prepárate, ¡porque los mutantes están listos para ti!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A425945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A425945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SUPER R-TYPE<sup>&reg;</sup></span></div>
</div>
