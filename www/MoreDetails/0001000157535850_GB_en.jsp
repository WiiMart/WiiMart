...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157535850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">GAME OVERVIEW
<br>
Stunt Cars takes place on elevated race tracks, with very little to stop the player from accidentally driving off the side. Turbo can be used to make a car go faster, but it can only be used for a limited amount of time in each race.
<br>
...
<br>
-   Race achievement awards – 12 to win, including Gold Hero, Track Warrior, Stopwatch Pro, Stunt Champion</div>
  <div id="image02">
