...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo puzzle game è stato pubblicato nel 1997 da Data East.
<br><br>
Controllando il clown, il giocatore deve attirare le sfere che scendono dall’alto dello schermo e rilanciarle in modo da allineare più sfere dello stesso colore. Quando tre sfere dello stesso colore sono allineate verticalmente, scompaiono.
<br><br>
Con il passar del tempo le sfere scendono dall'alto verso il clown, avvicinandosi sempre più. Se riescono a schiacciarlo, sarà game over! All’inizio è importante muoversi rapidamente e con precisione, puntando a eliminare le sfere giuste. Acquisita una certa dimestichezza, si potrà poi mirare a sfruttare l’effetto delle reazioni a catena! Le regole di base sono le stesse del titolo precedente, ma questo terzo titolo della serie conta ben 16 personaggi e la nuova modalità Magical Journey Mode. Questa offre un'esperienza di gioco ancora più intensa e immerge il giocatore nel fantastico mondo di MAGICAL DROP.
<br><br>Il testo all’interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MAGICAL DROP Ⅲ</span></div>
</div>
