...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気アクションゲーム「ロックマン」シリーズの第三弾です。ロックマンに二度も敗北したＤｒ．ワイリーはついに改心し、ライト博士とともに世界平和のための巨大ロボット“ガンマ”の開発に携わっていました。ところが、完成も間近と迫ったある日、８つの未知の惑星に派遣していたロボットたちが突如として暴走を始めます。各地で暴れまわるロボットを倒し混乱を鎮めるため、事件の真相を探るため、新登場の頼れる相棒“ラッシュ”を引き連れて、ロックマンは宇宙へと飛び立ちます。さらに本作より新アクションの「スライディング」が導入されたほか、ロックマンの兄である“ブルース”が登場します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン<sup>&reg;</sup>３</span></div>
</div>
