...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Street Gangs is the updated European version of the highly-acclaimed Japanese game, Downtown Nekketsu Monogatari, which was originally published on the NES. Downtown Nekketsu Monogatari was a cross-over between a beat-em-up and a role-playing game.
<br><br>
Street Gangs is the story of two friends, Alex and Ryan. The main storyline is to save Cyndi, Ryan's girlfriend, who has been kidnapped by a gang of bad guys. The game uses a side-scrolling fighting style, featuring various different techniques and many weapons. It also has role-playing components to it, as the player will be required to acquire items as well as developing and tracking the stats for their characters. Exploring River City to rescue Cyndi, Alex and Ryan will face the many gangs of the city - and each gang has its own territory and style.
<br><br>
Street Gangs offers a single player mode and a co-operative mode for 2 players.<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
