...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157575450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les jeux rétro classiques peuvent évoluer et devenir des jeux de nouvelle génération. BurgerTime World Tour est une variante aboutie du jeu d'arcade classique avec un environnement cylindrique en 3D et un système de jeu évolué. 
<br><br>
L'axe de rotation vous permet de visualiser le niveau en cylindre et d’élaborer de  nouvelles stratégies pour terminer le plus rapidement un burger. Peter Pepper peut maintenant balancer les ennemis. Il est donc plus facile de les faire tomber sur un morceau de burger pour remporter beaucoup de points bonus.  
<br><br>
Avec des éléments de plateforme redoutables, des chefs et plus de 20 niveaux, ce nouveau BurgerTime vous mettra l'eau à la bouche. Découvrez la touche originale de BurgerTime dans un monde en 3D. Échappez aux légumes et découvrez BurgerTime World dès aujourd'hui !
