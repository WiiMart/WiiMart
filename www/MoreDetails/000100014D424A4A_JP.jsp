...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">名作アクションゲーム『魔界村』のシリーズ第二弾。魔王を倒して３年後、復活した魔界の手の者により命を奪われたプリンセスのため、再び騎士「アーサー」の戦いが始まります。上撃ち、下撃ちという新たなアクションが加わったほか、黄金に輝くヨロイを身にまとうことで６種類の武器に応じたさまざまな魔法を使うことができるなど、大幅にパワーアップ。どんなに強力なヨロイを装備しても、敵からダメージを受ければ、あわれアーサーはパンツ１枚の姿に。もう一度ダメージを受けるとミスとなってしまいます。死神のさまよう処刑場や腐食した村を進み、塔や山を越え森を抜け、魔王の待つ魔城へ。アーサーの冒険は続きます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
