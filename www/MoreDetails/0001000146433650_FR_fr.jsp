...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mike Jones est un garçon ordinaire qui se retrouve embarqué dans une incroyable aventure! Invité par son oncle archéologue sur une île tropicale, il ne tarde pas à comprendre que celui-ci s'est fait kidnapper. Mike se jure alors de le retrouver et de percer les mystères qui se cachent derrière le décor paradisiaque.
<br><br>
StarTropics vous propose deux phases de jeu. Dans les niveaux d'exploration, visitez l'île avec Mike à pied ou dans le sous-marin de son oncle. Dans les niveaux de combat, traversez des grottes remplies de monstres en vous aidant de toute une panoplie d'armes et d'objets.
<br><br>
A sa sortie, StarTropics était accompagné d'une lettre de l'oncle de Mike lui permettant de progresser dans son enquête. Dans cette version pour la console virtuelle, vous trouverez cette lettre dans le mode d'emploi du jeu, accessible depuis le menu HOME.<br><br>Texte écran en anglais.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
