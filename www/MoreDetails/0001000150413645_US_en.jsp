...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Enter alone, deep into enemy territory to rescue the kidnapped President in this overhead-view action shooter. Take on the role of a commando in a Special Forces team and face your enemies with an onslaught of weapons, including machine guns and grenades. Earn valuable information, weapons, and items by rescuing POWs. Fight your way to the end of each stage and defeat the boss by effectively using your weapons and equipment.
<p>
This port of the insanely popular arcade game features refined graphics, story, and cut-scenes, making this action game a must-have. This new and enhanced version includes the never-been-told second half of the story that was left out of the arcade version.</div>
  <div id="image02">
