...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８８年にリリースされたパズルゲームです。プレイヤーは特定のルールに従って、画面内に積まれた１４４枚の麻雀牌の中から同じ絵柄を２枚１組で取り、最終的にすべて取ることが目標となります。麻雀牌は上に他の牌が乗っておらず、右左どちらかが空いているもののみ取れるというルールになっており、取る順番を間違えると手詰まりになってしまいます。ヘルプ機能は１ステージに付き３回まで使用可能となっています。無事すべての牌を取ることができれば龍の祝福画面が表示されます。<BR><BR>詳細は、<Center>http://www.vc-arcade.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">上海</span></div>
</div>
