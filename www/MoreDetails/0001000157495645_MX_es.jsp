...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157495645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Los Invasores del espacio han vuelto y ahora quieren la revancha! Toma el control de un ovni y véngate de esos humanos arrasándolos con tus tropas de heroicos invasores y destruyendo sus tanquecillos débiles, sus aviones y toda su artillería. ¡Pero no bajes la guardia cuando te enfrentes al enorme jefe que te espera al final de cada fase! ¡Utiliza los cinco ataques diferentes de tus invasores y el ataque supremo de la nave nodriza para obtener las puntuaciones más altas y registrarlas a través de la Conexión Wi-Fi de Nintendo para ver quién es el mejor del mundo!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157495645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157495645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SPACE INVADERS GET EVEN</span></div>
</div>
