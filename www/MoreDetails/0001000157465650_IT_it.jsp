...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157465650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il calcio controllo ritorna nel tuo Nintendo Wii!
<br><br>
Football Up! è un divertente gioco del calcio nel quale avrai un controllo totale di ogni azione dei tuoi giocatori: controlla la palla, dribla e tira dando alla palla la possibilità di battere il portiere avversario! 
<br><br>
La palla è in movimento libero. Dimostra la tua abilità nel controllarla e fai passaggi corti, lunghi e tiri in porta. Puoi controllare l'altezza, l'effetto e la forza del tiro. 
Trasformati in un maestro di calcio controllo e fai gol per la squadra! 
<br><br>
Ogni paese partecipante è rappresentato dalla propria squadra nazionale. Con l'editor integrato potrai creare la tua squadra, darle il nome che preferisci, scegliere il colore della divisa e, addirittura giocare con i Mii che hai creato prima nel Canale Mii del tuo Nintendo Wii.
<br><br>
- Controllo della palla realistico, la palla è in movimento libero e dovrai imparare a controllarla <br>
- Controllo totale di altezza, direzione ed effetto in ogni passaggio e tiro in porta che fai <br>
- Gioca la Coppa del mondo! <br>
- Opzione multiplayer locale per un massimo di quattro giocatori, in cooperazione o competizione 
<br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157465650/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157465650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Football Up</span></div>
</div>
