...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158484F50')", "wiiSelectSound()");
...
<br><br>
Attrapez votre télécommande Wii et construisez un tas équilibré dans ce casse-tête basé sur les lois de la physique !
<br><br>
Les jeux de casse-tête doivent être prenants. C'était notre priorité numéro 1 durant le développement de ce jeu. Testez vos capacités et votre imagination dans les 100 niveaux de ce titre aussi simple que passionnant !
<br><br>
Jouez en solo ou en équipe avec une deuxième télécommande Wii. Il y a même un mode "versus" sur écran partagé, pour encore plus de fun !<br><br>Texte écran en français.</div>
  <div id="image02">
