...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157434C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fallen off a cliff? Burning in lava? Just had your latest invention crushed by a frozen polar bear? Avoid all this with Doc Clock's amazing Time Slider. Enjoy the first Doc Clock time-travelling adventure! Invent almost anything out of everything you find, from catapults to incredible flying machines. Travel through time as Doc Clock battles mad, misguided robots to save his beloved cat and invent the perfect toasted sandwich machine.</div>
  <div id="image02">
