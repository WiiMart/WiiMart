...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Het is weer tijd voor een klassieker van toen! Op de Virtual Console kun je opnieuw het originele vervolg van het bestverkopende videospel uit de geschiedenis beleven!
<br><br>
Super Mario Bros.: The Lost Levels, oorspronkelijk alleen beschikbaar voor het Famicom Disk System in Japan, borduurt verder op zijn voorganger met uitdagende, nieuw ontworpen levels, nog lastigere tegenstanders en obstakels en een heleboel verborgen werelden die je kunt ontdekken!
<br><br>
Let op: deze versie voor de Virtual Console was aanvankelijk slechts beperkt beschikbaar tijdens een vorig Hanabi Festival. Nu is hij echter permanent verkrijgbaar, zodat iedereen er van kan genieten!
<br><br>Het spel is voorzien van Engelse schermteksten.
<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014642324C/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642324C/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Mario Bros.<sup>TM</sup>:</span></div>
</div>
