...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574C5050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LONPOS ist ein leicht verständliches und dennoch kniffliges Puzzle-Spiel, das deine Logik und Konzentration auf die Prüfung stellt. Spiele allein oder gegen deine Mitspieler. Das Ziel ist, ein Spielbrett mit unterschiedlich geformten Bausteinen komplett auszufüllen, indem du sie mit der Wii-Fernbedienung drehst und verschiebst.
<br><br>
Im normalen Modus kämpfst du gegen die Uhr und versuchst, so schnell wie möglich Puzzles zu lösen, um Punkte zu gewinnen. Im fortlaufenden Modus hingegen bedeutet ein falsch gesetzter Baustein bereits das Aus. Im Mehrspielermodus wechselst du dich mit deinem Freund bei dem Platzieren der Bausteine ab und im Wettkampfmodus trittst du gegen bis zu drei Mitspieler an.
<br><br>
LONPOS wird dich und deine grauen Zellen lange Zeit auf Trab halten.
<br><br>
