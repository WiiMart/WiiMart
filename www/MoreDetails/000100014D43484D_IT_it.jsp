...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Per la sua azione frenetica ed emozionante, MUSHA è una pietra miliare tra gli sparatutto a scorrimento verticale.
<br><br>
Il giocatore controlla Terri, una ragazza che pilota un M.U.S.H.A. (Metallic Uniframe Super Hybrid Armour). L'obiettivo di Terri è quello di eliminare Dire 51, un Intellicomputer sfuggito a ogni controllo e in procinto di scagliare un attacco offensivo contro l'umanità.
<br><br>
Usa le armi speciali come il Vanishing Buster, il Blazing Beam e il Defensive Detonator per sconfiggere i nemici! Scegli tra 6 diverse configurazioni d'attacco e vola attraverso 7 esaltanti livelli per raggiungere Dire 51 e distruggerlo una volta per tutte!
<br><br>
