...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Infíltrate en solitario, en lo más profundo del territorio enemigo para rescatar al Presidente secuestrado en este juego de disparos en vista aérea. Ponte en el papel de un comando en un equipo de las Fuerzas Especiales y enfréntate a tus enemigos con un gran arsenal de armas, que incluye ametralladoras y granadas. Consigue información valiosa, armas y objetos rescatando a los prisioneros de guerra. Ábrete paso hasta el final de cada fase y derrota al jefe utilizando de forma eficaz tus armas y equipamiento.
<br><br>
Esta conversión del increíblemente popular juego de recreativa tiene unos gráficos, historia y secuencias de animación mejorados, haciendo que este juego de acción sea totalmente indispensable. Esta nueva versión incluye la segunda mitad de la historia que no se incluyó en la versión de recreativa.
