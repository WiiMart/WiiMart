...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Released in 1996, THE PATH OF THE WARRIOR ART OF FIGHTING 3 is a fighting game set in Grasshill Valley, where drama and battles unfold among various fighters. Aside from the protagonists Ryo and Robert, this installment has all-new characters. THE PATH OF THE WARRIOR ART OF FIGHTING 3 features powerful airborne combos, more efficient parrying maneuvers, the ability to inflict damage to downed opponents, and the Ultimate K.O., which allows characters to win a match in just one round. Furthermore, the graphics are based off of motion capture technology rendering them smoother than ever before, making it one of the most innovative 2D fighting games at the time.
<p>(Content available in English and Spanish only.)</div>
  <div id="image02">
