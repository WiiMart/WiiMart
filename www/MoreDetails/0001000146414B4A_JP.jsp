...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アクションと謎解き要素がふんだんに盛り込まれた、アクションアドベンチャーの原点ともいえる『ゼルダ』シリーズの第一作。大魔王ガノンに占領された王国の平和とゼルダ姫を取り戻すため、主人公リンクが８つに分かれた「トライフォース」のカケラを探して冒険するアクションアドベンチャー。クリア後は、より難易度の高い裏ゼルダも遊べる。ファミリーコンピュータディスクシステムの第一弾ソフトとして発売された。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゼルダの伝説<sup>&reg;</sup></span></div>
</div>
