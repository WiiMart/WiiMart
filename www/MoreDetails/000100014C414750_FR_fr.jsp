...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Recréé à partir de la version originale sur SEGA MEGA DRIVE, Sonic The Hedgehog fut le premier jeu Sonic sur SEGA MASTER SYSTEM, avec des niveaux et des boss inédits, de nouvelles zones et une carte des niveaux. Vous vous souvenez sûrement que dans cette version, les Chaos Emeralds étaient dissimulées dans certains niveaux et non plus dans les étapes spéciales.
<br><br>
Foncez à travers 6 Zones, exclusivement disponibles sur SEGA MASTER SYSTEM, et affrontez le Dr. Eggman (alias Dr. Robotnik) au terme de chacune des Zones!<br><br>Texte écran en anglais.</div>
  <div id="image02">
