...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">危険なワナに守られた遺跡を探検し秘宝を探し出す、アドベンチャー気分いっぱいのアクションゲームです。伝説の冒険家「ピットフォール・ハリー」の息子「ハリー・ジュニア」となって、古代マヤの邪神ザケルアに囚われた父親とマヤの秘宝を求め、遺跡の中を縦横無尽に冒険します。ジャングルや廃坑、神殿といったさまざまなステージで、ヘビやコウモリやワニなどの猛獣や、ガイコツ兵士のようなさまざまな敵に対し、ムチのような攻撃も可能な必殺のパチンコやブーメランを使って戦いを挑みます。海外で根強い人気を持つシリーズの１作です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pitfall - The Mayan Adventure<sup>&reg;</sup></span></div>
</div>
