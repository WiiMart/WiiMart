...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157535545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Estás a punto de tomar parte en una batalla por el futuro de un mundo dominado por la ley de la selva. A medida que vayas subiendo de nivel, tu personaje evolucionará, y tus armas y habilidades de disparo cambiarán. Al principio, empezarás con armas arrojadizas, y luego pasarás a utilizar diferentes armas de proyectiles. También hay disponible un modo cooperativo de 2 jugadores. Los controles son muy simples. Mueve tu personaje con la palanca de control y el punto de mira con el mando de Wii, y dispara a los objetivos mientras esquivas los ataques enemigos. Si eres alcanzado por una bala o tocado por un enemigo contará como una herida. Cada herida te hará perder un corazón del contador de la parte inferior de la pantalla y la partida finalizará cuando pierdas todos los corazones.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157535545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157535545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Shootanto: Evolutionary Mayhem</span></div>
</div>
