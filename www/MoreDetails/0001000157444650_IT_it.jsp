...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157444650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Preparati a difendere il tuo castello dall'invasione dell'inarrestabile esercito dei pastelli colorati!
<br><br>
Per evitare che gli invasori distruggano il tuo prezioso castello, puntagli contro il telecomando Wii e afferrali tenendo premuto il pulsante A (o il pulsante B). Ora che hai il nemico in pugno, puoi scagliarlo in cielo, muovendo velocemente il telecomando Wii verso l'alto e rilasciando il pulsante.
<br><br>
Alcuni nemici sono troppo pesanti da prendere e per sconfiggerli è necessario adottare una tattica diversa.
<br><br>
Defend Your Castle si può giocare sia in modalità cooperativa che competitiva. Possono partecipare fino a 4 persone. I giocatori possono unirsi al gioco o lasciarlo, in qualsiasi momento. Per iniziare a giocare, è sufficiente attivare un altro telecomando Wii. Il gioco sceglierà automaticamente il livello di difficoltà, adattandolo al nuovo giocatore.
<br><br>
