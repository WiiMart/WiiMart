...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157505050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Avec Family Table Tennis, lancez-vous dans la simulation de ping-pong la plus amusante qui soit !

Son système de commande intuitif et stimulant tiendra toute votre famille en haleine dans des parties de ping-pong acharnées.

Maîtrisez le système de commande et les attaques spéciales pour réussir des coups spectaculaires !
<br><br>  
Deux modes de jeu : Solo et Duel pour un ou deux joueurs.

Trois mini-jeux exclusifs vous permettront d'affiner vos réflexes.

Choisissez un profil de personnage parmi quatre.
<br><br>
Vous pouvez même participer au tournoi le plus incroyable jamais organisé. <br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505050/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505050/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
