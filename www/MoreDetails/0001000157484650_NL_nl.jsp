...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157484650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Word lid van een elite militaire eenheid in Heavy Fire: Special Operations, een arcade schietpartij voor WiiWare. Neem deel aan uitdagende missies in het Midden-Oosten vechtend op grond, op een pantserwagen of uit een helicopter. Je gaat een snel afvurende vinger nodig hebben om deze extreem gevaarlijke missies te beëindigen.<br><br>
Verkrijg nieuwe militaire rangen en nieuwe, meer sterke wapens, die zich door eigenschappen en functies onderscheiden. Herhaal missies om je beste resultaat te verbeteren, die je in een wereldranking kan plaatsen. Maak combos en vernietig de omgevingselementen om meer punten te verkrijgen.<br><br>
Je kunt je vijanden elimineren in een één-speler mode of gebruik maken van de extra vuurkracht van je vriend in de multispeler mode! Wii Zapper is behulpzaam, maar niet verplicht.
<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157484650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157484650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Heavy Fire: </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Special Operations</span></div>
  </div>
