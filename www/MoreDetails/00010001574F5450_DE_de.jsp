...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574F5450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Overturn Mecha Wars ist ein Kampfturnier, in dem die Spieler futuristische, bis an die Zähne mit Hightech-Waffen ausgerüstete Mechs steuern.
<br>
Das Ziel des Spiels ist es, den Gegner wegzublasen und gleichzeitig Angriffen auszuweichen, um am Ende als Letzter noch zu stehen.
<br>
Die Spieler können jede der acht Maschinen konfigurieren und aus einer großen Auswahl an Spezialwaffen auswählen, während sie sich Runde für Runde durch das Turnier kämpfen. 
<br>
Das Spiel kann alleine oder zu zweit mit geteiltem Bildschirm gespielt werden.
<br>
Die Spieler können ihre Mechs auch mit dem Wii Balance Board steuern, indem sie ihr Gewicht verlagern!
<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F5450/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F5450/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
