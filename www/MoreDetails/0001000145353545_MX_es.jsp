...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prueba el juego recreativo de Capcom, que generó un gran número de copias, cuando el Commando original llegue a tu salón gracias a la Virtual Console Arcade. Hazte con el control de Super Joe y dispara (en ocho direcciones) para abrirte paso por el territorio enemigo, usando granadas para sembrar el caos en los emplazamientos enemigos de este influyente creador de género.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145353545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145353545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
