...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753554A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Wiiリモコンの特徴を活かしたシンプルでいて奥深いシューティングゲームで、人類の未来を賭けた戦いに挑みます。今回は「過去編」です。ステージが進むとキャラクターも進化してゆき、武器や射撃性能が変化します。2人同時プレイ可能、さらにスコアランキングで、ご家族やお友達と協力したり競い合うことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753554A/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753554A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SHOOTANTO ～過去編～</span></div>
</div>
