...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Hilf Mario und Luigi, alle Feinde aufs Kreuz zu legen, und erlebe ein authentisches Arcade-Abenteuer, das den Auftakt der beliebtesten Videospielserie aller Zeiten darstellt. Die Regeln sind einfach: Erledige so viele Gegner wie möglich und sammle Münzen, ohne getroffen zu werden. Wie der Titel Mario Bros.™ schon ahnen lässt, mischt hier auch erstmals Marios Bruder Luigi mit und stürzt sich im Zweispielermodus ins Getümmel. Auch weitere Grundelemente der Serie werden in diesem Titel eingeführt: Mario ist nun Klempner (anstatt eines Zimmermanns wie in Donkey Kong™), kämpft gegen schildkrötenähnliche Gegner und sammelt Münzen in Bonusleveln ein. Aber Vorsicht: Im Gegensatz zu späteren Episoden der Serie kann Mario hier seine Gegner noch nicht direkt durch seinen patentierten Kopfsprung ausschalten – zuerst muss er eine Möglichkeit finden, sie wehrlos zu machen... <br><br>Englischer Bildschirmtext.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
