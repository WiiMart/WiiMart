...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este vídeo juego de pelea, lanzado en 1992, comenzó la historia de la familia Sakazaki y Robert Garcia, la cual continúa después en otras dos versiones. Yuri Sakazaki ha sido secuestrada por Mr. Big para castigar a su padre, Takuma y su hermano, Ryo. Para rescatarla, Ryo y Robert deben enfrentar a numerosos enemigos alrededor de South Town y eventualmente encontrar al misterioso Mr. Karate. La pasión de los creadores del juego se hace evidente a través de los originales elementos que han introducido en su dinámica. Estos incluyen un medidor de energía que se vacía cada vez que un peleador usa una maniobra especial, Desperation Attacks que se pueden usar sólo cuando la salud de un peleador está baja y acercamiento de cámara que se ajusta instantáneamente mientras los peleadores se mueven alrededor del escenario. Todas estas características garantizan que los jugadores usarán estrategias y tácticas en vez de simplemente oprimir botones. Además, hay pequeños retoques, tales como personajes que muestran cortadas cuando sufren heridas y grabaciones de voz durante las escenas. ¿Puedes perfeccionar el arte de la pelea y salvar a Yuri?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ART OF FIGHTING</span></div>
</div>
