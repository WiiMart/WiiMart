...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157554950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mit "Lernerfolg Grundschule Mathematik Klasse 1" können Erstklässlerinnen und Erstklässler zusammen mit dem kleinen Vampir Freddy spannende Matheaufgaben lösen und dabei spielerisch Mathe lernen. Der kleine Vampir Freddy motiviert dabei die Kinder und steht ihnen mit Tipps zur Seite. So wird ein Lernen ohne Leistungsdruck ermöglicht. 
<br><br>
...
Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554950/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554950/FFFD0011" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
