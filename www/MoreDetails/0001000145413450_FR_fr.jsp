...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paru en 1995, ce jeu de combat est le troisième opus de la saga Samurai Shodown, bien que l'histoire se situe entre le premier et le deuxième. 
<br><br>
Incarnez l'un des 12 samouraïs proposés et terrassez Zankuro Minazuki!
<br>En plus de légères améliorations, telles que la possibilité de remplir votre jauge de furie en appuyant sur certains boutons ou la capacité de parer les coups dans les airs, SAMURAI SHODOWN III vous permet de choisir la version "slash" ou "bust" d'un même guerrier. Chacune de ces personnalités propose des coups spéciaux uniques, multipliant par deux le nombre de personnages jouables. En garde!
<br><br>
La langue du texte peut être choisie entre anglais, espagnol, portugais, japonais et coréen.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
