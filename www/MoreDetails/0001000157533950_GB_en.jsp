...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157533950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Now’s your chance to play the brain-busting puzzle game taking the world by storm.<br><br>  With over 100,000,000 Sudoku puzzles, you’ll never see the same puzzle twice in Sudoku Challenge!  You can select the classic nine-by-nine Sukodu gameboards as well as Grand Sudoku which challenges you to complete five intersecting Sudoku boards simultaneously!  Just a beginner? Don’t worry – With three difficulty options, even the most novice player can complete a Sudoku with ease. But if you’re a seasoned pro, challenge yourself in ‘Expert’ mode and test your true skills. <br><br>It’s time to get your thinking cap on and see how many Sudoku puzzles you can conquer!</div>
  <div id="image02">
