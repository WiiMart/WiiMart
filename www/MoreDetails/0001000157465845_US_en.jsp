...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157465845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">We all long for a cozy open fire, particularly during the cold season, but not everyone is able to snuggle in front of a warming blaze. The WiiWare service opens the door for a fireplace to fill the room with a magical and cozy atmosphere!
<p>
Select from a variety of logs and use the Wii Remote controller to stack them up. Now, light a virtual match and your home will soon be snug and glowing. There are 6 fireplaces available: fire alone, campfire and rustic, classic, elegant and Zen fireplaces.
...
<br><br>
- 6 types of fire: fire alone, campfire, rustic, classic, elegant and Zen fireplaces<br>
- Cozy, fireside sounds<br>
- Realistic physics simulation with PhysX® by NVIDIA Technology<br>
- 4 game functions: Butler (logs are placed on the fire automatically), Non-stop (logs never burn down), Standard (a ready-made fire in any fireplace), Individual (players select the logs and put them in the fireplace) 
<p>
