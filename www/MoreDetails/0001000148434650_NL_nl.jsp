...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000148434650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Met het Wii Speak-kanaal en het Wii Speak-accessoire kunnen tot vier Wii-systemen via de Nintendo Wi-Fi Connection met elkaar verbinding maken, zodat je met vrienden van over de hele wereld kunt praten!
<br><br>
Gebruik je eigen Mii-personages, die je in het Mii-personagekanaal hebt gemaakt, om jou tijdens de gesprekken te vertegenwoordigen. Deze bewegen hun lippen synchroon met het door de microfoon opgepikte geluid. Verras je vrienden door met een druk op de knop je stem te veranderen! Bovendien kunnen jullie elkaar tijdens een gesprek foto’s laten zien die op een SD-kaart of op het Wii-prikbord staan, en gesproken boodschappen vergezeld van een foto naar Wii-vrienden sturen.
<br><br>
Opmerking: als je in het Wii Speak-kanaal akkoord gaat met het delen van gegevens, kunnen geselecteerde Wii-vrienden je online status bekijken, inclusief met wie je aan het praten bent. Als je wordt toegevoegd aan een gesprek dat een Wii-vriend met zijn of haar vrienden voert, kunnen jullie elkaars Mii-personages en bijnamen zien, ook al hebben jullie elkaar niet als Wii-vriend geregistreerd. Je kunt het delen van gegevens te allen tijde uitschakelen. Lees de handleiding voor meer informatie.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434650/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434650/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii Speak<sup>TM</sup>-kanaal</span></div>
</div>
