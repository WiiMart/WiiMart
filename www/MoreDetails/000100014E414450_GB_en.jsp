...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Andross has launched an all-out attack on the Lylat System, and only Fox McCloud and the Star Fox team stand in his way. Jump into your Arwing fighter, Landmaster tank or Blue Marine sub, and blast Andross’s forces into atoms!
<br><br>
...
<br><br>
Lylat Wars also features a VS. mode for up to four players to battle it out in three thrilling game types: Point Match, Battle Royal and Time Trial.
<br><br>Original Rumble Pak functionality not available.</div>
  <div id="image02">
