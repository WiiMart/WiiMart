...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">迫り来る敵を撃破しながら、３Ｄ空間を前へと突き進むアクションシューティングゲームです。近未来の日本、人類が創造した新種生命体の中から人類を襲う攻撃体「ルフィアン」が突如出現。ルフィアンを狩る主人公の少年サキ・アマミヤは、戦いを繰り広げるうちにやがて事態の核心に近づいていきます。キャラクターと照準を別々にコントロールする、独特の操作方法が特徴。現れる敵をかわして倒しながら前方へ進む通常ステージのほか、高速で変化する空中戦をはじめとした多彩なステージが登場します。シューティングゲームに定評のあるトレジャーが開発を担当した手ごたえのあるゲーム性や、世紀末的な深い世界観とともに、ニンテンドウ６４ならではの個性的なソフトとして話題を呼びました。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">罪と罰</span></div>
</div>
