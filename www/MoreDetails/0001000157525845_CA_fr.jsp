...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157525845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Thanks to the support of all the fans, we at Capcom are proud to announce the release of Mega Man 10! Now fans of all ages can enjoy the newest entry into this historic 8-bit franchise. As a special service to new players, we added an Easy Mode - a first for a classic Mega Man game! This new feature means that new and long-time fans alike can all have a shot at making it to the end of a Mega Man game. We will also have some special treats in store for all the fans. This time you can play as Proto Man and try out Time Attack Mode from the beginning. You can also watch playthrough videos from players all over the world. We will also have some additional content available for the hardcore Mega Man fans. With Mega Man 10, we are pleased to present you with the next adventure in the continuing journeys of the iconic Blue Bomber!</div>
  <div id="image02">
