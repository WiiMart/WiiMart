...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">配信中の名作ピンボールゲーム「エイリアンクラッシュ」の続編。「デビルシューター」でボールを弾き、左右のフリッパーや台ゆらし機能を駆使して得点を積み重ねていきます。プレイ中に一定の条件を満たせば、全６種類のボーナスステージにチャレンジすることができ、それぞれでパーフェクトクリアを達成すれば、さらなる高得点の獲得も可能です。ステージは上・中・下の３段構成。より滑らかになったボールの動きや強化された随所の演出とともに、ますますエキサイティングなプレイが楽しめます。「骸骨騎士」や「魔導師」といったゴシックホラーテイストのキャラクターたちが、画面上を所せましと徘徊。中段画面に配置された「大顔面」は、ボールを当てる度に女神から蛇へと徐々に形相が変化し、ダークな雰囲気を一層盛り上げてくれます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">デビルクラッシュ</span></div>
</div>
