...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公「ディグダグ」を操作し、地中を上下左右に掘り進んでモンスターを倒していくアクションゲームです。ディグダグを追いかけてくる「プーカ」と気まぐれで深い地層を好む「ファイガー」、２種類のユーモラスな敵キャラクターに捕まらないように避けながら画面内の全ての敵を退治すればステージクリアです。敵はモリを刺してポンプで空気を送り込んでパンクさせるか、岩石を頭上に落として倒してください。深い地層で敵をやっつけたりファイガをヨコからパンクさせれば高得点。画面中央に出現するベジタブルターゲットはボーナス得点のチャンスです。さまざまなテクニックを駆使してハイスコアをめざしてください。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ディグダグ<sup>&reg;</sup></span></div>
</div>
