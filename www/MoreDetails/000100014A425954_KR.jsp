...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">버튼을 오래 누르는 것으로 파워를 모아서 쏠 수 있는 샷(파동포)이나 자유롭게 탈착이 가능한 무적 장비(포스)가 특징적인 횡 스크롤 게임으로, 치밀하고 독특한 그래픽이 화제를 블러 일으킨 슈팅 게임 R-TYPE 시리즈의 첫 번째 작품입니다. 일찌기 인간에 의해 보내어진 차원 전투기 「R-9」에 의해 전멸한 줄 알았던 베이드 제국이 그 후 다른 차원의 공간에서 급격한 변화를 거쳐 되살아나 있었던 것을 알게된 후 역습에 기세를 더하는 베이드 제국을 물리치기 위해 인류는 강화된 전투기 「신R-9」로 대항하게 됩니다. 최강의 무기 「포스」와 함께 5종류의 레이저 등 강화된 아이템을 총동원하여 7개의 모든 스테이지를 클리어해 보세요.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A425954/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A425954/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
