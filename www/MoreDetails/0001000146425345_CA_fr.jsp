...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">It is a world where music is the language of the people. An evil warlord from the north arrives and captures the castle. The princess is imprisoned deep within the castle, and the world’s musical instruments are taken and hidden away. Our hero, Milon, takes it upon himself to fight the warlord, rescue the princess, and recover the people’s musical instruments. He has only his wits and the magical Bubble to aid him on his quest. Help Milon along the way by looking for hidden doors, finding secret items, and defeating fierce enemies. Make sure to look for the shops inside the castle, where you can buy hints and valuable items. Whenever Milon finds a Music Box, he will be transported to a bonus stage. Each instrument you find will add a layer to the background music. Try to grab all seven instruments to create a performance worthy of a music-themed game!</div>
  <div id="image02">
