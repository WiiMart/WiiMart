...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574D3450')", "wiiSelectSound()");
...
Je kunt nu herrie gaan maken!<br><br>Het spel is voorzien van Engelse schermteksten.
<br/><br/>
De onlinefuncties van software die gebruik maken van WiiConnect24 zijn niet langer beschikbaar omdat een deel van de online diensten op het Wii-systeem op 28 juni 2013 is stopgezet.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3450/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3450/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
