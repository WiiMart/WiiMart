...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界征服をもくろむ謎の犯罪組織「Ｆｏｏｔ　Ｃｌａｎ」（フット・クラン）にさらわれた恩師スプリンターの一人娘エイプリルを助けるため、レオ、ラフ、マイク、ドンの４人の亀忍者が立ち向かうアクションゲームです。刀やヌンチャクなど異なる武器・能力を持った亀忍者を自由にセレクトし、敵にさらわれた仲間を助けたり、敵の破壊工作を阻止したりして、世界をフット・クランの魔の手から守るべく戦います。ライフが０になったり、敵のローラー車にひかれると、敵にとらわれたことになり、キャラクターチェンジとなります。４人全員がとらわれるか、時間制限のあるエリアで時間切れになるとゲームオーバーです。それぞれの亀忍者をうまくコントロールしながら、全６ステージをクリアしてください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">激亀忍者伝<sup>&reg;</sup></span></div>
</div>
