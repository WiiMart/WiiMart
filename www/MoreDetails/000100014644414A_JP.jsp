...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年に発売された洞窟探険アクションゲームです。断崖や落とし穴に落ちるとミスになる緊張感のあるゲーム性が当時話題となりました。プレイヤーは、不気味な幽霊、コウモリ、毒ガスや落とし穴のトラップといった様々な危険を乗り越えて、伝説の地底ピラミッドに眠る財宝を目指します。ジャンプと銃を使った基本アクションに加え、ダイナマイトやフラッシュ、トロッコ、ボートなどの様々なアイテムや仕掛けを駆使して洞窟に散らばる鍵を集めて次のエリアへ続く扉を開き、地底最深部に隠された財宝を探し出します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スペランカー<sup>TM</sup></span></div>
</div>
