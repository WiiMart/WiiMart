...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157454445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fight your way through 13 diverse locations on your own or with up to three friends in this frenetic and stylish side-scrolling action game. Play as Eduardo and his fellow toaster buddies as you fire an assortment of pastries at all kinds of dastardly food products. Hop onto laser-mounted scooters and fly across the screen in rocket packs, and learn to cooperate with your teammates or simply annoy each other in an awesomely fun way by throwing each other around the screen. The choice is up to you.</div>
  <div id="image02">
