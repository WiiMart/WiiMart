...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157485A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Planet Zethos ist unter die militärische Kontrolle von Thau-Phi gefallen, einer künstlichen Intelligenz, die ursprünglich zum Terraforming und zur Kolonialisierung des entfernten Planeten eingesetzt wurde. Deren absolute Kontrolle über alle automatisierten Systeme auf der Oberfläche schließt eine Legion Arbeitsroboter mit ein, die nun als unüberwindliche und selbstlose Armee dient, um den KI-Kern zu schützen.
<br><br>
Die einzige Hoffnung, den Planeten zu befreien, ohne einen hohen Preis zu Lasten der Konföderation zu bezahlen, ruht auf der Mannschaft der DST Horizon, einer Gruppe Elite-Söldner, die ihre hohen Kampfkünste an den Höchstbietenden verkaufen. Sie nehmen Jobs an, die für andere Söldner zu gefährlich und für die meisten Militärstreitkräfte zu illegal wären.
<br><br>
Horizon Riders ermöglicht es den Spielern, jedes der vier Mannschaftsmitglieder auf ihrer Mission zu steuern, Thau-Phi zu besiegen. Dabei rasen sie auf mächtigen Hoverboards mit Höchstgeschwindigkeit über die Oberfläche von Zethos, während sie die abtrünnige kybernetische Armee mit einem futuristischen Waffenarsenal vernichten.
