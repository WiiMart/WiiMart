...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157373450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mit Lernerfolg Grundschule Deutsch Klasse 4 können Viertklässlerinnen und Viertklässler spielerisch Deutsch lernen. Der kleine Vampir Freddy motiviert dabei die Kinder und steht ihnen mit Tipps zur Seite. So wird ein Lernen ohne Leistungsdruck ermöglicht. 
<br><br>
...
Sprachen: Deutsch, Englisch und Türkisch.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157373450/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157373450/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
