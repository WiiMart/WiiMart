...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mario et Luigi doivent se débarrasser de nombreuses créatures dans ce jeu d'arcade à la base de la franchise de jeu vidéo la plus populaire de tous les temps. Le but est de se débarrasser d'autant d'ennemis que possible et de ramasser des pièces sans se faire toucher. Comme son nom l'indique (Bros. signifie frères), Mario Bros.™ marque la première apparition de Luigi, le frère de Mario, lorsque deux joueurs jouent l'un contre l'autre. Le jeu introduit également d'autres éléments de la franchise. Notre héros est maintenant plombier (après avoir été charpentier dans Donkey Kong™), affronte des tortues et collecte des pièces dans des niveaux bonus. Mais faites cependant attention, il n'est pas encore possible de se débarrasser des ennemis en sautant directement dessus comme dans les épisodes suivants. Trouvez d'abord un moyen de les rendre inoffensifs. <br><br>Le texte à l'écran sera en anglais.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414650/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414650/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mario Bros.<sup>TM</sup></span></div>
</div>
