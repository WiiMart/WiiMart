...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157324950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to "FISHIE FISHIE", the only game that can be played with just one button.<br>
You're going to experience something extraordinary that will really test your reflexes.<br>
The game contains a series of tutorials that will teach you not only how to control your fishie, but also the various game modes.<br>
In "FISHIE FISHIE", you are a fish that has to eat all the time. You also have to finish several different game modes as quickly as possible. Every second counts.<br>
To win, you'll have to get through over a hundred levels spread over various game modes: “story”, “soccer”, “capture the star”, “survival”, “skill” and a large competition.<br>
You can play solo, or up to four people can play on the same screen. In co-op mode or every fishie for himself, it's no holds barred to win.</div>
  <div id="image02">
