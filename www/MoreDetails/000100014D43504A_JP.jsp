...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「サイバースーツ」で超人的な力を手に入れたミミズの「ジム」が、賞金稼ぎと戦いながらお姫様のもとへと向かうドタバタアクションゲームです。まるでテレビアニメを見ているかのような、なめらかな動きで展開するコミカルなアクションが特徴です。必殺のプラズマショットと、頭をムチのように繰り出すヘッドホイップ、頭を回転させて空中を移動するヘリコプターヘッドなどの技を駆使して、何が起こるかわからない、バラエティに富んだステージをクリアしていきます。海外で高い評価を得て数々の賞を受賞したタイトルです。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アースワームジム</span></div>
</div>
