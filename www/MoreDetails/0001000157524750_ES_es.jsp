...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157524750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rage of the Gladiator es un juego de lucha de fantasía en el que debes luchar por sobrevivir en el anfiteatro. ¡Demuestra lo que vales venciendo a todos los adversarios!<br><br>
...
- Ataques definitivos brutales: invoca un meteorito en llamas, un feroz tornado, ¡o transfórmate en un gigantesco coloso 10 veces mayor que tú!<br>
...
- Música épica: ¡disfruta de las emocionantes obras maestras del legendario compositor Sean Beeson!<br>
- Vuelve a jugar: completa el juego para desbloquear el modo Desafío, ¡en el que los adversarios son mucho más fuertes y tienen nuevas habilidades!<br>
