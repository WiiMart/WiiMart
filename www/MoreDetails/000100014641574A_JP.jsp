...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８３年にアーケードゲームで登場し、アイデアあふれるアクションで絶大な支持を得たスパイアクションゲームの傑作です。プレイヤーはスパイとなって屋上からビルへ忍び込み、ガードマン（敵）たちを倒して進みます。エレベーターを上下に移動しつつ敵を攻撃したり、ランプを射撃し暗闇に身を隠したりと、銃撃戦はスリル満点です。タイミング良くエレベーターを乗り継いで各階を移動し、全ての機密書類を盗み出し、地下駐車場から脱出するとステージクリアです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ELEVATOR ACTION<sup>&reg;</sup></span></div>
</div>
