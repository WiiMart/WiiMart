...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">横スクロールシューティングゲーム「スーパーダライアス」の続編で、アーケードゲームの移植作です。前作の死闘から数千年後。太陽系に逃れたダライアス人たちが、
再び「ベルサー軍団」の襲撃を受けＳＯＳを送ってきました。プレイヤーはパワーアップされた戦闘機「シルバーホーク」に乗り込み、同胞を救うため出撃します。今回の戦いは、太陽から木星までの７ラウンド・２８ゾーン。ゾーンクリア後の分岐点では、進行ルートの選択が可能で、どのルートを通ったかによってエンディングが変化するシステムです。各ゾーンに待ち受ける「魚型巨大戦艦」は、ラインナップが大幅に強化され、ゾーン毎に異なるボスとの対戦が実現しました。さらに、前作のボスたちも、それぞれが中ボスとして登場するなど、まさに集大成といえる豪華な内容となっています。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーダライアス２</span></div>
</div>
