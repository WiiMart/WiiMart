...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">風船で空中に浮かび上がり、敵の風船を割って倒していくアクションゲームです。Ａボタン連打またはＢボタンで上昇し、十字ボタン操作で飛行。高い位置から敵の風船を割ったり敵をふんだりするとやっつけられます。しかし空中では勢いがつくとなかなか止まれず、その独特のもどかしい操作感が大きな特徴です。地形にはねかえって敵に上を取られたり、行きすぎて雷などに当たらないよう気をつけてください。ゲームは、画面中の敵を倒してステージをクリアしていく通常モードと、横にスクロールしていくステージで雷をよけながら風船を割って進む「ＢＡＬＬＯＯＮ　ＴＲＩＰ」を搭載。通常モードは２人プレイにも対応、対戦するか協力するかは遊びかた次第です。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バルーンファイト<sup>&reg;</sup></span></div>
</div>
