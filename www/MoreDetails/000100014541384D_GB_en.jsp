...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Take control of a mighty warship alongside Iron Clad in this classic side-scrolling shoot 'em up! Bring the fight to the Iron Mask Republic and save the Kingdom of Chop by using a huge array of weaponry. Dish out a variety of melee attacks in close-range combat, nullify the enemy's attacks using your bomber, or combine with Iron Clad to deal even more damage! And when the dust has settled, go back and play through your favourite stages again, trying new weapon combinations and unlocking new endings!
<br><br>In-game text will include some Japanese.</div>
  <div id="image02">
