...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Malas noticias! Hay problemas en Moscú: ¡alguien ha desintegrado la catedral de San Basilio! Tan solo ha quedado un enorme montón de arena. El Jefe quiere a lo mejor de ACME en este caso. Dirígete cuanto antes de Moscú para averiguar qué está ocurriendo antes de que otros monumentos se conviertan en castillos de arena.
<p>
Carmen Sandiego y V.I.L.E. han vuelto y solo tú puedes desbaratar sus planes. Viaja por el mundo, resuelve acertijos matemáticos y atrapa al villano que desintegró la catedral. Resuelve el caso "Crumbling Cathedral" en el Story Mode (Modo de historia) para un jugador. Perfecciona tus habilidades matemáticas en el Practice Mode (Modo de práctica) para un jugador. Desafía a familiares y amigos a resolver acertijos contra reloj en Multiplayer Mode (Modo multijugador). Con Carmen Sandiego: Adventures in Math, tu destreza matemática será la mejor arma para luchar contra el crimen. Ideal para niños de 10-11 años. Los acertijos incluyen aritmética, lógica ¡y mucho más!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414B45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414B45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">The Crumbling Cathedral</span></div>
  </div>
