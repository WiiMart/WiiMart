...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495050')", "wiiSelectSound()");
...
<br><br>Bienvenido a Aprender con los PooYoos: el primer juego de agudeza mental para niños de 3 a 6 años.
<br><br>
Con los PooYoos, una alegre banda de adorables animalitos, tu hijo se divertirá y aprenderá elementos básicos para su desarrollo: números, letras, lateralización, formas, colores y más cosas. Los niños podrán bailar con sus nuevos amigos y conseguir montones de premios interactivos. Tiene dos niveles de interacción en los que los niños podrán realizar actividades basadas en los colores y la magia, sea cual sea su edad y nivel.
<br><br>
Este juego está diseñado para niños que aún no saben leer. <br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495050/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
