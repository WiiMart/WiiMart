...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001584A4845')", "wiiSelectSound()");
...
<p>
Paint Splash turns your TV into an interactive canvas where kids of all ages can enjoy painting using the Wii Remote. Up to four people can paint at the same time, so the entire family can participate in creating fantastic paintings. There are several tools and colors to choose from when you're painting. For the youngest members of the family it's also possible to paint in a dedicated Splash Mode where you simply shake the Wii Remote to splash paint on the screen.
<p>
If you have an SD card in your Wii console, you can save your paintings to the SD card so you can transfer them to your computer. You can then email your paintings to your friends or use them as desktop background.
<p>
