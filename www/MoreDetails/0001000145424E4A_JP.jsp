...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９５年にリリースされた格闘ゲームで、謎の男“獅子王”が開催する獣神武闘会を舞台に、１０人の格闘家が腕を競います。本作の登場キャラクターはブーメラン＋空手、斧＋プロレス、フリスビー＋サンボなど、武器＋格闘技という個性的なスタイルで戦う点が最大の特徴です。武器は近接戦闘では打撃用、遠距離では投擲(とうてき)用の武器として使用可能で、さらに各武器専用の必殺技も用意されています。他にも2ラインバトルによる奥行きのある戦い、ガードからの避け攻撃、投げ返し/殴り返し、一発逆転の超必殺技といった格闘ゲームファンを思わずニヤリとさせる要素も、しっかりと搭載しています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">風雲黙示録　～格闘創世～</span></div>
</div>
