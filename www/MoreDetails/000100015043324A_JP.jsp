...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">覆面パトカーで犯人の車に体当たりして逮捕する一風変わったレースゲーム。プレイヤーはニューヨークの犯罪撲滅特捜チーム「チェイスＨ．Ｑ．」の刑事コンビとして、覆面パトカーを操りながらステージ前半はカーチェイス、後半はカーアタックによるアクションに挑みます。ギアチェンジやステアリングを駆使してコーナーを切り抜けながら犯人車両を追跡し、体当たりを繰り返して逃走車を停止させるとステージクリアです。コース上の障害物や一般車を回避できなければスピードダウン。３回まで使用可能のターボを使うことで、走行スピードや体当たり時の破壊力をアップすることができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">タイトーCHASE H.Q.<sup>&reg;</sup></span></div>
</div>
