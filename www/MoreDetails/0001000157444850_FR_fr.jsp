...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157444850')", "wiiSelectSound()");
...
<br><br>
Art Style: Rotohex est un jeu de puzzle pour un ou deux joueurs. L'objectif est ici de placer rapidement les triangles de couleur qui tombent à l'écran en les faisant pivoter de façon à créer des hexagones de même couleur pour les faire disparaître. Plus le nombre de couleurs augmente, plus le défi est corsé ! 
<br><br>
Terminez le mode Solo pour débloquer de nouveaux modes tels que le mode Endless où vous pourrez tester votre endurance ou encore le mode Sprint réservé aux joueurs aguerris. Profitez du mode VS et mesurez-vous à un ami pour voir qui est le meilleur !
<br><br>
