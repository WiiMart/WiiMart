...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In the groundbreaking second instalment in SNK's wildly popular fighting game series, Terry, Andy and Joe reprise their roles from the first Fatal Fury, while another five distinctive challengers emerge to compete for the coveted championship title.
<br><br>
This game adds a novel dynamic to the health system - when a fighter's strength bar decreases to the point where it is blinking red, they can unleash a desperation technique. Giving you the power to turn the tide of the battle. The unique 2D plane format, a popular feature of the first game, has also been radically enhanced, allowing characters to jump freely between foreground and background, or force their opponent between planes. 
<br><br>
Revolutionary gameplay features, colourful graphics and an engaging soundtrack combine to make Fatal Fury 2 a must-have for any fighting gamer's collection! Are you ready to be the king of fighters? Get in the ring!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
