...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti à l’origine en 1999, il s’agit du sixième épisode de la série King of Fighters. Cette fois, un nouveau protagoniste avec une toute nouvelle histoire fait son apparition. Désormais, les équipes sont constituées de 4 combattants au lieu des 3 habituels. 3 combattent tandis que le 4ème joue le rôle de "Striker". Tout comme dans les épisodes précédents, vous pouvez libérer des Supers Coups Spéciaux, lorsque les jauges sont remplies. Toutefois, un nouveau type de jauge composée de 3 cases vous permet d’exécuter au choix le Mode Contre (qui augmente votre force offensive) ou le Mode Armure (qui augmente votre force défensive). Les tactiques à utiliser suivant la situation ont également été renforcées. 32 combattants jouables participent au King of Fighters 99. Pensez-vous avoir ce qu’il faut pour atteindre le sommet ? <br><br>Texte écran en anglais.</div>
  <div id="image02">
