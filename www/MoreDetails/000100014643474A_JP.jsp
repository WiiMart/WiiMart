...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">コミカルなキャラクタと複数人プレイが魅力のシューティングゲーム「ツインビー」シリーズの第１作目。宇宙や未来などが舞台となることが多かったシューティングゲームのなかにあって、食べ物や食器などをモチーフにしたコミカルなキャラや世界観が人気を博しました。プレイヤーはツインビー（２人プレイ時はウインビー）を操作し、空中の敵はショット、地上の敵にはボムで攻撃していきます。ショットを当てることで色が変化する「ベル」を集めると、さまざまなパワーアップが可能です。次々と出現する敵をやっつけ、スパイス大王に奪われたドンブリ島を取り返してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ツインビー<sup>&reg;</sup></span></div>
</div>
