...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574A4645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to the world of Gnomz. Gnomz is a new exciting arcade fighter for WiiWare. Gnomz allows up to four players to play against each other and/or AI-controlled opponents in three different game modes.
<p>
Game features:<br>
