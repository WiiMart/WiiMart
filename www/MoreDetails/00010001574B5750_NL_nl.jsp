...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574B5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Werk samen om in elk level de nodige voorwerpen op te sporen zodat de held de weg naar huis vindt. Van schelpen tot glinsterende juwelen, doe je best om de verborgen voorwerpen zo snel mogelijk te zoeken! Tijdens dit avontuur confronteer je in bepaalde actielevels ook spoken en een draak. Dit zoek-en-vind spel zit boordevol spanning en interessante voorwerpen!
<br><br>
Elk level kan tot vier spelers worden gespeeld voor maximaal speelplezier. Speel samen met vrienden of familie om het spel sneller te voltooien of kijk wie het snelst de voorwerpen in elk level kan vinden!
<br><br>
Met 11 levels in totaal, waaronder 2 actielevels, zijn er honderden voorwerpen om te zoeken! Elk level heeft tevens een unieke functie die voor een unieke speelervaring zorgt. Je hoeft de plek van de verborgen voorwerpen niet meer te onthouden, dus je kunt keer op keer van een level genieten!
<br><br>
Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B5750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B5750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Avontuur op LOST ISLAND</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Zoek-en-vind spel</span></div>
  </div>
