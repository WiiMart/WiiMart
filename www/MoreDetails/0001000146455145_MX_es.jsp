...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este es el tercer juego de la popular serie Castlevania y el último de la franquicia en aparecer en la consola NES™ original. Tomarás el papel de Trevor Belmont, el antepasado de Simon, que luchó contra Drácula mucho antes de que ocurrieran los eventos de los dos primeros juegos de Castlevania. Además de utilizar su confiable látigo, Trevor puede usar un poder que jamás se había visto antes: la habilidad de transformarse en uno de tres espíritus que lo acompañan tras conocerlos en distintos puntos de su trayecto: Syfa, una joven caza vampiros que posee magia poderosa; Grant, un feroz pirata que puede escalar muros, y Alucard, el hijo olvidado de Drácula que tiene la capacidad de disparar bolas de fuego y transformarse en murciélago. Utiliza una variedad de armas (algunas solo pueden ser usadas por ciertos personajes) mientras eliges el camino que emprenderás en tu lucha contra Drácula y su ejército. Este juego contiene algunos de los mejores elementos de acción en plataformas que puedas encontrar, los cuales te harán querer jugarlo una y otra vez. ¡No te lo puedes perder!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146455145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146455145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Castlevania<sup>&reg;</sup> III</span></div>
</div>
