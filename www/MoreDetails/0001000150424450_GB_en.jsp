...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Double Dungeons is a dungeon RPG that features smooth-scrolling 3D gameplay. Two players can play at the same time, which makes this game truly stand out from the rest.
<br><br>
There are 22 unique scenarios, spread over 6 levels. The higher the level is, the harder the scenario. Because each scenario is independent, you can choose to start the game from any scenario other than the final one (level 6).
<br><br>
Defeat monsters in each Dungeon to gain experience, while searching for the “key” that opens the door to the Boss room. Buy equipment at the Shop, team up with characters and defeat the Boss to clear a scenario. Conquer all 21 scenarios from level 1 though 5 to obtain passwords. Obtain all of them to make your way to the final scenario!</div>
  <div id="image02">
