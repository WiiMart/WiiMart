...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Esta versión es de demostración. Es probable que no tenga todas las funciones de la versión completa del título. Toma en cuenta que no podrás guardar los datos de tu juego en esta versión.
<p>
La enciclopedia ilustrada mágica, Aquaticus, ha sido contaminada por un frasco de tinta malévola llamada Influence. En Fluidity controlarás a un cuerpo de agua, que podrás cambiar entre los diferentes estados de la misma: liquido (agua), solido (hielo) y gaseoso (nube). Usa las diferentes propiedades del agua para superar varios obstáculos que han sido esparcidos a través de las páginas de Aquaticus y así salvarla de la corrupta Influence.
<p>
Inclina el control Wii Remote para controlar las varias formas y propiedades del agua en este fluido viaje a través de Aquaticus, donde cada página tiene varios cuadrantes e ilustraciones que han cobrado vida. Supera obstáculos y derrota enemigos para revelar Rainbow Drops (gotas arcoíris). Estas gotas arcoíris restaurarán el poder de Aquaticus, lo cual permitirá abrir más capítulos y otorgará nuevos poderes. Estos poderes adicionales, como adherirte a objetos cuando estés en forma de hielo o disparar rayos cuando estés en forma de nube, serán necesarios para destruir a Influence y a sus secuaces. 
<p>
Podrás poner a prueba el ingenio e instinto al encontrar piezas de rompecabezas que han sido escondidas en el camino. Estas piezas desbloquearán minijuegos que te darán la oportunidad de usar las habilidades que has aprendido y te retarán a competir contra el reloj para vencer tantos desafíos como sea posible. Estos minijuegos no afectan las misiones para restaurar los poderes de Aquaticus, pero todo el mundo merece un descanso de vez en cuando, ¿cierto?
<p>
Fluidity te ofrece la oportunidad de chapotear y deslizarte por un ambiente imaginativo, lleno de aventuras desafiantes, donde usarás el control de una manera intuitiva. ¿Estás listo para sumergirte en esta experiencia única y salvar el día?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484945/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484945/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fluidity</span></div>
</div>
