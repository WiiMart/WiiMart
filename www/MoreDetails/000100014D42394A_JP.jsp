...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ペンギンの「ペンゴ」がアイスブロックを飛ばして戦うアクションゲームです。散らばったクリスタル・ストーンを集めるため「ダイナワールド」や「ロボットワールド」など１０種類のパラレル・ワールドを冒険する「ストーリーモード」は、２人同時協力プレイも可能。ワールドの最後にはボスとの対決が待っています。また、４人のペンゴがアイスブロックをぶつけ合いながら対決する「バトルモード」は、みんなで楽しめる対戦ゲーム。そして「アーケードモード」では、１９８２年にゲームセンターで人気を博した、懐かしの元祖「ペンゴ」が登場します。１人でも２人でも４人でも、３種類のまったく異なるゲームをすみずみまで楽しんでください。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ぺぺんがペンゴ<sup>TM</sup></span></div>
</div>
