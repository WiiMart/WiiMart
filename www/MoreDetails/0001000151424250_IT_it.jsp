...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fighting Street non è altro che un adattamento della versione arcade del leggendario Street Fighter, il titolo che ridefinì il genere dei giochi di lotta uno contro uno.
<br><br>
Il giocatore controlla Ryu o Ken e combatte contro lottatori davvero singolari, provenienti da tutte le parti del mondo. Il primo che sconfigge l’avversario e si aggiudica due round su tre è il vincitore.
<br><br>
Il gioco consente di portare 3 livelli di attacchi: più a lungo tieni premuto un pulsante e più potente sarà il colpo. E ti ricordi quali erano le combinazioni giuste per eseguire gli attacchi speciali e infliggere gravi danni all'avversario? Sgranchisci le dita, perché solo con la piena padronanza di colpi normali e speciali potrai giungere alla vittoria!
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000151424250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151424250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Fighting Street</span></div>
</div>
