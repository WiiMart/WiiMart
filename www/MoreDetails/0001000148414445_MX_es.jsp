...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Hay una actualización disponible que facilitará a los usuarios nuevos la descarga de este canal. Si tu última actualización es posterior al 1 de septiembre de 2009, no apreciarás ningún cambio si actualizas ahora.  Para obtener más información visita support.nintendo.com.
<p>
Con el Canal Internet, ¡tú puedes navegar la Red con tu familia y amigos desde la comodidad de tu sala! Usa el Control Remoto Wii para navegar los sitios de red rápida y facilmente, revisa tu correo electrónico, o compra en línea. Tú puedes incluso acercar o alejar la imagen para leer cualquier página facilmente.<p><p>

Tú puedes ir directamente a los sitios de red ingresando una dirección, o usando la función de búsqueda para encontrar lo que sea que estés buscando en el Internet. Marca sitios de red como favoritos para navegación rápida y fácil.<p><p>

A partir de ahora, el Canal Internet es compatible con Adobe Flash Lite 3.1, lo que te permitirá ver todavía más vídeos.<br>
*Algunos elementos Flash podrían ser incompatibles.<p><p>

¡Descarga el Canal Internet y empieza a navegar hoy!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414445/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414445/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Canal Internet</span></div>
</div>
