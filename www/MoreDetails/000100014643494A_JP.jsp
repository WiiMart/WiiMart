...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">巨大コンピュータ「ズイガム・ボイド」に支配された未来の地球を舞台に繰り広げる、横スクロール型シューティングゲーム。プレイヤーは高機動戦闘メカ「ヴォルガードⅡ」を操り、ズイガム・ボイドの破壊をめざします。ゲームは飛行機の形態をした「ヴォルガードⅡ」１号機でスタート。敵キャラクターを倒し、オプションを獲得することで２号機が出現します。１号機と２号機を合体させるとロボットに変形できるようになり、ロボット形態ではパンチ攻撃など、より多彩な攻撃が可能。状況に応じて飛行形態とロボット形態をうまく使い分けることが、攻略のコツです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＶＯＬＧＵＡＲＤⅡ</span></div>
</div>
