...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Entérate de qué tan ingenioso puedes ser en este clásico juego, con una mezcla de aventura y elementos de un RPG. Ponte en los zapatos de Mike Jones, un adolescente lanzador estrella de Seattle, quien ha viajado a los trópicos a visitar a su tío Dr. Jones, un famoso arqueólogo. Después de enterarse que su tío fue raptado, Mike comienza su arriesgada misión para rescatarlo y resolver el misterio de su desaparición. Afortunadamente, Mike conoce a varios pueblerinos y encuentra varias armas mientras explora varias localidades y va de isla a isla usando el submarino de su tío. Nunca sabrás que es lo que se aproxima a través de los ocho niveles repletos de acción de esta historia cósmica que te llevará desde el laboratorio del Dr. Jones en la C-Island (“Isla-C”) hasta a una nave extraterrestre. ¿Quién sabía que una vacación tropical se podría convertir en una misión para salvar el mundo?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146433645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146433645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
