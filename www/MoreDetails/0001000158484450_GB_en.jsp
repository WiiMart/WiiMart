...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158484450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM"><b>This is a demo version. It is possible that it does not support every feature of the full version.</b>
<br><br>
<b>Please note that, after the demo is finished, you will be automatically forwarded to the Wii Shop Channel. This may take a few minutes.</b>
<br><br>Experience with NyxQuest: Kindred Spirits the awesome story of Nyx, an enigmatic winged girl, that must descend from heaven in search of her missing friend Icarus.<br>
<br>
Fly over the ruins of ancient Greece and avoid falling into blazing sands or perishing in the claws of cruel harpies, or by the head of a hydra. <br>
You will need to summon the powers of Zeus and other benevolent Gods from Olympus to help in your journey. They will let you shoot rays, modify the scenery and control the winds at your wish...
With your own wrist movements and pointing to the game screen, you will be able to achieve these and many other feats in this  new and  enjoyable Wii platform game. <br>
<br>
Fly, aim and shoot using the new and fullest potential of your Wii Remote.<br>
<br>
A game for one or two players. Play with a friend and maximize your abilities, while one controls Nyx, the other will control the powers of the Gods!</div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Demo version</span></div>
  </div>
