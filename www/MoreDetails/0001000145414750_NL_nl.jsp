...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit invloedrijke vechtspel uit 1994 was het eerste The King of Fighters-spel en vormde de basis voor de hele serie. Anders dan in de meeste één-tegen-één vechtspellen kun je in The King of Fighters ’94 kiezen uit acht teams, elk bestaande uit drie vechters uit SNK-klassiekers als Fatal Fury, Ikari Warriors, Psycho Soldier en Art of Fighting.
<br><br>
De regels zijn simpel: eerst kies je een landenteam en bepaal je de volgorde van je personages, om vervolgens te vechten tot een van beide teams verslagen is. Naast de gebruikelijke speciale bewegingen heeft elke vechter een krachtmeter die volloopt om een wanhoopsaanval uit te voeren. Deze meter vult zich steeds een stukje wanneer de vechter geraakt wordt, dus zelfs als je behoorlijk in elkaar geslagen wordt, heb je nog een kans om het tij te doen keren!
<br><br>
Met heldere, gedetailleerde beelden, vloeiende animaties en opwekkende muziek en geluidseffecten, moet iedere liefhebber van vechtspellen dit speelhalspel in huis halen!
<br><br>
Het spel is voorzien van Engelse schermteksten.<br>
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
