...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494A50')", "wiiSelectSound()");
...
<br><br>En el año 2112 la población está fascinada con las carreras de velocidad extrema. Los últimos avances en tecnología gravitacional han introducido el cambio de fases, y solo sobreviven los que consiguen utilizar el coche apropiado para cada tipo de pista.
<br><br>
¡Prepárate para una experiencia totalmente nueva a velocidad de vértigo! Pon a prueba tus límites para ganar carreras y batir récords, desafía a tus amigos en una competición a pantalla partida sin precedentes y compite contra adversarios implacables para alcanzar la cima en todas las ligas.
<br><br>
Calienta los motores, el futuro ya está aquí...<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494A50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494A50/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
