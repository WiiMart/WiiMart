...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SPIN MASTER is a thrilling side-scrolling action game that puts you in the shoes of an adventurer named Johnny. 
<br><br>
Dr. De Playne has stolen Johnny's piece of a treasure map and kidnapped his girlfriend Mary! Now he must set off across treacherous terrain to get them both back. Make your way through five different stages, each of which features a unique and colourful boss at the final turn. After clearing each stage, you will obtain a piece of the treasure map. Put all the pieces together and you’re in for one big surprise!
<br><br>
Make full use of jumps and attacks to advance through the game. To experience really explosive and invigorating combat, however, be sure to employ the wide range of special attacks that are also available. These include spirit charges, sliding attacks and super bomb attacks. On top of that, another player can also join in for double adventuring action!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
