...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157505050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Desafía a la familia en Family Table Tennis con el juego de ping pong más divertido!

Un sistema de control divertido e intuitivo para el disfrute de toda la familia en apasionantes partidos de ping pong.

Domina el sistema de control y los ataques especiales, ¡y demuestra tus golpes más espectaculares!
<br><br>  
Dos modos de juego: un jugador y duelo para uno o dos jugadores.

Tres minijuegos exclusivos para depurar tus habilidades.
<br><br>
Elige entre cuatro perfiles de jugador.

Y podrás participar en el torneo más increíble jamás creado. <br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505050/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
