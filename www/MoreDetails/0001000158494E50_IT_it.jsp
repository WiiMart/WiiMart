...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158494E50')", "wiiSelectSound()");
...
<br><br>Benvenuto nel mondo dei PooYoo, il primo gioco d'intelligenza poetico e divertente dedicato ai bambini da 3 a 6 anni di età.
<br><br>
Insieme ai PooYoo, un'allegra banda di cuccioli, il tuo bambino apprenderà divertendosi tutte le conoscenze necessarie alla sua crescita e a un corretto sviluppo del processo di lateralizzazione: numeri, lettere, forme, colori e tanto altro ancora. I bambini potranno ballare con i loro nuovi amici e riceveranno numerose ricompense interattive. I livelli di interattività sono due, di modo che il gioco sia accessibile a bambini di ogni età e livello di sviluppo.
<br><br>
Impara con i PooYoo è stato realizzato pensando ai bimbi più piccoli, che ancora non padroneggiano la lettura.
<br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494E50/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494E50/FFFD0012" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Episodio 1 - Demo</span></div>
  </div>
