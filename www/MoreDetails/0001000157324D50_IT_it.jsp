...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157324D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BLASTER MASTER OVERDRIVE è un gioco d’azione/avventura che si svolge su una Terra contaminata da un aggressivo virus polimorfico. 
I più innocui e docili animali, una volta infettati da questo virus a diffusione planetaria, sono stati trasformati in esseri terribili, divoratori di carne e assetati di sangue. 
Per fortuna nel mondo c’è Alex, uno dei più grandi biologi al mondo, specializzato in mutazioni virali e manipolazioni genetiche. <br><br>
Ogni biologo di fronte a un vero pericolo di annientamento globale necessita di un mezzo di trasporto, lo stesso vale per Alex. Si serve di S.O.P.H.I.A., una macchina incredibile che cambia forma, divora benzina e spara proiettili, l'emblema della potenza distruttiva su quattro ruote. <br><br>
Le cose sembrano mettersi male ma, grazie ad Alex e S.O.P.H.I.A., al nostro pianeta è forse data un'altra chance.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
