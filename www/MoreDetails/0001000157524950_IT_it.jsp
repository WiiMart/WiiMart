...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157524950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In "Rainbow Islands: Towering Adventure!" dovrai aiutare Bubby o Bobby a scalare le 7 aree della Rainbow Tower, la gigantesca torre dell'isola arcobaleno. Raggiungi la cima sconfiggendo i nemici grazie alla magia degli arcobaleni.<br><br>

Alla fine di ogni area ti scontrerai con i boss comandati dal Dr. Mezzaluna, un diabolico scienziato. Per incontrare Holly, la cometa multicolore, supera tutte le aree entro il limite di tempo!<br><br>
 
Ci sono 3 modalità di gioco. Nella modalità "Story" (Storia) puoi vivere la divertente storia della cometa di Holly; nella modalità "Challenge" (Sfida) proverai a salire più in alto che puoi prima dello scadere del tempo iniziando a 0 m; e infine la modalità "Time Attack" (Attacco a tempo), dove dovrai selezionare un'area e provare a salire 1000 m nel minor tempo possibile.<br><br>

"Rainbow Islands: Towering Adventure!" è un entusiasmante gioco d'azione che ti porterà al settimo cielo grazie agli arcobaleni!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">RAINBOW ISLANDS</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">TOWERING ADVENTURE!</span></div>
  </div>
