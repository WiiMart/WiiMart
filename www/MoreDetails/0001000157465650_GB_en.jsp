...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157465650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The ultimate football game returns to WiiWare™!
<br>
Football Up! is a fun football game where you have total control over the actions of your players. Control the ball, dribble, and trick the goalkeeper to score goals!
<br>
Master your control of the ball and make long or short passes. Adjust the height, effect and power of your shots. Become a football legend and make opposing defenders tremble!
<br>
Every in game country has a national team. You can also create your own team with the editor: choose a name, equipment and import Miis™ from the Mii Channel to use as players!
<br>
- Realistic ball physics ensure that control of the ball is vital<br>
- Control the height, direction and effect of every pass and shot<br>
- Play in the World Cup!<br>
- Local multiplayer allows up to four players to play in co-op or competitive modes</div>
  <div id="image02">
