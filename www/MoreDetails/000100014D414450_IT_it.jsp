...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aiuta il delfino Ecco a trovare i suoi amici esplorando il vasto oceano. Dovrai riemergere ogni tanto per respirare e stare attento ai nemici che popolano le profondità degli abissi. L'utilizzo del Sonar darà ad Ecco la possibilità di ottenere preziose informazioni dalle altre creature dell'oceano.<br><br>Il testo all'interno del gioco è in inglese.<br>Non supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
