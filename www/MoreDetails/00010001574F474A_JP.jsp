...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F474A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">げんき君とのぞみちゃんが、今度は「パターゴルフ」に挑戦。<BR>いろんな形のステージや、さまざまなギミックがあなたを待ちうけます。<BR>強く打つだけではなく、「ダッシュパネル」や「せんぷうき」をうまく使うのがカップインへの近道です。<BR>いろいろと試行錯誤して、ベストスコアを目指しましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F474A/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F474A/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">おきらくパターゴルフWii</span></div>
</div>
