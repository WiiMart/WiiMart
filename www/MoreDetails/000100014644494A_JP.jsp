...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">隣国のバサム帝国に支配されたスレン王国の王を操作して、横スクロールのフィールド上を進むアクションロールプレイングゲームです。敵に捕らわれたり魔法で木や岩に変身させられた兵士を助け出しながら、バサム帝国最深部にいる暴君「オゴレス」をめざして進みます。魔法で変身させられた兵士は、スレン王が体当たりすることで元の姿に戻すことができますが、どの木や岩が兵士の変身したものなのかは体当たりをしてみるまでわかりません。また助け出した兵士は「兵卒」「騎士」などグループごとにしか移動できず、同時に複数の兵士の動きに気をつけなければならないため、大軍になれば戦力は上がりますが進軍はむずかしくなります。敵と味方が接触すると戦闘になり、敵味方それぞれの強さとその時の運によって勝敗が決まります。兵士の特徴や相性を活かし、時には運に翻弄されながら、宿敵オゴレスを倒してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ボコスカウォーズ＼BOKOSUKA WARS<sup>&reg;</sup></span></div>
</div>
