...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das 1998 von SNK veröffentlichte Metal Slug 2 ist ein als Vertikalscroller angelegtes militärisches Actionspiel. Die Spieler wählen zwischen Marco, Tarma, Eri und Fio, bevor sie den Blick darauf richten, Mordens remobilisierte Rebellenarmee auszulöschen. Wie bereits in Metal Slug 1 kämpfen sich die Spieler schießend und springend durch die Level. Metal Slug 2 erweitert jedoch das  Arsenal, das aus einem schweren Maschinengewehr, einer Schrotflinte und selbst einer Laserwaffe besteht, was den Spielern den Genuss abwechslungsreicher Schlachten bietet. Aber nicht nur das, selbst Kampfeinflüsse spielen eine Rolle – Spieler verwandeln sich in Mumien, nachdem sie von Mumien ausgestoßene Gase einatmen. Spielcharaktere werden sogar dick, wenn sie zu viele Nahrungs-Items einsammeln, bekommen dafür allerdings ein Stärke-Upgrade. Da selbstverständlich Zwei-Spieler-Action unterstützt wird, können die Spieler auch gemeinsam mit ihren Freunden auf den Putz hauen.<br><br>
Englischer Bildschirmtext.<br>Das Tutorial ist auch auf Portugiesisch, Spanisch und Japanisch verfügbar.<br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
