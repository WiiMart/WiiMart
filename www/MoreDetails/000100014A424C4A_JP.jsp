...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">平和な宇宙をお騒がせする宇宙盗賊団コズモギャングズが、パズルゲームとなって登場。遊びかたはいたってシンプルで、上からどんどん落ちてくるブロックを操作して、高く積みあがらないように消していきます。ブロックは「コンテナ」「コズモ」「ボール」の３種類で構成され、コンテナは横一列に６つ並べると消え、コズモは転がるボールに触れると消すことができます。<BR>基本テクニックは、ブロックを回転させて落とし方を工夫し、コンテナの間にボールが転がる道となるようにコズモを並べること。コズモの一本道ができたら、ボールを転がして一気消しです。さらにコズモの上に乗っていたコンテナが横一列にそろえば連鎖で消すこともでき、スコアアップが狙えます。<BR>ゲームモードも、ハイスコアに挑戦する「１Ｐモード」、プレイヤー同士の対戦「ＶＳモード」、そして詰め将棋感覚でステージクリアしていく「１００面モード」の３つが用意されています。コズモ一気消しの爽快感がやみつきになるパズルアクションゲームです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">コズモギャング ザ パズル<sup>&reg;</sup></span></div>
</div>
