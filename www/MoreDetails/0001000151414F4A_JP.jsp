...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">多人数同時プレイが人気を呼んだアクション・ロールプレイングゲームの第二弾です。前作から半世紀後、コーネリアの地に再び復活を遂げた魔王「ブレード」と闇の魔導師「フォルゴーン」を打ち倒すべく８人の勇者たちが集結します。プレイヤーは、特性の異なる職業を持つ勇者たちから自由に「マイキャラ」を選択。上からの視点で表示される広大なフィールドやダンジョンの中、それぞれの武器と魔法を駆使して「ジェネレーター」から現れる敵を倒しつつ、探索をおこないます。戦い以外でも、冒険の途中で新たな仲間と出会ったり、死神とカードゲームで勝負したりと、楽しいイベントが盛りだくさん。さらに最高５人までが参加できる多人数プレイでは、それぞれが育てたキャラクターをパスワード機能で持ち寄ってパーティ・プレイも可能。１人では少々手ごわいボス戦などでも、他のプレイヤーと協力して迫力満点の戦いを満喫することができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000151414F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダンジョンエクスプローラー<sup>&reg;</sup>Ⅱ</span></div>
</div>
