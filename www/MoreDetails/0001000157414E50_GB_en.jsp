...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157414E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The beloved childhood pastime of lazy Sundays spent with a magnifying glass and an ant farm finally arrives on WiiWare in its most mischievous form!<br><br> You are in control of a small colony of Super Ants, which you must train through a devilishly fun toolset. Zap, torch, and manipulate your ants to make them tough enough to survive a variety of increasingly difficult challenges! Protect your ground from attack by ladybirds, spiders and other hostile creatures.<br><br> Swing your Wii remote to drop a hammer on your ants, use your Wii remote like a metal detector to search for gold and other treasures.</div>
  <div id="image02">
