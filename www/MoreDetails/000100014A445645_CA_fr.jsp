...
<p>
Blast your way through villainous outlaws, diabolical robots, and towering, screen-filling bosses either by yourself or with a friend at your side in the 2-player co-op mode. You'll need a sharp eye and quick-on-the-draw reflexes, but fortunately, you've got plenty of moves to help you survive the hail of bullets heading your way. You can dive-roll, jump, double jump, rope enemies with a lasso, and clear the screen with explosive special attacks. Blast apart just about everything in the environment to find guns, bombs, and other hidden powerups. It's up to you to bring justice back to town—or whatever's left of it when the gun smoke clears.</div>
  <div id="image02">
