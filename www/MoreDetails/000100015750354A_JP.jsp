...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750354A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">かわいらしい車たちを操作して、１人から最大４人までみんなでわいわいレースを楽しめます。体当たりで相手をはじきとばしたり、アイテムを拾ってワナをしかけたりとハチャメチャなレースが展開します。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750354A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750354A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ポコスカれーしんぐ</span></div>
</div>
