...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Faites rugir les moteurs... Super Mario Kart débarque sur la console virtuelle! Considéré comme l'un des meilleurs jeux de tous les temps, ce titre est le premier du genre et constitue le point de départ d'une longue série de hits incontournables.
<br><br>
Incarnez l'un de vos personnages préférés du royaume Champignon, de Mario à Bowser en passant par Donkey Kong Jr., dont c'est la seule apparition dans la série.
<br><br>
Grâce au Mode 7, roulez sur des circuits à l'animation exceptionnelle pour l'époque, dont bon nombre figurent encore aujourd'hui dans les opus les plus récents de la série: Circuit Mario, Château de Bowser, Plage Koopa ou encore la redoutable Route Arc-en-ciel!
<br><br>
Affrontez l'ordinateur en solo, mesurez-vous à un ami sur un écran partagé et redécouvrez la version d'origine du mode Bataille, un classique absolu du multijoueur! Sans oublier les commandes qui ont fait le succès de la série... Les dérapages n'ont pas pris une ride!
<br><br>
