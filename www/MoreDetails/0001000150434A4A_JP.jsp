...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機をパワーアップさせながら進撃する縦スクロール型のシューティングゲームです。移民惑星ウラノスの社会秩序を支えるバイオコンピュータ「フレイア」の暴走に対し、地球政府はミッション・コード“ＯＶＥＲＲＩＤＥ”を発動。プレイヤーに与えられたミッションは、ホバータンク「ギガイアス」を操って全６ステージを突破し、最終目標の「フレイア」を破壊することです。各ステージでは２つの「ディフェンス・アイテム」と５つの「オプション・アイテム」で自機を強化しながら、敵にすばやく対応します。独特の発動条件を持つ「プールショット」は、ボス戦にも有効な必殺技で、破壊力も抜群。タイミングを見極めて画面内の敵を一掃すれば、シューティングゲームならではの爽快感を味わうことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150434A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150434A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">オーバーライド</span></div>
</div>
