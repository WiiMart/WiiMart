...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ambientato nel periodo Bakumatsu della storia giapponese, The Last Blade è un gioco di combattimento originariamente pubblicato nel 1997 in cui più di dieci spadaccini combattono inseguendo diversi obiettivi. Accostabile ai precedenti titoli della serie Samurai Shodown rilasciati dalla stessa società, si differenzia in quanto la scelta del personaggio ti permette di selezionare tra due tipi di spada: Potenza, incentrata sul danno, o Velocità, che favorisce invece un tipo di gioco improntato alla rapidità. In più, trovi anche Contrasto, che ti permette di deviare gli attacchi nemici e Fendente sublime, che annulla Super fendente e può essere combinato con Super fendente segreto. Questi ultimi sono solo alcuni degli elementi che si sommano alla moltitudine di strategie d’attacco che questo gioco offre. Assicurati di non perdere mosse speciali come Super fendente segreto e Fendente segreto nascosto!
<br><br>
