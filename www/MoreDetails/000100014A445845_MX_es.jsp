...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡El aerialista extremo, Aero el acrobat, vuelve al centro de atención una vez más para detener al malvado industrialista , Edgar Ektor! ¡Aero ha entrado en un nuevo reino de encantamiento y ahora debe usar toda su habilidad acrobática para detener un complot criminal conocido solo como “Plan B”! ¡Únete a Aero mientras descubre nuevos amigos (y enemigos) en un mundo construido a medida para sus aventuras de altos vuelos!
<p>
*¡45 niveles de diversión acrobática desenfrenada, incluidas: Partidas de Bonus, Pantallas de Oportunidad y Cámaras Ocultas!<br>
*¡Nuevos enemigos y voces de personajes originales digitalizadas!<br>
*¡Password Feature te permite volver a cualquier nivel!<br>
*¡La pantalla de Snow Boarding añade un nuevo giro al estilo de Aero!<br>
*¡Nuevos movimientos y técnicas de combate para los ataques de Aero!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A445845/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A445845/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">AERO THE ACROBAT<sup>TM</sup> 2</span></div>
</div>
