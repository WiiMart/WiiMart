...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157534D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Olvídate de dietas y obsesiones por la salud! ¡Llega un juego rebosante de comida, gordura y lucha!<br><br>

Coloca el mando de Wii en posición horizontal, e inclínalo hacia la izquierda, hacia la derecha, hacia delante o hacia atrás para realizar toda clase de levantamientos y lanzamientos como en el sumo real. También hay movimientos ocultos como suplexs o scrapbusters introducidos para mayor diversión. Utiliza todos los movimientos que aprendas en los torneos alrededor del mundo para llegar a la cima del sumo y convertirte en yokozuna.<br><br>

En modo un jugador, come mientras juegas o entrénate con minijuegos para fortalecer a tu luchador y cambiar su apariencia. ¡También puedes usar tus propias caras Mii en tus luchadores!<br><br>

En modo dos jugadores, lucha con otro usando los luchadores por defecto o los jugadores que has creado.<br><br>

¡Engulle! ¡Engorda! Lucha para convertirte en el luchador de sumo más fuerte en Eat! Fat! FIGHT!
<br><br>
