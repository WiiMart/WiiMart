...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157325450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este es un juego de grupo que permite hasta 4 jugadores a la vez. Los jugadores se convertirán en nuevos Brain Cadets (estudiantes de una academia militar) que acatan órdenes del sargento de instrucción y se someten a un entrenamiento abrumador de fortalecimiento de la mente. 
<br><br>
Las reglas son simples, pero la concentración y la reacción rápida son la clave para jugar este juego y evolucionar para llegar a ser una máquina simple, perversa y pensante. Es mejor jugar este juego con amigos y familiares.
