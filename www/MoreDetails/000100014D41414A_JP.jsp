...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">２人同時プレイが可能な横スクロール型アクションゲーム。魔人によって連れ去られた女神アテナを救い出すのが目的です。主人公の２人は「スピリットボール」を手に入れることで獣人となり、超人的な能力を駆使しながら、行く手をさえぎるモンスターたちを倒していきます。ステージごとに変身できる獣人が変わり、必殺技もそれぞれ異なります。オリジナルは人気アーケードゲームで、さまざまなゲーム機に移植され話題を呼びました。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
