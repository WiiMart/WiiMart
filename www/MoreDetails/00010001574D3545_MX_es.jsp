...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D3545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Kurt Hectic batalla a un ejército de alienígenas para salvar la Tierra... El objetivo es guiar a través de diez niveles de juego de caracteres Kurt Hectic, Max y el Dr. Fluke Hawkins, cada uno con sus propias características. Por lo tanto, Kurt puede usar su francotirador para matar a los enemigos a una distancia muy lejos. Max, el perro cyborg con seis patas, el uso de la fuerza bruta: se puede usar cuatro armas al mismo tiempo, y también, en algunos pasajes, use un jetpack para que pueda llegar a nuevas alturas. Profesor Hawkins es físicamente más vulnerables de los tres personajes, pero puede recoger objetos y combinarlos para obtener diferentes gadgets y armas. Estos personajes son controlados a su vez: el primer nivel es con Kurt, el segundo con Max, el tercero con Hawkins... hasta que el nivel final en la que el jugador elige con quien terminó el partido, sabiendo que el epílogo será diferente cada vez.
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MDK<sup>TM</sup>2</span></div>
</div>
