...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574F4250')", "wiiSelectSound()");
...
<br><br>
In Art Style: ORBIENT stellt das Universum deinen Spielplatz dar. Als kleiner Zwergplanet musst du geschickt Gravitationskräfte einsetzen, um dich durch das Weltall zu manövrieren. Gewinne an Größe, indem du andere Planeten absorbierst, oder fange sie ein und lasse sie in einer Umlaufbahn als Satelliten um dich kreisen.
<br><br>
Doch aufgepasst! Das Weltall ist ein gefährlicher Ort für einen Planeten, der sich vor tückischen Asteroidenfeldern und schwarzen Löchern besser in Acht nehmen sollte! Beweise in 50 spannenden, fordernden Stages dein Können und begleite deinen Planeten bei seiner Reise durchs All. Eine überirdische Spielerfahrung!
<br><br>
