...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157505250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La série des Art Style - une exclusivité  WiiWare - est composée de jeux à la fois faciles à prendre en main et surprenants de par leur richesse graphique et sonore. 
<br><br>
Art Style: Cubello est un jeu de puzzles vous permettant de tester votre capacité à vous repérer dans l'espace ainsi que vos réflexes. Le principe est simple: détruire les cubes de couleur qui composent le "cubello" en lançant les cubes de même couleur issus de votre réserve à l'aide de la télécommande Wii.
<br><br>
Attention, le cubello tourne en permanence sur son axe ! Faites preuve de concentration et de la plus grande précision pour supprimer les cubes et venir à bout de ce puzzle ! Les joueurs à la recherche de sensations fortes se régaleront avec le mode Endless ! 
<br><br>
