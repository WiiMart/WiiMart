...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Experience improved graphics and controls in this exciting sequel to the action RPG Neutopia. Take on the role of the main hero’s son and watch as the story begins with the apparent revival of Dirth, the evil demon. Once again you’ll need to rely on your magic compass and the information you’ve gathered to find entrances to labyrinths and defeat the bosses in them. Make your way through the field, which can be tricky at times, to search for and find hidden information and items, or move blocks and destroy walls to uncover secret rooms. Like the original, this game has a save function, a finely tuned difficulty level, and a fast-paced story, making it truly an RPG that everyone can enjoy.</div>
  <div id="image02">
