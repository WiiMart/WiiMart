...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157504B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prepare to experience the intensity of a real Texas Hold’Em poker tournament online with opponents around the world! <br>
Up to 6 players can play wild poker parties thanks to an Online mode that also allows you to create your own tournaments. You can challenge opponents of any skill level you wish and enter the circle of the best poker players on WiiWare. <br><br>
                        
Of course, there’s plenty in the single-player modes as well. Whether a novice or veteran, you’ll enjoy Tournament, Cash Game, and Heads-up modes with simple, fun Wii Remote controls. Hit the tables as one of 6 fun and charismatic characters, or import your own Mii to really put on your poker face.<br><br>

Take on the most prestigious casinos where the other players won’t hesitate to taunt or comment, creating a very realistic poker atmosphere!<br><br>

Even if you’ve never played poker before, you can learn all the rules and strategies with the Advanced Tutorial, learning everything from winning hands and betting to bluffing.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504B50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504B50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
