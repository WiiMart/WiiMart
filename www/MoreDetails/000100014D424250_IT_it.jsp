...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il Dr. Eggman (alias Dr. Robotnik) ha iniziato un'ossessiva ricerca dei Chaos Emerald per alimentare il suo nuovo Death Egg. Un pomeriggio ha sferrato un poderoso attacco sull'isola dove sono nascosti i Chaos Emerald e ha imprigionato tutti gli animali per trasformarli in schiavi senz'anima.
<br><br>
Sonic non si fermerà davanti a nulla per sabotare il piano del dottore. Questa volta non è solo: Tails ha deciso di aiutarlo nella sua battaglia. Assieme dovranno trovare i Chaos Emerald prima che lo faccia il Dr. Eggman e mettere così fine al suo diabolico piano.
