...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Regresa a uno de los clásicos de disparos y desplazamiento vertical más aclamados! Disfruta de una experiencia única. ¡Oprime un botón para disparar y derriba a todos tus enemigos! Descubre los secretos especiales repartidos por las 25 zonas del juego. Gana <nobr>1 000 000</nobr> de puntos por resolver el misterio mayor. Acóplate a tu unidad aliada PURSER para obtener el modo de disparo rápido. Pon a punto tus dedos y prepárate para un ejercicio de control y potencia inolvidable. ¡Te quedarás sin aliento! Existe una gran cantidad de opciones disponibles que puedes ajustar: el número inicial de unidades Final Star, el nivel de dificultad, etc.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145365A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145365A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
