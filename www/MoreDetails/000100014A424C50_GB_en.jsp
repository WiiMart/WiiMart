...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pac-Man makes an appearance in Pac-Attack, a fun and quirky puzzle game!<br><br>
The goal of Pac-Attack is simple: Keep your screen clear of falling blocks and ghosts. To clear the blocks you must line them up in a horizontal line.<br><br>
To clear the ghosts you'll need the help of Pac-Man. Every so often Pac-Man will pop by to have a snack. It's up to you to get all the ghosts lined up for him. Pac-Man will keep eating ghosts until he hits a dead end. Pac-Man only moves down and horizontally. On a flat surface he will move in the direction he is facing.<br><br>
There are 3 game modes to choose from including, 1 Player Normal Game, 2 Player VS Game and the challenging 1 Player Puzzle Game.
