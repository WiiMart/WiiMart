...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Erlebe Sonics furioses Debüt in der zweiten Auflage des Originals "Sonic The Hedgehog" im SEGA MASTER SYSTEM-Remake!
<br><br>
Diese Version des Jump 'n' Run-Klassikers glänzt mit neuen Stages, neuen Bossgegnern und einer Level-Karte. Kannst du dich an die aufregende Jagd nach Chaos Emeralds in den Special Stages erinnern? Jetzt sind die Chaos Emeralds auch in den regulären Stages zu finden. Also geh auf Schatzsuche! Aber keine Sorge. In den Special Stages findest du immer noch jede Menge andere Schätze!
<br><br>
Dich erwarten haufenweise neue Zonen exklusiv in dieser Version und der Showdown mit dem fiesen Dr. Eggman (alias Dr. Robotnik) am Ende jeder Zone. Also, worauf wartest du noch? Der Spurt kann beginnen!<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sonic The Hedgehog<sup>TM</sup></span></div>
</div>
