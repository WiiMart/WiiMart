...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cratermaze es un juego de acción cómica situado en un mundo paralelo. Mientras viajando por el tiempo, tú y tus amigos se encuentran con "Kublai", un esbirro del malvado "Zenzombie". El ha capturado a tus amigos en el tiempo de espacio continuo. Ahora tendrás que luchar por 60 secuencias de laberintos para salvarlos. Dinosaurios, ninjas, robots, y otros enemigos merodean en los laberintos, con enemigos de los tiempos primitivos al los tiempos del futuro. ¡Escapa de los enemigos escarbando la tierra creando agujeros donde entierras al los enemigos para acabar con ellos!. Recoge todos los tesoros dentro del tiempo limite para conseguir la llave y salir hacia al siguiente laberinto. ¡Con objetos especiales como palas y plataformas elevadoras, Cratermaze lleva el juego a nuevos niveles haciendo que sea una experiencia inolvidable!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150423645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150423645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
