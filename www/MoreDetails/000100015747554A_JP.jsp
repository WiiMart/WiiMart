...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015747554A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aero Guitar（エアロ・ギター）は、Wiiリモコンをギターのように演奏して楽しめるリズムアクションゲームです。<BR>Wiiリモコンを活かした簡単操作でギターを弾けない大人から子供まですぐに遊ぶことができます。<BR>ヌンチャクをギターのネックに見立て、画面の右端からスクロールしてくる譜面に合わせてリモコンを振って演奏します。（初めての方にはカンタンモードもあります）<BR>また、収録曲で物足りなくなったら、追加楽曲を新たに購入することで、いつまでも飽きることなく楽しむことができます。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100015747554A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015747554A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Aero Guitar</span></div>
</div>
