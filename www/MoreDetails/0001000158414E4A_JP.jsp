...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">横スクロール型シューティングゲームの人気作『グラディウス』の続編を希望する多くのファンの声に応えるべく登場したＭＳＸ版だけの作品で、ＭＳＸオリジナルのグラディウス史が繰り広げられています。追放された科学者ヴェノム博士が、かつての敵バクテリアンの艦隊を率いて惑星グラディウスへの侵略を開始。この危機に対抗するため、最新型超時空戦闘機「メタリオン」に出撃命令がくだります。このソフトの特長は、ＫＯＮＡＭＩのＭＳＸゲームに初めて採用された特殊な音源チップ「ＳＣＣ」。今もファンの心をとらえて離さない、美しい音色と表現豊かなサウンドを作り出しました。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/l</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000158414E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158414E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">グラディウス２</span></div>
</div>
