...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">今なお続くＲＰＧ「真・女神転生」シリーズの第三弾。<BR><BR>それはある一人の少年から始まる。<BR>天才的頭脳を持つ眉目秀麗な少年ハザマ。凡俗との交流を持たず、常に孤独な存在であった。<BR>悪魔召喚プログラムを手に入れた彼はやがて魔界を支配するようになる。<BR>そして世界を魔界におこうとした。
手始めとして軽子坂高校、君の通う学校を魔界に引きずり込ませたのだ。<BR>傲慢、嫉妬、退廃に満ちた狂気の世界。そして目にしたものは…。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">真・女神転生if...</span></div>
</div>
