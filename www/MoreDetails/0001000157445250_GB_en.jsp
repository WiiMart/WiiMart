...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157445250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mr. Driller W is the new and updated instalment of the exciting, classic game challenging you with level upon level of frantic, underground, drilling action! Experience more than 20 varied stages and missions!
<br><br>
Drill through a seemingly endless onslaught of coloured blocks while avoiding falling obstacles and strategically managing your air supply. Multiple degrees of difficulty now challenge everyone from the first time novice to the most hardcore, Mr. Driller veteran. A playable tutorial will even help first time players learn the game's rules quickly and easily!
<br><br>
Vibrant graphics, addictive gameplay and loads of characters make this a modern twist on a gaming masterpiece!</div>
  <div id="image02">
