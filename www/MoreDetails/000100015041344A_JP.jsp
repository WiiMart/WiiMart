...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">パラソルを使い、画面内の敵を倒す、固定画面の面クリア型アクションゲームです。プレイヤーは「バビー」と「ボビー」を操作し、魔法のパラソルを使って敵を倒していきます。魔法のパラソルは敵をのせて投げたり、空や天井から出てくる「しずく」をのせて敵にぶつけたり、敵のミサイルなどを防いだりとさまざまな使い方が可能です。
さらに、「しずく」を集めて「大しずく」をつくれば、水流を発生させて敵をまとめて倒すこともできます。また、２人同時プレイにも対応しており、協力してステージを攻略することも可能です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">PARASOLSTARS<sup>&reg;</sup></span></div>
</div>
