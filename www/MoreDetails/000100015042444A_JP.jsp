...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スムーズな３Ｄウォークスルースクロール画面のダンジョンＲＰＧ。ＲＰＧで２人同時プレイができるという非常にユニークなシステムが特徴です。シナリオは難易度に応じてレベル１から６までの全２２本が収録されており、それぞれ１本ごとに独立したオムニバス形式となっています。ゲームを始めるときは、最終シナリオ（レベル６）以外であれば、自由に選択してスタートすることが可能です。ダンジョン内のモンスターを倒して経験値を積み重ねていき、シナリオごとのボスの部屋とその扉を開く「カギ」を探し出します。ショップで装備を購入したり、時には仲間と協力したりしながら、扉の奥に潜むボスを倒すとシナリオクリアとなります。レベル５までの２１本のシナリオを制覇し、全てのパスワードを手に入れると最終シナリオに挑戦できます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダブルダンジョン</span></div>
</div>
