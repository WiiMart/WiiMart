...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">China Warrior è un gioco d’azione a scorrimento orizzontale uscito in Giappone durante il periodo di lancio del PC Engine (Turbografx). Il maestro di kung fu Wang deve sconfiggere il perfido Imperatore delle Tenebre, campione supremo di arti marziali. In ogni livello sono presenti 3 boss, per arrivare ai quali dovrai battere i nemici con pugni e calci eseguendo tecniche letali e spettacolari.<br>
Evita gli attacchi avversari e completa i 4 livelli che compongono l’avventura, raccogliendo gli oggetti che ti fanno recuperare energia.<br> 
Quando debuttò sul mercato, China Warrior stupì il pubblico per la sua grafica dettagliata, i personaggi di grandi dimensioni e le eccellenti animazioni.<br>
I combattimenti contro i boss sono talmente realistici ed entusiasmanti che ti sembrerà di essere stato catapultato in un film di kung fu!
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150425450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150425450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">China Warrior</span></div>
</div>
