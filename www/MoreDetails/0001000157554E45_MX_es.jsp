...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157554E45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Prepárate para decir "UNO" en tu consola Wii! Ahora tienes el juego de cartas mundialmente famoso, reproducido a la perfección en tu consola Wii, con emocionantes nuevas reglas. Gracias al modo multijugador, en una consola Wii o a través de la Conexión Wi-Fi de Nintendo, jugar a UNO™ es más fácil y divertido que nunca. ¡Sé el primero en deshacerte de tus cartas!
<p>
• El juego número 1 para la diversión entre amigos o con la familia, recreado para respetar la identidad del juego clásico y con reglas que son fáciles de entender para todos.<br>
• Te permite personalizar las reglas del juego y descubrir nuevas maneras de jugar a UNO™, como "UNO 7-0", "Reto UNO", "Jump-In" y más.<br>
• Un emocionante modo multijugador, a través de la Conexión Wi-Fi de Nintendo, permite disfrutar de una partida de UNO™ entre amigos (hasta 6 jugadores). Sumérgete en esta experiencia y usa el Wii Speak para hablar con tus rivales y decir "UNO". ¡La victoria nunca ha sido tan divertida!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554E45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554E45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">UNO<sup>TM</sup></span></div>
</div>
