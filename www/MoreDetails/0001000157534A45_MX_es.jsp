...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157534A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El mejor juego de descubrir las diferencias para WiiWare contiene 160 escenas, 3 niveles de dificultad y 1.600 diferencias que descubrir. Juegue solo o con amigos (un máximo de 4 jugadores) y descubra quién tiene mejor ojo. Desplácese por las extrañas y atractivas escenas de las diversas categorías: paisajes, animales, tiempo de juego y riquísimo.
<p>
4 modos de juego disponibles:<br>
- Arcade: Las escenas aparecen en un orden aleatorio: descubra 5 diferencias en cada una.<br>
- Time attack: Descubra una diferencia en cada escena mientras no se detenga el cronómetro.<br>
- Escenas seleccionadas: Juegue con las escenas que elija y descubra cinco diferencias en cada una.<br>
- Varios jugadores: Juegue contra sus amigos (un máximo de 4 jugadores).
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534A45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534A45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Spot The Differences!</span></div>
</div>
