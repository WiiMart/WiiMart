...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157464E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fish Tank is a combination of a very popular Match 3 genre with a puzzle video gamestyle. It is an arcade-style matching game but instead of matching gems or blocks you collect  shoals of coloured fish. In order to do that, you need to build up a combination of four or more identical fish and press a corresponding button to remove them from the net. The gameplay goes horizontally – not vertically as you might be used to.
<br><br>
Looking for more? Here we go:<br>
- 24 achievements to unlock<br>
- 24 challenging levels<br>
- 9 different power-ups to enhance your playing experience<br>
- 4 player co-op mode<br>
- 2 game modes: Play and Challenges<br>
- 1 extra ultimate trophy at  the end of the game for the best gold medals collectors!</div>
  <div id="image02">
