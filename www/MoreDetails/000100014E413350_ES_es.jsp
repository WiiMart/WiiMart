...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Revive tu infancia con Bomberman en este emocionante juego de acción!
<br><br>
Un día, una misteriosa nave espacial se estrelló en el planeta Bomber. Bomberman acudió de inmediato al lugar del incidente para averiguar qué había pasado, y allí encontró a Pibot, el piloto robot de la nave. Pibot le contó que el imperio Garaden se había hecho con el control de Primus Star, y que la princesa Millian, con la que trataba de huir del planeta, también había sido capturada. Tras escuchar esto, Bomberman prometió rescatar a la princesa... ¡aunque para ello tuviera que llegar a los confines de la galaxia!
<br><br>
Bomberman cuenta con un número ilimitado de bombas, y podrá equipar mejoras que le ayudarán a salir victorioso de su misión. A lo largo de su viaje visitará cinco planetas llenos de peligros, volverá a encontrarse con su viejo amigo Louie y utilizará objetos nunca vistos hasta ahora. ¡Vuela, nada, dispara y lanza bombas a diestro y siniestro para abrirte paso a través de la galaxia y salvar a la princesa Millian!
<br><br>
Textos de pantalla en inglés.<br>La función de vibración del juego original no está disponible.</div>
  <div id="image02">
