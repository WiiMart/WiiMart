...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753434A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">松本零士ワールドの原点が解き明かされる、新作描き下ろしコミックが全編オールカラーでWiiに登場。<BR><BR>『時は西暦2099年9月9日東京。絶世の美女「羽黒 妖（はぐろよう）」指揮のもと、絶滅の危機に瀕した地球を救うべく宇宙へ飛び立つ時空船…。<BR>不思議な力を持つ銀のペンダントを携えた少年「海野 始（うみのはじめ）」と共に。<BR>銀のペンダントが光る時、何かが起きる…。「羽黒 妖（はぐろよう）」の正体とは…。<BR>壮大な生命のストーリーが今、はじまる…。』<BR><BR>コミックの読み方は、コマを少しずつ読んでいく「コマ表示モード」と、ページの上下半分ずつを読んでいく「ページ表示モード」のどちらかをお好みで選べます。<BR>「コマ表示モード」は自動再生もできるので、ハンズフリーでお楽しみいただけます。<BR><BR>
主コンテンツは、コミックを読むためのビュアーに、コミックが第１話から第３話まで入っており、さらに著者、松本零士の独占インタビュー記事、お宝拝見などのスペシャルコンテンツも入っています。今後追加コンテンツで第４話目以降を配信予定です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753434A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753434A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Out of Galaxy 銀のコーシカ ～松本零士～</span></div>
</div>
