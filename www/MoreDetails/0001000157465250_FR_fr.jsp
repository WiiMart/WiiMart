...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157465250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Frogger Returns reprend la base arcade de Frogger et lui fait passer une nouvelle dimension ! Le classique 2D des salles d'arcade a reçu de nouveaux graphismes 3D colorés, de nouvelles perspectives, de tout nouveaux niveaux, des ennemis inédits ainsi que des power-ups renforcés à utiliser et à esquiver ! Un mode multijoueur vous permet d’affronter un ami jusqu'à la victoire.
<br>
<br>
- Graphismes améliorés. Le jeu classique Frogger offre une présentation toute nouvelle.
<br>
<br>
- De nouveaux niveaux. Quatre niveaux illustrent le voyage original de Frogger de l’autoroute à la maison à travers une toute nouvelle aventure. 
<br>
<br>
- Nouveaux boss et nouvelles tactiques. Nouveaux ennemis et utilisation stratégique des power-ups.
<br>
<br>
- Jouer avec un ami ! Un mode multijoueur vous permet d’affronter un ami.<br>
