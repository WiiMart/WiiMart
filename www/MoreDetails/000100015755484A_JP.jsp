...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015755484A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">※「Ｗｉｉでウルトラハンド」は、クラブニンテンドー会員限定のＷｉｉウェアです。<BR><BR>
１９６６年に任天堂が発売した「ウルトラハンド」が、Ｗｉｉウェアになって帰ってきました。Ｗｉｉリモコンとヌンチャクを使って「ウルトラハンド」をすばやく操作できるでしょうか？<BR><BR>
●スコアアタック！<BR>
「ウルトラハンド」を伸び縮みさせて、コンロの上の「ニク」を取るゲームです。次々とコンロの上にあらわれるニクをこがさないように手前のお皿まで運んでください。<BR>
「グッド！」な焼き上がりで連続してニクを取ると「コンボ」となり、高得点が狙えます。ニクをこがしてしまったり、お皿以外の場所に落としてしまうとゲームオーバーです。<BR><BR>
●２人で対戦プレイ！<BR>
それぞれがウルトラハンドを持って、自分のコンロからニクを取るゲームです。９０秒以内にどちらが多く得点できるかを競います。相手のコンロからニクを取ることもできるので、チャンスがあればねらってみましょう。<BR><BR>
※このソフトはクラブニンテン<BR>
　ドーから受け取った特典ソフト<BR>
　引換番号１つにつき１台の<BR>
　Ｗｉｉで受信できます。<BR>
...
　本体では受信できません。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100015755484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015755484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wiiでウルトラハンド</span></div>
</div>
