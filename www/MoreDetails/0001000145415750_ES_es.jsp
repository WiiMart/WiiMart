...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Vuelve a librar los más duros combates en dos planos de profundidad, realiza todo tipo de técnicas especiales y remata a tus rivales con los ataques finales más salvajes y poderosos!
<br><br>
Distribuido por primera vez en los salones recreativos en 1993, este clásico juego de lucha reúne de nuevo a los ocho personajes seleccionables de Fatal Fury 2, pero además te permite controlar a sus cuatro temibles jefes (Billy, Axel, Laurence y el despiadado Krauser) y a tres veteranos del primer Fatal Fury (Duck, Tung y el popular Geese).
<br><br>
Pero eso no es todo: si cumples determinados requisitos, ¡podrás enfrentarte al mismísimo Ryo Sakazaki de ART OF FIGHTING en un combate legendario! ¡Atrévete a aceptar el desafío y descubre por qué Fatal Fury Special marcó un antes y un después en el género de los juegos de lucha!
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FATAL FURY SPECIAL<sup>TM</sup></span></div>
</div>
