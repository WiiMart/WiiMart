...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界１２か国の代表チームが熱い戦いを繰り広げるサッカーゲームです。多様なフォーメーションの選択で、よりリアルなゲームを実現。操作はシンプルながらも、パスやスライディング、オーバーヘッドキックなど、状況に応じた多彩なプレイが可能です。独特の「パワーアップレベル」システムでは、ゲージを消費することで選手をパワーアップさせることができるので、ドリブル突破など、ここぞという局面で有効です。ゲームモードは、それぞれにユニークな全４種類。１人用の「ＨＵＤＳＯＮ　ＣＵＰ」で勝ち進むと、入団を希望する選手が登場。優秀な選手を入れてチームを強化しつつ、優勝をめざして強豪チームと戦っていきます。２人対戦プレイでは、通常の「ＶＳ　ＭＯＤＥ」とＰＫ対戦ができる「ＰＫ　ＭＯＤＥ」の２種類を用意。また、試合をじっくり観戦できる「ＷＡＴＣＨ　ＭＯＤＥ」も搭載されています。ハーフタイムの応援や試合後のスポーツニュースなど、楽しいイベントや演出面の見どころもたっぷりです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043504A/FFFD001B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043504A/FFFD001C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パワーイレブン<sup>&reg;</sup></span></div>
</div>
