...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ritorna Mike Jones, studente e... avventuriero galattico, per un'altra avvincente impresa che lo vedrà impegnato in un viaggio non più attraverso lo spazio, ma attraverso il tempo!
<br><br>
Questo gioco, sequel di StarTropics (anch'esso disponibile su Virtual Console), fu pubblicato solo in Nord America e fu uno degli ultimi titoli per NES. Zoda's Revenge racconta le prodezze di Mike, catapultato in un viaggio lungo l'arco della storia dell'umanità, dall'Età della Pietra fino al Selvaggio West.
<br><br>
Non solo avrai modo d'incontrare illustri personaggi storici come Leonardo da Vinci e Cleopatra, ma dovrai anche affrontare i vendicatori di Zoda, il capo degli alieni che Mike aveva sconfitto alla fine della prima avventura. Forse Zoda è pronto per tornare all'attacco?
<br><br>
