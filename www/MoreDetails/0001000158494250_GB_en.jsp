...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158494250')", "wiiSelectSound()");
...
<br><br>
Jack and Walter are two old fishermen in a fantasy world. <br>
They have found places where crazy fish leap out of the water all day long. <br>
The perfect place for a spot of fishing. It's a shame the other strange creatures aren’t going to make things easy!
<br><br>
With this surreal action game, you will experience the excitement of the great arcade classics on your Wii console. <br>
Hold on tight to your controller and fish 'em all!
<br><br>
Features:
<br>
- Nine colourful scenarios.<br>
- Three game modes: Arcade, Challenge, Fishtris.<br>
- One or two players.</div>
  <div id="image02">
