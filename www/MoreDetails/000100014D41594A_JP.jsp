...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">地球に襲来した凶悪な宇宙人を倒すため、神出鬼没のエイリアン・バスターズが街中を駆け抜ける、２人同時プレイも可能な爽快アクションゲームです。バズーカ使いのタフガイ・ゴードン、火炎放射器を振り回す紅一点・カーラ、電磁ムチを自在に操るロボットのスクーターの３人からプレイヤーを選択し、街を荒らすエイリアンたちを退治していきます。基本となるアクションステージの途中には、建物の中でガンを撃ちまくる３Ｄシューティングステージ、エイリアンを追って高速で走りぬけるスクロールステージも登場し、戦いを盛り上げます。配信中の『ゴールデンアックス』開発スタッフによる、アーケードで人気を博したゲームの移植作です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エイリアンストーム<sup>TM</sup></span></div>
</div>
