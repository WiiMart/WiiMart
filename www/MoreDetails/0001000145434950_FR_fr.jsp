...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Metal Slug 4 est le cinquième episode la série. Choisissez un mercenaire parmi 4 et battez-vous contre le groupe terroriste "Amadeus". Sautez et tirez habilement pour vous frayer un chemin en territoire ennemi tout en ramassant des bonus pour recharger vos armes.　Comme dans les episodes précédents, vous pouvez monter dans des véhicules et vous battre avec vigueur contre vos ennemis. De plus, Metal Slug 4 présente un tout nouveau système “Metallish” : système de bonus lié au score qui donne une nouvelle dimension au jeu. De nouveaux bonus et personnages ont été rajoutés, donnant un vent de fraîcheur à la série.<br><br>Texte écran en anglais.</div>
  <div id="image02">
