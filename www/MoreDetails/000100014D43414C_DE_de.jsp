...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Im Jahr 2025 bricht ein Krieg zwischen den Menschen und feindlichen Außerirdischen aus, und auch die sechzehnjährige Lucia muss gemeinsam mit anderen Starfighter-Piloten der Earth Federation in den Kampf ziehen. Als ihr Vater Ken von den Außerirdischen gefangen genommen wird, beschließt Lucia, sich den brandneuen Starfighter-Prototypen „Gley Lancer“ zu schnappen und ihren Vater zu retten. In diesem seitwärts scrollenden Shooter setzt du dich als Lucia ins Cockpit des „Gley Lancer“, rettest deinen Vater und besiegst die finsteren Außerirdischen, die darauf aus sind, die Menschheit auszurotten!
<br><br>
Bildschirmtext enthält Japanisch.</div>
  <div id="image02">
