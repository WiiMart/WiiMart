...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157524950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dans « Rainbow Islands: Towering Adventure! », tu incarnes Bubby ou Bobby dans leur escalade d’une tour de 7 niveaux consécutifs qui les mènera jusqu’aux cieux. Or, pour se débarrasser des ennemis dressés sur leur chemin, ils devront s’armer de leur courage et de leurs pouvoirs arc-en-ciel.<br><br>

Des boss de fin de niveau aux ordres du docteur Croissant, le savant fou, attendent nos amis au bout de chaque tableau. Fonce à travers chaque niveau dans le temps imparti pour découvrir la comète aux couleurs de l’arc-en-ciel : la comète de Holly !<br><br>

3 modes de jeu sont disponibles : suis le conte sur la comète de Holly dans le « Mode histoire », repousse tes limites avec le « Mode défi » et grimpe aussi haut que possible en<br> 
« Contre la montre » où il faudra
grimper plus vite que les autres
joueurs se mesurant à toi.<br><br>

« Rainbow Islands: Towering Adventure! » est un jeu d’action grisant où les arcs-en-ciel te mènent tout droit au paradis !<br><br>Texte écran en français.</div>
  <div id="image02">
