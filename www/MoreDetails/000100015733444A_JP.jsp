...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015733444A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『３℃』は同じ色の粒をつなげて一気に消す爽快感たっぷりのパズルゲームです。<BR>粒はつなげればつなげるほど、消したときに、より高得点を獲得できます。<BR>ハイスコアをWi-Fiランキングに登録すると、全国のプレイヤーとスコアを競うことが可能です。<BR>また、２人用の対戦モードでは対戦専用の特殊粒が登場するなど、１人用のモードとはまた違った要素を楽しむことができます。<BR>アンビエント・ミュージックと砂粒の流れが、『３℃』独特の世界を作り出します。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015733444A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015733444A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">３℃</span></div>
</div>
