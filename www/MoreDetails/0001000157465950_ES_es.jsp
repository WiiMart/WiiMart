...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157465950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Una colección de juegos clásicos en lápiz y papel. ¡Los favoritos de siempre para toda la familia! <br><br>
 
LOS JUEGOS<br>
• Squares – Los cuadrados.  <br>
• Nine Men’s Morris – El molino.   <br>
• Safe Cracker – La caja fuerte. <br>  
• Matchsticks – Las cerillas.   <br>
• Noughts & Crosses – Tres en raya.   <br>
• 4 In-A-Row – Conecta 4.   <br>
• BattleFleet – Hundir la flota.   <br>
• Hangman – El ahorcado. <br><br>

CARACTERÍSTICAS<br>
• Incluye ocho divertidos juegos clásicos que te cautivarán.<br>
• Muchas reglas diferentes y distintas variantes de cada juego. ¡Hay un montón de maneras de jugar!<br>
• Diversión para toda la familia: pueden jugar hasta cuatro jugadores en los torneos. <br>
• Veinte recompensas especiales y secretas para desbloquear.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
