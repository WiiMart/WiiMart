...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is the third instalment of the "The King of Fighters" fighting game series. It was released in 1996.<br><br>
The KOF series features an SNK all-star lineup, with characters from games like "Fatal Fury," "Ikari Warriors," "Psycho Soldier," and "Art of Fighting," competing with each other for the title of the world's strongest fighter.
<br><br>
This instalment adds in some major systematic changes compared with previous titles. It features small, medium, and big jumps, forward and back flip emergency escapes, and it adds the extra element of guarding in midair. Being able to review commands makes moves easier to execute and projectiles have been toned down. This title got rid of the idea of projectile spamming, being an effective approach which marked a major turning point in the series.</div>
  <div id="image02">
