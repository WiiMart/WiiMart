...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego clásico de disparos, adaptado para la consola NES en agosto de 1988, es un juego derivado de la célebre serie Gradius. Pilota el Vic Viper a través de seis niveles llenos de acción, alternando entre escenarios de movimiento horizontal y vertical, y enfrentándote a grupos de enemigos que no dejan de aparecer. Destruye a ciertos enemigos a lo largo del juego (que ocurre dentro de un extraterrestre gigante) para recoger cápsulas que aumentarán tus habilidades, y equipa tu nave con armas más poderosas, más velocidad y escudos que tú mismo podrás elegir. Utiliza las cápsulas con mucho cuidado, ¡ya que un guardián terrorífico te espera al final de cada nivel y no será fácil de eliminar! Puedes intentarlo solo o jugar simultáneamente con un amigo para superar el reto. ¿Tienes lo que hace falta para salvar a tu planeta?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146454E45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146454E45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Life Force</span></div>
</div>
