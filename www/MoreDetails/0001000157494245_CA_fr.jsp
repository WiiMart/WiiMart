...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157494245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tired of the same old thing? Have you been waiting for the next big thing in casual/cross-over games? Well, guess what? The next big thing in games has arrived! Bittos+ is all about rotating, moving, and placing game pieces onto a game board to make squares. Yes, you heard right, squares! And more importantly squares within squares! Some of the most exciting square action ever! And all because making squares makes Bittos! The more squares, the more Bittos!  What could be more fun? Playing Bittos+ provides hours and hours of entertainment for the whole family and boatloads of challenge and replay value for the most avid gamer. With multiple modes to unlock, game styles to suit every mood, multiple real-time reactive control methods, in-game Awards to collect, high scoreboards for both you and your household, Bittos+ sweeps you away, through luscious environments, and into a new game world, delivering on the commitment to a brand new gameplay experience.</div>
  <div id="image02">
