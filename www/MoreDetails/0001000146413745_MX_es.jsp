...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Yoshi es un juego de acción/acertijo que tiene como personaje principal a Yoshi, el dinosaurio amigo de Mario, que está prisionero dentro de un huevo. Ahora llueve Goombas, Bloopers, y Boo Buddies, y tienes que ayudar a Mario a detener esta invasión aérea. Cuando las criaturas caen, debes atraparlas en bandejas. Apila dos de un mismo tipo para que ambas desaparezcan o captura a un grupo completo entre dos cáscaras de huevo. ¡Si las dos cáscaras encajan, Yoshi saldrá y tu puntaje aumentará! El juego se vuelve más emocionante cuando los personajes caen más y más rápido. ¡Haz cambios y barajas sin dejar que tus pilas crezcan demasiado, para convertirte en el salvador del día!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146413745/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146413745/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Yoshi<sup>&reg;</sup></span></div>
</div>
