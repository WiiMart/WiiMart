...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157435550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">3-2-1, Rattle Battle! est un party game composé de mini-jeux sensationnels. Tout le 
monde peut s'amuser : saisis simplement la télécommande Wii et agite-la pour gagner. Amusant en solo, le jeu prend tout son sens entre amis ou en famille !<br><br>
Mini-jeux<br>
- Rattle In Time : agite la télécommande Wii en rythme !<br>
- Rattle Reflex : teste tes capacités de concentration !<br>
- Rattle With Caution : un, deux, trois, soleil version secousses !<br>
- Tight Rope Rattle : fais preuve d’adresse pour te déplacer en équilibre sur la corde tout en évitant les flèches !<br>
- Rattle-a-Kiss : pousse un 
grand timide à offrir un baiser 
à sa belle. <br><br>
Avec un total de 12 mini-jeux, tes amis et toi allez passer de nombreuses soirées agitées !<br><br>
