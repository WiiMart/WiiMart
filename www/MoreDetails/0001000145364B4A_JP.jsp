...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">平凡なサラリーマン「中村等」が「アルファー遊星人」から銀の力と超変身物質を授かり、正義のヒーロー「ベラボーマン」に変身して戦うアクションシューティングゲームです。プレイヤーはベラボーマンを操作して、悪の天才科学者「爆田博士」の魔の手から新田四丁目を救うべく全３２ステージのクリアをめざします。新田四丁目は、地上を舞台とするアクションステージと、強制スクロールする水中を進むシューティングステージの２種類からなります。体力ゲージがなくなる前に各ステージに待ち受けるボスを倒すと、ステージクリアです。アクションステージの操作は、ボタンを押す強弱によってジャンプや攻撃の距離が変化するというユニークなシステムが特徴です。また、敵を倒すと現れる「福」マークを集めると「福引男」がやってきて、体力回復や攻撃力をアップさせるアイテムなどさまざまなアイテムが手に入ります。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145364B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145364B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">超絶倫人ベラボーマン<sup>&reg;</sup></span></div>
</div>
