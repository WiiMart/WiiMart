...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ghouls‘n Ghosts is het vervolg op het populaire actiespel Ghosts’n Goblins, dat oorspronkelijk uitkwam in de speelhallen en vervolgens werd uitgebracht voor de Mega Drive. 
<br><br>
Op een nacht tijdens volle maan, drie jaar na het gevecht tegen Astaroth, doorboort een lichtstraal de prinses en wordt haar ziel, recht voor de neus van Arthur, gestolen. Om de ziel van zijn bruid te redden, moet ridder Arthur allerlei kwade, ondode wezens bevechten met een verscheidenheid aan wapens, krachtige magie en nieuwe acties.
...
<br>Handleiding alleen beschikbaar in het Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ghouls'n Ghosts<sup>TM</sup></span></div>
</div>
