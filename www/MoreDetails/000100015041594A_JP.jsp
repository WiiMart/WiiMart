...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ワルキューレの冒険」の続編として登場した、ファンタジックなアクションゲームのＰＣエンジン版です。物語の舞台は平和で豊穣な世界。その昔、神が人間にさずけた不思議な「黄金の種」は、黄金に輝く泉の水で育てると、どんな願いでもかなえるといわれていました。しかし、その力を利用しようと企む悪の化身「カムーズ」によって種は奪われ、地上は混沌の世界に変わってしまいます。プレイヤーは神の子「ワルキューレ」を操作し、再び世界を救うため、多彩な地形や敵の待つ各ラウンドをクリアしながら、北にある泉をめざします。ゲーム中は、武器と魔法による攻撃とジャンプというシンプルな操作ながらも、多彩なアクションが可能。さらに、それぞれのラウンドでは攻略ルートによって、さまざまなイベントが発生します。アイテムによって変化する攻撃や、軌道修正が可能なジャンプを駆使しながら、全７ラウンドを攻略してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワルキューレの伝説<sup>&reg;</sup></span></div>
</div>
