...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157413750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Toribash es un juego de lucha online en el que se te da la libertad de hacer tus propias jugadas! Utiliza la precisión de los sensores de movimiento para crear cualquier jugada que se te ocurra. La imaginación es el límite. Modifica las articulaciones de tu luchador para conseguir un impacto máximo y derrota a tus enemigos con golpes precisos. Mejora tus articulaciones para conseguir más rapidez y fuerza y golpear con más dureza. Después agarra a tus contrarios y acaba con ellos.
<br><br>
¿Quieres realizar tus propias películas de lucha? Utiliza el editor de repeticiones. Puedes visionar de nuevo tu lucha y movimientos en cualquier momento para descubrir esa alucinante jugada que dejaste escapar.<br><br>Textos de pantalla en español.
<br/><br/>
