...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">1990年代、世界中のアーケードや家庭用ゲーム機で大ヒットし、対戦格闘ゲームのブームの火付け役となったソフト。個性あふれる８人のキャラクターが世界の頂点を目指して熱き戦いを繰り広げます。十字ボタンと６つのパンチ・キックボタンを使いこなし、多彩なコマンドの必殺技が繰り出せます。スーパーファミコン版にはハンディキャップ戦などアーケード版にはないオリジナル要素も盛り込まれています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414A4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414A4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ストリートファイター<sup>&reg;</sup>Ⅱ</span></div>
</div>
