...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Last Blade 2, juego de lucha publicado originalmente en 1998, es la secuela de “The Last Blade”, lanzado un año antes. Esta entrega retoma la acción en el punto en que quedó la anterior: en el clímax alcanzado en las puertas del abismo. En esta ocasión, podrás elegir entre 16 espadachines con ganas desesperadas de blandir sus espadas.En esta edición podrás seleccionar entre dos tipos de espadas: Fuerza y Ataque, además de poder rechazar las embestidas enemigas con “Repeler”. Podrás también cambiar los movimientos especiales, como el “Corte Súper Secreto” o el “Corte Oculto Secreto” por el “Corte Sublime”, que conecta con el Corte Súper Secreto, como en la versión anterior. Además de esto, encontrarás nuevas característias como rechazos y guardias aéreas, o la capacidad de recuperarse al ser derribado.¡Todo ello para que lleves tus batallas a un nivel de diversión extremo!
<p>(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434545/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">THE LAST BLADE 2</span></div>
</div>
