...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Metroid Prime 3: Corruption, le jeu d'action/aventure le plus attendu de la Wii, sera en vente le 26 octobre. Téléchargez cette chaîne exclusive pour avoir un avant-goût de l'expérience inoubliable qui vous attend. C'est le petit cadeau de Nintendo pour vous aider à patienter pendant les quelques semaines qui vous séparent encore du retour de Samus!
<br><br>
Les différentes vidéos disponibles vous offrent un aperçu des éléments clés du jeu et de l'action intense typique de la série. Gardez un œil sur cette chaîne: de nouvelles vidéos seront ajoutées au fil des jours, jusqu'à la sortie du jeu! Découvrez ce que signifie "Aurora", admirez la célèbre Boule Morphing en action et bien d'autres choses encore grâce aux nombreuses vidéos de la chaîne!
<br><br>
Metroid Prime 3 Preview est disponible gratuitement, mais uniquement pour une durée limitée. Téléchargez cette chaîne sans plus attendre et préparez-vous à vivre l'épisode le plus épique de la série Metroid Prime!</div>
  <div id="image02">
