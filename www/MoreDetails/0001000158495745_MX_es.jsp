...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495745')", "wiiSelectSound()");
...
<p>
El planeta Zethos se encuentra bajo el control marcial de Thau-Phi, una Inteligencia Artificial renegada. Su dominio es absoluto y se extiende por todos los sistemas automáticos del planeta, incluyendo las legiones de robots obreros ahora convertidos en un impenetrable ejército de máquinas de combate sin ningún reparo por su propia existencia. Los únicos que pueden liberar al planeta y evitar una sangrienta invasión de las tropas de la Confederación son los tripulantes de la DST Horizon, un grupo de mercenarios elite que venden su gran pericia de combate al mejor postor.
<p>
Horizon Riders te permite controlar a cualquiera a de los cuatro miembros del escuadrón en su misión por derrotar a Thau-Phi, viajando a toda velocidad por la superficie de Zethos sobre un poderoso deslizador y derrotando al ejército cibernético con un arsenal de poderosas armas futuristas.
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495745/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495745/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
