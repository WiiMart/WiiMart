...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un planeta entero es tu laboratorio en este juego de simulación a gran escala. Los jugadores apoyan nueva vida fomentando su evolución y llevándola a alcanzar formas de vida más inteligentes. Guía a la civilización por la senda evolutiva hasta lograr el “Éxodo”, el objetivo culminante de colonizar otro planeta. El reto básico del juego es mantener un entorno habitable para las formas de vida regulando las condiciones atmosféricas y geológicas. Pequeños organismos llamados Procariotas y Tribrachidiums crecerán y evolucionarán en múltiples formas de vida. Hacer cambios bruscos es una fórmula segura para el desastre. La clave del éxito es hacer pequeños ajustes y observar las reacciones de las formas de vida. SimEarth también incluye planetas con entornos diferentes al de la Tierra como Marte y Venus. Intenta terraformar estos planetas de condiciones extremas en mundos donde la vida pueda prosperar.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000151413345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151413345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SimEarth<sup>TM</sup>: The Living Planet</span></div>
</div>
