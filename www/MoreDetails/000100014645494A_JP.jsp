...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８５年に発売されたカーアクションゲームです。カリフォルニア生まれの少女「クラリス」が、４ＷＤＳミッドシップのスーパーマシン「クラリスカー」に乗りこみ、ハイウェイを走り回ります。彼女を追いかけてカーチェイスを繰り広げるパトカーや、おじゃまネコ、タケノコなどの障害物にぶつからないように注意しながら、ステージ上のハイウェイをすべて走破して塗りつぶせばステージクリアです。ジャンプやオイル缶を駆使して妨害をしりぞけ、世界中の名所をまわっていきましょう。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">シティコネクション</span></div>
</div>
