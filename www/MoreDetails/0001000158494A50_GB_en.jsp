...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158494A50')", "wiiSelectSound()");
...
<br><br>In the year 2112 the masses are fascinated by extreme high speed races. The latest antigrav racing technology introduced phase shifting. The key to staying alive is to perfectly match the phase of the track with the racing machine.
<br><br>
Prepare yourself for a whole new racing experience at breakneck speeds. Push your skills to the limit to win races and beat records. Challenge  your friends to an all-out split-screen competition. Compete against ruthless opponents and race to the top of all leagues.
<br><br>
Warm up your engines, the future is now...</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494A50/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
