...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「スターソルジャー」をベースに、ハドソンの人気作をパロディ化したシューティングゲームです。プレイヤーが操作する機体は、広域へのビーム戦が得意な「パロシーザー」、破壊力満点のボムを放つ「ボンバーマン」、守備を固めながらホーミングで迎撃する「ＰＣエンジン」と三者三様。これらの中から１つを選び、カラフルで愉快なキャラクターたちが目白押しの全８ステージのクリアをめざして出動します。さらに通常モードに加えて、２分間と５分間のスコアアタックモードも搭載されており、やり込み要素もたっぷりです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スターパロジャー</span></div>
</div>
