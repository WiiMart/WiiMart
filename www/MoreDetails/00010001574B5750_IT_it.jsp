...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574B5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aiuta l'eroe del gioco a trovare gli oggetti nascosti e a tornare a casa. Puoi giocare in squadra oppure sfidare gli avversari in una gara di velocità.
Trova nel minor tempo possibile tutti gli oggetti, che siano conchiglie o gemme scintillanti! Durante l'avventura, dovrai affrontare fantasmi e, a volte, persino draghi!
Miriadi di oggetti e tanto divertimento ti aspettano in questo rompicapo con oggetti nascosti!
<br><br>
Ogni livello può essere giocato da un massimo di 4 giocatori. Gioca con la tua famiglia o con gli amici per completare i livelli più velocemente, oppure sfidali per vedere chi è più abile a trovare gli oggetti nascosti!
<br><br>
Negli 11 livelli, di cui 2 di azione, ci sono centinaia di oggetti da trovare! Ciascun livello è diverso dall'altro e gli oggetti cambiano posizione ogni volta che ricominci un livello. Il divertimento non finisce mai!
<br><br>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Avventura sull'ISOLA PERDUTA</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Aguzza la vista</span></div>
  </div>
