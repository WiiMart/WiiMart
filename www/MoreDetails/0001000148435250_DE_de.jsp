...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieser Wii-Kanal ist speziell für Spieler von The Legend of Zelda: Skyward Sword.
<br><br>
Er dient dazu, Speicherdaten zu reparieren, die unter bestimmten Umständen das Weiterspielen verhindern können. Wenn bei der Suche nach dem Heldenlied zuerst die Stimme des Donners in der Wüste erlernt wurde, werden Ereignisse nicht ausgelöst, die nötig sind, um die beiden anderen Stimmen im Wald und am Vulkan zu finden. Wenn du The Legend of Zelda: Skyward Sword nicht spielst, benötigst du diesen Wii-Kanal nicht.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435250/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
