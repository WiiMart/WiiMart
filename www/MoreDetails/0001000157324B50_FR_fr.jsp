...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157324B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jouez à la balle avec vos amis dans différents mini-jeux et essayez d’obtenir les meilleurs scores en utilisant votre Mii ou d’autres personnages ! Choisissez parmi six modes de jeux en solo ou multijoueur tels que Speed Catch, qui teste votre capacité à attraper une balle rapide, et Bomb Catch, un jeu d’élimination qui peut se jouer jusqu’à 4. Choisissez parmi une grande variété de personnages ou utilisez votre Mii pour jouer à vos autres jeux favoris. Si vous possédez déjà le jeu Let’s TAP, vous pourrez débloquer du contenu inédit en achetant le jeu Let’s CATCH dès maintenant.<br><br>Texte écran en français.</div>
  <div id="image02">
