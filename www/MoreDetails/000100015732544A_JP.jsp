...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015732544A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">教官は鬼軍曹。スリル満点のパーティゲームです。<BR>最大４人までで遊べるパーティゲームです。Ｗｉｉリモコンだけで楽しめます。<BR>鬼教官の訓練生になって様々な問題に答えてください。<BR>簡単なルールで、集中力や注意力、そして判断力などを使って遊ぶゲームがそろっています。<BR>失敗ばかりして鬼教官を怒らせると、ゲーム中でもようしゃないバツゲームが待っています。<BR>ゲームをやり込むことであなたのＭｉｉが使えるようになります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015732544A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015732544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">オニトレ～教官は鬼軍曹～</span></div>
</div>
