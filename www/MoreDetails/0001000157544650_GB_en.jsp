...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157544650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The BIT.TRIP series comes full-circle with BIT.TRIP FLUX: CommanderVideo’s final adventure.<br><br>
Grab your Wii Remote and get ready for classic paddle-based gameplay as CommanderVideo returns to the source.<br><br>
Whether playing in single-player or in two-player co-op, you’ll be faced with new challenges that will make even the most experienced BIT.TRIPPERS weep.<br><br>
Enjoy new challenges presented within the familiar paddle-based gameplay that started the phenomenon called BIT.TRIP.<br><br>
• New Power-Ups including the Fullscreen Paddle!<br>
• New Beat Types including Avoid Beats!<br>
• Mid-Level Checkpoints!<br>
• Classic BIT.TRIP BEAT Gameplay now with all the Modes including the new Meta Mode!<br>
• Bit Shifter Returns as the Chiptune Gueststar!<br><br>
Ride along with CommanderVideo as he completes his mission and returns... home.</div>
  <div id="image02">
