...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750364A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大人気の『プラレール』がWiiウェアに登場！<BR>プラレールの『Ｎ７００系新幹線』『Ｃ１２蒸気機関車』を運転して遊ぼう！<BR>Ｗｉｉリモコンを使って、マスコンや、ブレーキレバーを操作、プラレールを運転します。<BR>ゲームは1人でも2人でも遊べます！2人で遊ぶ時は1人が運転、もう1人がライトや、ワイパーをなどの他の操作をする協力プレイができます。<BR><BR>■ゲーム紹介<BR>①『Ｎ７００系新幹線』
新幹線を運転したり、駅に止まってお客さんを乗り降りさせるゲームです。最高時速300km/hのスピードで走ることが出来ます。<BR><BR>②『Ｃ１２蒸気機関車』蒸気で動く、蒸気機関車を運転して遊ぶゲームです。石炭を火にくべるゲームで、力をためて蒸気機関車を動かします。ゲームは、『みじかいろせん』モードから始まり、プレイすると新しいモードが増えていきます。モードによっては視点を切り替えて、山や、街を走るプラレールを眺める事もできます。<BR><BR>
■プラレールカードについて<BR>ゲームをクリアしていくと、カッコいいプラレールのカードがごほうびにもらえます。楽しく遊んで、２４種類のプラレールカードを全部そろえましょう。<BR><BR>■ご注意<BR>「プラレールカード」とはゲーム中のみで見ることのできるカードのことです。<BR>２人で遊ぶためには、Wiiリモコンが２つ必要になります。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750364A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750364A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ぼくはプラレール運転士</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">新幹線＆蒸気機関車編</span></div>
  </div>
