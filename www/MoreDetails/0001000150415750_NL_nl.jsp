...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dit is een vernieuwde versie van het klassieke arcadeschietspel Galaga.<br><br> Het speelt zich af in de verste uithoeken van het heelal waar je, vechtend in 29 ronden, de vijandelijke vesting op de planeet Galaga probeert te bereiken. De levels in het spel bestaan uit een aantal ronden met verschillende vijanden en achtergronden. Voor het nostalgische gevoel eindigt elk level nog steeds met Galactic Dancing. Met behulp van het nieuwe spelelement, Dimension, kun je je aanvalsroute bepalen. Verzamel capsules en open de Dimension Warps op de kruispunten om tegen nog moeilijkere vijanden te vechten.<br><br> De aanwezigheid van de Triple Fighter, de scrollende achtergronden, de eindbazen (Boss Galagans) en de nieuwe speciale effecten, maakt Galaga ’90 tot een waar meesterwerk.
<br><br>Handleiding alleen beschikbaar in het Engels, Frans, Duits, Spaans en Italiaans.<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150415750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150415750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">GALAGA<sup>TM</sup> '90</span></div>
</div>
