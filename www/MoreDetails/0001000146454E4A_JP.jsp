...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気シューティングゲーム『グラディウス』の続編。奇数面が横スクロール、偶数面が縦スクロールとなっており、全６ステージで構成されています。激しく迫り来る敵の攻撃をかわしながら敵を破壊していき、ステージを進めていきます。敵を破壊することで出現するパワーアップカプセルを取ることでミサイルやレーザーなどのパワーアップが可能です。２人同時プレイにも対応しており、協力して敵と戦うことができます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146454E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146454E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
