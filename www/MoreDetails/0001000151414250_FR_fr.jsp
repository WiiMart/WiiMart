...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ys Book I & II retracent le début de l’odyssée du jeune Adol Christin, un aventurier en quête d’un royaume légendaire.
Partez à la découverte de l’île d’Esteria et recherchez les indices qui vous permettront de dévoiler le terrible secret d’Ys.
<br><br>
Explorez les grottes ou les tours puis combattez les nombreux monstres à l’aide de votre épée ou de vos sorts magiques. Employez la ruse pour échapper aux labyrinthes truffés de pièges mortels.
<br><br>
Ys Book I & II, les premiers épisodes de la série Ys, ont été exceptionnellement regroupés sur un même CD-ROM pour la fameuse TurboGrafx. Ce jeu mythique au charme impérissable vous enchantera par son scénario captivant, sa musique magistrale, son doublage de voix unique et ses étonnants effets spéciaux. Découvrez sans plus attendre ce jeu culte, véritable pépite d’or du panthéon vidéoludique.
<br><br>
