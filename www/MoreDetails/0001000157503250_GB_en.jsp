...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157503250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In the puzzle game Potpourrii, everything revolves around the seasons.<br>
<br>
For centuries, the seasons have followed a set pattern. But then things start to go awry in the forest. Suddenly, it's snowing while the sun shines and flowers bloom while leaves are falling. Then a strange purple goo appears. The leprechauns are stunned. Even worse, the magic oak of life loses its power.<br>
<br>
It all turns out to be the fault of an evil wizard. You must help the leprechauns defeat him and restore natural order. To do this you need to collect seasonal spirits. Pick them up with the spirit cannon, shoot them at the center of the screen, group them and make them disappear. But watch out - they get faster and faster!<br>
<br>
In short:<br>
- A puzzle game that keeps you hooked<br>
- Colourful visuals and beautiful effects<br>
- Easy to use Wii Remote controls<br>
- Play alone or with a second player<br>
- Use your Mii character<br></div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">A delicate mixture of challenge and fun!</span></div>
  </div>
