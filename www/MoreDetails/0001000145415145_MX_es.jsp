...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">World Heroes 2 es un juego de lucha publicado originalmente en 1993 por ADK. Este videojuego presenta personajes basados en héroes mundiales que han dejado grabada su impronta en la historia, tales como Hanzo, Janne o el Capitán Kidd entre un total de 14 personalidades. 
<p>
Algunas de las características de este juego incluyen la posibilidad de repeler y devolver proyectiles, lo que hace su modo de juego tan simple como dinámico. Existen dos modos de juego: el Modo Normal, en el que vence el ganador de dos rondas, y el Modo Mortal, aún más extremo que en su versión anterior, con una cuenta de 10 y un sistema de muerte repentina. Ambos modos están pensados para mantener la emoción en batallas febriles que no te dejarán despegarte del mando.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415145/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
