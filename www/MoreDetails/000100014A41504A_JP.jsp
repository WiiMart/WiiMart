...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">シミュレーションＲＰＧ「ファイアーエムブレム」シリーズの４作目。本作では、マップが広大になり、
より緻密な戦略的要素がプラスされました。また、登場キャラクターの恋愛や、子どもに能力を引き継ぐ
ことも可能で、親子二代にわたる壮大なストーリーが楽しめます。キャラクターの成長を喜び、戦略に悩
む。やりこむほどに味がでる壮大で奥深いシミュレーションＲＰＧです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイアーエムブレム<sup>&reg;</sup>　聖戦の系譜</span></div>
</div>
