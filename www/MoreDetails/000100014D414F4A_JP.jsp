...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">街を埋め尽くした奇怪な生物たちを相手に戦う、２人同時プレイ可能な横スクロールシューティングゲームです。登場する敵は虫や魚などをモチーフにした不気味な生物たち。本物さながらの動きで襲い来る亜生命たちをなぎ払う４種類のプレイヤーもまた、生物と機械が融合した生体兵器です。一撃必殺のため撃ちエネルギー弾に加え、８方向への攻撃が可能な拡散弾や強力な追尾レーザーなど、プレイヤーによって異なる７種類のオプション兵器を装備しています。生々しい虫たちの動きと、不気味に響き渡るＢＧＭ、それらが一体となった独特の世界観も魅力です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クライング<sup>TM</sup>　亜生命戦争</span></div>
</div>
