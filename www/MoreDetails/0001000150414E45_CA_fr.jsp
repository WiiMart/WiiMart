...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Military Madness is a futuristic simulation game which throws the player into the middle of a war on the moon’s surface.  The rules are simple, making it easy for newcomers to enjoy the thrills of this war-strategy game!  You can see easy-to-understand, detailed instructions from the Title screen.  Military Madness is also turn based, allowing you to devise your strategy before you move.  To top it off, the units you have for each stage are already decided for you, allowing you to concentrate on commanding!  Utilize the terrain and surround your enemy to claim victory!  Fight through all 16 stages and thwart your enemy’s ambitions!</div>
  <div id="image02">
