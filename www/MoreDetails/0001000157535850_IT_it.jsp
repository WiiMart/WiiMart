...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157535850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stunt Cars si svolge su circuiti sopraelevati: dovrai prestare attenzione, se non vuoi uscire fuori strada! Utilizza il Turbo per far sfrecciare a tutta velocità il tuo bolide, ma ricorda: potrai farlo solo per un certo lasso di tempo in ciascuna gara.
<br>
Man mano che avanzi nei quattro campionati offerti dal gioco, sbloccherai alcune aree speciali, come i premi ricevuti dal pilota e nuovi veicoli con cui gareggiare.
<br><br>
CARATTERISTICHE PRINCIPALI:
<br><br>
- 24 tracciati convulsi e impegnativi, costellati da salti, rampe e tunnel
<br><br>
- Schermo condiviso per gare multigiocatore fino a 4 giocatori
<br><br>
- Scegli tra 6 auto differenti con diverse caratteristiche di peso, accelerazione e velocità<br>
<br>
- 12 premi legati agli obiettivi di gara, tra cui Gold Hero (Eroe d'oro), Track Warrior (Guerriero del tracciato), Stopwatch Pro (Mago del cronometro), Stunt Champion (Campione di acrobazie)
<br><br>
