...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574F4745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Papá, Mamá, Sarah y Billy vuelven para jugar al minigolf! ¡Juega en múltiples campos de golf con obstáculos como bumpers, rampas, ventiladores y muchos más! ¡Hasta ocho jugadores pueden jugar usando el Wii Remote! A ver quién de tus amigos es el mejor en cada campo. Puedes descargar nuevos campos para seguir divirtiéndote jugando al minigolf. Aumentan las apuestas, con campos de minigolf todavía más complicados de superar. ¿Puedes vencer en todos los campos y ser el campeón del minigolf?</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4745/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4745/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
