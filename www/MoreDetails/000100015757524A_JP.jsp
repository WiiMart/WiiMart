...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015757524A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコンソフト<BR>「エキサイトバイク」が<BR>見た目も、楽しさも、<BR>爽快感も、パワーアップして<BR>Ｗｉｉウェアで登場。<BR><BR>本作では、１人プレイだけでなく<BR>ニンテンドーＷｉ－Ｆｉコネクションで世界中のプレイヤーと<BR>Ｗｉ－Ｆｉ対戦ができるように<BR>なりました。<BR><BR>ファミコン版にもあった「コースエディター」では、オリジナルコースを作成できるだけでなく、<BR>ＷｉｉＣｏｎｎｅｃｔ２４で、<BR>作成したコースをＷｉｉフレンドと送り合えます。<BR>
<BR>これぞ、元祖エキサイトバイクの<BR>正統進化バージョンです。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100015757524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015757524A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エキサイトバイク<sup>&reg;</sup>　ワールドレース</span></div>
</div>
