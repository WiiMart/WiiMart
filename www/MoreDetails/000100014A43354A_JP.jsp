...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自由度の高いプレイが楽しめるロールプレイングゲーム「サガ」シリーズの第４作。伝説が語り継がれる世界マルディアスで、「ディステニィストーン」と８人の主人公たちの壮大な冒険がえがかれます。８人の主人公たちにはそれぞれの物語が用意されている上に、ゲームクリアまでの過程をプレイヤーが自由に選ぶことができる“フリーシナリオ”システムが採用されています。また、バトルでの戦い方や武器の使用回数に応じてキャラクターの成長の仕方が変わるシステムとなっているため、非常に幅広いプレイが楽しめます。発売当時、これまでに無い試みが数多く導入された新しいタイプのＲＰＧとして話題となりました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロマンシング サ・ガ<sup>&reg;</sup></span></div>
</div>
