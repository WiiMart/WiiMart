...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157495545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In Inkub you are responsible for the defense of incubators. Every incubator is connected to a life support system by means of transparent carbon tubes. For years, different organisms, viruses and bacteria, have formed colonies that attack the species in each incubator.
<p>
Your objective is to repel the attacks of these organisms and keep the eggs in the incubators safe. To do this, you have an arsenal of weapons, mines, and blockers available. The different weapons available to you will be unlocked as you progress in the game: laser canons, projectiles, blockers, mines, and speed inhibitors. Use them by placing them throughout the tube to repel enemy attacks.</div>
  <div id="image02">
