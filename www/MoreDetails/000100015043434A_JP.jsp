...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「南総里見八犬伝」をベースに、新たな設定で作られた和風アクションＲＰＧです。かつて人々を恐怖に落としいれた怨霊「玉梓（たまずさ）」の封印が何者かによって解かれ、再びかの国に滅びの危機が訪れようとしています。プレイヤーは伝説の八犬士の生まれ変わり「しん」となり、各地でアイテムや情報を仕入れ、同じ八犬士の血を引く仲間との出会いを果たして行きます。待ち受ける魔物たちとの戦いは「体当たり」が主な攻撃方法となっており、真正面からの衝突を避けつつ、敵の側面や後ろをねらって倒すとダメージが少なく効果的です。またゲーム中では、ボス戦などを除くほとんどの場面で手軽にセーブ、ロードすることができるため、手強い敵の攻略にもじっくりと打ち込むことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">魔界八犬伝 SHADA</span></div>
</div>
