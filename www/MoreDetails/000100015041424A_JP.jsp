...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">原始時代が舞台の横スクロール型アクションゲーム。遊び方は単純明快。敵の攻撃や痛いものを避けながら、頭突きで敵をやっつけます。ボーナスゲームや隠し部屋なども盛りだくさん。途中に出現する原始肉を食べると原人がＰＣ猿人、ＰＣ変人へと２段階にパワーアップし無敵になります。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＰＣ原人<sup>TM</sup></span></div>
</div>
