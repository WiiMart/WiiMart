...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157505545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BUST-A-MOVE Plus! es un juego de rompecabezas sencillo pero sumamente adictivo en el que pasarás horas de diversión reventando montones de burbujas de colores usando tu lanza-burbujas. Las burbujas reventarán con un sonoro “pop” cada vez que agrupes tres o más del mismo color. Hay dos modos de juego disponibles: 1P Puzzle (modo de rompecabezas para 1 jugador), en donde los jugadores tendrán que reventar burbujas en los 135 niveles del juego, buscando completarlos con la mejor puntuación o en el menor tiempo; y Battle (batalla), en donde podrás enfrentarte a otros jugadores o a oponentes controlados por la CPU. ¡Y si eso no fuera suficiente para satisfacer tu pasión por reventar burbujas, además existe la opción de descargar paquetes con contenido adicional con un total de 270 niveles extra! ¡Estamos hablando de 135 niveles por paquete! BUST-A-MOVE Plus! es fácil de entender pero lo bastante profundo como para hacer que vuelvas por más. ¿¡A qué esperas!?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505545/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505545/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BUST-A-MOVE Plus!</span></div>
</div>
