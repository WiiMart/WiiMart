...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo picchiaduro, uscito nel 1995, è il quarto titolo della serie Fatal Fury.<br>
È una serie che ha sempre avuto la particolarità di permettere ai giocatori di spostarsi sul piano posteriore (in profondità) per combattere su due piani diversi, ma il “3” di Fatal Fury 3 indica anche la nuova possibilità di sfruttare ben tre piani (posteriore, centrale e frontale), anche se dopo un certo periodo di tempo il personaggio torna automaticamente al piano centrale. Il gioco offre inoltre la possibilità di eseguire con facilità Tecniche combinate premendo semplicemente i pulsanti al momento giusto o le Super tecniche segrete popolarissime anche nel capitolo precedente e le ancora più devastanti Potenzialità latenti.<br>
Tutto questo, insieme ad alcune modifiche apportate alle tecniche segrete dei personaggi, contribuisce a portare il gioco a nuovi livelli strategici e ne aumenta ulteriormente la fruibilità.
<br><br>
Il testo all'interno del gioco può essere visualizzato in inglese, spagnolo e giapponese.</div>
  <div id="image02">
