...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015736424A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『５３０（ゴミゼロ）エコシューター』は、Ｗｉｉザッパー対応のガンシューティングです。ゲーム中での移動は自動で動く乗り物でおこなうため、足元の地形を気にせず、気軽に臨場感あるシューティングを楽しむことができます。<BR><BR>
ゲームの舞台は空き缶再生工場。宇宙から飛来した謎の生物、カンカン星人によって空き缶が乗っ取られてしまった。このままでは大事な資源である空き缶が奪われ、地球上からなくなってしまう。<BR>
この危機に立ち向かうため、一人の男が立ち上がった。撃った缶を分解し、ＧＥ（エネルギー）として回収する「リサイクルキャノン」を手に豪快に笑うその男こそ、空き缶再生工場の「オッサン」（主人公）。空き缶のリサイクルにかけては、「オッサン」の右に出る者はいない。<BR>
今、地球の空き缶の命運は「オッサン」の手にゆだねられた。<BR>
プレイヤーは、この「オッサン」となって、カンカン星人から空き缶を取り戻すべく戦うのだ。<BR><BR>
缶を撃つと出現するＧＥは、回収して弾として再利用します。これぞ究極のエコ！？<BR>
手持ちのＧＥが０になるとゲームオーバーです。ＧＥは弾として発射するのはもちろん、敵の攻撃を受けても減ってしまうので要注意。<BR>
空き缶の攻撃をかいくぐり、撃って、回収して、地球に優しく戦え！</div>
  <div id="image02">
    <img src="/oss/ccs/000100015736424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015736424A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">530 エコシューター<sup>TM</sup></span></div>
</div>
