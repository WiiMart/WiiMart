...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157424850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sei in netta inferiorità numerica, non ti rimane scelta: puoi solo batterti e cercare di vincere a tutti i costi! Solo le tue armi e una sottile lingua di sabbia, Blood Beach,  ti separano dallo scontro diretto con la potente marina imperiale giapponese.
<br><br>
Mentre tu hai dalla tua un incredibile arsenale comprendente il Browning M2, l'M1 da 40 mm e il famoso mitra Thompson, la marina imperiale giapponese ti lancerà contro tutto il possibile: i Mitsubishi A6M, i Mitsubishi G4M e perfino le navi da battaglia Takao, nell'instancabile tentativo di riappropriarsi delle isole Solomon.
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424850/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424850/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Blood Beach</span></div>
</div>
