...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574A4650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bienvenido al mundo de Gnomz. Gnomz es un nuevo juego "arcade" de lucha del servicio WiiWare™. Gnomz permite que hasta cuatro jugadores jueguen entre sí o contra la inteligencia artificial (IA) en tres modos de juego diferentes.<br><br>
