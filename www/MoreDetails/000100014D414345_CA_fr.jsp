...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dr. Robotnik is stamping out music and fun in Mobius with his giant, robotizing Mean Bean Steaming Machine. Before he turns all the citizens of Beanville into robots, you must save the day by gathering up beans in matching colors and defeating Robotnik's guards!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dr. Robotnik's Mean Bean</span></div>
</div>
