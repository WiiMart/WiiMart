...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mit dem Jam with the Band Live-Kanal kannst du auf deiner Wii-Konsole eine Jamsession starten und dabei deinen Fernseher als Lautsprecher verwenden!
<br><br>
Laden einfach den Kanal herunter und starte ihn. Unter „Verbinden: So geht's!“ erhältst du Informationen darüber, wie du deine Jamsession einrichten kannst.
<br><br>
Spiele deine Lieblingssongs allein oder mit Freunden. Du kannst auch mitsingen, allerdings wird deine Stimme nicht über den Fernseher zu hören sein.
<br><br>
Jeder Spieler benötigt ein Nintendo DS-System, aber es reicht aus, wenn einer der Spieler eine Jam with the Band-Karte besitzt. Spieler ohne eigene Karte können über DS-Download-Spiel teilnehmen.
<br><br>
Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434150/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434150/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Jam with the Band<sup>TM</sup></span></div>
</div>
