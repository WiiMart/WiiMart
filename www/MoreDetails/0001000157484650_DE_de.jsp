...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157484650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In Heavy Fire: Special Operations, einem Arcade-Shooter für WiiWare, trittst du einer elitären Militäreinheit bei. Nimm an gefährlichen Missionen im Nahen Osten teil und kämpfe im Panzerauto, im Helikopter oder als Fußsoldat. Du musst blitzschnell schießen können, um die Missionen zu beenden. <br><br>
Erspiele dir höhere Dienstgrade und clever konstruierte Waffen mit unglaublichen Eigenschaften. Wiederhole Missionen, um deine Ergebnisse zu verbessern, die du später in der Weltrangliste veröffentlichen kannst. Sammle Combos und vernichte Umgebungselemente, um deine Punkte in die Höhe schnellen zu lassen. <br><br>
Du kannst deine Gegner im Einzelspieler-Modus eliminieren oder dir im Mehrspieler-Modus Unterstützung von einem Freund holen. Wii Zapper kann hilfreich sein, ist aber keine Pflicht.
