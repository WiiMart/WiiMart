...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">大都会ニューヨークを舞台に繰り広げられる、横スクロールタイプのアクションゲームです。プレイヤーは主人公｢ビジランテ｣となって、悪の集団によってさらわれた愛しの「マドンナ」を救い出すため、単身で敵地にのりこみます。敵は「鉄パイプ」や｢チェーン｣、｢拳銃｣、｢オートバイ｣といったさまざまな武器を手に襲いかかってきます。連続攻撃が可能な｢パンチ」、間合いをとって繰り出せる「キック」、そしてステージ上に落ちているパワーアップアイテムの「ヌンチャク」を上手く使い分けて敵を倒し、各ステージの最後に待ち構えるボスを倒すとステージクリアです。美しいグラフィックで表現された「表通り」、「スクラップ場」、「ブルックリンブリッジ」、「裏通り」、「ファイナルラウンド」の全5ステージを闘い抜きます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ビジランテ</span></div>
</div>
