...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This landmark action-puzzle game has been a worldwide fixture in video games from the moment of its inception through to the present day, producing many sequels and related products along the way! 
<br><br>
...
<br><br>
In addition to the regular play mode, this version of the game features an Edit Mode that allows players to design their own stages, adding a new level of enjoyment to the game!</div>
  <div id="image02">
