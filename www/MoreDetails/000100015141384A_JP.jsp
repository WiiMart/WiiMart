...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">横スクロールタイプのＳＦシューティングゲームです。テラフォーミングされた近未来の火星を舞台に、プレイヤーはＡ国軍のＡ・Ａ（アームドアーマー）隊パイロット「グレッグ少尉」として敵に立ち向かいます。新型実験機の強奪や仲間たちの裏切り、大気圏突入と、ハードなストーリーがドラマチックに展開し、豪華声優による熱いセリフをふんだんに盛り込んだデモシーンがゲームプレイを盛り上げます。ストーリー中盤以降は、最新の試作機に乗り換えることで、武装交換システムの使用が可能になります。出撃前にどの武器を装備して行くかはプレイヤー次第。状況に合わせた適切な装備を見つけ出し、自機の反転、移動速度の変更などもうまく利用しながら敵を撃破してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スプリガン mark2</span></div>
</div>
