...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157435550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">3-2-1, Rattle Battle! is a party game packed with exciting mini-games. Intuitive controls mean that anyone can enjoy playing - just grab the Wii Remote and shake it to “rattle”. Great fun for single players, but the party really gets started when you play with friends and family!<br><br>
Mini-Games<br><br>
- Rattle In Time: Use split-second timing to rattle at exactly the right moment!<br>
- Rattle Reflex: Test your powers of concentration!<br>
- Rattle With Caution: Rattle to move forward when the bad guy's back is turned!<br>
- Tight Rope Rattle: Rattle to move across the high wire while dodging the arrows!<br>
- Rattle-a-Kiss: Gauge the correct rattle speed to give that shy guy a push so he flies in for a smooch.<br><br>
With a total of 12 mini-games, you and your friends are in for a rattling good time!</div>
  <div id="image02">
