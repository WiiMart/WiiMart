...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157455250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Plantas acuáticas ondulando...<br>
Peces nadando sin rumbo...<br>
My Aquarium es una relajante experiencia de Wii la cual te permite disfrutar de un acuario virtual en tu tiempo libre.<br><br>

Sin importar si son de agua dulce o salada, puedes escoger de entre 40 tipos de peces famosos; incluyendo los más conocidos como el Pez payaso ocellaris, el Pez ángel de agua dulce y la Arowana asiática. También puedes crear hasta seis acuarios diferentes y personalizarlos añadiendo decoración como algas o madera flotante.<br><br>

En My Aquarium, puedes enviar acuarios a amigos que tengas registrados. Se pueden establecer fechas especiales para los acuarios, como el cumpleaños de un amigo, el cual los peces conmemorarán con un baile.<br><br>

Da de comer a tus peces y observa bien como las crías se convierten en adultos. Tras reunir ciertas condiciones, ¡podrás hacer que se reproduzcan!<br><br>

Otra divertida característica te permitirá interactuar con tus peces utilizando el mando de Wii, ¡y podrás "golpear" el cristal de tu acuario!<br><br>Textos de pantalla en español.<br/><br/>
Como algunos de los servicios en línea de la consola Wii han dejado de estar disponibles el 28 de junio de 2013, ya no es posible acceder a las funciones en línea de este programa por medio de WiiConnect24.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455250/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
