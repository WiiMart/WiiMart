...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753334A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">最強を誇る「銀星チェス」シリーズの思考エンジンを搭載。レベルも五段階の幅広い強さで、初心者の方から上級者の方までチェスを楽しんでいただけます。また五人の個性豊かなキャラクター達がプレイヤーの相手をします。初心者の方には安心のヒント機能、研究にも使える棋譜再生機能など、対局を楽しむ為の豊富な機能を搭載しています。最大10個の対局データを保存する事ができ、対局途中での中断、棋譜研究の為に棋譜を保存する事ができます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753334A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753334A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">最強銀星チェス</span></div>
</div>
