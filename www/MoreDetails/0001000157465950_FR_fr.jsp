...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157465950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Voici une collection de jeux papier et stylo classiques pour toute la famille qui ont su traverser les âges!<br><br>

LES JEUX<br>
• Squares/Dots (Pipopipette)<br>
• Nine Men’s Morris/Mill (Jeu du moulin) <br>
• Safe Cracker (Combinaison du coffre)<br>
• Matchsticks (Allumettes)<br>
• Noughts & Crosses (Tic-tac-toe)<br>
• 4 In-A-Row (Puissance 4)<br>
• BattleFleet (Bataille navale)<br>
• Hangman (Pendu)<br><br>

 PRINCIPALES CARACTÉRISTIQUES<br>
• Inclut 8 jeux classiques extrêmement prenants<br>
• D'innombrables règles et variations pour des parties sans cesse renouvelées!<br>
• Un divertissement pour toute la famille : 2 à 4 joueurs peuvent s'affronter en mode Tournoi <br>
• 20 récompenses secrètes et spéciales à débloquer<br><br>Texte écran en anglais.</div>
  <div id="image02">
