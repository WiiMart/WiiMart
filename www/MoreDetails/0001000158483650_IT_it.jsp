...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158483650')", "wiiSelectSound()");
...
<br><br>
Una sonda esploratrice è stata inviata su uno strano pianeta per investigare sulla perdita di sonde precedentemente inviate e raccogliere informazioni.
 <br><br>
Dopo un atterraggio forzato sulla superficie di questo pianeta, il nostro eroe perde le abilità in suo possesso utili per la missione. Aiutalo a recuperarle con l'aiuto di strane creature che hanno preso possesso dell'interno della sonda... scopri cosa si cela dietro la sua nuova missione!
<br><br>
Potrai sfruttare la modalità avventura in diversi luoghi del pianeta, esplorando diversi cammini e scoprendo i molteplici segreti nascosti al loro interno.
<br><br>
All'interno della sonda esploratrice, potrai usufruire dell'aiuto di minuscole creature per riparare le zone danneggiate dopo l’incidente, recuperando così le tue abilità e accedendo ai file di memoria.
<br><br>
Nel caso tu non possa muoverti all'interno del robot, dovrai trovare le pietre d’ambra all’esterno e ottenere così nuove creature per andare avanti nei circuiti interni.
<br><br>
