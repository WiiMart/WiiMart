...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dr. Robotnik is stamping out music and fun in Mobius with his giant, robotising Mean Bean Steaming Machine. Before he turns all the citizens of Beanville into robots, you must save the day by gathering up beans in matching colours and defeating Robotnik's guards!<br><br>Does not support Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
