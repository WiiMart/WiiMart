...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Con 1080°: TenEighty Snowboarding potrai sperimentare le più emozionanti acrobazie di questo sport estremo. Questo classico del Nintendo 64 è allo stesso tempo un gioco accessibile a tutti e una fedele simulazione di snowboarding... e si può giocare stando comodamente al calduccio!
<br><br>
1080°: TenEighty Snowboarding presenta sei percorsi diversi e la possibilità di eseguire più di 25 trick con lo snowboard! Offre sei modalità di gioco, tra cui la sfida acrobatica, la corsa contro il tempo, l'allenamento e la possibilità di gareggiare testa a testa contro un amico o contro la CPU. 
<br><br>
L'impressionante grafica 3D rende in modo realistico gli effetti di luce, il riverbero della luce solare e i cambiamenti metereologici. L'atmosfera creata dalla fantastica colonna sonora completa questo splendido gioco invernale!
<br><br>Il testo all'interno del gioco può essere visualizzato in inglese, tedesco, giapponese e francese.<br>La funzione rumble del gioco originale non è disponibile.</div>
  <div id="image02">
