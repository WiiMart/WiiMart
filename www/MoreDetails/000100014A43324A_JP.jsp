...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ひとりの戦国武将「木下藤吉郎」が足軽頭から関白にまで出世していくサクセスストーリーを再現する、歴史シミュレーションゲームです。序盤は、毎月開かれる評定に参加して「織田信長」から主命を受け、それを忠実に果たす事で信長の信頼を得て、身分昇進をめざします。城主に出世すると自ら評定を開き、城の経営や人事、軍事をおこない他国を切り従えていきます。大名になると、すべての戦略を自分で立てることになります。全国をほぼ統一し、関白に叙任されればゲームクリアです。イベントとして発生する有名な歴史的事件は人生のターニングポイントとなり、いかに解決するかがゲームの進行を大きく左右します。史実通り「本能寺の変」が起こるよう進めることもできれば、史実と異なるストーリーとして、信長を攻めて謀反を起こしたり、信長の全国統一を補佐することも可能です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">太閤立志伝</span></div>
</div>
