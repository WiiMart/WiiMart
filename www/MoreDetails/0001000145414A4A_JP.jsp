...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">1996年にSNKからリリースされた「メタルスラッグ」は、サイドビューのミリタリーアクションゲーム。プレイヤーは特殊工作部隊ペルグリン・ファルコン隊（通称PF隊）のマルコ（1P）とターマ（2P）を操作して、モーデン元帥の打倒と盗まれた兵器“メタルスラッグ”の奪回を目指します。ゲームはショットとジャンプを駆使して進んでいきますが、ヘビーマシンガン、ショットガン、ロケットランチャー、フレイムショットといった武器を活用したり、しばしば登場するメタルスラッグに乗り込めば戦いを有利に進められることでしょう。二人同時プレイもサポートしており、友達と一緒にプレイすれば盛り上がることは請け合いです。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルスラッグ</span></div>
</div>
