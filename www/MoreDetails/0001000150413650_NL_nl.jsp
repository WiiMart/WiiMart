...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dit actievolle schietspel met een bovenaanzicht dring je diep door in vijandelijk gebied om de ontvoerde president te redden. Neem de rol aan van een commando van het Special Forces-team en bind de strijd aan met je vijanden met behulp van verschillende wapens, zoals machinegeweren en granaten. Verkrijg waardevolle informatie, wapens en voorwerpen door krijgsgevangenen te bevrijden. Vecht je een weg naar het einde van elk level en versla de eindbaas door behendig gebruik te maken van je wapens en uitrusting.
<br><br>
Deze versie van het immens populaire spel uit de arcadehallen valt op door de verfijnde graphics, het pakkende verhaal en de boeiende tussenfilmpjes, dus deze game mag je niet missen! Deze nieuwe, aangepaste versie bevat ook de niet eerder vertelde tweede helft van het verhaal, die uit de arcadeversie was weggelaten.
<br><br>
...
Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150413650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150413650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bloody Wolf</span></div>
</div>
