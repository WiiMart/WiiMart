...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">高い難易度にもかかわらず何度でも挑戦したくなるアクションゲーム「魔界村」シリーズ第３弾。スーパーファミコンのグラフィック機能を生かし、変化する地形や画面の全てを覆う大津波など、恐ろしくも美しい魔界が表現されています。主人公の騎士「アーサー」はさらわれたプリンセスを救い出すために、多彩な武器をうまく使い分け、新アクションの二段ジャンプを駆使して、魔物たちに立ち向かいます。青銅の鎧を装備すると武器がパワーアップし、さらに黄金の鎧を装備すると強力な魔法を使うことができます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">超魔界村<sup>&reg;</sup></span></div>
</div>
