...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001574D5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rilassati con l'antico gioco delle tessere. 
<br><br>
Mahjong offre 30 diversi layout del tradizionale gioco di abbinamento delle tessere in 3D, ciascuno con milioni di combinazioni diverse. Lo stile e l'interfaccia di gioco sono stati progettati per essere usati in modo semplice e intuitivo con il telecomando Wii. È possibile ingrandire la visuale premendo un tasto e la grafica può essere personalizzata con sei eleganti tipi di tessere e un'ampia varietà di sfondi.
<br><br>
Siediti, rilassati e goditi la sfida infinita offerta da Mahjong. Sono inoltre disponibili rompicapo addizionali con i minigiochi aggiuntivi Memory e Matching.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
