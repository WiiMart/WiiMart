...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494850')", "wiiSelectSound()");
...
<br><br>
Rage of the Gladiator es un juego de lucha ambientado en un mundo fantástico en el que deberás pelear en la arena para sobrevivir. ¡Demuestra lo que vales venciendo a todos tus adversarios!<br><br>
Características del juego:<br>
- ¡Uno de los juegos para WiiWare más espectaculares hasta el momento! Con gráficos 3D, animaciones, iluminación, sombras y efectos especiales alucinantes.<br>
- Doblaje completo (en inglés): cada jefe tiene su propia personalidad, ¡y se burla de ti sin piedad!<br>
- Ataques definitivos brutales: invoca un meteorito en llamas, un feroz tornado, ¡o transfórmate en un gigantesco coloso diez veces mayor que tú!<br>
- Personaliza tu personaje y especialízate en uno de los tres árboles de habilidades (Ataque, Defensa y Magia) para ganar nuevos poderes.<br>
- Un argumento fascinante: ¡querrás acabar el juego para saber cómo termina la historia!<br>
- Música épica: ¡disfruta de una emocionante banda sonora compuesta por el famoso Sean Beeson!<br>
- Enfréntate a nuevos retos: completa el juego para desbloquear el modo Challenge, ¡en el que los adversarios son mucho más fuertes y tienen nuevas habilidades! <br>
- ¡Compatible con Wii MotionPlus!<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494850/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494850/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Rage of the Gladiator</span></div>
</div>
