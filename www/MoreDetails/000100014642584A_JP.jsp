...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">縦・横に移動するシンプルなマップとわかりやすいシステムで、気軽に戦略シミュレーションをプレイできる、人気のシミュレーションゲームシリーズの１作目です。プレイヤーは「レッドスター軍」か「ブルームーン軍」のいずれかを指揮して敵軍と戦います。自軍の部隊を生産し、都市などの施設の占領や敵軍との戦闘を繰り返しながら、敵基地の制圧、敵軍の部隊の全滅や降伏を達成すると、勝利となります。現代兵器をデフォルメしたさまざまな部隊を使い分け、部隊同士の相性や地形効果にも気を配りながら敵と戦い、歩兵を進めて確実に施設を占領していきましょう。戦場の特徴を活かした戦略を練ることがポイントです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファミコンウォーズ<sup>&reg;</sup></span></div>
</div>
