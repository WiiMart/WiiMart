...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157524545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Do you like a challenge and motor sports? Racers' Islands - Crazy Arenas bundles five wacky challenges where there is no slowing down...
<p>
...
<p>
During these frenzied events, Crazy Arenas can be particularly catchy thanks to its unique gameplay style of driving with one hand while aiming with the other one.</div>
  <div id="image02">
