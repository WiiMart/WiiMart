...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">With the Internet Channel you can surf the internet from your sofa simply using the Wii Remote.
<br><br>
Check emails, look for the latest Wii games and post updates to your social networking sites using your Wii!
<br><br>
New in the Internet Channel is support for Adobe Flash Lite 3.1, so now you can watch even more videos than before!<br><br>
<b>Please note that Nintendo accepts absolutely no liability for any loss or damage arising from your using the Internet Channel, or from your inability to connect. </b>
<br><br>* Some Flash content may not be supported.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414450/FFFD0014" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414450/FFFD0015" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
