...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157455650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Préparez-vous à être attaqué par de dangereux virus dans ce jeu d’action ultra rapide ! Dans Viral Survival, vous contrôlez un petit ADN. Récoltez-en d’autres autour de vous et formez une chaîne. Vous devrez batailler pour esquiver les virus et les repousser avec vos armes. Que le combat commence !<br><br>Texte écran en français.</div>
  <div id="image02">
