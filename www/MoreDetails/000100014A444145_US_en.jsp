...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ages ago, evil beings created powerful creatures called Espers, and unleashed them against each other. The resulting battles left their world a smoldering rubble. Legend has it, the Espers destroyed themselves and most of humanity. Magic disappeared forever.
<p>
Centuries have passed and a rational world now exists with Espers living only in myths, until one frozen solid since the ancient wars is unearthed. Suddenly, there are reports of magic attacks on civilians. Imperial Commandos launch raids using magic-powered MagiTek weapons. Magic is obviously alive and the world is in danger again. Who or what is behind the rediscovery and redeployment of this legendary power? What chaotic plans exist that will wreck havoc on this orderly world?
<p>
Originally released as FINAL FANTASY III on the Super NES in North America, this game is in fact FINAL FANTASY VI from the main series chronology.</div>
  <div id="image02">
