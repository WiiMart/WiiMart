...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Based on the original SEGA GENESIS version, Sonic The Hedgehog was re-created as the first Sonic game for the SEGA MASTER SYSTEM. Not just a straight port, this version includes new stages, bosses, some different zones, and a level map. The most noticeable difference, however, was that the Chaos Emeralds had to be found within certain stages instead of in the Special Stages. Dash through six Zones, including special zones which were only available for the SEGA MASTER SYSTEM version, and face Dr. Eggman (AKA Dr. Robotnik) at the end of every Zone!</div>
  <div id="image02">
