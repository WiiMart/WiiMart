...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464850')", "wiiSelectSound()");
...
Serás el controlador de un aeropuerto muy activo. Dirige toda clase de aparatos a un lugar seguro y no dejes que choquen entre sí.
<br><br>
¿Te parece fácil? A medida que vayan llegando cada vez más aviones, necesitarás unos nervios de acero y una buena estrategia para mantener el caos bajo control. Para jugar, lo único que tienes que hacer es seleccionar los aviones y llevarlos a las pistas de aterrizaje con el mando de Wii. ¡Incluso puedes jugar con tu familia y tus amigos en un modo multijugador de entrada y salida rápida para un máximo de cuatro personas!
<br><br>Viaja a cinco aeropuertos distintos, incluyendo uno situado en el desierto australiano y un portaaviones. Controla 10 tipos de aparatos distintos, como reactores, helicópteros e hidroaviones.
Tardarás un minuto en aprender a jugar a Flight Control, ¡pero te costará bastante más dejarlo!
<br><br>
