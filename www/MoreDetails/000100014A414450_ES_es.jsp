...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El despiadado mago Agahnim tiene a Hyrule bajo su yugo y va a liberar a Ganon de su prisión en el Mundo de las Tinieblas. Como el legendario héroe Link, cumple tu destino y detén a Agahnim antes de que sea demasiado tarde.
<br><br>
The Legend of Zelda: A Link to the Past fue un hito en la serie Zelda con sus dos mundos paralelos repletos de armas y objetos, monstruos originales y un inmejorable guión sobre la épica lucha entre el bien y el mal.
<br><br>
La obra maestra de Shigeru Miyamoto introdujo elementos que se convertirían en estándares para las futuras entregas de la serie, y la excelente banda sonora de Koji Kondo está entre los mejores trabajos de su carrera. ¡The Legend of Zelda: A Link to the Past es un auténtico clásico de Nintendo!
