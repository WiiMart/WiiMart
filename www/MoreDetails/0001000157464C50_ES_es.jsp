...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464C50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A pesar de sus propiedades casi mágicas –puede pasar de estado líquido a sólido o gaseoso–, casi no pensamos en el agua en nuestro día a día, ¡y ya es hora de que recupere protagonismo!
<br><br>
...
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464C50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464C50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
