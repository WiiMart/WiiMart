...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157585050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Paint Splash turns your TV into an interactive canvas where kids of all ages can enjoy painting using the Wii Remote. Up to four people can paint at the same time so the entire family can participate in creating fantastic paintings using just your Wii Remotes.
<br><br>
