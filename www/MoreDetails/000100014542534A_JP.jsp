...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年にリリースされた格闘ゲームです。「龍虎の拳」の外伝作品にあたり、グラスヒル・バレーを舞台に様々な格闘家たちのドラマや戦いを描いています。リョウとロバート以外は全員新規キャラクターに刷新され、強力な空中コンボ、敵の攻撃を受け流すさばき、倒れた相手にダメージを与えられるダウン攻撃、１本で試合を終了させてしまうアルティメットＫＯなど、ゲームシステムも大幅に変更。さらにモーション・キャプチャーをベースにしたドット絵は非常に滑らかで、２Ｄ格闘ゲームの新しい境地を切り開いた作品となっています。
<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アート・オブ・ファイティング</span></div>
</div>
