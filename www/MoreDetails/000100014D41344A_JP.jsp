...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">幻想と魔法の世界「バハムート大陸」を舞台に、聖戦士・魔術師・エルフ・ドラゴンなど８つの勢力が、さまざまなモンスターを率いて大陸制覇を目指すファンタジー・ウォーシミュレーションです。政策と作戦を駆使するゲームシステムは、３つのルールと４つのシナリオで構成。４０の地域に分かれた大陸へ侵攻して領土を拡大します。本格的なヘックス式（六角形マス）画面も選択できる戦術画面で軍を指揮し、戦闘シーンはリアルタイムアクション方式を選べば大逆転も可能です。シンプルな画面の中で、入門者から上級者まで楽しむことができる、シミュレーションゲームのすべてが詰まった作品です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41344A/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41344A/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バハムート戦記<sup>TM</sup></span></div>
</div>
