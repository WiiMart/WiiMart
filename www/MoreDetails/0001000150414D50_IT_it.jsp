...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In questo GDR d’azione dovrai salvare la principessa rapita e recuperare gli 8 “medallions”, i medaglioni rubati dal demone Dirth.<br>
Trova gli ingressi ai labirinti usando la tua “bussola magica” e le informazioni che otterrai, quindi affronta i mostri che ti attendono nelle segrete.
Per trovare tutti i “medallions” dovrai attraversare "terra", "mare", "cielo" e diversi "mondi sotterranei".
Risolvi gli enigmi, evita le trappole, sposta i blocchi e scopri le stanze segrete dei labirinti abbattendone le mura!
Usa la mappa per scoprire tesori nascosti e potenti oggetti!<br> La funzione di salvataggio, il livello di difficoltà perfettamente equilibrato e un sistema di gioco che non comprende punti esperienza rendono Neutopia un titolo adatto a qualunque giocatore! 
