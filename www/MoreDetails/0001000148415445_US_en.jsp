...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000148415445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">An update is available that will make it easier for future users to download this channel. If you last updated this channel after September 14th, 2009, you will not see any changes if you update now.  For more details, see support.nintendo.com.
<p>
With the Nintendo Channel, you can learn about new services and products as well as receive information about Nintendo and third-party publishers. Watch video clips (now available in High quality) from a variety of titles both old and new, use an array of search options to find detailed information about almost any game you want, and get recommendations for other titles you might enjoy based on surveys submitted by people like you.
<p>
Used in conjunction with the Internet Channel, the Nintendo Channel can direct you automatically to title-specific websites, and to e-commerce sites from which you can purchase the title directly. Additionally, the Nintendo Channel can transmit Nintendo DS software demos directly from your Wii to your Nintendo DS series system so you can take a closer look at the titles that catch your eye.
<p>
By using the Nintendo Channel, you can easily discover Wii, WiiWare, Virtual Console, Nintendo DS, and Nintendo DSiWare titles that suit your tastes perfectly!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415445/FFFD0016" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415445/FFFD0017" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Nintendo Channel</span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">Wii Channels</div>
</div>
</body>
</html>
