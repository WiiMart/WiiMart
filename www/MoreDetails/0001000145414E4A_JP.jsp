...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『餓狼伝説』シリーズ第二弾となる２Ｄ対戦格闘ゲームです。前作に登場したテリー、アンディ、ジョーに加え、新たに５名の個性的な格闘家が最強の座をめぐり腕を競います。体力が減ってゲージが赤く点滅しているときに使用できる一発逆転の超必殺技が導入されたほか、前作で話題となった２ラインバトルも大幅に進化し、自らライン移動をおこなったり相手を別ラインに吹き飛ばしたりできるので、画面の奥行きを考えた戦いが楽しめるようになりました。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">餓狼伝説<sup>TM</sup>２　～新たなる闘い～</span></div>
</div>
