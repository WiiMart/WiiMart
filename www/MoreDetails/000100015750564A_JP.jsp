...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015750564A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">古びた洋館に眠る謎の絵本…不思議で、怖くて、ちょっと切ない物語の扉が開く。Wiiリモコンを使ったスローイング“くまなげ”で謎を解き明かす、新感覚のパズルアクションゲーム。不思議な男の子“キイナ”と一緒に絵本の世界へ。不思議な力で動く“紙のくま”をうまく投げ込こんで青い宝石を守ろう！30ステージをこえる謎解きのページがアナタを待っています。おはなしとステージが異なる「パズル編」も同時発売！両方を解き明かすと、さらなるなにかが…？</div>
  <div id="image02">
    <img src="/oss/ccs/000100015750564A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015750564A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">くまなげ・バトル編</span></div>
</div>
