...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">水のバクダンを操るカバが主役の横スクロール型アクションゲームです。平和なカバの国に現れた魔物「ファイヤーサタン」を倒すため、カバの子「ヒポポ」の冒険が始まります。プレイヤーは「ヒポポ」を操作して、ピラミッドや空中神殿などに仕掛けられたさまざまなトラップに挑みます。各ラウンドでは、水のバクダン「ミズバク」を当てて気絶した敵をけちらしながら進みます。ミズバクはボタン連打で遠くまでバウンドし、ボタンをため押しすることで大きくふくらみます。大きなミズバクは水量も多く破壊力抜群で、高所にあるアイテムも大量の水で流し落とすことができます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ミズバク大冒険アドベンチャー<sup>&reg;</sup></span></div>
</div>
