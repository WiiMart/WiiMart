...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157503350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pearl Harbor Trilogy - 1941: Red Sun Rising è il primo gioco di una trilogia basata su azione e combattimenti aerei per WiiWare.
<br><br>
Decolla dal ponte di una portaerei o da basi militari storiche e lanciati in attacchi furtivi, combattimenti aerei, voli di ricognizione e missioni distruttive. Pilota i caccia, i bombardieri e gli aerosiluranti della seconda guerra mondiale!
<br><br>
Potrai cimentarti in ben due campagne che abbracciano i primi anni della guerra del Pacifico, scegliendo di interpretare il ruolo delle forze di aviazione navale degli Stati Uniti o dell'Impero giapponese. Inoltre, puoi affinare le tue abilità di combattimento nelle modalità Avenging Ace (asso della vendetta) o Survival dogfight (combattimento all'ultimo colpo).
<br><br>
