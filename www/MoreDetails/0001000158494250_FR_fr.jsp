...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158494250')", "wiiSelectSound()");
...
<br><br>
Jack et Walter sont deux pêcheurs dans un monde imaginaire. Ils ont découvert l'emplacement idéal pour pêcher : un endroit où des poissons fous passent leurs journées à surgir de l'eau ! Mais attention... d'étranges créatures rôdent dans les parages... 
<br><br>
Grâce à ce jeu d'action surréaliste, découvrez sur votre console Wii tout le gameplay ultra divertissant des grands classiques vidéoludiques. Munissez-vous de votre manette, tenez-la fermement et préparez-vous pour une partie de pêche pas comme les autres !
<br><br>
Caractéristiques :
<br>
- Neuf scénarios riches en couleurs.<br>
- Trois modes de jeu : Arcade, Défi, Fishtris.<br>
- Un ou deux joueurs.<br><br>Texte écran en français.</div>
  <div id="image02">
