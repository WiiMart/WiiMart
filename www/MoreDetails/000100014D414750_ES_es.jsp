...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un malvado pirata del espacio, Greedy, ha corrompido a los reyes de los siete planetas del sistema Valdi y ha esclavizado a la gente que vive allí. La falta de un héroe se ve resuelta por Ristar, que utiliza sus increíbles brazos extensibles y valentía para salvar a Valdi de las manos de Greedy.<br><br>Textos de pantalla en inglés.<br>Incompatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
