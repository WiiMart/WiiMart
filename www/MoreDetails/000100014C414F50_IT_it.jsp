...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">R-TYPE è un classico sparatutto a scorrimento orizzontale, sviluppato da Irem nel 1987. Il gioco è ambientato nel secolo XXII e tu sei l'ultima speranza dell'umanità contro il malvagio Impero dei Bydo. La tua navicella si chiama R-9a “Arrowhead” ed è equipaggiata con un'arma standard, ma in ogni missione troverai potenziamenti sempre più devastanti!
<br><br>
Muoviti all'interno di otto impegnativi livelli che metteranno alla prova anche i riflessi del più incallito videogiocatore. La versione per SEGA MASTER SYSTEM contiene un esclusivo livello segreto che non si trova in nessun'altra versione pubblicata!
<br><br>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">R-TYPE</span></div>
</div>
