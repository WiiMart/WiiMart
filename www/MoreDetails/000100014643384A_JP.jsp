...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">悪魔城ドラキュラのファミコン・ディスクシステム用ソフト第二弾。前作までの２ＤアクションにＲＰＧの要素が加わった、アクションＲＰＧです。前作から７年後のトランシルバニアを舞台に、主人公のシモン・ベルモンドが自身にかけられた呪いを解くため戦います。各地に散らばるアイテムを求めて、街から街へと移動しながらダンジョンを攻略し、ドラキュラの身体の５つのパーツを集め、ドラキュラ城で焼き払い封印することが目的です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドラキュラII 呪いの封印</span></div>
</div>
