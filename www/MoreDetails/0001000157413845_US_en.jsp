...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157413845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Control a circular creature-like organism known as a rotozoan and nimbly make your way through level after level of primordial ooze. Comprised of only three distinct parts (colored sides, tentacles, and life force), the focus of your rotozoan life is simple: grow your tentacles.
<p>
...
<p>
Games in the Art Style series feature elegant design, polished graphics, and pick-up-and-play controls, creating an experience focused purely on fun and engaging game play.</div>
  <div id="image02">
