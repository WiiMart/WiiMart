...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015745364A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">あなたはイルカのトレーナー。魔法のスティック（Wiiリモコン）とヌンチャクを自在に操り、リアルなイルカのショーを演じることができます。イルカに芸を教えたり、イルカが優雅に遊泳する様をお好みのシーン、BGM、アングルで鑑賞もできる「ショーアクション・イルカ育成・プール鑑賞ゲーム」です。<BR>モードは３つ。「育成コミュニケーション」では、朝・夕・夜のシーン、BGM、カメラアングルを選択し、イルカが自由に泳ぐ様を鑑賞できます。また、ショーで演じる技を練習することで、よりおおきな技ができるようになります。さらにイルカをボールや浮き輪で遊ばせることもできます。<BR>「ショータイム」では、育てたイルカを自在に操り、あなただけのショーをフィギュアスケートのように演じて、得点を獲得することができます。Wi-Fiランキングに対応しており、ショーの得点で他のプレイヤーと順位を競うことができます。<BR>「SEAFARM選手権」では、アマチュア選手権からWorldイルカ選手権まで、イルカのショーを競う大会が行われます。全選手権を制覇し、世界No.1のイルカ使いを目指してください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015745364A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015745364A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SEAFARM</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">～イルカとわたしのショータイム～</span></div>
  </div>
