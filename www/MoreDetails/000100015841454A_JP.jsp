...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">戦闘機マンボウ－Ｊ（自機）を操作し、地球を消し去ろうとする巨大マンボウ型戦艦の破壊をめざす横スクロール型シューティングゲームです。ミサイルやワイドショットなどのパワーアップアイテムを駆使し、全８ステージのクリアをめざしてください。当時の他のコナミシューティングゲームと比べて難易度は大幅に低く設定され、敵や敵弾を消してくれる兵器が要所で登場することなどもあって、シューティングゲームに慣れていない人でも楽しむことができます。滑らかなスクロールと美麗なドットグラフィックが当時の話題を集めました。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スペースマンボウ</span></div>
</div>
