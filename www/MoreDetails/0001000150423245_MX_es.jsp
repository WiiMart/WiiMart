...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Disfruta los gráficos y controles mejorados en esta emocionante secuela del juego de acción tipo RPG Neutopia. Asume el papel del hijo del héroe principal y ve como la historia comienza con el aparente renacimiento de Dirth, el malévolo demonio. Una vez más necesitarás confiar en tu brújula mágica y la información que has reunido para localizar entradas en los laberintos y derrotar a los jefes. Atraviesa los campos, los cuales pueden ser traicioneros, para buscar y encontrar información y objetos secretos o mueve bloques y destruye paredes para descubrir habitaciones secretas. Al igual que el original, este juego viene con la función de guardado, un nivel de dificultad bien afinado, y una acelerada historia, haciendo de este juego un gran RPG que todos puedan disfrutar.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150423245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150423245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Neutopia II</span></div>
</div>
