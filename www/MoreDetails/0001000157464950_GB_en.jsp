...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157464950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Reel Fishing Challenge offers a fun and challenging experience for novice fishers and master anglers alike. Put your skills to the test and discover new types of fish in the challenging mission mode, or relax and enjoy the game at your own pace in free play mode. No matter which mode you play, the game's beautiful graphics and natural setting bring the fishing experience to life. Choose from a variety of lures to attract and hook the game's numerous wily fish.  Each fish looks and moves so much like the real thing, it's the closest you can get to real-life fishing without putting on your waders!
<br><br>
This title supports English, French and German languages in game.</div>
  <div id="image02">
