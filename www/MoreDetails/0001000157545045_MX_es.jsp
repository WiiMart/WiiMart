...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157545045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tetris Party es un juego de rompecabezas muy adictivo que parece fácil a simple vista y que seguro que mantendrá entretenidos a ti y a toda tu familia y amigos durante horas y horas. Este juego para WiiWare tiene diez variaciones de Tetris nunca antes vistas del modo para un jugador y multijugador, incluyendo Escalador, Corredor de etapas, Sombra y modos usando la Wii Balance Board. Además varios modos dan la oportunidad a los jugadores de sacar provecho de la capacidad única del mando de Wii para apuntar y disparar. Pero la fiesta no termina aquí. Diviértete jugando a Tetris online a través de la Conexión Wi-Fi de Nintendo, donde podrás jugar a Tetris en el modo multijugador con hasta cinco amigos a la vez. También puedes ver como mejora tu habilidad con Tetris Party comparado al resto del mundo usando el sistema de clasificación global.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545045/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545045/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Tetris Party</span></div>
</div>
