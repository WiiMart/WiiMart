...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Street Gangs es la versión europea actualizada del aclamado título japonés Downtown Nekketsu Monogatari, originalmente publicado para NES. Se trata de un juego que combina los géneros de lucha, acción y rol.
<br><br>
El argumento de Street Gangs gira en torno a dos amigos, Alex y Ryan, cuyo objetivo es salvar a Cyndi, la novia de Ryan, secuestrada por una banda de maleantes. Dispondrás de diversos ataques y armas para luchar contra los enemigos que vayas encontrando por el camino. Pero no solo se trata de luchar, pues tendrás que hacerte con diferentes objetos, mejorar las técnicas de lucha y cuidar el estado de los personajes, lo que le añade un elemento de rol. Algunos diálogos del juego son realmente divertidos.<br><br>
En su incursión por River City para rescatar a Cyndi, Alex y Ryan se enfrentarán a las numerosas bandas que pueblan la ciudad, cada una con su territorio y colores propios. 
<br><br>
En Street Gangs podrás escoger entre un modo de juego individual y otro donde es posible la cooperación entre dos jugadores.
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146445650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146445650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Street Gangs</span></div>
</div>
