...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157483350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stell dir Folgendes vor: Du ziehst in dein neues Zuhause ein und jedes Zimmer ist perfekt - jedes außer einem. Dir stehen alle Möglichkeiten offen, aber du bist ratlos.
<br><br>
An wen wendest du dich? Das Team von Home Sweet Home!
<br><br>
Home Sweet Home gibt dir die Chance, deine verborgenen Talente als Innenarchitekt zu entfalten. Wähle Möbel, Muster und Farben aus, um ein Meisterwerk zu schaffen, das deinem Kunden den Atem verschlägt.
<br><br>
Durch die einfache Steuerung, die gute Grafik und eine benutzerfreundliche Oberfläche ermöglicht dir Home Sweet Home, deiner Kreativität freien Lauf zu lassen. Denke stets daran: Ein Zuhause ist erst dann ein Zuhause, wenn es ein Home Sweet Home ist!<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157483350/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157483350/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Home Sweet Home</span></div>
</div>
