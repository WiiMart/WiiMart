...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Kirby, Dream Land’s resident hero (and everyone’s favorite puffball), must once again save the day when the mischievous King Dedede starts causing trouble. Kirby must travel through an assortment of levels, battling an exotic array of enemies (both new and familiar) determined to stop him from completing his mission. Always armed with his trusty ability for swallowing enemies and gaining special attacks, Kirby can now also unite with some of his animal friends and make use of their particular talents. Featuring detailed graphics, challenging boss battles, and the distinct charm of a Kirby game, it’s no wonder this title is considered a classic!</div>
  <div id="image02">
