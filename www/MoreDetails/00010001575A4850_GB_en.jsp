...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001575A4850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">"My Zoo" is a relaxing animal sim that puts you in the shoes of an animal breeder, raising up animals you'd normally only dream of. All it takes is a Wii Remote for a simple, yet fulfilling connection with nature.
<br><br>
There are 12 animal types in total (4 sold separately as add-on content). Select your favourites and nurture them to adulthood.
Feeding them, stroking them, and cleaning up their mess is a great way to form a lasting bond.
<br><br>
...
<br><br>
Game time passes much more quickly than real time, and the different animal types are active at various hours--some during the day, and some at night. Sometimes it's fun to just kick back and watch what they do.
<br><br>
So what are you waiting for? It's time to create your own personal zoo.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4850/FFFD0001" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
