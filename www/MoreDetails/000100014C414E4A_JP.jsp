...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気アクションシリーズ「アレックスキッド」の第三弾。アーケード用につくられたものをマスターシステム向けに移植したバージョンです。夜空に輝く１２の星座の光を取り戻すため、ラダクシャンの王子・アレックスキッド（アレク）がアスレチックな大冒険を繰り広げます。今回のアレクの活躍の場は奇想天外な７つの世界。おもちゃの世界やホラーの世界、機械や体内の世界など、不思議な空間をジャンプアクションで乗り越え、光のもと「ミラクルボール」を手に入れましょう。マスターシステムならではの鮮やかなグラフィックと、ＦＭサウンドにも対応した軽快なサウンドも人気を呼びました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アレックスキッド<sup>TM</sup>　ザ･ロストスターズ</span></div>
</div>
