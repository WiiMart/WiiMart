...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Greedy, een kwaadaardige ruimtepiraat, heeft de koningen van de zeven planeten van het Valdi-systeem omgekocht en de bewoners van deze planeten tot slaaf gemaakt. Er is een held nodig, en snel! Ristar twijfelt geen moment. Hij werpt zijn moed en zijn verbluffend rekbare armen in de strijd, om Valdi te verlossen van de gierige Greedy.<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans<br>Het spel is voorzien van Engelse schermteksten.<br>Geen ondersteuning van de interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ristar<sup>TM</sup></span></div>
</div>
