...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">敵の手に落ちた都市へ潜入し、時限爆弾を設置してすべてを破壊する、アーケードで話題を呼んだ２人同時プレイ可能のスニーキングアクションです。２１世紀初頭、破壊工作のプロフェッショナル・ベンとアンディに与えられた使命は、狂気の天才科学者の手に落ちた武装都市に潜入すること。地図を頼りに決められた場所へ爆弾を仕掛けてステージを進みます。２人に残された時間はわずか。待ち受けるさまざまな人工生命体の目を逃れながら迷路を脱出しなくてはなりません。ベンとアンディの武器はマシンガンですが、弾数は限られています。敵とやみくもに銃撃戦を行うだけではなく、壁に張り付いて相手をやり過ごしたり、たくさんの敵に囲まれた時には同士撃ちを狙ったり、時には格闘戦を行なって道を切り開きます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クラックダウン<sup>TM</sup></span></div>
</div>
