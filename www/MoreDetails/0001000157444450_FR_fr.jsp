...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157444450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Diner Dash, le meilleur jeu PC d'action et de gestion arrive enfin sur WiiWare ! Aidez Flo, une ancienne employée de bureau reconvertie dans la restauration, à bâtir un véritable empire gastronomique à l'aide de quatre restaurants uniques ! Jouez en ligne et affrontez d'autres joueurs en mode Duel ! Si vous vous sentez à la hauteur, jouez en mode Equipe avec un ami ou un autre joueur en ligne pour savoir quel restaurant est le meilleur ! <br><br> 

Contrôlez Flo pour guider les clients, prendre les commandes, apporter les plats, encaisser les additions et débarrasser les tables le plus vite possible. Utilisez les commandes pointer-et-cliquer, ainsi que les raccourcis pour aider Flo dans sa quête du monde culinaire. La satisfaction des clients est représentée par une jauge qui se vide lorsque ceux-ci perdent patience. Lorsque la jauge est complètement vide, les clients quittent le restaurant.<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444450/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444450/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
