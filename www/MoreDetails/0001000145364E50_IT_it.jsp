...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Solomon's Key è un "rompicapo d'azione" in cui dovrai guidare il mago Dana all'interno di un labirinto alla ricerca del Solomon's Key, un libro magico in grado di scacciare gli spiriti malvagi che infestano il mondo.
<br><br>
Dovrai usare i pulsanti per creare e distruggere i blocchi e imparare a usare le diverse tecniche e abilità che hai a disposizione per trovare le chiavi che ti consentiranno di aprire le porte. Il gioco consente di modificare le varie impostazioni, come il numero di vite e il livello di difficoltà, così potrai sempre creare la tua sfida personalizzata!
<br><br>
Il gioco è uscito per diverse piattaforme, ma la versione arcade, che enfatizza l'azione, lo rende un titolo ancora più avvincente, adatto a giocatori di qualsiasi livello di bravura, dai principianti agli esperti.
<br><br>
