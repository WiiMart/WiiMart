...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８６年の発売当時、多くのファンに名作と言わしめた縦スクロール型シューティングゲームです。プレイヤーは新型戦闘機「ＺＡＮＡＣ（ザナック）」を操作して、敵機械化軍団の要塞を破壊するために、森林地帯や宇宙空間などの特徴的な１２エリアを進撃していきます。ボックスを撃つと現れるパワーチップを集めることで自機を強化し、通常弾と８種類の特殊弾とを状況によって使いこなすのがポイント。また本作にはＡ．Ｉ．機能が搭載されており、プレイヤーの遊び方によって敵の行動が変化するので、ゲームの難易度がリアルタイムで変化します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＺＡＮＡＣ</span></div>
</div>
