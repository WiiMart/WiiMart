...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Vesti i panni di un super guerriero che deve affrontare minacce provenienti dal passato in questo picchiaduro a scorrimento ambientato a Washington rilasciato per la prima volta nel 1991. La caratteristica principale di questo titolo è la possibilità di cambiare il personaggio controllabile durante la partita. Liberando i prigionieri mentre ti fai strada nel gioco, inoltre, potrai ampliare la rosa di personaggi selezionabili. Per una strategia vittoriosa, utilizza nel modo più appropriato il cane ninja, il samurai o il ninja a seconda della situazione. Puoi anche raccogliere oggetti, tra cui armi o globi che ti permetteranno di eseguire attacchi magici. La tua avventura si svolgerà a cavallo tra  il mondo reale e universi paralleli dove i livelli di gioco cambieranno a un ritmo frenetico senza un attimo di pausa!<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
