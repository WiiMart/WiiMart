...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157524A50')", "wiiSelectSound()");
...
- Tons of content to discover: items, trophies, time trials...</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524A50/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
