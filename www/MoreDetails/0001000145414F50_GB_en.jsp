...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Unleashed onto the NEOGEO by SNK in 1991, King of the Monsters is a fighting game featuring mighty battles between giant monsters. Choose a character from six fearsome monsters and rampage across Japan, clashing with other monsters in order to become the ultimate champion.
<br><br>
Each character has access to standard punches and kicks as well as devastating special moves such as fire breath and high-energy beams with which to crush opponents. To be victorious, you must completely exhaust your opponent in battle and pin him for three counts. 
<br><br>
You can play single-player matches against the computer or multiplayer with a friend, either one-on-one against each other or as a two-person tag team taking the best the computer can throw at you!<br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
