...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157424B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ＡＲＫＡＮＯＩＤ Ｐｌｕｓ！は、バウスを操りエナジーボールで、全てのブロック消す単純明快なブロック崩しです。ブロックを崩すと発生する様々な効果を発揮するアイテムで、更に爽快感のあるブロック崩しが楽しめます。２人同時プレイが可能であり、「残機制」「バリア制」の２種類のルールから選べるなど、様々な設定でプレイが可能です。<BR>「アーケードモード」は全６１ラウンドで左右のラウンドに分かれており、最終ラウンドでは２種類のボスが出現します。「ＶＳモード」はＣＰＵやプレイヤー同士での対戦プレイが楽しめます。「タイムリミットモード」では制限時間内にラウンドをクリアする緊迫感あるプレイが楽しめます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＡＲＫＡＮＯＩＤ Ｐｌｕｓ！</span></div>
</div>
