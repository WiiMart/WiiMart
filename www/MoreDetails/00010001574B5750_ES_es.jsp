...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574B5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Colabora o compite en cada nivel para encontrar los elementos necesarios para que nuestro héroe pueda conseguir encontrar el camino de vuelta a casa. Desde conchas marinas a brillantes joyas, ¡esfuérzate al máximo para encontrar los objetos ocultos lo más rápido que puedas! Durante esta aventura también deberás enfrentarte a fantasmas e incluso a un dragón en algunos de los niveles de acción. ¡Encontrarás montones de objetos en cada nivel y sobretodo diversión a raudales en este juego de objetos ocultos!
<br><br>
En cada nivel pueden jugar hasta 4 jugadores para mayor diversión durante la partida. ¡Colabora con tu familia o tus amigos para completar rápidamente el nivel o compite para ver quién es el mejor en la búsqueda de objetos ocultos en cada nivel!
<br><br>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Aventura en la ISLA PERDIDA</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Juego de objetos escondidos</span></div>
  </div>
