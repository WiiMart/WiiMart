...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Originally released in 1991, this is not your typical baseball game. In the near-future, there are two leagues with a total of twelve teams the player can choose from; pick your team and go for the championship. The games are held at the exclusive Cyber Egg Stadium, where the home run zone is alarmingly small and the fair zone is unusually wide. There is even a stop zone; stopping any ball that lands here. As the game progresses Crackers (mines) are installed. Armor can be purchased during games to reinforce your players. All this makes for a unique baseball experience. You may be a bit perplexed at first, but once you get used it and begin devising a strategy, you might even start enjoying all the curveballs being thrown at you.</div>
  <div id="image02">
