...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">鎌倉時代の日本を舞台に繰り広げられる「純和風」ロールプレイングゲームです。幼い頃に「林省寺」という寺に預けられ、都の僧「法眼」によって育てられた少年「鬼若（きじゃく）」が仲間たちとともに、平和を取り戻すため、日本中に現れた魔物たちや数々の謎に立ち向かいます。旅の道中で現れる魔物を倒し、訪れた町で情報や装備を手に入れ、パーティーを強化していきます。実際の日本地図に則したフィールドや歴史にちなんだイベント、「鎌倉」や「京の都」をはじめとする馴染みのある地名などが続々登場し、プレイヤーをファンタジックなもうひとつの歴史へと案内します。キャラクターデザインは漫画家の本宮ひろ志氏です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">弁慶外伝</span></div>
</div>
