...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F424A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機となる小惑星（プレイヤー惑星）を重力と反重力を使って間接的に操作し、他の星を吸収して大きくなったり、サテライト（衛星）にしたりしながら宇宙空間を遊泳するアクションゲーム。それが『ＯＲＢＩＴＡＬ』（オービタル）です。<br><br>
操作方法は、Ａボタンで重力、Ｂボタンで反重力を発生させて軌道をコントロールするだけ！<br><br>
大きな惑星や隕石などにぶつからないようコントロールしながら、同じ大きさの惑星を吸収してプレイヤー惑星を大きくしていき、 「ゴール惑星」と呼ばれる惑星をサテライトにすれば、ステージクリアです。<br><br>
３０ステージ以上で構成された宇宙空間を自由に遊泳してください。<br><br>
独特の操作感と、象徴的にデザインされた惑星群のグラフィック、そして無駄をそぎ落としたサウンドが作りあげた、無限の宇宙空間。<br>
Ａｒｔ　Ｓｔｙｌｅ<BR>
<div align="right">『ＯＲＢＩＴＡＬ』。</div></div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F424A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F424A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">ＯＲＢＩＴＡＬ<sup>&reg;</sup></span></div>
  </div>
