...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157345450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You're about to embark on the most addictive experience in recent years. Steer your way through fifteen diabolic levels in which you'll have to reconstruct impossible figures, helped by space energy balls. Race against the clock and the obstacles to activate the correct boxes. Spaceball: Revolution will put your ability and your concentration to the test to the utmost. Spaceball: Revolution lets you compare your score with the best players world-wide in the different difficulty levels: Easy, Normal, Advanced and Master.
<br>
Spaceball: Revolution challenges you. Are you ready?</div>
  <div id="image02">
