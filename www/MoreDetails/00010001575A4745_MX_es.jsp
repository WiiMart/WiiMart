...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001575A4745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El objetivo del juego es poner su disco en cada “meta” usando el mínimo número de lanzamientos. Cada recinto del zoológico es un "hoyo" en el campo Zoo Disc Golf. En este juego, la "meta" es la estación de Emergencia para el control de animales de cada recinto del zoológico. Un lanzamiento del disco equivale a un tiro en golf y cuenta como un punto. Los personajes disponibles son Rockhopper Penguin, Kangaroo, Panda, y Meerkat.
<p>
El campo Zoo Disc Golf está compuesto por 18 hoyos. Cada jugador tiene permitido un máximo de diez golpes en cada hoyo. Si un jugador alcanza el máximo, avanza al siguiente hoyo y esos diez golpes se le agregan a su puntuación.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4745/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A4745/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Zoo Disc Golf</span></div>
</div>
