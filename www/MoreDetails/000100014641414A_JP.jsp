...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">さらわれた恋人レディをマリオが救い出すアクションゲーム。ドンキーコングが次々と転がしてくるタルをジャンプで飛び越え、ひたすら上へ上へと進んでいき、画面上にいるレディのところにたどり着くと面クリア。ゲームセンターで人気を博し、ゲーム＆ウオッチでも発売された記念すべきマリオのデビュー作です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドンキーコング<sup>&reg;</sup></span></div>
</div>
