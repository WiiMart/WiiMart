...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ein neuer Shooter in der “Star Soldier”-Tradition!<br>
Du bist SIA (Special Interception Airforce)-Pilot und steuerst den Kampfflieger “Soldier Blade”. Bekämpfe die Zeograd-Truppen mit Waffenangriffen, die wechseln, wenn du ein Power-Up-Item erhältst. Je nach Farbe deines Power-Up-Items kannst du drei verschiedene Angriffe freisetzen.<br>
Neue Funktionen, wie die “Gunbody”-Option, um Angriffen auszuweichen, und das “Burst Out”-System, das je nach Power-Up Level verschiedene Effekte hat, bieten neue strategische Möglichkeiten, dank derer du in kurzer Zeit darüber entscheiden kannst, welche Items du einsetzt und welche Spezialangriffe du anwendest. Tolle Endgegner warten an jedem Einsatzende.<br>
Spiele im “CHALLENGE”-Modus und versuche, so viele Punkte wie möglich innerhalb des Zeitlimits zu erhalten.<br>
Ein Feature-geladener Shooter, der heiße Action garantiert!
