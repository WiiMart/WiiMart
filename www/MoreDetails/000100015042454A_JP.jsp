...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">未来を舞台に繰り広げられる、５人同時プレイが可能なレースゲームです。レースに勝って賞金を稼ぎ、マシンをパワーアップしながらレースに挑みます。マシンには「タイヤ」や「ボディ」などの通常パーツのほかに、「スペシャルパーツ」と呼ばれる特殊な装備を搭載することが可能です。高い障害物をジャンプできる「ホッパー」や驚異的な加速の「ニトロブースト」をうまく使えば、ライバルたちに一気に差をつけることができます。また、前方に発射する「グレネード」や後方に落としていく「ボンバー」などの攻撃アイテムも用意されており、より直接的に相手をジャマすることもできます。全８ヒートを走り抜き、ライバルとの駆け引きを制して真のチャンピオンを目指します。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">モトローダー<sup>TM</sup></span></div>
</div>
