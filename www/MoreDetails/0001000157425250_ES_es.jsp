...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157425250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pirates: The Key of Dreams es un frenético juego de acción en el mar. Navega por el Caribe lanzando cañonazos, saqueando tesoros, burlando bloqueos y, por último, combatiendo contra el propio Barbanegra.
<br><br>
El jugador se hace con el control de un capitán de la Marina enviado en secreto como despiadado pirata para buscar y salvar The Key of Dreams, un valioso y peligroso artefacto maldito. Rescata náufragos para reforzar la tripulación de tu barco, obteniendo mejoras en el rendimiento de tu navegación, armamento, integridad estructural y habilidades cartográficas. Recoge armas cada vez más potentes incluyendo misiles, minas, disparos en cadena, espadas dentadas y un lanzallamas para liquidar a tus enemigos.
<br><br>
Juega contra tres de tus viles amigos o contrincantes IA en batallas campales multijugador en 35 niveles y en siete ambientes diferentes.  Elige entre diferentes tipos de embarcaciones, la que se adapte mejor a tu estilo de juego.  ¡Juega en modo turbo si eres un pirata de verdad!
