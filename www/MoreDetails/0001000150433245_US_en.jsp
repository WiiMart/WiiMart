...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is a different style of racing game, in which you attempt to catch criminals by chasing them and ramming their car off the road. Playing as two cops from the NYPD special “CHASE H.Q.” unit, the first half of each stage involves you maneuvering your unmarked car in a heated chase, followed by an action sequence in the latter half. Once you reach the target vehicle, you flip on your lights and siren, then try to stop the culprit by repeatedly colliding with them. Use your different gears wisely as you make your way through streets and around corners, and be careful not to hit objects or other cars, or you’ll lose speed. Also at your disposal are turbo units for temporary extra speed and ramming power.</div>
  <div id="image02">
