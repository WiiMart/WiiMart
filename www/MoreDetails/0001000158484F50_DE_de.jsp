...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158484F50')", "wiiSelectSound()");
...
<br><br>
Schnapp dir deine Wii Fernbedienung und fang an zu stapeln!
<br /><br />
...
<br /><br />
Spiel alleine oder zusammen mit einem Freund und löst die Puzzles gemeinsam. Oder tretet im Split-Screen-Versus-Modus auch gegeneinander an.</div>
  <div id="image02">
