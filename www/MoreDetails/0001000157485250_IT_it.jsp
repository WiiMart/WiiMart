...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157485250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Heron: Steam Machine è un gioco ambientato in una fabbrica, alimentata da un enorme motore a vapore, che produce paperelle di gomma. Il tuo compito è quello di controllare scrupolosamente i quattro indicatori posti ai lati del macchinario.
<br><br>
Collegando i tubi, otterrai punti e riuscirai ad abbassare il livello della pressione, permettendo al macchinario di funzionare più a lungo! Se uno degli indicatori raggiunge il livello massimo, il macchinario finirà per esplodere e la partita avrà termine.
<br><br>
Nella modalità multigiocatore, avrai la possibilità di cooperare con i tuoi amici per controllare la macchina a vapore. Quando giochi con due, tre o quattro giocatori, lo schermo si divide in diverse sezioni con sfondi di colore diverso. Ogni giocatore dovrà controllare il rispettivo indicatore indipendentemente dagli altri giocatori, per cui occorrerà un lavoro di squadra per collegare i tubi correttamente!!
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157485250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157485250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Heron: Steam Machine</span></div>
</div>
