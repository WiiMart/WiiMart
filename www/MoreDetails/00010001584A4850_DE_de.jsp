...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001584A4850')", "wiiSelectSound()");
...
<br><br>
Paint Splash verwandelt Ihren Fernseher in eine interaktive Leinwand, auf der sich Kinder aller Altersgruppen am Malen mit der Wiimote erfreuen. Bis zu vier Benutzer können gleichzeitig malen, so dass die ganze Familie an der Entstehung fantastischer Gemälde, nur durch das Benutzen der Wiimote, teilnehmen kann.
<br><br>
