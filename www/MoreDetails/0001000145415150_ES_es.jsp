...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">World Heroes 2 es un juego de lucha publicado originalmente en 1993 por ADK. Este videojuego presenta personajes basados en héroes mundiales que han dejado grabada su impronta en la historia, tales como Hanzo, Janne o el Capitán Kidd entre un total de 14 personalidades. Algunas de las características de este juego incluyen la posibilidad de repeler y devolver proyectiles, lo que hace su modo de juego tan simple como dinámico. Existen dos modos de juego: el Modo Normal, en el que vence el ganador de dos rondas, y el Modo Mortal, aún más extremo que en su versión anterior, con una cuenta de 10 y un sistema de muerte repentina. Ambos modos están pensados para mantener la emoción en batallas febriles que no te dejarán despegarte del mando.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
