...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742574A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">このゲームは、１つのサクの中にいる様々な動物達を、自分で新たなサクをつくって種類毎に分けることが目的の、パズルアクションゲームです。あなたは"サク"作りの匠となって、世界中の牧場を飛び回る旅に出ます。自分の牧場、南の大地、サバンナ、果ては極寒の北極まで、"サクサク"っとサクで動物達を華麗に囲ってください。充実の１人用モードに加えて、２人同時協力プレイを搭載し、盛り上がる事必至です。４人まで同時プレイ可能なミニゲームも満載。すべてのモードを、とことん遊び尽くしてください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742574A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742574A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サクサク アニマルパニック</span></div>
</div>
