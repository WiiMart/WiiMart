...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アドベンチャーゲームの黎明期にパソコン向けゲームソフトとして発売され人気を博したタイトルのファミコン移植版です。登場人物がすべて野菜や果物という世界観で、キャラクターのかわいさはもちろん、盛りだくさんのギャグ要素のほか環境問題を考えさせられる内容も話題となりました。物語は「サラダ王国」の貴族「パンプキン大臣」の反乱から始まります。パンプキン大臣はみずから「カボチャ大王」を名乗り、王女「トマト姫」を捕らえて閉じ込めてしまいました。プレイヤーは王国一の勇者「キュウリ戦士」となって、画面に表示されるコマンドを使って物語を進めていきます。情報やアイテムを集めながら「３Ｄ迷路」や「あっち向いてホイ」による戦闘を制して、無事にトマト姫を救い出してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146464C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146464C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サラダの国のトマト姫<sup>&reg;</sup></span></div>
</div>
