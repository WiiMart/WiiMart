...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prodotto nel 1996 da SNK, Metal Slug è un gioco d'azione di ambientazione militare ad avanzamento orizzontale. I giocatori controllano Marco (nella modalità per giocatore singolo) e Tarma (nella modalità per due giocatori), entrambi membri della squadra operativa speciale "Peregrine Falcon" (più comunemente nota come "Team PF"). Scopo del gioco è quello di sconfiggere il Generale Morden e di riconquistare l'arma da lui trafugata, il Metal Slug. I giocatori devono aprirsi un varco attraverso vari livelli saltando e sparando. L'utilizzo di armi speciali, come mitragliatrici pesanti, fucili, lanciarazzi e lanciafiamme, nonché del temibile Metal Slug (che appare di frequente nel gioco), agevola il combattimento. Il gioco presenta una modalità multiplayer, che permette di divertirsi con un amico.
<br><br>
Il testo all'interno del gioco è in inglese. Il tutorial è disponibile anche in portoghese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Metal Slug<sup>TM</sup></span></div>
</div>
