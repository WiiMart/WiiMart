...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">魔物たちによって危機をむかえたモンスターワールドを救うため、かつてこの国を救った伝説の勇者の子孫・シオンがさまざまな世界を冒険するアクションＲＰＧです。シオンは旅の途中で出会った人たちの協力を得たり、妖精やドワーフ、悪魔やドラゴンの子供を仲間にしたりしながら、おばけきのこやドラゴンなど、巨大なボスが待ち受ける恐ろしいダンジョンの奥深くへと進んでいき、長い冒険の終わりには、真の黒幕との対決が待っています。『ワンダーボーイ モンスターランド』から続く人気シリーズの３作目であり『ワンダーボーイ』シリーズを締めくくる集大成となる作品です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41564A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ワンダーボーイⅤ<sup>TM</sup>　モンスターワールドⅢ<sup>TM</sup></span></div>
</div>
