...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">うどんとそば、どっちが好き？<BR><BR>
「みんなで投票チャンネル」は、簡単な二択の質問に答えて、全国の参加した人の結果を見ることができたり、どちらの選択肢が多く票を集めるかを予想することができるチャンネルです。<BR><BR>
日本国内だけでなく、全世界で同じ質問をするワールドアンケートもあり、集計結果から国ごとの違いも楽しめます。<BR><BR>
質問に答えた結果は、グラフで確認することができ、自分と世の中とのギャップがひと目でわかります。また、予想した結果から自分がどれだけ世の中をわかっているか知ることもできます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148414A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148414A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">みんなで投票チャンネル</span></div>
</div>
