...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">美しいグラフィックと幻想的な音楽でいろどられた海の中を、イルカの「エコー」がすばやく華麗な動きで泳ぎまわる、人気アクションゲームシリーズの第三弾。さらにかわいらしくなったエコーが、シャチの子どもと赤ちゃんイルカという新たな友達とともに、クジラの「ビッグブルー」が住む「果てなき大洋」と呼ばれる海をめざしてミニゲームをクリアしていきます。シリーズの魅力はそのままに、息つぎなしに海にもぐれたり、パスワードが絵付きで覚えやすく表示されるなどの工夫がこらされ、子供から大人まで誰でも遊べるのが本作の特長。ゲームオーバーのない海の旅を存分に楽しんでください。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エコーJr.<sup>TM</sup></span></div>
</div>
