...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pour la première fois hors du Japon, découvrez le chapitre final de la série Monster World ! Incarnez Asha, une jeune aventurière, pénétrez dans le Monster World (Monde des monstres) et affrontez le mal aux côtés de votre fidèle compagnon Pepe et d'un génie, pour sauver les Esprits élémentaux en danger ! <br><br>Texte écran en anglais</div>
  <div id="image02">
