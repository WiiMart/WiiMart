...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tornato sulla Terra, Ecco scopre che in realtà la Vortex Queen non era stata davvero sconfitta e che l'ha seguito per creare un nuovo alveare. Quando Ecco ha usato la macchina del tempo per salvare il suo branco, ha spaccato in due lo scorrere del tempo. Ora Ecco deve ripristinare il flusso temporale per evitare il futuro di un mondo meccanico e morto, prosciugato dalla Vortex Queen.
<br><br>
Ecco dovrà affrontare ancora una volta le profondità del suo mondo per incontrare forme di vita marine, risolvere enigmi e sconfiggere la minaccia aliena!
<br><br>Il testo all'interno del gioco è in inglese, francese, spagnolo e tedesco.
