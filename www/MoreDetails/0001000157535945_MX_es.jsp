...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157535945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bienvenido a Snail Mail, el juego de carreras para WiiWare™. Como Turbo el caracol (Turbo the Snail), tu meta es recoger correo intergaláctico mientras navegas por rutas de entrega cada vez más dificiles. Las rutas de entrega se tornarán más complicadas conforme avanzas en el juego. Se tornan más elaboradas con vueltas y piruetas, brechas y vacíos, caídas, saltos, giros y espirales. También te encontrarás con otros obstáculos como babosas, sal, asteroides y torretas. Juega el breve tutorial en el Menύ principal (Main Menu) para aprender a navegar a Turbo, evitar obstáculos, destruir enemigos e incrementar habilidades.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157535945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157535945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Snail Mail<sup>&reg;</sup></span></div>
</div>
