...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157595350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to the town of Sunnyville! Search local yard sales on your mission to find hidden treasures and objects. Use your fantastic finds to decorate your dream home in a competition to win the illustrious "Superstar Homes Magazine Contest!" Beat the clock or play at your own pace, searching for hundreds of items hidden in fun locales. Enjoy nonstop challenges in this expansive seek-and-find game! 
<br>
Engaging Environments - Explore 12 themed locations to complete your mission to find hidden treasures while meeting quirky new characters along the way. 
<br>
Secret Hints - Discover hidden stars in every level that rewards players with bonus hints in order to get through levels faster.
<br>
Bonus Stages - Revisit locations to unlock all-new missions in a race to beat the clock.</div>
  <div id="image02">
