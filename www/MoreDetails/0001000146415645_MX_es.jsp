...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tecmo Bowl pone al jugador en contra de la computadora en un partido de acción final con 11 juegos y eliminación singular. En los modos de “acción” o “entrenador”, los jugadores pueden ir lado a lado contra un rival humano. También pueden elegir entre 12 equipos. En el ataque, usualmente hay dos jugadas de “correr” y “pasar” para elegir. El jugador toma control del “quarterback” antes de la patada y entrega al corredor o trabaja a través de la progresión de su receptor de arriba a abajo en la pantalla. La defensa consiste en intentar adivinar qué jugada de ataque va a elegir el rival y tomar control de uno de los defensores antes de la patada. Un medidor de poder muy simple es usado para hacer goles de campo, puntos extras y patadas.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
