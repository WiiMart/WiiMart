...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157554E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界中で大人気のカードゲーム「UNO」がWiiウェア向けに様々な機能を加えて登場します。さまざまな種類のルールを思いのままにカスタマイズできるほか、3つのゲームモードを搭載。マルチプレイヤーモードではローカルで4人、オンライン接続時には世界中のプレイヤーと最大6人での対戦が可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554E4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554E4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">UNO</span></div>
</div>
