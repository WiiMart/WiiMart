...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157503350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">„Pearl Harbor Trilogy – 1941: Red Sun Rising“ ist der erste Teil einer Trilogie von Luftkampf-Actionspielen für WiiWare.
<br><br>
Starten Sie von Flugzeugträgern und historischen Militärstützpunkten, um geheime Angriffe durchzuführen, an spannenden Luftkämpfen teilzunehmen oder Such- und Zerstörungsmissionen zu absolvieren. Steigen Sie in die Cockpits der besten Kampfflugzeuge und Sturz- sowie Torpedobomber des Zweiten Weltkrieges!
<br><br>
Dieses Spiel umfasst zwei Kampagnen, die sich über die ersten Jahre des Pazifikkrieges erstrecken. Sie können dabei auf Seiten der US Air Force oder der Kaiserlichen Japanischen Luftstreitkräfte in den Krieg ziehen. Darüber hinaus haben Sie die Möglichkeit, Ihre Fähigkeiten in den Luftkampfmodi „Avenging Ace“ und „Survival“ zu verbessern.</div>
  <div id="image02">
