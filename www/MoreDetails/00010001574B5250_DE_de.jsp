...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574B5250')", "wiiSelectSound()");
...
<br><br>
Graue, tapsige Kämpfer aus allen Ecken der Welt treffen in einem Turnier aufeinander, in dem festgestellt werden soll, wer der größte Kämpfer aller Zeiten ist. Wähle Deinen Karate Phant und kämpfe Dich mit Rüsselschlägen und Arschbomben bis zur Spitze.
<br>
Karate Phants: Gloves of Glory ist ein Kampfspiel für 1-2 Spieler, mit den durch Otto Waalkes bekannten Ottifanten. Kämpfe Dich gegen alle computergesteuerten Gegner durch das Turnier oder fordere einen Freund heraus.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Otto proudly presents</span></div>
</div>
