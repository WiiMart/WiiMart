...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In een wereld waar muziek de voertaal is, heeft een kwaadaardige krijgsheer uit het noorden het kasteel veroverd. De koningin is opgesloten in het binnenste van het kasteel en alle muziekinstrumenten van over de hele wereld zijn gestolen en weggeborgen!
<br><br>
Onze held Milon neemt het op zich om de strijd aan te gaan met de krijgsheer, de koningin te redden en haar magische kristallen ballen terug te vinden. Zijn enige hulpmiddelen zijn zijn vernuft en zijn magische bubbel. Help Milon te zoeken naar verborgen deuren, geheime voorwerpen te vinden en woeste vijanden te verslaan. Houd je ogen open voor winkels in het kasteel; hier kun je hints en waardevolle voorwerpen kopen.<br><br>
Mocht je een muziekdoos vinden, dan wordt Milon naar een bonuslevel getransporteerd.
Elk instrument dat je vindt voegt een nieuwe laag toe aan de achtergrondmuziek. Probeer alle zeven instrumenten te verzamelen voor een geweldig muziekstuk!
<br><br>
