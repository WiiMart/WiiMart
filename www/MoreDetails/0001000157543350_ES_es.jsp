...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157543350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Desplazamiento lateral a alta velocidad para entre uno y cuatro jugadores!  ¡Controla al ejecutivo Hitoshi Susumo, que llega tarde y no parará de correr hasta llegar a su fiesta de baile! Evita a los samuráis, tiranosaurios, vaqueros y extraños obstáculos de todo tipo usando solo un botón. Desafía a tus amigos y consigue la máxima puntuación en esta nueva experiencia de juego frenética.
<br>
<br>
CARACTERÍSTICAS
<br>
<br>
- Desplazamiento lateral a alta velocidad.
<br>
<br>
- Extraño y humorístico como ningún otro juego.
<br>
<br>
- Cómodo sistema de control con un botón. Es fácil aprender pero muy difícil dominarlo.
<br>
<br>
- Gráficos de colores con animaciones de gran calidad.
<br>
<br>
- 9 niveles que incluyen la luna, la selva y una ciudad.
<br>
<br>
- ¡El sistema de pantalla dividida para cuatro jugadores será el alma de tus fiestas!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157543350/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157543350/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
