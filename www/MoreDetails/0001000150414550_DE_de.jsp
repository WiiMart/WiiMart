...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Die Eliteeinheiten des außerirdischen Mutterhirns greifen die Erde an, und allein der Neo Caesar, ein Abfangjäger mit vier Angriffssystemen und zwei Spezialwaffen, kann der Invasion Einhalt gebieten und die Eindringlinge in ihre Schranken weisen!<br>Super Star Soldier ist ein Vertikal-Shooter nach klassischer Spielhallen-Tradition. Neben dem Standardmodus stellen mehrere Zeitmodi den Feuerfinger auf die Probe und laden zur Highscore-Jagd ein. Zusätzlich können alle Höchstleistungen in einem separaten Modus betrachtet werden.<br>Der Standardmodus besteht aus acht actionreichen Leveln, die von knallharten Endgegnern bewacht werden und dem Spieler keine Pause lassen!<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
