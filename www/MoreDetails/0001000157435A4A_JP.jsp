...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157435A4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">同じ色のウイルスに体当たりして攻撃。ＵＦＯの色を切替え、時には体当たり、時には避けてゴールを目指します。仲間のＵＦＯが加われば、その組み合わせで色を変える事も。リモコンを両手で持って１人で遊ぶか、友達に手伝ってもらうか。さらにもう１つリモコンを加えれば、３人で一緒に遊ぶ事も出来ます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">カラーズ</span></div>
</div>
