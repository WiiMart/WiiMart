...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157534A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das ultimative Spiel "Finde den Unterschied!" für WiiWare bietet dir 160 Szenen, drei Schwierigkeitsgrade und 1 600 suchbare Unterschiede!<br>
<br>
Spiele entweder allein oder mit Freunden (bis zu vier Spieler) und finde heraus, wer der beste Sucher ist!<br>
<br>
Durchsuche skurrile und attraktive Szenen in mehreren Kategorien: Landschaften, Tiere, Erholung und Lecker! <br>
<br>
Vier Spielmodi sind verfügbar:<br>
<br>
- Arkade:  <br>
  Szenen erscheinen in zufälliger Reihenfolge: Suche jeweils fünf Unterschiede.<br>
<br>
- Time attack: <br>
   Suche einen Unterschied in jeder Szene solange die Uhr läuft!<br>
<br>
- Szenen auswählen: <br>
  Spiele Szenen deiner Wahl und finde jeweils fünf Unterschiede.<br>
<br>
- Mehrere Spieler: <br>
  Spiele gegen deine Freunde (bis zu vier Spieler).<br><br> Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534A50/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Finde die Unterschiede!</span></div>
</div>
