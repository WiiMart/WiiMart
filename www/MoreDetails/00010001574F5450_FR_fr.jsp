...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574F5450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Overturn Mecha Wars est un tournoi de combats en un-contre-un dans lequel les joueurs contrôlent des méchas futuristes équipés d'armes de haute technologie.
<br>
Le but du jeu est de mitrailler son adversaire tout en évitant ses attaques, afin qu'il n'en reste plus qu'un.
<br><br>
Les joueurs peuvent personnaliser chacune des huit machines, en sélectionnant parmi un vaste arsenal d'armes spéciales que les joueurs enrichissent au fil de leur progression dans le tournoi.
<br><br>
Le jeu peut se jouer seul ou à deux joueurs en local (écran séparé).
<br>
Les joueurs peuvent également contrôler leur robot en déplaçant leur centre de gravité sur la Wii Balance Board !
<br><br>
Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F5450/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F5450/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
