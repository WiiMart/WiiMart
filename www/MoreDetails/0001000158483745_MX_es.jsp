...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483745')", "wiiSelectSound()");
...
<p>
Sombrías criaturas han tomado la escuela secundaria de Jake y tienes que guiarlo a través de cada uno de los salones de clase para que se reúna con su novia, Rachael. Las fuentes de luces existentes deben ser usadas inteligentemente para crear puentes de luz que permitan que Jake cruce. Un paso falso y Jake se hundirá en la oscuridad. En el camino encontrará versiones malévolas de los profesores contra quienes debes vencer para poder avanzar. LIT es un juego tipo rompecabezas de horror que requiere el Wii Remote y el Nunchuk. Contiene 30 niveles, 5 batallas con Jefes, modo de repetición, y varias bonificaciones extra incluyendo múltiples finales, Modo Oscuro con medidor de tiempo, y un personaje de bonificación extra.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483745/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483745/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
