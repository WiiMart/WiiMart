...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157504250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pub Darts è una semplice simulazione di freccette che si avvale dei comandi speciali del Wii per imitare il movimento del lancio delle freccette. Il gioco si svolge in un pub di quartiere dove il giocatore potrà scegliere tra vari tipi di partite tra cui 501, Cricket, Around the Clock, Killer e Baseball.<br><br>I controlli danno la sensazione di lanciare una freccetta reale e i giocatori possono creare profili personalizzati, selezionando un'immagine personale da una lista di personaggi fantasiosi e scegliendo l'immagine visualizzata sulle proprie freccette.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
