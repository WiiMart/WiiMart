...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157414250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Attrapez votre télécommande Wii et construisez un tas équilibré dans ce casse-tête basé sur les lois de la physique !
<br><br>
Les jeux de casse-tête doivent être prenants. C'était notre priorité numéro 1 durant le développement de ce jeu. Avec 100 niveaux à vous offrir, le jeu mettra au défi non seulement votre habilité mais aussi votre imagination. Le jeu est facile à jouer et difficile à arrêter.
<br><br>
Jouez seul ou invitez un ami à venir jouer en mode coopératif avec une deuxième télécommande Wii. Il y a même un mode "versus" à écran partagé pour deux joueurs pour encore plus d'amusement.<br><br>Texte écran en français.</div>
  <div id="image02">
