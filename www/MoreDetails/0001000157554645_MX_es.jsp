...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157554645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Sumérgete en la acción con Drop Zone! ¡Siente la adrenalina fluir a medida que te abres camino en una caída en picado!
<br><br>
Año 2070, la humanidad ha alcanzado las estrellas, dejando a la Tierra indefensa ante el ataque de robots alienígenas. Los humanos restantes han formado el Grupo de Defensa Regreso a la Tierra para rebelarse contra los jefes robots. Como parte del equipo de élite Drop Zone, tu misión es lanzarte en paracaídas a gran velocidad a través de las fuerzas enemigas y distribuir las provisiones.
<br><br>
Controla tu velocidad mientras maniobras entre incendios en una envolvente simulación en 360º de salto en paracaídas. ¡Consigue armas y bonificaciones, y siente la emoción de destruir las naves robot mientras intentas llegar al objetivo!
<br><br>
• Más de 100 niveles plagados de acción<br>
• El mejor simulador en 360º de caída libre en paracaídas <br>
• Emocionante perspectiva en primera persona<br>
• Gran detalle gráfico de la ciudad<br>
• Plagado de obstáculos, bonificaciones, enemigos y armas<br>
<br>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554645/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Drop Zone: Under Fire</span></div>
</div>
