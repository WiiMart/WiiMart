...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574C4550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Welcome to the world of the PooYoos, the first fun poetic braintrainer for children 3-6 years old. <br><br>

With the PooYoos, a merry band of adorable baby animals, children will have fun while learning the basics of their development: numbers, letters, lateral thinking, shapes, colours and more. Children get to dance with their new friends and can receive lovely interactive rewards. There are two levels of interactivity, so children can play whatever their age and level. <br><br>

This game has been designed for use by children who have not yet grasped reading.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4550/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4550/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Learning with the</span></div>
</div>
