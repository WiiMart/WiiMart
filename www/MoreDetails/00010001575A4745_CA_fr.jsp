...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001575A4745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The objective of the game is to get your disc into each “goal” using the fewest number of throws. Each zoo enclosure is a “hole” in the Zoo Disc Golf course. In this game the “goal” is the Emergency Animal Control station in each zoo enclosure. A throw of the disc is equivalent to a stroke in golf and counts as one point. The available characters are the Rockhopper Penguin, Kangaroo, Panda and Meerkat.
<p>
The Zoo Disc Golf Course is made up of 18 holes. Each player is allowed a maximum of ten strokes on each hole. If the maximum is reached by a player, he moves to the next hole and those ten strokes are added to his score.</div>
  <div id="image02">
