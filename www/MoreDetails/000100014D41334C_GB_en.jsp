...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The object of this head-to-head puzzle game is to clear your grid of falling blobs, called puyos, by forming chains of four or more puyos of the same colour in a straight line or one of several geometric patterns. What makes this a challenging two-player contest is the fact that when you clear a chain of puyos from your grid, it drops filler into your opponent’s grid. The more puyos you clear, the more you fill your opponent’s grid, and if you can clutter up their grid enough to fill it to the top, you’ve won the game. An intriguing backstory makes this an amusing diversion for one or two players.<br><br>In-game text will include some Japanese.
<br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
