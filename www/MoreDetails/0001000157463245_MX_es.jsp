...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157463245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ponte en el lugar de la hija del Darklord y prepara trampas y monstruos dentro de la torre para aniquilar las interminables oleadas de aventureros que quieren invadir tu castillo en este juego de rol. La única manera de evitar que los aventureros destruyan el cristal oscuro del último piso de la malévola torre es plagándola de monstruos y trampas llamadas “Artefactos”. ¡Mueve tu torre por todas las tierras y conquista cada lugar hasta conseguir dominar el mundo entero!</div>
  <div id="image02">
