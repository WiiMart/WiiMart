...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157573250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Continúa la búsqueda de Wally, sus amigos y mucho más en el viaje fantástico 2! <br>Basado en la exitosa serie de libros, ¿Dónde está Wally? El viaje fantástico 2 te ofrece la aventura de búsqueda definitiva en los mundos mágicos de Los Malos Malísimos, Las Guerreras Del Bosque, Los Buceadores De Las Profundidades y muchos más! Desafía a tus amigos o juega solo mientras buscas objetos ocultos. ¡Prepárate para las sorpresas y únete a la diversión!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">¿Dónde está Wally?<sup>&reg;</sup></span></div>
</div>
