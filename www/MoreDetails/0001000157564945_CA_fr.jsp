...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157564945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Violin Paradise is a game designed for up to four people. Players can choose to be a conductor, violinist, violist or cellist as they are tasked with performing some of the most beautiful classical pieces in history.
<p>
The game includes a micro-orchestra, which helps players feel the enjoyment of a group performance and the delight of accomplishment. Now let's begin the game and enjoy playing classical music and modern compositions in a fun way. The game environment dynamically changes and can be enriched with more objects if you play successfully. Check the background and see if it is changed by your play.</div>
  <div id="image02">
