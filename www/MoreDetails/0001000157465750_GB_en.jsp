...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157465750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">While our heroine Follie is travelling to her auntie with a cargo of mystical Flowerworks seeds, her ship is pulled off course and crash-lands in a particularly dull area of the planet Elilia.<br>
<br>
Explore with Follie and help her recover her seeds to transform the world from drab to fab! You'll encounter strange inhabitants, some of whom will help Follie in her quest, and some who will hinder, such as naughty garden gnomes.<br>
<br>
'Flowerworks: Follie's Adventure' is a one or two player adventure which combines blooming flowers, colourful fireworks, exploration, and a whole lot of fun. It includes Adventure, FreePlay and
Tutorial game modes, five difficulty settings and a 20 hour epic adventure.<br>
<br>
'Flowerworks: Follie's Adventure' is an enhanced version of the original 'Flowerworks', with two-player co-operative play, new Beginner & Mastery difficulty levels, in-game support for 4 languages (English, French, Spanish & German) and even more surprises.</div>
  <div id="image02">
