...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157544650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La boucle de la série BIT.TRIP est maintenant bouclée avec BIT.TRIP FLUX, l'ultime aventure de CommanderVideo.<br><br>
Attrape ta télécommande Wii et profite d'un jeu de raquette de type arcade pour le retour aux sources de CommanderVideo !<br><br>
En solo ou à deux, tu devras relever de nouveaux défis à faire pleurer les BIT.TRIPPERS les plus expérimentés.<br><br>
Relève de nouveaux défis et profite du fameux gameplay qui a lancé le phénomène BIT.TRIP.<br><br>
• Nouveaux bonus, dont la raquette plein écran !<br>
• Nouveaux beats, comme les Avoid Beats !<br>
• Points de passage à mi-niveau !<br>
• Le gameplay original de BIT.TRIP BEAT avec tous les modes, dont le nouveau Meta Mode !<br>
• Le retour de Bit Shifter comme Chiptune Gueststar !<br><br>
Surfe sur la vibe avec CommanderVideo tandis qu'il termine sa mission et... rentre chez lui.
<br><br>
