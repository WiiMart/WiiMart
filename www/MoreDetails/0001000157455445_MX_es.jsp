...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157455445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Entra en el mundo de PictureBook Games: Pop-Up Pursuit y disfruta de un juego de mesa familiar que transcurre en un libro cuyas imágenes saltan de cada página abierta. Pero en este juego no avanzarás mediante el uso de un dado, usarás cartas (que pueden auxiliar o retrasar tu progreso) y monedas (que sirven para comprar más cartas o incrementar sus efectos, pero no olvides que al final del juego te servirán para ganar). También encontrarás que los espacios en el mapa juegan un papel importante para determinar el resultado del juego y que cada uno de los oponentes controlados por la computadora tiene su propia personalidad y comportamiento. Y por si todo eso fuera poco, cada vez que el misterioso libro de Magick sea abierto, se desencadenarán ciertos eventos cuyas consecuencias dependerán de la forma en que cada jugador se haya comportado. Esta mezcla de juego emocionante, combinada con un ambiente encantador y artístico da a Pop-Up Pursuit una profundidad de juego que hará que quieras jugarlo una y otra vez.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157455445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">PictureBook Games<sup>TM</sup>: </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Pop-Up Pursuit</span></div>
  </div>
