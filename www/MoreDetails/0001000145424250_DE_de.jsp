...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieses rasante Beat’em Up-Spiel ist der zweite Teil der beliebten “Fighter’s Story”-Serie. Wieder einmal spielt sich die Action auf dem Kampfsport-Turnier „Great Grapple“ ab, wo 13 Teilnehmer in dramatischen Wettkämpfen ihre Kräfte messen. 
<br><br>
Die Spielmechanik zeichnet sich durch eine Reihe geheimer Spezialattacken sowie ein Schwachpunkt-System für jeden Kämpfer aus, das zahlreiche Knock-Out-Techniken ermöglicht. Das Erlebnis wird dank der Möglichkeit, die beiden Boss-Charaktere Clown und Karnov selbst steuern zu können, noch intensiver.
<br><br>
Erfüllst du bestimmte Voraussetzungen, so kommst du in den Genuss des Zusatz-Features: Hier musst du dich dem mächtigen Ochsen aus dem Bonus-Level des Spiels „Karate Champ“ von Data East stellen.
<br><br>
