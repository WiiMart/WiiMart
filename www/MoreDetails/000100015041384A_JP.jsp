...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">２人同時プレイが可能な横スクロールタイプのシューティングで、美しいグラフィックと軽快なＢＧＭが人気を呼んだアーケードゲームからの移植作です。「悪人クボタ」にさらわれた婚約者「香奈」と原子変換装置「オーダイン」を取り戻すため、天才科学者「泊博士」は助手の「サンデー・珍」と共に「マイシップ」に乗り込んで追撃を開始します。プレイヤーは、空中、水中、洞窟などを舞台にした全７ステージを襲い掛かる敵を退けながら進み、敵を倒して「クリスタル」を集めれば、「空中ＩＮ」でアイテムを購入し、マイシップをグレードアップさせることができます。各ラウンドの最後に待ち構えるボスを破壊するとラウンドクリアとなり、最終ラウンド「クボタワールド」のクボタを倒せばゲームクリアです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">オーダイン<sup>&reg;</sup></span></div>
</div>
