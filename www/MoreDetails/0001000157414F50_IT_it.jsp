...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157414F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Very Hungry Caterpillar’s ABC (L’ABC del piccolo Bruco Maisazio) è un gioco educativo che consente a genitori e figli di divertirsi insieme familiarizzando con le basi della lingua inglese.<br><br>

Il gioco consiste di quattro parti, che includono un divertente e colorato alfabeto illustrato da Eric Carle e un quiz adatto ai bambini in età prescolare basato su sostantivi, numeri, colori, forme, animali, oltre a verbi e aggettivi semplici come “run” (correre), “eat” (mangiare) e “big” (grande).<br><br>

I genitori possono utilizzare il menu “To The Parents” (per i genitori) per controllare i progressi dei loro bambini nel memorizzare i vocaboli.<br><br>

Tutta la famiglia potrà divertirsi con le allegre illustrazioni di Eric Carle, autore di libri illustrati apprezzato in tutto il mondo.
