...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este es un mundo en donde la música es el lenguaje de la gente. Un malévolo caudillo del norte llega y captura el castillo.  La princesa está encarcelada dentro de las profundidades del castillo, y también se han llevado todos los instrumentos musicales del mundo para esconderlos.  Nuestro héroe, Milon, se ha propuesto luchar contra el caudillo, rescatar a la princesa, y recuperar todos los instrumentos musicales de la gente. Para ayudarle en esta aventura, solamente contará con su ingenio y la Burbuja mágica. Ayuda a Milon en su aventura al buscar por puertas escondidas, encontrar objetos secretos, y a derrotar a los salvajes enemigos.  Asegúrate de encontrar las tiendas dentro del castillo, donde podrás encontrar objetos y pistas valiosas. Cada vez que Milon encuentre una Caja de Música, se transportará a un nivel extra.  Cada instrumento que encuentres añadirá una capa de música a la melodía de fondo.  Trata de obtener los siete instrumentos para crear una interpretación digna de un video juego de tema musical.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146425345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146425345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Milon's Secret Castle<sup>&reg;</sup></span></div>
</div>
