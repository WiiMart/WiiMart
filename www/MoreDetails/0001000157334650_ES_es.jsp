...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157334650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">3D Pixel Racing es un juego de carreras que recuerda los clásicos de la historia de los videojuegos.<br>
...
El juego cuenta con 10 pistas, 11 coches, 10 pilotos: completa varios desafíos para desbloquear los contenidos ocultos.<br>
Disfruta del modo multijugador con pantalla compartida donde pueden jugar hasta 4 amigos al mismo tiempo! <br>
Modos de Juego: Carreras en solitario, Campeonato, Captura la bandera, Persecución, Prueba a tiempo.
<br><br>
