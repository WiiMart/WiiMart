...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Unisciti ad Adam e Laura in Monster Lair, una fantastica avventura che è allo stesso tempo un gioco di piattaforme ed uno sparatutto!<br><br>
Il gioco si compone di 14 livelli stracolmi di buffissimi mostri e l'azione è accompagnata da una straordinaria colonna sonora. Puoi giocare da solo assumendo il ruolo di Adam o unirti a un amico che prenderà il controllo di Laura.<br><br>
La prima sezione di ogni livello prevede una fase a piedi, dove il giocatore deve evitare ostacoli e buche. Usa i potenziamenti per eliminare i mostri che ti sbarrano il passo, recupera energia mangiando il cibo che riesci a trovare e raggiungi l'uscita. La seconda sezione è un'emozionante fase sparatutto che si svolge a bordo di un simpatico amico alato. Dovrai vedertela con micidiali nemici volanti e con il boss che cercherà di impedirti di accedere al livello successivo. 
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000151415550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000151415550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Monster Lair</span></div>
</div>
