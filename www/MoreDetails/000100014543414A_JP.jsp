...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９８年にリリースされた対戦格闘ゲームで、『餓狼伝説』シリーズの第７弾。前作のシステムをベースにしつつさらに改良された２ラインバトル、複数の技で可能になった「ブレイクショット」の他、レバーを上方向に入れ続けたり、歩き続けたりすることでスウェーラインに留まったり、ダウン時にレバーとボタンをタイミング良く入力することで素早く起きあがれたりといった新要素を導入。中国拳法の使い手「リー・シャンフェイ」とボクサーの「リック・ストラウド」の２人が追加され、「ギース・ハワード」がプレイキャラとして復活。総勢２２名の格闘家が腕を競います。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014543414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014543414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">リアルバウト餓狼伝説2</span></div>
</div>
