...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157464150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Quand il s’agit de tirs rapides, il n’y a que deux catégories de personnes : les tireurs rapides... et les morts ! Vous avez maintenant la possibilité de savoir quelle est votre position : debout ou allongé, comme il se pourrait. Vous affronterez les meilleurs tireurs rapides de ce secteur, y compris un des tireurs les plus rapides au monde, Wes Flowers.
<br><br>
Dégainez votre télécommande Wii et montrez-leur qui est vraiment le tireur le plus rapide dans ces duels en direct ! Vous pouvez même vous mesurer à un ami en mode multijoueur et voir qui de vous tire le plus vite.
<br><br>
Il vous faudra faire preuve d’une rapidité considérable et d’une précision impressionnante pour affronter ces tireurs... Alors, préparez-vous pour un peu d'action !
<br><br>Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464150/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464150/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
