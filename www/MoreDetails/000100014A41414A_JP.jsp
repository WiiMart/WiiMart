...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">恐竜ランドを舞台に、クッパに捕まったピーチ姫を救出するため、マリオとルイージが冒険するアクションゲーム。頼もしい味方ヨッシーとともに、敵を倒したり、マントをつけて空を飛んだり、といった魅力的なアクションや多彩なキャラクターが満載。多彩な仕掛けと謎解き要素がいっぱいのバラエティに富んだステージをクリアしていきます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41414A/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41414A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーマリオワールド<sup>TM</sup></span></div>
</div>
