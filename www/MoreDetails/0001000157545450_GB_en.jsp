...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157545450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Toki Tori is his name and collecting eggs is his game!<br><br>

In this puzzle / platform game, players get to use a variety of items such as the Telewarp, InstantRock™ and Slug Sucker. Clever use and combinations of these items is needed to solve all the game's levels, of which there are more than 70. These levels range from easy to brain-teasingly hard, resulting in dozens of hours of puzzle play-time.<br><br>

Toki Tori makes the most out of what the Wii has to offer. It uses the Wii Remote for a unique control scheme, which offers players a new and more relaxing play style. A second player can help you out, by drawing hints while you are playing. The game even uses the Wii Message Board in a unique way!<br><br>

In short, Toki Tori:<br><br>

- is a puzzle / platform game<br>
- offers dozens of hours of gameplay<br>
- uses multiple Wii Remotes for a new play style<br>
- uses the Wii Message Board<br>
- displays English texts and manual</div>
  <div id="image02">
