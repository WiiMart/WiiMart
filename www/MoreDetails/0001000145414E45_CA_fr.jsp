...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Released in 1992 by SNK, FATAL FURY 2 is the second installment of the renowned fighting-game series. In addition to Terry, Andy, and Joe, who appeared in the original game, another five distinctive fighters gather from around the world to compete for the championship title. Also newly added are stage-specific hazards and the ability to perform desperation attacks when a character’s strength is low. These particularly deadly techniques create the chance for a come-from-behind victory achieved with a single strike. Moreover, the innovative two-line battle, which proved popular in the previous version, has also been radically enhanced. Pressing the weak attack and strong attack buttons simultaneously enables a player to move their fighter to another line themselves, or to launch an attack that pushes the opponent back to another line. This game mechanic, unique to this title in the series, allows the player to take advantage of the depth of the screen and create even more exciting bouts. Can you prove yourself the king of fighters again?</div>
  <div id="image02">
