...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rejoin the heroic Alex Kidd in this platformer from the 1980s! Race against time to recover the twelve Miracle Balls and restore the stars of the Aries Constellation! This title features twelve fast-paced rounds in six challenging levels, including a toy land, robot factory and even outer space, all complete with crazy enemies!</div>
  <div id="image02">
