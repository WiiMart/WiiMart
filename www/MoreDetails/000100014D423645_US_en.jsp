...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">It’s a dark and stormy night in the kingdom of Granseal, when a thief steals two jewels from the Tower of the Ancients. He sets in motion strange events that lead to the resurrection of Zeon, the Devil King. Granseal’s king falls sick, the princess is kidnapped, and a door to Arc Valley, the Devil King’s home, is opened. The young swordsman, Bowie, realizing the grave danger Granseal faces, must lead the Shining Force to find the Holy Sword, the stolen jewels, and protect Granseal against the invading armies of Zeon.</div>
  <div id="image02">
