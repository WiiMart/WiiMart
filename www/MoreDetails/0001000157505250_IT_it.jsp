...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157505250')", "wiiSelectSound()");
...
<br><br>
Art Style: CUBELLO è un rompicapo tridimensionale che metterà a dura prova la tua percezione dello spazio e i tuoi riflessi! Lo scopo del gioco è semplice: eliminare i cubi colorati che costituiscono il Cubello colpendoli con i cubi dello stesso colore che hai a disposizione nel caricatore. Tutto questo usando il telecomando Wii!
<br><br>
Fai attenzione però, il Cubello rotea costantemente: la tua mira dovrà perciò essere infallibile per eliminare i cubi e risolvere il puzzle. Se invece cerchi una vera sfida, prova a cimentarti nella modalità Infinita!
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157505250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157505250/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
