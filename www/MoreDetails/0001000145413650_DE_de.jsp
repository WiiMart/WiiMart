...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Das ist der dritte Teil der Reihe “King of Fighters!”, das erstmals 1996 veröffentlicht wurde. Die  Reihe KOF bietet dir die Möglichkeit berühmte Kämpfer aus verschiedenen SNK-Spielen wie FATAL FURY, IKARI WARRIORS, PSYCHO SOLDIER und ART OF FIGHTING gegeneinander antreten zu lassen, und um den Titel des stärksten Kämpfers zu kämpfen.
<br><br>
Die Spielhandhabung in diesem Teil unterscheidet sich zu seinen Vorgängern in einigen wesentlichen Punkten. Es bietet kleine, mittlere und große Sprünge, Ausweichmanöver nach vorn und zurück, und ermöglicht dir zusätzlich im Sprung zu blocken. Die eingeblendeten Befehle erleichtern dir diese auszuführen. Außerdem wurden die bisher extrem effektiven Geschosse entschärft. Dadurch stellt dieser Teil einen Wendepunkt in der Reihe dar.
