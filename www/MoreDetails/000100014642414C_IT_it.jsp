...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questa frenetica simulazione di tennistavolo fu originariamente pubblicata solo in Giappone per il Famicom Disk System e ora, dopo 20 anni, fa il suo debutto in Europa grazie alla Virtual Console!
<br><br>
Sfida la console o un altro giocatore in un faccia a faccia al meglio dei 3 game! Per vincere un game bisogna totalizzare un determinato punteggio con almeno due punti di scarto. Se si arriva alla fine del game con un solo punto di scarto, subentra la regola della "parità" e il gioco continua finché uno dei due giocatori non abbia due punti di vantaggio sull'altro. 
<br><br>
Per battere il tuo avversario e mandare in visibilio gli spettatori hai a disposizione tutta la gamma di mosse (schiacciata, parabola alta, dritto e rovescio)... e, se giochi bene, tra la folla di tifosi potresti ritrovarti anche Donkey Kong Jr.!
<br><br>
Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014642414C/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642414C/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Smash Table Tennis<sup>TM</sup></span></div>
</div>
