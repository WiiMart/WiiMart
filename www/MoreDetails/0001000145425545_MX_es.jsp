...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego, originalmente publicado en 1991, se encuentra muy lejos de los típicos juegos de béisbol. Elige un equipo de un total de doce participantes, inscríbete en una de las dos ligas y lucha por el campeonato. Los partidos se celebran en el exclusivo Estado Cyberoval, cuya zona de home run está peligrosamente reducida y la zona limpia inusualmente ancha. Existe también una zona de stop, en la que se detiene toda bola que entra en ella. A medida que avanza el juego, serán instalados unos petardos (minas) que harán de los partidos una locura. Además, se pueden comprar armaduras durante el juego para reforzar a los jugadores, todo ello a fin de disfrutar de una experiencia única. Puede que te sorprenda al principio, pero una vez que te acostumbres y comiences a crear tus estrategias, empezarás a disfrutar todas las bolas con efecto que te lancen.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145425545/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145425545/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
