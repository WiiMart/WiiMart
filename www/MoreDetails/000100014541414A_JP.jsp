...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９１年に発売された２Ｄ対戦格闘ゲームです。プレイヤーはテリー・ボガード、アンディ・ボガード、ジョー・ヒガシのなかから一人を選び、各地でストリートファイトを繰り広げ、サウスタウン最強の男、宿敵ギース・ハワードとの戦いに挑みます。キャラクターごとの個性的な必殺技、画面の手前と奥を使った２ラインバトル、そして２人プレイ時には対戦だけでなく協力プレイにも対応しているなど、対戦格闘ゲームのなかでもユニークなシステムを採用していることで知られています。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">餓狼伝説 <sup>&reg;</sup>～宿命の闘い～</span></div>
</div>
