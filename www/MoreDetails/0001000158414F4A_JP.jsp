...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">名作シューティングゲーム『グラディウス』の、ＭＳＸオリジナルシリーズ最後のストーリーです。アーケード版『グラディウスⅡ　ＧＯＦＥＲの野望』の登場を受けて作られ、パワーアップでは『Ⅱ』の武器とタイプセレクトを踏襲していますが、前作『２』からパワーアップゲージ拡張システムも受け継いでシリーズ随一の武器の豊富さを誇るなど、ＭＳＸ版オリジナルの要素に彩られています。以前の戦いに勝利をもたらした「ジェイムス・バートン」の直系の子孫である「デイヴィッド・バートン」が、ついに完成した亜空間戦闘機「ヴィクセン」で亜空間を超え、いよいよ宿敵「バクテリアン」の本拠地へ乗り込みます。なお、最終ステージに進むには、それまでにいくつかのキーアイテムを発見しなければなりません。その最終ステージでさらにもうひとつのキーアイテムを入手し、ＭＳＸ版シリーズの完結となる真のエンディングをめざしてください。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000158414F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158414F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゴーファーの野望 EPISODE Ⅱ</span></div>
</div>
<div class="contentsBlueM" id="Platform">
  <div align="left" class="headerWhiteS">MSX</div>
</div>
</body>
</html>
