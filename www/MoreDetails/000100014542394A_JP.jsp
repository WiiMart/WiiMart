...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９５年にリリースされたサイドビューのシューティングゲームで、プレイヤーは愛機Ｄｉｎｏ２４６を操縦して、太陽系に襲来した異生命体と戦うことになります。ボタンを一定以上の速度で連打すれば広範囲の攻撃ができ、逆にボタンを押し続けることで溜め撃ちという個性的なショットが特徴的です。ステージの途中で出現するアイテムを取ることでスピードアップしたりミサイルを撃つことができます。また、自機の前方に装着可能な５種のボイジャー、自機の上下に装着可能で攻撃方向を設定できるイオといったオプションが登場する点も大きな魅力。実に多彩な攻撃が楽しめる点が大きな特徴となっています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パルスター</span></div>
</div>
