...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Metal Slug 3 es la cuarta entrega de la serie Metal Slug, Metal Slug después, Metal Slug 2 y Metal Slug X. Marco y Tarma, están de vuelta para volar a través de el camino hacía una nueva aventura llena de acción , recogiendo varias armas por el camino para hacer las cosas más fáciles. Las babosas también están de regreso y más coloridos que nunca, con Slugmariners, Drill Slugs y babosas Elephant que unen las babosas de metal originales y Slugnoids. Al igual que con los títulos anteriores, hay elementos ocultos que se encuentran prisioneros de guerra y de ser rescatados, mientras que un mapa de bifurcación permite a los jugadores a tomar una ruta diferente hasta el final con cada juego.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145423645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145423645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
