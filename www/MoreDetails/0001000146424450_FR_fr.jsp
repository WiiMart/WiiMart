...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">L'un des héros de Nintendo, Pit (également connu sous le nom de Kid Icarus), est né en 1987. Equipé d'un arc magique, notre ange guerrier est le dernier espoir de la Terre des Anges, mise sous le joug de la Déesse des Ténèbres, Medusa.
<br><br>
Cette aventure conçue par les créateurs de Metroid est un mélange de jeux de plate-forme et d'action. Vous devez en effet tirer à l'arc, récupérer des objets et explorer des donjons pour trouver les trois trésors sacrés. Et c'est seulement après tout cela que vous serez en mesure d'affronter Medusa!
<br><br>
Après Kid Icarus, Pit n'est apparu qu'une seule fois dans un jeu, sur Game Boy en 1992, mais on devrait le revoir bientôt en tant que nouveau combattant, dans Super Smash Bros. Brawl™, bientôt disponible sur Wii!
<br><br>Le texte à l'écran sera en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Kid Icarus<sup>TM</sup></span></div>
</div>
