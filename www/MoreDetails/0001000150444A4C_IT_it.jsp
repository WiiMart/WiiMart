...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questa è la versione per PCEngine (Turbografx16) di uno dei più famosi picchiaduro a incontri della storia dei videogiochi! Per il port della versione coin-op ai tempi fu usata una HuCARD di alta capacità, che permise una riproduzione fedele dell'intero software, compresi i bonus stage e gli effetti sonori.
<br><br>
Scegli uno dei dodici personaggi e affronta gli avversari in uno scontro senza esclusione di colpi per stabilire chi sia il lottatore più forte del mondo! Impara le caratteristiche di ogni personaggio, le sue mosse speciali e le combo per sconfiggere avversari da tutto il mondo!
<br><br>
La modalità V.S. BATTLE consente anche di impostare delle penalità, così anche i giocatori alle prime armi possono battersi con i più esperti in duelli testa a testa molto intensi! 
<br><br>
