...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494250')", "wiiSelectSound()");
...
<br><br>
Jack y Walter, dos viejos pescadores de un mundo de fantasía, han descubierto lugares llenos de peces que saltan sin cesar, ¡y esto resulta ideal para ponerse las botas!<br><br>
¡Es una pena que también se encuentren con extraños seres que no se lo pondrán nada fácil!
<br><br>
Con este juego de acción surrealista, podrás sentir todo el sabor de los grandes clásicos de las máquinas recreativas en tu Wii.<br><br>
Sujeta fuerte el mando y ¡péscalos a todos!
<br><br>
Características:
<br>
- Nueve escenarios fantásticos y coloristas.<br>
- Tres modos de juego: Arcade, Desafío y Fishtris.<br>
- Uno o dos jugadores. <br><br>Textos de pantalla en español.</div>
  <div id="image02">
