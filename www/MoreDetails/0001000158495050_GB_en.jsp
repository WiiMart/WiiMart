...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158495050')", "wiiSelectSound()");
...
This game has been designed for use by children who have not yet grasped reading.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495050/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
