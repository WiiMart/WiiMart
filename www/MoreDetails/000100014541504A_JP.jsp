...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">忍者が活躍する縦スクロール型アクションシューティングゲーム。プレイヤーは甲賀忍者の血を引く「ジョー」、伊賀忍法を身につけたくノ一「レイア」、風魔小太郎の末裔「リュー」の中から１人を選び、タイムマシンを使って世界を混乱に陥れようと企む死の商人「スパイダー」を追って、石器時代、エジプト時代、戦国時代など７つの時代で戦いを繰り広げます。各主人公には、ノーマルショット、画面全体の敵にダメージを与える必殺技、コマンド入力による忍法、さらには３つの巻物を集めると獣身変化による強力な攻撃を繰り出せるなど、多彩な攻撃方法が用意されています。２人同時プレイにも対応しており、お友達との協力プレイをお楽しみいただけます。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ニンジャコマンドー</span></div>
</div>
