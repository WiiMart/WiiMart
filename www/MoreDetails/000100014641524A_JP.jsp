...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">絶大な人気を誇ったアーケード版から移植され、１９８６年にファミコンで発売された横スクロール型のシューティングゲームです。パワーアップの種類やタイミングを自由に決められるのが最大の特徴。自機「ビックバイパー」を自分好みにパワーアップさせ、最終ステージをめざします。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641524A/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641524A/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
