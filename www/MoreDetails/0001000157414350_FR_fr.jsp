...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157414350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Arcade Essentials est une collection de cinq jeux d'arcade classiques. Ces titres ont résisté à l'épreuve du temps et sont parmi les plus populaires jamais édités ! Chacun bénéficie d'un tout nouveau design, d'un gameplay amélioré, ainsi que de graphismes et d'effets sonores du tout dernier cri. Plongez au cœur de l'action et immergez-vous dans ces jeux classiques comme vous l'avez peut-être fait il y a de nombreuses années.
<br><br>
- 5 jeux d'arcade classiques en un
<br><br>
- De nombreux niveaux à déverrouiller, des tableaux de scores et plein d'autres surprises
<br><br>
- Des graphismes et des effets sonores remis au goût du jour
<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414350/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414350/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Arcade Essentials</span></div>
</div>
