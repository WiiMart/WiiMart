...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157564B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Water Warfare is a comical first person shooter that uses water guns to battle and soak your opponents. Each map,  a Playground, Beach, Plaza, or Nature Park theme, is generated automatically when the game is on, where you can think up new strategies each time you engage! <br><br>Game modes include Single Player Missions, CPU Match, and 2-Player Split Screen.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564B50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564B50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
