...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lorsque le fameux scientifique du 21e siècle, Prof Yoshiyama, tomba amoureux de "C-Life", l'un de ses programmes d'intelligence artificielle, il se téléchargea dans son propre ordinateur. Le noyau du programme de C-Life fusionna alors avec l'ADN du professeur pour créer Pulseman, un être mi-homme, mi-machine. Une fois revenu dans le monde réel, Prof Yoshiyama perdit la raison et devint le maléfique Prof Waruyama.
<br><br>
Utilisez la capacité de contrôle de l'électricité de Pulseman ainsi que son attaque Voltecker, qui lui permet de se déplacer plus rapidement, pour combattre le gang galactique de l'horrible Waruyama dans 7 niveaux complètement fous.
<br><br>
Découvrez pourquoi ce classique était considéré comme l'un des plus beaux jeux de la SEGA MEGA DRIVE lors de sa sortie. Téléchargez-le dès maintenant !
<br><br>Le texte à l'écran est en anglais, et contient du japonais.<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
