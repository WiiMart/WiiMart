...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157505150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Protöthea est un jeu de tir à défilement vertical avec une totale liberté de mouvement. Vous pourrez prendre les commandes d'un vaisseau spatial de dernière génération, dont la mission est de détruire l'astéroïde "Maqno 01", et mettre fin aux plans de "The Core".
<br><br>
Protöthea par Ubisoft introduit de nouveaux concepts de jeu dans un grand classique, en mélangeant les genres et en tirant pleinement parti des graphismes et des commandes de la console Wii.<br><br>
Quel que soit votre âge et votre niveau, faites-vous plaisir et prenez les commandes de votre vaisseau. Frayez-vous un chemin à travers 4 mondes différents pour remporter les 10 missions. Déployez tout un arsenal d'armes, sans oublier les bonus spéciaux, pour atteindre votre objectif et n'hésitez pas à ralentir le temps pour tourner la situation à votre avantage.<br><br>Texte écran en français.</div>
  <div id="image02">
