...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ganz Dream Land ist in Aufruhr! Der erste offizielle Ghost Trap-Wettbewerb hat begonnen!
<br><br>
In diesem rasanten Puzzle-Spiel kämpfst du gegen Kirbys Gegner, indem du farbige Tropfen auf strategisch raffinierte Weise stapelst, um so massive Kettenreaktionen auszulösen.
<br><br>
Jede Explosion führt dazu, dass dein Gegner mit einer Ladung Geister eingedeckt wird! Kämpfe auf deinem Weg zu einem triumphalen Sieg durch 16 Level hindurch gegen legendäre Gegner aus dem Kirby-Universum!
