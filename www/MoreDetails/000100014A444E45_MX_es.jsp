...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Ghoul Patrol al rescate! ¡Las atracciones principales de la exhibición de trasgos en la biblioteca han cobrado vida! Como miembro del grupo Ghoul Patrol, viaja al pasado para desencantar toda una enciclopedia de personajes históricos. Aniquila a fantasmas de botes de basura y espíritus ninjas, rescata bibliotecarios y piratas espantados, esquiva libros voladores y plantas carnívoras, ¡y por fin restaura el orden de los libros de historia!
<p>
• El modo cooperativo de dos jugadores te permite aliarte con un amigo para acabar con los fantasmas.<br>
• Enfréntate a un cementerio lleno de enemigos incluyendo a los caballeros esqueleto, samuráis zombi y automóviles poseídos. <br>
• Encuentra una variedad de objetos especiales para juntar, incluyendo pollos de hule y pócimas mágicas.<br>
• Usa armas divertidas, desde el rifle de plasma hasta flechas con copa de succión.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A444E45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A444E45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ghoul Patrol<sup>TM</sup></span></div>
</div>
