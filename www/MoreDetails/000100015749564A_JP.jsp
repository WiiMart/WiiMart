...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015749564A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">スペースインベーダー　ゲットイーブンは、ＵＦＯを操作してチキュウを侵略していく「侵略シューティングゲーム」です。<BR>タイトルの「ゲットイーブン」は「借りを返す」という意味。今までやられてばかりだったスペースインベーダーたちが、ついにチキュウに逆襲を開始します。<BR>プレイヤーは最新型のＵＦＯを操作し、部下であり仲間でもあるスペースインベーダーたちを指揮してチキュウ上の戦車や戦闘機、強力な武装ビルなどの兵器を次々と破壊していきます。ステージの最後には、巨大なボスも待ち構えています。<BR>ＵＦＯの２つのモードと、スペースインベーダーの５つのアタックタイプ、そして必殺のＳＰアタックを駆使して、ハイスコアを目指しましょう。各ステージで高得点を得たら、Ｗｉ－Ｆｉランキングに登録することで、世界中のプレイヤーとスコアを競うことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015749564A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015749564A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">～逆襲のスペースインベーダー～</span></div>
  </div>
