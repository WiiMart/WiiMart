...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">すべてが三次元で表現され、マリオのアクションがより多彩になったマリオシリーズ初の３Ｄアクションゲーム。自由自在にマリオを操作し、クッパに奪われたパワースターを取り戻すための大冒険が楽しめます。ニンテンドー６４と同時発売された、３Ｄアクションゲームの代表作ともいえるソフトです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014E41414A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E41414A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーマリオ<sup>&reg;</sup>６４</span></div>
</div>
