...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ダイナミックな演出やテンポの良いゲーム展開が人気を博したＰＣエンジンを代表する定番野球シリーズの四作目。「オープンモード」ではコンピュータとの対戦はもちろん、最大４人までのマルチプレイに対応。４人プレイでは、守備側は「投手」と「守備」に分かれて操作し、攻撃側は「打者」と「走者」を打席ごとに交互に分担して行います。「ペナントモード」では、試合数を１０・３０・７０・１３０の中から選び、リーグ優勝を目指します。見事リーグを制すると日本シリーズに出場することができ、他リーグの優勝チームと日本一の座をかけて対戦することになります。そのほかにも「オールスターモード」や「ホームランモード」、さらにはコンピュータ同士の試合を観戦する「ウォッチモード」など、ゲームならではの楽しみ方もしっかりと押さえた本格派の野球ゲームです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043584A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043584A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">パワーリーグ<sup>&reg;</sup> ４</span></div>
</div>
