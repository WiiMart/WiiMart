...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prodotto nel 1991 da SNK, King of the Monsters è un picchiaduro dove i mostri si affrontano in spietati combattimenti. Scegli uno dei sei mostri, e inizia un viaggio attraverso il Giappone durante il quale dovrai cercare di vincere i vari incontri per diventare il campione assoluto.<br><br> Per battere gli avversari, ogni mostro ha a disposizione una serie di mosse standard, come calci e pugni, e alcune mosse speciali, come lanciare fiamme o raggi. Nell’ultima versione sono stati inseriti elementi ispirati al mondo del wrestling. Per vincere, dovrai stancare il tuo avversario e immobilizzarlo a terra durante il conteggio fino a tre. Se è l’avversario a schienarti, premi ripetutamente il pulsante per tornare a combattere. Potrai inoltre scegliere se sfidare il computer, un amico o se dare vita a entusiasmanti incontri a squadre due contro due.
<br><br>
