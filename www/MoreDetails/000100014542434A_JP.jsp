...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９４年にリリースされた架空のスポーツゲームで、６人の個性的な選手がフライングパワーディスクナンバーワンの座を賭けて火花を散らします。ルールは非常に簡単。円盤を投げ合って相手のゴールに入れたら得点となり、２セットを制すると勝利となります。なお本作の最大の見所は、レシーブから繰り出せる必殺シュートです。ド派手で破壊力も抜群！　うまく狙えばキャッチした相手ごとゴールに押し込むことも可能です。さらにゲームに慣れれば、必殺シュートを必殺シュートで打ち返すこともでき、非常に熱いラリーが楽しめます。テクニックを駆使して、フライングパワーディスク王者をめざしましょう。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542434A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542434A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">フライングパワーディスク</span></div>
</div>
