...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158494D50')", "wiiSelectSound()");
...
<br><br>HoopWorld: BasketBrawl is a 3 on 3 basketball game with an arcade twist: unique characters and beautiful natural locations set the stage, fighting and random power-ups keep the game fast and rough. Choose your favourite team and Basketbrawl across the globe to become the undisputed World Champions. Play on your own or with a friend, and see if you can beat the leaders of the HoopWorld™ global ranking. Are you ready?<br>
Long ago, a lost civilization called the Elders, who worshipped the magical power of Nature, built a network of sacred temples around the world.<br>
Millennia have since passed, and the temples lie in ruins. But their energy still resonates from the land, attracting adventurers from distant lands. Drawn by the unknown force, friends have begun to rebuild the ruins into ball courts, knowing only they must relive the time-honoured test of spirit of the Elders, the game now known as basketball.</div>
  <div id="image02">
