...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードゲーム「ワンダーボーイ　モンスターランド」をマスターシステム用にアレンジ移植した、アクションＲＰＧ「モンスターワールド」シリーズ第一弾です。悪の化身ドラゴンを倒すため、ブック少年はモンスターワールドを冒険します。敵を倒して剣やアイテム、ゴールドを手に入れ、集めたお金で装備を整えます。待ち受けるボスを倒して鍵を手に入れれば、ゴールに待つゲートから次のラウンドへ進めます。アーケード版の面白さはそのままに、本作だけのオリジナルステージや「メデューサ」ほか新ボスが追加されました。また、本作はマスターシステムのＦＭサウンド対応ソフトで、２種類のサウンドが選択可能となっています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーワンダーボーイ</span></div>
</div>
