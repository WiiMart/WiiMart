...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324F45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">My Aquarium 2 es la secuela del exitoso título de WiiWare, "My Aquarium". Esta vez el tema es el misterio de las profundidades marinas. ¡Puedes criar fascinantes criaturas de todas las formas y tamaños, como peces abisales y medusas luminosas, usando tan solo el Wii Remote! Como en el original, puedes personalizar tu acuario y elegir qué peces meter y dónde colocar diversos adornos. También puedes elegir entre distintas luces de colores para iluminar tu acuario. ¡Con el tiempo, los peces podrían procrear y tendrías un nuevo banco que criar! ¡Crea tu propio acuario y disfruta de interminables horas de relajante entretenimiento! 
<p>
¡Esta secuela incluye más peces y objetos que el original! Y como antes, puedes conectarte al Canal Tiempo para reflejar el tiempo real. También puedes enviar tus acuarios a amigos registrados a través de WiiConnect24. Además, habrá contenido adicional disponible para comprar. ¡Sumérgete y contempla las maravillosas criaturas del profundo mar azul!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324F45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324F45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">My Aquarium 2</span></div>
</div>
