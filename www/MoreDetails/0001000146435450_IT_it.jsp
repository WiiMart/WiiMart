...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">MEGA MAN è il solo in grado di sconfiggere i potenti capi delle forze di Monsteropolis.
Il brillante scienziato Dr. Light progettò la costruzione di alcuni robot sperimentali con forme umane, concepiti per i lavori domestici. Dr. Light e il suo aiutante, Dr. Wily, rimasero molto soddisfatti della loro prima creazione, MEGA MAN, e decisero di sviluppare altri sei umanoidi programmati per compiti specifici: CUT MAN, ICE MAN, GUTS MAN, BOMB MAN, FIRE MAN e ELEC MAN.
<br><br>
Purtroppo tutti questi esperimenti di meccanica andarono storti, a eccezione di MEGA MAN: il Dr. Wily tradì il Dr. Light, riprogrammando tutti gli umanoidi con lo scopo di mettere a tacere ogni opposizione e prendere così il controllo di tutte le risorse mondiali. Ora solo MEGA MAN rimane a difesa dell’universo e dei suoi abitanti e dovrà entrare da solo nei sette imperi di Monsteropolis per eliminare i capi e le loro truppe. Preparati a una sfida al cardiopalma!
...
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146435450/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146435450/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MEGA MAN<sup>TM</sup></span></div>
</div>
