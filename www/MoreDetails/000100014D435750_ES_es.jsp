...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Galaxy Force II es un juego de disparos de estilo arcade en el que, desde la cabina de tu TRX-5 Quasar, deberás enfrentarte al enemigo mientras sobrevuelas cinco planetas diferentes, con escenarios que varían desde un pacífico jardín a tierras de hielo y fuego.
<br><br>
Recorrerás peligrosos entornos volando a ras de la superficie del planeta y enfrentándote a robots, torretas y naves enemigas. Si superas estos obstáculos, todavía quedará asaltar la fortaleza alienígena de cada uno de esos planetas. Para conseguirlo, tendrás que volar por los aires sus salas de mando. Como miembro de la Galaxy Force, tu deber es contrarrestar la invasión alienígena y mantener la paz en el sistema solar.
<br><br>
Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D435750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D435750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Galaxy Force<sup>TM</sup> II</span></div>
</div>
