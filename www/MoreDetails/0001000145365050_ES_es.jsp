...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este trepidante juego de acción es todo un clásico de las recreativas, conocido en Europa bajo el nombre de Shadow Warriors. ¡Ahora puedes disfrutarlo en casa!
<br><br>
Conviértete en un ninja y viaja a Jungle, una ciudad estadounidense asolada por las bandas criminales. Tu objetivo será acabar con una de esas bandas, para lo que deberás valerte de todas tus habilidades ninja, como el ataque volador o la patada con agarre. En esta versión del juego podrás elegir el número de vidas y el nivel de dificultad, para que disfrutes todavía más la experiencia.
<br><br>
¿Quién prevalecerá en este espectacular enfrentamiento entre guerreros ninja y bandas callejeras? ¡Depende de ti!
<br><br>
