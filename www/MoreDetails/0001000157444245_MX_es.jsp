...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Derby Dogs es una simulación del crecimiento, crianza y competición que permite al jugador criar, alimentar y entrenar perros con una variedad de ejercicios que permiten aumentar cualidades específicas del perro. También puedes frecuentar la tienda de perros para rentar nuevos perros o comprar nuevas casas de perro o comida para ellos. Tus perros pueden competir en carreras en un gran número de pistas para lograr títulos y premios en efectivo, y tu puedes criar tus perros para hacerlos mejores.
<p>
¿Podrás convertirte en el mejor y criar perros que puedan triunfar en las competiciones?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Derby Dogs</span></div>
</div>
