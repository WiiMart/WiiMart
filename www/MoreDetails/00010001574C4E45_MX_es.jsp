...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C4E45')", "wiiSelectSound()");
...
Este juego está diseñado para niños que aún no saben leer. Las instrucciones se dan oralmente en francés, inglés, o español, según la opción de idioma de la consola Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4E45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4E45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Learning with the PooYoos:</span></div>
</div>
