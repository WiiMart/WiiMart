...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494845')", "wiiSelectSound()");
...
<p>
Rage of the Gladiator es un juego de fantasía donde deberás de luchar por tu vida en la arena. ¡Ponte a prueba y conquista a todos los oponentes!
<p>
Características:<br>
• ¡Uno de los juegos más increíbles de WiiWare jamás vistos! Increíbles gráficas en 3D, animaciones, iluminación de sombras y efectos especiales.<br>
• Actuación con voz. ¡Cada jefe tiene su propia personalidad y se burlará de ti sin misericordia!<br>
• Increíbles movimientos finales. ¡Invoca un feroz meteoro, un salvaje tornado o transfórmate en un coloso 10 veces más grande que tú!<br>
• Personaliza tu personaje. ¡Especialízate en una habilidad - Ofensiva, Defensiva o Mágica para ganar nuevos poderes!<br>
• Música épica. ¡Disfruta de obras maestras del legendario compositor Sean Beeson!<br>
• Excelente para jugar más de una vez. ¡Termina el juego para desbloquear el modo reto, donde los jefes son mucho más fuertes y tienen nuevas habilidades!<br>
• Inclusive, soporta el accesorio Wii MotionPlus™!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494845/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494845/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
