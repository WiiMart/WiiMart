...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158483750')", "wiiSelectSound()");
...
<br><br>
Des créatures de l'ombre ont envahi le lycée que fréquente notre héros, Jake. C'est votre mission de le guider à travers toutes les salles de classe pour qu'il rejoigne sa copine, Rachael. Vous devrez bien réfléchir et utiliser les sources de lumière déjà présentes afin de créer des chemins illuminés pour Jake. Un seul faux-pas et Jake tombera dans l’obscurité. Tout au long de son aventure, il rencontrera des versions bizarres des professeurs de son lycée, qui devront être vaincus pour pouvoir continuer.
<br><br>
LIT est un mélange d'horreur et d'énigmes qui se joue avec la télécommande Wii et le Nunchuk. Le jeu contient 30 niveaux, 5 combats contre des boss, des modes de répétition et des surprises à débloquer. Vous pouvez également choisir plusieurs fins de jeu, relever des défis chronométrés en mode Dark et débloquer un personnage.
<br><br>
Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483750/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483750/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">LIT</span></div>
</div>
