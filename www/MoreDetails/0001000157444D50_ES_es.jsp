...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Disfruta de nuevo de este juego clásico de puzles en tu consola Wii, ahora con partidas en línea y un nuevo modo, Bactericida. ¡Coloca las cápsulas que caen en el lugar correcto para crear líneas de un color y eliminar a las bacterias del frasco! Cuantas más bacterias elimines, más rápido caerán las cápsulas.
<br><br>
En Dr. Mario, enfréntate a la consola en el modo de un jugador o compite con un amigo en el modo multijugador.
<br><br>
Bactericida (basado en el juego de Más Brain Training del Dr. Kawashima) permite que hasta 4 jugadores puedan usar el mando de Wii para agarrar y colocar las cápsulas y ayudar a los Miis a mantener a raya la infección. ¿Quién iba a pensar que luchar contra las bacterias iba a ser tan divertido?
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444D50/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444D50/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dr. Mario<sup>TM</sup> &amp; Bactericida</span></div>
</div>
