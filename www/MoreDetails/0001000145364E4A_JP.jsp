...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">魔法使い「ダーナ」が、世に解き放たれた悪霊を封印し世界に平和をもたらすため、魔法の書「ソロモンの鍵」を求めて迷宮に挑む、固定画面型アクションパズルゲームです。ダーナの持つ術で足場ともなるブロックを出したり消したりして、数々のテクニックを駆使しながら次のステージへと続く「鍵」を入手し「扉」への到達をめざします。いくつもの機種に移植されてきたタイトルですが、
本作のアーケード版は特にアクション要素が強く、難易度も少し高めに設定されており、
初心者から上級者まで楽しめる内容になっています。
また、自キャラの数を増減したり難易度を変更したりなど、ゲーム設定の変更も可能です。<BR><BR>詳細は、<Center>
http://www.tecmo.co.jp/product/vca/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145364E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145364E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソロモンの鍵<sup>TM</sup></span></div>
</div>
