...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Solomon's Key est un jeu d'action/réflexion dans lequel vous incarnez le sorcier Dana, errant dans un labyrinthe à la recherche d'un grimoire magique appelé Solomon's Key. Cet objet vous aidera dans votre lutte contre les esprits maléfiques qui hantent le monde.
<br><br>
Faites appel à vos méninges et aux différentes techniques à votre disposition pour trouver des clefs qui vous permettront de passer des portes, en utilisant les boutons pour créer et détruire des blocs. Différentes options telles que le nombre de vies ou le niveau de difficulté peuvent être ajustées.
<br><br>
Le jeu a été édité sur de nombreux supports, mais la version arcade met l'accent sur la partie "action", ce qui le rend plus divertissant pour tous, du débutant au joueur confirmé.
<br><br>
