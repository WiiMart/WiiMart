...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気ＲＰＧ「ファイナルファンタジー」シリーズの２作目で、ファンタジーの世界に戦争のドラマを取り入れた異色作です。戦乱の時代、パラメキア帝国軍の猛攻で孤児となったフリオニールと仲間達は、反乱軍の戦士となってパラメキア軍の皇帝を倒すべく、戦火に身を投じます。レベルの概念を廃した熟練度システムや、プレイヤーがキーワードを選択するワードメモリシステム、物語の進行によって入れ替わっていく４番目の仲間など、前作から大胆なシステム変更がされており、ＲＰＧの進化の多様性を示しました。また、シリーズでおなじみのチョコボ、シドが本作で初登場します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファンタジー <sup>&reg;</sup>II</span></div>
</div>
