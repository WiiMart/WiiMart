...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego de golf fue lanzado en 1996. Al jugar, elegirás uno de los seis jugadores de golf disponibles para competir en un número de campos de golf alrededor del mundo, incluyendo Japón (Fujiyama Oriental Golf Club), América (Grand Canyon Gold Course), Australia (Blue Lagoon Golf Course) y Alemania (Baden Golf Course). El juego presenta dos modos de juego. El primero es el modo “Stroke Play”, donde intentarás obtener la mejor puntuación jugando a través de los 18 hoyos. El segundo es el modo “Match Play”, en el que dos jugadores compiten para ver quien puede ganar el mayor número de hoyos. ¡Invita a un amigo y prepárate para jugar!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
