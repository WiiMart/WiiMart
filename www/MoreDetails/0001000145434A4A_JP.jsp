...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９９年にリリースされた格闘ゲームで、『ザ・キング・オブ・ファイターズ』シリーズの第６弾。今回は主人公が交代となり、ストーリーも新章へと突入することになりました。これまでと同様にチームバトルは３人で戦いますが、チームは４名編成で３名がバトルに参加し、１名は支援役のストライカーとして同行することになります。これまでと同様に、戦ってゲージを溜めることで超必殺技が使えるようになりますが、新要素としてゲージ３本を消費することで攻撃に特化したカウンターモードや、逆の防御力を強化できるアーマーモードに突入可能。状況に応じた駆け引きもパワーアップしています。今回は３２名の格闘家が登場します。あなたはその頂点に立てるでしょうか。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ・キング・オブ・ファイターズ '99</span></div>
</div>
