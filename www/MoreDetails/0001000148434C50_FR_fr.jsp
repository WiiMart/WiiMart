...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Regardez instantanément des films et des séries diffusés en streaming sur votre TV, via votre console Wii. Profitez de l'intégralité des programmes, où et quand vous le souhaitez. Il vous suffit de télécharger et d'installer Netflix pour commencer. Les nouveaux abonnés peuvent profiter d'un essai gratuit d'un mois dès aujourd'hui. Abonnement annulable à tout moment. Inscription à Netflix obligatoire. Service disponible dans certains pays uniquement. Rendez-vous sur netflix.com pour plus d'informations.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434C50/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434C50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
