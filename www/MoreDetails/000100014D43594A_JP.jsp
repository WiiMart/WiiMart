...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">現代に生きる忍者が活躍するアクションゲーム『忍（ＳＨＩＮＯＢＩ）』シリーズの代表作です。朧流忍者ジョー・ムサシを操り、悪の組織「ＮＥＯ　ＺＥＥＤ」にとらわれたヒロインを救い出すため、必殺の「八双手裏剣」や「火龍の術」など多彩な忍術を駆使して戦います。ムサシの行く手には忍者軍団や私設軍隊、クンフーの達人など
多彩なキャラクターが待ち受けています。全８ラウンドは各３ステージで構成されていて、最終ステージではボスとの対決が待っています。なお本作の音楽は『ベア・ナックル』シリーズや『セブンスドラゴン』を手掛ける「古代祐三」が担当。ＦＭ音源を駆使したメロディアスなＢＧＭは、現在も高い評価を受けています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ザ･スーパー忍<sup>TM</sup></span></div>
</div>
