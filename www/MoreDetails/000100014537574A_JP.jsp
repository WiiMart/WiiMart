...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">４人の超人のいずれかを操作し、世界各地でおこなわれるケタはずれな８つの競技に挑戦するアクションゲームです。はじめに操作方法とルールが表示されますので、参考にして競技を進めてください。競技で通過基準以上の記録を出すとクリアとなり、次の競技に進みます。ボタンを押すタイミングや連打など、３つのボタンを駆使して各競技をクリアしてください。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ニューマンアスレチックス<sup>&reg;</sup></span></div>
</div>
