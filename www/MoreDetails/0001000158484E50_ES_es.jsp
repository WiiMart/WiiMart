...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484E50')", "wiiSelectSound()");
...
<br><br>
Adéntrate en el original mundo de Chronos Twins DX, donde vivirás una fantástica aventura llena de ideas innovadoras nunca vistas en otro juego. Gracias a su sistema de juego Dual Gameplay serás capaz de controlar a Nec en dos escenarios temporales a la vez. En Chronos Twins DX encontrarás acción, plataformas, aventura y puzles que pondrán a prueba tu inteligencia y habilidad.<br><br>
Si te gustan los juegos que supongan un reto no lo dudes, Chronos Twins DX es el juego que buscas.<br><br>
Características especiales:<br><br>

- Explora un mundo desconocido donde descubrirás un sinfín de secretos ocultos.<br>
- Diecinueve fases ambientadas en un mundo fantástico con espectaculares jefes finales.<br>
- Juega en dos mundos a la vez, completando retos que en un solo mundo serían imposibles.<br>
- Consigue el poder del SPLIT, con él podrás detener el pasado y el presente.<br>
- Empuja objetos y destruye criaturas para cambiar el pasado... y el presente cambiará en tiempo real.<br>
- Observa cómo transcurre el tiempo mientras progresas en tu aventura.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484E50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484E50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chronos Twins DX</span></div>
</div>
