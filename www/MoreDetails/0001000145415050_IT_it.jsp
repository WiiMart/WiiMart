...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Gioco d'azione a scorrimento verticale pubblicato da ADK nel 1992, in cui puoi scegliere uno fra i tre personaggi a disposizione: Joe, del clan ninja Koga; Rayar, esperta delle tecniche ninja degli Iga; Ryu, discendente di Kotaro Fuma.<br><br> Scopo del gioco è di trovare e sconfiggere il terribile mercante di morte Spider che progetta di gettare il mondo nel caos grazie a una macchina del tempo. Sono sette le ere che fanno da sfondo ai combattimenti: si va dall’era della pietra, a quella egizia, fino alla guerra civile giapponese. Ogni personaggio dispone di mosse personalizzate, di un attacco micidiale che danneggia tutti gli avversari presenti sullo schermo e di speciali tecniche di combattimento ninja.<br><br> Inoltre, raccogliendo tre antichi rotoli, il tuo personaggio si trasformerà in una bestia capace di sferrare un attacco poderoso. Potrai inoltre giocare in cooperativa con un amico.
<br><br>
