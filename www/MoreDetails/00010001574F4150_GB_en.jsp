...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574F4150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Daddy, Mommy, Sarah and Billy are back for some more family fun, and this time its glide hockey!<br><br>

You can hone and master your glide hockey skills in a gymnasium, a forest park, a beach, an amusement park, or even in the freezing Arctic!<br><br>

Family Glide Hockey features appealing cel-shaded graphics and endearing music, as well as friendly and competitive matches. Choose between single player mode, versus mode (with up to four players), or challenge your skill with engaging mini-games, such as "Glide Hockey Brawl!", "Glide Hockey Drill!", or "Glide Hockey Tracer!".</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4150/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4150/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
