...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Jugando en el rol del joven boxeador Little Mac, tendrás la gran oportunidad de luchar contra los mejores del circuito de la Asociación Mundial de Video Boxeo!  Enfréntate uno por uno, comenzando por el flaco Glass Joe, pasando por King Hippo, hasta llegar al campeón de la AMVB. ¡Usa tus mejores puñetes, ganchos, y golpes altos para derribar a tus rivales, pero fíjate en los sutiles cambios en la posición de sus cuerpos para que puedas esquivar sus fuertes golpes! ¡Con gráficos impresionantes, acción adictiva, y un toque de humor, este juego te mantendrá entretenido por muchas horas!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146424945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146424945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Punch-Out!!<sup>TM</sup></span></div>
</div>
