...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">METAL SLUG, un juego que lo sacó en SNK en 1996, es un juego de acción militar de desplazamiento horizontal. Los jugadores controlan a Marco y Tarma, los dos miembros del equipo Peregrine Falcon de la fuerzas de operaciones especiales (conocido como Team PF), y pelean nivel por nivel llenos de acción intensa. La meta es tratar de derrocar al General Modern y recuperar el arma robada, el Metal Slug. Los jugadores disparan al enfrentarse a muchos enemigos y máquinas (mientras también saltan sobre obstáculos en su camino) para avanzar por niveles. No es tan difícil como se escucha: armas como metralletas pesadas, escopetas, lanzacohetes, lanzallamas y hasta el mero Metal Slug (el cual aparece frecuentemente en el juego), harán las batallas más fáciles. ¡Desafía al General Morden con un amigo para hacer las cosas más parejas y la diversión aún mejor!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145414A45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145414A45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Metal Slug</span></div>
</div>
