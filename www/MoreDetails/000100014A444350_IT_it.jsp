...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Street Fighter Alpha 2 torna sugli schermi col suo gameplay frenetico e le sue innovative caratteristiche: le Alpha Counter e l'incredibile sistema di Combo Personalizzate definirono un nuovo standard per tutti i giochi di lotta!
<br><br>
Spingi al limite il tuo talento videoludico scoprendo le nuove mosse e le contromosse tipiche di ogni personaggio. Neutralizza gli attacchi dell'avversario con le Alpha Counter alte e basse, e impara a usare le Combo Personalizzate per creare nuove, mirabolanti sequenze di colpi.
<br><br>
Hai a disposizione tutti i tuoi combattenti favoriti. I personaggi che prima erano nascosti (Dan, Akuma e M. Bison) ora sono subito disponibili e sono accompagnati da cinque nuovi lottatori: Rolento, Gen, Sakura e i già classici Dhalsim e Zangief!
<br><br>
