...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Operation Cobra Blue: a top secret surveillance and counterterrorist operation directed against Professor Elvin Atombender by Field Operations Agent "Bravo 29".
Elvin, a known psychotic genius, is one of the world's leading experts on robotics, computers and codes. He lives at the top of an immense eight-tower complex. So far, his complex has proven to be nearly impossible to enter by agents of any police or intelligence agency.
<br><br>
Intelligence reports indicate that Elvin has spent the past four years trying to electronically break into military computer installations around the world, and he may be close to succeeding. In addition, it is believed that Elvin is becoming increasingly mentally unstable. He has been monitored muttering threats about destroying himself and the world.
<br><br>
Your task: to stop Elvin and to prevent him from destroying the world. You have 8 hours to complete your mission. Good luck, Agent.</div>
  <div id="image02">
