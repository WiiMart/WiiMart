...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157504250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pub Darts is een simpel darts-simulatiespel dat gebruik maakt van de unieke besturingsmogelijkheden van de Wii om de beweging van het dartswerpen na te bootsen. Het spel is gesitueerd in het plaatselijke café, alwaar de spelers vertoeven om een paar van hun favoriete dartsvarianten te spelen, waaronder 501, Cricket, Around the Clock, Killer, and Baseball.<br><br>De besturing is net als het werpen van een echte dart en spelers kunnen hun eigen persoonlijke profielen aanmaken, waarbij ze een avatar kunnen kiezen uit een verzameling creatieve personages en ook een design voor op de dart flights.<br><br>Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pub Darts</span></div>
</div>
