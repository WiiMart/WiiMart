...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015741384A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">体内や深海を思わせる不思議な空間。その空間内に浮遊する赤・青・緑など（最大５色）の色とりどりの触手をもった生命体（＝自機）をコントロールし、周りから襲ってくるエネミーを吸収して、触手をどんどん伸ばしていくゲーム。それが『ＰＥＮＴＡ ＴＥＮＴＡＣＬＥＳ』（ペンタテンタクルス）です。<BR><BR>自機のコントロールは、Ｗｉｉリモコンを横持ちして、十字ボタンで移動、１ボタンで左回転、２ボタンで右回転をおこなうのみ。それらを組み合わせてエネミーを吸収していきます。<BR><BR>同じ色のエネミーと接触すると伸び、違う色のエネミーと接触するとその場所からちぎれてしまう触手は、直接コントロールすることはできません。<BR>自機の動きに応じて不思議な動き方をする触手の動きを正確に予測することが、攻略のカギです。<BR><BR>すべての触手を一定の長さまで伸ばす「ＳＴＡＧＥ」モードや、触手をどこまでも長く伸ばしていくモードなど、合計３つのモードを用意しています。<BR><BR>しなやかな動きを見せる触手と、そのビジュアルに絡みつくように響くサウンドの組み合わせが描き出す、有機的な世界。<BR>Ａｒｔ　Ｓｔｙｌｅ<BR>『ＰＥＮＴＡ<BR><div align="right">ＴＥＮＴＡＣＬＥＳ』。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015741384A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015741384A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">ＰＥＮＴＡ ＴＥＮＴＡＣＬＥＳ<sup>TM</sup></span></div>
  </div>
