...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">本作は、『メタルスラッグ』シリーズの第五弾タイトルです。プレイヤーは４人の兵士から一人を選び、テロ組織「アマデウス」と戦います。前作同様にジャンプとショットを駆使して、アイテムを獲得して武器を補充し、乗り物で敵と過酷な戦いを繰り広げます。また、今回はメタリッシュシステムという得点システムを搭載しており、スコアアタックの面白さを堪能できます。更に、新アイテムや新キャラなども登場しており、新たなメタスラの世界が展開されています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014543494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014543494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルスラッグ4</span></div>
</div>
