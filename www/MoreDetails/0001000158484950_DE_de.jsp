...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158484950')", "wiiSelectSound()");
...
<br><br>
Wasser - Wir nehmen es täglich zu uns und setzen es als selbstverständlich voraus. Dabei hat es regelrecht magische Fähigkeiten. Ob fest, flüssig oder gasförmig, es wird Zeit, das Wasser ins Rampenlicht zu rücken!
<br><br>
