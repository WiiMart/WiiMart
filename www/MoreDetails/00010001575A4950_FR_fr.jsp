...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001575A4950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rubik's Puzzle Galaxy: RUSH est un jeu de puzzle 3D avec plus de 70 niveaux passionnants. Les joueurs doivent guider les cubes vers les points de sortie de la couleur correspondante.<br>
<br>
En utilisant les commandes intuitives de la télécommande Wii, les joueurs guident les cubes à l'aide de convoyeurs, de téléporteurs, de panneaux d'arrêt, de direction et de fractionnement.<br>
<br>
RUSH inclut aussi le Rubik's Cube original. Les joueurs peuvent résoudre des cubes de 4 tailles différentes, seuls ou contre un second joueur, ou apprendre à résoudre le Rubik's Cube classique.<br>
<br>
RUSH:<br>
- Plus de 70 niveaux à vous griller la cervelle<br>
- Commandes adaptées spécialement pour la télécommande Wii<br>
- Convoyeurs, téléporteurs, panneaux d'arrêt, de direction, de fractionnement et plus encore<br>
- Environnements élégants<br>
- Rubik's Cube classique de 4 tailles différentes<br>
- Tutoriel pour résoudre le Rubik's Cube original<br>
- Tableau des meilleurs scores en ligne
<br><br> Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A4950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Rubik's Puzzle Galaxy:</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">RUSH</span></div>
  </div>
