...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sonic et Tails sont de retour pour une nouvelle aventure dans laquelle ils auront à affronter le Dr. Eggman (alias<br> Dr. Robotnik), qui cherche désespérément à récupérer toutes les Émeraudes du Chaos pour reconstruire son Death Egg. Ils devront mettre la main
sur les émeraudes avant le<br> Dr. Eggman, mais il ne sera pas facile de gagner la course.
<br><br>
Un nouvel adversaire, Knuckles l’échidné, entre en scène et il fera tout son possible pour mettre des bâtons dans les roues de Sonic et Tails. Récupérez tous les anneaux dorés, trouvez des zones bonus et battez Knuckles et le<br> Dr. Eggman en foncant à travers 
ce troisième chapitre des aventures de Sonic.
<br><br>Texte écran en anglais.
<br>Compatible avec le mode entrelacé pour le câble composante AV Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424D50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424D50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Sonic the Hedgehog<sup>TM</sup> 3</span></div>
</div>
