...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015743324A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">クリスタル・ディフェンダーズR2は、フェンサーや黒魔道士などのキャラクターをマップに配置し、迫りくるモンスターからクリスタルを守るゲームです。<BR><BR> マップの入口からモンスターが出現し、出口に向かって進軍します。キャラクターを配置して、モンスターの侵攻を阻止しましょう。<BR><BR> キャラクターには、行動範囲は狭いが攻撃力の高いフェンサー、射程距離は広いが攻撃間隔が長い黒魔道士、素早い敵に有効な時魔道士など様々います。<BR> モンスターとの相性を考えてうまく配置しましょう。<BR><BR> モンスターが出口に到達すると、クリスタルを奪われます。<BR> クリスタルを全て奪われてしまうとゲームオーバーです。<BR><BR> クリスタル・ディフェンダーズR2では、キャラクターたちをパワーアップさせる３色のクリスタルが加わった他、ルートが分岐・合流するマップが多数収録されています。<BR>さらに、R1には登場しなかった「魔砲士」や「からくり士」などの新ジョブも登場し、やり応え十分な内容になっています。<BR><BR> クリスタルを１つも奪われずに全ステージクリアすることを目指してがんばってください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015743324A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015743324A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
