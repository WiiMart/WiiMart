...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574E5345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Uh oh! The scientists are being attacked by a vicious horde of monsters. Use physics to splat those nasty creatures before they get too close. Squash them, skewer them, explode them, and do whatever you can to help our scientist friends survive.
<p>
Use the Wii Remote controller to build traps out of random objects, rope, and elastic. Use springs and explosives for extra destruction. Complete almost 30 levels across four zones and then try and beat the special challenge in each. Will you manage to save the scientists from the horrors of the dark dimension?
<p>
