...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La enciclopedia ilustrada mágica, Aquaticus, ha sido contaminada por un frasco de tinta malévola llamada Influence. En Fluidity controlarás a un cuerpo de agua, que podrás cambiar entre los diferentes estados de la misma: liquido (agua), solido (hielo) y gaseoso (nube). Usa las diferentes propiedades del agua para superar varios obstáculos que han sido esparcidos a través de las páginas de Aquaticus y así salvarla de la corrupta Influence.
<p>
...
Fluidity te ofrece la oportunidad de chapotear y deslizarte por un ambiente imaginativo, lleno de aventuras desafiantes, donde usarás el control de una manera intuitiva. ¿Estás listo para sumergirte en esta experiencia única y salvar el día?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464C45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464C45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
