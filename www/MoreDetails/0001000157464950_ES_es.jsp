...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Reel Fishing Challenge ofrece una experiencia divertida y desafiante, tanto para pescadores noveles como profesionales. Pon a prueba tu destreza y descubre nuevos tipos de peces en el complicado modo misión, o relájate y disfruta del juego a tu propio ritmo en el modo juego libre. Juegues en el modo que juegues, los preciosos gráficos del juego y su ambientación natural darán vida a tu experiencia de pesca. Elige entre una variedad de cebos para atraer y enganchar a los numerosos y astutos peces del juego. ¡Tanto el aspecto de los peces como sus movimientos imitan a los de verdad, será como pescar de verdad, pero sin tener que ponerte las botas!
<br><br>
