...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('00010001584A4750')", "wiiSelectSound()");
...
<br><br>
Benvenuto nel mondo di Gnomz. Gnomz è un divertentissimo nuovo gioco arcade di combattimento per WiiWare™. Gnomz consente a un massimo di quattro giocatori di affrontarsi o collaborare contro il computer in tre differenti modalità.<br><br>
Caratteristiche del gioco:<br><br>
* battaglie tra gnomi con azione multigiocatore in tempo reale<br>
* 25 arene gnomesche piene di azione<br>
* ore di divertimento a suon di botte, schianti e salti<br>
* fino a quattro giocatori (+ 4 computer) per combattimenti in locale<br>
* potenziamenti magici, elefanti volanti, arcobaleni e renne luccicanti<br>
* Smash Match (Gara di schianti), Capture the Sock (Cattura il calzino) e Socker (Collezionista di calzini)<br>
* e molto altro ancora...<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001584A4750/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001584A4750/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Gnomz</span></div>
</div>
