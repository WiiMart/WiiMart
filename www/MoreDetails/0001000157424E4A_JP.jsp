...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157424E4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">植物のキャラクターたちが住む小さな村のバーバー（理髪店）のマスターになって、お客さんの頭に生えた枝や葉っぱをカットしましょう。<BR>
マスターとなったあなたは、ハサミ、バリカン、クシ、キリフキ、フデなど、バーバーのあらゆる道具を使いこなしながら、お客さんにリクエストされるスタイルを仕上げていきます。<BR><BR>村の住民は、１日に５名がカットにやってきます。<BR>カットのスタイルは全部で６０種以上。最初は簡単なスタイルから始め、毎日コツコツと手入れをしてあげることで、食べ物や動物をモチーフにしたもの、色付けが必要なものなど、個性豊かなスタイルにチャレンジすることができます。<BR><BR>カットの腕前を磨き、お客さんの満足度を高めると、お客さんからプレゼントをもらったり、旅先からバーバーへポストカードが届くこともあります。<BR><BR>お気に入りのカットはバーバーのカメラで写真におさめることもできます。<BR>写真はＷｉｉ伝言板に貼ることができます。<BR><BR>人数分のＷｉｉリモコンがあれば、カット時は４人まで一緒にプレイすることができます。ハサミの人、キリフキの人、バリカンの人など、役割を決めてワイワイ遊びましょう。<BR></div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">盆栽バーバー<sup>TM</sup></span></div>
</div>
