...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">後に多くの続編を生み出したＰＣエンジン初のプロレスゲーム。発売当時のレスラーをモデルにした総勢１６名のキャラクターが、リングを舞台に多彩な技の数々を披露します。試合の序盤は、打撃系を軸に相手の体力を削り、チャンスをうかがい大技を仕掛けていきます。勝負のポイントはまさに「タイミング」。互いのレスラーが組み合って腰を落とした瞬間がチャンスです。正確にタイミングをつかめれば、キャラクター独特の技が見事に炸裂します。力と技の駆け引きを制して、相手をピンフォールするか、ギブアップ、リングアウトさせると勝利です。試合形式は１ｖｓ１の「シングルマッチ」をはじめ、２ｖｓ２の「タッグマッチ」、そして５人で１チームを編成し、勝ち抜き戦を行う「イリミネーションマッチ」と、多彩なモードが用意されています。もちろん多人数での協力～対戦プレイにも対応。「タッグマッチ」では４人が一緒にプレイでき、プロレスの醍醐味が味わえます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイヤープロレスリング<sup>&reg;</sup></span></div>
</div>
