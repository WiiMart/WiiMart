...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">敵キャラクターに触れないように具材を落としてハンバーガーを完成させるアクションゲームです。画面内の全てのハンバーガーを完成させるとステージクリア。敵はプレイヤーを狙って素早く近づいてきます。ピンチのときはコショウを使って敵を足止めしたり、具材と一緒に敵を落下させたりして切り抜けてください。落下させた具材で挟み込めば敵を倒すこともできます。様々なテクニックを使ってステージクリアを目指してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バーガータイム<sup>TM</sup></span></div>
</div>
