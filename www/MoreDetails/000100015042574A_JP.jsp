...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ＰＣ原人」として好評を博したシリーズの横スクロール型シューティングゲームです。従来のコミカルな世界観を残しつつ、舞台は原始時代からサイバーパンクな未来世界へ。悪の科学者「キングタマーゴ・サンドロビッチ伯爵」によって改造された「ＰＣ電人ゲンヘッド」が、伯爵の悪巧みを阻止すべく仲間とともに闘います。ゲームは３段階の難易度設定に加え、「仲間モード」を３種類から選択が可能。「ミートカプセル」を手に入れることで多彩な攻撃を繰り出せるほか、１０人の仲間達との「合体無敵」や「ウンチボム」といったユニークな攻撃が楽しめます。さらに超インフレなスコア表記やゲームオーバー時に流れるテーマソングなどの楽しい演出も魅力的です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＰＣ電人<sup>&reg;</sup></span></div>
</div>
