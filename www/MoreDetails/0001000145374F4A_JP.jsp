...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">宇宙パイロットをめざす主人公「天現寺ひろみ」が乗り込むエアバイクやエアプレーンを操作して、全６日間の卒業試験に挑む３Ｄシューティングゲームです。コース上にあるいろいろなアイテムを取って、自機をパワーアップさせることもできます。１日の最後にはボス戦が待っています。
教官がボスの弱点を教えてくれるので、弱点を集中的に攻撃しましょう。ボスを倒して卒業試験に合格できればゲームクリアです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145374F4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145374F4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バーニングフォース<sup>&reg;</sup></span></div>
</div>
