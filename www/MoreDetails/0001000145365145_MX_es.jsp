...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Estamos en el año 19XX d.C., y la raza humana se encuentra al borde de la aniquilación por culpa del ancestral Señor de las Bestias, ahora resucitado. En un intento por detenerlo trajeron de nuevo a la vida a Rygar, un guerrero legendario, para devolver de nuevo la paz a la humanidad. Ármate con tu escudo siempre sujeto a una poderosa cadena y utiliza todas tus habilidades para abrirte paso a través de 27 intrincadas fases. En 1986 hizo su aparición en los salones recreativos este juego de acción de desplazamiento horizontal. El juego recibió maravillosas críticas gracias a sus increíbles gráficos renderizados y a sus efectos, como las puestas de sol y las cascadas. Este juego incluye muchas características adicionales, como por ejemplo obtener los cinco poderes de Indra para conseguir bonificaciones especiales u obtener un millón de puntos por hallar objetos ocultos (libro de los secretos de Indra). Además, podrás configurar el número de vidas y el nivel de dificultad.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145365145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145365145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">RYGAR<sup>TM</sup></span></div>
</div>
