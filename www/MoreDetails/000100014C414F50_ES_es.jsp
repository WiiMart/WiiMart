...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">R-TYPE es un clásico arcade de disparos de desplazamiento lateral desarrollado por Irem en 1987. La acción tiene lugar en el siglo XXII y eres la última esperanza de la humanidad para acabar con el malvado Imperio Bydo. Tu nave se llama "Arrowhead", es del tipo R-9a y está equipada con un láser estándar, aunque en cada misión hay disponibles actualizaciones y mejoras especiales. 
<br><br>
Navega a través de ocho desafiantes niveles que pondrán a prueba los reflejos del mejor de los jugadores. La versión de SEGA MASTER SYSTEM también incluye un exclusivo nivel secreto que no se encuentra en ninguna otra versión.
<br><br>
