...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157544650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Der Kreis schließt sich... mit CommanderVideos letztem Abenteuer BIT.TRIP FLUX endet die BIT.TRIP-Reihe.<br><br>
Schnapp dir deine Wii-Fernbedienung und mach dich bereit für diesen Klassiker: CommanderVideo kehrt zum Anfang zurück.<br><br>
Ob du den Einzelspielermodus oder den Zweispieler-Koop-Modus spielst, du wirst vor neue Herausforderungen gestellt, die selbst die erfahrensten BIT.TRIPPER zum Heulen bringen werden.<br><br>
Stelle dich unglaublichen Aufgaben – eingebettet in das bekannte Schläger-Spiel, das den BIT.TRIP-Hype ausgelöst hat.<br><br>
• Neue Power-Ups, zum Beispiel Fullscreen Paddle!<br>
• Neue Schlagarten, zum Beispiel Avoid Beats!<br>
• Kontrollpunkte innerhalb der Level!<br>
• Klassisches BIT.TRIP BEAT-Vergnügen mit allen Modi, darunter auch der neue Meta Mode!<br>
• Bit Shifter kehrt zurück... als Chiptune-Gaststar!<br><br>
Begleite CommanderVideo auf seiner letzten Mission und seiner Reise zurück nach... Hause.
<br><br>
Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
