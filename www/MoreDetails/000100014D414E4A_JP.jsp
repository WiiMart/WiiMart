...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">未来世界のレジャー施設「ゲイングランド」の中に閉じ込められた人々を救い、暴走したコンピュータを停止させるため、２０人の仲間が力を合わせて戦うタクティカルアクションシューティングです。５つの世界に分けられた５０のステージに待ち受けるロボット兵を倒し、囚われの仲間を助け出します。助けた仲間は次の面から新たなプレイヤーキャラクターとして活躍できるところが本作のポイント。２０人のキャラクターは生まれた時代も能力も違います。ヤリ１本で戦うスピード重視の原始人、魔法を操る中世の騎士、近代銃器を使う兵士たち、強力な火力で敵を圧倒する未来のロボットなど、個性豊かな登場人物と多彩な武器を使いこなして、ステージをクリアしていきます。高い評価を得たオリジナルのアーケード版同様、２人同時プレイが可能なのはもちろんのこと、新たに１０個のステージが追加されています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゲイングランド<sup>TM</sup></span></div>
</div>
