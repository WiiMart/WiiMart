...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">全世界で今なお高い人気を得ているＲＰＧ「ファイナルファンタジー」の１作目です。暗黒につつまれた世界を救い、クリスタルに輝きを取り戻すため、戦士、シーフ、モンク、赤魔術士、白魔術士、黒魔術士の職業（ジョブ）から好きなジョブを選んで４人パーティを組み、光の戦士となって冒険の旅へ出ます。ジョブやクラスチェンジの概念、ケアルやファイアなどの魔法体系、飛空艇やクリスタルなど、その後のシリーズに受け継がれる要素が凝縮されています。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファンタジー <sup>&reg;</sup></span></div>
</div>
