...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気アクションゲーム「スーパードンキーコング」シリーズの第三弾。島の探検に向かったまま戻らないドンキーコングとディディーコングを探しに、
ディクシーコングと赤ちゃんコングのディンキーが、謎につつまれた「クレミス島」の冒険へと出発します。ポニーテールを自在に操り身のこなしもすばやいディクシーと、ドンキーコングにも負けないパワーと立派な体重のディンキー。ふたりを状況に応じて入れかえ、それぞれの特長を活かしたアクションを使いこなして、コースに立ちはだかる敵や障害をクリアしていきます。ふたり一組で行動の幅が広がる「チームアップ」アクションや、協力してくれるアニマルフレンド、ＤＫコインやボーナスステージの攻略などもパワーアップして再登場。島のいたるところに隠されている「ベアーコイン」や「バナナバード」たちを見つけながら、さまざまなコースが待ち受ける８つのエリアを乗り越え、完全クリアをめざします。２人プレイでは、交代で協力プレイと、交互にプレイして競う対戦プレイとを選ぶことができます。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパードンキーコング<sup>&reg;</sup>３</span></div>
</div>
