...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574E5650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tangram-Multiplayer-Action! <br>
Versucht das Puzzle-Spiel, das am meisten süchtig macht und direkt aus Japan gekommen ist! <br>
NEVES Plus ist ein einfaches und spannendes Rätsel, welches auf den Puzzles des mythischen Orients beruht.  <br>
Bis zu vier Spieler können über 500 Rätsel zusammen lösen. Dazu bewegen, drehen und wenden sie die sieben Glücksteine in jedem der über 500 Silhouetten-Puzzles. Oder ihr könnt gegeneinander in einem Multi-Player-Modus konkurrieren: Versus, Schnelligkeit, Glückszahl und Partyquiz!  <br>
NEVES Plus wird Dich mit seinen genialen Silhouetten verzaubern, wenn Du alleine oder mit Freunden spielst.   <br>
- Über 500 Silhouette-Puzzles. <br>
- Fünf Spiel-Modi. <br>
- Jeder Modus kann mit bis zu vier Spielern gespielt werden. <br><br>
  
Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E5650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E5650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">NEVES Plus:</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Pantheon of Tangrams</span></div>
  </div>
