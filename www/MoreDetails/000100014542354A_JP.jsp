...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９８年にリリースされた格闘ゲームで、幕末を舞台に十数人の剣士たちが、それぞれの目的のために戦います。同社の「サムライスピリッツ」シリーズと似ている印象がありますが、キャラクター選択時に、ダメージ重視の「力」か、手数で勝負の「技」といった剣質から一つを選択できたり、敵の攻撃を跳ね返す「弾き」、特定の必殺技をキャンセルして超奥義につなぐ「昇華」といった本作ならではの要素もあり、多彩な駆け引きが楽しめます。もちろん、「超奥義」や「潜在奥義」といった強力な技も必見です。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">幕末浪漫 月華の剣士</span></div>
</div>
