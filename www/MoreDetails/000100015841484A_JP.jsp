...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ペンギンが氷の上を滑るアクションゲーム、「けっきょく南極大冒険」の続編として発売されたアクションゲーム。前作では氷上ステージのみの構成でしたが、本作では洞窟や海中などバリエーション豊かなステージが追加されました。ペンギンのペン太を操作し、不治の病に倒れたペンギン王国のペン子姫を助けるため夢大陸に渡ってゴールデンアップルを持ち帰ることが目的です。ハートを取ることでのパワーアップやお店でアイテムが買えるなど、システム面でも大幅な強化が図られています。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">夢大陸アドベンチャー</span></div>
</div>
