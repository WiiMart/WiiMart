...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">패밀리컴퓨터 용으로 발매된 퍼즐 게임. 주인공 「로로」는 대마왕에게 납치된 사랑하는 「라라」를 구출하기 위해 대마왕의 마수 군단이 지배하는「마수의 탑」에 도전합니다. 로로가 할 수 있는 것은 매직샷으로 적을 알로 만드는 것과 에메랄드를 움직여 공격을 막는 것. 적에게 잡히지 않도록 도망치면서 매직샷과 에메랄드를 잘 사용하여 스테이지를 공략해야 하며, 단순한 규칙이지만 퍼즐 게임의 필수 조건인 지혜와 재치가 필요한 게임입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146425554/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146425554/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">로로의 모험</span></div>
</div>
