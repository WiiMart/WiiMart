...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８４年にカプコンゲーム第２弾として登場し、個性豊かなキャラクターやフードアイテムなど、楽しさあふれる世界観で人気を博した名作です。ありがたいお経を手に入れるため、次々と出現する敵を倒しながらテンジクを目指すシューティングゲーム。当時としては珍しい２人同時プレイが可能で、長く険しいテンジクへの道を協力して進むことができます。<BR><BR>詳細は、<Center>http://www.capcom-onlinegames.jp/category/wii.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソンソン</span></div>
</div>
