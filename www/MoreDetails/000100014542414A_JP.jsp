...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">1996年にデータイーストからリリースされたアクションパズルゲームです。ルールは単純明快、ピエロを操作して画面上の玉を吸ったり吐いたりし、縦に同色の玉を３つ並べれば、その玉は消えてなくなります。同色の玉をまとめて消せる「スペシャル玉」、矢印が示す方向の玉をまとめて消す「矢印玉」、プレイの邪魔をする「泡玉」、ぶつけた玉のスペシャル玉として効果を発揮する「虹玉」といった特殊な玉も登場し、パズルゲームならではの連鎖やまとめ消しなどが楽しめます。次々と登場するコミカルな相手と戦う「ストーリーモード」、一人でとことん楽しむ「ひたすらモード」、詰め将棋のような遊び方が楽しめる「ひらめきモード」のほか、プレイヤー同士の対戦プレイも可能なので、友達とわいわいお楽しみいただけます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マジカルドロップ２</span></div>
</div>
