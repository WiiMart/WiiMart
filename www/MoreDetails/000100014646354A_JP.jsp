...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ダブルドラゴンⅡ The Revenge』は、１９８９年１２月２２日にファミリーコンピュータ用ソフトとして発売されたアクションゲームです。前作から数年後、平和を取り戻した町に謎の武装集団が出現し、主人公ビリー達の道場も襲われてしまいました。ビリーと兄のジミーを操作して、死んでいったビリーの恋人のマリアンと仲間達の復讐を成し遂げましょう。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ダブルドラゴンⅡ</span></div>
</div>
