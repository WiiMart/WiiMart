...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158495145')", "wiiSelectSound()");
...
<p>
¡Toma tu Wii Remote y prepárate para el mejor juego de dardos de tu consola Wii! Dart Rage cuenta con el sistema de lanzamiento de dardos más realista hasta la fecha. Ningún otro videojuego te ofrecerá una sensación tan parecida a la de arrojar un dardo en la vida real. Gracias a que no te obliga a usar botones y a que cuenta con una precisión envidiable, el realismo del juego te envolverá por completo. En Dart Rage, todas las miradas se posan en ti mientras compites con amigos, la computadora o ambas cosas a la vez. Con las cuatro variantes estupendas que ofrece Dart Rage, críquet, póquer, dardos americanos y 301 a 901, es imposible que te aburras o te canses. También se incluye un modo de duelo en el que puedes competir al mismo tiempo en una carrera por llegar a la meta antes que tu oponente. Pero eso no es todo: mientras juegues, disfrutarás de una banda de sonido electrizante y de un relator que anuncia cada acierto o desacierto.
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495145/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158495145/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dart Rage </span></div>
</div>
