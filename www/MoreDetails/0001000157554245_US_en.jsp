...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157554245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">What’s Ubongo? Its mechanics are very simple. Just solve as many puzzles as you can and get gems of the same color. At the end of the established time, the player who has the most gems of any one color will be the winner. The original board game is a blockbuster in many countries, where its popularity has translated into high sales for Ubongo. Why? Because, under a seemingly simple premise, an extremely entertaining game hides. You may find yourself always wanting to play just one more time!
<p>
-History Mode<br>
In this mode you’ll take the role of Kanu and must defeat the followers of evil Rifictus, beating them in Ubongo's games. 
<p>
-Quick Game<br>
Play a quick game of Ubongo.
<p>
-Time Attack<br>
In this mode you should focus your efforts on the clock, as the key is to get a high number of gems within a time limit! So here it will be important to have a good strategy in order to get the gems as quickly as possible.
<p>
-Multiplayer Mode<br>
Challenge your friends in this mode for up to four players.
<p>
(Content available in English, French, and Spanish.)</div>
  <div id="image02">
