...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This classic title features SEGA’s very first mascot, Alex Kidd! Alex had given up hope that his kidnapped father, King Thor, would return to his kingdom on Planet Aries. When the news arrived that he was very much alive and being held captive on the planet Paperock, Alex raced to his rescue!
<br><br>
Through 11 levels you will battle enemies and avoid obstacles while winning coins that will buy you special items and vehicles. At the end of each level, you’ll encounter a boss and enter into a match of “Rock, Paper, Scissors”. Throw the right symbols and you’ll be closer to bringing King Thor home; throw the wrong symbols and you’ll be squashed beneath a heavy weight!
