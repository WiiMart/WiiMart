...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">センセーショナルなＴＶ番組「ナックルヘッズ」は、世界中から強者を集めて格闘させるエンターテイメントショー。見事勝ち抜いた者には、この上ない名誉とスポンサーからの巨額な賞金が与えられるといいます。このゲームは、出場する６名のキャラクターから一人を操作して「ナックルヘッズ」を勝ち抜くことをめざす、対戦型格闘ゲームです。上段・下段の攻撃にジャンプの３つのボタンと、気合攻撃や、コマンド入力による特殊技を駆使して戦います。攻撃ボタンを押し続けると気合がたまり、その気合攻撃は、たとえ相手にガードされても相手の体力を消耗させることができます。一人の相手に２度負けると、ゲームオーバーです。また、対戦格闘ゲームでは初となる４人同時プレイも可能。４人対戦では全員が色違いの同じキャラクターで戦うこともできます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145374A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145374A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ナックルヘッズ<sup>TM</sup></span></div>
</div>
