...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157564B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Water Warfare es un juego de disparos en primera persona de corte cómico que usa pistolas de agua para luchar y dejar empapado a los rivales. Cada mapa (ambientados en un parque, una playa, una plaza y un parque natural) se genera automáticamente al inicio de la partida, ¡así que la estrategia cambia en todo momento! Incluye el modo misión de un jugador, el modo partida contra jugadores IA, y un modo para dos jugadores en pantalla partida. Además, hasta 8 jugadores de todo el mundo pueden luchar entre sí a través de la Conexión Wi-Fi de Nintendo o participar en el modo clasificación.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564B45/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564B45/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Water Warfare<sup>TM</sup></span></div>
</div>
