...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">“Around the World” es un juego sobre geografía para todos los públicos. Incluye un modo individual, para que sigas ampliando tus conocimientos sobre la materia, y un modo multijugador, para competir con familiares y amigos.<br><br> 
La filosofía del juego combina dos formatos distintos, en los que el jugador dispone de un tiempo limitado:<br>
- Preguntas: el jugador debe responder eligiendo la respuesta correcta entre un gran número de opciones.<br>
- Indicar el sitio más cercano: el jugador debe situar un lugar dado de la forma más precisa posible.<br><br>
De una forma amena y distendida, el juego aborda la geografía como un todo, en el que tienen cabida desde la historia y los monumentos hasta el deporte, el arte, la literatura y los temas de sociedad. <br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414550/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414550/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
