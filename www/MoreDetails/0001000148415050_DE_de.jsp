...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dieser aktualisierten Version für den Mii-Wettbewerbskanal ist es möglich, alle bisher übertragenen Miis in die Übertragungslobby zu rufen. Auch sind ab jetzt Altersbeschränkungen möglich.
<br><br>
Der Mii-Wettbewerbskanal wird in Verbindung mit den Mii-Kanal verwendet und ermöglicht es dir, deine Lieblings-Miis mit anderen Wii-Besitzern zu teilen und an spannenden Themenwettbewerben teilzunehmen.
<br><br>
Besuche die Übertragungslobby, um die neuesten und beliebtesten Miis anzusehen und übertrage deine Miis, um sie anderen zu zeigen. Wenn dir ein Mii gefällt, speichere es einfach in deine Favoriten-Liste oder "nimm es mit", indem du es in deinen Mii-Kanal importierst.
<br><br>
Und wenn du deine Fähigkeiten beweisen willst oder einfach nur bewerten möchtest, sieh bei den Mii-Wettbewerben vorbei, die eine bestimmte Themenvorgabe haben und regelmäßig aktualisiert werden.
<br><br>
Du kannst auch ein Erinnerungsfoto deines Miis erhalten, einfach indem du teilnimmst. Und wer weiß - mit genug Stimmen könntest du sogar Meister-Mii-Designer werden!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148415050/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148415050/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mii-Wettbewerbskanal</span></div>
</div>
