...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157584250')", "wiiSelectSound()");
...
<br><br>
Choose from 10 different aliens to work your way through 15 levels completing puzzle challenges along the way!
<br><br>
Fight through menacing villains and bosses in Ben’s newest adventure!
<br><br>
Experience the world of Ben 10: Alien Force with 3D characters set in a vibrant, 2D-styled environment!</div>
  <div id="image02">
