...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D4C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The ultimate chomp-off is about to begin! Grab your Wii Remote™ controller and dig into twelve different foods as you compete against the greatest major-league eaters in the world. This isn’t just a race to stuff your face—you’ll need strategy to master a smorgasbord of digestive attacks, defenses, and counters. These include the Mega Burp, Gas Attack, Antacid, and more. And don’t forget to keep an eye on your Barf-O-Meter, because if the food hits the plate twice, you’re out! Unlock 10+ characters in single-player career mode, go gut to gut against your friends in versus mode, or compete online through your Nintendo® Wi-Fi Connection. Online play supports friend codes, random matchmaking, and leaderboards.</div>
  <div id="image02">
