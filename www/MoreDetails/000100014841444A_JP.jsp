...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「インターネットチャンネル」は、ご家庭のテレビでインターネットのホームページが見られるチャンネルです。<BR><BR>

Opera Softwareのフルブラウザを使用し、JavaScriptに対応。<BR>
また、Adobe Flash Lite 3.1（※Adobe Flash バージョン8相当）を搭載し、対応したホームページ上のFlashコンテンツや動画なども見ることができます。<BR>
（※全てのFlashコンテンツに対応しているわけではありません。）<BR><BR>

操作は簡単。十字ボタンやBボタンでページをスクロール、気になるリンクにポイントしてＡボタンでジャンプ。また、＋、－ボタンを押せば、ポイントした部分を中心にページを拡大・縮小することができます。<BR><BR>

詳細は、<Center>http://www.nintendo.co.jp/wii/ </Center><div align=right>をご覧ください。</div><BR></div>
  <div id="image02">
    <img src="/oss/ccs/000100014841444A/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014841444A/FFFD000A" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">インターネットチャンネル</span></div>
</div>
