...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cratermaze è un divertente gioco d’azione che si svolge in un mondo parallelo.<br> Durante un viaggio nel tempo, tu ed i tuoi amici dovrete affrontare Kublai, uno scagnozzo del malvagio Zenzombie, che ha imprigionato i tuoi compagni di avventure in una zona circoscritta della dimensione spazio-temporale.
Fatti strada attraverso i 60 labirintici livelli per salvare i tuoi amici.
Dinosauri, ninja, robot ed altri nemici ti aspettano in labirinti sparsi nelle diverse ere temporali, da quelle preistoriche a quelle future.
Cerca di evitarli scavando delle buche in cui farli cadere e poi ricoprile per eliminarli!
Raccogli tutti i forzieri entro il tempo limite, ottieni la chiave e passa al livello successivo.<br>
Grazie a elementi quali pale e piattaforme a molla, la giocabilità, in Cratermaze, raggiunge nuovi livelli per un’esperienza indimenticabile! 
