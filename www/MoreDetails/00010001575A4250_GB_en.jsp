...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001575A4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cricket Challenge is an arcade style sports game that gives you a fun filled experience while playing as a batsman in a game of cricket. Using the Wii Remote as a real cricket bat you can swing and control the actions of a batsman to make him play strokes, hit boundaries, 6’s and try a variety of shots.
<br><br>
The game is set-up in a playground amidst an urban background with buildings, apartments and a lush green outfield giving a casual feel to the game.</div>
  <div id="image02">
