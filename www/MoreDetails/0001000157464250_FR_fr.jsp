...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157464250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Avec Sandy Beach, utilisez votre télécommande Wii pour faire des châteaux de sable en 3D! Vous pouvez prendre des photos de vos chefs-d’œuvre et les conserver dans une galerie dédiée et même bâtir des châteaux de sable avec des amis sur les doux rivages de Sandy Beach. <br>
Attention toutefois au mode Crab Battle, dans lequel les crustacés ne reculeront devant rien pour assiéger votre château. Construisez-le de façon stratégique puis défendez votre magnifique création à grand renfort de canons. <br>
Après avoir réussi à le défendre, utilisez votre détecteur de métaux pour trouver les trésors oubliés qui viendront décorer votre château, ou des canons qui vous permettront de le défendre contre un nouvel assaut de ces crabes exaspérants.<br><br>Texte écran en français.</div>
  <div id="image02">
