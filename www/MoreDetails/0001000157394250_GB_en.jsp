...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157394250')", "wiiSelectSound()");
...
<br><br>
Game types include: Train Trouble, Saloon, Windmill, Ranch, Mine, Street Scene, Boot Hill Cemetery, Outlaw Camp, Western Diorama and Turning Cards.</div>
  <div id="image02">
