...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157475350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Meet Phoenix Wright, the rookie defence lawyer new to the scene with the wildest cross-examination skills in town!  Take on four intriguing cases to reveal dramatic, stunning, and even comical court proceedings.  Use the Wii Remote to investigate the crime scenes, question witnesses and present shocking evidence.</div>
  <div id="image02">
