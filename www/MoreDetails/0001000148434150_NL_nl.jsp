...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Met het Jam with the Band Live Channel kun je via een Wii-systeem een eigen jamsessie opzetten, waarbij je je tv als speaker gebruikt!
<br><br>
Download en start dit kanaal, en kies vervolgens “How to Connect” voor meer informatie over het opzetten van een Wii-jamsessie.
 <br><br>
Speel je favoriete nummers alleen of met vrienden. Je kunt zelfs een zangpartij op je nemen. (Je stem wordt echter niet via de tv afgespeeld.)
<br><br>
Elke speler heeft een apart Nintendo DS-systeem nodig, maar er is slechts één Game Card van Jam with the Band vereist; spelers die geen Game Card hebben kunnen verbinding maken via DS Download Play.
<br><br>
Het spel bevat Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148434150/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148434150/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
