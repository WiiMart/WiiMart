...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157545445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Toki Tori es su nombre y reunir huevos es su misión! En este juego de puzle y plataformas, los jugadores pueden utilizar objetos, como el Teletransportador, la Roca instantánea™ y el Absorbe-babosas. Para resolver más de 70 niveles del juego, necesitarán un gran ingenio para usar y combinar estos objetos. El juego va aumentando de dificultad, lo que resulta en docenas de interesantes horas de juego. Toki Tori aprovecha al máximo las opciones que ofrece la consola Wii. Utiliza un sistema de control único del mando de Wii, que ofrece a los jugadores un nuevo estilo de juego más relajante. También puedes recibir la ayuda de un segundo jugador, que puede dibujar pistas mientras estás jugando. Este juego también utiliza el Tablón de Wii de un modo único. Toki Tori: es un juego de puzle y plataformas, que ofrece docenas de horas de juego, utiliza múltiples mandos de Wii para un nuevo estilo de juego, utiliza el Tablón de Wii, e incluye los diálogos y el manual en Español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
