...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574B5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Travaillez en équipe ou en solo dans chaque niveau afin de trouver les objets qui permettront au héros de rentrer chez lui. Des coquillages aux bijoux étincelants, faites de votre mieux pour trouver les objets cachés aussi vite que vous le pouvez ! Au cours de cette aventure, vous devrez également faire face à des fantômes et à un dragon dans quelques niveaux d'action. Il y a beaucoup d'objets et d'émotions à découvrir dans ce jeu d'objets cachés !<br><br>
  
Jusqu'à quatre joueurs peuvent participer pour un plaisir de jeu inégalé. Famille et amis peuvent s'associer afin de terminer un niveau le plus rapidement possible, ou rivaliser dans le but de voir qui est le plus doué pour trouver des objets cachés !
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Les aventures de l'ÎLE PERDUE</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Jeu d'objets cachés</span></div>
  </div>
