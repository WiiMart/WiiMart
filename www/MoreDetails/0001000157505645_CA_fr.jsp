...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157505645')", "wiiSelectSound()");
...
<p>
"Chaotic Conflicts" is just one part of The Tales of Bearsworth Manor saga. Complete both games to uncover an even deeper mystery...</div>
  <div id="image02">
