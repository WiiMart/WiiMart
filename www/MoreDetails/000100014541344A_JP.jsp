...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">対戦格闘ゲーム『サムライスピリッツ』シリーズの第三弾です。ストーリーは初代と前作『真サムライスピリッツ』との間に位置づけられており、プレイヤーは１２人の侍から一人を選択して、「壬無月斬紅郎」の打倒をめざします。前作と比較して、自分で怒りゲージをためられるようになったり空中ガードが搭載されたりなど、細かい変更が施されました。また、プレイキャラクターに「修羅」と「羅刹」の二種類の性格が設定され、選んだ性格によって異なる必殺技が使えるため、事実上２倍のキャラクターでの戦いを楽しめます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">サムライスピリッツ</span></div>
</div>
