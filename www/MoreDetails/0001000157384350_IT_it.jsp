...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157384350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">La saga di BIT.TRIP prosegue con BIT.TRIP CORE in questo gioco in stile rétro-arcade.
<br><br>
BIT.TRIP CORE è un emozionante gioco di azione e ritmo che potrai godere al meglio se ti lascerai avvolgere dall'atmosfera dei brani e dalla grafica accattivante. L'esperienza si ispira ai giochi degli anni Ottanta, con un tocco moderno. La meccanica di gioco è completamente nuova per questa serie e si lascia alle spalle i comandi ad asse singolo di BIT.TRIP BEAT in favore della possibilità di controllare due assi.
<br><br>
Se incontri delle difficoltà, chiama un amico per giocare in modalità
cooperativa. Raggiungi la fine per fare un ulteriore passo verso il completamento del viaggio di BIT.TRIP.
<br><br>
