...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Step onto the court in one of the first volleyball games ever made! Select either the men’s or women’s competition, choose from one of eight available countries to represent, and then prepare for some intensely fun game play. The straightforward controls include all the moves you’ll need to use to effectively direct your six-person team. Take some time mastering them in the training mode, though, because you’ll need all the practice you can get when competing against challenging computer opponents! Or if you feel like some multiplayer action, take on a friend in the two-player mode and see whose skills are more polished. Block, set, and spike your way to victory!</div>
  <div id="image02">
