...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157575445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Los clásicos juegos retro pueden ir más allá de su plataforma original y avanzar en la siguiente generación. BurgerTime World Tour es la evolución de un clásico arcade mejorado con entorno cilíndrico rotatorio en 3D y gran jugabilidad retro. El eje rotatorio te permite ver a través del nivel cilíndrico, creando elementos clave para decidir la manera más rápida de completar una hamburguesa. Pueden competir hasta cuatro jugadores, con marcadores y trofeos. Ahora Peter Pepper puede lanzar a sus enemigos. Lanzar una verdura enfadada ayudará a soltar con precisión a un enemigo en una parte de la hamburguesa, lo que dará al jugador muchos puntos de bonificación. Con elementos de plataformas desafiantes, jefes y más de 30 niveles, el nuevo BurgerTime está fresco y en su jugo. Vive el BurgerTime original en un mundo 3D mucho más grande. ¡Huye de verduras enfadadas y construye hoy tu BurgerTime World!
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157575445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157575445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
