...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574B4B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">● Was ist Pop-Up Pirate!?<br>
Jeder kann tonnenweise Spaß im Pop-Up Party-Modus haben oder im Pop-Up Logic-Modus einem Einzelspieler Spiel frönen. Die Spieler müssen die Fässer durchstoßen, die den Kapitän gefangen halten, aber darauf aufpassen, ihn nicht zu verletzen! Einzigartige Wii-Funktionen machen dies zu einem Partyspiel erster Klasse.
Für einige Lacher kannst du den Kapitän auch mal gegen einen Mii™ austauschen!
<br><br>
● Pop-Up Logic spielen<br>
Du musst ein Loch innerhalb des Zeitlimits auswählen und dein Schwert reinstecken. Wenn das Loch sicher ist, zeigt der Kapitän dir wie viele Löcher in dieser Gegend vermieden werden müssen.
Nutze diese Hinweise, um dein Schwert weise zu nutzen und von den gefährlichen Löchern fern zu bleiben. Für jedes erfolgreiche Zustoßen wird dir zusätzliche Zeit zu der übrigen hinzuaddiert.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
