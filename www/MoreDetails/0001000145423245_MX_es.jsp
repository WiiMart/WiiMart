...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juego de lucha publicado en 1997, sexta entrega de la serie Fatal Fury. El sistema de lucha está basado en las versiones previas del juego, con novedades tales como las dos líneas de batalla, la mejora de la barra de energía, la eliminación del sistema de expulsión del cuadrilátero y otros elementos que te permitirán elaborar distintas estrategias de combate.  Además de los 15 personajes presentados en las anteriores entregas (excepto Geese), aparecerán grandes luchadores como Tung Fu Rue, Cheng Sinzan, Laurence Blood y Wolfgang Krauser, resultando un total de 19 luchadores de lo más especiales. Quién de ellos es el más fuerte lo resolverán de inmediato a puñetazos.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145423245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145423245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
