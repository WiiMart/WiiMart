...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157545250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Lo retro vuelve a estar de moda con BIT.TRIP BEAT! Aprovecha el sensor de movimientos incorporado en el mando de Wii para mantener el compás en este juego lleno de ritmo.   <br><br>
...
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
