...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９５年にリリースされた競馬がテーマのゲーム。８頭の新馬から1頭を選んで、新馬戦を皮切りに様々なレースに挑戦し、最終的にはＧＩレースで勝利を目指します。ゲームでは方向キーで馬を操作し、ボタンで加速するという単純な操作ですが、競馬ならではのレース展開や仕掛けが十二分に楽しめます。さらに首押しや馬群割りといった特殊技、レース中のアイテム獲得でレースを有利に進められる、馬の表情から現在のレース展開が適切なのかがわかるなど、ゲームらしい特徴も盛り込まれています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014543444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014543444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ステークスウィナー</span></div>
</div>
