...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000158494E50')", "wiiSelectSound()");
...
<br><br>Welkom in de wereld van de PooYoo's, de eerste leuke en vrolijke braintrainer voor kinderen van 3-6 jaar oud.
<br><br>
Samen met de PooYoo's, een gezellig groepje schattige babydiertjes, maakt je kind kennis met allerlei dingen die goed zijn voor zijn ontwikkeling: cijfers, letters, vormen, kleuren en nog veel meer. Bovendien wordt de lateralisatie gestimuleerd. Kinderen kunnen samen met hun nieuwe vriendjes dansen en krijgen allerlei interactieve beloningen. Er zijn twee niveau's wat betreft interactie, dus kinderen kunnen altijd spelen, ongeacht hun niveau of leeftijd.
<br><br>
Dit spel is speciaal ontwikkeld om gebruikt te worden door kinderen die nog niet kunnen lezen.
<br><br>
Het spel is voorzien van Nederlandse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494E50/FFFD0013" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Aflevering 1 - Demo</span></div>
  </div>
