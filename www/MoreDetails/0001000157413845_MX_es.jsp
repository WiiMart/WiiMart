...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157413845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Controla a un organismo circular llamado rotozoan y prueba tu destreza mientras te abres camino a través de los niveles del caldo primordial. Compuesto de tan solo tres partes (lados, tentáculos y energía de vida) el objetivo principal de tu rotozoan es simple: crecer tentáculos.
<p>
Después de que juegues algunos niveles, habrás aprendido las reglas básicas de este  microscópico mundo y serás capaz de desbloquear modos adicionales de juego y  de seleccionar el número de tentáculos del rotozoan. Cada modo de juego tiene su propio objetivo ya sea el de hacer crecer los tentáculos del rotozoan en una medida determinada o el de hacer crecer los tentáculos lo más posible. Independientemente del modo que escojas, crecer tentáculos significará que tendrás que absorber a los enemigos (conocidos como goobug) y para lograrlo tendrás que tocarlos. Pero hay un pequeño problema... Para absorber a los enemigos deberás asegurarte de que el color del goobug es el mismo color del tentáculo. Además debes tomar en cuenta que entre más largo sea el tentáculo más fácilmente este tocará a un enemigo de color diferente y esto causará daños al tentáculo y a la energía de vida. Y eso no es todo, los enemigos goobug se multiplican y se adaptan a tus movimientos. Por suerte, podrás encontrar objetos que te ayudarán a sobrevivir tales como el objeto corazón con el cual recuperarás energía de vida y el objeto ciclón que te permitirá utilizar el ataque ciclón.
<p>
Con escenarios que van desde la relajante calma hasta el intenso desafío, Art Style: Rotozoa ofrece una gran variedad de niveles. Para conseguir la victoria necesitarás movimientos rápidos pero precisos y la habilidad de conservar la calma ante la presión. ¿Estás listo para enfrentarte a los goobug?
<p>
La serie de Art Style ofrece un diseño elegante, gráficos pulidos y controles simples, creando una experiencia que se centra principalmente en un estilo de juego divertido y atractivo.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157413845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Art Style<sup>TM</sup>: Rotozoa<sup>TM</sup></span></div>
</div>
