...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">本チャンネルは『ゼルダの伝説 スカイウォードソード』を
プレイされているお客様向けのチャンネルです。<BR><BR>
本チャンネルは、同ソフトにおいて、ゲームの進め方によっては
「勇者の詩」を手に入れるイベントで、「砂漠」で入手する「雷
龍の詩」を入手した後、その他の「火山」、「森」で起きるはず
の「詩」の入手イベントが起きず、先に進めなくなってしまった
セーブデータを、正常な状態に修復するためのチャンネルです。<BR>
『ゼルダの伝説 スカイウォードソード』をプレイされていない方は、
本チャンネルをご利用いただく必要はありません。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843524A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    </div>  
</div>
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゼルダの伝説　スカイウォードソード</span></div>
</div>
