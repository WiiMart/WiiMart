...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Questo seguito dell'originale The Legend of Zelda™ è famoso per aver indirizzato la serie verso una nuova direzione, introducendo elementi che diventarono caratteristiche distintive della serie. In Zelda II™: The Adventure of Link™, Link è in missione per ritrovare la Triforza del coraggio e risvegliare la principessa Zelda dal sonno magico in cui è stata gettata da uno stregone malvagio. E tutto mentre i servitori di Ganon stanno tentando di riportare in vita il loro padrone.<br>
Invece della tipica vista dall'alto, Zelda II utilizza una prospettiva a scorrimento laterale e una mappa del mondo. Presenta inoltre elementi da gioco di ruolo mai visti prima nella serie. Zelda II è anche ricco di nomi di luoghi e personaggi che i fan della serie riconosceranno sicuramente.
