...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il baseball è uno sport che riscuote molto successo in Giappone e in Nord America, altrove però è poco conosciuto. Nintendo ti offre l'opportunità di avvicinarti ad esso tramite questo gioco. All’epoca era considerato una delle migliori simulazioni sportive disponibili grazie alla semplicità e alla grafica simpatica. Rimane una buona introduzione alle sue regole. Il gioco permette di scegliere una tra sei squadre. In Giappone, queste rappresentavano l’intero gruppo della Central League, che ospita alcune delle più famose squadre di quella nazione. Nella versione internazionale, quelle squadre vennero rimpiazzate con le sei più famose della lega nordamericana dell’epoca.
