...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jij bent Tom-Tom de Wonder Boy en het is aan jou om je vriendin Tanya te redden uit de klauwen van het afschuwelijke monster dat haar heeft ontvoerd.<br><br> Baan je daarom een weg door een reeks werelden in een race tegen de tijd. Versla vijanden en verzamel fruit om de tijd aan te vullen die je hebt om je missie te voltooien. Daarnaast kun je krachtige bonusvoorwerpen ontvangen uit verschillende eieren, maar zorg dat je de rotte eieren en giftige paddenstoelen, die je kostbare levensenergie aantasten, vermijdt. <br<<br>Zoek in elk level de magische pop die verborgen gebieden opent, en overleef tot het eind om je ware liefde te redden!
...
<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414350/FFFD0000" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wonder Boy<sup>TM</sup></span></div>
</div>
