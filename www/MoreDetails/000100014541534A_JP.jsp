...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">剣劇対戦格闘ゲームのシリーズ２作目。１８世紀末の世界を舞台に、個性豊かなサムライたちの活躍をえがいています。登場キャラクターが１５人に増えたほか、前作で好評だった怒りゲージシステムもパワーアップしました。ゲージＭＡＸ時には攻撃力が増加するだけではなく、武器破壊必殺技が使用可能となり、技を命中させることで相手の攻撃手段を一時的に封じることができます。さらに前転や後転、下段避けなど多数の新要素を盛り込み、より戦術的な駆け引きが楽しめるようになりました。<BR><BR>詳細は、<Center>http://game.snkplaymore.co.jp/event/virtual-console/index_j.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">真・サムライスピリッツ</span></div>
</div>
