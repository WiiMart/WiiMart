...
<p>
You are an adventurer who has just returned to his home town, the Elf town of Eolis, at the base of the World Tree. You find the village in peril—the Elven water supply has dried up, monsters are causing chaos, and the Tree itself, once proud, is slowly wilting. Equipped with the last of the King's money and the trust of the people, you set out to climb the World Tree, braving obstacles, fiends and dangers, to discover the source of this corruption. Wield weapons and magic, get hints from townsfolk, and experience a world of new environments as you ascend to the top of the world!</div>
  <div id="image02">
