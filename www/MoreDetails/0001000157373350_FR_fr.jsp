...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157373350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">« Successfully Learning German Year 4 » propose aux élèves d'apprendre l'allemand en s'amusant. Freddy motive les enfants et leur donne des conseils, ce qui leur permet d'apprendre et de progresser à leur rythme.
<br><br>
...
<br><br>
Langues: anglais, allemand, turc.</div>
  <div id="image02">
