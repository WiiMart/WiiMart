...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">４人の精霊を召喚できる「金の腕輪」を手にした青年が、精霊を従え冒険へ旅立つ爽快感満点のアクションＲＰＧ。主人公の青年・ルオ王子は、古の魔人復活をくわだてる「銀の腕輪」を持つ者の野望を阻止するため、魔物相手に腕輪とナイフ１本で立ち向かいます。格闘アクションゲームさながらの戦いを繰り広げるルオのアクションが最大の魅力です。また、水・火・闇・緑の精霊たちが、仕掛けいっぱいのダンジョンなど、さまざまな場面でルオの冒険をサポートしてくれます。『ベア・ナックル』シリーズなどを手掛けた古代祐三による壮大なオーケストラサウンドも話題を呼んだ、メガドライブ円熟期の名作です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41524A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41524A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ストーリー･オブ･トア<sup>TM</sup>　光を継ぐ者</span></div>
</div>
