...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157324B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">あなたは最近、誰かとキャッチボールをしましたか？<BR>Wiiリモコンを使った直感操作で、ボールを投げる、キャッチする、そんなシンプルな楽しさがとことん味わえる新感覚の体感スポーツゲームです。<BR><BR>●ストーリーモード<BR>平凡な公園で繰り広げられる９つのドラマ・・・。<BR>プレイヤーはキャッチボールを通じて街の人々と交流を深めていきます。<BR>公園でキャッチボールをしていただけなのに、最終的には地球を救ってしまうという壮大なストーリーに発展します。<BR><BR>●スピードキャッチモード<BR>どんどん速くなっていくボールを、どこまでキャッチできるか競うモードです。<BR>人類がボールを投げる速度の限界は、せいぜい時速160km。<BR>しかし、このモードでは成功し続ければ音速を超えるボールをキャッチすることも可能です。<BR>あなたは人類の限界を超えられるでしょうか？<BR><BR>●ナイントライアルモード<BR>ボールを投げて、９枚のパネルをすべて打ち抜くまでの時間を競うモードです。<BR>うまくキャッチすることで、よりパネルを打ち抜きやすくなっていきます。<BR><BR>その他、多彩なモードが盛りだくさん。全部で６種類のモードが収録され、１人から４人まで楽しめます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">レッツキャッチ<sup>TM</sup></span></div>
</div>
