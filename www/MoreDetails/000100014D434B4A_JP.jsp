...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファンタシースター」シリーズの第４作目にして集大成となるロールプレイングゲームです。「ファンタシースターⅡ」から１０００年後、高度文明の失われた世界を舞台に、新米ハンターのルディと、魔道士やアンドロイド、エスパーなど個性豊かな９人の仲間たちが力を合わせて、バイオモンスターや機械兵器を操る巨大な悪に立ち向かいます。「マルチウィンドウビジュアル」で展開する多彩なイベントや、複数のキャラクターの攻撃がひとつになって新たな大技に変化する「コンビネーションバトル」、
乗り物の装備でモンスターと戦う迫力の「マシンバトル」も楽しめる戦闘など、オリジナリティあふれるシステムを多数搭載。シリーズファンの方はもちろん、はじめての方も存分にファンタシースター世界をお楽しみいただけます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファンタシースター<sup>TM</sup>千年紀の終りに</span></div>
</div>
