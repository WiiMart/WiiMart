...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">악어선장 크루루가 이끄는 해적 군단에게 납치된 동키콩을 구하기 위해 디디콩과 그 여자친구 딕시콩이 크레믈린 섬으로 모험을 떠납니다. 리얼한 그래픽으로 생동감 있게 움직이는 두 캐릭터를 조작하여 스테이지 클리어는 물론 DK 코인과 보너스 스테이지도 공략하여 올 클리어를 달성해 보세요. 디디콩과 딕시콩을 상황에 맞게 앞세워 가면서 동물친구를 적절하게 사용하는 것이 스테이지 클리어의 비결입니다. 또한 본 작품에서는 두 캐릭터가 서로를 들어 던지는 새로운 액션 「팀업」이 등장하여 더욱 다채로워진 액션을 경험할 수 있습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A424454/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A424454/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">동키콩 컨트리<sup>TM</sup> 2</span></div>
</div>
