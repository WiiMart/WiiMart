...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157504950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A frantic action-packed game that unfolds on the racing circuit.
During the game, the pit crew is not only faced with repairing vehicles, but various WHATSITs as well!
Handling the WHATSIT repairs is a pit crew made up of legendary beauties (?)!<br><br>
Simple Controls!<br>
Just grab a member of the crew with the Wii Remote's A Button, release the button when the Pointer is over the damaged PART and that crew member will begin repairs.
Assign repairs to the members of your team and provide support using the Wii Remote to send a fully repaired WHATSIT out of the pit as quick as you can!<br><br>
The game features Normal Mode which can be played using one of two rules; an Abnormal Mode where players split into two teams and compete against each other; and a Ranking Mode where you compete with players around the world for the top record.
Each mode can be played with a maximum of 4 Wii Remotes, allowing you to team up with friends and family. In short, your teamwork could lead to outstanding records!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504950/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504950/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
