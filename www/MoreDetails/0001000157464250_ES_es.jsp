...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sandy Beach es un juego de construcción de castillos de arena en 3D que usa el mando de Wii para dar forma y detalles a elaborados castillos cuyas imágenes puedes guardar en una galería de fotos. Podrás diseñar tu castillo en cooperación en las tranquilas costas de Sandy Beach.
¡Ten cuidado con los cangrejos que intentan invadir tu castillo en el modo Batalla de cangrejos! Constrúyelo estratégicamente y defiéndelo con cañones porque los cangrejos pretenden reducir a escombro tus preciosas construcciones de arena.
Después de defender tu castillo puedes usar el detector de metales para buscar tesoros ocultos con los que adornar tu castillo o incluso cañones adicionales para defenderte de esos condenados cangrejos.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
