...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El doctor Eggman (también conocido como Dr. Robotnik) se ha apoderado del monte Mobius y lo ha convertido en una base mecánica. Está utilizando la energía proveniente del magma que fluye bajo el volcán para hacer funcionar su Veg-O-Fortress. Es capaz de transformar animales desamparados en robots. Sonic the Hedgehog debe destruir su fortaleza y liberarlos. La única forma de lograrlo pasa por provocar una erupción del volcán. Sonic sabe que lo puede conseguir arrebatando las Chaos Emeralds que mantienen el volcán estable. El doctor Eggman también lo sabe, por lo que ha preparado un sofisticado sistema de defensa para asegurarse de que las joyas no abandonen el lugar.<p>
Este juego es de 1 a 4 jugadores. Para jugar entre varios jugadores, se usa 1 control, que es pasado entre los jugadores cuando llega su turno.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D415445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D415445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
