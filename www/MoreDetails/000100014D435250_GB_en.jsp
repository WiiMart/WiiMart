...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Following increased outbreaks in terrorism and insurgency using guerrilla warfare, the US Government has decided to hire a group of highly trained mercenaries. Their job: to carry out secret missions behind enemy lines. To go where no ordinary soldier would dare to go. 
<br><br>
Based on the popular arcade game, MERCS for the SEGA MEGA DRIVE lets you play as a MERC on these dangerous missions, and also adds an Original Mode, allowing players to choose from 5 different MERCS. Take no prisoners as you shoot your way through enemy forces, drive jeeps and tanks, and battle against huge bosses to accomplish your mission!  <br><br>Supports Wii Component AV cable Interlace Mode.</div>
  <div id="image02">
