...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157413250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Este juego de inteligencia y reflejos de Nintendo DS llega ahora a WiiWare, y le hemos dado un giro para la ocasión... ¡literalmente! Escoge a tu Mii favorito y maneja el cañón girando el mando de Wii de un lado a otro, lanzando gemas y juntándolas con otras del mismo color para hacerlas desaparecer antes de que alcancen la tronera.
<br><br>
Sumérgete sin más en la acción de los modos Partida rápida para uno o dos jugadores, pon a prueba tus nervios en el modo Resistencia o intenta superar el modo Pruebas, donde cada nivel supone un reto diferente.
<br><br>
Si no te apetece jugar solo, también puedes probar el modo Multijugador. ¡Pueden jugar hasta cuatro jugadores a la vez! Juega con tus amigos, contra la consola o las dos cosas. ¡Juega en equipo para eliminar las gemas o compite para descubrir quién es el mejor en Actionloop Twist!
<br><br>
Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413250/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
