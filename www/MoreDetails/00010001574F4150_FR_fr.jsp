...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574F4150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Papa, maman, Sarah et Billy sont de retour pour s’amuser en famille, et cette fois-ci en jouant au hockey de table !<br><br>
Améliorez vos compétences en hockey de table sur des terrains divers et variés tels qu’un gymnase, un parc forestier, une plage, un parc d’attractions et même les glaces de l’Arctique !<br><br>
Family Glide Hockey associe le charme des graphismes cel-shading au rythme de musiques entraînantes, lors de compétitions amicales endiablées. Choisissez entre le mode solo, le mode duel (jusqu’à 4 joueurs), ou mettez vos capacités à l’épreuve avec les mini-jeux, tels que « Glide Hockey Strike ! », « Glide Hockey Quiz ! » ou « Glide Hockey Traceur ! ».<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F4150/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F4150/FFFD000F" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
