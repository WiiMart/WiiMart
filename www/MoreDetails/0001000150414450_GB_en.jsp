...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A completely faithful port, right down to the character details, of the famous arcade shooting-game masterpiece, R-TYPE.
<br><br>
Destroy the POW armour and 6 different units will appear that you can use to power-up your R-9. Equip Bits and obtain Laser Units to make the Force appear and to power it up. The Force can then be integrated into or separated from your R-9. Make the most of the Reflecting Laser Beams, and the Air-to-surface, and Anti-aircraft Lasers.
<br><br>
Keep punching the fire button to send blasts from the Beam Cannon. Press and hold the fire button to charge the Beam Gauge and release it to fire a devastating Wave Cannon blast! The longer you hold it, the stronger the blast! The ultimate highlights are the boss characters that await you at the end of each stage, and a stage that pits you against a giant warship.</div>
  <div id="image02">
