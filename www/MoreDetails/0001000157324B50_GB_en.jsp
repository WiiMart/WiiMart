...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157324B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Play catch with friends in multi-player party games and compete for high scores using your Mii and other characters! Choose from six different single and multi-player modes such as Speed Catch, which tests your ability to catch a fast ball, and Bomb Catch, an elimination party game for up to four players. Select from a variety of characters or use your Mii to play other favourite catch games. Unlock special features when you own both Let's TAP and Let's CATCH!</div>
  <div id="image02">
