...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pilota tu nave haciendo uso de su exclusiva habilidad para combinarse con otras naves y derriba a los invasores. Los alienígenas atacan en formación siguiendo distintos esquemas de ataque. ¡Rescata tu nave capturada y acóplate para preparar un ataque doble de potencia múltiple! ¡Consigue bonus perfectos con más facilidad utilizando el ataque doble en las fases extra! GALAGA fue publicado en 1981 e inmediatamente se convirtió en un clásico gracias a su innovador sistema de acople de naves y a sus diversos sistemas de ataque.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146425245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146425245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
