...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157564F50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Hai le carte in regola per diventare un mito dell'alpinismo? Metti alla prova le tue capacità di coordinazione ed equilibrio! Conquista le vette di Rock N' Roll Climber!
<br><br>
Usa il telecomando Wii, il Nunchuk e, opzionale, la Wii Balance Board per muovere mani e piedi separatamente nella tua scalata verso la leggendaria chitarra!
<br><br>
Fai pratica con i comandi di gioco e poi tuffati in una serie di scenari emozionanti cercando di realizzare il tuo tempo migliore! Dovrai scalare dei pendii nella giungla, issarti lungo la parete di una cascata, affrontare delle montagne per veri temerari e altre sfide ancora. Ma mantieni alta la concentrazione... è molto facile cadere quando l'energia è agli sgoccioli!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564F50/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
