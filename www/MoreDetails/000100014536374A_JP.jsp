...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">主人公「ディグダグ」を操作して地面を掘り進み、地中に住むモンスターを退治する戦略的穴掘りゲームです。モンスターにモリを刺し空気を送りこんでパンクさせたり、岩を落として退治します。「プーカァ」と「ファイガー」という２種類の敵キャラクターに捕まらないよう避けながら画面内の敵をすべて倒すか、敵が逃げて画面からいなくなれば１ラウンドクリア。深い地層で敵を倒したり、ベジタブルターゲットを手に入れると高得点が得られます。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ディグダグ<sup>&reg;</sup>（アーケード版）</span></div>
</div>
