...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F5445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Overturn is a futuristic robot versus robot fighting game. Choose from eight different robots to pilot and master using various close and far range weapons to blast away enemies in six single-player tournaments. Unlock secret modes and up to twelve new weapons. Customize your robot's color and weapons to prepare for your next battle. Then take the action online to play in a 2 player Versus battle or a 4 player Battle Royale match. Search for Friends or other people across the world that are online and ready for battle! Use of the Wii Balance Board is optional to control your robot by shifting your weight.</div>
  <div id="image02">
