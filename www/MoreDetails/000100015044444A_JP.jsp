...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アクションとパズルの要素を持つ、陣取りアクションゲームです。操作方法とルールはシンプルですが、高得点を取るためのテクニックが多数存在し、その奥深さが人気を呼びました。プレイヤーは４方向に移動する自機（マイシップ）を操作し、グリーンのラインで囲まれたフィールドを、赤いラインを引きながら切り取っていきます。各フィールドではボスキャラやザコが、多彩な動きでプレイヤーを翻弄します。敵キャラクターの動きを読みながら、敵に触れないようにどんどん自陣の割合を増やしていってください。自陣の割合が７５％を超えるとラウンドクリアとなり、クリア時の割合が９９．９％に近いほど、ボーナスの得点が高くなります。敵の動きを自陣でうまく封じ込めるのがハイスコアをめざすコツです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015044444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015044444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">VOLFIED<sup>&reg;</sup></span></div>
</div>
