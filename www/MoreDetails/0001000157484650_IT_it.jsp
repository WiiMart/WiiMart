...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157484650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Entra nell'unità speciale di Heavy Fire: Special Operations, lo sparatutto per WiiWare. Partecipa alle difficili missioni in Medio Oriente combattendo a piedi, su veicoli corazzati o in elicottero. Dovrai essere svelto con il grilletto per arrivare in fondo a questi livelli pericolosissimi.  <br><br>
Sali nella gerarchia militare, e acquisisci nuove e più potenti armi con potenzialità e modi d'uso diversi. Ripeti la missione per aumentare il tuo punteggio e migliorare la tua posizione nel ranking mondiale. Realizza combo e distruggi gli elementi che ti circondano per ottenere più punti.  <br><br>
Puoi sbaragliare il nemico giocando da solo o con un amico in modalità multiplayer. Il Wii Zapper è utile, ma non è indispensabile.
