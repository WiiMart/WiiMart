...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">自機「ファイター」を操作し、次々に襲いかかってくるギャプラス編隊を倒していく縦スクロールタイプのシューティングゲーム。前作『ギャラガ』では左右の２方向しか移動できませんでしたが、今作では８方向に移動することができるようになりました。あらわれるすべての敵を倒すと、次のパーセック（ステージ）にすすみます。敵や敵の弾にあたるとファイターを１機失い、全滅するとゲームオーバーです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ギャプラス<sup>&reg;</sup></span></div>
</div>
