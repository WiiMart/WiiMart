...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D4C4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">笑えるフードファイトゲームです。Wiiリモコンを使って、ホットドッグ、ハンバーガーを始め全12種類の食べ物に挑戦。対戦相手はみんな名うての大食い選手なので、ただ食べているだけでは勝てません。「ゲップ・ブラスト」「激辛とうがらし」「オナラ攻撃」などユニークなアイテムを戦略的に使い勝利を目指しましょう。<BR><BR>登場キャラは、世界の大食い、早食いの有名選手10名。日本からは小林尊、ジャイアント白田、菅原初代。アメリカで開催されるホットドッグ早食いコンテストの優勝者もいます。<BR><BR>◆1人でも2人でもたのしめます。<BR>◆ニンテンドーWi-Fiコネクションでの通信対戦とランキングに対応。<BR>◆オフィシャルホームページ　http://www.mlegame.com/japan/</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4C4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D4C4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メジャーリーグ・イーティング</span></div>
</div>
