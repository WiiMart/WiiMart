...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574E4550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Conviértete en el rey de la pesca! Los pingüinos están hambrientos y necesitan tu ayuda para alimentarse... ¡Consigue el mayor número posible de peces antes de que alguien te los robe!<br>En este apasionante juego la estrategia es primordial. Adelántate a los movimientos de los otros pingüinos para no quedarte encerrado e intenta acceder a los témpanos de hielo que guardan más peces. En “Penguins & Friends” pueden participar de 1 a 4 jugadores dispuestos a soportar un frío polar.
<br><br>
¿Cómo se juega?<br>
El tablero está compuesto por trozos de hielo bajo los cuales hay un determinado número de peces (1, 2 ó 3). Estos trozos de hielo son hexagonales y forman un entramado similar a una colmena. La disposición inicial de dichos trozos de hielo podrá cambiar para crear distintos tableros de juego. Cada jugador dispone de un número determinado de pingüinos (en función del número de jugadores totales de la partida y del tamaño del tablero) los cuales harán la función de fichas para jugar.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E4550/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E4550/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
