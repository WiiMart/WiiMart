...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157444850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Art Style series - exclusive to WiiWare - brings you unique games that are simple to control, yet filled with rich gameplay, and atmospheric sound and visuals.
<br><br>
Art Style: ROTOHEX is a fast-paced puzzle game for one or two players. Arrange the coloured triangles that fall into the playing field, rotating them to create hexagons of the same colour, which then disappear. As the number of colours increase, so does the challenge.
<br><br>
Succeed at Solo Mode and you’ll unlock new modes like Endless Mode for the ultimate test of endurance, or the experts-only Sprint Mode. Alternatively, you can go head-to-head with a friend in VS Mode and battle to be the last one standing!</div>
  <div id="image02">
