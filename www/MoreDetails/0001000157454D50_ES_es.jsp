...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157454D50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Usa tu cerebro para resolver puzles y escapar de la habitación en la que se encuentra Milo! Juega solo o con tu familia 
 y amigos para resolver
 este juego de aventura 
 desconcertante.
<br><br>
Hoy es el cumpleaños de Milo y su padre le ha hecho un regalo increíble... Una habitación llena de puzles de los que le gusta resolver. Milo necesita resolver todos los puzles para escapar de la sala. Para ello, usa el mando de Wii y ¡¡MUÉVELO RÁPIDAMENTE!! ¡¡INCLÍNALO HACIA DELANTE!! ¡¡GÍRALO A LA DERECHA O LA IZQUIERDA!! para interactuar con los objetos que encuentres por el juego, para recogerlos y usarlos. Hay mucho por resolver usando todos los trucos del mando de Wii con las diferentes formas de manejarlo. Veamos si tienes lo que hay que tener para descubrirlo todo.
<br><br>
Textos de pantalla en inglés.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157454D50/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157454D50/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">"Aha! I Got It!"</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Escape Game</span></div>
  </div>
