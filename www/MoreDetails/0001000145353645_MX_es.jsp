...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El clásico juego retro de Capcom en los salones recreativos de 1985, EXED EXES, es un juego de disparos con desplazamiento vertical que te traerá bueno recuerdos. ¡Evita las balas! ¡Consigue fruta! Y consigue puntuaciones muy altas en el más vertiginoso juego de todos los tiempos con insectoides de ciencia ficción.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145353645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145353645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">EXED EXES<sup>TM</sup></span></div>
</div>
