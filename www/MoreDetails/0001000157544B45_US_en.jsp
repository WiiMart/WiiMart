...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157544B45')", "wiiSelectSound()");
...
• Questions that stimulate your reflexes thanks to original Wii Remote controller usage. For example, pop balloons in order to see the letters of the answers.</div>
  <div id="image02">
