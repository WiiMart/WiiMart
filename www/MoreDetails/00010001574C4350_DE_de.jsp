...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574C4350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Die ultimative BINGO-Spielesammlung! Enthält klassische BINGO-Spiele und einen neuen BINGO PARTY-Modus.
<br><br>
In BINGO PARTY Deluxe kannst du mit bis zu vier Spielern im 75 BALL-BINGO, 90 BALL-BINGO oder BINGO-PARTY-Modus spielen. Je mehr du spielst, umso mehr Punkte bekommst du! Sammel BINGO-Punkte, um tolle Extras freizuschalten, wie z.B. neue Spielmodi, BINGO-Kartenmuster und vieles mehr!
<br><br>
Alle BINGO-Modi können auch mit Computerspielern gespielt werden, deren Schwierigkeitsstufen einfach an dich angepasst werden können!
<br><br>
Der neue BINGO PARTY-Modus, exklusiv für dieses Spiel entwickelt, macht BINGO noch spannender, indem Spieler wetteifern, BINGO-Zahlen schnell zu finden und auf verschiedenen BINGO-Karten zu stempeln, welche schließlich BINGO-Muster komplettieren, die viele Punkte einbringen! Die Spieler können auch in den klassischen Modi 75 BALL-BINGO und 90 BALL-BINGO Spaß haben mit dem Ziel, BINGO-Muster auf den eigenen BINGO-Karten zu komplettieren.
<br><br>
Englischer Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574C4350/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574C4350/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BINGO PARTY Deluxe</span></div>
</div>
