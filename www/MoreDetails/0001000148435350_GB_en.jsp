...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This software allows you to transfer the following data from a Wii console to a Wii U console as a set:<br><br>
...
• Wii U does not support WiiConnect24. Some software features may no longer be available after transferring software to a Wii U console.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148435350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148435350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii U Transfer Tool</span></div>
</div>
