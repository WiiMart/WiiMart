...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001574C5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LostWinds is een fris, aanstekelijk avontuur waarin je de krachten krijgt van Enril, de windgeest, waarmee je tornado's, kleine windvlaagjes en alles ertussenin kunt maken. Je leidt en beschermt Toku, een jongen die je als enige kan helpen bij het tegengaan van een vloek tegen de wereld Mistralis en zijn inwoners, door de slechte Balasar.<br><br>
 
Mistralis is een prachtig gepresenteerd, magisch land vol verrassingen en intrige, dat bij elke actie en verkenning tot leven komt. De originele, speelse besturing van LostWinds maakt het mogelijk de krachten van Enril te gebruiken om Toku te laten springen en zweven door de verschillende regio's van Mistralis. met vijanden te laten afrekenen en puzzels op te lossen op weg naar de dramatische ontknoping. <br><br>
 
LostWinds zit boordevol nieuwe gameplay-ideeën die gebruik maken van de Wii-afstandsbediening en legt de kracht van de wind in de palm van je hand.</div>
  <div id="image02">
