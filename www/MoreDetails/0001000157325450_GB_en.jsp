...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157325450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This is a party game that allows up to 4 people to play at once. Players will become brand new Brain Cadets taking orders from the drill sergeant and go through mind-boggling, mind-strengthening training.
<br><br>
The rules are simple, but concentration and quick thinking are both key to playing this game and emerging as lean, mean, thinking machines. This game is best played with friends and family.</div>
  <div id="image02">
