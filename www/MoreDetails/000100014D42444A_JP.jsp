...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">メガドライブだけのオリジナル続編として発売され、大ヒットした剣と魔法のファンタジー・アクションゲームのシリーズ第二弾。悪しき巨人デス＝アダーとの戦いから三年後、神々の斧の力を手にした闇の皇帝ダーク＝ガルドが、魔族を率いて地上征服に乗り出し、かつて世界を救った３人の勇者・アックス、ティリス、ギリウスが新たな冒険に旅立ちます。魔法使いやリザードマン、ミノタウロスなどの敵キャラクターに加え、魔法の演出も一新。より一層遊びやすくなった操作システムで快適なプレイが楽しめます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42444A/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42444A/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゴールデンアックスII<sup>TM</sup></span></div>
</div>
