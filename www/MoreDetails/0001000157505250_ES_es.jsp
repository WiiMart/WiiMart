...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157505250')", "wiiSelectSound()");
...
<br><br>
Art Style: CUBELLO es un puzle en tres dimensiones que pondrá a prueba tu inteligencia espacial y tus reflejos. El objetivo es muy simple: elimina los cubos de color que forman el Cubello disparando otros del mismo color con el mando de Wii.
<br><br>
El Cubello gira constantemente, así que tendrás que afinar la puntería para eliminar los cubos y terminar el puzle. Y si te gusta que te lo pongan difícil, ¡prueba el Endless Mode (Modo Indefinido)!
<br><br>
