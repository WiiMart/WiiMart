...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001584A4950')", "wiiSelectSound()");
...
<br><br>Four brave gnomes venture on a journey so epic, they don't even know where they're going. Join Bumb, Berzerk, Speedster and Uncle Time as they run, fly, bounce, glide and break their way through the magical lands of Gnomia to reach their mysterious destiny.
<br><br>
You can help them save the kingdom, find a princess and collect hundreds of precious lost socks.
<br><br>
Run faster than a speeding rabbit!<br>
Leap large holes in a single bound!<br>
Become more powerful than a raging elephant!<br>
Get 2 Fast 4 Gnomz!</div>
  <div id="image02">
