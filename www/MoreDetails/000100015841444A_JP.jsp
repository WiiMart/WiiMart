...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">対戦型格闘ゲーム「イー・アル・カンフー」の続編で、前作の主人公「李（リー）」の息子「李英（リーヤング）」を操作して、チャーハン一族の再起を図るイーガー皇帝とその一味の打倒をめざす、面クリア型アクションゲーム。<BR>十字ボタンとパンチ、キックボタンを組み合わせて繰り出される多彩な技を駆使して、次から次に襲いくる攻撃をくぐり抜け、敵を打ち倒してください。また、時々出現する「小敵隊」をすべて倒すと、烏龍茶の葉を入手でき、これを５つ集めることで体力を全回復できる烏龍茶を入手することができます。さらに２人での対戦も可能で、李英と敵キャラクターを使った戦いを楽しめます。<BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841444A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841444A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">イーガー皇帝の逆襲</span></div>
</div>
