...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157485A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il pianeta Zethos è sotto il controllo militare di Thau-Phi, un'intelligenza artificiale ribelle inizialmente installata sul remoto pianeta per renderlo abitabile. Tutti i sistemi automatizzati rispondono al computer centrale, compresa una legione di robot operai ora schierata a difesa del nucleo IA.
<br><br>
L'unica speranza per liberare Zethos senza sacrificare innumerevoli vite di marines confederati è rappresentata dell'intervento della DST Horizon, il cui equipaggio è formato da un'élite di mercenari che vende la propria competenza d'avanguardia al miglior offerente. Accettano lavori troppo rischiosi per la maggior parte delle unità mercenarie e troppo compromettenti per la maggior parte delle forze militari.
<br><br>
Con Horizon Riders, sfreccerai su velocissimi hoverboard nei panni di uno a scelta tra i quattro membri della squadra, facendoti largo tra le file dell'esercito di robot ribelli, grazie a un avanzato arsenale tecnologico, fino all'ultima missione: la sconfitta di Thau-Phi.
