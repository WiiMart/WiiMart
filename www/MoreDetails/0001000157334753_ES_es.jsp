...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157334753')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡La tercera aventura de Phoenix Wright llega a WiiWare! El drama 
 del juzgado continúa en "Juicios y Deliberaciones". Nuevos personajes, 
 excepcionales historias y gran jugabilidad. ¡La defensa nunca  descansa!                                                                                     
 Cinco nuevos y emocionantes casos con perspectiva en primera persona.
 Función "Psyche-Lock". ¡Algunos testigos esconden la verdad! Utiliza una línea 
 correcta de interrogatorio para desmontar los testimonios más inconsistentes.
 Dos modos de juego:<br><br>

-Investigaciones. Examina la escena del crimen, interroga a los testigos y busca evidencias.<br><br>

-Juzgado: Presenta pruebas, escucha los testimonios y examina a los testigos.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334753/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157334753/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Trials and Tribulations (Textos en español)</span></div>
  </div>
