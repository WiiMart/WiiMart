...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Originally a launch game for Nintendo 64, Wave Race 64 immediately blew the competition out of the water with its impressive 3D graphics and gameplay that was anything but shallow!
<br><br>
...
<br><br>Text in-game can be set to English or German.</div>
  <div id="image02">
