...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157424850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Du bist hoffnungslos in der Unterzahl und hast nur eine Wahl: kämpfen und gewinnen. Du hast nur dich, deine Waffen und den dünnen Streifen Strand, der dich von der ganzen kaiserlichen japanischen Marine trennt.
<br><br>
Auch wenn sich dein Arsenal mit einer Browning M2, einer Bofors 40 mm und natürlich deiner Thompson-Maschinenpistole sehen lassen kann, wirft dir die japanische Marine alles entgegen, was sie hat: Mit Zeros, Bettys und sogar Kriegsschiffen der Takao-Klasse wird sie unermüdlich versuchen, die Solomon-Inseln zurückzuerobern.
<br><br>
