...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ブルードラゴンに姿を変えた勇士「アムル」を操作して戦う、縦スクロール型シューティングゲームです。太陽神とブルードラゴンによって、氷河地帯の奥深くに封じ込められていた闇の魔王「ザウエル」は、手下の魔物たちをつかって王女「アリーシャ」を復活のいけにえとして連れ去りました。王女を救うべく、アムルは伝説のブルードラゴンとなって、ザウエルのモンスター軍団との戦いへ飛び立ちます。次々に迫りくる敵を、対空用と対地用ファイヤーの２つの攻撃をうまく使い分けて攻撃しながら進みます。エリア中では地上にある「卵」や点滅する敵を破壊することで、さまざまなパワーアップアイテムが出現し、攻撃力が上がったり一定時間無敵になれるなど、戦いを有利に進めることができます。舞台となるのは、カルスト、火山、密林、砂漠など９つの魔境エリア。各エリアの最後にはエリア最強のボスが登場し、これらを倒さないと、次のエリアには進めません。すべてのエリアを突破して王女アリーシャを救い出してください。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドラゴンスピリット<sup>&reg;</sup></span></div>
</div>
