...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157413850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Take an unusual journey into a microscopic world, in this unique action game from the genre-redefining Art Style series.
<br><br>
...
<br><br>
Control your organism by simply spinning your way through the ooze; however keep a close eye on your flailing tentacles, to avoid absorbing the wrong colour.
<br><br>
Enjoy three different modes of play, and relaxing yet challenging gameplay with simple Wii Remote controls (or use the optional Classic Controller). It's a microscopic masterpiece!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157413850/FFFD0009" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
