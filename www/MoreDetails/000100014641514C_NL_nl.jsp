...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ninja JaJaMaru-kun, wat ‘vastberaden kleine ninja’ betekent, kwam oorspronkelijk uit voor de Famicom (NES) in Japan in 1985. In dit actiespel schittert de ninja JaJaMaru, die zijn werpsterren (shuriken) gebruikt om monsters te verslaan en prinses Sakura van de kwade Lord Namazu te redden. 
<br><br>
Gebruik op je tocht speciale voorwerpen (onder andere een enorme kikker waar je op kunt rijden!) terwijl je je een weg vecht door diverse levels vol typisch Japanse spoken en monsters. Geniet van dit klassieke actiespel, dat nu voor het eerst buiten Japan beschikbaar is... voor de Virtual Console!
<br><br>
