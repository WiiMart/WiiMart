...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコン時代の名キャラクター“くにおくん”の初登場作で、当時としては珍しかった「１人対複数人の格闘アクション」を実現した、初期のアクションゲームジャンルを代表するタイトルです。特にファミコンのＡ／Ｂボタンを使い分けることで繰り出される多彩な攻撃アクションが、当時高く評価されました。また、リアルに描かれたキャラクター、ボスキャラクターのセリフなどに代表される独特の世界観には、今も多くの根強いファンが存在します。“ダウンタウン”シリーズなど、“くにおくん”が登場する別のタイトルとあわせて遊ぶのも面白いでしょう。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">熱血硬派くにおくん<sup>&reg;</sup></span></div>
</div>
