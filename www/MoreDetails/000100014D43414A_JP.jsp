...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">７種類のフォーメーションと７種類のショットを駆使して戦う、爽快感あふれる横スクロール型シューティングゲームです。地球連邦とエイリアンによる全面戦争のさなか、船ごと拉致された父を救うべく、少女ルーシアは最新鋭戦闘機「グレイランサー」で出撃します。最大の特徴は自機に装備される２つの「ガンナー」。はじめに「ムーバーシステム」を選択することで、３方向に攻撃する「マルチ」や自機を追尾する「シャドウ」、自機の動きと逆の方向を攻撃させる「リバース」など、ガンナーフォーメーションをプレイヤーが自由に設定でき、それぞれ全く違うプレイ感覚を楽しめます。ガンナーの動きをうまくコントロールし、さまざまなショットを使い分けて、襲い来る敵機や巨大なボスを倒してください。難易度選択やオートショット機能もあるため、初心者でも手軽にプレイ可能。メサイヤ黄金期ならではの円熟した技術と美しいイベントグラフィック、ドラマチックな音楽なども話題となりました。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D43414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D43414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">グレイランサー<sup>TM</sup></span></div>
</div>
