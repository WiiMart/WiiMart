...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157504950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ein actionreiches Spiel, das auf
einer Rennstrecke ausgetragen
wird. Während des Spiels muss
die Crew nicht nur Fahrzeuge
reparieren, sondern auch
diverse DINGSDAS! Die
Reparaturen der DINGSDAS
werden von einer Crew von ...
ähm ... schnuckeligen
Schönheiten erledigt!<br><br>
Einfache Steuerung!<br>
Greife mit dem A-Knopf auf der 
Wii-Fernbedienung ein Mitglied
der Crew. Lasse den A-Knopf los,
wenn der Zeiger über dem
beschädigten TEIL ist und das
Crewmitglied beginnt die
Reparatur. Beauftrage die
Crewmitglieder mit Reparaturen
und nutze die Wii-
Fernbedienung, um vollständig
reparierte DINGSDAS so schnell
wie möglich auf die Strecke zu 
schicken! 

Unter der Option "Hauptmenü", 
kannst Du verschiedene Modi
auswählen, wie z. B.: 
Normal-Modus: kann unter 2
Regeln gespielt werden.
Unnormaler Modus: Spieler
werden in 2 Teams unterteilt
und kämpfen gegeneinander oder
Ranglisten-Modus: du spielst mit 
Spielern aus aller Welt um 
den höchsten Rekord.<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157504950/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157504950/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
