...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">魔法と精霊の世界「ジュラ」を舞台にした、縦スクロール型シューティングゲームです。他国への武力侵攻を開始した「ブライズバラ帝国」に対抗するべく、「精霊国家シースフェル」は、精霊の力を源に駆動する装甲戦士「精霊甲兵部隊」に出撃命令を出しました。プレイヤーは精霊甲兵で最強を誇る伝説の戦士「スプリガン」を操作し、４種類（地、火、風、水）の「精霊球」でパワーアップしながら敵に立ち向かいます。精霊球は最大３つまで持つことができ、その組み合わせによって攻撃形態がさまざまに変化。さらに周囲の敵を一掃する「ボンバー」としても使用することができます。また、腕に自信のあるシューティングファンのために、タイムアタックやスコアアタックが楽しめる「チャレンジ・モード」も搭載されています。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">精霊戦士スプリガン</span></div>
</div>
