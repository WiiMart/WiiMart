...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157505045')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">It's time for some good old family fun, and what's more fun than table tennis!? Just like a real family, choose your player character from a cast of four, which includes: Daddy, Mommy, Sarah, and Billy. There are four table tennis-tastic stages where it doesn't matter if you're an indoors or outdoors table-tennis player! Pick your setting from a gymnasium, a forest park, a beach, or even an amusement park! Choose from Single or Versus mode, or select a minigame to play! In Versus mode, you and a friend can play against each other to see who is the better table-tennis player. And if Single and Versus modes aren't enough, select between three minigames, which include: Target Table Tennis, Thrilling Table Tennis, and Matching Table Tennis! The appealing cel-shaded graphics and endearing music, on top of the super-fun game play, will have you and your family playing from morning till night! Get your paddles ready!</div>
  <div id="image02">
