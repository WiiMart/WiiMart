...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Conviértete en Boogerman, el heroico alter ego de Snotty Ragsdale, en este gran éxito de SEGA GENESIS. Mientras Boogerman está investigando el laboratorio del profesor Stinkbaum, descubre un extraño mecanismo que abre un portal hacia otra dimensión. Boogerman tiene olfato para la aventura, pero, ¿se quedará atrapado en un pañuelo tras esta pegajosa situación? Viaja a través de mundos llenos de peligro, y bátete con malvados enemigos como Fly Boy y Deodor Ant. Puedes atacarlos con las súper habilidades de Boogerman: rascar y capirotear con precisión mortífera, eructar, y rematar a los enemigos con su singular golpe especial.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D435145/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D435145/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Boogerman<sup>TM</sup>: A Pick and Flick Adventure</span></div>
</div>
