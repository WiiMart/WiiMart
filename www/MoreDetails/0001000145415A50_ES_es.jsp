...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Cuarta entrega de la saga World Heroes, publicada en 1995. En este juego, 16 figuras históricas se enfrentan por el título de luchador más fuerte del mundo. En ediciones anteriores, la cantidad de tiempo que mantenías el botón pulsado determinaba la fuerza o debilidad de un ataque; pero este sistema ha sido eliminado en la presente entrega. Además de recurrir a un modo de lucha más ortodoxo, usando distintos botones para ataques más o menos fuertes, este juego incluye nuevos elementos como la Barra de Héroe, Ataques Extra y Ataques Antiguardia, haciendo de este juego una nueva y excitante experiencia.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
