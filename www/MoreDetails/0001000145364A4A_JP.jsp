...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">宇宙辺境警備隊員の腕利き「ファイター」となって、凶悪宇宙生命体「オクティ族」を殲滅すべく戦うシューティングゲームです。宇宙辺境警備隊第一次救出隊の活躍により、オクティ族が潜むバラデューク要塞は消滅し、パケット星は救われたかにみえましたが、最後の使命を果たすため再び戦いが始まります。波動銃や機銃艇で敵を攻撃してください。ステージの最後まで行くと次のステージに脱出することができます。
前作「バラデューク」では登場しなかった新しい敵「ブラックパケット」や
カラーカプセルが登場。カプセルの中にはパワーアップできるアイテムもあります。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145364A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145364A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">爆突機銃艇<sup>&reg;</sup></span></div>
</div>
