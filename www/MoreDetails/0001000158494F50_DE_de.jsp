...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158494F50')", "wiiSelectSound()");
...
Dieses Spiel wurde für Kinder entwickelt,  die noch nicht lesen können. <br><br>Deutscher Bildschirmtext.</div>
  ...
  <div id="image01">
    <img src="/oss/ccs/0001000158494F50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
