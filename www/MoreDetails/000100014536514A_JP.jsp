...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">西暦１９××年、紀元前よりよみがえった獣王に制圧された世界を救うために「アルゴスの戦士」が立ち向かう横スクロール型アクションゲームです。ヨーヨーのように伸びる武器「ディスカーマー」とジャンプを駆使して、
全２７のステージを攻略していきます。沈む夕日や滝などの美しい壮大なグラフィックは、当時高い評価を得ていました。５つのインドラをすべて揃えるとスペシャルボーナスが獲得できたり、隠しアイテム「インドラの秘伝書」を入手すると１００万点のボーナスがもらえるなど、数々のボーナスポイントが設定されています。その他、自キャラの数や難易度などの設定変更も可能です。<BR><BR>詳細は、<Center>
http://www.tecmo.co.jp/product/vca/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アルゴスの戦士<sup>TM</sup></span></div>
</div>
