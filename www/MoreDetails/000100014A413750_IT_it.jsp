...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ActRaiser, un capolavoro di game design pubblicato originariamente poco dopo l'uscita della console SNES, è ancora oggi molto popolare grazie alla rivoluzionaria combinazione tra azione e simulazione.
<br><br>
Il giocatore interpreta il ruolo del Master, una divinità detronizzata il cui mondo un tempo idilliaco è caduto sotto il controllo del Malvagio. Privato della maggior parte dei suoi poteri divini, il Master deve in qualche modo fermare il Malvagio e ricostruire il suo regno in rovina.
<br><br>
Il gioco alterna due modalità: Azione e Simulazione. In modalità Azione, il Master deve lottare contro orde sterminate di mostri per riportare la pace in sei territori. In questo modo sarà possibile accedere alla modalità Simulazione, in cui il Master dovrà controllare lo sviluppo e il ripopolamento del territorio che ha riconquistato. In questo modo, guadagnerà dei seguaci che ripristineranno gradualmente i suoi poteri divini, dandogli la forza di riconquistare il territorio successivo e, infine, sconfiggere il Malvagio.
<br><br>Il testo all'interno del gioco è in inglese.
<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A413750/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A413750/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
