...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000158483650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Il est possible que cette version démo n’offre pas toutes les fonctions de la version intégrale de ce jeu.<br> 
Veuillez noter que vous ne pouvez pas sauvegarder votre progression dans cette version démo.
<br><br>
Une sonde d'exploration a été envoyée sur une étrange planète pour enquêter sur la perte des sondes précédentes et collecter des informations sur ladite planète.
 <br><br>
Après un atterrissage forcé à la surface, notre personnage perd les capacités dont il disposait pour mener à bien sa mission. Aidez-le à les récupérer grâce à des créatures étranges qui ont pris d'assaut son intérieur mécanique... Découvrez la vérité qui se cache derrière sa nouvelle mission !
<br><br>
Vous pouvez profiter d'un mode aventure complet, développé dans différents endroits de la planète, en explorant divers chemins et en découvrant les multiples secrets qui s'y cachent.
<br><br>
Dans la sonde exploratrice, vous pouvez manipuler des créatures minuscules qui vous aideront à réparer les parties endommagées par l'accident, récupérant ainsi vos capacités et vous permettant d'accéder aux fichiers de mémoire.
<br><br>
Si vous ne pouvez plus avancer à l'intérieur du robot, vous devez aller à l'extérieur rechercher des pierres d'ambre pour obtenir de nouvelles créatures et progresser ainsi dans ses circuits internes.<br><br>

Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158483650/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158483650/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Robox<sup>&reg;</sup></span></div>
</div>
