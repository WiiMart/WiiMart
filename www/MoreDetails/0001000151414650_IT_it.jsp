...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Dynastic Hero è un GdR d'azione ambientato nel mondo degli insetti, nel quale controlli il coraggioso Dyna, principe dei Beetras, impegnato a difendere la terra di Tarron dall’attacco dell’Impero Drillkor.
<br><br>
Guida Dyna attraverso livelli colmi di insidie, affronta in battaglia pericolosi nemici usando armi e oggetti che ti aiuteranno a superare aree particolarmente rischiose, come deserti infuocati od oceani sconosciuti.
<br><br>
Ma The Dynastic Hero è molto più di un semplice gioco d’azione! Rispondi correttamente alle domande che ti verranno poste nel corso dell’avventura, usa la tua ocarina magica per aprire porte sbarrate e fai attenzione alle infinite trappole disseminate ovunque! Azione e ragionamento si combinano insieme per creare un titolo intenso e divertentissimo!
<br><br>
