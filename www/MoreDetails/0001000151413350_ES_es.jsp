...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un planeta entero se convertirá en tu laboratorio en este juego de simulación a gran escala, en el cual deberás dar luz a la vida y hacer que evolucione hasta convertirse en vida inteligente. Guía a la civilización por la senda evolutiva hasta lograr el “Éxodo”, el objetivo definitivo de colonizar otro planeta.
<br><br>
El principal reto del juego es mantener un entorno confortable para las formas de vida regulando los parámetros atmosféricos y geológicos. Pequeños organismos llamados Procariotas y Tribrachidiums 
crecerán y evolucionarán convirtiéndose en múltiples seres. Hacer un cambio drástico es una fórmula segura para el desastre. La clave del éxito es hacer pequeños ajustes y observar la reacción de estos seres.<br><br>
SimEarth también incluye planetas con entornos diferentes al de la Tierra, como Marte y Venus. Intenta terraformar estos planetas de condiciones extremas en un mundo donde la vida pueda prosperar.
<br><br>
