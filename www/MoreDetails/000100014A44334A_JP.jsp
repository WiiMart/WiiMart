...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">地球統合軍準備部隊の最新兵器「ＸＡ－１」を操り、謎の組織「アギーマ帝国」の地球壊滅計画を阻止することが目的の横スクロールシューティングゲーム。ＸＡ－１には発射範囲の広いバルカンからエネルギーを溜めて放つフォトンなど個性豊かな８種類の武器を搭載でき、ステージのスタート時に選択できます。各武器は一定の得点に達するごとにレベルアップし、より強力な攻撃が可能になります。それぞれの特性を活かして戦うことがステージクリアのポイントです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SUPER E.D.F.<sup>TM</sup>			</span></div>
</div>
