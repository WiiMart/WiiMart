...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157564250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP VOID is het derde deel uit de retro-arcade BIT.TRIP-serie. 
<br><br>
BIT.TRIP VOID is een synesthetische verkenning van ritme en muziek zoals die in ons dagelijkse leven en gemoedstoestand passen. Met een besturing die nieuw is voor de serie, maar vertrouwd voor gamers, krijgt de speler de complete vrijheid om over het scherm te bewegen en op om een geheel nieuwe wijze te interacteren met de muziek. De klassieke en esthetische speelwijze is gebleven, terwijl kleur –  en de afwezigheid van kleur – zo veel mogelijk wordt verkend.
<br><br>
Speel de co-op modus voor 4 spelers en verlies jezelf in de beat met een vriend! Kijk of je de Beat aanval kunt weerstaan en je maak je eigen BIT.TRIP nog beter.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
