...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">劇場アニメ感覚で楽しめるスーパー・アメージング・シューティングゲームです。幼なじみの「ターくん」と「ユーちゃん」は近所でも有名な落書きコンビ。ある日、近所の塀に落書きをしていると、突然、壁からふたりのえがいた絵が飛び出し、ユーちゃんを空中に開いた穴へ連れ去ります。連れ去られたユーちゃんを探すため、ターくんは「すぅぱぁたあ坊」に乗り込み、冒険に出発します。ゲーム中には、ＣＤ－ＲＯＭの機能を活かした「しゃべる」演出がふんだんに盛り込まれており、声優陣も超豪華キャストを起用。思わずにやりとする要素も満載です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015142414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015142414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エルディス</span></div>
</div>
