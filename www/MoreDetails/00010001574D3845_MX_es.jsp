...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D3845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Hay una novedad disponible para la serie de Bomberman en WiiWare! Hasta 8 jugadores pueden combatir online mediante la Conexión Wi-Fi de Nintendo®. ¡Los sencillos controles lo hacen ideal para disfrutar con la familia y los amigos en cualquier momento! Diviértete como nunca en Bomberman activando nuevos objetos con una sacudida del mando de Wii. ¡Incluso puedes usar tus propios Miis para aumentar la intensidad! Los resultados de las batallas pueden registrarse en la tabla de clasificación de la Conexión Wi-Fi de Nintendo para compararlos con los de otros jugadores de todo el mundo. ¡Este título es la bomba, tanto para aquellos que nunca han probado otros juegos de Bomberman como para los maestros consumados!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D3845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574D3845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bomberman Blast</span></div>
</div>
