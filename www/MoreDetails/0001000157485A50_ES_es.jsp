...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157485A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El planeta Zethos se encuentra bajo control marcial de Thau-Phi, una inteligencia artificial renegada. Su dominio es absoluto y se extiende por todos los sistemas automáticos del planeta, incluyendo las legiones de robots obreros ahora convertidos en un impenetrable ejército de máquinas de combate que no dudan en sacrificar su propia existencia.
<br><br>
Los únicos que pueden liberar al planeta y evitar una masacre entre las tropas de la Conferedación son los tripulantes de la DST Horizon, un grupo de mercenarios de elite que venden su gran pericia de combate al mejor postor.
<br><br>
Horizon Riders pone en tus manos un arsenal de poderosas armas futuristas y te permite controlar a cualquiera de los cuatros miembros del escuadrón mientras viajas a toda velocidad por la superficie de Zethos sobre un poderoso deslizador para derrotar a Thau-Pi y a su ejército cibernético.
