...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">シャイニング・シリーズの中でも特に人気の高いタクティカルＲＰＧ「シャイニング・フォース」の第２作です。前作以上のボリュームで繰り広げられる壮大な物語と、より高度になった戦略が楽しめます。平和な王国グランシールにそびえたつ「古え（いにしえ）の塔」。その封印が解かれたことで悪魔王「ゼオン」率いる魔族たちが現れ、
グランシールへ侵略を開始しました。賢者アストラルの弟子である主人公「ボウイ」は、光の軍勢「シャイニング･フォース」を率いて、世界を救うために戦います。人間、エルフ、ケンタウロスといった多彩な種族で構成されたキャラクターの特性を生かし、様々な戦術を駆使して戦いを勝利に導いてください。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42364A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42364A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">シャイニング・フォースⅡ<sup>TM</sup>　古えの封印</span></div>
</div>
