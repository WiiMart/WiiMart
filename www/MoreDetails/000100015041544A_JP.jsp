...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">かわいらしいキャラクターが人気を博した「奇々怪界シリーズ」第一弾。全方位スクロール型のアクションシューティングゲームです。少女巫女「小夜ちゃん」を操作して、「もののけ」がたむろする全８ステージを進み、さらわれた七福神を救出することがゲームの目的です。四方八方から攻めてくる妖怪を、近距離ではおはらい棒を振るい、遠距離ではお札を投げて退治していきます。アイテムの「お札」や「水晶球」を手に入れると、お札の攻撃力を高めたり、画面上の敵を全滅させたりすることが可能になります。各ステージでは、ボス妖怪の待つ部屋へ通じる「鍵」を見つけることが重要です。ステージのどこかに落ちている鍵を見つけて、さらわれた七福神を助け出してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">奇々怪界<sup>&reg;</sup></span></div>
</div>
