...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Control Gil, the hero, as he climbs the tower starting from the first floor. Pick up the key inside each maze and go through the door to advance to the next floor. To clear the game, you must defeat Druaga, the ruler of the tower, then advance to the top floor and save your beloved Ki. Lives can be lost in numerous ways, including (but not limited to) taking damage from enemies, failing to block a spell attack with your shield, touching fire, and running out of time. Once you run out of lives, the game is over. Note: Not all enemies will kill you instantly; some will need to land several hits before causing you to lose a life.</div>
  <div id="image02">
