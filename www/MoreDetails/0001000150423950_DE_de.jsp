...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Spiele dich in diesem Action-Sport-Titel durch 18 Olympische Disziplinen. Die Spieler treten in den folgenden Kategorien gegeneinander an: Schießen, Bogenschießen, Rudern, Schwimmen und Leichtathletik (Track ＆ Field).
<br><br>
Dieses Spiel beinhaltet einen OLYMPIC-Modus, in dem alle Disziplinen über einen Verlauf von mehreren Tagen gespielt werden und einen TRAINING-Modus, in dem du einzelne Disziplinen auswählen kannst.
Hole dir nach der Übung im TRAINING-Modus Gold im OLYMPIC-Modus und brich Weltrekorde! Je nach Spielweise und Können kannst du das Spiel auf verschiedene Arten genießen.
<br><br>
Tritt im Spiel mit Freunden gegen bis zu 4 Mitspieler an und hol noch mehr aus diesem tollen Spiel heraus.
