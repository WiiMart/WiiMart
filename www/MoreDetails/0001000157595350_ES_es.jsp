...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157595350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Bienvenidos a Sunnyville! Busca objetos y tesoros ocultos en las ventas de garaje de tus vecinos.<br>Usa tus descubrimientos para decorar la casa de tus sueños y ganar el gran concurso de la revista "Superstar Homes". Juega contra el reloj o sigue tu propio ritmo buscando cientos de objetos ocultos en divertidos lugares. ¡Enfréntate a montones de desafíos en este juego de exploración!
<br>
Entornos fascinantes: explora 12 lugares temáticos para cumplir tu misión de encontrar tesoros ocultos mientras conoces a los personajes más estrafalarios.
<br>
Pistas secretas: descubre estrellas ocultas en todos los niveles para obtener pistas que te permitirán superar antes los niveles.
<br>
Niveles de bonificación: vuelve a los lugares ya explorados para desbloquear nuevas misiones en una carrera contrarreloj.
