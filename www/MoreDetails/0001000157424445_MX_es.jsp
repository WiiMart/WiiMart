...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Brain Drain es un divertido juego de puzles que te enganchará. Debes colocar las piezas de un puzle desordenado según un modelo determinado. Eliges piezas con el cursor y las giras para desplazarlas por la zona del puzle. Algunos rompecabezas pueden contener efectos de penalización que ralentizan la resolución del puzle. Tres modos de juego:<p />

Desafío: tiene 200 puzles fijos con mejores tiempos predeterminados para resolver y superarlos.<br />
Carrera: 4 dificultades. Un torrente de puzles y tablas de mejores tiempos para superarlos.<br />
Al azar: rompecabezas al azar relajadamente, interminables...</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157424445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157424445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Brain Drain</span></div>
</div>
