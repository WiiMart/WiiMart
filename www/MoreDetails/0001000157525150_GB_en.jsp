...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157525150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Featuring more than 30 elusive animals including woolly rhinos, white-tailed deer, wolves and Irish elk, Deer Drive Legends WiiWare takes you to the far corners of the earth to hunt some of the wildest animals rarely seen by the human eye - several even believed to be extinct.
These animals are quick, deadly, and eager to turn you into dinner! Engage in vicious boss battles against the feared T-Rex, sabre-toothed cats, and Gastornis. With diverse weapons to choose from like sniper rifles, crossbows, and high-powered shotguns, Deer Drive Legends WiiWare is the ultimate hunting game you've been waiting for!</div>
  <div id="image02">
