...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157564B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Water Warfare ist ein spaßiger Ego-Shooter, bei dem du deine Gegner mit Wasserpistolen nass machst. Die Karten (die Spielanlage, der Strand, der Platz und der Naturpark) werden beim Spielstart automatisch aufgerufen. Du kannst dir für jedes Spiel neue Strategien ausdenken! <br><br>Water Warfare bietet unter anderem Missionen für Einzelspieler, CPU-Matchs und einen Modus für zwei Spieler mit geteiltem Bildschirm.<br><br>
Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157564B50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157564B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
