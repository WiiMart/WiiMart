...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『テレビの友チャンネル<BR>
　Gガイド for Wii』は、<BR>
テレビ放送をよりお楽しみいただくためのチャンネルです。<BR><BR>

Ｗｉｉリモコンで軽快に操作できるテレビ番組表を通して、
「さがす」で自分が気になる番組を見つけたり、
「みんなの注目度」で他の人が気になっている番組を知ることができたりと、
これまで以上にテレビ放送をお楽しみいただけます。<BR><BR>

さらに、Ｍｉｉを登録すると使える便利な機能があります。<BR>
気になった番組に自分のＭｉｉを登録すると、
家族やＷｉｉフレンドと、気になる番組を知らせあうことができます。
みんなで使えば、テレビの話題がもっと盛り上がるかもしれません。<BR>
Ｍｉｉに「お知らせメール」を登録しておけば、
見たい番組がはじまる前に携帯電話などへメールを送ることもできます。<BR><BR>

また「テレビリモコン機能」を使うと、
番組表で選んだテレビ放送へ画面を切り換えたり、
テレビの音量やチャンネルを変えたりするなど、
お使いのテレビをＷｉｉリモコンで直接操作することができます。<BR><BR>
...
『テレビの友チャンネル』の詳細は、<BR>http://www.nintendo.co.jp/wii/<BR>をご覧ください。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000148424E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000148424E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">テレビの友チャンネル</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Ｇガイド for Wii</span></div>
  </div>
