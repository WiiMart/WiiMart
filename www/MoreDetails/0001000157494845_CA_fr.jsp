...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157494845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Play with Birds is an original cartoon bird game for players of all ages, offering a unique experience playing a bird. Fly through the city, accomplish dozen of bird minigames, including Birdman, Catch Thief!, Bird race!, and others. Become famous and find a bird to build a nest with!
<p>
