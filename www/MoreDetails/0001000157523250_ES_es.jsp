...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157523250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Un conejo está atrapado dentro del mando de Wii. ¡Ven a jugar con él!
<br><br>
Lo primero, intenta interactuar con él moviendo el mando de Wii o pulsando los botones. Verás cómo le gusta.
<br><br>
Después de que empecéis a conoceros, es hora de cambiar su aspecto en el laboratorio: deformar su cabeza, ponerle accesorios a la moda para que lleve sombrero, o cambiar su aspecto de la cabeza a los pies con el módulo de dibujo.
<br><br>
Cuando hayas convertido a tu conejo en algo único, puedes hacer una foto y enviarla con un mensaje de Wii a tus amigos.
<br><br>
