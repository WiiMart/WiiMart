...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157554E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Get ready to call “UNO” on your Wii! The world famous card game is faithfully reproduced for Wii and also features exciting new rules. With a multiplayer mode played on one Wii console, UNO has never been so fun and easy, so be the first to get rid of all your cards!
<br><br>
...
• Allows for customising the game rules and discovering new ways to play UNO like “UNO 7-0”, “UNO Challenge”, “Jump In” and many others.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554E50/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
