...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Stel je Pokémon-vechtkunsten en puzzelvaardigheden op de proef en neem het op tegen de beste trainers in Puzzle Village! Om te kunnen winnen moet je scherp zijn en snelle vingers hebben. Verwijder puzzelstukken door blokken van dezelfde kleur bij elkaar te zetten. Hoe meer puzzelstukken je in één keer verwijdert, des te meer punten zul je scoren.
<br><br>
Rijg gigantische combo's of ketens (Chains) aan elkaar om krachtige aanvallen naar je tegenstander (de computer of een vriend) te sturen en win badges van rivaliserende trainers om de Pokémon Puzzle Master te worden!
<br><br>
Naast gevechten staan er nog vele andere spannende uitdagingen op je te wachten, van de 3D-spelstand (3D Mode) tot de breinbrekende oefeningen in de puzzeluniversiteit (Puzzle University). Ben je klaar voor een nieuw soort Pokémon-gevecht?
<br><br>
Het spel is voorzien van Engelse schermteksten.<br>De Rumble-functie van het origineel wordt niet ondersteund.</div>
  <div id="image02">
