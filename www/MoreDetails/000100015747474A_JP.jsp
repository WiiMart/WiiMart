...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015747474A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ユータイリダツでユーレイになってしまった少女「リンゼ」が、誰もいなくなってしまったモンスターの街「モンストルオ」にゾンビ達を呼び戻すため、ホラーダンスを踊るダンスアクションゲームです。Ｗｉｉリモコンを持ち、モンスターと同じように踊るだけの簡単操作で遊べます。上手に踊れると、ゾンビが街に戻ってきたり、アイテムを獲得することができます。アイテムを獲得すれば、自分だけのキャラクターを作ることができます。<BR><BR>マルチプレイでは、最大４人まで同時に遊べるダンスバトルが用意されています。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015747474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015747474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">うしみつモンストルオぷち</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">不思議なお城のダンスパーティー</span></div>
  </div>
