...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Seguito del famoso “Lode Runner”, questo gioco include una modalità per cinque giocatori.
Dal Centro di Ricerca Temporale è stato rubato dell'oro e i ladri sono fuggiti usando una macchina del tempo. Il Centro invia allora un gruppo di ”Runner” che deve inseguire i ladri in varie ere temporali e recuperare l’oro.
Oltre che con la tradizionale modalità ”PUZZLE” potrai divertirti con la modalità ”BATTLE”, a cui possono partecipare fino a 5 giocatori, e la modalità ”EDIT”, che ti permette di creare nuovi livelli.
<br><br>
Esistono diverse varianti della modalità ”BATTLE”: in ”SURVIVAL” la vittoria va all’ultimo giocatore rimasto; in ”ESCAPE” devi rubare oggetti agli avversari e fuggire; in ”TAG MATCH” si affrontano 2 squadre da 2 giocatori ciascuna.
<br><br>Quando giochi nella modalità per più giocatori, il numero di telecomandi Wii o di controller per Nintendo GameCube dev'essere uguale al numero di giocatori.
Per giocare in cinque, è necessario utilizzare almeno un controller per Nintendo GameCube.
