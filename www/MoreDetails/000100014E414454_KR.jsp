...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">슈퍼 패미콤으로 발매된 「스타폭스」의 업그레이드판. 풀 보이스의 영상으로 구성된 입체감 넘치는 3D 슈팅 게임입니다. 플레이어는 폭스를 조종해서 동료와 협력하여 각 스테이지에서의 작전을 완수하며 베놈 행성을 향해 나아갑니다. 베놈 행성까지의 루트는 특정 스테이지의 클리어 조건에 따라 여러 갈래로 나뉘게 되며, 동료들이 전선에서 이탈하지 않은 상태로 일정 수의 적 기체를 격추시키면 얻을 수 있는 각 스테이지의 훈장을 모두 모으면 난이도가 높은 보너스 스테이지를 즐길 수 있게 됩니다. 대전 전용인 VS.모드에서는 4명까지 함께 플레이할 수 있습니다. 마지막까지 격추되지 않은 채 남아 있는 플레이어를 가리거나 대전 상대를 격추한 횟수를 겨룰 수 있습니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414454/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414454/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">스타폭스<sup>TM</sup> 64</span></div>
</div>
