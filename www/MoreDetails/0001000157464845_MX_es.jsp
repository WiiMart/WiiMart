...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157464845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Controla una inagotable sucesión de aviones en el famoso y adictivo juego de Firemint!
<p>
Serás el controlador de un aeropuerto muy activo. Dirige toda clase de aparatos a un lugar seguro y no dejes que choquen entre sí. ¿Te parece fácil? A medida que vayan llegando más aviones, necesitarás unos nervios de acero y una buena estrategia para mantener el caos bajo control. Para jugar, lo único que tienes que hacer es seleccionar los aviones y llevarlos a las pistas de aterrizaje con el Wii Remote. ¡Incluso puedes jugar con tu familia y tus amigos en un modo multijugador de entrada y salida rápida para un máximo de cuatro personas!
<p>
Viaja a cinco aeropuertos distintos, incluyendo uno situado en el desierto australiano y un portaaviones. Controla 10 tipos de aparatos distintos, como reactores, helicópteros e hidroaviones. Tardarás un minuto en aprender a jugar Flight Control, ¡pero te costará bastante más dejarlo!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
