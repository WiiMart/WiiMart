...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157534A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">L'ultimo Trova Le Differenze! su WiiWare, con 160 scene, 3 livelli di difficoltà e 1.600 differenze da trovare!<br>
<br>
Gioca da solo o con i tuoi amici (fino a 4 giocatori): vince chi ha la vista più acuta!<br>
Scopri le immagini più belle o più strane nelle diverse categorie: paesaggi, animali, giochi e golosità!<br>
<br>
4 modalità di gioco disponibili:<br>
<br>
- Arcade: <br>
Le scene appaiono in ordine sparso: trova 5 differenze per ogni scena. <br><br>
 
- A tempo: <br>
Trova una differenza per ciascuna scena prima della fine del tempo. <br><br>
 
- Selezione scene: <br>
Gioca usando la scena che preferisci e trova anche qui 5 differenze. <br><br>
 
- Multigiocatore: <br>
Sfida i tuoi amici (fino a 4 giocatori).<br><br> Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534A50/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Trova Le Differenze!</span></div>
</div>
