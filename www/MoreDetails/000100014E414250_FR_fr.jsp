...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les dérapages de folie et les lancers de carapaces sont de retour! Mario Kart 64 fut l'un des premiers grands succès de la Nintendo 64 et est toujours largement considéré comme l'un des meilleurs épisodes de la célèbre série de Nintendo. Une réputation qui se justifie amplement! Le mode multijoueur à 4 permet les parties les plus endiablées, alors que les sensations de conduite ont été améliorées grâce à l'ajout de techniques de pilotage avancées. De plus, les différents circuits regorgent de dispositifs ingénieux et de raccourcis en tous genres.
<br><br>
Malheureusement, il est impossible dans cette version de sauvegarder vos "fantômes" (représentations de vos meilleures performances en mode contre-la-montre). Veuillez nous excuser pour ce désagrément.
<br><br>
Le texte à l'écran sera en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Mario Kart 64<sup>TM</sup></span></div>
</div>
