...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">現在もさまざまなハードで発売され、根強いファンを持つ「メトロイド」シリーズの第一弾。数々のアクションやダンジョン探索が楽しいディスクシステム用ソフトの名作です。他の生物に取りつき、エネルギーを吸いつくしてしまう恐ろしい未知の生命体「メトロイド」。宇宙海賊に奪われたメトロイドを追って、宇宙戦士サムス・アランは海賊の本拠地「要塞惑星ゼーベス」へと向かいます。ゼーベスの各所に隠されたパワーアップアイテムを手に入れることで、武器やパワードスーツの能力を強化し、行動範囲を広げていきます。複雑な迷路と海賊の手によって仕掛けられた罠をくぐり抜け、限られた時間内で要塞マザーブレインの破壊をめざします。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146425A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146425A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メトロイド<sup>&reg;</sup></span></div>
</div>
