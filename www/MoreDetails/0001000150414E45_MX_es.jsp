...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Military Madness es un juego de simulación futurista que sitúa al jugador en medio de una guerra en la superficie de la Luna.  Las reglas son sencillas, ¡haciendo fácil para los novatos disfrutar de este emocionante juego de estrategia bélica!  Puedes ver instrucciones detalladas y fáciles de entender desde la pantalla de Título.  Military Madness también está basado en turnos, permitiéndote divisar tu estrategia antes de mover.  Y para rematar, las unidades que tienes para cada fase ya están decididas para ti, ¡permitiéndote concentrarte en las ordenes!  ¡Utiliza el terreno y rodea a tu enemigo para reclamar la victoria!  ¡Lucha a través de las 16 fases y arruina las ambiciones de tu enemigo!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414E45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414E45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
