...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157324650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Aquellos pacientes que tengan que completar un programa de rehabilitación conocen el problema:  Muchos de los ejercicios que son necesarios e importantes para el proceso de curación resultan a menudo monótonos y aburridos. Especialmente, cuando se trata del balance corporal y del equilibrio las variaciones son escasas.<br />
Aquí es donde el Physiofun Balance Training puede ayudar. El programa ayuda a que los ejercicios de entrenamiento resulten entretenidos.<br /><br />
El Physiofun Balance Training es ideal para los fisioterapeutas y los centros privados de rehabilitación. En lugar de emplear aparatos especiales caros, se pueden llevar a cabo importantes ejercicios para pacientes en recuperación como por ejemplo para dolencias en los pies, rodillas y la cadera.<br /><br />
El Physiofun Balance Training junta muchas funciones: Al lado de muchos tests significativos como la medición del centro de gravedad y el equilibrio corporal, el “Modo Fisio“ ofrece la oportunidad de crear planes sofisticados de entrenamiento para ejercicios fisioterapéuticos.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324650/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324650/FFFD0012" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Entrenamiento de equilibrio</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Physiofun</span></div>
  </div>
