...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157395550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bienvenue à bord !<br>
Vous trouverez ici quatre jeux fabuleux pour satisfaire votre appétit pour le jeu :<br>
- La machine à sous <br>
- La Roulette <br>
- Le Black Jack <br>
- Le "Vidéo" Poker <br>
Une fois sur le pont, vous serez en mesure de choisir :<br>
- Le mode Compétition <br>
- Le mode Quick Play <br>
Si vous battez un record, vous devez entrer votre nom afin d'apparaître dans le tableau des meilleurs scores. Mais prenez garde à la banqueroute !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157395550/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157395550/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Cruise Party</span></div>
</div>
