...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157525345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Step Up ofrece entrenadores profesionales especializados en ejercicios de Step, para ayudarle a perder todas las calorias que siempre ha deseado. Desarrollado en colaboración con expertos de la Universidad Laval, Step Up ofrece varios programas de ejercicios diseñados para ayudar al usuario a recordar las coreografías instintivamente.
<p>
Step Up incluye distintos niveles de dificultad con varias canciones con diferentes ritmos, permitiendole configurar su sesión de entrenamiento completamente a su gusto. Su configuración versátil permite a los principiantes realizar ejercicios básicos así como a los expertos realizar ejercicios complejos y alcanzar sus propios límites. Step Up puede ser configurado para funcionar con la Wii Balance Board o con un cajón de step del mismo tamaño.
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157525345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157525345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Step Up</span></div>
</div>
