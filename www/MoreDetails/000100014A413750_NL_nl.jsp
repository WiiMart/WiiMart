...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Een meesterwerk in gamedesign, uitgebracht aan het begin van het SNES-tijdperk. ActRaisers populariteit komt voort uit de revolutionaire mix van actie en simulatie. De speler neemt de rol aan van The Master, een onttroonde godheid wiens idyllische wereld in handen is gevallen van The Evil One. Zonder zijn goddelijke krachten moet The Master een einde zien te maken aan het bewind van The Evil One en zijn koninkrijk opnieuw opbouwen.
<br><br>
Je wisselt voortdurend tussen twee standen: actie en simulatie. In de actiestand moet The Master in zes landen vrede stichten. Zodra de vrede is hersteld, begint de simulatiestand. Daarin houdt The Master toezicht op de ontwikkeling en de herbevolking van het teruggewonnen gebied. Zo krijgt hij meer volgelingen en groeit zijn macht, waarmee hij een volgend gebied kan heroveren en The Evil One kan verslaan.
