...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En el planeta Nebulus están pasando cosas muy raras. ¡Alguien o algo ha empezado a construir enormes torres en el fondo del mar sin tener una licencia de construcción! Tu misión será de llegar a la base de cada torre en tu submarino. Deberás guiar al curioso protagonista a lo largo de las ocho torres para alcanzar la cima de cada una y detonar el mecanismo de destrucción, terminando así con la malvada amenaza. Reconocido en su tiempo por su innovación gráfica, seguramente es el mejor juego de Hewson de 1987. ¡No te lo pierdas!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000143393445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000143393445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Tower Toppler<sup>TM</sup></span></div>
</div>
