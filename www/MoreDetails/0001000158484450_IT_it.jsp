...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000158484450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM"><b>Questa è una versione demo e potrebbe non comprendere tutte le funzioni incluse nella versione completa del software.</b><br><br><b>Dopo aver giocato alla versione demo, accederai automaticamente al Canale Wii Shop. Questa operazione potrebbe richiedere alcuni minuti.</b><br><br>Con NyxQuest: Kindred Spirits vivi l'incredibile storia di Nyx, un'enigmatica fanciulla alata che dovrà scendere dal cielo in cerca di Icaro, il suo grande amico scomparso. 
<br><br>
Sorvola le rovine dell'antica Grecia ed evita di cadere nelle sabbie ardenti o di soccombere tra gli artigli di crudeli arpie ed idre...
<br><br>
Avrai bisogno dell'aiuto di Zeus e di altri dèi per invocare i poteri dell'Olimpo, che ti consentiranno di lanciare raggi, alterare lo scenario e dominare i venti a tuo piacere. Con i movimenti del tuo polso e mirando allo schermo potrai svolgere questa ed altre imprese nella più innovativa e divertente avventura di piattaforme per Wii. Vola, prendi la mira e spara, e sfrutta al massimo il potenziale del telecomando Wii!
<br><br>
Gioco per uno o due giocatori. Gioca col tuo migliore amico e massimizza le tue possibilità! Uno controlla Nyx, mentre l'altro lo aiuta con i poteri degli dèi.
<br><br>
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Versione demo</span></div>
  </div>
