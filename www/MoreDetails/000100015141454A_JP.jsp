...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">昼夜や四季によって変化する美しいゲーム画面で、鉄道会社の社長となって都市開発にのぞむ経営シミュレーションゲームです。工場で生産したりマップ外から購入した「資材」を開発地に集積させれば、駅を中心にひとりでに家やビルが作られ、人口が増加していきます。鉄道事業以外にも、デパートやマンション、ゴルフ場などの「子会社」を経営して街を活性化させることも重要です。人口とともに鉄道や子会社の利用客も増え、収益は増加していくので、新たな地域の開発も可能になります。このゲームには「クリア」はありません。資金の続く限り、思い通りの街づくりを楽しんでください。ただし資金がなくなってしまうと、会社は「倒産」しゲームオーバーとなります。急激な開発には十分注意して、収支の黒字を維持しつつ、街も会社もじっくりと育てていくのがポイントです。国内外で数々の賞に輝いたパソコン用ゲームのＰＣエンジン移植作です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141454A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141454A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">A列車で行こう<sup>&reg;</sup>Ⅲ</span></div>
</div>
