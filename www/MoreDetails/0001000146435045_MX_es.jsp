...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Controlar a un personaje para reventar el globo del oponente antes de que ellos revienten el tuyo suena fácil, verdad? No te dejes engañar por la sencillez del juego o su lindo exterior, ya que por debajo de todo esto encontrarás que este juego es sorprendentemente adictivo con estrategia de sobra.  Después de dominar los controles simples de aprender, tendrás que tomar control de la impresionante y realista física del juego.  Y si eso no se te hace demasiado, todavía tendrás que lidiar con los constantes enemigos y peligros medioambientales, como el agua y los relámpagos. O prueba el segundo modo del juego, Ballon Trip, por si deseas descansar de toda esta acción, o si nada más quieres ver cuanto tiempo te puedes mantener volando en el aire.  Y vale, ¿a quien no le gusta andar reventando globos de vez en cuando?</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146435045/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146435045/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Balloon Fight<sup>&reg;</sup></span></div>
</div>
