...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157594B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「読み聞かせあそびWii」は、昔ばなしや童話を子供と一緒に楽しむコミュニケーションソフトです。<BR>子供の想像力を豊かにする絵本の魅力と、親子の絆を深める「読み聞かせの魅力」をテーマにした、絵本でもビデオでもない本作は、お話を読み聞かせるだけでなく、Wiiならではの直感的な操作で遊べる「仕掛けあそび」やお話の動作をモチーフにした「チャレンジゲーム」も搭載しています。仕掛けやゲームはそれぞれのお話毎に遊び方や内容も様々。存分に楽しむことができます。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157594B4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157594B4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">読み聞かせあそびWii</span></div>
</div>
