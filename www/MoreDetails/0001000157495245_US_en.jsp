...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157495245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Shocking series finale sure to shiver your timbers! With the Monkey Island world in tatters at the conclusion of the fourth Tales of Monkey Island chapter, we're all left to wonder: who can save the Caribbean?!  LeChuck is revealing surprising new characteristics yet again, Guybrush has met a shocking fate, and Elaine must confront the ultimate evil with everything at stake! Your adventure takes you far beyond the stormy isles as you experience the Rise of the Pirate God!</div>
  <div id="image02">
