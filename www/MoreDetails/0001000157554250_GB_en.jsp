...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157554250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Get ready for a brand new experience...Germany's number one board game is here!<br><br> Its mechanics are very simple. Just solve as many puzzles as you can and get gems of the same colour.
<br><br>
The original board game is a blockbuster in countries such as Germany, where its popularity has taken Ubongo to the highest position in the lists of sales of board games. The game has sold 1,000,000 units in Germany and has won many awards, including Best Family Game award in Sweden and Game of the Year award in Norway and Finland. 
<br><br>
Game Modes:<br><br>
 -History Mode<br>
In this mode you’ll take the role of Kanu and must defeat the followers of the evil Rifictus by beating them in Ubongo's games.<br>
-Quick Game<br>
Find here Ubongo's quick games<br>
-Time Attack<br>
In this mode you should focus your efforts on the clock... as the key is to get the highest number of gems within the time limit!<br>
-Multiplayer Mode<br>
Challenge your friends in this Multiplayer Mode for up to 4 players.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554250/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157554250/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
