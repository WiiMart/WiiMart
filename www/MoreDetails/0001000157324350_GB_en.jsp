...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157324350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Boost your brain and relieve stress through 25 Visual, Memory, Logic, Math, and Focus mini-games.
<br><br>
Choose your favourite coach and get a detailed evaluation of your performance in personal training sessions.
<br><br>
...
<br><br>
Thanks to the special Kid Test and Senior Test modes, you can gather people of all generations around the game.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324350/FFFD0008" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324350/FFFD0009" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
