...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tu nombre es Mappy, el ratón policía. Tu misión es recolectar todos los objetos robados por Goro y su pandilla. Recoge todos los objetos robados de la mansión para avanzar a la siguiente ronda. Si entras en contacto con un enemigo o te caes en un hoyo, perderás una vida. Cuando pierdas todas las vidas, se terminará la partida. Podrás conseguir vidas extra cuando alcances ciertos intervalos de puntos. Salta sobre trampolines para ascender y descender. Con cada rebote seguido cambiarán de color y si saltas sobre un trampolín rojo, se romperá. Oprime el Botón 1 o Botón 2 para abrir o cerrar puertas cercanas. Las puertas se abren hacia el lado en el cual se encuentre el pomo. Abre las puertas especiales para soltar un impulso que expulsará fuera de la mansión a cualquier enemigo que se encuentre en su camino. El impulso se puede activar solo una vez por puerta especial.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145373345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145373345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MAPPY<sup>&reg;</sup></span></div>
</div>
