...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157414250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Usa il telecomando Wii per costruire una torre in equilibrio in questo puzzle basato sulla fisica!
<br><br>
I puzzle devono dare dipendenza. E questo era un obiettivo di massima priorità per noi, quando abbiamo sviluppato il gioco. Con ben 100 livelli, questo gioco non metterà soltanto a dura prova le tue abilità, ma anche la tua immaginazione. È un gioco facile da cominciare, ma difficile da lasciare.
<br><br>
Gioca da solo o fai partecipare un amico in qualsiasi momento, con la modalità Cooperativa e un secondo telecomando Wii. È presente anche un'apposita modalità Testa a testa a schermo condiviso, per due giocatori, per aumentare il divertimento.<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414250/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414250/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
