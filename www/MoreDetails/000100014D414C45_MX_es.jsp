...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mobo y Robo Bonanza disfrutaban de su programa de televisión favorito y, de repente, la imagen se hizo borrosa y la figura de un extraño apareció en la pantalla. Esta figura les pidió que recogieran ciertos objetos que se encuentran colocados dentro de varios edificios con el fin de comprobar su seguridad. Si regresan con todos las cosas, serán recompensados. Los dos indican que pueden hacer esto en tan solo 3 minutos. Sin embargo, ellos no saben que cada edificio es custodiado por guardias de seguridad, los cuales tocarán la alarma si son sorprendidos con las manos en la masa. Además, la recompensa por atrapar a Mobo y Robo es sustanciosa. Por suerte, Mobo y Robo están equipados con balas que mantienen a los guardias inconscientes durante unos segundos. Ayuda a los infames hermanos Bonanza a infiltrarse en diferentes lugares, pasando por bancos, mansiones y casinos, ¡y no permitas que los atrapen!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D414C45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D414C45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
