...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">おのれの拳だけを武器に、強大なシンジケートに戦いを挑む３人の若者たちの戦いを描いた格闘アクションゲームです。マーシャルアーツの使い手アクセル、ボクサーのアダム、紅一点の柔道家ブレイズの３人の中から１人を選び、シンジケートのボスが待つビルを目指し８つのステージを進んでいきます。２人同時プレイも可能で、２人プレイならではの協力攻撃もありますが、仲間と心をひとつにしていないとラストで大きなどんでん返しも？　数々の名曲を生み出したゲーム音楽家・古代祐三によるリズム感溢れるサウンドが戦いを彩ります。世界中で大ヒットした人気シリーズの第一作です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D41514A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D41514A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ベア･ナックル<sup>TM</sup>　怒りの鉄拳</span></div>
</div>
