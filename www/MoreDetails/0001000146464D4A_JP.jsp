...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８８年に発売されたサイドビュー（横から見た画面）とトップビュー（上から見た画面）のステージ構成が特徴のアクションシューテングゲームです。高度な文明によって栄える惑星国家「ソフィア第３惑星」は、大宇宙の恐怖の覇王「ＧＯＥＺ（ゴウズ）」率いるインベム暗黒星団の来襲によって、平和に終止符を打たれてしまいました。インベム打倒のための最終兵器、戦闘万能車両「メタル・アタッカー」を操り、インベム暗黒星団と戦います。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146464D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146464D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">超惑星戦記 メタファイト</span></div>
</div>
