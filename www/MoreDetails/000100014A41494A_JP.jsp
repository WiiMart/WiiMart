...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">英雄の血を受け継ぐ主人公の青年シモンが、鮮やかなムチさばきで魔物たちを次々と倒していく、横スクロール型アクションゲーム。最終的には復活したドラキュラを倒すのが目的。おどろおどろしい世界観をみごとに表現した美しいグラフィック、絶妙に再現されたムチの細やかな動きのほか、隠し部屋や隠しアイテムも豊富で、やりこみ要素もいっぱいです。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41494A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41494A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
