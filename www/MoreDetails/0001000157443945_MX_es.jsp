...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157443945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Han pasado otros 100 años desde la muerte del Conde Drácula, pero el renacimiento de su maldición ha emergido una vez más dentro del reino de Transylvania.  Juega el rol del máximo héroe gótico del largo linaje de cazadores de vampiros, el clan Belmont, y libera el universo de las legiones de oscuridad y perdición de Drácula.  Basado en el clásico original de 1989 Castlevania: The Adventure, la versión de WiiWare le permitirá a jugadores de una nueva generación y a los viejos aficionados experimentar uno de los juegos más populares dentro de la histórica línea de tiempo de Castlevania desde una nueva perspectiva.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157443945/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157443945/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
