...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157433250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In CRYSTAL DEFENDERS R2 devi schierare schermidori e maghi neri per difenderti dalle invasioni delle orde nemiche e impedire che si impossessino dei cristalli della tua fazione.<br><br>

Puoi scegliere tra diverse unità specializzate in potenti attacchi ravvicinati o in incantesimi a lungo raggio. Alcune possiedono archi con cui possono abbattere nemici aerei. Schiera le unità in punti strategici per sfruttare al meglio le loro caratteristiche.<br><br>

Ogni volta che un nemico supera la tua difesa e raggiunge l'uscita della mappa, la tua fazione perderà cristalli. La partita termina una volta che hai perso tutti i cristalli.<br><br>

In R2 troverai nuove e difficili mappe, con numerose vie d'accesso e vie d'uscita. Vengono inoltre introdotti tre tipi di Cristalli del potere, con cui potrai migliorare le abilità delle tue unità, mentre le nuove classi (inclusi i magicannonieri e gli inventori) ti permettono di creare strategie ancora più complesse.<br><br>

Riuscirai a difendere tutti i cristalli senza perderne neanche uno?<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
