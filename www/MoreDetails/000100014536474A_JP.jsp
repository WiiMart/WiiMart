...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">宇宙船「ハインダー号」は、長い航海を終えて地球に帰還する途中、
宇宙生命体「ブリーダー」に行く手を阻まれてしまいます。プレイヤーはハインダー号（パドル）を左右に動かし、跳んでくる「エナジーボール」をはね返して、宇宙生命体ブリーダー（ブロック）の破壊をめざします。破壊できるブロックを全て消去すると、ラウンドクリアになります。パックマンなどのナムコの人気キャラをかたどったラウンドなど、全３３ラウンドが用意されています。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536474A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536474A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ナムコクエスター<sup>&reg;</sup></span></div>
</div>
