...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157494E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lasciati trascinare in The Incredible Maze (Il Labirinto Fantastico)! <br><br>Inclina semplicemente il telecomando Wii per muoverti in una serie di emozionanti e contorti labirinti. Entrare in un labirinto non potrebbe essere più facile, ma trovare la via d’uscita richiederà intuito e una mano ferma. Ostacoli e trappole sono ad ogni angolo, per cui fai attenzione a muovere la palla attraverso il labirinto senza farla uscire dal bordo. Ma stai attento, ci sono molte sorprese in serbo per te. Potrai dare la caccia a gemme in una gara a tempo, o provare la tua abilità in una corsa contro il tempo. The Incredible Maze (Il Labirinto Fantastico) è anche compatibile con la Wii Balance Board, con la quale puoi veramente comandare il gioco usando il tuo peso. <br><br>Questa è la direzione che conduce all’interno, ma dovrai trovare da solo la via per uscirne.
<br><br>
Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157494E50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157494E50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">The Incredible Maze</span></div>
</div>
