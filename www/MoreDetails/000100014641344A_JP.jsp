...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">タマゴ怪獣「タマゴン」を操作して、デビルの支配する迷宮を進むアクションゲームです。迷宮はデビルによって常に上下左右いずれかにスクロールしており、プレイするたびに展開が異なります。プレイヤーは、迷宮の動きと敵の動きの両方に注意しながら、敵に当たったり壁にはさまれたりしないようタマゴンを操作しなければなりません。１ラウンドはクリア条件の異なる３つのステージで構成され、全てクリアすると次のラウンドへ進みます。それぞれのステージの特徴をつかみ、敵を倒したりステージをクリアするために必要な十字架やバイブルなどをうまく使って、迷宮を攻略してください。２人協力プレイにも対応していますが、お互いの動きを邪魔してミスになってしまわないように気を付けましょう。
<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641344A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641344A/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">デビルワールド<sup>TM</sup></span></div>
</div>
