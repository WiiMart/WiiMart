...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">シンプルな操作と単純明快なゲームシステムで好評を博した忍者アクションゲーム『忍者くん　魔城の冒険』の続編です。忍者くんを操作して、浜辺、海中、森、洞窟のステージを三角飛びやパワーアップアイテムなどを駆使してクリアしていきます。最終ステージに待ち構えるボス「阿修羅」を倒すのがゲームの目的です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014645374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014645374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">忍者くん 阿修羅ノ章</span></div>
</div>
