...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157434850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tu paciencia será la clave para enfrentarte a los mejores jugadores del mundo en “Chess Challenge!” (¡Desafío de ajedrez!). Perfecciona tus habilidades en el ajedrez jugando contra el ordenador en modalidades de dificultad múltiples. Gana juegos en línea e incluso, compara tu clasificación en el ajedrez con jugadores en el mundo examinando la tabla de clasificación en línea.
<br><br>
Si no tienes tiempo para jugar una partida de ajedrez en vivo con tus amigos, “Chess Challenge!” (¡Desafío de ajedrez!) te permite también jugar hasta con cinco amigos Wii utilizando WiiConnect24. ¡Con el soporte total Mii, puedes realmente darles vida a tus juegos! Empieza practicando con algunos juegos informales y ábrete el camino hacia arriba en partidas formalmente clasificados según el sistema de puntuación ELO. ¡Con todas estas opciones de juego, te esperan serias acciones de ajedrez!
<br><br>
Es hora de jugar tu mejor juego.
<br><br>
...
Como algunos de los servicios en línea de la consola Wii han dejado de estar disponibles el 28 de junio de 2013, ya no es posible acceder a las funciones en línea de este programa por medio de WiiConnect24.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157434850/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157434850/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Chess Challenge!</span></div>
</div>
