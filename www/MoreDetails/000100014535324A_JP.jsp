...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８４年に登場した、縦スクロールシューティングゲームです。多彩な敵の攻撃パターンや巨大なボスキャラなど、この時代のゲームでは珍しい特徴を持ち、後にシリーズ化されるほどの人気と完成度を誇る作品です。襲い来る敵機を撃墜しながら、ミッドウェイからオキナワまでの全３２ステージを、「ショット」と敵の攻撃を回避できる「宙返り」を駆使して戦い抜きましょう。<BR><BR>詳細は、<Center>http://www.capcom-onlinegames.jp/category/wii.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014535324A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014535324A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">１９４２</span></div>
</div>
