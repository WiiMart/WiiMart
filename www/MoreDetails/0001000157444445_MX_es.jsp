...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Diner Dash®, el juego de puzles de acción número uno para PC ha llegado a WiiWare™! ¡Guía a Flo, una antigua oficinista convertida en restauradora, mientras levanta su imperio con cuatro restaurantes únicos! ¡Conéctate y enfréntate a jugadores en partidas cara a cara! ¡Si aceptas el desafío, busca un amigo u otro jugador online para jugar en equipo, enfrentándoos a otros seis jugadores para ver quién tiene el mejor restaurante de la ciudad! Sienta a los clientes, toma nota, sirve la comida, cobra y limpia las mesas lo más eficazmente posible dentro del límite de tiempo permitido. Los jugadores que prefieran los esquemas de control tradicionales pueden usar un estilo de apuntar y hacer clic con accesos directos para ayudar a Flo en su búsqueda de la satisfacción del cliente, reflejada en un medidor de corazón que se vacía a medida que los clientes pierden la paciencia. Si se vacía del todo, el cliente se irá del restaurante.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157444445/FFFD000C" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157444445/FFFD000D" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
