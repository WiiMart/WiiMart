...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157525245')", "wiiSelectSound()");
...
<p>
Características:<br>
- Completa 12 niveles, derrotando a numerosos enemigos y visitando distintos lugares de la Inglaterra medieval<br>
- Busca objetos ocultos y consigue puntos extra<br>
- Enfréntate a supervillanos como el Sheriff de Nottingham<br>
- Juega de nuevo y mejora tu puntuación en la tabla de récords</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157525245/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157525245/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
