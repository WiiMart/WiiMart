...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157415950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Corre, salta, pon el mundo al revés!
<br>
And Yet It Moves es un juego premiado de plataforma basado en la física donde corres y saltas a través de un mundo hecho de papel. Para ayudarte a superar los retorcidos y alucinantes niveles, posees la única habilidad de rotar el mundo a tu voluntad. Las paredes se convierten en suelos, las pendientes se convierten en plataformas, pero un inofensivo montón de rocas se convierte en un peligro arriesgado cuando se pone al revés
<br>
