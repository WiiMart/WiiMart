...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157434C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Te has caído por un precipicio? ¿Te has quemado en la lava? ¿Te aplastó tu último invento un oso polar congelado? Evita todo esto con la increíble Barra del Tiempo de Doc Clock. ¡Disfruta viajando por el tiempo con la primera aventura de Doc Clock! Inventa cualquier cosa que se te ocurra con los objetos que recoges, desde catapultas a fantásticas máquinas voladoras. Viaja por el tiempo mientras Doc Clock lucha contra locos robots confundidos para poder salvar a su querido gato e inventar la tostadora perfecta.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157434C45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157434C45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Doc Clock<sup>TM</sup>:</span></div>
</div>
