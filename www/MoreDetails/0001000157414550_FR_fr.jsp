...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157414550')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Around the world est un jeu fun et grand public axé sur la géographie. <br>
Que vous désiriez améliorer vos connaissances ou bien vous amuser entre amis ou en famille, ce jeu est fait pour vous ! <br>
Il est composé d'un mode solo pour apprendre tout en vous amusant, et d'un mode multijoueur pour affronter vos proches.  <br>
Ce titre propose deux types d'épreuves où il vous faudra répondre dans le temps imparti :  <br>
- Quiz durant lequel le joueur doit répondre à la question en choisissant la bonne réponse parmi plusieurs propositions <br>
- "Pointez au plus près" où le joueur doit situer précisément un endroit donné  <br>
Ce jeu divertissant traite de la géographie au sens large à travers différents thèmes tels que les monuments, l'histoire, le sport, l'art, la littérature et les personnalités. <br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414550/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414550/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
