...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">現在も人気のアクションゲーム「がんばれゴエモン」シリーズの１作目。天下の義賊「ゴエモン」が、町や海、山などのバラエティに富んだステージを駆けめぐり、多彩に用意されたアイテムを駆使して敵をやっつけながら、さまざまな障害を乗りこえていきます。隠された通行手形を３つ探し出せば、次のステージに続く関所を通ることができます。数々の関所や難所をくぐりぬけ、城へ攻め入って悪大名をこらしめながら、肥後国からはるか江戸まで八つの諸国を順にめぐりましょう。２人プレイでは１人ずつ交互に遊ぶことができます。時代劇のようなグラフィックや軽快な音楽など、独特の世界観が支持を集めた人気作です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">がんばれゴエモン！<sup>&reg;</sup> からくり道中</span></div>
</div>
