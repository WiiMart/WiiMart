...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157454445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pelea solo o hasta con tres amigos más, para abrirte paso a través de 13 lugares diferentes en este frenético y emocionante juego de acción. Diviértete mientras Eduardo y sus compañeros tostadores disparan diversos tipos de postres a todo tipo de malvados productos alimenticios. Súbete en motociclos con láser y vuela a través de la pantalla con tu mochila de propulsión mientras aprendes a colaborar con tus compañeros en equipo  o simplemente disfruta fastidiando a tus compañeros al lanzarse el uno al otro a través de la pantalla. ¡La decisión es tuya!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157454445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157454445/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Eduardo the Samurai Toaster</span></div>
</div>
