...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157544B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">TV Show King, the WiiWare best seller, is back for a second round. There are 8,000 questions sorted into 12 categories on the program, including general knowledge, sports, movies, music and more... And that's without counting the questions that you can create yourself! Here's everything you need to compete with your friends!<br><br>

• Have fun and learn fascinating facts with image questions: for example, identify a work of art, or determine the correct location of a country on a world map.<br>
• Question editor: create your own quiz and post it online! Or download new question packs generated by other players for endless challenge!  <br>
• Questions that stimulate your reflexes thanks to original Wii Remote usage. For example, pop balloons in order to see the letters of the answers.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157544B50/FFFD0001" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157544B50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
