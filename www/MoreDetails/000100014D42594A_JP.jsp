...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『ガンスターヒーローズ』『ダイナマイトヘッディー』を制作したトレジャーの、最後のメガドライブ作品となったアクションＲＰＧです。プレイヤーは歴戦の剣士「デビッド・ランダー」となって、斜め視点で表現された地下迷宮にしかけられたさまざまなトラップをかいくぐり、魔法使いギルドがたくらむ怪事件の真相を究明するべく冒険を繰り広げます。リアルタッチのグラフィックでえがかれたモンスターとの戦闘を乗りこえながら、立体的な動きをみせるトラップのパズルを解いていく楽しさが、本作の醍醐味です。４つのエレメントを組み合わせて生み出す１５種類の魔法を駆使して進んだ迷宮の奥には、巨大なボスが待ち構えています。。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D42594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D42594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ライトクルセイダー<sup>TM</sup></span></div>
</div>
