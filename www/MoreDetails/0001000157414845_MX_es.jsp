...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157414845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Trenches Generals se despliega en la consola Wii y no toma prisioneros. Trenches Generals ha sido diseñado para la consola Wii desde cero para ser una experiencia inmersiva y apasionante que da un giro al tradicional género de defensa del castillo con su propio y personal estilo.
<p>
Dirige a las Fuerzas Expedicionarias Británicas como defensoras del mundo libre. Tus tropas deben tomar el campo, impedir que tu búnquer sea invadido y usar las trincheras situadas en el campo de batalla para mantener posiciones en tierra de nadie. ¡Conduce a fusileros, morteros, francotiradores, artilleros y muchos más contra los enemigos en el este! ¡Elige a tus extras para personalizar el modo de jugar la campaña para un jugador o para con un amigo en modo cooperativo y competitivo multijugador usando la pantalla partida! ¡Tu guerra, tus reglas!
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157414845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157414845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
