...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pon a prueba tu destreza en Columns, este antiguo juego fenicio. Las gemas multicolores caen desde lo alto de la pantalla hacia un foso y depende de ti cómo ordenes las joyas cuando caigan en líneas de tres o más. Si las gemas alcanzan la parte superior, el juego se acaba.<br><br>Textos de pantalla en inglés.<br>Incompatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
