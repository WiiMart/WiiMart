...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Ha vuelto el imperio Bydo! Más poderosos y mortales que nunca, los Bydo se dirigen hacia la Tierra y solo tú y tu nave R-90 os podéis interponer en su camino.
<br>
Al contrario que sus predecesores de arcade, R-Type III:™ The Third Lightning se desarrolló exclusivamente para Super Nintendo, aprovechando al máximo el sistema de gráficos "Mode 7" para generar fondos que giran, vibran y dan vueltas.
<br>
En R-Type III puedes elegir entre tres módulos -el módulo redondo, el módulo ciclón y el módulo sombra- que se pueden acoplar en la parte delantera o trasera de la nave y que multiplicarán su potencia de disparo, especialmente si los combinas con todas las mejoras. Además del cañón de ondas, está el hipercañón de ondas. Úsalo con moderación, ya que puede sobrecalentar la nave.
<br>
Si te gustó el R-Type™ original de Turbografx, R-Type III:™ The Third Lightning merece sin duda un hueco en tu colección de clásicos.
