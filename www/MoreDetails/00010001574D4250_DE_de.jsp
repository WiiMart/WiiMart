...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('00010001574D4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Was ist MaBoShi: Drei-Formen-Action? Es sind drei Spiele in einem. Einfach zu spielen, aber mit erstaunlich viel Tiefgang.
<br><br>
MaBoShi: Drei-Formen-Action basiert auf den drei grundlegenden Formen: Kreis, Stab und Quadrat. Es gibt drei Spielfenster, in denen drei Personen gleichzeitig spielen können. Dabei wird nur der A-Knopf oder das Steuerkreuz verwendet. Und die Spielfenster beeinflussen sich gegenseitig.
<br><br>
Das Ziel des Spiels ist in jedem Modus dasselbe – eine Million Punkte zu erreichen – aber jeder Modus stellt dich vor eine andere Herauforderung, ob du nun Gegner anrempelst im Kreis-Modus, dich durch den Level schlängelst im Stab-Modus oder dich durch ein Labyrinth aus Hindernissen brennst im Quadrat-Modus.
<br><br>
In MaBoShi: Drei-Formen-Action kannst du auch Mii-Figuren verwenden, via WiiConnect24 Replays an Freunde verschicken oder unterwegs auf deinem Nintendo DS spielen!
<br><br>
...
Da ein Teil der Online-Dienste, die auf der Wii-Konsole angeboten werden, am 28. Juni 2013 eingestellt wurde, sind die Online-Features dieser Software, die auf WiiConnect24 zugreifen, nicht mehr verfügbar.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4250/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Drei-Formen-Action</span></div>
  </div>
