...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El último metroide ha sido capturado y, por fin, la paz ha vuelto a la galaxia. Pero cuando los piratas espaciales roban la larva para sus malvados propósitos, la cazarrecompensas Samus Aran debe intervenir una vez más...
<br><br>
Vuelve al mundo subterráneo del Planeta Zebes y desciende a un laberinto aún más profundo, utilizando nuevos objetos como el Rayo de enganche y el visor de Rayos X. Enfréntate a descomunales enemigos con un increíble arsenal de rayos, misiles y bombas.
<br><br>
Super Metroid es famoso por ser uno de los mejores juegos de acción 2D jamás creados. Y también porque abrió el camino a la serie Metroid Prime, introduciendo por vez primera lo que serían las señas de identidad de la saga: el sistema de mapas, la amplia gama de trajes y armas y un mundo lleno de secretos que el jugador debe descubrir.<br><br>Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A415650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A415650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Metroid<sup>TM</sup></span></div>
</div>
