...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157424450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Brain Drain is een tof puzzel spel.<br>
Je moet alle puzzel elementen op hun juiste plaats brengen zoals in het voorbeeld.<br>
Drie verschillende spel modes :<br>
Challenge : 200 vaste puzzels met elks een 'Beste tijd' om te verslaan.<br>
Race: 4 moeilijkheidsgraden. Probeer een serie puzzels op te lossen in recordtijd.<br>
Random : gewoon ongelimiteerd puzzelen...<br>
<br><br>
