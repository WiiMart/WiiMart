...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ninja Spirit es un juego de acción horizontal que asombró al mundo de video juegos con sus gráficas precisas y la calidad del juego.  Juega como el ninja "Moonlight", que se ha involucrado en una pelea feroz para vengar la muerte de su padre y sacar a la luz los secretos de su nacimiento.  Elige entre el original "Arcade Mode" y el "PC-Engine Mode", los cuales incluyen un indicador de vida.  Usa 4 tipos de armas; katana, shuriken, bombas y cadenas para combatir a todos tus enemigos.  Recoge artículos de power-up y cambia tus armas para darte ventaja.  Necesitarás tomar en consideración los ataques del enemigo y las abilidades de tus armas para poder pasar todos los 7 niveles.  Usa tus abilidades y ataques para poder pasar por todos los enemigos y sus infinitas trampas. ¡Así tiene que ser la acción de ninja!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424E45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424E45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
