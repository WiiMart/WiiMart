...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El lanzamiento de Bubble Bobble en 1986 introdujo a los dos dragones bubble, Bub y Bob, y una nueva mecánica de juego, jugadores derrotarán a los enemigos al atraparlos dentro de burbujas para luego reventarlas. Aunque el juego se pueda ganar al pasar las 100 rondas, este también contiene elementos secretos como el de nunca poder llegar al “final verdadero” en el modo de un jugador, comandos secretos que te sirven para abrir rondas secretas, y un sin fin de diferentes objetos.  Estos elementos son unos de los más memorables e importantes funciones del juego.  Cada ronda tiene diferentes corrientes de aire que son invisibles, así que las burbujas se elevan en patrones impredecibles.  Aspectos del juego como el de forzar a los jugadores a entender y utilizar estos diferentes patrones mientras que tratan de jugar hacen que este juego revolucionario sea divertido en cualquier momento.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146433345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146433345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BUBBLE BOBBLE<sup>&reg;</sup></span></div>
</div>
