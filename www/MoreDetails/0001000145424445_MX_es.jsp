...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Juego de puzle publicado en 1997. Métete en los zapatos de un payaso y elimina las bolas apiladas en lo alto de la pantalla. Para ello, atrae hasta ti las bolas de arriba y dispáralas de vuelta. Alinea columnas de tres o más bolas del mismo color para ir eliminándolas. Las bolas van descendiendo a medida que pasa el tiempo; una vez tocan el suelo, termina el juego, ¡así que procura no relajarte! Elimina las bolas con movimientos cada vez más ágiles y, cuando seas un experto, dispáralas para formar largas cadenas.
<p>
Las reglas de esta edición son básicamente las mismas que las de las anteriores, pero ahora el juego aumenta el número de personajes a dieciséis, e incorpora un nuevo modo de juego: Aventura. ¡Disfruta el divertido mundo de MAGICAL DROP III!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145424445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145424445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MAGICAL DROP III</span></div>
</div>
