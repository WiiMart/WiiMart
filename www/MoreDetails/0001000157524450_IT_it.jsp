...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157524450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ti serviranno una vista acuta e una mente veloce per completare questi 100 puzzle di ricerca parole a tema. Trova Parole contiene parole divertenti di diverse categorie, come anatomia, città del mondo e presidenti. Con un vasto assortimento di materie tra cui scegliere, ci sarà sicuramente un puzzle divertente per tutti. Amplia il tuo vocabolario, allena la memoria e la tua abilità nel risolvere questi accattivanti rompicapi. Tieni traccia dei tuoi risultati e cerca di migliorare il tuo gioco di partita in partita, le parole saranno mischiate a ogni nuova sfida. Mettiti a riflettere seriamente fin da subito e finiscili tutti e 100!
<br><br>
Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157524450/FFFD000E" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157524450/FFFD0012" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Trova Parole</span></div>
</div>
