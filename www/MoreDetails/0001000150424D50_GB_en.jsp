...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">LEGEND OF HERO TONMA showed the gaming world that men weren’t the only ones capable of making great games. Designed and developed by an all-female team, this action game puts players in control of the magic user Tonma, whose role, as was typical for game heroes of the day, is to travel to another world and save the princess.<br><br>
Fight your way through 7 stages using Tonma’s jump ability and shot power. Collect Power-ups and Barriers to grow in strength and pummel your enemies. Bring that strength to the end of each stage to face off and defeat the menacing bosses that stand between you and the princess.<br><br>
This well-detailed game, with its comic visuals and feel, will have players wanting to come back for more frantic and exciting action.</div>
  <div id="image02">
