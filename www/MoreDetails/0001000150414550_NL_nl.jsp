...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Super Star Soldier is een klassiek schietspel waarin de spelwereld verticaal over het scherm schuift. Naast de standaard speelstand (NORMAL GAME), kun je ook racen tegen de klok, waarbij je kunt kiezen uit een spelletje van twee of vijf minuten.<br>De standaard speelstand bestaat uit acht verschillende gebieden, en aan het eind van vrijwel elk gebied moet je het opnemen tegen een eindbaas.<br>Het speciale aanvalsteam, geleid door Mother Brain, heeft een onstuimige aanval ontketend op de aarde, met het doel de wereld te veroveren. Bestuur je kleine gevechtsvliegtuig, de Neo Caesar, met zijn vier reguliere en twee speciale wapens, en verlos de aarde van het aanvalsteam!<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414550/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414550/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Star Soldier<sup>&reg;</sup></span></div>
</div>
