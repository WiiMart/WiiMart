...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミコンディスクシステム用ソフト『ふぁみこんむかし話　新・鬼ヶ島』の続編にあたり、主人公（男の子と女の子）のお供だった３匹の動物たちが、ふたりに出会う前のお話が語られるテキストアドベンチャーゲームです。後編では、第三話でキジの「おはな」が主人公になり、第四話では主人公たちと３匹が出会い、鬼ヶ島の決戦にのぞみます。新たな要素として、コマンド選択の代わりにアクションやパズルなどのミニゲームで物語を進めるシーンが追加され、迫力ある物語の世界をじっくり楽しんでいただけるようになりました。もとはスーパーファミコンでゲームを受信して楽しむ「サテラビュー」の番組として放送されたものを、スーパーファミコン用ソフトにしたものです。
<BR><BR>詳細は、<BR><center>http://www.nintendo.co.jp/vc/</center><div align="right">をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A44504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A44504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">平成　新・鬼ヶ島<sup>TM</sup>　後編</span></div>
</div>
