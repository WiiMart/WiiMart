...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Vive de nuevo fantásticas aventuras junto a maese Higgins en la segunda entrega de la serie clásica Adventure Island! En esta ocasión el malvado brujo y sus monstruos se han apoderado de varias islas y han secuestrado a Tina, la novia de Higgins.
<br><br>
Para rescatarla, Higgins deberá atravesar ocho islas diferentes divididas en fases que se vuelven cada vez más difíciles. Cada fase está llena de peligros y obstáculos, y al final de cada isla le espera un temible jefe que pondrá a prueba su entereza.
<br><br>
Además de su poderosa hacha, Higgins contará con la ayuda de varios dinosaurios con distintas habilidades que le serán especialmente útiles en tierra, mar y aire. ¡Ayuda a maese Higgins y a sus compañeros a rescatar a la adorable Tina y devuelve la paz a las islas! 
<br><br>
