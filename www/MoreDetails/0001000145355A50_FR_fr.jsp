...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Préparez-vous à atteindre des vitesses effarantes avec Super Hang-On ! Ce jeu de course et d'arcade à succès édité en 1987 par SEGA est la suite du non moins célèbre Hang-On. Testez vos talents de motard dans 48 circuits exigeants répartis sur quatre continents, et retrouvez toutes les sensations d'un jeu d'arcade ! Foncez d'un point de contrôle à l'autre pour ne pas être rattrapé par le chronomètre ou vos concurrents. Ressentez dès aujourd'hui l'exaltation du motard et faites-vous une place au sommet des classements dans ce jeu décoiffant, indispensable aux amateurs du genre ! <br><br> Texte écran en anglais.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145355A50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145355A50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Super Hang-On<sup>TM</sup></span></div>
</div>
