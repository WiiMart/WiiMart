...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574D4250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¿Qué es MaBoShi: El arcade de las tres formas? No se trata de un simple juego, ¡sino de tres a la vez! Disfruta de su simplicidad de control, pero sumérgete en sus infinitas posibilidades.
<br><br>
Este innovador juego se basa en tres formas básicas: círculo, barra y cuadrado. Gracias a sus tres ventanas de juego, hasta tres amigos podrán divertirse a la vez, ¡y todo tan solo pulsando el Botón A o la cruz de control! Pero cuidado con su novedoso sistema de efectos...
<br><br>
El objetivo es el mismo en cada juego: conseguir un millón de puntos. Sin embargo, cada uno tendrá sus características propias. Aplasta enemigos en el modo Círculo, ábrete camino a golpes en el modo Barra y supera a llamaradas los laberínticos obstáculos del modo Cuadrado.
<br><br>
Utiliza tus Miis favoritos y envía las repeticiones de tus mejores partidas a tus amigos gracias a WiiConnect24. ¡Y además, podrás disfrutar de una versión de MaBoShi: El arcade de las tres formas en tu DS!
<br><br>
...
Como algunos de los servicios en línea de la consola Wii han dejado de estar disponibles el 28 de junio de 2013, ya no es posible acceder a las funciones en línea de este programa por medio de WiiConnect24.</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574D4250/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">El arcade de las tres formas</span></div>
  </div>
