...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157453645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">You are a dolphin trainer. Use the magical stick (Wii Remote and Nunchuk controllers) to perform in lifelike dolphin shows. Teach your dolphin tricks, and have fun watching your dolphin swim and play elegantly with different scenes, music, and angles. This game lets you train your dolphin, compete in dolphin shows, and watch your dolphin swim freely. Using Nintendo <nobr>Wi-Fi</nobr> Connection Pay & Play, you can become friends with other dolphins that have different colors and personalities, as well as buy new toys such as rings and balls for your dolphin to play with.</div>
  <div id="image02">
