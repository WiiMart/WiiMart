...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574F5A4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「アイウエ・オームズ」は、大人からこどもまで楽しめる探偵ゲームとアニメ。事件を推理しながら親子の会話が広がります。<BR>本ソフトは事件のお話「かがみがしっている」と、５種類のゲームが遊べます。そのほか５つのお話を追加で購入（有料）することもできます。<BR><BR>■オームズ事件簿<BR>怪人100面相とオームズが対決する事件「かがみがしっている」のお話。事件が解決すると、ニュースを見ることもできます。<BR><BR>■オームズ探偵団入団テスト<BR>探偵に必要な力を養う４つのゲームと、うそを見抜く推理ゲームに合格すると、団員名入りの入団証明書が発行されます。<BR><BR>※「こども教育テレビWii  あいうえ・おーちゃん」を購入していると、おまけのゲーム「とりとりトリオ」ができます。「とりとりトリオ」はWiiウェア「あいうえ・おーちゃん」を購入していると、アイコンが自動的にオームズのデスク（メニュー）に表示されます。購入していない場合は、表示されません。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574F5A4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574F5A4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">こども教育テレビWii</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">アイウエ・オームズ</span></div>
  </div>
