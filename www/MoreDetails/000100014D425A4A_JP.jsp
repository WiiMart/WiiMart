...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">時代を越えた戦士たちが闘いを繰り広げる、異色２Ｄ対戦格闘ゲームです。元科学者のヴァンパイア、サイボーグ化したキックボクサー、怪しげな忍術を使う女暗殺者、ハードボイルドな夜盗、サーカスで暮らす女格闘家、近代兵器を使う賞金稼ぎ、棍棒を手にした原始人、科学を駆使した魔術師、アトランティスが生んだ人造人間といった、あらゆる世界から現れた９人の戦士たちが、世界を救うために特殊能力を駆使して闘います。各ステージには、対戦相手を倒す際に条件を満たすことで発生する特別な必殺デモも搭載。そのほか仕掛け満載のバトルルーム対戦やトーナメントモード、さまざまな練習モードも用意されています。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014D425A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D425A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エターナルチャンピオンズ<sup>TM</sup></span></div>
</div>
