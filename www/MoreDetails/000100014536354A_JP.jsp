...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ワルキューレの冒険」の続編として登場したアクションアドベンチャーゲーム。世界を支配しようと現れた悪の化身「カムーズ」によって平和が乱され、地上は混沌の世界に変わってしまいます。プレイヤーは再び世界を救うため、「ワルキューレ」と「サンドラ」を操作し、多彩な地形や敵の待つ各ラウンドをクリアしながら、北にある泉をめざします。ゲーム中は、武器と魔法による攻撃とジャンプというシンプルな操作ながらも、多彩なアクションが可能。さらに、それぞれのラウンドでは攻略ルートによって、さまざまなイベントが発生します。アイテムによって変化する攻撃や、軌道修正が可能なジャンプを駆使しながら、全８ラウンドを攻略してください。２人での同時プレイも可能です。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
