...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">This classic side-scrolling arcade shoot-em up, developed by Irem, takes place in the 22nd century, where you are humanity’s last hope against the evil Bydo Empire. Your ship, the R-9a “Arrowhead”, comes equipped with nothing but a standard laser, but never fear! Power-ups and upgrades are available in each mission to keep you fighting the good fight. 
<br><br>
Navigate through eight challenging levels that will test even the best gamer’s reflexes. The SEGA MASTER SYSTEM version also features an exclusive secret level not found in any other release!</div>
  <div id="image02">
