...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９８６年に発売されたバイクチェイスアクションシューティングゲームです。障害物ゾーンやスリップゾーンでのバイクチェイス、砲台ゾーン、砲台ゾーンを越えて恐竜タンクとの決戦の４シーンを１パターンとし、３パターン構成のループ背景となっており、シーンが進むごとに敵の強度も変わってきます。ただ撃つだけのシューティングゲームではなく、バイク同士の体当たりや障害物を避けるスリルを楽しめます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146465A4A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146465A4A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">セクロス</span></div>
</div>
