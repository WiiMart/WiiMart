...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ＰＣ電人」の続編にあたる、歌と笑いがたっぷりの横スクロール型シューティングゲームです。今回の電人はロカビリーのリズムに乗って、９つのキャラクターに大変身。宿命のライバル「サンドロビッチ伯爵」を相手に、７つのステージを所狭しと大暴れします。おなじみのアイテム「肉」を取ると、電人が最大５段階にパワーアップ。後半からは正義のヒーロー「デンジンマン」や「電獣ガウス」にも変身できます。さらに、助けを待っている仲間を助け出せば、合体して強力な攻撃が可能に。「マイクはなすなウナルンダー」は演歌を歌い、「おすし握るぜガッテンダー」はお寿司を投げつけるという具合に、ダジャレてんこ盛りの楽しい攻撃を披露します。テーマソングは３曲あり、どれもが雰囲気たっぷりの熱いナンバー。ゲームオーバー時の「歌う天気予報」など、ニクい演出にも思わずニヤリとさせられることでしょう。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">CD電人 ロカビリー天国</span></div>
</div>
