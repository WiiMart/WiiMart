...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lanzado en 1984, Boulder Dash es uno de los mayores clásicos entre los juegos para ordenador, uno de los pocos que fue llevado desde los ordenadores hasta las salas recreativas, algo que normalmente ocurre al revés.
<br><br>
Nuestro héroe es el valiente espeleólogo Rockford, que deberá excavar galerías en las cuevas para recoger diamantes, evitando al mismo tiempo varios tipos de peligrosas criaturas y rocas que se despeñan. Será constante el peligro de quedar aplastado bajo una avalancha o perecer a causa de una explosión subterránea.
<br><br>
Estrategia y planificación son las claves para dominar la “física” de Boulder Dash. Una vez conseguido un número requerido de piedras preciosas, se abrirá la misteriosa puerta que conducirá a Rockford a una nueva cueva, repleta también de piedras preciosas y peligros. ¿A qué estás esperando? ¡La fiebre de los diamantes ya está aquí!
<br><br>
