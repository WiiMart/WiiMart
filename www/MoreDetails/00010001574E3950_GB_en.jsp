...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574E3950')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Military is back for a new generation of recruits! The classic turn-based strategy series MILITARY MADNESS, a.k.a. NECTARIS, is exploding onto WiiWare with a platoon of new features. Coordinate strategies or taunt foes in team or vs. multiplayer modes for up to 4 people, offline or online. Customize the all-new commander unit by selecting from 20 unique abilities as it leads your forces in multiplayer. Command respect as you increase your rank as you march up the leaderboards on your mission to prove you’re the top general around. This is the maddest game in the series yet!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574E3950/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574E3950/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
