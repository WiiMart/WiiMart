...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Visita el lejano oeste más salvaje que verás en tu vida en este shooter de 3ra persona lleno de acción! ¡La banda de The Kid y su ejército de robots han tomado el control del pueblo!  Los únicos que pueden pararlos son Clint, un cazafortunas duro como pocos, y Annie, una mujer hermosa pero letal con cuentas pendientes que piensa saldar a los tiros.
<p>
Enfrenta a forajidos malvados, robots diabólicos y jefes enormes que ocupan toda la pantalla ya sea solo o con un amigo a tu lado en el modo cooperativo. Necesitarás un ojo agudo y reflejos imbatibles, pero afortunadamente tendrás muchos movimientos que te ayudarán a sobrevivir la lluvia de balas que te caerá. Puedes rodar, saltar, doble-saltar, atar enemigos con tu lazo y despejar la pantalla con ataques explosivos especiales. Dispárale a todo lo que se te cruce en el lugar para encontrar armas, bombas y otros potenciadores escondidos.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A445645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A445645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
