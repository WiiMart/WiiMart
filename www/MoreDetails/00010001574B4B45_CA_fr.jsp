...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B4B45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Based on the popular Pop-Up Pirate™ toy, players take turns thrusting swords into a barrel that holds your captain captive, trying to see who can insert the most swords into the barrel. Thrust a sword into the wrong hole and you'll send your captain flying, which means it's game over for you! Unique Wii features add to the excitement, making for a fun-filled party game. Try swapping out the captain and putting your custom Mii™ character in the barrel for some real laughs!</div>
  <div id="image02">
