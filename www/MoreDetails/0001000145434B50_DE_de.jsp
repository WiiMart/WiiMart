...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Erstmals veröffentlich 1990, ist NAM 1975 ein „shoot ‚em up“ Actionspiel, das man aus der Perspektive der dritten Person spielt. Der Spieler übernimmt die Rolle eines Soldaten der American Special Forces und kämpft sich durch ein raues Schlachtfeld während er sich im Vordergrund des Bildschirmes nach links und rechts bewegt und im Hintergrund Feinde wie wild auf ihn schießen. Im wesentlichen kämpft man mit Maschinenpistolen und anderen Schusswaffen, sowie mit Handgranaten und vergleichbarem, es ist außerdem auch möglich neue Waffen durch im Spielverlauf gefundene Gegenstände einzusammeln. Nicht zu vergessen, die Möglichkeit, wenn mit Erfahrung genutzt, sich sehr schnell zu bewegen, während man flott voranschreitet um aus brenzligen Situationen heraus zu kommen.<br><br>Englischer Bildschirmtext.</div>
  <div id="image02">
