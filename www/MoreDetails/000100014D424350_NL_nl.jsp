...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De lokale arcadehal wordt overspoeld door kinderen die het nieuwste, meest realistische videospel willen spelen. Het heet Wild Side en gebruikt holografische beelden om de speler in een vreemde wereld te doen opgaan. Er is echter een probleem: de kinderen worden letterlijk het spel ingezogen en nu zijn een aantal van hen erin opgesloten.
<br><br>
Het is aan jou, Kid Chameleon, de beste speler van de stad, om ook in het spel op te gaan, zodat je de eindbaas van het spel kunt verslaan en je vrienden naar de gewone wereld kunt terugbrengen. In het spel kun je verschillende vormen aannemen (Berzerker, Micromax, Maniaxe, Skycutter), waardoor je veel krachtiger wordt. Het spel kent meer dan 100 levels en 1850 schermen, dus er wordt nogal wat van je verwacht!
...
<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D424350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D424350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Kid Chameleon<sup>TM</sup></span></div>
</div>
