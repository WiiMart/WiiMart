...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">NINJA COMMANDO es un juego de acción vertical, lanzado por ADK en el año 1992. Los jugadores seleccionarán entre tres personajes (Joe, descendiente de los ninja Koga; Rayar, una mujer quien aprendió el arte del ninja Iga; y Ryu, descendiente del famoso ninja Fuma Kotaro) mientras que persiguen al mercader de la muerte conocido como Spider, quien planea usar una máquina de tiempo para destrozar el mundo. La batalla abarca siete épocas, incluyendo la Edad de Piedra, la época de Egipto, y la época de la Guerra Civil Japonesa. Además de sus ataques normales, cada héroe presenta una variedad de opciones de ataque, incluyendo un ataque mortal que perjudica a todos los enemigos en la pantalla, ataques especiales de arte de ninja que se ejecutan al ingresar comandos específicos, y finalmente, un poderoso ataque que se desata al “convertirte en una bestia” cuando reúnas tres pergaminos. Como también soporta el modo de dos jugadores, podrás traer a un amigo para que se diviertan juntos derrotando a Spider.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000145415045/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145415045/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
