...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">リアルなボールアクションとホラーテイストなグラフィックが魅力のピンボールゲームです。「台ゆらし」機能もついており、本物のピンボールマシンのような感覚で楽しめます。さまざまなトリックやアクションを楽しみながらハイスコアを目指します。ボーナスとエクストラボールの獲得が高得点へのポイントです。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エイリアンクラッシュ<sup>&reg;</sup></span></div>
</div>
