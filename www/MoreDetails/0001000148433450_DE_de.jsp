...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Crunchyroll ist die offizielle Anlaufstelle für das größte Angebot an aktuellen und auch ältereren Anime, Manga und Drama. Crunchyroll macht Millionen von Zuschauern weltweit Erfolgsserien wie Naruto Shippuden, JoJo's Bizarre Adventure oder Parasyte zugänglich. Alle Inhalte sind über unsere Apps auf Spielekonsolen, Set-Top-Boxen, Mobilgeräten und vielen weiteren Geräten verfügbar und werden professionell in diverse Sprachen übersetzt. Schaue kostenlos rein oder werde Premiummitglied und genieße das Angebot werbefrei und nur eine Stunde nach der Erstausstrahlung in Japan. Die Verfügbarkeit der Inhalte kann regionalen Beschränkungen unterliegen.</div>
  <div id="image02">
