...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dopo aver sconfitto il Mecha Dragon nelle profondità del Castello del Drago, l'eroe viene maledetto dalla bestia ferita ed è trasformato in un’abominevole creatura. Per riacquistare le sue sembianze umane il nostro eroe deve ora ritrovare la Salamander Cross, un manufatto che ha la capacità di annullare qualsiasi maledizione.
<br><br>
Questo GdR d’azione a scorrimento laterale non è lineare e ti permette di muoverti liberamente nel mondo. Raccogli il denaro e gli oggetti che trovi e potenzia il tuo equipaggiamento e le tue caratteristiche. L’eroe inizia nei panni dell’Uomo lucertola, ma ogni volta che sconfigge un boss, viene trasformato in un’altra creatura come l’Uomo topo, l’Uomo piranha, l’Uomo tigre e l’Uomo falco. Ciascuna creatura possiede abilità diverse come la capacità di volare, nuotare, camminare sui soffitti e appendersi alle pareti.
<br><br>
Usa le abilità di ogni creatura per trovare la Salamander Cross e riportare il nostro eroe alla sua forma umana originale!
<br><br>Il testo all'interno del gioco è in inglese.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414B50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dragon's Curse</span></div>
</div>
