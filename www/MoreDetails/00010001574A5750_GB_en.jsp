...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('00010001574A5750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Get set to play the world's #1 puzzle game, now for the Wii!  <br>Match sparkling gems three at a time to make them burst in showers of colours and points. Match four or more to create flashy power gems that boost your score and your mood with brilliant cascades and combos.  <br>Soar to gem-matching heights in Classic mode, or speed through matches against the clock in Action mode.  For even more dazzling fun, bump up your brainwaves with multi-faceted Puzzles, or enter the Zen state of Endless play.  <br>Every match is high-carat fun!</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574A5750/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
