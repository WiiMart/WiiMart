...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ocho equipos representando varios países luchan por ser el campeón de POWERBALL y tú controlas uno de ellos en tu búsqueda por el campeonato. POWERBALL es una combinación de deportes como el rugby y el fútbol: se juega en un campo de 100 yardas. Trata de ganar puntos cargando la bola a la zona final del adversario o pateándola a su red. Este juego de uno o dos jugadores ofrece partidos amistosos y competitivos. ¡Entra al juego de POWERBALL y prueba este deporte distinto!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014D434245/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014D434245/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">POWERBALL<sup>TM</sup></span></div>
</div>
