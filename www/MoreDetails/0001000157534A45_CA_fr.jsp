...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157534A45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The ultimate "spot the difference" game on the WiiWare service with 160 scenes, three levels of difficulty, and 1,600 differences to spot! Play either solo or with friends (up to four players) to find out who's the best spotter! Browse through odd and attractive scenes on various categories: Landscapes, Pets, Playtime and Yummy!
<p>
Four game modes are available:<br>
- Arcade: Scenes appear in random order, spot five differences in each.<br>
- Time Attack: Spot one difference in each scene for as long as the timer runs!<br>
- Select Scenes: Play with scenes of your choice and find five differences in each.<br>
- Multiplayer: Play against your friends (up to four players).
<p>
