...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Originally released on the SEGA MASTER SYSTEM, Phantasy Star was, and still is, a pioneer of the role-playing game genre.
<br><br>
You play as Alis, the fearless female protagonist, out to avenge her brother's death at the hands of the cruel tyrant, King Lassic. Guide Alis and her friends through the sprawling environments of the Algol solar system in an attempt to defeat King Lassic, a mission that develops into a grand quest to liberate the people of Algol! 
<br><br>
Engage in dynamic turn-based combat with dragons, ghouls, giants, and magicians by using unique weapons such as glowing daggers, crossbows and of course...magic spells!</div>
  <div id="image02">
