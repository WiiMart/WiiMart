...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ドラゴンを操作して戦うシューティングゲーム「ドラゴンスピリット」の続編です。バイオモンスターの軍勢が支配する汚染された大地。わずかに残された人類も敵の圧倒的な強さに希望を失いかけていたなか、勇敢な若者「ヒューイ」とエルフ族の女戦士「シリア」が、世界の平和を取りもどすため青と赤のドラゴンに姿を変え大空へ飛び立ちました。プレイヤーは対空用と対地用、２種類のファイアーで攻撃。対空用の攻撃は、エネルギーをためることで、より強力な「気合弾」にもなります。パワーアップは従来のファイアーアップのほかにも、新たなアイテム「ドラゴンチェンジ」が登場。ステージにあわせて火・風・雷・鋼のドラゴンに変化しながら全９ステージを戦います。さらに今作から２人同時プレイが可能になり、協力して楽しむこともできます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015043354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015043354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドラゴンセイバー<sup>&reg;</sup></span></div>
</div>
