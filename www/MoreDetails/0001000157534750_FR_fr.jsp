...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157534750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">SAMEGAME est un jeu de réflexion simple et passionnant dans lequel vous devez éliminer des groupes de 2 blocs ou plus.<br><br>

Visez le meilleur score en éliminant le plus de blocs possible en même temps. Si vous arrivez à éliminer tous les blocs du champ, vous continuez à jouer avec une nouvelle configuration. Éliminez tous les blocs pour obtenir un bonus !<br><br>

Ajustez la difficulté en mode 1 joueur en essayant différentes tailles de champ ou nombres de couleurs. Jouez comme vous le souhaitez !<br><br>

Jusqu'à 4 joueurs peuvent s'affronter dans 3 modes multijoueurs. Le mode "Fame Game" est similaire au mode 1 joueur. "Shame Game" retourne la situation et forcent les joueurs à viser le score le plus bas possible. Enfin, "Blame Game" est un mode chacun pour soi dans lequel les joueurs s'affrontent sur le même champ.<br><br>

Choisissez différents styles de blocs, graphismes de fond et musiques pour expérimenter le jeu différemment.<br><br>

SAMEGAME ! Rapide à maîtriser et facile à jouer... mais difficile à arrêter !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157534750/FFFD0011" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157534750/FFFD0012" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pop Them, Drop Them</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">SAMEGAME</span></div>
  </div>
