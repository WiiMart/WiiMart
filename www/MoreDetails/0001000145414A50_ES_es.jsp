...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Lanzado al mercado en 1996 por SNK, Metal Slug es un juego de acción militar de desplazamiento lateral. Los jugadores pueden dirigir a Marco (un jugador) y a Tarma (dos jugadores), que son miembros del grupo de operaciones especiales Team Peregrine Falcon (más conocido como Team PF). El objetivo es derrocar al general Morden y recuperar un arma robada: el Metal Slug. Básicamente, los jugadores deberán disparar y saltar para avanzar niveles. Para facilitar la victoria en las batallas, contarán con diversas armas, tales como ametralladoras pesadas, escopetas, lanzacohetes y lanzallamas (además del Metal Slug, que aparece con frecuencia). Úsalos bien al enfrentarte a oleadas de enemigos con uno o dos jugadores.
<br><br>
Textos de pantalla en inglés. Tutorial disponible también en portugués.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
