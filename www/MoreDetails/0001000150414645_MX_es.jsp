...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El juego se compone por 8 diferentes Etapas Especiales, incluyendo autopistas, desiertos, savanas, y costa. Cruza la línea de meta dentro del tiempo de la fase (más cualquier tiempo extra) para completar cada pantalla con éxito. Si el tiempo total es inferior al impuesto por la fase, podrás progresar a la siguiente fase.  Partes como ruedas, cambios, motores, sistemas de suspensión, y frenos pueden ser personalizados para hacer que el coche se adapte al tipo de carrera.  Conducir por terrenos en mal estado y chocar contra obstáculos causará daño a ciertas partes, así que necesitarás usar otras para hacer reparaciones. Esto significa que hacer buenas elecciones cuando se personalizan las partes es muy importante, y además añade un importante elemento de simulación al juego.  Corre desde París a Dakar, mientras haces recambios en los controles a lo largo del camino, en el juego de rally Victory Run.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150414645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150414645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Victory Run<sup>TM</sup></span></div>
</div>
