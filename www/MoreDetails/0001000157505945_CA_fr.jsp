...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157505945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jump and roll with Pallurikio, a fast-paced action platformer, easy to pick up, yet challenging to master. While playing a mysterious board game he found with his friends, Rusty is sucked up in a dimensional vortex and finds himself cast into a mystical and wondrous world, where he assumes the aspect of the round and bouncing Pallurikio. Using the Wii Remote controller to point at the screen, make Pallurikio jump and roll, and help him find his way through more than 50 enticing levels, while surviving all kinds of pitfalls and trickeries he might come across when traversing Bakumbala Jungle, the far reaches of Palluro Prime and many other weird settings. Featuring physics simulation, Time Attack mode, collectable cards, and space rockets to boot, Pallurikio is a game on which you won’t want to miss out!</div>
  <div id="image02">
