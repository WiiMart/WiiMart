...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">同名アーケードゲームを元に、ファミコンソフト『魂斗羅』の続編として１９９０年に発売されたアクションシューティングゲームです。謎のエイリアン軍団との死闘から１年が経った西暦２６３４年１２月。死滅したかと思われていたエイリアンは、その後変態を繰り返し、今まさに最後の変貌をとげて究極の生物に進化しようとしていました。極限にまで成長したエイリアンと最強のゲリラ兵「魂斗羅」たちの壮烈な戦いの火蓋が切られます。プレイヤーは、サイドビューまたはトップビュー視点のステージの中を、アクションと射撃を駆使して進んでいきます。途中に出てくるパワーアップアイテムを有効に使いこなして、あびせくる敵の攻撃や、多数の障害、難関を突破し、敵の本拠地を破壊するのが目的です。２人同時プレイにも対応していますので、力をあわせて敵地へと進撃してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014643534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014643534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパー魂斗羅<sup>&reg;</sup></span></div>
</div>
