...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">近未来を舞台にしたレースゲーム。宙に浮かぶ「Ｆ－ＺＥＲＯマシン」を駆使し、９つの惑星都市、１５のサーキットを戦い抜き、グランプリ制覇を目指します。マシンは個性豊かな４種類から選択。宙に浮かぶマシンの滑らかな操作感と爽快な音楽がプレイヤーを近未来の世界へ導きます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A41434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A41434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｆ－ＺＥＲＯ<sup>&reg;</sup></span></div>
</div>
