...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015746494A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">長年、多くのユーザーから愛され続る自然派釣りゲーム。実写のように美しいステージ、美しい風景の中で、川のせせらぎや虫の鳴き声に耳を傾け、自然を満喫しながら、釣りを楽しむことができます。与えられた課題を次々とクリアしていく「チャレンジモード」、自由にのんびりと釣りをして遊ぶ「フリーモード」で、魚と戯れ、ゆったりとした至福のひと時をお過ごしください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015746494A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015746494A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ｆｉｓｈ　Ｅｙｅｓ　Ｃｈａｌｌｅｎｇｅ</span></div>
</div>
