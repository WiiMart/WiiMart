...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157424B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ARKANOID Plus! es una versión actualizada de este juegazo de arcade. Los jugadores deberán dirigir una bola de energía usando la nave VAUS y destruir los bloques de colores. El juego contiene nuevas modalidades y opciones que cambiarán radicalmente tu experiencia de juego. La modalidad Arcade consiste en 61 rondas que se dividen en las versiones de derecha e izquierda con dos tipos de jefes que aparecen en la última ronda. En la modalidad
Versus los jugadores deberán
enfrentarse a un amigo o al
ordenador. El modo Contrarreloj desafiará a los
jugadores a que terminen cierto
número de rondas en un límite
de tiempo. ¡Sumérgete en la
sutil diferencia entre las reglas
por vidas y barreras, en la
gran cantidad de increíbles
objetos y la gran diversión
que tendrás por horas y horas de
juego! <br><br>Textos de pantalla en español.</div>
  <div id="image02">
