...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">『Wii U本体更新 修復プログラム』は一部のWii Uで本体更新やニンテンドーeショップがご利用いただけないエラーを修復します。<BR><BR>Wii用ソフト『ドラゴンクエストⅩ 目覚めし五つの種族 オンライン』のゲームを遊ばれたWii Uで本体更新やニンテンドーeショップへの接続を行う際に、エラー（エラーコード 105-3102）が発生する場合があります。<BR><BR>このエラーが発生する場合は、本プログラムのダウンロード後、Wiiメニューから開始して修復を行ってください。<BR>修復が完了すると、Wii Uメニューの「本体設定」からの本体更新、およびニンテンドーeショップへの接続が可能になります。<BR><BR>今回、Wii U本体内のプログラム修復を行っていただいた場合でも、今後行われるWii Uの本体更新の配信後に、再度同じエラー（エラーコード 105-3102）が発生する可能性があります。同じエラーが発生した場合は、再度この修復プログラムで修復を行ってください。<BR><BR>※2013年4月に予定しております本体更新によって、このエラーは解消されます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100014843594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014843594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Wii U本体更新 修復プログラム</span></div>
</div>
