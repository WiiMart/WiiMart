...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157564250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">BIT.TRIP VOID es la tercera parte de la saga arcade retro BIT.TRIP. 
<br><br>
BIT.TRIP VOID es una exploración sinestésica de ritmo y música, los cuales forman parte de nuestra vida diaria y estado de ánimo. Con un sistema de control nuevo en la serie, pero del todo familiar para los jugadores, el jugador tiene completa libertad para moverse por la pantalla a donde desee, interactuando con la música de maneras nuevas. La jugabilidad clásica sigue ahí, pues el color -y su ausencia- se exploran al máximo.
<br><br>
¡Embárcate en un juego cooperativo de 4 jugadores y piérdete en el compás con un amigo! Intenta sobrevivir a los ataques de los Compases y avanza en tu propio BIT.TRIP.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
