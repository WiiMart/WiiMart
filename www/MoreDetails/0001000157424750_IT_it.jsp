...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157424750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bang Attack è un coloratissimo puzzle game per tutte le età! Bastano pochi minuti di gioco per capire come si gioca. Trova gli oggetti identici e rompili con il tuo piccolo martello. Quando hai ottenuto abbastanza punti, usa il telecomando Wii per colpire con il martello GROSSO! C'è una banana che ti dà fastidio? Spazzala via dallo schermo!
<br><br>
Hai due telecomandi Wii? Sfida un amico per scoprire chi è il vero campione. Per vincere dovrai alternare con i giusti tempi le tattiche e il ritmo di gioco. Usa gli oggetti bonus speciali per ostacolare l'avversario, altrimenti sarà lui a batterti!
<br><br>
Bang Attack include 40 livelli suddivisi in 4 mondi fuori di testa per garantire ore di divertimento esplosivo! L´intera famiglia non vorrà mai smettere di giocarci!</div>
  <div id="image02">
