...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アクションゲーム「ロックマンＸ」シリーズの第二弾。<BR><BR>前作のシグマとの戦いから半年。電子頭脳に支障をきたしたレプリロイド「イレギュラー」は増加の一途を辿り、その逆襲によって一部のイレギュラーハンター組織が壊滅。捕獲されたレプリロイドを解析した結果、体内からイレギュラー化を促す特殊なチップが発見され、そこにはシグマのマークが刻まれていました。<BR>この事件にシグマの残党が絡んでいると確信した主人公「エックス」は、第17部隊を率いイレギュラー製造工場を破壊。しかし、この様子を「カウンターハンター」と名のる者たちが見ていました。彼らは“ある計画”を推し進めるべく、8体の特A級レプリロイドを各地に送り込み、全世界的な反乱を企てます。世界の平和を守る為、エックスは再び戦いの渦中へと巻き込まれていきます。<BR><BR>今作ではステージギミックがさらに充実し、特殊武器を使った隠し要素や、謎解きが多数盛り込まれています。
また、新たなライドマシンとして高速移動が可能になる「チェバル」が登場しました。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A45484A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A45484A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン<sup>&reg;</sup>X2</span></div>
</div>
