...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000158494E45')", "wiiSelectSound()");
...
<p>
Welcome to the world of the PooYoos, the first fun poetic braintrainer for children 3-6 years old. With the PooYoos, a merry band of adorable baby animals, children will have fun while learning the basics for his or her development: numbers, letters, lateralization, shapes, colors and more. Children get to dance with their new friends and are offered lovely interactive rewards. There are two levels of interactivity, so children can play whatever their age and level. This game has been designed for use by children who have not yet grasped reading.
<p>
