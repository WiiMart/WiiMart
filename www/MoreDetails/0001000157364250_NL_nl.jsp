...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('0001000157364250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De kwaadaardige Cannoids hebben alle lege blikken op aarde in hun macht, met het idee de planeet te vernietigen! Speel als Mack, de toptechnicus van Plant 530, en red de wereld van een ecologische ramp met behulp van je vertrouwde kringloopkanon!
<br><br>
In dit eerstepersoonsschietspel op rails is elk schot van belang, want je munitie dient ook als je levensenergie. Elke vijand die je vernietigt laat blikkenenergie achter, die je moet opzuigen om het gevecht voort te kunnen zetten.
<br><br>
Dankzij de eenvoudige besturing met de Wii-afstandsbediening (inclusief de optie om de Wii Zapper te gebruiken) kan iedereen de rol van Eco Shooter op zich nemen. Gevorderde spelers kunnen proberen de hoogste score te behalen met het combosysteem door treffers aaneen te schakelen voor extra punten. Stel al je vaardigheden op de proef om de aarde voor eens en voor altijd veilig te stellen in de pittige Challenge-stand.
<br><br>
Ben jij goed genoeg om een deuk te maken in het plan van de Cannoids?
<br><br>
Het spel bevat Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157364250/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157364250/FFFD0008" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
