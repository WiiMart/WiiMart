...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El archiconocido simulador que convierte al jugador en alcalde para que gestione una incipiente ciudad y la transforme en una gran metrópoli. Esta versión, coproducida por Maxis y Nintendo, se considera la mejor adaptación del juego. Fue originalmente publicada solo para Super Nintendo e incluye varias características propias. El aspecto de la población gestionada cambia con la estación del año y algunos conocidos personajes de Nintendo hacen apariciones estelares ante los ojos de los hábiles administradores que sean capaces de alcanzar ciertos niveles. Además, la versión posee misiones extra en el modo SCENARIO. SimCity™ se recuerda con cariño por ofrecer una de las mejores bandas sonoras jamás escuchadas en Super Nintendo.
<br><br>Textos de pantalla en inglés.<br>Compatible con la exploración entrelazada del cable por componentes de Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414650/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414650/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">SimCity<sup>TM</sup></span></div>
</div>
