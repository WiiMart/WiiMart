...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158494345')", "wiiSelectSound()");
...
<p>
Encarnas a los dioses más fabulosos de cuatro grandes mitologías: nórdica, egipcia, romana y japonesa. En calidad de dios, tienes que impedir a los humanos que tomen tu plaza. ¡Dichos insolentes se han metido en la cabeza construir una torre para medirse contigo! Así que utiliza tus numerosos poderes para impedírselo. Sin embargo, ¡ten cuidado y no los hieras porque necesitas que los hombres crean en ti! 
<p>
- 60 niveles para la campaña de un solo jugador<br>
- 16 dioses jugables con poderes específicos<br>
- 4 mitologías distintas que descubrir<br>
- 4 jefes histéricos que vencer<br>
- 16 trofeos especiales para los jugadores expertos<br>
- 1 modo especial de 2 jugadores con pantalla compartida
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158494345/FFFD000B" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158494345/FFFD000C" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
