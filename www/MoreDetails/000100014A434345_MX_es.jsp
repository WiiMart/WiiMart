...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El malvado King Dedede ha vuelto a hacerlo: ¡ha robado toda la fruta en Dream Land! Ahora depende de Kirby para recuperarla y evitar que el planeta Pop Star sea conquistado. En esta aventura del héroe rosa, la cual puede considerarse como la más diversa hasta el momento, Kirby tendrá a su disposición seis juegos principales y dos minijuegos, llegando al reto final en The Arena. Cada juego dispone de su propia historia y distintos retos de plataformas, además de entornos únicos y una gran variedad de enemigos. Además, si Kirby se traga a un enemigo copiará sus habilidades, recibiendo así la habilidad de realizar distintos ataques. El juego también incluye unos pequeños toques de estrategia, ya que Kirby puede deshacerse de una habilidad que haya conseguido y utilizarla para convertir a un enemigo en un aliado. El aliado seguirá a Kirby y peleará a su lado automáticamente, o permitirá que un segundo jugador lo controle y se una al juego. ¡Kirby no tendrá un momento de descanso! Deberá correr, volar y tragarse a los enemigos en esta batalla contra King Dedede, Dyna Blade, Meta Knight ¡y muchos más!</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A434345/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A434345/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Kirby Super Star<sup>TM</sup></span></div>
</div>
