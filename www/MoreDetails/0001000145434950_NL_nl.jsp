...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Metal Slug 4 is het vijfde deel van de Metal Slug serie. Kies uit vier verschillende huurlingen en bestrijd de terroristengroep “Amadesu”. Spring en schiet je behendig een weg door de vijanden heen en pak voorwerpen op om je wapens te hervullen. Net zoals in de vorige delen, kun je voertuigen besturen en keihard vechten tegen vijanden. Metal Slug 4 introduceert daarnaast het compleet nieuwe “Metallish Systeem” – een interessant bonus scoresysteem welke het spel een nieuwe wending geeft. Ook zijn er nieuwe voorwerpen en personages waardoor Metal Slug compleet vernieuwd aandoet.<br><br>De software is voorzien van Engelse schermteksten.</div>
  <div id="image02">
