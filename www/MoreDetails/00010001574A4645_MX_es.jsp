...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574A4645')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bienvenido al mundo de Gnomz. Gnomz es un nuevo juego "arcade" de lucha para WiiWare. Gnomz permite que hasta cuatro jugadores jueguen entre sí o contra la inteligencia artificial (IA) en tres modos de juego diferentes.
<p>
...
*Capture the Sock (Captura el calcetín), Smash Match (Duelo de apisonadoras) y Socker (Coleccionista de calcetines)...y mucho, muchísimo más
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574A4645/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574A4645/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
