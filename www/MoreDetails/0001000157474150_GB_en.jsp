...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157474150')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Help Becky and Tim get their jobs back so they can return to the Spirit World. Catch the runaway ghosts before it's too late!
<br><br>
Ghost Mania is an original puzzle game for players of all ages that offers a new twist on the falling block genre. Build and expand colour stacks of ghosts and blocks in any direction and in any number!
The game features multiple single and two-player modes — including a relaxed and thoughtful puzzle mode, an arcade mode, and a variety of two player modes such as the Battle and Enduro modes
<br><br>
Help Becky and Tim get their jobs back so they can return to the Spirit World. Catch the runaway ghosts before it's too late!</div>
  <div id="image02">
