...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The sequel to the action RPG, “Neutopia”, which is currently available for download. The story begins with the apparent revival of the evil demon, “Dirth”.<br><br>
This game picks up where the first one left off, with you taking on the role of the main hero’s son. You’ll need to rely on your “magic compass” and gathered information to find entrances to labyrinths and defeat the bosses in them.
Make your way through the field, which can be tricky at times, and find hidden information and items. Move blocks and destroy walls to uncover secret rooms.<br><br>
Like the original, this game has a save function, a fine-tuned difficulty level, and a fast-paced story, making it a true RPG that anyone can enjoy.
Experience improved graphics and controls in this exciting sequel.</div>
  <div id="image02">
