...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015748484A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ヒッチハイクすることに全力を注ぐ体感アクションゲームです。<BR>登場する乗り物は、パトカーやタクシーから飛脚や牛など普通じゃ乗れない物までいっぱい登場します。乗り物に向けてロックオンした後にWiiリモコンを使って、簡単操作でアピールします。<BR>アピールは、キャラクターから指示された動きを真似できれば成功です。<BR>上手に真似出来たらすごろくで遠くに進むことができます。<BR>アピールに成功しながらマップを進み、追いかけてくる肉屋のオヤジから逃げ切りゴールにたどり着ければクリアとなります。<BR>２～４人までみんなで対戦プレイも可能です。さらに対戦時は、相手のアピールやロックオンを応援したり、墨を出したりとあの手この手でみんなでジャマして、盛り上がること間違いなしです。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015748484A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015748484A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Let’s 全力ヒッチハイク!!!!!!!!!</span></div>
</div>
