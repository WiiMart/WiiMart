...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「惑星ラフラ」で繰り広げられる３ＤダンジョンタイプのＳＦロールプレイングゲームです。物語の舞台は人類の文明が古代遺跡の発掘によって高度な発展を遂げた時代。「インペリアル・スカウト（帝国偵察局）」の優秀なパイロットである主人公が、ラフラで暗躍する謎の組織「マース」の調査を開始するところから始まります。プレイヤーは「ＦＷ（ファイティングワーカー）」と呼ばれるロボットに乗り込み、敵ＦＷや「デュエリスト」と呼ばれるライバルたちと戦いながら調査を進めて行きます。また、ＦＷはシティに無事帰還することで、戦果に応じたターゲットポイントが支給され、装備を強化させることが可能。コックピット視点による表現は臨場感たっぷりで、世界観に
マッチしたクールなＢＧＭや滑らかにスクロールするゲーム画面とともに、ストーリーとの一体感をより一層高めてくれます。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015042594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015042594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アウトライブ</span></div>
</div>
