...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157324B50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Spiele Fangen mit deinen Freunden in Partyspielen für mehrere Spieler und kämpfe mit deinem Mii und anderen Charakteren um einen Platz in der Rekordliste! Wähle einen von sechs verschiedenen Einzel- und Mehrspieler-Modi, wie z. B. Speed Catch und teste deine Fähigkeit, einen schnellen Ball zu fangen oder versuche dich in Bomb Catch, einem Party-Ausscheidungsspiel für bis zu vier Spieler. Außerdem steht dir neben deinem Mii eine Auswahl verschiedener Charaktere zur Verfügung, mit denen du weitere beliebte Fangspiele bestreiten kannst. In Let's TAP und Let's CATCH kannst du besondere Features freischalten, sobald du sie erworben hast!<br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324B50/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324B50/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Let's CATCH<sup>TM</sup></span></div>
</div>
