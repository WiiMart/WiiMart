...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Controla al Chef Peter Pepper y esquiva a los alimentos enemigos mientras preparas hamburguesas completas!<p> Cada ingrediente se encuentra en una plataforma distinta por lo que deberás utilizar una serie de escaleras para llegar a todos los ingredientes. Pasa por un ingrediente para que caiga más cerca del plato de abajo. Una vez que las hamburguesas estén listas podrás pasar al siguiente nivel. Usa pizcas de pimienta para detener a Mr. Hot Dog, Mr. Egg y a Mr. Pickle. Además podrás atraerlos sobre o debajo de panes de hamburguesas, lechugas, queso o tomates ¡para escaper de sus garras! Preparar hamburguesas completas será cada vez más difícil a medida que avances a través de las seis pantallas de BurgerTime. <p>¡Esto será un desafío culinario!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146463445/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146463445/FFFD0001" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">BurgerTime<sup>TM</sup></span></div>
</div>
