...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気ＲＰＧ「ファイナルファンタジー」シリーズの３作目です。クリスタルの啓示を受けた４人の少年が、世界の闇をはらい、光を取り戻す冒険へと旅立ちます。はじめて飛空艇を手に入れた時、彼らが見たものとは・・・。本作では、のちのシリーズへと継承されていくジョブチェンジシステムや召喚魔法が初登場。高速飛行型、空海両用可変型、山を越えて飛ぶ大型飛空艇など、多彩な飛空艇も見所のひとつです。ハードスペックの限界にせまった、ファミコン時代最後の「ファイナルファンタジー」です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646464A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646464A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイナルファンタジー <sup>&reg;</sup>III</span></div>
</div>
