...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574B454A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「らくらく禁煙アプリWii」は辛く厳しい禁煙を少しでも“らく”に行うための禁煙支援ツールです。さまざまな禁煙ツールとアドバイスであなたの禁煙生活をサポートします。<BR>搭載された禁煙ツールは３種類。「禁煙カウンター」は次の目標の他に、登録情報をもとに、ガマンできたタバコの本数、節約できた金額、禁煙により伸びた寿命を算出しリアルタイムで表示します。「禁煙日誌」ではタバコを吸いたくなった状況と、体に起きた良い変化を１日１回質問に答える形式で入力、最終目標である禁煙９０日間達成までを記録に残すことができます。そして「禁煙履歴」により過去の喫煙・禁煙の変移の確認と、この先の目標の確認が可能です。<BR>また、東京女子医科大学付属病院「禁煙外来」医師・医学博士である阿部眞弓先生監修による「禁煙カウンセリング」を収録。禁煙外来で長年培われた経験と科学に裏打ちされた禁煙法から、禁煙成功へのコツや心構えなどを全９８項目のボリュームでわかりやすく解説します。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001574B454A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001574B454A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">らくらく禁煙アプリWii</span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">禁煙科の医者が教える７日でやめる方法</span></div>
  </div>
