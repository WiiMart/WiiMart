...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In Pokémon Snap vang je de Pokémon niet met een Poké Ball, maar met je camera! Je speelt Todd, een jonge fotograaf, die professor Oak helpt met zijn onderzoek naar Pokémon door foto’s voor hem te nemen vanuit de ZERO-ONE, een speciaal hiervoor ontwikkeld voertuig.
<br><br>
Bestuur je voertuig over Pokémon Island en maak foto’s van de Pokémon in hun natuurlijke omgeving. Veel Pokémon zijn echter cameraschuw, dus zul je speciale voorwerpen als voedsel of een fluit moeten gebruiken om ze naar buiten te lokken.
<br><br>
Professor Oak beoordeelt je foto’s onder andere op basis van de houding en de grootte van de Pokémon op de foto. Dus trek eropuit en test je fotografisch talent op verschillende Pokémon!
<br><br>
Verder is de Virtual Console-versie van Pokémon Snap aangepast om samen te werken met het Wii-prikbord. Nu kun je dus je favoriete Pokémon-foto’s met je vrienden delen!<br><br>Het spel is voorzien van Engelse schermteksten.<br>De Rumble-functie van het origineel wordt niet ondersteund.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414B50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414B50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
