...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158485A45')", "wiiSelectSound()");
...
<p>
¡Entra al original mundo de Chronos Twins DX para vivir una increíble aventura llena de ideas innovadoras! Gracias a su sistema de juego dual, podrás controlar a Nec en dos escenarios temporales al mismo tiempo. Chronos Twins es una mezcla de acción, juego de plataformas, aventuras y puzles, que retarán tu inteligencia y habilidad.
<p>
Características especiales:<br>
• Explora un mundo desconocido donde descubrirás innumerables secretos.<br>
• 19 niveles plagados de alienígenas y asombrosos jefes finales.<br>
• Juega en dos mundos al mismo tiempo y resuelve retos que serían imposibles de terminar si jugaras en un solo mundo.<br>
• Cambia el pasado al mover objetos y derrotar a las criaturas, ¡el presente se adaptará al pasado en tiempo real!<br>
• Fantásticos gráficos 3D, con efectos tales como partículas, niebla y floración.
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158485A45/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158485A45/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
