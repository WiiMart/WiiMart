...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">空前のブームとなったシューティングゲームの元祖「スペースインベーダー」のＰＣエンジン移植作。１９７８年のゲームセンター登場とともに、白黒やカラー、さらには画面にセロハンを貼ったものなどが生み出されました。本作ではこれらのバリエーションを画面上に再現し、お好みの「スペースインベーダー」であそぶことができます。プレイヤーは降下してくるインベーダーの軍団に対し、砲台を操作してビームで攻撃。敵の攻撃をかわしながら、砲台のある自陣を占領される前にインベーダーを全滅させるとステージクリアとなります。交互にあそぶ２人プレイのほかに、２人同時にあそべる「対戦モード」を搭載。先に全てのインベーダーを撃ち落とすシンプルなルールながら、相手の邪魔をするなど、対戦ならではの駆け引きも楽しむことができます。また、ＰＣエンジン版のオリジナル要素として、さまざまなイラストを背景にプレイする「おまけ」モードも用意されています。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141354A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141354A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スペースインベーダー<sup>&reg;</sup></span></div>
</div>
