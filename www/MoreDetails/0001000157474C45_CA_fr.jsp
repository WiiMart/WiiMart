...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157474C45')", "wiiSelectSound()");
...
<p>
The goal of the game is to distribute the anti-virus solution to the cells visible under the microscope before they become infected by deadly virus. Drag the solution from healthy cells to infected cells to kill them and/or prevent the healthy cells from becoming infected by the bad virus.</div>
  <div id="image02">
