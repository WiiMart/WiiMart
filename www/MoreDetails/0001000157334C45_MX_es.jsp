...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157334C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Malas noticias, detective! ¡Alguien le dio un mordisco a la Gran Manzana! La Estatua de la Libertad ha desaparecido y no creemos que se haya ido de paseo. The Chief (el Jefe) quiere a lo mejor de ACME en este caso. ¡Así que prepara tus herramientas y ve en rumbo a Nueva York!
<p>
Carmen Sandiego y V.I.L.E. han vuelto y solo tú puedes desbaratar sus planes. Viaja por el mundo, resuelve complicados acertijos matemáticos y atrapa al villano responsable del robo de Lady Libertad. Resuelve el caso "Lady Liberty Larceny" en el Story Mode (Modo de historia) para un jugador. Perfecciona tus habilidades matemáticas en el Practice Mode (Modo de práctica) para un jugador. Desafía a familiares y amigos a resolver acertijos contra reloj en Multiplayer Mode (Modo multijugador). Con Carmen Sandiego: Adventures in Math, tu destreza matemática será la mejor arma para luchar contra el crimen. Ideal para niños de 10-11 años. Los acertijos incluyen aritmética, lógica, fracciones ¡y mucho más!
<p>
(Contenido del juego disponible solamente en inglés.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157334C45/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157334C45/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">The Lady Liberty Larceny</span></div>
  </div>
