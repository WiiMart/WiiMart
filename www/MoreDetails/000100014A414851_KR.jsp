...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">1987년에 아케이드 게임으로 처음 등장한 이래, 참신한 시스템과 독특한 세계관으로 일세를 풍미했던 「R-TYPE」시리즈. 그 정통 시리즈의 속편으로 1993년 슈퍼 패미컴으로 발매된 것이 바로 「R-TYPEⅢ」입니다. 이 게임의 목적은 3종류의 포스와 9종류의 레이저, 메가 파동포, 파동포의 연사를 가능하게 해 주는 하이퍼 드라이브 모드를 구사하여, 지구를 침략한 이형의 공격형 생명체 「베이드」로부터 지구를 지키는 것입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A414851/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A414851/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">R-TYPE<sup>TM</sup> Ⅲ</span></div>
</div>
