...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気ステルスアクションゲーム「メタルギア」シリーズ第二弾。核の脅威から解放されたかにみえた世界でしたが、ソ連、中国、中近東に隣接する小国「ザンジバーランド」で新たな軍事政権が樹立、核の脅威が再び世界を襲います。ザンジバーランドの野望を阻止し世界を守るべく
特殊部隊隊員「ソリッド・スネーク」に再び極秘任務が下されます。
映画を彷彿させる重厚なストーリーと、前作より格段に増えた魅力的な登場人物達によって、より一層ゲームが盛り上がります。また後のシリーズの礎となる匍匐（ほふく）前進移動のアクションや、敵の動きを表示する「動体反応レーダー」が登場し、より洗練されたゲーム性が実現されました。 <BR><BR>詳細は、<Center>http://www.vc-msx.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015841504A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015841504A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">メタルギア２</span></div>
</div>
