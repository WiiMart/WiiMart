...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157545845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Las cartas están barajadas, las apuestas están adentro, y es tu turno. Apuesta, aumenta o presume tu camino a jugarlo todo con el Torneo de Texas Hold’em. Mejora tus habilidades en póker jugando contra cinco oponentes en la computadora o usando el servicio de Conexión Wi-Fi de Nintendo. Empieza escalando los niveles alrededor del mundo ganando torneos en línea e incluso ve como tus habilidades de póker se van mejorando en contra del mundo viendo la tabla de líderes. El Torneo de Texas Hold’em te permitirá jugar con múltiples de amigos hasta con cinco amigos con completo soporte de Mii™. Realmente te puedes traer a la mesa. Empieza en los pequeños cuartos de juego de Nevada y ábrete camino hasta los campeonatos de Las Vegas. Juega con múltiples de rondas y no habrá límites. Hay momentos de seria acción de póker, ¡esperándote!</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157545845/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157545845/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Texas Hold'em Tournament</span></div>
</div>
