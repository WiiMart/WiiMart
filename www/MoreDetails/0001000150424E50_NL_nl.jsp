...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Ninja Spirit is een zijwaarts scrollend actiespel dat de gamewereld imponeerde met zijn geavanceerde graphics en uitstekende gameplay. Je speelt een ninja, Moonlight, die in een hevige strijd verwikkeld is om zijn vaders dood te wreken en de waarheid rond zijn geboorte te onthullen.
<br><br>
Kies uit de originele ARCADE MODE en de PC-ENGINE MODE, die een levensmeter heeft. Maak gebruik van vier soorten wapens – samoeraizwaarden, werpsterren, bommen en kettingwapens – om je een weg te banen door de vijanden. Vind bonusvoorwerpen en wissel van wapen om de bovenhand te krijgen. Om alle 7 levels te doorlopen moet je behendig gebruik maken van de mogelijkheden van je wapens en rekening houden met vijandelijke aanvallen.
<br><br>
Gebruik je vaardigheden en aanvallen om de vele vijanden en valkuilen te trotseren. Dat is pas echte ninja-actie!
<br><br>Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.<br><br>Het spel is voorzien van Engelse schermteksten.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424E50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424E50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Ninja Spirit</span></div>
</div>
