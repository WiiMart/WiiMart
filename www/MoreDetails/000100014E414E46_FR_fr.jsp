...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Mettez vos compétences tactiques et vos capacités de réflexion à l'épreuve en affrontant les meilleurs Dresseurs du Village Puzzle! Soyez le plus rapide et agile à faire disparaître des pièces de puzzle en alignant des blocs de même couleur. Plus vous faites disparaître de pièces de puzzle en même temps, plus vous gagnez de points.
<br><br>
Réalisez d'énormes combos ou des réactions en chaîne pour envoyer de puissantes attaques sur votre adversaire (soit l'ordinateur, soit un ami). Gagnez les badges des Dresseurs que vous affrontez pour devenir le maître Puzzle Pokémon!
<br><br>
Outre les combats, d'autres défis vous attendent, tels que le mode Puzzle 3D ou les exercices de réflexion de l'Université Puzzle. Etes-vous prêt à participer à des combats Pokémon d'un nouveau genre?
<br><br>Texte écran en français.<br>La fonction vibration d’origine n’est pas disponible.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014E414E46/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014E414E46/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
