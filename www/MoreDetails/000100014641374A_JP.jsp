...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">上から落ちてくるキャラクターをキャッチして、同じキャラを重ねて消していくパズルゲーム。落ちてくる卵の殻の上に、クリボーやテレサといったマリオシリーズでおなじみのキャラクターたちをのせ、最後に卵の殻を乗せて消すという単純なルールで、タマゴの殻に敵をはさむとヨッシーが生まれます。「うえたまご」「したたまご」２種類の卵の殻をうまく使うことが高得点や対戦モードで敵を攻撃する時のコツ。ヨッシーがはじめて主役となったソフトです。

<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641374A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641374A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ヨッシーのたまご<sup>TM</sup></span></div>
</div>
