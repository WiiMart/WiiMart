...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The standard for vertically scrolling shooters, Star Soldier is the original game that spawned all of the titles in the long-running Soldier series. Go inside a floating space station inhabited by a giant computer known as Starbrain. Your mission: to stop Starbrain's galactic invasion by piloting Caesar, a new, compact space fighter through 16 deadly stages. Collect power capsules to increase three different attributes of your ship: firepower, movement speed, and defensive shields. Blast wave after wave of approaching enemies or use the innovative Trap Zone feature to fly beneath a land mass and avoid incoming fire. Conquer each stage to make your way to the final confrontation with Starbrain!</div>
  <div id="image02">
