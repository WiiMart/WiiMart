...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157424750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bang Attack est un jeu d’énigmes amusant et coloré pour les enfants comme pour les moins jeunes ! Pas besoin d’apprendre à jouer à Bang Attack, vous comprendrez le principe au fur et à mesure. Trouvez des objets identiques et écrasez-les avec votre petit marteau. Dès que vous avez assez de points, vous pouvez utiliser votre télécommande Wii™ pour brandir le GROS marteau. Une banane vous gêne ? Chassez-la de l’écran d’un coup de marteau !
<br><br>
Vous avez deux télécommandes Wii ? Affrontez-vous en duel pour savoir qui est le vrai champion. Mais personne ne devient champion en un clin d’œil : vous devrez faire preuve tantôt de sens tactique, tantôt de rapidité, au moment opportun. Utilisez les objets bonus spéciaux pour entraver la progression de votre adversaire, c’est le seul moyen de remporter la partie !
<br><br>
Bang Attack est un jeu que toute la famille appréciera !<br><br>Texte écran en français.</div>
  <div id="image02">
