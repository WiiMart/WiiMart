...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sonic The Hedgehog fue el primer juego de Sonic para SEGA MASTER SYSTEM. Aunque estaba basado en la versión original para SEGA MEGA DRIVE, incluía zonas nuevas, enemigos finales y un mapa de niveles orientativo. Otra diferencia que quizá recuerdes es que las Chaos Emeralds no se recogían en las zonas especiales, sino en algunas de las normales.
<br><br>
Prepárate para recorrer las 6 zonas exclusivas de esta versión para SEGA MASTER SYSTEM (incluidas las especiales) y enfrentarte al Dr. Eggman (también conocido como Dr. Robotnik) al final de cada una.<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
