...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A classic 2-player scrolling beat ‘em up is back on Virtual Console!
<p>
People are going missing in Bayside City and the rumors say someone conducting a shady human cloning experiment is responsible. For Rick (a.k.a. Hack) and Doug (a.k.a. Slash) this situation has become personal: three of their friends from their martial arts gym have been abducted. The duo set off to the enemy's secret air fortress to sort this out. These guys know all the moves, from martial arts to pro wrestling throws, and they don't hesitate to use them. They’re not afraid of using knives, bats, and other things they find to get the job done. And if that wasn’t enough, when they get hurt they get angry—and you really don’t want to mess with them then. They ignore damage and hit even harder than usual! They’re ready for the action. The question is: are you?</div>
  <div id="image02">
