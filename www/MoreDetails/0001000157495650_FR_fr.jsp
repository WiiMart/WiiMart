...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157495650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les Space Invaders sont de retour... et ils veulent leur revanche !<br><br>

Prenez les commandes d'un OVNI et vengez-vous des terriens ! Envoyez votre flotte d'envahisseurs héroïques balayer leurs ridicules tanks, avions de chasse et pièces d'artillerie !<br><br>

Battez vos records grâce aux 5 types d'attaque des envahisseurs et à la puissance de votre vaisseau-mère, puis publiez vos scores via la connexion Wi-Fi Nintendo pour voir votre position au classement général !<br><br>Texte écran en français.</div>
  <div id="image02">
