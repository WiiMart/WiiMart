...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157464650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Jouez au minigolf avec vos amis dans de magnifiques environnements.
<br><br>
Choisissez un personnage et transformez votre télécommande Wii en club de golf. Grâce à sa prise en main aisée, vous n'avez plus qu'à viser et swinguer pour savoir qui sera le meilleur golfeur. Des USA à l'Europe en passant par l'Asie, 27 trous vous attendent dans des environnements plus incroyables les uns que les autres. Tentez de décrochez l'or dans le mode 1 joueur ou bien invitez vos amis.
<br><br>
FUN! FUN! Minigolf peut se jouer jusqu'à 4 joueurs. Vous pouvez utiliser de 1 à 4 télécommandes Wii.
<br><br>
FUN! FUN! Minigolf, c'est le party-game idéal pour toute la famille !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157464650/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157464650/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">FUN! FUN! Minigolf</span></div>
</div>
