...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('00010001574D5A50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Amusez-vous sur le plus vieux jeu de tuiles, avec ses 30 motifs traditionnels en 3 dimensions et ses millions de combinaisons ! 
<br><br>
Le style et l'interface du Mahjong ont été conçus pour interagir agréablement avec la télécommande Wii, et permettre de zoomer en jeu à l'aide des boutons. Vous pourrez également personnaliser les graphismes grâce à six présentations et un grand choix d'arrière-plans.
<br><br>
Installez-vous confortablement, détendez-vous et savourez les défis que vous propose cette collection de jeux de Mahjong. Les plus courageux pourront aiguiser davantage leur finesse d'esprit avec les mini-jeux "Mémoire" et "Paires" inclus.<br><br>Texte écran en français.</div>
  <div id="image02">
