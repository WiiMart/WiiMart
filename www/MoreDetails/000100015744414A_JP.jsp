...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015744414A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ＤＡＲＴＳ Ｗｉｉ」は、みんなで手軽にダーツを楽しむことができるゲームです。Wiiリモコンの特性を活かした実際のダーツの投げ方に近い操作で、リアルなダーツ感覚を体験できます。ゲームのルールは、実際のダーツでよく遊ばれている代表的な「０１（ゼロワン）」「ＣＲＩＣＫＥＴ（クリケット）」「ＣＯＵＮＴ－ＵＰ（カウントアップ）」の３つを用意。さらに、「ＰＲＡＣＴＩＣＥ（プラクティス）」モードを搭載し、ダーツの練習をすることもできます。各ゲームは1人～4人まで遊べます。<BR>ダーツは、的に向けて矢を投げて得点を競うという、シンプルが故に奥が深いゲーム。「ＤＡＲＴＳ Ｗｉｉ」でダーツの世界を体感してください。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015744414A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015744414A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ＤＡＲＴＳ Ｗｉｉ</span></div>
</div>
