...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Fantasyland è stata conquistata da forze distruttive e l'aiuto arriva dallo spazio profondo con Space Harrier. Dotato di un'arma a raggio laser, Space Harrier sconfiggerà i nemici in dodici emozionanti livelli, ognuno dei quali caratterizzato da un pericolo boss.
<br><br>
