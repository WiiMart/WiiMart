...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「ドラゴンクエスト」の堀井雄二氏、「ドラゴンボール」の鳥山明氏、「ファイナルファンタジー」の開発スタッフから生まれたスーパーファミコンの名作ＲＰＧ。「現代」「中世」「未来」「原始」「古代」と、あらゆる時代を駆け巡りながら壮大なストーリーが展開します。また本作では「シームレスバトル」を採用しており、マップに表示されている敵に見つかったり、ぶつかったりすると戦闘が開始され、画面を切り替えることなくそのまま戦闘に突入します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A45434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A45434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">クロノ・トリガ―<sup>&reg;</sup></span></div>
</div>
