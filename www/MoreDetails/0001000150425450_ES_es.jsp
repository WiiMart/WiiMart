...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">China Warrior es un juego de acción de desplazamiento horizontal que se lanzó en las mismas fechas que la consola PC Engine (Turbografx) en Japón. Todo depende de que el maestro de kung-fu Wang derrote al Emperador Oscuro, que es el líder del kung-fu en China. Elimina a los enemigos que se interponen en tu camino con puñetazos y patadas.<br>
Ábrete paso con destreza por las 4 pantallas. ¡Asegúrate de recoger los objetos de recuperación mientras esquivas los ataques enemigos!<br>
China Warrior superaba el tamaño de los personajes y los detalles de otros juegos contemporáneos.<br>
¡Las peleas uno contra uno contra los jefes del juego te emocionarán tanto que parecerá que estás en medio de una película de kung-fu!
