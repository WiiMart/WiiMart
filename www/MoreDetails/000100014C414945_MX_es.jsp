...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Enduro Racer está basado en el conocido juego arcade de SEGA y fue rediseñado para la consola SEGA Master System. Este título te lleva a través de una serie intensa de circuitos hechos para acelerar tu adrenalina con sus terrenos abruptos y variados, los cuales pondrán a prueba tus habilidades y reflejos al límite. Conduce tan rápido como puedas para rebasar cuantos autos y motos encuentres mientras esquivas los obstáculos y trampas que hay en el camino. Salta por las rampas e intenta mantener tu velocidad al máximo, pero asegúrate de no perder de vista el estado de tu moto, ¡o estallará en el momento menos esperado! ¿Estás preparado para el desafío?</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414945/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414945/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
