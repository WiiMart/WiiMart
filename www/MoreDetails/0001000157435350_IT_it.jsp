...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157435350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prendi il tuo telecomando Wii e fai un tiro in questo gioco del biliardo virtuale! Divertiti a fare "partite", giocando ai classici: "Snooker", "Palla 9", "Palla 8", "Rotazione", e destreggiati in tiri ad effetto nella modalità "Puzzle".<br><br>
Questo gioco ti offre due tipi di controlli: ti permette di "colpire" virtualmente il pallino col tuo telecomando Wii, oppure di utilizzare i pulsanti per regolare la potenza del tuo tiro ed infine "colpire".
Affina le tue abilità nella modalità "Allenamento" ed impara tutte le tecniche necessarie per diventare un vero giocatore professionista.<br><br>
Usa la funzione "Modifica" per creare la tua sfida personale e realizza il tiro ad effetto che hai sempre desiderato fare. Sorprendi tutti con un tiro straordinario e mostra chi è il vero fuoriclasse!<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157435350/FFFD0013" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157435350/FFFD0014" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">CueSports - </span></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Snooker vs Billiards</span></div>
  </div>
