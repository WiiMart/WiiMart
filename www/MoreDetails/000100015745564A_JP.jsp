...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015745564A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">かわいいDNAを操作して、凶暴なウイルスから、いかにうまく逃げ続けるか？よけて、助けて、ジャンプして、たまには反撃したりして、とろこせましと暴れ回ります。DNA仲間を助ければ、どんどん連なってどんどん得点がアップします。モード：ノーマル を皮切りに、モード：ラジオコントロール、モード：ホード、モード：ズームイチニッパ、モード：シューターと、奥が深い5つのモードを搭載しています。それぞれのモードごとに違った感覚でプレイ出来て、幅の広い遊びを提供します。<BR>ワールドランキングを搭載しているので、インターネットに接続（無料）すれば、世界中のみんなとハイスコア等を競う事が出来ます。<BR>プロフィールデータを4つまで作成出来るので、ご家族みんなで楽しめます。それぞれのプロフィールには戦歴があり、やり込み要素も十分です。プロフィールセレクトでは、それぞれのワールドランキング順位が表示されるので、ご家族のランキングが一目で解ります。<BR>誰にでも出来る、超簡単操作です。Wiiリモコン+ヌンチャクで遊べます。片手でヌンチャクだけでも遊べるプレイスタイルです。それ以外に、クラシックコントローラ及び、ゲームキューブコントローラにも対応しています。遊びやすいスタイルで、ハイスコアに挑めます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015745564A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015745564A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ｐｅａｋｖｏｘ　ｅｓｃａｐｅ　ｖｉｒｕｓ</span></div>
</div>
