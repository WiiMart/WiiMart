...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574E3945')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">The Military is back for a new generation of recruits! The classic turn-based strategy series Military Madness, a.k.a. Nectaris, is exploding onto the WiiWare service. With an all-new graphical barrage, an all-new commander unit, online team and vs. multiplayer modes, and a platoon of other new features, this is the maddest game in the series yet! 
<p />
• 4-Person Online Multiplayer: Coordinate strategies or taunt foes in team or vs. multiplayer modes for up to 4 people.<br />
• An all-new unit - Commanders: Choose a commander to lead your forces in multiplayer and choose from 20 unique abilities.<br />
• Multiple command views: Plan out strategy in the overhead map view and watch glorious battles unfold with cinematic camera action.<br />
• Detailed stat-tracking leaderboards: Increase your rank as you march up the leaderboards on your mission to prove you’re the top general around!</div>
  <div id="image02">
