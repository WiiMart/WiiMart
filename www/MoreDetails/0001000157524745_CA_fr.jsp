...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157524745')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Rage of the Gladiator is a fantasy-based fighting game where you must fight for your life in the arena.  Prove yourself by conquering all opponents!

Features include:
<li> One of the most gorgeous WiiWare games ever!  Amazing 3D graphics, animation, lighting, shadows, and special effects.
<li> Full voice acting.  Each boss has its own personality, and taunts you mercilessly!
<li> Insane finishing moves.  Summon a fiery meteor, a savage tornado, or transform into a hulking colossus 10x your size!
<li> Customize your character.  Specialize in skill trees -- Offense, Defense, or Magic -- to gain new powers!
<li> Compelling Storyline.  You'll want to complete the game to hear the story's conclusion!
<li> Epic music.  Enjoy masterpieces of blood-pumping music by legendary composer Sean Beeson!
<li> Great replay value.  Beat the game to unlock Challenge Mode, where bosses are much tougher with all-new abilities!
<li> Also supports the Wii MotionPlus™ accessory!</div>
  <div id="image02">
