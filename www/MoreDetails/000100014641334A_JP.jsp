...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードゲームとして登場し、ファミリーコンピュータに移植されたシューティングゲームです。プレイヤーは地上形態（ロボット）と空中形態（戦闘機）の２種類の変形が可能な、形態可変戦闘メカ「イクスペル」を操作し、迫り来るザナック軍に立ち向かいます。攻撃には速射可能なパルスレーザーと、一定時間攻撃ボタンを押しつづけること（ため撃ち）で発射できる、高威力のビッグバンが用意されています。ボスキャラなど、ビッグバンでしか破壊できない敵も存在するため、武器の使い分けが重要です。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">フォーメーションZ<sup>&reg;</sup></span></div>
</div>
