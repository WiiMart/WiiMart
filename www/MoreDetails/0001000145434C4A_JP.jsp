...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９６年にリリースされた競馬ゲームの第２弾。前作から４頭増えた１２頭の新馬の中から１頭を選んで、３歳から５歳まで様々なレースに挑戦しながらG１レースで勝利を目指します。ゲームは方向キーで馬を操作し、手綱や鞭で加速するという単純な操作で白熱した競馬レースが楽しめます。脚質によって仕掛けるポイントが変わる仕掛けシステムや、レース中にコマンドを入力することで発動する特殊技でレースを有利に進められますが、中には使用することで審議が発生する技も。入賞賞金で購入できるアイテムやレース展開を読み取れる馬顔メーターなど、今回もゲームらしい要素が多数盛り込まれています。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145434C4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145434C4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ステークスウィナー2</span></div>
</div>
