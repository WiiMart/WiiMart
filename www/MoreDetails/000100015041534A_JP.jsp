...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">２人同時プレイが楽しめるアクションロールプレイングゲームです。突如現れた悪魔「バーログ」の侵攻により、平和な王国が恐怖につつまれました。ついには王国の平和の象徴「サラサ姫」がさらわれ、人々は希望を失ってしまいます。ゲームは国王よりサラサ姫救出の命を受けるところからスタートします。プレイヤーは国王のもとに集った４人の勇者、「戦士」「魔法使い」「僧侶」「忍者」からひとりを選び、城を出発します。勇者たちは高い攻撃力や強力な魔法など、それぞれ異なる特性を持っていますので、自分のプレイスタイルに合ったキャラクターを選んでください。旅の途中で出会う人々と会話して情報やヒントを集め、モンスターの巣くう洞窟を進みます。敵を倒してレベルを上げ、装備を強化しながらバーログの城をめざし、サラサ姫を救出してください。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015041534A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015041534A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">CADASH<sup>&reg;</sup></span></div>
</div>
