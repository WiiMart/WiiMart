...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157485050')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Pon tu pulso a cien con un juego de strip-póquer contra una selección de seis chicas de estilo manga.
<br>
Elige entre el clásico póquer Texas Hold'em para subir la emoción a medida que suben las apuestas, o prueba el Blackjack, una mezcla de suerte y estrategia. Descubre la personalidad de cada chica: ¡se marcarán un buen farol contigo!
<br>
Entra en la galería de fotos para ver las imágenes de las chicas que has desbloqueado jugando. Si eres suficientemente bueno, Emi, Sakura y sus seductoras amigas apostarán su ropa para seguir jugando: ¡desnúdalas!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157485050/FFFD000A" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157485050/FFFD000B" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
