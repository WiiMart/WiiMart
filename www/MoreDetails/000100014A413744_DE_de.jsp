...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ActRaiser, ein Meisterwerk gelungenen Spieldesigns, wurde ursprünglich in den Anfangstagen des Super Nintendo Entertainment System veröffentlicht. Seine anhaltende Popularität zog dieses Spiel aus der revolutionären Kombination von Action- und Simulationselementen. Der Spieler übernimmt die Rolle einer entthronten Gottheit, deren idyllische Welt jetzt von dem finsteren Dämonen Tanzra beherrscht wird. Seiner göttlichen Kraft beraubt, muss der Spieler die Herrschaft des Dämonen brechen und sein verwüstetes Reich wieder aufbauen.
<br><br>
Dieses Spiel verfügt über zwei unterschiedliche Modi: Aktion und Simulation. Im Modus "Aktion" kämpft die Gottheit gegen übermächtige Gegner, um den Frieden in sechs Welten zurückzubringen. Sobald eine Welt befriedet ist, wird der Simulationsmodus freigeschaltet. In diesem Modus kontrolliert die Gottheit Entwicklung und Besiedlung des Gebiets, das sie erobert hat. Dadurch versammelt sie Anhänger um sich, die Schritt für Schritt ihre göttliche Macht wiederherstellen und so den ultimativen Sieg über den Dämonen Tanzra ermöglichen.
<br><br>Unterstützt den Interlace-Modus mit dem Wii-Komponenten-Video-Kabel.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A413744/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A413744/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ActRaiser<sup>&reg;</sup></span></div>
</div>
