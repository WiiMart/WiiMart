...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">縦スクロール型シューティングゲーム『ゼビウス』の世界が３Ｄで表現され、その中を自機「ソルバルウ」のコックピット視点からプレイする、３Ｄシューティングゲーム。迫り来る空中の敵はザッパーで、地上の敵はブラスターで攻撃してください。ザッパーは連射することもできます。ブラスターは、敵に合わせたガンクロス（照準）が赤く光るとロックオンとなり、その状態でボタンを押すと撃つことができます。敵からの攻撃を受けたり障害物にぶつかると、ソルバルウのシールドが減ります。シールドがない状態でダメージを受けるとゲームオーバーです。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014537384A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014537384A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ソルバルウ<sup>&reg;</sup></span></div>
</div>
