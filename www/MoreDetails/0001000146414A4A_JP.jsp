...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">簡単操作で遊べる本格的アイスホッケーゲーム。パワータイプ、スピードタイプといった特徴のある４人を組み合わせてチームを構成。アイスホッケーにつきものの乱闘の演出も盛り込まれ、すべる、ころぶ、乱闘する、エキサイティングな展開が楽しめます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アイスホッケー</span></div>
</div>
