...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157535350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Solitaire features 18 variations of the most well-known and best-loved single-player card game including Klondike, Freecell, Spider, Pyramid and Yukon. Most games have custom gameplay options so you can enjoy the game with your favourite rules. On-screen instructions allow learning of new Solitaire variations.
<br><br>
Statistics are available for players who love to track their wins. Save the game status any time for later or customize the look with a wide variety of backgrounds. The game's style and interface has been designed for easy intuitive operation with the Wii Remote™ controller. 
<br><br>
Sit back and relax... Enjoy the endless challenge and fun with this Solitaire game collection.
<br><br>
Game supports texts in English, German, Spanish, French and Italien.</div>
  <div id="image02">
