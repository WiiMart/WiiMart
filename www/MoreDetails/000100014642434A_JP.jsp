...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">さまざまな障害物のあるオフロードコースを走り、新記録更新に挑むモトクロスレースゲーム。一定時間以上使い続けるとオーバーヒートして数秒間動けなくなってしまうターボの使い方や、遠くまでジャンプしたり着地の時に転倒しないように、うまくバランスを取るためのテクニックを駆使することが攻略のコツ。転倒した時はＡボタンを連打するとライダーが立ち上がり、レースに早く戻ることができます。また、障害物やトラップを自由に配置してオリジナルのコースを作ることが可能なエディットモードも搭載。

<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642434A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642434A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">エキサイトバイク<sup>&reg;</sup></span></div>
</div>
