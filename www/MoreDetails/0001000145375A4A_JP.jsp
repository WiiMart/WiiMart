...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">黄金の騎士「ギル」を操作して、悪魔「ドルアーガ」を倒し、塔の最上階にとらわれた恋人の「カイ」を救出するアクションロールプレイングゲームです。迷路に落ちている鍵を拾い、扉を開けば上の階に進めます。通路をふさぐ敵は剣を使って倒し、敵の放つ呪文は楯で受けて防ぎます。各階に隠された宝を手に入れることで、ギルがパワーアップしたり、ドルアーガの仕掛けた数々の罠に対抗することができます。宝箱の出現方法は、「特定の敵を倒す」「特定の位置に移動する」といったスタンダードなものから、「何もせずにしばらく待つ」「わざと体力を減らす」といった意外なものまでさまざま。取るとマイナス効果のあるアイテムもあり、宝箱とアイテムの情報こそが攻略のカギとなります。<BR><BR>詳細は、<Center>http://www.bandainamcogames.co.jp/
cs/download/virtual_consolearcade/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000145375A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000145375A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
