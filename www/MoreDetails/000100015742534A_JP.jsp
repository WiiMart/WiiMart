...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015742534A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">「Pop ～ ポップ」は泡を消すゲームです。 一見するとシンプルですが、ハイスコアを獲得するため、そして楽しい時間を過ごすための多くの要素が含まれています。同じ色の泡を連続で消したり、泡を膨らませて大爆発を起こしたりして、高得点獲得を目指します。ゲームの途中でも気軽に誰でも参加できて、友達と一緒にプレイを楽しめます。さらに、ユニークなパワーアップアイテムでハイスコアを狙ったり、対戦相手の行動も防ぐこともできます。<BR>「Pop ～ ポップ」には4つのモードが用意されています。Wi-Fiコネクションでランキングを見る事ができて、WiiConnect24でいつでも友達のスコアや自分のスコアを確認することができます。ドンドン楽しんで泡を消し、自分のベストスコアを目指しましょう。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015742534A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015742534A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Pop ～ポップ～</span></div>
</div>
