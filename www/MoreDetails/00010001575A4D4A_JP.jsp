...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001575A4D4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">麻雀ファンにはたまらないうれしい要素がぎっしり詰まった多機能麻雀です。ルールを自由に設定してCPUとの対戦が楽しめる『練習モード』、Mjリーグに参加してバトルを行い、Mjptを稼いでランキング1位を目指す「チャレンジモード」、ニンテンドーDSをコントローラとして使用する『DS連動モード』、フレンド登録したお友達や全国のプレイヤーと対戦を楽しめる『通信対戦モード』など盛りだくさん。麻雀初心者から上級者まで多くの人に楽しんでもらえる内容となっています。</div>
  <div id="image02">
    <img src="/oss/ccs/00010001575A4D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/00010001575A4D4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">@SIMPLEシリーズ　Vol.3</span></div>
</div>
