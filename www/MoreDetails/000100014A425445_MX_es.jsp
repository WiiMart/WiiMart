...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Tu eres Bren McGuire, en una misión de las Fuerzas por la Libertad de los Planetas Unidos para salvar al pacífico planeta de Katakis de la Maquina cual es la fuente de todo lo cruel y malévolo en el universo. La única arma que está de tu lado es el avanzado “Turrican Assault Suit” (“Traje de Ataque Turrican”.) Equipado con múltiples armas, incluyendo el increíble “Freeze-Beam” (“Rayo-Congelador”) e cual temporalmente inmoviliza a casi cualquier enemigo, el Turrican Assault Suit le da a un hombre el poder de un ejercito entero. Usa una multitud de armas y poderes a tu disposición para luchar a través de los 12 descabellados niveles, libra a los inocentes habitantes del planeta Katakis, y aplasta a la agobiante Maquina.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A425445/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A425445/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
