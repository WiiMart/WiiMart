...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158484550')", "wiiSelectSound()");
...
<br><br>
BIT.TRIP BEAT brings retro action back as you use the Wii Remote’s Motion Sensor to bounce beats in this rhythm game. 
<br><br>
Retro visuals, classic gameplay, 4-player multiplayer, and an 8-bit soundtrack will get you in the zone and rock your world. Pay attention, though! Like most classic games, the challenges are mighty. If you can stay cool as the difficulty increases, you’ll discover the beginnings of the BIT.TRIP saga...
 <br><br>
Everything comes from something.
We were before we became. From life comes rhythm, and from rhythm comes life. We are beings of information.
Everything is a conduit for learning.
We communicate in bits and bytes.
And we will return to something once we become nothing. After our BIT.TRIP is complete.</div>
  <div id="image02">
