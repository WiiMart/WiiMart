...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">アーケードで人気を博した２Ｄ対戦格闘ゲーム。基本操作は十字ボタンで移動やガード、３つのボタンで上・中・下段への攻撃、特定のコマンド入力で投げ技やキャラ固有の必殺技を出すことができます。武器を持つキャラは有利に戦えますが、一定の攻撃を受けると武器を落としてしまうため油断は禁物です。世界中から猛者が集い、熾烈な戦いを展開する「世界格闘トーナメント」。武器の使用もＯＫのルール無用の大会で、総勢１０名の個性的なキャラを操り、優勝をめざしてトーナメントを勝ち抜いてください。ＰＣエンジン版での追加要素としてピンチの時に出せる「隠し技」があり、うまく使えば形勢逆転も可能です。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100015141584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015141584A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">マーシャルチャンピオン</span></div>
</div>
