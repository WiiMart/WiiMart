...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">かわいらしいメルヘンの世界で、元気な男の子「ミロン」が大冒険をするアクションゲームです。平和な国ファンタジアにある、人と動物がなかよく暮らすピッコロ村。ある日ミロンは妖精「エリス」から、森から歌声や音楽が消えていると聞かされます。そこに突然、魔人「アモン」が現れ、楽器と妖精エリスを奪い去ってしまいました。ミロンはエリスを助けるために旅立ちます。コミカルで楽しそうな各ステージも、危険な仕掛けがいっぱいで油断は禁物。ミロンが使える武器は「魔法のストロー」だけですが、いろいろなアイテムがミロンの冒険を手助けしてくれます。中でも「楽器」が持つ不思議な力は、とても心強い味方。ボスから楽器を取りかえし「スターオンプ」の力で封印を解くと使えるようになります。仲間たちが教えてくれるヒントを参考に、全７ステージを攻略してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ドレミファンタジー<sup>&reg;</sup></span></div>
</div>
