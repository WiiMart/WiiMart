...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">R-TYPE is een klassiek zijwaartsscrollend schietspel uit de speelhal, ontwikkeld door Irem in 1987. Het spel speelt zich af in de 22e eeuw. Jij, de laatste hoop voor de mensheid, moet het opnemen tegen het kwaadaardige Bydo Empire. Je schip, de R-9a “Arrowhead”, is standaard uitgerust met een laser, maar in elke missie zijn er powerups en upgrades te vinden. 
<br><br>
Baan je een weg door acht uitdagende levels die zelfs de reflexen van de beste gamers op de proef zullen stellen. De versie voor de SEGA MASTER SYSTEM bevat ook een exclusief geheim level, dat niet in andere versies te vinden is.
<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414F50/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414F50/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">R-TYPE<sup>TM</sup></span></div>
</div>
