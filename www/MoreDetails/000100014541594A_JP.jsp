...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９２年にリリースされた怪獣格闘ゲームです。プレイヤーは３種のモンスターから１体を選んで、各地でエイリアンと死闘を演じます。モンスター達はパンチ、キック、ジャンプ攻撃、個性豊かな必殺技を駆使してマップを突き進み、最後に登場するボスを打ち破ればステージクリアーです。なおモンスターはたまに登場するパワーアイテムを取ることで新必殺技を習得できます。ボス戦を有利に進めるためにも、パワーアイテムは取り逃さないように。本作では協力プレイもサポート。友達との協力プレイは、シングルプレイや対戦プレイでは味わえない独特の面白さがありますので、ぜひ体験してください。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541594A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541594A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">キング・オブ・ザ・モンスターズ２</span></div>
</div>
