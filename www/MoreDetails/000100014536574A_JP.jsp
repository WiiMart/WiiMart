...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">魔人討伐のため３人の剣士が世界を冒険する、人気ファンタジーアクションゲームです。戦斧「ゴールデンアックス」を持つ魔人「デス・アダー」によって国を滅ぼされ、愛する肉親を失ったバーバリアンのアックス、アマゾネスのティリス、ドワーフのギリウスの３人は、それぞれ特徴的な剣を手に、協力して戦いの旅を続けます。シリーズ作すべてのオリジナルであり特に人気の高いこのアーケード版は、大男やガイコツなどのさまざまな敵兵士たち、ドラゴンなどプレイヤーが乗ることのできる動物、コミカルなシーフなどおなじみのキャラクターの登場はもちろん、さらにメガドライブ版をはるかにしのぐ多彩なアニメーションパターン、より美しさを追求したグラフィック、豊富な演出など、オリジナル版ならではの迫力をさまざまな場面で体験できます。２人同時プレイも可能で、アーケード版の攻略テクニックをそのまま利用することもできます。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゴールデンアックス<sup>TM</sup></span></div>
</div>
