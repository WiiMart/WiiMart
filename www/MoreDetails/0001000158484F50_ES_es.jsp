...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484F50')", "wiiSelectSound()");
...
<br><br>
¡Coge tu mando de Wii y construye una pila en equilibiro en este divertido juego de puzle!
<br><br>
Pon a prueba tu habilidad e imaginación con las 100 fases de este emocionante juego que te entusiasmará desde la primera partida. Aprender a jugar es fácil, ¡pero te costará  dejar la consola cuando empieces!
<br><br>
Juega solo o invita a un amigo a jugar en cualquier momento a una partida cooperativa con un segundo mando de Wii. Incluso hay un modo "versus" de pantalla partida especial para dos jugadores para aumentar la diversión.<br><br>Textos de pantalla en español.</div>
  <div id="image02">
