...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Devil’s Crush ist die aufregende Fortsetzung des Flipper-Hits Alien Crush und bietet noch flüssigere Kugelbewegungen und erweiterte Spezialeffekte.
<br><br>
Schieß die Kugel auf das Spielfeld mit dem Devil Shooter, dann benutze die Flipper und lass das Feld erzittern, um die Kugel im Spiel zu halten und einen High Score zu erzielen. Willst du die sechs verschiedenen Bonuslevel spielen, musst du bestimmte Voraussetzungen erfüllen.
Löse die Bonuslevel mit einem “Perfect Clear”, um massig Punkte zu erhalten!
<br><br>
Die unheimliche Atmosphäre wird durch die Gegner noch weiter verstärkt – von umherirrenden Skelettrittern, Zauberern und sogar von einem gigantischen Gesicht, welches sich von einer Göttin in das einer Schlange verwandelt!
