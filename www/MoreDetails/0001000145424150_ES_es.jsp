...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Data East publicó este divertido juego de puzle en 1996. Las reglas son sencillas: mueve al payaso para coger pompas y cambiarlas de lugar. Si juntas al menos tres pompas del mismo color en una línea vertical, desaparecerán.
<br><br>
Además, existen pompas que producen distintos efectos: La Pompa Especial, de cuatro colores diferentes, hará que desaparezcan todas las pompas del mismo color. La Pompa Flecha eliminará todas las pompas que se encuentren en la dirección que marque la flecha, la Pompa Espuma no hará más que darte problemas, y la Pompa Irisada hará explotar las pompas que tengan el mismo color de aquella con la que entre en contacto. ¡Aunque no hay duda de que lo más divertido es utilizarlas para conseguir reacciones en cadena que destruyan una pompa tras otra!
<br><br> 
Juega en solitario o enfréntate a los alocados personajes controlados por la consola. ¡Incluso podrás verte las caras con un amigo en ambos modos de juego! ¿Quién decía que explotar pompas no era divertido?
<br><br>
