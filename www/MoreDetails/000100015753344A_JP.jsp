...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753344A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">最強を誇る「銀星」シリーズに麻雀が登場。お求め安い価格でシンプルなつくりですので、どなたでも安心してお楽しみいただけます。個性豊かな６人の対戦者がプレイヤーを待ち受けます。６人それぞれの性格があり、麻雀初心者から上級者まで納得のいくイカサマなしの麻雀を楽しむ事ができます。また、プレイヤーの戦績が詳しく残るため、自分の打ち筋を研究する事も可能です。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753344A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753344A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">最強銀星麻雀</span></div>
</div>
