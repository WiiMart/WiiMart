...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157543345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">El hombre de negocios Hitoshi Susumu está retrasado y lleva mucho apuro.  De hecho, ¡no se detendrá una vez que empiece a correr!  Al pasar corriendo samurais, dinosaurios, vaqueros y toda clase de alocados obstáculos Sr. Susumu debe llegar a su meta tan rápido como pueda para el máximo baile 2D. Tomena Sanner es un juego de acción de alta velocidad de desplazamiento horizontal que presenta un sistema único de control basado en el tiempo que es tan desafiante como lo es de divertido.  Mientras vuelan, saltan y bailan sobre los muchos disparatados obstáculos los jugadores deben cronometrar sus movimientos para mantener su velocidad y ejecutar impresionantes trucos. Usando solo un botón, los jugadores de todas las edades y niveles de habilidad serán capaces de jugar y ayudar al Sr. Susumu a lograr su meta. Cuatro jugadores pueden competir para ver quién es el más rápido en correr a través del bizarro y cómico mundo de Tomena Sanner.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157543345/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157543345/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Tomena Sanner</span></div>
</div>
