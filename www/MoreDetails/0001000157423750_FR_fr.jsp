...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157423750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Voyagez à travers les USA et plongez dans l’atmosphère électrique des tournois de billard.
<br>
Entrez dans les bars les plus hauts en couleur et rencontrez 7 des joueurs les plus cool du circuit. <br>De Travis, la star de la country à Alison, la biologiste, en passant par John, le shérif. <br>Apprenez les meilleurs coups grâce aux tutoriels, et testez votre niveau en relevant les défis lancés par vos adversaires dans le mode Challenge.<br> Mais n’oubliez pas de varier les plaisirs avec les 3 règles de jeu différentes.
<br><br>
Textes en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157423750/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157423750/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Midnight Pool</span></div>
</div>
