...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Préparez-vous à connaître le frisson et les sueurs froides du sport extrême dans 1080°: TenEighty Snowboarding. Ce classique de Nintendo 64 vous propose l'une des simulations de snowboard les plus précises en restant toutefois accessible: et tout cela, bien au chaud.
<br><br>
1080°: TenEighty Snowboarding offre six parcours gigantesques permettant de réaliser plus de 25 figures à couper le souffle. Six modes de jeu sont disponibles parmi lesquels des courses en face à face contre un ami ou la console, des contre-la-montre, des défis acrobatiques et un mode 
entraînement vous permettant 
de vous perfectionner.
<br><br>
Des graphismes en 3D impressionnants (effets de lentille, variations des conditions météorologiques et d'ensoleillement) et une bande son aérienne viennent enrichir un kit parfait pour l'hiver à mettre entre toutes les mains.
<br><br>La langue du texte peut être choisie entre anglais, allemand, japonais et français.<br>La fonction vibration d’origine n’est pas disponible.</div>
  <div id="image02">
