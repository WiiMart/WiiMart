...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Control your Solvalou ship and destroy the Xevious forces! Use zapper missiles against air-based enemies and blaster bombs against ground-based targets. Destroy Andor Genesis to earn bonus points! <br>
Unique enemies, interesting BGM, a variety of vertically scrolling background environments and many hidden gameplay features differentiated Xevious from other shooting games released at the time. Xevious was released on the NES in 1989 and became an instant classic.<br><br>

In a 2-player game, players take turns to control their Solvalou ships. Change players when a ship is lost.<br>
2 controllers are required for a 2-player game.</div>
  <div id="image02">
