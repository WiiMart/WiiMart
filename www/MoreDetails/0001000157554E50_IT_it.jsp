...
function initPage()
{
	...
	setUnderButtonL(true, "Indietro", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manuale di istruzioni", "javascript:showManual('0001000157554E50')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Preparati a dire "UNO" sulla tua console Wii! Il gioco di carte famoso in tutto il mondo arriva sulla tua console Wii, con fantastiche nuove regole. Grazie alla modalità multigiocatore accessibile tramite la tua console Wii, giocare a UNO non è mai stato così semplice e divertente. Scarta tutte le carte per primo!
<br><br>
• Una versione fedelissima del più celebre gioco di carte per tutta la famiglia, con regole alla portata di tutti!<br>
• Personalizza le regole di gioco e scopri nuovi modi di giocare a UNO come “UNO 7-0”, “Contestazione”, “Cavallina” e tanti altri.
<br><br>Il testo all'interno del gioco è in italiano.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157554E50/FFFD0007" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
