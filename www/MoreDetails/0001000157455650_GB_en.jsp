...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157455650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Prepare to be attacked by vicious viruses in this fast-paced action game. In Viral Survival, 
you control a small DNA strand. Collect others around you, forming a tail. You will have to do your 
best to dodge them and fend them off with weapons. Let the battle begin!</div>
  <div id="image02">
