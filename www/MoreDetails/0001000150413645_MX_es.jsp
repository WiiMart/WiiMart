...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Infíltrate en solitario, en lo más profundo del territorio enemigo para rescatar al Presidente secuestrado en este shooter de acción en vista aérea. Ponte en el papel de un comando en un equipo de las Fuerzas Especiales y enfréntate a tus enemigos con un gran arsenal de armas, que incluye ametralladoras y granadas. Consigue información valiosa, armas y objetos rescatando a los prisioneras de guerra. Ábrete paso hasta el final de cada fase y derrota al Jefe utilizando de forma eficaz tus armas y equipamiento.
<p>
Esta conversión del increíblemente popular juego de arcade tiene unos gráficos, historia e intros refinados, haciendo que este juego de acción sea totalmente indispensable. Esta nueva y mejorada versión incluye la nunca antes contada segunda mitad de la historia que no se incluyó en la versión arcade.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000150413645/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150413645/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
