...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157434B4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">●チキンvsチキンの壮絶なお絵かきバトルゲーム！<BR>【チキンバトル！チクチクブーン】はぴょんぴょんとはねるチキンたちを操作し、5vs5で繰り広げるお絵かきバトルゲームです。<BR><BR>自分のアタック順になったときに、お題の絵をＷｉｉリモコンで描くと、アタックを発動することができます。<BR>さらに、絵の完成度が高ければ高いほど攻撃力がＵＰ！逆にアタックを受けた場合はＷｉｉリモコンで特定のカタチを描くことで回避！
たとえば「イナズマ」が落ちてきそうになった場合は「避雷針」を描くことでアタックを回避することができます。<BR><BR>●１５種のチーム、最大４人対戦可能！２０以上の攻撃方法であたふたバトル!<BR>本ゲームは、最大４人対戦可能で、１チームに最大２名配置することが可能。２名が１チームになった際は、１人のプレイヤーが「攻撃」を担当し、もう１人が「防御」を担当します。<BR><BR>アタックの種類は全部で２１種類！<BR>各アタックには、独自の特殊効果があり、対戦の「あたふた度」をさらにＵＰします。そのほか、特殊効果を発揮する「ピニャっち」や、コーンを落としてくれる「モロコシマン」などがバトルをさらににぎやかしてくれます！</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157434B4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157434B4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">チキンバトル！チクチクブーン</span></div>
</div>
