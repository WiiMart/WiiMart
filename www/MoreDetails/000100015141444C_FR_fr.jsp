...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Voici enfin la suite du mythique GRADIUS, le chef-d’œuvre qui a marqué l’histoire du shoot ’em up.<br><br>Deux ans après sa dernière bataille épique, l’armée GRADIUS envoie le vaisseau de combat super dimensionnel Vic Viper combattre l’invasion d’un nouvel ennemi, la redoutable armée Gofer. Pilotant le Vic Viper dernier modèle, vous pouvez sélectionner différents modules d'arme et boucliers pour compléter chaque niveau et repousser les multiples vagues d’assaut de l'ennemi.<br><br>Avec ses 9 niveaux, cette adaptation fidèle de la version originale propose l’une des durées de vie les plus longues de la série ainsi que des thèmes musicaux d’une grande qualité qui vous téléporteront au cœur même de l’action.<br><br>Le texte à l'écran est en anglais, et contient du japonais.</div>
  <div id="image02">
