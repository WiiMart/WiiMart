...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">１９９４年にリリースされた格闘ゲームです。『ファイターズヒストリー』の続編にあたるタイトルで、「グレートグラップル」という格闘大会を舞台に、１３人の格闘家が腕を競います。キャラクターごとにウィークポイントが設定され、そこを攻撃されると気絶する「弱点システム」や、前作でボスキャラだったクラウンやカルノフが使用可能になった他、多彩な隠し必殺技なども用意されています。ある条件を満たせば『空手道』のボーナスステージに登場した「牛」が隠しキャラとして登場します。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014542424A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014542424A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ファイターズヒストリーダイナマイト</span></div>
</div>
