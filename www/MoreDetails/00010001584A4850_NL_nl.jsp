...
function initPage()
{
	...
	setUnderButtonL(true, "Terug", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Handleiding", "javascript:showManual('00010001584A4850')", "wiiSelectSound()");
...
<br><br>
Paint Splash verandert uw TV in een interactief canvas waar kinderen van alle leeftijden kunnen leren schilderen met de Wii Remote. Maximaal vier personen kunnen tegelijk schilderen, dus de hele familie kan deelnemen aan het maken van fantastische schilderijen, enkel en alleen met de Wii Remotes.
<br><br>
Kies een van de verschillende kwasten of hulpmiddelen en schilder in alle kleuren van de regenboog. Of activeer de Splash Modus waarbij u, simpelweg door uw Wii Remote te schudden, verf op het canvas deponeert. Ideaal voor de jongste leden van het gezin.
<br><br>
U kunt uw schilderijen op een SD-geheugenkaart opslaan om uw creaties op andere apparaten te kunnen openen, printen en e-mailen.
<br><br>
