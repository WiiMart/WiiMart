...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('00010001574D4845')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">He’s clever, he’s daring, he’s brave, he’s...a mouse! Mouse House is an accessible and fast-paced logic puzzle game in which you lead a lively little mouse on his hunt to collect the cheese in each of 100 challenging puzzles. But these are no simple mazes – our adorable hero has to weave his way through a cast of colorful critters including stinger-shooting bees and nasty rats, as well as tricky traps like conveyor belts, collapsing floors and more! A true “pick up and play” game, Mouse House’s combination of simple controls and multiple levels of challenge make it perfect for players of all ages!</div>
  <div id="image02">
