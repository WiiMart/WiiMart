...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sengoku 3 è un picchiaduro a scorrimento laterale rilasciato originariamente nel 2001. Seleziona uno dei 4 personaggi principali con cui giocare e parti per un'avventura in giro per il mondo sconfiggendo spiriti malvagi risvegliati dalla luna rossa. Questo capitolo introduce una nuova meccanica di gioco nella serie: la barra ninja (shinobi) che, una volta riempita, ti permette di lanciare svariati attacchi ninja contro i tuoi nemici. Il nuovo sistema, inoltre, ti lascerà combinare attacchi con armi e senz'armi per eseguire combo strategicamente vincenti e elevare il tuo potenziale offensivo. Usa le tue abilità ninja per annientare i tuoi nemici nel capitolo definitivo di questa incredibile serie.<br><br>Testo a schermo in inglese.</div>
  <div id="image02">
