...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157444850')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">En la serie Art Style, exclusiva de WiiWare, encontrarás divertidos juegos con sencillos controles y sorprendentes efectos de imagen y sonido.
<br><br>
Art Style: ROTOHEX es un rápido juego de puzles para uno o dos jugadores. Desplaza los paneles triangulares de colores que caen en el tablero y gíralos para formar hexágonos del mismo color y hacerlos desaparecer. Cuantos más colores haya en el tablero, ¡más difícil será!
<br><br>
Si superas el Solo Mode (Modo Individual), desbloquearás otros modos como el Endless Mode (Modo Continuo), en el que podrás medir tu resistencia, o el Sprint Mode (Modo Carrera), apto solo para expertos. También puedes luchar por la victoria contra un amigo en el VS Mode (Modo Enfrentamiento).
<br><br>
