...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158484B45')", "wiiSelectSound()");
...
<p>
Durante los últimos cinco siglos, cientos de navíos de todas las banderas, han sucumbido al poder del océano. Naves mercantes, barcos pirata, buques de la armada... todos ellos terminaron cubiertos de coral en el fondo de los océanos de todo el planeta. Pero todos ellos guardaban secretos que durante años han estado ocultos. Secretos que siempre habían sido un misterio... hasta ahora.
<p>
En Dive: The Medes Islands Secret encarnas a John Sanders, un cazatesoros y submarinista experimentado que durante meses planifica y documenta una macro expedición para localizar y recuperar varios navíos de diferentes banderas en todo el mundo.
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158484B45/FFFD0005" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000158484B45/FFFD0006" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Dive: The Medes Islands Secret </span></div>
</div>
