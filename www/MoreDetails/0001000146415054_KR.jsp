...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">마리오와 루이지가 등장하는 본격 골프 게임입니다. 클럽을 사용하여 샷을 하고 되도록 적은 타수로 그린의 컵에 공을 넣어 보세요. 그린까지의 거리에 따라 자동적으로 클럽을 선택할 수 있게 되어 있어, 처음 접하는 경우에도 편하게 플레이할 수 있으며 골프에 대해
잘 모르는 사람도 골프 마니아도 함께 즐길 수 있습니다. 울창한 숲에 둘러싸인 홀이나 넓은 호수에 접하는 홀, 벙커투성이 홀 등 다양한 지형의 코스로 구성되어 있으며 각각의 코스에서 적절한 샷을 하는 것이 공략의 관건입니다.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415054/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415054/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">마리오 오픈 골프<sup>TM</sup></span></div>
</div>
