...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ファミリーコンピュータディスクシステム用ソフト「ゼルダの伝説」の続編で、シリーズ唯一の横スクロールで冒険する”ゼルダ”。大魔王ガノンはリンクによって倒されたものの、ガノンの復活を企む手下たちによって、ハイラル王国は荒廃の一途。王国の平和を取り戻すため、大神殿に封印された勇気のトライフォースを開放するべく、再びリンクは冒険の旅に出ます。壮大なストーリーと謎解きの魅力はそのままに、よりアクション性に磨きがかかった冒険が楽しめます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014641394A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014641394A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">リンクの冒険<sup>&reg;</sup></span></div>
</div>
