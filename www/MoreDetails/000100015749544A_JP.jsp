...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015749544A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界中で大人気の「アイテム探しゲーム」がWiiWareで登場。画面にちらばった数百個のアイテムの中から、目的のアイテム12個をいち早く見つけましょう。<BR>大きな魚や小さなイヤリングなどの簡単に見つかるアイテムから、よく探さないと見つからないアイテムまで、画面いっぱいにちらばったアイテム達があなたの「眼力」をビシビシと刺激します。<BR>１人で遊べるのはモチロン、友達同士や家族みんなで競争プレイもできて、盛り上がること間違いなし（最大4人まで可）<BR>世界中を舞台に１０種類のステージ、２００個以上のアイテムが登場する大ボリューム。しかもアイテムはプレイするたびに配置が変わるから、何度プレイしても楽しんでいただけます。ゲームに登場するのは、地球人の幸せを願う４人のかわいい宇宙人たち。<BR>あなたは、その宇宙人の１人となって、世界中にちらばったアイテムを探しましょう。忍者、バレリーナ、海賊、王女のバラエティに富んだ人物が登場します。<BR>みんなでワイワイ新感覚ゲーム。アイテム探しをレッツプレイ。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015749544A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015749544A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ああっ！見つけた！★アイテム探しゲ～ム★</span></div>
</div>
