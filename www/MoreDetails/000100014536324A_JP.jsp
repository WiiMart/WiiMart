...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">美しく幻想的なグラフィックと、３Ｄ視点が生み出す圧倒的なスピード感を特長とし、今もなおファンから高い評価を受けているシューティングゲームです。ドラゴンランドの危機を救うため、超能力戦士「ハリアー」は大空を飛び大地を駆け、邪悪なドラゴンや異生物、巨大ロボットや戦闘機と戦いを繰り広げます。「セガ体感ゲーム」シリーズの第２弾タイトルである本作は、コックピット型の大型マシンと操縦桿（かん）による操作システムが特徴でした。バーチャルコンソールアーケード版では、ヌンチャクを使った操作により、オリジナルと同様の直感的なプレイ感覚で楽しむことができます。Ｗｉｉリモコンやクラシックコントローラによる、従来の家庭用移植バージョンと同様の操作も可能です。<BR><BR>詳細は、<Center>http://vc.sega.jp/ </Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014536324A/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014536324A/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スペースハリアー<sup>TM</sup></span></div>
</div>
