...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('00010001574C3545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">HB Arcade Disc Golf lleva hasta el comedor de tu casa el popular deporte de lanzamiento de disco. Jugar es muy sencillo: tan fácil como lanzar un disco por el aire en un día espléndido.En la pista, los lanzadores disponen de tres tipos de disco diferentes: un driver para tiros largos, un disco de medio alcance y un putter para tiros cortos. Pulsa el botón 1 en el Wii Remote para cambiar el disco actual al siguiente tipo de disco. El objetivo del juego es meter el disco en la cesta con el menor número posible de lanzamientos. Al final de la ronda se calcula la puntuación y gana el jugador que tenga la puntuación más baja.</div>
  <div id="image02">
