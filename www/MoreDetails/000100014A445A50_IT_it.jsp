...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Riscopri un gioiello in cui azione e avventura si fondono al meglio. Vesti i panni di Benjamin e recupera i Cristalli dei quattro elementi per ripristinare l'equilibrio dell’universo! Vivi una storia indimenticabile nata per il Super Nintendo: salva ancora una volta il mondo dalle forze del male!
<br><br>
Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014A445A50/FFFD0006" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A445A50/FFFD0007" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">MYSTIC QUEST LEGEND<sup>TM</sup></span></div>
</div>
