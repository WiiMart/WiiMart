...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">プレイヤーみずからが探偵となって事件を調査し解決する、コマンド選択式の推理アドベンチャーゲーム『ファミコン探偵倶楽部』のシリーズ２作目。前作『消えた後継者』から数年前の世界を舞台に、スリリングな物語と個性的な登場人物たちによる、丁寧に作り込まれた骨太の長編ミステリーが展開します。画面に映し出される場面を参考に、状況に応じて変化するコマンドの中から、推理をはたらかせて自分の行動を選び、捜査を進めていきます。プレイヤーは探偵事務所の助手となって、ある女子高生の殺人事件を調査するうちに、学校に伝わる「うしろの少女」という不気味なうわさ話にたどり着きます。どこにでもある、ありふれた学校の怪談が彼女の死とどんな関係があるのか。さまざまな人物から話を聞くなどして情報を集め、事件解決をめざしましょう。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014644584A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014644584A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
