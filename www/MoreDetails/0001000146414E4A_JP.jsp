...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">上下のパンチや強弱のパンチを使い分け、街の乱暴者をやっつけるファミコン初の対戦格闘ゲーム。画面の端にあるマンホールに落とせば勝ち。頭上から落下してくる植木鉢に当たると気絶したりするユニークな演出も楽しい。熱くなる対戦プレイもこのゲームの醍醐味。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146414E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146414E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">アーバンチャンピオン<sup>TM</sup></span></div>
</div>
