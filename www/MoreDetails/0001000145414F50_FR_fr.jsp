...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti sur NEOGEO en 1991, King of the Monsters est un jeu de combat où des monstres s'affrontent en pleine ville. Le joueur choisit un monstre parmi les six qui sont proposés. Celui-ci se rend ensuite à divers endroits du Japon livrer des combats afin de devenir l'ultime vainqueur.
<br><br>
Outre les coups de poing, les coups de pied et autres coups habituels, chaque personnage possède des attaques dévastatrices telles que des jets de flammes ou des faisceaux pour vaincre les adversaires. Ce jeu inclut des éléments de catch: pour remporter une victoire, vous devez épuiser totalement votre opposant et l’immobiliser au sol pendant trois secondes. Si ce dernier est sur vous alors que vous êtes sur le dos, appuyez à plusieurs reprises sur un bouton pour vous dégager.
<br><br>
En plus du mode joueur contre ordi, cette version vous permet de vous amuser dans des duels ainsi que dans des matchs par équipes de deux contre l'ordi.
<br><br>
