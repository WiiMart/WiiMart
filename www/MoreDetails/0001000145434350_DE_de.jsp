...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Dieses Spiel ist eine verbesserte Version von Metal Slug 2. Aufbauend auf dem bekannten Spielprinzip von Metal Slug 2, stehen dir dieses Mal neue Waffen zur Verfügung: der Iron Lizard, der deine Gegner verfolgt, und der Drop Shot, dessen Schüsse abprallen. Viele neue Gegner erscheinen und du kannst die Schwierigkeitsstufe ändern, indem du die Position von Endgegnern und anderen Gegenständen verstellst. Neue Hintergrundmusik und Szenen sind weitere Features. Das Spiel garantiert dir gewohnten Spielspaß, und Fans der Metal Slug-Reihe werden beim Spielen einige Neuheiten entdecken.
