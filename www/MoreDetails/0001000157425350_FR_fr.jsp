...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157425350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Avec Pop, l’objectif est de faire éclater des bulles ! Cela peut paraître simple, mais il existe de nombreuses façons de jouer et de faire grimper son score :  
<br>
- Faire éclater plusieurs bulles de la même couleur pour marquer plus de points<br>
- Utiliser des Puissances Plus pour améliorer son score ou gêner un adversaire<br>
- Pomper les bulles pour créer d'énormes explosions ou des chaînes de bulles consécutives<br>
- Jouer seul<br>
- Jouer avec des amis sur le même écran<br>
- Rejoindre une partie déjà commencée<br>
- Déverrouiller les badges<br>
- 4 modes de jeu différents<br><br>

Il existe également un tableau des meilleurs scores en ligne et des messages WiiConnect24 pour savoir où en sont vos amis et leur faire connaître vos propres progrès.
<br><br>
