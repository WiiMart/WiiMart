...
function initPage()
{
	...
	setUnderButtonL(true, "Retour", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Mode d&rsquo;emploi électronique", "javascript:showManual('0001000157425750')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Les créatures se sont échappées et c'est le chaos dans la basse-cour ! C'est à vous de rassembler les animaux dans ce challenge plein d'action !  Vous devrez réparer les barrières en vitesse pour que toutes les créatures soient en sécurité et soient satisfaites !  Mais l'action ne s'arrête pas à la ferme ; 50 niveaux stimulants vous emmènent dans des lieux exotiques, dont l'outback australien, les glaces arctiques, la savane et bien plus !  Il y a même une série de mini-jeux, au cas où les créatures vous laisseraient tomber : le Football boule de neige, le Saccage prédateur, Capturer les poulets et les Barrières pièges. Jusqu'à quatre joueurs peuvent participer ou coopérer quand les créatures deviennent sauvages. Alors, remontez vos manches et attrapez un ami - ces créatures ne s'attraperont pas elles-mêmes !<br><br>Texte écran en français.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157425750/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157425750/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Critter Round-Up</span></div>
</div>
