...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ペンギンの「グリン」と「マロン」を、ゴールまで導くパズル型アクションゲームです。ある日、魔法の森に迷い込み「鏡の迷路」に閉じ込められてしまったグリンとマロン。そこはグリンが右に動くとマロンは左に動く不思議な空間で、脱出のためには、ふたりが同時にゴールにたどり着かなければいけません。左右対称に動くふたりを導くパズル要素と、敵やクモの巣などに触れないように立ち回るアクション要素を楽しみながら、ゴールをめざします。うまく動かせなくて頭が混乱しそうになっても、焦りは禁物。冷静に敵の動きを見極めて全９９面を攻略してください。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014646544A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014646544A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">バイナリィランド</span></div>
</div>
