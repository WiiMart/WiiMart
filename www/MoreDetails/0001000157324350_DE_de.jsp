...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000157324350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bring dein Gehirn in Schwung und baue Stress ab, mit 25 Minispielen in den Kategorien Visuell, Merken, Logik, Mathe und Fokus.
<br><br>
Wähle deinen Lieblingstrainer und erhalte detaillierte Bewertungen in persönlichen Trainingseinheiten.
<br><br>
Fordere Freunde und Familie mit deinem persönlichen Mii in 3 unterhaltsamen Mehrspielermodi heraus. Zeig ihnen, wer der Boss ist! Dank der speziellen Kinder- und Seniorentestmodi wird Gehirntraining zu einem generationsübergreifenden Spiel.
<br><br>
Deutscher Bildschirmtext</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157324350/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157324350/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Gehirntraining</span></div>
</div>
