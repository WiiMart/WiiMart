...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">マリオやクッパなど、マリオシリーズのキャラクター達がカートでレース＆バトルをする人気レースゲーム「マリオカート」シリーズの１作目。加速重視やグリップ重視など４タイプ、計８台の中からお気に入りのキャラクターを選択してレースに挑みます。コースは全部で２０種類。サーキットやオフロードなどバラエティに富んだものが用意されています。また、コース上にある「？パネル」を通過することで、ミドリこうらやキノコなどのアイテムを入手でき、ライバルカートを攻撃したり、一時的に自分のスピードをアップしたりすることができます。コンピュータを含む８台で複数のコースを連戦する「マリオカートＧＰ」をはじめ、ゲームモードも充実。１人プレイでは好きなコースを１台だけで走る「タイムアタック」でベストタイムを狙ったり、２人プレイ時には、１対１の真剣勝負「ＶＳマッチレース」や、お互いのカートに付いている３つの風船を割りあう「バトルゲーム」も遊ぶことができます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A43574A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A43574A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スーパーマリオカート<sup>TM</sup></span></div>
</div>
