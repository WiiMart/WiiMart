...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Speel als de donkere ridder Cecil, commandant van de Red Wings-brigade, en beleef een legendarisch avontuur vol beproevingen, verraad, vriendschap, verlies en persoonlijke ontdekkingen. Kan Cecil zijn twijfels over de motieven van zijn heerser onder ogen zien en van het pad van duisternis en vernietiging wijken?
<br><br>
Dit spel werd oorspronkelijk in Noord-Amerika voor de SNES uitgebracht als FINAL FANTASY II, maar is in de chronologie van de serie eigenlijk FINAL FANTASY IV.
<br><br>
