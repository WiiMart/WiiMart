...
function initPage()
{
	...
	setUnderButtonL(true, "Zurück", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Bedienungsanleitung", "javascript:showManual('0001000158495050')", "wiiSelectSound()");
...
<br><br>Willkommen in der Welt der Pooyoos, dem ersten lustig-poetischen Gehirntrainer für Kinder von 3 bis 6 Jahren.
<br><br>
...
Dieses Spiel wurde für Kinder entwickelt, die noch nicht lesen können. <br><br>Deutscher Bildschirmtext.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000158495050/FFFD0004" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
