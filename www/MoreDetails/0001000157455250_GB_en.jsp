...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157455250')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Swaying aquatic plants...<br>
Fish idly swimming about...<br>
My Aquarium is a relaxing Wii software experience which allows you to enjoy a virtual aquarium in your spare time.<br><br>

Regardless of fresh or saltwater, you can select from over 40 popular types of fish including favorites like the Ocellaris Clownfish, the Freshwater Angelfish and the Asian Arowana. You can also create up to six different aquariums and personalize them by adding decorations like seaweed and driftwood.<br><br>

In My Aquarium, you can send aquariums to your registered friends. The aquariums can even be set with special dates, such as a friend's birthday, when the fish will commemorate it with a dance.<br><br>

Feed your fish and watch them steadily grow from fry to adult. Then, after meeting certain conditions, you can breed them! <br><br>
...
As some of the Wii console’s online services were discontinued on 28th June 2013, online features for this software, using WiiConnect24, are no longer available.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157455250/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
