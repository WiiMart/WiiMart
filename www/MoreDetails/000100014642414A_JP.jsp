...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">本物のピンポンで遊んでいるかのような気になれる、本格ピンポンゲームです。プレイヤーの動きは手とラケットのみで表現されるなどゲーム全体がシンプルに作られており、ピンポンそのもののおもしろさが際立ちます。自分のラケットは自動的に移動するので、タイミングを合わせてボタンを押し分けるだけで球の方向や速さを変えられるなど、操作も簡単です。ディスクシステムのキャラクター「ディスくん」が声援を送ってくれたり、「ドンキーコング」が観客席で応援してくれるなどのお楽しみ要素もあります。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014642414A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014642414A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">スマッシュピンポン<sup>TM</sup></span></div>
</div>
