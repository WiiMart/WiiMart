...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">歩兵や兵器を率いて、敵軍を撃破して行く指揮官のような気分が味わえるシューティングゲームです。プレイヤーは攻撃母艦「ジェネシス－３」を操り、捕まえた敵を味方にできる新兵器「キャプチャービーム」を駆使しながら戦闘を行い、敵の司令部を破壊すればステージクリアとなります。歩兵や戦車、ヘリコプターなどの個性的
なユニットを活用しながら戦いを勝利に導きます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146415A4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146415A4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">フィールドコンバット</span></div>
</div>
