...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000158483750')", "wiiSelectSound()");
...
<br><br>
Sombrías criaturas se han apoderado de la escuela secundaria de Jake, y eres el único que puede guiarle a través de cada aula para que se reúna con su novia, Rachael. Utiliza sabiamente las fuentes de luz existentes para crear puentes que permitan a Jake cruzar. ¡Un paso en falso y Jake se hundirá en la oscuridad! En el camino encontrarás versiones malévolas de los profesores de la escuela, a las que deberás vencer para seguir avanzando.
<br><br>
LIT es un juego de terror lleno de puzles que se juega con el mando de Wii y el Nunchuk. El juego incluye 30 niveles, cinco jefes, modos de repetición y varios elementos desbloqueables, como desenlaces múltiples, retos en la oscuridad con límite de tiempo y un personaje extra.
<br><br>
