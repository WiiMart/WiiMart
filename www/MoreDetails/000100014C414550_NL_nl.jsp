...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In dit platformspel uit de jaren '80 speel je Alex Kidd, die op zoek is naar zijn vermiste broer Egle. Om je broer te vinden moet je het opnemen tegen Janken the Great, die zijn monsters en handlangers op je af stuurt om je te stoppen.<br>
Een van de onderdelen in dit avontuur is het spelen van het spel Steen, papier, schaar om de handlangers te verslaan.<br>
Met 16 verschillende levels die je moet overwinnen om Egle te redden, stelt deze klassieker zowel je verstand als je reactievermogen op de proef.
<br><br>
Let op: dit is de originele versie van Alex Kidd in Miracle World zoals die in 1986 werd uitgegeven. De aanpassingen voor de in het SEGA MASTER SYSTEM ‘ingebouwde’ versie zijn niet in deze versie inbegrepen.
<br><br>
...
Handleiding alleen beschikbaar in Engels, Frans, Duits, Spaans en Italiaans.</div>
  <div id="image02">
    <img src="/oss/ccs/000100014C414550/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014C414550/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Alex Kidd in Miracle World<sup>TM</sup></span></div>
</div>
