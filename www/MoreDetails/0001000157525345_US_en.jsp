...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157525345')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Step Up brings you professional trainers specialized in aerobic step workouts, to help you burn all the calories you have ever dreamed of. Developed in collaboration with Laval University experts, Step Up's selection of workout moves are designed to be intuitive and easy to remember.
<p>
Step Up comes with many difficulty levels and a variety of songs with various BPM (beat per minutes) allowing you to configure your training session exactly the way you want it. Versatile configurations allow beginners to have a great exercise session, though Step Up can push even a gym professional to their limit. Step Up can be configured to work with the Wii Balance Board or with a basic aerobic step in similar size.
<p>
