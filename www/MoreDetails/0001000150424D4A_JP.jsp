...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">魔法使いのもとで修行をしていた主人公の「トンマ」が、魔物にさらわれたお姫様を助けるために魔境を冒険するアクションゲームです。プレイヤーは「ショット」と「ジャンプ」で行く手をさえぎる敵キャラクターに立ち向かい、７つのステージを進みます。補助攻撃として２段階まで強化できる「特殊弾」や５つの玉が周囲をガードする「バリア」など、ステージ上に落ちている魔法のアイテムを上手に使って、各ステージの最後に登場するボスを倒せばステージクリア。敵の頭を踏み台にした特大ジャンプや、ジャンプ中の方向転換など、テクニックしだいで攻略の幅が広がります。ミスをしたときに「トンマ」のマントがヒラヒラと空中を舞うコミカルな演出も見どころです。発売当時、女性スタッフだけで開発されたタイトルとして話題になりました。<BR><BR>詳細は、<Center>http://vc-pce.com/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000150424D4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000150424D4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">レジェンド・オブ・ヒーロー・トンマ</span></div>
</div>
