...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015753454A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">世界的に人気のコミックがWiiに登場。壮大なスケールでおくる、ファンタジー＆ラブロマンス<BR><BR>『プリンセス・アイ物語』は、日米アーティストのコラボレーションにより生まれました。人気漫画家の矢沢あいがキャラクターをデザインし、原作をアメリカの人気ロックアーティストのコートニー・ラヴが手がけました。<BR><BR>コミックの読み方は、コマを少しずつ読んでいく「コマ表示モード」と、ページの上下半分ずつを読んでいく「ページ表示モード」のどちらかをお好みで選べます。<BR>「コマ表示モード」は自動再生もできるので、ハンズフリーでお楽しみいただけます。<BR><BR>このソフトには、コミックが第１話から第３話までが入っています。追加コンテンツは全部で６つ。各２話ずつ、最終話の15話まで配信します。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015753454A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015753454A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">プリンセス・アイ物語</span></div>
</div>
