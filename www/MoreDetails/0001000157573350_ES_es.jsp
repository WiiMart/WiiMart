...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157573350')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Prosigue la búsqueda de Wally, sus amigos y mucho más en el viaje fantástico 3! <br>Basado en la exitosa serie de libros, ¿Dónde está Wally? El viaje fantástico 3 te ofrece la aventura de búsqueda definitiva en los mundos mágicos de los malvados gigantes, los cazadores subterráneos, la tierra de los Wally y muchos más. Desafía a tus amigos o juega solo mientras buscas objetos ocultos. ¡Prepárate para las sorpresas y únete a la diversión!<br><br>Textos de pantalla en español.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157573350/FFFD000F" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157573350/FFFD0010" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
