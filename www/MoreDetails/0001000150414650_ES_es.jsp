...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Victory Run es un juego de carreras basado en el “Rally París-Dakar”, disputado entre la capital de Francia y la de Senegal.<br>Experimenta una carrera de rally totalmente realista, donde tendrás que hacer frente a daños en el vehículo, ¡desde fallos en el motor hasta averías en la transmisión!<br>Escenarios que cambian dependiendo del tiempo... La emocionante sensación de velocidad... Intensas escenas de choques...<br>¡No pares de correr hasta el final del inolvidable trayecto de 13.000 km!<br><br>Textos de pantalla en inglés.</div>
  <div id="image02">
