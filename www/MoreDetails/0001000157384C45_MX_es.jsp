...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157384C45')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Balloon Pop Festival es un juego revolucionario de puzzle apto para todas las edades. Apunta a la pantalla para alcanzar y enlazar una serie de globos para crear combos satisfactorios. Ve cómo el festival anima y devuelve la alegría a la tierra, liberando diferentes elementos gráficos para representar a cada mes.
<p>
El objetivo del juego es conseguir la mayor puntuación posible antes de que los globos crucen el límite de la parte inferior. Cada festival tiene diferentes elementos gráficos, animaciones y el personaje luce distintos trajes. Al subir de nivel, los elementos gráficos se desarrollarán y completarán en 10 niveles. Festival cambiará cada 10 niveles. Cuanto más puedas avanzar a través del festival, más gráficas abrirás para jugar en los otros modos.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157384C45/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157384C45/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Balloon Pop Festival</span></div>
</div>
