...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Sorti en 1990, Ninja Combat est un jeu d'action/de combat à défilement horizontal dans lequel le joueur contrôle deux personnages au départ: Joe (parties à un joueur) et Hayabusa (parties à deux joueurs). Il doit affronter un clan de dangereux ninjas, les "Kage Ichizoku", qui demeurent dans leur forteresse principale, la "Ninja Tower".<br><br> Outre les attaques normales, les sauts, les mouvements spéciaux et les techniques ninja qui infligent un coup dévastateur à tous les ennemis à l’écran, le joueur doit également combattre en tirant le meilleur parti des armes et objets qu'il découvre sur la carte.<br><br> De plus, au fur et à mesure que le joueur progresse dans le jeu, de nouveaux alliés de confiance apparaissent, tels que Musashi, Kagero et Gembu, ce qui lui permet de choisir un personnage supplémentaire à chaque niveau. Ninja Combat permet également de jouer à deux simultanément. Ainsi, vous pouvez jouer avec un ami.
<br><br>
