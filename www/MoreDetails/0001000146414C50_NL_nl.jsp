...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">In Japan en Noord-Amerika is honkbal veel populairder dan in veel andere landen. Met dit spel biedt Nintendo je de mogelijkheid om kennis te maken met deze fantastische sport en zijn spelregels. In de tijd dat het spel uitkwam voor de NES, werd het beschouwd als een van de beste sportsimulaties, vanwege de toegankelijkheid en de vormgeving van het spel. In het spel kun je kiezen uit zes verschillende teams. In de Japanse versie werden deze teams vertolkt door de volledige Central League, waaraan een aantal van de bekendste teams van het land meedoet. In de internationale versie werden deze teams vervangen door de zes populairste teams uit de Noord-Amerikaanse competitie, ten tijde van de release van dit spel.
