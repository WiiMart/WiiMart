...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Virtual Console Arcade te brinda la oportunidad de disfrutar en tu propia casa de la versión original de Commando, uno de los juegos de Capcom más imitados.<br>
¡Controla a Super Joe y dispara en ocho direcciones distintas para abrirte paso a través de territorio hostil!<br>
¡Siembra el caos entre las filas enemigas con tus granadas y álzate con la victoria en este juego clásico que sentó las bases de un nuevo género!
