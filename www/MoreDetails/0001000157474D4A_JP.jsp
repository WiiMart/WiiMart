...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157474D4A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">ゲームサウンドステーションは、ストリーミングサウンド配信サービスです。チケットを使用することで、ゲームのサウンドトラックCD、ドラマCD、ボーカルCDなどのサウンドを自由に視聴することができます。自分好みのプレイリストを編集も可能です。収録コンテンツは今後も追加予定です。</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157474D4A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157474D4A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ゲームサウンドステーション</span></div>
</div>
