...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157545545')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">There's a battle brewing in the backyard and only you can save the day! Tumblebugs is the hit action-puzzler in which Black Bugs are rounding up and trapping the peaceful Tumblebugs underground. Now the black bugs are back. And they are meaner, faster and nastier! They've crashed the garden party and are rounding up the colored beetles. Once again it's Tumble to the rescue, but this time she's got backup. Call on your friends to help you battle your way through 89 stunning all-new levels. Thrilling new powerups also help you free bugs better than ever. And who is behind this black bug invasion?</div>
  <div id="image02">
