...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Bubble Bobble est un jeu d'action/réflexion qui met en scène Bub et Bob, les deux dragons cracheurs de bulles. Lors de sa sortie dans les salles d'arcade en 1986, il a introduit de toutes nouvelles mécaniques de jeu: pour éliminer leurs ennemis, les joueurs doivent les enfermer dans des bulles avant de les faire éclater.
<br><br>
Bien qu'il soit possible de terminer le jeu en venant à bout de ses 100 niveaux, il contient également de nombreux secrets, comme une "vraie fin" accessible uniquement en mode deux joueurs, des niveaux cachés et des tonnes d'objets différents. Ces éléments ont grandement contribué au succès du jeu.
<br><br>
Chaque niveau possède même ses propres courants d'air invisibles, déplaçant les bulles de façon imprévisible. Le fait d'obliger les joueurs à comprendre certains aspects pour mieux les maîtriser ensuite a fait de Bubble Bobble un jeu révolutionnaire à son époque.
<br><br>
