...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('0001000157395245')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Planning a Christmas party and want to grab guests’ attention? Or want to send greeting cards without the hassle of licking stamps? Then here is the solution: create and send fun Christmas cards with this unique WiiWare application! Happy Holidays Christmas lets you make fun Christmas-themed e-cards and send them straight to friends' Wii consoles! Add a tree and decorations; choose frames, stickers and music; and then write a message to friends registered in your Wii Address Book. It might not snow this Christmas, but with this fun new software your holiday is guaranteed to be a happy one!</div>
  <div id="image02">
