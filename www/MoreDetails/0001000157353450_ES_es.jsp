...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157353450')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡Diviértete con toda la familia y compite en los diferentes modos de juego!<br>
5 Spots Party es un juego de habilidad para todos los públicos basado en el famoso juego de buscar 5 diferencias.
<br><br>
En sus tres modos de juego, el objetivo consiste en encontrar el máximo número de diferencias en las imágenes que se te presentan. En los modos party deberás competir con otros jugadores y descubrir el máximo número de errores posible. En el modo 1 Jugador, debes encontrar las diferencias antes de que el tiempo termine para superar los récords del juego.
<br><br>
