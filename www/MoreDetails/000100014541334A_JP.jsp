...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">宇宙を旅する冒険家や異星の獣人戦士など、個性的な能力と必殺技を持つ８人の格闘家の中から一人を選んで戦うＳＦ格闘ゲームです。ステージが左右にスクロール可能なので戦いの最中に画面端に追い込まれることがなく、高速なダッシュが加わることで戦術が広がります。ダッシュ中は全てのダメージが１．５倍増になるだけでなく、通常攻撃でもガード中の相手の体力を削れたり、防御もガードキャンセルが可能。ダッシュを絡めた攻防で本作ならではの躍動感あふれる戦いを楽しめます。<BR><BR>詳細は、<Center>http://www.vc-neogeo.d4e.co.jp/title_neogeo/galaxyfight/index.html</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014541334A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014541334A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ギャラクシーファイト</span></div>
</div>
