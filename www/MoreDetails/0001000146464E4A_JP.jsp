...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">人気アクションゲーム「ロックマン」シリーズの第四弾です。未知の惑星での死闘を終えたロックマンのもとに、突如何者かから「８つの都市を征服した」とメッセージが届きました。またもＤｒ．ワイリーの仕業か、それとも新たなる強大な敵の出現か！？　ロックマンはライト博士が密かに開発をすすめていた新兵器「ニューロックバスター」を装備し、８つの都市の奪還に向かいます。ロックマンにアイテムを届けてくれる頼もしい仲間「エディ」、そしてロックマンの必殺技「チャージショット」は、本作から登場します。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/0001000146464E4A/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146464E4A/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ロックマン<sup>&reg;</sup>４</span></div>
</div>
