...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">De moedige Link begint aan een gevaarlijke reis door de fantasiewereld Hyrule. Gebruik je zwaard, je schild en vooral je verstand om de acht fragmenten van de Triforce te verzamelen en prinses Zelda te redden uit de klauwen van de kwaadaardige Gannon. The Legend of Zelda™ is het eerste deel uit een van de populairste avonturenseries aller tijden. Het spel werd ontwikkeld door Shigeru Miyamoto en introduceerde tal van innovatieve ideeën waaraan Zelda™-spellen tot op de dag van vandaag worden herkend. Niet alleen puilt dit avontuur uit van de actie, het zit vol raadselachtige kerkers en geheime doorgangen. Ontdek of herontdek deze tijdloze klassieker op de Virtual Console. <br><br>Het spel is voorzien van Engelse schermteksten.<br>Ondersteunt interlace modus met het componentsnoer voor Wii.</div>
  <div id="image02">
