...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Title Operations Guide", "javascript:showManual('000100015732434A')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">子供から大人まで誰でも毎日楽しく脳を鍛えられるゲームです。記憶、視覚、数学、論理、集中の5分野にわたる問題を搭載。さらに５つのストレス診断ミニゲームで、ストレス度をチェックして鍛えることができます。家族やお友達と最大４人で楽しめるマルチプレーヤーモードで仲間とコンテストを開催することができます。</div>
  <div id="image02">
    <img src="/oss/ccs/000100015732434A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100015732434A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">ブレインチャレンジ</span></div>
</div>
