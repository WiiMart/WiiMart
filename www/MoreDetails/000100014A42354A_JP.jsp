...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">洪水で洞窟に閉じこめられた主人公の「ぐっすん」と「およよ」を、無事にステージの出口へと導いてあげるパズルゲームです。プレイヤーは上から落ちてくるブロックを操作したり破壊したりして、動きまわる「ぐっすん」や「およよ」を敵などの障害から守りながら、水に落ちたりしないように出口までの道を作って導いてあげます。１人で楽しめるモードだけではなく、２人で対戦できる「たいせんモード」や、自分でオリジナル面を作って遊べる「えでぃっとモード」もプレイできます。<BR><BR>詳細は、<Center>http://www.nintendo.co.jp/vc/</Center><div align=right>をご覧ください。</div></div>
  <div id="image02">
    <img src="/oss/ccs/000100014A42354A/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/000100014A42354A/FFFD0004" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">すーぱーぐっすんおよよ<sup>&reg;</sup></span></div>
</div>
