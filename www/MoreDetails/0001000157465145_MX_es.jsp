...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157465145')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">¡La emoción coin-op de Frogger ha regresado y esta mejor que nunca! Da un brinco hacia la acción con modos clásicos y nuevos que expanden el juego de Frogger. ¡Personaliza tu juego con diferentes temas como el estilo moderno “neon” de HYPER ARCADE y el estilo Castlevania 8-bit y hasta Contra! ¡Compite contra amigos o la CPU en partidos de hasta 4 jugadores y mira quién es el mejor!
<p>
(Contenido del juego disponible en inglés, francés y español.)</div>
  <div id="image02">
    <img src="/oss/ccs/0001000157465145/FFFD0003" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000157465145/FFFD0005" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
