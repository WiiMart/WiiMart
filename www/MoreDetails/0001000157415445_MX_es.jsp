...
function initPage()
{
	...
	setUnderButtonL(true, "Atrás", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "Manual electrónico", "javascript:showManual('0001000157415445')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Astro Bugz Revenge es un rompe cabezas de acción con un toque retro. Protege nuestro sistema solar de astro-bugz y destrúyelos los combinando 3 o más bugz. Recoge valiosas cargas de poder y actívalas para aniquilar a los invasores. Cambia de bando y busca venganza jugando como un bugz. Pon a prueba tus habilidades cuando juegas contra tus amigos en modo Co-Op o en modo Versus. Este juego lleno de acción te atrapará sin duda alguna.</div>
  <div id="image02">
