...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000157505650')", "wiiSelectSound()");
...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">A crumbling mansion is home to a most peculiar picture book. Gather your courage and open the door to this odd, unsettling, and slightly scary tale. Turn the tide of frantic battles by using the Wii Remote to throw animated paper bears into the picture book's unusual pages. Use all the tools at your disposal to defend the shining blue jewels found within against Kina, the mysterious young boy residing in the mansion. Thirty exciting and challenging stages await you!<br><br>

The simultaneous release "Puzzling Pages" is a parallel game with its own tale and puzzle-oriented stages. Complete both games to uncover an even deeper mystery...</div>
  <div id="image02">
