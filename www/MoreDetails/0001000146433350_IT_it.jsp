...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Quando fece il suo primo ingresso nelle sale giochi nel 1986, Bubble Bobble introdusse delle dinamiche di gioco fino ad allora sconosciute: i giocatori dovevano sconfiggere i nemici facendo scoppiare le bolle in cui li avevano intrappolati.
<br><br>
Questo gioco d'azione con elementi da rompicapo ha come protagonisti Bub e Bob, due draghi Bubble.
<br><br>
Anche se è possibile completare il gioco superando 100 livelli, Bubble Bobble nasconde diversi segreti, quali l'impossibilità di vedere il "vero finale" se si gioca da soli, oltre ad alcuni stratagemmi, che conducono a livelli traboccanti di oggetti bonus. Questi elementi rappresentano i principali punti di forza del gioco.
<br><br>
Ogni livello presenta delle correnti d'aria invisibili che rendono imprevedibile il comportamento delle bolle. Aspetti come questo costituivano una continua sorpresa per i giocatori, costringendoli ad analizzare e a sfruttare a proprio vantaggio i vari elementi del gioco. Tutte queste innovazioni resero Bubble Bobble una pietra miliare nella storia dei videogiochi d'azione.
<br><br>
Il testo all'interno del gioco è in inglese.<br>Supporta la modalità interlacciata per il cavo AV Component per Wii.</div>
  <div id="image02">
    <img src="/oss/ccs/0001000146433350/FFFD0002" width="160" height="120" alt="Screen Shot 2"/>
    </div>
  <div id="image01">
    <img src="/oss/ccs/0001000146433350/FFFD0003" width="160" height="120" alt="Screen Shot 3"/>
    </div>  
</div>
<div id="text01-01">
...
<div style="overflow:hidden" nowrap id="TitleName1stline">
  <div align="center" class="headerBlueL"><span class="contentsBlueM">Bubble Bobble<sup>TM</sup></span></div>
</div>
