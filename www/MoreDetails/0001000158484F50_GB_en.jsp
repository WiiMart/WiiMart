...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showBack()", "snd.playSE(cSE_Cancel)");
	        ...
	        setUnderButtonR(true, "View Operations Guide", "javascript:showManual('0001000158484F50')", "wiiSelectSound()");
...
<br><br>
Play alone or invite a friend to grab a second Wii Remote and drop in at any time for co-op play. We even added a dedicated two players split-screen "versus" mode for extra fun.</div>
  <div id="image02">
