...
<div id="goodsfree">
  <div id="text" class="buttonTextBlackM">Plus de 10 ans avant Picross DS, il y avait déjà Mario's Super Picross sur Super Nintendo. Ce classique des "images en mots croisés", jusqu'à présent uniquement disponible au Japon, propose des centaines de défis à la fois relaxants et stimulants.
<br><br>
Un puzzle de Picross se présente sous la forme d'une grille de cases qui révèlent une image lorsqu'elles sont cochées correctement. Dans les puzzles de Mario, une erreur vous fait perdre de précieuses minutes. En revanche, dans les puzzles de Wario, plus difficiles, le temps n'est pas limité, mais vos erreurs ne sont pas indiquées!
<br><br>
Tout comme Picross DS, Mario's Super Picross dispose d'une fonction de sauvegarde qui vous permet de reprendre un puzzle ultérieurement, et propose un choix de plusieurs musiques de fond différentes.
<br><br>Compatible avec le mode entrelacé pour le câble composante AV Wii.
<br><br>Le texte à l'écran contient du japonais.</div>
  <div id="image02">
