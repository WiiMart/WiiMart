		...
		if (giftStatus == "sending") {
			...
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "OK", "javascript:showPage('B_28.jsp?titleId=00010001574B4A45&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "OK", "javascript:showPage('B_09.jsp?titleId=00010001574B4A45&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "OK", "javascript:showPage('B_18.jsp?titleId=00010001574B4A45&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
			...
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "OK", "javascript:showPage('B_09.jsp?titleId=00010001574B4A45&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
...
<div id="TitleName1stline" nowrap>
  <div align="center" class="contentsBlueM">KARAOKE JOYSOUND</div>
</div>
<div id="text02-01" >
  <div align="center" >
...
<div id="controller" align="center">
  <img src="/oss/oss/common/images//banner/B_08_RvlCtrl.gif" width="68" height="51" />
    <img src="/oss/oss/common/images//banner/B_08_MicrophoneCtrl.gif" width="68" height="51" />
    </div>

<div id="text04-02">
    <div align="center" >
      <div align="left" class="contentsBlackS">* A Wii-compatible USB mic is required to sing.<br>
* Tickets are required to access online music and cannot be used in software other than KARAOKE JOYSOUND.<br>
IMPORTANT NOTE: Service terminating on July 28, 2016. Last day to redeem or purchase ANY tickets is June 27, 2016. Last day to purchase the full version is May 31, 2016.</div>
    </div>
  </div>
</body>
</html>
