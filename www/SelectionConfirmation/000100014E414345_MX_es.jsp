...
<title>Confirmar la descarga</title>
<style type="text/css">
  /* B_08:  Caution Items */
...
function initPage()
{
	...
	if (ecSupportsSession()) {
		...
		if (giftStatus == "sending") {
			setUnderButtonL(true, "Atrás", "javascript:showOldPage('B_05.jsp')", "snd.playSE(cSE_Cancel)");
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "Aceptar", "javascript:showPage('B_28.jsp?titleId=000100014E414345&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "Aceptar", "javascript:showPage('B_09.jsp?titleId=000100014E414345&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "Aceptar", "javascript:showPage('B_18.jsp?titleId=000100014E414345&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		} else if (giftStatus == "receiving") {
			// setUnderButtonL(true, "Atrás", "javascript:showGiftTrans("+transId+")", "snd.playSE(cSE_Cancel)");
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "Aceptar", "javascript:showPage('B_09.jsp?titleId=000100014E414345&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		...
		*/
		...
		if (showCtrlPage == "true") {
			...
			document.getElementById("B08headingMessage").innerHTML = "Confirmación de controles";
		} else {
			document.getElementById("B08headingMessage").innerHTML = "Confirmar la descarga";
		}
    }
}
//-->
...
<div id="TitleName1stline" nowrap>
  <div align="center" class="contentsBlueM">The Legend of Zelda<sup>TM</sup>:</div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Ocarina of Time<sup>TM</sup></span></div>
  </div>
<div id="text02-01" >
  <div align="center" >
    <div align="center" class="contentsBlueS_01">Notas previas a la descarga:</div>
  </div>
</div>
...
<div id="text03-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Se recomienda el uso de un Classic Controller o un Classic Controller Pro (se venden por separado). El Wii Remote no es compatible con este juego.</div>
    </div>
  </div>
  <div id="text04-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">La versión de este juego para la Consola Virtual no es compatible con la función “rumble” (retumbo) que estaba disponible en el juego original de N64.</div>
    </div>
  </div>
</body>
</html>
