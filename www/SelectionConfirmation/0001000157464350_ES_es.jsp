...
<title>Confirmar programa</title>
<style type="text/css">
  /* B_08:  Caution Items */
	...
	if (ecSupportsSession()) {
		...
		if (giftStatus == "sending") {
			...
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "Aceptar", "javascript:showPage('B_28.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "Aceptar", "javascript:showPage('B_09.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "Aceptar", "javascript:showPage('B_18.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
			...
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "Aceptar", "javascript:showPage('B_09.jsp?titleId=0001000157464350&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		...
		*/
		...
		if (showCtrlPage == "true") {
			...
			document.getElementById("B08headingMessage").innerHTML = "Mandos compatibles";
		} else {
			document.getElementById("B08headingMessage").innerHTML = "Confirmar programa";
		}
    }
}
//-->
...
<div id="text03-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Para este título puedes usar el mando de Wii, el Nunchuk, el mando clásico y el mando clásico Pro (se venden por separado).</div>
    </div>
  </div>
  <div id="text04-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Textos de pantalla en inglés.</div>
    </div>
  </div>
</body>
</html>
