		...
		if (giftStatus == "sending") {
			...
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_28.jsp?titleId=000100014D424950&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_09.jsp?titleId=000100014D424950&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_18.jsp?titleId=000100014D424950&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
			...
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_09.jsp?titleId=000100014D424950&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
...
<div id="TitleName1stline" nowrap>
  <div align="center" class="contentsBlueM">Landstalker<sup>TM</sup></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">Treasures of King Nole</span></div>
  </div>
<div id="text02-01" >
  <div align="center" >
