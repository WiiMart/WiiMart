		...
		if (giftStatus == "sending") {
			...
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "OK", "javascript:showPage('B_28.jsp?titleId=000100014537364A&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "OK", "javascript:showPage('B_09.jsp?titleId=000100014537364A&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "OK", "javascript:showPage('B_18.jsp?titleId=000100014537364A&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
			...
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "OK", "javascript:showPage('B_09.jsp?titleId=000100014537364A&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
...
<div id="TitleName1stline" nowrap>
  <div align="center" class="contentsBlueM">エメラルディア<sup>&reg;</sup></div>
</div>
<div id="text02-01" >
  <div align="center" >
