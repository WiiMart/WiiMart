...
<title>Softwarebevestiging</title>
<style type="text/css">
  /* B_08:  Caution Items */
...
function initPage()
{
	...
	if (ecSupportsSession()) {
		...
		if (giftStatus == "sending") {
			setUnderButtonL(true, "Terug", "javascript:showOldPage('B_05.jsp')", "snd.playSE(cSE_Cancel)");
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "Oké", "javascript:showPage('B_28.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "Oké", "javascript:showPage('B_09.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "Oké", "javascript:showPage('B_18.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		} else if (giftStatus == "receiving") {
			// setUnderButtonL(true, "Terug", "javascript:showGiftTrans("+transId+")", "snd.playSE(cSE_Cancel)");
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "Oké", "javascript:showPage('B_09.jsp?titleId=0001000157464350&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		...
		*/
		...
		if (showCtrlPage == "true") {
			...
			document.getElementById("B08headingMessage").innerHTML = "Controllers";
		} else {
			document.getElementById("B08headingMessage").innerHTML = "Softwarebevestiging";
		}
    }
}
//-->
...
<div id="TitleName1stline" nowrap>
  <div align="center" class="contentsBlueM">FINAL FANTASY<sup>&reg;</sup> CRYSTAL </div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">CHRONICLES: My Life as a King<sup>TM</sup></span></div>
  </div>
<div id="text02-01" >
  <div align="center" >
    <div align="center" class="contentsBlueS_01">Let op het volgende als je deze software wilt downloaden:</div>
  </div>
</div>

<div id="controller" align="center">
  <img src="/oss/oss/common/images//banner/B_08_RvlCtrl.gif" width="68" height="51" />
    <img src="/oss/oss/common/images//banner/B_08_NunchukCtrl.gif" width="68" height="51" />
...
<div id="text03-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Deze software ondersteunt het gebruik van de Wii-afstandsbediening, de Nunchuk, de Traditionele Controller en de Traditionele Controller Pro (apart verkrijgbaar).</div>
    </div>
  </div>
  <div id="text04-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Het spel is voorzien van Engelse schermteksten.</div>
    </div>
  </div>
</body>
</html>
