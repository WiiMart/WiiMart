		...
		if (giftStatus == "sending") {
			...
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_28.jsp?titleId=00010001574C4D50&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_09.jsp?titleId=00010001574C4D50&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_18.jsp?titleId=00010001574C4D50&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
			...
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_09.jsp?titleId=00010001574C4D50&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
...
<div id="controller" align="center">
  <img src="/oss/oss/common/images//banner/B_08_RvlCtrl.gif" width="68" height="51" />
    ...
    <img src="/oss/oss/common/images//banner/B_08_KeyboardCtrl.gif" width="68" height="51" />
    </div>
