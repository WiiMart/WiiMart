...
function initPage()
{
	...
	if (ecSupportsSession()) {
		...
		if (giftStatus == "sending") {
			setUnderButtonL(true, "Indietro", "javascript:showOldPage('B_05.jsp')", "snd.playSE(cSE_Cancel)");
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "OK", "javascript:showPage('B_28.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "OK", "javascript:showPage('B_09.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "OK", "javascript:showPage('B_18.jsp?titleId=0001000157464350&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		} else if (giftStatus == "receiving") {
			// setUnderButtonL(true, "Indietro", "javascript:showGiftTrans("+transId+")", "snd.playSE(cSE_Cancel)");
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "OK", "javascript:showPage('B_09.jsp?titleId=0001000157464350&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		...
		*/
		...
		if (showCtrlPage == "true") {
			...
			document.getElementById("B08headingMessage").innerHTML = "Informazioni controller";
		} else {
			document.getElementById("B08headingMessage").innerHTML = "Conferma software";
		}
    }
}
//-->
...
<div id="text02-01" >
  <div align="center" >
    <div align="center" class="contentsBlueS_01">Leggi attentamente prima di scaricare questo software:</div>
  </div>
</div>
...
<div id="text03-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Per questo software puoi usare il telecomando Wii, il Nunchuk, il controller tradizionale e il controller tradizionale pro (venduti separatamente).</div>
    </div>
  </div>
  <div id="text04-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Il testo all'interno del gioco è in inglese.</div>
    </div>
  </div>
</body>
</html>
