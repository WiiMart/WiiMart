...
<title>Software Confirmation</title>
<style type="text/css">
  /* B_08:  Caution Items */
	...
	if (ecSupportsSession()) {
		...
		*/
		...
		if (showCtrlPage == "true") {
			...
			document.getElementById("B08headingMessage").innerHTML = "Software Confirmation";
		}
    }
}
//-->
...
<div id="text03-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Use of a Classic Controller or Classic Controller Pro (sold separately) is recommended for playing this game. This game cannot be played using the Wii Remote by itself.</div>
    </div>
  </div>
  <div id="text04-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Does not support Wii Component AV cable Interlace Mode.</div>
    </div>
  </div>
</body>
</html>
