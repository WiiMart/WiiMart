...
<title>Software-Bestätigung</title>
<style type="text/css">
  /* B_08:  Caution Items */
...
function initPage()
{
	...
	if (ecSupportsSession()) {
		...
		var platform = 'SFC/SNES';
		trace("platform: "+platform);
		var genreWifiPay = "";
		
		if (giftStatus == "sending") {
			setUnderButtonL(true, "Zurück", "javascript:showOldPage('B_05.jsp')", "snd.playSE(cSE_Cancel)");
			if (showCtrlPage != "true") {
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_28.jsp?titleId=000100014A414850&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else if (hasCautionItem3 == "true") {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_09.jsp?titleId=000100014A414850&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				} else {
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_18.jsp?titleId=000100014A414850&itemId=&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		} else if (giftStatus == "receiving") {
			// setUnderButtonL(true, "Zurück", "javascript:showGiftTrans("+transId+")", "snd.playSE(cSE_Cancel)");
			if (showCtrlPage == "true") {
				...
				if (hasCautionItem2 == "true" || ((genreWifiPay == "true") && (wifiIndicator == WIFI_PARTIALLY_CHARGED || wifiIndicator == WIFI_ALL_CHARGED || wifiIndicator == WIFI_FREE_INPUT))) {
					...
					setUnderButtonR(true, "O.K.", "javascript:showPage('B_09.jsp?titleId=000100014A414850&SD=')", "snd.playSE(cSE_Decide)");
				}
			}
		...
		*/
		...
		if (showCtrlPage == "true") {
			...
			document.getElementById("B08headingMessage").innerHTML = "Controller-Information";
		} else {
			document.getElementById("B08headingMessage").innerHTML = "Software-Bestätigung";
		}
    }
}
//-->
...
<div id="TitleName1stline" nowrap>
  <div align="center" class="contentsBlueM">R-TYPE Ⅲ<sup>TM</sup></div>
</div>
<div style="overflow:hidden" nowrap id="TitleName2stline">
    <div align="center"><span class="contentsBlueM">THE THIRD LIGHTNING</span></div>
  </div>
<div id="text02-01" >
  <div align="center" >
    <div align="center" class="contentsBlueS_01">Bitte beachte beim Download dieser Software folgenden Hinweis:</div>
  </div>
</div>

<div id="controller" align="center">
  <img src="/oss/oss/common/images//banner/B_08_ClassicCtrl.gif" width="68" height="51" />
    <div id="GcCtrl"  style="display: inline-block; _display: inline;"><img src="/oss/oss/common/images//banner/B_08_GcCtrl.gif" width="68" height="51" /></div>
    </div>

<div id="text03-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Für dieses Spiel wird die Nutzung eines Classic Controllers oder eines Classic Controller Pro (separat erhältlich) empfohlen. Die alleinige Verwendung einer Wii-Fernbedienung ist bei diesem Spiel nicht möglich.</div>
    </div>
  </div>
  <div id="text04-01">
    <div align="center" >
      <div align="left" class="contentsBlackS">Interlace-Modus mit dem Wii-Komponenten-Video-Kabel wird nicht unterstützt.</div>
    </div>
  </div>
</body>
</html>
