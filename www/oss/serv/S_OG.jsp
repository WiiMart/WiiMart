...
<!--<a href="https://oss-auth.a.taur.cloud/oss/serv/debugMode.jsp">debug mode</a>
<a href="https://oss-auth.a.taur.cloud/oss/serv/W_01.jsp">Click here to skip checking account status</a>-->
...
function onIsRegisteredDone(progress) {
  ...
  if (info.registrationStatus == "R") {
    //top.location = "https://oss-auth.a.taur.cloud/oss/serv/CheckRegistered.jsp";
...
function isRegistered() {
  var ecsUrl = 'https://oss-auth.a.taur.cloud/oss/ecs/services/ECommerceSOAP';
  var iasUrl = 'https://oss-auth.a.taur.cloud/oss/ias/services/IdentityAuthenticationSOAP';
  var ccsUrl = 'http://oss-auth.a.taur.cloud/ccs/download';
