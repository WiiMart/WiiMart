...
<%
	...
	String opmanualW = ""; // FOR WIIWARE
	String continueBtnW = "";
	String OPmanual_spacerLeft = "";
	String ContinueBtn_spacerLeft = "";

	String fmt_ID = titleId.substring(8, 10);
	...
	String region2letter = "US";
	String country2letter = "US"; // COUNTY
	String language2letter = language.toUpperCase();

	if (language2letter.equals("ES")) {
		language2letter = "SP";
	}

	if (language2letter.equals("DE")) {
		language2letter = "GE";
	}

	if (language2letter.equals("JA")) {
		language2letter = "JP";
	}

	if (language2letter.equals("KO")) {
		language2letter = "KR";
	}

	if (language2letter.equals("NL")) {
		language2letter = "HO";
	}

	switch (language2letter) {
		case "NL":
		case "HO":
			OPmanual_spacerLeft = "62";
			ContinueBtn_spacerLeft = "356";
			opmanualW = "264";
			continueBtnW = "189";
			break;
		default:
		case "KR":
		case "EN":
			opmanualW = "355"; // for both US and EU
			continueBtnW = "154";
			OPmanual_spacerLeft = "34";
			ContinueBtn_spacerLeft = "419";
			break;
		case "ES":
		case "SP":
			ContinueBtn_spacerLeft = "337";
			OPmanual_spacerLeft = "82";
			opmanualW = "225"; // for both US and EU
			continueBtnW = "188";
			break;
		case "IT":
			ContinueBtn_spacerLeft = "372";
			OPmanual_spacerLeft = "58";
			opmanualW = "284";
			continueBtnW = "178";
			break;
		case "FR":
			if (region2letter.equals("US")) {
				OPmanual_spacerLeft = "29";
				ContinueBtn_spacerLeft = "418";
				opmanualW = "359";
			} else {
				ContinueBtn_spacerLeft = "420";
				OPmanual_spacerLeft = "28";
				opmanualW = "362";
			}
				continueBtnW = "160";
			break;
		...
		case "GE":
			OPmanual_spacerLeft = "34";
			ContinueBtn_spacerLeft = "408";
			opmanualW = "344";
			continueBtnW = "165";
			break;
		case "JA":
		case "JP":
			ContinueBtn_spacerLeft = "338";
			OPmanual_spacerLeft = "79";
			opmanualW = "229";
			continueBtnW = "190";
			break;
	}
...
body {
	<% if (vc.equals("true")) { %>
	background-image: url(/oss/oss/common/images//HealthAndSafety_image/VC_HAS_<%= region2letter %>_<%= language2letter %>.gif);
	<% } else if (vc.equals("false")) { %>
	background-image: url(/oss/oss/common/images//HealthAndSafety_image/WW_HAS_<%= region2letter %>_<%= language2letter %>.gif);
	<% } else { %>
...
function initPage()
{
	...
	<% if (vc.equals("SHOWGIFTNEXT")) { %>goGiftNext('<%= titleId %>')<% } %>
...
<% if (!vc.equals("SHOWGIFTNEXT")) { %>
<% if (vc.equals("true")) { %> <%-- VC --%>
<div id="banner" style="position:absolute; left:209px; top:369px; width:190px; height:54px; z-index:1"><img src="/oss/oss/common/images//HealthAndSafety_image/B_12_banner_<%= language2letter %>.gif" width="190" height="54"></div>
...
<% } else { %> <%-- WW/WC --%>
<div id="spacer2" style="position:absolute; left:<%= ContinueBtn_spacerLeft %>px; top:369px; width:<%= continueBtnW %>px; height:54px; z-index:2"><a href="javascript:goGiftNext('<%= titleId %>')"><img src="/oss/oss/common/images//spacer.gif" width="<%= continueBtnW %>" height="54" border="0" onmouseover="wiiFocusSound();" onclick="wiiSelectSound();"></a></div>
<div id="spacer3" style="position:absolute; left:<%= OPmanual_spacerLeft %>px; top:369px; width:<%= opmanualW %>px; height:54px; z-index:2"><a href="javascript:showNotImplementedYetFromB_13('<%= titleId %>')"><img src="/oss/oss/common/images//spacer.gif" width="<%= opmanualW %>" height="54" border="0" onmouseover="wiiFocusSound();" onclick="wiiSelectSound();"></a></div>
<% } %>
<% } %>
</body>
</html>
