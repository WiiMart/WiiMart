...
//-->
    ...
    <SCRIPT language="JavaScript">const l = new wiiShop().connecting;</SCRIPT>
...
function getNOAError(code)
{
    ...
    <title>???S_17.title???</title>
    <!--link href="/oss/oss/common/css/S_20.css" rel="stylesheet" type="text/css" /-->

    <link href="/oss/oss/common/css/S_17.css" rel="stylesheet" type="text/css" />
...
<body onload="initPage();">
  ...
  <div id='balanceInfo'>
    ...
    <a href="javascript:window.location.reload();" style="position:absolute;top:0;left:0;">reload</a>
    <a href="/oss/serv/W_03.jsp" style="position:absolute;top:25px;left:2px;" onclick="snd.playSE(4)">returnhome</a>
    <!--
        /* For S_18: Helpee number Input Page for Helper */
        register the helpee that got helped? (based off div names)
    -->
    <div id="text01-01" class="titleBlackM">Connection Ambassador Registration</div><!--title-->
    <!--<div id="text02-01">text02-01</div>
    <div id="text03-01">text03-01</div>-->
    <div id="numberfield">
        <input type="text" class="input" id="numfield"
		onmouseover="this.style.backgroundColor='#E6E6E6';if(snd&&'playSE'in snd){snd.playSE(cSE_Forcus)}"
		onmouseout="this.style.backgroundColor='#FFFFFF';"
		onclick="kbd.call(1)" />
    </div>
    <!--input type="text" class="input"-->
    <div id="banner01">banner01</div>
    <div id="text01">text01</div>
    <div id="spacer01">spacer01</div>
    <div id="banner02">banner02</div>
    <div id="text02">text02</div>
    <div id="spacer02">spacer02</div>

    <div id="explanationfield"><img src="/oss/oss/common/images/banner/helpee.png"></div>

    <div id="explanationtext">explanationtext</div>
    <div id="notefield">Note: The Wii Number must be registered by <span id="registerDate">18/11/09</span>.</div>
    <div id="statusMessage" class="buttonTextBlackM" style="display: none;">The Period during which you were able to register as<BR>having been helped to connect your Wii conssole to the<BR>internet has expired.<BR><BR>Registration must take place within <span id="days">30</span> days of your first<BR>connection to the Wii Shop Channel.<BR><BR>We hope you continue to enjoy using the Wii Shop<BR>Channel.</div><!--period expired div-->
</body>
