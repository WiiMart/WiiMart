...
<a href="https://oss-auth.a.taur.cloud/oss/serv/W_03.jsp">W_03.jsp</a>
<a href="https://oss-auth.a.taur.cloud/oss/serv/P_06.jsp">P_06.jsp</a>
<!--  -----------------------------------------------------  -->
...
function initPageCommon()
{
	...
	ucsUrl = 'https://oss-auth.a.taur.cloud/ccs/download';
...
function initPage()
{
	...
	document.getElementById("newBalance").innerHTML = ec.getCachedBalance();
		...
		if (element) {
			if (ecSupportsSession()) {
				if (ec.getSessionValue("ogMode") == "true") {
					element.innerHTML = "Wii Shop Channel";
				} else {
					element.innerHTML = "WiiMart";
				}
			}
		}
	}
...
<div id="text02-01" class="catalogTitleBlack">
  	<span id="addedPoints"></span> Wii Points were added to your <span id="title"></span> account!</div>
