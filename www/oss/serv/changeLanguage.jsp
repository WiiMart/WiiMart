...
<% String recvlang = request.getParameter("targetLanguage") == null ? "en" : request.getParameter("targetLanguage"); %>
...
{
	initPageCommon();
	ec.setPersistentValue("altLanguage", "<%= recvlang %>")
    ...
    setUnderButton(true, "OK", "javascript:showPage('W_03.jsp');", "snd.playSE(cSE_Decide)")
...
<div id="text01-01" class="titleBlackL">Change Language</div>
<div class="titleBlackL" id="text02-01" style="text-align: center;">
    recvlang: <%= recvlang %><BR>
	getPersistentValue: <script>document.write(ec.getPersistentValue('altLanguage'));</script>
    </div>
</body>
</html>