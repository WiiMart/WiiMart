...
//if (ec.getSessionValue("ogMode") != "true") {
	document.write('<a href="https://oss-auth.a.taur.cloud/oss/serv/debug.jsp">debug</a>');
//}
</script>
<script type="text/javascript">
<!--
...
function initPageCommon()
{
	...
	ccsUrl = 'http://oss-auth.a.taur.cloud/oss/ccs/download';

	ucsUrl = 'http://oss-auth.a.taur.cloud/oss/ccs/download';
...
function showError(progress)
{
 	...
 	setUnderButton(true, shop.menuBtn, "javascript:shop.returnToMenu()", "wiiSelectSound();");
...
<body onload="initPage();shop.disableHRP();">
...
<div class="titleBlueL" id="text01-01">
  <script>
	if (ec.getSessionValue("ogMode") == "true") {
		...
		document.write("WiiMart");
	}
  </script></div>
<div align="center" class="titleBlueL" id="text02-01">
<script>
if (ec.getSessionValue("ogMode") == "true") {
	document.write(shop.connecting);
} else {
	document.write("Checking your balance...");
}
</script>
<div id="Progress">
