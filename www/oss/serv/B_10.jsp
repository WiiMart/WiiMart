<%@ page import = "org.wiimart.Catalog,org.wiimart.Title,java.io.*,java.util.*,java.util.Random,java.net.http.*,java.net.URI,java.net.http.HttpResponse.BodyHandlers,java.net.HttpURLConnection,java.net.URL,java.nio.charset.StandardCharsets,org.json.*,java.nio.file.*,java.io.*" %>
...
%>
<% String t = request.getParameter("titleId"); %>
...
<script>var SHOP = new wiiShop(); //const l = SHOP.connecting; </script>
<script type="text/JavaScript">
...
function initPageCommon()
{
	...
	ucsUrl = 'http://ccs.cdn.shop.wii.com/ccs/download';
	...
	ecTimeout = new ECTimeout(parseInt("120000"));
...
<script language="javascript">
    ...
    <%
        // B_13 fix
        // See https://wiibrew.org/wiki/Title_Database for every type.
        String type = id.substring(8, 10);
        String isGame = "false";
    ...
    %>
    var titleIsGame = '<%= isGame %>'; // substring 8, 10 (JSP), substr 8, 2 (JS)
    trace(titleIsGame);
    ...
    function purchaseTitle(titleId, itemId, price, limits)
    {
        ...
        if (titleId == null) {
            ...
            if (ec.getSessionValue("giftStatus") == "receiving") {
                //If receiving gift, set title price to 0.
                price = new ECPrice("0", "POINTS");
            }
    ...
    function setSDErrorHtmlMsg(sdErrCode)
    {
        ...
        if (sdErrCode == -13) {
            ...
            setUnderButton(true, shop.retryBtn, "javascript:shop.retry();", "wiiSelectSound();");
            document.getElementById("details").style.display='none';
            document.getElementById("text02-01").style.display='none';
            document.getElementById("TitleName").style.display='none';
    ...
    function handleError(progress){
        ...
        if(errCode == 205540 && shop.isCompatibleMode){
            ...
            document.getElementById("OKBtnWord").innerHTML=shop.menuBtn;
            ...
            document.getElementById("OKBtnWord").innerHTML=shop.retryBtn;
        }
    ...
    function showICRExpirePage(){
        ...
        document.getElementById("text02-01").style.display='none';
        document.getElementById("TitleName").style.display='none';
        setUnderButton(true, shop.retryBtn, "javascript:window.location.reload();", "wiiSelectSound()");
...
<body onload="try {initPage();} catch (err) {trace('ERROR' + err.message)};console.log('<%= id.substring(8, 10) %>');">
