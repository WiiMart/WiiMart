...
<body onload="initPage();var shop = new wiiShop();var unused = shop.connecting;" background="/oss/oss/common/images/back/bg_present.gif" style="background-repeat: no-repeat;">
<!--  -----------------------------------------------------  -->
<!--  Copyright 2005-2014 Acer Cloud Technology, Inc.        -->
<!--  All Rights Reserved.                                   -->
<!--                                                         -->
...
<div id="giftConfirm" style="position:absolute; left:36px; top:88px; width:540px; height:277px; z-index:37">
  <div align="center">
    <div align="center"><table height="100%"><tr><td align="left" valign="middle"><span id="rcvHead" class="buttonTextBlackM">A gift is waiting for you that<BR>you haven&rsquo;t downloaded yet.<BR>Please download or return the gift.</span></td></tr></table></div>
  </div>
</div>
