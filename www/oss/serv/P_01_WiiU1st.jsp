...
<span id="P_01_WiiU" style="font-size: 20px;"><span style="color:#FF0000;">Wii Points added here can only be used <% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%>o<%}else{%>o<%}%>n <% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%>WiiMart<%}else{%>the Wii Shop Channel<%}%>. You cannot redeem them for Wii U software from Nintendo eShop.</span><br><br>Add Wii Points to your <% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%>WiiMart<%}else{%>the Wii Shop Channel<%}%> account?</span>
...
<div align="left" class="contentsBlack" id="text03-01">
  On <% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%>WiiMart<% } else { %>the Wii Shop Channel<% } %>, you use Wii Points to download software.<BR><BR>You can add Wii Points in two ways: by redeeming a Wii Points Card purchased at retail or by buying them with a credit card here.<% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%><BR><BR><B>NOTE</B>: Wii Points are free.<% } %></div>
