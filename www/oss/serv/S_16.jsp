...
function showAboutCSS()
{
	...
	if(isSCAEnabled) {
		...
		//setUnderButtonR(true, "Wii Connection<BR>Masters", "javascript:showAboutSCA()", "wiiSelectSound()");
		setUnderButtonR(true, "Wii Connection Masters", "javascript:showAboutSCA()", "wiiSelectSound()");
	} else {
		setUnderButtonR(false);
	}
...
<div id="text02-01" class="catalogTitleBlack_02">With the Connection Ambassador Campaign, people who have connected their Wii console to the Internet can help other users get online, earning 500 Wii Points for both parties. To learn more, select More Information below.</div>
...
<div id="aboutSCA">
	<div id="text04" class="titleBlackM">
		Wii Connection Masters</div>
	<div id="catalogFrameAboutSCA" class="catalogFrame">
		<span class="aboutExplain catalogTitleBlack_04">
			When the number of people you assist hits 10, you are designated a [Connection Ambassador 10]. As a bonus, you will be able to download the entire library of Nintendo titles for the NES free of charge.<BR><BR>When you reach 20 people, you are designated a [Connection Ambassador 20]. As a bonus, you will be able to download the entire library of titles for the NES, SNES, and Nintendo 64 free of charge.<BR><BR>At the point when you become a Connection Ambassador, any of these titles that you had already downloaded may be gifted once to a Wii Friend, also free of charge.<BR><BR>This campaign may end without notice.
	<!--<a href="javascript:window.location.href='S_22.jsp?r=SCA_GOLD_01'">SCA Gold 1 S_22</a><br>
	<a href="javascript:window.location.href='S_22.jsp?r=SCA_GOLD_02'">SCA Gold 2 S_22</a><br>
	<a href="javascript:window.location.href='S_22.jsp?r=SCA_GOLD_TOICR'">SCA Gold to ICR S_22</a><br><br>
	<a href="javascript:window.location.href='S_22.jsp?r=CSS_SILVER_01'">CSS Silver 01 S_22</a><br>
	<a href="javascript:window.location.href='S_22.jsp?r=CSS_SILVER_02'">CSS Silver 02 S_22</a><br>
	<a href="javascript:window.location.href='S_22.jsp?r=CSS_SILVER_TOICR'">CSS Silver to ICR S_22</a><br><br>
	<a href="javascript:window.location.href='S_27.jsp?r=CSS_SILVER'">CSS Silver S_27</a><br>
	<a href="javascript:window.location.href='S_27.jsp?r=SCA_GOLD'">SCA Gold S_27</a>-->
		</span>
	</div>
</div>
