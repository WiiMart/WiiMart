...
<div id="cautionArea">
  <div align="center" style="height:300px;">
    <table align="center" cellpadding="4"><tr><td align="left"><span class="contentsBlackS">
		<% if (!titleId.equals("000100015746534A")) { %>
		<c:out value="${Body}" escapeXml="false" />
		<% } else { %>
			本ソフトの購入前に取扱説明書をよくご確認いただき、その内容に同意いただいたうえでご購入ください
		<% } %>
	</span></td></tr></table>
  </div>
</div>
