...
{
	initPageCommon();
	var giftTitleUrl = 'B_22.jsp?titleId=<%= id %>&itemId=101449&recipient=<%= request.getParameter("recipient") %>&recipientDeviceCode=<%= request.getParameter("recipientDeviceCode") %>';
