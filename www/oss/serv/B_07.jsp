...
<%@ page import = "com.ocarina.classes.Catalog,java.io.*,java.util.*,javax.servlet.*" %>
...
<% String ratingUrl = request.getParameter("ratingUrl") == null ? "PEGI_en.html" : request.getParameter("ratingUrl"); %>
<%-- USK/OFLC available --%>
<%--
USK: DE01
OFLC: AU
...
<div id="goodsdetails">
  <iframe src="/oss/oss/common/html/ratings/<%= ratingUrl %>" frameborder="0" style="border:solid 1px #35beed;" scrolling="auto" width="540" height="262"></iframe>
</div>
