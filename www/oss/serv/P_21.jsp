...
<a href="https://oss-auth.a.taur.cloud/oss/serv/debug.jsp">debug</a> docomoPg
<% } %>
...
<div id="P_01_text01-01" class="titleBlackM" >ニンテンドープリペイド番号販売（ドコモ）</div>
<!--
...
<div id="menuText" style="position:absolute; left:40px; top:216px; width:360px; height:18px; z-index:33;">
  <div align="left" class="buttonTextBlackM"><table height="100%"><tr><td align="left" valign="middle">iMenuからアクセス</td></tr></table></div>
</div>
...
<div id="menuBody" style="position:absolute; left:40px; top:242px; width:540px; height:18px; z-index:33;">
  <div align="left" class="catalogTitleBlue"><table height="100%"><tr><td align="left" valign="middle">iMenu ⇒ メニューリスト ⇒ 着信メロディ/カラオケ ⇒ ゲーム<BR>⇒ 任天堂モバイル ⇒ ニンテンドープリペイド番号販売</td></tr></table></div>
</div>
