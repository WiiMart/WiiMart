...
<%
    String titleToChange = request.getParameter("title") == null ? "WiiMart" : request.getParameter("title");
	String oldTitle = "WiiMart";
	if (titleToChange.equals("WSC")) {
		titleToChange = "Wii Shop Channel";
		oldTitle = "WiiMart";
	} else if (titleToChange.equals("WiiMart")) {
		oldTitle = "Wii Shop Channel";
	}
    %>
    <%
    ...
    String updateSQL = "UPDATE public.userbase SET og_title = ? WHERE serial_number = ?";
    PreparedStatement pst = conn.prepareStatement(updateSQL);
    pst.setString(1, titleToChange);
...
%>
<script>
    console.log("Changing title to <%= titleToChange %> from <%= oldTitle %>")
</script>
...
function initPage()
{
	...
	ec.setSessionValue("currTitle", "<%= titleToChange %>");
...
<div id="text01-01" class="titleBlackL">Title Change</div>
<div class="titleBlackL" id="text02-01" style="text-align: center;">
    Your title is now <%= titleToChange %>!
    </div>
</body>
