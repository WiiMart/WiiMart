...
<%
	String last8digits = titleId.substring(8,16);
	String count = String.valueOf(last8digits.length());
%><%
	//String magic = String.valueOf(Integer.parseInt(last8digits)-Integer.parseInt(count)-1);
%>
<%
	//response.sendRedirect("/oss/oss/ext/manual/"+titleId+"/FFFD");
%>
<body onload="initPageCommon();goodsfree2.focus();var shop = new wiiShop();var unused = shop.connecting;shop.setWallpaper(2)" style="overflow: hidden !important;">
<div id="goodsfree2" style="position:absolute; left:0px; top:0px; width:608px; height:456px; z-index:31; overflow:auto;">
	...
	<a href="/oss/serv/debug.jsp">debug&lt;span&gt;</a><a href="javascript:location.reload()"> reload</a><span> indev</span><a href="javascript:showAbsPage('/oss/oss/ext/manual/0001000248414241/FFFD1AAA/html/manual/NOA/startup.html')"> shop manual</a><a href="javascript:showPage('W_03.jsp')"> exit</a>
  	<!--iframe name="manualFrame" src="/oss/oss/ext/manual/0001000248414241/FFFD1AAA/html/manual/NOA/startup.html" frameborder="0" scrolling="Auto" width="608" height="456"></iframe-->
</div>
</body>
</html>
