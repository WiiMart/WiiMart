...
function initPageCommon()
{
	...
	ecsUrl = 'https://oss-auth.a.taur.cloud/SOAP/ECommerceSOAP.jsp';

	iasUrl = 'https://oss-auth.a.taur.cloud/ias/services/IdentityAuthenticationSOAP';

	casUrl = 'https://oss-auth.a.taur.cloud/cas/services/CatalogingSOAP'
	...
	ossPath = "http://oss-auth.a.taur.cloud/oss/serv/";
...
function proceedUnregister(challenge)
{
	...
	document.getElementById("text03-01").innerHTML='<div align="center" class="headerBlueL" style="color: #34BEED"><table height="100%"><tr><td align="left" valign="middle">Now removing your account...</td></tr></table></div>';
