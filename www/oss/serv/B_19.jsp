...
String title1 = title.title1.replaceAll("'", "&apos;");
String title2 = title.title2.replaceAll("'", "&apos;");
...
function initPageCommon()
{
	...
	ecsUrl = 'https://ecs.a.taur.cloud/ecs/services/ECommerceTest';

	iasUrl = 'https://ias.a.taur.cloud/ias/services/IdentityAuthenticationTest';
...
function giveGift()
{
	var nextUrl = 'B_21.jsp?titleId=<%= request.getParameter("titleId") == null ? "" : request.getParameter("titleId") %>&recipient=<%= request.getParameter("recipient") == null ? "" : request.getParameter("recipient") %>&itemId=<%= request.getParameter("itemId") == null ? "" : request.getParameter("itemId") %>&recipientDeviceCode=<%= request.getParameter("recipientDeviceCode") == null ? "" : request.getParameter("recipientDeviceCode") %>';
...
function initPage()
{
	...
	if (giftStatus == "rejecting") {
		document.getElementById("constElements").style.display='none';
		document.getElementById("giftline").style.display='';
		document.getElementById("giftcurrentBalance").innerHTML = getBalance();
		setUnderButtonL(false);
		setUnderButtonR(true, "OK", "javascript:onRejectConfirmUnderButtonPressed()");
		document.getElementById("text01-01").innerHTML = 'Thank-You Message';
	}
