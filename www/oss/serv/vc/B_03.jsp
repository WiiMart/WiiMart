...
<c:set var="region" value="${param.region}" scope="page" />
<c:set var="country" value="${param.country}" scope="page" />
<c:set var="language" value="${param.language}" scope="page" />
<c:set var="displayRegion" value="E" scope="page" />
<c:choose>
  <c:when test="${param.region eq 'EUR'}">
    <c:set var="displayRegion" value="P" scope="page" />
  </c:when>
  <c:when test="${param.region eq 'USA'}">
    <c:set var="displayRegion" value="E" scope="page" />
  </c:when>
  <c:when test="${param.region eq 'JPN'}">
    <c:set var="displayRegion" value="J" scope="page" />
  </c:when>
  <c:when test="${param.region eq 'KOR'}">
    <c:set var="displayRegion" value="K" scope="page" />
  </c:when>
  <c:otherwise>
    <c:set var="displayRegion" value="E" scope="page" />
  </c:otherwise>
...
<div id="searchItem" class="searchItem" >
  <!-- this is where the console buttons go -->

  <img
    src="/oss/oss/common/images//spacer.gif"
    width="1"
    height="1"
    id="Image10"
  ...
  >
    <img
      src="/oss/oss/common/images//banner/B_04_halfB_consolebannerE_a.png"
      width="244"
      height="91"
      id="Image01"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_FC_NES_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo01"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >86</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=NES')"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_SFC_SNES_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo02"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >55</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=Super NES')"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_N64_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo03"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >20</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=Nintendo 64')"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_PCE_TG16_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo04"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >17</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=TurboGrafx16')"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_MD_GEN_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo05"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >44</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=Sega Genesis')"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_NEOGEO_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo06"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >28</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=NEOGEO')"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_MASTER_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo07"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >10</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=MASTER SYSTEM')"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_VCA_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo08"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >12</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=Virtual Console Arcade')"
  ...
  >
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_C64_<c:out value="${displayRegion}" />.gif"
      width="110"
      height="52"
      id="Logo09"
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="left" valign="top" >
            <span class="contentsBlack" >Commodore 64</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <table width="100%" height="100%" >
      <tbody >
        <tr >
          <td align="right" valign="top" >
            <span class="contentsBlack" >9</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=Commodore 64')"
  ...
  <div
    ...
    "
  >
  <%-- always JP / J, no need to run server code --%>
    <img
      src="/oss/oss/ext/attributes/images/platform/Plat_MSX_J.gif"
      width="110"
      height="52"
      id="Logo10"
  ...
  >
    <a
      href="javascript:showPage('B_04.jsp?p=1&amp;vc=true&amp;platform=MSX')"
      ...
      ><img
        ...
        border="0"
        id="Image10s"
        onmouseover="MM_swapImage('Image10-1','','/oss/oss/common/images//banner/B_04_halfB_consolebannerE_b.png',1);snd.playSE( cSE_Forcus );"
        onmouseout="MM_swapImgRestore()"
        onclick="snd.playSE(cSE_Decide);"
