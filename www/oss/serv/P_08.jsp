...
function returnToCardType()
{
	...
	form.action = "https://oss-auth.a.taur.cloud/oss/serv/P_07.jsp";
//	form.method = "post";
...
<div align="left" class="contentsRedM" id="errorText" style="display:none">
    ...
    <div style="text-align:left;font-size:12px; color:#f5f5f5;">Transaction Country: United States of America</div>
		...
		<div id="P_08-text02-01" class="catalogTitleBlack_01">Please enter your credit-card information.<% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%> <% } else { %><BR>(Your credit card information will be sent over a secure connection.)<% } %>
		</div>
</div>
...
<form id="cardInfo" method="POST" name="cardInfo" action="https://oss-auth.a.taur.cloud/oss/serv/P_12.jsp">
<div id="cardfields">
	<% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) { %>
	<B id="disclaimer" style="position:absolute; left:190px; top:117px; text-align:center;">
		Wii Points don't cost money.
	</B>
	<% } else { %>
	<B id="disclaimer" style="position:absolute; left:310px; top:117px; text-align:center; font-size:12px">
		Wii Points don't cost money.
	</B>
	<% } %>
