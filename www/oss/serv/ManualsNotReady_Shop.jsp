...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function initPage() {
                ...
                setUnderButton(true, "Back", "javascript:showPage('B_06.jsp?titleId=<%= titleId %>')", "snd.playSE(cSE_Cancel)");
            }
        </script>
    </head>
    ...
    <body onload="initPage()" style="overflow: hidden;">
        ...
        <center>
            ...
            <p>Return to the title details page by pressing the button below.</p>
        </center>
