...
function initPage()
{
	...
	setUnderButtonL(true, "Back", "javascript:showPoints()", "wiiCancelSound()");		
...
<div id="text02-01" align="center" class="contentsBlackM">Please select the number of Wii Points you want to buy.<BR><B>Wii Points don't cost money</B></div>
