...
%>
<% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%><a href="https://oss-auth.a.taur.cloud/oss/serv/debug.jsp">debug</a><!--<a href="S_region.jsp">Change region</a>--><% } %>
...
function initPage()
{
    ...
    MM_preloadImages('/oss/oss/common/images/banner/under_banner_b.gif',
            ...
            '/oss/oss/common/images//banner/icr_b_<%= platfcode %>.gif',
...
<script type="text/javascript">
	function doPreload() {
		...
		'/oss/oss/common/images//banner/mynintendo_b.gif',
		'/oss/oss/common/images//banner/mynintendoEU_b.gif');
		MM_preloadImages("/oss/oss/common/images//banner/accessible_b.gif");
	}	
</script>
<script type="text/javascript">
	var scroll_step = 30;
...
<body onload="initPage();doPreload();" style="overflow:hidden" onkeypress="kdown();">
...
<!-- Change mode -->
<div id="changeTitle" style="top: 677px">
...
<div id="access" style="top:300px;">
  ...
  <img id="accessSpacer" onmouseout="MM_swapImgRestore()" src="/oss/oss/common/images//spacer.gif" onmouseover="MM_swapImage('Image12','','/oss/oss/common/images//banner/accessible_b.gif',1);snd.playSE( cSE_Forcus );" onclick="showAccessibleTitles();snd.playSE(cSE_Decide)">
...
<div id="icr" style="top:395px;">
  <img src="/oss/oss/common/images//banner/icr_a_<%= platfcode %>.gif" name="Image20" border="0" id="Image20">
  <img id="icrSpacer" onmouseout="MM_swapImgRestore()" src="/oss/oss/common/images//spacer.gif" onmouseover="MM_swapImage('Image20','','/oss/oss/common/images//banner/icr_b_<%= platfcode %>.gif',1); if(snd) snd.playSE( cSE_Forcus );" onclick="showPage('S_30.jsp');snd.playSE( cSE_Decide );">
  <div id="icrTitleTxt">
