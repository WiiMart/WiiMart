...
function P_02_setUnderButtons() {
	setUnderButtonL(true, "やめる", "javascript:showBack()", "if(snd) snd.playSE(cSE_Cancel)");
...
<div id="text02-01" class="catalogTitleBlack_02">ニンテンドープリペイド番号販売サイトで購入した際に、携帯電話の<BR>画面上に表示されるニンテンドープリペイド番号を登録できます。</div>

<img id="pointcard"/>
<div id="inputs">
<div style="position:absolute; left:0px; top:0px; width:608px; height:456px; z-index:0; overflow: hidden;">
    <img src="/oss/oss/common/images//back/P_20_add_points_mobile_bg.gif" width="608" height="456" border="0"/>
  </div>
