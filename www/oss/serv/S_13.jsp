...
<%
	String refuseGiftFlag = request.getParameter("refuseGiftFlag");
%>
<!--  -----------------------------------------------------  -->
...
<div class="titleBlackL" id="text01-01">
  Gift Settings</div>
<div align="center" class="contentsBlackS_01" align="left" id="text02-01">
 	<table height="100%"><tr><td align="left" valign="middle">You successfully updated your gift settings.</td></tr></table>
</div>
</body>
