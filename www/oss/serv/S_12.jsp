...
<%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8" %><% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%><a href="https://oss-auth.a.taur.cloud/oss/serv/debug.jsp">debug</a><a href="javascript:location.reload()"> reload</a><% } %>
<!--  -----------------------------------------------------  -->
...
function refuseGift(refuseFlag)
{
    trace("refuseGift " + refuseFlag + "\n");	
    var inputHTML = "";
    inputHTML += '<input type="hidden" name="refuseGiftFlag" value="' + refuseFlag + '"/>';
    var form = createPostForm("RefuseGiftForm", "S_13.jsp", true, inputHTML);    
    form.submit();
}
...
function initPage()
{
	...
	refuseGiftFlag = 'false';

	trace("refuseGiftFlag:"+refuseGiftFlag);
		
	if (refuseGiftFlag == 'false') {
		if(document.getElementById("refuseGiftFlag")) {
			document.getElementById("refuseGiftFlag").innerHTML = 'You&rsquo;ve set your Wii to receive gifts. Your Wii Friends are able to send you gifts.<BR><BR>If you&rsquo;d like to change your settings so that you do not receive gifts, select the Don&rsquo;t Receive icon below.<BR><BR>';
		}
		document.getElementById("receiveGiftButton").style.display = 'none';
		document.getElementById("refuseGiftButton").style.display = '';
	} else {
		if(document.getElementById("refuseGiftFlag")) {
			document.getElementById("refuseGiftFlag").innerHTML = 'You&rsquo;ve set your Wii to not receive gifts. Your Wii Friends are not able to send you gifts.<BR><BR>If you&rsquo;d like to change your settings so that you can receive gifts, select the Receive icon below.';
		}
		document.getElementById("receiveGiftButton").style.display = '';
		document.getElementById("refuseGiftButton").style.display = 'none';
	}
	...
	MM_preloadImages('/oss/oss/common/images//banner/under_banner_b.gif',
			 ...
			 '/oss/oss/common/images//banner/gift_setreject_b.gif',
			 '/oss/oss/common/images//banner/gift_setreceive_b.gif');
...
<div id="P_01_text01-01" class="titleBlackL" >Gift Settings</div>

<div align="left" class="contentsBlack" style="position:absolute; left:36px; top:88px; width:540px; height:180px; z-index:37">
  <table height="100%"><tr><td align="left" valign="middle"><span id="refuseGiftFlag"></span></td></tr></table>
</div>

<div id="receiveGiftButton" style="position:absolute; left:176px; top:284px; width:256px; height:85px;">
  <img class="cardspacer" src='/oss/oss/common/images//spacer.gif' border="0" 
  onmouseover="MM_swapImage('card02_Img','','/oss/oss/common/images//banner/gift_setreceive_b.gif',1); snd.playSE( cSE_Forcus );" 
  onmouseout="MM_swapImgRestore()" onclick="refuseGift(false); wiiSelectSound();"/>
  <img class="cardbanner" src='/oss/oss/common/images//banner/gift_setreceive_a.gif' id="card02_Img" />
  <div id="giftsettext" style="position:absolute; left:76px; top:5px; width:160px; height:74px; z-index:23;" class="catalogTitleBlack" align="center">
	<table height="100%"><tr><td align="left" valign="middle">Receive</td></tr></table>
  </div>
</div>

<div id="refuseGiftButton" style="position:absolute; left:176px; top:284px; width:256px; height:85px;"> 
  <img class="cardspacer" src='/oss/oss/common/images//spacer.gif' border="0" 
  onmouseover="MM_swapImage('card01_Img','','/oss/oss/common/images//banner/gift_setreject_b.gif',1); snd.playSE( cSE_Forcus );"
  onmouseout="MM_swapImgRestore()" onclick="refuseGift(true); wiiSelectSound();" />
  <img class="cardbanner" src='/oss/oss/common/images//banner/gift_setreject_a.gif' id="card01_Img">
  <div id="giftsettext" style="position:absolute; left:76px; top:5px; width:160px; height:74px; z-index:23;" class="catalogTitleBlack" align="center">
    <table height="100%"><tr><td align="left" valign="middle">Don&rsquo;t Receive</td></tr></table>
  </div>
</div>
