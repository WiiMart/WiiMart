<%@ page import = "com.ocarina.classes.Catalog,java.io.*,java.util.*,java.net.http.*,java.net.URI,java.net.URLEncoder,java.net.URLDecoder,java.net.http.HttpResponse.BodyHandlers,java.net.HttpURLConnection,java.net.URL,java.nio.charset.StandardCharsets,org.json.*,java.util.stream.Collectors" %><%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8" %><%@ page buffer="8192kb" autoFlush="true" %><a href="https://oss-auth.a.taur.cloud/oss/serv/debug.jsp">debug</a><a href="javascript:window.location.reload();">reload</a><a href="javascript:window.history.go(-1)">back</a><%
...
if (region == "TWN" || region == "TW") {
    region = "USA";
}
JSONObject obj = catalog.getW_01Titles(region, language, country);
JSONArray rec = obj.getJSONArray("rec");
JSONArray tL1 = obj.getJSONArray("t1");
JSONArray tL2 = obj.getJSONArray("t2");
JSONArray tL3 = obj.getJSONArray("t3");
JSONArray tL4 = obj.getJSONArray("t4");
%>
...
function initPageCommon()
{
	...
	ecsUrl = 'https://oss-auth.a.taur.cloud/ecs/services/ECommerceSOAP';

	iasUrl = 'https://oss-auth.a.taur.cloud/ias/services/IdentityAuthenticationSOAP';
...
<div id="info02n" align="center">
      ...
      <div id="info01">
        <div nowrap align="left" class="txt_info">
          <script language="JavaScript">document.write('Catalog updated! Games added August 6.'.replace('[NEW]', ''));</script>
        </div>
      </div>
