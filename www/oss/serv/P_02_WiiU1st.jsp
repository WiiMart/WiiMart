...
<span id="P_01_WiiU" style="font-size: 20px;"><span style="color:#FF0000;">Wii Points added here can only be used <% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%>on WiiMart<% } else { %>in the Wii Shop Channel<% } %>. You cannot redeem them for Wii U software from Nintendo eShop.</span><br><br>Add Wii Points to your <% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%>WiiMart<% } else { %>Wii Shop Channel<% } %> account?</span>
