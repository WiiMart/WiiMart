...
String targetURL = "";
if (region3Letter == "TWN" || region3Letter == "TW") {
    targetURL = "http://127.0.0.1:8082/W_01titles?region=USA&language=en";
} else {
    targetURL = "http://127.0.0.1:8082/W_01titles?region=" + region3Letter + "&language=" + language;
}
...
function initPageCommon()
{
	...
	ecsUrl = 'https://oss-auth.a.taur.cloud/ecs/services/ECommerceTest';

	iasUrl = 'https://oss-auth.a.taur.cloud/ias/services/IdentityAuthenticationTest';
...
// IAS errors
function isLoyaltyprogress(progress)
{
...
function change_Header_titlelistName0()
{
    ...
    if (ec.getSessionValue("ogMode") == "true") {
        titleElem.innerHTML="<span class='style1'>" + shop.title + "</span><span class='style2'>Recommended Titles</span>";
    } else {
...
<%
    JSONArray fallbackTitles = null;
    
    fallbackTitles = new JSONArray("[{'recommendedTitles':[{ id: '000100014843534A', title1: 'Wii U Transfer Tool', title2: '', console: 'WII', controllers: '', region: '', language: '', attributes: '', date: '', added: '', publisher: '', genre: '', points: '0', players: '', rating: '', ratingdetails: '', thumbnail: 'FFFD0000', size: '', titleVersion: -1, page: -1 }],'titleList1':[{ id: '000100014843334A', title1: 'USB Flash Optimization Program', title2: '', console: '', controllers: '', region: '', language: '', attributes: '', date: '', added: '', publisher: '', genre: '', points: '0', players: '', rating: '', ratingdetails: '', thumbnail: 'FFFD0000', size: '', titleVersion: -1, page: -1 }],'titleList2':[{ id: '000100014843534A', title1: 'Wii U Transfer Tool', title2: '', console: '', controllers: '', region: '', language: '', attributes: '', date: '', added: '', publisher: '', genre: '', points: '0', players: '', rating: '', ratingdetails: '', thumbnail: 'FFFD0000', size: '', titleVersion: -1, page: -1 }],'titleList3':[{ id: '000100014843534A', title1: 'Wii U Transfer Tool', title2: '', console: '', controllers: '', region: '', language: '', attributes: '', date: '', added: '', publisher: '', genre: '', points: '0', players: '', rating: '', ratingdetails: '', thumbnail: 'FFFD0000', size: '', titleVersion: -1, page: -1 }],'titleList4':[{ id: '000100014843534A', title1: 'Wii U Transfer Tool', title2: '', console: '', controllers: '', region: '', language: '', attributes: '', date: '', added: '', publisher: '', genre: '', points: '0', players: '', rating: '', ratingdetails: '', thumbnail: 'FFFD0000', size: '', titleVersion: -1, page: -1 }]}]");
    try {
        rec.getJSONObject(1).getString("id");
    } catch (org.json.JSONException e) {
        g = null;

        g = fallbackTitles;
        obj = g.getJSONObject(0);
        tL1 = null;
        tL2 = null;
        tL3 = null;
        tL4 = null;
...
function initRecommendedTitles()
{
  ...
  <% for (int i = 0; i < rec.length(); i++) { 
    ...
    JSONObject title01_01 = rec.getJSONObject(i);
    String RECtitleid = title01_01.has("id") ? title01_01.getString("id") : "";
    String RECtitlename1stline = title01_01.has("title1") ? title01_01.getString("title1") : " ";
    String RECtitlename2ndline = title01_01.has("title2") ? title01_01.getString("title2") : "";
    String RECtitlethumbnail = title01_01.has("thumbnail") ? title01_01.getString("thumbnail") : "";
    String RECtitleisnew = title01_01.has("isNew") ? title01_01.getString("isNew") : "false";
    String RECTitlePrice = title01_01.has("points") ? title01_01.getString("points") : "0";

    %>
    title = new TitleInfo();
      title.titleId = '<%= RECtitleid %>';

      title.nameFirstLine = '<%= RECtitlename1stline %>';
      title.nameSecondLine = '<%= RECtitlename2ndline %>';

	  title.titleImage = null;
    
      title.titleImage = '/oss/ccs/<%= RECtitleid %>/<%= RECtitlethumbnail %>';
      MM_preloadImages('/oss/ccs/<%= RECtitleid %>/<%= RECtitlethumbnail %>');
    
      title.isNew = '<%= RECtitleisnew %>';
      title.price = '<%= RECTitlePrice %>';
...
<body link="black" vlink="black" alink="black" onkeypress="kdown();" onload="initPage();shop.enableHRP();" style="overflow: hidden;">
...
<div id="info01n" align="center">
      ...
      <div id="info01">
        ...
        <script> document.write("Dynamic Banners are now available!"); </script>
        </div>
      </div>
      <div id="infoShadow01">
        <img src="/oss/oss/common/images//spacer.gif" border="0" name="info01s" />
      </div>
      <div id="infoSpacer01">
        <a href="javascript:showPage('W_02.jsp?p=12')">
            <img src="/oss/oss/common/images//spacer.gif" width="514" height="25" border="0" 
                ...
                onMouseOut="MM_swapImage('info01s','','/oss/oss/common/images//banner/GifA_News_noAction.png',1);" />
        </a>
      </div>
      ...
      <div id="info01">
        <div nowrap align="left" class="txt_info">
          <script language="JavaScript">document.write('Catalog updated! Games added Nov 5.'.replace('[NEW]', ''));</script>
        </div>
      </div>
      ...
      <div id="infoSpacer02"><a href="javascript:showPage('W_02.jsp?p=1')">
        <img src="/oss/oss/common/images//spacer.gif" width="514" height="25" border="0" 
            onMouseDown="MM_swapImage('info02s','','/oss/oss/common/images//banner/GifA_News_Press.png',1);" 
            onMouseUp="MM_swapImage('info02s','','/oss/oss/common/images//banner/GifA_News_Over.png',1)" 
            onClick="snd.playSE(cSE_Decide);" 
            onmouseover="snd.playSE( cSE_Forcus ); MM_swapImage('info02s','','/oss/oss/common/images//banner/GifA_News_Over.png',1);move_fleeze_cursor();" 
            onMouseOut="MM_swapImage('info02s','','/oss/oss/common/images//banner/GifA_News_noAction.png',1);" /></a></div>
...
<div id="txtSoftList" align="center">
    <span class="style1">
        <script>
            document.write(ec.getSessionValue("currTitle"))
        </script></span>
