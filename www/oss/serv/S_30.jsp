...
function initPage()
{
    ...
    setUnderButtonR(true, "OK", "javascript:showPage('B_04.jsp?icr=true&p=1')", "wiiSelectSound()");
...
<div id="text02-02">
    <div align="center" class="contentsBlackM">
        <table height="100%">
            <tr>
                <td align="left" valign="middle">
                    Please note that this offer will expire<BR>on December 31st, <fmt:formatDate value="${date}" pattern="yyyy" />.</td>
            </tr>
        </table>
    </div>
</div>
