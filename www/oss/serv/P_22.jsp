...
<% if ((request.getParameter("og") == null ? "false" : request.getParameter("og")).equals("false")) {%><a href="https://oss-auth.a.taur.cloud/oss/serv/debug.jsp">debug</a> auPg
<% } %>
...
function initPage()
{
	...
	setUnderButtonL(true, "もどる", "javascript:gotoWiipoint()", "snd.playSE(cSE_Cancel)");
...
<div id="P_01_text01-01" class="titleBlackM" >ニンテンドープリペイド番号販売（au）</div>
<!--
<div id="P_01_text02-01">
  <div align="left" class="catalogTitleBlack_02">下記のサイトでニンテンドーポイント番号を購入し、登録してください。</div>
</div>
-->


<div id="urlText" style="position:absolute; left:40px; top:87px; width:240px; height:18px; z-index:33;">
  <div align="left" class="buttonTextBlackM"><table height="100%"><tr><td align="left" valign="middle">URLからアクセス</td></tr></table></div>
</div>

<div id="qrText" style="position:absolute; left:322px; top:87px; width:240px; height:18px; z-index:33;">
  <div align="left" class="buttonTextBlackM"><table height="100%"><tr><td align="left" valign="middle">QRコードからアクセス</td></tr></table></div>
</div>

<div id="menuText" style="position:absolute; left:40px; top:216px; width:360px; height:18px; z-index:33;">
  <div align="left" class="buttonTextBlackM"><table height="100%"><tr><td align="left" valign="middle">トップメニューからアクセス</td></tr></table></div>
</div>


<div id="urlBody" style="position:absolute; left:40px; top:148px; width:360px; height:18px; z-index:33;">
  <div align="left" class="contentsBlueM"><table height="100%"><tr><td align="left" valign="middle">http://nintendo.jp/np/</td></tr></table></div>
</div>

<div id="menuBody" style="position:absolute; left:40px; top:242px; width:540px; height:18px; z-index:33;">
  <div align="left" class="catalogTitleBlue" id="hogeho"><table height="100%"><tr><td align="left" valign="middle">EZWeb⇒ au one トップまたはトップメニュー⇒ メニューリスト⇒<BR>３．ゲーム・電子書籍⇒ ゲーム⇒ ゲーム機連動⇒ ニンテンドープリペイド番号販売</td></tr></table></div>
</div>
...
<div id="mobileButton" style="position:absolute; left:100px; top:288px; width:409px; height:86px;">
  ...
  <div id="mobileText" style="position:absolute; left:10px; top:10px; width:389px; height:66px; z-index:33;">
    <div align="center" class="catalogTitleBlack"><table height="100%"><tr><td align="left" valign="middle">購入済みのニンテンドープリペイド番号を<BR>使用してWiiポイントを登録</td></tr></table></div>
  </div>
