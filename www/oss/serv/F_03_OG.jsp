...
function initPage()
{
    ...
    if (isShowUpdateAvailable()) {
        if ( shop.isCompatibleMode )
        {
            document.getElementById("updateMessage").innerHTML = "There is an update to the Wii Shop Channel!<BR><BR>To receive this update, go to System Settings on the Wii U Menu and select System Update. Come back after you&rsquo;ve updated!"
...
<div align="center" class="buttonTextBlackM" id="text02-01">
   <span id="updateMessage">There is an update to the Wii Shop Channel!<BR><BR>To receive this update, go to Wii Settings and select Wii System Update. When you return to the Wii Shop Channel, you will receive the update. Come back after you&rsquo;ve updated!</span>
</div>
