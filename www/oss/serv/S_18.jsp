...
<title>???S_18.title???</title>
<link href="/oss/oss/common/css/S_18.css" rel="stylesheet" type="text/css" />
...
<div id="notefield">notefield</div>
<div id="text02-01">Please enter the Wii Number of the person you helped connect<BR>to the internet.</div>
<div id="text03-01">
	<!--text03-01-->
</div>
<div id="numberfield">
	<input type="text" class="input"
	onclick="kbd.call(1)" id="numfield"
	onmouseover="this.style.backgroundColor='#E6E6E6';if(snd&&'playSE'in snd){snd.playSE(cSE_Forcus)}"
	onmouseout="this.style.backgroundColor='#FFFFFF'"
	/>
</div>
<!--input type="text" class="input"-->
<div id="registhelper" style="text-align: center;">Register Wii Number of<BR>Someone You Helped</div><!--button-->

<div id="status" style="text-align: center;">Check Registration Status</div><!--button-->
<!--
possibly unused
<div id="text01">text01</div>
<div id="text02">text02</div>

<div id="countframe">countframe</div>
<div id="countstar">#countstar</div>
<!--<div id="member_id_area">member_id_area</div>
<div id="gold_text">gold_text</div>
<div id="gold_attention">gold_attention</div>-->
</body></html>