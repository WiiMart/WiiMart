...
<div id="text02-01" class="catalogTitleBlack_03">With a Wii Download Ticket, you can enter a code to download software.<BR><BR>If you need to download a title you&rsquo;ve already redeemed, select &quot;Titles You&rsquo;ve Downloaded&quot; from the main menu, and choose the title.</div>

<div id="inputs">
  <div id="text03-01" align="center" class="contentsBlueM">Please enter the Wii Download Ticket code.</div>
  <form id="cardForm" action="https://oss-auth.a.taur.cloud/oss/serv/B_32.jsp" method="post" name="cardForm">
