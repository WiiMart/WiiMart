...
class ECommerceInterface {
    ...
    getWeakToken() {
        return "0f6a6fc44edf263279bcef4d8220e43b"
    }
...
class wiiNwc24 {
     constructor() {
        this.myUserId = '5688781504425659'
        this.friends = [{name: "idkwh", userId: "2603363066089393", miiImage: ""}];
     }
     getFriendNum() {
          return this.friends.length;
     }
     getFriendInfo(num, type) {
          if (num > this.friends.length) return;
          return this.friends[num][type];
     }
}
window.wiiNwc24 = wiiNwc24;
snd = new wiiSound();
shop = new wiiShop();
ec = new ECommerceInterface();
if (typeof TitleManager != "undefined") titleManager = new TitleManager(titleId, titleSize, titleTmdSize, latestVersion);
function hasProgressFinished() { return 0;}
function isRefreshBalanceNeeded() {return false;}
soundCheck = true;
ecCheck = true;
ossCheck = true;
shopCheck = true;
