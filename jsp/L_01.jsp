...
<div class="catalogTitleBlack" id="text02-01">
  <p id="wii_message" class="styleConfirm">The country setting for the console has changed since the last time you connected to the WiiMart.&nbsp;If you have pending gifts, you won&rsquo;t be able to receive them after changing your country setting.</p>
