...
<div id="changeTitle" style="top: 771px">
	<img src="/oss/oss/common/images//banner/accessible_a.gif" name="Image16" border="0" id="Image16">
	<img id="regionSpacer" onmouseout="MM_swapImgRestore()" src="/oss/oss/common/images//spacer.gif" onmouseover="MM_swapImage('Image16','','/oss/oss/common/images//banner/accessible_b.gif',1);snd.playSE( cSE_Forcus );" onclick="showPage('S_title.jsp');snd.playSE( cSE_Decide );">
	<div id="usageRecordTxt">
		<div class="headerBlueM" id="text04-01"><table height="100%"><tbody><tr><td align="left" valign="middle" style="color: #35beed; font-weight: bold;">Change title</td></tr></tbody></table></div>
	</div>
  </div>
