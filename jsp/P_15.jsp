...
<html>
	<head>
		<script>
			// prevent 209601 (idle on a

<a href="https://oss-auth.thecheese.io/oss/serv/debug.jsp">debug</a>
<a href="javascript:window.location.reload();">reload</a>
<a href="https://oss-auth.thecheese.io/oss/serv/W_03.jsp">W_03.jsp</a>
<a href="https://oss-auth.thecheese.io/oss/serv/P_06.jsp">P_06.jsp</a>
<!--  -----------------------------------------------------  -->
<!--  Copyright 2005-2014 Acer Cloud Technology, Inc.        -->
<!--  All Rights Reserved.                                   -->
<!--                                                         -->
...
function initPageCommon()
{
	...
	ucsUrl = 'https://oss-auth.thecheese.io/ccs/download';
